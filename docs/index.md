...
------------- | ------  | --- | -------------------------- | -----------
[0.6.2](https://github.com/elmsln/elmsln/archive/0.6.2.zip)  | 5.4+ & 7 | Drupal 7.x | [![Build Status](https://travis-ci.org/elmsln/elmsln.svg?branch=master)](https://travis-ci.org/elmsln/elmsln)
