...
------------- | ------  | --- | -------------------------- | -----------
[0.6.0](https://github.com/elmsln/elmsln/archive/0.6.0.zip)  | 5.4.0+ | Drupal 7.x | [![Build Status](https://travis-ci.org/elmsln/elmsln.svg?branch=master)](https://travis-ci.org/elmsln/elmsln) [![Stories in Ready](https://badge.waffle.io/elmsln/elmsln.png?label=ready&title=Ready)](http://waffle.io/elmsln/elmsln)
