...
That's where DAAAAAAAAYYYYYNNNNAAAAAAA comes in, DAAAAAAAAYYYYYNNNNAAAAAAA allows you to give all of those anonymous nodes over to someone else as author. It takes 1 param, loads all nodes that are currently marked anonymous, loads them, changes author to match the user id of the username/id you passed in and then your done.
