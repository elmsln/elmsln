...
define("vs/language/json/workerManager", ["require", "exports"], function (e, t) {
  ...
  t.WorkspaceChange = W, (w = t.TextDocumentIdentifier || (t.TextDocumentIdentifier = {})).create = function (e) {
    return {
      uri: e
    };
  }, w.is = function (e) {
  ...
  }, (N = P = t.MarkedString || (t.MarkedString = {})).fromPlainText = function (e) {
    ...
    var t = e;
    return Z.objectLiteral(t) && (K.is(t.contents) || P.is(t.contents) || Z.typedArray(t.contents, P.is)) && (void 0 === e.range || r.is(e.range));
  ...
  t.DocumentSymbol = Y, (q = Y = t.DocumentSymbol || (t.DocumentSymbol = {})).create = function (e, t, n, r, o, i) {
    var a = {
      name: e,
      detail: t,
      kind: n,
    ...
    var t = e;
    return t && Z.string(t.name) && Z.number(t.kind) && r.is(t.range) && r.is(t.selectionRange) && (void 0 === t.detail || Z.string(t.detail)) && (void 0 === t.deprecated || Z.boolean(t.deprecated)) && (void 0 === t.children || Array.isArray(t.children));
  }, t.DocumentSymbol = Y, (U = t.CodeActionKind || (t.CodeActionKind = {})).QuickFix = "quickfix", U.Refactor = "refactor", U.RefactorExtract = "refactor.extract", U.RefactorInline = "refactor.inline", U.RefactorRewrite = "refactor.rewrite", U.Source = "source", U.SourceOrganizeImports = "source.organizeImports", (B = t.CodeActionContext || (t.CodeActionContext = {})).create = function (e, t) {
    var n = {
      diagnostics: e
    };
    ...
    var t = e;
    return t && Z.string(t.title) && (void 0 === t.diagnostics || Z.typedArray(t.diagnostics, v.is)) && (void 0 === t.kind || Z.string(t.kind)) && (void 0 !== t.edit || void 0 !== t.command) && (void 0 === t.command || b.is(t.command)) && (void 0 === t.edit || S.is(t.edit));
  ...
  t.DocumentLink = X, (G = X = t.DocumentLink || (t.DocumentLink = {})).create = function (e, t, n) {
    ...
    for (var n = e.getText(), r = function e(t, n) {
      ...
      n = n.substring(0, s) + a.newText + n.substring(u, n.length), o = s;
    }
      ...
      return this._worker(o).then(function (e) {
        ...
        if (e) {
          var t = e.items.map(function (e) {
            ...
            return e.textEdit && (t.range = u(e.textEdit.range), t.insertText = e.textEdit.newText), e.additionalTextEdits && (t.additionalTextEdits = e.additionalTextEdits.map(c)), e.insertTextFormat === i.InsertTextFormat.Snippet && (t.insertTextRules = monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet), t;
          });
          return {
  ...
  Object.defineProperty(t, "__esModule", {
    ...
    function f(e, t) {
      for (var n = 0, r = 0; n < e || !t;) {
        ...
        if (48 <= o && o <= 57) r = 16 * r + o - 48;else if (65 <= o && o <= 70) r = 16 * r + o - 65 + 10;else {
          if (!(97 <= o && o <= 102)) break;
          r = 16 * r + o - 97 + 10;
        }
        a++, n++;
    ...
    function t() {
      ...
      switch (e) {
        ...
        case 47:
          ...
          if (42 !== i.charCodeAt(a + 1)) return r += String.fromCharCode(e), a++, u = 16;
          a += 2;
        ...
        case 45:
          if (r += String.fromCharCode(e), ++a === o || !h(i.charCodeAt(a))) return u = 16;
        ...
        case 57:
          return r += function () {
            ...
            if (a < i.length && 46 === i.charCodeAt(a)) {
              if (!(++a < i.length && h(i.charCodeAt(a)))) return c = 3, i.substring(e, a);
  ...
  t.format = function (r, e, t) {
    ...
    if (e) {
      for (a = e.offset, s = a + e.length, i = a; 0 < i && !w(r, i - 1);) i--;

      for (var u = s; u < r.length && !w(r, u);) u++;

      o = r.substring(i, u), n = function (e, t) {
    ...
    for (; 17 !== b;) {
      ...
      if (2 === _) 1 !== b && (l--, E = p());else if (4 === _) 3 !== b && (l--, E = p());else {
        switch (b) {
          case 3:
          case 1:
            l++, E = p();
  ...
  function f(e, t, n) {
    ...
    function y(e, t, n) {
      if (void 0 === t && (t = []), void 0 === n && (n = []), h(e), 0 < t.length + n.length) for (var r = o.getToken(); 17 !== r;) {
        if (-1 !== t.indexOf(r)) {
          v();
          break;
        }
  ...
  t.getLocation = function (e, o) {
    ...
    function r(e, t, n, r) {
      u.value = e, u.offset = t, u.length = n, u.type = r, u.colonOffset = void 0, s = u;
    }
    ...
    try {
      f(e, {
        ...
        onSeparator: function (e, t, n) {
          if (o <= t) throw a;
          if (":" === e && s && "property" === s.type) s.colonOffset = t, c = !1, s = void 0;else if ("," === e) {
            var r = i[i.length - 1];
            i[i.length - 1] = "number" == typeof r ? r + 1 : (c = !0, ""), s = void 0;
          }
        }
      });
    } catch (e) {
    ...
    return {
      ...
      isAtPropertyKey: c,
      matches: function (e) {
        for (var t = 0, n = 0; t < e.length && n < i.length; n++) if (e[t] === i[n] || "*" === e[t]) t++;else if ("**" !== e[t]) return !1;
    ...
    if (void 0 === r && (r = !1), s(t, n, r)) {
      var o = t.children;
      if (Array.isArray(o)) for (var i = 0; i < o.length && o[i].offset <= n; i++) {
        var a = e(o[i], n, r);
        if (a) return a;
      }
      return t;
  ...
  function r(e, t, n, r, o) {
    for (var i, a = t.slice(), s = C.parseTree(e, []), u = void 0, c = void 0; 0 < a.length && (c = a.pop(), void 0 === (u = C.findNodeAtLocation(s, a)) && void 0 !== n);) n = "string" == typeof c ? ((i = {})[c] = n, i) : [n];

    if (u) {
      if ("object" === u.type && "string" == typeof c && Array.isArray(u.children)) {
        ...
        if (void 0 !== f) {
          ...
          return 0 < d ? l = (b = u.children[d - 1]).offset + b.length : (l = u.offset + 1, 1 < u.children.length && (g = u.children[1].offset)), _(e, {
            offset: l,
            length: g - l,
            content: ""
          }, r);
        ...
        var h = JSON.stringify(c) + ": " + JSON.stringify(n),
            p = o ? o(u.children.map(function (e) {
      ...
      if ("array" === u.type && "number" == typeof c && Array.isArray(u.children)) {
        if (-1 === c) {
          h = "" + JSON.stringify(n), m = void 0;
          if (0 === u.children.length) m = {
            offset: u.offset + 1,
            length: 0,
            content: h
          };else m = {
            offset: (b = u.children[u.children.length - 1]).offset + b.length,
            length: 0,
            content: "," + h
          };
          return _(e, m, r);
      ...
      throw new Error("Can not add " + ("number" != typeof c ? "index" : "property") + " to parent of type " + u.type);
    }
  ...
  function _(e, t, n) {
    ...
    for (var a = c.format(r, {
      offset: o,
      length: i - o
    }, n), s = a.length - 1; 0 <= s; s--) {
      var u = a[s];
      r = f(r, u), o = Math.min(o, u.offset), i = Math.max(i, u.offset + u.length), i += u.content.length - u.length;
    }
      ...
      tokenize: function (e, t, n, r) {
        return function (e, t, n, r, o) {
          ...
          for (u = {
            ...
            if (d === r + c.getPosition()) throw new Error("Scanner did not advance, next 3 characters are: " + t.substr(c.getPosition(), 3));
            ...
            u.endState = new p(n.getStateData(), c.getTokenError(), f), u.tokens.push({
              startIndex: d,
              scopes: l
            });
          }
