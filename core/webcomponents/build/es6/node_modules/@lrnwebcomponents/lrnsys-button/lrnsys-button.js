 ...
 */import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import"../materializecss-styles/lib/colors.js";import"../../@polymer/paper-button/paper-button.js";import"../../@polymer/iron-icon/iron-icon.js";/**
 * `lrnsys-button`
 * `A simple button for use in systems`
 * @demo demo/index.html
 */class LrnsysButton extends PolymerElement{constructor(){super();import("../../@polymer/iron-icons/iron-icons.js");import("../../@polymer/paper-tooltip/paper-tooltip.js")}static get template(){return html`
...
this.__prefetchLink=link;document.head.appendChild(link)}}/**
   * attached life cycle
   */ready(){super.ready();afterNextRender(this,function(){this.addEventListener("mousedown",this.tapEventOn.bind(this));this.addEventListener("mouseover",this.tapEventOn.bind(this));this.addEventListener("mouseout",this.tapEventOff.bind(this));this.$.button.addEventListener("focused-changed",this.focusToggle.bind(this))})}connectedCallback(){super.connectedCallback();this.__ready=!0;afterNextRender(this,function(){this._applyPrefetch(this.prefetch)})}/**
