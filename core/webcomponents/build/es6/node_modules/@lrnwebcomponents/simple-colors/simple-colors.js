 ...
 */import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import"./lib/simple-colors-styles.js";/**
 * `simple-colors`
...
static get properties(){return{/**
       ...
       * make the default theme dark?
       */colors:{name:"colors",type:"Object",value:window.SimpleColorsUtilities.colors,notify:!0}}}static get tag(){return"simple-colors"}/**
   ...
   */maxContrastShade(shade){return window.SimpleColorsUtilities.maxContrastShade(shade)}/**
   * gets the current shade
   *
   * @param {string} the shade
   * @param {number} the inverted shade
   */invertShade(shade){return window.SimpleColorsUtilities.invertShade(shade)}/**
   ...
   */makeVariable(color="grey",shade=1,theme="default"){return window.SimpleColorsUtilities.makeVariable(color="grey",shade=1,theme="default")}/**
   * returns a variable based on color name, shade, and fixed theme
   *
   * @param {string} the color name
   * @param {number} the color shade
   ...
   */makeClass(color="grey",shade=1,theme="default",suffix=""){return window.SimpleColorsUtilities.makeClass(color="grey",shade=1,theme="default",suffix="")}/**
   ...
   */getContrastingColors(colorName,colorShade,isLarge){return window.SimpleColorsUtilities.getContrastingColors(colorName,colorShade,isLarge)}/**
   * for large or small text given a color and its shade,
   ...
   */getContrastingShades(isLarge,colorName,colorShade,contrastName){return window.SimpleColorsUtilities.getContrastingShades(isLarge,colorName,colorShade,contrastName)}/**
   ...
   */isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade){return window.SimpleColorsUtilities.isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade)}}customElements.define(SimpleColors.tag,SimpleColors);export{SimpleColors};