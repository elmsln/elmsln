 ...
 */import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import{SimpleColors}from"../../simple-colors.js";//import the shared styles
/**
 ...
 */class simpleColorsSwatchInfo extends SimpleColors{//render function
static get template(){return html`
   ...
   * @param {string} a swatch id (`color_index`)
   * @returns {string} the style
   */_getBorder(swatchId,inverse=!1){let colors=this._getColors(swatchId,inverse);return"border: 3px solid "+colors[0]+"; padding: 3px;"}/**
   ...
   * @param {string} a swatch id (`color_index`)
   * @returns {string} the style
   */_getInverseBorder(swatchId){return this._getBorder(swatchId,!0)}/**
...
}export{simpleColorsSwatchInfo};window.customElements.define(simpleColorsSwatchInfo.tag,simpleColorsSwatchInfo);