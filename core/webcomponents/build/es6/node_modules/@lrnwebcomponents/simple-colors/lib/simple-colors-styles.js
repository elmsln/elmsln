...
class SimpleColorsStyles extends PolymerElement {
  ...
  addCssVariables(sheet) {
    if (typeof sheet !== typeof undefined) {
      ...
      sheet.insertRule(this.makeRule("html", this.addColorShades("default", "accent", greys, false) + this.addThemeVariables("default", false)), sheet.cssRules.length);
      sheet.insertRule(this.makeRule("html", this.addColorShades("fixed", "accent", greys, false) + this.addThemeVariables("fixed", false)), sheet.cssRules.length);
      sheet.insertRule(this.makeRule("[dark]", this.addColorShades("default", "accent", greys, true) + this.addThemeVariables("default", true)), sheet.cssRules.length);
      return sheet;
    }
  }
  /**
  ...
  addAccentVariables(sheet) {
    if (typeof sheet !== typeof undefined) {
      for (let color in this.colors) {
        sheet.insertRule(this.makeRule('[accent-color="' + color + '"]', [this.addColorShades("default", "accent", this.colors[color], false), this.addColorShades("fixed", "accent", this.colors[color], false)].join("")), sheet.cssRules.length);
        sheet.insertRule(this.makeRule('[dark][accent-color="' + color + '"]', [this.addColorShades("default", "accent", this.colors[color], true)].join("")), sheet.cssRules.length);
      }
  ...
  getAccentVariablesText() {
    ...
    for (let color in this.colors) {
      text += this.makeRule(':host([accent-color="' + color + '"])', [this.addColorShades("default", "accent", this.colors[color], false), this.addColorShades("fixed", "accent", this.colors[color], false)].join(""));
      text += this.makeRule(':host([dark][accent-color="' + color + '"])', [this.addColorShades("default", "accent", this.colors[color], true)].join(""));
    }
