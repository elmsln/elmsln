 ...
 */import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import{SchemaBehaviors}from"../schema-behaviors/schema-behaviors.js";import"../../@polymer/iron-a11y-keys/iron-a11y-keys.js";/**
 * `a11y-gif-player`
 ...
 */class A11yGifPlayer extends SchemaBehaviors(PolymerElement){constructor(){super();import("../../@polymer/iron-image/iron-image.js")}static get template(){return html`
      <style>
        :host {
          display: block;
        }
      ...
      ></iron-a11y-keys>
    `}static get tag(){return"a11y-gif-player"}static get properties(){let props={/**
       ...
       * Alt text of the gif
       */alt:{type:String,value:null}};if(super.properties){props=Object.assign(props,super.properties)}return props}connectedCallback(){super.connectedCallback();afterNextRender(this,function(){this.addEventListener("click",this.toggleAnimation.bind(this));this.HAXWiring=new HAXWiring;this.HAXWiring.setup(A11yGifPlayer.haxProperties,A11yGifPlayer.tag,this)})}disconnectedCallback(){this.removeEventListener("click",this.toggleAnimation.bind(this));super.disconnectedCallback()}/**
   * Ready life cycle
   */ready(){super.ready();this.stop();this.shadowRoot.querySelector("#a11y").target=this.shadowRoot.querySelector("#gifbutton")}/**
   * plays the animation regarless of previous state
   */play(){this.__stopped=!0;this.toggleAnimation()}/**
