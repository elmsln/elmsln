import{html}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import{SimpleColors}from"../simple-colors/simple-colors.js";/**
 * `person-testimonial`
 * `Leaving a testimonial from a person to say your company rocks!`
 * @demo demo/index.html
 */class PersonTestimonial extends SimpleColors{constructor(){super();import("../../@polymer/paper-card/paper-card.js");import("../../@polymer/iron-image/iron-image.js");import("../../@polymer/iron-icon/iron-icon.js");import("./lib/person-testimonial-icon.js");afterNextRender(this,function(){this.HAXWiring=new HAXWiring;this.HAXWiring.setup(PersonTestimonial.haxProperties,PersonTestimonial.tag,this)})}static get template(){return html`
