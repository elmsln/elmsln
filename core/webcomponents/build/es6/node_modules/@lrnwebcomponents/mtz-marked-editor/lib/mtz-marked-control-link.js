import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../../../@polymer/iron-a11y-keys/iron-a11y-keys.js";import"../../../@polymer/paper-icon-button/paper-icon-button.js";import{mtzMarkedControlBehavior}from"./mtz-marked-control-behavior.js";class MtzMarkedControlLink extends mtzMarkedControlBehavior(PolymerElement){static get template(){return html`
      <style>
        :host {
      ...
      <iron-a11y-keys
        ...
        target="[[__editor]]"
      ></iron-a11y-keys>
    `}static get tag(){return"mtz-marked-control-link"}static get properties(){let props={title:String,icon:String,keys:String,noink:Boolean// Pass-through
   ...
   * @return {Boolean}
   * @protected
   */_isLink(selection){return selection.text.startsWith("https://")}}window.customElements.define(MtzMarkedControlLink.tag,MtzMarkedControlLink);export{MtzMarkedControlLink};