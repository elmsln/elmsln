import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../../../@polymer/paper-button/paper-button.js";import"../../../@polymer/iron-collapse/iron-collapse.js";/**
`lrnsys-collapselist-item`


* @demo demo/index.html
*/class LrnsysCollapselistItem extends PolymerElement{static get template(){return html`
      <style>
        :host {
          display: block;
    ...
    `}static get tag(){return"lrnsys-collapselist-item"}static get properties(){return{/**
   ...
   */collapseToggle(e){this.$.collapse.toggle()}}window.customElements.define(LrnsysCollapselistItem.tag,LrnsysCollapselistItem);export{LrnsysCollapselistItem};