 ...
 */class LrnAside extends PolymerElement{constructor(){super();import("../lrndesign-panelcard/lrndesign-panelcard.js");afterNextRender(this,function(){this.HAXWiring=new HAXWiring;this.HAXWiring.setup(LrnAside.haxProperties,LrnAside.tag,this)})}static get template(){return html`
      <style>
        :host {
          display: flex;
          padding: 8px;
