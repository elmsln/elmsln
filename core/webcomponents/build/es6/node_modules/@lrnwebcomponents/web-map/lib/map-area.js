import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../@polymer/polymer/lib/utils/render-status.js";import{dom}from"../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"./map-styles.js";/* styles scoped to inside a custom element must be in a style module */class MapArea extends PolymerElement{static get template(){return html`
...
var title=L.SVG.create("title"),titleText=document.createTextNode(this.alt);dom(title).appendChild(titleText);dom(this._feature._path).appendChild(title)}if(this.href){// conditionally act on click on an area link.  If no link it should be an
