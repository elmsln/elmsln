import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../../simple-colors/simple-colors.js";import"./hax-shared-styles.js";/**
 * `hax-source`
 ...
 */class HaxAppSearchResult extends PolymerElement{constructor(){super();import("../../../@polymer/iron-image/iron-image.js");import("../../../@polymer/paper-button/paper-button.js");import("../../../@polymer/paper-styles/paper-styles.js")}static get template(){return html`
    ...
    `}static get tag(){return"hax-app-search-result"}static get properties(){return{/**
       * Preview object from hax-app originally.
       */resultData:{type:Object}}}/**
   * Handle media item selected.
   */_itemSelected(e){var map=this.resultData.map,gizmoType=this.resultData.type;// sanity check as well as guessing based on type if we absolutely have to
if((null===gizmoType||""===gizmoType)&&typeof map.source!==typeof void 0){gizmoType=window.HaxStore.guessGizmoType(map.source)}let haxElements=window.HaxStore.guessGizmo(gizmoType,map);// see if we got anything
...
window.HaxStore.instance.haxAppPicker.presentOptions(haxElements,gizmoType,"How would you like to display this "+gizmoType+"?","gizmo")}}else{window.HaxStore.toast("Sorry, I don't know how to handle that link yet.")}}}window.customElements.define(HaxAppSearchResult.tag,HaxAppSearchResult);export{HaxAppSearchResult};