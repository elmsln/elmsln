 ...
 */class HaxStaxBrowserItem extends PolymerElement{constructor(){super();import("../../../@polymer/iron-image/iron-image.js");import("../../../@polymer/paper-button/paper-button.js");import("../../../@polymer/paper-card/paper-card.js")}static get template(){return html`
   ...
   */_fireEvent(e){this.dispatchEvent(new CustomEvent("hax-insert-content-array",{bubbles:!0,cancelable:!0,composed:!0,detail:this.stax}));window.HaxStore.instance.haxStaxPicker.close()}}window.customElements.define(HaxStaxBrowserItem.tag,HaxStaxBrowserItem);export{HaxStaxBrowserItem};