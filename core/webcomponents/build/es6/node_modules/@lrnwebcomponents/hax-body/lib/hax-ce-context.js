import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{dom}from"../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../simple-colors/lib/simple-colors-picker.js";import"./hax-shared-styles.js";/**
 * `hax-ce-context`
 ...
 */class HaxCeContext extends PolymerElement{constructor(){super();import("./hax-context-item.js");import("./hax-toolbar.js")}static get template(){return html`
...
let slot=dom(this);while(null!==slot.firstChild){slot.removeChild(slot.firstChild)}let settings=newValue.settings.quick,configure=newValue.settings.configure,advanced=newValue.settings.advanced;// support things that could technically have no configuration
...
if(typeof setting.property!==typeof void 0){item.propertyToBind=setting.property}else if(typeof setting.attribute!==typeof void 0){item.propertyToBind=setting.attribute}else{item.slotToBind=setting.slot}slot.appendChild(item)}}}}window.customElements.define(HaxCeContext.tag,HaxCeContext);export{HaxCeContext};