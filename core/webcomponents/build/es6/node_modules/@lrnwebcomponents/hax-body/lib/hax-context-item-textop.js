import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../../../@polymer/iron-a11y-keys/iron-a11y-keys.js";/**
 ...
 */class HaxContextItemTextop extends PolymerElement{constructor(){super();import("./hax-toolbar-item.js");import("../../../@polymer/iron-icons/iron-icons.js");import("../../../@polymer/iron-icons/editor-icons.js");import("../../../@polymer/iron-icons/device-icons.js");import("../../../@polymer/iron-icons/hardware-icons.js");import("../../../@polymer/iron-icons/social-icons.js");import("../../../@polymer/iron-icons/av-icons.js");import("../../../@polymer/iron-icons/image-icons.js");import("../../../@polymer/iron-icons/maps-icons.js");import("../../../@polymer/neon-animation/neon-animation.js")}static get template(){return html`
    ...
    `}static get tag(){return"hax-context-item-textop"}static get properties(){return{/**
   ...
   * attached life cycle
   */connectedCallback(){super.connectedCallback();// bind keyboard to button press
this.target=this.shadowRoot.querySelector("#button")}/**
   * Fire an event that includes the eventName of what was just pressed.
   */_fireEvent(e){this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,cancelable:!0,composed:!0,detail:{target:this,eventName:this.eventName}}))}}window.customElements.define(HaxContextItemTextop.tag,HaxContextItemTextop);export{HaxContextItemTextop};