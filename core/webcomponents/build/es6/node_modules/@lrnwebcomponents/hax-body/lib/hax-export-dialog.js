import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../@polymer/polymer/lib/utils/render-status.js";import{MtzFileDownloadBehaviors}from"../../dl-behavior/dl-behavior.js";import"./hax-shared-styles.js";/**
 * `hax-export-dialog`
 * `Export dialog with all export options and settings provided.`
 */class HaxExportDialog extends MtzFileDownloadBehaviors(PolymerElement){static get template(){return html`
...
this.dispatchEvent(new CustomEvent("hax-register-export",{bubbles:!0,cancelable:!0,composed:!0,detail:this}));afterNextRender(this,function(){// add event listeners
...
content=`
   ...
   * Toggle ourselves.
   */toggleDialog(){if(this.shadowRoot.querySelector("#dialog").opened){this.close()}else{this.shadowRoot.querySelector("#textarea").editorValue=this.contentToFile(!1);window.HaxStore.instance.closeAllDrawers(this)}}constructor(){super();import("../../../@polymer/paper-dialog/paper-dialog.js")}/**
   * open the dialog
   */open(){import("../../../@polymer/iron-icon/iron-icon.js");import("../../../@polymer/iron-icons/iron-icons.js");import("../../../@polymer/paper-input/paper-input.js");import("../../../@polymer/paper-button/paper-button.js");import("../../code-editor/code-editor.js");import("../../hexagon-loader/hexagon-loader.js");this.shadowRoot.querySelector("#dialog").open();this.shadowRoot.querySelector("#buttons").style.display="none";this.shadowRoot.querySelector("#loading").setAttribute("loading","loading");this.shadowRoot.querySelector("#wrapper").appendChild(this.shadowRoot.querySelector("#textarea"));// silly but we need the code editor to figure itself out real quick as to sizing
setTimeout(()=>{this.shadowRoot.querySelector("#loading").removeAttribute("loading");this.shadowRoot.querySelector("#buttons").style.display="unset"},800)}/**
   * close the dialog
   */close(){this.shadowRoot.querySelector("#dialog").close()}}window.customElements.define(HaxExportDialog.tag,HaxExportDialog);export{HaxExportDialog};