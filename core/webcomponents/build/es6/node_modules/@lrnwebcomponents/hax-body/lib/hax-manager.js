import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../@polymer/polymer/lib/utils/render-status.js";import{dom}from"../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../@polymer/paper-styles/paper-styles.js";import"../../simple-colors/simple-colors.js";import"./hax-shared-styles.js";import"../../../@polymer/iron-pages/iron-pages.js";/**
 * `hax-manager`
 ...
 */class HaxManager extends PolymerElement{constructor(){super();import("../../../@polymer/iron-icons/iron-icons.js");import("../../../@polymer/iron-icon/iron-icon.js");import("../../../@polymer/paper-input/paper-input.js");import("../../../@polymer/paper-button/paper-button.js");import("../../../@polymer/paper-icon-button/paper-icon-button.js");import("../../../@vaadin/vaadin-upload/vaadin-upload.js");import("./hax-preview.js");import("./hax-app-browser.js");import("./hax-gizmo-browser.js");import("../../../@polymer/app-layout/app-drawer/app-drawer.js")}static get template(){return html`
   ...
   * life cycle
   */connectedCallback(){super.connectedCallback();// send an event that this is the manager
this.dispatchEvent(new CustomEvent("hax-register-manager",{bubbles:!0,cancelable:!0,composed:!0,detail:this}));afterNextRender(this,function(){// add event listeners
...
document.body.addEventListener("place-holder-file-drop",this._placeHolderFileDrop.bind(this));this.shadowRoot.querySelector("#dialog").addEventListener("iron-overlay-canceled",this.close.bind(this));this.shadowRoot.querySelector("#dialog").addEventListener("iron-overlay-closed",this.close.bind(this));this.shadowRoot.querySelector("#closedialog").addEventListener("tap",this.close.bind(this));this.shadowRoot.querySelector("#newassetconfigure").addEventListener("tap",this.newAssetConfigure.bind(this));this.shadowRoot.querySelector("#fileupload").addEventListener("upload-before",this._fileAboutToUpload.bind(this));this.shadowRoot.querySelector("#fileupload").addEventListener("upload-response",this._fileUploadResponse.bind(this))})}/**
   * Detached life cycle
   */disconnectedCallback(){document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));document.body.removeEventListener("hax-app-picker-selection",this._haxAppPickerSelection.bind(this));document.body.removeEventListener("place-holder-file-drop",this._placeHolderFileDrop.bind(this));this.shadowRoot.querySelector("#dialog").removeEventListener("iron-overlay-canceled",this.close.bind(this));this.shadowRoot.querySelector("#dialog").removeEventListener("iron-overlay-closed",this.close.bind(this));this.shadowRoot.querySelector("#closedialog").removeEventListener("tap",this.close.bind(this));this.shadowRoot.querySelector("#newassetconfigure").removeEventListener("tap",this.newAssetConfigure.bind(this));this.shadowRoot.querySelector("#fileupload").removeEventListener("upload-before",this._fileAboutToUpload.bind(this));this.shadowRoot.querySelector("#fileupload").removeEventListener("upload-response",this._fileUploadResponse.bind(this));super.disconnectedCallback()}/**
   * Toggle panel size
...
this.close()}/**
   ...
   */close(e){var normalizedEvent=dom(e),local=normalizedEvent.localTarget;if(typeof e===typeof void 0||local===this.shadowRoot.querySelector("#dialog")||local===this.shadowRoot.querySelector("#closedialog")){// reset the active element which will force this to reset the manager
...
window.HaxStore.instance.haxAppPicker.presentOptions(haxElements,type,"Pick how to present the "+type,"gizmo")}}else{window.HaxStore.toast("Sorry, HAX doesn't know how to handle that type of link yet.")}}/**
   ...
   */_resolveObjectPath(path,obj){return path.split(".").reduce(function(prev,curr){return prev?prev[curr]:null},obj||self)}}window.customElements.define(HaxManager.tag,HaxManager);export{HaxManager};