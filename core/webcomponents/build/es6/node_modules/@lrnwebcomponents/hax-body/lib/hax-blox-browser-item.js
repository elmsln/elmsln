import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../@polymer/polymer/lib/utils/render-status.js";import"./hax-shared-styles.js";/**
 * `hax-blox-browser-item`
 * `A button on the hax-gizmo-browser app display`
 */class HaxBloxBrowserItem extends PolymerElement{constructor(){super();import("../../../@polymer/paper-button/paper-button.js");import("../../../@polymer/paper-card/paper-card.js");import("../../../@polymer/iron-icon/iron-icon.js")}static get template(){return html`
...
let blox={tag:"grid-plate",properties:{layout:this.layout},content:content};this.dispatchEvent(new CustomEvent("hax-insert-content",{bubbles:!0,cancelable:!0,composed:!0,detail:blox}));window.HaxStore.instance.haxBloxPicker.close()}}window.customElements.define(HaxBloxBrowserItem.tag,HaxBloxBrowserItem);export{HaxBloxBrowserItem};