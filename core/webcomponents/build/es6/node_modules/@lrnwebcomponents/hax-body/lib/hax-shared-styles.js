import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";const styleElement=document.createElement("dom-module");styleElement.innerHTML=`<template>
  <style>
  :host, :host * ::slotted(*) {
    --hax-color-bg: #ffffff;
