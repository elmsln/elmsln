 ...
 */class HaxAppBrowser extends PolymerElement{constructor(){super();import("../../../@polymer/paper-input/paper-input.js");import("../../../@polymer/paper-item/paper-item.js");import("../../dropdown-select/dropdown-select.js");import("./hax-app-browser-item.js");import("./hax-app-search.js")}static get template(){return html`
      ...
      ></hax-app-search>
      <slot></slot>
    `}static get tag(){return"hax-app-browser"}static get properties(){return{/**
       * Search term
       */search:{type:String},/**
       ...
       */hasActive:{reflectToAttribute:!0,value:!1,type:Boolean}}}/**
   * life cycle
   ...
   * Detached life cycle
   */disconnectedCallback(){document.body.removeEventListener("hax-app-selected",this._appSelected.bind(this));document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));super.disconnectedCallback()}/**
   * App has been selected.
   */_appSelected(e){// item bubbled up
if(typeof e.detail!==typeof void 0){this.set("__activeApp",e.detail);this.searching=!0;window.HaxStore.write("activeApp",this.__appList[e.detail],this)}}/**
   * Active app updated, so scroll it into view
   */_activeAppChanged(newValue,oldValue){if(typeof oldValue!==typeof void 0&&null!=newValue){window.HaxStore.instance.haxManager.searching=!0;this.hasActive=!0}else{this.hasActive=!1}}/**
   * Store updated, sync.
   ...
   * Reset this browser.
   */resetBrowser(){microTask.run(()=>{this.searching=!1;this.set("__appList",window.HaxStore.instance.appList);if(this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist")){this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist").filtered=this.__appList}this.shadowRoot.querySelector("#inputfilter").value="";this.shadowRoot.querySelector("#filtertype").value="details.title";this.shadowRoot.querySelector("#filter").value="";this.shadowRoot.querySelector("#filter").filter();this.shadowRoot.querySelector("#filter").where="details.title";this.shadowRoot.querySelector("#filter").like="";setTimeout(()=>{if(this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist")){this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist").dispatchEvent(new CustomEvent("iron-resize",{bubbles:!0,cancelable:!0,composed:!0,detail:!0}));window.dispatchEvent(new Event("resize"))}},100)})}}window.customElements.define(HaxAppBrowser.tag,HaxAppBrowser);export{HaxAppBrowser};