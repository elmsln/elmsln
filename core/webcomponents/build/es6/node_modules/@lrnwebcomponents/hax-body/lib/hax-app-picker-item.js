...
*/class HaxAppPickerItem extends PolymerElement{constructor(){super();import("../../../@polymer/iron-icon/iron-icon.js");import("../../../@polymer/paper-button/paper-button.js")}static get template(){return html`
    ...
    `}connectedCallback(){super.connectedCallback();afterNextRender(this,function(){this.addEventListener("mousedown",this.tapEventOn.bind(this));this.addEventListener("mouseover",this.tapEventOn.bind(this));this.addEventListener("mouseout",this.tapEventOff.bind(this));this.addEventListener("focusin",this.tapEventOn.bind(this));this.addEventListener("focusout",this.tapEventOff.bind(this))})}disconnectedCallback(){this.removeEventListener("mousedown",this.tapEventOn.bind(this));this.removeEventListener("mouseover",this.tapEventOn.bind(this));this.removeEventListener("mouseout",this.tapEventOff.bind(this));this.removeEventListener("focusin",this.tapEventOn.bind(this));this.removeEventListener("focusout",this.tapEventOff.bind(this));super.disconnectedCallback()}static get tag(){return"hax-app-picker-item"}static get properties(){return{/**
       ...
       */elevation:{type:Number,value:1,reflectToAttribute:!0}}}_getHexColor(color){let name=color.replace("-text",""),tmp=new SimpleColors;if(tmp.colors[name]){return tmp.colors[name][6]}return"#000000"}/**
   * special handling for taps on the thing
   */tapEventOn(e){this.elevation=2}/**
   * Hover off stop showing the deeper shadow.
   */tapEventOff(e){this.elevation=1}}window.customElements.define(HaxAppPickerItem.tag,HaxAppPickerItem);export{HaxAppPickerItem};