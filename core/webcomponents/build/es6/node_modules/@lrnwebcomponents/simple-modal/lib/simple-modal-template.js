 ...
 */import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../simple-modal.js";/**
 ...
 */class SimpleModalTemplate extends PolymerElement{/* REQUIRED FOR TOOLING DO NOT TOUCH */ /**
...
static get template(){return html`
   ...
   */associateEvents(target,evt="tap",bubbles=!0,cancelable=!0){target.addEventListener(evt,e=>{this.openModal(target,bubbles,cancelable)});return this.modal}/**
   ...
   * @param {boolean} whether the event bubbles (default is true)
   * @param {boolean} whether the event can be canceled (default is true)
   */openModal(target,bubbles=!0,cancelable=!0){const styles=getComputedStyle(this),evt=new CustomEvent("simple-modal-show",{bubbles:bubbles,cancelable:cancelable,composed:!0,detail:{title:null!==this.title?this.title:!1,elements:{header:this._getSlot("header"),content:this._getSlot("content"),buttons:this._getSlot("buttons")},invokedBy:target}});["--simple-modal-width","--simple-modal-height","--simple-modal-min-width","--simple-modal-min-height","--simple-modal-max-width","--simple-modal-max-height","--simple-modal-titlebar-color","--simple-modal-titlebar-background","--simple-modal-header-color","--simple-modal-header-background","--simple-modal-content-container-color","--simple-modal-content-container-background","--simple-modal-buttons-color","--simple-modal-buttons-background","--simple-modal-button-color","--simple-modal-button-background"].forEach(prop=>{this.modal.style.setProperty(prop,styles.getPropertyValue(prop))});window.dispatchEvent(evt)}/**
   ...
   */_getSlot(slotName){let slot=this.querySelector("[slot=\""+slotName+"\"]");return null!==slot?slot.cloneNode(!0):!1}}window.customElements.define(SimpleModalTemplate.tag,SimpleModalTemplate);export{SimpleModalTemplate};