...
static get properties(){return{/**
   ...
   */invokedBy:{name:"invokedBy",type:Object}}}constructor(){super();import("../../@polymer/paper-dialog-scrollable/paper-dialog-scrollable.js");import("../../@polymer/paper-button/paper-button.js");import("../../@polymer/iron-icons/iron-icons.js");import("../../@polymer/iron-icon/iron-icon.js");import("../../@polymer/neon-animation/animations/scale-up-animation.js");import("../../@polymer/neon-animation/animations/fade-out-animation.js")}/**
...
while(null!==dom(this).firstChild){dom(this).removeChild(dom(this).firstChild)}setTimeout(()=>{this.show(e.detail.title,e.detail.elements,e.detail.invokedBy,e.detail.id,e.detail.modalClass,e.detail.styles,e.detail.clone)},100)}else{this.show(e.detail.title,e.detail.elements,e.detail.invokedBy,e.detail.id,e.detail.modalClass,e.detail.styles,e.detail.clone)}}/**
