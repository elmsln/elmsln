import{dom}from"../../@polymer/polymer/lib/legacy/polymer.dom.js";export const MtzFileDownloadBehaviors=function(SuperClass){return class extends SuperClass{static get properties(){if(super.properties){return Object.assign({fileTypes:{type:Object,value(){return{CSV:"text/csv",JSON:"text/json",PDF:"application/pdf",TXT:"text/plain"}}}},super.properties)}else{return{fileTypes:{type:Object,value(){return{CSV:"text/csv",JSON:"text/json",PDF:"application/pdf",TXT:"text/plain"}}}}}}/**
...
const link=document.createElement("a");link.href=(window.URL||window.webkitURL).createObjectURL(blob);link.download=filename;link.target=newTab?"_blank":"_self";dom(this.root).appendChild(link);link.click();dom(this.root).removeChild(link)}}/**
