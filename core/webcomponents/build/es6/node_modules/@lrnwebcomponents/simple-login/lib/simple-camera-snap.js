import"./simple-login-avatar.js";import"./simple-login-camera.js";import"../../../@polymer/paper-icon-button/paper-icon-button.js";class SimpleCameraSnap extends HTMLElement{constructor(delayRender=!1){super();import("../../../@polymer/iron-icons/iron-icons.js");import("../../../@polymer/iron-icons/image-icons.js");this.tag=SimpleCameraSnap.tag;this.template=document.createElement("template");this.attachShadow({mode:"open"});if(!delayRender){this.render()}}static get tag(){return"simple-camera-snap"}render(){this.shadowRoot.innerHTML=null;this.template.innerHTML=this.html;if(window.ShadyCSS){window.ShadyCSS.prepareTemplate(this.template,this.tag)}this.shadowRoot.appendChild(this.template.content.cloneNode(!0))}get html(){return`
    <style>
      simple-login-avatar {
        margin: 0;
        width: 205px;
