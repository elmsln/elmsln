...
*/class LrnappBook extends HAXCMSTheme(PolymerElement){static get template(){return html`
...
setTimeout(()=>{this._resetScroll()},500)}/**
   * attached life cycle
   */connectedCallback(){super.connectedCallback();afterNextRender(this,function(){this.$.progress.addEventListener("node-percent-milestone",this.testMilestone.bind(this));this.$.mapmenu.addEventListener("link-clicked",this._menuItemClicked.bind(this))})}/**
   * detached life cycle
...
if(this.editMode&&!newValue.page.meta.canUpdate){this.editMode=!1}}}/**
   ...
   */_toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}window.customElements.define(LrnappBook.tag,LrnappBook);export{LrnappBook};