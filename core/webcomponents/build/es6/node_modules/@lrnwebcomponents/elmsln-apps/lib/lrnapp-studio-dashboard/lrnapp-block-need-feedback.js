...
window.location.href=this.basePath+"lrnapp-studio-submission/submissions/"+active}handleResponse(e){this.$.loading.hidden=!0}_toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}window.customElements.define(LrnappBlockNeedFeedback.tag,LrnappBlockNeedFeedback);export{LrnappBlockNeedFeedback};