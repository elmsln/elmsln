import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../../@polymer/polymer/lib/utils/render-status.js";import{dom}from"../../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../../@polymer/iron-list/iron-list.js";import"../../../../@polymer/iron-pages/iron-pages.js";import"../../../../@polymer/iron-selector/iron-selector.js";import"../../../../@polymer/app-layout/app-toolbar/app-toolbar.js";import"../../../../@polymer/polymer/lib/elements/dom-repeat.js";import"../../../../@polymer/app-route/app-location.js";import"../../../../@polymer/app-route/app-route.js";import"../../../../@polymer/paper-dropdown-menu/paper-dropdown-menu.js";import"../../../../@polymer/paper-listbox/paper-listbox.js";import"../../../../@polymer/paper-item/paper-item.js";import"../../../../@polymer/paper-toast/paper-toast.js";import"../../../lrndesign-gallerycard/lrndesign-gallerycard.js";import"../../../elmsln-loading/elmsln-loading.js";import"./lrnapp-open-studio-table.js";import"./lrnapp-open-studio-projects.js";import"./lrnapp-open-studio-assignments.js";class LrnappOpenStudio extends PolymerElement{static get template(){return html`
    ...
    `}static get tag(){return"lrnapp-open-studio"}static get properties(){return{elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},/**
       ...
       */activeSubmission:{type:String,value:null,notify:!0},queryParams:{type:Object,notify:!0},_blockcycle:{type:Boolean,value:!1}}}connectedCallback(){super.connectedCallback();afterNextRender(this,function(){this.addEventListener("route-change",this._routeChange.bind(this))})}disconnectedCallback(){this.removeEventListener("route-change",this._routeChange.bind(this));super.disconnectedCallback()}static get observers(){return["_routeChanged(route, endPoint)","_deleteToast(queryParams.deletetoast)","_assignmentFilterChanged(queryParams.assignment)","_projectFilterChanged(queryParams.project)"]}// If the current route is outside the scope of our app
...
window.location.reload()}}/**
   ...
   */_routeChange(e){var details=e.detail;if(typeof details.queryParams.assignment!==typeof void 0){this.set("queryParams.assignment",details.queryParams.assignment)}if(typeof details.queryParams.project!==typeof void 0){this.set("queryParams.project",details.queryParams.project)}if(typeof details.queryParams.author!==typeof void 0){this.set("queryParams.author",details.queryParams.author)}if(typeof details.data.page!==typeof void 0){this.set("data.page",details.data.page)}}_submissionsCompute(originalSubmissions,queryParams){// if we don't have an original submissions object to work with then we need to bail
if("undefined"===typeof originalSubmissions){return[]}// define vars
const root=this;let filteredSubmissions=[];// filter the submissions by the query params
...
setTimeout(()=>{this.$.ironlist.fire("iron-resize")},200);return filteredSubmissions}/**
   * Support having a toast message because of delete or error elsewhere.
   */_deleteToast(deletetoast,old){if(typeof deletetoast!==typeof void 0){if("error"==deletetoast){this.$.toast.show("That submission on longer exists!")}else{this.$.toast.show("Submission deleted successfully!")}this.set("queryParams.deletetoast",void 0);this.notifyPath("queryParams.deletetoast")}}_assignmentFilterChanged(assignment){// if we have a assignment then we need to uncheck project
if(typeof assignment!==typeof void 0&&!this._blockcycle){this._blockcycle=!0;this.set("queryParams.project",void 0);this.notifyPath("queryParams.project");this.set("queryParams.assignment",assignment);this.notifyPath("queryParams.assignment")}else{this._blockcycle=!1}}_projectFilterChanged(project){// if we have a project then we need to uncheck assignment
if(typeof project!==typeof void 0&&!this._blockcycle){this._blockcycle=!0;this.set("queryParams.project",project);this.notifyPath("queryParams.project");this.set("queryParams.assignment",void 0);this.notifyPath("queryParams.assignment")}else{this._blockcycle=!1}}/**
...
tmp.assignments.forEach(function(element){assignments.push(element)});root.$.loading.hidden=!0;this.set("assignments",assignments);this.set("authors",authors)}_submissionsClicked(e){this.set("route.path",this.endPoint+"/submissions");this.notifyPath("route.path")}_projectsClicked(e){this.set("route.path",this.endPoint+"/projects");this.notifyPath("route.path")}_assignmentsClicked(e){this.set("route.path",this.endPoint+"/assignments");this.notifyPath("route.path")}_tableClicked(e){this.set("route.path",this.endPoint+"/table");this.notifyPath("route.path")}/**
   * Simple way to convert from object to array.
   */_toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}window.customElements.define(LrnappOpenStudio.tag,LrnappOpenStudio);export{LrnappOpenStudio};