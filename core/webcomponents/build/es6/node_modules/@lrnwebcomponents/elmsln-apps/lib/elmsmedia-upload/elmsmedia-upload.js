...
let response=JSON.parse(event.detail.xhr.response);this.uploadTitle=response.data.node.title;this.shadowRoot.querySelector("#content").innerHTML=response.data.node.nid;this.shadowRoot.querySelector("#dialog").open()}}window.customElements.define(ElmsMediaUpload.tag,ElmsMediaUpload);export{ElmsMediaUpload};