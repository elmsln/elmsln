import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import"../../../../@polymer/paper-card/paper-card.js";import"../../../../@polymer/marked-element/marked-element.js";import"../../../../@polymer/iron-image/iron-image.js";import"../../../../@polymer/polymer/lib/elements/dom-if.js";import"../../../image-inspector/image-inspector.js";import"../../../lrndesign-avatar/lrndesign-avatar.js";import"../../../word-count/word-count.js";import"../../../../@polymer/polymer/lib/elements/dom-repeat.js";import"../../../lrnsys-button/lrnsys-button.js";import"../../../lrndesign-contentblock/lrndesign-contentblock.js";import"../../../lrnsys-layout/lib/lrnsys-dialog.js";class LrnappStudioSubmissionDisplay extends PolymerElement{static get template(){return html`
      <style>
        :host {
          display: block;
        }
    ...
    `}static get tag(){return"lrnapp-studio-submission-display"}static get properties(){return{/**
       * Object that has all the details of a submission that
       * is being viewed.
       */submission:{type:Object,notify:!0},elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String}}}date(time){if(time){var parts=time.split("-");let times=time.split("T"),month=parts[2].split("T");times=times[1].split("-");return parts[1]+"/"+month[0]+" - "+times[0]}}/**
   * Simple way to convert from object to array.
   */_toArray(obj){if("object"===typeof obj&&null!==obj){return Object.keys(obj).map(function(key){return obj[key]})}return[]}/**
   * See if this is a GIF, if it is then report back so we
   * know which player to display.
   */_isGif(url){if(-1!=url.indexOf(".gif")){return!0}return!1}}window.customElements.define(LrnappStudioSubmissionDisplay.tag,LrnappStudioSubmissionDisplay);export{LrnappStudioSubmissionDisplay};