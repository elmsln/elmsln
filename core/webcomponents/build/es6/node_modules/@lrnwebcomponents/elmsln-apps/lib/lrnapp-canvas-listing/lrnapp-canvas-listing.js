import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid.js";import"../../../../@polymer/polymer/lib/elements/dom-repeat.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid.js";import"../../../../@polymer/polymer/lib/elements/dom-if.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-column-group.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-filter.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-sorter.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-selection-column.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../../@polymer/iron-image/iron-image.js";import"../../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../lrnsys-layout/lib/lrnsys-dialog.js";import"../../../elmsln-loading/elmsln-loading.js";import"../../../lrndesign-avatar/lrndesign-avatar.js";class LrnappCanvasListing extends PolymerElement{static get template(){return html`
    ...
    `}static get tag(){return"lrnapp-canvas-listing"}static get properties(){return{elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},elmslnCourses:{type:Array,notify:!0},canvasCourses:{type:Array,notify:!0},roster:{type:Array,notify:!0,value:!1},queryResponse:{type:Array,notify:!0},sourcePath:{type:String,notify:!0},activeCourse:{type:String,notify:!0,reflectToAttribute:!0}}}/**
   ...
   */collapseToggle(e){e.target.nextElementSibling.toggle()}/**
   * Trigger the dialog box to opened and kick off request for data.
   */_triggerDialog(e){this.shadowRoot.querySelector("#details-dialog").toggleDialog();this.roster=!1;this.activeCourse=this.canvasCourses[e.target.id];this.shadowRoot.querySelector("#request").params.sis_course_id=this.activeCourse.sis_course_id;this.shadowRoot.querySelector("#request").generateRequest();this.shadowRoot.querySelector("#loadingContent").style.display="none"}handleResponse(){this.elmslnCourses=this.queryResponse.data.elmslnCourses;this.canvasCourses=this.queryResponse.data.canvasCourses;this.$.loading.hidden=!0}handleRosterResponse(){this.roster=this.queryResponse.data;this.shadowRoot.querySelector("#loadingContent").style.display="block"}}window.customElements.define(LrnappCanvasListing.tag,LrnappCanvasListing);export{LrnappCanvasListing};