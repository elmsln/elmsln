import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import{dom}from"../../../../@polymer/polymer/lib/legacy/polymer.dom.js";import{microTask}from"../../../../@polymer/polymer/lib/utils/async.js";import"../../../../@polymer/iron-icons/iron-icons.js";import"../../../../@polymer/iron-icons/hardware-icons.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../../@polymer/paper-icon-button/paper-icon-button.js";import"../../../../@polymer/paper-styles/color.js";import"../../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../../@polymer/app-route/app-location.js";import"../../../../@polymer/app-route/app-route.js";import"../../../grid-plate/grid-plate.js";import"../../../responsive-grid/lib/responsive-grid-row.js";import"../../../responsive-grid/lib/responsive-grid-col.js";import"../../../materializecss-styles/materializecss-styles.js";import{afterNextRender}from"../../../../@polymer/polymer/lib/utils/render-status.js";/**
 * `lrnapp-book`
 * A LRN element
 *
 ...
 */class MoocContent extends PolymerElement{static get template(){return html`
   ...
   */_modalTap(e){var normalizedEvent=dom(e),local=normalizedEvent.localTarget;// verify that it is a buttonß
...
if(typeof this.outlineData.data===("undefined"===typeof void 0?"undefined":typeof void 0)){this.$.fulloutlinepath.generateRequest()}microTask.run(()=>{window.dispatchEvent(new Event("resize"))})}}}/**
   * Callback to push the data into the page.
   */handleOutlineResponse(e){// handle the HTML we just got
var data=this.outlineData.data;if(("undefined"===typeof data?"undefined":typeof data)!==("undefined"===typeof void 0?"undefined":typeof void 0)){this.$.outlinemodal.innerHTML=data.outline;this.aliases=data.aliases}}connectedCallback(){super.connectedCallback();afterNextRender(this,function(){if(window.Drupal){window.Drupal.attachBehaviors(document,window.Drupal.settings)}})}/**
...
if(null!=this.$.hackycsspotterhates){dom(this.$.hackycontainer).innerHTML=""}// construct a new style tag and inject it overtop of what was there previously
...
dom(this.$.hackycontainer).appendChild(customStyle)}/**
   * highjack shadowDom
   */_attachDom(dom){this.appendChild(dom)}}window.customElements.define(MoocContent.tag,MoocContent);export{MoocContent};