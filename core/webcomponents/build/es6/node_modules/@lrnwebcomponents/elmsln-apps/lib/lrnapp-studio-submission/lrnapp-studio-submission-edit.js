import{html,Polymer}from"../../../../@polymer/polymer/polymer-legacy.js";import"../../../../@polymer/paper-input/paper-input.js";import"../../../lrnsys-button/lrnsys-button.js";import"./lrnapp-studio-submission-media-editoverlay.js";import"./lrnapp-studio-submission-edit-images.js";import"./lrnapp-studio-submission-edit-files.js";import"./lrnapp-studio-submission-edit-video.js";import"./lrnapp-studio-submission-edit-links.js";import"./lrnapp-studio-submission-edit-textarea.js";Polymer({_template:html`
    <style>
      :host {
        display: block;
        padding: 16px;
  ...
  `,is:"lrnapp-studio-submission-edit",properties:{submission:{type:Object,notify:!0},uploadFilesUrl:{type:String},newlink:{type:String},newvideo:{type:String},videoGenerateSourceUrl:{type:String},submission:{type:Object,notify:!0}},observers:["_bodyChanged(title)"],_publishClicked:function(){this.set("submission.attributes.state","submission_ready");this.notifyPath("submission.attributes.state");this.fire("submissionPublishClicked")},_saveDraftClicked:function(){this.set("submission.attributes.state","submission_in_progress");this.notifyPath("submission.attributes.state");this.fire("submissionSaveDraftClicked")},_deleteClicked:function(){this.fire("submissionDeleteClicked")},_toArray:function(obj){return Object.keys(obj).map(function(key){return obj[key]})}});