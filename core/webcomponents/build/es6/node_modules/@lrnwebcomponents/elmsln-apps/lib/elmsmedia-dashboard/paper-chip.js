import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import"../../../../@polymer/paper-styles/color.js";import"../../../../@polymer/paper-styles/typography.js";/**
...
@demo demo/chip.html
*/class PaperChip extends PolymerElement{static get template(){return html`
      <style>
        :host {
      ...
      <slot></slot>
    `}static get tag(){return"paper-chip"}static get properties(){return{selectable:{type:Boolean,value:!1,reflectToAttribute:!0}}}}window.customElements.define(PaperChip.tag,PaperChip);export{PaperChip};