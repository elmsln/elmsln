import{html,Polymer}from"../../../../@polymer/polymer/polymer-legacy.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../../@polymer/iron-icon/iron-icon.js";import"../../../../@polymer/iron-list/iron-list.js";import"../../../../@polymer/paper-card/paper-card.js";import"../../../../@polymer/paper-item/paper-item-shared-styles.js";import"../../../../@polymer/paper-button/paper-button.js";import"../../../lrnsys-button/lrnsys-button.js";import"../../../elmsln-loading/elmsln-loading.js";import"../../../materializecss-styles/materializecss-styles.js";Polymer({_template:html`
  ...
  `,is:"lrnapp-block-recent-project",properties:{sourcePath:{type:String,notify:!0},response:{type:Object,notify:!0},project:{type:Object,notify:!0},hasProject:{type:Boolean,notify:!0,reflectToAttribute:!0,computed:"_getHasProject(project)"}},_getHasProject:function(project){if(typeof project.id!==typeof void 0){return!0}return!1},handleResponse:function(){this.$.loading.hidden=!0;this.project=this.response.data},_toArray:function(obj){return Object.keys(obj).map(function(key){return obj[key]})}});