import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../../@polymer/polymer/lib/utils/render-status.js";import{dom}from"../../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../../@polymer/polymer/lib/elements/dom-if.js";import"../../../../@polymer/polymer/lib/elements/dom-repeat.js";import"../../../../@polymer/app-route/app-location.js";import"../../../../@polymer/app-route/app-route.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../../@polymer/paper-toggle-button/paper-toggle-button.js";import"../../../../@polymer/paper-item/paper-item.js";import"../../../../@polymer/paper-badge/paper-badge.js";import"../../../../@polymer/polymer/lib/elements/dom-if.js";import"../../../../@polymer/paper-button/paper-button.js";import"../../../../@polymer/paper-input/paper-input.js";import"../../../../@polymer/paper-icon-button/paper-icon-button.js";import"../../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-filter.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-sorter.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-column-group.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-selection-column.js";import"../../../../@polymer/polymer/lib/elements/dom-repeat.js";import"../../../elmsln-loading/elmsln-loading.js";import"../../../lrndesign-chart/lib/lrndesign-bar.js";import"../../../lrndesign-chart/lib/lrndesign-line.js";import"../../../lrndesign-chart/lib/lrndesign-pie.js";import"../../../dropdown-select/dropdown-select.js";import"../../../lrnsys-button/lrnsys-button.js";import"../../../lrndesign-avatar/lrndesign-avatar.js";import"../../../lrnsys-layout/lib/lrnsys-dialog.js";import"../lrnapp-studio-submission/lrnapp-studio-submission.js";class LrnappStudioInstructor extends PolymerElement{static get template(){return html`
...
this.studentParams.projectId=this.activeProject;this.$.studentrequest.generateRequest()}/**
   * attached life cycle
   */connectedCallback(){super.connectedCallback();afterNextRender(this,function(){// listen for focus event to have fired
...
setTimeout(()=>{this.shadowRoot.querySelector("#sorter").direction="asc"},200)}/**
   ...
   */_changeActiveItem(e){document.body.classList.add("scroll-disabled");var normalizedEvent=dom(e),local=normalizedEvent.localTarget,newstudent,newassignment;// use button id in order to move around in the grid as far as active
...
if(-1==index){index=keys.indexOf(parseInt(key))}if(-1==i&&0<index||1==i&&index<keys.length-1){return items[keys[index+i]]}else{return-1}}/**
   ...
   */_setActiveSubmission(e){var normalizedEvent=dom(e),local=normalizedEvent.localTarget;this.__rememberClick=local;var item=local.id.split("-");// find the active elements
...
this.$.nextassignment.disabled=!0;this.$.prevassignment.disabled=!0;this.$.nextstudent.disabled=!0;this.$.prevstudent.disabled=!0;var normalizedEvent=dom(e),local=normalizedEvent.localTarget;this.__rememberClick=local;var item=local.id.split("-");// find the active elements
this.set("activeData.student",this.students[item[1]]);this.set("activeData.assignment",this.assignments[item[3]]);this.set("activeData.submission",this.students[item[1]].assignments[item[3]]);this.set("route.path",this.endPoint+"/submissions/"+item[item.length-1]);document.body.classList.add("scroll-disabled");this.$.dialog.toggleDialog()}/**
   * Simple way to convert from object to array.
   */_toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}window.customElements.define(LrnappStudioInstructor.tag,LrnappStudioInstructor);export{LrnappStudioInstructor};