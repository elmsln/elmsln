import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import{dom}from"../../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../../@polymer/paper-input/paper-input.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-column.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-sorter.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-filter.js";import"../../../lrnsys-button/lrnsys-button.js";import"../../../materializecss-styles/materializecss-styles.js";import"../lrnapp-studio-submission/lrnapp-studio-submission-display.js";class LrnappOpenStudioTable extends PolymerElement{static get template(){return html`
      <custom-style>
    ...
    `}static get tag(){return"lrnapp-open-studio-table"}static get properties(){return{elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},/**
       ...
       */activeSubmission:{type:String,value:null,notify:!0}}}_loadProjectRoute(e){var normalizedEvent=dom(e),local=normalizedEvent.localTarget,project=local.getAttribute("data-project-id"),author=local.getAttribute("data-author-id");// fire event w/ parts of the route to changes
...
window.location.href=this.basePath+"lrnapp-studio-submission/submissions/"+active}/**
   ...
   */_toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}window.customElements.define(LrnappOpenStudioTable.tag,LrnappOpenStudioTable);export{LrnappOpenStudioTable};