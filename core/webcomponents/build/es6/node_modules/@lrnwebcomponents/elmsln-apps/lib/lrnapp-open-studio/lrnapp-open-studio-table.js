import{html,Polymer}from"../../../../@polymer/polymer/polymer-legacy.js";import{dom}from"../../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../../@polymer/paper-input/paper-input.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-column.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-sorter.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-filter.js";import"../../../lrnsys-button/lrnsys-button.js";import"../../../materializecss-styles/materializecss-styles.js";import"../lrnapp-studio-submission/lrnapp-studio-submission-display.js";Polymer({_template:html`
  ...
  `,is:"lrnapp-open-studio-table",properties:{submissions:{type:Array,notify:!0},_numWidth:{type:String,value:"2.25em"},sourcePath:{type:String,notify:!0},basePath:{type:String,notify:!0},activeSubmission:{type:String,value:null,notify:!0}},_loadProjectRoute:function(e){var normalizedEvent=dom(e),local=normalizedEvent.localTarget,project=local.getAttribute("data-project-id"),author=local.getAttribute("data-author-id");this.fire("route-change",{data:{page:"projects"},queryParams:{author:author,project:project}})},_loadSubmissionUrl:function(e){this;var normalizedEvent=dom(e),local=normalizedEvent.localTarget,active=local.getAttribute("data-submission-id");window.location.href=this.basePath+"lrnapp-studio-submission/submissions/"+active},_handleResponse:function(){this.$.loading.hidden=!0},_toArray:function(obj){return Object.keys(obj).map(function(key){return obj[key]})}});