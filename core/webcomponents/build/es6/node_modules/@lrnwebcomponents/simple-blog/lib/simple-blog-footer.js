...
class SimpleBlogFooter extends PolymerElement {
  ...
  constructor() {
    super();
    import("../../haxcms-elements/lib/ui-components/navigation/site-menu-button.js");
  ...
  connectedCallback() {
    ...
    autorun(reaction => {
      ...
      if (typeof this.manifest.metadata !== typeof undefined && typeof this.manifest.metadata.cssVariable !== typeof undefined) {
        // json outline schema changed, allow other things to react
        // fake way of forcing an update of these items
        let ary = this.manifest.metadata.cssVariable.replace("--simple-colors-default-theme-", "").split("-");
        ary.pop();
        this.accentColor = ary.join("-"); // set this directly instead of messing w/ accentColor

        document.body.style.setProperty("--haxcms-color", this.manifest.metadata.hexCode);
      }
