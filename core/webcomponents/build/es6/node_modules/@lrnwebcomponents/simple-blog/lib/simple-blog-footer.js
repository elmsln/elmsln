import{html,Polymer}from"../../../@polymer/polymer/polymer-legacy.js";import{store}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun,toJS}from"../../../mobx/lib/mobx.module.js";import"../../haxcms-elements/lib/ui-components/navigation/site-menu-button.js";import"../../../@polymer/paper-button/paper-button.js";import"../../simple-datetime/simple-datetime.js";Polymer({_template:html`
    <style>
      :host {
        display: block;
        width: 100%;
  ...
  `,is:"simple-blog-footer",properties:{activeManifestIndex:{type:Number,observer:"_activeManifestIndexChanged"},manifest:{type:Object}},_activeManifestIndexChanged:function(newValue){if(this.manifest.items[newValue-1]){this.prevTitle=" - "+this.manifest.items[newValue-1].title;this.prevChanged=this.manifest.items[newValue-1].metadata.created}else{this.prevTitle="";this.prevChanged=""}if(this.manifest.items[newValue+1]){this.nextTitle=" - "+this.manifest.items[newValue+1].title;this.nextChanged=this.manifest.items[newValue+1].metadata.created}else{this.nextTitle="";this.nextChanged=""}},attached:function(){this.__disposer=autorun(()=>{this.manifest=toJS(store.routerManifest);if(typeof this.manifest.title!==typeof void 0){document.title=this.manifest.title}if(typeof this.manifest.metadata!==typeof void 0&&typeof this.manifest.metadata.cssVariable!==typeof void 0){let ary=this.manifest.metadata.cssVariable.replace("--simple-colors-default-theme-","").split("-");ary.pop();this.accentColor=ary.join("-");document.body.style.setProperty("--haxcms-color",this.manifest.metadata.hexCode)}});this.__disposer2=autorun(()=>{this.activeManifestIndex=toJS(store.activeManifestIndex)})},detached:function(){this.__disposer();this.__disposer2()},_backButtonTap:function(){window.history.pushState(null,null,store.location.baseUrl);window.dispatchEvent(new PopStateEvent("popstate"))}});