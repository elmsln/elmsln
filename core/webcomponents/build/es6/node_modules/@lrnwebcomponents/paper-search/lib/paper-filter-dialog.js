import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{dom}from"../../../@polymer/polymer/lib/legacy/polymer.dom.js";class PaperFilterDialog extends PolymerElement{static get tag(){return"paper-filter-dialog"}/**
...
dom(document.body).appendChild(this);// Wait until dialog is added to the DOM (required for Safari)
...
return value.name});return 0<names.length?names.join(", "):this.noValuesLabel}}window.customElements.define(PaperFilterDialog.tag,PaperFilterDialog);export{PaperFilterDialog};