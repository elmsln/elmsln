import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{pathFromUrl}from"../../../@polymer/polymer/lib/utils/resolve-url.js";/**
 * append and register the shared styles
 *
 * @polymer
 * @customElement
 * @see ../chartist.render.js
 */const styleElement=document.createElement("dom-module"),template=document.createElement("template");styleElement.appendChild(html`
  <style>
    .ct-label {
