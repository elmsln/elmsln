import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../@polymer/polymer/lib/utils/render-status.js";import"../../../@polymer/paper-menu-button/paper-menu-button.js";import"../../../@polymer/paper-button/paper-button.js";import"../../../@polymer/paper-listbox/paper-listbox.js";import"../../../@polymer/paper-tooltip/paper-tooltip.js";import"./editable-table-editor-insdel.js";import{cellBehaviors}from"./editable-table-behaviors.js";/**
...
*/class EditableTableEditorRowcol extends cellBehaviors(PolymerElement){static get template(){return html`
      <style>
        :host {
          display: block;
        }
    ...
    `}static get tag(){return"editable-table-editor-rowcol"}static get properties(){return{/**
       ...
       * Is it row or column?
       */type:{type:String,value:null}}}connectedCallback(){super.connectedCallback();afterNextRender(this,function(){this.addEventListener("insdel-tapped",this._onTap.bind(this))})}disconnectedCallback(){this.removeEventListener("insdel-tapped",this._onTap.bind(this));super.disconnectedCallback()}_onTap(e){}}window.customElements.define(EditableTableEditorRowcol.tag,EditableTableEditorRowcol);export{EditableTableEditorRowcol};