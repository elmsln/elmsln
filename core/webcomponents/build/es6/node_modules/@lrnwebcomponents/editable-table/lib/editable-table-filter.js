import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../@polymer/polymer/lib/utils/render-status.js";import"../../../@polymer/paper-button/paper-button.js";import"../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../@polymer/iron-icons/iron-icons.js";import"./editable-table-iconset.js";/**
...
*/class EditableTableFilter extends PolymerElement{static get template(){return html`
    ...
    `}static get tag(){return"editable-table-filter"}connectedCallback(){super.connectedCallback();afterNextRender(this,function(){this.addEventListener("tap",this._onFilterTapped.bind(this))})}disconnectedCallback(){this.removeEventListener("tap",this._onFilterTapped.bind(this));super.disconnectedCallback()}static get properties(){return{/**
   ...
   */_getPressed(filtered){return filtered?"true":"false"}/**
   * listen for button tap
   */_onFilterTapped(){this.dispatchEvent(new CustomEvent("toggle-filter",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}window.customElements.define(EditableTableFilter.tag,EditableTableFilter);export{EditableTableFilter};