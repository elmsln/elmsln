import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../../../@polymer/polymer/lib/utils/render-status.js";import{LrndesignGalleryBehaviors}from"./lrndesign-gallery-behaviors.js";import"./lrndesign-gallery-zoom.js";import"./lrndesign-gallery-details.js";export{LrndesignGalleryGrid};class LrndesignGalleryGrid extends LrndesignGalleryBehaviors{static get tag(){return"lrndesign-gallery-grid"}static get behaviors(){return[LrndesignGalleryBehaviors]}static get template(){return html`
    ...
    `}static get properties(){return{imageStyle:{type:String,computed:"_getImageStyle(items)",reflectToAttribute:!0}}}_handleScroll(e){this._scrollIntoView([this._getParentOffset(this),e.path[0].offsetTop])}_getImageStyle(items=[]){let img=new Image,padding=75;if(items!==void 0&&0<items.length){img.src=items[0].src;if(0<img.naturalWidth&&0<img.naturalHeight)padding=100*img.naturalHeight/img.naturalWidth}return"padding-bottom: "+padding+"%;"}}window.customElements.define(LrndesignGalleryGrid.tag,LrndesignGalleryGrid);