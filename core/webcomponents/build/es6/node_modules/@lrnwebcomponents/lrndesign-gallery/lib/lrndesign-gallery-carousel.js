 ...
 */import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{LrndesignGalleryBehaviors}from"./lrndesign-gallery-behaviors.js";import"./lrndesign-gallery-details.js";import"./lrndesign-gallery-zoom.js";export{LrndesignGalleryCarousel};/**
 ...
 */class LrndesignGalleryCarousel extends LrndesignGalleryBehaviors{/**
   ...
   */static get tag(){return"lrndesign-gallery-carousel"}//get gallery behaviors
...
static get properties(){return{/**
       ...
       */__imageStyle:{type:String,computed:"_getImageStyle(extraWide,responsiveSize)"}}}/**
   * life cycle, element is ready
   */ready(){super.ready();if(this.selected.scroll){let target=this.$.carouselitem;this._scrollIntoView([this._getParentOffset(target)]);if(!this.selected.zoomed)target.focus()}}/**
   * go to item by id, or index
   *
   * @param {o}
   */goToItem(index){let root=this;if("number"===typeof index&&0<=index&&index<root.items.length){root.selected=root.items[index]}}/**
