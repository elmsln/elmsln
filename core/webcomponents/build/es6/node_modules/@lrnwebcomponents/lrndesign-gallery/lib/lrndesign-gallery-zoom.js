...
static get properties(){return{/**
   ...
   */ready(){super.ready();this._detailsChanged();this.$.zoomtpl.associateEvents(this.$.zoombtn);if(this.scrolled){this.dispatchEvent(new CustomEvent("gallery-scroll"));if(!this.zoomed)this.$.zoombtn.focus()}if(this.zoomed){this.zoom()}}/**
   * opens the modal
