...
*/class CMSToken extends PolymerElement{static get template(){return html`
      <style>
        :host {
          display: inline;
          min-width: 112px;
...
microTask.run(()=>{let template=document.createElement("template");template.innerHTML=newValue.content;dom(this).appendChild(document.importNode(template.content,!0));this.loading=!1})}}/**
...
if(typeof this.tokenEndPoint===typeof void 0&&typeof window.cmstokenEndPoint!==typeof void 0){this.tokenEndPoint=window.cmstokenEndPoint}if(this.tokenEndPoint){this.loading=!0;microTask.run(()=>{this.$.tokenrequest.generateRequest()})}}}/**
...
this._clickInvoked=!0}/**
   ...
   */connectedCallback(){super.connectedCallback();if(typeof this.token!==typeof void 0&&null!==this.token&&""!==this.token){let slot=dom(this).getEffectiveChildNodes();// only kick off request if there's nothing in it
...
if(typeof this.tokenEndPoint===typeof void 0&&typeof window.cmstokenEndPoint!==typeof void 0){this.tokenEndPoint=window.cmstokenEndPoint}if(this.tokenEndPoint){this.loading=!0;microTask.run(()=>{this.$.tokenrequest.generateRequest()})}}}afterNextRender(this,function(){document.addEventListener("visibilitychange",this._windowVisibilityChanged.bind(this));this.HAXWiring=new HAXWiring;this.HAXWiring.setup(CMSToken.haxProperties,CMSToken.tag,this)})}/**
...
if(typeof this.tokenData!==typeof void 0){href=this.tokenData.editEndpoint;slot=this.tokenData.editText;for(var i in this.tokenData.schema){schema.properties[i]=this.tokenData.schema[i]}}schema.properties.__editThis={type:"string",component:{name:"a",properties:{id:"cmstokenidtolockonto",href:href,target:"_blank"},slot:slot}};return schema}}window.customElements.define(CMSToken.tag,CMSToken);export{CMSToken};