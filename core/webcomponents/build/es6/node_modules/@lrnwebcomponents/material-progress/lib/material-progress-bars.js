import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{mixinBehaviors}from"../../../@polymer/polymer/lib/legacy/class.js";import"./material-progress-behavior.js";class MaterialProgressBars extends mixinBehaviors([MaterialProgressBehaviorImpl],PolymerElement){static get template(){return html`
      <style>
        #barsContainer {
          overflow: hidden;
    ...
    `}static get tag(){return"material-progress-bars"}static get properties(){return{/**
       ...
       */max:{type:Number,value:100,observer:"_refresh"}}}_getWidthForBar(barValue,barValuesSum,maxBarValue,barHeight){var realMax=Math.max(barValuesSum,this.max),width=(0<realMax?Math.floor(1e4*(barValue/realMax))/100:"0")+"%",negativeMargin=barHeight/2;return"calc("+width+" + "+negativeMargin+"px"+")"}}window.customElements.define(MaterialProgressBars.tag,MaterialProgressBars);export{MaterialProgressBars};