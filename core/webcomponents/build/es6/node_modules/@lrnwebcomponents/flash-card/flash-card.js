 ...
 */class FlashCard extends SchemaBehaviors(PolymerElement){static get template(){return html`
    ...
    `}static get tag(){return"flash-card"}static get properties(){let props={/**
       * Title
       */title:{type:String}};if(super.properties){props=Object.assign(props,super.properties)}return props}constructor(){super();import("../../@polymer/paper-card/paper-card.js")}/**
