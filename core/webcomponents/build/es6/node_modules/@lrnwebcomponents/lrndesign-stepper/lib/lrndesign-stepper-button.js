...
*/class LrndesignStepperButton extends PolymerElement{static get template(){return html`
    ...
    `}static get tag(){return"lrndesign-stepper-button"}static get properties(){return{/**
       * The button title.
       ...
       */collapsible:{type:Boolean,reflectToAttribute:!0,notify:!0,value:!1},opened:{type:Boolean,value:!1}}}ready(){super.ready();setTimeout(()=>{var target=this.shadowRoot.querySelector("iron-collapse");if(this.opened){console.log("opening in stepper");target.show()}},0)}/**
   ...
   */hasCollapse(bool,test){if(bool==test){return!0}else{return!1}}}window.customElements.define(LrndesignStepperButton.tag,LrndesignStepperButton);export{LrndesignStepperButton};