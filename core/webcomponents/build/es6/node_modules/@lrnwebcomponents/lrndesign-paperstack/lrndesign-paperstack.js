import{html}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{SimpleColors}from"../simple-colors/simple-colors.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import{A11yBehaviors}from"../a11y-behaviors/a11y-behaviors.js";class LrndesignPaperstack extends(A11yBehaviors(SimpleColors)){constructor(){super(),import("../../@polymer/iron-icon/iron-icon.js"),import("../lrn-icons/lrn-icons.js"),afterNextRender(this,function(){this.HAXWiring=new HAXWiring,this.HAXWiring.setup(LrndesignPaperstack.haxProperties,LrndesignPaperstack.tag,this)})}static get template(){return html`
      <style>
        :host {
          display: block;
          font-size: 14px;
