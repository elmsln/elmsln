import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import{Router}from"../../../../@vaadin/router/dist/vaadin-router.js";import{autorun}from"../../../../mobx/lib/mobx.module.js";import{store}from"./haxcms-site-store.js";/**
 * `haxcms-site-router`
...
let options={};if(this.baseURI){options.baseUrl=this.baseURI}this.router=new Router(this,options);/**
     * Subscribe to changes in the manifest
     */this.__disposer=autorun(()=>{this._updateRouter(store.routerManifest)});window.addEventListener("vaadin-router-location-changed",this._routerLocationChanged.bind(this))}/**
   * Detached life cycle
...
store.location=e.detail.location}}window.customElements.define(HAXCMSSiteRouter.tag,HAXCMSSiteRouter);export{HAXCMSSiteRouter};