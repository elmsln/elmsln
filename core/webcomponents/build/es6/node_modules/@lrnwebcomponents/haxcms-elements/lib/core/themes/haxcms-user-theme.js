 ...
 */import{html,PolymerElement}from"../../../../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../../../../@polymer/polymer/lib/utils/render-status.js";import{stylesFromTemplate}from"../../../../../@polymer/polymer/lib/utils/style-gather.js";import{HAXCMSTheme}from"../HAXCMSThemeWiring.js";// @todo load the elements this theme needs dynamically
// we reference this but pull nothing in to get the dependency tree loaded in full
import"../../ui-components/templates/basic-template.js";import"../../../../simple-colors/simple-colors.js";/**
 * `haxcms-custom-theme`
...
static get template(){return html`
    ...
    `}templateReady(e){this.__counter++;if(e.detail.css){this._css=e.detail.css}if(e.detail.html){this._html=e.detail.html}if(2===this.__counter){let t=document.createElement("template");t.innerHTML=`
      ...
      ${this._html}`;const styles=stylesFromTemplate(t);while(this.shadowRoot.firstChild){this.shadowRoot.removeChild(this.shadowRoot.firstChild)}// add in all styles found
for(var i in styles){t.innerHTML=styles[i].outerHTML+t.innerHTML}this.__instance=this._stampTemplate(t);// now the template
this.shadowRoot.appendChild(this.__instance)}}}window.customElements.define("haxcms-user-theme",HAXCMSUserTheme);export{HAXCMSUserTheme};