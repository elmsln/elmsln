import{html,PolymerElement}from"../../../../../@polymer/polymer/polymer-element.js";import{store}from"../../core/haxcms-site-store.js";import{autorun,toJS}from"../../../../../mobx/lib/mobx.module.js";import"../../../../../@polymer/polymer/lib/elements/dom-repeat.js";import"../query/site-query.js";/**
 ...
 */class SiteRecentContentBlock extends PolymerElement{/**
   ...
   */static get tag(){return"site-recent-content-block"}constructor(){super();import("../../../../../@polymer/iron-image/iron-image.js")}// render function
...
if(this.shadowRoot.querySelector("[data-id=\""+newValue+"\"]")){el=this.shadowRoot.querySelector("[data-id=\""+newValue+"\"]")}else{let tmpItem=store.manifest.items.find(i=>i.id==newValue);// fallback, maybe there's a child of this currently active
