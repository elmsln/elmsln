 ...
 */class SiteMenu extends PolymerElement{/**
   ...
   */static get tag(){return"site-menu"}constructor(){super();import("../../../../map-menu/map-menu.js")}// render function
static get template(){return html`
   ...
   */static get properties(){return{/**
       ...
       */trackIcon:{type:String,value:""}}}connectedCallback(){super.connectedCallback();this.__disposer=autorun(()=>{this.routerManifest=Object.assign({},toJS(store.routerManifest))});// silly but delay to ensure highlighting happens
setTimeout(()=>{this.__disposer2=autorun(()=>{this.activeId=toJS(store.activeId)})},50);this.shadowRoot.querySelector("map-menu").addEventListener("active-item",this.mapMenuActiveChanged.bind(this))}disconnectedCallback(){super.disconnectedCallback();this.__disposer();if(this.__disposer2){this.__disposer2()}this.shadowRoot.querySelector("map-menu").removeEventListener("active-item",this.mapMenuActiveChanged.bind(this))}/**
...
window.localStorage.setItem("HAXCMSSystemData",JSON.stringify(userData))}}window.customElements.define(SiteMenu.tag,SiteMenu);export{SiteMenu};