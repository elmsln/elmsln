 ...
 */import{html,PolymerElement}from"../../../../../@polymer/polymer/polymer-element.js";import{store}from"../../core/haxcms-site-store.js";import{autorun,toJS}from"../../../../../mobx/lib/mobx.module.js";import"../query/site-query.js";import"../../../../../@polymer/polymer/lib/elements/dom-repeat.js";/**
 * `site-top-menu`
 ...
 */class SiteTopMenu extends PolymerElement{/**
   ...
   */static get tag(){return"site-top-menu"}constructor(){super();import("../../../../../@polymer/paper-tooltip/paper-tooltip.js");import("../../../../../@polymer/paper-button/paper-button.js")}// render function
...
this.$.indicator.classList.remove("activated")}}}connectedCallback(){super.connectedCallback();this.__disposer=autorun(()=>{this.manifest=toJS(store.manifest)});// minor timing thing to ensure store has picked active
