 ...
 */class SiteQueryMenuSlice extends PolymerElement{/**
   ...
   */_computeItems(start,end,parent,dynamicMethodology,_routerManifest,noDynamicLevel){if(_routerManifest){return store.computeItems(start,end,parent,dynamicMethodology,_routerManifest,noDynamicLevel)}}connectedCallback(){super.connectedCallback();this.__disposer=autorun(()=>{this._routerManifest=Object.assign({},toJS(store.routerManifest))});if(!this.fixedId){this.__disposer2=autorun(()=>{this.parent=toJS(store.activeId)})}}disconnectedCallback(){this.__disposer();if(!this.fixedId){this.__disposer2()}super.disconnectedCallback()}}window.customElements.define(SiteQueryMenuSlice.tag,SiteQueryMenuSlice);export{SiteQueryMenuSlice};