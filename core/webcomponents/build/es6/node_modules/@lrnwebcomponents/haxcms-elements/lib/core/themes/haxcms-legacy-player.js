...
import { encapScript, findTagsInHTML, wipeSlot } from "../../../../hax-body/lib/haxutils.js";
        ...
        if (this.manifest.metadata.dynamicElementLoader) {
          ...
          for (var i in tagsFound) {
            ...
            if (this.manifest.metadata.dynamicElementLoader[tagName] && !window.customElements.get(tagName)) {
              import(`${basePath}../../../../../${this.manifest.metadata.dynamicElementLoader[tagName]}`).then(response => {//console.log(tagName + ' dynamic import');
              }).catch(error => {
                /* Error handling */
                console.log(error);
              });
