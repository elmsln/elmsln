 ...
 */import{html,PolymerElement}from"../../../../../@polymer/polymer/polymer-element.js";import{store}from"../../core/haxcms-site-store.js";import{autorun,toJS}from"../../../../../mobx/lib/mobx.module.js";import"../query/site-query-menu-slice.js";import"../../../../../@polymer/polymer/lib/elements/dom-repeat.js";/**
 * `site-children-block`
 ...
 */class SiteChildrenBlock extends PolymerElement{/**
   ...
   */static get tag(){return"site-children-block"}constructor(){super();import("../../../../../@polymer/paper-button/paper-button.js")}// render function
...
if(this._prevEl){this._prevEl.classList.remove("active")}}}connectedCallback(){super.connectedCallback();this.__disposer=autorun(()=>{this.manifest=toJS(store.manifest)});// minor timing thing to ensure store has picked active
// needed if routes set on first paint or lifecycles miss
setTimeout(()=>{this.__disposer2=autorun(()=>{this.activeId=toJS(store.activeId)})},50)}disconnectedCallback(){super.disconnectedCallback();this.__disposer();if(this.__disposer2){this.__disposer2()}}}window.customElements.define(SiteChildrenBlock.tag,SiteChildrenBlock);export{SiteChildrenBlock};