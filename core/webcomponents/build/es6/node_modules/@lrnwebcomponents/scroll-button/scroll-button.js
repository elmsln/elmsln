 ...
 */import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import"../../@polymer/paper-icon-button/paper-icon-button.js";import"../../@polymer/paper-tooltip/paper-tooltip.js";import"../../@polymer/iron-icons/iron-icons.js";/**
 * `scroll-button`
 ...
 */class ScrollButton extends PolymerElement{// render function
...
static get properties(){return{target:{name:"target",type:"Object"},icon:{name:"icon",type:"String",value:"icons:expand-less"},label:{name:"label",type:"String",value:"Scroll to top"},position:{name:"position",type:"String",value:"top"}}}/**
   ...
   */connectedCallback(){super.connectedCallback();this.$.btn.addEventListener("tap",e=>{if(this.target){this.target.scrollIntoView({behavior:"smooth",block:"end",inline:"nearest"})}else{window.scrollTo({top:0,left:0,behavior:"smooth"})}});this.HAXWiring=new HAXWiring;this.HAXWiring.setup(ScrollButton.haxProperties,ScrollButton.tag,this)}/**
   * life cycle, element is removed from the DOM
   */disconnectedCallback(){this.$.btn.removeEventListener("tap",e=>{if(this.target){this.target.scrollIntoView({behavior:"smooth",block:"end",inline:"nearest"})}else{window.scrollTo({top:0,left:0,behavior:"smooth"})}});super.disconnectedCallback()}}window.customElements.define(ScrollButton.tag,ScrollButton);export{ScrollButton};