import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import{SchemaBehaviors}from"../schema-behaviors/schema-behaviors.js";import{SimpleColors}from"../simple-colors/simple-colors.js";import"../responsive-utility/responsive-utility.js";export{LrndesignTimeline};class LrndesignTimeline extends SimpleColors{static get template(){return html`
      <style>
        :host {
          font-size: 14px;
          font-weight: 100;
    ...
    `}static get haxProperties(){return{canScale:!1,canPosition:!1,canEditSource:!0,gizmo:{title:"Timeline",description:"A timeline of events with images and text",icon:"icons:timeline",color:"indigo",groups:["Content","Instructional","Media","Image"],handles:[{type:"image",source:"image"}],meta:{author:"LRNWebComponents"}},settings:{quick:[],configure:[{property:"title",title:"Timeline Title",description:"A title for the timeline.",inputMethod:"textfield"},{property:"accentColor",title:"Accent Color",description:"An optional accent color.",inputMethod:"colorpicker",icon:"editor:format-color-fill"},{property:"dark",title:"Dark Theme",description:"Enable Dark Theme",inputMethod:"boolean",icon:"icons:invert-colors"},{slot:"",title:"Timeline Description",description:"Optional text describing the timeline.",inputMethod:"textfield"},{property:"events",title:"Timeline Events",description:"The events in the timeline",inputMethod:"array",properties:[{property:"heading",title:"Event Heading",description:"The heading for the event.",inputMethod:"textfield",icon:"editor:title"},{property:"details",title:"Event Details",description:"The body text with details for the event.",inputMethod:"textfield",icon:"editor:title"},{property:"imagesrc",title:"Event Image",description:"The path of the image.",inputMethod:"haxupload",icon:"editor:title"},{property:"imagealt",title:"Event Image Alt Text",description:"The alt text of the image (for accessibility).",inputMethod:"alt",icon:"editor:title"}]}],advanced:[]}}}static get properties(){let props={title:{type:"String",value:null},events:{type:"Array",value:[],notify:!0},__events:{type:"Array",computed:"_updateEvents(events)",notify:!0},timelineSize:{type:"String",value:"xs",reflectToAttribute:!0}};return super.properties&&(props=Object.assign(props,super.properties)),props}static get tag(){return"lrndesign-timeline"}static get behaviors(){return[SimpleColors]}connectedCallback(){super.connectedCallback(),this.HAXWiring=new HAXWiring,this.HAXWiring.setup(LrndesignTimeline.haxProperties,LrndesignTimeline.tag,this),window.ResponsiveUtility.requestAvailability(),window.dispatchEvent(new CustomEvent("responsive-element",{detail:{element:this,attribute:"timeline-size",relativeToParent:!0,sm:600,md:900,lg:1200,xl:1600}})),this._checkScroll()}_checkScroll(){let events=this.shadowRoot.querySelectorAll(".event");events.length<1&&this.$.repeat.render(),(events=this.shadowRoot.querySelectorAll(".event")).forEach(event=>{let top=event.offsetTop,target=events[0].offsetTop+50+event.parentNode.scrollTop,bottom=event.offsetTop+event.offsetHeight;target>top&&target<bottom?event.setAttribute("selected",!0):event.removeAttribute("selected")})}_isMediaType(event,type){return!(!this._isSet(event.media)||!this._isSet(event.media.type))&&event.media.type===type}_isSet(prop){return null!=prop}_updateEvents(events){return events="string"==typeof events?JSON.parse(events):events}_onScroll(e){this._checkScroll()}}window.customElements.define(LrndesignTimeline.tag,LrndesignTimeline);