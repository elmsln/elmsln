import{html}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{SimpleColors}from"../simple-colors/simple-colors.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";class LrndesignPanelcard extends SimpleColors{constructor(){super(),import("../../@polymer/paper-card/paper-card.js"),afterNextRender(this,function(){this.HAXWiring=new HAXWiring,this.HAXWiring.setup(LrndesignPanelcard.haxProperties,LrndesignPanelcard.tag,this)})}static get template(){return html`
      <style>
        :host {
