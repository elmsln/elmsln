import{LitElement,html,css}from"../../lit-element/lit-element.js";import"../../@polymer/paper-card/paper-card.js";import"../simple-popover/simple-popover.js";class SimpleBlogCard extends LitElement{render(){return html`
<style>
:host {
  display:block;
}
...
</simple-popover>`}static get properties(){return{title:{name:"title",type:"String"},author:{name:"author",type:"String"},authorimage:{name:"authorimage",type:"String"},authorlink:{name:"authorlink",type:"String"},readtime:{name:"readtime",type:"Number"},timestamp:{name:"timestamp",type:"Number"},image:{name:"image",type:"String"},link:{name:"link",type:"String"},shadow:{name:"shadow",type:"Number"},size:{name:"size",type:"String"},placeholder:{name:"placeholder",type:"String"},alt:{name:"alt",type:"String"}}}tag(){return"simple-blog-card"}static get styles(){return[css`
        :host {
