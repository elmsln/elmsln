...
righttl.to([setonerighttwo],.1,{x:"-=10",display:"block",display:"none"}).to([setonerightthree],.3,{x:"-=10",display:"block",display:"none"}).to([setonerightfour],.3,{x:"-=10",display:"block"});this.tl=tl;this.lefttl=lefttl;this.righttl=righttl;this.animationReady=!0;this.tl.pause();this.lefttl.pause();this.righttl.pause()}}window.customElements.define(GeneCrossover2.tag,GeneCrossover2);export{GeneCrossover2};