 ...
 */class HaxorSlevin extends HAXCMSTheme(PolymerElement){// render function
...
static get properties(){return{}}/**
   ...
   */static get tag(){return"haxor-slevin"}static get properties(){return Object.assign(super.properties,{manifest:{type:Object},color:{type:String,computed:"_getColor(manifest)"},selectedPage:{type:Number,reflectToAttribute:!0,value:0}})}_getColor(manifest){if(manifest&&manifest.metadata&&manifest.metadata.hexCode){return manifest.metadata.hexCode}}constructor(){super();import("../../@polymer/paper-button/paper-button.js");import("../../@polymer/iron-image/iron-image.js");import("../haxcms-elements/lib/ui-components/active-item/site-active-title.js");import("../haxcms-elements/lib/ui-components/site/site-rss-button.js");import("../simple-blog-card/simple-blog-card.js");import("../../@polymer/app-layout/app-header/app-header.js");import("../../@polymer/app-layout/app-toolbar/app-toolbar.js");import("../social-share-link/social-share-link.js");import("../haxcms-elements/lib/ui-components/site/site-search.js");import("../haxcms-elements/lib/ui-components/layout/site-modal.js")}_showImage(image){if(image){return image}if(this.image){return this.image}return!1}/**
...
if(store.activeItem&&store.activeItem.metadata&&store.activeItem.metadata.fields&&store.activeItem.metadata.fields.images&&store.activeItem.metadata.fields.images[0]&&store.activeItem.metadata.fields.images[0].src){this.activeImage=store.activeItem.metadata.fields.images[0].src}this.__disposer.push(reaction)})}/**
   ...
   */_goBack(e){window.history.pushState(null,null,store.location.baseUrl);window.dispatchEvent(new PopStateEvent("popstate"));// should help account for starting on a page where popstate isn't set
// and also generate data model mirroring
window.scrollTo({top:0,left:0});const evt=new CustomEvent("json-outline-schema-active-item-changed",{bubbles:!0,cancelable:!0,detail:{}});this.dispatchEvent(evt);this.selectedPage=0}}window.customElements.define(HaxorSlevin.tag,HaxorSlevin);export{HaxorSlevin};