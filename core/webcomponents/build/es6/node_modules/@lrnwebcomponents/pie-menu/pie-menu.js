import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{dom}from"../../@polymer/polymer/lib/legacy/polymer.dom.js";class PieMenu extends PolymerElement{constructor(){super(),import("../../@polymer/iron-icons/iron-icons.js")}static get template(){return html`
      <style>
        :host,
        :host > div {
          width: 200px;
    ...
    `}static get tag(){return"pie-menu"}static get properties(){return{hideLabelText:{type:String,value:"false"},centerLabel:{type:String,value:"Home"},topLabel:{type:String,value:"Option 1"},leftLabel:{type:String,value:"Option 2"},bottomLabel:{type:String,value:"Option 3"},rightLabel:{type:String,value:"Option 4"},centerIcon:{type:String,value:"icons:check-box-outline-blank"},topIcon:{type:String,value:"icons:check-box-outline-blank"},leftIcon:{type:String,value:"icons:check-box-outline-blank"},bottomIcon:{type:String,value:"icons:check-box-outline-blank"},rightIcon:{type:String,value:"icons:check-box-outline-blank"}}}ready(){super.ready();for(var buttons=this.querySelectorAll('[role="button"][data-button]'),i=0;i<buttons.length;i++)this._addListenerAddState(this,buttons[i],"mouseover","hover"),this._addListenerAddState(this,buttons[i],"focus","focus"),this._addListenerRemoveState(this,buttons[i],"mouseout","hover"),this._addListenerRemoveState(this,buttons[i],"blur","focus")}_addListenerAddState(menu,button,action,state){button.addEventListener(action,e=>{for(var elements=menu._getButtonElements(menu,button),i=0;i<elements.length;i++)elements[i].classList.add(state)})}_addListenerRemoveState(menu,button,action,state){button.addEventListener(action,e=>{for(var elements=menu._getButtonElements(menu,button),i=0;i<elements.length;i++)elements[i].classList.remove(state)})}_getButtonElements(menu,button){return menu.querySelectorAll('[data-button="'+button.getAttribute("data-button")+'"]')}_itemTapped(e){var localLink=dom(e).localTarget;localLink.hasAttribute("role")&&"button"!==localLink.getAttribute("role")||(localLink=localLink.parentNode),this.dispatchEvent(new CustomEvent("pie-menu-selection",{bubbles:!0,cancelable:!0,composed:!0,detail:{option:localLink}}))}}window.customElements.define(PieMenu.tag,PieMenu);export{PieMenu};