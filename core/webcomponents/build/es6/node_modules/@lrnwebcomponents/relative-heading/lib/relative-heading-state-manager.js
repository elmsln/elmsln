 ...
 */import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";// register globally so we can make sure there is only one
 ...
 * @customElement
 * @polymer
 */class RelativeHeadingStateManager extends PolymerElement{/* REQUIRED FOR TOOLING DO NOT TOUCH */ /**
...
if(!window.RelativeHeadingStateManager.instance){window.RelativeHeadingStateManager.instance=this;window.addEventListener("set-relative-heading",e=>{root.setRelativeHeading(e)});return this}}/**
   ...
   */disconnectedCallback(){let root=this;window.addEventListener("set-relative-heading",e=>{root.setRelativeHeading(e)})}}window.customElements.define(RelativeHeadingStateManager.tag,RelativeHeadingStateManager);export{RelativeHeadingStateManager};