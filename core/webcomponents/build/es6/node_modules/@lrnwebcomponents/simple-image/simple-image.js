import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import{SchemaBehaviors}from"../schema-behaviors/schema-behaviors.js";class SimpleImage extends(SchemaBehaviors(PolymerElement)){constructor(){super(),afterNextRender(this,function(){this.HAXWiring=new HAXWiring,this.HAXWiring.setup(SimpleImage.haxProperties,SimpleImage.tag,this)})}static get template(){return html`
      <style>
        :host {
          display: block;
        }
