 ...
 */import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{pathFromUrl}from"../../@polymer/polymer/lib/utils/resolve-url.js";import"../../@polymer/paper-progress/paper-progress.js";import"./lib/lrnsys-progress-circle.js";/**
 * `lrnsys-progress`
...
const active=this.active;this.set("active",0);this.set("active",active);this.notifyPath("active");return response}}window.customElements.define(LrnsysProgress.tag,LrnsysProgress);export{LrnsysProgress};