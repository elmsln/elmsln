 ...
 */class LrnsysProgressCircle extends PolymerElement{static get template(){return html`
    ...
    `}static get tag(){return"lrnsys-progress-circle"}static get properties(){return{/**
       ...
       */completeSound:{type:String,value:pathFromUrl(decodeURIComponent(import.meta.url))+"assets/complete.mp3",reflectToAttribute:!0},/**
       * Play sound on complete.
       */finishedSound:{type:String,value:pathFromUrl(decodeURIComponent(import.meta.url))+"assets/finished.mp3",reflectToAttribute:!0},/**
...
this._bubbleProgress={25:!1,50:!1,75:!1}}connectedCallback(){super.connectedCallback();afterNextRender(this,function(){this.addEventListener("tap",this.tapEventOn.bind(this));this.addEventListener("mouseover",this.focusOn.bind(this));this.addEventListener("mouseout",this.focusOff.bind(this));this.addEventListener("focused-changed",this.focusEvent.bind(this))})}disconnectedCallback(){this.removeEventListener("tap",this.tapEventOn.bind(this));this.removeEventListener("mouseover",this.focusOn.bind(this));this.removeEventListener("mouseout",this.focusOff.bind(this));this.removeEventListener("focused-changed",this.focusEvent.bind(this));super.disconnectedCallback()}/**
...
if(typeof oldValue!==typeof void 0&&newValue!==oldValue){this.dispatchEvent(new CustomEvent("node-status-change",{bubbles:!0,cancelable:!0,composed:!0,detail:{status:newValue}}))}}/**
   ...
   */_disableStatus(status){if("disabled"==status){return!0}return!1}}window.customElements.define(LrnsysProgressCircle.tag,LrnsysProgressCircle);export{LrnsysProgressCircle};