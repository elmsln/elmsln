 ...
 */import{html,PolymerElement}from"../../../../@polymer/polymer/polymer-element.js";import"../../../../@polymer/iron-a11y-keys/iron-a11y-keys.js";import"../../../simple-popover/simple-popover.js";import"../../../simple-fields/simple-fields.js";import"../buttons/rich-text-editor-button-styles.js";// register globally so we can make sure there is only one
 ...
 * @customElement
 * @polymer
 */class richTextEditorPrompt extends PolymerElement{/* REQUIRED FOR TOOLING DO NOT TOUCH */ // render function
...
if(!window.richTextEditorPrompt.instance){window.richTextEditorPrompt.instance=this;return this}}/**
   ...
   * Handles button tap;
   */_confirm(e){e.preventDefault();this.__button.value=this.value;this.__button.confirm();this.clearTarget()}}window.customElements.define(richTextEditorPrompt.tag,richTextEditorPrompt);export{richTextEditorPrompt};