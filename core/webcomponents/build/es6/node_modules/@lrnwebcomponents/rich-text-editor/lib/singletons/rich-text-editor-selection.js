...
class RichTextEditorSelection extends PolymerElement {
  ...
  getWrapper() {
    if (this.range) {
      ...
      return ancestor && ancestor.tagName ? ancestor : parent && ancestor.parentNode.tagName ? ancestor.parentNode : null;
    }
  }
  ...
  wrapOrGetTag(tag) {
    ...
    if (tag && (!wrapper || tag.toLowerCase() !== wrapper.tagName.toLowerCase())) {
