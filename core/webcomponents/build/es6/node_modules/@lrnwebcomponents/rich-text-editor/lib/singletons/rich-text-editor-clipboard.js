 ...
 * @customElement
 * @polymer
 */class RichTextEditorClipboard extends PolymerElement{// properties available to the custom element for data binding
static get properties(){return{}}static get template(){return html`
      <style>
        :host {
   ...
   */getRange(){let sel=window.getSelection();if(sel.getRangeAt&&sel.rangeCount){return sel.getRangeAt(0)}else if(sel){return sel}else!1}}window.customElements.define(RichTextEditorClipboard.tag,RichTextEditorClipboard);export{RichTextEditorClipboard};window.RichTextEditorClipboard={};window.RichTextEditorClipboard.instance=null;/**
