 ...
 * @customElement
 * @polymer
 */class RichTextEditorButton extends PolymerElement{// render function
...
static get properties(){return{/**
   ...
   *
   */_isToggled(selection){let toggled=null!==this.command&&this.toggles?document.queryCommandState(this.command):!1;/*,
   ...
   *
   */_getLabel(selection,command,toggles){let toggled=null!==this.command&&toggles?document.queryCommandState(command):!1,label=this._regOrToggled(this.label,this.toggledLabel,toggled);return label}/**
   * Handles button tap;
   ...
   */_labelStyle(icon,showTextLabel){return icon!==void 0&&null!==icon&&""!==icon&&!1===showTextLabel?"offscreen":null}}window.customElements.define(RichTextEditorButton.tag,RichTextEditorButton);export{RichTextEditorButton};