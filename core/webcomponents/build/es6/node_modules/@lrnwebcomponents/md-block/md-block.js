 ...
 */import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import"../../@polymer/marked-element/marked-element.js";/**
 * `md-block`
 * `a markdown block`
 *
 ...
 */class MdBlock extends PolymerElement{// render function
...
static get properties(){return{source:{name:"source",type:"String"},markdown:{name:"markdown",type:"String"}}}/**
   * Store the tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */static get tag(){return"md-block"}/**
   * life cycle, element is afixed to the DOM
   */connectedCallback(){super.connectedCallback();this.HAXWiring=new HAXWiring;this.HAXWiring.setup(MdBlock.haxProperties,MdBlock.tag,this)}/**
   * life cycle, element is removed from the DOM
   */ //disconnectedCallback() {}
}window.customElements.define(MdBlock.tag,MdBlock);export{MdBlock};