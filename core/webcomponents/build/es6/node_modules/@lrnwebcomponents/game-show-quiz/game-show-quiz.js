...
dom(this.__activeTap).appendChild(icon);// check for 2 points remaining
...
this.set("gameBoard",[]);setTimeout(()=>{this.set("gameBoard",gameBoard);this.notifyPath("gameBoard.*")},100)}}generateUUID(){return"item-sss-ss-ss".replace(/s/g,this._uuidPart)}_uuidPart(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}/**
   ...
   * Attached to the DOM
   */connectedCallback(){super.connectedCallback();window.SimpleToast.requestAvailability();afterNextRender(this,function(){this.HAXWiring=new HAXWiring;this.HAXWiring.setup(GameShowQuiz.haxProperties,GameShowQuiz.tag,this);this.shadowRoot.querySelector("#dismiss").addEventListener("tap",this.resetFocus.bind(this));this.shadowRoot.querySelector("#contentcontainer").addEventListener("tap",this._gameBoardTap.bind(this));this.shadowRoot.querySelector("#submit").addEventListener("tap",this.submitAnswer.bind(this));this.shadowRoot.querySelector("#continue").addEventListener("tap",this.continueGameTap.bind(this));this.shadowRoot.querySelector("#question").addEventListener("click",this.registerTap.bind(this))})}/**
   * detached life cycke
   */disconnectedCallback(){this.shadowRoot.querySelector("#dismiss").removeEventListener("tap",this.resetFocus.bind(this));this.shadowRoot.querySelector("#contentcontainer").removeEventListener("tap",this._gameBoardTap.bind(this));this.shadowRoot.querySelector("#submit").removeEventListener("tap",this.submitAnswer.bind(this));this.shadowRoot.querySelector("#continue").removeEventListener("tap",this.continueGameTap.bind(this));this.shadowRoot.querySelector("#question").removeEventListener("click",this.registerTap.bind(this));super.disconnectedCallback()}}window.customElements.define(GameShowQuiz.tag,GameShowQuiz);export{GameShowQuiz};