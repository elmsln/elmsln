 ...
 */class A11yCollapseIconButton extends PolymerElement{static get tag(){return"a11y-collapse-icon-button"}static get template(){return html`
    ...
    `}static get properties(){return{/**
       ...
       */rotated:{type:Boolean,value:!1}}}connectedCallback(){super.connectedCallback();afterNextRender(this,function(){this.$.expand.addEventListener("tap",this._onTap.bind(this))})}disconnectedCallback(){this.$.expand.removeEventListener("tap",this._onTap.bind(this));super.disconnectedCallback()}/**
   * Handle tap
   */_onTap(e){if(!this.disabled){this.dispatchEvent(new CustomEvent("a11y-collapse-tap",{bubbles:!0,composed:!0,cancelable:!0,detail:this}))}}}window.customElements.define(A11yCollapseIconButton.tag,A11yCollapseIconButton);export{A11yCollapseIconButton};