 ...
 */import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{A11yMediaBehaviors}from"./a11y-media-behaviors.js";import"./a11y-media-transcript-cue.js";export{A11yMediaTranscript};/**
 ...
 * @customElement
 * @polymer
 */class A11yMediaTranscript extends A11yMediaBehaviors{// properties available to the custom element for data binding
...
static get template(){return html`
   ...
   *
   * @param {string} the title of the media
   */print(mediaTitle){let root=this,track=root.shadowRoot.querySelector("#track[active]").cloneNode(!0),css=html`
        <style>
          a11y-media-transcript-cue {
            display: table-row;
