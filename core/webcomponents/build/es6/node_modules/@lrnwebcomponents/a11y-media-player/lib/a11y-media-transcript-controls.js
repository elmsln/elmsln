import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{A11yMediaPlayerBehaviors}from"./a11y-media-player-behaviors.js";import"../../simple-search/simple-search.js";import"./a11y-media-button.js";export{A11yMediaTranscriptControls};class A11yMediaTranscriptControls extends A11yMediaPlayerBehaviors{static get properties(){return{target:{type:Object,value:null}}}static get tag(){return"a11y-media-transcript-controls"}static get behaviors(){return[A11yMediaPlayerBehaviors]}static get template(){return html`
    ...
    `}connectedCallback(){super.connectedCallback();let root=this;root.search=root.$.simplesearch;root.dispatchEvent(new CustomEvent("searchbar-added",{detail:root.search}))}_handleScrollClick(){this.dispatchEvent(new CustomEvent("toggle-scroll",{detail:this}))}}window.customElements.define(A11yMediaTranscriptControls.tag,A11yMediaTranscriptControls);