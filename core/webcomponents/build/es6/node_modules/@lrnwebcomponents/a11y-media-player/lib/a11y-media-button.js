 ...
 * @customElement
 * @polymer
 */class A11yMediaButton extends A11yMediaBehaviors{// properties available to the custom element for data binding
...
static get template(){return html`
   ...
   */_buttonTap(){this.dispatchEvent(new CustomEvent("tap",{detail:this}))}}window.customElements.define(A11yMediaButton.tag,A11yMediaButton);