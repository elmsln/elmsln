 ...
 */import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{A11yMediaBehaviors}from"./a11y-media-behaviors.js";import"../../../@polymer/iron-a11y-keys/iron-a11y-keys.js";import"../../simple-search/lib/simple-search-content.js";export{A11yMediaTranscriptCue};/**
 ...
 * @customElement
 * @polymer
 */class A11yMediaTranscriptCue extends A11yMediaBehaviors{// properties available to the custom element for data binding
...
static get template(){return html`
   ...
   * handles tap
   */_handleTap(e){let root=this;this.dispatchEvent(new CustomEvent("cue-seek",{detail:root.cue.seek}))}}window.customElements.define(A11yMediaTranscriptCue.tag,A11yMediaTranscriptCue);