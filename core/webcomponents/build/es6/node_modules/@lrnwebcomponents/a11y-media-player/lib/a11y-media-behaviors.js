 ...
 */import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{SimpleColors}from"../../simple-colors/simple-colors.js";import"../../responsive-utility/responsive-utility.js";export{A11yMediaBehaviors};/**
...
static get properties(){return{/**
   ...
   * gets behaviors
   */static get behaviors(){return[SimpleColors,ResponsiveUtility]}/**
   ...
   * handles transcript printing
   */_handlePrinting(e){let root=this;root.dispatchEvent(new CustomEvent("printing-transcript",{detail:root}));root.$.transcript.print(root.mediaTitle)}}window.customElements.define(A11yMediaBehaviors.tag,A11yMediaBehaviors);