import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import"./lib/gitgraph.js/src/gitgraph.js";/**
 * `lrn-gitgraph`
...
orientation:root.orientation,element:root.shadowRoot.querySelector("#gitGraph")};if(""!==root.mode){config.mode=root.mode}root.config=config}}window.customElements.define(LrnGitgraph.tag,LrnGitgraph);export{LrnGitgraph};