import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../../responsive-utility/responsive-utility.js";import"./responsive-grid-col.js";import"./responsive-grid-clear.js";/**   
`responsive-grid-row`
A LRN element
...
*/class ResponsiveGridRow extends PolymerElement{static get template(){return html`
      <style>
        :host {
          display: block;
          width: 100%;
    ...
    `}static get tag(){return"responsive-grid-row"}static get properties(){return{/**
       ...
       */screen:{type:String,value:"xs",notify:!0,reflectToAttribute:!0}}}connectedCallback(){super.connectedCallback();window.ResponsiveUtility.requestAvailability();this.dispatchEvent(new CustomEvent("responsive-element",{bubbles:!0,cancelable:!0,composed:!0,detail:{element:this,attribute:"screen",relativeToParent:this.responsiveToParent}}))}}window.customElements.define(ResponsiveGridRow.tag,ResponsiveGridRow);export{ResponsiveGridRow};