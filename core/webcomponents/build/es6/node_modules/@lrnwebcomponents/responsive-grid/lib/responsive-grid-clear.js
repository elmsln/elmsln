...
*/class ResponsiveGridClear extends PolymerElement{static get template(){return html`
      <style>
        :host {
          display: none;
          clear: both;
    ...
    `}static get tag(){return"responsive-grid-clear"}static get properties(){return{/**
       ...
       */xs:{type:Boolean,value:!1}}}}window.customElements.define(ResponsiveGridClear.tag,ResponsiveGridClear);export{ResponsiveGridClear};