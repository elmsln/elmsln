...
*/class ResponsiveGridCol extends PolymerElement{static get template(){return html`
      <style>
        :host {
          position: relative;
          min-height: 1px;
    ...
    `}static get tag(){return"responsive-grid-col"}static get properties(){return{/**
       ...
       */xs:{type:Number,value:1}}}}window.customElements.define(ResponsiveGridCol.tag,ResponsiveGridCol);export{ResponsiveGridCol};