 ...
 */class TabList extends PolymerElement{constructor(){super();import("../../@polymer/paper-tabs/paper-tabs.js");import("../../@polymer/paper-tabs/paper-tab.js");import("../../@polymer/paper-button/paper-button.js");afterNextRender(this,function(){this.HAXWiring=new HAXWiring;this.HAXWiring.setup(TabList.haxProperties,TabList.tag,this)})}static get template(){return html`
      <style>
        :host {
          display: block;
          margin: 0 auto;
