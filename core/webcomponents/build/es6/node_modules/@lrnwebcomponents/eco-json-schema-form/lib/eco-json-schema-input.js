...
*/class EcoJsonSchemaInput extends mixinBehaviors([AppLocalizeBehavior],PolymerElement){static get tag(){return"eco-json-schema-input"}static get template(){return html`
      <custom-style>
        <style
          is="custom-style"
