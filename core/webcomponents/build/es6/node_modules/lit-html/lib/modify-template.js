 ...
 */ /**
 * @module shady-render
 */import{isTemplatePartActive}from"./template.js";const walkerNodeFilter=133/* NodeFilter.SHOW_{ELEMENT|COMMENT|TEXT} */;/**
 ...
 */export function insertNodeIntoTemplate(template,node,refNode=null){const{element:{content},parts}=template;// If there's no refNode, then put node at end of template.
