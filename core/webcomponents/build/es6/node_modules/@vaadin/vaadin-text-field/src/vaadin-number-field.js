...
*/import"../../../@polymer/polymer/polymer-element.js";import"../../../@polymer/polymer/lib/elements/custom-style.js";import{TextFieldElement}from"./vaadin-text-field.js";import{DomModule}from"../../../@polymer/polymer/lib/elements/dom-module.js";const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<dom-module id="vaadin-number-field-template">
  <template>
    <style>
      :host([readonly]) {
        pointer-events: none;
...
*/class NumberFieldElement extends TextFieldElement{static get is(){return"vaadin-number-field"}static get version(){return"2.3.7"}static get properties(){return{/**
...
if(this.min!==void 0||this.max!==void 0||this.step){this.invalid=!this.inputElement.checkValidity()}return super.checkValidity()}}window.customElements.define(NumberFieldElement.is,NumberFieldElement);export{NumberFieldElement};