...
*/import{afterNextRender}from"../../../@polymer/polymer/lib/utils/render-status.js";import{idlePeriod,animationFrame}from"../../../@polymer/polymer/lib/utils/async.js";import{flush}from"../../../@polymer/polymer/lib/utils/flush.js";import{PolymerIronList}from"./iron-list.js";import{Debouncer}from"../../../@polymer/polymer/lib/utils/debounce.js";/**
 * This Element is used internally by vaadin-grid.
 *
 * @private
 */class GridScrollerElement extends PolymerIronList{static get is(){return"vaadin-grid-scroller"}static get properties(){return{size:{type:Number,notify:!0},_vidxOffset:{value:0}}}static get observers(){return["_effectiveSizeChanged(_effectiveSize)"]}connectedCallback(){super.connectedCallback();this._scrollHandler()}/**
  * @protected
