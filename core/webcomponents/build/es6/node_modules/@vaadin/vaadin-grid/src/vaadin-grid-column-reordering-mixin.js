...
*/import{GestureEventListeners}from"../../../@polymer/polymer/lib/mixins/gesture-event-listeners.js";import{addListener}from"../../../@polymer/polymer/lib/utils/gestures.js";import{dom}from"../../../@polymer/polymer/lib/legacy/polymer.dom.js";import{useShadow}from"../../../@polymer/polymer/lib/utils/settings.js";/**
 * @polymerMixin
 */export const ColumnReorderingMixin=superClass=>class ColumnReorderingMixin extends GestureEventListeners(superClass){static get properties(){return{/**
