...
*/import"../../../@polymer/polymer/polymer-legacy.js";import{GridColumnElement}from"./vaadin-grid-column.js";import"../../vaadin-checkbox/src/vaadin-checkbox.js";import{html}from"../../../@polymer/polymer/lib/utils/html-tag.js";/**
 ...
 */class GridSelectionColumnElement extends GridColumnElement{static get template(){return html`
...
if(cells.value&&(path!==void 0||renderer!==void 0)){this._bodyTemplate=bodyTemplate=void 0;this.__cleanCellsOfTemplateProperties(cells.value)}if(headerCell&&(header!==void 0||headerRenderer!==void 0)){this._headerTemplate=headerTemplate=void 0;this.__cleanCellsOfTemplateProperties([headerCell])}super._pathOrHeaderChanged(path,header,headerCell,footerCell,cells,renderer,headerRenderer,bodyTemplate,headerTemplate)}__cleanCellsOfTemplateProperties(cells){cells.forEach(cell=>{cell._content.innerHTML="";delete cell._instance;delete cell._template})}_prepareHeaderTemplate(){const headerTemplate=this._prepareTemplatizer(this._findTemplate(!0)||this.$.defaultHeaderTemplate);// needed to override the dataHost correctly in case internal template is used.
