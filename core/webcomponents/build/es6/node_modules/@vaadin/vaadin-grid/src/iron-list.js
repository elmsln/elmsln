...
*/import"../../../@polymer/polymer/polymer-legacy.js";import{IronResizableBehavior}from"../../../@polymer/iron-resizable-behavior/iron-resizable-behavior.js";import{IronScrollTargetBehavior}from"../../../@polymer/iron-scroll-target-behavior/iron-scroll-target-behavior.js";import{animationFrame,idlePeriod,microTask}from"../../../@polymer/polymer/lib/utils/async.js";import{Class}from"../../../@polymer/polymer/lib/legacy/class.js";import{flush,enqueueDebouncer}from"../../../@polymer/polymer/lib/utils/flush.js";import{flush as flush$0}from"../../../@polymer/polymer/lib/legacy/polymer.dom.js";import{Debouncer}from"../../../@polymer/polymer/lib/utils/debounce.js";var IOS=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),IOS_TOUCH_SCROLLING=IOS&&8<=IOS[1],DEFAULT_PHYSICAL_COUNT=3,ANIMATION_FRAME=animationFrame,IDLE_TIME=idlePeriod,MICRO_TASK=microTask;export const PolymerIronList=Class({behaviors:[IronResizableBehavior,IronScrollTargetBehavior],/**
...
flush?flush():flush$0();var newPhysicalSize=0,oldPhysicalSize=0,prevAvgCount=this._physicalAverageCount,prevPhysicalAvg=this._physicalAverage;this._iterateItems(function(pidx,vidx){oldPhysicalSize+=this._physicalSizes[pidx];this._physicalSizes[pidx]=this._physicalItems[pidx].offsetHeight;newPhysicalSize+=this._physicalSizes[pidx];this._physicalAverageCount+=this._physicalSizes[pidx]?1:0},itemSet);if(this.grid){this._updateGridMetrics();this._physicalSize=Math.ceil(this._physicalCount/this._itemsPerRow)*this._rowHeight}else{oldPhysicalSize=1===this._itemsPerRow?oldPhysicalSize:Math.ceil(this._physicalCount/this._itemsPerRow)*this._rowHeight;this._physicalSize=this._physicalSize+newPhysicalSize-oldPhysicalSize;this._itemsPerRow=1}// Update the average if it measured something.
...
if(forceUpdate||Math.abs(this._estScrollHeight-this._scrollHeight)>=this._viewportHeight){this.$.items.style.height=this._estScrollHeight+"px";this._scrollHeight=this._estScrollHeight}},/**
   ...
   */scrollToIndex:function(idx){if("number"!==typeof idx||0>idx||idx>this.items.length-1){return}flush?flush():flush$0();// Items should have been rendered prior scrolling to an index.
