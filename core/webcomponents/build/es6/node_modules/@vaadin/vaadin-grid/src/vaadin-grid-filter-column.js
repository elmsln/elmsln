...
*/import{GridColumnElement}from"./vaadin-grid-column.js";import"./vaadin-grid-filter.js";import{html}from"../../../@polymer/polymer/lib/utils/html-tag.js";/**
 ...
 */class GridFilterColumnElement extends GridColumnElement{static get template(){return html`
...
headerTemplate.templatizer.dataHost=this;return headerTemplate}_getHeader(header,path){return header||this._generateHeader(path)}}customElements.define(GridFilterColumnElement.is,GridFilterColumnElement);export{GridFilterColumnElement};