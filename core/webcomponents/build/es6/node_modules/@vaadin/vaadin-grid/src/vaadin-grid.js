...
this._update()}}/**
   ...
   */notifyResize(){super.notifyResize()}_heightByRowsChanged(value,oldValue){if(value||oldValue){this.notifyResize()}}}customElements.define(GridElement.is,GridElement);export{GridElement};