...
*/import{GridColumnElement}from"./vaadin-grid-column.js";import"./vaadin-grid-tree-toggle.js";import{html}from"../../../@polymer/polymer/lib/utils/html-tag.js";/**
 ...
 */class GridTreeColumnElement extends GridColumnElement{static get template(){return html`
...
template.templatizer.dataHost=this;return template}__isLeafItem(item,itemHasChildrenPath){return!(item&&item[itemHasChildrenPath])}__getToggleContent(path,item){return path&&this.get(path,item)}}customElements.define(GridTreeColumnElement.is,GridTreeColumnElement);export{GridTreeColumnElement};