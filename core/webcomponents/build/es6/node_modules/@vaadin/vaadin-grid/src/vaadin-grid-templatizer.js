...
*/import{PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{templatize}from"../../../@polymer/polymer/lib/utils/templatize.js";/**
...
index=t.value.index;count=t.value.addedCount}else{return}Object.keys(this._parentPathValues||{}).forEach(keyName=>{for(var i=index;i<index+count;i++){this._templateInstances[i].set(keyName,this._parentPathValues[keyName])}})}}customElements.define(GridTemplatizer.is,GridTemplatizer);export{GridTemplatizer as Templatizer};