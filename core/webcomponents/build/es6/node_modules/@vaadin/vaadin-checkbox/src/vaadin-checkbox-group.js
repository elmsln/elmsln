 ...
 */class CheckboxGroupElement extends ThemableMixin(PolymerElement){static get template(){return html`
    <style>
      :host {
        display: inline-flex;
      }
...
this._checkboxes.forEach(checkbox=>{checkbox.checked=-1<value.indexOf(checkbox.value)});this._updatingValue=!1;this.validate()}_labelChanged(label){if(label){this.setAttribute("has-label","")}else{this.removeAttribute("has-label")}}_getErrorMessageAriaHidden(invalid,errorMessage){return(!errorMessage||!invalid).toString()}}customElements.define(CheckboxGroupElement.is,CheckboxGroupElement);export{CheckboxGroupElement};