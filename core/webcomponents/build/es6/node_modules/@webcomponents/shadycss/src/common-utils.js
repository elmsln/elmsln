...
*/"use strict";import{MIXIN_MATCH,VAR_ASSIGN}from"./common-regex.js";/**
 * @param {Element} element
 * @param {Object=} properties
 */export function updateNativeProperties(element,properties){// remove previous properties
 ...
 * @return {boolean}
 */export function detectMixin(cssText){const has=MIXIN_MATCH.test(cssText)||VAR_ASSIGN.test(cssText);// reset state of the regexes
