...
*/import"../utils/boot.js";import{PropertyEffects}from"../mixins/property-effects.js";import{OptionalMutableData}from"../mixins/mutable-data.js";import{GestureEventListeners}from"../mixins/gesture-event-listeners.js";import{strictTemplatePolicy}from"../utils/settings.js";import{wrap}from"../utils/wrap.js";/**
 * @constructor
 * @extends {HTMLElement}
 ...
 */export class DomBind extends domBindBase{static get observedAttributes(){return["mutable-data"]}constructor(){super();if(strictTemplatePolicy){throw new Error(`strictTemplatePolicy: dom-bind not allowed`)}this.root=null;this.$=null;this.__children=null}/**
   * @override
   * @return {void}
