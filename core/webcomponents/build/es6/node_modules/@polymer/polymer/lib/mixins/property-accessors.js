...
*/import"../utils/boot.js";import{dedupingMixin}from"../utils/mixin.js";import{camelToDashCase,dashToCamelCase}from"../utils/case-map.js";import{PropertiesChanged}from"./properties-changed.js";// Save map of native properties; this forms a blacklist or properties
...
outValue=value}break;case Array:try{outValue=JSON.parse(/** @type {string} */value)}catch(x){outValue=null;console.warn(`Polymer::Attributes: couldn't decode Array as JSON: ${value}`)}break;case Date:outValue=isNaN(value)?value+"":+value;outValue=new Date(outValue);break;default:outValue=super._deserializeValue(value,type);break;}return outValue}/* eslint-enable no-fallthrough */ /**
     ...
     * @protected
     * @override
     */_isPropertyPending(prop){return!!(this.__dataPending&&prop in this.__dataPending)}}return PropertyAccessors});