 ...
 */const timeOut={/**
   ...
   * @return {void}
   */cancel(handle){window.clearTimeout(handle)}};export{timeOut};/**
 ...
 */const animationFrame={/**
   ...
   * @param {number} handle Handle returned from `run` of callback to cancel
   * @return {void}
   */cancel(handle){window.cancelAnimationFrame(handle)}};export{animationFrame};/**
 ...
 */const idlePeriod={/**
   ...
   * @param {number} handle Handle returned from `run` of callback to cancel
   * @return {void}
   */cancel(handle){window.cancelIdleCallback?window.cancelIdleCallback(handle):window.clearTimeout(handle)}};export{idlePeriod};/**
 ...
 */const microTask={/**
   ...
   * @param {number} handle Handle returned from `run` of callback to cancel
   * @return {void}
   */cancel(handle){const idx=handle-microtaskLastHandle;if(0<=idx){if(!microtaskCallbacks[idx]){throw new Error("invalid async handle: "+handle)}microtaskCallbacks[idx]=null}}};export{microTask};