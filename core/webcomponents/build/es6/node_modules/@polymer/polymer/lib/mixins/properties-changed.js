...
*/import"../utils/boot.js";import{dedupingMixin}from"../utils/mixin.js";import{microTask}from"../utils/async.js";import{wrap}from"../utils/wrap.js";/** @const {!AsyncInterface} */const microtask=microTask;/**
...
old===old||value===value))}/**
     ...
     * @return {void}
     * @override
     */_valueToNodeAttribute(node,value,attribute){const str=this._serializeValue(value);if(str===void 0){node.removeAttribute(attribute)}else{if("class"===attribute||"name"===attribute||"slot"===attribute){node=/** @type {?Element} */wrap(node)}node.setAttribute(attribute,str)}}/**
