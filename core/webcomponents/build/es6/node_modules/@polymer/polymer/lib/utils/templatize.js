 ...
 */import"./boot.js";import{PropertyEffects}from"../mixins/property-effects.js";import{MutableData}from"../mixins/mutable-data.js";import{strictTemplatePolicy}from"./settings.js";import{wrap}from"./wrap.js";// Base class for HTMLTemplateElement extension that has property effects
 ...
 */export function templatize(template,owner,options){// Under strictTemplatePolicy, the templatized element must be owned
 ...
 */export function modelForElement(template,node){let model;while(node){// An element with a __templatizeInstance marks the top boundary
...
node=wrap(node).parentNode}}return null}export{TemplateInstanceBase};