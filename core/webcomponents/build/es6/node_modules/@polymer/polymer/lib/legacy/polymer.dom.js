...
*/import"../utils/boot.js";import{wrap}from"../utils/wrap.js";import"../utils/settings.js";import{FlattenedNodesObserver}from"../utils/flattened-nodes-observer.js";export{flush,enqueueDebouncer as addDebouncer}from"../utils/flush.js";/* eslint-disable no-unused-vars */import{Debouncer}from"../utils/debounce.js";// used in type annotations
/* eslint-enable no-unused-vars */const p=Element.prototype,normalizedMatchesSelector=p.matches||p.matchesSelector||p.mozMatchesSelector||p.msMatchesSelector||p.oMatchesSelector||p.webkitMatchesSelector;/**
 ...
 */export const matchesSelector=function(node,selector){return normalizedMatchesSelector.call(node,selector)};/**
 ...
 * `target` is an `Event`.
 */export class EventApi{constructor(event){this.event=event}/**
...
// in v1 Shadow DOM.
forwardReadOnlyProperties(DomApiNative.prototype,["parentNode","firstChild","lastChild","nextSibling","previousSibling","firstElementChild","lastElementChild","nextElementSibling","previousElementSibling","childNodes","children","classList"]);forwardProperties(DomApiNative.prototype,["textContent","innerHTML"])}export const DomApi=DomApiImpl;/**
 ...
 */export const dom=function(obj){obj=obj||document;if(obj instanceof DomApiImpl){return(/** @type {!DomApi} */obj)}if(obj instanceof EventApi){return(/** @type {!EventApi} */obj)}let helper=obj.__domApi;if(!helper){if(obj instanceof Event){helper=new EventApi(obj)}else{helper=new DomApiImpl(/** @type {Node} */obj)}obj.__domApi=helper}return helper};