...
*/import"./boot.js";import"./mixin.js";import"./async.js";/**
 * @summary Collapse multiple callbacks into one invocation after a timer.
 */export class Debouncer{constructor(){this._asyncModule=null;this._callback=null;this._timer=null}/**
 ...
 * @return {void}
 */export const enqueueDebouncer=function(debouncer){debouncerQueue.add(debouncer)};/**
 * Flushes any enqueued debouncers
 *
 * @return {boolean} Returns whether any debouncers were flushed
 */export const flushDebouncers=function(){const didFlush=!!debouncerQueue.size;// If new debouncers are added while flushing, Set.forEach will ensure
