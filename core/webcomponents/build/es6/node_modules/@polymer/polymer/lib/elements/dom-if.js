...
*/import{PolymerElement}from"../../polymer-element.js";import{templatize}from"../utils/templatize.js";import{Debouncer}from"../utils/debounce.js";import{enqueueDebouncer,flush}from"../utils/flush.js";import{microTask}from"../utils/async.js";import{root}from"../utils/path.js";import{wrap}from"../utils/wrap.js";/**
 ...
 */export class DomIf extends PolymerElement{// Not needed to find template; can be removed once the analyzer
...
this.__renderDebouncer=Debouncer.debounce(this.__renderDebouncer,microTask,()=>this.__render());enqueueDebouncer(this.__renderDebouncer)}/**
   ...
   * @return {void}
   */render(){flush()}__render(){if(this.if){if(!this.__ensureInstance()){// No template found yet
...
if(parent){parent=wrap(parent);for(let i=0,n;i<c$.length&&(n=c$[i]);i++){parent.removeChild(n)}}}this.__instance=null;this.__invalidProps=null}}/**
   ...
   * @protected
   * @suppress {visibility}
   */_showHideChildren(){let hidden=this.__hideTemplateChildren__||!this.if;if(this.__instance){this.__instance._showHideChildren(hidden)}}}customElements.define(DomIf.is,DomIf);