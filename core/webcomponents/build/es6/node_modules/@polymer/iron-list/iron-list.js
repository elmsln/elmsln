import"../polymer/polymer-legacy.js";import"../iron-a11y-keys-behavior/iron-a11y-keys-behavior.js";import{IronResizableBehavior}from"../iron-resizable-behavior/iron-resizable-behavior.js";import{IronScrollTargetBehavior}from"../iron-scroll-target-behavior/iron-scroll-target-behavior.js";import{OptionalMutableDataBehavior as OptionalMutableDataBehavior$0}from"../polymer/lib/legacy/mutable-data-behavior.js";import{Polymer as Polymer$0}from"../polymer/lib/legacy/polymer-fn.js";import{addDebouncer,dom,flush as flush$0}from"../polymer/lib/legacy/polymer.dom.js";import{Templatizer}from"../polymer/lib/legacy/templatizer-behavior.js";import{animationFrame,idlePeriod,microTask}from"../polymer/lib/utils/async.js";import{Debouncer}from"../polymer/lib/utils/debounce.js";import{enqueueDebouncer,flush}from"../polymer/lib/utils/flush.js";import{html}from"../polymer/lib/utils/html-tag.js";import{matches,translate}from"../polymer/lib/utils/path.js";var IOS=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),IOS_TOUCH_SCROLLING=IOS&&8<=IOS[1],DEFAULT_PHYSICAL_COUNT=3,HIDDEN_Y="-10000px",ITEM_WIDTH=0,ITEM_HEIGHT=1,SECRET_TABINDEX=-100,IS_V2=null!=flush,ANIMATION_FRAME=IS_V2?animationFrame:0,IDLE_TIME=IS_V2?idlePeriod:1,MICRO_TASK=IS_V2?microTask:2;if(!OptionalMutableDataBehavior$0){Polymer.OptionalMutableDataBehavior={}}Polymer$0({_template:html`
    <style>
      :host {
        display: block;
      }
