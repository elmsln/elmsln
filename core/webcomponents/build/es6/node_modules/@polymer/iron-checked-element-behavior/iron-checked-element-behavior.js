...
*/import"../polymer/polymer-legacy.js";import{IronFormElementBehavior}from"../iron-form-element-behavior/iron-form-element-behavior.js";import{IronValidatableBehavior}from"../iron-validatable-behavior/iron-validatable-behavior.js";/**
 ...
 */export const IronCheckedElementBehaviorImpl={properties:{/**
...
this._hasIronCheckedElementBehavior=!0},/**
   ...
   */_valueChanged:function(){if(this.value===void 0||null===this.value){this.value="on"}}};/** @polymerBehavior */export const IronCheckedElementBehavior=[IronFormElementBehavior,IronValidatableBehavior,IronCheckedElementBehaviorImpl];