...
```
*/Polymer({is:"cascaded-animation",behaviors:[NeonAnimationBehavior],/**
   * @param {{
   *   animation: string,
   *   nodes: !Array<!Element>,
...
if(abortedConfigure){return}this._effect=new GroupEffect(effects);return this._effect},complete:function(){for(var animation,index=0;animation=this._animations[index];index++){animation.complete(animation.config)}}});