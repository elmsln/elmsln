...
*/import"../polymer/polymer-legacy.js";import{IronButtonState,IronButtonStateImpl}from"../iron-behaviors/iron-button-state.js";import{IronControlState}from"../iron-behaviors/iron-control-state.js";import{PaperRippleBehavior}from"./paper-ripple-behavior.js";/** @polymerBehavior PaperButtonBehavior */export const PaperButtonBehaviorImpl={properties:{/**
...
if(this.hasRipple()&&1>this.getRipple().ripples.length){this._ripple.uiDownAction()}},/**
   ...
   *
   * @param {!KeyboardEvent} event .
   */_spaceKeyUpHandler:function(event){IronButtonStateImpl._spaceKeyUpHandler.call(this,event);if(this.hasRipple()){this._ripple.uiUpAction()}}};/** @polymerBehavior */export const PaperButtonBehavior=[IronButtonState,IronControlState,PaperRippleBehavior,PaperButtonBehaviorImpl];