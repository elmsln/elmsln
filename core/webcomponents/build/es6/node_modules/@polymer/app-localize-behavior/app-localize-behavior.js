...
*/import"../polymer/polymer-legacy.js";import"../iron-ajax/iron-ajax.js";import IntlMessageFormat from"../../intl-messageformat/src/main.js";window.IntlMessageFormat=IntlMessageFormat;// This isn't a complete `Object.assign` polyfill, but this element expects
 ...
 */export const AppLocalizeBehavior={/**
   ...
   */properties:{/**
     ...
     */formats:{type:Object,value:function(){return{}}},/**
     ...
     */bubbleEvent:{type:Boolean,value:!1}},loadResources:function(path,language,merge){var proto=this.constructor.prototype;// Check if localCache exist just in case.
...
proto.__localizationCache.requests[path]=request}else{request.completes.then(onRequestResponse.bind(this),this.__onRequestError.bind(this))}},/**
   ...
   */__computeLocalize:function(language,resources,formats){var proto=this.constructor.prototype;// Check if localCache exist just in case.
