...
*/import"../../polymer/polymer-legacy.js";import{IronScrollTargetBehavior}from"../../iron-scroll-target-behavior/iron-scroll-target-behavior.js";import{_scrollEffects}from"../helpers/helpers.js";/**
 ...
 *
 * @polymerBehavior
 */export const AppScrollEffectsBehavior=[IronScrollTargetBehavior,{properties:{/**
...
if(!1!==effectDef.setUp()){this._effectsRunFn.push(effectDef.run)}},this)}},/**
     ...
     */_getDOMRef:function(id){console.warn("_getDOMRef","`"+id+"` is undefined")},_getUndefinedMsg:function(effectName){return"Scroll effect `"+effectName+"` is undefined. "+"Did you forget to import app-layout/app-scroll-effects/effects/"+effectName+".html ?"}}];