...
*/import"../polymer/polymer-legacy.js";import{IronOverlayBehavior}from"../iron-overlay-behavior/iron-overlay-behavior.js";import{dom}from"../polymer/lib/legacy/polymer.dom.js";/**
 ...
 */export const PaperDialogBehaviorImpl={hostAttributes:{role:"dialog",tabindex:"-1"},properties:{/**
...
for(var path=dom(event).path,i=0,l=path.indexOf(this),target;i<l;i++){target=path[i];if(target.hasAttribute&&(target.hasAttribute("dialog-dismiss")||target.hasAttribute("dialog-confirm"))){this._updateClosingReasonConfirmed(target.hasAttribute("dialog-confirm"));this.close();event.stopPropagation();break}}}};/** @polymerBehavior */export const PaperDialogBehavior=[IronOverlayBehavior,PaperDialogBehaviorImpl];