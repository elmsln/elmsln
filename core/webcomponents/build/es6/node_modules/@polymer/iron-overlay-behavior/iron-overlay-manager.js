...
*/import"../polymer/polymer-legacy.js";import"./iron-overlay-backdrop.js";import{IronA11yKeysBehavior}from"../iron-a11y-keys-behavior/iron-a11y-keys-behavior.js";import{dom}from"../polymer/lib/legacy/polymer.dom.js";import*as gestures from"../polymer/lib/utils/gestures.js";/**
 * @struct
 * @constructor
 * @private
...
while((overlay=/** @type {?} */this._overlays[i])&&this._overlayInPath(path)!==overlay){overlay._onCaptureClick(event);if(overlay.allowClickThrough){i--}else{break}}},/**
   ...
   * @suppress {missingProperties}
   * @private
   */_shouldBeBehindOverlay:function(overlay1,overlay2){return!overlay1.alwaysOnTop&&overlay2.alwaysOnTop}};export const IronOverlayManager=new IronOverlayManagerClass;