...
*/Polymer({_template:template,is:"paper-toggle-button",behaviors:[PaperCheckedElementBehavior],/** @private */hostAttributes:{role:"button","aria-pressed":"false",tabindex:0},properties:{/**
...
_createRipple:function(){this._rippleContainer=this.$.toggleButton;var ripple=PaperRippleBehavior._createRipple();ripple.id="ink";ripple.setAttribute("recenters","");ripple.classList.add("circle","toggle-ink");return ripple}});