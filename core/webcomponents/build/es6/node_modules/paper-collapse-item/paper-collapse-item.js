 ...
 */class PaperCollapseItem extends PolymerElement{static get template(){return html`
			<style>
				.header {
					min-height: 48px;
	 ...
	 *
	 * @event toggle
	 */_toggleOpened(e){this.opened=!this.opened;const toggleEvent=new CustomEvent("toggle",{detail:this,bubbles:!0,composed:!0});this.dispatchEvent(toggleEvent)}_computeToggleIcon(opened){return opened?"icons:expand-less":"icons:expand-more"}_or(value1,value2){return value1||value2}}window.customElements.define("paper-collapse-item",PaperCollapseItem);