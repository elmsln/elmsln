...
*/(0,_polymerFn.Polymer)({_template:(0,_htmlTag.html)(_templateObject_c2c66840898111e9ba38e33cad2d1624()),is:"app-box",behaviors:[_appScrollEffectsBehavior.AppScrollEffectsBehavior,_ironResizableBehavior.IronResizableBehavior],listeners:{"iron-resize":"_resizeHandler"},/**
   * The current scroll progress.
   *
   * @type {number}
   */_progress:0,attached:function attached(){this.resetLayout()},_debounceRaf:function _debounceRaf(fn){var self=this;if(this._raf){window.cancelAnimationFrame(this._raf)}this._raf=window.requestAnimationFrame(function(){self._raf=null;fn.call(self)})},/**
...
if(0===this.offsetWidth&&0===this.offsetHeight){return}var scrollTop=this._clampedScrollTop,savedDisabled=this.disabled;this.disabled=!0;this._elementTop=this._getElementTop();this._elementHeight=this.offsetHeight;this._cachedScrollTargetHeight=this._scrollTargetHeight;this._setUpEffect();this._updateScrollState(scrollTop);this.disabled=savedDisabled})},_getElementTop:function _getElementTop(){var currentNode=this,top=0;while(currentNode&&currentNode!==this.scrollTarget){top+=currentNode.offsetTop;currentNode=currentNode.offsetParent}return top},_updateScrollState:function _updateScrollState(scrollTop){if(this.isOnScreen()){var viewportTop=this._elementTop-scrollTop;this._progress=1-(viewportTop+this._elementHeight)/this._cachedScrollTargetHeight;this._runEffects(this._progress,scrollTop)}},/**
   ...
   * @return {Object}
   */getScrollState:function getScrollState(){return{progress:this._progress}}})});