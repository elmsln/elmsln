 ...
 *
 * @polymerBehavior
 */var AppScrollEffectsBehavior=[_ironScrollTargetBehavior.IronScrollTargetBehavior,{properties:{/**
     ...
     * parallax.run(0.5, 0);
     * ```
     */createEffect:function createEffect(effectName,effectConfig){var effectDef=_helpers._scrollEffects[effectName];if(!effectDef){throw new ReferenceError(this._getUndefinedMsg(effectName))}var prop=this._boundEffect(effectDef,effectConfig||{});prop.setUp();return prop},/**
