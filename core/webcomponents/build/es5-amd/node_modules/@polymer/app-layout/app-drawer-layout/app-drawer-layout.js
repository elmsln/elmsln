...
*/(0,_polymerFn.Polymer)({_template:(0,_htmlTag.html)(_templateObject_c31dfe20898111e9ba38e33cad2d1624()),is:"app-drawer-layout",behaviors:[_appLayoutBehavior.AppLayoutBehavior],properties:{/**
   ...
   *
   * @property drawer
   */get drawer(){return(0,_polymerDom.dom)(this.$.drawerSlot).getDistributedNodes()[0]},attached:function attached(){// Disable drawer transitions until after app-drawer-layout sets the initial
// opened state.
