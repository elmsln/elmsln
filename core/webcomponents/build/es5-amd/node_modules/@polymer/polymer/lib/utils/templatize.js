define(["exports","./boot.js","../mixins/property-effects.js","../mixins/mutable-data.js","./settings.js","./wrap.js"],function(_exports,_boot,_propertyEffects,_mutableData,_settings,_wrap){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.templatize=templatize;_exports.modelForElement=modelForElement;_exports.TemplateInstanceBase=void 0;/**
@license
 ...
 * @implements {Polymer_PropertyEffects}
 * @private
 */var templateInstanceBase=(0,_propertyEffects.PropertyEffects)(/*#__PURE__*/function(){function _class(){babelHelpers.classCallCheck(this,_class)}return _class}()),TemplateInstanceBase=/*#__PURE__*/function(_templateInstanceBase){babelHelpers.inherits(TemplateInstanceBase,_templateInstanceBase);function TemplateInstanceBase(props){var _this;babelHelpers.classCallCheck(this,TemplateInstanceBase);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(TemplateInstanceBase).call(this));_this._configureProperties(props);/** @type {!StampedTemplate} */_this.root=_this._stampTemplate(_this.__dataHost);// Save list of stamped children
// Polymer 1.x did not use `Polymer.dom` here so not bothering.
for(var children=_this.children=[],n=_this.root.firstChild;n;n=n.nextSibling){children.push(n);n.__templatizeInstance=babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))}if(_this.__templatizeOwner&&_this.__templatizeOwner.__hideTemplateChildren__){_this._showHideChildren(!0)}// Flush props only when props are passed if instance props exist
...
var templateHost=this.__dataHost.__dataHost;if(templateHost){templateHost._addEventListenerToNode(node,eventName,handler)}}}/**
   ...
   * @return {void}
   * @protected
   */},{key:"_showHideChildren",value:function _showHideChildren(hide){for(var c=this.children,i=0,n;i<c.length;i++){n=c[i];// Ignore non-changes
 ...
 * @implements {Polymer_MutableData}
 * @private
 */var MutableTemplateInstanceBase=(0,_mutableData.MutableData)(TemplateInstanceBase);function findMethodHost(template){// Technically this should be the owner of the outermost template.
