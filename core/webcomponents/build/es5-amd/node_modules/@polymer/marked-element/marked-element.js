define(["../polymer/polymer-legacy.js","./marked-import.js","../polymer/lib/legacy/polymer-fn.js","../polymer/lib/legacy/polymer.dom.js","../polymer/lib/utils/html-tag.js"],function(_polymerLegacy,_markedImport,_polymerFn,_polymerDom,_htmlTag){"use strict";function _templateObject_eb946e4096ae11e98fa963daf87dc373(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n      }\n    </style>\n    <slot name=\"markdown-html\">\n      <div id=\"content\"></div>\n    </slot>\n  "]);_templateObject_eb946e4096ae11e98fa963daf87dc373=function _templateObject_eb946e4096ae11e98fa963daf87dc373(){return data};return data}/**
...
*/(0,_polymerFn.Polymer)({_template:(0,_htmlTag.html)(_templateObject_eb946e4096ae11e98fa963daf87dc373()),is:"marked-element",properties:{/**
...
this._markdownElement=(0,_polymerDom.dom)(this).querySelector("[type=\"text/markdown\"]");if(!this._markdownElement){return}if(this._markdownElement.src){this._request(this._markdownElement.src)}if(""!==this._markdownElement.textContent.trim()){this.markdown=this._unindent(this._markdownElement.textContent)}var observer=new MutationObserver(this._onScriptAttributeChanged.bind(this));observer.observe(this._markdownElement,{attributes:!0})},/**
   ...
   * @param {string} text
   * @return {string}
   */unindent:function unindent(text){return this._unindent(text)},get outputElement(){var child=(0,_polymerDom.dom)(this).queryDistributedElements("[slot=\"markdown-html\"]")[0];return child||this.$.content},/**
