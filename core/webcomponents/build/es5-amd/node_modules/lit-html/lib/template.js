...
for(var _i3=0,n;_i3<nodesToRemove.length;_i3++){n=nodesToRemove[_i3];n.parentNode.removeChild(n)}};_exports.Template=Template;var isTemplatePartActive=function isTemplatePartActive(part){return-1!==part.index};// Allows `document.createComment('')` to be renamed for a
