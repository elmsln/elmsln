(function(global,factory){"object"===("undefined"===typeof exports?"undefined":babelHelpers.typeof(exports))&&"undefined"!==typeof module?factory(exports):"function"===typeof define&&define.amd?define(["exports"],factory):factory(global.Vaadin=global.Vaadin||{})})(this,function(exports){"use strict";var _typeof="function"===typeof Symbol&&"symbol"===babelHelpers.typeof(Symbol.iterator)?function(obj){return babelHelpers.typeof(obj)}:function(obj){return obj&&"function"===typeof Symbol&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":babelHelpers.typeof(obj)},classCallCheck=function classCallCheck(instance,Constructor){if(!babelHelpers.instanceof(instance,Constructor)){throw new TypeError("Cannot call a class as a function")}},createClass=function(){function defineProperties(target,props){for(var i=0,descriptor;i<props.length;i++){descriptor=props[i];descriptor.enumerable=descriptor.enumerable||!1;descriptor.configurable=!0;if("value"in descriptor)descriptor.writable=!0;Object.defineProperty(target,descriptor.key,descriptor)}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor}}(),get=function get(object,property,receiver){if(null===object)object=Function.prototype;var desc=Object.getOwnPropertyDescriptor(object,property);if(desc===void 0){var parent=Object.getPrototypeOf(object);if(null===parent){return void 0}else{return get(parent,property,receiver)}}else if("value"in desc){return desc.value}else{var getter=desc.get;if(getter===void 0){return void 0}return getter.call(receiver)}},inherits=function inherits(subClass,superClass){if("function"!==typeof superClass&&null!==superClass){throw new TypeError("Super expression must either be null or a function, not "+babelHelpers.typeof(superClass))}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:!1,writable:!0,configurable:!0}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass},possibleConstructorReturn=function possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called")}return call&&("object"===babelHelpers.typeof(call)||"function"===typeof call)?call:self},toConsumableArray=function toConsumableArray(arr){if(Array.isArray(arr)){for(var i=0,arr2=Array(arr.length);i<arr.length;i++){arr2[i]=arr[i]}return arr2}else{return Array.from(arr)}};function toArray$1(objectOrArray){objectOrArray=objectOrArray||[];return Array.isArray(objectOrArray)?objectOrArray:[objectOrArray]}function log(msg){return"[Vaadin.Router] "+msg}function logValue(value){if("object"!==("undefined"===typeof value?"undefined":_typeof(value))){return value+""}var stringType=Object.prototype.toString.call(value).match(/ (.*)\]$/)[1];if("Object"===stringType||"Array"===stringType){return stringType+" "+JSON.stringify(value)}else{return stringType}}var MODULE="module",NOMODULE="nomodule",bundleKeys=[MODULE,NOMODULE];function ensureBundle(src){if(!src.match(/.+\.[m]?js$/)){throw new Error(log("Unsupported type for bundle \""+src+"\": .js or .mjs expected."))}}function ensureRoute(route){if(!route||!isString(route.path)){throw new Error(log("Expected route config to be an object with a \"path\" string property, or an array of such objects"))}var bundle=route.bundle,stringKeys=["component","redirect","bundle"];if(!isFunction(route.action)&&!Array.isArray(route.children)&&!isFunction(route.children)&&!isObject(bundle)&&!stringKeys.some(function(key){return isString(route[key])})){throw new Error(log("Expected route config \""+route.path+"\" to include either \""+stringKeys.join("\", \"")+"\" "+"or \"action\" function but none found."))}if(bundle){if(isString(bundle)){ensureBundle(bundle)}else if(!bundleKeys.some(function(key){return key in bundle})){throw new Error(log("Expected route bundle to include either \""+NOMODULE+"\" or \""+MODULE+"\" keys, or both"))}else{bundleKeys.forEach(function(key){return key in bundle&&ensureBundle(bundle[key])})}}if(route.redirect){["bundle","component"].forEach(function(overriddenProp){if(overriddenProp in route){console.warn(log("Route config \""+route.path+"\" has both \"redirect\" and \""+overriddenProp+"\" properties, "+("and \"redirect\" will always override the latter. Did you mean to only use \""+overriddenProp+"\"?")))}})}}function ensureRoutes(routes){toArray$1(routes).forEach(function(route){return ensureRoute(route)})}function loadScript(src,key){var script=document.head.querySelector("script[src=\""+src+"\"][async]");if(!script){script=document.createElement("script");script.setAttribute("src",src);if(key===MODULE){script.setAttribute("type",MODULE)}else if(key===NOMODULE){script.setAttribute(NOMODULE,"")}script.async=!0}return new Promise(function(resolve,reject){script.onreadystatechange=script.onload=function(e){script.__dynamicImportLoaded=!0;resolve(e)};script.onerror=function(e){if(script.parentNode){script.parentNode.removeChild(script)}reject(e)};if(null===script.parentNode){document.head.appendChild(script)}else if(script.__dynamicImportLoaded){resolve()}})}function loadBundle(bundle){if(isString(bundle)){return loadScript(bundle)}else{return Promise.race(bundleKeys.filter(function(key){return key in bundle}).map(function(key){return loadScript(bundle[key],key)}))}}function fireRouterEvent(type,detail){return!window.dispatchEvent(new CustomEvent("vaadin-router-"+type,{cancelable:"go"===type,detail:detail}))}function isObject(o){// guard against null passing the typeof check
return"object"===("undefined"===typeof o?"undefined":_typeof(o))&&!!o}function isFunction(f){return"function"===typeof f}function isString(s){return"string"===typeof s}function getNotFoundError(context){var error=new Error(log("Page not found ("+context.pathname+")"));error.context=context;error.code=404;return error}var notFoundResult=new function NotFoundResult(){classCallCheck(this,NotFoundResult)};/* istanbul ignore next: coverage is calculated in Chrome, this code is for IE */function getAnchorOrigin(anchor){// IE11: on HTTP and HTTPS the default port is not included into
...
cache.set("|false",{keys:[],pattern:/(?:)/});function decodeParam(val){try{return decodeURIComponent(val)}catch(err){return val}}function matchPath(routepath,path,exact,parentKeys,parentParams){exact=!!exact;var cacheKey=routepath+"|"+exact,regexp=cache.get(cacheKey);if(!regexp){var keys=[];regexp={keys:keys,pattern:pathToRegexp_1(routepath,keys,{end:exact,strict:""===routepath})};cache.set(cacheKey,regexp)}var m=regexp.pattern.exec(path);if(!m){return null}for(var params=Object.assign({},parentParams),i=1;i<m.length;i++){var key=regexp.keys[i-1],prop=key.name,value=m[i];if(value!==void 0||!hasOwnProperty.call(params,prop)){if(key.repeat){params[prop]=value?value.split(key.delimiter).map(decodeParam):[]}else{params[prop]=value?decodeParam(value):value}}}return{path:m[0],keys:(parentKeys||[]).concat(regexp.keys),params:params}}/**
   ...
   * This source code is licensed under the MIT license found in the
   * LICENSE.txt file in the root directory of this source tree.
   */function isChildRoute(parentRoute,childRoute){var route=childRoute;while(route){route=route.parent;if(route===parentRoute){return!0}}return!1}function generateErrorMessage(currentContext){var errorMessage="Path '"+currentContext.pathname+"' is not properly resolved due to an error.",routePath=(currentContext.route||{}).path;if(routePath){errorMessage+=" Resolution had failed on route: '"+routePath+"'"}return errorMessage}function addRouteToChain(context,match){var route=match.route,path=match.path;function shouldDiscardOldChain(oldChain,route){return!route.parent||!oldChain||!oldChain.length||oldChain[oldChain.length-1].route!==route.parent}if(route&&!route.__synthetic){var item={path:path,route:route};if(shouldDiscardOldChain(context.chain,route)){context.chain=[item]}else{context.chain.push(item)}}}/**
   * @memberof Vaadin
   */var Resolver=function(){function Resolver(routes){var options=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};classCallCheck(this,Resolver);if(Object(routes)!==routes){throw new TypeError("Invalid routes")}this.baseUrl=options.baseUrl||"";this.errorHandler=options.errorHandler;this.resolveRoute=options.resolveRoute||resolveRoute;this.context=Object.assign({resolver:this},options.context);this.root=Array.isArray(routes)?{path:"",__children:routes,parent:null,__synthetic:!0}:routes;this.root.parent=null}/**
     * Returns the current list of routes (as a shallow copy). Adding / removing
     * routes to / from the returned array does not affect the routing config,
     * but modifying the route objects does.
     *
     * @return {!Array<!Route>}
     */createClass(Resolver,[{key:"getRoutes",value:function getRoutes(){return[].concat(toConsumableArray(this.root.__children))}/**
       * Sets the routing config (replacing the existing one).
       *
       * @param {!Array<!Route>|!Route} routes a single route or an array of those
       *    (the array is shallow copied)
       */},{key:"setRoutes",value:function setRoutes(routes){ensureRoutes(routes);var newRoutes=[].concat(toConsumableArray(toArray$1(routes)));this.root.__children=newRoutes}/**
       ...
       * @return {!Array<!Route>}
       * @protected
       */},{key:"addRoutes",value:function addRoutes(routes){var _root$__children;ensureRoutes(routes);(_root$__children=this.root.__children).push.apply(_root$__children,toConsumableArray(toArray$1(routes)));return this.getRoutes()}/**
...
return pathname}var base=this.__effectiveBaseUrl,normalizedUrl=this.constructor.__createUrl(pathname,base).href;if(normalizedUrl.slice(0,base.length)===base){return normalizedUrl.slice(base.length)}}},{key:"__effectiveBaseUrl",/**
       ...
       */get:function get$$1(){return this.baseUrl?this.constructor.__createUrl(this.baseUrl,document.baseURI||document.URL).href.replace(/[^\/]*$/,""):""}}],[{key:"__createUrl",value:function __createUrl(url,base){return new URL(url,base)}}]);return Resolver}();Resolver.pathToRegexp=pathToRegexp_1;/**
   * Universal Router (https://www.kriasoft.com/universal-router/)
   *
   * Copyright (c) 2015-present Kriasoft.
   *
...
cacheRoutes(routesByName,router.root,router.root.__children);route=getRouteByName(routesByName,routeName);if(!route){throw new Error("Route \""+routeName+"\" not found")}}var regexp=cache$1.get(route.fullPath);if(!regexp){var fullPath=getRoutePath(route),rt=route.parent;while(rt){var path=getRoutePath(rt);if(path){fullPath=path.replace(/\/$/,"")+"/"+fullPath.replace(/^\//,"")}rt=rt.parent}for(var tokens=pathToRegexp$1.parse(fullPath),toPath=pathToRegexp$1.tokensToFunction(tokens),keys=Object.create(null),i=0;i<tokens.length;i++){if(!isString(tokens[i])){keys[tokens[i].name]=!0}}regexp={toPath:toPath,keys:keys};cache$1.set(fullPath,regexp);route.fullPath=fullPath}var url=regexp.toPath(params,options)||"/";if(options.stringifyQueryParams&&params){for(var queryParams={},_keys=Object.keys(params),_i=0,key;_i<_keys.length;_i++){key=_keys[_i];if(!regexp.keys[key]){queryParams[key]=params[key]}}var query=options.stringifyQueryParams(queryParams);if(query){url+="?"===query.charAt(0)?query:"?"+query}}return url}}/**
   ...
   */var Router=function(_Resolver){inherits(Router,_Resolver);/**
     ...
     */function Router(outlet,options){classCallCheck(this,Router);var baseElement=document.head.querySelector("base"),_this=possibleConstructorReturn(this,(Router.__proto__||Object.getPrototypeOf(Router)).call(this,[],Object.assign({// Default options
baseUrl:baseElement&&baseElement.getAttribute("href")},options)));_this.resolveRoute=function(context){return _this.__resolveRoute(context)};var triggers=Router.NavigationTrigger;Router.setTriggers.apply(Router,Object.keys(triggers).map(function(key){return triggers[key]}));/**
       ...
       */_this.ready;_this.ready=Promise.resolve(outlet);/**
       ...
       */_this.location;_this.location=createLocation({resolver:_this});_this.__lastStartedRenderId=0;_this.__navigationEventHandler=_this.__onNavigationEvent.bind(_this);_this.setOutlet(outlet);_this.subscribe();return _this}createClass(Router,[{key:"__resolveRoute",value:function __resolveRoute(context){var route=context.route,callbacks=Promise.resolve();if(isFunction(route.children)){callbacks=callbacks.then(function(){return route.children(copyContextWithoutNext(context))}).then(function(children){// The route.children() callback might have re-written the
// route.children property instead of returning a value
if(!isResultNotEmpty(children)&&!isFunction(route.children)){children=route.children}processNewChildren(children,route)})}var commands={redirect:function redirect(path){return createRedirect(context,path)},component:function component(_component){return renderComponent(context,_component)}};return callbacks.then(function(){return runCallbackIfPossible(route.action,[context,commands],route)}).then(function(result){if(isResultNotEmpty(result)){// Actions like `() => import('my-view.js')` are not expected to
// end the resolution, despite the result is not empty. Checking
// the result with a whitelist of values that end the resulution.
if(babelHelpers.instanceof(result,HTMLElement)||result.redirect||result===notFoundResult){return result}}if(isString(route.redirect)){return commands.redirect(route.redirect)}if(route.bundle){return loadBundle(route.bundle).then(function(){},function(){throw new Error(log("Bundle not found: "+route.bundle+". Check if the file name is correct"))})}}).then(function(result){if(isResultNotEmpty(result)){return result}if(isString(route.component)){return commands.component(route.component)}})}/**
       ...
       */},{key:"setRoutes",value:function setRoutes(routes){this.__urlForName=void 0;get(Router.prototype.__proto__||Object.getPrototypeOf(Router.prototype),"setRoutes",this).call(this,routes);this.__onNavigationEvent()}/**
       ...
       * @return {!Promise<!Node>}
       */},{key:"render",value:function render(pathnameOrContext,shouldUpdateHistory){var _this2=this,renderId=++this.__lastStartedRenderId,pathname=pathnameOrContext.pathname||pathnameOrContext;// Find the first route that resolves to a non-empty result
...
.then(function(context){return _this2.__fullyResolveChain(context)}).then(function(context){if(renderId===_this2.__lastStartedRenderId){var previousContext=_this2.__previousContext;// Check if the render was prevented and make an early return in that case
if(context===previousContext){return _this2.location}_this2.location=createLocation(context);fireRouterEvent("location-changed",{router:_this2,location:_this2.location});if(shouldUpdateHistory){_this2.__updateBrowserHistory(context.pathname,context.redirectFrom)}_this2.__addAppearingContent(context,previousContext);var animationDone=_this2.__animateIfNeeded(context);_this2.__runOnAfterEnterCallbacks(context);_this2.__runOnAfterLeaveCallbacks(context,previousContext);return animationDone.then(function(){if(renderId===_this2.__lastStartedRenderId){// If there is another render pass started after this one,
// the 'disappearing content' would be removed when the other
// render pass calls `this.__addAppearingContent()`
_this2.__removeDisappearingContent();_this2.__previousContext=context;return _this2.location}})}}).catch(function(error){if(renderId===_this2.__lastStartedRenderId){if(shouldUpdateHistory){_this2.__updateBrowserHistory(pathname)}removeDomNodes(_this2.__outlet&&_this2.__outlet.children);_this2.location=createLocation({pathname:pathname,resolver:_this2});fireRouterEvent("error",{router:_this2,error:error,pathname:pathname});throw error}});return this.ready}},{key:"__fullyResolveChain",value:function __fullyResolveChain(originalContext){var _this3=this,currentContext=1<arguments.length&&arguments[1]!==void 0?arguments[1]:originalContext;return this.__amendWithResolutionResult(currentContext).then(function(amendedContext){var initialContext=amendedContext!==currentContext?amendedContext:originalContext;return amendedContext.next().then(function(nextContext){if(null===nextContext||nextContext===notFoundResult){var matchedPath=getPathnameForRouter(getMatchedPath(amendedContext.chain),amendedContext.resolver);if(matchedPath!==amendedContext.pathname){throw getNotFoundError(initialContext)}}return nextContext&&nextContext!==notFoundResult?_this3.__fullyResolveChain(initialContext,nextContext):_this3.__amendWithOnBeforeCallbacks(initialContext)})})}},{key:"__amendWithResolutionResult",value:function __amendWithResolutionResult(context){var _this4=this,result=context.result;if(babelHelpers.instanceof(result,HTMLElement)){return Promise.resolve(context)}else if(result.redirect){return this.__redirect(result.redirect,context.__redirectCount).then(function(context){return _this4.__amendWithResolutionResult(context)})}else if(babelHelpers.instanceof(result,Error)){return Promise.reject(result)}else{return Promise.reject(new Error(log("Invalid route resolution result for path \""+context.pathname+"\". "+("Expected redirect object or HTML element, but got: \""+logValue(result)+"\". ")+"Double check the action return value for the route.")))}}},{key:"__amendWithOnBeforeCallbacks",value:function __amendWithOnBeforeCallbacks(contextWithFullChain){var _this5=this;return this.__runOnBeforeCallbacks(contextWithFullChain).then(function(amendedContext){if(amendedContext===_this5.__previousContext||amendedContext===contextWithFullChain){return amendedContext}return _this5.__fullyResolveChain(amendedContext)})}},{key:"__runOnBeforeCallbacks",value:function __runOnBeforeCallbacks(newContext){var _this6=this,previousContext=this.__previousContext||{},previousChain=previousContext.chain||[],newChain=newContext.chain,callbacks=Promise.resolve(),prevent=function prevent(){return{cancel:!0}},redirect=function redirect(pathname){return createRedirect(newContext,pathname)};newContext.__divergedChainIndex=0;if(previousChain.length){for(var i=0;i<Math.min(previousChain.length,newChain.length);i=++newContext.__divergedChainIndex){if(previousChain[i].route!==newChain[i].route||previousChain[i].path!==newChain[i].path||(previousChain[i].element&&previousChain[i].element.localName)!==(newChain[i].element&&newChain[i].element.localName)){break}}for(var _i=previousChain.length-1,location;_i>=newContext.__divergedChainIndex;_i--){location=createLocation(newContext);callbacks=callbacks.then(amend("onBeforeLeave",[location,{prevent:prevent},this],previousChain[_i].element)).then(function(result){if(!(result||{}).redirect){return result}})}}for(var _i2=newContext.__divergedChainIndex,_location;_i2<newChain.length;_i2++){_location=createLocation(newContext,newChain[_i2].route);callbacks=callbacks.then(amend("onBeforeEnter",[_location,{prevent:prevent,redirect:redirect},this],newChain[_i2].element))}return callbacks.then(function(amendmentResult){if(amendmentResult){if(amendmentResult.cancel){return _this6.__previousContext}if(amendmentResult.redirect){return _this6.__redirect(amendmentResult.redirect,newContext.__redirectCount)}}return newContext})}},{key:"__redirect",value:function __redirect(redirectData,counter){if(counter>MAX_REDIRECT_COUNT){throw new Error(log("Too many redirects when rendering "+redirectData.from))}return this.resolve({pathname:this.urlForPath(redirectData.pathname,redirectData.params),redirectFrom:redirectData.from,__redirectCount:(counter||0)+1})}},{key:"__ensureOutlet",value:function __ensureOutlet(){var outlet=0<arguments.length&&arguments[0]!==void 0?arguments[0]:this.__outlet;if(!babelHelpers.instanceof(outlet,Node)){throw new TypeError(log("Expected router outlet to be a valid DOM Node (but got "+outlet+")"))}}},{key:"__updateBrowserHistory",value:function __updateBrowserHistory(pathname,replace){if(window.location.pathname!==pathname){var changeState=replace?"replaceState":"pushState";window.history[changeState](null,document.title,pathname);window.dispatchEvent(new PopStateEvent("popstate",{state:"vaadin-router-ignore"}))}}},{key:"__addAppearingContent",value:function __addAppearingContent(context,previousContext){this.__ensureOutlet();// If the previous 'entering' animation has not completed yet,
...
for(var i=currentContext.__divergedChainIndex;i<currentContext.chain.length;i++){var currentComponent=currentContext.chain[i].element||{},location=createLocation(currentContext,currentContext.chain[i].route);runCallbackIfPossible(currentComponent.onAfterEnter,[location,{},currentContext.resolver],currentComponent)}}},{key:"__animateIfNeeded",value:function __animateIfNeeded(context){for(var from=(this.__disappearingContent||[])[0],to=(this.__appearingContent||[])[0],promises=[],chain=context.chain,config=void 0,i=chain.length;0<i;i--){if(chain[i-1].route.animate){config=chain[i-1].route.animate;break}}if(from&&to&&config){var leave=isObject(config)&&config.leave||"leaving",enter=isObject(config)&&config.enter||"entering";promises.push(animate(from,leave));promises.push(animate(to,enter))}return Promise.all(promises).then(function(){return context})}/**
       ...
       * method.
       */},{key:"unsubscribe",value:function unsubscribe(){window.removeEventListener("vaadin-router-go",this.__navigationEventHandler)}},{key:"__onNavigationEvent",value:function __onNavigationEvent(event){var pathname=event?event.detail.pathname:window.location.pathname;if(isString(this.__normalizePathname(pathname))){if(event&&event.preventDefault){event.preventDefault()}this.render(pathname,!0)}}/**
       ...
       * @return {boolean}
       */}],[{key:"setTriggers",value:function setTriggers(){for(var _len=arguments.length,triggers=Array(_len),_key=0;_key<_len;_key++){triggers[_key]=arguments[_key]}setNavigationTriggers(triggers)}},{key:"go",value:function go(pathname){return fireRouterEvent("go",{pathname:pathname})}}]);return Router}(Resolver),DEV_MODE_CODE_REGEXP=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i;function isMinified(){function test(){/** vaadin-dev-mode:start
      return false;
...
window.Vaadin=window.Vaadin||{};/**
   ...
   */var runIfDevelopmentMode=function runIfDevelopmentMode(callback,args){if(window.Vaadin.developmentMode){return uncommentAndRun(callback,args)}};if(window.Vaadin.developmentMode===void 0){window.Vaadin.developmentMode=isDevelopmentMode()}/* This file is autogenerated from src/vaadin-usage-statistics.tpl.html */function maybeGatherAndSendStats(){/** vaadin-dev-mode:start
    ...
    // Intentionally ignored as this is not a problem in the app being developed
     ...
     vaadin-dev-mode:end **/}var usageStatistics=function usageStatistics(){if("function"===typeof runIfDevelopmentMode){return runIfDevelopmentMode(maybeGatherAndSendStats)}};window.Vaadin=window.Vaadin||{};window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.registrations.push({is:"@vaadin/router",version:"1.2.0"});usageStatistics();Router.NavigationTrigger={POPSTATE:POPSTATE,CLICK:CLICK};var isUrlAvailable=void 0,urlDocument=void 0,urlBase=void 0,urlAnchor=void 0;Resolver.__ensureUrlAvailableOrPolyfilled=function(){if(isUrlAvailable===void 0){try{var url=new URL("b","http://a");url.pathname="c";isUrlAvailable="http://a/c"===url.href}catch(e){isUrlAvailable=!1}if(!isUrlAvailable){// The URL constructor is not available in IE11. Polyfill it by creating
...
// window.location.origin, so won't include it here either.
var protocol=urlAnchor.protocol,port=urlAnchor.port,defaultHttp="http:"===protocol&&"80"===port,defaultHttps="https:"===protocol&&"443"===port,host=defaultHttp||defaultHttps?urlAnchor.hostname:urlAnchor.host;return protocol+"//"+host}});// IE11: HTMLAnchorElement pathname does not start with a leading slash
...
urlAnchor.href=urlAnchor.href;return urlAnchor};exports.Router=Router;exports.Resolver=Resolver;Object.defineProperty(exports,"__esModule",{value:!0})});//# sourceMappingURL=vaadin-router.umd.js.map