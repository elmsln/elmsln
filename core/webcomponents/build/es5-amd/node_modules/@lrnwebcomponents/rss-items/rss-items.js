 ...
 */var RssItems=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(RssItems,_PolymerElement);babelHelpers.createClass(RssItems,[{key:"initRequest",/**
   ...
   */value:function initRequest(){this.shadowRoot.querySelector("#rssajax").generateRequest()}},{key:"_maxChanged",value:function _maxChanged(newValue){if(newValue){this.xmlToItems(this.xml)}}/**
   * Receives a xml and set this.items as json.
   * @param {Object} xml XML element.
   */},{key:"xmlToItems",value:function xmlToItems(newValue){if(newValue){// parse xml to json and get items
...
get:function get(){return(0,_polymerElement.html)(_templateObject_8b39ac70898111e9ba38e33cad2d1624())}// haxProperty definition
