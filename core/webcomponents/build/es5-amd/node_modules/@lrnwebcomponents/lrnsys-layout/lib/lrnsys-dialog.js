...
*/var LrnsysDialog=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(LrnsysDialog,_PolymerElement);function LrnsysDialog(){babelHelpers.classCallCheck(this,LrnsysDialog);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrnsysDialog).apply(this,arguments))}babelHelpers.createClass(LrnsysDialog,[{key:"tapEventOn",/**
   ...
   */value:function tapEventOn(e){var _this=this;if(babelHelpers.typeof(this.hoverClass)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){var classes=this.hoverClass.split(" ");classes.forEach(function(item,index){if(""!=item){_this.$.dialogtrigger.classList.add(item)}})}}/**
   * Handle a mouse out event and remove the hoverclasses
   * from the classList array for paper-button.
   */},{key:"tapEventOff",value:function tapEventOff(e){var _this2=this;if(babelHelpers.typeof(this.hoverClass)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){var classes=this.hoverClass.split(" ");classes.forEach(function(item,index){if(""!=item){_this2.$.dialogtrigger.classList.remove(item)}})}}},{key:"toggleDialog",value:function toggleDialog(){this.openDialog()}/**
   * Toggle the drawer to open / close.
   */},{key:"openDialog",value:function openDialog(){// assemble everything in the slot
var nodes=(0,_polymerDom.dom)(this).getEffectiveChildNodes(),h=document.createElement("span"),c=document.createElement("span"),node={};for(var i in nodes){if(babelHelpers.typeof(nodes[i].tagName)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){switch(nodes[i].getAttribute("slot")){case"toolbar-primary":case"toolbar-secondary":case"toolbar":case"header":node=nodes[i].cloneNode(!0);node.removeAttribute("slot");h.appendChild(node);break;case"button":// do nothing
break;default:node=nodes[i].cloneNode(!0);node.removeAttribute("slot");if(this.dynamicImages&&"IRON-IMAGE"===node.tagName){node.preventLoad=!1;node.removeAttribute("prevent-load")}c.appendChild(node);break;}}}var evt=new CustomEvent("simple-modal-show",{bubbles:!0,composed:!0,cancelable:!0,detail:{title:this.header,elements:{header:h,content:c},invokedBy:this.$.dialogtrigger,clone:!0}});this.dispatchEvent(evt)}/**
...
classes.forEach(function(item,index){if(""!=item){if(_this3.focusState){_this3.$.dialogtrigger.classList.add(item)}else{_this3.$.dialogtrigger.classList.remove(item)}}})}this.focusState=!this.focusState}/**
   * Ready lifecycle
   ...
   * Attached lifecycle
   */},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysDialog.prototype),"connectedCallback",this).call(this);(0,_renderStatus.afterNextRender)(this,function(){this.$.dialogtrigger.addEventListener("focused-changed",this.focusToggle.bind(this));this.$.dialogtrigger.addEventListener("mousedown",this.tapEventOn.bind(this));this.$.dialogtrigger.addEventListener("mouseover",this.tapEventOn.bind(this));this.$.dialogtrigger.addEventListener("mouseout",this.tapEventOff.bind(this))})}/**
   * detached lifecycle
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){this.$.dialogtrigger.removeEventListener("focused-changed",this.focusToggle.bind(this));this.$.dialogtrigger.removeEventListener("mousedown",this.tapEventOn.bind(this));this.$.dialogtrigger.removeEventListener("mouseover",this.tapEventOn.bind(this));this.$.dialogtrigger.removeEventListener("mouseout",this.tapEventOff.bind(this));babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysDialog.prototype),"disconnectedCallback",this).call(this)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_09569df096d611e9958011805f8b519d())}},{key:"tag",get:function get(){return"lrnsys-dialog"}},{key:"properties",get:function get(){return{/**
