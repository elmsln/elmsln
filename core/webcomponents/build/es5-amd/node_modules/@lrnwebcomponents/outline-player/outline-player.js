...
(0,_elementMixin.updateStyles)()})}/**
   ...
   */},{key:"_activeIdChanged",value:function _activeIdChanged(newValue){// close menu if it's narrow and something new is picked
if(this.opened&&this.narrow){this.$.drawer.toggle()}window.scrollTo({top:0,left:0,behavior:"smooth"})}/**
   * attached life cycle
   */},{key:"connectedCallback",value:function connectedCallback(){var _this=this;babelHelpers.get(babelHelpers.getPrototypeOf(OutlinePlayer.prototype),"connectedCallback",this).call(this);this.__disposer=[];(0,_mobxModule.autorun)(function(reaction){_this.activeId=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.activeId);_this.__disposer.push(reaction)})}/**
   * detatched life cycle
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){for(var i in this.__disposer){this.__disposer[i].dispose()}babelHelpers.get(babelHelpers.getPrototypeOf(OutlinePlayer.prototype),"disconnectedCallback",this).call(this)}}],[{key:"tag",/**
   * Store the tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */get:function get(){return"outline-player"}// render function
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_87d328e0898111e9ba38e33cad2d1624())}},{key:"properties",get:function get(){return{opened:{type:Boolean,reflectToAttribute:!0},closed:{type:Boolean,notify:!0,reflectToAttribute:!0,value:!1},activeId:{type:String,observer:"_activeIdChanged"},narrow:{type:Boolean,reflectToAttribute:!0}}}}]);return OutlinePlayer}((0,_HAXCMSThemeWiring.HAXCMSTheme)(_polymerElement.PolymerElement));_exports.OutlinePlayer=OutlinePlayer;window.customElements.define(OutlinePlayer.tag,OutlinePlayer)});