define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../simple-colors/simple-colors.js","../hax-body-behaviors/lib/HAXWiring.js"],function(_exports,_require,_polymerElement,_renderStatus,_simpleColors,_HAXWiring){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrndesignPanelcard=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_86c710807cd211e98efbab36cb9e78ba(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style include=\"simple-colors\"></style>\n      <style>\n        :host {\n          display: inline-block;\n          position: relative;\n          box-sizing: border-box;\n          --lrndesign-panelcard-text-color: var(\n            --simple-colors-default-theme-grey-12\n          );\n          --lrndesign-panelcard-color: var(\n            --simple-colors-default-theme-accent-1\n          );\n        }\n        :host([dark]:not([accent-color=\"grey\"])) {\n          --lrndesign-panelcard-color: var(\n            --simple-colors-default-theme-accent-3\n          );\n        }\n        :host([colored-text]) {\n          --lrndesign-panelcard-text-color: var(\n            --simple-colors-default-theme-accent-9\n          );\n          --lrndesign-panelcard-color: var(\n            --simple-colors-default-theme-grey-1\n          );\n        }\n        .card-panel {\n          transition: box-shadow 0.25s;\n          padding: 24px;\n          margin: 0;\n          border-radius: 2px;\n          color: var(--lrndesign-panelcard-text-color);\n          background-color: var(--lrndesign-panelcard-color);\n        }\n\n        h3 {\n          padding: 0;\n          margin: 0 0 8px 0;\n        }\n      </style>\n      <aside>\n        <paper-card elevation=\"[[elevation]]\">\n          <div class=\"card-panel\">\n            <h3>[[title]]</h3>\n            <span><slot></slot></span>\n          </div>\n        </paper-card>\n      </aside>\n    "]);_templateObject_86c710807cd211e98efbab36cb9e78ba=function _templateObject_86c710807cd211e98efbab36cb9e78ba(){return data};return data}/**
`lrndesign-panelcard`
A LRN element

* @demo demo/index.html
*/var LrndesignPanelcard=/*#__PURE__*/function(_SimpleColors){babelHelpers.inherits(LrndesignPanelcard,_SimpleColors);function LrndesignPanelcard(){var _this;babelHelpers.classCallCheck(this,LrndesignPanelcard);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignPanelcard).call(this));new Promise(function(res,rej){return _require.default(["../../@polymer/paper-card/paper-card.js"],res,rej)});(0,_renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this)),function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(LrndesignPanelcard.haxProperties,LrndesignPanelcard.tag,this)});return _this}babelHelpers.createClass(LrndesignPanelcard,null,[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_86c710807cd211e98efbab36cb9e78ba())}},{key:"tag",get:function get(){return"lrndesign-panelcard"}},{key:"properties",get:function get(){var props={/**
       * Title of the panel
