...
get:function get(){return(0,_polymerElement.html)(_templateObject_83ef3ca07c0711e98a2471d74bf08c91())}// properties available to the custom element for data binding
...
while(null!==(0,_polymerDom.dom)(this).firstChild){(0,_polymerDom.dom)(this).removeChild((0,_polymerDom.dom)(this).firstChild)}setTimeout(function(){_this2.show(e.detail.title,e.detail.elements,e.detail.invokedBy,e.detail.clone)},100)}else{this.show(e.detail.title,e.detail.elements,e.detail.invokedBy,e.detail.clone)}}/**
   * Show the modal and display the material
   */},{key:"show",value:function show(title,elements,invokedBy){var _this3=this,clone=3<arguments.length&&arguments[3]!==void 0?arguments[3]:!1;this.set("invokedBy",invokedBy);this.title=title;var element,slots=["header","content","buttons"];// append element areas into the appropriate slots
