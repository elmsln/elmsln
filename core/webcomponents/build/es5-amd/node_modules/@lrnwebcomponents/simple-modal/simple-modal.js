...
get:function get(){return(0,_polymerElement.html)(_templateObject_aaea29c07cd211e98efbab36cb9e78ba())}// properties available to the custom element for data binding
...
while(null!==(0,_polymerDom.dom)(this).firstChild){(0,_polymerDom.dom)(this).removeChild((0,_polymerDom.dom)(this).firstChild)}setTimeout(function(){_this2.show(e.detail.title,e.detail.elements,e.detail.invokedBy,e.detail.id,e.detail.modalClass,e.detail.styles,e.detail.clone)},100)}else{this.show(e.detail.title,e.detail.elements,e.detail.invokedBy,e.detail.id,e.detail.modalClass,e.detail.styles,e.detail.clone)}}/**
   * Show the modal and display the material
   */},{key:"show",value:function show(title,elements,invokedBy){var _this3=this,id=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null,modalClass=4<arguments.length&&arguments[4]!==void 0?arguments[4]:null,styles=5<arguments.length&&arguments[5]!==void 0?arguments[5]:null,clone=6<arguments.length&&arguments[6]!==void 0?arguments[6]:!1;this.set("invokedBy",invokedBy);this.title=title;var element,slots=["header","content","buttons"];// append element areas into the appropriate slots
