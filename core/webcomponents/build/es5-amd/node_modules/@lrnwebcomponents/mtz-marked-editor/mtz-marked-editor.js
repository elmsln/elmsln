define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/iron-form-element-behavior/iron-form-element-behavior.js","../../@polymer/iron-validatable-behavior/iron-validatable-behavior.js","../../@polymer/polymer/lib/legacy/class.js"],function(_exports,_polymerElement,_renderStatus,_polymerDom,_ironFormElementBehavior,_ironValidatableBehavior,_class){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MtzMarkedEditor=void 0;function _templateObject_baf5d4407cd211e98efbab36cb9e78ba(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n      </style>\n      <slot name=\"controls\"></slot> <slot name=\"textarea\"></slot>\n      <slot name=\"footer\"></slot>\n    "]);_templateObject_baf5d4407cd211e98efbab36cb9e78ba=function _templateObject_baf5d4407cd211e98efbab36cb9e78ba(){return data};return data}/**
 * `mtz-marked-editor`
 * `Creates a textarea with common editor logic and can be controlled by UI elements`
 * @demo demo/index.html
 */var MtzMarkedEditor=/*#__PURE__*/function(_mixinBehaviors){babelHelpers.inherits(MtzMarkedEditor,_mixinBehaviors);babelHelpers.createClass(MtzMarkedEditor,null,[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_baf5d4407cd211e98efbab36cb9e78ba())}},{key:"tag",get:function get(){return"mtz-marked-editor"}},{key:"properties",get:function get(){var props={autofocus:Boolean,readonly:Boolean,textareaSelector:{type:String,value:"textarea"},__textarea:Object};if(babelHelpers.get(babelHelpers.getPrototypeOf(MtzMarkedEditor),"properties",this)){props=Object.assign(props,babelHelpers.get(babelHelpers.getPrototypeOf(MtzMarkedEditor),"properties",this))}return props}}]);function MtzMarkedEditor(){var _this;babelHelpers.classCallCheck(this,MtzMarkedEditor);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MtzMarkedEditor).call(this));_this.addEventListener("register-control",_this.__bindControlToEditor.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));return _this}babelHelpers.createClass(MtzMarkedEditor,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(MtzMarkedEditor.prototype),"connectedCallback",this).call(this);this.__textarea=(0,_polymerDom.dom)(this).queryDistributedElements("[slot=\"textarea\"]")[0]}},{key:"disconnectedCallback",value:function disconnectedCallback(){this.removeEventListener("register-control",this.__bindControlToEditor);this.disconnectedCallback()}/**
