...
*/var PaperFabSpeedDial=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(PaperFabSpeedDial,_PolymerElement);function PaperFabSpeedDial(){babelHelpers.classCallCheck(this,PaperFabSpeedDial);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PaperFabSpeedDial).apply(this,arguments))}babelHelpers.createClass(PaperFabSpeedDial,[{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(PaperFabSpeedDial.prototype),"ready",this).call(this);var fab=(0,_polymerDom.dom)(this.$.fabContainer).getDistributedNodes()[0];fab.addEventListener("click",function(){this.$.dropdown.open()}.bind(this));var content=(0,_polymerDom.dom)(this.$.contentContainer).getDistributedNodes()[0];content.addEventListener("click",function(){this.$.dropdown.close()}.bind(this))}/**
   * Show the speed dial options.
   */},{key:"open",value:function open(){this.$.dropdown.open()}/**
   * Hide the speed dial options.
   */},{key:"close",value:function close(){this.$.dropdown.close()}},{key:"_updateDropdown",value:function _updateDropdown(direction,offset){var d=this.$.dropdown;switch(direction){case"bottom":d.verticalAlign="top";d.horizontalOffset=0;d.verticalOffset=offset;d.classList.add("vertical");d.classList.remove("horizontal");break;case"top":d.verticalAlign="bottom";d.horizontalOffset=0;d.verticalOffset=offset;d.classList.add("vertical");d.classList.remove("horizontal");break;case"right":d.horizontalAlign="left";d.horizontalOffset=offset;d.verticalOffset=0;d.classList.add("horizontal");d.classList.remove("vertical");break;case"left":d.horizontalAlign="right";d.horizontalOffset=offset;d.verticalOffset=0;d.classList.add("horizontal");d.classList.remove("vertical");break;default:throw"Invalid direction. Must be one of [top, bottom, left, right].";}}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_ac25dda0898111e9ba38e33cad2d1624())}},{key:"tag",get:function get(){return"paper-fab-speed-dial"}},{key:"properties",get:function get(){return{/**
       ...
       */openAnimationConfig:{type:Array,value:function value(){return[{name:"fade-in-animation",timing:{delay:150,duration:50}},{name:"paper-square-grow-animation",startSize:56,timing:{delay:150,duration:200}}]}},/**
       * An animation config. If provided, this will be used to animate the
       * closing of the options dropdown.
       */closeAnimationConfig:{type:Array,value:function value(){return[{name:"fade-out-animation",timing:{duration:200}}]}}}}},{key:"observers",get:function get(){return["_updateDropdown(direction, offset)"]}}]);return PaperFabSpeedDial}(_polymerElement.PolymerElement);_exports.PaperFabSpeedDial=PaperFabSpeedDial;window.customElements.define(PaperFabSpeedDial.tag,PaperFabSpeedDial)});