define(["exports","meta","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/polymer/lib/utils/resolve-url.js","../hax-body-behaviors/lib/HAXWiring.js","../es-global-bridge/es-global-bridge.js","../../@polymer/iron-ajax/iron-ajax.js"],function(_exports,meta,_require,_polymerElement,_renderStatus,_polymerDom,_resolveUrl,_HAXWiring,_esGlobalBridge,_ironAjax){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnCalendar=void 0;meta=babelHelpers.interopRequireWildcard(meta);_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_448baad07c0711e98a2471d74bf08c91(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        lrn-calendar-date {\n          display: inline-table;\n          top: 0px;\n        }\n        paper-card {\n          width: 14%;\n          height: 20px;\n          display: inline-table;\n          padding: 0;\n          margin: 0;\n        }\n        .calendar {\n          color: var(--my-toolbar-title-color);\n        }\n        .header {\n          padding-bottom: 15px;\n        }\n      </style>\n\n      <div class=\"calendar\">\n        <div class=\"header\">\n          <div style=\"float: left\">\n            <paper-button raised type=\"button\" on-tap=\"monthView\"\n              >Month</paper-button\n            >\n            <paper-button raised type=\"button\" on-tap=\"weekView\"\n              >Week</paper-button\n            >\n          </div>\n          <div style=\"float: right\">\n            <paper-button raised type=\"button\" on-tap=\"showDate\"\n              >Today</paper-button\n            >\n            <paper-button on-tap=\"showPrev\"\n              ><iron-icon icon=\"arrow-back\"></iron-icon\n            ></paper-button>\n            <paper-button on-tap=\"showNext\"\n              ><iron-icon icon=\"arrow-forward\"></iron-icon\n            ></paper-button>\n          </div>\n          <div style=\"margin: 0 auto; width: 200px; text-align: center\">\n            <h2>[[getDisplayDate(date)]]</h2>\n          </div>\n        </div>\n\n        <div class=\"calendarView\" id=\"calView\"></div>\n      </div>\n    "]);_templateObject_448baad07c0711e98a2471d74bf08c91=function _templateObject_448baad07c0711e98a2471d74bf08c91(){return data};return data}/**
 * `lrn-calendar`
 * @demo demo/index.html
 */var LrnCalendar=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(LrnCalendar,_PolymerElement);babelHelpers.createClass(LrnCalendar,[{key:"_fileChanged",/**
   * Notice the file has changed and attempt to rebind.
   */value:function _fileChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&this.__icalLoaded){this.loadFile();this.getDateInfo();this.createCalendar()}}/**
   * Notice the file has changed and attempt to rebind.
   */},{key:"_viewTypeChanged",value:function _viewTypeChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(this.file)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&this.__icalLoaded){this.getDateInfo();this.createCalendar()}}/**
   * Notice the file has changed and attempt to rebind.
   */},{key:"_dateChanged",value:function _dateChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(this.file)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&this.__icalLoaded){this.getDateInfo();this.createCalendar()}}/**
   * Notice the String of the date has changed and reset the actual date to it
   */},{key:"_dateStringChanged",value:function _dateStringChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&""!=newValue&&this.__icalLoaded){this.date=new Date(newValue)}}/**
   * created life cycle
   */}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_448baad07c0711e98a2471d74bf08c91())}},{key:"tag",get:function get(){return"lrn-calendar"}},{key:"properties",get:function get(){return{/**
       ...
       */file:{type:String,reflectToAttribute:!0,observer:"_fileChanged"}}}}]);function LrnCalendar(){var _this;babelHelpers.classCallCheck(this,LrnCalendar);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrnCalendar).call(this));new Promise(function(res,rej){return _require.default(["../../@polymer/paper-button/paper-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/iron-icons/iron-icons.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/iron-icon/iron-icon.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-card/paper-card.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-menu-button/paper-menu-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-dropdown-menu/paper-dropdown-menu.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../lrnsys-layout/lrnsys-layout.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../lrnsys-layout/lib/lrnsys-drawer.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../lrnsys-layout/lib/lrnsys-dialog.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../lrnsys-layout/lib/lrnsys-collapselist.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../lrnsys-layout/lib/lrnsys-collapselist-item.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./lib/lrn-calendar-date.js"],res,rej)});(0,_renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this)),function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(LrnCalendar.haxProperties,LrnCalendar.tag,this)});var basePath=(0,_resolveUrl.pathFromUrl)(decodeURIComponent(meta.url)),location="".concat(basePath,"lib/ical.js/build/ical.js");window.addEventListener("es-bridge-ical-loaded",_this._icalLoaded.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));window.ESGlobalBridge.requestAvailability();window.ESGlobalBridge.instance.load("ical",location);return _this}babelHelpers.createClass(LrnCalendar,[{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(LrnCalendar.prototype),"disconnectedCallback",this).call(this);window.removeEventListener("es-bridge-ical-loaded",this._icalLoaded.bind(this))}/**
   * ical loaded
   */},{key:"_icalLoaded",value:function _icalLoaded(){this.__icalLoaded=!0;if(babelHelpers.typeof(this.file)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.loadFile()}}/**
   * Attached lifecycle.
   */},{key:"loadFile",/**
   * Load the ical file.
   */value:function loadFile(){this.startIndex=0;this.calendarText=this.readTextFile(this.file);this.listOfEvents=this.getEvents(this.date,this.calendarText);this.listOfEvents=this.sortByTime(this.listOfEvents)}/*
   * Is called to show the previous month/week depending on option selected
   */},{key:"showPrev",value:function showPrev(){var current;this.startIndex=0;if("month"==this.view){if(2==this.date.getMonth()){if(28<this.date.getDate()){current=new Date(this.date.getFullYear(),this.date.getMonth()-1,28)}else{current=new Date(this.date.getFullYear(),this.date.getMonth()-1,this.date.getDate())}}else{current=new Date(this.date.getFullYear(),this.date.getMonth()-1,this.date.getDate())}this.date=current}else{var current=new Date(this.date.getFullYear(),this.date.getMonth(),this.date.getDate()-7);this.date=current}this.startMonth=this.date.getMonth()+1;this.getDateInfo();this.createCalendar()}/*
   * Is called to show the next month/week
   */},{key:"showNext",value:function showNext(){var current;if("month"==this.view){if(11==this.date.getMonth()){current=new Date(this.date.getFullYear()+1,0,this.date.getDate())}else if(0==this.date.getMonth()){if(28<this.date.getDate()){current=new Date(this.date.getFullYear(),this.date.getMonth()+1,28)}else{current=new Date(this.date.getFullYear(),this.date.getMonth()+1,this.date.getDate())}}else{current=new Date(this.date.getFullYear(),this.date.getMonth()+1,this.date.getDate())}this.date=current}else{var current=new Date(this.date.getFullYear(),this.date.getMonth(),this.date.getDate()+7);this.date=current}this.getDateInfo();this.createCalendar()}/**
   * Is called to show the next month/week
   */},{key:"showDate",value:function showDate(){this.startIndex=0;this.date=new Date;this.getDateInfo();this.createCalendar()}//Set the view to month
},{key:"monthView",value:function monthView(){this.view="month";this.startIndex=0;this.createCalendar()}//Set the view to weekly
},{key:"weekView",value:function weekView(){this.view="week";this.startIndex=0;this.createCalendar()}},{key:"readTextFile",value:function readTextFile(file){this.fileNotFound=!1;var rawFile=new XMLHttpRequest,allText="";rawFile.open("GET",file,!1);rawFile.onreadystatechange=function(){if(4===rawFile.readyState){if(200===rawFile.status||0==rawFile.status){allText=rawFile.responseText}else{allText="Not Found"}}};rawFile.send(null);this.calendarText=allText;return allText}/*
   ...
   */},{key:"createCalendar",value:function createCalendar(){if("month"!=this.view){if("week"!=this.view){this.view="month"}}if(!this.date.getFullYear()){this.date=new Date}this.getDateInfo();this.totalDays=7*this.numweeks;this.calendarText=this.readTextFile(this.file);this.calendarView=this.shadowRoot.querySelector("#calView");var days=1,pastDate=0,elem=(0,_polymerDom.dom)(this.shadowRoot.querySelector("#calView")).node,elemChildren=elem.childNodes;while(elemChildren[1]){elem.removeChild(elem.childNodes[1])}//*******************************************************************
//Setup for calendar*******************************************************************
...
if(12==this.currentMonth&&31==this.currentDate){this.currentYear=this.currentYear+1;this.currentMonth=1;this.currentDate=1;this.newDay=new Date(this.currentYear+"/"+this.currentMonth+"/"+this.currentDate)}else{this.currentDate=this.currentDate+1;this.newDay=new Date(this.currentYear+"/"+this.currentMonth+"/"+this.currentDate);if(this.newDay.getDate()!=this.currentDate){if(1==this.currentMonth||3==this.currentMonth||5==this.currentMonth||7==this.currentMonth||8==this.currentMonth||10==this.currentMonth||12==this.currentMonth){this.newDay=new Date(this.currentYear+"/"+(this.currentMonth+1)+"/"+1)}this.currentDate=1;this.currentMonth=this.currentMonth+1}}var dynamicEl=document.createElement("lrn-calendar-date");dynamicEl.valid=!0;dynamicEl.setAttribute("id","date");dynamicEl.date=this.newDay;dynamicEl.style.width="14.25%";dynamicEl.style.display="inline-block";dynamicEl.view=this.view;if(this.date.getFullYear()===this.newDay.getFullYear()&&this.date.getMonth()===this.newDay.getMonth()&&this.date.getDate()===this.newDay.getDate()){dynamicEl.loadeddate=!0}var eventsOnDayMain=this.eventCheck(this.listOfEvents,this.newDay),sendEventMain=this.createReturn(eventsOnDayMain);dynamicEl.events=sendEventMain;if(7>firstWeekCount){dynamicEl.firstWeek=!0}firstWeekCount=firstWeekCount+1;dynamicEl.valid=!0;(0,_polymerDom.dom)(this.calendarView).appendChild(dynamicEl);days=days+1;if(days==this.totalDays&&6!=this.newDay.getDay()){days=days-1;pastDate=1}}}/*
   ...
   */},{key:"createRepeatedEvent",value:function createRepeatedEvent(events,maxRepeat){var iter=events.iterator(events.startDate),next,num=0;while((next=iter.next())&&num++<maxRepeat){var newTest=new ICAL.Event;newTest.summary=events.summary;newTest.description=events.description;newTest.startDate=events.getOccurrenceDetails(next).startDate;newTest.endDate=events.getOccurrenceDetails(next).endDate;var locationString=events.location+"";newTest.location=locationString;if(newTest.startDate._time.day!=events.startDate._time.day||newTest.startDate._time.month!=events.startDate._time.month||newTest.startDate._time.year!=events.startDate._time.year){this.eventArray.push(newTest)}}return}/*
   * Called from eventCheck, gets the start time of an event and returns it
   */},{key:"createDate",value:function createDate(event){var year=event.startDate._time.year,month=event.startDate._time.month,day=event.startDate._time.day,eventDate=new Date(year+"/"+month+"/"+day);return eventDate}/*
   ...
   */},{key:"eventCheck",value:function eventCheck(events,date){for(var eventsOnDay=[],end=events.length,i=this.startIndex,startDay;i<end;i++){startDay=this.createDate(events[i]);if(startDay.getTime()>date.getTime()){end=i;if(0!=i){this.startIndex=i-1}}if(startDay.getTime()==date.getTime()){eventsOnDay.push(events[i])}}return eventsOnDay}/*
   * Organizes the events on a certain day in order based on start time
   */},{key:"sortByTime",value:function sortByTime(eventList){var swapped;do{swapped=!1;for(var i=0;i<eventList.length-1;i++){if(eventList[i].startDate>eventList[i+1].startDate){var temp=eventList[i];eventList[i]=eventList[i+1];eventList[i+1]=temp;swapped=!0}}}while(swapped);return eventList}},{key:"getDateInfo",value:function getDateInfo(){this.startMonth=this.date.getMonth()+1;this.startYear=this.date.getFullYear();this.startDay=this.date.getDate();this.startDayOfWeek=this.date.getDay();this.currentDate=this.startDay;this.currentMonth=this.startMonth;this.currentYear=this.startYear;this.currentDayofWeek=this.startDayOfWeek;return}/*
   * Creates an event array that gets all of the events for that certain day
   */},{key:"createReturn",value:function createReturn(event){for(var EventArray=[],i=0;i<event.length;i++){EventArray.push({event:event[i]})}return EventArray}/*
   * Gets the date to display on the header, currently the month and year. Returns it as a String
   */},{key:"getDisplayDate",value:function getDisplayDate(date){if("function"===typeof date.getMonth){var monthInt=date.getMonth(),day=date.getDate(),monthsArray=["January","February","March","April","May","June","July","August","September","October","November","December"];return monthsArray[monthInt]+" "+date.getFullYear()}return""}}],[{key:"haxProperties",get:function get(){return{canScale:!1,canPosition:!1,canEditSource:!1,gizmo:{title:"Calendar",description:"Present dates.",icon:"icons:today",color:"grey",groups:["Date"],handles:[{type:"ical",source:"file",date:"date"}],meta:{author:"LRNWebComponents"}},settings:{quick:[{property:"file",title:"iCal feed",description:"Calendar feed to display",inputMethod:"textfield",icon:"link",required:!0}],configure:[{property:"file",title:"iCal feed",description:"Calendar feed to display",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"},{property:"view",title:"View calendar in week or month format",description:"week or month view",inputMethod:"select",options:{week:"Week",month:"Month"}},{property:"dateString",title:"Date: yyyy/mm/dd",description:"Date to display calendar",inputMethod:"datepicker"}],advanced:[]}}}}]);return LrnCalendar}(_polymerElement.PolymerElement);_exports.LrnCalendar=LrnCalendar;window.customElements.define(LrnCalendar.tag,LrnCalendar)});