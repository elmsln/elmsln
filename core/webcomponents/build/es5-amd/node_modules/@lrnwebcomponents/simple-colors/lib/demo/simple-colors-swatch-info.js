 ...
 */var simpleColorsSwatchInfo=/*#__PURE__*/function(_SimpleColors){babelHelpers.inherits(simpleColorsSwatchInfo,_SimpleColors);function simpleColorsSwatchInfo(){babelHelpers.classCallCheck(this,simpleColorsSwatchInfo);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(simpleColorsSwatchInfo).apply(this,arguments))}babelHelpers.createClass(simpleColorsSwatchInfo,[{key:"connectedCallback",/**
   * life cycle, element is afixed to the DOM
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(simpleColorsSwatchInfo.prototype),"connectedCallback",this).call(this)}/**
   * life cycle, element is readt
   */},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(simpleColorsSwatchInfo.prototype),"ready",this).call(this)}/**
   ...
   */},{key:"_getAa",value:function _getAa(swatchId,color){var aaLarge=2<arguments.length&&arguments[2]!==void 0?arguments[2]:!1,data=swatchId.split("_"),index=parseInt(data[1]);return this.getContrastingShades(!1,data[0],index,color)}/**
   * given a particular swatch/shade of color,
   ...
   * @param {string} a swatch id (`color_index`)
   * @returns {string} the style
   */},{key:"_getBorder",value:function _getBorder(swatchId){var inverse=1<arguments.length&&arguments[1]!==void 0?arguments[1]:!1,colors=this._getColors(swatchId,inverse);return"border: 3px solid "+colors[0]+"; padding: 3px;"}/**
   ...
   * @param {string} a swatch id (`color_index`)
   * @returns {string} the style
   */},{key:"_getInverseBorder",value:function _getInverseBorder(swatchId){return this._getBorder(swatchId,!0)}/**
   ...
   * @param {string} a swatch id (`color_index`)
   * @returns {string} the style
   */},{key:"_getInverseText",value:function _getInverseText(swatchId){return this._getText(swatchId,!0)}/**
   ...
   * @param {string} a swatch id (`color_index`)
   * @returns {string} the style
   */},{key:"_getText",value:function _getText(swatchId){var inverse=1<arguments.length&&arguments[1]!==void 0?arguments[1]:!1,colors=this._getColors(swatchId,inverse);return"color: "+colors[0]+"; background: "+colors[1]+";"}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_d9318b707cd211e98efbab36cb9e78ba())}/**
   ...
   */},{key:"properties",get:function get(){return{/**
       ...
       */border:{name:"border",type:"String",computed:"_getBorder(swatchId)"},/**
       * A style where swatch color is the border-color in dark mode
       */inverseBorder:{name:"inverseBorder",type:"String",computed:"_getInverseBorder(swatchId)"}}}/**
   * gets simple-colors behaviors
   */},{key:"behaviors",get:function get(){return[_simpleColors.SimpleColors]}/**
