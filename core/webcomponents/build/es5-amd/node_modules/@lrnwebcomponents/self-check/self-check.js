 ...
 */var SelfCheck=/*#__PURE__*/function(_SchemaBehaviors){babelHelpers.inherits(SelfCheck,_SchemaBehaviors);function SelfCheck(){var _this;babelHelpers.classCallCheck(this,SelfCheck);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SelfCheck).call(this));new Promise(function(res,rej){return _require.default(["../../@polymer/paper-card/paper-card.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-icon-button/paper-icon-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/iron-icons/editor-icons.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/iron-icons/iron-icons.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-tooltip/paper-tooltip.js"],res,rej)});return _this}babelHelpers.createClass(SelfCheck,[{key:"openAnswer",/**
   * Property for toggling "checkbtn".
   */value:function openAnswer(e){this.correct=!this.correct}},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(SelfCheck.prototype),"connectedCallback",this).call(this);(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(SelfCheck.haxProperties,SelfCheck.tag,this);new Promise(function(res,rej){return _require.default(["../user-action/user-action.js"],res,rej)})})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_0b427c1083d511e9a39cbd3cd8776fa6())}},{key:"tag",get:function get(){return"self-check"}},{key:"properties",get:function get(){var props={/**
       * Title.
