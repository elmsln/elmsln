 ...
 *
 */var LrndesignChartBehaviors=/*#__PURE__*/function(_SchemaBehaviors){babelHelpers.inherits(LrndesignChartBehaviors,_SchemaBehaviors);function LrndesignChartBehaviors(){babelHelpers.classCallCheck(this,LrndesignChartBehaviors);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignChartBehaviors).apply(this,arguments))}babelHelpers.createClass(LrndesignChartBehaviors,[{key:"ready",/**
   * life cycle, element is ready
   */value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignChartBehaviors.prototype),"ready",this).call(this);var root=this,checkReady=setInterval(function(){if(root.__dataReady){root.$.chartist.makeChart();clearInterval(checkReady)}},1)}/**
   * Convert from csv text to an array in the table function
   */},{key:"handleResponse",value:function handleResponse(e){var root=this,raw=root.CSVtoArray(root.rawData);root.data={labels:raw[0],series:"pie"!==root.type?raw.slice(1,raw.length):raw[1]};root.options=root._getOptions();root.__dataReady=!0}/**
   * override this with type-specific options
   */},{key:"_getOptions",value:function _getOptions(){return{}}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_a3cae380898111e9ba38e33cad2d1624())}// properties available to the custom element for data binding
