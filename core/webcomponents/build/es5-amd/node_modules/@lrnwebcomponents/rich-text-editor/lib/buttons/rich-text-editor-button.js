 ...
 * @customElement
 * @polymer
 */var RichTextEditorButton=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(RichTextEditorButton,_PolymerElement);function RichTextEditorButton(){babelHelpers.classCallCheck(this,RichTextEditorButton);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(RichTextEditorButton).apply(this,arguments))}babelHelpers.createClass(RichTextEditorButton,[{key:"ready",/**
   * life cycle, element is ready
   */value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorButton.prototype),"ready",this).call(this);var root=this;root.addEventListener("mousedown",function(e){e.preventDefault()});root.addEventListener("keypress",function(e){e.preventDefault()})}/**
   * life cycle, element is afixed to the DOM
   */},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorButton.prototype),"connectedCallback",this).call(this);this.__a11y=this.$.button}/**
   * life cycle, element is detatched
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorButton.prototype),"disconnectedCallback",this).call(this)}/**
   * excutes the button's command
   */},{key:"doTextOperation",value:function doTextOperation(){var root=this,selection=root.selection;if(root.toggled&&null!==root.toggledCommand){document.execCommand(root.toggledCommand,!1,root.toggledCommand||"")}else if(null!==root.command){root.dispatchEvent(new CustomEvent(root.command+"-button",{bubbles:!0,cancelable:!0,composed:!0,detail:root}));document.execCommand(root.command,!1,root.commandVal||"");root.selection=selection}}/**
   * determine if the button is toggled
   *
   * @param {object} the text selection
   * @returns {boolean} whether the button is toggled
   *
   */},{key:"_isToggled",value:function _isToggled(selection){var toggled=null!==this.command&&this.toggles?document.queryCommandState(this.command):!1;/*,
   ...
   *
   */},{key:"_getLabel",value:function _getLabel(selection,command,toggles){var toggled=null!==this.command&&toggles?document.queryCommandState(command):!1,label=this._regOrToggled(this.label,this.toggledLabel,toggled);return label}/**
   * Handles button tap;
   */},{key:"_buttonTap",value:function _buttonTap(e){e.preventDefault();this.doTextOperation()}/**
   ...
   */},{key:"_regOrToggled",value:function _regOrToggled(toggledOff,toggledOn,toggled){return null!==toggledOn&&toggled?toggledOn:toggledOff}/**
   ...
   */},{key:"_labelStyle",value:function _labelStyle(icon,showTextLabel){return icon!==void 0&&null!==icon&&""!==icon&&!1===showTextLabel?"offscreen":null}}],[{key:"template",// render function
get:function get(){return(0,_polymerElement.html)(_templateObject_087c2070943911e98e3c411fb3099df0())}// properties available to the custom element for data binding
       ...
       */selection:{name:"selection",type:Object,notify:!0,value:null},/**
       * Show text label even if an icon is named?
       */showTextLabel:{name:"showTextLabel",type:Boolean,value:!1},/**
       * Is this button toggled?
       */toggled:{name:"toggled",type:Boolean,computed:"_isToggled(selection)",notify:!0},/**
       * The label for the button based on its toggled state
       */__label:{name:"__label",type:String,computed:"_getLabel(selection,command,toggles)",notify:!0},/**
   ...
   */},{key:"tag",get:function get(){return"rich-text-editor-button"}}]);return RichTextEditorButton}(_polymerElement.PolymerElement);_exports.RichTextEditorButton=RichTextEditorButton;window.customElements.define(RichTextEditorButton.tag,RichTextEditorButton)});