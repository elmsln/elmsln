 ...
 */var RichTextEditorButton=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(RichTextEditorButton,_PolymerElement);function RichTextEditorButton(){babelHelpers.classCallCheck(this,RichTextEditorButton);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(RichTextEditorButton).apply(this,arguments))}babelHelpers.createClass(RichTextEditorButton,[{key:"ready",/**
   ...
   * @returns {void}
   */},{key:"_editorChanged",value:function _editorChanged(newVal,oldVal){var root=this;root.dispatchEvent(new CustomEvent(root.command+"-button-editor-change",{bubbles:!0,cancelable:!0,composed:!0,detail:root}))}/**
   ...
   *
   */},{key:"_getLabel",value:function _getLabel(range,command,toggles){var toggled=null!==this.command&&toggles?document.queryCommandState(command):!1,label=this._regOrToggled(this.label,this.toggledLabel,toggled);return label}/**
   * determine if the button is toggled
   *
   * @param {object} the text selected range
   * @returns {boolean} whether the button is toggled
   *
   */},{key:"_isToggled",value:function _isToggled(range){var toggled=null!==this.command&&this.toggles?document.queryCommandState(this.command):!1;/*,
...
get:function get(){return(0,_polymerElement.html)(_templateObject_1cada2e096d611e9958011805f8b519d())}// properties available to the custom element for data binding
