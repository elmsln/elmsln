...
get:function get(){return(0,_polymerElement.html)(_templateObject_6322a36096cc11e9bb8ed118ba2d1e5c())}/**
...
if(!window.RichTextEditorPrompt.instance){window.RichTextEditorPrompt.instance=babelHelpers.assertThisInitialized(_this);return babelHelpers.possibleConstructorReturn(_this,babelHelpers.assertThisInitialized(_this))}return _this}/**
   ...
   * Makes sure there is a utility ready and listening for elements.
   */babelHelpers.createClass(RichTextEditorPrompt,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorPrompt.prototype),"connectedCallback",this).call(this);this.__a11yconfirm=this.$.confirm;this.__a11ycancel=this.$.cancel;/*
   ...
   * @returns {void}
   */},{key:"setTarget",value:function setTarget(button){this.clearTarget();this.set("fields",button.fields);this.set("value",button.value);this.__button=button;if(button.__selection)this.for=button.__selection.getAttribute("id")}/**
   ...
   * @param {event} e the event
   * @returns {void}
   */},{key:"_confirm",value:function _confirm(e){e.preventDefault();this.__button.value=this.value;this.__button.confirm();this.clearTarget()}}]);return RichTextEditorPrompt}(_polymerElement.PolymerElement);_exports.RichTextEditorPrompt=RichTextEditorPrompt;window.customElements.define(RichTextEditorPrompt.tag,RichTextEditorPrompt);// register globally so we can make sure there is only one
