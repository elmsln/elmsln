define(["exports","../../@polymer/polymer/polymer-element.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/iron-a11y-keys/iron-a11y-keys.js","./lib/rich-text-editor-styles.js","./lib/singletons/rich-text-editor-clipboard.js","./lib/toolbars/rich-text-editor-toolbar.js","./lib/toolbars/rich-text-editor-toolbar-mini.js","./lib/toolbars/rich-text-editor-toolbar-full.js"],function(_exports,_polymerElement,_HAXWiring,_ironA11yKeys,_richTextEditorStyles,_richTextEditorClipboard,_richTextEditorToolbar,_richTextEditorToolbarMini,_richTextEditorToolbarFull){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.RichTextEditor=void 0;function _templateObject_d855737096d511e9958011805f8b519d(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host([hidden]) {\n          display: none;\n        }\n        :host {\n          display: block;\n          min-height: 20px;\n          cursor: pointer;\n          @apply --rich-text-editor-content;\n        }\n        :host([contenteditable=\"true\"]) {\n          border: var(--rich-text-editor-border);\n          overflow: auto;\n          @apply --rich-text-editor-content-edit;\n        }\n        :host(.heightmax[contenteditable=\"true\"]) {\n          max-height: calc(100vh - 200px);\n          overflow-y: scroll;\n        }\n        :host([contenteditable=\"true\"]):empty:before {\n          content: attr(placeholder);\n          display: block;\n          @apply --rich-text-editor-content-placeholder;\n        }\n      </style>\n      <style include=\"rich-text-editor-styles\"></style>\n      <slot></slot>\n    "]);_templateObject_d855737096d511e9958011805f8b519d=function _templateObject_d855737096d511e9958011805f8b519d(){return data};return data}/**
 * `rich-text-editor`
...
if(!this.toolbar)this.toolbar=this._generateUUID();if(!editor||!editor.addEditableRegion){editor=document.createElement(this.type);editor.id=this.toolbar;root.parentNode.appendChild(editor)}editor.addEditableRegion(root)}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_d855737096d511e9958011805f8b519d())}// haxProperty definition
