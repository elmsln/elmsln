...
if(unix){timestamp=1e3*timestamp}return new Date(timestamp).format(format)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_a7349bd07cd211e98efbab36cb9e78ba())}},{key:"tag",get:function get(){return"simple-datetime"}},{key:"properties",get:function get(){return{/**
