...
// over reported percentages upstream
   ...
   */},{key:"focusEvent",value:function focusEvent(e){// see if it has hover classes
...
if(babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&newValue!==oldValue){this.dispatchEvent(new CustomEvent("node-status-change",{bubbles:!0,cancelable:!0,composed:!0,detail:{status:newValue}}))}}/**
   ...
   */},{key:"_disableStatus",value:function _disableStatus(status){if("disabled"==status){return!0}return!1}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_b48067407c0711e98a2471d74bf08c91())}},{key:"tag",get:function get(){return"lrnsys-progress-circle"}},{key:"properties",get:function get(){return{/**
       * Current value.
       ...
       */_bubbleProgress:{type:Object,value:{25:!1,50:!1,75:!1}}}}}]);return LrnsysProgressCircle}(_polymerElement.PolymerElement);_exports.LrnsysProgressCircle=LrnsysProgressCircle;window.customElements.define(LrnsysProgressCircle.tag,LrnsysProgressCircle)});