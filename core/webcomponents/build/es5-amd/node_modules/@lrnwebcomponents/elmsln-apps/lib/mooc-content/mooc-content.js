 ...
 */var MoocContent=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(MoocContent,_PolymerElement);function MoocContent(){babelHelpers.classCallCheck(this,MoocContent);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MoocContent).apply(this,arguments))}babelHelpers.createClass(MoocContent,[{key:"_modalTap",/**
   * Ensure modal is closed on tap of an item.
   */value:function _modalTap(e){var normalizedEvent=(0,_polymerDom.dom)(e),local=normalizedEvent.localTarget;// verify that it is a buttonß
...
if(window.Drupal){window.Drupal.attachBehaviors(document,window.Drupal.settings)}// first time this fires let's get the outline block in the background
if(babelHelpers.typeof(this.outlineData.data)===("undefined"===typeof void 0?"undefined":"undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.$.fulloutlinepath.generateRequest()}_async.microTask.run(function(){window.dispatchEvent(new Event("resize"))})}}}/**
   * Callback to push the data into the page.
   */},{key:"handleOutlineResponse",value:function handleOutlineResponse(e){// handle the HTML we just got
var data=this.outlineData.data;if(("undefined"===typeof data?"undefined":babelHelpers.typeof(data))!==("undefined"===typeof void 0?"undefined":"undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.$.outlinemodal.innerHTML=data.outline;this.aliases=data.aliases}}},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(MoocContent.prototype),"connectedCallback",this).call(this);(0,_renderStatus.afterNextRender)(this,function(){if(window.Drupal){window.Drupal.attachBehaviors(document,window.Drupal.settings)}})}/**
   ...
   */},{key:"_routeChanged",value:function _routeChanged(data,route,endPoint){if("string"===typeof route.path){// target for url alias that might be delivered into content
...
if(this.__modal&&this.__modal.opened){window.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))}return}else if("edit"==tmp[tmp.length-1]){window.location.reload()}}// test for an node alias, then send off
...
this.requestParams.node=this.nid;this.$.pageajax.generateRequest();// if this is open, close it
if(this.__modal&&this.__modal.opened){window.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))}return}// implies front page on first load, so fix that
...
window.location.reload()}}},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(MoocContent.prototype),"ready",this).call(this);this.__modal=window.SimpleModal.requestAvailability()}/**
   * Reset scroll position visually and internally data wise.
   */},{key:"_resetScroll",value:function _resetScroll(){var item=0<arguments.length&&arguments[0]!==void 0?arguments[0]:"anchor";this.resetScroll=!0;this.$[item].scrollIntoView({block:"nearest",behavior:"smooth"})}/**
   ...
   * what this enables.
   */},{key:"__injectStyle",value:function __injectStyle(style){// target and wipe our id area by force
if(null!=this.$.hackycsspotterhates){(0,_polymerDom.dom)(this.$.hackycontainer).innerHTML=""}// construct a new style tag and inject it overtop of what was there previously
...
(0,_polymerDom.dom)(this.$.hackycontainer).appendChild(customStyle)}/**
   * highjack shadowDom
   */},{key:"_attachDom",value:function _attachDom(dom){this.appendChild(dom)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_bc1eea80898111e9ba38e33cad2d1624())}},{key:"tag",get:function get(){return"mooc-content"}},{key:"observers",get:function get(){return["_routeChanged(data, route, endPoint)"]}},{key:"properties",get:function get(){var _ref;return _ref={elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},/**
       * Source of data
       ...
       */responseData:{type:Object,value:{}}},babelHelpers.defineProperty(_ref,"basePath",{type:String}),babelHelpers.defineProperty(_ref,"elmslnCourse",{type:String}),babelHelpers.defineProperty(_ref,"outlineTitle",{type:String}),babelHelpers.defineProperty(_ref,"nid",{type:Number}),babelHelpers.defineProperty(_ref,"_loading",{type:Boolean,observer:"_contentLoading",value:!1}),babelHelpers.defineProperty(_ref,"loading",{type:Boolean,reflectToAttribute:!0,value:!1}),babelHelpers.defineProperty(_ref,"aliases",{type:Array}),babelHelpers.defineProperty(_ref,"activeNodeItem",{type:Object,value:null}),_ref}}]);return MoocContent}(_polymerElement.PolymerElement);_exports.MoocContent=MoocContent;window.customElements.define(MoocContent.tag,MoocContent)});