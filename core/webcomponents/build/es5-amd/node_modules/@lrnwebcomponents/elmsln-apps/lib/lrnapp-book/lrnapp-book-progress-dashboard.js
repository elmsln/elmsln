...
*/var LrnappBookProgressDashboard=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(LrnappBookProgressDashboard,_PolymerElement);function LrnappBookProgressDashboard(){babelHelpers.classCallCheck(this,LrnappBookProgressDashboard);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrnappBookProgressDashboard).apply(this,arguments))}babelHelpers.createClass(LrnappBookProgressDashboard,[{key:"_routeDataChanged",/**
   * Notice route data has changed.
   */value:function _routeDataChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.requestParams[newValue.type]=newValue.id;// if we're visible kick off the call
if(this.progressChanged){this.$.dataajax.generateRequest()}}}/**
   * Showing element state has changed
   */},{key:"_showProgressChanged",value:function _showProgressChanged(newValue,oldValue){// ensure we are visible
if(newValue&&babelHelpers.typeof(this.routeData)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.$.dataajax.generateRequest()}}/**
   * Response data.
   */},{key:"handleDataResponse",value:function handleDataResponse(obj){var response=obj.detail.response.data;// show the info
...
this.userData=response.userdata;this.dashboardItems=this._toArray(response.items)}/**
   ...
   */},{key:"_toArray",value:function _toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_b50d8760898111e9ba38e33cad2d1624())}},{key:"tag",get:function get(){return"lrnapp-book-progress-dashboard"}},{key:"properties",get:function get(){return{/**
       ...
       */showProgress:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"_showProgressChanged"}}}}]);return LrnappBookProgressDashboard}(_polymerElement.PolymerElement);_exports.LrnappBookProgressDashboard=LrnappBookProgressDashboard;window.customElements.define(LrnappBookProgressDashboard.tag,LrnappBookProgressDashboard)});