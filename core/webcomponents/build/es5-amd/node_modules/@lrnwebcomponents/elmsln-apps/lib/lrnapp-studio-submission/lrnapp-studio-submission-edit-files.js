define(["exports","../../../../@polymer/polymer/polymer-element.js","../../../../@polymer/polymer/lib/elements/dom-repeat.js","../../../../@polymer/polymer/lib/elements/dom-if.js","../../../secure-request/secure-request.js","../../../../@polymer/iron-icon/iron-icon.js","../../../../@polymer/paper-button/paper-button.js","../../../../@vaadin/vaadin-upload/vaadin-upload.js","../../../simple-modal/lib/simple-modal-template.js","./lrnapp-studio-submission-edit-add-asset.js","./lrnapp-studio-submission-edit-file.js"],function(_exports,_polymerElement,_domRepeat,_domIf,_secureRequest,_ironIcon,_paperButton,_vaadinUpload,_simpleModalTemplate,_lrnappStudioSubmissionEditAddAsset,_lrnappStudioSubmissionEditFile){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrnappStudioSubmissionEditFiles=void 0;function _templateObject_dd4c3ce083ae11e9bca9910ed3db32b8(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n          position: relative;\n          min-height: 200px;\n        }\n        #pages {\n          display: block;\n        }\n        .files__files {\n          display: flex;\n          flex-wrap: wrap;\n        }\n        .files__files > * {\n          margin-right: 16px;\n          min-width: 200px;\n        }\n      </style>\n\n      <div class=\"files__files\">\n        <template is=\"dom-repeat\" items=\"{{files}}\" as=\"file\">\n          <lrnapp-studio-submission-edit-file\n            file=\"{{file}}\"\n            on-deleted=\"_deleteImage\"\n            data-index$=\"[[index]]\"\n          ></lrnapp-studio-submission-edit-file>\n        </template>\n        <lrnapp-studio-submission-edit-add-asset\n          on-click=\"_addImage\"\n          icon=\"editor:attach-file\"\n        ></lrnapp-studio-submission-edit-add-asset>\n      </div>\n      <simple-modal-template id=\"dialog\" title=\"Add Files\">\n        <div slot=\"header\">Add Files</div>\n        <div class=\"files__upload\" slot=\"content\">\n          <template is=\"dom-if\" if=\"[[uploadUrl]]\">\n            <vaadin-upload\n              accept=\"[[fileTypes]]\"\n              target=\"[[uploadUrl]]\"\n              method=\"POST\"\n              form-data-name=\"file-upload\"\n              on-upload-success=\"_handleImageUploadSuccess\"\n            >\n              <div class=\"files__drop-label\">\n                <iron-icon icon=\"description\"></iron-icon>\n                Upload files here:\n              </div>\n            </vaadin-upload>\n          </template>\n        </div>\n        <div slot=\"buttons\">\n          <paper-button dialog-dismiss>Cancel</paper-button>\n        </div>\n      </simple-modal-template>\n    "],["\n      <style>\n        :host {\n          display: block;\n          position: relative;\n          min-height: 200px;\n        }\n        #pages {\n          display: block;\n        }\n        .files__files {\n          display: flex;\n          flex-wrap: wrap;\n        }\n        .files__files > * {\n          margin-right: 16px;\n          min-width: 200px;\n        }\n      </style>\n\n      <div class=\"files__files\">\n        <template is=\"dom-repeat\" items=\"{{files}}\" as=\"file\">\n          <lrnapp-studio-submission-edit-file\n            file=\"{{file}}\"\n            on-deleted=\"_deleteImage\"\n            data-index\\$=\"[[index]]\"\n          ></lrnapp-studio-submission-edit-file>\n        </template>\n        <lrnapp-studio-submission-edit-add-asset\n          on-click=\"_addImage\"\n          icon=\"editor:attach-file\"\n        ></lrnapp-studio-submission-edit-add-asset>\n      </div>\n      <simple-modal-template id=\"dialog\" title=\"Add Files\">\n        <div slot=\"header\">Add Files</div>\n        <div class=\"files__upload\" slot=\"content\">\n          <template is=\"dom-if\" if=\"[[uploadUrl]]\">\n            <vaadin-upload\n              accept=\"[[fileTypes]]\"\n              target=\"[[uploadUrl]]\"\n              method=\"POST\"\n              form-data-name=\"file-upload\"\n              on-upload-success=\"_handleImageUploadSuccess\"\n            >\n              <div class=\"files__drop-label\">\n                <iron-icon icon=\"description\"></iron-icon>\n                Upload files here:\n              </div>\n            </vaadin-upload>\n          </template>\n        </div>\n        <div slot=\"buttons\">\n          <paper-button dialog-dismiss>Cancel</paper-button>\n        </div>\n      </simple-modal-template>\n    "]);_templateObject_dd4c3ce083ae11e9bca9910ed3db32b8=function _templateObject_dd4c3ce083ae11e9bca9910ed3db32b8(){return data};return data}var LrnappStudioSubmissionEditFiles=/*#__PURE__*/function(_SecureRequestXhr){babelHelpers.inherits(LrnappStudioSubmissionEditFiles,_SecureRequestXhr);function LrnappStudioSubmissionEditFiles(){babelHelpers.classCallCheck(this,LrnappStudioSubmissionEditFiles);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrnappStudioSubmissionEditFiles).apply(this,arguments))}babelHelpers.createClass(LrnappStudioSubmissionEditFiles,[{key:"_filesChanged",value:function _filesChanged(files){}},{key:"_addImage",value:function _addImage(e){// @todo switch to singleton
