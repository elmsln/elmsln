define(["exports","../../@polymer/polymer/polymer-element.js"],function(_exports,_polymerElement){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.BeakerBroker=void 0;function _templateObject_68f90f407cd211e98efbab36cb9e78ba(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n    "]);_templateObject_68f90f407cd211e98efbab36cb9e78ba=function _templateObject_68f90f407cd211e98efbab36cb9e78ba(){return data};return data}/**
 * `beaker-broker`
...
this.set("archive",new DatArchive(newValue))}case 1:case"end":return _context.stop();}}},_callee,this)}));return function _datUrlChanged(_x,_x2){return _datUrlChanged2.apply(this,arguments)}}()/**
   * Write to file
   * @usage - this.write('hello.txt', 'things and stuff');
   */},{key:"write",value:function(){var _write=babelHelpers.asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee2(path,data){return regeneratorRuntime.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_context2.next=2;return this.archive.writeFile(path,data);case 2:case"end":return _context2.stop();}}},_callee2,this)}));return function write(_x3,_x4){return _write.apply(this,arguments)}}()/**
   * Read to file
