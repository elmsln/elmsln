...
*/var SillyHaxGame=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_10ec7830898111e9ba38e33cad2d1624()),is:"silly-hax-game",properties:{/**
   ...
   */_resetTimer:function _resetTimer(e){this.$.timer.pause();this.playing=!1;this.timer=0;this.set("tasks",[])},_haxTextValue:function _haxTextValue(time){if(babelHelpers.typeof(time)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))||60==time){return"Take the HAX challenge"}else{return time.toFixed(2)}},/**
