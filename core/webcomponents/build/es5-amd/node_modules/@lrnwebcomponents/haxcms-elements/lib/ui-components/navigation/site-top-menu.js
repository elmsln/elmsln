 ...
 */var SiteTopMenu=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(SiteTopMenu,_PolymerElement);babelHelpers.createClass(SiteTopMenu,null,[{key:"tag",/**
   ...
   */get:function get(){return"site-top-menu"}}]);function SiteTopMenu(){var _this;babelHelpers.classCallCheck(this,SiteTopMenu);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SiteTopMenu).call(this));_this.__disposer=[];new Promise(function(res,rej){return _require.default(["../../../../../@polymer/paper-tooltip/paper-tooltip.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../../../@polymer/paper-button/paper-button.js"],res,rej)});return _this}// render function
...
this.$.indicator.classList.remove("activated")}}}},{key:"connectedCallback",value:function connectedCallback(){var _this3=this;babelHelpers.get(babelHelpers.getPrototypeOf(SiteTopMenu.prototype),"connectedCallback",this).call(this);(0,_mobxModule.autorun)(function(reaction){_this3.manifest=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.manifest);_this3.__disposer.push(reaction)});(0,_mobxModule.autorun)(function(reaction){_this3.editMode=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.editMode);_this3.__disposer.push(reaction)});// minor timing thing to ensure store has picked active
// needed if routes set on first paint or lifecycles miss
setTimeout(function(){(0,_mobxModule.autorun)(function(reaction){_this3.activeId=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.activeId);_this3.__disposer.push(reaction)})},50);window.addEventListener("resize",function(){_this3._activeIdChanged(_this3.activeId)},!0)}},{key:"disconnectedCallback",value:function disconnectedCallback(){var _this4=this;// clean up state
for(var i in this.__disposer){this.__disposer[i].dispose()}window.removeEventListener("resize",function(){_this4._activeIdChanged(_this4.activeId)},!0);babelHelpers.get(babelHelpers.getPrototypeOf(SiteTopMenu.prototype),"disconnectedCallback",this).call(this)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_6b17f55096b511e9829757de2ff72774())}/**
   * Props
   */},{key:"properties",get:function get(){return{/**
       ...
       */conditions:{type:Object,value:{parent:null}},position:{type:String,value:"bottom"},editMode:{type:Boolean,reflectToAttribute:!0}}}}]);return SiteTopMenu}(_polymerElement.PolymerElement);_exports.SiteTopMenu=SiteTopMenu;window.customElements.define(SiteTopMenu.tag,SiteTopMenu)});