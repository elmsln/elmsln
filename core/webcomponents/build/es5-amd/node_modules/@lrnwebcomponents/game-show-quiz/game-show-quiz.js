...
this.shadowRoot.querySelector("#dialog").toggle();this.scoreBoardToggle({});var _evt2=new CustomEvent("simple-toast-show",{bubbles:!0,cancelable:!0,detail:{text:"Game over!",duration:5e3}});this.dispatchEvent(_evt2)}}}/**
...
this.set("gameBoard",[]);setTimeout(function(){_this4.set("gameBoard",gameBoard);_this4.notifyPath("gameBoard.*")},100)}}},{key:"generateUUID",value:function generateUUID(){return"item-sss-ss-ss".replace(/s/g,this._uuidPart)}},{key:"_uuidPart",value:function _uuidPart(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}/**
   ...
   * Attached to the DOM
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(GameShowQuiz.prototype),"connectedCallback",this).call(this);window.SimpleToast.requestAvailability();(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(GameShowQuiz.haxProperties,GameShowQuiz.tag,this);this.shadowRoot.querySelector("#dismiss").addEventListener("tap",this.resetFocus.bind(this));this.shadowRoot.querySelector("#contentcontainer").addEventListener("tap",this._gameBoardTap.bind(this));this.shadowRoot.querySelector("#submit").addEventListener("tap",this.submitAnswer.bind(this));this.shadowRoot.querySelector("#continue").addEventListener("tap",this.continueGameTap.bind(this));this.shadowRoot.querySelector("#question").addEventListener("click",this.registerTap.bind(this))})}/**
   * detached life cycke
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){this.shadowRoot.querySelector("#dismiss").removeEventListener("tap",this.resetFocus.bind(this));this.shadowRoot.querySelector("#contentcontainer").removeEventListener("tap",this._gameBoardTap.bind(this));this.shadowRoot.querySelector("#submit").removeEventListener("tap",this.submitAnswer.bind(this));this.shadowRoot.querySelector("#continue").removeEventListener("tap",this.continueGameTap.bind(this));this.shadowRoot.querySelector("#question").removeEventListener("click",this.registerTap.bind(this));babelHelpers.get(babelHelpers.getPrototypeOf(GameShowQuiz.prototype),"disconnectedCallback",this).call(this)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_6b4a79507cd211e98efbab36cb9e78ba())}},{key:"properties",get:function get(){return{/**
       * Title
