 ...
 */var HexagonLoader=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HexagonLoader,_PolymerElement);function HexagonLoader(){babelHelpers.classCallCheck(this,HexagonLoader);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HexagonLoader).apply(this,arguments))}babelHelpers.createClass(HexagonLoader,[{key:"connectedCallback",/**
   * life cycle, element is afixed to the DOM
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(HexagonLoader.prototype),"connectedCallback",this).call(this);for(var items=[],i=0;i<this.itemCount;i++){items.push("")}this.set("items",items)}/**
   * Color changed
   */},{key:"_colorChanged",value:function _colorChanged(newValue,oldValue){if(newValue){this.updateStyles({"--hexagon-color":newValue})}}/**
   * life cycle, element is removed from the DOM
   */ //disconnectedCallback() {}
}],[{key:"template",// render function
get:function get(){return(0,_polymerElement.html)(_templateObject_5aaf3890898111e9ba38e33cad2d1624())}// properties available to the custom element for data binding
   ...
   */},{key:"tag",get:function get(){return"hexagon-loader"}}]);return HexagonLoader}(_polymerElement.PolymerElement);_exports.HexagonLoader=HexagonLoader;window.customElements.define(HexagonLoader.tag,HexagonLoader)});