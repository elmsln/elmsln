define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","./a11y-collapse-button-styles.js","../../../@polymer/iron-icon/iron-icon.js","../../../@polymer/paper-tooltip/paper-tooltip.js"],function(_exports,_polymerElement,_renderStatus,_a11yCollapseButtonStyles,_ironIcon,_paperTooltip){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.A11yCollapseAccordionButton=void 0;function _templateObject_b2db8ca07cd211e98efbab36cb9e78ba(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style include=\"a11y-collapse-button-styles\">\n        :host #heading:focus,\n        :host #heading:hover {\n          @apply --a11y-collapse-heading-focus;\n        }\n        :host #heading:focus #text,\n        :host #heading:hover #text {\n          @apply --a11y-collapse-heading-text-focus;\n        }\n        :host #heading:focus #expand,\n        :host #heading:hover #expand {\n          @apply --a11y-collapse-icon-focus;\n        }\n      </style>\n      <div\n        id=\"heading\"\n        aria-controls=\"content\"\n        aria-expanded$=\"[[expanded]]\"\n        disabled$=\"[[disabled]]\"\n        label$=\"[[label]]\"\n        role=\"button\"\n      >\n        <div id=\"text\"><slot></slot></div>\n        <iron-icon\n          id=\"expand\"\n          aria-hidden=\"true\"\n          icon$=\"[[icon]]\"\n          rotated$=\"[[rotated]]\"\n        >\n        </iron-icon>\n      </div>\n      <paper-tooltip for=\"heading\" offset=\"24\">[[tooltip]]</paper-tooltip>\n    "],["\n      <style include=\"a11y-collapse-button-styles\">\n        :host #heading:focus,\n        :host #heading:hover {\n          @apply --a11y-collapse-heading-focus;\n        }\n        :host #heading:focus #text,\n        :host #heading:hover #text {\n          @apply --a11y-collapse-heading-text-focus;\n        }\n        :host #heading:focus #expand,\n        :host #heading:hover #expand {\n          @apply --a11y-collapse-icon-focus;\n        }\n      </style>\n      <div\n        id=\"heading\"\n        aria-controls=\"content\"\n        aria-expanded\\$=\"[[expanded]]\"\n        disabled\\$=\"[[disabled]]\"\n        label\\$=\"[[label]]\"\n        role=\"button\"\n      >\n        <div id=\"text\"><slot></slot></div>\n        <iron-icon\n          id=\"expand\"\n          aria-hidden=\"true\"\n          icon\\$=\"[[icon]]\"\n          rotated\\$=\"[[rotated]]\"\n        >\n        </iron-icon>\n      </div>\n      <paper-tooltip for=\"heading\" offset=\"24\">[[tooltip]]</paper-tooltip>\n    "]);_templateObject_b2db8ca07cd211e98efbab36cb9e78ba=function _templateObject_b2db8ca07cd211e98efbab36cb9e78ba(){return data};return data}/**
 ...
 */var A11yCollapseAccordionButton=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(A11yCollapseAccordionButton,_PolymerElement);function A11yCollapseAccordionButton(){babelHelpers.classCallCheck(this,A11yCollapseAccordionButton);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(A11yCollapseAccordionButton).apply(this,arguments))}babelHelpers.createClass(A11yCollapseAccordionButton,[{key:"connectedCallback",/**
   * life cycle
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(A11yCollapseAccordionButton.prototype),"connectedCallback",this).call(this);(0,_renderStatus.afterNextRender)(this,function(){this.addEventListener("tap",this._onTap.bind(this))})}/**
   * Handle tap
   */},{key:"_onTap",value:function _onTap(e){if(!this.disabled){this.dispatchEvent(new CustomEvent("a11y-collapse-tap",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}}],[{key:"tag",get:function get(){return"a11y-collapse-accordion-button"}},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_b2db8ca07cd211e98efbab36cb9e78ba())}},{key:"properties",get:function get(){return{/**
       * is disabled?
