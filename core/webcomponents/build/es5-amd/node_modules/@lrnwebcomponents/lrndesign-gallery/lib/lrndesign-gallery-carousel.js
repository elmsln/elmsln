 ...
 */var LrndesignGalleryCarousel=/*#__PURE__*/function(_LrndesignGalleryBeha){babelHelpers.inherits(LrndesignGalleryCarousel,_LrndesignGalleryBeha);function LrndesignGalleryCarousel(){babelHelpers.classCallCheck(this,LrndesignGalleryCarousel);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignGalleryCarousel).apply(this,arguments))}babelHelpers.createClass(LrndesignGalleryCarousel,[{key:"ready",/**
   ...
   */value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryCarousel.prototype),"ready",this).call(this);if(this.selected.scroll){var target=this.$.carouselitem;this._scrollIntoView([this._getParentOffset(target)]);if(!this.selected.zoomed)target.focus()}}/**
   ...
   */},{key:"_onPrev",value:function _onPrev(e){this.goToItem(parseInt(this.$.carouselprev.getAttribute("index")))}/**
   * when a next is tapped, goes to the next item
   */},{key:"_onNext",value:function _onNext(e){this.goToItem(parseInt(this.$.carouselnext.getAttribute("index")))}/**
   ...
   */},{key:"_updateDetails",value:function _updateDetails(){this.$.itembody.innerHTML=this.item.details}}],[{key:"tag",/**
...
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_a628f7c0898111e9ba38e33cad2d1624())}// properties available to the custom element for data binding
