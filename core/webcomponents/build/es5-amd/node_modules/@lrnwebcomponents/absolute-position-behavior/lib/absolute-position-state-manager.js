 ...
 */var AbsolutePositionStateManager=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(AbsolutePositionStateManager,_PolymerElement);babelHelpers.createClass(AbsolutePositionStateManager,null,[{key:"tag",/* REQUIRED FOR TOOLING DO NOT TOUCH */ /**
   ...
   */}]);function AbsolutePositionStateManager(){var _this;babelHelpers.classCallCheck(this,AbsolutePositionStateManager);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(AbsolutePositionStateManager).call(this));var root=babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this));// sets the instance to the current instance
if(!window.AbsolutePositionStateManager.instance){window.AbsolutePositionStateManager.instance=babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this));return babelHelpers.possibleConstructorReturn(_this,babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this)))}return _this}/**
