...
*/var EditableTableEditor=/*#__PURE__*/function(_editBehaviors){babelHelpers.inherits(EditableTableEditor,_editBehaviors);function EditableTableEditor(){babelHelpers.classCallCheck(this,EditableTableEditor);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(EditableTableEditor).apply(this,arguments))}babelHelpers.createClass(EditableTableEditor,[{key:"ready",/**
   * click detection
   */value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(EditableTableEditor.prototype),"ready",this).call(this);this.onclick=function(e){var el=null!==e.srcElement&&null!==e.srcElement.tagName&&"td"===e.srcElement.tagName.toLowerCase()?e.srcElement:!1;if(el&&null!==el.getElementsByTagName("editable-table-cell")){console.log(el.children[0]);el.children[0].focus()}}}},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(EditableTableEditor.prototype),"connectedCallback",this).call(this);(0,_renderStatus.afterNextRender)(this,function(){this.addEventListener("cell-move",this._onCellMove.bind(this));this.addEventListener("cell-value-changed",this._onCellValueChange.bind(this));this.addEventListener("insert-row",this._handleInsertRow.bind(this));this.addEventListener("insert-column",this._handleInsertColumn.bind(this));this.addEventListener("delete-row",this._handleDeleteRow.bind(this));this.addEventListener("delete-column",this._handleDeleteColumn.bind(this));this.addEventListener("editable-table-setting-changed",this._onTableSettingChange.bind(this));this.addEventListener("dropdown-select-changed",this._onAccentChange.bind(this))})}},{key:"disconnectedCallback",value:function disconnectedCallback(){this.removeEventListener("cell-move",this._onCellMove.bind(this));this.removeEventListener("cell-value-changed",this._onCellValueChange.bind(this));this.removeEventListener("insert-row",this._handleInsertRow.bind(this));this.removeEventListener("insert-column",this._handleInsertColumn.bind(this));this.removeEventListener("delete-row",this._handleDeleteRow.bind(this));this.removeEventListener("delete-column",this._handleDeleteColumn.bind(this));this.removeEventListener("editable-table-setting-changed",this._onTableSettingChange.bind(this));this.removeEventListener("dropdown-select-changed",this._onAccentChange.bind(this));babelHelpers.get(babelHelpers.getPrototypeOf(EditableTableEditor.prototype),"disconnectedCallback",this).call(this)}/**
   * Get the current accent color
   */},{key:"_getAccentSelected",value:function _getAccentSelected(accentColor){return null!==accentColor?accentColor:"none"}/**
   * Gets the row data for a given row index
   */},{key:"_getCurrentRow",value:function _getCurrentRow(index,data){var row=null;if(data!==void 0&&null!==data&&data[index]!==void 0&&null!==data[index]){row=data[index]}return row}/**
   * Handles delete column event
   */},{key:"_handleDeleteColumn",value:function _handleDeleteColumn(e){this.deleteColumn(e.detail)}/**
   * Handles delete row event
   */},{key:"_handleDeleteRow",value:function _handleDeleteRow(e){this.deleteRow(e.detail)}/**
   * Handles insert column event
   */},{key:"_handleInsertColumn",value:function _handleInsertColumn(e){this.insertColumn(e.detail)}/**
   * Handles insert row event
   */},{key:"_handleInsertRow",value:function _handleInsertRow(e){this.insertRow(e.detail)}/**
   * Tests for first row of data. Workaround to restamp column headers.
   */},{key:"_isFirstRow",value:function _isFirstRow(index){return 0===index}/**
   * Handle accent dropdown-select change
   */},{key:"_onAccentChange",value:function _onAccentChange(e){this.accentColor="none"!==e.detail.value?e.detail.value:null}/**
   * Move the focus/cursor to the correct cell when navigation keys are pressed
   */},{key:"_onCellMove",value:function _onCellMove(e){var dir=e.detail.direction,cell=e.detail.cell,row=cell.parentNode,body=this.$.tbody,x=Array.prototype.indexOf.call(row.children,cell),y=Array.prototype.indexOf.call(body.children,row);if("down"===dir){if(y+1<body.children.length-1){body.children[y+1].children[x].children[0].setFocus()}else{this.insertRow(y)}}else if("up"===dir){if(0<y){body.children[y-1].children[x].children[0].setFocus()}}else if("right"===dir){if(x+1<row.children.length-1){row.children[x+1].children[0].setFocus()}else if(y+1<body.children.length-1){body.children[y+1].children[1].children[0].setFocus()}}else if("left"===dir){if(1<x){row.children[x-1].children[0].setFocus()}else if(0<y){body.children[y-2].children[body.children[y-2].children.length-2].children[0].setFocus()}}}/**
   * Updates data when cell value changes
   */},{key:"_onCellValueChange",value:function _onCellValueChange(e){this.set("data."+e.detail.row+"."+e.detail.column,e.detail.value)}/**
   * Updates table properties when setting changes
   */},{key:"_onTableSettingChange",value:function _onTableSettingChange(e){this[e.detail.prop]=e.detail.value}/**
   * Makes sure there is always on cell to work from
   */},{key:"_setMinimumData",value:function _setMinimumData(data){if(1>data.length||1>data[0].length){this.set("data",[["","",""],["","",""],["","",""]])}}/**
   * Are all of the table style choices hidden?
   */},{key:"_tableStylesHidden",value:function _tableStylesHidden(hideBordered,hideCondensed,hideStriped,hideScroll){return hideBordered&&hideCondensed&&hideStriped&&hideScroll}/**
   * Are all of the theme choices hidden?
   */},{key:"_tableThemeHidden",value:function _tableThemeHidden(hideAccentColor,hideDarkTheme){return hideAccentColor&&hideDarkTheme}/**
   * Are all of the theme choices hidden?
   */},{key:"_tableSortHidden",value:function _tableSortHidden(hideSort,hideFilter){return hideSort&&hideFilter}/**
   * Delete a column at the given index
   */},{key:"deleteColumn",value:function deleteColumn(index){if(confirm("Delete entire column?")){for(var i=0;i<this.data.length;i++){this.splice("data."+i,index,1)}}}/**
   * Delete a row at the given index
   */},{key:"deleteRow",value:function deleteRow(index){if(confirm("Delete entire row?")){this.splice("data",index,1)}}/**
   * Insert a column at the given index
   */},{key:"insertColumn",value:function insertColumn(index){for(var temp=[],first=null,i=0;i<this.data.length;i++){this.splice("data."+i,index,0,"")}}/**
   * Insert a row at the given index
   */},{key:"insertRow",value:function insertRow(index){for(var temp=[],i=0;i<this.data[0].length;i++){temp.push("")}this.splice("data",index+1,0,temp)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_97fa2390898111e9ba38e33cad2d1624())}},{key:"tag",get:function get(){return"editable-table-editor"}},{key:"observers",get:function get(){return["_setMinimumData(data)"]}},{key:"properties",get:function get(){return{/**
       * Get accent color and change unspecified to none.
       */accentSelected:{type:String,computed:"_getAccentSelected(accentColor)"},/**
       * Hide the table styles menu
       */hideTableStyles:{type:Boolean,computed:"_tableStylesHidden(hideBordered,hideCondensed,hideStriped,hideScroll)"},/**
       * Hide the table theme menu
       */hideTableTheme:{type:Boolean,computed:"_tableThemeHidden(hideAccentColor,hideDarkTheme)"},/**
       * Hide the table sorting & filtering menu
       */hideTableSort:{type:Boolean,computed:"_tableSortHidden(hideSort,hideFilter)"}}}}]);return EditableTableEditor}((0,_editableTableBehaviors.editBehaviors)((0,_editableTableBehaviors.displayBehaviors)((0,_responsiveUtilityBehaviors.ResponsiveUtilityBehaviors)(_polymerElement.PolymerElement))));_exports.EditableTableEditor=EditableTableEditor;window.customElements.define(EditableTableEditor.tag,EditableTableEditor)});