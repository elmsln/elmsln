define(["exports","meta","../../@polymer/polymer/polymer-element.js","../es-global-bridge/es-global-bridge.js","../../@polymer/polymer/lib/utils/resolve-url.js"],function(_exports,meta,_polymerElement,_esGlobalBridge,_resolveUrl){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.Hal9000=void 0;meta=babelHelpers.interopRequireWildcard(meta);function _templateObject_e8a9854083d411e9a39cbd3cd8776fa6(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n        [hidden] {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n    "]);_templateObject_e8a9854083d411e9a39cbd3cd8776fa6=function _templateObject_e8a9854083d411e9a39cbd3cd8776fa6(){return data};return data}/**
 * `hal-9000`
...
get:function get(){return(0,_polymerElement.html)(_templateObject_e8a9854083d411e9a39cbd3cd8776fa6())}// properties available to the custom element for data binding
