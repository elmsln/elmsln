...
*/var CMSToken=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(CMSToken,_PolymerElement);function CMSToken(){babelHelpers.classCallCheck(this,CMSToken);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(CMSToken).apply(this,arguments))}babelHelpers.createClass(CMSToken,[{key:"_displayModeChanged",/**
...
this.token=this.token.replace(oldValue,newValue)}}/**
   ...
   */},{key:"_handleTokenResponse",value:function _handleTokenResponse(newValue,oldValue){var _this=this;if(null!==newValue&&babelHelpers.typeof(newValue.content)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){// store the text and url callbacks in the event we're in an editing mode
...
_async.microTask.run(function(){var template=document.createElement("template");template.innerHTML=newValue.content;(0,_polymerDom.dom)(_this).appendChild(document.importNode(template.content,!0));_this.loading=!1})}}/**
   * Token end point changed
   */},{key:"_tokenChanged",value:function _tokenChanged(newValue,oldValue){var _this2=this;// ensure we have something and are not loading currently
...
if(babelHelpers.typeof(this.tokenEndPoint)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(window.cmstokenEndPoint)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.tokenEndPoint=window.cmstokenEndPoint}if(this.tokenEndPoint){this.loading=!0;_async.microTask.run(function(){_this3.$.tokenrequest.generateRequest()})}}}(0,_renderStatus.afterNextRender)(this,function(){document.addEventListener("visibilitychange",this._windowVisibilityChanged.bind(this));this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(CMSToken.haxProperties,CMSToken.tag,this)})}/**
...
if(babelHelpers.typeof(this.tokenData)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){href=this.tokenData.editEndpoint;slot=this.tokenData.editText;for(var i in this.tokenData.schema){schema.properties[i]=this.tokenData.schema[i]}}schema.properties.__editThis={type:"string",component:{name:"a",properties:{id:"cmstokenidtolockonto",href:href,target:"_blank"},slot:slot}};return schema}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_eca2230096d511e9958011805f8b519d())}},{key:"tag",get:function get(){return"cms-token"}},{key:"properties",get:function get(){return{/**
       * Loading state
