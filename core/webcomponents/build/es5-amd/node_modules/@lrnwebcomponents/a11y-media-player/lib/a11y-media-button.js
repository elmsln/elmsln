 ...
 * @customElement
 * @polymer
 */var A11yMediaButton=/*#__PURE__*/function(_A11yMediaBehaviors){babelHelpers.inherits(A11yMediaButton,_A11yMediaBehaviors);function A11yMediaButton(){babelHelpers.classCallCheck(this,A11yMediaButton);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(A11yMediaButton).apply(this,arguments))}babelHelpers.createClass(A11yMediaButton,[{key:"connectedCallback",/**
   ...
   */},{key:"_buttonTap",value:function _buttonTap(){this.dispatchEvent(new CustomEvent("click",{detail:this}))}}],[{key:"properties",// properties available to the custom element for data binding
get:function get(){return{/**
   ...
   */},{key:"tag",get:function get(){return"a11y-media-button"}//get player-specifc properties
},{key:"behaviors",get:function get(){return[_a11yMediaBehaviors.A11yMediaBehaviors]}//render function
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_92f0ec80898111e9ba38e33cad2d1624())}}]);return A11yMediaButton}(_a11yMediaBehaviors.A11yMediaBehaviors);_exports.A11yMediaButton=A11yMediaButton;window.customElements.define(A11yMediaButton.tag,A11yMediaButton)});