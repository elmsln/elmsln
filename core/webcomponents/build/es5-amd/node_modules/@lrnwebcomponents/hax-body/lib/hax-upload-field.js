...
this.__allowUpload=!0;this.shadowRoot.querySelector("#fileupload").uploadFiles()}},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(HaxUploadField.prototype),"connectedCallback",this).call(this);// hide the button if this environment can't support it anyway
