...
var url=prompt("Enter a URL:",href);if(url){document.execCommand("createLink",!1,url)}break;case"text-unlink":document.execCommand("unlink");break;/**
...
if(-1!=ua.indexOf("safari")){if(-1<ua.indexOf("chrome")){}else{return!0}}return!1}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_aee354a07c0711e98a2471d74bf08c91())}},{key:"tag",get:function get(){return"hax-text-context"}},{key:"properties",get:function get(){return{_showIndent:{type:Boolean,computed:"_computeShowIndent(selectedValue, polyfillSafe)"},/**
