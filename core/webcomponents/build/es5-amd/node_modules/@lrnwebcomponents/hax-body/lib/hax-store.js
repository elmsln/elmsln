define(["exports","meta","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js","../../../@polymer/polymer/lib/utils/resolve-url.js","../../../@polymer/polymer/lib/utils/settings.js","./shadows-safari.js","./haxutils.js","../../../@polymer/iron-ajax/iron-ajax.js","../../simple-toast/simple-toast.js","../../media-behaviors/media-behaviors.js","../../hax-body-behaviors/hax-body-behaviors.js","../../code-sample/code-sample.js"],function(_exports,meta,_require,_polymerElement,_renderStatus,_polymerDom,_resolveUrl,_settings,_shadowsSafari,_haxutils,_ironAjax,_simpleToast,_mediaBehaviors,_haxBodyBehaviors,_codeSample){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxStore=void 0;meta=babelHelpers.interopRequireWildcard(meta);_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_c700b7007cd211e98efbab36cb9e78ba(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"[[appStore.url]]\"\n        params=\"[[appStore.params]]\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        last-response=\"{{__appStoreData}}\"\n      ></iron-ajax>\n      <hal-9000 id=\"hal\" debug=\"debug\" commands=\"[[voiceCommands]]\"></hal-9000>\n    "]);_templateObject_c700b7007cd211e98efbab36cb9e78ba=function _templateObject_c700b7007cd211e98efbab36cb9e78ba(){return data};return data}var HaxStore=/*#__PURE__*/function(_HAXElement){babelHelpers.inherits(HaxStore,_HAXElement);babelHelpers.createClass(HaxStore,[{key:"_storageDataChanged",/**
...
(0,_polymerDom.dom)(haxAutoloader).appendChild(document.createElement(i))}}}).catch(function(error){/* Error handling */console.log(error)});case 6:_context.next=2;break;case 8:case"end":return _context.stop();}}},_callee,this)}));return function _handleDynamicImports(_x,_x2){return _handleDynamicImports2.apply(this,arguments)}}()},{key:"_editModeChanged",value:function _editModeChanged(newValue){if(newValue&&this.globalPreferences.haxVoiceCommands){this.shadowRoot.querySelector("#hal").auto=!0}else{this.shadowRoot.querySelector("#hal").auto=!1}}},{key:"_globalPreferencesChanged",value:function _globalPreferencesChanged(newValue,oldValue){// regardless of what it is, reflect it globally but only after setup
...
var sel=window.HaxStore.getSelection(),range;if(range=window.HaxStore.getRange()){range.deleteContents();range.insertNode(document.createTextNode(text))}}}/**
   ...
   */}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_c700b7007cd211e98efbab36cb9e78ba())}},{key:"tag",get:function get(){return"hax-store"}/**
...
if("function"===typeof test.reload){return!0}return!1}},/**
         ...
         */connectionRewrites:{type:Object,value:{}}},babelHelpers.get(babelHelpers.getPrototypeOf(HaxStore),"properties",this))}}]);function HaxStore(){var _this;babelHelpers.classCallCheck(this,HaxStore);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HaxStore).call(this));new Promise(function(res,rej){return _require.default(["./hax-app.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-stax.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-stax-browser.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-blox.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-blox-browser.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../hal-9000/hal-9000.js"],res,rej)});(0,_settings.setPassiveTouchGestures)(!0);// claim the instance spot. This way we can easily
// be referenced globally
if(null==window.HaxStore.instance){window.HaxStore.instance=babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))}_this.haxToast=window.SimpleToast.requestAvailability();// notice hax property definitions coming from anywhere
window.addEventListener("hax-register-properties",_this._haxStoreRegisterProperties.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// app registration can come in automatically from app-stores
// or through direct definition in the DOM
document.body.addEventListener("hax-register-app",_this._haxStoreRegisterApp.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// register stax which are groupings of haxElements
document.body.addEventListener("hax-register-stax",_this._haxStoreRegisterStax.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// register blox which are grid plate configurations
// with lots of sane visual defaults
document.body.addEventListener("hax-register-blox",_this._haxStoreRegisterBlox.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// register the pieces of the body of what we call HAX
// think of this like the core of the system required
// to do anything like have buttons or state management
// write data to the store
document.body.addEventListener("hax-store-write",_this._writeHaxStore.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// register the manager panel / modal
document.body.addEventListener("hax-register-manager",_this._haxStoreRegisterManager.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// register the autoloader area for elements
document.body.addEventListener("hax-register-autoloader",_this._haxStoreRegisterAutoloader.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// register a body, kind of a big deal
document.body.addEventListener("hax-register-body",_this._haxStoreRegisterBody.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// register the interaction panel / menu
document.body.addEventListener("hax-register-panel",_this._haxStoreRegisterPanel.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// register the app picker for contextual setting / option
document.body.addEventListener("hax-register-app-picker",_this._haxStoreRegisterAppPicker.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// stax modal
document.body.addEventListener("hax-register-stax-picker",_this._haxStoreRegisterStaxPicker.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// blox modal
document.body.addEventListener("hax-register-blox-picker",_this._haxStoreRegisterBloxPicker.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// preferences modal
document.body.addEventListener("hax-register-preferences",_this._haxStoreRegisterPreferences.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// export modal
document.body.addEventListener("hax-register-export",_this._haxStoreRegisterExport.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));// notice content insert and help it along to the body
document.body.addEventListener("hax-insert-content",_this._haxStoreInsertContent.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));document.body.addEventListener("hax-insert-content-array",_this._haxStoreInsertMultiple.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));window.addEventListener("hax-add-voice-command",_this._addVoiceCommand.bind(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this))));document.body.style.setProperty("--hax-ui-headings","#d4ff77");return _this}/**
...
if(window.HaxStore.instance._isSandboxed){var webview={canScale:!0,canPosition:!0,canEditSource:!1,settings:{quick:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"}],configure:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"}],advanced:[]}};this.setHaxProperties(webview,"webview")}var iframe={canScale:!0,canPosition:!0,canEditSource:!0,gizmo:{title:"Basic iframe",description:"A basic iframe",icon:"icons:fullscreen",color:"grey",groups:["Content"],handles:[{type:"link",source:"src",height:"height",width:"width"}],meta:{author:"W3C"}},settings:{quick:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"}],configure:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"}],advanced:[]}};this.setHaxProperties(iframe,"iframe");var img={canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Image",description:"A basic img tag",icon:"image:image",color:"grey",groups:["Image","Media"],handles:[{type:"link",source:"src"},{type:"image",source:"src",height:"height",width:"width"}],meta:{author:"W3C"}},settings:{quick:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"},{attribute:"alt",title:"Alt text",description:"Useful for screen readers and improved SEO.",inputMethod:"alt",icon:"accessibility"},{attribute:"height",title:"Height",description:"height in pixels of the item",inputMethod:"textfield",icon:"icons:swap-vert"},{attribute:"width",title:"Width",description:"width in pixels of the item",inputMethod:"textfield",icon:"icons:swap-horiz"}],configure:[{attribute:"src",title:"Source",description:"The URL for this video.",inputMethod:"haxupload",icon:"link",required:!0,validationType:"url"},{attribute:"alt",title:"Alt text",description:"Useful for screen readers and improved SEO.",inputMethod:"alt",icon:"accessibility"},{attribute:"height",title:"Height",description:"height in pixels of the item",inputMethod:"textfield",icon:"icons:swap-vert"},{attribute:"width",title:"Width",description:"width in pixels of the item",inputMethod:"textfield",icon:"icons:swap-horiz"}],advanced:[]}};this.setHaxProperties(img,"img");var ahref={canScale:!1,canPosition:!1,canEditSource:!0,gizmo:{title:"Basic link",description:"A basic a tag",icon:"icons:link",color:"grey",groups:["Link"],handles:[{type:"link",source:"href",title:"innerText",alt:"title"}],meta:{author:"W3C"}},settings:{quick:[{attribute:"href",title:"Link",description:"The URL for this video.",inputMethod:"textfield",icon:"icons:link",required:!0,validationType:"url"},{attribute:"title",title:"Title text",description:"Useful for screen readers and improved SEO.",inputMethod:"textfield",icon:"icons:accessibility"}],configure:[{attribute:"innerText",title:"Text",description:"Text of the link",inputMethod:"textfield",required:!0},{attribute:"href",title:"Link",description:"The URL for this video.",inputMethod:"haxupload",icon:"icons:link",required:!0,validationType:"url"},{attribute:"title",title:"Title text",description:"Useful for screen readers and improved SEO.",inputMethod:"textfield",icon:"icons:accessibility"},{attribute:"target",title:"Target",description:"Where to place the link.",inputMethod:"select",icon:"icons:launch",options:{"":"Same window",_blank:"New window",_top:"Top window",_parent:"Parent window"}}],advanced:[]}};this.setHaxProperties(ahref,"a");var p={canScale:!1,canPosition:!1,canEditSource:!0,settings:{quick:[],configure:[],advanced:[]}};this.setHaxProperties(p,"p");var hr={canScale:!0,canPosition:!0,canEditSource:!1,settings:{quick:[],configure:[],advanced:[]}};this.setHaxProperties(hr,"hr");this.setHaxProperties(_codeSample.CodeSample.haxProperties,_codeSample.CodeSample.tag)}/**
   ...
   */},{key:"_haxStoreInsertContent",value:function _haxStoreInsertContent(e){if(e.detail){var properties={};// support for properties to be set automatically optionally
if(babelHelpers.typeof(e.detail.properties)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){properties=e.detail.properties}// ensure better UX for text based operations
this.activeHaxBody.__activeHover=null;// invoke insert or replacement on body, same function so it's easier to trace
if(e.detail.replace&&e.detail.replacement){var node=window.HaxStore.haxElementToNode(e.detail.tag,e.detail.content,properties);if(this.activeNode!==this.activeContainerNode){this.activeHaxBody.haxReplaceNode(this.activeNode,node,this.activeContainerNode)}else{this.activeHaxBody.haxReplaceNode(this.activeNode,node)}}else if(babelHelpers.typeof(e.detail.__type)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&"inline"===e.detail.__type){var _node=window.HaxStore.haxElementToNode(e.detail.tag,e.detail.content,properties);// replace what WAS the active selection w/ this new node
...
this.activePlaceHolder=null}else{this.activeHaxBody.haxInsert(e.detail.tag,e.detail.content,properties)}}}/**
   ...
   */},{key:"_haxStoreInsertMultiple",value:function _haxStoreInsertMultiple(e){var _this6=this;if(e.detail){var properties;for(var i in e.detail){properties={};// support for properties to be set automatically optionally
if(babelHelpers.typeof(e.detail[i].properties)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){properties=e.detail[i].properties}this.activeHaxBody.haxInsert(e.detail[i].tag,e.detail[i].content,properties,!1)}setTimeout(function(){_this6.activeHaxBody.breakUpdateLock()},300)}}/**
...
var tag=node.tagName.toLowerCase();if(window.HaxStore.instance._isSandboxed&&"iframe"===tag){tag="webview"}var slotContent=window.HaxStore.getHAXSlot(node);// special edge case for slot binding in primatives
...
var delProps=["inner-text","tabindex","guestinstance"];for(var delProp in delProps){if(babelHelpers.typeof(propvals[delProps[delProp]])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){delete propvals[delProps[delProp]]}}// remove id attribute if it's empty, somehow misses above
 ...
 */window.HaxStore.getHAXSlot=function(node){var content="",slotnodes=(0,_polymerDom.dom)(node).children;// ensure there's something inside of this
if(0<slotnodes.length){// loop through everything found in the slotted area and put it back in
for(var j=0,len2=slotnodes.length;j<len2;j++){if(babelHelpers.typeof(slotnodes[j].tagName)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){// if we're a custom element, keep digging, otherwise a simple
// self append is fine.
