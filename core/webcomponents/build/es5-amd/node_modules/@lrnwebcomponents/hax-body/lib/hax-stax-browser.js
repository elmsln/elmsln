define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/async.js","../../../@polymer/iron-list/iron-list.js"],function(_exports,_require,_polymerElement,_async,_ironList){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxStaxBrowser=void 0;_require=babelHelpers.interopRequireWildcard(_require);function _templateObject_1e802ca083d511e9a39cbd3cd8776fa6(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        hax-stax-browser-item {\n          margin: 10px;\n          -webkit-transition: 0.3s all linear;\n          transition: 0.3s all linear;\n        }\n        #ironlist {\n          min-height: 50vh;\n        }\n      </style>\n      <iron-list id=\"ironlist\" items=\"[[__staxList]]\" as=\"stax\" grid=\"\">\n        <template>\n          <div class=\"stax-container\">\n            <hax-stax-browser-item\n              index=\"[[stax.index]]\"\n              title=\"[[stax.details.title]]\"\n              tag=\"[[stax.details.tag]]\"\n              image=\"[[stax.details.image]]\"\n              author=\"[[stax.details.author]]\"\n              teaser=\"[[stax.details.teaser]]\"\n              description=\"[[stax.details.description]]\"\n              examples=\"[[stax.details.examples]]\"\n              status=\"[[stax.details.status]]\"\n              stax=\"[[stax.stax]]\"\n            ></hax-stax-browser-item>\n          </div>\n        </template>\n      </iron-list>\n    "]);_templateObject_1e802ca083d511e9a39cbd3cd8776fa6=function _templateObject_1e802ca083d511e9a39cbd3cd8776fa6(){return data};return data}/**
 * `hax-stax-browser`
 ...
 */var HaxStaxBrowser=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HaxStaxBrowser,_PolymerElement);function HaxStaxBrowser(){var _this;babelHelpers.classCallCheck(this,HaxStaxBrowser);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HaxStaxBrowser).call(this));new Promise(function(res,rej){return _require.default(["./hax-stax-browser-item.js"],res,rej)});return _this}babelHelpers.createClass(HaxStaxBrowser,[{key:"ready",/**
   * Ready life cycle
   */value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(HaxStaxBrowser.prototype),"ready",this).call(this);document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this))}/**
   * life cycle
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));this.disconnectedCallback()}/**
   * life cycle
   */},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(HaxStaxBrowser.prototype),"connectedCallback",this).call(this);this.resetBrowser()}/**
   * Store updated, sync.
