 ...
 */var HaxAppBrowser=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HaxAppBrowser,_PolymerElement);function HaxAppBrowser(){var _this;babelHelpers.classCallCheck(this,HaxAppBrowser);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HaxAppBrowser).call(this));new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-item/paper-item.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../dropdown-select/dropdown-select.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-app-browser-item.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-app-search.js"],res,rej)});return _this}babelHelpers.createClass(HaxAppBrowser,[{key:"connectedCallback",/**
   * life cycle
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(HaxAppBrowser.prototype),"connectedCallback",this).call(this);this.resetBrowser();(0,_renderStatus.afterNextRender)(this,function(){var _this2=this;this.shadowRoot.querySelector("#inputfilter").addEventListener("value-changed",function(e){_this2.shadowRoot.querySelector("#filter").like=e.target.value});this.shadowRoot.querySelector("#filtertype").addEventListener("change",function(e){_this2.shadowRoot.querySelector("#inputfilter").value="";_this2.shadowRoot.querySelector("#filter").where=e.detail.value;_this2.shadowRoot.querySelector("#filter").like=""});document.body.addEventListener("hax-app-selected",this._appSelected.bind(this));document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this))})}/**
   * Detached life cycle
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){document.body.removeEventListener("hax-app-selected",this._appSelected.bind(this));document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));babelHelpers.get(babelHelpers.getPrototypeOf(HaxAppBrowser.prototype),"disconnectedCallback",this).call(this)}/**
