 ...
 */var HaxCeContext=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HaxCeContext,_PolymerElement);function HaxCeContext(){var _this;babelHelpers.classCallCheck(this,HaxCeContext);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HaxCeContext).call(this));new Promise(function(res,rej){return _require.default(["./hax-context-item.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-toolbar.js"],res,rej)});return _this}babelHelpers.createClass(HaxCeContext,[{key:"setHaxProperties",/**
   * Set haxProperties.
   */value:function setHaxProperties(props){// be aggressive w/ reset
this.set("haxProperties",{});this.set("haxProperties",props)}/**
   * ce size changed.
   */},{key:"_ceSizeChanged",value:function _ceSizeChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,cancelable:!0,composed:!0,detail:{eventName:"hax-size-change",value:newValue}}))}}/**
   * HAX properties changed, update buttons available.
   */},{key:"_haxPropertiesChanged",value:function _haxPropertiesChanged(newValue,oldValue){if(babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(newValue.settings)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){// clear current slot for the tag
...
if(babelHelpers.typeof(setting.property)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){item.propertyToBind=setting.property}else if(babelHelpers.typeof(setting.attribute)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){item.propertyToBind=setting.attribute}else{item.slotToBind=setting.slot}slot.appendChild(item)}}}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_9cf047d0898111e9ba38e33cad2d1624())}},{key:"tag",get:function get(){return"hax-ce-context"}},{key:"properties",get:function get(){return{/**
       * ce size.
       */ceSize:{type:Number,value:100,observer:"_ceSizeChanged"},/**
       * Selected value to match ce direction currently.
       */haxProperties:{type:Object,value:{},observer:"_haxPropertiesChanged"}}}}]);return HaxCeContext}(_polymerElement.PolymerElement);_exports.HaxCeContext=HaxCeContext;window.customElements.define(HaxCeContext.tag,HaxCeContext)});