...
*/var ResponsiveGridRow=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(ResponsiveGridRow,_PolymerElement);function ResponsiveGridRow(){babelHelpers.classCallCheck(this,ResponsiveGridRow);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ResponsiveGridRow).apply(this,arguments))}babelHelpers.createClass(ResponsiveGridRow,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(ResponsiveGridRow.prototype),"connectedCallback",this).call(this);window.ResponsiveUtility.requestAvailability();this.dispatchEvent(new CustomEvent("responsive-element",{bubbles:!0,cancelable:!0,composed:!0,detail:{element:this,attribute:"screen",relativeToParent:this.responsiveToParent}}))}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_46ea156096af11e98fa963daf87dc373())}},{key:"tag",get:function get(){return"responsive-grid-row"}},{key:"properties",get:function get(){return{/**
       ...
       */screen:{type:String,value:"xs",notify:!0,reflectToAttribute:!0}}}}]);return ResponsiveGridRow}(_polymerElement.PolymerElement);_exports.ResponsiveGridRow=ResponsiveGridRow;window.customElements.define(ResponsiveGridRow.tag,ResponsiveGridRow)});