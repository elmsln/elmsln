 ...
 */var LrndesignBlockquote=/*#__PURE__*/function(_SchemaBehaviors){babelHelpers.inherits(LrndesignBlockquote,_SchemaBehaviors);function LrndesignBlockquote(){var _this;babelHelpers.classCallCheck(this,LrndesignBlockquote);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignBlockquote).call(this));(0,_renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(_this),function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(LrndesignBlockquote.haxProperties,LrndesignBlockquote.tag,this)});return _this}babelHelpers.createClass(LrndesignBlockquote,[{key:"_imageChanged",/**
   * Notice display mode change activated so load the font
   */value:function _imageChanged(newValue,oldValue){if("hypercard"==this.displayMode){this.$.wrap.style.cssText="";this.$.thumb.style.cssText=""}else if("poster"==this.displayMode){this.$.wrap.style.cssText="background: #444 url("+newValue+") no-repeat 140% 25%";this.$.thumb.style.cssText=""}else{this.$.wrap.style.cssText="";this.$.thumb.style.cssText="background: url("+newValue+") no-repeat center center"}}/**
   * Notice display mode change activated so load the font
   */},{key:"_displayModeChanged",value:function _displayModeChanged(newValue,oldValue){if("hypercard"==newValue){this.$.wrap.style.cssText="";this.$.thumb.style.cssText="";var style=document.createElement("style"),basePath=(0,_resolveUrl.pathFromUrl)(decodeURIComponent(meta.url));style.innerHTML="@font-face {\n        font-family: 'Chikarego';\n        font-display: swap;\n        src: url('".concat(basePath,"lib/chikarego2-webfont.woff2') format('woff2'),\n             url('").concat(basePath,"lib/chikarego2-webfont.woff') format('woff');\n        font-weight: normal;\n        font-style: normal;\n      }");document.head.appendChild(style)}else if("poster"==newValue){this.$.wrap.style.cssText="background: #444 url("+this.image+") no-repeat 140% 25%";this.$.thumb.style.cssText=""}else{this.$.wrap.style.cssText="";this.$.thumb.style.cssText="background: url("+this.image+") no-repeat center center"}}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_68287860898111e9ba38e33cad2d1624())}},{key:"tag",get:function get(){return"lrndesign-blockquote"}},{key:"properties",get:function get(){return{/**
       * Source being cited
