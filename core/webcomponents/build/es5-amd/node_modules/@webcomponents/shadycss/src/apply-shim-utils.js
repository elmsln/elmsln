 ...
 */function invalidate(elementName){var template=_templateMap.default[elementName];if(template){invalidateTemplate(template)}}/**
 ...
 * @param {string} elementName
 * @return {boolean}
 */function isValid(elementName){var template=_templateMap.default[elementName];if(template){return templateIsValid(template)}return!0}/**
 * @param {HTMLTemplateElement} template
 * @return {boolean}
 */function templateIsValid(template){return template[CURRENT_VERSION]===template[NEXT_VERSION]}/**
 * @param {string} elementName
 * @return {boolean}
 */function isValidating(elementName){var template=_templateMap.default[elementName];if(template){return templateIsValidating(template)}return!1}/**
 ...
 * @param {string} elementName
*/function startValidating(elementName){var template=_templateMap.default[elementName];startValidatingTemplate(template)}/**
 ...
 * @return {boolean}
 */function elementsAreInvalid(){for(var elementName in _templateMap.default){var template=_templateMap.default[elementName];if(!templateIsValid(template)){return!0}}return!1}});