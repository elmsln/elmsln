...
if(!(error instanceof DOMException)){error.code=error.code||500}if(_this.errorHandler){currentContext.result=_this.errorHandler(error);return currentContext}throw error})}/**
