...
*/ /**
 * @polymerMixin
 */const ColumnResizingMixin=superClass=>class ColumnResizingMixin extends(0,_gestureEventListeners.GestureEventListeners)(superClass){ready(){super.ready();const scroller=this.$.scroller;(0,_gestures.addListener)(scroller,"track",this._onHeaderTrack.bind(this));// Disallow scrolling while resizing
...
this._resizeHandler()}}};_exports.ColumnResizingMixin=ColumnResizingMixin});