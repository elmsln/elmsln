...
this._update()}}/**
   ...
   */notifyResize(){super.notifyResize()}_heightByRowsChanged(value,oldValue){if(value||oldValue){this.notifyResize()}}}_exports.GridElement=GridElement;customElements.define(GridElement.is,GridElement)});