define(["exports","./vaadin-grid-column.js","./vaadin-grid-filter.js","../../../@polymer/polymer/lib/utils/html-tag.js"],function(_exports,_vaadinGridColumn,_vaadinGridFilter,_htmlTag){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.GridFilterColumnElement=void 0;/**
@license
 ...
 */class GridFilterColumnElement extends _vaadinGridColumn.GridColumnElement{static get template(){return _htmlTag.html`
...
headerTemplate.templatizer.dataHost=this;return headerTemplate}_getHeader(header,path){return header||this._generateHeader(path)}}_exports.GridFilterColumnElement=GridFilterColumnElement;customElements.define(GridFilterColumnElement.is,GridFilterColumnElement)});