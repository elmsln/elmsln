...
// application routing
_routeChanged(route,endPoint){if("string"===typeof route.path){if("string"===typeof endPoint){if(route.path.startsWith(endPoint)){return}}window.location=route.path}}/**
...
this._deleteTitle="Delete assignment";this._deleteText="Are you sure you want to delete this assignment?";this._deleteType="assignment";this.$.delete.open()}/**
   ...
   */displayNewBadge(count){if(0==count){return!0}return!1}/**
...
xhr.generateRequest()}}/**
   ...
   */_handleProjectResponse(event){this.$.loading.hidden=!0;this._setToggle(!0)}/**
   ...
   */_handleUpdateResponse(event){if(200==this.backendResponse.status){this.$.toast.text="Updated successfully";this.$.toast.toggle();this.$.projectbackend.generateRequest()}else{// this would imply an error
...
if(0==submission.status&&0==submission.submission.length){if(!update){this.shadowRoot.querySelector("#activetoggle").disabled=!0;this.shadowRoot.querySelector("#activetoggle").checked=!1}this.shadowRoot.querySelector("#activetoggle").title="Submission not started";this.shadowRoot.querySelector("#activetoggletext").textContent="Submission not started"}else if(0==submission.status){if(!update){this.shadowRoot.querySelector("#activetoggle").disabled=!1;this.shadowRoot.querySelector("#activetoggle").checked=!1}this.shadowRoot.querySelector("#activetoggle").title="Submission started";this.shadowRoot.querySelector("#activetoggletext").textContent="Submission in progress"}else{if(!update){this.shadowRoot.querySelector("#activetoggle").disabled=!1;this.shadowRoot.querySelector("#activetoggle").checked=!0}this.shadowRoot.querySelector("#activetoggle").title="Submission ready";this.shadowRoot.querySelector("#activetoggletext").textContent="Submission ready"}}}/**
   ...
   */_toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}ready(){super.ready();this.__modal=window.SimpleModal.requestAvailability();this.__modal.style="--simple-modal-min-width: 50vw;--simple-modal-min-height: 50vh;"}}_exports.LrnappStudioKanban=LrnappStudioKanban;window.customElements.define(LrnappStudioKanban.tag,LrnappStudioKanban)});