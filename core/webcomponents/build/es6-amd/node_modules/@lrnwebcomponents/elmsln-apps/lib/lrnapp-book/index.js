define(["./lrnapp-book.js"],function(_lrnappBook){"use strict";const $_documentContainer=document.createElement("div");$_documentContainer.setAttribute("style","display: none;");$_documentContainer.innerHTML=`<title>lrnapp-book demo</title><lrnapp-book outline-path="demo/data.json" book-path="demo/data.json" title="Lesson 2">
    ...
    </lrnapp-book>`;document.head.appendChild($_documentContainer)});