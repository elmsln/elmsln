...
</dom-repeat>`}// haxProperty definition
...
static get properties(){let props={/**
   ...
   */initRequest(){this.shadowRoot.querySelector("#rssajax").generateRequest()}_maxChanged(newValue){if(newValue){this.xmlToItems(this.xml)}}/**
   * Receives a xml and set this.items as json.
   * @param {Object} xml XML element.
   */xmlToItems(newValue){if(newValue){// parse xml to json and get items
