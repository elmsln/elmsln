define(["exports","../../@polymer/polymer/polymer-element.js","../schema-behaviors/schema-behaviors.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/iron-icon/iron-icon.js","./lib/stop-icon.js"],function(_exports,_polymerElement,_schemaBehaviors,_HAXWiring,_ironIcon,_stopIcon){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.StopNote=void 0;/**
 * `stop-note`
 * `A note that directs people to an action item of different warning levels`
 * @demo demo/index.html
 * @microcopy - the mental model for this element
 * -
 */class StopNote extends(0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement){static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
          width: auto;
   ...
   */connectedCallback(){super.connectedCallback();this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(StopNote.haxProperties,StopNote.tag,this)}}_exports.StopNote=StopNote;window.customElements.define(StopNote.tag,StopNote)});