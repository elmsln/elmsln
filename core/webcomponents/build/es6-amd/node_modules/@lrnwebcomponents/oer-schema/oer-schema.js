define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../schema-behaviors/schema-behaviors.js","../hax-body-behaviors/lib/HAXWiring.js","./lib/oerschema.js"],function(_exports,_polymerElement,_renderStatus,_schemaBehaviors,_HAXWiring,_oerschema){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.OerSchemaElement=void 0;/**
 * `oer-schema`
 * `A LRN element to wrap an oer schema prefix onto materials.`
 * @demo demo/index.html
 */class OerSchemaElement extends(0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement){constructor(){super();(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(OerSchemaElement.haxProperties,OerSchemaElement.tag,this)})}static get template(){return _polymerElement.html`
      <style>
        :host {
