 ...
 */class HAXCMSOutlineEditorDialog extends _polymerElement.PolymerElement{/**
   ...
   */static get tag(){return"haxcms-outline-editor-dialog"}constructor(){super();new Promise((res,rej)=>_require.default(["../../../../@polymer/paper-button/paper-button.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../../@polymer/iron-icon/iron-icon.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../../@polymer/iron-icons/iron-icons.js"],res,rej))}// render function
static get template(){return _polymerElement.html`
   ...
   * attached life cycle
   */connectedCallback(){super.connectedCallback();this.__disposer=[];(0,_mobxModule.autorun)(reaction=>{setTimeout(()=>{this.manifestItems=Object.assign([],(0,_mobxModule.toJS)(_haxcmsSiteStore.store.manifest.items));this.__disposer.push(reaction)},500)})}/**
   * detached life cycle
...
if(!newValue){this.$.outline.importJsonOutlineSchemaItems()}else{const items=this.$.outline.exportJsonOutlineSchemaItems(!0);this.set("manifestItems",items)}}/**
   ...
   */_saveTap(e){this.dispatchEvent(new CustomEvent("haxcms-save-outline",{bubbles:!0,composed:!0,cancelable:!1,detail:this.$.outline.exportJsonOutlineSchemaItems(!0)}))}}_exports.HAXCMSOutlineEditorDialog=HAXCMSOutlineEditorDialog;window.customElements.define(HAXCMSOutlineEditorDialog.tag,HAXCMSOutlineEditorDialog)});