...
info.removedNodes.map(node=>{if(node.tagName){this.updateEditorValue(node)}})}})})}}_exports.CodeEditor=CodeEditor;window.customElements.define(CodeEditor.tag,CodeEditor)});