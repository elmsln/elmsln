define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/iron-a11y-keys/iron-a11y-keys.js","../../../@polymer/paper-icon-button/paper-icon-button.js","./mtz-marked-control-behavior.js"],function(_exports,_polymerElement,_ironA11yKeys,_paperIconButton,_mtzMarkedControlBehavior){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MtzMarkedControlLink=void 0;class MtzMarkedControlLink extends(0,_mtzMarkedControlBehavior.mtzMarkedControlBehavior)(_polymerElement.PolymerElement){static get template(){return _polymerElement.html`
   ...
   * @return {Boolean}
   * @protected
   */_isLink(selection){return selection.text.startsWith("https://")}}_exports.MtzMarkedControlLink=MtzMarkedControlLink;window.customElements.define(MtzMarkedControlLink.tag,MtzMarkedControlLink)});