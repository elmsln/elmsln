define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","./a11y-collapse-button-styles.js","../../../@polymer/iron-icon/iron-icon.js","../../../@polymer/paper-tooltip/paper-tooltip.js"],function(_exports,_polymerElement,_renderStatus,_a11yCollapseButtonStyles,_ironIcon,_paperTooltip){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.A11yCollapseAccordionButton=void 0;/**
 ...
 */class A11yCollapseAccordionButton extends _polymerElement.PolymerElement{static get tag(){return"a11y-collapse-accordion-button"}static get template(){return _polymerElement.html`
   ...
   * life cycle
   */connectedCallback(){super.connectedCallback();(0,_renderStatus.afterNextRender)(this,function(){this.addEventListener("tap",this._onTap.bind(this))})}/**
   * Handle tap
   */_onTap(e){if(!this.disabled){this.dispatchEvent(new CustomEvent("a11y-collapse-tap",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}}_exports.A11yCollapseAccordionButton=A11yCollapseAccordionButton;window.customElements.define(A11yCollapseAccordionButton.tag,A11yCollapseAccordionButton)});