...
(0,_polymerDom.dom)(this).appendChild(this.__clone.root)}/**
   ...
   *
   * @event filter
   */_onFilter(){this.dispatchEvent(new CustomEvent("filter",{bubbles:!0,cancelable:!0,composed:!0,detail:!0}))}}_exports.GrafittoFilter=GrafittoFilter;window.customElements.define(GrafittoFilter.tag,GrafittoFilter)});