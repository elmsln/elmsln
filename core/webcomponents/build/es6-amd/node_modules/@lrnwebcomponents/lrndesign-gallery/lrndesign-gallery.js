define(["exports","../../@polymer/polymer/polymer-element.js","./lib/lrndesign-gallery-behaviors.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js","../simple-colors/simple-colors.js","./lib/lrndesign-gallery-carousel.js","./lib/lrndesign-gallery-grid.js"],function(_exports,_polymerElement,_lrndesignGalleryBehaviors,_HAXWiring,_schemaBehaviors,_simpleColors,_lrndesignGalleryCarousel,_lrndesignGalleryGrid){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrndesignGallery=void 0;/**
 ...
 */class LrndesignGallery extends _lrndesignGalleryBehaviors.LrndesignGalleryBehaviors{/**
   ...
   */static get tag(){return"lrndesign-gallery"}static get behaviors(){return[_lrndesignGalleryBehaviors.LrndesignGalleryBehaviors]}// render function
...
static get properties(){return{}}/**
   ...
   */connectedCallback(){let root=this;super.connectedCallback();this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(LrndesignGallery.haxProperties,LrndesignGallery.tag,this);root.__gallery=root.$.gallery;root.anchorData=root._getAnchorData();window.ResponsiveUtility.requestAvailability();window.dispatchEvent(new CustomEvent("responsive-element",{detail:{element:root,attribute:"responsive-size",relativeToParent:!0}}))}/**
   * life cycle, element is ready
   */ready(){super.ready()}}_exports.LrndesignGallery=LrndesignGallery;window.customElements.define(LrndesignGallery.tag,LrndesignGallery)});