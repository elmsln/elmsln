define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","./lrndesign-gallery-behaviors.js","./lrndesign-gallery-zoom.js","./lrndesign-gallery-details.js"],function(_exports,_polymerElement,_renderStatus,_lrndesignGalleryBehaviors,_lrndesignGalleryZoom,_lrndesignGalleryDetails){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrndesignGalleryGrid=void 0;/**
 ...
 */class LrndesignGalleryGrid extends _lrndesignGalleryBehaviors.LrndesignGalleryBehaviors{/**
   ...
   */static get tag(){return"lrndesign-gallery-grid"}static get behaviors(){return[_lrndesignGalleryBehaviors.LrndesignGalleryBehaviors]}// render function
...
static get properties(){return{/**
       ...
       */imageStyle:{type:String,computed:"_getImageStyle(items)",reflectToAttribute:!0}}}/**
   * handles gallery-scroll event
   */_handleScroll(e){this._scrollIntoView([this._getParentOffset(this),e.path[0].offsetTop])}/**
   ...
   */_getImageStyle(items=[]){let img=new Image,padding=75;if(items!==void 0&&0<items.length){img.src=items[0].src;if(0<img.naturalWidth&&0<img.naturalHeight)padding=100*img.naturalHeight/img.naturalWidth}return"padding-bottom: "+padding+"%;"}}_exports.LrndesignGalleryGrid=LrndesignGalleryGrid;window.customElements.define(LrndesignGalleryGrid.tag,LrndesignGalleryGrid)});