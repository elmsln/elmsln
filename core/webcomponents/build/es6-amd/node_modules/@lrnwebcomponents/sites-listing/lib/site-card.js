define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/paper-card/paper-card.js","../../../@polymer/iron-icon/iron-icon.js","../../../@polymer/iron-image/iron-image.js"],function(_exports,_polymerElement,_paperCard,_ironIcon,_ironImage){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SiteCard=void 0;/**
 ...
 */class SiteCard extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        :host {
          display: inline-flex;
          width: 250px;
   ...
   * Reset the elevation.
   */_mouseLeave(e){this.elevation=this.__oldElevation}}_exports.SiteCard=SiteCard;window.customElements.define(SiteCard.tag,SiteCard)});