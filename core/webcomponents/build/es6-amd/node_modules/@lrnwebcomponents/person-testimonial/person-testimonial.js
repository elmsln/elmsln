 ...
 */class PersonTestimonial extends _simpleColors.SimpleColors{constructor(){super();new Promise((res,rej)=>_require.default(["../../@polymer/paper-card/paper-card.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/iron-image/iron-image.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/iron-icon/iron-icon.js"],res,rej));new Promise((res,rej)=>_require.default(["./lib/person-testimonial-icon.js"],res,rej));(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(PersonTestimonial.haxProperties,PersonTestimonial.tag,this)})}static get template(){return _polymerElement.html`
    ...
    `}static get tag(){return"person-testimonial"}static get properties(){let props={/**
