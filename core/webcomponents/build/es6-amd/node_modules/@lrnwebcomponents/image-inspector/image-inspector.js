define(["exports","require","../../@polymer/polymer/polymer-element.js"],function(_exports,_require,_polymerElement){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ImageInspector=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 * `image-inspector`
 * `Zoom, Rotate, Mirror, Download, and View image`
 *
 * @demo demo/index.html
 */class ImageInspector extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../@polymer/app-layout/app-layout.js"],res,rej));new Promise((res,rej)=>_require.default(["../img-pan-zoom/img-pan-zoom.js"],res,rej));new Promise((res,rej)=>_require.default(["../lrnsys-button/lrnsys-button.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/iron-icons/iron-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/iron-icons/image-icons.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
...
this.degrees+=-90;this.__img.style.transform="rotate("+this.degrees+"deg)";this.__img.toggleClass("top")}/**
   ...
   */zoomOut(){this.__img.zoomOut()}}_exports.ImageInspector=ImageInspector;window.customElements.define(ImageInspector.tag,ImageInspector)});