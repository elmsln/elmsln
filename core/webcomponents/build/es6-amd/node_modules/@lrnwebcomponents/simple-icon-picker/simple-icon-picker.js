define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../simple-picker/simple-picker.js","../../@polymer/iron-meta/iron-meta.js"],function(_exports,_polymerElement,_renderStatus,_simplePicker,_ironMeta){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimpleIconPicker=void 0;/**
 ...
 */class SimpleIconPicker extends _simplePicker.SimplePicker{// render function
...
[
  ...
  */__iconList:{name:"__iconList",type:"Array","read-only":!0}}}/**
   ...
   */ready(){super.ready();(0,_renderStatus.afterNextRender)(this,function(){const iconSets=new _ironMeta.IronMeta({type:"iconset"});if(0===this.icons.length&&typeof iconSets!==typeof void 0&&iconSets.list&&iconSets.list.length){var iconList=[];iconSets.list.forEach(function(item){item.getIconNames().forEach(icon=>{iconList.push(icon)})});this.__iconList=iconList}})}/**
