define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/elements/dom-repeat.js","../../@polymer/polymer/lib/elements/dom-if.js","../schema-behaviors/schema-behaviors.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/paper-toast/paper-toast.js","../simple-colors/simple-colors.js"],function(_exports,_require,_polymerElement,_renderStatus,_domRepeat,_domIf,_schemaBehaviors,_HAXWiring,_paperToast,_simpleColors){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MultipleChoice=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 * `multiple-choice`
 * `Ask the user a question from a set of possible answers.`
 * @demo demo/index.html
 */class MultipleChoice extends(0,_schemaBehaviors.SchemaBehaviors)(_simpleColors.SimpleColors){static get tag(){return"multiple-choice"}constructor(){super();new Promise((res,rej)=>_require.default(["../../@polymer/iron-icons/iron-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/iron-icon/iron-icon.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/paper-button/paper-button.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
...
let eventData=[""];eventData={dbType:"xapistatements",activityDisplay:"answered",activityId:"http://adlnet.gov/expapi/verbs/answered",objectId:"http://haxcms.psu.edu/haxQuiz",objectName:this.quizName,objectDescription:"HAX Quiz",resultScoreScaled:1,resultScoreMin:0,resultScoreMax:100,resultScoreRaw:100,resultSuccess:gotRight,resultCompletion:!0,resultResponse:"sample",resultDuration:"sample"};this.dispatchEvent(new CustomEvent("user-engagement",{bubbles:!0,composed:!0,cancelable:!1,detail:eventData}))}/**
   * Show the data based on user selecting the view and
   * that they want to see how they did.
   */_showData(e){// start of data passing, this is a prototype atm
let eventData=[""];eventData={dbType:"xapistatements",activityDisplay:"answered",activityId:"http://adlnet.gov/expapi/verbs/answered",objectId:"http://haxcms.psu.edu/haxQuiz",objectName:this.quizName,objectDescription:"HAX Quiz",resultScoreScaled:1,resultScoreMin:0,resultScoreMax:100,resultScoreRaw:100,resultSuccess:"tester",//test value
...
if(this.singleOption){new Promise((res,rej)=>_require.default(["../../@polymer/paper-radio-group/paper-radio-group.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/paper-radio-button/paper-radio-button.js"],res,rej))}else{new Promise((res,rej)=>_require.default(["../../@polymer/paper-checkbox/paper-checkbox.js"],res,rej))}this.setAttribute("typeof","oer:Assessment");(0,_renderStatus.afterNextRender)(this,function(){this.$.toast.fitInto=this;this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(MultipleChoice.haxProperties,MultipleChoice.tag,this)})}}_exports.MultipleChoice=MultipleChoice;window.customElements.define(MultipleChoice.tag,MultipleChoice)});