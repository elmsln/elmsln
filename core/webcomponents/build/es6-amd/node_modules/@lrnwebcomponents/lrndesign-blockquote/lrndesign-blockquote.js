 ...
 */class LrndesignBlockquote extends(0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement){constructor(){super();(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(LrndesignBlockquote.haxProperties,LrndesignBlockquote.tag,this)})}static get template(){return _polymerElement.html`
   ...
   * Notice display mode change activated so load the font
   */_displayModeChanged(newValue,oldValue){if("hypercard"==newValue){this.$.wrap.style.cssText="";this.$.thumb.style.cssText="";let style=document.createElement("style"),basePath=(0,_resolveUrl.pathFromUrl)(decodeURIComponent(meta.url));style.innerHTML=`@font-face {
