...
case"text-bold":document.execCommand("bold");e.preventDefault();e.stopPropagation();break;case"text-italic":document.execCommand("italic");e.preventDefault();e.stopPropagation();break;case"text-underline":document.execCommand("underline");e.preventDefault();e.stopPropagation();// silly hack to account for trigging a selection from
// inside the menu that isn't from a paper-item
this.shadowRoot.querySelector("#toolbar").shadowRoot.querySelector("#moremenu").shadowRoot.querySelector("#menu").hideMenu();break;case"text-subscript":document.execCommand("subscript");e.preventDefault();e.stopPropagation();// silly hack to account for trigging a selection from
// inside the menu that isn't from a paper-item
this.shadowRoot.querySelector("#toolbar").shadowRoot.querySelector("#moremenu").shadowRoot.querySelector("#menu").hideMenu();break;case"text-superscript":document.execCommand("superscript");e.preventDefault();e.stopPropagation();// silly hack to account for trigging a selection from
// inside the menu that isn't from a paper-item
this.shadowRoot.querySelector("#toolbar").shadowRoot.querySelector("#moremenu").shadowRoot.querySelector("#menu").hideMenu();break;case"text-remove-format":document.execCommand("removeFormat");e.preventDefault();e.stopPropagation();break;case"text-strikethrough":document.execCommand("strikeThrough");e.preventDefault();e.stopPropagation();// silly hack to account for trigging a selection from
// inside the menu that isn't from a paper-item
...
let url=prompt("Enter a URL:",href);if(url){document.execCommand("createLink",!1,url);e.preventDefault();e.stopPropagation()}break;case"text-unlink":document.execCommand("unlink");e.preventDefault();e.stopPropagation();break;/**
       * Our bad actors when it comes to polyfill'ed shadowDOM.
       * Naughty, naughty shadyDOM. Fortunately this is only IE11/Edge
       */case"text-indent":document.execCommand("indent");e.preventDefault();e.stopPropagation();break;case"text-outdent":document.execCommand("outdent");e.preventDefault();e.stopPropagation();break;case"text-list-numbered":try{document.execCommand("insertOrderedList");e.preventDefault();e.stopPropagation()}catch(e){}break;case"text-list-bulleted":try{document.execCommand("insertUnorderedList");e.preventDefault();e.stopPropagation()}catch(e){}break;}}/**
