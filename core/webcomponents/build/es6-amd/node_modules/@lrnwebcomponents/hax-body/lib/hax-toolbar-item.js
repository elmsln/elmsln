define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../simple-colors/simple-colors.js","./hax-shared-styles.js"],function(_exports,_require,_polymerElement,_simpleColors,_haxSharedStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxToolbarItem=void 0;_require=babelHelpers.interopRequireWildcard(_require);class HaxToolbarItem extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../../@polymer/paper-button/paper-button.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-tooltip/paper-tooltip.js"],res,rej))}static get template(){return _polymerElement.html`
   ...
   */_tooltipChanged(newValue,oldValue){if(""==newValue||null==newValue){this.shadowRoot.querySelector("#tooltip").setAttribute("aria-hidden","true")}else{this.shadowRoot.querySelector("#tooltip").setAttribute("aria-hidden","false")}}}_exports.HaxToolbarItem=HaxToolbarItem;window.customElements.define(HaxToolbarItem.tag,HaxToolbarItem)});