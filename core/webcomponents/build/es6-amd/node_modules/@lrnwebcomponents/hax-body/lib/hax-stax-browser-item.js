define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","./hax-shared-styles.js"],function(_exports,_require,_polymerElement,_renderStatus,_haxSharedStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxStaxBrowserItem=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 * `hax-stax-browser-item`
 * `A button on the hax-gizmo-browser app display`
 */class HaxStaxBrowserItem extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../../@polymer/iron-image/iron-image.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-button/paper-button.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-card/paper-card.js"],res,rej))}static get template(){return _polymerElement.html`
   ...
   */_fireEvent(e){this.dispatchEvent(new CustomEvent("hax-insert-content-array",{bubbles:!0,cancelable:!0,composed:!0,detail:this.stax}));window.HaxStore.instance.haxStaxPicker.close()}}_exports.HaxStaxBrowserItem=HaxStaxBrowserItem;window.customElements.define(HaxStaxBrowserItem.tag,HaxStaxBrowserItem)});