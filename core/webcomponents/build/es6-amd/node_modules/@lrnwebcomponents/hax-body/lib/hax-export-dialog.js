...
document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));this.shadowRoot.querySelector("#download").addEventListener("click",this.download.bind(this));this.shadowRoot.querySelector("#downloadfull").addEventListener("click",this.downloadfull.bind(this));this.shadowRoot.querySelector("#import").addEventListener("click",this.importContent.bind(this));this.shadowRoot.querySelector("#copy").addEventListener("click",this.selectBody.bind(this));this.shadowRoot.querySelector("#closedialog").addEventListener("click",this.close.bind(this));this.shadowRoot.querySelector("#elementexport").addEventListener("click",this.htmlToHaxElements.bind(this))})}/**
   * Detached life cycle
   */disconnectedCallback(){document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));this.shadowRoot.querySelector("#download").removeEventListener("click",this.download.bind(this));this.shadowRoot.querySelector("#downloadfull").removeEventListener("click",this.downloadfull.bind(this));this.shadowRoot.querySelector("#import").removeEventListener("click",this.importContent.bind(this));this.shadowRoot.querySelector("#copy").removeEventListener("click",this.selectBody.bind(this));this.shadowRoot.querySelector("#closedialog").removeEventListener("click",this.close.bind(this));this.shadowRoot.querySelector("#elementexport").removeEventListener("click",this.htmlToHaxElements.bind(this));super.disconnectedCallback()}/**
   * Store updated, sync.
