 ...
 */class HaxBloxBrowser extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["./hax-blox-browser-item.js"],res,rej));new Promise((res,rej)=>_require.default(["./hax-icons.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
        }
    ...
    `}static get tag(){return"hax-blox-browser"}static get properties(){return{/**
       * The list of blox
       */bloxList:{type:Array,observer:"_bloxListChanged"}}}ready(){super.ready();document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this))}/**
   * Attached life cycle
