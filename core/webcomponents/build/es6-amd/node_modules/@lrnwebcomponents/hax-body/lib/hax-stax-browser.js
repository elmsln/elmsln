define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/async.js","../../../@polymer/iron-list/iron-list.js"],function(_exports,_require,_polymerElement,_async,_ironList){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxStaxBrowser=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 * `hax-stax-browser`
 ...
 */class HaxStaxBrowser extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["./hax-stax-browser-item.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
        }
    ...
    `}static get tag(){return"hax-stax-browser"}static get properties(){return{/**
       * The list of stax
       */staxList:{type:Array,observer:"_staxListChanged"}}}/**
   * Ready life cycle
   */ready(){super.ready();document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this))}/**
   * life cycle
   */disconnectedCallback(){document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));this.disconnectedCallback()}/**
   * life cycle
...
if(typeof this[e.detail.property]!==typeof void 0&&null!=this[e.detail.property]&&typeof this[e.detail.property].length!==typeof void 0){this.set(e.detail.property,[])}this.set(e.detail.property,e.detail.value)}}/**
   ...
   */_staxListChanged(newValue,oldValue){if(typeof newValue!==typeof void 0){this.set("__staxList",newValue)}}/**
   * Reset this browser.
   */resetBrowser(){_async.microTask.run(()=>{setTimeout(()=>{this.shadowRoot.querySelector("#ironlist").dispatchEvent(new CustomEvent("iron-resize",{bubbles:!0,cancelable:!0,composed:!0,detail:!0}));window.dispatchEvent(new Event("resize"))},100)})}}_exports.HaxStaxBrowser=HaxStaxBrowser;window.customElements.define(HaxStaxBrowser.tag,HaxStaxBrowser)});