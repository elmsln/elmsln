define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","../../simple-colors/simple-colors.js","./hax-shared-styles.js"],function(_exports,_require,_polymerElement,_renderStatus,_simpleColors,_haxSharedStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HaxSchemaForm=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 * `hax-schema-form`
 ...
 */class HaxSchemaForm extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../../@polymer/paper-toggle-button/paper-toggle-button.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-card/paper-card.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-tabs/paper-tabs.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-tabs/paper-tab.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/paper-button/paper-button.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/iron-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../eco-json-schema-form/eco-json-schema-form.js"],res,rej));new Promise((res,rej)=>_require.default(["../../eco-json-schema-form/lib/eco-json-schema-object.js"],res,rej));new Promise((res,rej)=>_require.default(["../../code-editor/code-editor.js"],res,rej))}static get template(){return _polymerElement.html`
    ...
    `}static get tag(){return"hax-schema-form"}static get properties(){return{/**
       ...
       * JSON Schema.
       */advancedSchema:{type:Object,value:{schema:{}}}}}connectedCallback(){super.connectedCallback();(0,_renderStatus.afterNextRender)(this,function(){new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-textarea.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../app-datepicker/app-datepicker.js"],res,rej));new Promise((res,rej)=>_require.default(["../../simple-picker/simple-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["../../simple-icon-picker/simple-icon-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["../../simple-colors/lib/simple-colors-picker.js"],res,rej));new Promise((res,rej)=>_require.default(["../../paper-input-flagged/paper-input-flagged.js"],res,rej))})}/**
...
if("advanced"===mode){this.advancedForm=!0}else{this.advancedForm=!1}}}/**
   ...
   */removeField(key,type="configure"){if("configure"===type){delete this.configureSchema.properties[key];this.set("schema",this.configureSchema)}else{delete this.advancedSchema.properties[key];this.set("schema",this.advancedSchema)}this.notifyPath("schema.*")}}_exports.HaxSchemaForm=HaxSchemaForm;window.customElements.define(HaxSchemaForm.tag,HaxSchemaForm)});