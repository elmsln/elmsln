...
*/class HaxPanel extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/iron-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/editor-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/device-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/hardware-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/communication-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/social-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/av-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/iron-icons/maps-icons.js"],res,rej));new Promise((res,rej)=>_require.default(["../../../@polymer/app-layout/app-drawer/app-drawer.js"],res,rej));new Promise((res,rej)=>_require.default(["./hax-panel-item.js"],res,rej))}static get template(){return _polymerElement.html`
    ...
    `}static get tag(){return"hax-panel"}static get properties(){return{/**
       ...
       */globalPreferences:{type:Object,observer:"_globalPreferencesChanged"}}}/**
   ...
   * Detached life cycle
   */disconnectedCallback(){this.removeEventListener("hax-item-selected",this._processItemEvent.bind(this));document.body.removeEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this));document.body.removeEventListener("hax-active-hover-name",this._activeNameChange.bind(this));document.body.removeEventListener("hax-panel-operation",this._processItemEvent.bind(this));super.disconnectedCallback()}_activeNameChange(e){this.activeOperationName=e.detail}/**
   * Global preference changed.
   */_globalPreferencesChanged(newValue){if(newValue&&typeof newValue.haxShowExportButton!==typeof void 0){this.hideExportButton=!newValue.haxShowExportButton}}/**
   * Store updated, sync.
   ...
   */_processItemEvent(e){let detail=e.detail;// support a simple insert event to bubble up or everything else
...
break;}}/**
   * _editModeChanged
   */_editModeChanged(newValue,oldValue){if(typeof newValue!==typeof void 0&&newValue){this.__tipText="Save";this.shadowRoot.querySelector("#button").icon="save"}else{this.__tipText="Edit";this.shadowRoot.querySelector("#button").icon="create"}}/**
   * Toggle the drawer when the button is clicked.
   */_clickEditButton(e){this.toggle()}/**
   * Toggle the drawer when the button is clicked.
   */_clickSaveButton(e){this.toggle();this.dispatchEvent(new CustomEvent("hax-save",{bubbles:!0,cancelable:!0,composed:!0,detail:e.detail}))}/**
   * HTML Export trigger.
   */_htmlExportDialog(e){window.HaxStore.instance.haxExport.toggleDialog()}/**
   * Preferences trigger.
   */_preferencesDialog(e){window.HaxStore.instance.haxPreferences.toggleDialog()}/**
   * Toggle the panel.
   */toggle(e){window.HaxStore.write("editMode",!this.editMode,this);this.shadowRoot.querySelector("#drawer").opened=this.editMode;if(!this.shadowRoot.querySelector("#drawer").opened){window.HaxStore.instance.closeAllDrawers()}}}_exports.HaxPanel=HaxPanel;window.customElements.define(HaxPanel.tag,HaxPanel)});