 ...
 * @customElement
 * @polymer
 */class A11yMediaButton extends _a11yMediaBehaviors.A11yMediaBehaviors{// properties available to the custom element for data binding
static get properties(){return{/**
   ...
   */static get tag(){return"a11y-media-button"}//get player-specifc properties
...
static get template(){return _polymerElement.html`
   ...
   */ready(){super.ready();this.__target=this.$.button}/**
   * lets player know this button was clicked
   */_buttonTap(){this.dispatchEvent(new CustomEvent("tap",{detail:this}))}}_exports.A11yMediaButton=A11yMediaButton;window.customElements.define(A11yMediaButton.tag,A11yMediaButton)});