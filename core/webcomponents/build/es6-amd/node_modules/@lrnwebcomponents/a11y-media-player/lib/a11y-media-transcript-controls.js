define(["exports","../../../@polymer/polymer/polymer-element.js","./a11y-media-behaviors.js","../../simple-search/simple-search.js","./a11y-media-button.js"],function(_exports,_polymerElement,_a11yMediaBehaviors,_simpleSearch,_a11yMediaButton){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.A11yMediaTranscriptControls=void 0;/**
 ...
 * @customElement
 * @polymer
 */class A11yMediaTranscriptControls extends _a11yMediaBehaviors.A11yMediaBehaviors{// properties available to the custom element for data binding
static get properties(){return{/**
       * target of the controls
       */target:{type:Object,value:null}}}/**
   * Store the tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */static get tag(){return"a11y-media-transcript-controls"}//get player-specifc properties
...
static get template(){return _polymerElement.html`
   ...
   */connectedCallback(){super.connectedCallback();let root=this;root.search=root.$.simplesearch;root.dispatchEvent(new CustomEvent("searchbar-added",{detail:root.search}))}/**
   * handles the transcript scroll button toggle
   */_handleScrollClick(e){this.dispatchEvent(new CustomEvent("toggle-scroll",{detail:this}))}}_exports.A11yMediaTranscriptControls=A11yMediaTranscriptControls;window.customElements.define(A11yMediaTranscriptControls.tag,A11yMediaTranscriptControls)});