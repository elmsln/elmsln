define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/legacy/polymer.dom.js"],function(_exports,_require,_polymerElement,_polymerDom){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PieMenu=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
 * `pie-menu`
 ...
 */class PieMenu extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../../@polymer/iron-icons/iron-icons.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host,
        :host > div {
          width: 200px;
   ...
   */_itemTapped(e){var normalizedEvent=(0,_polymerDom.dom)(e),localLink=normalizedEvent.localTarget;// make sure we normalize tap vs click vs keyboard
if(!(localLink.hasAttribute("role")&&"button"!==localLink.getAttribute("role"))){localLink=localLink.parentNode}// bubble up event
this.dispatchEvent(new CustomEvent("pie-menu-selection",{bubbles:!0,cancelable:!0,composed:!0,detail:{option:localLink}}))}}_exports.PieMenu=PieMenu;window.customElements.define(PieMenu.tag,PieMenu)});