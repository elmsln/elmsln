...
classes.forEach((item,index)=>{if(""!=item){if(this.focusState){this.$.dialogtrigger.classList.add(item)}else{this.$.dialogtrigger.classList.remove(item)}}})}this.focusState=!this.focusState}/**
   ...
   * detached lifecycle
   */disconnectedCallback(){this.$.dialogtrigger.removeEventListener("focused-changed",this.focusToggle.bind(this));this.$.dialogtrigger.removeEventListener("mousedown",this.tapEventOn.bind(this));this.$.dialogtrigger.removeEventListener("mouseover",this.tapEventOn.bind(this));this.$.dialogtrigger.removeEventListener("mouseout",this.tapEventOff.bind(this));super.disconnectedCallback()}}_exports.LrnsysDialog=LrnsysDialog;window.customElements.define(LrnsysDialog.tag,LrnsysDialog)});