define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/iron-meta/iron-meta.js","../../@polymer/iron-icon/iron-icon.js","../../@polymer/marked-element/marked-element.js"],function(_exports,_polymerElement,_ironMeta,_ironIcon,_markedElement){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.IconsetDemo=void 0;/**
 ...
 */class IconsetDemo extends _polymerElement.PolymerElement{// render function
...
static get properties(){return{/**
   ...
   */ready(){super.ready();const iconSets=new _ironMeta.IronMeta({type:"iconset"});let temp=[];// need to access iconset imperatively now
if(typeof iconSets!==typeof void 0&&iconSets.list&&iconSets.list.length){var index=0;iconSets.list.forEach(function(item){let name=item.name;if(!root._hideIconset(name)){temp.push({name:name,icons:[]});item.getIconNames().forEach(icon=>{temp[index].icons.push(icon)});index++}})}this.__iconList=temp}/**
   ...
   */_hideIconset(name){let isets=null!==this.includeSets?this.includeSets.split(/ /):[],included=0===isets.length||isets.includes(name),esets=null!==this.excludeSets?this.excludeSets.split(/ /):[],excluded=0<esets.length.length&&esets.includes(name);return!included||excluded}/**
   * life cycle, element is removed from the DOM
   */ //disconnectedCallback() {}
}_exports.IconsetDemo=IconsetDemo;window.customElements.define(IconsetDemo.tag,IconsetDemo)});