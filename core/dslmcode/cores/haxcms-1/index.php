...
<html lang="en">
  <head>
    ...
    <link rel="import" href="webcomponents/bower_components/sites-listing/sites-listing.html">
    <!-- Adding Favicon -->
  ...
  <body>
    <sites-listing data-source="<?php print $HAXCMS->sitesJSON;?>"></sites-listing>
  </body>
</html>