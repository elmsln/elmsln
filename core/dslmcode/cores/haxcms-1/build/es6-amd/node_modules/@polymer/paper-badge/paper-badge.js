...
(0,_polymerFn.Polymer)({_template:_htmlTag.html`
  ...
  `,is:"paper-badge",hostAttributes:{role:"status",tabindex:0},behaviors:[_ironResizableBehavior.IronResizableBehavior],listeners:{"iron-resize":"updatePosition"},properties:{for:{type:String,observer:"_forChanged"},label:{type:String,observer:"_labelChanged"},icon:{type:String,value:""},_boundNotifyResize:{type:Function,value:function(){return this.notifyResize.bind(this)}},_boundUpdateTarget:{type:Function,value:function(){return this._updateTarget.bind(this)}}},attached:function(){requestAnimationFrame(this._boundUpdateTarget)},attributeChanged:function(name){"hidden"===name&&this.updatePosition()},_forChanged:function(){this.isAttached&&this._updateTarget()},_labelChanged:function(){this.setAttribute("aria-label",this.label)},_updateTarget:function(){this._target=this.target,requestAnimationFrame(this._boundNotifyResize)},_computeIsIconBadge:function(icon){return icon.length>0},get target(){var parentNode=(0,_polymerDom.dom)(this).parentNode,ownerRoot=(0,_polymerDom.dom)(this).getOwnerRoot();return this.for?(0,_polymerDom.dom)(ownerRoot).querySelector("#"+this.for):parentNode.nodeType==Node.DOCUMENT_FRAGMENT_NODE?ownerRoot.host:parentNode},updatePosition:function(){if(this._target&&this.offsetParent){var parentRect=this.offsetParent.getBoundingClientRect(),targetRect=this._target.getBoundingClientRect(),thisRect=this.getBoundingClientRect();this.style.left=targetRect.left-parentRect.left+(targetRect.width-thisRect.width/2)+"px",this.style.top=targetRect.top-parentRect.top-thisRect.height/2+"px"}}})}));