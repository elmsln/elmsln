...
/**
  ...
  */var m=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),p=m&&m[1]>=8;(0,l.Polymer)({_template:_.html`
    <style>
      :host {
        display: block;
      }
