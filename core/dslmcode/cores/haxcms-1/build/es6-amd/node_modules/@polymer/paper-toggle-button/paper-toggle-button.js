define(["../polymer/polymer-legacy.js","../iron-flex-layout/iron-flex-layout.js","../paper-styles/color.js","../paper-styles/default-theme.js","../paper-behaviors/paper-checked-element-behavior.js","../paper-behaviors/paper-ripple-behavior.js","../polymer/lib/legacy/polymer-fn.js","../polymer/lib/utils/gestures.js","../polymer/lib/utils/html-tag.js","../polymer/lib/utils/render-status.js"],function(_polymerLegacy,_ironFlexLayout,_color,_defaultTheme,_paperCheckedElementBehavior,_paperRippleBehavior,_polymerFn,_gestures,_htmlTag,_renderStatus){const template=_htmlTag.html`
  ...
  `;template.setAttribute("strip-whitespace",""),(0,_polymerFn.Polymer)({_template:template,is:"paper-toggle-button",behaviors:[_paperCheckedElementBehavior.PaperCheckedElementBehavior],hostAttributes:{role:"button","aria-pressed":"false",tabindex:0},properties:{},listeners:{track:"_ontrack"},attached:function(){(0,_renderStatus.afterNextRender)(this,function(){(0,_gestures.setTouchAction)(this,"pan-y")})},_ontrack:function(event){var track=event.detail;"start"===track.state?this._trackStart(track):"track"===track.state?this._trackMove(track):"end"===track.state&&this._trackEnd(track)},_trackStart:function(track){this._width=this.$.toggleBar.offsetWidth/2,this._trackChecked=this.checked,this.$.toggleButton.classList.add("dragging")},_trackMove:function(track){var dx=track.dx;this._x=Math.min(this._width,Math.max(0,this._trackChecked?this._width+dx:dx)),this.translate3d(this._x+"px",0,0,this.$.toggleButton),this._userActivate(this._x>this._width/2)},_trackEnd:function(track){this.$.toggleButton.classList.remove("dragging"),this.transform("",this.$.toggleButton)},_createRipple:function(){this._rippleContainer=this.$.toggleButton;var ripple=_paperRippleBehavior.PaperRippleBehavior._createRipple();return ripple.id="ink",ripple.setAttribute("recenters",""),ripple.classList.add("circle","toggle-ink"),ripple}})});