define(["exports","./boot.js","../mixins/property-effects.js","../mixins/mutable-data.js","./settings.js","./wrap.js"],(function(_exports,_boot,_propertyEffects,_mutableData,_settings,_wrap){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.templatize=templatize,_exports.modelForElement=function modelForElement(template,node){let model;for(;node;)if(model=node.__templatizeInstance){if(model.__dataHost==template)return model;node=model.__dataHost}else node=(0,_wrap.wrap)(node).parentNode;return null},_exports.TemplateInstanceBase=void 0;
/**
  @license
