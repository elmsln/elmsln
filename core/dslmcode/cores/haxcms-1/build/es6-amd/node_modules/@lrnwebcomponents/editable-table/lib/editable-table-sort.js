define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/paper-button/paper-button.js","../../../@polymer/iron-icons/iron-icons.js","./editable-table-iconset.js"],function(_exports,_polymerElement,_paperButton,_ironIcons,_editableTableIconset){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.EditableTableSort=void 0;class EditableTableSort extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
    ...
    `}static get tag(){return"editable-table-sort"}static get properties(){return{columnIndex:{type:Number,value:null,reflectToAttribute:!0},sortMode:{type:String,value:"none",reflectToAttribute:!0},sortColumn:{type:Number,value:-1,reflectToAttribute:!0},sorting:{type:Boolean,computed:"_isSorting(columnIndex,sortColumn)",reflectToAttribute:!0},text:{type:String,value:""}}}_onSortClicked(){this.dispatchEvent(new CustomEvent("change-sort-mode",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}setSortMode(mode){this.sortMode=mode,this.__checked="asc"===mode||"desc"===mode&&mode}_isSorting(columnIndex,sortColumn){return columnIndex===sortColumn}}_exports.EditableTableSort=EditableTableSort,window.customElements.define(EditableTableSort.tag,EditableTableSort)});