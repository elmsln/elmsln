define(["exports","../../../lit-element/lit-element.js","../../responsive-utility/responsive-utility.js","./responsive-grid-col.js","./responsive-grid-clear.js"],(function(e,r,s,n,o){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.ResponsiveGridRow=void 0;class ResponsiveGridRow extends r.LitElement{static get styles(){return[r.css`
        :host {
          display: block;
          width: 100%;
          margin-right: auto;
    ...
    `}static get tag(){return"responsive-grid-row"}constructor(){super(),this.xl=null,this.lg=null,this.md=null,this.sm=null,this.xs=null,this.gutter=0,this.responsiveToParent=!1,this.screen="xs",window.ResponsiveUtility.requestAvailability()}firstUpdated(){this.dispatchEvent(new CustomEvent("responsive-element",{bubbles:!0,cancelable:!0,composed:!0,detail:{element:this,attribute:"screen",relativeToParent:this.responsiveToParent}}))}updated(e){e.forEach((e,r)=>{"screen"==r&&this.dispatchEvent(new CustomEvent("screen-changed",{detail:{value:this[r]}}))})}static get properties(){return{xs:{type:Number},sm:{type:Number},md:{type:Number},lg:{type:Number},xl:{type:Number},gutter:{type:Number},responsiveToParent:{type:Boolean,reflect:!0,attribute:"responsive-to-parent"},screen:{type:String,reflect:!0}}}}e.ResponsiveGridRow=ResponsiveGridRow,window.customElements.define(ResponsiveGridRow.tag,ResponsiveGridRow)}));