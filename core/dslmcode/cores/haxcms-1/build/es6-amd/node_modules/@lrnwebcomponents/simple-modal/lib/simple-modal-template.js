define(["exports", "../../../lit-element/lit-element.js", "../simple-modal.js"], function (_exports, _litElement, _simpleModal) {
   ...
   */
  class SimpleModalTemplate extends _litElement.LitElement {
    /**
    ...
    _getSlot(slotName) {
      let slot = this.querySelectorAll('[slot="' + slotName + '"]'); // account for slot passing down from parent element
