define(["exports", "../../lit-element/lit-element.js", "../hax-body-behaviors/lib/HAXWiring.js", "../a11y-details/a11y-details.js"], function (_exports, _litElement, _HAXWiring, _a11yDetails) {
   ...
   */
  class A11yFigure extends _a11yDetails.A11yDetails {
    //styles function
    static get styles() {
    ...
    render() {
      ...
      <figure>
        ${this.imgSrc ? (0, _litElement.html)` <img src="${this.imgSrc}" alt="${this.imgAlt}" /> ` : ``}
    ...
    _copyAndFilter(clone, nodenames = [], i = 0) {
      let childname = nodenames[i + 1],
          child = clone && childname ? clone.querySelector(`* > ${childname}`) : undefined;
