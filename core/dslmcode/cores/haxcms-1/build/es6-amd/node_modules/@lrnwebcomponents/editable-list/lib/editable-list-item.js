define(["exports","../../../lit-element/lit-element.js","../../simple-colors/simple-colors.js","../../../@polymer/iron-icons/iron-icons.js","../../../@polymer/paper-icon-button/paper-icon-button.js","../../../@polymer/paper-input/paper-input.js","../../../@polymer/polymer/lib/elements/custom-style.js"],function(_exports,_litElement,_simpleColors,_ironIcons,_paperIconButton,_paperInput,_customStyle){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.EditableListItem=void 0;class EditableListItem extends _simpleColors.SimpleColors{static get styles(){return[...super.styles,_litElement.css`
    ...
    `}valueChanged(e){this.value=e.detail.value}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>{"editMode"==propName&&this.dispatchEvent(new CustomEvent("edit-mode-changed",{detail:{value:this[propName]}})),"editing"==propName&&this._editModeChanged(this[propName])})}constructor(){super(),this.editMode=!1,this.editing=!1,this.canEdit=!1,this.canDelete=!1}static get properties(){return{value:{type:String},editMode:{type:Boolean,reflect:!0,attribute:"edit-mode"},editing:{type:Boolean},canEdit:{type:Boolean,reflect:!0,attribute:"can-edit"},canDelete:{type:Boolean,reflect:!0,attribute:"can-delete"}}}static get tag(){return"editable-list-item"}_editToggle(e){this.editing=!this.editing,this.editing&&this.shadowRoot.querySelector("#input").focus()}_deleteModal(e){const evt=new CustomEvent("editable-list-item-delete",{bubbles:!0,cancelable:!0,detail:{element:this}});this.dispatchEvent(evt)}_editModeChanged(newValue,oldValue){void 0!==newValue&&(this.shadowRoot.querySelector("#edit").icon=newValue?"icons:save":"icons:create")}}_exports.EditableListItem=EditableListItem,window.customElements.define(EditableListItem.tag,EditableListItem)});