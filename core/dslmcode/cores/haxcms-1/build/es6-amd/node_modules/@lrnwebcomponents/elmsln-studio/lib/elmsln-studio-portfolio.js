define(["exports", "../../../lit-element/lit-element.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "../../img-view-modal/img-view-modal.js", "../../hax-iconset/hax-iconset.js", "../../threaded-discussion/threaded-discussion.js", "./elmsln-studio-link.js", "./elmsln-studio-button.js"], function (_exports, _litElement, _elmslnStudioStyles, _elmslnStudioUtilities, _imgViewModal, _haxIconset, _threadedDiscussion, _elmslnStudioLink, _elmslnStudioButton) {
  ...
  class ElmslnStudioPortfolio extends (0, _elmslnStudioUtilities.ElmslnStudioUtilities)((0, _elmslnStudioStyles.ElmslnStudioStyles)(_litElement.LitElement)) {
    ...
    render() {
      return !this.portfolio ? "" : (0, _litElement.html)`
          <div id="breadcrumb">
            ...
            ${!this.portfolio.projectId || !this.portfolio.project ? `` : (0, _litElement.html)`
                  ...
                  <span> > </span>
                `}
            ${!this.assignment || !this.assignment.assignment ? `` : (0, _litElement.html)`
                  <elmsln-studio-link
          ...
          >
            <article id="portfolio-project">
              ...
              ${!this.portfolio ? `` : this.sortedSubmissions.map(s => (0, _litElement.html)`
                      <section
