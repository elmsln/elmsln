define(["exports", "require", "../../../../lit-element/lit-element.js", "../../../materializecss-styles/lib/colors.js"], function (_exports, _require, _litElement, _colors) {
  ...
  class LrnappOpenStudioProjects extends _litElement.LitElement {
    /**
    ...
    constructor() {
      super();
      new Promise((res, rej) => _require.default(["../../../lrnsys-button/lrnsys-button.js"], res, rej));
      new Promise((res, rej) => _require.default(["../lrnapp-studio-submission/lrnapp-studio-submission-display.js"], res, rej));
    }

    render() {
      return _litElement.html`
      ${this.showSubmissions ? _litElement.html`
            <h1 class="project-title black-text">
              ${this.activeProject.attributes.title}
            </h1>
            <div class="project-steps">
              ${this.activeProject.attributes.steps.map(assignment => _litElement.html`
                  <lrnsys-button
            ...
            ${this.renderSubmissions.map(submission => _litElement.html`
                <a
