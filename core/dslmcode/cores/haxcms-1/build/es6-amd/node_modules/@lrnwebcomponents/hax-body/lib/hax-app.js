...
```
*/class HAXApp extends HTMLElement{constructor(){super();this.data={};this.eventName="hax-register-app"}static get tag(){return"hax-app"}/**
   * Connected life cycle
   */connectedCallback(){if(typeof this.data!==typeof void 0){this.dispatchEvent(new CustomEvent(this.eventName,{bubbles:!0,composed:!0,cancelable:!1,detail:this.data}))}}}_exports.HAXApp=HAXApp;window.customElements.define(HAXApp.tag,HAXApp)});