define(["exports","../../@polymer/polymer/polymer-element.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/paper-button/paper-button.js"],function(_exports,_polymerElement,_HAXWiring,_paperButton){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.LayoutBuilder=void 0;class LayoutBuilder extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
        }
    ...
    `}static get haxProperties(){return{canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Layout builder",description:"A new UI for adding content to layouts",icon:"icons:android",color:"green",groups:["Builder"],handles:[{type:"todo:read-the-docs-for-usage"}],meta:{author:"nikkimk",owner:"The Pennsylvania State University"}},settings:{quick:[],configure:[],advanced:[]}}}static get properties(){return{type:{name:"type",type:"Boolean",value:"layout"},id:{name:"id",type:"String",reflecttoAttribute:!0}}}static get tag(){return"layout-builder"}connectedCallback(){super.connectedCallback(),this.HAXWiring=new _HAXWiring.HAXWiring,this.HAXWiring.setup(LayoutBuilder.haxProperties,LayoutBuilder.tag,this),this.id=this._generateUUID()}_handleAddChild(){let lb=document.createElement("layout-builder");lb.type="sub-"+this.type,lb.innerHTML=`I am a ${this.type} of ${this.id}.`,this.prepend(lb)}_handleAddSibling(){let lb=document.createElement("layout-builder");lb.type=this.type,lb.innerHTML=`I am a ${this.type} of ${this.id}.`,this.parentNode.insertBefore(lb,this.nextSibling)}_generateUUID(){let hex=Math.floor(65536*(1+Math.random())).toString(16).substring(1);return this.type+"-ss-s-s-s-sss".replace(/s/g,hex)}}_exports.LayoutBuilder=LayoutBuilder,window.customElements.define(LayoutBuilder.tag,LayoutBuilder)});