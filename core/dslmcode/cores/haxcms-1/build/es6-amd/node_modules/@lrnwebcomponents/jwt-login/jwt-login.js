define(["exports","../../lit-element/lit-element.js","../../@polymer/iron-ajax/iron-ajax.js"],(function(e,t,o){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.JwtLogin=void 0;class JwtLogin extends t.LitElement{constructor(){super(),this.auto=!1,this.method="GET",this.body={},this.key="jwt",this.jwt=null}lastErrorChanged(e){e.detail.value&&(console.error(e),this.dispatchEvent(new CustomEvent("jwt-login-refresh-error",{composed:!0,bubbles:!0,cancelable:!1,detail:{value:e.detail.value}})))}render(){return t.html`
      <iron-ajax
        reject-with-request
        ?auto="${this.auto}"
        id="request"
