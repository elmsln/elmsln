define(["exports"], function (_exports) {
  ...
  const mtzMarkedControlLineBehaviorImpl = function (SuperClass) {
    return class extends SuperClass {
      ...
      _handleCommand(event) {
        ...
        const lines = editor.getLines(); // Grab the newline char

        const newlineChar = lines.length > 1 ? lines[1].match(/(\n|\r\n)/)[0] : ""; // Grab lines within the selection
        ...
        let offset = 0; // Toggle syntax on each line
