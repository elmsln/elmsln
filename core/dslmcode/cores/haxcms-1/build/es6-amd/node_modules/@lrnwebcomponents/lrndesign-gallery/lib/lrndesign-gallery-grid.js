define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "./lrndesign-gallery-behaviors.js", "./lrndesign-gallery-zoom.js", "./lrndesign-gallery-details.js"], function (_exports, _polymerElement, _renderStatus, _lrndesignGalleryBehaviors, _lrndesignGalleryZoom, _lrndesignGalleryDetails) {
  "use strict";
  ...
  class LrndesignGalleryGrid extends _lrndesignGalleryBehaviors.LrndesignGalleryBehaviors {
    ...
    _getImageStyle(items = []) {
      ...
      if (items !== undefined && items.length > 0) {
        img.src = items[0].src;
        if (img.naturalWidth > 0 && img.naturalHeight > 0) padding = 100 * img.naturalHeight / img.naturalWidth;
      }
