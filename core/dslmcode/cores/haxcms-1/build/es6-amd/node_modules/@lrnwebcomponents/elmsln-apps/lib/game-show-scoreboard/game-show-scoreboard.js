define(["exports","../../../../@polymer/polymer/polymer-element.js","../../../../@polymer/polymer/lib/elements/dom-if.js","../../../../@polymer/polymer/lib/elements/dom-repeat.js","../../../../@polymer/app-route/app-location.js","../../../../@polymer/app-route/app-route.js","../../../../@polymer/iron-ajax/iron-ajax.js","../../../../@polymer/paper-toggle-button/paper-toggle-button.js","../../../../@polymer/paper-item/paper-item.js","../../../../@polymer/paper-button/paper-button.js","../../../../@polymer/paper-input/paper-input.js","../../../../@polymer/paper-icon-button/paper-icon-button.js","../../../../@polymer/paper-tooltip/paper-tooltip.js","../../../../@vaadin/vaadin-grid/vaadin-grid.js","../../../../@vaadin/vaadin-grid/vaadin-grid-filter.js","../../../../@vaadin/vaadin-grid/vaadin-grid-sorter.js","../../../../@vaadin/vaadin-grid/vaadin-grid-sort-column.js","../../../../@vaadin/vaadin-grid/vaadin-grid-column-group.js","../../../../@vaadin/vaadin-grid/vaadin-grid-selection-column.js","../../../simple-datetime/simple-datetime.js","../../../elmsln-loading/elmsln-loading.js","../../../simple-picker/simple-picker.js","../../../lrndesign-avatar/lrndesign-avatar.js"],function(_exports,_polymerElement,_domIf,_domRepeat,_appLocation,_appRoute,_ironAjax,_paperToggleButton,_paperItem,_paperButton,_paperInput,_paperIconButton,_paperTooltip,_vaadinGrid,_vaadinGridFilter,_vaadinGridSorter,_vaadinGridSortColumn,_vaadinGridColumnGroup,_vaadinGridSelectionColumn,_simpleDatetime,_elmslnLoading,_simplePicker,_lrndesignAvatar){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.GameShowScoreboard=void 0;class GameShowScoreboard extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
    ...
    `}static get tag(){return"game-show-scoreboard"}static get observers(){return["_routeChanged(route, endPoint)"]}/**
   * props
   */static get properties(){return{elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},optionsPath:{type:String},dataPath:{type:String},section:{type:String},game:{type:String,value:""},dataRequestUrl:{type:String,computed:"_computeDataRequestUrl(dataPath, section, game)"},/**
       * routing variable for url
       */route:{type:String},tail:{type:String},optionsData:{type:Object,value:{},observer:"_optionsDataChanged"},sectionOptions:{type:Array,value:[]},gameOptions:{type:Array,value:[]},activeData:{type:Object,value:{},observer:"_activeDataChanged"},visibleData:{type:Array,value:[]}}}_computeDataRequestUrl(dataPath,section,game){return`${dataPath}&section=${section}&game=${game}`}_optionsDataChanged(newValue){if(newValue&&newValue.status){var sections=[];for(var i in newValue.data.sections){sections.push([{alt:newValue.data.sections[i],value:i}])}var games=[];for(var i in newValue.data.games){games.push([{alt:newValue.data.games[i],value:i}])}this.set("sectionOptions",sections);this.set("gameOptions",games)}}_activeDataChanged(newValue){this.set("visibleData",newValue.data)}/**
   * Route changed
   */_routeChanged(route,endPoint){if("string"===typeof route.path){if("string"===typeof endPoint){// ignore "home page" as well since that's our path
if(route.path.startsWith(endPoint)||"/"==route.path){return}}window.location.reload()}}connectedCallback(){super.connectedCallback();if(document.getElementById("block-mooc-nav-block-mooc-nav-nav")){document.getElementById("block-mooc-nav-block-mooc-nav-nav").remove()}}_toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}_exports.GameShowScoreboard=GameShowScoreboard;window.customElements.define(GameShowScoreboard.tag,GameShowScoreboard)});