  ...
  class SimpleBlogHeader extends _polymerElement.PolymerElement {
    ...
    connectedCallback() {
      ...
      (0, _mobxModule.autorun)(reaction => {
        ...
        this.image = (0, _haxutils.varGet)(manifest, "metadata.theme.variables.image", "assets/banner.jpg");
        this.icon = (0, _haxutils.varGet)(manifest, "metadata.theme.variables.icon", "icons:record-voice-over");
        this.author = (0, _haxutils.varGet)(manifest, "metadata.author", {});
