  ...
  return function (r) {
      ...
      return t = e, (r = [{
        ...
        value: function (e, t) {
          if (this.handlers) {
            var r,
                n = this.handlers[e];
            if (n) if (t) for (r = n.length - 1; 0 <= r; r--) n[r] == t && n.splice(r, 1);else n.length = 0;
          }
        }
      }, {
        key: "unAll",
    ...
    var c = function (e) {
      ...
      return function (e, t) {
        ...
        key: "updateSize",
        value: function () {
          for (var n = this, e = Math.round(this.width / this.params.pixelRatio), t = Math.ceil(e / this.maxCanvasElementWidth); this.canvases.length < t;) this.addCanvas();
