define(["exports", "meta", "require", "../../../../lit-element/lit-element.js", "../../../utils/utils.js", "../../../../mobx/dist/mobx.esm.js", "./haxcms-site-store.js", "../../../hax-body/lib/hax-store.js", "../../../simple-toast/simple-toast.js", "../../../simple-progress/simple-progress.js"], function (_exports, meta, _require, _litElement, _utils, _mobxEsm, _haxcmsSiteStore, _haxStore, _simpleToast, _simpleProgress) {
  "use strict";
  ...
  class HAXCMSSiteBuilder extends _litElement.LitElement {
    ...
    updated(changedProperties) {
      ...
      changedProperties.forEach((oldValue, propName) => {
        if (["outlineLocation", "activeItemLocation"].includes(propName) && this[propName] != "") {
          loadPage = true;
        }

        if (["outlineLocation", "file"].includes(propName) && this[propName] != "") {
          loadOutline = true;
        }
    ...
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["./haxcms-site-router.js"], res, rej));
    ...
    firstUpdated(changedProperties) {
        ...
        if (this.children[i].tagName && this.children[i].getAttribute("slot")) {
          ...
          switch (key) {
            ...
            case "haxcms-site-editor-ui-suffix-buttons":
              _haxcmsSiteStore.store.setupSlots[key] = item;
              break;
          }
        }
      ...
      setTimeout(() => {
        ...
        (0, _mobxEsm.autorun)(reaction => {
          this.dashboardOpened = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.dashboardOpened);

          this.__disposer.push(reaction);
        });
        (0, _mobxEsm.autorun)(reaction => {
          this.themeData = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.themeData);
    ...
    storeReady(e) {
      ...
      if (_haxcmsSiteStore.store.cmsSiteEditor && _haxcmsSiteStore.store.cmsSiteEditor.instance && _haxStore.HAXStore.activeHaxBody && _haxcmsSiteStore.store.activeItemContent) {
        _haxStore.HAXStore.activeHaxBody.importContent(_haxcmsSiteStore.store.activeItemContent);
      }
    }
    /**
