      ...
      schemaKeys.forEach(key => {
        ...
        if (data && data.element) {
          let id = `${prefix}${key}`,
              ...
              value = this._getValue(`${prefix}${key}`); // support for dynamic import of location of this field


          if (!window.customElements.get(data.element) && data.import) {
            new Promise((res, rej) => _require.default([`${this.basePath}${data.import}`], res, rej));
