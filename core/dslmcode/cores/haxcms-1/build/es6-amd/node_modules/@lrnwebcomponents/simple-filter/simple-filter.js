define(["exports", "../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  _exports.SimpleFilter = _exports.SimpleFilterMixin = void 0;
   ...
   */
  const SimpleFilterMixin = function (SuperClass) {
    return class extends SuperClass {
      ...
      update(changedProperties) {
        ...
        changedProperties.forEach((oldValue, propName) => {
          if (["items", "where", "like", "caseSensitive"].includes(propName) && this.shadowRoot) {
            clearTimeout(this.__debounce);
            this.__debounce = setTimeout(() => {
              this.filtered = this._computeFiltered(this.items, this.where, this.like, this.caseSensitive);
            }, 0);
          }
          ...
          if (propName == "filtered" && this.shadowRoot) {
            ...
            this.dispatchEvent(new CustomEvent("filtered-changed", {
              bubbles: true,
              cancelable: true,
              composed: true,
              detail: {
      ...
      _computeFiltered(items, where, like, caseSensitive) {
        ...
        var filtered = []; //Save a reference to this object
  ...
  class SimpleFilter extends SimpleFilterMixin(_litElement.LitElement) {
    constructor() {
      super();
    }
