define(["exports","require","../../lit-element/lit-element.js"],(function(e,t,i){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.MagazineCover=void 0,t=babelHelpers.interopRequireWildcard(t);
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class MagazineCover extends i.LitElement{static get styles(){return[i.css`
        :host {
          display: block;
      ...
      `]}constructor(){super(),this.action="Touch to learn more",this.icon="trending-flat",this.link="",this.eventName="",this.eventData={},new Promise((e,i)=>t.default(["../../@polymer/iron-image/iron-image.js"],e,i)),new Promise((e,i)=>t.default(["../../@polymer/iron-icons/iron-icons.js"],e,i)),new Promise((e,i)=>t.default(["../../@polymer/iron-icon/iron-icon.js"],e,i)),new Promise((e,i)=>t.default(["../../@polymer/paper-button/paper-button.js"],e,i))}render(){return i.html`
      <iron-image
        src="${this.image}"
        preload=""
        fade=""
