define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/paper-card/paper-card.js", "../../../../@polymer/marked-element/marked-element.js", "../../../../@polymer/iron-image/iron-image.js", "../../../image-inspector/image-inspector.js", "../../../lrndesign-avatar/lrndesign-avatar.js", "../../../word-count/word-count.js", "../../../lrnsys-button/lrnsys-button.js", "../../../lrndesign-contentblock/lrndesign-contentblock.js", "../../../lrnsys-layout/lib/lrnsys-dialog.js"], function (_exports, _litElement, _paperCard, _markedElement, _ironImage, _imageInspector, _lrndesignAvatar, _wordCount, _lrnsysButton, _lrndesignContentblock, _lrnsysDialog) {
  ...
  class LrnappStudioSubmissionDisplay extends _litElement.LitElement {
    /**
      ...
      <div class="submission-page">
        <paper-card class="submission-page-card ferpa-protect">
          <div class="card-content">
            ...
            <!-- ----- Images Submission ----- -->
            ${this.submission.attributes.images ? _litElement.html`
                  <lrndesign-contentblock class="center">
                    ${this._toArray(this.submission.attributes.images).map(image => _litElement.html`
                        <lrnsys-dialog alt="View Image" dynamic-images="">
                          ...
                          <div style="text-align: center;">
                            ${this._isGif(image.url) ? _litElement.html`
                                  <iron-image
                ...
                ` : ``}
            <!-- ----- Video Submission ----- -->
            ${this.submission.attributes.video ? _litElement.html`
                  <lrndesign-contentblock>
                    ${this._toArray(this.submission.attributes.video).map(video => _litElement.html`
                        <iframe
                          width="460"
                          height="249"
                          src="${video.video_src}"
                ...
                ` : ``}
            <!-- ----- Links Submission ----- -->
            ${this.submission.attributes.links ? _litElement.html`
                  <lrndesign-contentblock>
                    ${this._toArray(this.submission.attributes.links).map(link => _litElement.html`
                        <p>
                ...
                ` : ``}
            <!-- ----- Files Submission ----- -->
            ${this.submission.attributes.files ? _litElement.html`
                  <lrndesign-contentblock title="Files Submitted">
                    ${this._toArray(this.submission.attributes.files).map(file => _litElement.html`
                        <p>
