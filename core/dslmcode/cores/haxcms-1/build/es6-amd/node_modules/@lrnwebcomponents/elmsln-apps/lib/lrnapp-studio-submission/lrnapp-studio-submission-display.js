define(["exports","../../../../@polymer/polymer/polymer-element.js","../../../../@polymer/paper-card/paper-card.js","../../../../@polymer/marked-element/marked-element.js","../../../../@polymer/iron-image/iron-image.js","../../../../@polymer/polymer/lib/elements/dom-if.js","../../../image-inspector/image-inspector.js","../../../lrndesign-avatar/lrndesign-avatar.js","../../../word-count/word-count.js","../../../../@polymer/polymer/lib/elements/dom-repeat.js","../../../lrnsys-button/lrnsys-button.js","../../../lrndesign-contentblock/lrndesign-contentblock.js","../../../lrnsys-layout/lib/lrnsys-dialog.js","../../../utils/utils.js"],(function(e,t,i,s,a,n,r,o,l,d,m,p,c,u){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.LrnappStudioSubmissionDisplay=void 0;class LrnappStudioSubmissionDisplay extends t.PolymerElement{static get template(){return t.html`
    ...
    `}static get tag(){return"lrnapp-studio-submission-display"}static get properties(){return{submission:{type:Object,notify:!0,observer:"_submissionLoaded"},elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String}}}_submissionLoaded(e){if(this.shadowRoot&&this.shadowRoot.querySelector("#markedarea")&&(0,u.wipeSlot)(this.shadowRoot.querySelector("#markedarea")),e&&e.attributes&&e.attributes.body){let t=document.createElement("script");t.type="text/markdown",t.innerHTML=e.attributes.body,this.shadowRoot.querySelector("#markedarea").appendChild(t),this.shadowRoot.querySelector("#markedarea").markdown=e.attributes.body}}date(e){if(e){var t=e.split("-");let i=e.split("T"),s=t[2].split("T");return i=i[1].split("-"),t[1]+"/"+s[0]+" - "+i[0]}}_toArray(e){return"object"==typeof e&&null!==e?Object.keys(e).map((function(t){return e[t]})):[]}_isGif(e){return!(!e||-1==e.indexOf(".gif"))}}e.LrnappStudioSubmissionDisplay=LrnappStudioSubmissionDisplay,window.customElements.define(LrnappStudioSubmissionDisplay.tag,LrnappStudioSubmissionDisplay)}));