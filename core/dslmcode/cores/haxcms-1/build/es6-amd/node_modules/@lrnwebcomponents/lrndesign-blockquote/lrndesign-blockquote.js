define(["exports","meta","../../lit-element/lit-element.js","../schema-behaviors/schema-behaviors.js"],function(_exports,meta,_litElement,_schemaBehaviors){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.LrndesignBlockquote=void 0,meta=babelHelpers.interopRequireWildcard(meta);class LrndesignBlockquote extends((0,_schemaBehaviors.SchemaBehaviors)(_litElement.LitElement)){static get styles(){return[_litElement.css`
        :host {
    ...
    `}static get tag(){return"lrndesign-blockquote"}constructor(){super(),this.displayMode="default"}static get properties(){return{citation:{type:String},image:{type:String},author:{type:String},sourceLink:{type:String,attribute:"source-link"},displayMode:{type:String,reflect:!0,attribute:"display-mode"}}}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>{if(["author","image","citation","displayMode","sourceLink"].includes(propName)){let eventName=`${propName.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g,"$1-$2").toLowerCase()}-changed`;this.dispatchEvent(new CustomEvent(eventName,{detail:{value:this[propName]}}))}"displayMode"==propName&&this._displayModeChanged(this[propName]),"image"==propName&&this._imageChanged(this[propName])})}_imageChanged(newValue){"hypercard"==this.displayMode?(this.shadowRoot.querySelector("#wrap").style.cssText="",this.shadowRoot.querySelector("#thumb").style.cssText=""):"poster"==this.displayMode?(this.shadowRoot.querySelector("#wrap").style.cssText="background: #444 url("+newValue+") no-repeat 140% 25%",this.shadowRoot.querySelector("#thumb").style.cssText=""):(this.shadowRoot.querySelector("#wrap").style.cssText="",this.shadowRoot.querySelector("#thumb").style.cssText="background: url("+newValue+") no-repeat center center")}pathFromUrl(url){return url.substring(0,url.lastIndexOf("/")+1)}_displayModeChanged(newValue){if("hypercard"==newValue){this.shadowRoot.querySelector("#wrap").style.cssText="",this.shadowRoot.querySelector("#thumb").style.cssText="";let style=document.createElement("style"),basePath=this.pathFromUrl(decodeURIComponent(meta.url));style.innerHTML=`@font-face {\n        font-family: 'Chikarego';\n        font-display: swap;\n        src: url('${basePath}lib/chikarego2-webfont.woff2') format('woff2'),\n             url('${basePath}lib/chikarego2-webfont.woff') format('woff');\n        font-weight: normal;\n        font-style: normal;\n      }`,document.head.appendChild(style)}else"poster"==newValue?(this.shadowRoot.querySelector("#wrap").style.cssText="background: #444 url("+this.image+") no-repeat 140% 25%",this.shadowRoot.querySelector("#thumb").style.cssText=""):(this.shadowRoot.querySelector("#wrap").style.cssText="",this.shadowRoot.querySelector("#thumb").style.cssText="background: url("+this.image+") no-repeat center center")}static get haxProperties(){return{canScale:!0,canPosition:!0,canEditSource:!0,gizmo:{title:"Fancy quote",description:"Presents a famous quote with additional design options.",icon:"editor:format-quote",color:"grey",groups:["Content","Presentation"],handles:[{type:"image",source:"image",src:"image",author:"author",description:"",citation:"citation"}],meta:{author:"ELMS:LN"}},settings:{quick:[{property:"displayMode",title:"Display style",description:"Style to present the quote with",inputMethod:"select",icon:"image:style",options:{default:"Default",leather:"Leather",swoop:"Swoop",soft:"Soft",poster:"Poster",fun:"Fun",photo:"Photo",hypercard:"Hypercard"}},{property:"image",title:"Image",description:"Picture of the author of this quote",inputMethod:"textfield",icon:"editor:short-text",required:!1,validationType:"text"}],configure:[{property:"displayMode",title:"Display style",description:"Style to present the quote with",inputMethod:"select",icon:"image:style",options:{default:"Default",leather:"Leather",swoop:"Swoop",soft:"Soft",poster:"Poster",fun:"Fun",photo:"Photo",hypercard:"Hypercard"}},{property:"image",title:"Image",description:"Picture of the author of this quote",inputMethod:"haxupload",icon:"editor:short-text",required:!1,validationType:"text"},{property:"citation",title:"Citation",description:"",inputMethod:"textfield",icon:"editor:short-text",required:!1,validationType:"text"},{property:"author",title:"Author",description:"",inputMethod:"textfield",icon:"editor:short-text",required:!1,validationType:"text"},{slot:"",title:"Quote",description:"",inputMethod:"textfield",icon:"editor:format-quote",required:!0,validationType:"text"},{property:"sourceLink",title:"Source link",description:"Reference to the ",inputMethod:"haxupload",icon:"editor:short-text",required:!1,validationType:"url"}],advanced:[]}}}}_exports.LrndesignBlockquote=LrndesignBlockquote,window.customElements.define(LrndesignBlockquote.tag,LrndesignBlockquote)});