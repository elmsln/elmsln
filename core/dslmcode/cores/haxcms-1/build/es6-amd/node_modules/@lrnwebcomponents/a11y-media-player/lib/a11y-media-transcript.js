define(["exports","../../../@polymer/polymer/polymer-element.js","./a11y-media-behaviors.js","./a11y-media-transcript-cue.js"],function(_exports,_polymerElement,_a11yMediaBehaviors,_a11yMediaTranscriptCue){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.A11yMediaTranscript=void 0;class A11yMediaTranscript extends _a11yMediaBehaviors.A11yMediaBehaviors{static get properties(){return{activeCues:{type:Array,value:null,reflectToAttribute:!0,notify:!0},disableInteractive:{name:"disableInteractive",type:Boolean,value:!1},hideTimestamps:{name:"hideTimestamps",type:Boolean,value:!1},lang:{type:String,value:"en",reflectToAttribute:!0},mediaId:{type:String,value:null},tabIndex:{type:Number,computed:"_getTabIndex(disableInteractive)"},role:{type:Number,computed:"_getRole(disableInteractive)"},selectedTranscript:{type:String,value:"0"},status:{type:String,computed:"_stampLoadingStatus(disableSeek, __ready)"},__ready:{type:Boolean,value:!1},tracks:{type:Array,value:null}}}static get tag(){return"a11y-media-transcript"}static get template(){return _polymerElement.html`
      <style>
        :host {
    ...
    `}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent("transcript-ready",{detail:this}))}ready(){super.ready(),this.__ready=!0}download(mediaTitle){let a=document.createElement("a"),title=null!==mediaTitle&&""!==mediaTitle?mediaTitle:this._getLocal("transcript","label"),filename=null!==mediaTitle&&""!==mediaTitle?mediaTitle.replace(/[^\w\d]/g,""):"Transcript",track=this.shadowRoot.querySelector("#download[active]"),data=null!==track?track.innerText:"";a.setAttribute("href","data:text/plain;charset=UTF-8,"+encodeURIComponent(title+"\n"+data)),a.setAttribute("download",filename+".txt"),a.style.display="none",document.body.appendChild(a),a.click(),document.body.removeChild(a)}print(mediaTitle){let track=this.shadowRoot.querySelector("#track[active]").cloneNode(!0),css=_polymerElement.html`
        <style>
          a11y-media-transcript-cue {
            display: table-row;
