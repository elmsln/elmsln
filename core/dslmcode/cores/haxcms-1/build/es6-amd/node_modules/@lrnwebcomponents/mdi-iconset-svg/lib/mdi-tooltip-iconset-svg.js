define(["../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-iconset-svg/iron-iconset-svg.js", "../../../@polymer/polymer/lib/utils/html-tag.js"], function (_ironIcon, _ironIconsetSvg, _htmlTag) {
   ...
   * @customElement mdi-tooltip-iconset-svg is a iconset for the Material Design Icons collection with the "tooltip" tag
   *
   * Example:
   *   <iron-icon icon="mdi-tooltip:tooltip-outline"></iron-icon>
   *
