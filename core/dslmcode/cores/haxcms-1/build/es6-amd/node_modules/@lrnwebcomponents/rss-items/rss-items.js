define(["exports","meta","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/polymer/lib/utils/resolve-url.js","../es-global-bridge/es-global-bridge.js","../../@polymer/iron-ajax/iron-ajax.js","../../@polymer/polymer/lib/elements/dom-repeat.js"],function(_exports,meta,_require,_polymerElement,_renderStatus,_HAXWiring,_resolveUrl,_esGlobalBridge,_ironAjax,_domRepeat){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.RssItems=void 0,meta=babelHelpers.interopRequireWildcard(meta),_require=babelHelpers.interopRequireWildcard(_require);class RssItems extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        :host([hidden]) {
          display: none;
        }
