define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/render-status.js","../../../@polymer/polymer/lib/utils/async.js","../../simple-colors/simple-colors.js","../../grafitto-filter/grafitto-filter.js","../../../@polymer/iron-list/iron-list.js","./hax-shared-styles.js"],function(_exports,_require,_polymerElement,_renderStatus,_async,_simpleColors,_grafittoFilter,_ironList,_haxSharedStyles){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxGizmoBrowser=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxGizmoBrowser extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../dropdown-select/dropdown-select.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-gizmo-browser-item.js"],res,rej))}static get template(){return _polymerElement.html`
    ...
    `}static get tag(){return"hax-gizmo-browser"}static get properties(){return{search:{type:String},title:{type:String,value:"Make"}}}ready(){super.ready(),this.resetBrowser(),(0,_renderStatus.afterNextRender)(this,function(){this.shadowRoot.querySelector("#inputfilter").addEventListener("value-changed",e=>{this.shadowRoot.querySelector("#filter").like=e.target.value}),this.shadowRoot.querySelector("#filtertype").addEventListener("change",e=>{this.shadowRoot.querySelector("#inputfilter").value="",this.shadowRoot.querySelector("#filter").where=e.detail.value,this.shadowRoot.querySelector("#filter").like=""}),document.body.addEventListener("hax-store-property-updated",this._haxStorePropertyUpdated.bind(this))})}_haxStorePropertyUpdated(e){e.detail&&void 0!==e.detail.value&&e.detail.property&&this.set(e.detail.property,e.detail.value)}resetBrowser(){void 0!==this.shadowRoot.querySelector("#filter")&&_async.microTask.run(()=>{this.set("__gizmoList",window.HaxStore.instance.gizmoList),this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist")&&(this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist").filtered=this.__gizmoList),this.shadowRoot.querySelector("#inputfilter").value="",this.shadowRoot.querySelector("#filtertype").value="title",this.shadowRoot.querySelector("#filter").value="",this.shadowRoot.querySelector("#filter").filter(),this.shadowRoot.querySelector("#filter").where="title",this.shadowRoot.querySelector("#filter").like="",setTimeout(()=>{this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist")&&(this.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist").dispatchEvent(new CustomEvent("iron-resize",{bubbles:!0,cancelable:!0,composed:!0,detail:!0})),window.dispatchEvent(new Event("resize")))},100)})}}_exports.HaxGizmoBrowser=HaxGizmoBrowser,window.customElements.define(HaxGizmoBrowser.tag,HaxGizmoBrowser)});