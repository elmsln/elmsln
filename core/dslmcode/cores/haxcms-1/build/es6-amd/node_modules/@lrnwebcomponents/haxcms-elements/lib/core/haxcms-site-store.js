define(["exports", "../../../../mobx/dist/mobx.esm.js", "../../../utils/utils.js", "../../../json-outline-schema/json-outline-schema.js", "../../../hax-body/lib/hax-store.js"], function (_exports, _mobxEsm, _utils, _jsonOutlineSchema, _haxStore) {
  ...
  class HAXCMSSiteStore extends HTMLElement {
    constructor() {
      super(); // keep track of the HTML element pieces dedicated to different
      // critical pieces of functionality like theme and editor builders.

      this.storePieces = {}; // full on store that does the heavy lifting

      this.store = store; // source for reading in the store if different than default site.json
      ...
      (0, _mobxEsm.autorun)(() => {
        const foundItem = (0, _mobxEsm.toJS)(store.findItem(store.activeId));
      ...
      (0, _mobxEsm.autorun)(() => {
        const editMode = (0, _mobxEsm.toJS)(store.editMode); // trap for early setup
