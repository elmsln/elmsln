define(["exports","../../../../@polymer/polymer/polymer-element.js","./rich-text-editor-breadcrumb.js","../rich-text-editor-styles.js","../buttons/rich-text-editor-button-styles.js"],function(_exports,_polymerElement,_richTextEditorBreadcrumb,_richTextEditorStyles,_richTextEditorButtonStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.RichTextEditorBreadcrumbs=void 0;/**
 ...
 * @customElement
 * @polymer
 */class RichTextEditorBreadcrumbs extends _polymerElement.PolymerElement{/* REQUIRED FOR TOOLING DO NOT TOUCH */ // render function
...
static get properties(){return{/**
   ...
   * @returns {void}
   */_getAncestorNodes(range,controls){let nodes=[],node="",ancestor=!1,parent=!1;if(range)ancestor=range.commonAncestorContainer;if(ancestor)parent=ancestor;this.hidden=!ancestor;while(parent&&"RICH-TEXT-EDITOR"!==parent.nodeName){nodes.unshift({tag:parent.nodeName.toLowerCase(),target:parent});parent=parent.parentNode}return nodes}}_exports.RichTextEditorBreadcrumbs=RichTextEditorBreadcrumbs;window.customElements.define(RichTextEditorBreadcrumbs.tag,RichTextEditorBreadcrumbs)});