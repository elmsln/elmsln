define(["exports", "meta", "require", "../../../../../@polymer/polymer/polymer-element.js", "../../../../../@vaadin/router/dist/vaadin-router.js", "../../../../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../../../../@polymer/polymer/lib/utils/async.js", "../../../../../@polymer/polymer/lib/utils/resolve-url.js", "../../../../../@polymer/polymer/lib/utils/render-status.js", "../../../../hax-body/lib/haxutils.js", "../../../../../@polymer/app-layout/app-header/app-header.js", "../../../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../../../../@polymer/app-layout/app-drawer/app-drawer.js", "../../../../../@polymer/app-layout/app-drawer-layout/app-drawer-layout.js", "../../../../../@polymer/app-layout/app-header-layout/app-header-layout.js", "../../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../simple-colors/simple-colors.js", "../../../../hax-body/lib/hax-shared-styles.js", "../../../../map-menu/map-menu.js"], function (_exports, meta, _require, _polymerElement, _vaadinRouter, _polymerDom, _async, _resolveUrl, _renderStatus, _haxutils, _appHeader, _appToolbar, _appDrawer, _appDrawerLayout, _appHeaderLayout, _ironAjax, _simpleColors, _haxSharedStyles, _mapMenu) {
  "use strict";
   ...
   */
  class HAXCMSLegacyPlayer extends _polymerElement.PolymerElement {
    /**
    ...
    _activeItemContentChanged(newValue, oldValue) {
      if (newValue) {
        ...
        if (html !== null) {
          ...
          html = (0, _haxutils.encapScript)(newValue); // insert the content as quickly as possible, then work on the dynamic imports
          ...
          if (this.manifest.metadata.dynamicElementLoader) {
            ...
            for (var i in tagsFound) {
              ...
              if (this.manifest.metadata.dynamicElementLoader[tagName] && !window.customElements.get(tagName)) {
                new Promise((res, rej) => _require.default([`${basePath}../../../../../${this.manifest.metadata.dynamicElementLoader[tagName]}`], res, rej)).then(response => {//console.log(tagName + ' dynamic import');
                }).catch(error => {
                  /* Error handling */
                  console.log(error);
                });
