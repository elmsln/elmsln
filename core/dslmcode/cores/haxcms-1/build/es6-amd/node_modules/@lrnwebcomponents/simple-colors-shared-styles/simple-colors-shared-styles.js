define(["exports", "../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  _exports.SimpleColorsSharedStylesGlobal = _exports.SimpleColorsSharedStyles = void 0;
  ...
  class SimpleColorsSharedStyles extends _litElement.LitElement {
    //styles function
    static get styles() {
  ...
  _exports.SimpleColorsSharedStyles = SimpleColorsSharedStyles;
  window.customElements.define(SimpleColorsSharedStyles.tag, SimpleColorsSharedStyles);
  ...
  window.SimpleColorsSharedStyles.requestAvailability = () => {
    if (window.SimpleColorsSharedStyles.instance == null) {
      window.SimpleColorsSharedStyles.instance = document.createElement("simple-colors-shared-styles");
      window.SimpleColorsSharedStyles.colors = window.SimpleColorsSharedStyles.instance.colors;
      window.SimpleColorsSharedStyles.contrasts = window.SimpleColorsSharedStyles.instance.contrasts;
      window.SimpleColorsSharedStyles.stylesheet = document.createElement("style");
  ...
  const SimpleColorsSharedStylesGlobal = window.SimpleColorsSharedStyles.requestAvailability();
  _exports.SimpleColorsSharedStylesGlobal = SimpleColorsSharedStylesGlobal;
});