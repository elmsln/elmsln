define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../haxcms-elements/lib/core/haxcms-site-store.js", "../../utils/utils.js", "../../../mobx/dist/mobx.esm.js", "../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _simpleColors, _haxcmsSiteStore, _utils, _mobxEsm, _customStyle) {
  ...
  class SimpleBlogFooter extends _simpleColors.SimpleColors {
    ...
    constructor() {
      ...
      this.prevChanged = "";
      this.nextTitle = "";
      this.nextChanged = ""; // prettier-ignore
    ...
    connectedCallback() {
      ...
      (0, _mobxEsm.autorun)(reaction => {
        this.manifest = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.routerManifest);
      ...
      (0, _mobxEsm.autorun)(reaction => {
        this.activeManifestIndex = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeManifestIndex);
