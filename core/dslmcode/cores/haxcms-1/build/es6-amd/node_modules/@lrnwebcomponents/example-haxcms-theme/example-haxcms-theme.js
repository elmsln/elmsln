 ...
 */class ExampleHaxcmsTheme extends(0,_HAXCMSThemeWiring.HAXCMSTheme)(_polymerElement.PolymerElement){// render function
...
new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/navigation/site-top-menu.js"],res,rej));new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js"],res,rej));new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/layout/site-modal.js"],res,rej));// create a blank array to store mobx reactions
...
(0,_renderStatus.afterNextRender)(this,function(){new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"],res,rej));new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/site/site-search.js"],res,rej))})}/**
...
(0,_mobxModule.autorun)(reaction=>{this.activeManifestIndex=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.activeManifestIndex);this.__disposer.push(reaction)});// editMode is the global state of the HAXeditor as reflected in HAXcms
(0,_mobxModule.autorun)(reaction=>{this.editMode=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.editMode);this.__disposer.push(reaction)})}/**
...
for(var i in this.__disposer){this.__disposer[i].dispose()}super.disconnectedCallback()}}_exports.ExampleHaxcmsTheme=ExampleHaxcmsTheme;window.customElements.define(ExampleHaxcmsTheme.tag,ExampleHaxcmsTheme)});