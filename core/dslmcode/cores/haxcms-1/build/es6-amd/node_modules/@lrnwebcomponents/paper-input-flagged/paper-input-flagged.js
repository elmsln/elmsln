define(["exports","require","../../lit-element/lit-element.js"],function(_exports,_require,_litElement){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.PaperInputFlagged=void 0,_require=babelHelpers.interopRequireWildcard(_require);class PaperInputFlagged extends _litElement.LitElement{static get styles(){return[_litElement.css`
        :host {
          display: block;
        }
        iron-icon {
