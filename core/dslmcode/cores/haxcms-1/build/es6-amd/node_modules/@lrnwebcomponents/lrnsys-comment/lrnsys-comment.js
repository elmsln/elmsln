define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/polymer/lib/utils/async.js","../../@polymer/paper-input/paper-textarea.js","../materializecss-styles/lib/colors.js","../mtz-marked-editor/mtz-marked-editor.js","../mtz-marked-editor/lib/mtz-marked-control-generic-line.js","../mtz-marked-editor/lib/mtz-marked-control-generic-wrap.js","../mtz-marked-editor/lib/mtz-marked-control-link.js","../word-count/word-count.js","../lrnsys-button/lrnsys-button.js","../lrndesign-avatar/lrndesign-avatar.js"],function(_exports,_require,_polymerElement,_polymerDom,async,_paperTextarea,_colors,_mtzMarkedEditor,_mtzMarkedControlGenericLine,_mtzMarkedControlGenericWrap,_mtzMarkedControlLink,_wordCount,_lrnsysButton,_lrndesignAvatar){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.LrnsysComment=void 0,_require=babelHelpers.interopRequireWildcard(_require),async=babelHelpers.interopRequireWildcard(async);class LrnsysComment extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["../../@polymer/iron-icons/editor-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/paper-tooltip/paper-tooltip.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/marked-element/marked-element.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/paper-badge/paper-badge.js"],res,rej)),new Promise((res,rej)=>_require.default(["../moment-element/moment-element.js"],res,rej))}static get template(){return _polymerElement.html`
    ...
    `}static get tag(){return"lrnsys-comment"}static get properties(){return{comment:{type:Object,notify:!0,observer:"_commentLoaded"},displayName:{type:String,notify:!0,computed:"_generateName(comment.relationships.author.data.display_name, comment.relationships.author.data.visual)"},commentNew:{type:String,notify:!0,computed:"_isCommentNew(comment.relationships.author.data.visual)"},hoverClass:{type:String,reflectToAttribute:!0},editform:{type:Boolean,notify:!0,observer:"_editTrigger",reflectToAttribute:!0},disabled:{type:Boolean,notify:!0,reflectToAttribute:!0}}}connectedCallback(){super.connectedCallback(),this.$.bodyarea.addEventListener("click",this.bodyToggle.bind(this)),this.$.bodyarea.addEventListener("dblclick",this.bodyToggleOn.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.$.bodyarea.removeEventListener("click",this.bodyToggle.bind(this)),this.$.bodyarea.removeEventListener("dblclick",this.bodyToggleOn.bind(this))}_generateName(name,visual){return void 0!==visual&&!1!==visual.label?name+" ("+visual.label+")":name}_isCommentNew(visual){return void 0!==visual&&!1!==visual.label?"new-comment":""}_commentLoaded(e){this.editform=this.comment.metadata.editing,this.disabled=this.comment.metadata.disabled,this.blockFirstState=!0}actionHandler(e){var target=(0,_polymerDom.dom)(e).localTarget;null==target.dataCommentid||target.disabled||(target.dataCommentid,"reply"==target.id?this.dispatchEvent(new CustomEvent("comment-reply",{bubbles:!0,cancelable:!0,composed:!0,detail:{comment:this.comment,target:target}})):"like"==target.id?(this.$.like.classList.toggle("like-icon-color"),this.dispatchEvent(new CustomEvent("comment-like",{bubbles:!0,cancelable:!0,composed:!0,detail:{comment:this.comment,target:target}}))):"edit"==target.id?this.editform=!this.editform:"delete"==target.id&&this.dispatchEvent(new CustomEvent("comment-delete-dialog",{bubbles:!0,cancelable:!0,composed:!0,detail:{comment:this.comment,target:target}})))}_editTrigger(e){void 0!==this.comment&&this.comment.actions.edit&&async.microTask.run(()=>{this.$.renderedcomment.hidden=this.editform,this.$.commenteditor.hidden=!this.editform,this.editform?(this.$.edit.icon="save",this.$.edit.alt="Save",this.$.reply.disabled=!0,this.$.editcomment.focus(),this.dispatchEvent(new CustomEvent("comment-editing",{bubbles:!0,cancelable:!0,composed:!0,detail:{comment:this.comment}})),this.blockFirstState=!1):(this.blockFirstState?this.blockFirstState=!1:this.dispatchEvent(new CustomEvent("comment-save",{bubbles:!0,cancelable:!0,composed:!0,detail:{comment:this.comment}})),this.$.edit.icon="create",this.$.edit.alt="Edit",this.$.reply.disabled=!1)})}bodyToggle(e){this.$.bodyarea.classList.remove("nowrap-me")}bodyToggleOn(e){this.$.bodyarea.classList.toggle("nowrap-me")}}_exports.LrnsysComment=LrnsysComment,window.customElements.define(LrnsysComment.tag,LrnsysComment)});