define(["exports","../../../@polymer/polymer/polymer-element.js"],function(_exports,_polymerElement){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.AgencyThemeBand=void 0;class AgencyThemeBand extends _polymerElement.PolymerElement{static get tag(){return"agency-theme-band"}connectedCallback(){super.connectedCallback()}static get template(){return _polymerElement.html`
      <style>
      :host {
    ...
    `}}_exports.AgencyThemeBand=AgencyThemeBand,window.customElements.define(AgencyThemeBand.tag,AgencyThemeBand)});