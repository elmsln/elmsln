define(["exports", "require", "../../lit-element/lit-element.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/dist/mobx.esm.js", "../utils/utils.js", "../anchor-behaviors/anchor-behaviors.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _haxcmsSiteStore, _mobxEsm, _utils, _anchorBehaviors, _simpleIcon, _simpleIcons) {
  ...
  class HaxorSlevin extends _HAXCMSLitElementTheme.HAXCMSLitElementTheme {
    ...
    constructor() {
      ...
      setTimeout(() => {
        this.selectedPage = 0;
        new Promise((res, rej) => _require.default(["../../@polymer/iron-pages/iron-pages.js"], res, rej)); // prettier-ignore
        ...
        (0, _mobxEsm.autorun)(reaction => {
          let location = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.location);
        ...
        (0, _mobxEsm.autorun)(reaction => {
          let manifest = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.manifest);
        ...
        (0, _mobxEsm.autorun)(reaction => {
          this.activeTitle = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeTitle);
    ...
    firstUpdated() {
      ...
      setTimeout(() => {
        ...
        new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/active-item/site-share-widget.js"], res, rej)); // prettier-ignore

        new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/active-item/site-git-corner.js"], res, rej)); // prettier-ignore

        new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/site/site-rss-button.js"], res, rej));
        new Promise((res, rej) => _require.default(["../social-share-link/social-share-link.js"], res, rej)); // prettier-ignore
