define(["exports","require","../../@polymer/polymer/polymer-element.js","../haxcms-elements/lib/core/HAXCMSThemeWiring.js"],function(_exports,_require,_polymerElement,_HAXCMSThemeWiring){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.LearnTwoTheme=void 0,_require=babelHelpers.interopRequireWildcard(_require);class LearnTwoTheme extends((0,_HAXCMSThemeWiring.HAXCMSTheme)(_polymerElement.PolymerElement)){static get template(){return _polymerElement.html`
      <style>
        :host {
    ...
    `}static get properties(){let props={};return super.properties&&(props=Object.assign(props,super.properties)),props}constructor(){super(),new Promise((res,rej)=>_require.default(["../simple-colors/simple-colors.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/app-layout/app-drawer/app-drawer.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/app-layout/app-drawer-layout/app-drawer-layout.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/paper-icon-button/paper-icon-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/active-item/site-active-title.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/site/site-title.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/site/site-rss-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/site/site-print-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/navigation/site-menu.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/site/site-search.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/layout/site-modal.js"],res,rej)),new Promise((res,rej)=>_require.default(["../haxcms-elements/lib/ui-components/active-item/site-git-corner.js"],res,rej))}static get tag(){return"learn-two-theme"}static get properties(){let props=super.properties;return props.opened={type:Boolean,reflectToAttribute:!0},props.cd={type:String},props}toggleDrawer(e){this.shadowRoot.querySelector("app-drawer").toggle()}}_exports.LearnTwoTheme=LearnTwoTheme,window.customElements.define(LearnTwoTheme.tag,LearnTwoTheme)});