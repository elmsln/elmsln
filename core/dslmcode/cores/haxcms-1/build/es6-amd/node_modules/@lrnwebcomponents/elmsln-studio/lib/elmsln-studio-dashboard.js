define(["exports","../../../lit-element/lit-element.js","./lrnapp-studio-dashboard-profile.js","./lrnapp-studio-dashboard-widget.js","./lrnapp-studio-dashboard-keywords.js"],(function(t,a,e,i,s){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.ElmslnStudioDashboard=void 0;
/**
   * Copyright 2020 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class ElmslnStudioDashboard extends a.LitElement{static get styles(){return[css`
        :host {
          display: block;
    ...
    `}static get properties(){return{profile:{type:Object}}}tag(){return"elmsln-studio-dashboard"}constructor(){super(),this.tag=ElmslnStudioDashboard.tag,this.title="Project 1 Title",this.author="Bill Billerson";let t=ElmslnStudioDashboard.properties;for(let a in t)t.hasOwnProperty(a)&&(this.hasAttribute(a)?this[a]=this.getAttribute(a):(this.setAttribute(a,t[a].value),this[a]=t[a].value))}_toArray(t){return Object.keys(t).map(a=>t[a])}connectedCallback(){super.connectedCallback()}}t.ElmslnStudioDashboard=ElmslnStudioDashboard,customElements.define("elmsln-studio-dashboard",ElmslnStudioDashboard)}));