define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../iconset-demo/iconset-demo.js"], function (_exports, _litElement, _simpleColors, _iconsetDemo) {
  ...
  class LoremData extends _litElement.LitElement {
    ...
    randomPicsum(aspect, greyscale, blur = 0, multiple = -1) {
      ...
      aspect = aspect || this.randomAspect();
      return `https://picsum.photos/${aspect}/${params.length == 0 ? "" : `?${params.join("&")}`}`;
    }
    ...
    randomImage(aspect, greyscale, topic, multiple) {
      return topic && ["man", "woman", "person"].includes(topic) ? this.randomProfileImage(aspect, topic) : typeof multiple === typeof undefined ? this.randomPlaceImg(aspect, greyscale, topic) : typeof multiple === typeof undefined ? this.randomPicsum(aspect, greyscale, multiple) : this.randomFlickr(aspect, [topic], false, multiple);
    }
