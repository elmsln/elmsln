define(["exports","require","../../../lit-element/lit-element.js"],(function(_exports,_require,_litElement){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxInputMixer=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HaxInputMixer extends _litElement.LitElement{static get styles(){return[_litElement.css`
        :host {
          display: block;
          margin: 0;
          border: none;
      ...
      `]}constructor(){super(),this.value=null,this.options={},this.icon="android",this.inputMethod=null,this.__inputtextarea=!1,this.__inputtextfield=!1,this.__inputboolean=!1,this.__inputcolorpicker=!1,this.__inputflipboolean=!1,new Promise((res,rej)=>_require.default(["../../simple-colors/lib/simple-colors-picker.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-textarea.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-checkbox/paper-checkbox.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../../@polymer/paper-tooltip/paper-tooltip.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-context-item-menu.js"],res,rej)),new Promise((res,rej)=>_require.default(["./hax-context-item.js"],res,rej))}render(){return _litElement.html`
      <custom-style>
        <style>
          paper-textarea,
          paper-input {
      ...
      <div class="wrapper">
        ${this.__inputselect?_litElement.html`
        ...
        <span class="input-method">
          ${this.__inputtextarea?_litElement.html`
                <paper-textarea
                  id="input"
                  label="${this.label}"
                  .value="${this.value}"
                ...
                ></paper-textarea>
              `:_litElement.html``}
          ${this.__inputtextfield?_litElement.html`
                <paper-input
                  id="input"
                ...
                ></paper-input>
              `:_litElement.html``}
          ${this.__inputboolean?_litElement.html`
                <paper-checkbox
                  id="input"
                  .checked="${this.value}"
                ...
                >
              `:_litElement.html``}
          ${this.__inputflipboolean?_litElement.html`
                <paper-checkbox
                  id="input"
                  .checked="${this.value}"
                  @checked-changed="${this.valueChanged}"
                ...
                >
              `:_litElement.html``}
          ${this.__inputcolorpicker?_litElement.html`
