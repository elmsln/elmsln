define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../simple-colors/simple-colors.js","../a11y-behaviors/a11y-behaviors.js","../hax-body-behaviors/lib/HAXWiring.js"],function(_exports,_require,_polymerElement,_renderStatus,_simpleColors,_a11yBehaviors,_HAXWiring){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HeroBanner=void 0,_require=babelHelpers.interopRequireWildcard(_require);class HeroBanner extends((0,_a11yBehaviors.A11yBehaviors)(_simpleColors.SimpleColors)){constructor(){super(),new Promise((res,rej)=>_require.default(["../../@polymer/paper-button/paper-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/iron-image/iron-image.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
          width: 100%;
