define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../schema-behaviors/schema-behaviors.js"],(function(t,e,o,i,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.PromoTile=void 0,e=babelHelpers.interopRequireWildcard(e);class PromoTile extends((0,r.SchemaBehaviors)(o.PolymerElement)){constructor(){super(),new Promise((t,o)=>e.default(["../../@polymer/paper-button/paper-button.js"],t,o)),new Promise((t,o)=>e.default(["../../@polymer/iron-icon/iron-icon.js"],t,o)),new Promise((t,o)=>e.default(["../../@polymer/iron-icons/iron-icons.js"],t,o))}static get template(){return o.html`
      <style>
        :host {
          display: block;
        }
