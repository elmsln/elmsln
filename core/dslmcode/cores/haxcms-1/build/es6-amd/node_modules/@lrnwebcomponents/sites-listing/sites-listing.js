define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/iron-ajax/iron-ajax.js","../../@polymer/iron-list/iron-list.js","./lib/site-card.js","../../@polymer/paper-button/paper-button.js"],function(_exports,_require,_polymerElement,_polymerDom,_ironAjax,_ironList,_siteCard,_paperButton){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SitesListing=void 0,_require=babelHelpers.interopRequireWildcard(_require);class SitesListing extends _polymerElement.PolymerElement{constructor(){super(),new Promise((res,rej)=>_require.default(["../elmsln-loading/elmsln-loading.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          height: 100vh;
          display: flex;
    ...
    `}static get tag(){return"sites-listing"}static get properties(){return{sitesResponse:{type:Object,notify:!0,observer:"_sitesResponseChanged"},sites:{type:Array,notify:!0},size:{type:String,value:"large"},dataSource:{type:String},loadLocation:{type:Boolean,value:!1}}}connectedCallback(){super.connectedCallback(),window.addEventListener("sites-listing-refresh-data",this.refreshData.bind(this))}disconnectedCallback(){window.removeEventListener("sites-listing-refresh-data",this.refreshData.bind(this)),super.disconnectedCallback()}refreshData(e){this.shadowRoot.querySelector("#loaddata").generateRequest()}_sitesResponseChanged(newValue,oldValue){newValue&&void 0!==newValue.items&&(this.set("sites",[]),this.set("sites",newValue.items),this.notifyPath("sites.*"))}_siteClicked(e){var active=(0,_polymerDom.dom)(e).localTarget.getAttribute("data-site-id");let findSite=this.sites.filter(site=>site.id===active);findSite.length>0&&(findSite=findSite.pop()),this.loadLocation&&void 0!==findSite.location&&(window.location.href=findSite.location),this.dispatchEvent(new CustomEvent("sites-listing-item-selected",{bubbles:!0,cancelable:!0,composed:!0,detail:findSite}))}_mouseEnter(e){let card=(0,_polymerDom.dom)(e.target).querySelectorAll("site-card")[0];card.__oldElevation=card.elevation,card.elevation+2>5?card.elevation=5:card.elevation+=2}_mouseLeave(e){let card=(0,_polymerDom.dom)(e.target).querySelectorAll("site-card")[0];card.elevation=card.__oldElevation}}_exports.SitesListing=SitesListing,window.customElements.define(SitesListing.tag,SitesListing)});