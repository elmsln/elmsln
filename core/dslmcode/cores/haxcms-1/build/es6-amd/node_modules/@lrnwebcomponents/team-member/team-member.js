define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _require, _polymerElement, _schemaBehaviors) {
   ...
   */
  class TeamMember extends (0, _schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement) {
    constructor() {
      super();
      new Promise((res, rej) => _require.default(["../../@polymer/iron-iconset-svg/iron-iconset-svg.js"], res, rej));
      ...
      new Promise((res, rej) => _require.default(["../mdi-iconset-svg/lib/mdi-social-iconset-svg.js"], res, rej));
    }
