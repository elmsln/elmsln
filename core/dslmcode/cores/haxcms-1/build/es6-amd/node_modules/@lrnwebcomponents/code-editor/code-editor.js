define(["exports","meta","require","../../lit-element/lit-element.js","../schema-behaviors/schema-behaviors.js"],function(_exports,meta,_require,_litElement,_schemaBehaviors){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.CodeEditor=void 0,meta=babelHelpers.interopRequireWildcard(meta),_require=babelHelpers.interopRequireWildcard(_require);class CodeEditor extends((0,_schemaBehaviors.SchemaBehaviors)(_litElement.LitElement)){static get styles(){return[_litElement.css`
        :host {
          display: block;
          padding: 16px;
          font-family: unset;
      ...
      `]}constructor(){super(),this.showCodePen=!1,this.readOnly=!1,this.theme="vs-dark",this.language="javascript",this.fontSize=16,this.autofocus=!1,this.hideLineNumbers=!1,this.focused=!1,this.__libPath=decodeURIComponent(meta.url)+"/../../../monaco-editor/min/vs",new Promise((res,rej)=>_require.default(["./lib/monaco-element/monaco-element.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/code-pen-button.js"],res,rej)),setTimeout(()=>{this.addEventListener("monaco-element-ready",this.editorReady.bind(this))},0)}render(){return _litElement.html`
