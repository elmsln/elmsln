define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxEsm) {
   ...
   */
  class SiteFooter extends _litElement.LitElement {
    static get styles() {
    ...
    constructor() {
      super();
      this.__disposer = [];
      new Promise((res, rej) => _require.default(["../../../../license-element/license-element.js"], res, rej));
    } // render function
