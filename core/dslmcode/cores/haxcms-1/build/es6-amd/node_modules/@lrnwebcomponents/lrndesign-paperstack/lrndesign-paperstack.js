define(["exports","require","../../@polymer/polymer/polymer-element.js","../simple-colors/simple-colors.js","../a11y-behaviors/a11y-behaviors.js"],function(_exports,_require,_polymerElement,_simpleColors,_a11yBehaviors){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.LrndesignPaperstack=void 0,_require=babelHelpers.interopRequireWildcard(_require);class LrndesignPaperstack extends((0,_a11yBehaviors.A11yBehaviors)(_simpleColors.SimpleColors)){constructor(){super(),new Promise((res,rej)=>_require.default(["../../@polymer/iron-icon/iron-icon.js"],res,rej)),new Promise((res,rej)=>_require.default(["../lrn-icons/lrn-icons.js"],res,rej))}static get template(){return _polymerElement.html`
