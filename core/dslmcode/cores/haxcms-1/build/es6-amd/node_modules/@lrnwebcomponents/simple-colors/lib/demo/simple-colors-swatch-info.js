define(["exports","../../../../lit-element/lit-element.js","../../simple-colors.js"],(function(t,e,s){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.simpleColorsSwatchInfo=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class simpleColorsSwatchInfo extends s.SimpleColors{static get styles(){return[...super.styles,e.css`
        :host {
          display: block;
          margin: 15px 0;
        }
      ...
      >
        ...
        <tbody>
          ${this._getOptions(this.colors).map(t=>e.html`
              <tr>
                <th scope="row">${t}</th>
                <td>
                  ${this._getAa(this.swatchId,t).map(s=>e.html`
                        <span
                          class="contrast"
                          style="${this._getContrastBg(t,s)}"
                          >${t}-${s}</span
                        >
                      `)}
                </td>
                <td>
                  ${this._getAaLarge(this.swatchId,t).map(s=>e.html`
                        <span
                          class="contrast"
                          style="${this._getContrastBg(t,s)}"
                          >${t}-${s}</span
