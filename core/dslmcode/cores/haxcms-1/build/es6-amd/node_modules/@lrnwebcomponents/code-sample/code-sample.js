define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/flattened-nodes-observer.js","./lib/themes/one-dark.js","./lib/highlightjs/highlight.js","./lib/highlightjs/languages/javascript.js","./lib/highlightjs/languages/xml.js"],function(_exports,_polymerElement,_flattenedNodesObserver,_oneDark,_highlight,_javascript,_xml){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.CodeSample=void 0,_highlight.hljs.registerLanguage("javascript",_javascript.javascript),_highlight.hljs.registerLanguage("xml",_xml.xml),window.hljs=_highlight.hljs;class CodeSample extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
        }
