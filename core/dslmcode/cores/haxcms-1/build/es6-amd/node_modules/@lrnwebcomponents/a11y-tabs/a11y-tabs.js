define(["exports","../../lit-element/lit-element.js","../responsive-utility/responsive-utility.js","../../@polymer/paper-button/paper-button.js","../../@polymer/iron-icons/iron-icons.js","../../@polymer/paper-tooltip/paper-tooltip.js","./lib/a11y-tab.js"],(function(_exports,_litElement,_responsiveUtility,_paperButton,_ironIcons,_paperTooltip,_a11yTab){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.A11yTabs=void 0;
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class A11yTabs extends _litElement.LitElement{static get styles(){return[_litElement.css`
        :host {
          display: block;
      ...
      >
        ${this.__items.map(tab=>_litElement.html`
            <li>
              <paper-button
                id="${tab.id}-button"
                controls="${tab.id}"
