define(["exports", "../../lit-element/lit-element.js", "../responsive-utility/lib/responsive-utility-behaviors.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-tooltip/simple-tooltip.js", "./lib/a11y-tab.js"], function (_exports, _litElement, _responsiveUtilityBehaviors, _simpleIcon, _simpleIcons, _simpleTooltip, _a11yTab) {
   ...
   * @element a11y-tabs
   */
  class A11yTabs extends (0, _responsiveUtilityBehaviors.ResponsiveUtilityBehaviors)(_litElement.LitElement) {
    //styles function
    static get styles() {
    ...
    render() {
      return (0, _litElement.html)` <ul id="tabs" role="tablist">
        ${this.tabs.map((tab, i) => (0, _litElement.html)` <li>${this._tabButton(tab, i)}</li> `)}
      </ul>
      <div id="content">
        <slot></slot>
      </div>`;
    ...
    get iconsOnly() {
      return this.iconBreakpoint && (this.tabs || []).filter(tab => !tab.icon).length < 1 && this.responsiveWidth < this.iconBreakpoint;
    }
    /**
    ...
    _handleKey(i, e) {
      ...
      let focus = (dir = 1) => {
        this.__tabFocus = this.__tabFocus + dir; // If we're at the end, go to the start

        if (this.__tabFocus >= this.buttons.length) {
          this.__tabFocus = 0; // If we're at the start, move to the end
        } else if (this.__tabFocus < 0) {
          this.__tabFocus = this.buttons.length - 1;
        }

        if (this.buttons[this.__tabFocus].disabled && this.__tabFocus !== i) focus(dir);
      }; // Move right
    ...
    _tabIcon(tab, icon) {
      return tab.flag ? (0, _litElement.html)`
          <simple-icon
            class="icon"
            ?hidden="${!tab[icon]}"
            .icon="${tab[icon]}"
    ...
    _tabLabel(tab) {
      return (0, _litElement.html)` <span class="label">${tab.label}</span> `;
    }
    /**
     * makes tab tooltip
     *
