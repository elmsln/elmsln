define(["exports", "require", "../../lit-element/lit-element.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js"], function (_exports, _require, _litElement, _simpleIcon, _simpleIcons, _simpleIconButton) {
   ...
   */
  class LrnappFabMenu extends _litElement.LitElement {
    constructor() {
      super();
      this.icon = "add";
      this.disabled = false;
      setTimeout(() => {
        // prettier-ignore
        new Promise((res, rej) => _require.default(["./lib/lrnapp-fab-speed-dial-action.js"], res, rej));
        new Promise((res, rej) => _require.default(["../paper-fab-speed-dial/paper-fab-speed-dial.js"], res, rej)); // prettier-ignore

        new Promise((res, rej) => _require.default(["../paper-fab-speed-dial/lib/paper-fab-speed-dial-overlay.js"], res, rej));
      }, 0);
    }
