...
!function (v) {
      ...
      touchstart: function (e) {
        !function (e, t) {
          var i,
              ...
              a = [],
              l = e.getActivePointersListByType("touch");
          i = v.now();
  ...
  function u(e, t, i) {
    var n,
        o = e.getActivePointersListByType(t);
    o.captureCount += i || 1;
  ...
  function N(e, t, i) {
    var n,
        o,
        r,
        s = e.getActivePointersListByType(i[0].type),
        a = i.length;
  ...
  function V(e, t, i, n) {
    var o,
        ...
        s,
        a = f[e.hash],
        l = e.getActivePointersListByType(i[0].type),
        h = i.length;
  ...
  function U(e, t, i, n) {
    var o,
        ...
        h,
        c = f[e.hash],
        u = e.getActivePointersListByType(i[0].type),
        d = i.length,
        p = !1,
        g = !1;
  ...
  function j(n, o, r) {
    var e,
        ...
        a,
        l = f[n.hash],
        h = n.getActivePointersListByType(r[0].type),
        c = r.length;
    ...
    open: function (i, e) {
      ...
      if (i) if (this.sequenceMode && m.isArray(i)) {
        ...
        if (i.length) {
          ...
          function t(i) {
            m.isPlainObject(i) && i.tileSource || (i = {
              tileSource: i
            });
...
!function (c) {
  c.Navigator = function (i) {
    ...
    if (i.id) {
      ...
      i.controlOptions = {
        anchor: c.ControlAnchor.TOP_RIGHT,
        attachToViewer: !0,
        autoFade: i.autoFade
      };
    ...
    (i = c.extend(!0, {
      sizeRatio: c.DEFAULT_SETTINGS.navigatorSizeRatio
    }, i, {
...
!function (g) {
  ...
  function p(e, t) {
    var i,
        ...
        u = parseInt(o.TileSize, 10),
        d = parseInt(o.Overlap, 10),
        p = [];
...
!function (h) {
  h.IIIFTileSource = function (e) {
    ...
    } else if (this.tile_width) e.tileSize = this.tile_width;else if (this.tile_height) e.tileSize = this.tile_height;else if (this.tiles) {
...
!function (d) {
  ...
  d.ReferenceStrip = function (e) {
    ...
    if (e.width && e.height) {
      ...
      r.addControl(this.element, {
        anchor: d.ControlAnchor.BOTTOM_LEFT
      });
      ...
      r.addControl(this.element, {
        anchor: d.ControlAnchor.TOP_LEFT
      });
    }
  ...
  d.extend(d.ReferenceStrip.prototype, d.EventSource.prototype, d.Viewer.prototype, {
    setFocus: function (e) {
      var t,
          ...
          n = d.getElementSize(this.viewer.canvas),
  ...
  function a(e) {
    var t = Number(this.element.style.marginLeft.replace("px", "")),
        ...
        r = d.getElementSize(this.viewer.canvas);
    this.dragging = !0;
  ...
  function h(e, t, i) {
    ...
    for (l = o = (o = (r = Math.ceil((Math.abs(i) + t) / n) + 1) - o) < 0 ? 0 : o; l < r && l < e.panels.length; l++) if (!(h = e.panels[l]).activePanel) {
      ...
      c = u.referenceStripThumbnailUrl ? {
        type: "image",
        url: u.referenceStripThumbnailUrl
      } : u;
      (s = new d.Viewer({
        id: h.id,
        tileSources: [c],
      ...
      s.displayRegion.innerTracker = new d.MouseTracker({
...
!function (h) {
  ...
  h.Tile.prototype = {
    ...
    drawHTML: function (e) {
      ...
      } else h.console.warn("[Tile.drawHTML] attempting to draw tile %s when it's not cached", this.toString());
    },
    drawCanvas: function (e, t, i, n) {
      var o,
          r = this.position.times(h.pixelDensityRatio),
          s = this.size.times(h.pixelDensityRatio);
...
!function (c) {
  ...
  c.OverlayRotationMode = c.freezeObject({
    NO_ROTATION: 1,
    EXACT: 2,
    BOUNDING_BOX: 3
  });
...
!function (p) {
  p.Viewport = function (e) {
    var t = arguments;
    t.length && t[0] instanceof p.Point && (e = {
      containerSize: t[0],
      contentSize: t[1],
      config: t[2]
    });
  ...
  p.Viewport.prototype = {
    ...
    getCenter: function (e) {
      var t,
          ...
          r,
          s,
          a = new p.Point(this.centerSpringX.current.value, this.centerSpringY.current.value),
...
!function (y) {
    ...
    _updateViewport: function () {
      ...
      !function (n, e) {
        ...
        for (var m = e.length - 1; 0 <= m; m--) {
          ...
          t.beingDrawn = !0;
          n.viewer && n.viewer.raiseEvent("tile-drawn", {
            tiledImage: n,
            tile: t
          });
        }
  ...
  function T(e, t, i, n, o, r, s, a, l, h, c, u) {
    var d = function (e, t, i, n, o, r, s, a, l, h) {
      ...
      return w;
    }(n, o, r, e, e.source, e.tilesMatrix, c, h, e._worldWidthCurrent, e._worldHeightCurrent),
        p = i;
    ...
    !function (e, t, i, n, o, r) {
      ...
      var l = i.pixelFromPointNoRotate(s, !0),
          h = i.pixelFromPointNoRotate(s, !1),
          c = i.deltaPixelsFromPointsNoRotate(a, !0),
          u = i.deltaPixelsFromPointsNoRotate(a, !1),
          d = h.plus(u.divide(2)),
          p = n.squaredDistanceTo(d);
