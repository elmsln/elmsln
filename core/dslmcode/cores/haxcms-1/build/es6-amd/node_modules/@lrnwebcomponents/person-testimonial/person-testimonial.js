define(["exports","require","../../@polymer/polymer/polymer-element.js","../simple-colors/lib/simple-colors-polymer.js"],(function(_exports,_require,_polymerElement,_simpleColorsPolymer){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.PersonTestimonial=void 0,_require=babelHelpers.interopRequireWildcard(_require);class PersonTestimonial extends _simpleColorsPolymer.SimpleColorsPolymer{constructor(){super(),new Promise((res,rej)=>_require.default(["../../@polymer/paper-card/paper-card.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/iron-image/iron-image.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/iron-icon/iron-icon.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/person-testimonial-icon.js"],res,rej))}static get template(){return _polymerElement.html`
