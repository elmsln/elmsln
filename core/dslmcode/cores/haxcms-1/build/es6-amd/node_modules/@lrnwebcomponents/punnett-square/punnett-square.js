define(["exports","../../@polymer/lit-element/lit-element.js","../../@polymer/paper-input/paper-input.js"],function(_exports,_litElement,_paperInput){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.PunnettSquare=void 0;class PunnettSquare extends _litElement.LitElement{tag(){return"punnett-square"}static get properties(){return{variant1:{type:String},variant2:{type:String},editable:{type:Boolean}}}constructor(){super(),this.variant1="",this.variant2="",this.editable=!1}connectedCallback(){super.connectedCallback()}__ensureArray(value){return("string"==typeof value?value.split(",").map(i=>i.trim()):[]).map(i=>"string"==typeof i?i.split("").map(i=>i.trim()):[])}render(){let value1=this.__ensureArray(this.variant1),value2=this.__ensureArray(this.variant2);return _litElement.html`
      <style>
        :host {
          display: block;
