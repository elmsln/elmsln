define(["exports","../../../lit-element/lit-element.js","../../../@polymer/paper-button/paper-button.js","../../../@polymer/paper-tooltip/paper-tooltip.js","../../../@polymer/iron-icon/iron-icon.js"],function(_exports,_litElement,_paperButton,_paperTooltip,_ironIcon){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HAXPanelItem=void 0;class HAXPanelItem extends _litElement.LitElement{constructor(){super(),this.disabled=!1,this.edged="",this.icon="editor:text-fields",this.label="editor:text-fields",this.eventName="button",this.value=""}static get properties(){return{light:{type:Boolean,reflect:!0},voiceCommand:{type:String,attribute:"voice-command"},disabled:{type:Boolean},edged:{type:String,reflect:!0},icon:{type:String,reflect:!0},label:{type:String,reflect:!0},eventName:{type:String,reflect:!0,attribute:"event-name"},value:{type:String,reflect:!0}}}static get tag(){return"hax-panel-item"}static get styles(){return[_litElement.css`
        :host {
          display: inline-flex;
        }
        paper-button {
