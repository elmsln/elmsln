define(["exports","require","../../../lit-element/lit-element.js","../../utils/utils.js"],(function(e,t,o,i){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.HaxTextContext=void 0,t=babelHelpers.interopRequireWildcard(t);class HaxTextContext extends((0,i.winEventsElement)(o.LitElement)){static get styles(){return[o.css`
        :host {
          display: block;
          pointer-events: none;
        }
      ...
      `]}constructor(){super(),this.__winEvents={"hax-store-property-updated":"_haxStorePropertyUpdated"},new Promise((e,o)=>t.default(["../../../@polymer/paper-item/paper-item.js"],e,o)),new Promise((e,o)=>t.default(["../../../@polymer/iron-icon/iron-icon.js"],e,o)),new Promise((e,o)=>t.default(["./hax-context-item-menu.js"],e,o)),new Promise((e,o)=>t.default(["./hax-context-item.js"],e,o)),new Promise((e,o)=>t.default(["./hax-context-item-textop.js"],e,o)),new Promise((e,o)=>t.default(["./hax-toolbar.js"],e,o)),setTimeout(()=>{this.addEventListener("hax-context-item-selected",this._haxContextOperation.bind(this))},0),this.realSelectedValue="p",this.selection=!1,this.formatIcon="hax:format-textblock",this.isSafari=this._isSafari()}_haxStorePropertyUpdated(e){e.detail&&void 0!==e.detail.value&&e.detail.property&&(this[e.detail.property]=e.detail.value)}render(){return o.html`
      <hax-toolbar
