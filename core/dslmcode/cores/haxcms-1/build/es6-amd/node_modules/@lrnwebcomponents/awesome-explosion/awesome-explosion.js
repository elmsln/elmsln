define(["exports","meta","../../lit-element/lit-element.js"],(function(e,t,s){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.AwesomeExplosion=void 0,t=babelHelpers.interopRequireWildcard(t);
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class AwesomeExplosion extends s.LitElement{static get styles(){return[s.css`
        :host {
      ...
      `]}pathFromUrl(e){return e.substring(0,e.lastIndexOf("/")+1)}constructor(){super();const e=this.pathFromUrl(decodeURIComponent(t.url));this.state="stop",this.image=e+"assets/explode.gif",this.sound=e+"assets/273320__clagnut__fireworks.mp3",this.size="medium",this.color="",this.resetSound=!1,setTimeout(()=>{this.addEventListener("click",this._setPlaySound.bind(this)),this.addEventListener("mouseover",this._setPlaySound.bind(this)),this.addEventListener("mouseout",this._setStopSound.bind(this))},0)}render(){return s.html`
      <img
        loading="lazy"
        src="${this.image}"
        id="image"
