define(["exports","../../lit-element/lit-element.js","../simple-colors/simple-colors.js","../chartist-render/chartist-render.js","../../@polymer/iron-ajax/iron-ajax.js"],function(_exports,_litElement,_simpleColors,_chartistRender,_ironAjax){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.LrndesignChart=void 0;class LrndesignChart extends _simpleColors.SimpleColors{static get styles(){let styles=[_litElement.css`
        :host {
      ...
      `];return super.styles&&(styles=Object.assign(super.styles,styles)),styles}render(){return _litElement.html`
      <iron-ajax
        auto
        handle-as="text"
        url="${this.dataSource}"
