define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js"], function (_exports, _require, _litElement, _simpleColors) {
   ...
   * @element csv-render
   */
  class CsvRender extends _simpleColors.SimpleColors {
    /**
    ...
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["../../@polymer/iron-ajax/iron-ajax.js"], res, rej));
    ...
    render() {
      ...
      <table class="table" summary="${this.summary}">
        ...
        <thead>
          <tr>
            ${this.tableHeadings.map(heading => (0, _litElement.html)`
        ...
        <tbody>
          ${this.table.map(row => (0, _litElement.html)`
              <tr>
                ${row.map(col => (0, _litElement.html)`
                    <td>${col}</td>
                  `)}
              </tr>
            `)}
