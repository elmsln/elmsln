define(["exports","../../../@polymer/polymer/polymer-element.js","./a11y-media-behaviors.js","../../../@polymer/paper-menu-button/paper-menu-button.js","../../../@polymer/paper-listbox/paper-listbox.js","../../../@polymer/paper-input/paper-input.js","../../../@polymer/paper-item/paper-item.js","../../../@polymer/paper-icon-button/paper-icon-button.js","../../../@polymer/paper-toggle-button/paper-toggle-button.js","../../dropdown-select/dropdown-select.js","../../../@polymer/paper-slider/paper-slider.js","../../../@polymer/paper-tooltip/paper-tooltip.js","./a11y-media-button.js"],function(_exports,_polymerElement,_a11yMediaBehaviors,_paperMenuButton,_paperListbox,_paperInput,_paperItem,_paperIconButton,_paperToggleButton,_dropdownSelect,_paperSlider,_paperTooltip,_a11yMediaButton){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.A11yMediaControls=void 0;class A11yMediaControls extends _a11yMediaBehaviors.A11yMediaBehaviors{static get properties(){return{compactControls:{name:"compactControls",type:Boolean,computed:"_getCompactControls(responsiveSize)"},fixedHeight:{type:Boolean,value:!1},fullscreen:{name:"fullscreen",type:Boolean,value:!1},fullscreenButton:{name:"fullscreenButton",type:Boolean,value:!1,nofity:!0},hasCaptions:{name:"hasCaptions",type:Boolean,value:!1,notify:!0},hideTranscript:{name:"hideTranscript",type:Boolean,value:!1},hideTranscriptButton:{type:Boolean,computed:"_hideTranscriptButton(noTranscriptToggle,compactControls)"},linkUrl:{type:String,value:"test"},muteUnmute:{name:"muteUnmute",type:Object},noPrinting:{type:Boolean,computed:"_noPrinting(standAlone,fixedHeight)"},noTranscriptToggle:{type:Boolean,computed:"_noTranscriptToggle(standAlone,fixedHeight,hasTranscript)"},responsiveSize:{name:"responsiveSize",type:String,notify:!0,value:"xs",reflectToAttribute:!0}}}static get tag(){return"a11y-media-controls"}constructor(){super()}static get template(){return _polymerElement.html`
    ...
    `}connectedCallback(){super.connectedCallback();this._addResponsiveUtility({element:this,attribute:"responsive-size",relativeToParent:!0,sm:300,md:600,lg:900,xl:1200})}ready(){super.ready();let root=this;root.shadowRoot.querySelector("#mute").shadowRoot.querySelector("#button").onfocus=function(){root.shadowRoot.querySelector("#volume").classList.add("focus")},root.shadowRoot.querySelector("#mute").shadowRoot.querySelector("#button").onblur=function(){root.shadowRoot.querySelector("#volume").classList.remove("focus")}}setStatus(status){this.shadowRoot.querySelector("#statbar").innerText=status}setTracks(tracks){this.set("tracks",[]),this.set("tracks",tracks.slice(0))}_getCompactControls(responsiveSize){return this._testAttribute(responsiveSize,"xs")||this._testAttribute(responsiveSize,"sm")}_handleTrackChange(e){let root=this;null!==root.__selectedTrack&&(""!==e.detail.value?(root.dispatchEvent(new CustomEvent("select-track",{detail:{control:root,value:e.detail.value}})),root.dispatchEvent(new CustomEvent("toggle-cc",{detail:{control:root,value:!0}}))):root.dispatchEvent(new CustomEvent("toggle-cc",{detail:{control:root,value:!1}})))}_handleSettingsSelect(e){}_handleSettingsActivate(e){}_onButtonTap(e){this.dispatchEvent(new CustomEvent("controls-change",{detail:e.detail})),this.shadowRoot.querySelector("#settings").close()}_onSettingsChanged(e){this.dispatchEvent(new CustomEvent("controls-change",{detail:e.target})),this.shadowRoot.querySelector("#settings").close()}_hideTranscriptButton(noTranscriptToggle,compactControls){return noTranscriptToggle||compactControls}_noPrinting(standAlone,fixedHeight){return standAlone||!fixedHeight}_noTranscriptToggle(standAlone,fixedHeight,hasTranscript){return standAlone||fixedHeight||!hasTranscript}}_exports.A11yMediaControls=A11yMediaControls,window.customElements.define(A11yMediaControls.tag,A11yMediaControls)});