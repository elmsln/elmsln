define(["exports","require","../../lit-element/lit-element.js","../schema-behaviors/schema-behaviors.js"],(function(_exports,_require,_litElement,_schemaBehaviors){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.A11yGifPlayer=void 0,_require=babelHelpers.interopRequireWildcard(_require);
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class A11yGifPlayer extends((0,_schemaBehaviors.SchemaBehaviors)(_litElement.LitElement)){constructor(){super(),this.alt=null,this.disabled=!1,this.src=null,this.tooltip="Toggle animation",this.tooltipPlaying=null,this.srcWithoutAnimation=null,this.__playing=!1,this.noImage=!0,new Promise((res,rej)=>_require.default(["../../@polymer/paper-tooltip/paper-tooltip.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/iron-image/iron-image.js"],res,rej))}static get styles(){return[_litElement.css`
        :host {
          display: inline-flex;
        }
        *[hidden] {
