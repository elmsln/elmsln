define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/paper-button/paper-button.js","../../../@polymer/paper-tooltip/paper-tooltip.js","../../../@polymer/iron-icons/iron-icons.js","./editable-table-iconset.js"],function(_exports,_polymerElement,_paperButton,_paperTooltip,_ironIcons,_editableTableIconset){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.EditableTableFilter=void 0;class EditableTableFilter extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      ...
      >
    `}static get tag(){return"editable-table-filter"}static get properties(){return{columnIndex:{type:Number,value:null},filtered:{type:Boolean,value:!1,reflectToAttribute:!0},text:{type:String,value:""}}}_getPressed(filtered){return filtered?"true":"false"}_onFilterClicked(){this.dispatchEvent(new CustomEvent("toggle-filter",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}_exports.EditableTableFilter=EditableTableFilter,window.customElements.define(EditableTableFilter.tag,EditableTableFilter)});