  ...
  class HAXCMSSiteDashboard extends _litElement.LitElement {
    ...
    render() {
      ...
      <div class="title-wrapper">
        ...
        ${(0, _haxutils.varExists)(this.manifest, "metadata.site.static.publishedLocation") ? _litElement.html`
              <span class="toptext">
                <a
                  class="publishlink"
                  href="${(0, _haxutils.varGet)(this.manifest, "metadata.site.static.publishedLocation", "#")}"
