define(["exports","../../lit-element/lit-element.js","../../@polymer/iron-icons/iron-icons.js","../../@polymer/iron-icon/iron-icon.js"],function(_exports,_litElement,_ironIcons,_ironIcon){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.LrndesignSidenote=void 0;class LrndesignSidenote extends _litElement.LitElement{static get properties(){return{label:{type:String},icon:{type:String},bgColor:{type:String}}}static get haxProperties(){return{canScale:!1,canPosition:!0,canEditSource:!1,gizmo:{title:"Side-Note",description:"A .",icon:"icons:bookmark",color:"blue",groups:[""],meta:{author:"LRNWebComponents"}},settings:{quick:[{property:"label",title:"Label",description:"The label of the sidenote.",inputMethod:"textfield",icon:"editor:title"}],configure:[{property:"icon",title:"Icon",description:"The icon of the sidenote.",inputMethod:"iconpicker",options:["icons:announcement","icons:book","icons:bookmark","icons:check-circle","icons:feedback","icons:thumb-down","icons:thumb-up","icons:warning"]},{property:"bgColor",title:"Color",description:"The background color of the sidenote.",inputMethod:"colorpicker",icon:"editor:format-color-fill"}],advanced:[]}}}constructor(){super(),this.label="",this.icon="",this.bgColor=""}render(){return _litElement.html`
    ...
    `}static get tag(){return"lrndesign-sidenote"}}_exports.LrndesignSidenote=LrndesignSidenote,customElements.define("lrndesign-sidenote",LrndesignSidenote)});