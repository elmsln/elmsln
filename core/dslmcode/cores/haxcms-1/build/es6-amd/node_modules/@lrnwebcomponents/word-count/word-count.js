define(["exports","../../lit-element/lit-element.js"],function(_exports,_litElement){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.WordCount=void 0;/**
 * `word-count`
 * `Count the words on whatever this wraps`
 *
 * @demo demo/index.html
 */class WordCount extends _litElement.LitElement{static get styles(){return[_litElement.css`
        :host {
          display: block;
        }
        :host:after {
   ...
   */_updateWords(mutations){if(""!==this.textContent){this.words=parseInt(this.textContent.split(/\s+/g).length-1)}else{this.words=0}}}_exports.WordCount=WordCount;window.customElements.define(WordCount.tag,WordCount)});