define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/paper-button/paper-button.js","../../@polymer/paper-input/paper-input.js","../../@polymer/paper-progress/paper-progress.js","../../@polymer/paper-styles/shadow.js","../../@polymer/paper-styles/typography.js","../../@polymer/paper-styles/color.js"],(function(r,e,o,t,i,a,n,p,l){"use strict";Object.defineProperty(r,"__esModule",{value:!0}),r.SimpleLogin=void 0;
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class SimpleLogin extends e.PolymerElement{static get template(){return e.html`
      <style>
        :host {
          display: block;
        }
    ...
    `}static get properties(){return{...super.properties,title:String,subtitle:String,errorMsg:String,username:{type:String,notify:!0},password:{type:String,notify:!0},loading:{type:Boolean,value:!1},userInputLabel:{type:String,value:"Username"},userInputErrMsg:{type:String,value:"Username required"},passwordInputLabel:{type:String,value:"Password"},passwordInputErrMsg:{type:String,value:"Password required"},loginBtnText:{type:String,value:"Login"}}}static get tag(){return"simple-login"}constructor(){super(),(0,o.afterNextRender)(this,(function(){this.shadowRoot.querySelector("#loginform").addEventListener("keypress",this._keyPressLogin.bind(this))}))}disconnectedCallback(){this.shadowRoot.querySelector("#loginform").removeEventListener("keypress",this._keyPressLogin.bind(this)),super.disconnectedCallback()}_keyPressLogin(r){if(13==r.keyCode)return this._login(),!1}_login(){this.shadowRoot.querySelector("#userinput").validate()&&this.shadowRoot.querySelector("#passinput").validate()&&this.dispatchEvent(new CustomEvent("simple-login-login",{cancelable:!0,bubbles:!0,composed:!0,detail:{u:this.shadowRoot.querySelector("#userinput").value,p:this.shadowRoot.querySelector("#passinput").value}}))}}r.SimpleLogin=SimpleLogin,window.customElements.define(SimpleLogin.tag,SimpleLogin)}));