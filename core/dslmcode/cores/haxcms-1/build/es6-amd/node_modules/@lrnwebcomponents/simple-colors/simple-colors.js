define(["exports","../../lit-element/lit-element.js","../simple-colors-shared-styles/simple-colors-shared-styles.js"],function(_exports,_litElement,_simpleColorsSharedStyles){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SimpleColorsSuper=_exports.SimpleColors=void 0;const SimpleColorsSuper=function(SuperClass){return class extends SuperClass{static get styles(){return[_litElement.css`
          :host([dark]) {
        ...
        <slot></slot>
      `}static get properties(){return{...super.properties,accentColor:{attribute:"accent-color",type:String,reflect:!0},dark:{name:"dark",type:Boolean,reflect:!0},colors:{name:"colors",type:Object}}}constructor(){super(),this.accentColor="grey",this.dark=!1,this.__utils=window.SimpleColorsSharedStyles.requestAvailability(),this.colors=window.SimpleColorsSharedStyles.colors}static get tag(){return"simple-colors"}invertShade(shade){return this.__utils.invertShade(shade)}getColorInfo(colorName){return this.__utils.getColorInfo(colorName)}makeVariable(color="grey",shade=1,theme="default"){return this.__utils.makeVariable("grey",1,"default")}getContrastingColors(colorName,colorShade,isLarge){return this.__utils.getContrastingColors(colorName,colorShade,isLarge)}getContrastingShades(isLarge,colorName,colorShade,contrastName){return this.__utils.getContrastingShades(isLarge,colorName,colorShade,contrastName)}isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade){return this.__utils.isContrastCompliant(isLarge,colorName,colorShade,contrastName,contrastShade)}}};_exports.SimpleColorsSuper=SimpleColorsSuper;class SimpleColors extends(SimpleColorsSuper(_litElement.LitElement)){}_exports.SimpleColors=SimpleColors,window.customElements.define(SimpleColors.tag,SimpleColors)});