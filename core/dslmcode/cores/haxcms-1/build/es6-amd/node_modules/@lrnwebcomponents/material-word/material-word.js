define(["exports","../../@polymer/polymer/polymer-element.js"],function(_exports,_polymerElement){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.MaterialWord=void 0;class MaterialWord extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        html {
          font-size: 100%;
          height: 100%;
    ...
    `}static get tag(){return"material-word"}static get properties(){return{word:{type:String,notify:!0},letters:{type:Array,value:[],notify:!0,reflectToAttribute:!0},halfLetters:{type:Array,value:["e","f","h","i"]}}}ready(){super.ready();var letters=this.getAttribute("word").toLowerCase().trim().split("");letters.length&&(this.letters=letters)}showHalf(letter){return!!this.halfLetters[letter]}}_exports.MaterialWord=MaterialWord,window.customElements.define(MaterialWord.tag,MaterialWord)});