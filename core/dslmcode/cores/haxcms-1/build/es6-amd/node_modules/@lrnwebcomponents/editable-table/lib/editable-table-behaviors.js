define(["exports"], function (_exports) {
  ...
  const displayBehaviors = function (SuperClass) {
    return class extends SuperClass {
      ...
      getTableHTMLNode() {
        let n = document.createElement("editable-table-display"); // replicate values that we had previously so they get reflected back into the DOM
      ...
      getTableHTML() {
        ...
        return [`<table ${attr}>`, this.caption !== "" && this.caption !== null && this.caption !== "null" ? `\n\t<caption>\n\t\t${this.caption}\n\t</caption>` : "", headers.length > 0 ? `\n\t<thead>${headers.join("")}\n\t</thead>` : "", body.length > 0 ? `\n\t<tbody>${body.join("")}\n\t</tbody>` : "", footer.length > 0 ? `\n\t<tfoot>${footer.join("")}\n\t</tfoot>` : "", "\n</table>"].join("");
      }
      /**
