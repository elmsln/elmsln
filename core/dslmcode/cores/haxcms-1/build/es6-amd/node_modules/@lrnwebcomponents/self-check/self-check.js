define(["exports","require","../../lit-element/lit-element.js","../simple-colors/simple-colors.js","../schema-behaviors/schema-behaviors.js"],function(_exports,_require,_litElement,_simpleColors,_schemaBehaviors){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SelfCheck=void 0,_require=babelHelpers.interopRequireWildcard(_require);class SelfCheck extends((0,_schemaBehaviors.SchemaBehaviors)(_simpleColors.SimpleColors)){constructor(){super(),this.correct=!1,this.alt="",this.image="",this.question="",this.title="Self-Check",new Promise((res,rej)=>_require.default(["../user-action/user-action.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/paper-card/paper-card.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/paper-icon-button/paper-icon-button.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/iron-icons/editor-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/iron-icons/iron-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/paper-tooltip/paper-tooltip.js"],res,rej))}static get styles(){return[...super.styles,_litElement.css`
        :host {
          display: block;
          margin: 15px 0;
        }
