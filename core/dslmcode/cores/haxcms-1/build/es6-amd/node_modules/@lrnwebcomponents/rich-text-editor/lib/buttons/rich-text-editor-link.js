 ...
 * @customElement
 * @polymer
 */class RichTextEditorLink extends _richTextEditorPromptButton.RichTextEditorPromptButton{constructor(){super();this.fields=[{property:"",title:"Text",description:"The link text",inputMethod:"textfield"},{property:"href",title:"Link",description:"The link URL. (Leave blank to remove.)",inputMethod:"textfield"}];this.tag="a";this.value={link:null}}// properties available to the custom element for data binding
static get properties(){return{}}/**
   ...
   */_getTagNeeded(value){return value&&this.getCleanValue("")&&""!==this.getCleanValue("")&&this.getCleanValue("href")&&null!==this.getCleanValue("href")}}_exports.RichTextEditorLink=RichTextEditorLink;window.customElements.define(RichTextEditorLink.tag,RichTextEditorLink)});