define(["exports","../../@polymer/polymer/polymer-element.js","../json-editor/json-editor.js","../code-editor/code-editor.js","../../@vaadin/vaadin-split-layout/vaadin-split-layout.js","../../@polymer/paper-button/paper-button.js","../hax-body/lib/hax-schema-form.js"],function(_exports,_polymerElement,_jsonEditor,_codeEditor,_vaadinSplitLayout,_paperButton,_haxSchemaForm){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxschemaBuilder=void 0;class HaxschemaBuilder extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
    ...
    `}static get haxProperties(){return{canScale:!0,canPosition:!0,canEditSource:!0,gizmo:{title:"Haxschema builder",description:"dynamically build and visualize HAXschema",icon:"icons:android",color:"green",groups:["Builder"],handles:[],meta:{author:"btopro",owner:"The Pennsylvania State University"}},settings:{quick:[],configure:[{property:"source",description:"",inputMethod:"textfield",required:!0,icon:"icons:link",validationType:"url"}],advanced:[]}}}static get properties(){let props={haxSchema:{name:"haxSchema",type:String,notify:!0,observer:"_haxSchemaChanged"},configureSchema:{name:"configureSchema",type:Object,value:{}},advancedSchema:{name:"advancedSchema",type:Object,value:{}},source:{name:"source",type:String},value:{name:"value",type:String}};return super.properties&&(props=Object.assign(props,super.properties)),props}static get tag(){return"haxschema-builder"}connectedCallback(){super.connectedCallback(),this.source||(this.haxSchema=JSON.stringify(this.HAXWiring.prototypeHaxProperties(),null,2)),this.$.form.modeTab="advanced",setTimeout(()=>{this.$.form.modeTab="configure"},2e3)}_haxSchemaChanged(newValue){newValue&&(this.$.code.editorValue=newValue)}_editorDataChanged(e){this.haxSchema=e.detail.value;let hs=JSON.parse(this.haxSchema);for(var key in hs.settings){let schema=this.HAXWiring.getHaxJSONSchema(key,hs);this.set(key+"Schema",schema)}}addAdvanced(e){let hs=JSON.parse(this.haxSchema);hs.settings.advanced.push(this.__propPrototype()),this.__refreshSchemas(hs)}addConfigure(e){let hs=JSON.parse(this.haxSchema);hs.settings.configure.push(this.__propPrototype()),this.__refreshSchemas(hs)}__refreshSchemas(hs){for(var key in hs.settings){let schema=this.HAXWiring.getHaxJSONSchema(key,hs);this.set(key+"Schema",schema)}this.haxSchema=JSON.stringify(hs)}__propPrototype(){return{property:"title",title:"Title",description:"",inputMethod:"textfield",icon:"android",required:!0,validationType:"text"}}}_exports.HaxschemaBuilder=HaxschemaBuilder,window.customElements.define(HaxschemaBuilder.tag,HaxschemaBuilder)});