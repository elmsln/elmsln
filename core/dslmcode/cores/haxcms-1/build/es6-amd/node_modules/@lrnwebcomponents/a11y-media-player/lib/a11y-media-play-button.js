define(["exports","../../../@polymer/polymer/polymer-element.js","./a11y-media-behaviors.js","../../../@polymer/paper-tooltip/paper-tooltip.js"],function(_exports,_polymerElement,_a11yMediaBehaviors,_paperTooltip){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.A11yMediaPlayButton=void 0;class A11yMediaPlayButton extends _a11yMediaBehaviors.A11yMediaBehaviors{static get properties(){return{action:{type:String,value:null},disabled:{type:Boolean,value:!1},playing:{type:Boolean,value:!1}}}static get tag(){return"a11y-media-play-button"}constructor(){super()}static get template(){return _polymerElement.html`
    ...
    `}connectedCallback(){super.connectedCallback(),this.$.text.innerText=this.playLabel}ready(){super.ready(),this.target=this.$.button}_handleButtonClick(e){this.dispatchEvent(new CustomEvent("controls-change",{detail:this}))}}_exports.A11yMediaPlayButton=A11yMediaPlayButton,window.customElements.define(A11yMediaPlayButton.tag,A11yMediaPlayButton)});