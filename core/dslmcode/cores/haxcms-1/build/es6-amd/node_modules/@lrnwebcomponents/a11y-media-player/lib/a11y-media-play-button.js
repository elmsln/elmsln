define(["exports", "../../../lit-element/lit-element.js", "./a11y-media-button.js"], function (_exports, _litElement, _a11yMediaButton) {
   ...
   */
  class A11yMediaPlayButton extends _a11yMediaButton.A11yMediaButton {
    ...
    static get styles() {
      return [...super.buttonStyles, (0, _litElement.css)`
        :host {
          display: block;
          opacity: 1;
    ...
    render() {
      ...
      >
        ${this.youtubeId != "undefined" && this.youtubeId != undefined ? (0, _litElement.html)`
              <svg
                id="svg"
                aria-hidden="true"
