define(["exports", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/async.js", "../../@polymer/paper-icon-button/paper-icon-button.js", "../../@polymer/iron-icons/iron-icons.js", "../../@polymer/iron-icons/social-icons.js", "../../@polymer/iron-icons/device-icons.js", "../../@polymer/iron-pages/iron-pages.js", "../../@polymer/iron-image/iron-image.js", "../../@polymer/paper-button/paper-button.js", "../../@polymer/paper-card/paper-card.js", "../../@polymer/iron-ajax/iron-ajax.js", "../../@polymer/iron-list/iron-list.js", "../../@polymer/iron-swipeable-container/iron-swipeable-container.js", "../simple-tooltip/simple-tooltip.js", "../../@polymer/paper-progress/paper-progress.js", "../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../@polymer/app-layout/app-header/app-header.js", "../item-overlay-ops/item-overlay-ops.js", "../lrnsys-outline/lrnsys-outline.js", "../simple-colors/lib/simple-colors-polymer.js", "../simple-modal/simple-modal.js", "../editable-list/editable-list.js", "./lib/sortable-list.js", "./lib/pagemap.js"], function (_exports, _polymerElement, async, _paperIconButton, _ironIcons, _socialIcons, _deviceIcons, _ironPages, _ironImage, _paperButton, _paperCard, _ironAjax, _ironList, _ironSwipeableContainer, _simpleTooltip, _paperProgress, _appToolbar, _appHeader, _itemOverlayOps, _lrnsysOutline, _simpleColorsPolymer, _simpleModal, _editableList, _sortableList, _pagemap) {
   ...
   */
  class OutlineDesigner extends _polymerElement.PolymerElement {
    // render function
    render() {
      return (0, _polymerElement.html)` <style>
        :host {
          display: block;
        }
    ...
    _detailsModeChanged(newValue, oldValue) {
      if (typeof newValue !== typeof undefined) {
        ...
        if (this.selectedView === 0) {
          async.microTask.run(() => {
            setTimeout(() => {
              this.shadowRoot.querySelector("#ironlist").dispatchEvent(new CustomEvent("iron-resize", {
                bubbles: true,
                cancelable: true,
                composed: true,
                detail: true
