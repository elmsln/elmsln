define(["exports", "meta", "require", "../../simple-fields/simple-fields.js", "./HAXFields.js"], function (_exports, meta, _require, _simpleFields, _HAXFields) {
  ...
  class HAXWiring {
    constructor() {
      ...
      this.setup = (props, tag = "", context = this) => {
        ...
        if (typeof window.HaxStore !== typeof undefined && window.HaxStore.instance != null && window.HaxStore.instance.ready) {
      ...
      this._haxStoreReady = e => {
        if (e.detail && typeof this.tagName !== typeof undefined && typeof this.haxProperties !== typeof undefined) {
          ...
          if (tag != "" && typeof window.HaxStore === typeof undefined) {
          ...
          } else if (tag != "" && typeof window.HaxStore.instance.elementList[tag.toLowerCase()] === typeof undefined) {
            const evt = new CustomEvent("hax-register-properties", {
              bubbles: true,
              composed: true,
              cancelable: true,
            ...
            context.dispatchEvent(evt);
          } else if (typeof this.tagName !== typeof undefined && typeof window.HaxStore.instance.elementList[this.tagName.toLowerCase()] === typeof undefined) {
            const evt = new CustomEvent("hax-register-properties", {
              bubbles: true,
              composed: true,
              cancelable: true,
      ...
      this.setHaxProperties = (props = {}, tag = "", context = document, isReady = false) => {
        ...
        if (props.api == "1") {
          ...
          if (typeof props.gizmo === typeof undefined) {
            ...
            if (typeof props.gizmo.iconLib !== typeof undefined) {
              ...
              new Promise((res, rej) => _require.default([`${basePath}${props.gizmo.iconLib}`], res, rej));
            }
          ...
          if (typeof props.settings !== typeof undefined) {
            ...
            for (let i = 0; i < props.settings.quick.length; i++) {
              props.settings.quick[i] = this.validateSetting(props.settings.quick[i]); // account for a bad property and remove it
      ...
      this.readyToFireHAXSchema = (tag, props, context) => {
        if (tag != "" && typeof window.HaxStore === typeof undefined) {
          ...
          console.warn(`${tag} missed our checks and has an issue in implementation with HAX`);
        }
      };
      /**
      ...
      this.validateSetting = setting => {
        ...
        if (typeof setting.property === typeof undefined && typeof setting.slot === typeof undefined && typeof setting.attribute === typeof undefined) {
          return false;
  ...
  const HAXElement = function (SuperClass) {
