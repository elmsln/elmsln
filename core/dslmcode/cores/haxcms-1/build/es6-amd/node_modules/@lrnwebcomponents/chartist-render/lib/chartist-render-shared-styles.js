define(["../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/resolve-url.js"],function(_polymerElement,_resolveUrl){"use strict";/**
 * append and register the shared styles
 *
 * @polymer
 * @customElement
 * @see ../chartist.render.js
 */const styleElement=document.createElement("dom-module"),template=document.createElement("template");styleElement.appendChild(_polymerElement.html`
  <style>
    .ct-label {
