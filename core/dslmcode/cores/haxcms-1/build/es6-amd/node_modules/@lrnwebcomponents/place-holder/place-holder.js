define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../hax-body-behaviors/lib/HAXWiring.js","../simple-colors/simple-colors.js"],function(_exports,_require,_polymerElement,_renderStatus,_HAXWiring,_simpleColors){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.PlaceHolder=void 0,_require=babelHelpers.interopRequireWildcard(_require);class PlaceHolder extends _polymerElement.PolymerElement{constructor(){super(),(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring,this.HAXWiring.setup(PlaceHolder.haxProperties,PlaceHolder.tag,this)})}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
          border: none;
