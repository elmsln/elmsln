define(["exports", "meta", "../../lit-element/lit-element.js", "../utils/utils.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _litElement, _utils, _esGlobalBridge) {
  "use strict";
  ...
  const ChartistRenderSuper = function (SuperClass) {
    return class extends SuperClass {
      ...
      render() {
        return (0, _litElement.html)` <div id="${this.__chartId}-title" class="title">
          ${this.chartTitle}
      ...
      get observer() {
        let callback = (mutationsList, observer) => this._updateData(mutationsList, observer);
      ...
      updated(changedProperties) {
        ...
        changedProperties.forEach((oldValue, propName) => {
          if (propName === "chartData" && JSON.stringify(this.chartData) !== JSON.stringify(oldValue)) {
            ...
            if (this.dataSource !== "") fetch(this.dataSource).then(response => response.text()).then(data => this.data = this._CSVtoArray(data));
