define(["exports","../../../lit-element/lit-element.js","./simple-fields-fieldset.js","../../../@polymer/paper-button/paper-button.js","../../../@polymer/iron-icon/iron-icon.js","../../../@polymer/iron-icons/iron-icons.js","./simple-fields-array-item.js"],(function(e,t,i,s,d,l,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.SimpleFieldsArray=void 0;class SimpleFieldsArray extends i.SimpleFieldsFieldset{static get tag(){return"simple-fields-array"}static get styles(){return[...super.styles,t.css`
        fieldset {
          padding: 0 20px;
        }
        #item-fields {
      ...
      `]}static get properties(){return{...super.properties,count:{type:Number},label:{type:String},description:{type:String},expanded:{type:Boolean}}}get fields(){return t.html`
      <paper-button
        id="expand"
