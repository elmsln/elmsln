define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/elements/dom-repeat.js"],function(_exports,_polymerElement,_domRepeat){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimpleSearchContent=void 0;/**
 ...
 */class SimpleSearchContent extends _polymerElement.PolymerElement{static get is(){return"simple-search-content"}static get properties(){return{/**
...
searchObject.addEventListener("goto-result",e=>{this.focus(e.detail)})}/**
   ...
   *
   * @param {number} the number of a search result
   */_getTabIndex(matchNumber){return matchNumber!==void 0&&null!==matchNumber?"1":""}}_exports.SimpleSearchContent=SimpleSearchContent;customElements.define(SimpleSearchContent.is,SimpleSearchContent)});