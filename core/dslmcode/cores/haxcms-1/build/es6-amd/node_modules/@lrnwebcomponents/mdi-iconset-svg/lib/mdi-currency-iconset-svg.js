define(["../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-iconset-svg/iron-iconset-svg.js", "../../../@polymer/polymer/lib/utils/html-tag.js"], function (_ironIcon, _ironIconsetSvg, _htmlTag) {
   ...
   * @element mdi-currency-iconset-svg is a iconset for the Material Design Icons collection with the "currency" tag
   *
   * Example:
   *   <simple-icon icon="mdi-currency:currency-usd"></simple-icon>
   *
