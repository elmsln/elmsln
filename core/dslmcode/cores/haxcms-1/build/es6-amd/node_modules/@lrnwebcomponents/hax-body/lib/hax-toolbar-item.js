define(["exports","../../../lit-element/lit-element.js","../../../@polymer/paper-button/paper-button.js","../../simple-tooltip/simple-tooltip.js"],(function(t,o,e,i){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.HaxToolbarItem=void 0;class HaxToolbarItem extends o.LitElement{static get styles(){return[o.css`
        :host {
          display: flex;
    ...
    `}static get tag(){return"hax-toolbar-item"}constructor(){super(),this.corner="",this.large=!1,this.disabled=!1,this.dark=!1,this.menu=!1,this.mini=!1,this.icon="",this.label="",this.tooltip="",this.tooltipDirection="top",this.default=!1}updated(t){t.forEach((t,o)=>{"height"==o&&this.shadowRoot&&(this.shadowRoot.querySelector("#btn").style.height=this[o])})}static get properties(){return{corner:{type:String,reflect:!0},height:{type:String},disabled:{type:Boolean,reflect:!0},dark:{type:Boolean,reflect:!0},menu:{type:Boolean,reflect:!0},mini:{type:Boolean,reflect:!0},large:{type:Boolean,reflect:!0},icon:{type:String},label:{type:String},tooltip:{type:String},tooltipDirection:{type:String,attribute:"tooltip-direction"},default:{type:Boolean,reflect:!0}}}}t.HaxToolbarItem=HaxToolbarItem,window.customElements.define(HaxToolbarItem.tag,HaxToolbarItem)}));