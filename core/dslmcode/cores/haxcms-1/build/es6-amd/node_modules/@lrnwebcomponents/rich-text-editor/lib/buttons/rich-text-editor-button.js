  ...
        `];
      ...
      updated(changedProperties) {
        ...
        changedProperties.forEach((oldValue, propName) => {
          if (propName === "controls") this._editorChanged(this.controls, oldValue);
      ...
      sendCommand(command = this.operationCommand, commandVal = this.operationCommandVal) {
