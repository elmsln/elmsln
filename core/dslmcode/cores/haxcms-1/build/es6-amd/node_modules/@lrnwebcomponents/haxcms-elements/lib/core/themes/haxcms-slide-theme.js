define(["exports", "require", "../../../../../lit-element/lit-element.js", "../HAXCMSLitElementTheme.js", "../../../../simple-colors/simple-colors.js", "../haxcms-site-store.js", "../../../../simple-icon/simple-icon.js", "../../../../simple-icon/lib/simple-icons.js", "../../../../../mobx/dist/mobx.esm.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _simpleColors, _haxcmsSiteStore, _simpleIcon, _simpleIcons, _mobxEsm) {
  ...
  class HAXCMSSlideTheme extends (0, _simpleColors.SimpleColorsSuper)(_HAXCMSLitElementTheme.HAXCMSLitElementTheme) {
    constructor() {
      ...
      setTimeout(() => {
        // prettier-ignore
        new Promise((res, rej) => _require.default(["../../ui-components/site/site-title.js"], res, rej)); // prettier-ignore

        new Promise((res, rej) => _require.default(["../../ui-components/site/site-print-button.js"], res, rej)); // prettier-ignore

        new Promise((res, rej) => _require.default(["../../ui-components/active-item/site-active-title.js"], res, rej)); // prettier-ignore

        new Promise((res, rej) => _require.default(["../../ui-components/navigation/site-dot-indicator.js"], res, rej)); // prettier-ignore
    ...
    connectedCallback() {
      ...
      (0, _mobxEsm.autorun)(reaction => {
        this.manifestLength = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.routerManifest.items.length);

        this.__disposer.push(reaction);
      });
      (0, _mobxEsm.autorun)(reaction => {
        this.activeManifestIndexCounter = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeManifestIndexCounter);
