define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","../../@polymer/polymer/lib/utils/async.js","../../@polymer/iron-resizable-behavior/iron-resizable-behavior.js","../../@polymer/polymer/lib/legacy/class.js"],function(_exports,_polymerElement,_renderStatus,async,_ironResizableBehavior,_class){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ResponsiveUtility=void 0;async=babelHelpers.interopRequireWildcard(async);window.ResponsiveUtility={};window.ResponsiveUtility.instance=null;class ResponsiveUtility extends(0,_class.mixinBehaviors)([_ironResizableBehavior.IronResizableBehavior],_polymerElement.PolymerElement){static get template(){return _polymerElement.html`
      <style>
        :host {
          display: inline;
        }
   ...
   */_onIronResize(){for(let i=0;i<this.details.length;i++){window.ResponsiveUtility.setSize(this.details[i])}}}_exports.ResponsiveUtility=ResponsiveUtility;window.customElements.define(ResponsiveUtility.tag,ResponsiveUtility);/**
