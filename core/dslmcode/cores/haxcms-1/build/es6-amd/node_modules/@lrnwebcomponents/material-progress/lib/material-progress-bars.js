define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/legacy/class.js","./material-progress-behavior.js"],function(_exports,_polymerElement,_class,_materialProgressBehavior){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MaterialProgressBars=void 0;class MaterialProgressBars extends(0,_class.mixinBehaviors)([MaterialProgressBehaviorImpl],_polymerElement.PolymerElement){static get template(){return _polymerElement.html`
      <style>
        #barsContainer {
          overflow: hidden;
    ...
    `}static get tag(){return"material-progress-bars"}static get properties(){return{/**
       ...
       */max:{type:Number,value:100,observer:"_refresh"}}}_getWidthForBar(barValue,barValuesSum,maxBarValue,barHeight){var realMax=Math.max(barValuesSum,this.max),width=(0<realMax?Math.floor(1e4*(barValue/realMax))/100:"0")+"%",negativeMargin=barHeight/2;return"calc("+width+" + "+negativeMargin+"px"+")"}}_exports.MaterialProgressBars=MaterialProgressBars;window.customElements.define(MaterialProgressBars.tag,MaterialProgressBars)});