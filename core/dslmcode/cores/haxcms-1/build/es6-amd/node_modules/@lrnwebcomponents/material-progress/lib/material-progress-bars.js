define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/legacy/class.js","./material-progress-behavior.js"],(function(e,r,a,t){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.MaterialProgressBars=void 0;class MaterialProgressBars extends((0,a.mixinBehaviors)([MaterialProgressBehaviorImpl],r.PolymerElement)){static get template(){return r.html`
      <style>
        #barsContainer {
          overflow: hidden;
    ...
    `}static get tag(){return"material-progress-bars"}static get properties(){return{max:{type:Number,value:100,observer:"_refresh"}}}_getWidthForBar(e,r,a,t){var s=Math.max(r,this.max);return"calc("+((s>0?Math.floor(e/s*1e4)/100:"0")+"%")+" + "+t/2+"px)"}}e.MaterialProgressBars=MaterialProgressBars,window.customElements.define(MaterialProgressBars.tag,MaterialProgressBars)}));