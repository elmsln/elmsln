define(["exports", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../utils/utils.js", "../../../../../mobx/dist/mobx.esm.js"], function (_exports, _litElement, _haxcmsSiteStore, _utils, _mobxEsm) {
  "use strict";
  ...
  class SiteQuery extends _litElement.LitElement {
    ...
    _computeResult(entity, conditions, sorts, routerManifest, activeId, limit, startIndex, random, forceRebuild) {
      if (routerManifest && routerManifest.items) {
        ...
        var items = [...(0, _mobxEsm.toJS)(routerManifest.items)]; // ohhh.... boy.... let's completely alter how this thing works
    ...
    connectedCallback() {
      ...
      this.__disposer = (0, _mobxEsm.autorun)(() => {
        this.routerManifest = Object.assign({}, (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.routerManifest));
      });
      this.__disposer2 = (0, _mobxEsm.autorun)(() => {
