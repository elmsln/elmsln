define(["exports","../../@polymer/polymer/polymer-element.js","../schema-behaviors/schema-behaviors.js","../../@polymer/iron-icon/iron-icon.js","./lib/stop-icon.js"],function(_exports,_polymerElement,_schemaBehaviors,_ironIcon,_stopIcon){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.StopNote=void 0;class StopNote extends((0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement)){static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
          width: auto;
