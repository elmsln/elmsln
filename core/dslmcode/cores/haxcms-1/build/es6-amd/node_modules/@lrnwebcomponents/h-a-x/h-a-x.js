define(["exports", "require", "../hax-body/lib/hax-store.js"], function (_exports, _require, _haxStore) {
  ...
  class HAX extends HTMLElement {
    ...
    constructor(delayRender = false) {
      ...
      window.addEventListener("hax-store-app-store-loaded", this.appStoreReady.bind(this)); // dynamically import definitions for all needed tags

      new Promise((res, rej) => _require.default(["./lib/h-a-x-dependencies.js"], res, rej));
    }
    /**
