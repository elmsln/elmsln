define(["exports", "../../hax-body/lib/hax-upload-field.js"], function (_exports, _haxUploadField) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.HaxElementizer = _exports.HaxSchematizer = void 0;

  /**
   * fields array of input methods to JSON schema object conversion configuration
   * that can be reused outside of Simple Fields
   */
  const HaxSchematizer = {
    defaultSettings: {
      type: "string"
    },
    format: {
  ...
  _exports.HaxSchematizer = HaxSchematizer;
  const HaxElementizer = {
    defaultSettings: {
  ...
  _exports.HaxElementizer = HaxElementizer;
});