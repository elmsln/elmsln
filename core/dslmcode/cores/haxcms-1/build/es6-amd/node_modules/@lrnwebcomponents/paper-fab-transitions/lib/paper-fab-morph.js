...
*/class PaperFabMorph extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        iron-dropdown {
    ...
    `}static get tag(){return"paper-fab-morph"}static get properties(){return{/**
