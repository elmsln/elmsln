    ...
    connectedCallback() {
      ...
      setTimeout(() => {
        ...
        if (!this.data || this.data.length < 1 || this.data[0].length < 1) {
          let table = this.children.item(0); // support wrapping editable-table-display tag or primative

          if (table && table.tagName === "EDITABLE-TABLE-DISPLAY") {
            table = table.children.item(0);
          }

          if (typeof table !== typeof undefined && table !== null && table.tagName === "TABLE" && table.children && table.children.length > 0) {
