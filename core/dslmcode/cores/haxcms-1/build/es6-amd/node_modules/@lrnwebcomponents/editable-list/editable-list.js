define(["exports","../../@polymer/polymer/polymer-element.js","../simple-modal/simple-modal.js","../../@polymer/iron-list/iron-list.js","./lib/editable-list-item.js"],function(_exports,_polymerElement,_simpleModal,_ironList,_editableListItem){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.EditableList=void 0;/**
 ...
 */class EditableList extends _polymerElement.PolymerElement{// render function
...
static get properties(){let props={/**
       ...
       */activeElement:{name:"activeElement",type:Object}};if(super.properties){props=Object.assign(props,super.properties)}return props}/**
...
_itemsChanged(newValue,oldValue){if(typeof newValue!==typeof void 0&&"string"===typeof newValue){this.set("items",JSON.parse(newValue))}}}_exports.EditableList=EditableList;window.customElements.define(EditableList.tag,EditableList)});