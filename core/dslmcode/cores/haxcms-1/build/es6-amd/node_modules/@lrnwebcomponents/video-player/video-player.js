define(["exports","../../lit-element/lit-element.js","../simple-colors/simple-colors.js","../schema-behaviors/schema-behaviors.js","../media-behaviors/media-behaviors.js","../a11y-media-player/a11y-media-player.js"],(function(e,t,i,r,o,a){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.VideoPlayer=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class VideoPlayer extends((0,o.MediaBehaviorsVideo)((0,r.SchemaBehaviors)(i.SimpleColors))){static get styles(){return[...super.styles,t.css`
        :host {
          display: block;
          margin: 0 0 15px;
        }
      ...
      ${!this.sourceData||this.sourceData.length<1?t.html``:this.isA11yMedia?t.html`
            <a11y-media-player
          ...
          `:t.html`
            ...
            >
              ${this.sandboxed?t.html``:t.html`
                  ...
                  `}
              ${this.sandboxed||!this.iframed?t.html``:t.html`
                    <iframe
                      resource="${this.schemaResourceID}-video"
                      .src="${this.sourceData&&this.sourceData[0]&&this.sourceData[0].src||void 0}"
                      width="${this.width}"
