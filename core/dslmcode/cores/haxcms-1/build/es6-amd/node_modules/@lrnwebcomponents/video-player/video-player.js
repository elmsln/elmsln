define(["exports","../../lit-element/lit-element.js","../simple-colors/simple-colors.js","../schema-behaviors/schema-behaviors.js","../media-behaviors/media-behaviors.js","../a11y-media-player/a11y-media-player.js"],(function(_exports,_litElement,_simpleColors,_schemaBehaviors,_mediaBehaviors,_a11yMediaPlayer){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.VideoPlayer=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class VideoPlayer extends((0,_mediaBehaviors.MediaBehaviorsVideo)((0,_schemaBehaviors.SchemaBehaviors)(_simpleColors.SimpleColors))){static get styles(){return[...super.styles,_litElement.css`
        :host {
          display: block;
          margin: 0 0 15px;
        }
      ...
      ${!this.sourceData||this.sourceData.length<1?_litElement.html``:this.isA11yMedia?_litElement.html`
            <a11y-media-player
              ...
              .height="${this.height}"
            >
              ${this.youtubeId?_litElement.html`
                    <iframe
                    ...
                    ></iframe>
                  `:_litElement.html``}
              ${this.audioOnly?_litElement.html`
          ...
          `:_litElement.html`
            ...
            >
              ${this.sandboxed?_litElement.html``:_litElement.html`
                    <webview
                  ...
                  `}
              ${this.sandboxed||!this.iframed?_litElement.html``:_litElement.html`
                    <iframe
                      resource="${this.schemaResourceID}-video"
                      .src="${this.sourceData&&this.sourceData[0]&&this.sourceData[0].src||void 0}"
                      width="${this.width}"
