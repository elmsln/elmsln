define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../schema-behaviors/schema-behaviors.js", "../media-behaviors/media-behaviors.js", "../intersection-element/lib/IntersectionObserverMixin.js", "../a11y-media-player/a11y-media-player.js"], function (_exports, _litElement, _simpleColors, _schemaBehaviors, _mediaBehaviors, _IntersectionObserverMixin, _a11yMediaPlayer) {
   ...
   */
  class VideoPlayer extends (0, _IntersectionObserverMixin.IntersectionObserverMixin)((0, _mediaBehaviors.MediaBehaviorsVideo)((0, _schemaBehaviors.SchemaBehaviors)(_simpleColors.SimpleColors))) {
    //styles function
    static get styles() {
    ...
    render() {
      return (0, _litElement.html)` ${this.elementVisible ? (0, _litElement.html)`${!this.isA11yMedia ? (0, _litElement.html)` <div
                class="responsive-video-container"
                .lang="${this.lang || undefined}"
              >
                ${this.sandboxed ? (0, _litElement.html)`` : (0, _litElement.html)` <webview
              ...
              </div>` : (0, _litElement.html)` <a11y-media-player
