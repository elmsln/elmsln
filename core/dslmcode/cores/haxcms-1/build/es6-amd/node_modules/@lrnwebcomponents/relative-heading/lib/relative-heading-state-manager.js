define(["exports","require","../../../lit-element/lit-element.js"],(function(e,t,a){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.RelativeHeadingStateManager=void 0,t=babelHelpers.interopRequireWildcard(t),
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
window.RelativeHeadingStateManager=window.RelativeHeadingStateManager||{},window.RelativeHeadingStateManager.requestAvailability=()=>(window.RelativeHeadingStateManager.instance||(window.RelativeHeadingStateManager.instance=document.createElement("relative-heading-state-manager"),document.body.appendChild(window.RelativeHeadingStateManager.instance)),window.RelativeHeadingStateManager.instance);class RelativeHeadingStateManager extends a.LitElement{static get tag(){return"relative-heading-state-manager"}static get properties(){return{...super.properties,closeIcon:{type:String},closeLabel:{type:String},copyHeading:{type:Object},copyMessage:{type:String},headings:{type:Object},usesCopyLink:{type:Boolean}}}constructor(){super(),this.closeIcon="close",this.closeLabel="Close",this.copyMessage="Copied to Clipboard",this.headings=[],this.copyHeading={},this.usesCopyLink=!1,window.RelativeHeadingStateManager.instance||(window.RelativeHeadingStateManager.instance=this)}static get styles(){return[a.css`
