 ...
 *
 */class SimpleBlogOverview extends _polymerElement.PolymerElement{/**
   * Store the tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */static get tag(){return"simple-blog-overview"}constructor(){super();new Promise((res,rej)=>_require.default(["../../../@polymer/paper-card/paper-card.js"],res,rej));new Promise((res,rej)=>_require.default(["../../simple-datetime/simple-datetime.js"],res,rej))}// render function
static get template(){return _polymerElement.html`
   ...
   */tapEventOff(e){this.elevation=0}}_exports.SimpleBlogOverview=SimpleBlogOverview;window.customElements.define(SimpleBlogOverview.tag,SimpleBlogOverview)});