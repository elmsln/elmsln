define(["exports","../../../@polymer/polymer/polymer-element.js","../../lrndesign-animationctrl/lrndesign-animationctrl.js","./TweenMax.min.js"],function(_exports,_polymerElement,_lrndesignAnimationctrl,_TweenMaxMin){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.GeneCrossover2=void 0;class GeneCrossover2 extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
        }
    ...
    `}static get tag(){return"gene-crossover-2"}static get properties(){return{tl:{type:Object,value:null},selected:{type:Boolean,value:!1},animationReady:{type:Boolean,value:!1}}}static get observers(){return["_selectedChanged(selected, animationReady)"]}_selectedChanged(selected,animationReady){animationReady&&(selected?(this.tl.play(),this.lefttl.play(),this.righttl.play()):(this.tl.progress(0),this.lefttl.progress(0),this.righttl.progress(0),this.tl.pause(),this.lefttl.pause(),this.righttl.pause()))}ready(){super.ready();var tl=new TimelineMax,lefttl=new TimelineMax,righttl=new TimelineMax,svg=(this.shadowRoot.querySelector("#play-button"),this.shadowRoot.querySelector("#replay-button"),this.shadowRoot.querySelector("#chromosomes")),setonerightfour=(svg.getElementById("synapsetext"),svg.getElementById("setonerightfour")),setonerightthree=svg.getElementById("setonerightthree"),setonerighttwo=svg.getElementById("setonerighttwo"),setonerightone=svg.getElementById("setonerightone"),setoneleftfour=svg.getElementById("setoneleftfour"),setoneleftthree=svg.getElementById("setoneleftthree"),setonelefttwo=svg.getElementById("setonelefttwo"),setoneleftone=svg.getElementById("setoneleftone");tl.set([setoneleftfour,setoneleftthree,setonelefttwo,setonerightfour,setonerightthree,setonerighttwo],{display:"none"}),tl.to([setoneleftone],.2,{x:"+=5",alpha:0}).to([setonerightone],.2,{x:"-=5",alpha:0}),lefttl.to([setonelefttwo],.1,{x:"+=10",display:"block",display:"none"}).to([setoneleftthree],.3,{x:"+=10",display:"block",display:"none"}).to([setoneleftfour],.3,{x:"+=10",display:"block"}),righttl.to([setonerighttwo],.1,{x:"-=10",display:"block",display:"none"}).to([setonerightthree],.3,{x:"-=10",display:"block",display:"none"}).to([setonerightfour],.3,{x:"-=10",display:"block"}),this.tl=tl,this.lefttl=lefttl,this.righttl=righttl,this.animationReady=!0,this.tl.pause(),this.lefttl.pause(),this.righttl.pause()}}_exports.GeneCrossover2=GeneCrossover2,window.customElements.define(GeneCrossover2.tag,GeneCrossover2)});