  ...
  class HaxTray extends (0, _utils.winEventsElement)(_litElement.LitElement) {
      ...
      switch (detail.eventName) {
        ...
        case "insert-blox":
          ...
          for (var i = 0; i < e.path[0].blox.length; i++) {
            let node = window.HaxStore.haxElementToNode(e.path[0].blox[i].tag, e.path[0].blox[i].content, e.path[0].blox[i].properties);
    ...
    _setupForm() {
      ...
      if (activeNode.tagName && window.HaxStore.instance.elementList[activeNode.tagName.toLowerCase()]) {
        ...
        let disable = []; // see if we have any layout settings or disable
