define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../hax-body-behaviors/lib/HAXFields.js", "../../simple-popover/lib/SimpleTourFinder.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js", "../../simple-fields/simple-fields.js", "../../simple-popover/simple-popover.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js", "../../hax-iconset/lib/simple-hax-iconset.js", "../../a11y-collapse/lib/a11y-collapse-group.js", "../../a11y-collapse/a11y-collapse.js", "./hax-tray-upload.js", "./hax-gizmo-browser.js", "./hax-app-browser.js", "./hax-blox-browser.js", "./hax-stax-browser.js", "./hax-map.js", "./hax-preferences-dialog.js"], function (_exports, _require, _litElement, _utils, _HAXFields, _SimpleTourFinder, _haxStore, _mobxEsm, _simpleFields, _simplePopover, _simpleIcon, _simpleIcons, _simpleHaxIconset, _a11yCollapseGroup, _a11yCollapse, _haxTrayUpload, _haxGizmoBrowser, _haxAppBrowser, _haxBloxBrowser, _haxStaxBrowser, _haxMap, _haxPreferencesDialog) {
  ...
  class HaxTray extends (0, _SimpleTourFinder.SimpleTourFinder)((0, _utils.winEventsElement)(_litElement.LitElement)) {
      ...
      <div class="wrapper">
        ...
        <a11y-collapse-group accordion radio>
          ...
          <a11y-collapse id="settingscollapse" accordion data-simple-tour-stop>
            <div slot="heading" data-stop-title>
              <simple-icon icon="${this.activeTagIcon}"></simple-icon> ${this.activeTagName}
            </div>
            <div slot="tour" data-stop-content>
    ...
    _refreshLists(e) {
      this.shadowRoot.querySelector("#bloxbrowser").bloxList = [..._haxStore.HAXStore.bloxList];
    ...
    _processTrayEvent(e) {
      ...
      switch (detail.eventName) {
        ...
        case "insert-tag":
          ...
          let element = _haxStore.HAXStore.haxElementPrototype(gizmo, properties, innerContent);
