define(["exports","../../../lit-element/lit-element.js","../../simple-search/lib/simple-search-content.js"],(function(_exports,_litElement,_simpleSearchContent){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.A11yMediaTranscriptCue=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class A11yMediaTranscriptCue extends _litElement.LitElement{static get properties(){return{...super.properties,active:{attribute:"active",type:Boolean,reflect:!0},disabled:{attribute:"disabled",type:Boolean,reflect:!0},end:{type:String},hideTimestamps:{attribute:"hide-timestamps",type:Boolean,reflect:!0},start:{type:String}}}static get tag(){return"a11y-media-transcript-cue"}constructor(){super(),this.active=!1,this.disabled=!1,this.hideTimestamps=!1,this.start="",this.end=""}static get styles(){return[_litElement.css`
        :host {
          cursor: default;
          display: table-row;
          width: 100%;
    ...
    `}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>{"active"===propName&&this.active&&this.dispatchEvent(new CustomEvent("active-changed",{detail:{element:this,oldValue:oldValue,value:this.active}}))})}}_exports.A11yMediaTranscriptCue=A11yMediaTranscriptCue,window.customElements.define(A11yMediaTranscriptCue.tag,A11yMediaTranscriptCue)}));