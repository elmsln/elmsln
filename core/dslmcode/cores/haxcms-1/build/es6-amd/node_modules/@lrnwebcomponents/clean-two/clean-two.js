define(["exports", "require", "../../lit-element/lit-element.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/lib/mobx.module.js", "../responsive-utility/lib/responsive-utility-behaviors.js", "../../@polymer/paper-icon-button/paper-icon-button.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _HAXCMSThemeParts, _haxcmsSiteStore, _mobxModule, _responsiveUtilityBehaviors, _paperIconButton) {
   ...
   * @element clean-two
   */
  class CleanTwo extends (0, _HAXCMSThemeParts.HAXCMSThemeParts)((0, _responsiveUtilityBehaviors.ResponsiveUtilityBehaviors)(_HAXCMSLitElementTheme.HAXCMSLitElementTheme)) {
    //styles function
    static get styles() {
    ...
    constructor() {
      ...
      (0, _mobxModule.autorun)(reaction => {
        if (_haxcmsSiteStore.store.activeItem && _haxcmsSiteStore.store.activeItem.metadata && _haxcmsSiteStore.store.activeItem.metadata.updated) {
          this.pageTimestamp = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.activeItem.metadata.updated);
        }
