define(["exports", "require", "../../lit-element/lit-element.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js", "../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/dist/mobx.esm.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button.js", "../utils/utils.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _HAXCMSThemeParts, _HAXCMSMobileMenu, _haxcmsSiteStore, _mobxEsm, _simpleIcon, _simpleIcons, _simpleIconButton, _utils) {
   ...
   * @element clean-two
   */
  class CleanTwo extends (0, _HAXCMSThemeParts.HAXCMSThemeParts)((0, _HAXCMSMobileMenu.HAXCMSMobileMenuMixin)(_HAXCMSLitElementTheme.HAXCMSLitElementTheme)) {
    //styles function
    static get styles() {
    ...
    searchChanged(e) {
      ...
      if (target.value) {
        // prettier-ignore
        new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/site/site-search.js"], res, rej)).then(() => {
        ...
        <div class="content-wrapper">
          <div class="content">
            <div class="header">
              ...
              ${this.responsiveSize != "xl" ? (0, _litElement.html)`
                    <site-menu-content
    ...
    constructor() {
      ...
      (0, _mobxEsm.autorun)(reaction => {
        if (_haxcmsSiteStore.store.activeItem && _haxcmsSiteStore.store.activeItem.metadata && _haxcmsSiteStore.store.activeItem.metadata.updated) {
          this.pageTimestamp = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeItem.metadata.updated);
        }

        this.__disposer.push(reaction);
      });
      new Promise((res, rej) => _require.default(["../simple-datetime/simple-datetime.js"], res, rej)); // prettier-ignore
      ...
      new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/navigation/site-menu-content.js"], res, rej)); // prettier-ignore
      ...
      new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/site/site-rss-button.js"], res, rej)); // prettier-ignore
