...
let schema=this.latestSchema;this.types={};for(var i in schema.classes){if(typeof schema.classes[i].label!==typeof void 0&&typeof schema.classes[i].subClassOf!==typeof void 0&&(schema.classes[i].subClassOf.includes("Resource")||schema.classes[i].subClassOf.includes("LearningComponent")||schema.classes[i].subClassOf.includes("InstructionalPattern"))){this.types["oer:"+i]=schema.classes[i].label}}}}_exports.OERSchema=OERSchema});