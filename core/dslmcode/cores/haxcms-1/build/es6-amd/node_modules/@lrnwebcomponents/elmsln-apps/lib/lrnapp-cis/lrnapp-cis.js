define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/polymer/lib/elements/custom-style.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/paper-item/paper-item.js", "../../../simple-modal/lib/simple-modal-template.js", "../../../../@polymer/paper-listbox/paper-listbox.js", "../../../../@polymer/paper-dropdown-menu/paper-dropdown-menu.js", "../../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../../../@polymer/paper-dialog/paper-dialog.js", "../../../../@polymer/app-route/app-location.js", "../../../../@polymer/app-route/app-route.js", "../../../../@polymer/paper-button/paper-button.js", "../../../../@polymer/paper-toast/paper-toast.js", "../../../elmsln-loading/elmsln-loading.js", "../../../lrndesign-course-banner/lrndesign-course-banner.js", "../../../lrn-icon/lrn-icon.js", "../../../lrnsys-button/lrnsys-button.js", "../../../lrndesign-avatar/lrndesign-avatar.js", "../../../lrnsys-layout/lib/lrnsys-dialog.js", "../../../responsive-grid/lib/responsive-grid-col.js", "../../../responsive-grid/lib/responsive-grid-row.js", "../../../materializecss-styles/materializecss-styles.js", "./lrnapp-cis-course-card.js"], function (_exports, _litElement, _customStyle, _ironAjax, _paperItem, _simpleModalTemplate, _paperListbox, _paperDropdownMenu, _appToolbar, _paperDialog, _appLocation, _appRoute, _paperButton, _paperToast, _elmslnLoading, _lrndesignCourseBanner, _lrnIcon, _lrnsysButton, _lrndesignAvatar, _lrnsysDialog, _responsiveGridCol, _responsiveGridRow, _materializecssStyles, _lrnappCisCourseCard) {
  ...
  */
  class LrnappCis extends _litElement.LitElement {
    /**
    ...
    render() {
      ...
      <app-toolbar class="">
        ...
        >
          ...
          >
            ...
            ${this.originalCourses.map(course => _litElement.html`
        ...
        >
          ...
          >
            <paper-item>-- Any --</paper-item>
            ${this.programs.map(program => _litElement.html`
        ...
        >
          ...
          >
            <paper-item>-- Any --</paper-item>
            ${this.academics.map(academic => _litElement.html`
      ...
      <div class="courses-grid">
        <div class="list-container">
          ${this.courses.map(course => _litElement.html`
              <paper-button
      ...
      <paper-dialog id="dialog" with-backdrop>
        ...
        <paper-dialog-scrollable>
          <div class="dialog-header">
            ${this.activeCourse.attributes ? _litElement.html`
          ...
          <div id="coursedetails">
            ${this.activeCourse.attributes ? _litElement.html`
                  <responsive-grid-row gutter="5">
                    <responsive-grid-col xl="6" lg="6" md="6" sm="12" xs="12">
                      <div class="column">
                        ...
                        ${this.activeCourse.topology ? _litElement.html`
                              ${this.activeCourse.topology.Network.map(service => _litElement.html`
                                  ${service._exists ? _litElement.html`
                                        <lrnsys-button
                                          raised=""
                                          href="${service.url}"
                    ...
                    <responsive-grid-col xl="6" lg="6" md="6" sm="12" xs="12">
                      <div class="column">
                        <h4>Operations</h4>
                        ${this.activeCourse.meta.canUpdate ? _litElement.html`
                    <lrnsys-button
                      raised=""
                  ...
                  <lrnsys-button
                    ...
                    icon="delete"
                  ></lrnsys-button>
                  ${this.activeCourse.meta.canDelete ? _litElement.html`
                          <div
