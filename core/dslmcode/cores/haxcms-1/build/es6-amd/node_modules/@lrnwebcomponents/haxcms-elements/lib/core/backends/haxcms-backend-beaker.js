define(["exports", "require", "../../../../../@polymer/polymer/polymer-element.js", "../../../../beaker-broker/beaker-broker.js", "../haxcms-site-store.js"], function (_exports, _require, _polymerElement, _beakerBroker, _haxcmsSiteStore) {
  ...
  class HAXCMSBackendBeaker extends _polymerElement.PolymerElement {
    ...
    async saveNode(e) {
      ...
      _haxcmsSiteStore.store.cmsSiteEditor.instance.$.toast.show("Page updated!");
    ...
    async saveOutline(e) {
      ...
      _haxcmsSiteStore.store.cmsSiteEditor.instance.$.toast.show("Outline saved!");
    ...
    async deleteNode(e) {
      ...
      _haxcmsSiteStore.store.cmsSiteEditor.instance.$.toast.show(`${page.title} deleted`);
    ...
    async createNode(e) {
      ...
      _haxcmsSiteStore.store.cmsSiteEditor.instance.$.toast.show(`${page.title} created!`);
    ...
    async saveManifest(e) {
      ...
      _haxcmsSiteStore.store.cmsSiteEditor.instance.$.toast.show("Site details saved!");
