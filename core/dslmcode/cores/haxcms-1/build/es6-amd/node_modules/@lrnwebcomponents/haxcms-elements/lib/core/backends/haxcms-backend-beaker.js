define(["exports", "require", "../../../../../lit-element/lit-element.js", "../haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../utils/utils.js", "../../../../beaker-broker/beaker-broker.js", "../../../../hax-body/lib/hax-store.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxEsm, _utils, _beakerBroker, _haxStore) {
  ...
  class HAXCMSBackendBeaker extends _litElement.LitElement {
    ...
    render() {
      return (0, _litElement.html)` <beaker-broker id="beaker"></beaker-broker> `;
    }
    ...
    _appPicked(e) {
      if (e.detail.connection.protocol === "dat") {
        ...
        reader.onload = event => {
          let fileLocation = "files/" + _haxStore.HAXStore.haxTray.shadowRoot.querySelector("#fileupload").files[0].name;
    ...
    async saveNode(e) {
      ...
      await this.shadowRoot.querySelector("#beaker").write(this.activeItem.location, _haxStore.HAXStore.activeHaxBody.haxToContent());
