define(["exports", "../../../lit-element/lit-element.js", "../simple-picker.js"], function (_exports, _litElement, _simplePicker) {
   ...
   */
  class SimpleSymbolPicker extends _simplePicker.SimplePicker {
    //styles function
    static get styles() {
    ...
    firstUpdated(changedProperties) {
      ...
      this.symbolTypes.forEach(type => window.SimplePickerSymbols[type].forEach(symbol => optData.push(symbol)));
