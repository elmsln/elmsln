define(["exports", "../../../lit-element/lit-element.js", "./simple-fields-container.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _litElement, _simpleFieldsContainer, _simpleIcon, _simpleIcons) {
  "use strict";
  ...
  class SimpleFieldsField extends _simpleFieldsContainer.SimpleFieldsContainer {
    ...
    updated(changedProperties) {
      ...
      changedProperties.forEach((oldValue, propName) => {
        ...
        if (propName === "type" && this.type !== oldValue || ["itemsList", "options"].includes(propName)) {
          this._updateField();
        }
      });
    }
    ...
    get fieldMeta() {
      return (0, _litElement.html)` <div id="fieldmeta" aria-live="polite"></div> `;
    }
    /**
    ...
    _handleIconClick(checked, option) {
      this.value = !option ? !checked : this.type === "radio" && checked ? undefined : this.type === "radio" ? (option || {}).value : checked ? (this.value || []).filter(i => i !== option.value) : [...(this.value || []), (option || {}).value];
    ...
    getInput(option) {
      let checked = !option ? !!this.value : this.type === "radio" ? this.value === (option || {}).value : (this.value || []).includes((option || {}).value),
      ...
      <span class="input-option">
        ...
        />
        ${this.type !== "checkbox" && this.type !== "radio" ? "" : (0, _litElement.html)`
              <simple-icon
                icon="${icon}"
