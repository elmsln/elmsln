define(["exports","../../../lit-element/lit-element.js","./simple-fields-container.js"],(function(e,t,i){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.SimpleFieldsField=void 0;class SimpleFieldsField extends i.SimpleFieldsContainer{static get tag(){return"simple-fields-field"}static get styles(){return[...super.styles,t.css`
        fieldset {
          margin: 0;
          padding: 0;
          border: none;
    ...
    `}get inputTemplate(){return t.html`
      <input
        aria-descrbedby="${this.describedBy}"
        aria-invalid="${this.error?"true":"false"}"
        ?autofocus="${this.autofocus}"
        ...
        .type="${this.type}"
      />
    `}get selectTemplate(){return t.html`
      <select
        ?autofocus="${this.autofocus}"
        aria-descrbedby="${this.describedBy}"
        aria-invalid="${this.error?"true":"false"}"
    ...
    `}get slottedFieldObserver(){}get textareaTemplate(){return t.html`
      <textarea
        aria-invalid="${this.error?"true":"false"}"
        ?autofocus="${this.autofocus}"
