"object" == typeof module ? ICAL = module.exports : "object" != typeof ICAL && (this.ICAL = {}), ICAL.foldLength = 75, ICAL.newLineChar = "\r\n", ICAL.helpers = {
  ...
  binsearchInsert: function (a, b, c) {
    ...
    for (var d, e, f = 0, g = a.length - 1; f <= g;) if (d = f + Math.floor((g - f) / 2), e = c(b, a[d]), e < 0) g = d - 1;else {
      if (!(e > 0)) break;
      f = d + 1;
    }
  ...
  a.prototype = Error.prototype, b.property = function (a, c) {
    ...
    for (var k, l, m, n, o, p, q = g, r = 0, s = f, t = {}, u = -1; r !== !1 && (r = j.unescapedIndexOf(c, s, r + 1)) !== -1;) {
      ...
      if ('"' === v) {
        if (u = r + 2, r = j.unescapedIndexOf(c, '"', u), o && r != -1) for (var w = !0; w;) c[r + 1] == o && '"' == c[r + 2] ? r = j.unescapedIndexOf(c, '"', r + 3) : w = !1;
  ...
  return b._parseMultiValue = function (a, c, d, e, f, g, h) {
    ...
    for (; (k = j.unescapedIndexOf(a, c, l)) !== -1;) i = a.substr(l, k - l), i = f ? b._parseMultiValue(i, f, d, [], null, g, h) : b._parseValue(i, d, g, h), e.push(i), l = k + c.length;
  ...
  return a.prototype = {
    ...
    getFirstSubcomponent: function (a) {
      if (a) {
        for (var b = 0, e = this.jCal[c], f = e.length; b < f; b++) if (e[b][d] === a) {
    ...
    getAllSubcomponents: function (a) {
      ...
      if (!this._components || this._hydratedComponentCount !== b) for (; e < b; e++) this._hydrateComponent(e);
      return this._components || [];
    },
    hasProperty: function (a) {
      for (var c = this.jCal[b], e = c.length, f = 0; f < e; f++) if (c[f][d] === a) return !0;

      return !1;
    },
    getFirstProperty: function (a) {
      if (a) {
        for (var c = 0, e = this.jCal[b], f = e.length; c < f; c++) if (e[c][d] === a) {
    ...
    getAllProperties: function (a) {
      ...
      if (!this._properties || this._hydratedPropertyCount !== c) for (; e < c; e++) this._hydrateProperty(e);
    ...
    _removeObject: function (a, b, c) {
      ...
      if ("string" == typeof c) {
        for (; e < g; e++) if (f[e][d] === c) return this._removeObjectByIndex(a, h, e), !0;
      } else if (h) for (; e < g; e++) if (h[e] && h[e] === c) return this._removeObjectByIndex(a, h, e), !0;
  ...
  return a.prototype = {
    ...
    setValues: function (a) {
      ...
      var b = a.length,
          c = 0;
      if (this.removeAllValues(), b > 0 && "object" == typeof a[0] && "icaltype" in a[0] && this.resetType(a[0].icaltype), this.isDecorated) for (; c < b; c++) this._setDecoratedValue(a[c], c);else for (; c < b; c++) this.jCal[e + c] = a[c];
    },
    setValue: function (a) {
  ...
  return a.prototype = {
    ...
    fromData: function (a) {
      if (a) for (var b in a) a.hasOwnProperty(b) && (this[b] = a[b]);
  ...
  ICAL.Timezone = function (a) {
    ...
    fromData: function (b) {
      if (this.expandedUntilYear = 0, this.changes = [], b instanceof ICAL.Component) this.component = b;else {
    ...
    _expandComponent: function (a, b, c) {
      ...
      if (a.hasProperty("rrule") || a.hasProperty("rdate")) {
        ...
        if (l) {
          ...
          for (var m, n = l.iterator(g); (m = n.next()) && (f = e(), !(m.year > b) && m);) f.year = m.year, f.month = m.month, f.day = m.day, f.hour = m.hour, f.minute = m.minute, f.second = m.second, f.isDate = m.isDate, ICAL.Timezone.adjust_change(f, 0, 0, 0, -f.prevUtcOffset), c.push(f);
        }
  ...
  ICAL.Time = function (a, b) {
    ...
    adjust: function (a, b, c, d, e) {
      var f,
          ...
          n = 0,
          o = e || this._time;
      if (o.isDate || (h = o.second + d, o.second = h % 60, f = ICAL.helpers.trunc(h / 60), o.second < 0 && (o.second += 60, f--), i = o.minute + c + f, o.minute = i % 60, g = ICAL.helpers.trunc(i / 60), o.minute < 0 && (o.minute += 60, g--), j = o.hour + b + g, o.hour = j % 24, m = ICAL.helpers.trunc(j / 24), o.hour < 0 && (o.hour += 24, m--)), o.month > 12 ? n = ICAL.helpers.trunc((o.month - 1) / 12) : o.month < 1 && (n = ICAL.helpers.trunc(o.month / 12) - 1), o.year += n, o.month -= 12 * n, k = o.day + a + m, k > 0) for (; l = ICAL.Time.daysInMonth(o.month, o.year), !(k <= l);) o.month++, o.month > 12 && (o.year++, o.month = 1), k -= l;else for (; k <= 0;) 1 == o.month ? (o.year--, o.month = 12) : o.month--, k += ICAL.Time.daysInMonth(o.month, o.year);
    ...
    for (var g = 11; g >= 0; g--) if (d > ICAL.Time.daysInYearPassedMonth[f][g]) {
  ...
  ICAL.VCardTime = function (a, b, c) {
    ...
    toString: function () {
      ...
      if (this.zone === ICAL.Timezone.utcTimezone) a = "Z";else if (this.zone instanceof ICAL.UtcOffset) a = this.zone.toString();else if (this.zone === ICAL.Timezone.localTimezone) a = "";else if (this.zone instanceof ICAL.Timezone) {
  ...
  ICAL.Recur = function (a) {
    ...
    toJSON: function () {
      ...
      for (var b in this.parts) if (this.parts.hasOwnProperty(b)) {
        var c = this.parts[b];
  ...
  return a.prototype = {
    ...
    init: function () {
      ...
      if ("MONTHLY" == this.rule.freq && this.has_by_data("BYDAY")) {
        ...
        for (var j in this.by_data.BYDAY) if (this.by_data.BYDAY.hasOwnProperty(j)) {
          this.last = h.clone();
    ...
    normalizeByMonthDayRules: function (a, b, c) {
      for (var d, e = ICAL.Time.daysInMonth(b, a), f = [], g = 0, h = c.length; g < h; g++) if (d = c[g], !(Math.abs(d) > e)) {
    ...
    _byDayAndMonthDay: function (a) {
      ...
      for (var n = 48; !k && n;) if (n--, e = m + 1, e > g) c();else {
        var o = d[i++];
    ...
    next_month: function () {
      ...
      if (this.has_by_data("BYDAY") && this.has_by_data("BYMONTHDAY")) a = this._byDayAndMonthDay();else if (this.has_by_data("BYDAY")) {
        ...
        for (var f = this.last.day + 1; f <= b; f++) if (this.last.day = f, this.is_day_in_byday(this.last) && (!this.has_by_data("BYSETPOS") || this.check_set_position(++c) || this.check_set_position(c - d - 1))) {
          a = 1;
          break;
        }
    ...
    expand_year_days: function (a) {
      ...
      if (0 == o) {
        ...
        for (var q in this.by_data.BYMONTH) if (this.by_data.BYMONTH.hasOwnProperty(q)) {
        ...
        for (var s in this.by_data.BYMONTHDAY) if (this.by_data.BYMONTHDAY.hasOwnProperty(s)) {
        ...
        for (var q in this.by_data.BYMONTH) if (this.by_data.BYMONTH.hasOwnProperty(q)) {
          ...
          } else for (var D in this.by_data.BYDAY) if (this.by_data.BYDAY.hasOwnProperty(D)) {
            var E,
                ...
                J = (I + 7 - x) % 7 + 1,
                K = v - (z + 7 - I) % 7;
            if (0 == H) for (var B = J; B <= v; B += 7) this.days.push(y + B);else H > 0 ? (E = J + 7 * (H - 1), E <= v && this.days.push(y + E)) : (E = K + 7 * (H + 1), E > 0 && this.days.push(y + E));
          }
        }
    ...
    expand_by_day: function (a) {
      ...
      for (var g in this.by_data.BYDAY) if (this.by_data.BYDAY.hasOwnProperty(g)) {
        var h = this.by_data.BYDAY[g],
            i = this.ruleDayOfWeek(h),
            j = i[0],
            k = i[1];
        if (0 == j) for (var l = (k + 7 - d) % 7 + 1, m = l; m <= f; m += 7) b.push(m);else if (j > 0) {
          var n;
    ...
    is_day_in_byday: function (a) {
      for (var b in this.by_data.BYDAY) if (this.by_data.BYDAY.hasOwnProperty(b)) {
    ...
    sort_byday_rules: function (a, b) {
      for (var c = 0; c < a.length; c++) for (var d = 0; d < c; d++) {
    ...
    check_contract_restriction: function (b, c) {
      ...
      if (b in this.by_data && e == a.CONTRACT) {
        ...
        for (var h in g) if (g.hasOwnProperty(h) && g[h] == c) {
          f = !0;
          break;
        }
      } else f = !0;
