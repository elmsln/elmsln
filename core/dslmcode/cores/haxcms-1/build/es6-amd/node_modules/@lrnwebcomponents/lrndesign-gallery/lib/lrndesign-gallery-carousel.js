define(["exports","../../../lit-element/lit-element.js","./lrndesign-gallery-behaviors.js","../../../@polymer/iron-image/iron-image.js","../../../@polymer/iron-icons/iron-icons.js","./lrndesign-gallery-zoom.js"],(function(e,i,t,s,o,l){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.LrndesignGalleryCarousel=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class LrndesignGalleryCarousel extends t.LrndesignGalleryBehaviors{static get tag(){return"lrndesign-gallery-carousel"}static get styles(){return[...super.styles,i.css`
        :host {
          margin: 15px 0 0;
          padding: 0;
        }
                    ...
                    <div>
                      ...
                      ${this.sources.map(e=>i.html`
                          <button
                            ...
                            class="gallerythumb"
                            index="${e.index}"
                            @click="${i=>this._itemChanged(e.id)}"
                            ?disabled="${this.selected.id===e.id}"
                          >
                            <iron-image
                              alt="${e.alt}"
                              fade
    ...
    `}static get properties(){return{...super.properties}}constructor(){super()}get hideNav(){return console.log("hideNav",this,this.sources,void 0===this.sources||this.sources.length<2),void 0===this.sources||this.sources.length<2}_onNavTapped(e){this.goToItem(e.index)}}e.LrndesignGalleryCarousel=LrndesignGalleryCarousel,window.customElements.define(LrndesignGalleryCarousel.tag,LrndesignGalleryCarousel)}));