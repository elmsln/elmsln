define(["exports","../../../@polymer/polymer/polymer-element.js","./lrndesign-gallery-behaviors.js","./lrndesign-gallery-details.js","./lrndesign-gallery-zoom.js"],(function(e,t,i,s,l){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.LrndesignGalleryCarousel=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class LrndesignGalleryCarousel extends i.LrndesignGalleryBehaviors{static get tag(){return"lrndesign-gallery-carousel"}static get behaviors(){return[i.LrndesignGalleryBehaviors]}static get template(){return t.html`
    ...
    `}static get properties(){return{__imageStyle:{type:String,computed:"_getImageStyle(extraWide,responsiveSize)"}}}ready(){if(super.ready(),this.selected.scroll){let e=this.shadowRoot.querySelector("#carouselitem");this._scrollIntoView([this._getParentOffset(e)]),this.selected.zoomed||e.focus()}}goToItem(e){let t=this;"number"==typeof e&&e>=0&&e<t.items.length&&(t.selected=t.items[e])}_getImageStyle(e,t){return e||"xs"===t?"padding-bottom: "+100/this.aspectRatio+"%;":"xl"===t?"width: "+400*this.aspectRatio+"px; height: 400px;":"lg"===t?"width: "+300*this.aspectRatio+"px; height: 300px;":"width: "+200*this.aspectRatio+"px; height: 200px;"}_getIndex(e,t){return e+t}_hideNav(e){return void 0===e||e.length<2}_onPrev(e){this.goToItem(parseInt(this.shadowRoot.querySelector("#carouselprev").getAttribute("index")))}_onNext(e){this.goToItem(parseInt(this.shadowRoot.querySelector("#carouselnext").getAttribute("index")))}_onNavTapped(e){this.goToItem(e.model.item.index)}_updateDetails(){this.shadowRoot.querySelector("#itembody").innerHTML=this.item.details}}e.LrndesignGalleryCarousel=LrndesignGalleryCarousel,window.customElements.define(LrndesignGalleryCarousel.tag,LrndesignGalleryCarousel)}));