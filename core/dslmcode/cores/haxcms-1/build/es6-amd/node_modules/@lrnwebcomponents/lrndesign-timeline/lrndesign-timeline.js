...
class LrndesignTimeline extends t.SimpleColors{render(){return i.html`
        ...
        <div id="timeline">
          <div id="events" @scroll="${this._checkScroll}">
            ${this.eventsList.map((e,t)=>i.html`
                <section
                  class="event"
                  ?has-media="${e.imagesrc&&""!==e.imagesrc}"
                >
    ...
    `}static get properties(){return{events:{type:"Array"},timelineSize:{type:"String",reflect:!0,attribute:"timeline-size",value:"xs",timelineTitle:{type:"String",reflect:!0,attribute:"timeline-title"},title:{type:"String",attribute:"title"}}}}tag(){return"lrndesign-timeline"}constructor(){super(),this.events=[],this.timelineSize="xs",super.connectedCallback(),window.ResponsiveUtility.requestAvailability(),window.dispatchEvent(new CustomEvent("responsive-element",{detail:{element:this,attribute:"timeline-size",relativeToParent:!0,sm:600,md:900,lg:1200,xl:1600}}))}updated(e){super.updated(e),e.forEach((e,i)=>{"timelineTitle"===i&&this.title&&!this.timelineTitle&&(this.timelineTitle=this.title)})}connectedCallback(){super.connectedCallback()}get eventsElement(){return!(!this.shadowRoot||!this.shadowRoot.querySelector("#events"))&&this.shadowRoot.querySelector("#events")}get eventsList(){return("string"==typeof this.events?JSON.parse(this.events):this.events)||[]}_checkScroll(){if(this.shadowRoot){let e=this.shadowRoot.querySelectorAll(".event")||[];e.forEach(i=>{let t=i.offsetTop,n=e[0].offsetTop+50+i.parentNode.scrollTop,s=i.offsetTop+i.offsetHeight;n>t&&n<s?i.setAttribute("selected",!0):i.removeAttribute("selected")})}}}e.LrndesignTimeline=LrndesignTimeline,customElements.define("lrndesign-timeline",LrndesignTimeline)}));