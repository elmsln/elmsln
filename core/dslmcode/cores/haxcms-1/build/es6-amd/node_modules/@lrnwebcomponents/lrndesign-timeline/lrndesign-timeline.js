define(["exports","../../lit-element/lit-element.js","../simple-colors/simple-colors.js","../responsive-utility/responsive-utility.js"],(function(e,i,t,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.LrndesignTimeline=void 0;
/**
   * Copyright 2020 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class LrndesignTimeline extends t.SimpleColors{render(){return i.html`
<style>:host {
  font-size: 14px;
  font-weight: 100;
  line-height: 160%;
...
<article>
  ...
  <div id="timeline">
      <div id="events" @scroll="${this._checkScroll}">
        ${this.eventsList.map((e,t)=>i.html`
          <section class="event" ?has-media="${e.imagesrc&&""!==e.imagesrc}">
            <div class="event-overview">
              <div class="heading"><h2>${e.heading}</h2></div>
              <div class="media-outer">
                ${e.imagesrc&&""!==e.imagesrc?i.html`
                    <div class="media">
                      <div><image alt="${e.imagealt}" src="${e.imagesrc}"/></div>
                    </div>
                `:""}
              </div>
            </div>
...
</article>`}static get properties(){return{events:{type:"Array"},timelineSize:{type:"String",reflect:!0,attribute:"timeline-size",value:"xs",timelineTitle:{type:"String",reflect:!0,attribute:"timeline-title"},title:{type:"String",attribute:"title"}}}}static get tag(){return"lrndesign-timeline"}constructor(){super(),this.events=[],this.timelineSize="xs",window.ResponsiveUtility.requestAvailability(),window.dispatchEvent(new CustomEvent("responsive-element",{detail:{element:this,attribute:"timeline-size",relativeToParent:!0,sm:600,md:900,lg:1200,xl:1600}}))}updated(e){super.updated(e),e.forEach((e,i)=>{"timelineTitle"===i&&this.title&&!this.timelineTitle&&(this.timelineTitle=this.title)})}get eventsElement(){return!(!this.shadowRoot||!this.shadowRoot.querySelector("#events"))&&this.shadowRoot.querySelector("#events")}get eventsList(){return("string"==typeof this.events?JSON.parse(this.events):this.events)||[]}_checkScroll(){if(this.shadowRoot){let e=this.shadowRoot.querySelectorAll(".event")||[];e.forEach(i=>{let t=i.offsetTop,n=e[0].offsetTop+50+i.parentNode.scrollTop,s=i.offsetTop+i.offsetHeight;n>t&&n<s?i.setAttribute("selected",!0):i.removeAttribute("selected")})}}}e.LrndesignTimeline=LrndesignTimeline,customElements.define(LrndesignTimeline.tag,LrndesignTimeline)}));