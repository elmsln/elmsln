define(["exports", "../../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  class SimpleFieldsContainer extends _litElement.LitElement {
    ...
    render() {
      return (0, _litElement.html)` ${this.fieldMainTemplate} ${this.fieldBottom} `;
    }
    ...
    _updateCount() {
      let count = ``,
        ...
        return ((this.field || {}).value || "").match(regex);
          ...
          wordlength = () => {
        return !this.field || !this.field.value || !matchval(wordcounter) ? 0 : matchval(wordcounter).length;
      },
