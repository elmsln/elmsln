define(["exports","../../lit-element/lit-element.js","../../@polymer/paper-icon-button/paper-icon-button.js","../../@polymer/iron-icons/iron-icons.js","../simple-tooltip/simple-tooltip.js"],(function(e,t,o,a,i){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.A11yCollapse=void 0;class A11yCollapse extends t.LitElement{static get styles(){return[t.css`
        :host {
          display: block;
    ...
    `}_onClick(){this.disabled||(this.toggle(),this.dispatchEvent(new CustomEvent("a11y-collapse-click",{bubbles:!0,cancelable:!0,composed:!0,detail:this})))}}e.A11yCollapse=A11yCollapse,window.customElements.define(A11yCollapse.tag,A11yCollapse)}));