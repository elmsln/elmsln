  ...
  */
  class LrnsysOutlineItem extends _polymerElement.PolymerElement {
    ...
    disconnectedCallback() {
      ...
      this.$.input.removeEventListener("focused-changed", this._focusin.bind(this));
    ...
    add() {
      let i = this.$.input.shadowRoot.querySelector("#" + this.$.input._inputId).inputElement.selectionStart,
          j = this.title;
    ...
    _onBackspace(e) {
      ...
      } else if (this.$.input.shadowRoot.querySelector("#" + this.$.input._inputId).inputElement.selectionStart == 0) {
        this.dispatchEvent(new CustomEvent("indent-item", {
          bubbles: true,
          cancelable: true,
          composed: true,
    ...
    _onArrowUp() {
      if (this.$.input.shadowRoot.querySelector("#" + this.$.input._inputId).inputElement.selectionStart == 0) {
        this.dispatchEvent(new CustomEvent("focus-item", {
          bubbles: true,
          cancelable: true,
          composed: true,
    ...
    _onArrowDown() {
      if (this.$.input.shadowRoot.querySelector("#" + this.$.input._inputId).inputElement.selectionStart == this.title.length) {
        this.dispatchEvent(new CustomEvent("focus-item", {
          bubbles: true,
          cancelable: true,
          composed: true,
