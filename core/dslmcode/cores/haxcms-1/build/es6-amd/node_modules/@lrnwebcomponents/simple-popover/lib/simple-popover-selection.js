define(["exports", "../../../lit-element/lit-element.js", "../../../lit-html/lib/render.js", "../../../lit-html/directives/unsafe-html.js", "./simple-popover-manager.js"], function (_exports, _litElement, _render, _unsafeHtml, _simplePopoverManager) {
  ...
  class SimplePopoverSelection extends _litElement.LitElement {
    constructor() {
      super();
      this.disabled = false;
    }
    ...
    openedChanged(state) {
      if (state) {
        ...
        let slot = this.querySelectorAll('[slot="options"]'); // account for nesting in a single option area
        ...
        let content; // support for slot injected styles
        ...
        if (this.querySelector('[slot="style"]')) {
          ...
          content = (0, _litElement.html)`${(0, _unsafeHtml.unsafeHTML)(div.innerHTML)}${(0, _unsafeHtml.unsafeHTML)(style.outerHTML)}`;
        } else {
          content = (0, _litElement.html)`${(0, _unsafeHtml.unsafeHTML)(div.innerHTML)}`;
        }
    ...
    itemSelect(e) {
      ...
      this.opened = false;
      setTimeout(() => {
        window.SimplePopoverManager.requestAvailability().setPopover(this, this.querySelector('[slot="button"]'), false);
    ...
    render() {
      return (0, _litElement.html)`<slot name="button"></slot>`;
    }
