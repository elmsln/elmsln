  ...
  class a11yCompareImage extends _litElement.LitElement {
    ...
    render() {
      ...
      <figure>
        ...
        <div id="input">
          ${this.__markers.map(marker => (0, _litElement.html)` <div class="marker" style="left: ${marker}%;"></div> `)}
          <simple-range-input
            accent-color="blue"
            id="slider"
    ...
    _slide() {
      ...
      let section = 100 / total; // Index of the upper image

      let active = Math.floor(this.position / section) || 0; // This is the layer number that is current on top.
      ...
      let relativePosition = this.position - lastSection; // Percentage into the current section
