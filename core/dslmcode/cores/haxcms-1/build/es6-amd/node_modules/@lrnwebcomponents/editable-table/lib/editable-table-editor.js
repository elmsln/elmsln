...
*/class EditableTableEditor extends(0,_editableTableBehaviors.editBehaviors)((0,_editableTableBehaviors.displayBehaviors)((0,_responsiveUtilityBehaviors.ResponsiveUtilityBehaviors)(_polymerElement.PolymerElement))){static get template(){return _polymerElement.html`
   ...
   */insertRow(index){let temp=[];for(let i=0;i<this.data[0].length;i++){temp.push("")}this.splice("data",index+1,0,temp)}}_exports.EditableTableEditor=EditableTableEditor;window.customElements.define(EditableTableEditor.tag,EditableTableEditor)});