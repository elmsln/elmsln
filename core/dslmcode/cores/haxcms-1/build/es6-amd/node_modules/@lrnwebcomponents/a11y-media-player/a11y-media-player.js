define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../responsive-utility/responsive-utility.js", "../anchor-behaviors/anchor-behaviors.js", "./lib/a11y-media-state-manager.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _require, _litElement, _simpleColors, _responsiveUtility, _anchorBehaviors, _a11yMediaStateManager, _esGlobalBridge) {
   ...
   */
  new Promise((res, rej) => _require.default(["./lib/a11y-media-button.js"], res, rej));
  new Promise((res, rej) => _require.default(["./lib/a11y-media-transcript-cue.js"], res, rej));
  new Promise((res, rej) => _require.default(["./lib/a11y-media-youtube.js"], res, rej));
  ...
  class A11yMediaPlayer extends _simpleColors.SimpleColors {
    ...
    get fullFlex() {
      return this.flexLayout && !this.height && this.responsiveSize !== "xs" && this.responsiveSize !== "sm";
    }
    /**
    ...
    updated(changedProperties) {
      changedProperties.forEach((oldValue, propName) => {
        ...
        if (change(["height"])) this.style.setProperty("--a11y-media-player-height", this.height ? this.height : "unset");
        /* updates media */
    ...
    getloadedTracks() {
      ...
      if (!media) {
        primary = document.createElement(this.querySelectorAll('source[type*="audio"]').length > 0 ? "audio" : "video");
