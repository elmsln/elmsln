    ...
    <div id="player" .style="${this.playerStyle}">
      ...
      ${0!==Object.keys(this.captionCues||[]).length&&this.showCustomCaptions?_litElement.html`
        <div id="cc-custom" 
          ...
          class="screen-only">
            <div id="cc-text">
              ${this.captionCues?Object.keys(this.captionCues).map(key=>_litElement.html`${this.captionCues[key].text?this.captionCues[key].text:""}`):""}
            </div>
        </div>
        `:_litElement.html``}
    </div>
...
${this.poster?_litElement.html`<img id="print-thumbnail" aria-hidden="true" .src="${this.poster}" />`:""}
