define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../simple-toast/simple-toast.js", "../fullscreen-behaviors/fullscreen-behaviors.js", "../anchor-behaviors/anchor-behaviors.js", "../responsive-utility/responsive-utility.js", "../absolute-position-behavior/absolute-position-behavior.js", "../simple-tooltip/simple-tooltip.js", "./lib/a11y-media-play-button.js", "./lib/a11y-media-state-manager.js", "./lib/a11y-media-button.js", "./lib/a11y-media-transcript-cue.js", "./lib/a11y-media-youtube.js"], function (_exports, _require, _litElement, _simpleColors, _simpleToast, _fullscreenBehaviors, _anchorBehaviors, _responsiveUtility, _absolutePositionBehavior, _simpleTooltip, _a11yMediaPlayButton, _a11yMediaStateManager, _a11yMediaButton, _a11yMediaTranscriptCue, _a11yMediaYoutube) {
  "use strict";
   ...
   */
  class A11yMediaPlayer extends (0, _fullscreenBehaviors.FullscreenBehaviors)(_simpleColors.SimpleColors) {
    //styles function
    static get styles() {
    ...
    render() {
      return (0, _litElement.html)` <div class="sr-only" ?hidden="${!this.mediaCaption}">
        ${this.mediaCaption}
      </div>
          ...
          <div id="player" .style="${this.playerStyle}">
            ...
            ${Object.keys(this.captionCues || []).length === 0 || !this.showCustomCaptions ? (0, _litElement.html)`` : (0, _litElement.html)`
                  <div id="cc-custom" aria-live="polite" class="screen-only">
                    <div id="cc-text">
                      ${!this.captionCues ? `` : Object.keys(this.captionCues).map(key => (0, _litElement.html)`${this.captionCues[key].text ? this.captionCues[key].text : ""}`)}
                    </div>
                  </div>
                `}
          </div>
      ...
      ${this.poster ? (0, _litElement.html)`<img
            id="print-thumbnail"
            aria-hidden="true"
            .src="${this.poster}"
          />` : ``}
      ...
      >
        ...
        return (0, _litElement.html)`
                ...
                ` : (0, _litElement.html)` <div id="loading" class="transcript-from-track">
                  ${this.status}
                </div>`}
          </div>
        </div>
    ...
    constructor() {
      ...
      setTimeout(() => {
        ...
        new Promise((res, rej) => _require.default(["../simple-range-input/simple-range-input.js"], res, rej));
    ...
    get fullscreenButton() {
      ...
      return this.fullscreenEnabled && !mobile && !this.disableFullscreen && !this.audioNoThumb;
    }
    /**
