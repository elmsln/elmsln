define(["exports","meta","require","../../lit-element/lit-element.js","../simple-colors/simple-colors.js","../responsive-utility/responsive-utility.js","../anchor-behaviors/anchor-behaviors.js","../es-global-bridge/es-global-bridge.js"],(function(_exports,meta,_require,_litElement,_simpleColors,_responsiveUtility,_anchorBehaviors,_esGlobalBridge){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.A11yMediaPlayer=void 0,meta=babelHelpers.interopRequireWildcard(meta),_require=babelHelpers.interopRequireWildcard(_require);
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class A11yMediaPlayer extends _simpleColors.SimpleColors{static get styles(){return[...super.styles,_litElement.css`
        :host {
          display: block;
          width: calc(100% - 2px);
        ...
        >
          <div id="player" .style="${this.playerStyle}">
            ...
            ${this.videoId?_litElement.html`
                ...
                `:_litElement.html``}
            ${0!==Object.keys(this.captionCues||[]).length&&this.showCustomCaptions?_litElement.html`
                  <div id="cc-custom" aria-live="polite" class="screen-only">
                    <div id="cc-text">
                      ${this.captionCues?Object.keys(this.captionCues).map(key=>_litElement.html`
                  ...
                  <div class="setting">
                    ...
                    <div class="setting-control">
                      ...
                      >
                        ...
                        >
                        ${this.loadedTracks?Object.keys(this.loadedTracks.textTracks).map(key=>_litElement.html`
      ...
      >
        <div id="transcript-and-controls" ?hidden="${this.hideTranscript}">
          ...
          <div id="transcript" aria-live="polite">
            ...
            ${this.transcriptCues.length>0?_litElement.html`
                  <div class="transcript-from-track">
                    ${this.transcriptCues.map((cue,index)=>_litElement.html`
