define(["exports","meta","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js","./lib/a11y-media-behaviors.js","../../@polymer/polymer/lib/utils/resolve-url.js","../../@polymer/polymer/lib/legacy/class.js","../simple-colors/simple-colors.js","../es-global-bridge/es-global-bridge.js","./lib/a11y-media-state-manager.js","./lib/a11y-media-controls.js","./lib/a11y-media-html5.js","./lib/a11y-media-transcript.js","./lib/a11y-media-transcript-controls.js","./lib/a11y-media-youtube.js"],function(_exports,meta,_require,_polymerElement,_renderStatus,_a11yMediaBehaviors,_resolveUrl,_class,_simpleColors,_esGlobalBridge,_a11yMediaStateManager,_a11yMediaControls,_a11yMediaHtml,_a11yMediaTranscript,_a11yMediaTranscriptControls,_a11yMediaYoutube){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.A11yMediaPlayer=void 0,meta=babelHelpers.interopRequireWildcard(meta),_require=babelHelpers.interopRequireWildcard(_require);class A11yMediaPlayer extends _a11yMediaBehaviors.A11yMediaBehaviors{static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
          width: calc(100% - 2px);
    ...
    `}static get properties(){return{allowConcurrent:{name:"allowConcurrent",type:Boolean,value:!1},audioNoThumb:{name:"audioNoThumb",type:Boolean,computed:"_getAudioNoThumb(audioOnly,thumbnailSrc)"},darkTranscript:{name:"darkTranscript",type:Boolean,value:!1},disableFullscreen:{name:"disableFullscreen",type:Boolean,value:!1},disableInteractive:{name:"disableInteractive",type:Boolean,value:!1},flexLayout:{name:"flexLayout",type:Boolean,computed:"_isFlexLayout(standAlone,hideTranscript,audioNoThumb,stackedLayout)",reflectToAttribute:!0},fullscreen:{name:"fullscreen",type:Boolean,value:!1},fullscreenButton:{name:"fullscreenButton",type:Boolean,computed:"_getFullscreenButton(disableFullscreen,audioNoThumb,screenfullLoaded)",notify:!0},hasCaptions:{name:"hasCaptions",type:Boolean,value:!1},hideElapsedTime:{name:"hideElapsedTime",type:Boolean,value:!1},hideTimestamps:{name:"hideTimestamps",type:Boolean,value:!1},hideTranscript:{name:"hideTranscript",type:Boolean,value:!1,reflectToAttribute:!0},id:{name:"id",type:String,value:null,reflectToAttribute:!0},mediaCaption:{name:"mediaCaption",type:String,computed:"_getMediaCaption(audioOnly,localization,mediaTitle)"},mediaLang:{name:"mediaLang",type:String,value:"en"},muteUnmute:{name:"muteUnmute",type:Object,computed:"_getMuteUnmute(muted)"},printCaption:{name:"printCaption",type:String,computed:"_getPrintCaption(audioOnly,audioLabel,videoLabel,mediaTitle)"},responsiveSize:{name:"responsiveSize",type:String,notify:!0,value:"xs",reflectToAttribute:!0},screenfullLoaded:{name:"screenfullLoaded",type:Boolean,value:!1,notify:!0},showCustomCaptions:{name:"showCustomCaptions",type:Boolean,computed:"_showCustomCaptions(isYoutube, audioOnly, hasCaptions, cc)"},sources:{name:"sources",type:Array,value:[]},stackedLayout:{name:"stackedLayout",type:Boolean,value:!1},sticky:{name:"sticky",type:Boolean,value:!1,reflectToAttribute:!0},stickyCorner:{name:"stickyCorner",type:String,value:"top-right",reflectToAttribute:!0},thumbnailSrc:{name:"thumbnailSrc",type:String,value:null,reflectToAttribute:!0},tracks:{name:"tracks",type:Array,value:[]},playPause:{name:"playPause",type:Object,computed:"_getPlayPause(__playing)"},__playing:{name:"__playing",type:Boolean,value:!1,notify:!0,reflectToAttribute:!0}}}constructor(){super(),new Promise((res,rej)=>_require.default(["../../@polymer/paper-slider/paper-slider.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/iron-icons/iron-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/iron-icons/av-icons.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/a11y-media-play-button.js"],res,rej));const location=`${(0,_resolveUrl.pathFromUrl)(decodeURIComponent(meta.url))}lib/screenfull/dist/screenfull.js`;window.ESGlobalBridge.requestAvailability(),window.ESGlobalBridge.instance.load("screenfullLib",location),window.addEventListener("es-bridge-screenfullLib-loaded",this._onScreenfullLoaded.bind(this)),this.__playerAttached=!0,window.A11yMediaStateManager.requestAvailability()}static get tag(){return"a11y-media-player"}static get behaviors(){return[_a11yMediaBehaviors.A11yMediaBehaviors,_simpleColors.SimpleColors]}connectedCallback(){super.connectedCallback(),this._addResponsiveUtility(),window.dispatchEvent(new CustomEvent("a11y-player",{detail:this})),this.isYoutube&&this._youTubeRequest()}ready(){super.ready();let root=this;new Array,new Array;"object"==typeof screenfull&&root._onScreenfullLoaded.bind(root),null===root.id&&(root.id="a11y-media-player"+Date.now()),root.__playerReady=!0,root.target=root.shadowRoot.querySelector("#transcript"),root.__status=root._getLocal("loading","label"),root.__slider=root.$.slider,root.__slider.min=0,root.__volume=root.muted?0:Math.max(this.volume,10),root.__resumePlaying=!1,root.__duration=0,root.$.controls.setStatus(root.__status),root.width=null!==root.width?root.width:"100%",root.style.maxWidth=null!==root.width?root.width:"100%",root._setPlayerHeight(16/9),root.isYoutube?(root._youTubeRequest(),document.addEventListener("timeupdate",e=>{e.detail===root.media&&root._handleTimeUpdate(e)})):(root.media=root.$.html5,root.media.media.addEventListener("timeupdate",e=>{root._handleTimeUpdate(e)}),root._addSourcesAndTracks()),root.$.transcript.setMedia(root.$.innerplayer)}play(){this.__playing;this.__playing=!0,this.media.play(),window.dispatchEvent(new CustomEvent("a11y-player-playing",{detail:this}))}pause(){this.__playing=!1,this.media.pause()}stop(){this.pause(),this.seek(0)}restart(){this.seek(0),this.play()}rewind(amt){amt=void 0!==amt?amt:this.media.duration/20,this.__resumePlaying=this.__playing,this.seek(this.media.getCurrentTime()-amt,0),this.__resumePlaying&&this.play(),this.__resumePlaying=!1}forward(amt){amt=void 0!==amt?amt:this.media.duration/20,this.__resumePlaying=this.__playing,this.seek(this.media.getCurrentTime()+amt),this.__resumePlaying&&this.play(),this.__resumePlaying=!1}seek(time){let seekable=void 0!==this.media&&null!==this.media?this.media.seekable:[];seekable.length>0&&time>=seekable.start(0)&&time<=seekable.end(0)&&this.media.seek(time)}selectTrack(index){this.__selectedTrack=index,this.$.html5.selectTrack(index)}setVolume(value){this.volume=null!==value?value:70,this.media.setVolume(this.volume),this.muted=0===this.volume}setPlaybackRate(value){value=null!==value?value:1,this.media.setPlaybackRate(value)}toggleCC(mode){this.cc=void 0===mode?!this.cc:mode,this.$.html5.setCC(this.cc)}toggleLoop(mode){this.isYoutube||(this.loop=void 0===mode?!this.loop:mode,this.media.setLoop(this.loop))}toggleMute(mode){this.muted=void 0===mode?!this.muted:mode,this.__volume=this.muted?0:Math.max(this.volume,10),this.media.setMute(this.muted)}toggleSticky(mode){mode=void 0===mode?!this.sticky:mode,this.sticky=mode,this.dispatchEvent(new CustomEvent("player-sticky",{detail:this}))}toggleTranscript(mode){mode=void 0===mode?this.hideTranscript:mode,this.hideTranscript=!mode,void 0!==this.$.transcript&&null!==this.$.transcript&&this.dispatchEvent(new CustomEvent("transcript-toggle",{detail:this}))}_appendToPlayer(data,type){if(null!=data&&data!==[]){let root=this,arr=Array.isArray(data)?data:JSON.parse(data);for(let i=0;i<arr.length;i++){let el=document.createElement(type);for(let key in arr[i])el.setAttribute(key,arr[i][key]);root.$.html5.media.appendChild(el)}}}_setPlayerHeight(aspect){let root=this;root.audioOnly&&null===root.thumbnailSrc&&null===root.height?root.$.player.style.height="60px":null===root.height?(root.$.player.style.paddingTop=100/aspect+"%",root.$.innerplayer.style.maxWidth="calc("+100*aspect+"vh - "+80*aspect+"px)"):root.$.outerplayer.style.height=root.height}_getMediaCaption(audioOnly,localization,mediaTitle){let audioLabel=this._getLocal("audio","label"),hasMediaTitle=null!=mediaTitle&&""!==mediaTitle;return audioOnly&&hasMediaTitle?mediaTitle+" ("+audioLabel+")":audioOnly?audioLabel:hasMediaTitle?mediaTitle:null}_getMuteUnmute(muted){return muted?{label:this._getLocal("unmute","label"),icon:this._getLocal("unmute","icon"),action:"unmute"}:{label:this._getLocal("mute","label"),icon:this._getLocal("mute","icon"),action:"mute"}}_getPrintCaption(audioOnly,localization,mediaTitle){let audioLabel=this._getLocal("audio","label"),videoLabel=this._getLocal("video","label"),hasMediaTitle=null!=mediaTitle&&""!==mediaTitle;return audioOnly&&hasMediaTitle?mediaTitle+" ("+audioLabel+")":audioOnly?audioLabel:hasMediaTitle?mediaTitle+" ("+videoLabel+")":videoLabel}_getThumbnailCSS(thumbnailSrc,isYoutube,audioOnly){return null!=thumbnailSrc&&(isYoutube||audioOnly)?"background-image: url("+thumbnailSrc+"); background-size: cover;":null}_addSourcesAndTracks(){let root=this,counter=0;root.querySelectorAll("source,track").forEach(node=>{root.$.html5.media.appendChild(node)}),root._appendToPlayer(root.tracks,"track"),root._appendToPlayer(root.sources,"source"),root.$.html5.media.textTracks.onaddtrack=e=>{root.hasCaptions=!0,root.hasTranscript=!root.standAlone,root._getTrackData(e.track,counter++)}}_getAudioNoThumb(audioOnly,thumbnailSrc){return audioOnly&&null==thumbnailSrc}_getFullscreenButton(disableFullscreen,audioNoThumb,screenfullLoaded){return!(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||disableFullscreen||audioNoThumb||!screenfullLoaded)}_getPlayPause(__playing){return!1!==__playing?{label:this._getLocal("pause","label"),icon:this._getLocal("pause","icon"),action:"pause"}:{label:this._getLocal("play","label"),icon:this._getLocal("play","icon"),action:"play"}}_getTrackData(track,id){let loadCueData,root=this,selected=!0===track.default||void 0===root.__selectedTrack;selected&&root.selectTrack(id),track.mode=selected&&!0===this.cc?"showing":"hidden",loadCueData=setInterval(()=>{if(void 0!==track.cues&&null!==track.cues&&track.cues.length>0){clearInterval(loadCueData);let cues=Object.keys(track.cues).map(key=>({order:""!==track.cues[key].id?track.cues[key].id:key,seek:track.cues[key].startTime,seekEnd:track.cues[key].endTime,start:root._getHHMMSS(track.cues[key].startTime,root.media.duration),end:root._getHHMMSS(track.cues[key].endTime,root.media.duration),text:track.cues[key].text}));void 0===root.__tracks&&(root.__tracks=[]),root.push("__tracks",{value:id,language:track.language,text:void 0!==track.label?track.label:void 0!==track.language?track.language:"Track "+id,cues:cues}),root.$.controls.setTracks(root.__tracks),root.$.transcript.setTracks(root.__tracks),root.push("__tracks"),track.oncuechange=e=>{root.$.transcript.setActiveCues(Object.keys(e.currentTarget.activeCues).map(key=>e.currentTarget.activeCues[key].id))}}},1)}_handleTranscriptSeek(e){let root=this;root.standAlone||void 0===root.$.transcript||null===root.$.transcript||(root.__resumePlaying=root.__playing,root.seek(e.detail))}_handleMediaLoaded(e){let aspect=this.media.aspectRatio;this._setPlayerHeight(aspect),this.$.playbutton.removeAttribute("disabled"),this._setElapsedTime(),this._getTrackData(this.$.html5.media)}_hidePlayButton(thumbnailSrc,isYoutube,__elapsed){return isYoutube&&null===thumbnailSrc||!(void 0===__elapsed||0===__elapsed)}_handlePrinting(e){this.dispatchEvent(new CustomEvent("printing-transcript",{detail:this})),this.$.transcript.print(this.mediaTitle)}_handleSearchAdded(e){this.search=e.detail}_handleSliderStart(e){this.__resumePlaying=!this.paused,this.pause(),this.__seeking=!0}_handleSliderStop(e){this.seek(this.$.slider.immediateValue),this.__seeking=!1,this.__resumePlaying&&(this.play(),this.__resumePlaying=null)}_handleTimeUpdate(e){let root=this;root.isYoutube&&root.media.duration!==root.media.getDuration()&&(root.__duration=root.media.duration=root.media.getDuration(),root.disableSeek=!1,root._addSourcesAndTracks(),root.media.seekable&&root.media.seekable.length>0&&0!==root.media.seekable.start(0)&&(root.$.slider.min=root.media.seekable.start(0))),void 0!==root.media.seekable&&root.media.seekable.length>0&&root.media.seekable.end(0)<=root.media.getCurrentTime()&&(root.stop(),root.__playing=!1),root._updateCustomTracks(),root._setElapsedTime()}_handleTranscriptScrollToggle(e){this.disableScroll=!this.disableScroll}_isFlexLayout(standAlone,hideTranscript,audioNoThumb,stackedLayout){return!(standAlone||hideTranscript||audioNoThumb||stackedLayout)}_onControlsChanged(e){let root=this,action=void 0!==e.detail.action?e.detail.action:e.detail.id;"backward"===action||"rewind"===action?root.rewind():"captions"===action?root.toggleCC():"transcript"===action||"transcript-toggle"===action?root.toggleTranscript():"tracks"===e.detail.id?""===e.detail.value?root.toggleCC(!1):(root.toggleCC(!0),root.selectTrack(e.detail.value)):"forward"===action?root.forward():"fullscreen"===action&&root.fullscreenButton?(root.toggleTranscript(root.fullscreen),screenfull.toggle(root.$.outerplayer)):"loop"===action?root.toggleLoop():"mute"===action||"unmute"===action?root.toggleMute():"pause"===action?root.pause():"play"===action?root.play():"restart"===action?(root.seek(0),root.play()):"speed"===action?root.setPlaybackRate(e.detail.value):"volume"===action&&root.setVolume(e.detail.value)}_onScreenfullLoaded(){let root=this;root.screenfullLoaded=!0,screenfull&&screenfull.on("change",()=>{screenfull.enabled&&(root.fullscreen=screenfull.isFullscreen)})}_setElapsedTime(){let elapsed=!0===this.__seeking?this.$.slider.immediateValue:this.media.getCurrentTime()>0?this.media.getCurrentTime():0,duration=this.media.duration>0?this.media.duration:0;this.__elapsed=elapsed,this.__duration=duration,void 0!==this.media.seekable&&this.media.seekable.length>0&&(void 0!==this.media.seekable.start(0)&&(elapsed-=this.media.seekable.start(0)),void 0!==this.media.seekable.end(0)&&(duration=this.media.seekable.end(0)-(void 0!==this.media.seekable.start(0)?this.media.seekable.start(0):0))),this.__status=this._getHHMMSS(elapsed,duration)+"/"+this._getHHMMSS(duration),this.$.controls.setStatus(this.__status)}_showCustomCaptions(isYoutube,audioOnly,hasCaptions,cc){return(isYoutube||audioOnly)&&hasCaptions&&cc}_useYoutubeIframe(thumbnailSrc,isYoutube,__elapsed){return isYoutube&&(null===thumbnailSrc||void 0===__elapsed||0===__elapsed)}_youTubeRequest(){window.A11yMediaYoutube.requestAvailability();let root=this,ytUtil=window.A11yMediaYoutube.instance;if(root.disableSeek=!0,root.__playerAttached&&root.__playerReady){let ytInit=()=>{root.media=ytUtil.initYoutubePlayer({width:"100%",height:"100%",videoId:root.youtubeId}),root.__status=root._getLocal("youTubeLoading","label"),root.$.controls.setStatus(root.__status),root.$.youtube.appendChild(root.media.a),root.__ytAppended=!0,root._updateCustomTracks()},checkApi=e=>{ytUtil.apiReady&&(document.removeEventListener("youtube-api-ready",checkApi),root.__ytAppended||ytInit())};ytUtil.apiReady?root.__ytAppended||ytInit():document.addEventListener("youtube-api-ready",checkApi)}}_updateCustomTracks(){if((this.isYoutube||this.audioOnly)&&this.__tracks){let root=this,track=root.__tracks[this.$.transcript.selectedTranscript],active=[],caption="";if(null!=track&&void 0!==track.cues&&null!==track.cues){for(let i=0;i<track.cues.length;i++)track.cues[i].seek<root.__elapsed&&track.cues[i].seekEnd>root.__elapsed&&(active.push(track.cues[i].order),caption=""===caption?track.cues[i].text:caption);root.$.customcctxt.innerText=caption,root.$.transcript.setActiveCues(active)}}}disconnectedCallback(){window.removeEventListener("es-bridge-screenfullLib-loaded",this._onScreenfullLoaded.bind(this)),super.disconnectedCallback()}}_exports.A11yMediaPlayer=A11yMediaPlayer,window.customElements.define(A11yMediaPlayer.tag,A11yMediaPlayer)});