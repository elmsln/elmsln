define(["exports","../../@polymer/polymer/polymer-element.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/paper-icon-button/paper-icon-button.js","../../@polymer/iron-icons/hardware-icons.js"],function(_exports,_polymerElement,_HAXWiring,_paperIconButton,_hardwareIcons){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.FullScreenImage=void 0;/**
 ...
 */class FullScreenImage extends _polymerElement.PolymerElement{// render function
...
static get properties(){return{title:{name:"title",type:"String",value:"",reflectToAttribute:!1,observer:!1},subtitle:{name:"subtitle",type:"String",value:"",reflectToAttribute:!1,observer:!1},source:{name:"source",type:"String",value:"",reflectToAttribute:!1,observer:!1}}}/**
   ...
   */connectedCallback(){super.connectedCallback();this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(FullScreenImage.haxProperties,FullScreenImage.tag,this);this.$.down.addEventListener("click",e=>{this.nextElementSibling.scrollIntoView({block:"start",inline:"nearest",behavior:"smooth"})})}/**
   * life cycle, element is removed from the DOM
   */disconnectedCallback(){super.disconnectedCallback();this.$.down.removeEventListener("click",e=>{this.nextElementSibling.scrollIntoView({block:"start",inline:"nearest",behavior:"smooth"})})}}_exports.FullScreenImage=FullScreenImage;window.customElements.define(FullScreenImage.tag,FullScreenImage)});