define(["exports", "../../lit-element/lit-element.js", "../h-a-x/h-a-x.js", "../hax-body/lib/hax-store.js"], function (_exports, _litElement, _hAX, _haxStore) {
  "use strict";
  ...
  */
  class AppEditorHax extends _litElement.LitElement {
    ...
    render() {
      return (0, _litElement.html)` <h-a-x .app-store="${this.appStoreConnection}"></h-a-x> `;
    }
    ...
    save() {
      ...
      let content = _haxStore.HAXStore.activeHaxBody.haxToContent(); // fire event so apps can react correctly
