define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxEsm) {
  ...
  class SiteBreadcrumb extends _litElement.LitElement {
    ...
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["../../../../simple-icon/lib/simple-icons.js"], res, rej)); // keep editMode in sync globally
      ...
      (0, _mobxEsm.autorun)(reaction => {
        this._activeItemChanged((0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeItem));
