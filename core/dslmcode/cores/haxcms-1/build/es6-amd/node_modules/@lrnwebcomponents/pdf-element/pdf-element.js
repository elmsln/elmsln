define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/paper-input/paper-input.js","../../@polymer/iron-input/iron-input.js","../../@polymer/paper-icon-button/paper-icon-button.js","../schema-behaviors/schema-behaviors.js","../../pdfjs-dist/build/pdf.js","../../pdfjs-dist/build/pdf.worker.js","./lib/main.js"],function(_exports,_require,_polymerElement,_paperInput,_ironInput,_paperIconButton,_schemaBehaviors,_pdf,_pdfWorker,_main){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.PdfElement=void 0,_require=babelHelpers.interopRequireWildcard(_require);class PdfElement extends((0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement)){constructor(){super(),new Promise((res,rej)=>_require.default(["../../@polymer/paper-card/paper-card.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/app-layout/app-toolbar/app-toolbar.js"],res,rej)),new Promise((res,rej)=>_require.default(["../../@polymer/paper-spinner/paper-spinner.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
          width: 100%;
