...
```
*/class HAXStax extends _haxApp.HAXApp{constructor(){super();this.eventName="hax-register-stax"}static get tag(){return"hax-stax"}}_exports.HAXStax=HAXStax;window.customElements.define(HAXStax.tag,HAXStax)});