define(["exports","require","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/render-status.js"],function(_exports,_require,_polymerElement,_renderStatus){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrndesignGallerycard=void 0;_require=babelHelpers.interopRequireWildcard(_require);/**
`lrndesign-gallerycard`
A LRN element for presenting a gallery of items as cards
that can pop up to display more info
* @demo demo/index.html
*/class LrndesignGallerycard extends _polymerElement.PolymerElement{constructor(){super();new Promise((res,rej)=>_require.default(["../lrndesign-avatar/lrndesign-avatar.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/iron-image/iron-image.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/paper-card/paper-card.js"],res,rej));new Promise((res,rej)=>_require.default(["../../@polymer/iron-icon/iron-icon.js"],res,rej))}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: inline-flex;
        }
    ...
    `}static get tag(){return"lrndesign-gallerycard"}connectedCallback(){super.connectedCallback();(0,_renderStatus.afterNextRender)(this,function(){this.addEventListener("mouseenter",this._mouseEnter.bind(this));this.addEventListener("mouseleave",this._mouseLeave.bind(this))})}disconnectedCallback(){this.removeEventListener("mouseenter",this._mouseEnter.bind(this));this.removeEventListener("mouseleave",this._mouseLeave.bind(this));super.disconnectedCallback()}static get properties(){return{size:{type:String,notify:!0,reflectToAttribute:!0},/**
       ...
       */comments:{type:Number,value:0,reflectToAttribute:!0,notify:!0}}}_mouseEnter(e){this.elevation+=2}_mouseLeave(e){this.elevation-=2}}_exports.LrndesignGallerycard=LrndesignGallerycard;window.customElements.define(LrndesignGallerycard.tag,LrndesignGallerycard)});