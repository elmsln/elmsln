define(["exports","require","../../lit-element/lit-element.js","../simple-colors/simple-colors.js","../utils/utils.js"],(function(_exports,_require,_litElement,_simpleColors,_utils){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HaxBody=void 0,_require=babelHelpers.interopRequireWildcard(_require);var timer=null;const maxStep=25,edgeSize=100;class HaxBody extends _simpleColors.SimpleColors{static get styles(){return[...super.styles,_litElement.css`
        :host,
        :host * ::slotted(*) {
          line-height: 1.8;
        }
      ...
      `]}constructor(){super(),this.___moveLock=!1,this.editMode=!1,this.globalPreferences={},this.haxRayMode=!1,this.activeNode=null,this.activeContainerNode=null,setTimeout(()=>{new Promise((res,rej)=>_require.default(["./lib/hax-text-context.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/hax-ce-context.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/hax-plate-context.js"],res,rej)),new Promise((res,rej)=>_require.default(["./lib/hax-input-mixer.js"],res,rej)),new Promise((res,rej)=>_require.default(["../grid-plate/grid-plate.js"],res,rej)),this.polyfillSafe=window.HaxStore.instance.computePolyfillSafe(),this.addEventListener("hax-context-item-selected",this._haxContextOperation.bind(this)),this.addEventListener("hax-input-mixer-update",this._haxInputMixerOperation.bind(this)),this.addEventListener("place-holder-replace",this.replacePlaceholder.bind(this)),this.addEventListener("focusin",this._focusIn.bind(this)),this.addEventListener("mousedown",this._focusIn.bind(this)),this.addEventListener("mouseover",this._mouseOver.bind(this)),this.addEventListener("drop",this.dropEvent.bind(this))},0)}static get tag(){return"hax-body"}_mouseOver(e){this.openDrawer||!this.editMode||this.__tabTrap||this.positionContextMenus()}render(){return _litElement.html`
