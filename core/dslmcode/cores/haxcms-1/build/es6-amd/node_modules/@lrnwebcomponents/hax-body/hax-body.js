...
setTimeout(()=>{html=(0,_haxutils.encapScript)(html);const validTags=window.HaxStore.instance.validTagList;let fragment=document.createElement("div");fragment.insertAdjacentHTML("beforeend",html);while(null!==fragment.firstChild){if(typeof fragment.firstChild.tagName!==typeof void 0&&validTags.includes(fragment.firstChild.tagName.toLowerCase())){// ensure import doesn't import non-sandbox safe things!
