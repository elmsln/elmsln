  ...
  class HaxBody extends _simpleColors.SimpleColors {
      ...
      if (!this.openDrawer && this.editMode) {
        ...
        try {
          ...
          if (e.dataTransfer && e.dataTransfer.items && e.dataTransfer.items.length > 0 && e.dataTransfer.items[0].kind === "file") {
            ...
            if (target && target.removeAttribute && target !== null && typeof local !== typeof undefined && target !== local && target !== local.parentNode && target.parentNode === this || local.parentNode === this) {
    ...
    dragEnter(e) {
      if (!this.openDrawer && this.editMode && e.target) {
        e.preventDefault();
        e.target.classList.add("hax-hovered"); // perform check for edge of screen
