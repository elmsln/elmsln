define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../utils/utils.js", "../undo-manager/undo-manager.js", "./lib/hax-store.js", "../../mobx/dist/mobx.esm.js"], function (_exports, meta, _require, _litElement, _simpleColors, _utils, _undoManager, _haxStore, _mobxEsm) {
  ...
  class HaxBody extends (0, _undoManager.UndoManagerBehaviors)(_simpleColors.SimpleColors) {
    ...
    positionContextMenus(node = this.activeNode) {
      ...
      clearTimeout(this.__positionContextTimer);
      this.__positionContextTimer = setTimeout(() => {
        if (node && node.tagName && !_haxStore.HAXStore._lockContextPosition && this.__ready) {
    ...
    async _activeNodeChanged(newValue, oldValue) {
      ...
      _haxStore.HAXStore.runHook(oldValue, "activeElementChanged", [oldValue, false]); // attempt new value processing on element changed
      // @see haxHooks activeElementChanged


      _haxStore.HAXStore.runHook(newValue, "activeElementChanged", [newValue, true]); // OLD VALUE TEST
      ...
      if (oldValue) {
        let oldSchema = _haxStore.HAXStore.haxSchemaFromTag(oldValue.tagName.toLowerCase());
      ...
      if (newValue) {
        ...
        if (newSchema && newSchema.editingElement && newSchema.editingElement != "core") {
          ...
          (0, _utils.wrap)(newValue, this.__activeEditingElement); // @see haxHooks activeElementChanged
