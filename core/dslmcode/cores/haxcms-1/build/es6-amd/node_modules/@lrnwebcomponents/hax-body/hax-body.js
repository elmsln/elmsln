      ...
      for (var i = 0, len = children.length; i < len; i++) {
        ...
        if (this._validElementTest(children[i])) {
          ...
          // yet we need to remove from output as they do not really exist :)
              ...
              let tmp = _haxStore.HAXStore.runHook(children[i], "activeChanged", [this.activeNode, false]);
    ...
    async _activeNodeChanged(newValue, oldValue) {
      ...
      if (oldValue) {
        ...
        if (oldSchema.editingElement != "core") {
          ...
          let replacement = _haxStore.HAXStore.runHook(this.__activeEditingElement, "activeChanged", [oldValue, false]);
      ...
      if (newValue) {
        ...
        if (newSchema && newSchema.editingElement && newSchema.editingElement != "core") {
          ...
          (0, _utils.wrap)(newValue, this.__activeEditingElement); // run internal state hook if it exists

          _haxStore.HAXStore.runHook(this.__activeEditingElement, "activeChanged", [newValue, true]);
        }
      }
    }
    /**
