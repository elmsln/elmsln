define(["exports","require","../../lit-element/lit-element.js","../simple-colors/simple-colors.js","../utils/utils.js"],(function(e,t,o,i,a){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.HaxBody=void 0,t=babelHelpers.interopRequireWildcard(t);var n=null;class HaxBody extends i.SimpleColors{static get styles(){return[...super.styles,o.css`
        :host,
        :host * ::slotted(*) {
          line-height: 1.8;
        }
      ...
      `]}constructor(){super(),this.___moveLock=!1,this.editMode=!1,this.globalPreferences={},this.haxRayMode=!1,this.activeNode=null,this.haxSelectedText="",this.activeContainerNode=null,setTimeout(()=>{new Promise((e,o)=>t.default(["./lib/hax-text-context.js"],e,o)),new Promise((e,o)=>t.default(["./lib/hax-ce-context.js"],e,o)),new Promise((e,o)=>t.default(["./lib/hax-plate-context.js"],e,o)),new Promise((e,o)=>t.default(["../grid-plate/grid-plate.js"],e,o)),this.polyfillSafe=window.HaxStore.instance.computePolyfillSafe(),this.addEventListener("hax-context-item-selected",this._haxContextOperation.bind(this)),this.addEventListener("place-holder-replace",this.replacePlaceholder.bind(this)),this.addEventListener("focusin",this._focusIn.bind(this)),this.addEventListener("mousedown",this._focusIn.bind(this)),this.addEventListener("dragenter",this.dragEnterBody.bind(this)),this.addEventListener("drop",this.dropEvent.bind(this))},0)}static get tag(){return"hax-body"}dragEnterBody(e){const t=this.childNodes;for(var o in t)t[o].classList&&t[o]!==this.activeItem&&t[o].classList.add("hax-mover")}render(){return o.html`
