define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/paper-button/paper-button.js", "../../../@polymer/iron-icons/iron-icons.js", "../../materializecss-styles/lib/colors.js", "../../../@polymer/paper-card/paper-card.js", "../../lrnsys-layout/lib/lrnsys-drawer.js", "../../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, _polymerElement, _paperButton, _ironIcons, _colors, _paperCard, _lrnsysDrawer, _ironAjax) {
  ...
  /**
   * `lrn-calendar-date`
   * @customElement lrn-calendar-date
   * `A LRN element`
   *
   * @demo demo/index.html
   *
   */
  class LrnCalendarDate extends _polymerElement.PolymerElement {
    static get template() {
    ...
    timeString(startHour, startMinute, endHour, endMinute) {
    ...
    computeStyle(item) {
      if (item.event.startDate._time.hour == 0) var s = "background-color:" + " yellow";else var s = "background-color:" + " clear";
      return s;
    }
    /*
  ...
  _exports.LrnCalendarDate = LrnCalendarDate;
  window.customElements.define(LrnCalendarDate.tag, LrnCalendarDate);
});