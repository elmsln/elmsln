define(["exports", "require", "../../../lit-element/lit-element.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "../../lrndesign-avatar/lrndesign-avatar.js"], function (_exports, _require, _litElement, _elmslnStudioStyles, _elmslnStudioUtilities, _lrndesignAvatar) {
  ...
  class ElmslnStudioAssignment extends (0, _elmslnStudioUtilities.ElmslnStudioUtilities)((0, _elmslnStudioStyles.ElmslnStudioStyles)(_litElement.LitElement)) {
    ...
    render() {
      return this.assignments && !this.assignment ? this.message404("Assignment", "Assignments", "/assignments") : (0, _litElement.html)`
            ...
            <article id="assignment">
              <h1>
                <span class="lesson-name">
                  ${!this.assignment ? (0, _litElement.html)`<em>Lesson</em>` : this.assignment.lesson}
                </span>
                <span class="assignment-name">
                  ${!this.assignment ? (0, _litElement.html)`<em>Assignment</em>` : this.assignment.assignment}
                </span>
              </h1>
              ${!(this.assignment || {}).date ? "" : (0, _litElement.html)`
    ...
    firstUpdated(changedProperties) {
      ...
      new Promise((res, rej) => _require.default(["../../rich-text-editor/rich-text-editor.js"], res, rej));
      new Promise((res, rej) => _require.default(["../../rich-text-editor/lib/toolbars/rich-text-editor-toolbar-full.js"], res, rej));
    ...
    updated(changedProperties) {
      ...
      changedProperties.forEach((oldValue, propName) => {
        if (propName == "submission") {
          this.__links = this.submission && this.submission.links ? this.submission.links : [];
          this.__sources = this.submission && this.submission.sources ? this.submission.sources : [];
        }
      });
    }

    get actions() {
      return !this.editable ? (0, _litElement.html)`` : (0, _litElement.html)`
          <section id="actions">
    ...
    get alert() {
      let getAlert = (message, date, icon = true) => {
        return (0, _litElement.html)` <p
            id="alert"
            class="${this.assignmentStatus.toLowerCase().replace(/\s/, "-")}"
          >
            ${!icon ? "" : (0, _litElement.html)`
                  <iron-icon
                    id="alert-avatar"
    ...
    get bodytext() {
      ...
      return !this.assignment || bodyEmpty ? "" : (0, _litElement.html)`
          <section id="text">
            <h2 class="sr-only">Text</h2>
            ${!this.editable ? body : (0, _litElement.html)`
                  ...
                  >
                    ${body || (0, _litElement.html)`<p>Add text</p>`}
                  </rich-text-editor>
                `}
          </section>
        `;
    ...
    get links() {
      ...
      return !this.assignment || linksEmpty ? "" : (0, _litElement.html)`
          <section id="links">
            <h2 class="sr-only">Links</h2>
            <ul id="linklist">
              ${(this.__links || []).map((link, i) => (0, _litElement.html)`
                  <li>
                    <a id="link-${i}" href="link.url" class="link ${link.type}">
                      ${link.text} (${link.url})
                    </a>
                    ${!this.editable ? "" : (0, _litElement.html)`
                          <button
              ...
              ${!this.editable ? `` : (0, _litElement.html)`
                    <li>
                      ...
                      <input
                        id="linktext"
                        @change="${e => this.__newLinkText = this._getFieldVal("linktext")}"
                      ...
                      <input
                        id="linkurl"
                        @change="${e => this.__newLinkUrl = this._getFieldVal("linkurl")}"
                        placeholder="url"
                        required
                        type="url"
                      />
    ...
    get nav() {
      let prevLabel = (this.prevAssign || {}).assignment || "",
          ...
          prevHref = (this.prevAssign || {}).id ? `./${this.prevAssign.id}` : undefined,
          nextHref = (this.nextAssign || {}).id ? `./${this.nextAssign.id}` : undefined;
    ...
    get sources() {
      ...
      return !this.assignment || sourcesEmpty ? "" : (0, _litElement.html)`
          <section id="uploads">
            <h2 class="sr-only">Uploads</h2>
            <ul id="uploadlist">
              ${(this.__sources || []).map((source, i) => (0, _litElement.html)`
                  <li
                    id="source-${i}"
                    style="background-image: url(${source.src})"
                  >
                    ${!this.editable ? `` : (0, _litElement.html)` <button
                          aria-controls="source-${i}"
                          class="delete-upload"
                ...
                `)}
              ${!this.editable ? (0, _litElement.html)`<div></div>` : (0, _litElement.html)`
                    <li>
                      <vaadin-upload
                        id="add-upload"
    ...
    _getFieldVal(id) {
      return this.shadowRoot && this.shadowRoot.querySelector(`#${id}`) ? this.shadowRoot.querySelector(`#${id}`).value : undefined;
    }
    ...
    _setFieldVal(id, val) {
      if (this.shadowRoot && this.shadowRoot.querySelector(`#${id}`)) this.shadowRoot.querySelector(`#${id}`).value = "";
    }
