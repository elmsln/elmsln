define(["exports","../../@polymer/polymer/polymer-element.js","./lib/shadows-safari.js","../../@polymer/iron-a11y-keys/iron-a11y-keys.js","../../@polymer/iron-icon/iron-icon.js","../../@polymer/iron-icons/iron-icons.js","../../@polymer/iron-icons/editor-icons.js","../json-outline-schema/json-outline-schema.js"],function(_exports,_polymerElement,_shadowsSafari,_ironA11yKeys,_ironIcon,_ironIcons,_editorIcons,_jsonOutlineSchema){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.EditableOutline=void 0;/**
 ...
 */class EditableOutline extends _polymerElement.PolymerElement{// render function
...
static get properties(){let props={/**
       ...
       */__outlineNode:{name:"__outlineNode",type:Object}};if(super.properties){props=Object.assign(props,super.properties)}return props}constructor(){super();this.polyfillSafe=this.__computePolyfillSafe();window.JSONOutlineSchema.requestAvailability()}/**
...
return window.getSelection()}/**
   ...
   * This
   */__computePolyfillSafe(){if(document.head.createShadowRoot||document.head.attachShadow){return!0}else{console.log("Shadow DOM missing, certain operations hidden");return!1}}}_exports.EditableOutline=EditableOutline;window.customElements.define(EditableOutline.tag,EditableOutline)});