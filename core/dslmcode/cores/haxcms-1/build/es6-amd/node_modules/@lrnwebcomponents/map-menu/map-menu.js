define(["exports","../../lit-element/lit-element.js","./lib/map-menu-builder.js","./lib/map-menu-container.js"],(function(_exports,_litElement,_mapMenuBuilder,_mapMenuContainer){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.MapMenu=void 0;
/**
...
class MapMenu extends _litElement.LitElement{static get styles(){return[_litElement.css`
      ...
      `]}constructor(){super(),this.disabled=!1,this.title="Content outline",this.data=null,this.items=[],this.autoScroll=!1,this.activeIndicator=!1,setTimeout(()=>{this.addEventListener("link-clicked",this.__linkClickedHandler.bind(this)),this.addEventListener("toggle-updated",this.__toggleUpdated.bind(this)),this.addEventListener("active-item",this.__activeItemHandler.bind(this)),this.addEventListener("map-meu-item-hidden-check",this._mapMeuItemHiddenCheckHandler.bind(this))},0)}render(){return _litElement.html`
      <div id="itemslist">
        <map-menu-container>
