define(["exports","../../lit-element/lit-element.js","../simple-colors/simple-colors.js"],(function(_exports,_litElement,_simpleColors){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.AccentCard=void 0;
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class AccentCard extends _simpleColors.SimpleColors{static get tag(){return"accent-card"}static get styles(){return[...super.styles,_litElement.css`
        :host {
          display: block;
          border-radius: 2px;
          margin: 0 0 15px;
