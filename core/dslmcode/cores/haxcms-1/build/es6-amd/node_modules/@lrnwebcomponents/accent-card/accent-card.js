define(["exports","../../@polymer/polymer/polymer-element.js","../hax-body-behaviors/lib/HAXWiring.js","../schema-behaviors/schema-behaviors.js","../simple-colors/simple-colors.js"],function(_exports,_polymerElement,_HAXWiring,_schemaBehaviors,_simpleColors){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.AccentCard=void 0;class AccentCard extends _simpleColors.SimpleColors{static get tag(){return"accent-card"}static get template(){return _polymerElement.html`
      <style>
        :host {
          display: block;
          border-radius: 2px;
