define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../intersection-element/lib/IntersectionObserverMixin.js"], function (_exports, _litElement, _simpleColors, _IntersectionObserverMixin) {
   ...
   */
  class AccentCard extends (0, _IntersectionObserverMixin.IntersectionObserverMixin)(_simpleColors.SimpleColors) {
    /**
    ...
    render() {
      ...
      <article id="card">
        <div class="image-outer" ?hidden="${!this.imageSrc}">
          <div
            class="image"
            .style="${this.elementVisible && this.imageSrc ? `background-image: url(${this.imageSrc});` : `display: none;`}"
          ></div>
        </div>
        <div class="body">
          <div id="heading">
