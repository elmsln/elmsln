      ...
      this.__valueDebounce = setTimeout(() => {
        ...
        if (haxcore) {
          ...
          if (haxcore.providers["haxcore-providers-cdn"] == "other") {
            this.wcRegistryEndpoint = haxcore.providers["haxcore-providers-other"] + "wc-registry.json";
          } else {
            this.wcRegistryEndpoint = haxcore.providers["haxcore-providers-cdn"] + "wc-registry.json";
          } // apply filters
