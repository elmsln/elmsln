    ...
    return class extends SuperClass {
      ...
      connectedCallback() {
        ...
        (0, _mobxEsm.autorun)(reaction => {
          this.activeItemContent = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeItemContent);
          setTimeout(() => {
            if (this.HAXCMSThemeSettings.autoScroll) {
              this.HAXCMSThemeSettings.scrollTarget.scrollTo({
                top: 0,
        ...
        (0, _mobxEsm.autorun)(reaction => {
          this.isLoggedIn = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.isLoggedIn);

          this.__disposer.push(reaction);
        }); // store disposer so we can clean up later

        (0, _mobxEsm.autorun)(reaction => {
          const __manifest = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.manifest);
        ...
        (0, _mobxEsm.autorun)(reaction => {
          this._location = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.location);
