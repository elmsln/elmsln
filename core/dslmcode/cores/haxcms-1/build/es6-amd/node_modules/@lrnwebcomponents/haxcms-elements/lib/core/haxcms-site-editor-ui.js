define(["exports", "require", "../../../../lit-element/lit-element.js", "./haxcms-site-store.js", "../../../utils/utils.js", "../../../../mobx/lib/mobx.module.js", "../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _utils, _mobxModule, _customStyle) {
  ...
  class HAXCMSSiteEditorUI extends _litElement.LitElement {
    ...
    constructor() {
      ...
      this.editMode = false;
      this.manifestEditMode = false; // this ensures that an initial paint won't get a cached copy of the site.json file
    ...
    firstUpdated(changedProperties) {
      ...
      new Promise((res, rej) => _require.default(["../../../paper-avatar/paper-avatar.js"], res, rej)); // load user data
