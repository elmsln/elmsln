define(["exports", "require", "../../../../lit-element/lit-element.js", "./haxcms-site-store.js", "../../../../mobx/dist/mobx.esm.js", "../../../simple-icon/simple-icon.js", "../../../simple-icon/lib/simple-icons.js", "../../../simple-icon/lib/simple-icon-button.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxEsm, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  class HAXCMSSiteEditorUI extends _litElement.LitElement {
    ...
    constructor() {
      ...
      setTimeout(() => {
        // prettier-ignore
        new Promise((res, rej) => _require.default(["./haxcms-outline-editor-dialog.js"], res, rej)); // prettier-ignore
    ...
    connectedCallback() {
      ...
      (0, _mobxEsm.autorun)(reaction => {
        if (_haxcmsSiteStore.store.userData) {
          this.userName = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.userData.userName);
          this.userPicture = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.userData.userPicture);
        }
      ...
      (0, _mobxEsm.autorun)(reaction => {
        this.manifest = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.manifest);
        this.icon = "hax:site-settings";
      ...
      (0, _mobxEsm.autorun)(reaction => {
        const activeItem = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeItem);
