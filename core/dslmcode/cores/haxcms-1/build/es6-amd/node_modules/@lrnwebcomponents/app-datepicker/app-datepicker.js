define(["exports","../../@polymer/polymer/polymer-legacy.js","../../@polymer/polymer/lib/legacy/polymer.dom.js","../../@polymer/polymer/lib/utils/flattened-nodes-observer.js","../../@polymer/polymer/lib/utils/async.js","../../@polymer/iron-selector/iron-selector.js","../../@polymer/iron-list/iron-list.js","../../@polymer/paper-icon-button/paper-icon-button.js","../../@polymer/neon-animation/neon-animation-runner-behavior.js","../../@polymer/neon-animation/neon-animated-pages.js","./lib/app-datepicker-icons.js","./lib/app-datepicker-animations.js"],function(_exports,_polymerLegacy,_polymerDom,_flattenedNodesObserver,async,_ironSelector,_ironList,_paperIconButton,_neonAnimationRunnerBehavior,_neonAnimatedPages,_appDatepickerIcons,_appDatepickerAnimations){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.AppDatepicker=void 0,async=babelHelpers.interopRequireWildcard(async);let AppDatepicker=(0,_polymerLegacy.Polymer)({_template:_polymerLegacy.html`
  ...
  `,is:"app-datepicker",behaviors:[_neonAnimationRunnerBehavior.NeonAnimationRunnerBehavior],properties:{locale:{type:String,value:function(){return window.Intl&&window.Intl&&window.Intl.DateTimeFormat&&window.Intl.DateTimeFormat().resolvedOptions&&window.Intl.DateTimeFormat().resolvedOptions().locale||"en-US"}},view:String,theme:String,firstDayOfWeek:{type:Number,value:0},disableDays:{type:Array,value:function(){return[6,0]}},disableDates:{type:Array,value:function(){return[]}},minDate:{type:String,value:"1000/00/01"},maxDate:{type:String,value:"9999/99/99"},format:{type:String,value:"yyyy/mm/dd"},date:{type:String,notify:!0,readOnly:!0},inputDate:String,noAnimation:Boolean,pageEntryAnimation:String,pageExitAnimation:String,showLongDate:{type:Boolean,value:!1},invalidDate:{type:Boolean,notify:!0,readOnly:!0},autoUpdateDate:{type:Boolean,value:!1},alwaysResetSelectedDateOnDialogClose:Boolean,_monthNames:{type:Array,value:function(){return["January","February","March","April","May","June","July","August","September","October","November","December"]}},_shiftedDisableDays:{type:Array,value:[6,0]},_activeMonthYear:String,_shortSelectedDate:String,_showSelectedYear:String,_daysOfWeek:Array,_daysOfMonth:Array,_listOfYears:Array,_activeView:{type:String,value:"calendar"},_activeYear:{type:Number,value:function(){return(new Date).getFullYear()}},_activeMonth:{type:Number,value:function(){return(new Date).getMonth()}},_isIncrementMonth:Boolean,_isDecrementMonth:Boolean,_selectedYear:{type:Number,value:function(){return(new Date).getFullYear()}},_selectedMonth:{type:Number,value:function(){return(new Date).getMonth()}},_selectedDate:{type:Number,value:function(){return(new Date).getDate()}},_chosenDaysOfMonth:{type:Number,value:function(){return(new Date).getDate()}},_isListRendered:{type:Boolean,value:!1},_isSelectedDateConfirmed:Boolean,_format:{type:Object,value:function(){return{y:"yyyy",m:"mm",d:"dd",s1:"/",s2:"/"}}}},observers:["_computeDaysOfMonth(_activeYear, _activeMonth, firstDayOfWeek, locale)","_computeSeparateFormat(format)","_computeShowLongDate(showLongDate, locale)","_updateToReflectExternalChange(inputDate)","_updateThemeColor(theme)","_updateDatepickerView(view)","_computeDaysOfWeek(firstDayOfWeek, locale)","_computeActiveMonthYear(_activeYear, _activeMonth, locale)","_computeShortSelectedDate(_selectedYear, _selectedMonth, _selectedDate, locale)","_computeShowSelectedYear(_selectedYear, locale)","_computeShiftedDisableDays(firstDayOfWeek, disableDays.*)"],attached:function(){this.noAnimation||(this.set("animationConfig",{incrementEntry:[{name:"slide-from-right-animation",node:this.$.daysOfWeek},{name:"slide-from-right-animation",node:this.$.daysOfMonth},{name:"datepicker-slide-from-right-animation",node:this.$.navMonthYear}],decrementEntry:[{name:"slide-from-left-animation",node:this.$.daysOfWeek},{name:"slide-from-left-animation",node:this.$.daysOfMonth},{name:"datepicker-slide-from-left-animation",node:this.$.navMonthYear}]}),this.set("pageEntryAnimation","fade-in-animation"),this.set("pageExitAnimation","fade-out-animation"));let effectiveChildren=_flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(this).filter(n=>n.nodeType===Node.ELEMENT_NODE);if(effectiveChildren&&effectiveChildren.length>0){for(var i=0;i<effectiveChildren.length;i++)effectiveChildren[i].hasAttribute("dialog-confirm")&&(effectiveChildren[i].addEventListener("tap",this._updateBindDate.bind(this)),effectiveChildren[i].addEventListener("transitionend",this._updateBindDate.bind(this))),this._updateDistributedButtonInkColorCustomProp(effectiveChildren[i],"#737373");this.$.dp.classList.add("with-buttons")}else this.$.dp.classList.remove("with-buttons");this.fire("app-datepicker-attached")},_computeDaysOfMonth:function(_activeYear,_activeMonth,_firstDayOfWeek,_locale){if(window.Intl){var _start=new Date(_activeYear,_activeMonth,1).getDay(),_daysOfMonth=[],_totalDays=function _computeTotalDaysOfMonth(_year,_month){return new Date(_year,_month+1,0).getDate()}(_activeYear,_activeMonth);_firstDayOfWeek>0&&_firstDayOfWeek<7&&(_start=(_start-=_firstDayOfWeek)<0?7+_start:_start),_locale=_locale||window.Intl&&window.Intl.DateTimeFormat&&window.Intl.DateTimeFormat().resolvedOptions&&window.Intl.DateTimeFormat().resolvedOptions().locale||"en-US";for(var _formatter=window.Intl&&window.Intl.DateTimeFormat?new window.Intl.DateTimeFormat(_locale,{timeZone:"UTC",day:"numeric"}).format:function dateTimeFormatShim(date){return date.getDate()},i=0,j=1-_start;i<42;i++,j++){var _formatted=_formatter(Date.UTC(_activeYear,_activeMonth,j)),_dateObj={date:"",index:""};i>=_start&i<_start+_totalDays&&(_dateObj.date=_formatted,_dateObj.index=j),_daysOfMonth.push(_dateObj)}this.set("_chosenDaysOfMonth",this._computeChosenDaysOfMonth(_daysOfMonth,this._selectedDate)),this.set("_daysOfMonth",_daysOfMonth)}},_computeShiftedDisableDays:function(_firstDayOfWeek,_isDisableDays){_firstDayOfWeek=_firstDayOfWeek>0&&_firstDayOfWeek<7?_firstDayOfWeek:0;var _sdd=this.disableDays.map(function(_day){return(_day-=_firstDayOfWeek)<0?7+_day:_day});this.set("_shiftedDisableDays",_sdd)},_incrementMonth:function(ev){this.debounce("_incrementMonth",function(){this.set("_isIncrementMonth",!0),window.requestAnimationFrame(function(){var _month=this._activeMonth;++_month%12==0&&this._activeYear++,this.set("_activeMonth",_month%12),this.noAnimation||(this.cancelAnimation(),this.playAnimation("incrementEntry")),this.set("_isIncrementMonth",!1)}.bind(this))},100)},_decrementMonth:function(ev){this.debounce("_decrementMonth",function(){this.set("_isDecrementMonth",!0),window.requestAnimationFrame(function(){var _month=this._activeMonth;--_month<0&&(this._activeYear--,_month=11),this.set("_activeMonth",_month),this.noAnimation||(this.cancelAnimation(),this.playAnimation("decrementEntry")),this.set("_isDecrementMonth",!1)}.bind(this))},100)},_computeActiveMonthYear:function(_activeYear,_activeMonth,_locale){if(window.Intl){_locale=_locale||window.Intl&&window.Intl.DateTimeFormat&&window.Intl.DateTimeFormat().resolvedOptions&&window.Intl.DateTimeFormat().resolvedOptions().locale||"en-US";var _amy=new window.Intl.DateTimeFormat(_locale,{timeZone:"UTC",month:"short",year:"numeric"}).format(Date.UTC(_activeYear,_activeMonth,1));this.set("_activeMonthYear",_amy)}},_computeShortSelectedDate:function(_selectedYear,_selectedMonth,_selectedDate,_locale){if(window.Intl){_locale=_locale||window.Intl&&window.Intl.DateTimeFormat&&window.Intl.DateTimeFormat().resolvedOptions&&window.Intl.DateTimeFormat().resolvedOptions().locale||"en-US";var _ssd=new window.Intl.DateTimeFormat(_locale,{timeZone:"UTC",weekday:"short",month:"short",day:"numeric"}).format(Date.UTC(_selectedYear,_selectedMonth,_selectedDate));this.set("_shortSelectedDate",_ssd),this.autoUpdateDate&&this.enforceDateChange()}},_computeShowSelectedYear:function(_selectedYear,_locale){if(window.Intl){_locale=_locale||window.Intl&&window.Intl.DateTimeFormat&&window.Intl.DateTimeFormat().resolvedOptions&&window.Intl.DateTimeFormat().resolvedOptions().locale||"en-US";var _ssy=new window.Intl.DateTimeFormat(_locale,{timeZone:"UTC",year:"numeric"}).format(Date.UTC(_selectedYear,0,1));this.set("_showSelectedYear",_ssy)}},_chooseDaysOfMonth:function(ev){var _target=ev.target;_target&&this._isNumber(_target.date)&&!_target.classList.contains("is-disabled-day")&&(this.set("_chosenDaysOfMonth",_target.index),this.set("_selectedYear",this._activeYear),this.set("_selectedDate",_target.date),this.set("_selectedMonth",this._activeMonth))},_isToday:function(_item,_activeYear,_activeMonth){var _now=new Date;return _item===_now.getDate()&&_activeYear===_now.getFullYear()&&_activeMonth===_now.getMonth()?" is-today":""},_isEmptyDate:function(_item){return this._isNumber(_item)?"":" is-non-selectable"},_isChosenDaysOfMonth:function(_item,_selectedYear,_selectedMonth,_selectedDate){return this._chosenDaysOfMonth>=0&&this._activeYear===_selectedYear&&this._activeMonth===_selectedMonth&&_item===_selectedDate?" chosen-days-of-month":""},_isDisableDays:function(_index,_firstDayOfWeek,_minDate,_maxDate,_item){var _isLessThanMinDate=!1,_isMoreThanMaxDate=!1,_isDisableDates=!1,_isDisableDays=this._shiftedDisableDays.some(function(_n){return _n===_index%7});if(this._isNumber(_item)){var _minDateObj=this._convertDateStringToDateObject(_minDate),_maxDateObj=this._convertDateStringToDateObject(_maxDate),_currentDate=new Date(this._activeYear,this._activeMonth,_item);_minDateObj&&(_isLessThanMinDate=_currentDate.getTime()<_minDateObj.getTime()),_maxDateObj&&(_isMoreThanMaxDate=_currentDate.getTime()>_maxDateObj.getTime()),_isDisableDates=this.disableDates&&this.disableDates.length&&this.disableDates.some(function(date){var _dateObj=this._convertDateStringToDateObject(date);return _dateObj&&_currentDate.getTime()===_dateObj.getTime()}.bind(this))}return _isDisableDays||_isDisableDates||_isLessThanMinDate||_isMoreThanMaxDate?" is-disabled-day is-non-selectable":""},_isListOfYearsSelected:function(selectedYear,year){return+selectedYear==+year?" is-selected":""},_computeDaysOfWeek:function(_firstDayOfWeek,_locale){var _dow=["S","M","T","W","T","F","S"];_firstDayOfWeek=_firstDayOfWeek>0&&_firstDayOfWeek<7?_firstDayOfWeek:0;if(_locale&&window.Intl){_dow=[];for(var _today=new Date,_offsetDate=_today.getDate()-_today.getDay(),_formatter=new window.Intl.DateTimeFormat(_locale,{timeZone:"UTC",weekday:"narrow"}).format,newDate=null,i=0;i<7;i++)newDate=Date.UTC(_today.getFullYear(),_today.getMonth(),_offsetDate+i),_dow.push(_formatter(newDate))}var _sliced=_dow.slice(_firstDayOfWeek),_rest=_dow.slice(0,_firstDayOfWeek),_concatted=Array.prototype.concat(_sliced,_rest);this.set("_daysOfWeek",_concatted)},_computeChosenDaysOfMonth:function(_daysOfMonth,_selectedDate){for(var _len=_daysOfMonth.length,i=0;i<_len;i++)if(i>=0&&_daysOfMonth[i].index===_selectedDate)return i},_convertDateStringToDateObject:function(_date){var _checkDate=_date instanceof Date||"string"!=typeof _date?_date:new Date(_date);return"Invalid Date"!==_checkDate.toDateString()?_checkDate:null},_updateList:function(_activeView){for(var _newList=[],i=1900;i<=2100;i++)_newList.push({year:i});this.set("_listOfYears",_newList)},_onAnimationFinish:function(ev){var _target=ev.detail;if(_target&&"IRON-LIST"===_target.toPage.tagName){var _focusableItem=this._updateListScroller(_target.toPage);async.microTask.run(()=>{_target.toPage._focusPhysicalItem(_focusableItem)})}else async.microTask.run(()=>{this.$.showSelectedYear.focus()})},_updateListScroller:function(_list){var _slh=(0,_polymerDom.dom)(_list.root).querySelector("#items").getBoundingClientRect().height||12863.994140625,_sli=Math.floor(_slh/201*(this._activeYear-1900-2))+1;return!this.$.dp.classList.contains("with-buttons")&&window.matchMedia("(orientation: landscape)").matches&&(_sli=Math.floor(_slh/201*(this._activeYear-1900-1))+1),async.microTask.run(()=>{_list.scroll(0,_sli),_list.selectItem(this._activeYear-1900)}),this._activeYear-1900},_onIronSelectorSelectedChanged:function(ev){"year"===ev.detail.value&&(this._isListRendered?this.noAnimation&&this._updateListScroller(this.shadowRoot.querySelector("#listOfYears")):(this._updateList(),this.set("_isListRendered",!0)))},_onListRendered:function(ev){ev.target.if&&this.noAnimation&&async.microTask.run(()=>{this._updateListScroller(this.shadowRoot.querySelector("#listOfYears"))})},_goCalendar:function(ev){if("keydown"!==ev.type||13===ev.keyCode){var _selectedYear=ev.model.item.year;this.set("_activeYear",_selectedYear),this.set("_selectedYear",_selectedYear),this.shadowRoot.querySelector("#listOfYears").selectItem(_selectedYear-1900),this.set("_activeView","calendar")}},_computeSeparateFormat:function(_format){var m=/^(yyyy|yy|m{1,4}|d{1,2}|do)\W+(yyyy|yy|m{1,4}|d{1,2}|do)\W+(yyyy|yy|m{1,4}|d{1,2}|do)$/g.exec(_format),_temp={},_tempArr=[];if(null!==m){_tempArr.push(m[1]),_tempArr.push(m[2]),_tempArr.push(m[3]);for(var matched,i=0;i<3;i++)(matched=_tempArr[i]).indexOf("y")>=0?_temp.y=matched:matched.indexOf("m")>=0?_temp.m=matched:matched.indexOf("d")>=0&&(_temp.d=matched)}"d"in _temp&&"m"in _temp&&"y"in _temp&&this.set("_format",_temp),_temp=null},_bindSelectedFulldate:function(_selectedYear,_selectedMonth,_selectedDate,_format){if(this.showLongDate)return this._computeShowLongDate(this.showLongDate,this.locale,!0);var _formattedYear=_selectedYear,_formattedMonth=this._monthNames[_selectedMonth],_formattedDate=_selectedDate,_finalFormatted=this.format;if("yy"===_format.y&&(_formattedYear=_selectedYear%100),"mmm"===_format.m?_formattedMonth=_formattedMonth.slice(0,3):"mm"===_format.m?_formattedMonth=this._padStart(_selectedMonth+1,2,"0"):"m"===_format.m&&(_formattedMonth=_selectedMonth+1),"do"===_format.d){var _cardinalNumber=_formattedDate%10,_suffixOrdinal=_cardinalNumber>3?"th":["th","st","nd","rd"][_cardinalNumber];11!==_formattedDate&&12!=_formattedDate&&13!==_formattedDate||(_suffixOrdinal="th"),_formattedDate+=_suffixOrdinal}else"dd"===_format.d&&(_formattedDate=this._padStart(_formattedDate,2,"0"));return _finalFormatted=(_finalFormatted=(_finalFormatted=_finalFormatted.replace(_format.y,_formattedYear)).replace(_format.m,_formattedMonth)).replace(_format.d,_formattedDate)},_updateBindDate:function(ev){this.debounce("_updateBindDate",function(){var _type=ev.type;if("tap"===_type&&this.set("_isSelectedDateConfirmed",!0),("transitionend"===_type||this.noAnimation)&&this._isSelectedDateConfirmed){var _sy=this._selectedYear,_sm=this._selectedMonth,_sd=this._selectedDate,_f=this._format,_confirmDate=this._bindSelectedFulldate(_sy,_sm,_sd,_f);this._setDate(_confirmDate),this.set("_isSelectedDateConfirmed",!1),this.alwaysResetSelectedDateOnDialogClose&&this.resetDate()}},1)},_computeShowLongDate:function(_showLongDate,_locale,_returnResult){if(window.Intl&&this._selectedDate&&void 0!==this._selectedDate){var _selectedDate=this._selectedDate,_longDate=Date.UTC(this._selectedYear,this._selectedMonth,_selectedDate);if(_showLongDate){_locale=_locale||window.Intl&&window.Intl.DateTimeFormat&&window.Intl.DateTimeFormat().resolvedOptions&&window.Intl.DateTimeFormat().resolvedOptions().locale||"en-US";var _options={timeZone:"UTC",weekday:this.showLongDate?"short":void 0,year:"numeric",month:this.showLongDate?"short":"2-digit",day:"2-digit"};if(_longDate=new window.Intl.DateTimeFormat(_locale,_options).format(_longDate),_returnResult)return _longDate;window.navigator.msManipulationViewsEnabled&&(_locale||""===_locale)&&(_longDate=decodeURIComponent(encodeURIComponent(_longDate).replace(/\%E2\%80\%8[0-9A-F]/gi,""))),this._setDate(_longDate)}else{if(_longDate=this._bindSelectedFulldate(this._selectedYear,this._selectedMonth,_selectedDate,this._format),_returnResult)return _longDate;this._setDate(_longDate)}}},_updateToReflectExternalChange:function(_inputDate){if(this.showLongDate&&this.locale.indexOf("en")<0)this._setInvalidDate(!0);else{var _showLongDate=this.showLongDate,_yy=0,_mm=0,_isValidDate=function validateDate(_id,_showLongDate){var _res={valid:!1,result:""};if(_showLongDate){var _ds=_id.split(", ");if(_ds.length>2){_ds=_ds[1].split(" ").join("/")+", "+_ds[2];var _newDate=new Date(_ds);return"Invalid Date"===_newDate.toString()?_res:{valid:!0,result:_newDate}}return _res}var _validWithRe1=/^(\d{4})\W+(\d{1,2})\W+(\d{1,2})$/i.exec(_id),_validWithRe2=/^(\d{4})[ ](\w+)[ ](\d{1,2})$/i.exec(_id);if(null===_validWithRe1&&null===_validWithRe2)return _res;var _resultToDate=null;return null===_validWithRe1?_resultToDate=new Date(_validWithRe2[1]+" "+_validWithRe2[2]+" "+_validWithRe2[3]):null===_validWithRe2&&(_resultToDate=new Date(+_validWithRe1[1],+_validWithRe1[2]-1,+_validWithRe1[3])),{valid:!0,result:_resultToDate}}(_inputDate,_showLongDate);if(_isValidDate.valid){if(this.alwaysResetSelectedDateOnDialogClose)return;var _vd=new Date(_isValidDate.result);_yy=_vd.getFullYear(),_mm=_vd.getMonth();this._setInvalidDate(!1),this.set("_activeYear",_yy),this.set("_activeMonth",_mm),this.set("_selectedYear",_yy),this.set("_selectedMonth",_mm),this.set("_selectedDate",_vd.getDate())}else this.set("_selectedDate",this._selectedDate||(new Date).getDate()),this._computeShowLongDate(_showLongDate,this.locale),this._setInvalidDate(!0)}},enforceDateChange:function(){this._setInvalidDate(!1),this._computeShowLongDate(this.showLongDate,this.locale)},resetDate:function(){if(!this._isSelectedDateConfirmed){var now=new Date,nowFy=now.getFullYear(),nowM=now.getMonth(),nowD=now.getDate();this.set("_activeYear",nowFy),this.set("_activeMonth",nowM),this.set("_selectedYear",nowFy),this.set("_selectedMonth",nowM),this.set("_selectedDate",nowD),this._setInvalidDate(!1)}},_shouldTabIndex:function(_index,_firstDayOfWeek,_minDate,_maxDate,_item){var _isDisableDays=this._isDisableDays(_index,_firstDayOfWeek,_minDate,_maxDate,_item);return _item&&_item>=0&&!_isDisableDays?0:-1},_shouldAriaDisabled:function(_index,_firstDayOfWeek,_minDate,_maxDate,_item){var _isDisableDays=this._isDisableDays(_index,_firstDayOfWeek,_minDate,_maxDate,_item);return!(_item&&_item>=0&&!_isDisableDays)},_padStart:function(_string,_length,_chars){return(_chars+_string).slice(-_length)},_isNumber:function(_value){return"number"==typeof _value||!isNaN(parseFloat(_value))&&isFinite(_value)},_updateThemeColor:function(_theme){var _themes=["dark-theme","light-theme","goog-theme"],_themeIdx=_themes.indexOf(_theme),_distributedButtons=(0,_polymerDom.dom)(this).querySelectorAll("paper-button"),_distributedButtonsLen=_distributedButtons.length,_colorCode=["#bcbcbc","#737373","#616161"][_themeIdx];_themeIdx>=0?(_themes.splice(_themeIdx,1),this.toggleClass(_themes[0],!1,this),this.toggleClass(_themes[1],!1,this),this.toggleClass(_theme,!0,this)):(this.toggleClass("dark-theme",!1,this),this.toggleClass("light-theme",!1,this),this.toggleClass("goog-theme",!1,this));for(var i=0;i<_distributedButtonsLen;i++)this._updateDistributedButtonInkColorCustomProp(_distributedButtons[i],_colorCode||"#737373");this.updateStyles()},_updateDatepickerView:function(_view){this.toggleClass("horizontal-view","horizontal"===_view,this),this.toggleClass("vertical-view","vertical"===_view,this)},_updateDistributedButtonInkColorCustomProp:function(_node,_colorCode){this.updateStyles({"--paper-button-ink-color":_colorCode})}});_exports.AppDatepicker=AppDatepicker});