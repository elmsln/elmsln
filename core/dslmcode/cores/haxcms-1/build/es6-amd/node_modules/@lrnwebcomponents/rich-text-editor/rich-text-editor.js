define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/iron-a11y-keys/iron-a11y-keys.js","./lib/rich-text-editor-styles.js","./lib/toolbars/rich-text-editor-toolbar.js","./lib/toolbars/rich-text-editor-toolbar-mini.js","./lib/toolbars/rich-text-editor-toolbar-full.js"],(function(_exports,_polymerElement,_ironA11yKeys,_richTextEditorStyles,_richTextEditorToolbar,_richTextEditorToolbarMini,_richTextEditorToolbarFull){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.RichTextEditor=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class RichTextEditor extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        :host([hidden]) {
          display: none;
        }
