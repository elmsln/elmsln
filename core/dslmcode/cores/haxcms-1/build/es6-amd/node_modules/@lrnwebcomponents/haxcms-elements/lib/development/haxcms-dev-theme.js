define(["exports", "require", "../../../../@polymer/polymer/polymer-element.js", "../core/HAXCMSPolymerElementTheme.js", "../../../simple-colors/lib/simple-colors-polymer.js", "../../../../@polymer/iron-list/iron-list.js"], function (_exports, _require, _polymerElement, _HAXCMSPolymerElementTheme, _simpleColorsPolymer, _ironList) {
  ...
  class HAXCMSDevTheme extends _HAXCMSPolymerElementTheme.HAXCMSPolymerElementTheme {
    ...
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["../../../simple-tooltip/simple-tooltip.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../ui-components/active-item/site-active-title.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../ui-components/blocks/site-children-block.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../ui-components/navigation/site-breadcrumb.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../ui-components/navigation/site-menu.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../ui-components/navigation/site-menu-button.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../ui-components/navigation/site-top-menu.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../ui-components/query/site-query.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../ui-components/query/site-render-query.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../ui-components/query/site-query-menu-slice.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../ui-components/site/site-rss-button.js"], res, rej)); // prettier-ignore
