 ...
 * @customElement
 * @polymer
 */class RichTextEditorBreadcrumb extends _polymerElement.PolymerElement{// render function
...
static get properties(){return{/**
   ...
   */static get tag(){return"rich-text-editor-breadcrumb"}/**
   ...
   * @returns {void}
   */_buttonTap(e){e.preventDefault();this.dispatchEvent(new CustomEvent("breadcrumb-tap",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}_exports.RichTextEditorBreadcrumb=RichTextEditorBreadcrumb;window.customElements.define(RichTextEditorBreadcrumb.tag,RichTextEditorBreadcrumb)});