define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  class LrndesignImagemap extends _litElement.LitElement {
    constructor() {
      super();
      new Promise((res, rej) => _require.default(["../relative-heading/relative-heading.js"], res, rej)); // prettier-ignore
    ...
    render() {
      ...
      <figure id="figure">
        <figcaption>
          ...
          >
            ${this.label ? (0, _litElement.html)` <h1>${this.label}</h1> ` : (0, _litElement.html)` <slot name="heading"></slot> `}
          </relative-heading>
