 ...
 */class SiteChildrenBlock extends _polymerElement.PolymerElement{/**
   ...
   */static get tag(){return"site-children-block"}constructor(){super();this.__disposer=[];new Promise((res,rej)=>_require.default(["../../../../../@polymer/paper-button/paper-button.js"],res,rej))}// render function
static get template(){return _polymerElement.html`
    ...
    `}static get properties(){return{/**
       ...
       */activeId:{type:String,observer:"_activeIdChanged"},editMode:{type:Boolean,reflectToAttribute:!0}}}/**
...
if(this._prevEl){this._prevEl.classList.remove("active")}}}connectedCallback(){super.connectedCallback();(0,_mobxModule.autorun)(reaction=>{this.editMode=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.editMode);this.__disposer.push(reaction)});(0,_mobxModule.autorun)(reaction=>{this.manifest=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.manifest);this.__disposer.push(reaction)});(0,_renderStatus.afterNextRender)(this,function(){// minor timing thing to ensure store has picked active
// needed if routes set on first paint or lifecycles miss
setTimeout(()=>{(0,_mobxModule.autorun)(reaction=>{this.activeId=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.activeId);this.__disposer.push(reaction)})},250)})}disconnectedCallback(){// clean up state
for(var i in this.__disposer){this.__disposer[i].dispose()}super.disconnectedCallback()}}_exports.SiteChildrenBlock=SiteChildrenBlock;window.customElements.define(SiteChildrenBlock.tag,SiteChildrenBlock)});