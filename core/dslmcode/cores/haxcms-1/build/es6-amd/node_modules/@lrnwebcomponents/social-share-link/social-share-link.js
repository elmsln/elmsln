define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/iron-icons/iron-icons.js","../social-media-icons/social-media-icons.js"],(function(_exports,_polymerElement,_ironIcons,_socialMediaIcons){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SocialShareLink=void 0;
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class SocialShareLink extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        :host {
          display: inline;
        }
    ...
    `}static get properties(){return{...super.properties,buttonStyle:{name:"buttonStyle",type:Boolean,value:!1,reflectToAttribute:!0},image:{name:"image",type:String,value:""},message:{name:"message",type:String,value:""},mode:{name:"mode",type:String,value:null},text:{name:"text",type:String,value:null},type:{name:"type",type:String,value:"Twitter"},url:{name:"url",type:String,value:null},__href:{name:"__href",type:String,computed:"_getHref(image,message,type,url)"},__icon:{name:"icon",type:String,computed:"_getIcon(type)"},__linkText:{name:"__linkText",type:String,computed:"_getLinkText(text,type)"}}}static get tag(){return"social-share-link"}connectedCallback(){super.connectedCallback()}_getHref(image,message,type,url){let link;switch(type){case"Facebook":link=null!==url&&"https://www.facebook.com/sharer/sharer.php?u="+url;break;case"LinkedIn":link=(null!==url?"&url="+url:"")+(null!==message?"&summary="+message:""),link=null!==link&&"https://www.linkedin.com/shareArticle?mini=true"+link;break;case"Pinterest":link=(null!==url?"&url="+url:"")+(null!==message?"&description="+message:"")+(null!==image?"&media="+image:""),link=null!==link&&"http://pinterest.com/pin/create/button/?"+link.substring(1);break;case"Twitter":link=null!==message?"status="+message+" "+url:url,link=null!==link&&"https://twitter.com/home?"+link}return encodeURI(link)}_getLinkText(text,type){return null!==text?text:"Share via "+type}_getIcon(type){return"social-media:"+type.toLowerCase()}}_exports.SocialShareLink=SocialShareLink,window.customElements.define(SocialShareLink.tag,SocialShareLink)}));