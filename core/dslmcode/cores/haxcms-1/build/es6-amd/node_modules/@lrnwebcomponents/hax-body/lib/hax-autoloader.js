define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../utils/utils.js", "./hax-store.js"], function (_exports, meta, _require, _litElement, _haxBodyBehaviors, _utils, _haxStore) {
  "use strict";
          ...
          try {
            ...
            if (typeof effectiveChildren[i].getHaxProperties === "function") {
              ...
              if (!window.customElements.get(name)) {
                let nameLocation = (0, _utils.varGet)(_haxStore.HAXStore, "__appStoreData.autoloader." + name, `@lrnwebcomponents/${name}/${name}.js`);
