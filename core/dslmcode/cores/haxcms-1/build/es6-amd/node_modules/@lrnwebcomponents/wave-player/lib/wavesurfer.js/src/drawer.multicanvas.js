define(["exports", "./drawer.js", "./util/index.js"], function (_exports, _drawer, util) {
   ...
   * in renderer.
   */
  class MultiCanvas extends _drawer.default {
    /**
    ...
    updateDimensions(entry, width, height) {
      ...
      const totalWidth = Math.round(this.width / this.params.pixelRatio); // Where the canvas starts and ends in the waveform, represented as a decimal between 0 and 1.
    ...
    drawLineToContext(entry, ctx, peaks, absmax, halfH, offsetY, start, end) {
      ...
      const first = Math.round(length * entry.start); // Use one more peak value to make sure we join peaks at ends -- unless,
      ...
      return util.frame(() => {
        ...
        if (peaks[0] instanceof Array) {
          ...
          if (this.params.splitChannels) {
            ...
            return channels.forEach((channelPeaks, i) => this.prepareDraw(channelPeaks, i, start, end, fn));
          }
