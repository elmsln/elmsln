define(["exports","require","../../../@polymer/polymer/polymer-element.js","../../../@polymer/app-localize-behavior/app-localize-behavior.js","../../../@polymer/polymer/lib/legacy/class.js","../../../@polymer/iron-flex-layout/iron-flex-layout-classes.js","../../../@polymer/polymer/lib/elements/dom-repeat.js"],(function(e,o,a,r,t,s,i){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.EcoJsonSchemaArray=void 0,o=babelHelpers.interopRequireWildcard(o);class EcoJsonSchemaArray extends((0,t.mixinBehaviors)([r.AppLocalizeBehavior],a.PolymerElement)){static get tag(){return"eco-json-schema-array"}constructor(){super(),setTimeout(()=>{new Promise((e,a)=>o.default(["../../../@polymer/iron-icons/iron-icons.js"],e,a)),new Promise((e,a)=>o.default(["../../../@polymer/iron-icons/editor-icons.js"],e,a)),new Promise((e,a)=>o.default(["../../../@polymer/paper-icon-button/paper-icon-button.js"],e,a)),new Promise((e,a)=>o.default(["../../simple-tooltip/simple-tooltip.js"],e,a)),new Promise((e,a)=>o.default(["../../a11y-collapse/a11y-collapse.js"],e,a)),new Promise((e,a)=>o.default(["../../a11y-collapse/lib/a11y-collapse-group.js"],e,a))},0)}static get template(){return a.html`
    ...
    `}_toArray(e){return null==e?[]:Object.keys(e).map((function(o){return e[o]}))}static get properties(){return{globalOptions:{type:Object,value:{icon:"settings",tooltip:"configure item"},notify:!0},propertyName:{type:String,value:null},schema:{type:Object,value:{},notify:!0,observer:"_schemaChanged"},__headings:{type:Array,value:[],notify:!0}}}ready(){super.ready(),this.__headings=[],this._schemaChanged(),this.addEventListener("form-field-changed",e=>{this._updateHeadings(e)})}disconnectedCallback(){this.removeEventListener("form-field-changed",e=>{this._updateHeadings(e)}),super.disconnectedCallback()}_schemaChanged(){setTimeout(()=>{let e=this.schema.items.itemLabel;this.schema&&Array.isArray(this.schema.value)&&this.schema.value.forEach(o=>{this.push("__headings",o[e])}),this.shadowRoot.querySelectorAll(".item-fields").forEach(e=>{let o=e.getAttribute("data-index"),a=`${this.propertyPrefix}${this.propertyName}`,r=`${a}.${o}`,t=this.schema.value[o];this.dispatchEvent(new CustomEvent("build-fieldset",{bubbles:!1,cancelable:!0,composed:!0,detail:{container:e,path:a,prefix:r,properties:this.schema.properties.map(e=>{let o=JSON.parse(JSON.stringify(e));return o.value=t[e.name],o}),type:EcoJsonSchemaArray.tag,value:this.schema.value||[]}}))})},0)}_onAddItem(e){let o={};this.schema.properties.forEach(e=>{o[e.name]=e.value}),this.push("schema.value",o),this.notifyPath("schema.*"),this.notifyPath("schema.value.*"),this._schemaChanged()}_onRemoveItem(e){let o=e.target.controls.replace(/item-/,"");this.splice("schema.value",o,1),this.notifyPath("schema.*"),this.notifyPath("schema.value.*"),this._schemaChanged()}_updateHeadings(e){let o=e.detail.getAttribute("name"),a=e.detail.value,r=o?o.split("."):[],t=r.length>2?r[r.length-2]:null,s=e.detail.propertyName===this.schema.items.itemLabel?a:this.__headings[t];t&&this.set(`__headings.${t}`,s)}_getHeading(e,o,a){return this.__headings&&this.__headings[a]&&"string"==typeof this.__headings[a]&&""!==this.__headings[a].trim("")?this.__headings[a].trim(""):o&&"string"==typeof o&&""!==o.trim("")?`${o.trim("")} ${a+1}`:`Item ${a+1}`}}e.EcoJsonSchemaArray=EcoJsonSchemaArray,window.customElements.define(EcoJsonSchemaArray.tag,EcoJsonSchemaArray)}));