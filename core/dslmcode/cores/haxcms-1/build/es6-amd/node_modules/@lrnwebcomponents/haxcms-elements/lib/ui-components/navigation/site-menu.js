define(["exports", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../map-menu/map-menu.js", "../../core/utils/HAXCMSThemeParts.js"], function (_exports, _litElement, _haxcmsSiteStore, _mobxEsm, _mapMenu, _HAXCMSThemeParts) {
  "use strict";
  ...
  class SiteMenu extends (0, _HAXCMSThemeParts.HAXCMSThemeParts)(_litElement.LitElement) {
    ...
    mapMenuActiveChanged(e) {
      ...
      if (userData.manifests) {
        if (typeof userData.manifests[this.routerManifest.id] === typeof undefined) {
