define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/elements/dom-repeat.js","./lib/hex-a-gon.js"],function(_exports,_polymerElement,_domRepeat,_hexAGon){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.HexagonLoader=void 0;class HexagonLoader extends _polymerElement.PolymerElement{static get template(){return _polymerElement.html`
      <style>
        :host {
          display: none;
        }
    ...
    `}static get properties(){return{color:{name:"color",type:"String",observer:"_colorChanged",reflectToAttribute:!0},size:{name:"size",type:"String",reflectToAttribute:!0},loading:{name:"loading",type:"Boolean",reflectToAttribute:!0},itemCount:{name:"itemCount",type:"Number",value:37}}}static get tag(){return"hexagon-loader"}connectedCallback(){super.connectedCallback();let items=[];for(var i=0;i<this.itemCount;i++)items.push("");this.set("items",items)}_colorChanged(newValue,oldValue){newValue&&this.updateStyles({"--hexagon-color":newValue})}}_exports.HexagonLoader=HexagonLoader,window.customElements.define(HexagonLoader.tag,HexagonLoader)});