define(["exports","../../lit-element/lit-element.js","./lib/hex-a-gon.js"],(function(i,t,a){"use strict";Object.defineProperty(i,"__esModule",{value:!0}),i.HexagonLoader=void 0;
/**
   * Copyright 2018 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
class HexagonLoader extends t.LitElement{static get styles(){return[t.css`
        :host {
          display: none;
        }
        :host([hidden]) {
      ...
      <div>
        ${this.items.map(i=>t.html`
              <hex-a-gon></hex-a-gon>
            `)}
      </div>
    `}static get properties(){return{...super.properties,color:{name:"color",type:String,reflect:!0},size:{name:"size",type:String,reflect:!0},loading:{name:"loading",type:Boolean,reflect:!0},items:{name:"items",type:Array},itemCount:{name:"itemCount",type:Number,reflect:!0,attribute:"item-count"}}}static get tag(){return"hexagon-loader"}constructor(){super(),this.itemCount=37,this.items=[]}updated(i){i.forEach((i,t)=>{if("color"==t&&this._colorChanged(this[t],i),"itemCount"==t){this.items=[];for(let i=0;i<this[t];i++)this.items.push("")}})}_colorChanged(i,t){i&&window.ShadyCSS&&window.ShadyCSS.styleSubtree(this,{"--hexagon-color":i})}}i.HexagonLoader=HexagonLoader,window.customElements.define(HexagonLoader.tag,HexagonLoader)}));