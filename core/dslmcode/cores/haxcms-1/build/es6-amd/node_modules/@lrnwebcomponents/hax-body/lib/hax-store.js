  ...
  class HaxStore extends (0, _utils.winEventsElement)((0, _haxBodyBehaviors.HAXElement)(_litElement.LitElement)) {
    ...
    updated(changedProperties) {
      ...
      changedProperties.forEach((oldValue, propName) => {
        ...
        if (["__ready", "__appStoreData", "haxAutoloader"].includes(propName) && this.__ready && this.__appStoreData) {
    ...
    constructor() {
      ...
      this._isSandboxed = typeof test.reload === "function"; // imports app, blox, stax definitions
