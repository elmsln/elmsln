define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../../undoer/undoer.js"], function (_exports, meta, _require, _litElement, _utils, _haxBodyBehaviors, _undoer) {
  ...
  class HaxStore extends (0, _utils.winEventsElement)((0, _haxBodyBehaviors.HAXElement)(_litElement.LitElement)) {
    ...
    updated(changedProperties) {
      ...
      changedProperties.forEach((oldValue, propName) => {
        ...
        if (["haxAutoloader", "activeHaxBody", "haxToast", "haxExport", "haxPreferences", "haxAppPicker", "haxTray"].includes(propName)) {
          ...
          this._storePiecesAllHere(this.haxAutoloader, this.activeHaxBody, this.haxToast, this.haxExport, this.haxPreferences, this.haxAppPicker, this.haxTray);
        }
      });
    ...
    _storePiecesAllHere(haxAutoloader, activeHaxBody, haxToast, haxExport, haxPreferences, haxAppPicker, haxTray) {
          ...
          if (wordPaste) {
            ...
            return false;
              ...
              for (var i in haxElements) {
                ...
                let node = window.HaxStore.haxElementToNode(haxElements[i].tag, haxElements[i].content.replace(/<span>&nbsp;<\/span>/g, " ").trim(), haxElements[i].properties);
    ...
    _haxStoreInsertContent(e) {
      if (e.detail) {
        ...
        if (details.replace && details.replacement) {
          let node = window.HaxStore.haxElementToNode(details.tag, details.content, properties);
          ...
          let node = window.HaxStore.haxElementToNode(details.tag, details.content, properties); // replace what WAS the active selection w/ this new node
          ...
          let node = window.HaxStore.haxElementToNode(details.tag, details.content, properties); // allow for inserting things into things but not grid plate
  ...
  window.HaxStore.toast = (message, duration = 4000, classStyle = "capsule", closeText = null, eventCallback = null) => {
