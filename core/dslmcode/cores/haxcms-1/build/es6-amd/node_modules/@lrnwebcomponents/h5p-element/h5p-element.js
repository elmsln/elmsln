define(["exports","meta","../../lit-element/lit-element.js","../../@polymer/polymer/lib/utils/resolve-url.js","../es-global-bridge/es-global-bridge.js"],function(_exports,meta,_litElement,_resolveUrl,_esGlobalBridge){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.Toposort=_exports.H5PStandalone=_exports.H5PElement=void 0,meta=babelHelpers.interopRequireWildcard(meta),window.__H5PBridgeTimeOut=function(){setTimeout(function(){window.H5P.init()},500)};class H5PElement extends _litElement.LitElement{render(){return _litElement.html`
      <style>
        :host {
          display: block;
        }
