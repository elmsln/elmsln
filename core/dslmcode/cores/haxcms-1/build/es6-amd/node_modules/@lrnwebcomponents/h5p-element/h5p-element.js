define(["exports","meta","../../lit-element/lit-element.js","../es-global-bridge/es-global-bridge.js"],(function(_exports,meta,_litElement,_esGlobalBridge){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.Toposort=_exports.H5PStandalone=_exports.H5PElement=void 0,meta=babelHelpers.interopRequireWildcard(meta),
/**
   * Copyright 2019 The Pennsylvania State University
   * @license Apache-2.0, see License.md for full text.
   */
window.__H5PBridgeTimeOut=function(){setTimeout((function(){window.H5P.init()}),500)};class H5PElement extends _litElement.LitElement{static get styles(){return[_litElement.css`
        :host {
          display: block;
        }
