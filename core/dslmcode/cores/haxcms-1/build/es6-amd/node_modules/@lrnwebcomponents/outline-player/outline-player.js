define(["exports","require","../../lit-element/lit-element.js","../haxcms-elements/lib/core/HAXCMSLitElementTheme.js","../simple-colors/simple-colors.js","../haxcms-elements/lib/core/haxcms-site-store.js","../../mobx/lib/mobx.module.js","../../@polymer/polymer/lib/elements/custom-style.js"],(function(e,t,i,o,n,a,r,s){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.OutlinePlayer=void 0,t=babelHelpers.interopRequireWildcard(t);class OutlinePlayer extends((0,n.SimpleColorsSuper)(o.HAXCMSLitElementTheme)){static get styles(){return[...super.styles,i.css`
        :host {
          display: block;
      ...
      `]}static get tag(){return"outline-player"}constructor(){super(),this.__disposer=[],this.closed=!1,new Promise((e,i)=>t.default(["../../@polymer/app-layout/app-drawer/app-drawer.js"],e,i)),new Promise((e,i)=>t.default(["../../@polymer/app-layout/app-drawer-layout/app-drawer-layout.js"],e,i)),new Promise((e,i)=>t.default(["../haxcms-elements/lib/ui-components/navigation/site-menu.js"],e,i)),new Promise((e,i)=>t.default(["../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"],e,i)),new Promise((e,i)=>t.default(["../haxcms-elements/lib/ui-components/site/site-print-button.js"],e,i)),new Promise((e,i)=>t.default(["../haxcms-elements/lib/ui-components/site/site-title.js"],e,i)),new Promise((e,i)=>t.default(["../haxcms-elements/lib/ui-components/active-item/site-active-title.js"],e,i)),new Promise((e,i)=>t.default(["../haxcms-elements/lib/ui-components/active-item/site-git-corner.js"],e,i))}render(){return i.html`
      <custom-style>
        <style>
          app-drawer {
