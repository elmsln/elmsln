define(["exports","../../@polymer/polymer/polymer-element.js","../../@polymer/polymer/lib/utils/async.js","../../@polymer/polymer/lib/mixins/element-mixin.js","../haxcms-elements/lib/core/HAXCMSThemeWiring.js","../haxcms-elements/lib/core/haxcms-site-store.js","../../mobx/lib/mobx.module.js","../../@polymer/app-layout/app-header/app-header.js","../../@polymer/app-layout/app-toolbar/app-toolbar.js","../../@polymer/app-layout/app-drawer/app-drawer.js","../../@polymer/app-layout/app-drawer-layout/app-drawer-layout.js","../../@polymer/app-layout/app-header-layout/app-header-layout.js","../simple-colors/simple-colors.js","../haxcms-elements/lib/ui-components/navigation/site-menu.js","../haxcms-elements/lib/ui-components/navigation/site-menu-button.js","../haxcms-elements/lib/ui-components/site/site-print-button.js","../haxcms-elements/lib/ui-components/site/site-title.js","../haxcms-elements/lib/ui-components/active-item/site-active-title.js","../haxcms-elements/lib/ui-components/active-item/site-git-corner.js"],function(_exports,_polymerElement,async,_elementMixin,_HAXCMSThemeWiring,_haxcmsSiteStore,_mobxModule,_appHeader,_appToolbar,_appDrawer,_appDrawerLayout,_appHeaderLayout,_simpleColors,_siteMenu,_siteMenuButton,_sitePrintButton,_siteTitle,_siteActiveTitle,_siteGitCorner){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.OutlinePlayer=void 0,async=babelHelpers.interopRequireWildcard(async);class OutlinePlayer extends((0,_HAXCMSThemeWiring.HAXCMSTheme)(_polymerElement.PolymerElement)){static get tag(){return"outline-player"}static get template(){return _polymerElement.html`
    ...
    `}static get properties(){return{opened:{type:Boolean,reflectToAttribute:!0},closed:{type:Boolean,notify:!0,reflectToAttribute:!0,value:!1},activeId:{type:String,observer:"_activeIdChanged"},narrow:{type:Boolean,reflectToAttribute:!0}}}_toggleMenu(e){this.$.drawer.toggle(),this.closed=!this.$.drawer.opened,async.microTask.run(()=>{window.dispatchEvent(new Event("resize")),(0,_elementMixin.updateStyles)()})}_activeIdChanged(newValue){this.opened&&this.narrow&&this.$.drawer.toggle(),window.scrollTo({top:0,left:0,behavior:"smooth"})}connectedCallback(){super.connectedCallback(),this.__disposer=[],(0,_mobxModule.autorun)(reaction=>{this.activeId=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.activeId),this.__disposer.push(reaction)})}disconnectedCallback(){for(var i in this.__disposer)this.__disposer[i].dispose();super.disconnectedCallback()}}_exports.OutlinePlayer=OutlinePlayer,window.customElements.define(OutlinePlayer.tag,OutlinePlayer)});