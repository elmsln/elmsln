define(["exports", "require", "../../lit-element/lit-element.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../simple-colors/simple-colors.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/dist/mobx.esm.js", "../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _simpleColors, _haxcmsSiteStore, _mobxEsm, _customStyle) {
  "use strict";
  ...
  class OutlinePlayer extends (0, _simpleColors.SimpleColorsSuper)(_HAXCMSLitElementTheme.HAXCMSLitElementTheme) {
    ...
    constructor() {
      ...
      new Promise((res, rej) => _require.default(["../../@polymer/app-layout/app-drawer-layout/app-drawer-layout.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/navigation/site-menu.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/site/site-print-button.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/site/site-title.js"], res, rej)); // prettier-ignore

      new Promise((res, rej) => _require.default(["../haxcms-elements/lib/ui-components/active-item/site-active-title.js"], res, rej)); // prettier-ignore
    ...
    firstUpdated(changedProperties) {
      ...
      (0, _mobxEsm.autorun)(reaction => {
        this.activeId = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeId);
