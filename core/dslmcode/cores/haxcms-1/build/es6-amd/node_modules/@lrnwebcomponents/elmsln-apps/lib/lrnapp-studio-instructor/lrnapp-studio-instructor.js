  ...
  class LrnappStudioInstructor extends _polymerElement.PolymerElement {
    ...
    connectedCallback() {
      ...
      (0, _renderStatus.afterNextRender)(this, function () {
        ...
        this.$.selectedproject.addEventListener("change", this._projectChanged.bind(this));
        this.$.selectedchart.addEventListener("change", this._chartChanged.bind(this));
      });
    }
    /**
     * detached life cycle
    ...
    disconnectedCallback() {
      ...
      this.$.selectedproject.removeEventListener("change", this._projectChanged.bind(this));
      this.$.selectedchart.removeEventListener("change", this._chartChanged.bind(this));
