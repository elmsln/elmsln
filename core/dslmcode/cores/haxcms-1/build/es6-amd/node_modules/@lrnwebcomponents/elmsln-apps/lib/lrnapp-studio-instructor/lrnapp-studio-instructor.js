define(["exports","../../../../@polymer/polymer/polymer-element.js","../../../../@polymer/polymer/lib/utils/render-status.js","../../../../@polymer/polymer/lib/legacy/polymer.dom.js","../../../../@polymer/polymer/lib/elements/dom-if.js","../../../simple-tooltip/simple-tooltip.js","../../../../@polymer/polymer/lib/elements/dom-repeat.js","../../../../@polymer/app-route/app-location.js","../../../../@polymer/app-route/app-route.js","../../../../@polymer/app-layout/app-header/app-header.js","../../../../@polymer/app-layout/app-toolbar/app-toolbar.js","../../../../@polymer/iron-ajax/iron-ajax.js","../../../../@polymer/paper-toggle-button/paper-toggle-button.js","../../../../@polymer/paper-item/paper-item.js","../../../../@polymer/paper-badge/paper-badge.js","../../../../@polymer/paper-button/paper-button.js","../../../../@polymer/paper-input/paper-input.js","../../../../@polymer/paper-icon-button/paper-icon-button.js","../../../../@vaadin/vaadin-grid/vaadin-grid.js","../../../../@vaadin/vaadin-grid/vaadin-grid-filter.js","../../../../@vaadin/vaadin-grid/vaadin-grid-sorter.js","../../../../@vaadin/vaadin-grid/vaadin-grid-column-group.js","../../../../@vaadin/vaadin-grid/vaadin-grid-selection-column.js","../../../elmsln-loading/elmsln-loading.js","../../../lrndesign-chart/lib/lrndesign-bar.js","../../../lrndesign-chart/lib/lrndesign-line.js","../../../lrndesign-chart/lib/lrndesign-pie.js","../../../simple-picker/simple-picker.js","../../../lrnsys-button/lrnsys-button.js","../../../lrndesign-avatar/lrndesign-avatar.js","../../../../@polymer/paper-dialog/paper-dialog.js","../../../materializecss-styles/materializecss-styles.js","../lrnapp-studio-submission/lrnapp-studio-submission.js"],(function(t,e,i,s,a,n,r,o,d,l,p,c,m,g,u,h,b,v,y,j,f,_,D,k,P,x,C,S,$,w,O,T,A){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.LrnappStudioInstructor=void 0;class LrnappStudioInstructor extends e.PolymerElement{static get template(){return e.html`
    ...
    </paper-dialog>`}static get tag(){return"lrnapp-studio-instructor"}static get observers(){return["_routeChanged(route, endPoint)","_activeDataChanged(activeData.student, activeData.assignment)"]}static get properties(){return{elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},sourceProjectPath:{type:String},sourceStudentPath:{type:String},simplePickerOptions:{type:Array,value:[[{alt:"Submissions by Assignment",value:"byassignment-submissions"}],[{alt:"Comments by Assignment",value:"byassignment-comments"}],[{alt:"Commenters by Assignment",value:"byassignment-commenters"}]]},dataType:{type:Boolean,value:!1,observer:"_dataTypeChanged"},dataTypeText:{type:String,value:"Submissions"},projects:{type:Object,notify:!0},assignments:{type:Object,notify:!0},students:{type:Object,notify:!0,value:!1},_projectData:{type:Object,value:{}},studentParams:{type:Object,value:{projectId:null,type:"submission"}},_studentData:{type:Object},_numWidth:{type:String,value:"2.25em"},sourcePath:{type:String,notify:!0},basePath:{type:String,notify:!0},route:{type:String},csrfToken:{type:String},elmslnCourse:{type:String},elmslnSection:{type:String},data:{type:Object},activeProject:{type:Number,value:!1},activeData:{type:Object,value:{student:!1,assignment:!1,submission:!1}},stats:{type:Object,value:{}},activeChart:{type:Object,value:{}}}}_chartChanged(t){this.set("activeChart.title",t.detail.value),this.notifyPath("activeChart.title"),this.set("activeChart.description","Chart of values relative to "+t.detail.value),this.notifyPath("activeChart.description"),this.set("activeChart.data",this._formatChartData(t.detail.value)),this.notifyPath("activeChart.data")}_formatChartData(t){var e=[],i=[[]];const s=this.stats.stats,a=this._toArray(this.assignments);let n=t.split("-");if(void 0!==s[n[0]]&&void 0!==s[n[0]][n[1]])for(var r in a){let t=a[r].title;void 0!==s[n[0]][n[1]][a[r].id]?(i[0].push(s[n[0]][n[1]][a[r].id]),t+=` (${s[n[0]][n[1]][a[r].id]})`):(i[0].push(0),t+=" (0)"),e.push(t)}return{labels:e,series:i}}_dataTypeChanged(t,e){void 0!==e&&(this.dataTypeText=t?"Comments (beta)":"Submissions")}_commentIndex(t){return t+1}_routeChanged(t,e){if("string"==typeof t.path){if("string"==typeof e&&t.path.startsWith(e))return;window.location.reload()}}_activeDataChanged(t,e){void 0!==t.id&&(-1==this._getObjectByPosition(this.students,t.id,-1)?this.$.prevstudent.disabled=!0:this.$.prevstudent.disabled=!1,-1==this._getObjectByPosition(this.students,t.id,1)?this.$.nextstudent.disabled=!0:this.$.nextstudent.disabled=!1,-1==this._getObjectByPosition(this.assignments,e.id,-1)?this.$.prevassignment.disabled=!0:this.$.prevassignment.disabled=!1,-1==this._getObjectByPosition(this.assignments,e.id,1)?this.$.nextassignment.disabled=!0:this.$.nextassignment.disabled=!1)}_projectChanged(t){this.$.loading.hidden=!1,this.__rememberClick=this.$.statsdialogbutton,this.$.statsdialogbutton.disabled=!1,this.$.datatype.disabled=!1,this.activeProject=t.detail.value,this.studentParams.projectId=this.activeProject,this.$.studentrequest.generateRequest()}_openStatsDialog(t){this.$.statsdialog.toggle()}connectedCallback(){super.connectedCallback(),(0,i.afterNextRender)(this,(function(){this.$.statsdialogbutton.addEventListener("click",this._openStatsDialog.bind(this)),this.$.statsdialog.addEventListener("opened-changed",this._accessibleFocus.bind(this)),this.$.dialog.addEventListener("opened-changed",this._accessibleFocus.bind(this)),this.$.selectedproject.addEventListener("change",this._projectChanged.bind(this)),this.$.selectedchart.addEventListener("change",this._chartChanged.bind(this))}))}disconnectedCallback(){this.$.statsdialogbutton.removeEventListener("click",this._openStatsDialog.bind(this)),this.$.statsdialog.removeEventListener("opened-changed",this._accessibleFocus.bind(this)),this.$.dialog.removeEventListener("opened-changed",this._accessibleFocus.bind(this)),this.$.selectedproject.removeEventListener("change",this._projectChanged.bind(this)),this.$.selectedchart.removeEventListener("change",this._chartChanged.bind(this)),super.disconnectedCallback()}_accessibleFocus(t){t.detail||(document.body.classList.remove("scroll-disabled"),this.__rememberClick.focus())}_handleProjectResponse(t){this.$.loading.hidden=!0,this.set("projects",this._projectData.data.projects)}_handleStudentResponse(t){this.$.loading.hidden=!0,this.set("students",[]),this.set("students",this._studentData.data.students),this.set("assignments",[]),this.set("assignments",this._studentData.data.assignments),this.stats=this._studentData.data.stats,this.set("stats.header","Statistics for "+this.projects["project-"+this.activeProject].attributes.title),setTimeout(()=>{this.shadowRoot.querySelector("#sorter").direction="asc"},200)}_changeActiveItem(t){var e,i;switch(document.body.classList.add("scroll-disabled"),(0,s.dom)(t).localTarget.id){case"prevstudent":-1!=(e=this._getObjectByPosition(this.students,this.activeData.student.id,-1))&&void 0!==e.assignments[this.activeData.assignment.id]&&(this.set("activeData.student",{}),this.set("activeData.student",e),this.set("activeData.submission",{}),this.set("activeData.submission",e.assignments[this.activeData.assignment.id]),this.set("route.path",this.endPoint+"/submissions/"+this.activeData.submission.id));break;case"nextstudent":-1!=(e=this._getObjectByPosition(this.students,this.activeData.student.id,1))&&void 0!==e.assignments[this.activeData.assignment.id]&&(this.set("activeData.student",{}),this.set("activeData.student",e),this.set("activeData.submission",{}),this.set("activeData.submission",e.assignments[this.activeData.assignment.id]),this.set("route.path",this.endPoint+"/submissions/"+this.activeData.submission.id));break;case"prevassignment":-1!=(i=this._getObjectByPosition(this.assignments,this.activeData.assignment.id,-1))&&(this.set("activeData.assignment",{}),this.set("activeData.assignment",i),void 0!==this.activeData.student.assignments[i.id].id?(this.set("activeData.submission",this.activeData.student.assignments[i.id]),this.set("activeData.submission",{}),this.set("route.path",this.endPoint+"/submissions/"+this.activeData.student.assignments[i.id].id)):this.set("activeData.submission",!1));break;case"nextassignment":-1!=(i=this._getObjectByPosition(this.assignments,this.activeData.assignment.id,1))&&(this.set("activeData.assignment",{}),this.set("activeData.assignment",i),void 0!==this.activeData.student.assignments[i.id].id?(this.set("activeData.submission",{}),this.set("activeData.submission",this.activeData.student.assignments[i.id]),this.set("route.path",this.endPoint+"/submissions/"+this.activeData.student.assignments[i.id].id)):this.set("activeData.submission",!1))}}_getObjectByPosition(t,e,i){var s=Object.keys(t).sort((function(e,i){return void 0!==t[e].sis?t[e].sis.sortable_name>t[i].sis.sortable_name?1:t[e].sis.sortable_name<t[i].sis.sortable_name?-1:0:e-i}));void 0!==e&&(e=e.toString());var a=s.indexOf(e);return-1==a&&(a=s.indexOf(parseInt(e))),-1==i&&a>0||1==i&&a<s.length-1?t[s[a+i]]:-1}_submissionStatus(t,e,i){if(null!=t){if(!i&&void 0!==t.assignments[e.id]&&void 0!==t.assignments[e.id].id)return!0;if(i&&void 0!==t.assignmentComments[e.id]&&this._toArray(t.assignmentComments[e.id]).length>0)return!0}return!1}_submissionID(t,e){return null!=t&&void 0!==t.assignments[e.id]&&void 0!==t.assignments[e.id].id&&t.assignments[e.id].id}_submissionPiece(t,e,i){if(null!=t&&void 0!==t.assignments[e.id]&&void 0!==t.assignments[e.id].id){var s=t.assignments[e.id];switch(i){case"url":return this.basePath+"lrnapp-studio-submission/submissions/"+s.id;case"title":return s.attributes.title;case"icon":return s.meta.state_icon;case"color":return s.meta.state_color;case"comments":return this._toArray(t.assignmentComments[e.id])}}return""}_commentCount(t,e,i){return!i&&null!=t&&void 0!==t.assignmentComments[e.id]&&this._toArray(t.assignmentComments[e.id]).length}_setActiveSubmission(t){var e=(0,s.dom)(t).localTarget;this.__rememberClick=e;var i=e.id.split("-");this.set("activeData.student",this.students[i[1]]),this.set("activeData.assignment",this.assignments[i[3]]),this.set("activeData.submission",this.students[i[1]].assignments[i[3]]),this.set("route.path",this.endPoint+"/submissions/"+i[i.length-1]),document.body.classList.add("scroll-disabled"),this.$.dialog.toggle()}_setActiveComment(t){this.$.nextassignment.disabled=!0,this.$.prevassignment.disabled=!0,this.$.nextstudent.disabled=!0,this.$.prevstudent.disabled=!0;var e=(0,s.dom)(t).localTarget;this.__rememberClick=e;var i=e.id.split("-");this.set("activeData.student",this.students[i[1]]),this.set("activeData.assignment",this.assignments[i[3]]),this.set("activeData.submission",this.students[i[1]].assignments[i[3]]),this.set("route.path",this.endPoint+"/submissions/"+i[i.length-1]),document.body.classList.add("scroll-disabled"),this.$.dialog.toggle()}_toArray(t){return null==t?[]:Object.keys(t).map((function(e){return t[e]}))}}t.LrnappStudioInstructor=LrnappStudioInstructor,window.customElements.define(LrnappStudioInstructor.tag,LrnappStudioInstructor)}));