...
/**
   ...
   */
class SimplePopover extends o.AbsolutePositionBehavior{static get styles(){return[e.css`
        :host([hidden]) {
          display: none;
        }
        :host > div {
