define(["exports","../../@polymer/polymer/polymer-element.js","../hax-body-behaviors/lib/HAXWiring.js","../absolute-position-behavior/absolute-position-behavior.js"],function(_exports,_polymerElement,_HAXWiring,_absolutePositionBehavior){Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.SimplePopover=void 0;class SimplePopover extends _absolutePositionBehavior.AbsolutePositionBehavior{static get template(){return _polymerElement.html`
      <style>
        :host {
    ...
    `}static get haxProperties(){return{canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Simple popover",description:"A popover alertdialog that is positioned next to a target element",icon:"icons:android",color:"green",groups:["Popover"],handles:[{type:"todo:read-the-docs-for-usage"}],meta:{author:"nikkimk",owner:"The Pennsylvania State University"}},settings:{quick:[],configure:[{property:"title",description:"",inputMethod:"textfield",required:!1,icon:"icons:android"}],advanced:[]}}}static get properties(){let props={__pointerOffSetStyle:{type:Object,computed:"_getMargins(__positions)"}};return super.properties&&(props=Object.assign(props,super.properties)),props}constructor(){super(),this.offset=-10,this.fitToVisibleBounds=!0}static get tag(){return"simple-popover"}connectedCallback(){super.connectedCallback(),this.HAXWiring=new _HAXWiring.HAXWiring,this.HAXWiring.setup(SimplePopover.haxProperties,SimplePopover.tag,this)}_getMargins(positions){let self=this.getBoundingClientRect(),h="bottom"===this.position||"top"===this.position,max=h?self.width:self.height,sStart=h?self.left:self.top,center=(h?positions.target.left:positions.target.top)+(h?positions.target.width/2:positions.target.height/2)-10,margin=Math.min(max-20,Math.max(0,center-sStart));return h?`margin: 0 0 0 ${margin}px;`:`margin: ${margin}px 0 0 0;`}}_exports.SimplePopover=SimplePopover,window.customElements.define(SimplePopover.tag,SimplePopover)});