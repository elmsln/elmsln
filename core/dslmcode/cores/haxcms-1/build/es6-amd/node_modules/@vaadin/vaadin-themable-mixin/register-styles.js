define(["exports", "../../@polymer/polymer/lib/elements/dom-module.js", "./node_modules/lit-element/lit-element.js"], function (_exports, _domModule, _litElement) {
  "use strict";
  ...
  Object.defineProperty(_exports, "unsafeCSS", {
    enumerable: true,
    get: function () {
      return _litElement.unsafeCSS;
    }
  });
  _exports.registerStyles = void 0;
  let moduleIdIndex = 0; // Map of <CSSResult, Polymer.DomModule> pairs.
  ...
  const registerStyles = (themeFor, styles, options) => {
    ...
    styles.forEach(cssResult => {
      if (!(cssResult instanceof _litElement.CSSResult)) {
