 ...
 *
 * @memberof Vaadin
 */class GridSorterElement extends(0,_vaadinThemableMixin.ThemableMixin)(_polymerElement.PolymerElement){static get template(){return _htmlTag.html`
    <style>
      :host {
        display: inline-flex;
        cursor: pointer;
...
var isSafari=/^((?!chrome|android).)*safari/i.test(navigator.userAgent);if(isSafari&&this.root){this.root.querySelectorAll("*").forEach(function(el){el.style["-webkit-backface-visibility"]="visible";el.style["-webkit-backface-visibility"]=""})}}}_exports.GridSorterElement=GridSorterElement;customElements.define(GridSorterElement.is,GridSorterElement)});