  ...
  const ScrollMixin = superClass => class ScrollMixin extends superClass {
    ...
    ready() {
      ...
      this.addEventListener('wheel', e => {
        ...
        this._debouncerWheelScrolling = _debounce.Debouncer.debounce(this._debouncerWheelScrolling, _async.timeOut.after(this._timeouts.WHEEL_SCROLLING), () => this._wheelScrolling = false);
    ...
    _onWheel(e) {
      ...
      this._debouncerWheelAnimationFrame = _debounce.Debouncer.debounce(this._debouncerWheelAnimationFrame, _async.animationFrame, () => this._wheelAnimationFrame = false);
      ...
      if (this._canScroll(table, e.deltaX, deltaY)) {
        ...
        this._debouncerIgnoreNewWheel = _debounce.Debouncer.debounce(this._debouncerIgnoreNewWheel, _async.timeOut.after(this._timeouts.IGNORE_WHEEL), () => this._ignoreNewWheel = false);
    ...
    _scheduleScrolling() {
      ...
      this._debounceScrolling = _debounce.Debouncer.debounce(this._debounceScrolling, _async.timeOut.after(this._timeouts.SCROLLING), () => {
      ...
      this._debounceScrollPeriod = _debounce.Debouncer.debounce(this._debounceScrollPeriod, _async.timeOut.after(this._timeouts.SCROLL_PERIOD), () => {
    ...
    _updateOverflow() {
      ...
      this._debounceOverflow = _debounce.Debouncer.debounce(this._debounceOverflow, _async.animationFrame, () => {
    ...
    _frozenCellsChanged() {
      this._debouncerCacheElements = _debounce.Debouncer.debounce(this._debouncerCacheElements, _async.microTask, () => {
    ...
    _translateStationaryElements() {
      ...
      if (this._frozenCells.length > 0) {
        const x = this.__isRTL ? this.__getNormalizedScrollLeft(this.$.table) + this.__scrollerMetrics.clientWidth - this.__scrollerMetrics.scrollWidth : this._scrollLeft;
