define(["exports","./vaadin-grid-column.js","./vaadin-grid-tree-toggle.js","../../../@polymer/polymer/lib/utils/html-tag.js"],function(_exports,_vaadinGridColumn,_vaadinGridTreeToggle,_htmlTag){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.GridTreeColumnElement=void 0;/**
@license
 ...
 */class GridTreeColumnElement extends _vaadinGridColumn.GridColumnElement{static get template(){return _htmlTag.html`
...
template.templatizer.dataHost=this;return template}__isLeafItem(item,itemHasChildrenPath){return!(item&&item[itemHasChildrenPath])}__getToggleContent(path,item){return path&&this.get(path,item)}}_exports.GridTreeColumnElement=GridTreeColumnElement;customElements.define(GridTreeColumnElement.is,GridTreeColumnElement)});