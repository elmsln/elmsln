define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.WebComponentInterface=void 0;/**
 ...
 */class WebComponentInterface{/**
   ...
   */onBeforeLeave(location,commands,router){// user implementation example:
if(this.hasUnfinishedChanges()){return commands.prevent()}}/**
   ...
   *
   * @param router the `Router` instance
   */onBeforeEnter(location,commands,router){// user implementation example:
if("admin"===context.params.userName){return context.redirect(context.pathname+"?admin")}}/**
   ...
   * @param router the `Router` instance
   */onAfterLeave(location,commands,router){// user implementation example:
storeTimeSpentOnTheView()}/**
   ...
   * @param commands empty object
   * @param router the `Router` instance
   */onAfterEnter(location,commands,router){// user implementation example:
sendVisitStatistics()}}_exports.WebComponentInterface=WebComponentInterface});