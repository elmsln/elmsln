define(["exports","../../../@polymer/polymer/polymer-element.js","./vaadin-text-field-mixin.js","../../vaadin-element-mixin/vaadin-element-mixin.js","../../../@polymer/polymer/lib/utils/html-tag.js","../../vaadin-themable-mixin/vaadin-themable-mixin.js"],function(_exports,_polymerElement,_vaadinTextFieldMixin,_vaadinElementMixin,_htmlTag,_vaadinThemableMixin){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.TextAreaElement=void 0;/**
@license
 ...
 */class TextAreaElement extends(0,_vaadinElementMixin.ElementMixin)((0,_vaadinTextFieldMixin.TextFieldMixin)((0,_vaadinThemableMixin.ThemableMixin)(_polymerElement.PolymerElement))){static get template(){return _htmlTag.html`
...
input.style.removeProperty("max-width");inputField.style.removeProperty("display");inputField.scrollTop=scrollTop;if(this.__previousInputHeight&&this.__previousInputHeight!==inputHeight){this.dispatchEvent(new CustomEvent("iron-resize",{bubbles:!0}))}this.__previousInputHeight=inputHeight}/**
   * Fired when the text-area height changes.
   *
   * @event iron-resize
   */}_exports.TextAreaElement=TextAreaElement;customElements.define(TextAreaElement.is,TextAreaElement)});