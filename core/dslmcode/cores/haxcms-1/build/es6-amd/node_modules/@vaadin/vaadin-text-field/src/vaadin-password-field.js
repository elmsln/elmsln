define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/elements/custom-style.js","./vaadin-text-field.js","../../../@polymer/polymer/lib/elements/dom-module.js"],function(_exports,_polymerElement,_customStyle,_vaadinTextField,_domModule){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PasswordFieldElement=void 0;/**
@license
 ...
 */class PasswordFieldElement extends _vaadinTextField.TextFieldElement{static get is(){return"vaadin-password-field"}static get version(){return"2.3.7"}static get properties(){return{/**
       * Set to true to hide the eye icon which toggles the password visibility.
       */revealButtonHidden:{type:Boolean,value:!1},/**
       * True if the password is visible ([type=text]).
       */passwordVisible:{type:Boolean,value:!1,reflectToAttribute:!0,observer:"_passwordVisibleChange",readOnly:!0}}}static get template(){if(!memoizedTemplate){// Clone the superclass template
...
e.preventDefault();this._togglePasswordVisibility();this.inputElement.focus()}_togglePasswordVisibility(){this._passwordVisibilityChanging=!0;this.inputElement.blur();this._setPasswordVisible(!this.passwordVisible);this.inputElement.focus();this._passwordVisibilityChanging=!1}_passwordVisibleChange(passwordVisible){this.inputElement.type=passwordVisible?"text":"password"}}_exports.PasswordFieldElement=PasswordFieldElement;customElements.define(PasswordFieldElement.is,PasswordFieldElement)});