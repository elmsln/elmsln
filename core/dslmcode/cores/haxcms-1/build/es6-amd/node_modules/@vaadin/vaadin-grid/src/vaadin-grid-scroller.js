...
const content=this.querySelector("[slot]");if(content){const slot=content.getAttribute("slot");content.setAttribute("slot","foo-bar");content.setAttribute("slot",slot)}this._updateHeaderFooterMetrics();(0,_renderStatus.afterNextRender)(this,()=>this.notifyResize());return physicalItems}/**
