 ...
 */class Resolver{constructor(routes,options={}){if(Object(routes)!==routes){throw new TypeError("Invalid routes")}this.baseUrl=options.baseUrl||"";this.errorHandler=options.errorHandler;this.resolveRoute=options.resolveRoute||_resolveRoute.default;this.context=Object.assign({resolver:this},options.context);this.root=Array.isArray(routes)?{path:"",__children:routes,parent:null,__synthetic:!0}:routes;this.root.parent=null}/**
   ...
   */setRoutes(routes){(0,_utils.ensureRoutes)(routes);const newRoutes=[...(0,_utils.toArray)(routes)];this.root.__children=newRoutes}/**
   ...
   * @return {!Array<!Route>}
   * @protected
   */addRoutes(routes){(0,_utils.ensureRoutes)(routes);this.root.__children.push(...(0,_utils.toArray)(routes));return this.getRoutes()}/**
...
return pathname}const base=this.__effectiveBaseUrl,normalizedUrl=this.constructor.__createUrl(pathname,base).href;if(normalizedUrl.slice(0,base.length)===base){return normalizedUrl.slice(base.length)}}}Resolver.pathToRegexp=_pathToRegexp.default;var _default=Resolver;_exports.default=_default});