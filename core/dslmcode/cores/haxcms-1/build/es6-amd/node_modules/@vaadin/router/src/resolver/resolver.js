define(["exports", "./path-to-regexp.js", "./matchRoute.js", "./resolveRoute.js", "../utils.js"], function (_exports, _pathToRegexp, _matchRoute, _resolveRoute, _utils) {
  ...
  class Resolver {
    ...
    setRoutes(routes) {
      ...
      const newRoutes = [...(0, _utils.toArray)(routes)];
    ...
    addRoutes(routes) {
      ...
      this.root.__children.push(...(0, _utils.toArray)(routes));
    ...
    resolve(pathnameOrContext) {
      const context = Object.assign({}, this.context, (0, _utils.isString)(pathnameOrContext) ? {
        pathname: pathnameOrContext
      } : pathnameOrContext);
      const match = (0, _matchRoute.default)(this.root, this.__normalizePathname(context.pathname), this.baseUrl);
