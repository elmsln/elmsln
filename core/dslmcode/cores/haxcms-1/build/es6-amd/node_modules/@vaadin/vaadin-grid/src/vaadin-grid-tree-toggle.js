define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/elements/custom-style.js","../../../@polymer/polymer/lib/utils/debounce.js","../../vaadin-themable-mixin/vaadin-themable-mixin.js","../../../@polymer/polymer/lib/utils/html-tag.js","../../../@polymer/polymer/lib/utils/async.js"],function(_exports,_polymerElement,_customStyle,_debounce,_vaadinThemableMixin,_htmlTag,_async){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.GridTreeToggleElement=void 0;/**
@license
 ...
 */class GridTreeToggleElement extends(0,_vaadinThemableMixin.ThemableMixin)(_polymerElement.PolymerElement){static get template(){return _htmlTag.html`
    <style>
      :host {
        display: inline-flex;
...
`}static get is(){return"vaadin-grid-tree-toggle"}static get properties(){return{/**
       ...
       */expanded:{type:Boolean,value:!1,reflectToAttribute:!0,notify:!0}}}ready(){super.ready();this.addEventListener("click",e=>this._onClick(e))}_onClick(e){if(this.leaf){return}e.preventDefault();this.expanded=!this.expanded}_levelChanged(level){const value=(+level).toString();this.style["---level"]=value;// Async is to make DOM updates applied before evaluating the style
// update, required for polyfilled RTL support in MSIE and Edge.
this._debouncerUpdateLevel=_debounce.Debouncer.debounce(this._debouncerUpdateLevel,_async.microTask,()=>this.updateStyles({"---level":value}))}}_exports.GridTreeToggleElement=GridTreeToggleElement;customElements.define(GridTreeToggleElement.is,GridTreeToggleElement)});