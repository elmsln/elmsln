define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/elements/custom-style.js", "../../../@polymer/polymer/lib/utils/debounce.js", "../../vaadin-themable-mixin/vaadin-themable-mixin.js", "../../../@polymer/polymer/lib/utils/html-tag.js", "../../../@polymer/polymer/lib/utils/async.js"], function (_exports, _polymerElement, _customStyle, _debounce, _vaadinThemableMixin, _htmlTag, _async) {
  ...
  */
  ...
  class GridTreeToggleElement extends (0, _vaadinThemableMixin.ThemableMixin)(_polymerElement.PolymerElement) {
    static get template() {
...
`;
    ...
    _levelChanged(level) {
      ...
      this._debouncerUpdateLevel = _debounce.Debouncer.debounce(this._debouncerUpdateLevel, _async.microTask, () => this.updateStyles({
        '---level': value
      }));
    }
