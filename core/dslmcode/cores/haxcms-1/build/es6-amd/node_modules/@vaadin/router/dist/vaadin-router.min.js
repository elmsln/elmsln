    ...
    A(t, e = t) {
      return this.D(e).then(n => {
        const r = n !== e ? n : t,
              ...
              i = (t, e) => {
          let n = void 0;
          return void 0 === e ? e = t.route : n = null, t.next(void 0, e, n).then(e => null === e || e === p ? o ? t : i(t, t.route.parent) : e);
        };
    ...
    W(t) {
      ...
      if (t.q = 0, t.T = !1, n.length) {
        ...
        if (t.T = r.length === n.length && t.q == r.length && this.J(t.result, e.result), t.T) {
          for (let s = r.length - 1; s >= 0; s--) n[s].path === r[s].path && t.search === e.search || (o = this.K(o, t, {
            prevent: i
          }, n[s]));

          for (let c = 0; c < r.length; c++) n[c].path === r[c].path && t.search === e.search || (o = this.V(o, t, {
            prevent: i,
            redirect: s
          }, r[c])), n[c].element.location = Y(t, n[c].route);
        } else for (let e = n.length - 1; e >= t.q; e--) o = this.K(o, t, {
          prevent: i
        }, n[e]);
      }

      for (let e = t.q; !t.T && e < r.length; e++) o = this.V(o, t, {
        prevent: i,
        redirect: s
      }, r[e]);
