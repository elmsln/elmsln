define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/elements/custom-style.js", "./vaadin-text-field.js", "../../../@polymer/polymer/lib/elements/dom-module.js", "../../../@polymer/polymer/lib/utils/html-tag.js"], function (_exports, _polymerElement, _customStyle, _vaadinTextField, _domModule, _htmlTag) {
  ...
  */
  const $_documentContainer = (0, _htmlTag.html)`<dom-module id="vaadin-number-field-template">
  <template>
    <style>
  ...
  class NumberFieldElement extends _vaadinTextField.TextFieldElement {
    static get is() {
    ...
    static get template() {
      if (!memoizedTemplate) {
        ...
        const styles = thisTemplate.content.querySelector('style'); // Add the buttons and styles to the text-field template
