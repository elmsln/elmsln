  ...
  class WebSocialShare {
    ...
    renderTargets() {
      if (!this.share || !this.share.config) {
        ...
        return this.share.config.map(config => (0, _chunk92e462c.h)("div", {
    ...
    renderButton(share) {
      if (share.facebook) {
        return (0, _chunk92e462c.h)("button", {
          onClick: $event => this.handleFacebookShare($event, share),
        ...
        return (0, _chunk92e462c.h)("button", {
          onClick: $event => this.handleTwitterShare($event, share),
        ...
        return (0, _chunk92e462c.h)("button", {
          onClick: $event => this.handleEmailShare($event, share),
        ...
        return (0, _chunk92e462c.h)("button", {
          onClick: $event => this.handleLinkedinShare($event, share),
        ...
        return (0, _chunk92e462c.h)("button", {
          onClick: $event => this.handlePinterestShare($event, share),
        ...
        return (0, _chunk92e462c.h)("button", {
          onClick: $event => this.handleRedditShare($event, share),
        ...
        return (0, _chunk92e462c.h)("button", {
          onClick: $event => this.handleWhatsappShare($event, share),
        ...
        return (0, _chunk92e462c.h)("button", {
          onClick: $event => this.handleCopyShare($event, share),
