define(["exports", "require"], function (_exports, _require) {
  ...
  const loadModule = (cmpMeta, hostRef, hmrVersionId) => {
    ...
    return new Promise((res, rej) => _require.default([
    /* webpackInclude: /\.entry\.js$/ */

    /* webpackExclude: /\.system\.entry\.js$/ */

    /* webpackMode: "lazy" */
    `./${bundleId}.entry.js${''}`], res, rej)).then(importedModule => {
      {
  ...
  const patchEsm = () => {
    ...
    if (!(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
      // @ts-ignore
      return new Promise((res, rej) => _require.default(['./css-shim-6aaf713d-9b13816a.js'], res, rej)).then(() => {
  ...
  const patchBrowser = () => {
    ...
    if (importMeta !== '') {
      ...
      if (!window.customElements) {
        ...
        // @ts-ignore
        return new Promise((res, rej) => _require.default(['./dom-76cc7c7d-0a082895.js'], res, rej)).then(() => opts);
      }
    }
    ...
    /* hasInitializedComponent */
      ...
      if (!styles.has(scopeId) && Cstr.style) {
        ...
        /* needsShadowDomShim */
            ...
            style = await new Promise((res, rej) => _require.default(['./shadow-css-4889ae62-23996f3f.js'], res, rej)).then(m => m.scopeCss(style, scopeId, false));
          }
