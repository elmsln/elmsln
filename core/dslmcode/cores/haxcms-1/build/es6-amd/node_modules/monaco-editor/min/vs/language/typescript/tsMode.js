 ...
 *-----------------------------------------------------------------------------*/
define("vs/language/typescript/workerManager", ["require", "exports"], function (e, t) {
  "use strict";
  ...
  var n = function () {
    function e(e, t) {
      var n = this;
      this._modeId = e, this._defaults = t, this._worker = null, this._idleCheckInterval = setInterval(function () {
    ...
    return e.prototype._stopWorker = function () {
      ...
      if (this._lastUsedTime = Date.now(), !this._client) {
        ...
        this._defaults.getEagerModelSync() && (e = e.then(function (e) {
          return t._worker.withSyncedResources(monaco.editor.getModels().filter(function (e) {
...
define("vs/language/typescript/languageFeatures", ["require", "exports"], function (e, t) {
  "use strict";
  ...
  (r = n || (n = {}))[r.None = 0] = "None", r[r.Block = 1] = "Block", r[r.Smart = 2] = "Smart";
  ...
  var o = function () {
    ...
    return e.prototype._positionToOffset = function (e, t) {
    ...
    function e(e, r, t) {
      ...
      o._defaults = e, o._selector = r, o._disposables = [], o._listener = Object.create(null);
      ...
      return o._disposables.push(monaco.editor.onDidCreateModel(i)), o._disposables.push(monaco.editor.onWillDisposeModel(a)), o._disposables.push(monaco.editor.onDidChangeModelLanguage(function (e) {
        a(e.model), i(e.model);
      })), o._disposables.push({
        dispose: function () {
      ...
      }), o._disposables.push(o._defaults.onDidChange(function () {
        for (var e = 0, t = monaco.editor.getModels(); e < t.length; e++) {
          var n = t[e];
          a(n), i(n);
        }
      })), monaco.editor.getModels().forEach(i), o;
    }

    return __extends(e, n), e.prototype.dispose = function () {
      ...
      this._worker(i).then(function (e) {
        ...
        return r || t.push(e.getSyntacticDiagnostics(i.toString())), o || t.push(e.getSemanticDiagnostics(i.toString())), u.join(t);
      }).then(function (e) {
        ...
        monaco.editor.setModelMarkers(monaco.editor.getModel(i), a._selector, t);
  ...
  var a = function (e) {
    ...
    return __extends(u, e), Object.defineProperty(u.prototype, "triggerCharacters", {
      get: function () {
        return ["."];
      },
      enumerable: !0,
      configurable: !0
    }), u.prototype.provideCompletionItems = function (e, t, n, r) {
      e.getWordUntilPosition(t);

      var o = e.uri,
          i = this._positionToOffset(o, t);

      return this._worker(o).then(function (e) {
        return e.getCompletionsAtPosition(o.toString(), i);
      }).then(function (e) {
        if (e) return {
          suggestions: e.entries.map(function (e) {
            return {
              uri: o,
              position: t,
              label: e.name,
              insertText: e.name,
              sortText: e.sortText,
              kind: u.convertKind(e.kind)
            };
          })
        };
      });
    }, u.prototype.resolveCompletionItem = function (e, t, n, r) {
      var o = this,
          i = n,
          a = i.uri,
          s = i.position;
      return this._worker(a).then(function (e) {
        return e.getCompletionEntryDetails(a.toString(), o._positionToOffset(a, s), i.label);
      }).then(function (e) {
        return e ? {
          uri: a,
          position: s,
          label: e.name,
          kind: u.convertKind(e.kind),
          detail: c(e.displayParts),
          documentation: {
            value: c(e.documentation)
          }
        } : i;
      });
    }, u.convertKind = function (e) {
      switch (e) {
  ...
  var l = function (t) {
    ...
    return __extends(e, t), e.prototype.provideSignatureHelp = function (e, t, n) {
      var r = this,
          o = e.uri;
      return this._worker(o).then(function (e) {
        return e.getSignatureHelpItems(o.toString(), r._positionToOffset(o, t));
      }).then(function (e) {
        if (e) {
          var t = {
          ...
          return e.items.forEach(function (i) {
            var a = {
              label: "",
              documentation: null,
              parameters: []
            };
            a.label += c(i.prefixDisplayParts), i.parameters.forEach(function (e, t, n) {
              var r = c(e.displayParts),
                  o = {
                label: r,
                documentation: c(e.documentation)
              };
              a.label += r, a.parameters.push(o), t < n.length - 1 && (a.label += c(i.separatorDisplayParts));
            }), a.label += c(i.suffixDisplayParts), t.signatures.push(a);
          }), t;
        }
      });
    }, e;
  ...
  var p = function (e) {
    ...
    return __extends(t, e), t.prototype.provideHover = function (e, t, n) {
      var o = this,
          i = e.uri;
      return this._worker(i).then(function (e) {
        return e.getQuickInfoAtPosition(i.toString(), o._positionToOffset(i, t));
      }).then(function (e) {
        if (e) {
          var t = c(e.documentation),
              n = e.tags ? e.tags.map(function (e) {
            var t = "*@" + e.name + "*";
  ...
  var g = function (e) {
    ...
    return __extends(t, e), t.prototype.provideDocumentHighlights = function (e, t, n) {
      var r = this,
          o = e.uri;
      return this._worker(o).then(function (e) {
        return e.getOccurrencesAtPosition(o.toString(), r._positionToOffset(o, t));
      }).then(function (e) {
        if (e) return e.map(function (e) {
          return {
            range: r._textSpanToRange(o, e.textSpan),
            kind: e.isWriteAccess ? monaco.languages.DocumentHighlightKind.Write : monaco.languages.DocumentHighlightKind.Text
          };
        });
      });
    }, t;
  ...
  var m = function (e) {
    ...
    return __extends(t, e), t.prototype.provideDefinition = function (e, t, n) {
      var a = this,
          r = e.uri;
      return this._worker(r).then(function (e) {
        return e.getDefinitionAtPosition(r.toString(), a._positionToOffset(r, t));
      }).then(function (e) {
        if (e) {
          for (var t = [], n = 0, r = e; n < r.length; n++) {
            var o = r[n],
                i = s.parse(o.fileName);
            monaco.editor.getModel(i) && t.push({
              uri: i,
  ...
  var f = function (e) {
    ...
    return __extends(t, e), t.prototype.provideReferences = function (e, t, n, r) {
      var a = this,
          o = e.uri;
      return this._worker(o).then(function (e) {
        return e.getReferencesAtPosition(o.toString(), a._positionToOffset(o, t));
      }).then(function (e) {
        if (e) {
          for (var t = [], n = 0, r = e; n < r.length; n++) {
            var o = r[n],
  ...
  var d = function (e) {
    ...
    return __extends(t, e), t.prototype.provideDocumentSymbols = function (e, t) {
      var u = this,
          c = e.uri;
      return this._worker(c).then(function (e) {
        ...
        if (e) {
          var s = function (e, t, n) {
            var r = {
              name: t.text,
              detail: "",
              kind: _[t.kind] || monaco.languages.SymbolKind.Variable,
              range: u._textSpanToRange(c, t.spans[0]),
              selectionRange: u._textSpanToRange(c, t.spans[0]),
              containerName: n
            };
            if (t.childItems && 0 < t.childItems.length) for (var o = 0, i = t.childItems; o < i.length; o++) {
              var a = i[o];
              s(e, a, r.name);
            }
            e.push(r);
  ...
  var v = function (e) {
    ...
    return __extends(t, e), t._convertOptions = function (e) {
      return {
    ...
    return __extends(t, e), t.prototype.provideDocumentRangeFormattingEdits = function (e, t, n, r) {
      var o = this,
          i = e.uri;
      return this._worker(i).then(function (e) {
        return e.getFormattingEditsForRange(i.toString(), o._positionToOffset(i, {
  ...
  var S = function (e) {
    ...
    return __extends(t, e), Object.defineProperty(t.prototype, "autoFormatTriggerCharacters", {
      get: function () {
        return [";", "}", "\n"];
      },
      enumerable: !0,
      ...
      var i = this,
          a = e.uri;
      return this._worker(a).then(function (e) {
        return e.getFormattingEditsAfterKeystroke(a.toString(), i._positionToOffset(a, t), n, v._convertOptions(r));
      }).then(function (e) {
        if (e) return e.map(function (e) {
...
}), define("vs/language/typescript/tsMode", ["require", "exports", "./workerManager", "./languageFeatures"], function (e, t, o, i) {
  "use strict";

  var n, r;

  function a(e, t) {
    var r = new o.WorkerManager(t, e),
        n = function (e) {
