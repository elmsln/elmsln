...
!function (e) {
    ...
    function t() {
      ...
      switch (e) {
        ...
        case 57:
          return n += function () {
            var e = a;
            if (48 === i.charCodeAt(a)) a++;else for (a++; a < i.length && h(i.charCodeAt(a));) a++;
  ...
  t.getLocation = function (e, o) {
    ...
    return {
      ...
      isAtPropertyKey: u,
      matches: function (e) {
        for (var t = 0, r = 0; t < e.length && r < i.length; r++) if (e[t] === i[r] || "*" === e[t]) t++;else if ("**" !== e[t]) return !1;
  ...
  function n(e, t, r, n, o) {
    for (var i, a = t.slice(), s = S.parseTree(e, []), c = void 0, u = void 0; 0 < a.length && (u = a.pop(), void 0 === (c = S.findNodeAtLocation(s, a)) && void 0 !== r);) r = "string" == typeof u ? ((i = {})[u] = r, i) : [r];
...
!function (e) {
        ...
        case "array":
          !function (i, e, a, s) {
            if (Array.isArray(e.items)) {
              ...
              }), i.items.length > c.length) if ("object" == typeof e.additionalItems) for (var t = c.length; t < i.items.length; t++) {
                var r = new I();
  ...
  t.JSONDocument = w, t.parse = function (s, e) {
    ...
    function m(e, t) {
      ...
      if (t[n.value] = i ? (d(T("DuplicateKeyWarning", "Duplicate object key"), C.ErrorCode.DuplicateKey, r.keyNode.offset, r.keyNode.offset + r.keyNode.length, j.DiagnosticSeverity.Warning), "object" == typeof i && d(T("DuplicateKeyWarning", "Duplicate object key"), C.ErrorCode.DuplicateKey, i.keyNode.offset, i.keyNode.offset + i.keyNode.length, j.DiagnosticSeverity.Warning), !0) : r, 6 === f.getToken()) r.colonOffset = f.getTokenOffset(), l();else if (p(T("ColonExpected", "Colon expected"), C.ErrorCode.ColonExpected), 10 === f.getToken() && s.positionAt(n.offset + n.length).line < s.positionAt(f.getTokenOffset()).line) return r.length = n.length, r;
      var a = v(r, n.value);
  ...
  var b = e("../parser/jsonParser"),
    ...
    return e.prototype.doResolve = function (e) {
      for (var t = this.contributions.length - 1; 0 <= t; t--) if (this.contributions[t].resolveCompletion) {
  ...
  var i = function () {
    ...
    return e.prototype.getRegisteredSchemaIds = function (r) {
      ...
      var s = this,
        ...
        if (o) for (var i in o) o.hasOwnProperty(i) && !e.hasOwnProperty(i) && (e[i] = o[i]);else a.push(l("json.schema.invalidref", "$ref '{0}' in '{1}' can not be resolved.", n, r));
      },
          f = function (r, n, o, e) {
        ...
        for (var c = [e], t = [], o = [], i = function (e) {
          ...
          !function () {
            ...
            for (var r = 0, n = e; r < n.length; r++) {
              var o = n[r];
              if ("object" == typeof o) for (var i in o) {
                var a = o[i];
  ...
  var n,
      a = monaco.Promise;
  "undefined" != typeof fetch && (n = function (e) {
