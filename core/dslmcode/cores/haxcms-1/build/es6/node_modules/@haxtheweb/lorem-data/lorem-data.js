import{LitElement as e,html as t,css as a}from"../../lit/index.js";import{LoremDataBehaviors as r}from"./lib/lorem-data-behaviors.js";class LoremData extends(r(e)){static get styles(){return[a`
      ...
      `]}__revokeRemovedSchemaUrls(){const e=Object.keys(this.schemas||{});Object.keys(this.__downloadUrls||{}).forEach(t=>{e.includes(t)||(globalThis.URL.revokeObjectURL(this.__downloadUrls[t]),delete this.__downloadUrls[t])})}__revokeAllDownloadUrls(){Object.keys(this.__downloadUrls||{}).forEach(e=>{globalThis.URL.revokeObjectURL(this.__downloadUrls[e]),delete this.__downloadUrls[e]})}static get tag(){return"lorem-data"}static get properties(){return{schemas:{type:Object}}}constructor(){super(),this.schemas={},this.__downloadUrls={}}render(){return t`
      <button @click="${this.saveAll}">Save All</button>
      ${Object.keys(this.schemas||[]).map(e=>t`
          <p>
            <label>
              <a href="${this.saveDataUrl(this.schemas[e],e)}" download="${e}"
                >${e}:
              </a>
              <br />
