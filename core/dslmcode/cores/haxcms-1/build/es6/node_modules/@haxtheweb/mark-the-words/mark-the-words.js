      ...
      feedback indicating correctness of your answer.
          ...
          ${this.showAnswer?e` <p class="feedback">
                ...
                ${this.wordList.filter((e=>!e.selected&&e.unselectedFeedback)).length>0?e`
                    ...
                    `:s}
                ${this.querySelector&&this.querySelector('[slot="feedbackIncorrect"]')?e`<slot
          ...
          ${this.showAnswer&&this.numberCorrect===this.displayedAnswers.filter((e=>e.correct)).length?e` <p class="feedback">${this.correctText}</p>
                ${this.querySelector&&this.querySelector('[slot="feedbackCorrect"]')?e`<slot
        ...
        `}`}static get haxProperties(){return new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(MarkTheWords.tag,MarkTheWords);