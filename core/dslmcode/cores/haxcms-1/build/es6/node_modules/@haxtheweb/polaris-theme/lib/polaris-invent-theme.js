...
import{html as e,css as t}from"../../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as o}from"../../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{HAXCMSMobileMenuMixin as a}from"../../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as r}from"../../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{store as s}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{MicroFrontendRegistry as n}from"../../micro-frontend-registry/micro-frontend-registry.js";import{HAXCMSRememberRoute as l}from"../../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{QRCodeMixin as d}from"../../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{PrintBranchMixin as p}from"../../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{PDFPageMixin as c}from"../../haxcms-elements/lib/core/utils/PDFPageMixin.js";import"../../scroll-button/scroll-button.js";import"../../haxcms-elements/lib/ui-components/site/site-title.js";import"../../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../../haxcms-elements/lib/ui-components/navigation/site-menu.js";import"../../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../../haxcms-elements/lib/ui-components/layout/site-region.js";import{autorun as m,toJS as h}from"../../../mobx/dist/mobx.esm.js";import{DDDSuper as g}from"../../d-d-d/d-d-d.js";import{HAXCMSToastInstance as u}from"../../haxcms-elements/lib/core/haxcms-toast.js";import{LTIResizingMixin as v}from"../../haxcms-elements/lib/core/utils/LTIResizingMixin.js";class PolarisInventTheme extends(v(r(l(c(p(d(o(a(g(i)))))))))){static get styles(){return[super.styles,t`
    ...
    `}static get properties(){let e={};return super.properties&&(e=super.properties),{...e,dataPalette:{type:Number,reflect:!0,attribute:"data-palette"},searchTerm:{type:String},siteDescription:{type:String},imageLink:{type:String},image:{type:String},imageAlt:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"polaris-invent-theme"}appStoreReady(e){if(globalThis.HaxStore&&globalThis.HaxStore.requestAvailability()){let e=globalThis.HaxStore.requestAvailability();["polaris-cta","polaris-mark","polaris-story-card","polaris-tile","media-quote"].map(t=>{let i=globalThis.document.createElement(t);e.haxAutoloader.appendChild(i)}),this.windowControllersLoaded.abort()}}constructor(){super(),this.dataPalette=8,u.style.setProperty("--rpg-character-toast-display","none"),u.style.setProperty("--rpg-character-toast-mid-background-image","none"),u.style.setProperty("--rpg-character-toast-right-background-image","none"),u.style.setProperty("--rpg-character-toast-left-background-image","none"),u.style.setProperty("--rpg-character-toast-mid-padding",0),u.style.setProperty("--rpg-character-toast-height","96px"),u.style.backgroundColor="light-dark(var(--ddd-accent-6), var(--ddd-primary-4))",this.windowControllersLoaded=new AbortController,globalThis.addEventListener("hax-store-app-store-loaded",this.appStoreReady.bind(this),{once:!0,passive:!0,signal:this.windowControllersLoaded.signal}),this.searchTerm="",this.imageAlt="",this.image="",this.imageLink="",this.__disposer=this.__disposer?this.__disposer:[],this.__disposer.push(m(e=>{if(s.themeData&&s.themeData.variables){const e=h(s.themeData.variables);this.imageAlt=e.imageAlt,this.image=e.image,this.imageLink=e.imageLink}})),this.__disposer.push(m(e=>{this.siteDescription=h(s.siteDescription)})),this.__disposer.push(m(e=>{this.activeManifestIndex=h(s.activeManifestIndex)})),this.__disposer.push(m(e=>{s.activeItem&&s.activeItem.metadata&&s.activeItem.metadata.updated&&(this.pageTimestamp=h(s.activeItem.metadata.updated))}))}siteModalClick(e){import("../../haxcms-elements/lib/ui-components/site/site-search.js").then(e=>{"search"!==s.getInternalRoute()&&globalThis.history.replaceState({},null,"x/search");const t=new URLSearchParams(s.currentRouterLocation.search),i=globalThis.SimpleModal.requestAvailability().querySelector("site-search").shadowRoot.querySelector("simple-fields-field");i.focus(),t.get("search")&&(i.value=t.get("search"),setTimeout(()=>{i.select()},0))})}}globalThis.customElements.define(PolarisInventTheme.tag,PolarisInventTheme);export{PolarisInventTheme};