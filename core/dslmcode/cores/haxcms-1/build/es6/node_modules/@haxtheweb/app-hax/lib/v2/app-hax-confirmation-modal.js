import{LitElement as t,html as e,css as o}from"../../../../lit/index.js";import{DDDSuper as a}from"../../../d-d-d/d-d-d.js";import"../../../simple-modal/simple-modal.js";import"../../../simple-icon/lib/simple-icon-lite.js";import"../../../simple-icon/lib/simple-icons.js";import{store as d}from"./AppHaxStore.js";export class AppHaxConfirmationModal extends(a(t)){static get tag(){return"app-hax-confirmation-modal"}constructor(){super(),this.open=!1,this.title="",this.message="",this.confirmText="Confirm",this.cancelText="Cancel",this.confirmAction=null,this.cancelAction=null,this.dangerous=!1,this.cancelIsNeutral=!1,this.cancelActionOnPassiveClose=!0,this._confirmed=!1,this._cancelClicked=!1}static get properties(){return{open:{type:Boolean,reflect:!0},title:{type:String},message:{type:String},confirmText:{type:String},cancelText:{type:String},dangerous:{type:Boolean},cancelIsNeutral:{type:Boolean},cancelActionOnPassiveClose:{type:Boolean,attribute:"cancel-action-on-passive-close"}}}static get styles(){return[super.styles,o`
        :host {
      ...
      `]}openModal(){document.body.style.overflow="hidden",this._confirmed=!1,this._cancelClicked=!1,this.open=!0;const t=this.shadowRoot.querySelector("simple-modal");t&&(t.opened=!0)}closeModal(){this._cancelClicked=!0;const t=this.shadowRoot.querySelector("simple-modal");t?t.opened=!1:this.handleModalClosed()}handleModalClosed(t){if(document.body.style.overflow="",this.open=!1,this._confirmed);else{const t=this._cancelClicked||this.cancelActionOnPassiveClose;t&&this.cancelAction&&"function"==typeof this.cancelAction&&this.cancelAction(),t&&!this.cancelIsNeutral&&d.appEl&&d.appEl.playSound&&d.appEl.playSound("error")}this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}confirmModal(){this._confirmed=!0;const t=this.shadowRoot.querySelector("simple-modal");t?t.opened=!1:document.body.style.overflow="",d.appEl&&d.appEl.playSound&&d.appEl.playSound("success"),this.confirmAction&&"function"==typeof this.confirmAction&&this.confirmAction()}render(){return e`
      <simple-modal
        .opened="${this.open}"
        title="${this.title}"
