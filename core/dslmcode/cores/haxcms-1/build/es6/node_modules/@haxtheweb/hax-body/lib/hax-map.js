import{html as t,css as i}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icon-lite.js";import"./hax-toolbar-item.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import"../../simple-icon/lib/simple-icon-button-lite.js";import{HAXStore as a}from"./hax-store.js";import{normalizeEventPath as l,nodeToHaxElement as o}from"../../utils/utils.js";import{HaxTrayDetailHeadings as s}from"./hax-ui-styles.js";import{I18NMixin as n}from"../../i18n-manager/lib/I18NMixin.js";import{autorun as r,toJS as c}from"../../../mobx/dist/mobx.esm.js";import{SimpleColors as h}from"../../simple-colors/simple-colors.js";class HaxMap extends(n(h)){static get styles(){return[super.styles,...s,i`
        :host {
          display: block;
        }
        .container {
      ...
      `]}constructor(){super(),this.elementList=[],this.dark=!1,this.t={contentStatistics:"Content Statistics",words:"Words",headings:"Headings",paragraphs:"Paragraphs",widgets:"Widgets",characters:"Characters",listView:"List view"},this.registerLocalization({context:this,namespace:"hax"}),r((()=>{a.editMode&&(this.activeNode=c(a.activeNode),setTimeout((()=>{this.requestUpdate()}),0))})),r((()=>{const t=(c(a.globalPreferences)||{}).haxUiTheme||"hax";this.dark="haxdark"===t}))}async updateHAXMap(t){let e=[];for(var i=0;i<a.activeHaxBody.childNodes.length;i++){const t=a.activeHaxBody.childNodes[i];let s=await o(t,null);if(s.parent=null,s.node=t,e.push(s),t.children&&t.children.length>0)for(var l=0;l<t.children.length;l++){let i=await o(t.children[l],null);i.parent=s.tag,i.node=t.children[l],["span","strong","b","sup","sub","i","em","div","strike"].includes(i.tag)||e.push(i)}}this.calcStats(e);let s=[];for(i=0;i<e.length;i++){let t=a.haxSchemaFromTag(e[i].tag);t.gizmo?s.push({node:e[i].node,tag:e[i].tag,parent:e[i].parent,icon:t.gizmo.icon,name:t.gizmo.title}):e[i].tag&&e[i].tag.includes("-")?s.push({tag:e[i].tag,parent:e[i].parent,icon:"hax:templates",name:"Widget"}):s.push({tag:e[i].tag,parent:e[i].parent,icon:"hax:paragraph",name:"HTML block"})}this.elementList=[...s]}calcStats(t){if(t&&a.activeHaxBody.innerText){let i={c:a.activeHaxBody.innerText.length,w:parseInt(a.activeHaxBody.innerText.split(/\s+/g).length-1),h:0,b:0,p:0,e:0};for(var e in t.forEach((t=>{switch(t.tag){case"blockquote":case"div":case"span":case"p":case"ul":case"ol":case"strong":case"em":i.p++;break;case"h1":case"h2":case"h3":case"h4":case"h5":case"h6":i.h++;break;default:i.e++}})),i)this[`${e}Count`]=i[e]}}render(){return t`${this.hidden?"":t` <h5>${this.t.contentStatistics}</h5>
          ...
          <ul>
            ${this.indentedElements(this.elementList).map(((e,i)=>t`
              ...
              `))}
          </ul>`} `}editItem(t){!1!==t&&this.elementList[t].node&&this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,cancelable:!0,composed:!0,detail:{target:this.elementList[t].node,eventName:"content-edit",value:!0}}))}isLocked(t){if(!1!==t&&this.elementList[t].node){let e=this.elementList[t].node;return!!(null!=e.getAttribute("data-hax-lock")||e.parentNode&&null!=e.parentNode.getAttribute("data-hax-lock"))}}itemOp(t,e){if(!1!==t&&this.elementList[t].node&&e){let i=this.elementList[t].node;if(null==i.getAttribute("data-hax-lock")&&i.parentNode&&null==i.parentNode.getAttribute("data-hax-lock"))switch(e){case"lock":i.setAttribute("data-hax-lock","data-hax-lock"),this.dispatchEvent(new CustomEvent("hax-toggle-active-node-lock",{bubbles:!0,composed:!0,cancelable:!0,detail:{lock:!0,node:i}}));break;case"delete":a.activeHaxBody.haxDeleteNode(i);break;case"down":i.nextElementSibling&&a.activeHaxBody.haxMoveGridPlate(i);break;case"up":i.previousElementSibling&&"PAGE-BREAK"!==i.previousElementSibling.tagName&&a.activeHaxBody.haxMoveGridPlate(i,-1)}else"lock"===e&&(i.removeAttribute("data-hax-lock"),this.dispatchEvent(new CustomEvent("hax-toggle-active-node-lock",{bubbles:!0,composed:!0,cancelable:!0,detail:{lock:!1,node:i}})));setTimeout((()=>{this.requestUpdate()}),0)}}indentedElements(t){let e="h1";return t.map((t=>{let i=t;return null===i.parent&&(i.parent=e),["h1","h2","h3","h4","h5","h6"].includes(i.tag)&&(i.parent=i.tag,e=i.tag),i}))}goToItem(t){if(!1!==t&&this.elementList[t].node){let e=this.elementList[t].node;a.activeNode=e,e.classList.add("blinkfocus"),"function"==typeof e.scrollIntoViewIfNeeded?e.scrollIntoViewIfNeeded(!1):e.scrollIntoView({behavior:"smooth",inline:"center",block:"center"}),setTimeout((()=>{e.classList.remove("blinkfocus")}),500)}}scrollInMap(){var t=l(e)[0];this.goToItem(t.getAttribute("data-index"))}static get tag(){return"hax-map"}static get properties(){return{...super.properties,opened:{type:Boolean},hidden:{type:Boolean,reflect:!0},dark:{type:Boolean,reflect:!0},elementList:{type:Array},cCount:{type:String},wCount:{type:String},bCount:{type:String},hCount:{type:String},pCount:{type:String},eCount:{type:String},activeNode:{type:Object}}}}globalThis.customElements.define(HaxMap.tag,HaxMap);export{HaxMap};