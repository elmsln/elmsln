...
import{LitElement as t,html as e,css as o}from"../../../lit/index.js";const A11yMenuButtonItemBehaviors=function(t){return class extends t{static get styles(){return[o`
        ...
        <a
          ...
          tabindex="${this.disabled?-1:void 0}"
      ...
      `}get menuItem(){return this.shadowRoot&&this.shadowRoot.querySelector("[role=menuitem]")?this.shadowRoot.querySelector("[role=menuitem]"):void 0}focus(){this.menuItem&&this.menuItem.focus()}_handleDisabledClick(t){this.disabled&&(t.preventDefault(),t.stopPropagation())}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent("add-a11y-menu-button-item",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new CustomEvent("remove-a11y-menu-button-item",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}};class A11yMenuButtonItem extends(A11yMenuButtonItemBehaviors(t)){}globalThis.customElements.define(A11yMenuButtonItem.tag,A11yMenuButtonItem);export{A11yMenuButtonItem,A11yMenuButtonItemBehaviors};