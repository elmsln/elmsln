...
import{html as e,css as r}from"../../lit/index.js";import{SimpleColors as i}from"../simple-colors/simple-colors.js";class SimpleRangeInput extends i{constructor(){super(),this.dragging=!1,this.label="Range input",this.min=0,this.max=100,this.step=1,this.value=0,this.immediateValue=0,this.disabled=!1,this.addEventListener("mousedown",()=>{this.dragging=!0}),this.addEventListener("mouseup",()=>{this.dragging=!1,this.value=this.immediateValue}),this.addEventListener("keydown",()=>{this.dragging=!0,setTimeout(()=>{this.value=this.immediateValue},0)}),this.addEventListener("keyup",()=>{this.dragging=!1,this.value=this.immediateValue})}static get properties(){return{...super.properties,dragging:{type:Boolean,reflect:!0},immediateValue:{type:Number,attribute:"immediate-value"},value:{type:Number,reflect:!0},min:{type:Number},step:{type:Number},max:{type:Number},label:{type:String},disabled:{type:Boolean,reflect:!0}}}static get tag(){return"simple-range-input"}static get styles(){return[super.styles,r`
      ...
      /><label id="label">${this.label}</label>`}_inputChanged(e){this.immediateValue=e.target.value}_valueChanged(e){this.value=e.target.value}firstUpdated(){super.firstUpdated(),setTimeout(()=>{this.__ready=!0},0)}updated(e){super.updated&&super.updated(e),this.shadowRoot&&this.__ready&&e.forEach((e,r)=>{"immediateValue"===r&&(this.dragging?this.dispatchEvent(new CustomEvent("immediate-value-changed",{detail:{value:this.immediateValue}})):this.value=this.immediateValue),"value"===r&&this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:this.value}}))})}}globalThis.customElements.define(SimpleRangeInput.tag,SimpleRangeInput);export{SimpleRangeInput};