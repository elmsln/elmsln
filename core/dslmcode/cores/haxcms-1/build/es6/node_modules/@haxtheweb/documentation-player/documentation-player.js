 ...
 */
import{LitElement as t,html as e,css as i,render as s,nothing as l}from"../../lit/index.js";import"../simple-img/simple-img.js";import"../simple-icon/lib/simple-icon-button-lite.js";import"../play-list/play-list.js";import"../code-sample/code-sample.js";import"../code-editor/lib/code-pen-button.js";import{nodeToHaxElement as r}from"../utils/utils.js";class DocumentationPlayer extends t{constructor(){super(),this.label="",this.haxSchema=[],this.imageUrl="",this.url="",setTimeout((async()=>{for(let t=0;t<this.children.length;t++)this.haxSchema.push(await r(this.children[t]))}),0)}static get properties(){return{label:{type:String},haxSchema:{type:Array,attribute:!1},imageUrl:{type:String,attribute:"image-url"},url:{type:String,attribute:"url"}}}static get styles(){let t=[];return super.styles&&(t=super.styles),[t,i`
        :host {
          display: block;
        }
      `]}_getDataString(t){return JSON.stringify(t).replace(/"/g,"&quot;").replace(/'/g,"&apos;")}codePenData(t){return this._getDataString({title:t,html:this.innerHTML.trim(),head:'<script>globalThis.WCGlobalCDNPath="https://cdn.webcomponents.psu.edu/cdn/";<\/script><script src="https://cdn.webcomponents.psu.edu/cdn/build.js"><\/script>'})}renderPlayListTemplate(){let t=globalThis.document.createElement("template");s(e` <div>
