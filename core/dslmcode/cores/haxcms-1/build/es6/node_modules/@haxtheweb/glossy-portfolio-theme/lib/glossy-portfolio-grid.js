 ...
 */
import{LitElement as t,html as e,css as i}from"../../../lit/index.js";import{DDDSuper as a}from"../../d-d-d/d-d-d.js";import{I18NMixin as s}from"../../i18n-manager/lib/I18NMixin.js";import{store as r}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as l,toJS as o}from"../../../mobx/dist/mobx.esm.js";export class GlossyPortfolioGrid extends(a(s(t))){static get tag(){return"glossy-portfolio-grid"}constructor(){super(),this.filtersList=[],this.filteredData=[],this.activeFilter="",this.__disposer=this.__disposer||[],this.__disposer.push(l(t=>{const e=o(r.activeItem);if(e){this.activeItem=e,this.activeParent=r.findItem(e.parent)||"";const t=r.getItemChildren(r.activeId);this.title="",this.data=[];let i=[];if(t&&t.length>0)this.data=[...t],this.title=this.activeItem&&this.activeItem.title||"";else if(this.activeItem.metadata.relatedItems){this.title="Related Content";let t=r.findItem(e.metadata.relatedItems);this.data.some(e=>e.id===t.id)||i.push(t),this.data=[...i]}else if(this.activeParent){this.title="Related Content";let t=[...r.getItemChildren(this.activeParent.id)],e=t.findIndex(t=>t.id===this.activeItem.id);t[e-1]&&i.push(t[e-1]),t[e+1]&&i.push(t[e+1]),this.data=[...i]}}}))}static get properties(){return{...super.properties,filteredData:{type:Array},data:{type:Array},filtersList:{type:Array}}}static get styles(){return[super.styles,i`
      :host {
        display: block;
