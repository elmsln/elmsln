import{html as e,css as i}from"../../../../lit/index.js";import"../../../simple-datetime/simple-datetime.js";import{toJS as t}from"../../../../mobx/dist/mobx.esm.js";import{store as o}from"./AppHaxStore.js";import{SimpleColors as a}from"../../../simple-colors/simple-colors.js";export class AppHaxSiteDetails extends a{static get tag(){return"app-hax-site-details"}constructor(){super(),this.need="all need to succeed",this.details={},this.siteId="",this.detailOps=[{name:"Copy",op:"copySite",icon:"icons:content-copy"},{name:"Download",op:"downloadSite",icon:"file-download"},{name:"Archive",op:"archiveSite",icon:"icons:archive"}]}static get properties(){return{...super.properties,details:{type:Object},siteId:{type:String,attribute:"site-id"}}}static get styles(){return[super.styles,i`
      ...
      `]}siteOperation(e){o.appEl.playSound("click");var i=e.target;"DIV"===i.tagName&&(i=i.parentNode);const a=globalThis.document.createElement("div"),s=i.getAttribute("data-site-operation"),n=i.getAttribute("data-site-operation-name"),l=i.getAttribute("data-site");o.activeSiteOp=s,o.activeSiteId=l,import("../../../simple-modal/simple-modal.js").then(()=>{setTimeout(()=>{const e=t(o.manifest.items.filter(e=>e.id===l).pop());a.appendChild(globalThis.document.createTextNode(`Are you sure you want to ${s.replace("Site","")} ${e.metadata.site.name}?`));const d=globalThis.document.createElement("div"),p=globalThis.document.createElement("button");p.innerText="Confirm",p.classList.add("hax-modal-btn"),p.addEventListener("click",this.confirmOperation.bind(this)),d.appendChild(p);const r=globalThis.document.createElement("button");r.innerText="Cancel",r.classList.add("hax-modal-btn"),r.classList.add("cancel"),r.addEventListener("click",this.cancelOperation.bind(this)),d.appendChild(r),this.dispatchEvent(new CustomEvent("simple-modal-show",{bubbles:!0,cancelable:!0,composed:!0,detail:{title:`${n} ${e.metadata.site.name}?`,elements:{content:a,buttons:d},invokedBy:i,styles:{"--simple-modal-titlebar-background":"orange","--simple-modal-titlebar-color":"light-dark(black, white)","--simple-modal-width":"30vw","--simple-modal-min-width":"300px","--simple-modal-z-index":"100000000","--simple-modal-height":"20vh","--simple-modal-min-height":"300px","--simple-modal-titlebar-height":"80px"}}}))},0)})}cancelOperation(){o.activeSiteOp="",o.activeSiteId=null,globalThis.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,composed:!0})),o.appEl.playSound("error")}async confirmOperation(){const e=t(o.activeSiteOp),i=t(o.activeSite);await o.AppHaxAPI.makeCall(e,{site:{name:i.metadata.site.name,id:i.id}},!0,()=>{"downloadSite"===t(o.activeSiteOp)?globalThis.open(o.AppHaxAPI.lastResponse.downloadSite.data.link,"_blank"):o.refreshSiteListing()}),globalThis.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,composed:!0})),o.appEl.playSound("success"),o.toast(`${i.metadata.site.name} ${e.replace("Site","")} successful!`,3e3,{hat:"random"})}render(){return e`
