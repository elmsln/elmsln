 ...
 */
import{DDD as e}from"../../d-d-d/d-d-d.js";import{css as t,html as o}from"../../../lit/index.js";import{autorun as i,toJS as n}from"../../../mobx/dist/mobx.esm.js";import{ChatStore as l}from"./chat-agent-store.js";class ChatDeveloperPanel extends e{static get tag(){return"chat-developer-panel"}constructor(){super(),this.chatLog=[],this.context=null,this.engine=null,this.isFullView=null,this.__disposer=[],this.__disposer.push(i(()=>{this.chatLog=n(l.chatLog)})),this.__disposer.push(i(()=>{this.context=n(l.context)})),this.__disposer.push(i(()=>{this.engine=n(l.engine)})),this.__disposer.push(i(()=>{this.isFullView=n(l.isFullView)}))}static get styles(){return[super.styles,t`
