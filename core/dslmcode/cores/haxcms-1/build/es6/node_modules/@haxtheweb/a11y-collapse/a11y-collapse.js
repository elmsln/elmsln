import{html as e,css as a}from"../../lit/index.js";import{DDD as t}from"../d-d-d/d-d-d.js";import"../simple-icon/lib/simple-icon-button-lite.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import"../simple-tooltip/simple-tooltip.js";class A11yCollapse extends t{static get styles(){return[super.styles,a`
        :host {
          display: block;
    ...
    `}_onClick(){this.disabled||(this.toggle(),this.shadowRoot.querySelector("simple-tooltip").hide(),this.dispatchEvent(new CustomEvent("a11y-collapse-click",{bubbles:!0,cancelable:!0,composed:!0,detail:this})))}_makeAccordionButton(){this._makeHeadingButton()}}globalThis.customElements.define(A11yCollapse.tag,A11yCollapse);export{A11yCollapse};