export class licenseList{constructor(e="full"){let t={by:{name:"Attribution",link:"https://creativecommons.org/licenses/by/4.0/",image:"https://i.creativecommons.org/l/by/4.0/88x31.png"},"by-sa":{name:"Attribution Share a like",link:"https://creativecommons.org/licenses/by-sa/4.0/",image:"https://i.creativecommons.org/l/by-sa/4.0/88x31.png"},"by-nd":{name:"Attribution No derivatives",link:"https://creativecommons.org/licenses/by-nd/4.0/",image:"https://i.creativecommons.org/l/by-nd/4.0/88x31.png"},"by-nc":{name:"Attribution non-commercial",link:"https://creativecommons.org/licenses/by-nc/4.0/",image:"https://i.creativecommons.org/l/by-nc/4.0/88x31.png"},"by-nc-sa":{name:"Attribution non-commercial share a like",link:"https://creativecommons.org/licenses/by-nc-sa/4.0/",image:"https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png"},"by-nc-nd":{name:"Attribution Non-commercial No derivatives",link:"https://creativecommons.org/licenses/by-nc-nd/4.0/",image:"https://i.creativecommons.org/l/by-nc-nd/4.0/88x31.png"}};if("select"==e){var i={};for(var n in t)i[n]=t[n].name;return i}return t}}import{LitElement as e,html as t,css as i}from"../../lit/index.js";import{SchemaBehaviors as n}from"../schema-behaviors/schema-behaviors.js";import{DDDSuper as r}from"../d-d-d/d-d-d.js";class LicenseElement extends(n(r(e))){static get styles(){return[i`
    ...
    `}static get tag(){return"license-element"}static get properties(){return{...super.properties,title:{type:String},creator:{type:String},source:{type:String},licenseName:{type:String,attribute:"license-name"},licenseImage:{type:String,attribute:"license-image"},licenseLink:{type:String,attribute:"license-link"},license:{type:String},moreLabel:{type:String,attribute:"more-label"},moreLink:{type:String,attribute:"more-link"},hasMore:{type:Boolean,attribute:"has-more"}}}constructor(){super(),this.licenseList=new licenseList,this.creator="(author)",this.source=null,this.moreLabel="on the licensing details page"}updated(e){e.forEach((e,t)=>{"license"==t&&this._licenseUpdated(this[t]),"moreLink"==t&&(this.hasMode=this._computeHasMore(this.moreLink))})}static get haxProperties(){return{canScale:!1,canEditSource:!0,gizmo:{title:"License",description:"Provide a license for your work.",icon:"icons:copyright",color:"grey",tags:["Other","content","copyright","license","cc0","cc-by","cc-by-sa","cc-by-nd","cc-by-nc","cc-by-nc-sa","cc-by-nc-nd","citation"],handles:[{type:"license",source:"source",title:"title",author:"creator",license:"license"}],meta:{author:"HAXTheWeb core team"}},settings:{configure:[{property:"title",title:"Title",description:"Title of the cited work.",inputMethod:"textfield",icon:"editor:title"},{property:"source",title:"Source link",description:"Source URL for the licensed work.",inputMethod:"textfield",icon:"link",validationType:"url"},{property:"license",title:"License",description:"License applied to this work.",inputMethod:"select",options:new licenseList("select"),icon:"link"},{property:"creator",title:"Creator",description:"Creator or owner of this work.",inputMethod:"textfield",icon:"link"}],advanced:[{property:"moreLink",title:"Source link",description:"Link to additional licensing details.",inputMethod:"textfield",validationType:"url"},{property:"moreLabel",title:"More label",description:"Label for additional licensing details.",inputMethod:"textfield"}]},demoSchema:[{tag:"license-element",properties:{title:"Wonderland",creator:"Mad Hatter",source:"https://haxtheweb.org/",license:"by"},content:""}]}}_computeHasMore(e){return void 0!==e&&""!==e}_licenseUpdated(e){void 0!==e&&void 0!==this.licenseList[e]&&(this.licenseName=this.licenseList[e].name,this.licenseLink=this.licenseList[e].link,this.licenseImage=this.licenseList[e].image)}}globalThis.customElements.define(LicenseElement.tag,LicenseElement);export{LicenseElement};