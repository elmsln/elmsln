import{css as e,html as t}from"../../../../../lit/index.js";import{normalizeEventPath as s,localStorageGet as o,localStorageSet as r}from"../../../../utils/utils.js";import{HAXCMSI18NMixin as c}from"./HAXCMSI18NMixin.js";import{toJS as i,autorun as h}from"../../../../../mobx/dist/mobx.esm.js";import{store as l}from"../haxcms-site-store.js";const HAXCMSUserStylesMenuMixin=function(n){return class extends(c(n)){constructor(){super(),this.t.A="A",this.t.increaseFontSize="Increase font size",this.t.decreaseFontSize="Decrease font size",this.t.setFontToSerif="Set font to serif",this.t.setFontToSansSerif="Set font to sans serif",this.t.serif="Serif",this.t.sansSerif="Sans serif",this.t.day="Day",this.t.sepia="Sepia",this.t.night="Night",this.t.textSettings="Text settings",this.hideUserStylesMenu=!0,this.fontSize=o("haxcms-userPref-fontSize",1),this.fontFamily=o("haxcms-userPref-fontFamily",0),this.colorTheme=o("haxcms-userPref-colorTheme",0),this.addEventListener("click",this.checkUserStylesMenuOpen.bind(this)),h(()=>{const e=i(l.darkMode);Promise.resolve().then(()=>{const t=e;let s=o("haxcms-userPref-colorTheme",0);this.colorTheme=t?2:2===s?0:s})})}static get styles(){let t=[];return super.styles&&(t=super.styles),[t,e`
          :host([color-theme="0"]) {
        ...
        `]}HAXCMSUserStylesMenu(){return import("../../../../simple-icon/simple-icon.js"),import("../../../../simple-icon/lib/simple-icons.js"),import("../../../../simple-icon/lib/simple-icon-button-lite.js"),import("../../../../simple-popover/simple-popover.js"),import("../../../../simple-tooltip/simple-tooltip.js"),t`
        <simple-icon-button-lite
      ...
      `}static get properties(){return{...super.properties||{},hideUserStylesMenu:{type:Boolean},fontSize:{type:Number,reflect:!0,attribute:"font-size"},fontFamily:{type:Number,reflect:!0,attribute:"font-family"},colorTheme:{type:Number,reflect:!0,attribute:"color-theme"}}}checkUserStylesMenuOpen(e){var t=s(e);this.hideUserStylesMenu||t.includes(this.toggleUserStylesMenuTarget)||t.includes(this.shadowRoot.querySelector("#haxcmsuserstylesmenu"))||"BUTTON"===t.tagName||(this.hideUserStylesMenu=!0)}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{"editMode"==t&&this[t]&&(this.hideUserStylesMenu=!0)})}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.toggleUserStylesMenuTarget=this.shadowRoot.querySelector("#haxcmsuserstylesmenupopover"),this.shadowRoot.querySelector("#haxcmsuserstylesmenu").target=this.toggleUserStylesMenuTarget}toggleUserStylesMenu(e){this.hideUserStylesMenu=!this.hideUserStylesMenu}UserStylesSizeDown(e){this.fontSize>0&&(this.fontSize=this.fontSize-1,r("haxcms-userPref-fontSize",this.fontSize))}UserStylesSizeUp(e){this.fontSize<4&&(this.fontSize=this.fontSize+1,r("haxcms-userPref-fontSize",this.fontSize))}UserStylesFontFamilyChange(e){var t=s(e)[0];this.fontFamily=parseInt(t.getAttribute("data-font")),r("haxcms-userPref-fontFamily",this.fontFamily)}UserStylesColorThemeChange(e){var t=s(e)[0];this.colorTheme=parseInt(t.getAttribute("data-theme")),r("haxcms-userPref-colorTheme",this.colorTheme)}}};export{HAXCMSUserStylesMenuMixin};