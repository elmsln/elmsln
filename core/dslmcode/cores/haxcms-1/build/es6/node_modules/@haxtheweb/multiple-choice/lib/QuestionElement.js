import{LitElement as e,html as t,css as s,nothing as i}from"../../../lit/index.js";import{SchemaBehaviors as r}from"../../schema-behaviors/schema-behaviors.js";import{DDDSuper as a}from"../../d-d-d/d-d-d.js";import{I18NMixin as o}from"../../i18n-manager/lib/I18NMixin.js";import"../../simple-icon/simple-icon.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-fields/lib/simple-fields-field.js";import"../../simple-toolbar/lib/simple-toolbar-button.js";import"../../simple-toast/simple-toast.js";import"../../grid-plate/grid-plate.js";export class QuestionElement extends(r(o(a(e)))){constructor(){super(),this.guessDataValue="display",this.shadowRootOptions={...e.shadowRootOptions,delegatesFocus:!0},this.maxAttempts=0,this.attempts=0,this.showAnswer=!1,this.randomize=!1,this.hideButtons=!1,this.disabled=!1,this.singleOption=!1,this.media=null,this.question="",this.answers=[],this.displayedAnswers=[],this.correctText="You are correct!",this.incorrectText="Try again!",this.quizName="default",this.t={numCorrectLeft:"You have",numCorrectRight:"correct",checkAnswer:"Check answer",tryAgain:"Try again"},this.edit=!1}updated(e){super.updated&&super.updated(e),e.forEach(((e,t)=>{if(["answers","displayedAnswers"].includes(t)){let e=`${t.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g,"$1-$2").toLowerCase()}-changed`;this.dispatchEvent(new CustomEvent(e,{detail:{value:this[t]}}))}if("edit"===t&&this.edit&&this._haxstate&&["feedbackIncorrect","feedbackCorrect","content","hint","evidence"].map((e=>{if(null===this.querySelector(`[slot="${e}"]`)){let t=globalThis.document.createElement("p");t.setAttribute("slot",e),this.appendChild(t)}})),"answers"==t&&this.answers&&this.answers.length>0&&!this.__answerLock){this.__answerLock=!0;const e=this.cleanAnswerData(this.answers);this.answers=[...e],this.displayedAnswers=[...this._computeDisplayedAnswers([...this.answers],this.randomize)],setTimeout((()=>{this.__answerLock=!1}),0)}}))}getGuess(){return"display"==this.guessDataValue?this.displayedAnswers.filter((e=>!0===e.userGuess)):this[this.guessDataValue]?this[this.guessDataValue]:void 0}guessCount(){return this.getGuess().length}checkedEvent(e){this.displayedAnswers[e.target.name].userGuess=e.detail.value,this.requestUpdate()}resetAnswer(e){this.showAnswer=!1,globalThis.dispatchEvent(new CustomEvent("simple-toast-hide",{bubbles:!0,composed:!0,cancelable:!1,detail:!1})),this.displayedAnswers=[],this.answers.forEach((e=>{e.userGuess=""}));const t=JSON.parse(JSON.stringify(this.answers));this.answers=[...t]}isCorrect(){let e=!0;for(var t in this.displayedAnswers)0!=e&&this.displayedAnswers[t].correct&&this.displayedAnswers[t].userGuess?e=!0:(this.displayedAnswers[t].correct&&!this.displayedAnswers[t].userGuess||!this.displayedAnswers[t].correct&&this.displayedAnswers[t].userGuess)&&(e=!1);return e}makeItRain(){import("./confetti-container.js").then((e=>{setTimeout((()=>{this.shadowRoot.querySelector("#confetti").setAttribute("popped","")}),0)}))}checkAnswer(e){globalThis.document&&globalThis.document.startViewTransition?globalThis.document.startViewTransition((()=>{this.checkAnswerCallback()})):this.checkAnswerCallback()}checkAnswerCallback(){globalThis.dispatchEvent(new CustomEvent("simple-toast-hide",{bubbles:!0,composed:!0,cancelable:!1,detail:!1}));let e,t,s,i=document.createElement("simple-icon-lite"),r={},a="simple-toast-show";globalThis.HAXCMSToast&&(a="haxcms-toast-show",i.style.setProperty("--simple-icon-height","40px"),i.style.setProperty("--simple-icon-width","40px"),i.style.height="150px",i.style.marginLeft="8px"),this.showAnswer=!0,this.shadowRoot.querySelector("#feedback").focus();let o=this.isCorrect();o?(e="green",t="icons:thumb-up",s=this.correctText,this.makeItRain(),this.playSound("success"),r.hat="party"):(e="red",t="icons:thumb-down",s=this.incorrectText,r.fire=!0,this.playSound("error")),i.icon=t,i.style.marginLeft="16px",i.accentColor=e,i.dark=!0,globalThis.dispatchEvent(new CustomEvent(a,{bubbles:!0,composed:!0,cancelable:!0,detail:{text:s,accentColor:e,duration:3e3,slot:i,...r}}));let d={activityDisplay:"answered",objectName:this.quizName,resultSuccess:o};this.dispatchEvent(new CustomEvent("user-engagement",{bubbles:!0,composed:!0,cancelable:!1,detail:d})),this.attempts++}_computeDisplayedAnswers(e,t){if(void 0!==e&&null!=e&&e.length>0&&t&&!this._haxstate){let t=e;for(var s,i,r=t.length;0!==r;)i=Math.floor(Math.random()*r),s=t[r-=1],t[r]=t[i],t[i]=s;return t}return e}static get properties(){return{...super.properties,edit:{type:Boolean,reflect:!0},showAnswer:{type:Boolean,reflect:!0,attribute:"show-answer"},media:{type:String},maxAttempts:{type:Number,reflect:!0,attribute:"max-attempts"},attempts:{type:Number,reflect:!0},disabled:{type:Boolean,reflect:!0},singleOption:{type:Boolean,attribute:"single-option"},relatedResource:{type:String,attribute:"related-resource"},question:{type:String},answers:{type:Array},displayedAnswers:{type:Array},quizName:{type:String,attribute:"quiz-name"},randomize:{type:Boolean,reflect:!0},hideButtons:{type:Boolean,attribute:"hide-buttons"}}}static get styles(){return[super.styles,s`
      ...
      <confetti-container id="confetti">
        <grid-plate layout="1-1">
          ...
          <div slot="col-2">
            ...
            ${this.querySelector('[slot="content"]')&&!this.edit?t` <details ?open="${!this.showAnswer}" id="related">
    ...
    `}renderDirections(){return t`<p>
      ...
      ${this.showAnswer&&!this.isCorrect()?t` <p class="feedback">${this.incorrectText}</p>
            ${this.querySelector('[slot="feedbackIncorrect"]')?t`<slot name="feedbackIncorrect"></slot>`:i}`:i}
      ${this.showAnswer&&this.isCorrect()?t` <p class="feedback">${this.correctText}</p>
            ${this.querySelector('[slot="feedbackCorrect"]')?t`<slot name="feedbackCorrect"></slot>`:i}`:i}
      ${this.querySelector('[slot="hint"]')&&this.showAnswer&&!this.isCorrect()?t`
            <h4>Need a hint?</h4>
            <div>
              <slot name="hint"></slot>
            </div>
          `:i}
      ${this.querySelector('[slot="evidence"]')&&this.showAnswer&&this.isCorrect()?t`
            <h4>Evidence</h4>
            <div>
