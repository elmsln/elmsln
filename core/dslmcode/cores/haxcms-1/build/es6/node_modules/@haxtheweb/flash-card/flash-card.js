import{html as t,css as e}from"../../lit/index.js";import{DDD as r}from"../d-d-d/d-d-d.js";import{SchemaBehaviors as i}from"../schema-behaviors/schema-behaviors.js";import"../simple-toolbar/lib/simple-toolbar-button.js";import"../simple-toast/simple-toast.js";import"./lib/flash-card-answer-box.js";import"./lib/flash-card-prompt-img.js";export class FlashCard extends(i(r)){static get tag(){return"flash-card"}constructor(){super(),this.imgKeyword="",this.imgSource="",this.typeOfAction="",this.hasLearningObjective=""}static get properties(){return{...super.properties,inverted:{type:Boolean},imgSource:{type:String,attribute:"img-source",reflect:!0},imgKeyword:{type:String,attribute:"img-keyword"},status:{type:String,reflect:!0},typeOfAction:{type:String,attribute:"type-of-action"},hasLearningObjective:{type:String,attribute:"has-learning-objective"}}}static get styles(){return[super.styles,e`
        :host {
          display: block;
      ...
      `]}statusChanged(t){this.status=t.detail,this.provideFeedback()}provideFeedback(){let t,e,r;if("correct"===this.status?(t="green",e="icons:thumb-up",r="Correct!",this.makeItRain(),this.playSound("success")):"incorrect"===this.status&&(t="red",e="icons:thumb-down",r="Try again!",this.playSound("error")),"correct"===this.status||"incorrect"===this.status){let i=globalThis.document.createElement("simple-icon-lite");i.icon=e,i.style.marginLeft="16px",i.style.setProperty("--simple-icon-height","24px"),i.style.setProperty("--simple-icon-width","24px"),globalThis.dispatchEvent(new CustomEvent("simple-toast-show",{bubbles:!0,composed:!0,cancelable:!0,detail:{text:r,accentColor:t,duration:3e3,slot:i}}))}}makeItRain(){import("../multiple-choice/lib/confetti-container.js").then(t=>{setTimeout(()=>{this.shadowRoot.querySelector("#confetti").setAttribute("popped","")},0)})}playSound(t){globalThis.dispatchEvent(new CustomEvent("playaudio",{detail:{sound:t}}))}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),this.setAttribute("typeof","oer:Practice")}render(){return t`
