import{LitElement as e,html as t,css as i}from"../../../../lit/index.js";import"../../../simple-tooltip/simple-tooltip.js";import"../../../simple-icon/lib/simple-icon-lite.js";import{store as o}from"./AppHaxStore.js";export class AppHaxUseCase extends e{static get tag(){return"app-hax-use-case"}constructor(){super(),this.title="",this.description="",this.source="",this.demoLink="",this.iconImage=[],this.isSelected=!1,this.showContinue=!1}static get properties(){return{title:{type:String},description:{type:String},source:{type:String},demoLink:{type:String},iconImage:{type:Array},isSelected:{type:Boolean,reflect:!0},showContinue:{type:Boolean}}}static get styles(){return[i`
        :host {
          display: flex;
      ...
      `]}toggleDisplay(){this.isSelected=!this.isSelected,this.showContinue=this.isSelected,this.dispatchEvent(new CustomEvent("toggle-display",{detail:{isSelected:this.isSelected},bubbles:!0,composed:!0})),this.isSelected&&setTimeout(()=>{this.continueAction()},100)}continueAction(){this.dispatchEvent(new CustomEvent("continue-action",{detail:{title:this.title,description:this.description,source:this.source,template:this.title},bubbles:!0,composed:!0}))}openDemo(){this.demoLink&&globalThis.open(this.demoLink,"_blank")}render(){const e=this.source&&"string"==typeof this.source&&""!==this.source.trim(),i=this.title&&"string"==typeof this.title&&""!==this.title.trim()?this.title.trim():"Untitled template",o=this.description&&"string"==typeof this.description&&""!==this.description.trim()?`${i}: ${this.description.trim()}`:i,a=Array.isArray(this.iconImage)&&this.iconImage[0]&&this.iconImage[0].icon?this.iconImage[0].icon:"icons:cloud-download";return t`
      <button
        class="card"
      ...
      >
        <div class="image">
          ${e?t`<img
                ...
                decoding="async"
                fetchpriority="high"
              />`:t`<div class="image-placeholder" aria-hidden="true">
                <simple-icon-lite icon="${a}"></simple-icon-lite>
              </div>`}
        </div>
        <div class="title">
          <h3>${i}</h3>
