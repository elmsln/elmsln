 ...
 */
import{css as t,LitElement as e,render as i,unsafeCSS as o,html as s}from"../../../../lit/index.js";import{HAXCMSTheme as n}from"./HAXCMSThemeWiring.js";import{ResponsiveUtilityBehaviors as r}from"../../../responsive-utility/lib/responsive-utility-behaviors.js";import{store as l}from"./haxcms-site-store.js";import{autorun as a,toJS as h}from"../../../../mobx/dist/mobx.esm.js";import"../../../simple-icon/lib/simple-icons.js";import{SimpleIconsetStore as d}from"../../../simple-icon/lib/simple-iconset.js";import{editableTableDisplayStyles as c}from"../../../editable-table/lib/editable-table-behaviors.js";import{copyToClipboard as p}from"../../../utils/utils.js";class HAXCMSLitElementTheme extends(n(r(e))){constructor(){super(),this.editMode=!1,this.isLoggedIn=!1,this.__disposer=this.__disposer?this.__disposer:[],a((t=>{this.editMode=h(l.editMode),this.__disposer.push(t)})),a((t=>{h(l.activeItemContent);if(this.HAXCMSThemeSettings.autoScroll&&this.shadowRoot&&this.HAXCMSThemeSettings.scrollTarget&&this.HAXCMSThemeSettings.scrollTarget.scrollIntoView){void 0!==globalThis.safari?this.HAXCMSThemeSettings.scrollTarget.scrollIntoView():this.HAXCMSThemeSettings.scrollTarget.scrollIntoView({behavior:"instant",block:"start",inline:"nearest"})}setTimeout((()=>{let t=this.querySelectorAll("h1,h2,h3,h4,h5,h6");t.length>0&&t.forEach((t=>{t.addEventListener("click",this.copyLink.bind(this)),t.addEventListener("pointerenter",this.hoverIntentEnter.bind(this)),t.addEventListener("pointerleave",this.hoverIntentLeave.bind(this))}))}),100),this.__disposer.push(t)}))}hoverIntentEnter(t){t.target.classList.add("haxcms-copyable")}hoverIntentLeave(t){t.target.classList.remove("haxcms-copyable")}HAXCMSGlobalStyleSheetContent(){return[t`
        .haxcms-copyable {
