 ...
 */
import{html as o,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as e}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{store as i}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as r,toJS as s}from"../../mobx/dist/mobx.esm.js";import{DDDSuper as a}from"../d-d-d/d-d-d.js";import{I18NMixin as l}from"../i18n-manager/lib/I18NMixin.js";import{DDDVariables as n}from"../d-d-d/lib/DDDStyles.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../bootstrap-theme/lib/BootstrapBreadcrumb.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"./lib/glossy-portfolio-card.js";import"./lib/glossy-portfolio-header.js";import"./lib/glossy-portfolio-footer.js";import"./lib/glossy-portfolio-home.js";import"./lib/glossy-portfolio-grid.js";import"./lib/glossy-portfolio-about.js";import"./lib/glossy-portfolio-breadcrumb.js";export class GlossyPortfolioTheme extends(a(l(e))){static get tag(){return"glossy-portfolio-theme"}constructor(){super(),this.title="",this.HAXCMSThemeSettings.autoScroll=!0,this.activeParent="",this.__disposer=this.__disposer||[],r((o=>{this.isHome=!1;const t=s(i.activeItem);t&&0===t.order&&null===i.ancestorItem&&(this.isHome=!0)}))}static get properties(){return{...super.properties,title:{type:String},siteDescription:{type:String},relatedItem:{type:Object},isHome:{type:Boolean},items:{type:Object}}}disconnectedCallback(){if(this.__disposer)for(var o in this.__disposer)this.__disposer[o].dispose();super.disconnectedCallback()}firstUpdated(o){super.firstUpdated(o);let t=globalThis.DesignSystemManager.requestAvailability();t.addDesignSystem({name:"glossy-portfolio-theme",styles:[...GlossyPortfolioTheme.styles,n],fonts:["https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Source+Code+Pro:ital,wght@0,200..900;1,200..900&family=Work+Sans:ital,wght@0,100..900;1,100..900&display=swap","https://fonts.googleapis.com/css2?family=Manrope:wght@200..800&display=swap","https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&display=swap"],hax:!0}),t.active="glossy-portfolio-theme"}static get styles(){return[super.styles,t`
    :host{
    ...
    `]}render(){this.activeItem&&this.activeItem.title;return o`
    <!-- temporary margin-top  -->
    <glossy-portfolio-header></glossy-portfolio-header>

    <div class="body-wrapper"> 
      ${this.isHome?o`<glossy-portfolio-home></glossy-portfolio-home>`:o``}
