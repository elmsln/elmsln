import{LitElement as a,html as c,css as e}from"../../../lit/index.js";class PolarisMark extends a{static get properties(){return{type:{type:String},name:{type:String},url:{type:String}}}constructor(){super(),this.type="default",this.name="",this.url="https://psu.edu/"}static get styles(){return[e`
        :host {
          display: block;
        }
    ...
    `}renderSource(a){return"dark"===a?this.renderDark():this.renderDefault()}renderDark(){return c`
      <div id="svg">
    ...
    `}static get tag(){return"polaris-mark"}static get haxProperties(){return new URL(`./${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(PolarisMark.tag,PolarisMark);export{PolarisMark};