 ...
 */
import{LitElement as A,html as Q,css as g}from"../../../lit/index.js";import{DDDSuper as C}from"../../d-d-d/d-d-d.js";import{I18NMixin as i}from"../../i18n-manager/lib/I18NMixin.js";export class GlossyPortfolioCard extends(C(i(A))){static get tag(){return"glossy-portfolio-card"}constructor(){super(),this.title="Title",this.thumbnail="https://img.freepik.com/premium-photo/cool-cat-wearing-pink-sunglasses-with-neon-light-background_514761-16858.jpg",this.slug="https://google.com"}static get properties(){return{...super.properties,title:{type:String},thumbnail:{type:String},slug:{type:String}}}static get styles(){return[super.styles,g`
      :host {
        display: block;
        height: auto;
...
`}handleImageError(A){A.target.style.visibility="hidden"}displayArrow(){return Q`
