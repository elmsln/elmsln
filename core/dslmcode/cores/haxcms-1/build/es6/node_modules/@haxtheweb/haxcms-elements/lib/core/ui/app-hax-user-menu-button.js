import{LitElement as t,html as e,css as n}from"../../../../../lit/index.js";import{DDDSuper as o}from"../../../../d-d-d/d-d-d.js";import"../../../../simple-icon/lib/simple-icon-lite.js";export class AppHaxUserMenuButton extends(o(t)){static get tag(){return"app-hax-user-menu-button"}constructor(){super(),this.icon="account-circle",this.label="Default"}handleClick(t){const e=this.parentElement;e&&"a"===e.tagName.toLowerCase()&&(t.stopPropagation(),e.click())}static get properties(){return{icon:{type:String},label:{type:String}}}static get styles(){return[super.styles,n`
        :host {
