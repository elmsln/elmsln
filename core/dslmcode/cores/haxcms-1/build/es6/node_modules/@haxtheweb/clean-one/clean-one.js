 ...
 */
import{html as t,css as e}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as o}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{HAXCMSRememberRoute as n}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{QRCodeMixin as s}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{EmailPageMixin as a}from"../haxcms-elements/lib/core/utils/EmailPageMixin.js";import{HAXCMSMobileMenuMixin as r}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{LTIResizingMixin as l}from"../haxcms-elements/lib/core/utils/LTIResizingMixin.js";import{store as c}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as d,toJS as m}from"../../mobx/dist/mobx.esm.js";import"../scroll-button/scroll-button.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"./lib/clean-one-search-box.js";import{PrintBranchMixin as h}from"../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{MicroFrontendRegistry as p}from"../micro-frontend-registry/micro-frontend-registry.js";import{PDFPageMixin as u}from"../haxcms-elements/lib/core/utils/PDFPageMixin.js";import{DDDSuper as b}from"../d-d-d/d-d-d.js";class CleanOne extends(l(h(u(a(s(o(r(n(b(i)))))))))){static get styles(){return[super.styles,e`
        :host {
          width: 100%;
          margin: 0;
          display: flex;
            ...
            <header class="site-header">
              <div class="btn-container">
                <div class="pull-left">
                  ...
                  ${p.has("@haxcms/siteToHtml")?this.PrintBranchButton("bottom"):t`
                        <site-print-button
                          class="btn js-toolbar-action"
                          part="print-btn"
                        ></site-print-button>
                      `}
                  ${p.has("@core/htmlToPdf")?this.PDFPageButton("bottom"):""}
                </div>
    ...
    `}searchChanged(t){t.detail.value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{"search"!==c.getInternalRoute()&&globalThis.history.replaceState({},null,"x/search"),this.searchTerm=t.detail.value})):this.searchTerm=""}static get properties(){return{...super.properties,searchTerm:{type:String}}}static get tag(){return"clean-one"}constructor(){super(),this.searchTerm="",this.HAXCMSThemeSettings.autoScroll=!0,import("../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"),import("../haxcms-elements/lib/ui-components/site/site-print-button.js"),import("../haxcms-elements/lib/ui-components/site/site-rss-button.js"),import("../haxcms-elements/lib/ui-components/active-item/site-git-corner.js"),this.__disposer=this.__disposer?this.__disposer:[],d((t=>{this.activeManifestIndex=m(c.activeManifestIndex),this.searchTerm="",this.__disposer.push(t)}))}HAXCMSGlobalStyleSheetContent(){return[...super.HAXCMSGlobalStyleSheetContent(),e`
        body stop-note a,
        body stop-note a:any-link,
        body stop-note a:-webkit-any-link {
          color: var(--ddd-theme-colorContrast, var(--ddd-theme-default-link));
        }
      `]}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),globalThis.document.body.style.overflow="hidden",this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector("main"),globalThis.AbsolutePositionStateManager.requestAvailability().scrollTarget=this.HAXCMSThemeSettings.scrollTarget,this.shadowRoot.querySelector("scroll-button").target=this.shadowRoot.querySelector("main");const e=new URLSearchParams(c.currentRouterLocation.search);"search"===c.getInternalRoute()&&e.get("search")&&import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{this.searchTerm=e.get("search"),this.shadowRoot.querySelector("clean-one-search-box").focus(),setTimeout((()=>{this.shadowRoot.querySelector("clean-one-search-box").select()}),0)})),globalThis.DesignSystemManager.requestAvailability().active="ddd"}disconnectedCallback(){for(var t in this.__disposer)this.__disposer[t].dispose();globalThis.document.body.style.removeProperty("overflow"),super.disconnectedCallback()}prevPage(t){super.prevPage(t)}nextPage(t){super.nextPage(t)}}globalThis.customElements.define(CleanOne.tag,CleanOne);export{CleanOne};