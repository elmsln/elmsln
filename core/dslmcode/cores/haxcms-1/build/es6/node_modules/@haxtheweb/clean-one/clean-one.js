...
import{html as t,css as e}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as o}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{HAXCMSRememberRoute as n}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{QRCodeMixin as s}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{EmailPageMixin as a}from"../haxcms-elements/lib/core/utils/EmailPageMixin.js";import{HAXCMSMobileMenuMixin as r}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{store as l}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as c,toJS as d}from"../../mobx/dist/mobx.esm.js";import"../scroll-button/scroll-button.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"./lib/clean-one-search-box.js";import{PrintBranchMixin as m}from"../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{MicroFrontendRegistry as h}from"../micro-frontend-registry/micro-frontend-registry.js";import{PDFPageMixin as p}from"../haxcms-elements/lib/core/utils/PDFPageMixin.js";import{DDDSuper as u}from"../d-d-d/d-d-d.js";class CleanOne extends(m(p(a(s(o(r(n(u(i))))))))){static get styles(){return[super.styles,e`
            ...
            <header class="site-header">
              <div class="btn-container">
                <div class="pull-left">
                  ...
                  ${h.has("@haxcms/siteToHtml")?this.PrintBranchButton("bottom"):t`
                        <site-print-button
                          class="btn js-toolbar-action"
                          part="print-btn"
                        ></site-print-button>
                      `}
                  ${h.has("@core/htmlToPdf")?this.PDFPageButton("bottom"):""}
                </div>
    ...
    `}searchChanged(t){t.detail.value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{"search"!==l.getInternalRoute()&&globalThis.history.replaceState({},null,"x/search"),this.searchTerm=t.detail.value})):this.searchTerm=""}static get properties(){return{...super.properties,searchTerm:{type:String}}}static get tag(){return"clean-one"}constructor(){super(),this.searchTerm="",import("../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"),import("../haxcms-elements/lib/ui-components/site/site-print-button.js"),import("../haxcms-elements/lib/ui-components/site/site-rss-button.js"),import("../haxcms-elements/lib/ui-components/active-item/site-git-corner.js"),this.__disposer=this.__disposer?this.__disposer:[],c((t=>{this.activeManifestIndex=d(l.activeManifestIndex),this.searchTerm="",this.__disposer.push(t)}))}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),globalThis.document.body.style.overflow="hidden",this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector("main"),globalThis.AbsolutePositionStateManager.requestAvailability().scrollTarget=this.HAXCMSThemeSettings.scrollTarget,this.shadowRoot.querySelector("scroll-button").target=this.shadowRoot.querySelector("main");const e=new URLSearchParams(l.currentRouterLocation.search);"search"===l.getInternalRoute()&&e.get("search")&&import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{this.searchTerm=e.get("search"),this.shadowRoot.querySelector("clean-one-search-box").focus(),setTimeout((()=>{this.shadowRoot.querySelector("clean-one-search-box").select()}),0)}))}disconnectedCallback(){for(var t in this.__disposer)this.__disposer[t].dispose();super.disconnectedCallback()}prevPage(t){super.prevPage(t)}nextPage(t){super.nextPage(t)}}customElements.define(CleanOne.tag,CleanOne);export{CleanOne};