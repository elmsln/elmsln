 ...
 */
import{LitElement as e,html as t,css as o,render as i}from"../../lit/index.js";import{oneDark as n}from"./lib/themes/one-dark.js";import{hljs as r,highlightjs_line_numbers as s}from"./lib/highlightjs/highlight.js";import{javascript as h}from"./lib/highlightjs/languages/javascript.js";import{yaml as a}from"./lib/highlightjs/languages/yaml.js";import{jsonLang as l}from"./lib/highlightjs/languages/json.js";import{cssLang as d}from"./lib/highlightjs/languages/css.js";import{phpLang as c}from"./lib/highlightjs/languages/php.js";import{xml as p}from"./lib/highlightjs/languages/xml.js";import{I18NMixin as g}from"../i18n-manager/lib/I18NMixin.js";r.registerLanguage("javascript",h),r.registerLanguage("json",l),r.registerLanguage("css",d),r.registerLanguage("php",c),r.registerLanguage("yaml",a),r.registerLanguage("xml",p),r.registerLanguage("html",p),globalThis.hljs=r,s();class CodeSample extends(g(e)){static get styles(){return[o`
        :host {
          display: block;
        }
      ...
      `]}getMinHeight(){return this.shadowRoot&&this.shadowRoot.querySelector("#code-container")&&this.shadowRoot.querySelector("#code-container").getBoundingClientRect().height>250?this.shadowRoot.querySelector("#code-container").getBoundingClientRect().height+"px":"250px"}render(){return t` ${this._haxstate?t`<code-editor
            language="${this.type}"
