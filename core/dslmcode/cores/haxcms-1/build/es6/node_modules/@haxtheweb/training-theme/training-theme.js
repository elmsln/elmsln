 ...
 */
import{html as t,css as e}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSRememberRoute as n}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{HAXCMSThemeParts as a}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{PrintBranchMixin as o}from"../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{PDFPageMixin as r}from"../haxcms-elements/lib/core/utils/PDFPageMixin.js";import{QRCodeMixin as s}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{HAXCMSMobileMenuMixin as l}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as d}from"../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{varExists as p,varGet as m}from"../utils/lib/object-path.js";import{store as g}from"../haxcms-elements/lib/core/haxcms-site-store.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu-button.js";import{DDDSuper as c}from"../d-d-d/d-d-d.js";import{autorun as x,toJS as h}from"../../mobx/dist/mobx.esm.js";import"./lib/training-button.js";import"./lib/training-top.js";class TrainingTheme extends(d(n(r(o(s(a(l(c(i))))))))){constructor(){super(),this.items=[],this.t.next="Next",this.t.previous="Previous",this.maxIndex=0,this.activeId=null,this.time=0,x(()=>{const t=h(g.activeId);Promise.resolve().then(()=>{this.activeId=t})}),x(()=>{const t=h(g.manifest.items);Promise.resolve().then(()=>{this.items=t})}),x(()=>{const t=h(g.activeManifestIndex);Promise.resolve().then(()=>{const e=t;e>this.maxIndex&&(this.maxIndex=e)})})}static get tag(){return"training-theme"}static get properties(){return{...super.properties,items:{type:Array},activeId:{type:String},time:{type:String},prevPage:{type:String},nextPage:{type:String},maxIndex:{type:Number}}}__prevPageLabelChanged(t){this.prevPage=t.detail.value}__nextPageLabelChanged(t){this.nextPage=t.detail.value}static get styles(){return[super.styles,e`
        :host {
          display: block;
          color: light-dark(
    ...
    `}}globalThis.customElements.define(TrainingTheme.tag,TrainingTheme);export{TrainingTheme};