import{LitElement as t,html as o,css as e}from"../../lit/index.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import"../simple-icon/lib/simple-icon-button.js";import"../img-pan-zoom/img-pan-zoom.js";class ImageInspector extends t{static get styles(){return[e`
        :host {
          display: block;
          overflow: hidden;
      ...
      `]}constructor(){super(),this.noLeft=!1,this.degrees=0,this.src=""}render(){return o`
      <div class="wrap">
        <simple-icon-button
          label="Zoom in"
          icon="zoom-in"
