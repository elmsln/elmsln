import{LitElement as a,html as r,css as o}from"../../../lit/index.js";export class PolarisCta extends a{static get tag(){return"polaris-cta"}constructor(){super(),this.text="",this.link="",this.type="tinted",this.outlined=!1,this.filled=!1,this.editMode=!1}static get properties(){return{text:{type:String},link:{type:String},type:{type:String,reflect:!0},outlined:{type:Boolean,reflect:!0},filled:{type:Boolean,reflect:!0},editMode:{type:Boolean}}}static get styles(){return[o`
        :host {
          display: block;
          margin-left: 32px;
      ...
      `]}render(){return r`<a href="${this.link}" @click="${this._clickLink}"
      ><slot>${this.text}</slot></a
    >`}haxHooks(){return{editModeChanged:"haxeditModeChanged",activeElementChanged:"haxactiveElementChanged"}}haxeditModeChanged(a){this.editMode=a}_clickLink(a){this.editMode&&(a.preventDefault(),a.stopPropagation(),a.stopImmediatePropagation())}haxactiveElementChanged(a,r){return this.editMode=r,!1}static get haxProperties(){return new URL(`./${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(PolarisCta.tag,PolarisCta);