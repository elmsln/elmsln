import{LitElement as a,html as r,css as o}from"../../../lit/index.js";export class PolarisCta extends a{static get tag(){return"polaris-cta"}constructor(){super(),this.text="",this.link="",this.type="tinted",this.outlined=!1,this.filled=!1}static get properties(){return{text:{type:String},link:{type:String},type:{type:String,reflect:!0},outlined:{type:Boolean,reflect:!0},filled:{type:Boolean,reflect:!0}}}static get styles(){return[o`
        :host {
          display: block;
          margin-left: 32px;
      ...
      `]}render(){return r`<a href="${this.link}"><slot>${this.text}</slot></a>`}}globalThis.customElements.define(PolarisCta.tag,PolarisCta);