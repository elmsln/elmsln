import{html as t,css as e}from"../../lit/index.js";import{SimpleColors as i}from"../simple-colors/simple-colors.js";export class ProductGlance extends i{static get styles(){return[super.styles,e`
        :host {
    ...
    `}static get tag(){return"product-glance"}static get haxProperties(){return new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(ProductGlance.tag,ProductGlance);