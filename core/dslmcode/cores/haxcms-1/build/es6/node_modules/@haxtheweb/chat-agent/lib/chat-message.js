 ...
 */
import{DDD as e}from"../../d-d-d/d-d-d.js";import"../../type-writer/type-writer.js";import{css as t,html as s}from"../../../lit/index.js";import{autorun as a,toJS as d}from"../../../mobx/dist/mobx.esm.js";import{ChatStore as r}from"./chat-agent-store.js";class ChatMessage extends e{static get tag(){return"chat-message"}constructor(){super(),this.darkMode=null,this.editMode=null,this.hasSuggestedPrompts=!1,this.hat="none",this.isSentPrompt=!1,this.message="",this.messageWasSuggestedPrompt=!1,this.suggestedPrompts=r.currentSuggestions,this.__disposer=[],this.__disposer.push(a(()=>{const e=d(r.darkMode);Promise.resolve().then(()=>{this.darkMode=e})})),this.__disposer.push(a(()=>{const e=d(r.editMode);Promise.resolve().then(()=>{this.editMode=e})}))}static get styles(){return[super.styles,t`
