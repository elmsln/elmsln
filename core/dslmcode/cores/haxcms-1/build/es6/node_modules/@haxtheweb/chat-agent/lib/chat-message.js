 ...
 */
import"../../type-writer/type-writer.js";import{ChatAgentModalStore as e}from"../chat-agent.js";import{DDD as t}from"../../d-d-d/d-d-d.js";import{html as s,css as r}from"../../../lit/index.js";import{autorun as a,toJS as d}from"../../../mobx/dist/mobx.esm.js";class ChatMessage extends t{static get tag(){return"chat-message"}constructor(){super(),this.hasSuggestedPrompts=!1,this.isSentPrompt=!1,this.message="",this.messageWasSuggestedPrompt=!1,this.suggestedPrompts=e.currentSuggestions}static get styles(){return[super.styles,r`
