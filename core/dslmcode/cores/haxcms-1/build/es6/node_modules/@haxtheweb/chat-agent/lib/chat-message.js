 ...
 */
import"../../type-writer/type-writer.js";import{ChatStore as e}from"./chat-agent-store.js";import{DDD as t}from"../../d-d-d/d-d-d.js";import{autorun as s,toJS as a}from"../../../mobx/dist/mobx.esm.js";import{html as d,css as r}from"../../../lit/index.js";class ChatMessage extends t{static get tag(){return"chat-message"}constructor(){super(),this.darkMode=null,this.editMode=null,this.hasSuggestedPrompts=!1,this.isSentPrompt=!1,this.message="",this.messageWasSuggestedPrompt=!1,this.suggestedPrompts=e.currentSuggestions,this.hat="none",s((()=>{this.darkMode=a(e.darkMode),this.editMode=a(e.editMode)}))}static get styles(){return[super.styles,r`
    ...
    `}renderReceivedMessage(){return d`
