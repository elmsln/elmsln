import{LitElement as e,html as t,css as i}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import{I18NMixin as o}from"../../i18n-manager/lib/I18NMixin.js";import"../../simple-tooltip/simple-tooltip.js";class MapMenuHeader extends(o(e)){static get styles(){return[i`
      ...
      ${this.editControls&&this.active?t` <div class="ops">
          ...
          </div>`:""}`}static get tag(){return"map-menu-header"}constructor(){super(),this.editControls=!1,this.isFlex=!1,this.iconLabel=null,this.icon=null,this.url="",this.status="",this.opened=!1,this.active=!1,this.published=!0,this.hideInMenu=!1,this.hovered=!1,this.locked=!1,this.itemtitle="",this.t={pageIsUnpublished:"Page is unpublished"},this.registerLocalization({context:this,namespace:"map-menu",localesPath:new URL("../locales/map-menu.es.json",import.meta.url).href+"/../"}),setTimeout((()=>{this.addEventListener("click",this.__tap.bind(this)),this.addEventListener("keypress",this.__keypress.bind(this))}),0)}updated(e){e.forEach(((e,t)=>{"opened"==t&&void 0!==e&&this._openedChanged(this[t],e),["id","selected"].includes(t)&&this.__selectedChanged(this.selected,this.id)}))}static get properties(){let e={};return super.properties&&(e=super.properties),{...e,opened:{type:Boolean,reflect:!0},itemtitle:{type:String},iconLabel:{type:String,attribute:"icon-label"},editControls:{type:Boolean,attribute:"edit-controls"},isFlex:{type:Boolean,attribute:"is-flex"},url:{type:String},hideInMenu:{type:Boolean,reflect:!0,attribute:"hide-in-menu"},id:{type:String,reflect:!0},icon:{type:String,reflect:!0},active:{type:Boolean,reflect:!0},hovered:{type:Boolean,reflect:!0},published:{type:Boolean,reflect:!0},locked:{type:Boolean},status:{type:String,reflect:!0},selected:{type:String,reflect:!0},__collapseIcon:{type:String},__collapseAria:{type:String}}}_openedChanged(e,t){e?(this.__collapseIcon="icons:expand-more",this.__collapseAria="collapse menu"):(this.__collapseIcon="icons:chevron-right",this.__collapseAria="expand menu")}__selectedChanged(e,t){e===t&&(this.parentNode.expanded||this.dispatchEvent(new CustomEvent("toggle-header",{bubbles:!0,cancelable:!0,composed:!0,detail:!0})),this.dispatchEvent(new CustomEvent("active-item",{bubbles:!0,cancelable:!0,composed:!0,detail:this})))}__tap(e){this.__toggleEventHandler(e)}__keypress(e){"Enter"===e.code&&this.__toggleEventHandler(e)}__toggleEventHandler(e){this.parentNode.expanded||this.dispatchEvent(new CustomEvent("toggle-header",{bubbles:!0,cancelable:!0,composed:!0,detail:!0}))}}globalThis.customElements.define(MapMenuHeader.tag,MapMenuHeader);export{MapMenuHeader};