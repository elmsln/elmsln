...
import{html as e,css as t}from"../../lit/index.js";import"../simple-toolbar/lib/simple-toolbar-button.js";import{QuestionElement as r}from"../multiple-choice/lib/QuestionElement.js";import{DDD as s}from"../d-d-d/d-d-d.js";class TaggingQuestion extends r{static get tag(){return"tagging-question"}constructor(){super(),this.guessDataValue="selectedAnswers",this.dragEnter=!1,this.dragEnterAnswer=!1,this.dragging=!1,this.selectedAnswers=[]}static get styles(){return[super.styles,t`
      ...
      >
        ${this.displayedAnswers.map((t=>e`
          ...
          ${this.showAnswer?e`
                <p class="feedback">
                  ${this.selectedAnswers.filter((e=>e.correct)).length}
                  out of
                  ${this.answers.filter((e=>e.correct)).length}
                  correct${this.selectedAnswers.length>this.answers.filter((e=>e.correct)).length&&this.selectedAnswers.length>this.selectedAnswers.filter((e=>e.correct)).length?e`, <strong>but too many options present!</strong>`:"."}
                </p>
