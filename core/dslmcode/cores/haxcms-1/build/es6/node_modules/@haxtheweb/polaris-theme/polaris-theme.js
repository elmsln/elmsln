 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as o}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as i}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{PrintBranchMixin as r}from"../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{PDFPageMixin as a}from"../haxcms-elements/lib/core/utils/PDFPageMixin.js";import{QRCodeMixin as s}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{HAXCMSMobileMenuMixin as l}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as n}from"../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{store as c}from"../haxcms-elements/lib/core/haxcms-site-store.js";import"../scroll-button/scroll-button.js";import"../haxcms-elements/lib/ui-components/site/site-title.js";import"../haxcms-elements/lib/ui-components/navigation/site-top-menu.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../haxcms-elements/lib/ui-components/layout/site-region.js";import"../haxcms-elements/lib/ui-components/blocks/site-children-block.js";import{autorun as p,toJS as d}from"../../mobx/dist/mobx.esm.js";import{DDDSuper as m}from"../d-d-d/d-d-d.js";class PolarisTheme extends(n(a(r(s(i(l(m(o)))))))){static get styles(){return[super.styles,t`
        :host {
          display: block;
          color: light-dark(
    ...
    `}static get properties(){let e={};return super.properties&&(e=super.properties),{...e,searchTerm:{type:String},siteDescription:{type:String},imageLink:{type:String},image:{type:String},imageAlt:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"polaris-theme"}appStoreReady(e){if(globalThis.HaxStore&&globalThis.HaxStore.requestAvailability()){let e=globalThis.HaxStore.requestAvailability();["polaris-cta","polaris-mark","polaris-story-card","polaris-tile"].map(t=>{let o=globalThis.document.createElement(t);e.haxAutoloader.appendChild(o)}),this.windowControllersLoaded.abort()}}constructor(){super(),this.windowControllersLoaded=new AbortController,globalThis.addEventListener("hax-store-app-store-loaded",this.appStoreReady.bind(this),{once:!0,passive:!0,signal:this.windowControllersLoaded.signal}),this.HAXCMSThemeSettings.autoScroll=!0,this.searchTerm="",this.imageAlt="",this.image="",this.imageLink="",this.__disposer=this.__disposer?this.__disposer:[],this.__disposer.push(p(e=>{const t=d(c.themeData.variables);Promise.resolve().then(()=>{if(c.themeData&&c.themeData.variables){const e=t;this.imageAlt=e.imageAlt,this.image=e.image,this.imageLink=e.imageLink}})})),this.__disposer.push(p(e=>{const t=d(c.siteDescription);Promise.resolve().then(()=>{this.siteDescription=t})})),this.__disposer.push(p(e=>{const t=d(c.activeManifestIndex);Promise.resolve().then(()=>{this.activeManifestIndex=t})})),p(()=>{const e=d(c.badDevice);Promise.resolve().then(()=>{if(!1===e){const e=globalThis.document.createElement("link");e.setAttribute("href","https://fonts.googleapis.com/css2?family=Open+Sans&display=swap"),e.setAttribute("rel","stylesheet"),e.setAttribute("fetchpriority","low"),globalThis.document.head.appendChild(e)}})}),this.__disposer.push(p(e=>{const t=d(c.activeItem&&c.activeItem.metadata?c.activeItem.metadata.updated:null);Promise.resolve().then(()=>{t&&(this.pageTimestamp=t)})}))}siteModalClick(e){import("../haxcms-elements/lib/ui-components/site/site-search.js").then(e=>{"displays/search"!==c.getInternalRoute()&&globalThis.history.replaceState({},null,"x/displays/search");const t=new URLSearchParams(c.currentRouterLocation.search),o=globalThis.SimpleModal.requestAvailability().querySelector("site-search").shadowRoot.querySelector("simple-fields-field");o.focus(),t.get("search")&&(o.value=t.get("search"),setTimeout(()=>{o.select()},0))})}}globalThis.customElements.define(PolarisTheme.tag,PolarisTheme);export{PolarisTheme};