import{LitElement as t,html as e,css as o}from"../../../lit/index.js";import{A11yMenuButtonBehaviors as i}from"../../a11y-menu-button/a11y-menu-button.js";import{SimpleToolbarButtonBehaviors as s}from"./simple-toolbar-button.js";import{normalizeEventPath as n}from"../../utils/lib/events.js";import"./simple-toolbar-menu-item.js";const SimpleToolbarMenuBehaviors=function(t){return class extends(i(s(t))){static get simpleButtonCoreStyles(){return[...super.simpleButtonCoreStyles,o`
      ...
      `}get buttonInnerTemplate(){return super.buttonInnerTemplate}get tooltipTemplate(){return this.tooltipVisible?e`<simple-tooltip
          ...
          >`:""}static get tag(){return"simple-toolbar-menu"}static get properties(){return{...super.properties}}get focusableElement(){return this.shadowRoot&&this.shadowRoot.querySelector("#menubutton")?this.shadowRoot.querySelector("#menubutton"):void 0}_excludeEvent(t){let e=(n(t)||[])[0];return!(!e.closest("simple-toolbar-field")||"BUTTON"!==e.tagName)}_handleFocus(t){s._handleFocus&&s._handleFocus(t),i._handleFocus&&i._handleFocus(t);let e=(n(t)||[])[0];"menubutton"!==e.id&&!e.closest("#menubutton")||this.noOpenOnHover||this.expanded||this.open()}_handleBlur(t){s._handleBlur&&s._handleBlur(t),i._handleBlur&&i._handleBlur(t);const e=t.relatedTarget;if(e){if(this.contains(e)||this.menuItems.some(t=>t===e||t.contains(e)||t.focusableElement&&(t.focusableElement===e||t.focusableElement.contains(e))))return}this.isCurrentItem||setTimeout(()=>this.close(),300)}addItem(t){if(this.getItemIndex(t)<0){let e=this.itemListeners;this.__menuItems=this.__menuItems||[],this.__menuItems.push(t),Object.keys(e).forEach(o=>(t.focusableElement||t).addEventListener(o,e[o].bind(this)))}}removeItem(t){if(this.getItemIndex(t)<0){let e=this.itemListeners;Object.keys(e).forEach(o=>(t.focusableElement||t).removeEventListener(o,e[o].bind(this))),this.__menuItems&&(this.__menuItems=[...this.menuItems.filter(e=>t!==e)])}}}};class SimpleToolbarMenu extends(SimpleToolbarMenuBehaviors(t)){}globalThis.customElements.define(SimpleToolbarMenu.tag,SimpleToolbarMenu);export{SimpleToolbarMenu,SimpleToolbarMenuBehaviors};