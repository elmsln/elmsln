import{LitElement as e,html as t,css as i}from"../../../lit/index.js";import"../../simple-modal/lib/simple-modal-template.js";import"./hax-picker.js";import{HaxComponentStyles as s}from"./hax-ui-styles.js";class HaxAppPicker extends e{static get styles(){return[...s,i`
    ...
    `}static get tag(){return"hax-app-picker"}firstUpdated(){this.dispatchEvent(new CustomEvent("hax-register-core-piece",{bubbles:!0,cancelable:!0,composed:!0,detail:{piece:"haxAppPicker",object:this}}))}}globalThis.customElements.define(HaxAppPicker.tag,HaxAppPicker);export{HaxAppPicker};