 ...
 */
import{LitElement as e,html as a,css as t}from"../../lit/index.js";import"./lib/map-menu-builder.js";import"./lib/map-menu-container.js";import{normalizeEventPath as i}from"../utils/lib/events.js";import{SchemaBehaviors as n}from"../schema-behaviors/schema-behaviors.js";class MapMenu extends(n(e)){static get styles(){return[t`
        :host {
      ...
      `]}constructor(){super(),this.editControls=!1,this.isFlex=!1,this.isHorizontal=!1,this.maxDepth=5,this.disabled=!1,this.title="Content outline",this.data=null,this.items=[],this.autoScroll=!1,this.activeIndicator=!1,this.addEventListener("link-clicked",this.__linkClickedHandler.bind(this)),this.addEventListener("toggle-updated",this.__toggleUpdated.bind(this)),this.addEventListener("active-item",this.__activeItemHandler.bind(this)),this.addEventListener("opened-changed",this.__openChanged.bind(this)),this.addEventListener("map-meu-item-hidden-check",this._mapMeuItemHiddenCheckHandler.bind(this))}render(){return a`
