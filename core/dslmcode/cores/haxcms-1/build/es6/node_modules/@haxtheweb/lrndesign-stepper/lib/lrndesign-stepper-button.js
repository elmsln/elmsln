import{html as t,PolymerElement as o}from"../../../@polymer/polymer/polymer-element.js";import"../../simple-icon/simple-icon.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/lib/simple-icon-button.js";import"../../../@polymer/polymer/lib/elements/dom-if.js";import"../../a11y-collapse/a11y-collapse.js";class LrndesignStepperButton extends o{static get template(){return t`
      <style>
        :host {
          display: block;
    ...
    `}static get tag(){return"lrndesign-stepper-button"}static get properties(){return{title:{type:String,reflectToAttribute:!0,notify:!0},icon:{type:String,reflectToAttribute:!0,notify:!0},url:{type:String,reflectToAttribute:!0,notify:!0},location:{type:String,reflectToAttribute:!0,notify:!0},collapsible:{type:Boolean,reflectToAttribute:!0,notify:!0,value:!1},opened:{type:Boolean,value:!1}}}hasCollapse(t,o){return t==o}}customElements.define(LrndesignStepperButton.tag,LrndesignStepperButton);export{LrndesignStepperButton};