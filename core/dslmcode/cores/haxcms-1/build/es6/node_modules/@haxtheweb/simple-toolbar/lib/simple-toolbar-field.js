 ...
 */
import{LitElement as t,html as e,css as i}from"../../../lit/index.js";import{SimpleToolbarButtonBehaviors as o}from"./simple-toolbar-button.js";class SimpleToolbarField extends(o(t)){static get tag(){return"simple-toolbar-field"}static get styles(){return[super.styles,i`
        :host([full-display]) {
          min-width: 100px;
          display: block;
          padding-right: 3px;
      ...
      `]}constructor(){super(),this.fullDisplay=!1,this.addEventListener("click",this.toggleFocus),this.observer.observe(this,{childList:!0,subtree:!0})}static get properties(){return{...super.properties,fullDisplay:{type:Boolean,attribute:"full-display",reflect:!0}}}get buttonTemplate(){return this.fullDisplay?e` <div
        ...
        >`:""}get focusableElement(){return this.querySelector("*:not([disabled]):not([hidden])")}toggleFocus(t){this.focusableElement.clientWidth>10?this.focusableElement.blur():this.focus()}updated(t){super.updated&&super.updated(t),t.forEach((t,e)=>{"isCurrentItem"!==e&&"disabled"!==e||!this.focusableElement||this._syncFocusableState()})}_syncFocusableState(){this.focusableElement&&(this.focusableElement.setAttribute("tabindex",this.disabled||!this.isCurrentItem?-1:0),this.disabled?this.focusableElement.setAttribute("aria-disabled","true"):this.focusableElement.removeAttribute("aria-disabled"))}get observer(){return new MutationObserver(t=>this._watchChildren(t))}_watchChildren(t){this._syncFocusableState()}}globalThis.customElements.define(SimpleToolbarField.tag,SimpleToolbarField);export{SimpleToolbarField};