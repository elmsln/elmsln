import{html as t,css as e,unsafeCSS as s}from"../../../../lit/index.js";import{SimpleColors as a}from"../../../simple-colors/simple-colors.js";import{autorun as i,toJS as o}from"../../../../mobx/dist/mobx.esm.js";import{store as p}from"./AppHaxStore.js";import{localStorageSet as r}from"../../../utils/utils.js";import"../../../../scrollable-component/index.js";import"../../../simple-icon/lib/simple-icon-lite.js";import{MicroFrontendRegistry as n}from"../../../micro-frontend-registry/micro-frontend-registry.js";import{enableServices as l}from"../../../micro-frontend-registry/lib/microServices.js";import"./app-hax-site-button.js";import"./app-hax-hat-progress.js";import"./app-hax-button.js";const c=new URL("../assets/images/Home.svg",import.meta.url).href,h=new URL("../assets/images/DisabledCircle.svg",import.meta.url).href,d=new URL("../assets/images/TransparentCircle.svg",import.meta.url).href,m=new URL("../assets/images/EnabledCircle.svg",import.meta.url).href,u={collection:["collections-theme","bootstrap-theme"],blog:["haxor-slevin"],course:["clean-one","clean-two","learn-two-theme"],website:["polaris-flex-theme"],training:["training-theme"],import:["clean-one","clean-two","learn-two-theme"]};export class AppHaxSteps extends a{static get tag(){return"app-hax-steps"}constructor(){super(),this.unlockComingSoon=!1,this.unlockTerrible=!1,this.windowControllers=new AbortController,this.nameTyped="",this.stepRoutes=[],this._progressReady=!1,this.step=null,this.loaded=!1,this.themeNames=[],this.appSettings={},i(()=>{this.appSettings=o(p.appSettings);const t=o(p.site.structure);this.themeNames=Object.keys(this.appSettings.themes).filter(e=>t&&u[t]&&u[t].includes(e))}),i(()=>{this.dark=o(p.darkMode)}),i(()=>{r("app-hax-step",o(p.step))}),i(()=>{r("app-hax-site",o(p.site)),this.step=p.stepTest(this.step)}),i(()=>{o(p.createSiteSteps)&&o(p.location)&&(this.step=p.stepTest(this.step))}),i(()=>{const t=o(p.routes);this.stepRoutes=t.filter(t=>t.step)})}static get properties(){return{...super.properties,step:{type:Number,reflect:!0},stepRoutes:{type:Array},themeNames:{type:Array},unlockComingSoon:{type:Boolean,reflect:!0,attribute:"unlock-coming-soon"},unlockTerrible:{type:Boolean,reflect:!0,attribute:"unlock-terrible"},loaded:{type:Boolean,reflect:!0},appSettings:{type:Object},nameTyped:{type:String}}}chooseStructure(t){if(!t.target.comingSoon){const{value:e}=t.target;p.site.structure=e,"course"===e&&(p.site.type="own",p.site.theme="clean-one"),"blog"===e&&(p.site.type="own",p.site.theme="haxor-slevin"),"collection"===e&&(p.site.type="own",p.site.theme="collections-theme"),"website"===e&&(p.site.type="own",p.site.theme="polaris-flex-theme"),"training"===e&&(p.site.type="own",p.site.theme="training-theme"),p.appEl.playSound("click2")}}chooseType(t){if(!t.target.comingSoon){const{type:e}=t.target;p.site.type=e,p.appEl.playSound("click2")}}async docxImport(t){if(!t.target.comingSoon){const{type:e}=t.target;import("../../../file-system-broker/lib/docx-file-system-broker.js").then(async t=>{l(["haxcms"]);const s=globalThis.FileSystemBroker.requestAvailability(),a=await s.loadFile("docx"),i=new FormData;i.append("method","site"),i.append("type",o(p.site.structure)),i.append("upload",a),this.setProcessingVisual();const r=await n.call("@haxcms/docxToSite",i);p.toast("Processed!",300),200==r.status&&r.data&&""!=r.data.contents?(p.items=r.data.items,r.data.files&&(p.itemFiles=r.data.files),this.nameTyped=r.data.filename.replace(".docx","").replace("outline","").replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout(()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()},800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("File did not return valid HTML structure"))})}}async pdfImport(t){if(!t.target.comingSoon){const{type:e}=t.target;import("../../../file-system-broker/file-system-broker.js").then(async t=>{l(["haxcms"]);const s=globalThis.FileSystemBroker.requestAvailability(),a=await s.loadFile("pdf"),i=new FormData;i.append("method","site"),i.append("type",o(p.site.structure)),i.append("upload",a),this.setProcessingVisual();const r=await n.call("@haxcms/pdfToSite",i);p.toast("Processed!",300),200==r.status&&r.data&&""!=r.data.contents?(p.items=r.data.items,r.data.files&&(p.itemFiles=r.data.files),this.nameTyped=r.data.filename.replace(".pdf","").replace("outline","").replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout(()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()},800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("File did not return valid HTML structure"))})}}async pptxImport(t){if(!t.target.comingSoon){const{type:e}=t.target;import("../../../file-system-broker/file-system-broker.js").then(async t=>{l(["haxcms"]);const s=globalThis.FileSystemBroker.requestAvailability(),a=await s.loadFile("pptx"),i=new FormData;i.append("method","site"),i.append("type",o(p.site.structure)),i.append("upload",a),this.setProcessingVisual();const r=await n.call("@haxcms/pptxToSite",i);p.toast("Processed!",300),200==r.status&&r.data&&""!=r.data.contents?(p.items=r.data.items,r.data.files&&(p.itemFiles=r.data.files),this.nameTyped=r.data.filename.replace(".pptx","").replace("outline","").replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout(()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()},800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("File did not return valid HTML structure"))})}}async htmlImport(t){t.target.comingSoon||import("../../../file-system-broker/file-system-broker.js").then(async t=>{l(["haxcms"]);const e=globalThis.FileSystemBroker.requestAvailability(),s=await e.loadFile("html"),a=new FormData;a.append("method","site"),a.append("type",o(p.site.structure)),a.append("upload",s),this.setProcessingVisual();const i=await n.call("@haxcms/htmlToSite",a);p.toast("Processed!",300),200==i.status&&i.data&&""!=i.data.contents?(p.items=i.data.items,i.data.files&&(p.itemFiles=i.data.files),this.nameTyped=i.data.filename.replace(".html","").replace(".htm","").replace("outline","").replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout(()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()},800),p.site.type="html",p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("File did not return valid HTML structure"))})}async evoImport(t){if(!t.target.comingSoon){const{type:e}=t.target;import("../../../file-system-broker/file-system-broker.js").then(async t=>{l(["haxcms"]);const s=globalThis.FileSystemBroker.requestAvailability(),a=await s.loadFile("zip"),i=new FormData;i.append("method","site"),i.append("type",o(p.site.structure)),i.append("upload",a),this.setProcessingVisual();const r=await n.call("@haxcms/evolutionToSite",i,null,null,"?jwt="+o(p.AppHaxAPI.jwt));p.toast("Processed!",300),200==r.status&&r.data&&""!=r.data.contents?(p.items=r.data.items,this.nameTyped=r.data.filename.replace(".zip","").replace("outline","").replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout(()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()},800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("File did not return valid HTML structure"))})}}async gbImport(t){if(!t.target.comingSoon){const{type:e}=t.target;let s=globalThis.prompt("URL for the Gitbook repo");l(["haxcms"]),this.setProcessingVisual();const a=await n.call("@haxcms/gitbookToSite",{md:s});p.toast("Processed!",300),200==a.status&&a.data&&""!=a.data.contents?(p.items=a.data.items,a.data.files&&(p.itemFiles=a.data.files),this.nameTyped=a.data.filename.replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout(()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()},800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("Repo did not return valid structure"))}}async importFromURL(t){const{type:e,prompt:s,callback:a,param:i}=t.target;if(!t.target.comingSoon){let t=globalThis.prompt(s);l(["haxcms"]),this.setProcessingVisual();const o={};o[i]=t;const r=await n.call(a,o);p.toast("Processed!",300),200==r.status&&r.data&&""!=r.data.contents?(p.items=r.data.items,r.data.files&&(p.itemFiles=r.data.files),this.nameTyped=r.data.filename.replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout(()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()},800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("Repo did not return valid structure"))}}async notionImport(t){if(!t.target.comingSoon){const{type:e}=t.target;let s=globalThis.prompt("URL for the Github Notion repo");l(["haxcms"]),this.setProcessingVisual();const a=await n.call("@haxcms/notionToSite",{repoUrl:s});p.toast("Processed!",300),200==a.status&&a.data&&""!=a.data.contents?(p.items=a.data.items,a.data.files&&(p.itemFiles=a.data.files),this.nameTyped=a.data.filename.replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout(()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()},800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("Repo did not return valid structure"))}}async pressbooksImport(t){if(!t.target.comingSoon){const{type:e}=t.target;import("../../../file-system-broker/lib/docx-file-system-broker.js").then(async t=>{l(["haxcms"]);const s=globalThis.FileSystemBroker.requestAvailability(),a=await s.loadFile("html"),i=new FormData;i.append("method","site"),i.append("type",o(p.site.structure)),i.append("upload",a),this.setProcessingVisual();const r=await n.call("@haxcms/pressbooksToSite",i);p.toast("Processed!",300),200==r.status&&r.data&&""!=r.data.contents?(p.items=r.data.items,r.data.files&&(p.itemFiles=r.data.files),this.nameTyped=r.data.filename.replace(".html","").replace("outline","").replace(/\s/g,"").replace(/-/g,"").toLowerCase(),setTimeout(()=>{this.shadowRoot.querySelector("#sitename").value=this.nameTyped,this.shadowRoot.querySelector("#sitename").select()},800),p.site.type=e,p.site.theme="clean-one",p.appEl.playSound("click2")):(p.appEl.playSound("error"),p.toast("File did not return valid HTML structure"))})}}setProcessingVisual(){let t=globalThis.document.createElement("simple-icon-lite");t.icon="hax:loading",t.style.setProperty("--simple-icon-height","40px"),t.style.setProperty("--simple-icon-width","40px"),t.style.height="150px",t.style.marginLeft="8px",p.toast("Processing",6e4,{hat:"construction",slot:t})}chooseTheme(t){if(!t.target.comingSoon){const{value:e}=t.target;p.site.theme=e,p.appEl.playSound("click2")}}chooseName(){if(""!==this.nameTyped){const t=this.shadowRoot.querySelector("#sitename").value;p.site.name=t,p.appEl.playSound("click2")}}progressReady(t){t.detail&&(this._progressReady=!0,5===this.step&&setTimeout(()=>{this.shadowRoot.querySelector("app-hax-hat-progress").process()},300))}updated(t){super.updated&&super.updated(t),t.forEach((t,e)=>{if(4===this.step&&"step"===e&&this.shadowRoot&&(this.shadowRoot.querySelector("#sitename").value=o(p.site.name)),5===this.step&&"step"===e&&this.shadowRoot&&this._progressReady&&setTimeout(()=>{this.shadowRoot.querySelector("app-hax-hat-progress").process()},600),"step"===e&&(p.step=this.step),"unlockTerrible"===e&&this[e]){Object.keys(u).forEach(t=>{u[t]=[...u[t],"terrible-themes","terrible-productionz-themes","terrible-outlet-themes","terrible-best-themes","terrible-resume-themes"]});const t=o(p.site.structure);this.themeNames=Object.keys(this.appSettings.themes).filter(e=>t&&u[t]&&u[t].includes(e))}})}connectedCallback(){super.connectedCallback(),globalThis.addEventListener("resize",this.maintainScroll.bind(this),{signal:this.windowControllers.signal}),globalThis.addEventListener("popstate",this.popstateListener.bind(this),{signal:this.windowControllers.signal})}disconnectedCallback(){this.windowControllers.abort(),super.disconnectedCallback()}popstateListener(t){if("popstate"===t.type&&null===t.state)try{setTimeout(()=>{const e=t.target.document.location.pathname.split("/").pop();if(e.includes("createSite")){const t=parseInt(e.replace("createSite-step-",""));t<p.stepTest(t)?this.shadowRoot.querySelector("#link-step-"+t).click():t>p.stepTest(t)&&(p.toast("Please select an option"),this.step=p.stepTest(t),this.shadowRoot.querySelector("#link-step-"+this.step).click())}},0)}catch(t){}}maintainScroll(){this.shadowRoot&&this.step&&(this.scrollToThing(`#step-${this.step}`,{behavior:"instant",block:"start",inline:"nearest"}),setTimeout(()=>{this.scrollToThing(`#step-${this.step}`,{behavior:"instant",block:"start",inline:"nearest"})},100))}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),setTimeout(()=>{null===this.step&&(this.step=1),this.scrollToThing(`#step-${this.step}`,{behavior:"instant",block:"start",inline:"nearest"})},100),i(()=>{if(o(p.createSiteSteps)&&o(p.appReady)){const t=o(p.location);t.route&&t.route.step&&t.route.name&&setTimeout(()=>{this.scrollToThing("#".concat(t.route.name),{behavior:"smooth",block:"start",inline:"nearest"}),4===t.route.step&&4===p.stepTest(4)&&setTimeout(()=>{this.shadowRoot.querySelector("#sitename").focus(),this.scrollToThing("#step-4",{behavior:"instant",block:"start",inline:"nearest"})},800)},300)}}),i(()=>{if(this.shadowRoot&&o(p.createSiteSteps)&&o(p.appReady)){const t=o(p.activeItem);t&&t.name&&t.step&&!this.__overrideProgression&&this.shadowRoot.querySelector("#link-".concat(t.name)).click()}})}scrollToThing(t,e){const s=void 0!==globalThis.safari;this.shadowRoot.querySelector(".carousel-with-snapping-item.active-step")&&this.shadowRoot.querySelector(".carousel-with-snapping-item.active-step").classList.remove("active-step"),s?this.shadowRoot.querySelector(t).scrollIntoView():this.shadowRoot.querySelector(t).scrollIntoView(e),this.shadowRoot.querySelector(t).classList.add("active-step")}static get styles(){return[super.styles,e`
        :host {
          display: block;
        }
      ...
      `]}progressFinished(t){t.detail&&(this.loaded=!0,p.appEl.playSound("success"),t.target.shadowRoot.querySelector(".game").focus(),this.scrollToThing(`#step-${this.step}`,{behavior:"instant",block:"start",inline:"nearest"}))}typeKey(){this.nameTyped=this.shadowRoot.querySelector("#sitename").value}keydown(t){[" ","/","\\","&","#","?","+","=","{","}","|","^","~","[","]","`",'"',"'"].includes(t.key)?(p.appEl.playSound("error"),p.toast(`"${t.key}" is not allowed. Use - or _`),t.preventDefault()):"Enter"===t.key?this.chooseName():["ArrowUp","ArrowRight","ArrowDown","ArrowLeft"].includes(t.key)||p.appEl.playSound("click")}stepLinkClick(t){const e=parseInt(t.target.getAttribute("data-step"),10);this.step<e?t.preventDefault():null===t.target.getAttribute("data-step")?(p.createSiteSteps=!1,p.appMode="home",this.nameTyped="",p.siteReady=!1,p.site.structure=null,p.site.type=null,p.site.theme=null,p.site.name=null):this.step>e&&(this.nameTyped="",p.siteReady=!1,1===e?(p.site.structure=null,p.site.type=null,p.site.theme=null,p.site.name=null):2===e?(p.site.type=null,p.site.theme=null,p.site.name=null):3===e?(p.site.theme=null,p.site.name=null):4===e&&(p.site.name=null),this.step=e)}renderTypes(e){const s=o(p.site.structure);var a=t``;switch(s){case"collection":a=t` <app-hax-button
          ...
          <app-hax-button
            ...
            type="art"
            ?coming-soon="${!this.unlockComingSoon}"
          ></app-hax-button>`;break;default:case"course":a=t` <app-hax-button
            tabindex="${2!==e?"-1":""}"
            @click=${this.chooseType}
          ></app-hax-button>
          <app-hax-button
            ...
            @click=${this.chooseType}
            type="15w"
          ></app-hax-button>`;break;case"website":a=t` <app-hax-button
          tabindex="${2!==e?"-1":""}"
          @click=${this.chooseType}
          type="website"
        ></app-hax-button>`;break;case"training":a=t` <app-hax-button
          tabindex="${2!==e?"-1":""}"
          @click=${this.chooseType}
          type="training"
        ></app-hax-button>`;break;case"blog":a=t` <app-hax-button
          tabindex="${2!==e?"-1":""}"
          @click=${this.chooseType}
          type="blog"
        ></app-hax-button>`;break;case"import":a=t` <app-hax-button
            tabindex="${2!==e?"-1":""}"
          ...
          <app-hax-button
            ...
            param="repoUrl"
            beta
          ></app-hax-button>`}return a}render(){return t`
      <div id="container">
        <ul id="step-links">
          <li>
            ${o(p.isNewUser)?t``:t`
