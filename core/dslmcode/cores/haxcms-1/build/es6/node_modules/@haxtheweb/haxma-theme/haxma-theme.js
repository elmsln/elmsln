 ...
 */
import{html as e,css as a}from"../../lit/index.js";import{HAXCMSLitElementTheme as t}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{store as i}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as o,toJS as r}from"../../mobx/dist/mobx.esm.js";import"../haxcms-elements/lib/ui-components/site/site-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu-button.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"../haxcms-elements/lib/ui-components/site/site-search.js";import"../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu.js";import"../haxcms-elements/lib/ui-components/navigation/site-top-menu.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu-content.js";import{HAXCMSThemeParts as n}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{DDDSuper as s}from"../d-d-d/d-d-d.js";export class HaxmaTheme extends(n(s(t))){static get tag(){return"haxma-theme"}constructor(){super(),this._items=[],this.activeItem={},this.manifest={},this.mobileNavOpen=!1,this.searchOpen=!1,this.nextPage="",this.prevPage="",this.__disposer=this.__disposer||[],this.__disposer.push(o(e=>{const a=r(i.manifest);Promise.resolve().then(()=>{this.manifest=a})})),this.__disposer.push(o(e=>{const a=r(i.activeItem);Promise.resolve().then(()=>{this.activeItem=a})})),this.__disposer.push(o(e=>{const a=r(i.manifest&&i.manifest.items?i.manifest.items:[]);Promise.resolve().then(()=>{this._items=a})}))}static get properties(){return{...super.properties,_items:{type:Array},activeItem:{type:Object},manifest:{type:Object},mobileNavOpen:{type:Boolean,reflect:!0,attribute:"mobile-nav-open"},searchOpen:{type:Boolean,reflect:!0,attribute:"search-open"},nextPage:{type:String},prevPage:{type:String}}}HAXCMSGlobalStyleSheetContent(){return[...super.HAXCMSGlobalStyleSheetContent(),a`
        :root {
    ...
    `]}toggleMobileNav(){this.mobileNavOpen=!this.mobileNavOpen}closeMobileNav(){this.mobileNavOpen=!1}toggleSearch(){this.searchOpen=!this.searchOpen}toggleDarkMode(){i.darkMode=!i.darkMode}__prevPageLabelChanged(e){this.prevPage=e.detail.value}__nextPageLabelChanged(e){this.nextPage=e.detail.value}firstUpdated(e){super.firstUpdated(e),this.HAXCMSThemeSettings.themeTop=this.shadowRoot.querySelector(".main-content"),this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector(".main-content")}render(){const a=this.manifest||{},t=(a.metadata||{}).site||{};this.activeItem;return e`
        ...
        <footer class="site-footer">
          <div class="footer-content">
            ...
            <div class="footer-brand">
              <div class="brand-title">${t.name||"HAXma"}</div>
              <div class="brand-description">
                ${a.description||"Empowering web creation through HAX"}
              </div>
            </div>
            ...
            <div class="footer-section">
              ...
              <div class="footer-page-grid">
                ${this._items.map(a=>e`
                  <a href="${a.slug}" class="footer-page-link">
                    ${a.title}
                  </a>
                `)}
              </div>
    ...
    `}disconnectedCallback(){this.__disposer&&(this.__disposer.forEach(e=>{"function"==typeof e&&e()}),this.__disposer=[]),super.disconnectedCallback()}}globalThis.customElements.define(HaxmaTheme.tag,HaxmaTheme);