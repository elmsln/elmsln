...
`;export const DDDPaletteStyles=d`
  /** Default Palette */
  html,
  :root {
...
`;export const DDDAllStyles=[DDDGlobalStyles,DDDVariables,DDDPaletteStyles,...DDDDataAttributes,DDDReset,DDDBreadcrumb,DDDExtra,DDDLetterSpacing,DDDBoxShadow,DDDBorderRadius,DDDBackground,DDDFontClasses,DDDFontWeight,DDDAnimations];