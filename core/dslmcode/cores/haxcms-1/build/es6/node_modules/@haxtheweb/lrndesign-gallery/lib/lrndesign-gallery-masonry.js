...
import{LitElement as e,html as s,css as t}from"../../../lit/index.js";import{LrndesignGalleryBehaviors as i}from"./lrndesign-gallery-behaviors.js";import"./lrndesign-gallery-zoom.js";import"./lrndesign-gallery-details.js";import{normalizeEventPath as l}from"../../utils/utils.js";class LrndesignGalleryMasonry extends i{static get tag(){return"lrndesign-gallery-masonry"}static get styles(){return[...super.styles,t`
      ...
      `]}static get properties(){return{...super.properties,__aspects:{type:Object},__columns:{type:Array},__items:{type:Array}}}constructor(){super(),this.__aspects={},this.__items=[]}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e);let s=this.shadowRoot.querySelector("#carouselitem");this.selected.scroll&&s&&(this._scrollIntoView([this._getParentOffset(s)]),this.selected.zoomed||s.focus())}render(){return s`
      <div id="grid">
    ...
    `}updated(e){super.updated(e),e.forEach(((e,s)=>{"sources"===s&&this._updateItems(),"responsiveSize"===s&&this._updateItems()}))}_getStyle(e,s){return[`--lrndesign-gallery-image-aspect:${e||100/75};`,`--lrndesign-gallery-image-height:${100/e||75}%;`,`--lrndesign-gallery-image-width:${100*e/s||.75}%`].join("")}_handleImgLoad(e){l(e)[0].naturalWidth>0&&this._updateItems()}_updateItems(){let e=[],s={xs:2,sm:3,md:4,lg:5,xl:6}[this.responsiveSize||"xs"],t=Math.ceil(this.sources.length/s);for(let i=0;i<t;i++){let t={aspect:0,cols:[]};for(let e=i*s;e<Math.min(this.sources.length,(i+1)*s);e++){let s=JSON.parse(JSON.stringify(this.sources[e])),i=this.shadowRoot.querySelector(`img[src="${s.src}"]`);s.aspect=i&&i.naturalWidth>0?i.naturalWidth/i.naturalHeight:100/75,t.aspect+=s.aspect,t.cols.push(s)}e.push(t)}this.__items=e}}customElements.define(LrndesignGalleryMasonry.tag,LrndesignGalleryMasonry);export{LrndesignGalleryMasonry};