import{LitElement as i,html as e,css as t}from"../../../../../lit/index.js";import{HAXCMSI18NMixin as l}from"../utils/HAXCMSI18NMixin.js";import"../../../../simple-icon/simple-icon.js";import"../../../../simple-icon/lib/simple-icons.js";import"../../../../hax-iconset/lib/simple-hax-iconset.js";import"../../../../place-holder/place-holder.js";class HAXCMSPageGetStarted extends(l(i)){constructor(){super()}static get tag(){return"haxcms-page-get-started"}static get styles(){return[t`
        :host {
          display: block;
          position: absolute;
          top: 0;
      ...
      `]}handleWhoGotClicked(i){console.log(i.target)}render(){return e`
    ...
    `}}globalThis.customElements.define(HAXCMSPageGetStarted.tag,HAXCMSPageGetStarted);