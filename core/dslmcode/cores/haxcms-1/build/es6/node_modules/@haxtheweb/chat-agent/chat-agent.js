 ...
 */
import"./lib/chat-button.js";import"./lib/chat-control-bar.js";import"./lib/chat-developer-panel.js";import"./lib/chat-input.js";import"./lib/chat-interface.js";import"./lib/chat-message.js";import"./lib/chat-suggestion.js";import"../rpg-character/rpg-character.js";import"../simple-icon/simple-icon.js";import"../simple-cta/simple-cta.js";import{DDD as e}from"../d-d-d/d-d-d.js";import{html as t,css as s}from"../../lit/index.js";import{HAXCMSSiteEditorUI as i}from"../haxcms-elements/lib/core/haxcms-site-editor-ui.js";import{store as n}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{observable as o,makeObservable as a,computed as r,configure as h,autorun as c,toJS as l}from"../../mobx/dist/mobx.esm.js";h({enforceActions:!1});import{MicroFrontendRegistry as d}from"../micro-frontend-registry/micro-frontend-registry.js";import{enableServices as u}from"../micro-frontend-registry/lib/microServices.js";u(["haxcms"]),d.add({endpoint:"/api/apps/haxcms/aiChat",name:"@haxcms/aiChat",title:"AI Chat",description:"AI based chat agent that can answer questions about a site",params:{site:"location of the HAXcms site OR site.json data",type:"site for site.json or link for remote loading",question:"Question to ask of the AI",engine:"which engine to use as we test multiple",context:"context to query based on. Course typical"}});class ChatAgent extends e{static get tag(){return"chat-agent"}constructor(){super(),this.chatLog=[],this.engine="alfred",void 0!==n.userData.userName?this.userName=n.userData.userName:this.userName="guest",void 0!==n.userData.userPicture&&(this.userPicture=n.userData.userPicture),this.context="phys211",this.isLoading=null,this.dataCollectionEnabled=!0,this.buttonIcon="hax:wizard-hat",this.buttonLabel="Merlin-AI",this.developerModeEnabled=!0,this.promptCharacterLimit,this.promptPlaceholder="Enter your prompt here...",this.isFullView=!1,this.isInterfaceHidden=!1,this.merlinIndex=0,this.messageIndex=0,this.userIndex=0,this.userTypeWriterSpeed=0,this.merlinTypeWriterSpeed=4,this.currentSuggestions=[],this.isSiteEditorOpen=i.userMenuOpen,console.log(this.isSiteEditorOpen),a(this,{buttonIcon:o,chatLog:o,dataCollectionEnabled:o,engine:o,isFullView:o,isInterfaceHidden:o,isLoading:o,merlinIndex:o,messageIndex:o,userIndex:o}),c((()=>{l(this.buttonIcon),l(this.chatLog),l(this.dataCollectionEnabled),l(this.engine);const e=l(this.isFullView),t=l(this.isInterfaceHidden),s=l(this.isLoading);l(this.merlinIndex),l(this.messageIndex),l(this.userIndex);e?this.setAttribute("is-full-view",""):this.removeAttribute("is-full-view"),t?this.setAttribute("is-interface-hidden",""):this.removeAttribute("is-interface-hidden"),this.buttonIcon=s?"hax:loading":"hax:wizard-hat"}))}static get styles(){return[super.styles,s`
