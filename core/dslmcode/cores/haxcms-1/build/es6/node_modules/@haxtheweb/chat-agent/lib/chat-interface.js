 ...
 */
import{ChatAgentModalStore as e}from"../chat-agent.js";import{DDD as i}from"../../d-d-d/d-d-d.js";import{html as h,css as t}from"../../../lit/index.js";import{autorun as a,toJS as r}from"../../../mobx/dist/mobx.esm.js";class ChatInterface extends i{static get tag(){return"chat-interface"}constructor(){super(),this.chatLog=[],this.developerModeEnabled=null,this.isFullView=null,this.isInterfaceHidden=null,this.hasEditorUI=null,a((()=>{this.chatLog=r(e.chatLog),this.developerModeEnabled=r(e.developerModeEnabled),this.isFullView=r(e.isFullView),this.isInterfaceHidden=r(e.isInterfaceHidden);const i=document.querySelector("#site");window.innerHeight>1e3?this.isFullView&&!this.isInterfaceHidden?i.style.width="65%":i.style.width="100%":this.isFullView&&!this.isInterfaceHidden?i.style.width="75%":i.style.width="100%",document.querySelector("haxcms-site-editor-ui")?this.hasEditorUI=!0:this.hasEditorUI=!1,console.log(hasEditorUI)}))}static get styles(){return[super.styles,t`
