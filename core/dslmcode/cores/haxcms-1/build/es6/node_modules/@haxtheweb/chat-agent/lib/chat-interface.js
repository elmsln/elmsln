            ...
            <div class="chat-container">
              <div class="chat-messages">
                  ${this.chatLog.map((i=>a`
                    <chat-message message="${i.message}" ?sent-prompt="${i.author===e.userName}" ?suggested-prompts="${e.currentSuggestions.length>0}"></chat-message>
                  `))}
              </div>
