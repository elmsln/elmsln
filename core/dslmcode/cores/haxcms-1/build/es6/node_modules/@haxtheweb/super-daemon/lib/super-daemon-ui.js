        ...
        ${this.loading?e`<div class="loading">${this.t.loadingResults}..</div>`:e`
              ${this.filtered.length&&0!==this.filtered.length?e`
                    <lit-virtualizer
                      scroller
                      .items=${this.filtered}
                      .renderItem=${(t,i)=>e`<super-daemon-row
                          data-row-index="${i}"
                          .value="${t.value}"
                          icon="${t.icon}"
                          image="${t.image}"
