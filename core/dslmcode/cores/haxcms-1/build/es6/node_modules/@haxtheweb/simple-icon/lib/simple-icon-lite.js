 ...
 */
import{html as e,svg as t,css as i,LitElement as r}from"../../../lit/index.js";import{SimpleIconsetStore as o}from"./simple-iconset.js";export const SimpleIconBehaviors=function(r){return class extends r{static get styles(){return[super.styles||[],i`
          :host {
            display: inline-flex;
            align-items: center;
        ...
        `]}render(){return this.useSafariPolyfill?e`
            <div
              id="svg-polyfill"
      ...
      `}get feFlood(){return this.noColorize?"":t`<feFlood result="COLOR"/>`}static get properties(){return{...super.properties,dir:{type:String,reflect:!0},src:{type:String},noColorize:{type:Boolean,attribute:"no-colorize"},icon:{type:String,attribute:"icon",reflect:!0}}}constructor(){super(),this.noColorize=!1,this.dir=this.documentDir}get documentDir(){return globalThis.document&&globalThis.document.body&&(globalThis.document.body.getAttribute("xml:dir")||globalThis.document.body.getAttribute("dir")||globalThis.document.documentElement.getAttribute("xml:dir")||globalThis.document.documentElement.getAttribute("dir"))||"ltr"}get useSafariPolyfill(){return globalThis.navigator&&globalThis.navigator.userAgent.indexOf("Safari")>-1}get safariMask(){return this.src&&this.useSafariPolyfill?`url(${this.src}) no-repeat center / contain`:""}firstUpdated(e){if(super.firstUpdated&&super.firstUpdated(e),this.useSafariPolyfill)return;const t="f-"+Math.random().toString().slice(2,10);this.shadowRoot.querySelector("image").style.filter=`url(#${t})`,this.shadowRoot.querySelector("filter").setAttribute("id",t)}setSrcByIcon(e){return this.src=o.getIcon(this.icon,e),this.src}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{"icon"===t&&(this[t]?Promise.resolve().then(()=>{this.setSrcByIcon(this)}):Promise.resolve().then(()=>{this.src=null})),"src"===t&&this[t]&&!this.useSafariPolyfill&&this.shadowRoot.querySelector("image").setAttribute("xlink:href",`${this[t]}`)})}}};class SimpleIconLite extends(SimpleIconBehaviors(r)){static get tag(){return"simple-icon-lite"}}globalThis.customElements.define(SimpleIconLite.tag,SimpleIconLite);export{SimpleIconLite};