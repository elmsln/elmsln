 ...
 */
import{LitElement as r,html as e,css as t}from"../../../lit/index.js";class SimpleSearchMatch extends r{static get tag(){return"simple-search-match"}static get properties(){return{...super.properties,matchNumber:{type:Number,reflect:!0,attribute:"match-number"}}}static get styles(){return[t`
        :host {
          margin-right: 4px;
      ...
      `]}render(){return e` <slot></slot> `}}globalThis.customElements.define(SimpleSearchMatch.tag,SimpleSearchMatch);export{SimpleSearchMatch};