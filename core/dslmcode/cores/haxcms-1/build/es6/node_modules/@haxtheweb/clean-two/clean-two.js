...
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSRememberRoute as a}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{HAXCMSThemeParts as o}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{PrintBranchMixin as r}from"../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{EmailPageMixin as d}from"../haxcms-elements/lib/core/utils/EmailPageMixin.js";import{PDFPageMixin as n}from"../haxcms-elements/lib/core/utils/PDFPageMixin.js";import{QRCodeMixin as s}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{HAXCMSMobileMenuMixin as l}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as c}from"../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{store as p}from"../haxcms-elements/lib/core/haxcms-site-store.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import{autorun as m,toJS as h}from"../../mobx/dist/mobx.esm.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import{normalizeEventPath as g}from"../utils/utils.js";import{MicroFrontendRegistry as b}from"../micro-frontend-registry/micro-frontend-registry.js";import"../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu-content.js";import{DDDSuper as x}from"../d-d-d/d-d-d.js";class CleanTwo extends(c(a(d(n(r(s(o(l(x(i)))))))))){static get styles(){return[super.styles,t`
      ...
      `]}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),document.body.style.overflow="hidden",this.HAXCMSThemeSettings.themeTop=this.shadowRoot.querySelector("#haxcms-theme-top"),this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector(".body-wrapper"),globalThis.AbsolutePositionStateManager.requestAvailability().scrollTarget=this.HAXCMSThemeSettings.scrollTarget,p.internalRoutes.search.callback=this.siteModalForceClick}searchItemSelected(e){this.searchTerm=""}searchChanged(e){var t=g(e)[0];t.value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{this.searchTerm=t.value})):this.searchTerm=""}render(){return e`
        ...
        <div class="content-wrapper">
          <div class="content">
            <header class="header">
              ...
              ${b.has("@haxcms/siteToHtml")?this.PrintBranchButton():e`<replace-tag
    ...
    `}__prevPageLabelChanged(e){this.prevPage=e.detail.value}__nextPageLabelChanged(e){this.nextPage=e.detail.value}static get properties(){let e={};return super.properties&&(e=super.properties),{...e,searchTerm:{type:String},prevPage:{type:String},nextPage:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"clean-two"}constructor(){super(),this.HAXCMSThemeSettings.autoScroll=!0,this.searchTerm="",this.__disposer=this.__disposer?this.__disposer:[],m((e=>{this.activeManifestIndex=h(p.activeManifestIndex),this.__disposer.push(e)})),m((e=>{p.activeItem&&p.activeItem.metadata&&p.activeItem.metadata.updated&&(this.pageTimestamp=h(p.activeItem.metadata.updated)),this.__disposer.push(e)}))}siteModalForceClick(e){setTimeout((()=>{const e=document.querySelector("clean-two");e&&e.shadowRoot&&e.shadowRoot.querySelector("site-modal")&&e.shadowRoot.querySelector("site-modal").shadowRoot&&e.shadowRoot.querySelector("site-modal").shadowRoot.querySelector("simple-icon-button-lite")&&e.shadowRoot.querySelector("site-modal").shadowRoot.querySelector("simple-icon-button-lite").click()}),500)}siteModalClick(e){import("../haxcms-elements/lib/ui-components/site/site-search.js").then((e=>{"search"!==p.getInternalRoute()&&window.history.replaceState({},null,"x/search");const t=new URLSearchParams(p.currentRouterLocation.search),i=window.SimpleModal.requestAvailability().querySelector("site-search").shadowRoot.querySelector("simple-fields-field");i.focus(),t.get("search")&&(i.value=t.get("search"),setTimeout((()=>{i.select()}),0))}))}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}}customElements.define(CleanTwo.tag,CleanTwo);export{CleanTwo};