 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSRememberRoute as a}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{HAXCMSThemeParts as o}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{PrintBranchMixin as r}from"../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{EmailPageMixin as d}from"../haxcms-elements/lib/core/utils/EmailPageMixin.js";import{PDFPageMixin as n}from"../haxcms-elements/lib/core/utils/PDFPageMixin.js";import{QRCodeMixin as s}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{HAXCMSMobileMenuMixin as l}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as c}from"../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{LTIResizingMixin as p}from"../haxcms-elements/lib/core/utils/LTIResizingMixin.js";import{store as m}from"../haxcms-elements/lib/core/haxcms-site-store.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import{autorun as h,toJS as g}from"../../mobx/dist/mobx.esm.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import{normalizeEventPath as b}from"../utils/utils.js";import{MicroFrontendRegistry as u}from"../micro-frontend-registry/micro-frontend-registry.js";import"../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../haxcms-elements/lib/ui-components/navigation/site-menu-content.js";import{DDDSuper as x}from"../d-d-d/d-d-d.js";class CleanTwo extends(p(c(a(d(n(r(s(o(l(x(i))))))))))){static get styles(){return[super.styles,t`
        :host {
      ...
      `]}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),globalThis.document.body.style.overflow="hidden",this.HAXCMSThemeSettings.themeTop=this.shadowRoot.querySelector("#haxcms-theme-top"),this.HAXCMSThemeSettings.siteMenuContent=this.shadowRoot.querySelector(".body-wrapper"),this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector(".content-wrapper"),globalThis.AbsolutePositionStateManager.requestAvailability().scrollTarget=this.HAXCMSThemeSettings.scrollTarget,m.internalRoutes.search.callback=this.siteModalForceClick,globalThis.DesignSystemManager.requestAvailability().active="ddd"}searchItemSelected(e){this.searchTerm=""}searchChanged(e){var t=b(e)[0];t.value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{this.searchTerm=t.value})):this.searchTerm=""}render(){return e`
      <div class="body-wrapper">
        ...
        <div class="content-wrapper">
          <div class="content">
            ...
            <header class="header">
              ${["xl"].includes(this.responsiveSize)?"":e`
              ...
              ${u.has("@core/htmlToPdf")?this.PDFPageButton():""}
              ${u.has("@haxcms/siteToHtml")?e`${this.PrintSiteButton()}${this.PrintBranchButton()}`:e`<replace-tag
    ...
    `}__prevPageLabelChanged(e){this.prevPage=e.detail.value}__nextPageLabelChanged(e){this.nextPage=e.detail.value}static get properties(){let e={};return super.properties&&(e=super.properties),{...e,searchTerm:{type:String},prevPage:{type:String},nextPage:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"clean-two"}constructor(){super(),this.xl=1800,this.HAXCMSThemeSettings.autoScroll=!0,this.searchTerm="",this.__disposer=this.__disposer?this.__disposer:[],h((e=>{this.activeManifestIndex=g(m.activeManifestIndex),this.__disposer.push(e)})),h((e=>{m.activeItem&&m.activeItem.metadata&&m.activeItem.metadata.updated&&(this.pageTimestamp=g(m.activeItem.metadata.updated)),this.__disposer.push(e)}))}siteModalForceClick(e){setTimeout((()=>{const e=globalThis.document.querySelector("clean-two");e&&e.shadowRoot&&e.shadowRoot.querySelector("site-modal")&&e.shadowRoot.querySelector("site-modal").shadowRoot&&e.shadowRoot.querySelector("site-modal").shadowRoot.querySelector("simple-icon-button-lite")&&e.shadowRoot.querySelector("site-modal").shadowRoot.querySelector("simple-icon-button-lite").click()}),500)}siteModalClick(e){import("../haxcms-elements/lib/ui-components/site/site-search.js").then((e=>{"search"!==m.getInternalRoute()&&globalThis.history.replaceState({},null,"x/search");const t=new URLSearchParams(m.currentRouterLocation.search),i=globalThis.SimpleModal.requestAvailability().querySelector("site-search").shadowRoot.querySelector("simple-fields-field");i.focus(),t.get("search")&&(i.value=t.get("search"),setTimeout((()=>{i.select()}),0))}))}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();globalThis.document.body.style.removeProperty("overflow"),super.disconnectedCallback()}}globalThis.customElements.define(CleanTwo.tag,CleanTwo);export{CleanTwo};