 ...
 */
import{html as e,css as t,LitElement as i}from"../../lit/index.js";import{SchemaBehaviors as a}from"../schema-behaviors/schema-behaviors.js";import{IntersectionObserverMixin as o}from"../intersection-element/lib/IntersectionObserverMixin.js";import{I18NMixin as s}from"../i18n-manager/lib/I18NMixin.js";import"../simple-icon/lib/simple-icon-button-lite.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import{pageBreakManager as l}from"./lib/page-break-manager.js";import{DDDExtra as r}from"../d-d-d/lib/DDDStyles.js";import{store as n}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as d,toJS as h}from"../../mobx/dist/mobx.esm.js";export class PageBreak extends(o(s(a(i)))){static get tag(){return"page-break"}constructor(){super(),this.relatedItems=null,this.icon=null,this.accentColor=null,this.entityType="page",this.status="",this.author=null,this.linkUrl=null,this.linkTarget="_self",this.t={newPage:"New page",pageBreak:"Page break",selectToEditPageDetails:"Select to edit Page details",noParent:"No parent",toggleLock:"Toggle lock",togglePublished:"Toggle published",linkMessage:"Users will be redirected to:",linkOpensInNewWindow:"Opens in new window",linkOpensInSameWindow:"Opens in same window",pageActions:"Page Actions",editPage:"Edit page",modifyPageTitle:"Modify page title",modifyPageIcon:"Modify page icon",editMedia:"Edit Media",editTags:"Edit tags",viewRevisions:"View revisions",pageReport:"Page report",lock:"Lock",unlock:"Unlock",publish:"Publish",unpublish:"Unpublish",savePage:"Save page",cancel:"Cancel"},this.registerLocalization({context:this,localesPath:new URL("./locales/page-break.es.json",import.meta.url).href+"/../"}),this.description=null,this.hideInMenu=!1,this.noderefs=[],this.developerTheme=null,this.tags=null,this.title=this.t.newPage,this.pageType=null,this.slug="",this.published=!1,this.image=null,this.target=null,this.locked=!1,this.overridePathauto=!1,this.order=null,this.depth=0,this.itemId=null,this._haxState=!1,this.hidden=!n.platformAllows("pageBreak"),this.IORemoveOnVisible=!1,this.IODelay=250,this.remoteHeadingobserver=new MutationObserver(()=>{this.title!=this.target.innerText&&(this.__moUpdate=!0,this.title=this.target.innerText)}),this.iconType="editor:format-page-break",this.breakType="node",this.isLoggedIn=!1,this._editingUILoaded=!1,this.__disposer=[],this.__disposer.push(d(e=>{const t=h(n.isLoggedIn);Promise.resolve().then(()=>{this.isLoggedIn=t})}))}_openPageReport(e){const t=this.shadowRoot.querySelector("#menu");if(t&&t.close(),!n.platformAllows("insights"))return;const i="string"==typeof this.itemId&&""!==this.itemId.trim()?this.itemId.trim():n.activeItem&&n.activeItem.id?`${n.activeItem.id}`:"",a=n&&n.cmsSiteEditor&&n.cmsSiteEditor.haxCmsSiteEditorUIElement?n.cmsSiteEditor.haxCmsSiteEditorUIElement:null;if(!i||!a||!a._reportsButtonTap)return;const o=globalThis.SuperDaemonManager&&globalThis.SuperDaemonManager.requestAvailability?globalThis.SuperDaemonManager.requestAvailability():null,s=o&&o.allItems&&Array.isArray(o.allItems)?o.allItems.find(e=>e&&"CMS/admin/reports"===e.path&&"super-daemon-element-method"===e.eventName&&e.value&&e.value.target&&e.value.method):null;if(s){const t=s.value&&s.value.args&&Array.isArray(s.value.args)?[...s.value.args]:[];let a={};return t[2]&&"object"==typeof t[2]&&!Array.isArray(t[2])&&(a={...t[2]}),t[2]={...a,reportScope:"page",reportNodeId:i,invokedBy:e&&e.target?e.target:null},void globalThis.dispatchEvent(new CustomEvent(s.eventName,{bubbles:!0,composed:!0,cancelable:!0,detail:{...s.value,args:t}}))}a._reportsButtonTap(null,!1,{reportScope:"page",reportNodeId:i,invokedBy:e&&e.target?e.target:null})}static get properties(){return{...super.properties||{},iconType:{type:String},noderefs:{type:Array,attribute:!1},relatedItems:{type:String,attribute:"related-items"},icon:{type:String},accentColor:{type:String,attribute:"accent-color"},entityType:{type:String,attribute:"entity-type"},description:{type:String},order:{type:Number},hideInMenu:{type:Boolean,reflect:!0,attribute:"hide-in-menu"},tags:{type:String,reflect:!0},developerTheme:{type:String,attribute:"developer-theme"},title:{type:String,reflect:!0},slug:{type:String,reflect:!0},image:{type:String},parent:{type:String,reflect:!0},published:{type:Boolean,reflect:!0},locked:{type:Boolean,reflect:!0},overridePathauto:{type:Boolean,reflect:!0,attribute:"override-pathauto"},depth:{type:Number,reflect:!0},itemId:{type:String,attribute:"item-id",reflect:!0},breakType:{type:String,attribute:"break-type"},status:{type:String},pageType:{type:String,attribute:"page-type"},author:{type:String},linkUrl:{type:String,attribute:"link-url"},linkTarget:{type:String,attribute:"link-target"},_haxState:{type:Boolean},hidden:{type:Boolean,reflect:!0},isLoggedIn:{type:Boolean,reflect:!0,attribute:"is-logged-in"}}}async _ensureEditingUI(){!this._editingUILoaded&&n.platformAllows("pageBreak")&&(await Promise.all([import("../simple-toolbar/lib/simple-toolbar-button.js"),import("../simple-fields/lib/simple-context-menu.js")]),this._editingUILoaded=!0,this.requestUpdate())}connectedCallback(){super.connectedCallback(),"node"===this.breakType&&(this.nextElementSibling&&this.nextElementSibling.tagName&&["H1","H2","H3","H4","H5","H6"].includes(this.nextElementSibling.tagName)?(this.title=this.nextElementSibling.innerText,this.target=this.nextElementSibling,this.setupTargetData(this.target)):setTimeout(()=>{if(null===this.target)if(this.nextElementSibling&&this.nextElementSibling.tagName&&["H1","H2","H3","H4","H5","H6"].includes(this.nextElementSibling.tagName))this.title=this.nextElementSibling.innerText,this.target=this.nextElementSibling,this.setupTargetData(this.target);else{let e=0===this.depth?"h2":`h${this.depth+2}`,t=globalThis.document.createElement(e);t.setAttribute("data-original-level","H2"),t.innerText=this.title,this.parentNode.insertBefore(t,this.nextElementSibling),setTimeout(()=>{this.setupTargetData(this.nextElementSibling)},100)}},0)),globalThis.dispatchEvent(new CustomEvent("page-break-registration",{composed:!0,bubbles:!0,cancelable:!0,detail:{value:this,action:"add"}})),globalThis.dispatchEvent(new CustomEvent("page-break-change",{composed:!0,bubbles:!0,cancelable:!0,detail:{value:this}}))}disconnectedCallback(){for(var e in globalThis.dispatchEvent(new CustomEvent("page-break-registration",{detail:{value:this,action:"remove"}})),globalThis.dispatchEvent(new CustomEvent("page-break-change",{composed:!0,bubbles:!0,cancelable:!0,detail:{value:this}})),this.remoteHeadingobserver.disconnect(),this.__disposer)"function"==typeof this.__disposer[e]?this.__disposer[e]():this.__disposer[e]&&"function"==typeof this.__disposer[e].dispose&&this.__disposer[e].dispose();super.disconnectedCallback()}setupTargetData(e){this.target&&this.remoteHeadingobserver.disconnect(),this.target=e,this.target&&this.target instanceof Node?(this._haxSibling=this,this.remoteHeadingobserver.observe(this.target,{characterData:!0,childList:!0,subtree:!0})):console.warn("page-break: setupTargetData called with invalid target",this.target)}getCurrentUser(){return globalThis.HAXCMS&&globalThis.HAXCMS.requestAvailability().store.userData&&globalThis.HAXCMS.requestAvailability().store.userData.userName?globalThis.HAXCMS.requestAvailability().store.userData.userName:globalThis.store&&globalThis.store.user&&globalThis.store.user.name?globalThis.store.user.name:null}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{if("isLoggedIn"===t&&this.isLoggedIn&&!this._editingUILoaded&&this._ensureEditingUI(),["title","description","tags","published","locked","overridePathauto"].includes(t)&&void 0!==e){const e=this.getCurrentUser();e&&e!==this.author&&(this.author=e)}if("noderefs"===t){let e=[];for(let t=0;t<this.noderefs.length;t++)e.push(this.noderefs[t].node);this.relatedItems=e.join(",")}"schemaResourceID"===t&&null==this.itemId&&void 0!==e&&(this.itemId=this.schemaResourceID.replace("#","item-")),this.locked&&"locked"===t?l.elementsBetween(this).forEach(e=>{e.setAttribute("data-hax-lock","data-hax-lock")}):!this.locked&&"locked"===t&&e&&l.elementsBetween(this).forEach(e=>{e.removeAttribute("data-hax-lock")}),this._ceMenu&&["locked","parent","published"].includes(t)&&this._updateHAXCEMenu(),"overridePathauto"===t&&void 0!==e&&globalThis.dispatchEvent(new CustomEvent("hax-refresh-tray-form",{})),["title","parent","slug"].includes(t)&&globalThis.dispatchEvent(new CustomEvent("page-break-change",{composed:!0,bubbles:!0,cancelable:!0,detail:{value:this}})),"node"===this.breakType&&this.target&&("title"===t&&this[t]&&(this.__moUpdate?this.__moUpdate=!1:this.title!=this.target.innerText&&(this.target.innerText=this.title)),!this._haxState&&"depth"===t&&this.depth>=0&&l.elementsBetween(this,"page-break","h1,h2,h3,h4,h5,h6").forEach(e=>{let t=(e.getAttribute("data-original-level")?new Number(e.getAttribute("data-original-level").replace("H","")):new Number(e.tagName.replace("H","")))+this.depth;t=t>6?6:t;const i=globalThis.document.createElement(`h${t}`);i.setAttribute("data-original-level",e.tagName);for(var a=0,o=e.attributes.length;a<o;++a)i.setAttribute(e.attributes.item(a).nodeName,e.attributes.item(a).nodeValue);i.innerHTML=e.innerHTML,this.setupTargetData(i),e.parentNode.replaceChild(i,e)}),"_haxState"===t&&void 0!==e&&(this._haxState?l.elementsBetween(this,"page-break","h1,h2,h3,h4,h5,h6").forEach(e=>{if(e.getAttribute("data-original-level")){let a=new Number(e.getAttribute("data-original-level").replace("H",""));const o=globalThis.document.createElement(`h${a}`);for(var t=0,i=e.attributes.length;t<i;++t)o.setAttribute(e.attributes.item(t).nodeName,e.attributes.item(t).nodeValue);o.innerHTML=e.innerHTML,e.parentNode.replaceChild(o,e),this.setupTargetData(o)}}):l.elementsBetween(this,"page-break","h1,h2,h3,h4,h5,h6").forEach(e=>{let t=(e.getAttribute("data-original-level")?new Number(e.getAttribute("data-original-level").replace("H","")):new Number(e.tagName.replace("H","")))+this.depth;t=t>6?6:t;const i=globalThis.document.createElement(`h${t}`);i.setAttribute("data-original-level",e.tagName);for(var a=0,o=e.attributes.length;a<o;++a)i.setAttribute(e.attributes.item(a).nodeName,e.attributes.item(a).nodeValue);i.innerHTML=e.innerHTML,e.parentNode.replaceChild(i,e),this.setupTargetData(i)}))),"breakType"===t&&("node"===this[t]?this.iconType="editor:format-page-break":this.iconType="hax:page-details")})}static get styles(){return[r,t`
        :host {
          display: block;
          position: relative;
          height: 0;
      ...
      `]}firstUpdated(e){if(super.firstUpdated&&super.firstUpdated(e),this.relatedItems){const e=this.relatedItems.split(",");for(let t=0;t<e.length;t++)this.noderefs.push({node:e[t]})}null!=this.itemId&&(this.schemaResourceID=this.itemId)}render(){const t="string"==typeof this.itemId&&""!==this.itemId.trim()?this.itemId.trim():"",i=t?`#${t}`:this.slug;return e`
      <a .href="${i}" .name="${t}" class="sr-only">${this.title}</a>
      <div class="text">
      ...
      ${this.isLoggedIn&&!this._haxState?e`
            ...
            <simple-context-menu id="menu" title="${this.t.pageActions}">
              ...
              <simple-toolbar-button
                ...
                ?disabled="${this.locked}"
                ?hidden=${!n.platformAllows("uploadMedia")}
              ></simple-toolbar-button>
              <simple-toolbar-button
                class="menu-item"
                icon="icons:label"
              ...
              <simple-toolbar-button
                ...
                ?hidden=${!n.platformAllows("insights")}
              ></simple-toolbar-button>
              <simple-toolbar-button
                class="menu-item"
              ...
              <simple-toolbar-button
                ...
                ?disabled="${this.locked}"
                ?hidden=${!n.platformAllows("deletePage")}
              ></simple-toolbar-button>
            </simple-context-menu>
          `:""}
      ${this.isLoggedIn&&this._haxState?e`
            ...
            ></simple-toolbar-button>
          `:""}
    `}_toggleMenu(e){e.stopPropagation();const t=this.shadowRoot.querySelector("#menu");t&&t.toggle(e.target)}_editPage(e){if(this.locked){const e=this.shadowRoot.querySelector("#menu");return e&&e.close(),n.toast("This page is locked. Unlock it first to edit.",3e3,{hat:"error"}),void n.playSound("error")}const t=this.shadowRoot.querySelector("#menu");t&&t.close(),n.cmsSiteEditor.haxCmsSiteEditorUIElement._editButtonTap()}_cancelEdit(e){n.cmsSiteEditor.haxCmsSiteEditorUIElement._cancelButtonTap(e)}async _editTitle(e){if(this.locked){const e=this.shadowRoot.querySelector("#menu");return e&&e.close(),n.toast("This page is locked. Unlock it first to edit.",3e3,{hat:"error"}),void n.playSound("error")}const t=this.shadowRoot.querySelector("#menu");t&&t.close();const i=h(n.activeItem);if(!i||!i.id)return void console.warn("page-break _editTitle: No active item found");if(!globalThis.SuperDaemonManager)return void console.error("page-break _editTitle: SuperDaemonManager not available");const a=globalThis.SuperDaemonManager.requestAvailability();n.playSound("click"),a.waveWand(["","/",{},"edit-title","Edit title"])}async _editIcon(e){if(this.locked){const e=this.shadowRoot.querySelector("#menu");return e&&e.close(),n.toast("This page is locked. Unlock it first to edit.",3e3,{hat:"error"}),void n.playSound("error")}const t=this.shadowRoot.querySelector("#menu");t&&t.close();const{SimpleIconsetStore:i}=await(import("../simple-icon/lib/simple-iconset.js")),a=h(n.activeItem);if(!a||!a.id)return;const o=globalThis.SuperDaemonManager.requestAvailability();n.playSound("click");const s=i&&i.iconlist?[...i.iconlist].sort():[];o.defineOption({title:"Edit Icon",icon:"icons:image",priority:-1e4,tags:["edit","icon"],eventName:"super-daemon-run-program",path:"CMS/edit/icon",value:{name:"edit-icon",machineName:"edit-icon",placeholder:"Type to search icons by name",program:async e=>{const t=e?e.toLowerCase():"",i=[];return(t?s.filter(e=>e.toLowerCase().includes(t)):s.slice(0,50)).forEach(e=>{const t=e.replace(/^.*:/,"").replace(/-/g," ").replace(/\b\w/g,e=>e.toUpperCase());i.push({title:`${t} (${e})`,icon:e,tags:["icon"],value:{target:globalThis,method:"dispatchEvent",args:[new CustomEvent("haxcms-save-node-details",{bubbles:!0,composed:!0,cancelable:!0,detail:{id:a.id,idOrSlug:a.id,operation:"setIcon",icon:e}})]},eventName:"super-daemon-element-method",path:`CMS/edit/icon/${e}`})}),0===i.length?[{title:t?`No icons found for "${t}"`:"No icons available",icon:"icons:search",tags:["empty"],value:{disabled:!0},eventName:"disabled",path:"No results"}]:(!t&&s.length>50&&i.push({title:`Showing 50 of ${s.length} icons - type to search`,icon:"icons:info",tags:["hint"],value:{disabled:!0},eventName:"disabled",path:"Hint"}),i)}}}),o.waveWand(["","/",{},"edit-icon","Edit Icon"])}async _editMedia(e){if(this.locked){const e=this.shadowRoot.querySelector("#menu");return e&&e.close(),n.toast("This page is locked. Unlock it first to edit.",3e3,{hat:"error"}),void n.playSound("error")}const t=this.shadowRoot.querySelector("#menu");t&&t.close();const i=globalThis.SuperDaemonManager.requestAvailability();n.playSound("click"),i.waveWand(["","/",{},"hax-agent","Agent"])}async _editTags(e){if(this.locked){const e=this.shadowRoot.querySelector("#menu");return e&&e.close(),n.toast("This page is locked. Unlock it first to edit.",3e3,{hat:"error"}),void n.playSound("error")}const t=this.shadowRoot.querySelector("#menu");t&&t.close();const i=h(n.activeItem);if(!i||!i.id)return;const a=globalThis.SuperDaemonManager.requestAvailability();a.close(),n.playSound("click");const o=i.metadata&&i.metadata.tags||"";this._originalTags=o,a.waveWand([o,"/",{},"edit-tags","Edit tags"]);const handleEscape=e=>{"Escape"===e.key&&(this.tags=this._originalTags,globalThis.removeEventListener("keydown",handleEscape))};globalThis.addEventListener("keydown",handleEscape,{once:!0})}_openRevisions(e){const t=this.shadowRoot.querySelector("#menu");t&&t.close();const i="string"==typeof this.itemId&&""!==this.itemId.trim()?this.itemId.trim():n.activeItem&&n.activeItem.id?n.activeItem.id:"";i&&(n.playSound("click"),globalThis.dispatchEvent(new CustomEvent("haxcms-open-page-revisions",{bubbles:!0,composed:!0,cancelable:!0,detail:{nodeId:i,nodeTitle:this.title||"",source:"page-break"}})))}async _toggleLocked(e){const t=this.shadowRoot.querySelector("#menu");t&&t.close();const i=h(n.activeItem);i&&i.id&&(n.playSound("click"),globalThis.dispatchEvent(new CustomEvent("haxcms-save-node-details",{bubbles:!0,composed:!0,cancelable:!0,detail:{id:i.id,idOrSlug:i.id,operation:"setLocked",locked:!this.locked}})))}async _togglePublished(e){if(this.locked){const e=this.shadowRoot.querySelector("#menu");return e&&e.close(),n.toast("This page is locked. Unlock it first to change publish status.",3e3,{hat:"error"}),void n.playSound("error")}const t=this.shadowRoot.querySelector("#menu");t&&t.close();const i=h(n.activeItem);i&&i.id&&(n.playSound("click"),globalThis.dispatchEvent(new CustomEvent("haxcms-save-node-details",{bubbles:!0,composed:!0,cancelable:!0,detail:{id:i.id,idOrSlug:i.id,operation:"setPublished",published:!this.published}})))}async _savePage(e){n.cmsSiteEditor.haxCmsSiteEditorUIElement._editButtonTap()}_deletePage(e){if(this.locked){const e=this.shadowRoot.querySelector("#menu");return e&&e.close(),n.toast("This page is locked. Unlock it first to delete.",3e3,{hat:"error"}),void n.playSound("error")}const t=this.shadowRoot.querySelector("#menu");t&&t.close(),n.cmsSiteEditor.haxCmsSiteEditorUIElement._deleteButtonTap()}static get haxProperties(){return new URL("./lib/page-break.haxProperties.json",import.meta.url).href}haxHooks(){return{editModeChanged:"haxeditModeChanged",inlineContextMenu:"haxinlineContextMenu",activeElementChanged:"haxactiveElementChanged",setupActiveElementForm:"haxsetupActiveElementForm",preProcessInsertContent:"haxpreProcessInsertContent",trayDragNDropToNode:"haxtrayDragNDropToNode"}}async haxpreProcessInsertContent(e,t){let i=t;if(i&&i.parentNode){for(;"HAX-BODY"!==i.parentNode.tagName;)i=i.parentNode;const t=await l.associatedPageBreak(i);t&&(e.properties.parent=t.parent,e.properties.order=t.order+1,e.properties.published=t.published,e.properties.locked=t.locked)}return e}async haxtrayDragNDropToNode(e){let t=e;for(;"HAX-BODY"!==t.parentNode.tagName;)t=t.parentNode;const i=await l.associatedPageBreak(t);i&&(e.parent=i.parent,e.order=i.order+1,e.published=i.published,e.locked=i.locked)}haxsetupActiveElementForm(e){if(globalThis.HAXCMS){const i=globalThis.HAXCMS.requestAvailability().store.getManifestItems(!0);var t=[{text:`-- ${this.t.noParent} --`,value:null}];const a=new Set,collectDescendants=e=>{i.forEach(t=>{t.parent===e&&(a.add(t.id),collectDescendants(t.id))})};this.itemId&&collectDescendants(this.itemId),i.forEach(e=>{let o=e,s="- ";for(;o&&null!=o.parent;)o=i.find(e=>e.id==o.parent),o&&(s="--"+s);t.push({text:s+e.title,value:e.id,disabled:e.id===this.itemId||a.has(e.id)})}),e.settings.advanced.forEach((i,a)=>{"parent"===i.property&&(e.settings.advanced[a].inputMethod="select",e.settings.advanced[a].itemsList=t),"noderefs"===i.property&&(e.settings.advanced[a].properties[0].inputMethod="select",e.settings.advanced[a].properties[0].itemsList=t)}),e.settings.developer.forEach((t,i)=>{if("developerTheme"===t.property&&globalThis.appSettings&&globalThis.appSettings.themes){var a=[{text:"",value:null}];Object.keys(globalThis.appSettings.themes).map(e=>{a.push({text:globalThis.appSettings.themes[e].name,value:globalThis.appSettings.themes[e].element})}),e.settings.developer[i].inputMethod="select",e.settings.developer[i].itemsList=a}}),e.settings.developer.forEach((t,i)=>{if("author"===t.property){const t=this.getCurrentUser();t&&!this.author&&(this.author=t,e.settings.developer[i].value=t)}}),e.settings.advanced.forEach((t,i)=>{if("slug"===t.property){const t=n.manifest,a=t&&t.metadata&&t.metadata.site&&t.metadata.site.settings&&!0===t.metadata.site.settings.pathauto;e.settings.advanced[i].disabled=a&&!this.overridePathauto}})}}haxactiveElementChanged(e,t){!t&&this._ceMenu&&("site"===this.breakType?(this._ceMenu.disableOps=!1,this._ceMenu.canMoveElement=!0,this._ceMenu.insertAbove=!0):this._ceMenu.disableDuplicate=!1)}haxeditModeChanged(e){this._haxState=e}haxinlineContextMenu(e){this._ceMenu=e,this._updateHAXCEMenu(),"site"===this.breakType?(this._ceMenu.disableOps=!0,this._ceMenu.canMoveElement=!1,this._ceMenu.insertAbove=!1):this._ceMenu.disableDuplicate=!0}_updateHAXCEMenu(){this._ceMenu.ceButtons=[{icon:this.locked?"icons:lock":"icons:lock-open",callback:"haxClickInlineLock",label:this.t.toggleLock},{icon:this.published?"lrn:view":"lrn:view-off",callback:"haxClickInlinePublished",label:this.t.togglePublished}]}haxClickLockInPage(e){this.locked=!this.locked,globalThis.dispatchEvent(new CustomEvent("hax-refresh-tray-form",{}))}haxClickInlineLock(e){return this.locked=!this.locked,!0}haxClickInlinePublished(e){return this.published=!this.published,!0}}globalThis.customElements.define(PageBreak.tag,PageBreak);