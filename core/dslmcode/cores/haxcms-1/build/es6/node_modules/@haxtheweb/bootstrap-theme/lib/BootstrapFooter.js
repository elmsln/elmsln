import{LitElement as o,html as t,css as r}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import{store as e}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as a,toJS as s}from"../../../mobx/dist/mobx.esm.js";class BootstrapFooter extends o{static get tag(){return"bootstrap-footer"}static get styles(){return[r`
        :host {
          margin-bottom: 10px;
      ...
      `]}static get properties(){return{_backwardItem:{type:Object},_forwardItem:{type:Object},colorTheme:{type:String,attribute:"color-theme"}}}constructor(){super(),this._bootstrapPath=this._resolveBootstrapStylesheetPath(),this._forwardItem={},this._backwardItem={},this._activeItemIndex=-1,this._routerManifest={},this.__disposer=this.__disposer?this.__disposer:[],this.__disposer.push(a(o=>{let t=s(e.activeManifestIndex),r=s(e.routerManifest);this._activeItem===t&&this._routerManifest===r||(this._activeItem=t,this._routerManifest=r,r.items[t-1]&&(this._backwardItem=r.items[t-1]),r.items[t+1]&&(this._forwardItem=r.items[t+1]))}))}render(){return t`
    ...
    `}_resolveBootstrapStylesheetPath(){const o=decodeURIComponent(import.meta.url);return-1!==o.indexOf("/node_modules/@haxtheweb/")?new URL("../../bootstrap/dist/css/bootstrap.min.css",o).href:new URL("../../../node_modules/bootstrap/dist/css/bootstrap.min.css",o).href}}globalThis.customElements.define(BootstrapFooter.tag,BootstrapFooter);export{BootstrapFooter};