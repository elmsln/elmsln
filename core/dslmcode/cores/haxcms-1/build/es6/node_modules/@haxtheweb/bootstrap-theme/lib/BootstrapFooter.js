import{LitElement as o,html as t,css as r}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import{store as e}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as a,toJS as s}from"../../../mobx/dist/mobx.esm.js";class BootstrapFooter extends o{static get tag(){return"bootstrap-footer"}static get styles(){return[r`
      ...
      `]}static get properties(){return{_backwardItem:{type:Object},_forwardItem:{type:Object},colorTheme:{type:String,attribute:"color-theme"}}}constructor(){super();let o=this.getBasePath(decodeURIComponent(import.meta.url));this._bootstrapPath=o+"bootstrap/dist/css/bootstrap.min.css",this._forwardItem={},this._backwardItem={},this._activeItemIndex=-1,this._routerManifest={},this.__disposer=this.__disposer?this.__disposer:[],a((o=>{let t=s(e.activeManifestIndex),r=s(e.routerManifest);this._activeItem===t&&this._routerManifest===r||(this._activeItem=t,this._routerManifest=r,r.items[t-1]&&(this._backwardItem=r.items[t-1]),r.items[t+1]&&(this._forwardItem=r.items[t+1])),this.__disposer.push(o)}))}render(){return t`
    ...
    `}getBasePath(o){return o.substring(0,o.lastIndexOf("/@haxtheweb/")+1)}}globalThis.customElements.define(BootstrapFooter.tag,BootstrapFooter);export{BootstrapFooter};