...
import{html as t,css as o,LitElement as i}from"../../../lit/index.js";import"./simple-icons.js";import"./simple-icon-lite.js";export const SimpleIconButtonBehaviors=function(i){return class extends i{constructor(){super(),this.ariaLabelledby="",this.controls="",this.disabled=!1,this.form="",this.label="",this.fieldName="",this.type="",this.value="",this.icon=""}static get styles(){return[super.styles||[],o`
        ...
        <button
          ...
          aria-pressed="${this.toggles?this.toggled?"true":"false":void 0}"
          aria-controls="${this.controls||void 0}"
          part="button"
      ...
      `}static get properties(){return{...super.properties,autofocus:{type:Boolean},ariaLabelledby:{attribute:"aria-labelledby",type:String},controls:{type:String},disabled:{type:Boolean},fieldName:{attribute:"field-name",type:String},form:{type:String},icon:{type:String,reflect:!0},label:{type:String},type:{type:String},value:{type:String,reflect:!0},toggles:{type:Boolean,reflect:!0},toggled:{type:Boolean,reflect:!0}}}}};class SimpleIconButtonLite extends(SimpleIconButtonBehaviors(i)){static get tag(){return"simple-icon-button-lite"}constructor(){super(),this.type="button"}}globalThis.customElements.define(SimpleIconButtonLite.tag,SimpleIconButtonLite);export{SimpleIconButtonLite};