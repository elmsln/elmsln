 ...
 */
import{LitElement as t,html as e,css as o}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import{store as r}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as a,toJS as s}from"../../../mobx/dist/mobx.esm.js";class BootstrapBreadcrumb extends t{static get styles(){return[o`
        :host {
      ...
      `]}static get tag(){return"bootstrap-breadcrumb"}static get properties(){return{items:{type:Array},homeItem:{type:Object},colorTheme:{type:String,reflect:!0,attribute:"color-theme"}}}constructor(){super(),this.items=[],this._activeItem={},this.homeItem={},this._bootstrapPath=this._resolveBootstrapStylesheetPath(),this.__disposer=this.__disposer?this.__disposer:[],this.__disposer.push(a(t=>{let e=s(r.manifest.items[0]),o=s(r.activeItem);this.homeItem!==e&&(this.homeItem=e),o&&this._activeItem!==o&&(this.items=[],this._activeItem=o,this.items.push(o),o.parent&&this.addParentToItems(o))}))}render(){return e`
      ...
      <div class="container p-0 mb-3">
        <nav aria-label="Breadcrumb navigation">
          <ol class="breadcrumb m-auto">
            ...
            ${this.items.map((t,o)=>{const r=o===this.items.length-1;return e`
                <li
                  class="breadcrumb-item ${r?"active":""}"
                  data-bs-toggle="tooltip"
                  data-bs-placement="top"
                  title="${t.title}"
                  ${r?'aria-current="page"':""}
                >
                  ${r?e`<span>${t.title}</span>`:e`<a
                        href="${t.slug}"
    ...
    `}_resolveBootstrapStylesheetPath(){const t=decodeURIComponent(import.meta.url);return-1!==t.indexOf("/node_modules/@haxtheweb/")?new URL("../../bootstrap/dist/css/bootstrap.min.css",t).href:new URL("../../../node_modules/bootstrap/dist/css/bootstrap.min.css",t).href}getParentById(t){let e=r.manifest.items.map(t=>s(t.id)).indexOf(t);return s(r.manifest.items[e])}addParentToItems(t){let e=this.getParentById(t.parent);this.items.unshift(e),e.parent&&this.addParentToItems(e)}firstUpdated(t){}updated(t){t.forEach((t,e)=>{})}}globalThis.customElements.define(BootstrapBreadcrumb.tag,BootstrapBreadcrumb);export{BootstrapBreadcrumb};