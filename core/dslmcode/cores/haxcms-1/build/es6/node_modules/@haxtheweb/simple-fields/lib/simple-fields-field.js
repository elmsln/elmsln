import{LitElement as e,html as t,css as i}from"../../../lit/index.js";import{SimpleFieldsContainerBehaviors as o}from"./simple-fields-container.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/simple-icon.js";const SimpleFieldsFieldBehaviors=function(e){return class extends(o(e)){static get tag(){return"simple-fields-field"}static get styles(){return[super.styles,i`
          fieldset {
            margin: 0;
            padding: 0;
            border: none;
          ...
          <div id="options" part="fieldset-options">
            ${(this.sortedOptions||[]).map((e=>t`
                <div
                  class="option"
                  part="option"
                  @click="${t=>{"DIV"===t.target.tagName&&(t.preventDefault(),t.stopPropagation(),this._handleIconClick(this.getChecked(e),e))}}"
                >
                  <label
                    for="${this.id}.${e.value}"
                    class="radio-label"
                    part="option-label"
                    >${e.html?t`<div
                          @click="${t=>{t.preventDefault(),t.stopPropagation(),this._handleIconClick(this.getChecked(e),e)}}"
                        >
                          ${e.html}
                        </div>`:e.text}</label
                  >${this.getInput(e)}
