...
import{html as t,css as e}from"../../lit/index.js";import{DDD as o}from"../d-d-d/d-d-d.js";import"../simple-icon/lib/simple-icon-button-lite.js";import"../simple-tooltip/simple-tooltip.js";class PageSection extends o{constructor(){super(),this.AbortControllers=new AbortController,this.filter=!1,this.fold=!1,this.full=!1,this.scroller=!1,this.bg=null,this.image=null,this.accentColor="blue",this.scrollerLabel="Scroll to reveal content",this.preset=null,this.anchor=null}static get properties(){return{...super.properties,anchor:{type:String},scrollerLabel:{type:String,attribute:"scroller-label"},filter:{type:Boolean,reflect:!0},fold:{type:Boolean,reflect:!0},full:{type:Boolean,reflect:!0},scroller:{type:Boolean,reflect:!0},bg:{type:String},image:{type:String,reflect:!0},preset:{type:String,reflect:!0}}}static get styles(){let t=[];return super.styles&&(t=super.styles),[t,e`
      ...
      `]}cleanAnchor(t){return t?t.replace(/[^a-zA-Z]+/g,"").toLowerCase():""}videoPlay(t){this.bg="var(--ddd-theme-default-coalyGray)"}videoPause(t){this.bg="var(--ddd-theme-default-limestoneLight)"}updated(t){if(t.has("preset")&&this.preset)switch(this.preset){case"antihero":this.bg="var(--ddd-theme-default-limestoneLight)",this.image=new URL("./lib/assets/geo-bkg.png",import.meta.url).href;break;case"video":this.bg="var(--ddd-theme-default-limestoneLight)",this.image=null,this.AbortControllers.abort(),this.AbortControllers=new AbortController,this.addEventListener("play",this.videoPlay.bind(this),{signal:this.AbortControllers.signal}),this.addEventListener("pause",this.videoPause.bind(this),{signal:this.AbortControllers.signal});break;case"antihero-light":this.bg="var(--ddd-theme-default-slateMaxLight)",this.image=null;break;case"lines":this.bg="var(--ddd-theme-default-white)",this.image=new URL("./lib/assets/texture-lines.svg",import.meta.url).href}t.has("anchor")&&this.anchor&&this.shadowRoot&&!this.getAttribute("id")&&this.setAttribute("id",this.cleanAnchor(this.anchor))}bgStyle(t,e,o){return e?`background-color: ${t};background-image:var(--ddd-theme-default-gradient-antihero),url("${o}");`:`background-color: ${t};background-image: url("${o}");`}render(){return t`
      <section
        class="section"
    ...
    `}scrollToNextTarget(t){const e=this.nextElementSibling;e&&e.scrollIntoView&&e.scrollIntoView({behavior:"smooth",block:"start"})}static get tag(){return"page-section"}static get haxProperties(){return new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(PageSection.tag,PageSection);export{PageSection};