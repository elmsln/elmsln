import{html as t,css as e}from"../../lit/index.js";import{SimpleColors as i}from"../simple-colors/simple-colors.js";import{SchemaBehaviors as a}from"../schema-behaviors/schema-behaviors.js";class PersonTestimonial extends(a(i)){static get styles(){return[super.styles,e`
        :host {
          display: block;
    ...
    `}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),this.setAttribute("typeof","oer:SupportingMaterial")}static get tag(){return"person-testimonial"}static get properties(){return{...super.properties,describedBy:{type:String,attribute:"described-by"},image:{type:String},name:{type:String},position:{type:String}}}static get haxProperties(){return new URL("./lib/person-testimonial.haxProperties.json",import.meta.url).href}}globalThis.customElements.define(PersonTestimonial.tag,PersonTestimonial);export{PersonTestimonial};