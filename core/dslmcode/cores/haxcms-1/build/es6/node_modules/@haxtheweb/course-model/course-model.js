 ...
 */
import{LitElement as e,html as t,css as i}from"../../lit/index.js";import{SchemaBehaviors as o}from"../schema-behaviors/schema-behaviors.js";import"./lib/model-option.js";import"./lib/model-info.js";class CourseModel extends(o(e)){static get tag(){return"course-model"}static get properties(){return{visible:{type:String,reflect:!0},title:{type:String},src:{type:String},alt:{type:String},poster:{type:String}}}static get haxProperties(){return!this._sent&&globalThis.HaxStore&&globalThis.HaxStore.instance&&globalThis.HaxStore.instance.ready&&(this._sent=!0,globalThis.HaxStore.instance.setHaxProperties({api:"1",canScale:!0,canEditSource:!0,contentEditable:!1,gizmo:{title:"3d Model",description:"3D Model viewer",icon:"3d-rotation",color:"purple",tags:["Media","3D","model","viewer"],handles:[],meta:{author:"Google"}},settings:{configure:[{property:"poster",title:"Poster image",inputMethod:"haxupload",noVoiceRecord:!0},{property:"src",title:"Source",inputMethod:"haxupload",noVoiceRecord:!0,noCamera:!0},{property:"alt",title:"Alternate Text",inputMethod:"alt"}],advanced:[{attribute:"environment-image",title:"Environment Image",inputMethod:"haxupload",noVoiceRecord:!0,noCamera:!0},{property:"ar",title:"Augmented Reality",inputMethod:"boolean"},{attribute:"camera-controls",title:"Camera controls",inputMethod:"boolean"},{attribute:"touch-action",title:"Touch action",inputMethod:"textfield"},{attribute:"shadow-intensity",title:"Shadow intensity",inputMethod:"number"}],developer:[]},demoSchema:[{tag:"model-viewer",content:"",properties:{alt:"Neil Armstrong's Spacesuit from the Smithsonian Digitization Programs Office and National Air and Space Museum",src:"https://modelviewer.dev/shared-assets/models/NeilArmstrong.glb",ar:!0,"environment-image":"https://modelviewer.dev/shared-assets/environments/moon_1k.hdr",poster:"https://modelviewer.dev/shared-assets/models/NeilArmstrong.webp","shadow-intensity":"1","camera-controls":!0,"touch-action":"pan-y",style:"height: 500px;"}}]},"model-viewer")),new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}constructor(){super(),this.visible="model",this.title="",this.src="",this.poster="",globalThis.HaxStore&&(globalThis.ModelViewerController=new AbortController,globalThis.addEventListener("hax-insert-content",e=>{"model-viewer"===e.detail.tag&&(import("../../@google/model-viewer/dist/model-viewer.js"),globalThis.ModelViewerController.abort())},{once:!0,passive:!0,signal:globalThis.ModelViewerController.signal})),this.addEventListener("model-select",this._srcChanged)}static get styles(){return[i`
        :host {
          display: block;
        }
      ...
      `]}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.setAttribute("typeof","oer:MediaObject"),import("../../@google/model-viewer/dist/model-viewer.js")}render(){return t`
    ...
    `}_openInfo(e){"model-info"==this.visible?this.visible="model":"model-info"!=this.visible&&(this.visible="model-info")}_openText(e){"model-text"==this.visible?this.visible="model":"model-text"!=this.visible&&(this.visible="model-text")}_openAnimation(e){"model-animation"==this.visible?this.visible="model":"model-animation"!=this.visible&&(this.visible="model-animation")}_openCheck(e){"model-check"==this.visible?this.visible="model":"model-check"!=this.visible&&(this.visible="model-check")}_srcChanged(e){this.src=e.detail.src,this.title=e.detail.title,this.visible="model"}}globalThis.customElements.define(CourseModel.tag,CourseModel);export{CourseModel};