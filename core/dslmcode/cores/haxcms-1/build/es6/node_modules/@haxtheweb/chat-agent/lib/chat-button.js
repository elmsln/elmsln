 ...
 */
import{DDD as e}from"../../d-d-d/d-d-d.js";import{css as t,html as r}from"../../../lit/index.js";import{autorun as i,toJS as a}from"../../../mobx/dist/mobx.esm.js";import{ChatStore as d}from"./chat-agent-store.js";class ChatButton extends e{static get tag(){return"chat-button"}constructor(){super(),this.buttonIcon=null,this.darkMode=null,this.isFullView=null,this.isInterfaceHidden=null,this.__disposer=[],this.__disposer.push(i(()=>{this.buttonIcon=a(d.buttonIcon)})),this.__disposer.push(i(()=>{this.darkMode=a(d.darkMode)})),this.__disposer.push(i(()=>{this.isFullView=a(d.isFullView)})),this.__disposer.push(i(()=>{this.isInterfaceHidden=a(d.isInterfaceHidden)}))}static get styles(){return[super.styles,t`
