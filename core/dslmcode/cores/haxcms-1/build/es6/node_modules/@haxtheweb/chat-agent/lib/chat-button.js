 ...
 */
import{ChatStore as e}from"./chat-agent-store.js";import{DDD as t}from"../../d-d-d/d-d-d.js";import{autorun as r,toJS as a}from"../../../mobx/dist/mobx.esm.js";import{html as i,css as d}from"../../../lit/index.js";class ChatButton extends t{static get tag(){return"chat-button"}constructor(){super(),this.buttonIcon=null,this.darkMode=null,this.isFullView=null,this.isInterfaceHidden=null,r((()=>{this.buttonIcon=a(e.buttonIcon),this.darkMode=a(e.darkMode),this.isFullView=a(e.isFullView),this.isInterfaceHidden=a(e.isInterfaceHidden)}))}static get styles(){return[super.styles,d`
