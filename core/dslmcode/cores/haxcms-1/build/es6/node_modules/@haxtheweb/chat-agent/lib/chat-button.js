 ...
 */
import{DDD as e}from"../../d-d-d/d-d-d.js";import{css as t,html as r}from"../../../lit/index.js";import{autorun as i,toJS as a}from"../../../mobx/dist/mobx.esm.js";import{ChatStore as o}from"./chat-agent-store.js";class ChatButton extends e{static get tag(){return"chat-button"}constructor(){super(),this.buttonIcon=null,this.darkMode=null,this.isFullView=null,this.isInterfaceHidden=null,this.__disposer=[],this.__disposer.push(i(()=>{const e=a(o.buttonIcon);Promise.resolve().then(()=>{this.buttonIcon=e})})),this.__disposer.push(i(()=>{const e=a(o.darkMode);Promise.resolve().then(()=>{this.darkMode=e})})),this.__disposer.push(i(()=>{const e=a(o.isFullView);Promise.resolve().then(()=>{this.isFullView=e})})),this.__disposer.push(i(()=>{const e=a(o.isInterfaceHidden);Promise.resolve().then(()=>{this.isInterfaceHidden=e})}))}static get styles(){return[super.styles,t`
      ...
      >
        ...
        <div class="label-wrapper" unselectable="on">
          <slot name="label">${o.buttonLabel}</slot>
        </div>
      </div>
    `}keyPress(e){if("Enter"===e.key){e.preventDefault(),o.devStatement("Chat button pressed using Enter key.","log");const t=this.shadowRoot.querySelector(".chat-button-wrapper");t.classList.contains("active-mimic")?t.classList.remove("active-mimic"):t.classList.add("active-mimic"),setTimeout(()=>{t.classList.remove("active-mimic")},100),this.handleChatButton()}}handleChatButton(){o.devStatement("Chat button pressed.","log"),o.isInterfaceHidden=!this.isInterfaceHidden}disconnectedCallback(){for(;this.__disposer.length;){const e=this.__disposer.pop();e&&"function"==typeof e&&e()}super.disconnectedCallback()}static get properties(){return{...super.properties,buttonIcon:{type:String,attribute:"button-icon"},darkMode:{type:Boolean,attribute:"dark-mode",reflect:!0},isFullView:{type:Boolean,attribute:"is-full-view",reflect:!0},isInterfaceHidden:{type:Boolean,attribute:"is-interface-hidden",reflect:!0}}}}globalThis.customElements.define(ChatButton.tag,ChatButton);export{ChatButton};