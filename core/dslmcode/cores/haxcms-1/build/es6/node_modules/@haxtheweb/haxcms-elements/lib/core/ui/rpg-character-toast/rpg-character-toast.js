import{css as t,html as e,unsafeCSS as i}from"../../../../../../lit/index.js";import{SimpleToastEl as a}from"../../../../../simple-toast/lib/simple-toast-el.js";import"../../../../../rpg-character/rpg-character.js";import"../../../../../future-terminal-text/future-terminal-text.js";import"../../../../../simple-icon/lib/simple-icon-button-lite.js";import"../../../../../simple-tooltip/simple-tooltip.js";const s=new URL("./images/SpeechBubbleL.svg",import.meta.url).href,l=new URL("./images/SpeechBubbleMiddle.svg",import.meta.url).href,r=new URL("./images/SpeechBubbleR.svg",import.meta.url).href;export class RPGCharacterToast extends a{static get tag(){return"rpg-character-toast"}constructor(){super(),this.awaitingMerlinInput=!1,this.windowControllers=new AbortController,this.text="Saved",this.closeText="Close",this.merlin=!1,this.classStyle="",this.future=!1,this.duration=3e3,this.accentColor="grey",this.dark=!1,this.eventCallback=null,this.fire=!1,this.hat="coffee",this.speed=500,this.walking=!1,this.characterHeight=180,this.characterWidth=64}static get styles(){return[super.styles,t`
        :host([opened]) {
          display: block;
          padding: 0;
          margin: 0;
      ...
      <div class="bubble bubble-wrapper" part="bubble-wrapper">
        ${this.merlin?"":e`<div class="dismiss-wrap">
