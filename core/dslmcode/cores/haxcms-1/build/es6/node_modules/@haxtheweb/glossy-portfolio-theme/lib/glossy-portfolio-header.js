...
import{LitElement as e,html as t,css as i}from"../../../lit/index.js";import{DDDSuper as o}from"../../d-d-d/d-d-d.js";import{I18NMixin as s}from"../../i18n-manager/lib/I18NMixin.js";import{store as r}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as l,toJS as a}from"../../../mobx/dist/mobx.esm.js";export class GlossyPortfolioHeader extends(o(s(e))){static get tag(){return"glossy-portfolio-header"}constructor(){super(),this.title="Title",this.homeLink="",this.__disposer=this.__disposer||[],this.isOverflow=!1,this.isOpen=!1,this.scrollPosition=0,this.__onScroll=this.scrollFunction.bind(this),this.__disposer.push(l(e=>{let t=a(r.getItemChildren(null));t&&t.length>0&&(this.topItems=[...t])})),this.__disposer.push(l(e=>{this.homeLink=a(r.homeLink)})),this.__disposer.push(l(e=>{this.logo=a(r.logo)}))}static get properties(){return{...super.properties,title:{type:String},thumbnail:{type:String},link:{type:String},topItems:{type:Array},isOverflow:{type:Boolean},isOpen:{type:Boolean}}}static get styles(){return[super.styles,i`
    ...
    `}_toggleHamburger(){!0===this.isOpen?this.closeHamburger():!1===this.isOpen&&this.openHamburger()}openHamburger(){let e=this.renderRoot.querySelector(".nav-menu");console.log("open"),this.isOpen=!0,e.style.display="flex",globalThis.document.body.classList.add("no-scroll")}closeHamburger(){let e=this.renderRoot.querySelector(".nav-menu");this.isOpen=!1,e.style.display="none",globalThis.document.body.classList.remove("no-scroll")}toggleHamburger(){globalThis.document.startViewTransition?globalThis.document.startViewTransition(()=>{this._toggleHamburger()}):this._toggleHamburger()}firstUpdated(e){const t=this.renderRoot.querySelector(".container.desktop");t&&(this._resizeObserver=new ResizeObserver(()=>{this._checkOverflow()}),this._resizeObserver.observe(t)),requestAnimationFrame(()=>this._checkOverflow()),globalThis.addEventListener("scroll",this.__onScroll)}disconnectedCallback(){this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=null),globalThis.removeEventListener("scroll",this.__onScroll),super.disconnectedCallback&&super.disconnectedCallback()}scrollFunction(){const e=globalThis.scrollY||globalThis.document.documentElement.scrollTop;this.scrollPosition=e,e>50?this.halfOpacity():this.fullOpacity()}fullOpacity(){const e=this.renderRoot.querySelector(".container.desktop");e.style.transition="opacity 0.05s ease-in-out",e.style.opacity="1"}halfOpacity(){const e=this.renderRoot.querySelector(".container.desktop");this.scrollPosition>50&&(e.style.transition="opacity 0.1s ease-in-out",e.style.opacity="0.4")}_checkOverflow(){const e=this.renderRoot.querySelector(".container.desktop"),t=this.renderRoot.querySelector(".container.mobile");if(e){const i=Array.from(e.children),o=e.clientWidth-100;let s=0;for(const r of i)s+=r.offsetWidth+25,s>o?(this.isOverflow=!0,e.style.visibility="hidden",e.style.height="0px",e.style.padding="0px 50px",t.style.display="flex"):(this.isOverflow=!1,e.style.visibility="visible",e.style.padding="var(--desktop-header-padding)",e.style.height="auto",t.style.display="none",globalThis.document.body.classList.remove("no-scroll"),this.closeHamburger()),this.requestUpdate()}}handleImageError(e){e.target.src="https://img.icons8.com/m_sharp/512/FFFFFF/home.png"}static get haxProperties(){return new URL(`./lib/${this.tag}.haxProperties.json`,import.meta.url).href}}globalThis.customElements.define(GlossyPortfolioHeader.tag,GlossyPortfolioHeader);