import{html as t,css as i}from"../../lit/index.js";import{SchemaBehaviors as e}from"../schema-behaviors/schema-behaviors.js";import{IntersectionObserverMixin as o}from"../intersection-element/lib/IntersectionObserverMixin.js";import{I18NMixin as r}from"../i18n-manager/lib/I18NMixin.js";import{SimpleColors as a}from"../simple-colors/simple-colors.js";class ImageCompareSlider extends(r(o(e(a)))){static get styles(){return[i`
      ...
      `]}constructor(){super(),this.opacity=!1,this.topAlt="",this.bottomAlt="",this.position=50,this.accentColor="blue",this.t={slideToCompareImages:"Slide to compare images"},this.registerLocalization({context:this,basePath:import.meta.url})}render(){return t`${this.elementVisible?t`
          <a11y-compare-image
