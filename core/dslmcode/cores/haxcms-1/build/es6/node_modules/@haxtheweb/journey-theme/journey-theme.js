 ...
 */
import{css as t,html as e,nothing as i}from"../../lit/index.js";import{HAXCMSLitElementTheme as a}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{store as o}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as r,toJS as s}from"../../mobx/dist/mobx.esm.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/magic/site-collection-list.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"../simple-cta/simple-cta.js";import{DDDVariables as n,DDDPaletteStyles as l}from"../d-d-d/lib/DDDStyles.js";import"../simple-tooltip/simple-tooltip.js";import"../simple-icon/lib/simple-icon-button-lite.js";import"../scroll-button/scroll-button.js";import{licenseList as d}from"../license-element/license-element.js";import{UserScaffoldInstance as c}from"../user-scaffold/user-scaffold.js";class JourneyTheme extends a{static get tag(){return"journey-theme"}constructor(){super();const t=c.readMemory("HAXCMSSitePalette");this.dataPalette=""===t||null===t?11:t,this._items=[],this.location=null,this.activeItem={},this.ancestorItem={},this.basePath=null,this.manifest={},this.__disposer=this.__disposer||[],this.t={readMore:"Read more",home:"Home"};try{this.basePath=globalThis.document.querySelector("base").href}catch(t){this.basePath=globalThis.location.origin}this.HAXSiteCustomRenderRoutes={"x/tags":{items:this.HAXSiteRenderXTagsItems}},this.__disposer.push(r(t=>{this.manifest=s(o.manifest),this.lastUpdated=new Date(1e3*o.manifest.metadata.site.updated).toDateString(),this.copyrightYear=new Date(1e3*o.manifest.metadata.site.created).getFullYear();let e=new d;this.manifest.license&&e[this.manifest.license]&&(this.licenseName=e[this.manifest.license].name,this.licenseLink=e[this.manifest.license].link,this.licenseImage=e[this.manifest.license].image),this._items=this.getItemChildren(null)})),this.__disposer.push(r(t=>{this.activeItem=s(o.activeItem)})),this.__disposer.push(r(t=>{this.ancestorItem=s(o.ancestorItem)})),this.__disposer.push(r(t=>{let e=s(o.location);this.location=e})),this.__disposer.push(r(t=>{const e=s(o.pageCounter);this.pageCurrent=e.current,this.pageTotal=e.total}))}getItemChildren(t){if(this.manifest&&this.manifest.items)return this.manifest.items.filter(e=>e.parent===t)}updated(t){super.updated(t),t.has("dataPalette")&&c.writeMemory("HAXCMSSitePalette",this.dataPalette,"long")}static get properties(){return{...super.properties,_items:{type:Array},activeItem:{type:Object},ancestorItem:{type:Object},location:{type:Object},basePath:{type:String},dataPalette:{type:Number,reflect:!0,attribute:"data-palette"},licenseName:{type:String},licenseLink:{type:String},licenseImage:{type:String},lastUpdated:{type:String},copyrightYear:{type:Number},pageCurrent:{type:Number},pageTotal:{type:Number}}}HAXSiteRenderXTagsItems(t){return e`
      <div>
        ${t.map(t=>e` <a
              href="${t.slug}"
