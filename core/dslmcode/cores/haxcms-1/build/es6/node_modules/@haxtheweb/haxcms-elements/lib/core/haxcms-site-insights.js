import{store as e,iconFromPageType as t}from"./haxcms-site-store.js";import{toJS as i}from"../../../../mobx/dist/mobx.esm.js";import{LitElement as s,html as a,css as l}from"../../../../lit/index.js";import{HAXCMSI18NMixin as o}from"./utils/HAXCMSI18NMixin.js";import{MicroFrontendRegistry as n}from"../../../micro-frontend-registry/micro-frontend-registry.js";import{enableServices as r}from"../../../micro-frontend-registry/lib/microServices.js";import"../../../a11y-tabs/a11y-tabs.js";import"../../../accent-card/accent-card.js";import"../../../retro-card/retro-card.js";import"../../../simple-img/simple-img.js";import"../../../simple-fields/simple-fields.js";import"../../../lesson-overview/lib/lesson-highlight.js";import"../../../../@github/time-elements/dist/relative-time-element.js";import"../../../iframe-loader/lib/loading-indicator.js";import{learningComponentTypes as c}from"../../../d-d-d/lib/DDDStyles.js";r(["haxcms","core"]);class HAXCMSShareDialog extends(o(s)){static get styles(){return[l`
        :host {
          display: block;
          overflow: auto;
          height: 85vh;
      ...
      >
        ...
        >
          ${"insights"===this.activeTab?a`
                <loading-indicator
                  full
                  ?loading="${this.loading}"
                ></loading-indicator>
                ${this.loading?a`<p>${this.t.loading} ${this.t.insights}..</p>`:a`
        <div class="insights">
          <h2>${e&&e.title?e.title:""} ${this.t.insights}</h2>
          <ul>
            <li>
            <lesson-highlight icon="editor:insert-drive-file">
              <p slot="title">${e.pages?e.pages:a`0`} ${this.t.pages}</p>
            ...
            <li>
              ...
              <ol class="recently-updated-items">
                ${e.updatedItems?e.updatedItems.map((e=>a` <li>
      ...
      `}
        ...
        >
          ${"linkchecker"==this.activeTab?a`
                <loading-indicator
                  full
                  ?loading="${this.loading}"
                ></loading-indicator>
                ${this.loading?a`<p>${this.t.loading} ${this.t.linkChecker}..</p>`:a`
                      <div>
                        ...
                        <ul class="link-list">
                          ${e.linkData?Object.keys(e.linkData).map((t=>this.renderLinkCheck(e.linkData,t))):a`${this.t.noLinksInSelectedPages}`}
                        </ul>
                      </div>
                    `}
              `:""}
        ...
        >
          ${"contentbrowser"==this.activeTab?a`
                <loading-indicator
                  full
                  ?loading="${this.loading}"
                ></loading-indicator>
                ${this.loading?a`<p>${this.t.loading} ${this.t.contentBrowser}..</p>`:a`
                      <div>
                        ...
                        <ul class="content-list">
                          ${e.contentData?e.contentData.map((e=>a`
                                  <li>
                                    <accent-card
                                      image-src="https://screenshoturl.open-apis.hax.cloud/api/screenshotUrl?quality=25&render=img&urlToCapture=${i}${e.location}"
                                      horizontal
                                    >
                                      <div slot="heading">
                                        <a
        ...
        >
          ${"mediabrowser"==this.activeTab?a`
                <loading-indicator
                  full
                  ?loading="${this.loading}"
                ></loading-indicator>
                ${this.loading?a`<p>${this.t.loading} ${this.t.mediaBrowser}..</p>`:a`
                      <div class="mediabrowser-wrapper">
                        ...
                        <ul class="media-list">
                          ${e.mediaData?e.mediaData.map((e=>a`
                                  <li>
                                    <retro-card
                                      nosource
                                    ...
                                    >
                                      <div class="body">
                                        ...
                                        ${"video"==e.type&&e.source.includes("videoseries")?a`<iframe
                                              src="${e.source}"
                                            ></iframe>`:""}
                                        ${"video"!=e.type||e.source.includes("videoseries")?"":a`<video-player
                                              source="${e.source}"
                                            ></video-player>`}
                                        ${"h5p"==e.type?a`<iframe
                                              src="${e.source}"
                                            ></iframe>`:""}
                                        ${"audio"==e.type?a`<video-player
                                              source="${e.source}"
                                            ></video-player>`:""}
                                        ${"document"==e.type?a`<div>
                                              <a
                                                href="${e.source}"
                                                target="_blank"
    ...
    `}analyzeAltData(e){return null==e.alt||"null"==e.alt?a`<simple-icon
        icon="error"
        accent-color="red"
        title="missing alt text"
      ></simple-icon>`:e.name==e.alt||e.source==e.alt?a`<simple-icon
        icon="error"
        accent-color="red"
        title="alt text matches file name"
      ></simple-icon>`:e.title==e.alt?a`<simple-icon
        icon="error"
        accent-color="red"
        title="alt text matches title"
      ></simple-icon>`:""==e.alt?a`<simple-icon
        icon="warning"
        accent-color="yellow"
        title="alt text set to blank, ensure decorative image"
      ></simple-icon>`:e.alt&&e.alt.includes("image")?a`<simple-icon
        icon="warning"
        accent-color="yellow"
        title="alt text includes word 'image'"
      ></simple-icon>`:e.alt&&e.alt.includes("picture")?a`<simple-icon
        icon="warning"
        accent-color="yellow"
        title="alt text includes word 'picture'"
      ></simple-icon>`:a`<simple-icon
      icon="info"
      accent-color="blue"
      title="alt text: ${e.alt}"
    ></simple-icon>`}linkValidationResponse(e){let t=Object.keys(e.data);this.linkResponseData[t[0]]=e.data[t[0]],clearTimeout(this.__interval),this.__interval=setTimeout((()=>{this.requestUpdate()}),500)}renderLinkCheck(e,t){return this.linkResponseData[t]||(this.linkResponseData[t]={ok:"loading"},n.call("@core/linkValidator",{links:t},this.linkValidationResponse.bind(this))),a`
      <li class="link-status-${this.linkResponseData[t].ok}">
        ${"loading"===this.linkResponseData[t].ok?a`<simple-icon
              icon="hax:loading"
              accent-color="grey"
            ></simple-icon>`:""}
        ${"loading"!=this.linkResponseData[t].ok?this.linkResponseData[t].ok?a`<simple-icon
                icon="check"
                accent-color="green"
              ></simple-icon>`:a`<simple-icon
                icon="clear"
              ...
              ></simple-icon>`:""}
        ${"loading"!=this.linkResponseData[t].ok?this.linkResponseData[t].ok?a`<a
                href="${t}"
                target="_blank"
    ...
    `}accentColorFromType(e){switch(e){case"video":return"red";case"h5p":return"purple";case"audio":return"orange";case"image":return"blue";case"document":return"green";default:return"grey"}}renderItemLinkById(t){if(null!=t){const s=i(e.findItem(t));if(s)return a`<a href="${s.slug}" @click="${this.closeModal}"
          >${s.title}</a
        >`}return a``}constructor(){super(),this.base="",this.filters={},this.linkResponseData={},this.t=this.t||{},this.t={...this.t,pageToProvideInsightsAbout:"Page to provide insights about",noLinksInSelectedPages:"No links in selected pages",noMediaInSelectedPages:"No media in selected pages",recentUpdates:"Recent updates",created:"Created",lastUpdated:"Last updated",updateInsights:"Update insights",onPage:"on page",learningObjectives:"learning objectives",specialElements:"Special elements",headings:"Headings",externalLinks:"External links",pages:"Pages",videos:"videos",authorNotes:"Author notes",placeholders:"Placeholders",video:"Video",audio:"Audio",selfChecks:"Self checks",openInNewTab:"Open in new tab",links:"Links",images:"Images",dataTables:"Data tables",ofReading:"of reading",basedGradeReadingLevel:"based grade reading level",words:"Words",longWords:"long words",linkReport:"Link report",loading:"Loading",fullSite:"Full site",insights:"Insights",linkChecker:"Link checker",mediaBrowser:"Media browser",contentBrowser:"Content browser",hour:"hour",hours:"hours",minute:"minute",minutes:"minutes"},this.data={readability:{},updatedItems:[]},this.activeTab="insights",this.loading=!1}static get properties(){return{...super.properties,data:{type:Object},hideResults:{type:String,attribute:"hide-results",reflect:!0},filters:{type:Object},linkResponseData:{type:Object},activeTab:{type:String},base:{type:String,reflect:!0},loading:{type:Boolean,reflect:!0}}}pageSelector(){const t=e.getManifestItems(!0);var s=[{text:`-- ${this.t.fullSite} --`,value:null}];return t.forEach((e=>{let i=e,a="- ";for(;i&&null!=i.parent;)i=t.find((e=>e.id==i.parent)),i&&(a="--"+a);s.push({text:a+e.title,value:e.id})})),a`<div class="selector-wrapper">
    ...
    </div>`}}globalThis.customElements.define(HAXCMSShareDialog.tag,HAXCMSShareDialog);export{HAXCMSShareDialog};