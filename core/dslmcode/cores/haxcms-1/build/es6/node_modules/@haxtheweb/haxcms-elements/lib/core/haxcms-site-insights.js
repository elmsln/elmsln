import{store as e,iconFromPageType as t}from"./haxcms-site-store.js";import{toJS as i}from"../../../../mobx/dist/mobx.esm.js";import{LitElement as a,html as s,css as l}from"../../../../lit/index.js";import{HAXCMSI18NMixin as o}from"./utils/HAXCMSI18NMixin.js";import{MicroFrontendRegistry as r}from"../../../micro-frontend-registry/micro-frontend-registry.js";import{enableServices as n}from"../../../micro-frontend-registry/lib/microServices.js";import"../../../a11y-tabs/a11y-tabs.js";import"../../../accent-card/accent-card.js";import"../../../retro-card/retro-card.js";import"../../../simple-img/simple-img.js";import"../../../simple-fields/simple-fields.js";import"../../../simple-toolbar/lib/simple-toolbar-button.js";import"../ui-components/lesson-overview/lib/lesson-highlight.js";import"../../../../@github/time-elements/dist/relative-time-element.js";import"../../../iframe-loader/lib/loading-indicator.js";import{learningComponentTypes as d}from"../../../d-d-d/lib/DDDStyles.js";n(["haxcms","core"]);class HAXCMSShareDialog extends(o(a)){static get styles(){return[l`
        :host {
          display: flex;
      ...
      `]}updated(e){super.updated(e),e.forEach(((e,t)=>{"activeTab"===t&&this[t]&&this.refreshData()}))}_insightResponse(e){this.loading=!1,this.data=e.data,this._originalData=JSON.parse(JSON.stringify(e.data)),this.filters={},setTimeout((()=>{switch(this.activeTab){case"linkchecker":this.filters={links:"all"},this.shadowRoot.querySelector("#schema").fields=[{property:"links",title:"Link status",inputMethod:"select",options:{all:"All",error:"Error only",ok:"OK only"}}];break;case"contentbrowser":this.filters={sort:"title",title:"",hasVideo:!1,hasH5P:!1,hasAuthorNotes:!1,hasLinks:!1,hasImages:!1,hasPlaceholders:!1,hasSiteRemoteContent:!1},this.shadowRoot.querySelector("#schema").value=this.filters,this.shadowRoot.querySelector("#schema").fields=[{property:"title",title:"Title",inputMethod:"textfield"},{property:"pageType",title:"Page type",inputMethod:"select",options:{"":"",...d}},{property:"sort",title:"Sort by",inputMethod:"select",options:{title:"Title",lastUpdated:"Last updated",contentLength:"Content length"}},{property:"hasAuthorNotes",title:"Author notes",description:"Includes content editor notes",inputMethod:"boolean"},{property:"hasVideo",title:"Video",description:"Includes video",inputMethod:"boolean"},{property:"hasH5P",title:"H5P",description:"Includes h5p",inputMethod:"boolean"},{property:"hasPlaceholders",title:"Placeholders",description:"Includes placeholders",inputMethod:"boolean"},{property:"hasSiteRemoteContent",title:"Remote content",description:"Includes remote content",inputMethod:"boolean"},{property:"hasLinks",title:"Links",description:"Includes external links",inputMethod:"boolean"},{property:"hasImages",title:"Images",description:"Includes images",inputMethod:"boolean"}];break;case"mediabrowser":this.filters={title:"",type:"all",location:"all"},this.shadowRoot.querySelector("#schema").fields=[{property:"title",title:"Title",inputMethod:"textfield"},{property:"status",title:"Status",inputMethod:"select",options:{all:"All",info:"No issues",warning:"Warnings",error:"Errors"}},{property:"type",title:"Media type",inputMethod:"select",options:{all:"All",audio:this.t.audio,video:this.t.video,image:this.t.images,h5p:"H5P",document:"Document"}},{property:"location",title:"Location",inputMethod:"select",options:{all:"All",external:"External only",internal:"Internal only"}}],this.shadowRoot.querySelector("#schema").values=this.filters}}),0)}refreshData(){let t=this.base;""==t&&globalThis.document.querySelector("base")&&(t=globalThis.document.querySelector("base").href);const a=i(e.manifest),s={type:"site",site:{file:t+"site.json",id:a.id,title:a.title,author:a.author,description:a.description,license:a.license,metadata:a.metadata,items:a.items},activeId:this.shadowRoot.querySelector("#selector").value,link:t};switch(this.loading=!0,this.activeTab){case"insights":r.call("@haxcms/insights",s,this._insightResponse.bind(this),this);break;case"linkchecker":r.call("@haxcms/linkChecker",s,this._insightResponse.bind(this),this);break;case"contentbrowser":r.call("@haxcms/contentBrowser",s,this._insightResponse.bind(this),this);break;case"mediabrowser":r.call("@haxcms/mediaBrowser",s,this._insightResponse.bind(this),this);break;default:this.loading=!1}}static get tag(){return"haxcms-site-insights"}getReadingTime(e){let t=[];var i=Math.floor(e/60),a=Math.floor(e-60*i);return 1===i?t.push(`${i} ${this.t.hour}`):0===i||t.push(`${i} ${this.t.hours}`),1===a?t.push(`${a} ${this.t.minute}`):0===a||t.push(`${a} ${this.t.minutes}`),t.join(", ")}closeModal(){globalThis.dispatchEvent(new CustomEvent("simple-modal-hide"))}activeChanged(e){this.activeTab=e.detail.activeTab}linkFormChanged(e){this.filters.links=e.detail.value.links,"error"===this.filters.links?this.hideResults="link-status-true":"ok"===this.filters.links&&(this.hideResults="link-status-false")}contentBrowserFormChanged(e){this.data=JSON.parse(JSON.stringify(this._originalData));let t=e.detail.value;this.filters={title:t.title?t.title:"",sort:t.sort,pageType:t.pageType,hasVideo:t.hasVideo,hasH5P:t.hasH5P,hasAuthorNotes:t.hasAuthorNotes,hasPlaceholders:t.hasPlaceholders,hasSiteRemoteContent:t.hasSiteRemoteContent,hasLinks:t.hasLinks,hasImages:t.hasImages},this.data.contentData&&(this.data.contentData=this.data.contentData.filter((e=>(!0!==this.filters.hasVideo||0!==e.videos)&&((!0!==this.filters.hasH5P||0!==e.h5p)&&((!0!==this.filters.hasAuthorNotes||0!==e.authorNotes)&&((!0!==this.filters.hasPlaceholders||0!==e.placeholders)&&((!0!==this.filters.hasSiteRemoteContent||0!==e.siteremotecontent)&&((!0!==this.filters.hasLinks||0!==e.links)&&((!0!==this.filters.hasImages||0!==e.images)&&(""==this.filters.pageType||!this.filters.pageType||e.pageType==this.filters.pageType&&(""==this.filters.title||!!e.title.toLowerCase().includes(this.filters.title.toLowerCase()))))))))))),this.data.contentData.sort(((e,t)=>{switch(this.filters.sort){case"title":return e.title.localeCompare(t.title);case"contentLength":return t.readTime-e.readTime;case"lastUpdated":return new Date(t.updated)-new Date(e.updated)}})))}mediaBrowserFormChanged(e){this.data=JSON.parse(JSON.stringify(this._originalData));let t=e.detail.value;this.filters={title:t.title?t.title:"",type:t.type?t.type:"all",status:t.status?t.status:"all",location:t.location?t.location:"all"},this.data.mediaData&&(this.data.mediaData=this.data.mediaData.filter((e=>"all"==this.filters.location||this.filters.location==e.locType)),this.data.mediaData=this.data.mediaData.filter((e=>"all"==this.filters.status||this.filters.status==e.status)),this.data.mediaData=this.data.mediaData.filter((e=>"all"==this.filters.type||this.filters.type==e.type)),this.data.mediaData=this.data.mediaData.filter((e=>!this.filters.title||""==this.filters.title||!(this.filters.title.toLowerCase&&!e.name.toLowerCase().includes(this.filters.title.toLowerCase())))))}render(){const e=this.data;let i=this.base;return""==i&&globalThis.document.querySelector("base")&&(i=globalThis.document.querySelector("base").href),s`
      ${this.pageSelector()}
      <a11y-tabs
        id="tabs"
        full-width
          ...
          <ul>
            ...
            ${0==e.video?"":s`<li>
                    <lesson-highlight icon="av:play-circle-outline">
                      ...
                      ${0!=e.videoLength?s`(
                            <p>${function toHHMMSS(e){var t="",i=parseInt(e,10),a=Math.floor(i/3600),s=Math.floor((i-3600*a)/60);0!==a&&(t+=`${a} hour`,1!==a&&(t+="s"),t+=", ");0!==s&&(t+=`${s} minute`,1!==a&&(t+="s"));return t}(e.videoLength)}</p>
                            )`:""}
                    </lesson-highlight>
                  </li>`}
            ${0==e.h5p?"":s`<li>
