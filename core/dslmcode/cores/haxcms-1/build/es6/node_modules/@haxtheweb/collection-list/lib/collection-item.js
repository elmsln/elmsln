import{html as i,css as t}from"../../../lit/index.js";import"../../simple-icon/simple-icon.js";import"../../simple-fields/lib/simple-tags.js";import{DDD as e}from"../../d-d-d/d-d-d.js";class CollectionItem extends e{static get properties(){return{...super.properties,url:{type:String},image:{type:String},alt:{type:String},icon:{type:String},line1:{type:String},line2:{type:String},line3:{type:String},saturate:{type:Boolean,reflect:!0},tags:{type:String}}}constructor(){super(),this._haxstate=!1,this.tags=null,this.saturate=!1,this.url=null,this.image=null,this.alt=null,this.icon=null,this.line1=null,this.line2=null,this.line3=null,this.accentColor=null}static get haxProperties(){return new URL(`./${this.tag}.haxProperties.json`,import.meta.url).href}static get styles(){return[super.styles,t`
    ...
    `}_handleClick(i){(this._haxstate||this.parentNode&&null!==this.parentNode.getAttribute("lock-items"))&&(i.preventDefault(),i.stopPropagation(),i.stopImmediatePropagation())}haxHooks(){return{editModeChanged:"haxeditModeChanged",activeElementChanged:"haxactiveElementChanged"}}haxactiveElementChanged(i,t){t&&(this._haxstate=t)}haxeditModeChanged(i){this._haxstate=i}static get tag(){return"collection-item"}}globalThis.customElements.define(CollectionItem.tag,CollectionItem);export{CollectionItem};