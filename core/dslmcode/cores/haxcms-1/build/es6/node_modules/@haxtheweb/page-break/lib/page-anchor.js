import{html as t,css as e}from"../../../lit/index.js";import{DDD as i}from"../../d-d-d/d-d-d.js";import{store as r}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{HAXStore as a}from"../../hax-body/lib/hax-store.js";import{toJS as o}from"../../../mobx/dist/mobx.esm.js";export class PageAnchor extends i{constructor(){super(),this.value=null,this.target="",this.entityId=null}static get properties(){return{...super.properties,value:{type:String},target:{type:String,reflect:!0},entityId:{type:String,attribute:"entity-id"}}}static get styles(){return[super.styles,e`
        :host {
