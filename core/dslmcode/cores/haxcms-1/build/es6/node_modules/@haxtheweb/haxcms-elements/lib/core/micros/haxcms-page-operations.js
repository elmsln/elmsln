import{html as t,css as o}from"../../../../../lit/index.js";import{DDD as e}from"../../../../d-d-d/d-d-d.js";import{I18NMixin as i}from"../../../../i18n-manager/lib/I18NMixin.js";import{store as l}from"../haxcms-site-store.js";import{toJS as s,autorun as a}from"../../../../../mobx/dist/mobx.esm.js";import"../../../../simple-icon/lib/simple-icon-button-lite.js";import"../../../../simple-toolbar/lib/simple-toolbar-button.js";import"../../../../simple-fields/lib/simple-context-menu.js";export class HAXCMSPageOperations extends(i(e)){static get tag(){return"haxcms-page-operations"}static get styles(){return[super.styles,o`
      ...
      `]}static get properties(){return{...super.properties,actionId:{type:String,attribute:"action-id"},isLocked:{type:Boolean},editMode:{type:Boolean}}}constructor(){super(),this.actionId=null,this.isLocked=!1,this.editMode=!1,this.t={...super.t,outlineActions:"Outline Actions",editPage:"Edit Page",addPage:"Add child page",moveUp:"Move Up",moveDown:"Move Down",indent:"Indent",outdent:"Outdent",moveTo:"Move to...",siteOutline:"Open Site Outline",delete:"Delete Page",unlock:"Unlock",lock:"Lock"},this.registerLocalization({context:this,basePath:import.meta.url}),a(()=>{const t=s(l.activeItem);this.isLocked=!!(t&&t.metadata&&t.metadata.locked)}),a(()=>{this.editMode=s(l.editMode)})}connectedCallback(){super.connectedCallback(),l.pageOperationsElement=this}disconnectedCallback(){l.pageOperationsElement===this&&(l.pageOperationsElement=null),super.disconnectedCallback()}_toggleDialog(){const t=this.shadowRoot.querySelector("simple-context-menu"),o=this.shadowRoot.querySelector(".ops");t&&o&&t.toggle(o)}render(){return l.platformAllows("outlineDesigner")?t`
      ...
      <simple-context-menu title="${this.t.outlineActions}">
        ${l.platformAllows("addPage")&&!this.editMode?t`
              <haxcms-button-add
                id="addpagebutton"
