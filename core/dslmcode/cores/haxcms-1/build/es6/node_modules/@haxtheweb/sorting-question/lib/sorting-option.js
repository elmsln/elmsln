import{LitElement as t,html as e,css as i}from"../../../lit/index.js";import{DDDSuper as o}from"../../d-d-d/d-d-d.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icon-button-lite.js";export class SortingOption extends(o(t)){static get tag(){return"sorting-option"}static get properties(){return{...super.properties,disabled:{type:Boolean,reflect:!0},dragging:{type:Boolean,reflect:!0},correct:{type:Boolean,reflect:!0},incorrect:{type:Boolean,reflect:!0}}}updated(t){super.updated&&super.updated(t),t.has("disabled")&&(this.disabled?this.removeAttribute("draggable"):this.setAttribute("draggable",!0))}constructor(){super(),this.shadowRootOptions={...t.shadowRootOptions,delegatesFocus:!0},this.dragging=!1,this.disabled=!1,this.addEventListener("mousedown",this.getCurrentPosition),this.addEventListener("drag",this.dragStart),this.addEventListener("dragend",this.dragEnd),this.addEventListener("mouseup",this.dragEnd)}getCurrentPosition(t){if(!this.disabled){this.correct=null,this.incorrect=null;var e=t.clientY;this.currentPosition=e}}dragStart(t){globalThis.document&&globalThis.document.startViewTransition?globalThis.document.startViewTransition(()=>{this.dragStartCallback(t)}):this.dragStartCallback(t)}dragStartCallback(t){if(!this.disabled){this.dragging=!0;var e=64;this.querySelectorAll("img").length>0&&(e=92);var i=t.clientY;0!=i&&i>0&&(this.dragPosition=i);var o=this,r=this.parentNode;if(this.dragPosition+e<this.currentPosition){for(var d=0;d<r.children.length;d++)r.children[d].isEqualNode(o)&&(n=d);if(0!=n)return r.insertBefore(o,r.children[n-1]),void(this.currentPosition=this.dragPosition)}if(this.dragPosition-e>this.currentPosition){var n;for(d=0;d<r.children.length;d++)r.children[d].isEqualNode(o)&&(n=d);if(n!=r.children.length-1)return r.insertBefore(r.children[n+1],o),void(this.currentPosition=this.dragPosition)}}}dragEnd(){this.disabled||(this.dragging=!1)}arrowSort(t){const e=t.target;globalThis.document&&globalThis.document.startViewTransition?globalThis.document.startViewTransition(()=>{this.arrowSortCallback(e)}):this.arrowSortCallback(e)}arrowSortCallback(t){if(!this.disabled){let e=this.parentNode;if("downArrow"===t.getAttribute("id")){if(this.nextElementSibling&&"SORTING-OPTION"===this.nextElementSibling.tagName){e.insertBefore(this.nextElementSibling,this).shadowRoot.querySelector("#downArrow").focus()}}else if(this.previousElementSibling&&"SORTING-OPTION"===this.previousElementSibling.tagName){e.insertBefore(this,this.previousElementSibling).shadowRoot.querySelector("#upArrow").shadowRoot.querySelector("button").focus()}this.style.backgroundColor="var(--ddd-theme-default-linkLight)",setTimeout(()=>{this.style.backgroundColor=""},500)}}static get styles(){return[super.styles,i`
        :host {
