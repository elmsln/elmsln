      ...
      <confetti-container id="confetti">
        <grid-plate layout="1-1">
          ...
          <div slot="col-2">
            ...
            ${this.querySelector('[slot="content"]')?t` <details
                  tabindex="${this.disabled?"-1":""}"
                  ?disabled="${this.disabled}"
    ...
    `}inactiveCase(){return!0}renderDirections(){return t`<p>
      ...
      here indicating correctness of your answer.
          ...
          ${this.showAnswer&&this.numberCorrect!==this.answers.length?t` <p class="feedback">
                ...
                ${this.querySelector('[slot="feedbackIncorrect"]')?t`<slot name="feedbackIncorrect"></slot>`:""}`:""}
          ${this.showAnswer&&this.numberCorrect===this.answers.length?t` <p class="feedback">${this.correctText}</p>
                ${this.querySelector('[slot="feedbackCorrect"]')?t`<slot name="feedbackCorrect"></slot>`:""}`:""}
          ${this.querySelector('[slot="hint"]')&&this.showAnswer&&this.numberCorrect!==this.answers.length?t`
                <h4>Need a hint?</h4>
                <div>
                  <slot name="hint"></slot>
                </div>
              `:""}
          ${this.querySelector('[slot="evidence"]')&&this.showAnswer&&this.numberCorrect===this.answers.length?t`
                <h4>Evidence</h4>
                <div>
