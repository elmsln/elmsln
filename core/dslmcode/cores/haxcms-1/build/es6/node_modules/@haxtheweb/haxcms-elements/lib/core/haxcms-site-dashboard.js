 ...
 */
import{html as t,css as e}from"../../../../lit/index.js";import{store as o}from"./haxcms-site-store.js";import{autorun as i,toJS as s}from"../../../../mobx/dist/mobx.esm.js";import"../../../simple-tooltip/simple-tooltip.js";import"../../../simple-fields/lib/simple-fields-form.js";import"../../../simple-icon/simple-icon.js";import"../../../simple-icon/lib/simple-icons.js";import"../../../simple-icon/lib/simple-icon-button.js";import{HaxUiBaseStyles as a}from"../../../hax-body/lib/hax-ui-styles.js";import{HaxSchematizer as r,HaxElementizer as d}from"../../../hax-body-behaviors/lib/HAXFields.js";import{SimpleColors as l}from"../../../simple-colors/simple-colors.js";class HAXCMSSiteDashboard extends l{static get tag(){return"haxcms-site-dashboard"}constructor(){super(),this.siteTitle="",this.activeSection="site",this.method="POST",this.loadEndpoint="",this.body={},this.headers={},this.__disposer=[],this.__disposer.push(i(t=>{this.jwt=s(o.jwt)})),this.__disposer.push(i(t=>{this.siteTitle=s(o.siteTitle)}))}static get styles(){return[a,e`
        :host {
          z-index: 1;
          display: block;
    ...
    `}static get properties(){return{...super.properties,loadEndpoint:{type:String,attribute:"load-endpoint"},headers:{type:Object},body:{type:Object},method:{type:String},jwt:{type:String},publishing:{type:Boolean},siteTitle:{type:String},activeSection:{type:String,attribute:"active-section"}}}updated(t){super.updated&&super.updated(t),t.has("activeSection")&&this._activateSettingsSection()}disconnectedCallback(){for(var t in this.__disposer){const e=this.__disposer[t];"function"==typeof e?e():e&&"function"==typeof e.dispose&&e.dispose()}this.__disposer=[],super.disconnectedCallback()}fieldDataLoaded(){const t=o.getManifestItems(!0);var e=[];t.forEach(o=>{if(o.id!=this.itemId){let i=o,s="- ";for(;i&&null!=i.parent;)i=t.find(t=>t.id==i.parent),i&&(s="--"+s);e.push({text:s+o.title,value:o.id})}}),requestAnimationFrame(()=>{const t=this.shadowRoot.querySelector("#siteform").fields;t.find(t=>"manifest"===t.property).properties.find(t=>"theme"===t.property).properties.find(t=>"regions"===t.property).properties.map(t=>{"array"===t.inputMethod&&(t.properties[0].itemsList=e)});const o=t.find(t=>"manifest"===t.property).properties.find(t=>"site"===t.property);if(o&&o.properties){const t=o.properties.find(t=>"manifest-metadata-site-homePageId"===t.property);if(t){const o={"":"-- default to first page --"};e.forEach(t=>{o[t.value]=t.text}),t.options=o}}setTimeout(()=>{this.shadowRoot.querySelector("#siteform").fields=[...t],requestAnimationFrame(()=>{this.shadowRoot.querySelector("#siteform").requestUpdate(),this._activateSettingsSection()})},0)})}_activateSettingsSection(){const t={site:"manifest/site",theme:"manifest/theme",seo:"manifest/seo",author:"manifest/author"},e=t[this.activeSection]||t.site;let o=0;const applyActivePath=()=>{const t=this.shadowRoot.querySelector("#siteform");if(t&&t.shadowRoot&&t.shadowRoot.querySelector("#sf")){const o=t.shadowRoot.querySelector("#sf");if(o&&o.setActivePath)return void o.setActivePath(e)}o++,o<15&&setTimeout(()=>{applyActivePath()},100)};applyActivePath()}generateRequest(){this.shadowRoot.querySelector("#siteform").loadData()}_saveSiteFieldsTap(t){o.playSound("click"),globalThis.dispatchEvent(new CustomEvent("haxcms-save-site-data",{bubbles:!0,composed:!0,cancelable:!0,detail:this.shadowRoot.querySelector("#siteform").submit()})),setTimeout(()=>{globalThis.dispatchEvent(new CustomEvent("simple-modal-hide",{bubbles:!0,cancelable:!0,detail:{}}))},0)}}globalThis.customElements.define(HAXCMSSiteDashboard.tag,HAXCMSSiteDashboard);export{HAXCMSSiteDashboard};