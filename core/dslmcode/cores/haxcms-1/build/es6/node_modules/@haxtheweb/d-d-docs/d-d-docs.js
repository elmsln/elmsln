 ...
 */
import"../accent-card/accent-card.js";import"../course-design/lib/block-quote.js";import"../course-design/lib/learning-component.js";import{DDD as e}from"../d-d-d/d-d-d.js";import"../d-d-d/lib/ddd-card.js";import"../d-d-d/lib/ddd-steps-list-item.js";import"../d-d-d/lib/ddd-steps-list.js";import{getDDDPaletteOptionByValue as t,getDDDPaletteOptions as a}from"../d-d-d/lib/DDDPaletteRegistry.js";import{ApplicationAttributeData as s,DDDAllStyles as d}from"../d-d-d/lib/DDDStyles.js";import{DDDBorders as l}from"../d-d-d/lib/DDDBorders.js";import{DDDMarginPadding as i}from"../d-d-d/lib/DDDMarginPadding.js";import{DDDFontSizing as o}from"../d-d-d/lib/DDDFontSizing.js";import{DDDLineHeight as r}from"../d-d-d/lib/DDDLineHeight.js";import"../d-d-d/lib/hax-palette-picker.js";import"../figure-label/figure-label.js";import"../media-image/media-image.js";import"../page-section/page-section.js";import"../self-check/self-check.js";import"../simple-cta/simple-cta.js";import"../stop-note/stop-note.js";import"../video-player/video-player.js";import{css as n,html as c}from"../../lit/index.js";export const styleGuideTopics={DDDelementsList:"DDDelementsList",Breakpoints:"Breakpoints",DataAttributes:"DataAttributes",Borders:"Borders",DefaultColors:"DefaultColors",DefaultFunctionalColors:"DefaultFunctionalColors",Palettes:"Palettes",PalettePicker:"PalettePicker",Gradients:"Gradients",Radius:"Radius",Shadows:"Shadows",Spacing:"Spacing",HeaderSample:"HeaderSample",Typography:"Typography",RichText:"RichText",InstructionalComponents:"InstructionalComponents",Cards:"Cards",StepsList:"Steps List",Buttons:"Buttons",PageSections:"PageSections"};class DDDocs extends e{constructor(){super(),this.option="*",this.options=Object.keys(styleGuideTopics),this.palettePickerOptions=a();const e=t("0","0",this.palettePickerOptions);this.palettePickerValue=e?e.dataPalette:"0"}static get properties(){return{option:{type:String},options:{type:Array},palettePickerOptions:{type:Array,attribute:!1},palettePickerValue:{type:String}}}static get styles(){return[super.styles,d,l,i,o,r,n`
        /* used for demo */
        :host {
          display: block;
        }
      ...
      `]}renderDataAttributes(){return c`${Object.keys(s).map(e=>c`
          <h2>${e}</h2>
          <div>
            ${Object.keys(s[e]).map(t=>c`
                <d-d-d-sample type="${e}" option="${t}"
      ...
      >
        ${Object.keys(s.primary).map(e=>c`
            <simple-cta data-primary="${e}" data-pulse="1"
              >Primary-${e}</simple-cta
            >
            <simple-cta data-primary="${e}" data-pulse="1" light
              >Primary-${e}</simple-cta
            >
          `)}
      </div> `}renderHeaderSample(){let e=[];for(let t=0;t<22;t++)e.push(c`
        <details style="max-width: 100%; margin: 0 64px;">
          ...
          ${Array(6).fill().map((e,a)=>c`
                <div
                  class="my-16"
                  data-accent
                  data-primary="${t}"
                  style="--ddd-theme-accent: var(--ddd-accent-${a}); border: var(--ddd-border-sm); border-color: var(--ddd-theme-primary);"
                >
                  <h2 data-primary="${t}" data-design-treatment="horz">
                    Discover Penn State
                  </h2>
                  <p>ddd-primary-${t}</p>
                  <p>ddd-accent-${a}</p>
          ...
          ${Array(6).fill().map((e,a)=>0===a?c`<h2
                ...
                >
                  Sample Header
                </h2>`:2===a?c`<h2 data-primary="${t}" data-design-treatment="bg">
                  Sample Header
                </h2>`:3===a?c`<h2 data-primary="${t}" data-instructional-action>
                  Sample Header
                </h2>`:4===a?c`<h2
                  data-primary="${t}"
      ...
      `);return e}renderDDDelementsList(){return c`
    ...
    `}renderDefaultFunctionalColors(){return c`
      <h2 class="fs-s mt-0 mb-2 pb-5 bb-sm">
    ...
    `}_onPalettePickerValueChanged(e){e.detail&&(e.detail.value||"0"===e.detail.value)&&e.detail.value.toString?this.palettePickerValue=e.detail.value.toString():this.palettePickerValue="0"}renderPalettePicker(){const e=t(this.palettePickerValue,"0",this.palettePickerOptions),a=e?e.dataPalette:"0",s=e?e.label:"",d=e?e.key:"",l=e&&Array.isArray(e.swatches)?e.swatches:[1,2,3,4,5,6,7];return c`
      ...
      <div class="palette-picker-layout">
        ...
        <div class="palette-picker-preview-stack">
          <div class="palette-picker-preview" data-palette="${a}">
            ...
            <div class="palette-picker-swatches">
              ${l.map(e=>c`
                  <span class="palette-picker-swatch palette-picker-swatch-${e}"></span>
                `)}
            </div>
          </div>
          <div
    ...
    `}renderRichText(){return c`
      ...
      <div class="b-xs py-8 px-4 my-10 mx-30">
        ...
        <ul class="ddd-link-list">
          ...
          <li><a href="#">NEW: Engineering and Science Degree</a></li>
    ...
    `}renderCards(){return c` <h3>ddd-card</h3>
      <ddd-card
      ...
      </ddd-card>`}renderStepsList(){return c`
    ...
    `}renderButtons(){let e=[];for(let t=0;t<22;t++){Math.floor(14*Math.random());e.push(c`
        <div class="grid-3 ">
          <simple-cta data-primary="${t}">Primary-${t}</simple-cta>
          <simple-cta data-primary="${t}" light>Primary-${t} Light</simple-cta>
          <simple-cta data-primary="${t}" Hotline
            >Primary-${t} Hotline</simple-cta
          >
          <simple-cta data-primary="${t}" large>Primary-${t} large</simple-cta>
          <simple-cta data-primary="${t}" hide-icon
            >Primary-${t} hide-icon</simple-cta
          >
          <simple-cta data-primary="${t}" saturate
            >Primary-${t} saturate</simple-cta
          >
        </div>
      `)}return e.push(c`
      <div
    ...
    `}renderInstructionalComponents(){return c`
      <div class="b-xs">
        <div class="m-10">
          <h3>figure-label</h3>
          <figure-label
