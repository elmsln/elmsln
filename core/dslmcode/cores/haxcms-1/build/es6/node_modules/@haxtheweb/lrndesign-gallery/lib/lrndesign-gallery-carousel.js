 ...
 */
import{LitElement as e,html as i,css as l}from"../../../lit/index.js";import{LrndesignGalleryBehaviors as t}from"./lrndesign-gallery-behaviors.js";import"../../simple-tooltip/simple-tooltip.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import"./lrndesign-gallery-zoom.js";import"./lrndesign-gallery-details.js";class LrndesignGalleryCarousel extends t{static get tag(){return"lrndesign-gallery-carousel"}static get styles(){return[...super.styles,l`
        :host {
          margin: 15px 0;
          padding: 0;
    ...
    `}static get properties(){return{...super.properties}}constructor(){super()}get hideNav(){return void 0===this.sources||this.sources.length<2}_onNavTapped(e){this.goToItem(e.index)}}customElements.define(LrndesignGalleryCarousel.tag,LrndesignGalleryCarousel);export{LrndesignGalleryCarousel};