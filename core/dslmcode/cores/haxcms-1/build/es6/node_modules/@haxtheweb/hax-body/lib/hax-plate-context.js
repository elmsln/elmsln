import{LitElement as t,css as e,html as o}from"../../../lit/index.js";import"./hax-toolbar.js";import"../../simple-toolbar/lib/simple-toolbar-menu-item.js";import{HAXStore as i}from"./hax-store.js";import"./hax-toolbar-menu.js";import"./hax-toolbar.js";import"./hax-context-item.js";import{wipeSlot as a}from"../../utils/utils.js";import{autorun as l,toJS as s}from"../../../mobx/dist/mobx.esm.js";import{HaxContextBehaviors as n}from"./hax-context-behaviors.js";import{normalizeEventPath as r}from"../../utils/utils.js";import{I18NMixin as d}from"../../i18n-manager/lib/I18NMixin.js";class HaxPlateContext extends(d(n(t))){constructor(){super(),this.disableOps=!1,this.disableItemOps=!1,this.insertAbove=!0,this.disableDuplicate=!1,this.hasActiveEditingElement=!1,this.haxUIElement=!0,this.t={edit:"Edit",dragHandle:"Drag handle",moveUp:"Move up",moveDown:"Move down",addColumn:"Add column",removeColumn:"Remove column",remove:"Remove",duplicate:"Duplicate",confirmDelete:"Confirm delete",changeTo:"Change to",editElement:"Edit Mode",modifyHTMLSource:"Modify HTML source",regions:"Available regions",insertItemAbove:"Insert item above",insertItemAboveOrBelow:"Insert item above or below",insertItemBelow:"Insert item below",selectLayout:"Select Layout Element",lockContent:"Lock content",unlockContent:"Unlock content"},this.registerLocalization({context:this,namespace:"hax"}),this.ceButtons=[],this.activeTagName="",this.activeTagIcon="hax:paragraph",this.addEventListener("hax-context-item-selected",this.handleCECustomEvent.bind(this))}static get tag(){return"hax-plate-context"}static get styles(){return[super.styles,e`
    ...
    `}get filteredBlocks(){return this.getFilteredBlocks(this.formatBlocks)}__updatePlatePosition(t){let e=this.shadowRoot.querySelector("#right"),o=this.shadowRoot.querySelector("#rightremove");e.disabled=!1,o.disabled=!1,t&&"GRID-PLATE"==t.tagName?"1-1-1-1"==t.layout&&(e.disabled=!0):o.disabled=!0}__dblClickFireInsert(t){this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,cancelable:!0,composed:!0,detail:{target:t.target,eventName:"insert-below-active"}}))}handleCECustomEvent(t){let e=t.detail;if("hax-ce-custom-button"===e.eventName)this.activeNode&&"function"==typeof this.activeNode[e.value]&&this.activeNode[e.value](t)&&i.refreshActiveNodeForm()}updated(t){super.updated&&super.updated(t),t.forEach(((t,e)=>{"onScreen"===e&&this.onScreen&&this._resetCEMenu(),"activeNode"===e&&(this.isLocked=this._isNodeLocked(this.activeNode)),"activeNode"!==e&&"activeEditingElement"!==e||(this.activeSchema=i.activeSchema(),this.editElementProperty=!(!this.activeSchema||!this.activeSchema.editElement)&&this.activeSchema.editElement,this.editElementToggled=this.activeNode&&this.editElementProperty&&!!this.activeNode[this.editElementProperty])}))}firstUpdated(t){super.firstUpdated(t),l((()=>{this.activeNode=s(i.activeNode),this.activeNode&&this.activeNode.classList&&this._resetCEMenu(),this.activeNode&&s(i.editMode)&&setTimeout((()=>{this.__updatePlatePosition(this.activeNode)}),0)})),l((()=>{s(i.activeEditingElement)?this.hasActiveEditingElement=!0:this.hasActiveEditingElement=!1})),this.shadowRoot.querySelector("#drag").addEventListener("dragstart",this._dragStart),this.shadowRoot.querySelector("#drag").addEventListener("dragend",this._dragEnd)}_dragEnd(t){let e=r(t)?r(t)[0]:void 0;e&&e.close(!0),i._lockContextPosition=!1}_dragStart(t){let e=s(i.activeNode),o=r(t)?r(t)[0]:void 0;o&&o.close(!0),i.__dragTarget=e,i._lockContextPosition=!0,i.activeHaxBody.__activeHover=null,i.activeHaxBody._hideContextMenu(i.activeHaxBody.contextMenus.add),t.dataTransfer&&(t.dataTransfer.effectAllowed="move",t.dataTransfer.dropEffect="move",t.dataTransfer.setDragImage(e,-20,-20)),t.stopPropagation(),t.stopImmediatePropagation()}async _resetCEMenu(){if(this.shadowRoot&&a(this,"*"),this.ceButtons=[],i.activeHaxBody&&null!=this.activeNode){let t=i.haxSchemaFromTag(this.activeNode.tagName);this.sourceView=t.canEditSource,i.activeGizmo&&(this.activeTagName=i.activeGizmo.title,this.activeTagIcon=i.activeGizmo.icon)}else i.activeGizmo?(this.activeTagName=i.activeGizmo.title,this.activeTagIcon=i.activeGizmo.icon):(this.activeTagName="",this.activeTagIcon="");await i.runHook(this.activeNode,"inlineContextMenu",[this])}_isNodeLocked(t){return!(!t||!t.getAttribute)&&(null!=t.getAttribute("data-hax-lock")||!(!t.parentNode||!t.parentNode.getAttribute||null==t.parentNode.getAttribute("data-hax-lock")))}_toggleActiveNodeLock(t){if(!this.activeNode||!this.activeNode.getAttribute)return;t.preventDefault(),t.stopPropagation();const e=this.activeNode;let o=null!=e.getAttribute("data-hax-lock");o?(e.removeAttribute("data-hax-lock"),o=!1):(e.setAttribute("data-hax-lock","data-hax-lock"),o=!0),this.isLocked=o,this.dispatchEvent(new CustomEvent("hax-toggle-active-node-lock",{bubbles:!0,composed:!0,cancelable:!0,detail:{lock:o,node:e}}))}static get properties(){return{...super.properties,activeTagIcon:{type:String},activeSchema:{type:Object},editElementProperty:{type:String},editElementToggled:{type:Boolean},activeTagName:{type:String},disableOps:{type:Boolean},disableItemOps:{type:Boolean},insertAbove:{type:Boolean},disableDuplicate:{type:Boolean},canMoveElement:{type:Boolean},ceButtons:{type:Array},hasActiveEditingElement:{type:Boolean},onScreen:{type:Boolean,attribute:"on-screen",reflect:!0},sourceView:{type:Boolean},isLocked:{type:Boolean}}}}globalThis.customElements.define(HaxPlateContext.tag,HaxPlateContext);export{HaxPlateContext};