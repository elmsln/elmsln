 ...
 */
import{html as e,css as t,render as s,nothing as i}from"../../lit/index.js";import{SimpleColors as a}from"../simple-colors/simple-colors.js";import{SchemaBehaviors as o}from"../schema-behaviors/schema-behaviors.js";import{I18NMixin as r}from"../i18n-manager/lib/I18NMixin.js";import{validURL as l,cleanVideoSource as n,isElementInViewport as d}from"../utils/utils.js";import{gSheetInterface as c}from"../utils/lib/gSheetsInterface.js";import{normalizeEventPath as h}from"../utils/utils.js";import"../simple-fields/lib/simple-fields-field.js";import"../simple-fields/lib/simple-fields-tag-list.js";import"../a11y-collapse/a11y-collapse.js";import"../a11y-collapse/lib/a11y-collapse-group.js";import"../editable-table/lib/editable-table-display.js";import"../a11y-tabs/a11y-tabs.js";import"../a11y-tabs/lib/a11y-tab.js";import"../grid-plate/grid-plate.js";import"../iframe-loader/lib/loading-indicator.js";import"./lib/letter-grade.js";import"./lib/letter-grade-picker.js";import"../../@github/time-elements/dist/index.js";import{UIRenderPieces as p}from"./lib/GradeBookUIPieces.js";import{GradeBookStore as u}from"./lib/grade-book-store.js";import"./lib/grade-book-pop-up.js";import{autorun as g,toJS as m}from"../../mobx/dist/mobx.esm.js";import{get as b,set as v}from"../../idb-keyval/dist/compat.js";import{ESGlobalBridgeStore as f}from"../es-global-bridge/es-global-bridge.js";import{XLSXFileSystemBrokerSingleton as y}from"../file-system-broker/lib/xlsx-file-system-broker.js";class GradeBook extends(p(r(o(a)))){constructor(){super(),this.__disposer=[],this.__resizeObserver=null,this.__xlsxFileSystemDataHandler=null,this.hasFilePicker=!1,this.source="googledocs",globalThis.showOpenFilePicker&&(this.source="filesystem",this.hasFilePicker=!0),this.ready=!1,this.displayMode=0,this.assessmentView=this.resetAssessmentView(),this.totalScore=0,this.activeStudentSubmissions=[],this.scoreLock=!0,this.activeRubric=[],this.activeGrading={},this.settings={photo:!0,fname:!0,surname:!0,email:!0},this.forCourse="",this.disabled=!1,this.loading=!1,this.t={csvURL:"CSV URL",points:"Points",criteria:"Criteria",description:"Description",assessmentWeight:"Assessment weight",overallFeedback:"Overall feedback",letterGrade:"Letter grade",highRange:"High range",lowRange:"Low range",noSubmission:"No submission found",studentSubmission:"Student submission",openInNewWindow:"Open in new window",gradingScale:"Grading scale",activeStudent:"Active student",activeAssignment:"Active assignment",submitted:"Submitted",dueDate:"Due date",firstName:"First name",surname:"Surname",photo:"Photo",email:"Email",settings:"Settings",previous:"Previous",next:"Next",previousStudent:"Previous student",nextStudent:"Next student",previousAssignment:"Previous assignment",nextAssignment:"Next assignment",student:"Student",assessmentView:"Assessment View",activeAssessment:"Active assessment",studentReportView:"Student report view",loadGradebook:"Load gradebook",load:"Load",saveGradebook:"Save gradebook",selectGradebookSource:"Select gradebook source",sourceData:"Source data",pasteValidJSONHere:"Paste valid JSON here",loadingFilePleaseWait:"LOADING FILE PLEASE WAIT.."},this.registerLocalization({context:this,basePath:import.meta.url}),this.addEventListener("simple-fields-tag-list-changed",this.qualitativeFeedbackUpdate.bind(this)),this.addEventListener("value-changed",this.rubricCriteriaPointsChange),this.addEventListener("drop",this._handleDragDrop.bind(this)),this.__disposer.push(g(()=>{const e=m(u.activeStudent);Promise.resolve().then(()=>{this.activeStudent=e})})),this.__disposer.push(g(()=>{const e=m(u.activeAssignment);Promise.resolve().then(()=>{this.activeAssignment=e})})),this.__disposer.push(g(()=>{const e=m(u.database);Promise.resolve().then(()=>{this.database=e})})),this.__disposer.push(g(()=>{const e=m(u.activeSubmission);Promise.resolve().then(()=>{this.activeSubmission=e})}))}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.__resizeObserver=new ResizeObserver(e=>{clearTimeout(this.__resizer),this.__resizer=setTimeout(()=>{var t=0;for(let s of e)t=s.contentBoxSize?Math.round(globalThis.innerHeight-s.contentBoxSize[0].blockSize-122):Math.round(globalThis.innerHeight-s.contentRect.height-122);this.shadowRoot.querySelector("#studentassessment").shadowRoot.querySelector("[part='content']").style.height=t+"px"},50)}),this.__resizeObserver.observe(this.shadowRoot.querySelector("#studentgrid")),setTimeout(async()=>{this.prevLocalFileReference=await b("grade-book-prev-file"),this.requestUpdate()},0)}resetAssessmentView(){return{qualitative:[],written:[]}}getStudentSubmissions(e){let t=[];for(var s in this.database.submissions){let a=this.database.submissions[s];if(a.student===this.database.roster[e].student){for(var i in a)if("student"!==i){let s=this.getAssignmentByShortName(i);s&&t.push({studentScore:this.database.grades[e]&&""!=this.database.grades[e][i]?this.database.grades[e][i]:null,assignmentPoints:s.points,assignmentName:s.name,assignmentIndex:s.index})}return t}}return t}getAssignmentByShortName(e){let t,s=this.database.assignments.filter((s,i)=>s.shortName===e&&(t=i,!0));return 1===s.length?(s[0].index=t,s[0]):null}getCurrentScore(e,t){return this.database.grades[e]&&this.database.grades[e][this.database.assignments[t].shortName]?this.database.grades[e][this.database.assignments[t].shortName]:0}getActiveRubric(){return this.database.rubrics.filter(e=>e.shortName==this.database.assignments[this.activeAssignment].rubric)}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{if(!this.loading&&["activeAssignment","activeStudent","database","loading"].includes(t)&&(setTimeout(()=>{this.totalScore=this.getCurrentScore(this.activeStudent,this.activeAssignment),this.assessmentView=this.resetAssessmentView(),this.activeRubric=[...this.getActiveRubric()],this.hideRubricInfo=[...this.activeRubric.map(()=>!1)],this.activeStudentSubmissions=[],this.activeStudentSubmissions=[...this.getStudentSubmissions(this.activeStudent)],2==this.displayMode&&this.renderSubmissionInWindow()},0),this.maintainScrollPosition()),["sourceData","source"].includes(t))if(this.sourceData)switch(this.source){case"googledocs":this.loading=!0,this.gSheet=new c(this,this.sourceData,{tags:0,roster:118800528,assignments:540222065,rubrics:1744429439,submissions:2104732668,gradeScale:980501320,grades:2130903440,gradesDetails:644559151,settings:1413275461}),setTimeout(async()=>{for(var e in this.gSheet.sheetGids){let t=await this.gSheet.loadSheetData(e);t=this.transformTable(t),"function"==typeof this[`process${e}Data`]&&(t=this[`process${e}Data`](t)),this.database[e]=t,"gradeScale"===e&&this.database.gradeScale&&this.database.gradeScale.length>0&&(u.gradeScale=this.database.gradeScale),this.requestUpdate()}this.importStateCleanup()},0);break;case"url":this.loading=!0,fetch(this.sourceData).then(e=>{if(e.ok)return e.json()}).then(e=>{u.database=e,this.importStateCleanup()}).catch(e=>{console.warn(e)});break;case"json":u.database=JSON.parse(this.sourceData),this.importStateCleanup()}else"filesystem"==this.source&&(this.__applied||(this.__applied=!0,this.__xlsxFileSystemDataHandler=e=>{let t=e.detail.data;for(var s in t){let e=this.transformTable(t[s]);"function"==typeof this[`process${s}Data`]&&(e=this[`process${s}Data`](e)),u.database[s]=e}this.importStateCleanup()},globalThis.addEventListener("xlsx-file-system-data",this.__xlsxFileSystemDataHandler)))})}disconnectedCallback(){for(var e in this.__resizeObserver&&(this.__resizeObserver.disconnect(),this.__resizeObserver=null),this.__resizer&&(clearTimeout(this.__resizer),this.__resizer=null),this.__xlsxFileSystemDataHandler&&(globalThis.removeEventListener("xlsx-file-system-data",this.__xlsxFileSystemDataHandler),this.__xlsxFileSystemDataHandler=null,this.__applied=!1),this.__disposer){const t=this.__disposer[e];"function"==typeof t?t():t&&"function"==typeof t.dispose&&t.dispose()}this.__disposer=[],super.disconnectedCallback&&super.disconnectedCallback()}importStateCleanup(){this.loading=!1,this.database.gradeScale&&this.database.gradeScale.length>0&&(u.gradeScale=this.database.gradeScale),this.requestUpdate(),this.ready=!0}transformTable(e){let t=e.shift(),s={},i=[];for(var a in t)s[t[a]]=a;for(var a in e){let t={};for(var o in s)t[o]=e[a][s[o]];i.push(t)}return i}maintainScrollPosition(){this.shadowRoot&&this.shadowRoot.querySelector("#studentgrid [data-active]")&&setTimeout(()=>{let e=d(this.shadowRoot.querySelector("#studentgrid [data-active]"),{top:0,right:globalThis.innerWidth,bottom:this.shadowRoot.querySelector("#studentgrid").getBoundingClientRect().height+20,left:192});0===u.activeStudent?this.shadowRoot.querySelector("#studentgrid").scrollTop=0:e||(this.shadowRoot.querySelector("#studentgrid").scrollTop=this.shadowRoot.querySelector("#studentgrid [data-active]").offsetTop-this.shadowRoot.querySelector("#studentgrid").offsetTop),0===u.activeAssignment?this.shadowRoot.querySelector("#studentgrid").scrollLeft=0:e||(this.shadowRoot.querySelector("#studentgrid").scrollLeft=this.shadowRoot.querySelector("#studentgrid [data-active]").offsetLeft-192-this.shadowRoot.querySelector("#studentgrid").offsetLeft)},0)}processassignmentsData(e){for(var t in e)if(""!=e[t].dueDate)try{const s=new Date(`${e[t].dueDate} ${e[t].dueTime}`);e[t]._ISODueDate=s.toISOString()}catch(e){}return e}processtagsData(e){let t=new Set([]),s=[];for(var i in e)e[i].category=e[i].category?e[i].category.split(","):[],e[i].associatedMaterial=e[i].associatedMaterial?e[i].associatedMaterial.split(","):[],e[i].category.forEach(e=>{t.add(e)}),s=[...Array.from(t)];return{categories:s,data:e}}processrubricsData(e){for(var t in e)e[t].qualitative=e[t].qualitative?e[t].qualitative.split(","):[];return e}processrosterData(e){for(var t in e)e[t].interests=e[t].interests?e[t].interests.split(","):[];return e}processsettingsData(e){let t={};for(var s in e)t[e[s].key]=e[s].value;return t}static get properties(){return{...super.properties,displayMode:{type:Number},settings:{type:Object},disabled:{type:Boolean,reflect:!0},loading:{type:Boolean,reflect:!0},ready:{type:Boolean,reflect:!0},activeStudent:{type:Number,attribute:"active-student"},activeAssignment:{type:Number,attribute:"active-assignment"},totalScore:{type:Number},scoreLock:{type:Boolean},source:{type:String},sourceData:{type:String,attribute:"source-data"},activeSubmission:{type:String,attribute:!1},database:{type:Object,attribute:!1},activeRubric:{type:Object,attribute:!1},assessmentView:{type:Object,attribute:!1},activeGrading:{type:Object,attribute:!1},activeStudentSubmissions:{type:Array},forCourse:{type:String,attribute:"for-course"}}}async changeStudent(e){this.shadowRoot.querySelectorAll("#studentgrid .th-or-td").forEach(e=>{e.classList.remove("col-highlight")}),"prev"==e.target.getAttribute("value")&&0!==this.activeStudent?u.activeStudent--:"next"==e.target.getAttribute("value")&&this.database.roster.length-1!==this.activeStudent&&u.activeStudent++,await this.requestUpdate()}async changeAssignment(e){this.shadowRoot.querySelectorAll("#studentgrid .th-or-td").forEach(e=>{e.classList.remove("col-highlight")}),"prev"==e.target.getAttribute("value")&&0!==this.activeAssignment?u.activeAssignment--:"next"==e.target.getAttribute("value")&&this.database.assignments.length-1!==u.activeAssignment&&u.activeAssignment++,await this.requestUpdate()}static get styles(){return[super.styles,t`
        :host {
          display: block;
        }
        :host [hidden] {
      ...
      ></relative-time> `;return l(t)?(i=e`${i}<a
          href="${t}"
          target="_blank"
          ...
          ><simple-icon-button-lite
            ...
            icon="open-in-new"
          ></simple-icon-button-lite
        ></a>`,t!=n(t)?(import("../video-player/video-player.js"),e`${i}<video-player
        ...
        </div>`)}studentLetterGradeHistoryClick(e){u.activeAssignment=parseInt(e.target.value),this.requestUpdate()}activateOption(e){let t=h(e);t[0].getAttribute("data-student")&&t[0].getAttribute("data-assignment")&&(u.activeAssignment=parseInt(t[0].getAttribute("data-assignment")),u.activeStudent=parseInt(t[0].getAttribute("data-student")),this.shadowRoot.querySelector("#studentgrid").style.height="140px",this.maintainScrollPosition())}mouseHighlight(e){let t=h(e)[0];clearTimeout(this.__mdebounce),this.__mdebounce=setTimeout(()=>{t&&t.getAttribute("data-assignment")!=this.__activeHoverAssignment&&(this.shadowRoot.querySelectorAll('#studentgrid .th-or-td[data-assignment="'+this.__activeHoverAssignment+'"]').forEach(e=>{e.classList.remove("col-highlight")}),this.__activeHoverAssignment=t.getAttribute("data-assignment"),this.shadowRoot.querySelectorAll('#studentgrid .th-or-td[data-assignment="'+this.__activeHoverAssignment+'"]').forEach(e=>{e.classList.add("col-highlight")}))},10)}mouseLeave(e){clearTimeout(this.__mdebounce),this.__mdebounce=setTimeout(()=>{this.shadowRoot.querySelectorAll("#studentgrid .th-or-td").forEach(e=>{e.classList.remove("col-highlight")})},100)}settingChanged(e){e.stopPropagation(),e.stopImmediatePropagation(),e.preventDefault(),this.settings[e.detail.name]=e.detail.value,this.settings={...this.settings}}handleGridScaling(e){let t=h(e);"TABLE"===t[0].tagName&&(""!=t[0].style.height?t[0].style.height=null:t[0].style.height="90vh")}checkTabHeight(e){parseInt(this.shadowRoot.querySelector("#studentgrid").getBoundingClientRect().height)/globalThis.innerHeight>.65&&(this.shadowRoot.querySelector("#studentgrid").style.height=null)}studentreportClick(e){f.import("jspdf",new URL("./lib/grade-book.js",import.meta.url).href+"/../jspdf.min.js").then(()=>{var e=new jsPDF;e.fromHTML(this.shadowRoot.querySelector("#studentreport").outerHTML,15,15);const t=new Date,s=`${t.getFullYear()}-${t.getMonth()}-${t.getDate()}__${t.getHours()}-${t.getMinutes()}-${t.getSeconds()}`,i=`${this.database.roster[this.activeStudent].student}--${this.database.assignments[this.activeAssignment].shortName}--${s}.pdf`;e.save(i)})}openWindow(e){this.__openWindow&&!this.__openWindow.closed?this.__openWindow.focus():(this.__openWindow=globalThis.open("","studentwork",`left=0,top=0,width=${screen.width/2},height=${screen.height/2},menubar=0,location=0,toolbar=0,status=0`),this.__openWindow.onbeforeunload=()=>{this.displayMode=0,this.__openWindow=null}),this.renderSubmissionInWindow()}renderSubmissionInWindow(){this.__openWindow&&2===this.displayMode&&(this.__openWindow.document.body.style.margin="0",s(e` ${this.database.assignments.length&&this.database.assignments[this.activeAssignment]?e`<grade-book-pop-up></grade-book-pop-up>`:e`${this.t.noSubmission}`}`,this.__openWindow.document.body))}renderAssessmentSchema(){return this.database&&this.database.assignments&&this.database.assignments.length?e`
      <div class="oer-assessment-schema" hidden>
        ${this.database.assignments.map(t=>e`
            <span typeof="oer:Assessment">
              <meta property="oer:gradingFormat" content="points" />
              ${this.forCourse?e`<meta
