 ...
 */
import{LitElement as t,html as e,css as i}from"../../lit/index.js";import{DDD as s}from"../d-d-d/d-d-d.js";import{FullscreenBehaviors as o}from"../fullscreen-behaviors/fullscreen-behaviors.js";import{I18NMixin as r}from"../i18n-manager/lib/I18NMixin.js";import{SchemaBehaviors as l}from"../schema-behaviors/schema-behaviors.js";import"../anchor-behaviors/anchor-behaviors.js";import"../responsive-utility/responsive-utility.js";import{normalizeEventPath as n}from"../utils/lib/events.js";import"../absolute-position-behavior/absolute-position-behavior.js";import"../simple-tooltip/simple-tooltip.js";import"../simple-search/simple-search.js";import"../simple-range-input/simple-range-input.js";import"../simple-fields/lib/simple-fields-field.js";import"./lib/a11y-media-play-button.js";import"./lib/a11y-media-state-manager.js";import"./lib/a11y-media-button.js";import"./lib/a11y-media-transcript-cue.js";import"./lib/a11y-media-youtube.js";class A11yMediaPlayer extends(l(r(o(s)))){static get styles(){return[super.styles,i`
        :host {
          display: block;
          overflow: hidden;
          width: calc(100% - 2px);
      ...
      `]}render(){return e` <meta property="oer:name" content="${this.mediaTitle}" />
        ...
        >
          <div id="player" .style="${this.playerStyle}">
            <a11y-media-play-button
              ...
              label="${this.__playing?this.t&&this.t.pauseLabel?this.t.pauseLabel:"Pause":this.t&&this.t.playLabel?this.t.playLabel:"Play"}"
                  ...
                  <div class="transcript-from-track">
                    ${this.transcriptCues.map((t,i)=>e`
                        <a11y-media-transcript-cue
                          ...
                          tabindex="${this.disableInteractive||this.disableSeek||0===this.duration?-1:0}"
                          @click="${e=>this._handleCueSeek(t)}"
                          @keydown="${e=>this._handleCueKeydown(e,t)}"
