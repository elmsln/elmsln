...
import{LitElement as e,html as t,css as i}from"../../lit/index.js";import{SchemaBehaviors as a}from"../schema-behaviors/schema-behaviors.js";import{SimpleModalHandler as o}from"../simple-modal/lib/simple-modal-handler.js";import"../figure-label/figure-label.js";import{DDD as r}from"../d-d-d/d-d-d.js";class MediaImage extends r{static get styles(){return[super.styles,i`
      ...
      `]}constructor(){super(),this.link=null,this.disableZoom=!1,this.modalTitle="",this.source="",this.citation="",this.caption="",this.figureLabelTitle="",this.figureLabelDescription="",this.alt="",this.asMd=!1,this.size="wide",this.round=!1,this.card=!1,this.box=!1,this.offset="none"}updated(e){super.updated&&super.updated(e),e.forEach(((e,t)=>{"asMd"===t&&this[t]&&import("../md-block/md-block.js"),"caption"==t&&this._computeHasCaption(this[t]),"link"===t&&this.link&&(this.disableZoom=!0),["figureLabelTitle","figureLabelDescription"].includes(t)&&(this.__figureLabel=this._hasFigureLabel(this.figureLabelTitle,this.figureLabelDescription)),["figureLabelTitle","caption"].includes(t)&&(this.modalTitle=this.figureLabelTitle?this.figureLabelTitle:this.caption,this.modalTitle+=this.figureLabelDescription?" - "+this.figureLabelDescription:"")}))}render(){return t`
    ...
    `}updated(e){e.forEach(((e,t)=>{"source"==t&&(this.modalContent.src=this[t])}))}static get properties(){return{source:{type:String},alt:{type:String},round:{type:Boolean,reflect:!0},modalTitle:{type:String,attribute:"modal-title"}}}static get tag(){return"media-image-image"}}globalThis.customElements.define(MediaImageImage.tag,MediaImageImage);class MediaImageCitation extends r{static get styles(){return[super.styles,i`
        :host {
          display: block;
          overflow: auto;
        }
