 ...
 */
import{ChatAgentModalStore as e}from"../chat-agent.js";import{DDD as t}from"../../d-d-d/d-d-d.js";import{html as s,css as r}from"../../../lit/index.js";import{autorun as i,toJS as o}from"../../../mobx/dist/mobx.esm.js";class ChatSuggestion extends t{static get tag(){return"chat-suggestion"}constructor(){super(),this.chosenPrompt=!1,this.disabled=!1,this.promptType="",this.suggestion="",
//! mobx
this.messageIndex=null,this.userIndex=null,i((()=>{this.messageIndex=o(e.messageIndex),this.userIndex=o(e.userIndex)}))}static get styles(){return[super.styles,r`
