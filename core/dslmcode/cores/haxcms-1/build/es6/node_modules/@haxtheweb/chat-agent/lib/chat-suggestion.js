...
//! mobx
this.messageIndex=null,this.userIndex=null,this.__disposer=[],this.__disposer.push(i(()=>{this.messageIndex=r(o.messageIndex)})),this.__disposer.push(i(()=>{this.userIndex=r(o.userIndex)}))}static get styles(){return[super.styles,t`
