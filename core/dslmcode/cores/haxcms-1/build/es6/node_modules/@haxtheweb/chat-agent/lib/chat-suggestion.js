...
//! mobx
this.messageIndex=null,this.userIndex=null,this.__disposer=[],this.__disposer.push(i(()=>{const e=r(o.messageIndex);Promise.resolve().then(()=>{this.messageIndex=e})})),this.__disposer.push(i(()=>{const e=r(o.userIndex);Promise.resolve().then(()=>{this.userIndex=e})}))}static get styles(){return[super.styles,t`
    ...
    `}handleSuggestion(){this.disabled?o.devStatement("Suggestion buttons disabled, ignoring request","warn"):(o.devStatement(`Suggestion button pressed. Suggested prompt to send to Merlin: ${this.suggestion}`,"info"),o.handleMessage(o.userName,this.suggestion))}firstUpdated(){let e=this.shadowRoot.querySelector("simple-icon-lite");switch(this.promptType){case"suggestion":e.setAttribute("icon","question-answer"),e.style.color="var(--data-theme-primary, var(--ddd-primary-13))";break;case"network":e.setAttribute("icon","device:signal-cellular-connected-no-internet-0-bar"),e.style.color="var(--ddd-theme-default-coalyGray)";break;case"help":e.setAttribute("icon","help-outline"),e.style.color="var(--ddd-theme-default-original87Pink)";break;case"hax":e.setAttribute("icon","hax:hax2022"),e.style.color="var(--data-theme-primary, var(--ddd-primary-13))";break;default:e.setAttribute("icon","lrn:info"),e.style.color="var(--ddd-theme-default-skyBlue)"}}updated(){this.disabled&&this.shadowRoot.querySelector(".chat-suggestion-wrapper").removeAttribute("tabindex")}disconnectedCallback(){for(;this.__disposer.length;){const e=this.__disposer.pop();e&&"function"==typeof e&&e()}super.disconnectedCallback()}static get properties(){return{...super.properties,chosenPrompt:{type:Boolean,attribute:"chosen-prompt"},disabled:{type:Boolean},promptType:{type:String,attribute:"prompt-type"},suggestion:{type:String}}}}globalThis.customElements.define(ChatSuggestion.tag,ChatSuggestion);export{ChatSuggestion};