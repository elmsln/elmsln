...
import{LitElement as t,html as e,css as i}from"../../../../../lit/index.js";import{store as o}from"../../core/haxcms-site-store.js";import{autorun as s,toJS as n}from"../../../../../mobx/dist/mobx.esm.js";import{DDDPulseEffectSuper as r}from"../../../../d-d-d/d-d-d.js";import{HAXCMSThemeParts as a}from"../../core/utils/HAXCMSThemeParts.js";import{HAXCMSI18NMixin as l}from"../../core/utils/HAXCMSI18NMixin.js";import"../../../../simple-icon/lib/simple-icon-lite.js";import"../../../../simple-icon/lib/simple-icons.js";class SiteMenuButton extends(l(a(r(t)))){static get styles(){return[super.styles,i`
      ...
      `]}static get tag(){return"site-menu-button"}constructor(){super(),this.HAXCMSI18NMixinBase="../../../",this.disabled=!1,this.icon="",this.position="right",this.t={noPreviousPage:"No previous page",noNextPage:"No next page"},this.hideLabel=!1,this.__disposer=this.__disposer?this.__disposer:[],this.__disposer.push(s(t=>{const e=n(o.activeRouterManifestIndex);Promise.resolve().then(()=>{this.activeRouterManifestIndex=e})})),this.__disposer.push(s(t=>{const e=n(o.routerManifest);Promise.resolve().then(()=>{this.routerManifest=e})})),this.__disposer.push(s(t=>{const e=n(o.editMode);Promise.resolve().then(()=>{this.editMode=e})})),import("../../../../simple-tooltip/simple-tooltip.js")}render(){return e`
      <a
        tabindex="-1"
