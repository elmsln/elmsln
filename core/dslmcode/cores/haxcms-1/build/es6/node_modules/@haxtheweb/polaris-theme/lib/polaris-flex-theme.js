 ...
 */
import{html as e,css as a}from"../../../lit/index.js";import{HAXCMSLitElementTheme as t}from"../../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as i}from"../../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{HAXCMSMobileMenuMixin as o}from"../../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as r}from"../../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{store as n}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{MicroFrontendRegistry as d}from"../../micro-frontend-registry/micro-frontend-registry.js";import{HAXCMSRememberRoute as s}from"../../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{QRCodeMixin as l}from"../../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{PrintBranchMixin as m}from"../../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{PDFPageMixin as c}from"../../haxcms-elements/lib/core/utils/PDFPageMixin.js";import"../../scroll-button/scroll-button.js";import"../../haxcms-elements/lib/ui-components/site/site-title.js";import"../../haxcms-elements/lib/ui-components/active-item/site-active-tags.js";import"../../haxcms-elements/lib/ui-components/active-item/site-active-media-banner.js";import"../../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"../../haxcms-elements/lib/ui-components/navigation/site-menu.js";import"../../haxcms-elements/lib/ui-components/layout/site-modal.js";import"../../haxcms-elements/lib/ui-components/layout/site-region.js";import{autorun as p,toJS as h}from"../../../mobx/dist/mobx.esm.js";import{DDDSuper as g}from"../../d-d-d/d-d-d.js";import{HAXCMSToastInstance as u}from"../../haxcms-elements/lib/core/haxcms-toast.js";import{LTIResizingMixin as v}from"../../haxcms-elements/lib/core/utils/LTIResizingMixin.js";class PolarisFlexTheme extends(v(r(s(c(m(l(i(o(g(t)))))))))){static get styles(){return[super.styles,a`
        :host {
          display: block;
          overflow-x: hidden;
    ...
    `}static get properties(){let e={};return super.properties&&(e=super.properties),{...e,haxTrayAlignment:{type:String,reflect:!0,attribute:"hax-tray-alignment"},searchTerm:{type:String},siteDescription:{type:String},imageLink:{type:String},image:{type:String},imageAlt:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"polaris-flex-theme"}appStoreReady(e){if(globalThis.HaxStore&&globalThis.HaxStore.requestAvailability()){let e=globalThis.HaxStore.requestAvailability();["polaris-cta","polaris-mark","polaris-story-card","polaris-tile","simple-cta","ddd-card","media-quote"].map(a=>{let t=globalThis.document.createElement(a);e.haxAutoloader.appendChild(t)}),this.windowControllersLoaded.abort()}}constructor(){super(),this.haxTrayAlignment=function localStorageGet(e,a=""){try{return null===localStorage.getItem(e)?a:JSON.parse(localStorage.getItem(e))}catch(e){return!1}}("hax-tray-elementAlign"),u.style.setProperty("--rpg-character-toast-display","none"),u.style.setProperty("--rpg-character-toast-mid-background-image","none"),u.style.setProperty("--rpg-character-toast-right-background-image","none"),u.style.setProperty("--rpg-character-toast-left-background-image","none"),u.style.setProperty("--rpg-character-toast-mid-padding",0),u.style.setProperty("--rpg-character-toast-height","96px"),u.style.backgroundColor="light-dark(var(--ddd-accent-6), var(--ddd-primary-4))",this.windowControllersLoaded=new AbortController,globalThis.addEventListener("hax-store-app-store-loaded",this.appStoreReady.bind(this),{once:!0,passive:!0,signal:this.windowControllersLoaded.signal}),this.searchTerm="",this.imageAlt="",this.image="",this.imageLink="",this.__disposer=this.__disposer?this.__disposer:[],this.__disposer.push(p(e=>{const a=h(n.themeData.variables);Promise.resolve().then(()=>{if(n.themeData&&n.themeData.variables){const e=a;this.imageAlt=e.imageAlt,this.image=e.image,this.imageLink=e.imageLink}})})),this.__disposer.push(p(e=>{const a=h(n.siteDescription);Promise.resolve().then(()=>{this.siteDescription=a})})),this.__disposer.push(p(e=>{const a=h(n.activeManifestIndex);Promise.resolve().then(()=>{this.activeManifestIndex=a})})),this.__disposer.push(p(e=>{const a=h(n.activeItem&&n.activeItem.metadata?n.activeItem.metadata.updated:null);Promise.resolve().then(()=>{a&&(this.pageTimestamp=a)})}))}_editModeChanged(e,a){super._editModeChanged&&super._editModeChanged(e,a),!0===e&&this.menuOpen&&this.__HAXCMSMobileMenuToggle()}siteModalClick(e){import("../../haxcms-elements/lib/ui-components/site/site-search.js").then(e=>{"displays/search"!==n.getInternalRoute()&&globalThis.history.replaceState({},null,"x/displays/search");const a=new URLSearchParams(n.currentRouterLocation.search),t=globalThis.SimpleModal.requestAvailability().querySelector("site-search").shadowRoot.querySelector("simple-fields-field");t.focus(),a.get("search")&&(t.value=a.get("search"),setTimeout(()=>{t.select()},0))})}}globalThis.customElements.define(PolarisFlexTheme.tag,PolarisFlexTheme);export{PolarisFlexTheme};