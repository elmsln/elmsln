...
`]}static get properties(){return{...super.properties,badgeDate:{type:String},badgeImage:{type:String},badgeTitle:{type:String},badgeDetails:{type:String},hyperLink:{type:String},badgeSkills:{type:String},skillsOpened:{type:Boolean},detailsOpened:{type:Boolean},badgeColor:{type:String}}}render(){return t`
    ...
    `}static get tag(){return"badge-sticker"}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),this.activeNode=this.shadowRoot.querySelector(".badge"),this.skillsArray=this.badgeSkills.split(",")}skillClick(t){this.skillsOpened=!this.skillsOpened}}globalThis.customElements.define(BadgeSticker.tag,BadgeSticker);export{BadgeSticker};