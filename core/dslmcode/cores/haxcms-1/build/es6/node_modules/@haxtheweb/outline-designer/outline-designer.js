...
import{LitElement as e,css as t,html as i}from"../../lit/index.js";import{I18NMixin as o}from"../i18n-manager/lib/I18NMixin.js";import{unsafeHTML as a}from"../../lit/directives/unsafe-html.js";import{HAXStore as s}from"../hax-body/lib/hax-store.js";import{store as d}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as n,toJS as r}from"../../mobx/dist/mobx.esm.js";import{JSONOutlineSchemaItem as l}from"../json-outline-schema/lib/json-outline-schema-item.js";import{JsonOutlineSchema as c}from"../json-outline-schema/json-outline-schema.js";import"../simple-popover/simple-popover.js";import"../simple-icon/lib/simple-icon-lite.js";import"../hax-iconset/lib/simple-hax-iconset.js";import"../simple-icon/lib/simple-icon-button-lite.js";import"../simple-fields/lib/simple-fields-field.js";import"../simple-fields/lib/simple-context-menu.js";import"../simple-toolbar/lib/simple-toolbar-button.js";import{encapScript as h,haxElementToNode as p,isSafari as m}from"../utils/utils.js";export class OutlineDesigner extends(o(e)){static get styles(){return[t`
      ...
      `]}constructor(){super(),this._blurBlock=!1,this.fidelity="medium",this.haxGizmos=[],this.hideDelete=!1,this.activeItemForActions=null,this.storeTools=!1,this.hideContentOps=!1,this.items=[],this.appReady=!1,this.eventData={},this.activeId=null,this.activePreview=null,this.activePreviewIndex=-1,this.liveRegionText="",this._dropZone=null,this._dragPreviewElement=null,this._isSafari=m(),this.activePage=null,this.selectedPages=[],this.zoomLevel=1,this._dragHandleActive=null,this.t={selectTarget:"Select target",importContentUnderThisPage:"Import content under this page",importThisContent:"Import this content",thisPage:"this page",newPage:"New page",copyOf:"Copy of",pageActions:"Page Actions",editTitle:"Edit title",lock:"Lock",unlock:"Unlock",moveUp:"Move up",moveDown:"Move down",makeChild:"Make child",moveToParentLevel:"Move to parent level",addPage:"Add page",duplicate:"Duplicate",delete:"Delete",restore:"Restore",goToPage:"Go to page"},this.registerLocalization({context:this,basePath:import.meta.url}),n(()=>{this.activeId=r(d.activeId)}),n(()=>{this.appReady=r(d.appReady)}),n(()=>{this.haxGizmos=r(s.gizmoList).filter(e=>!!(e&&e.meta&&e.meta.outlineDesigner))}),this.addEventListener("click",this.resetPopOver.bind(this))}resetPopOver(){this.activePreview&&(this.shadowRoot.querySelector("simple-popover").setAttribute("hidden","hidden"),this.activePreview=null,this.activePreviewIndex=-1)}getSiteItems(){var e=[{text:this.t.selectTarget,value:null}];if(this.appReady&&this.items.length>0){const t=d.getManifestItems(!0);t.forEach(i=>{let o=i,a="- ";for(;o&&null!=o.parent;)o=t.find(e=>e.id==o.parent),o&&(a="--"+a);e.push({text:a+i.title,value:i.id})})}return e}render(){return i` <div class="controls ${this.storeTools?"store-tools":""}">
        ${this.storeTools?i`
    ...
    >
      ${this.haxGizmos.map(e=>i`
          ...
          >
        `)}
    </li>`}prependNodeToContent(e){let t=e.target.closest("[data-item-for-content-id]").getAttribute("data-item-for-content-id");this.items.map((i,o)=>{if(i.id===t&&e.target.value){let t,a=s.haxSchemaFromTag(e.target.value);t=a.gizmo&&a.gizmo.tag&&a.demoSchema&&a.demoSchema[0]?p(a.demoSchema[0]):globalThis.document.createElement(tag),this.items[o].contents=t.outerHTML+i.contents,this.resetPopOver(),this.__syncUIAndDataModel()}})}renderNodeAsItem(e,t,o,a){let d=e.tagName.toLowerCase(),n="hax:bricks",r=d,l="non-heading",c=s.haxSchemaFromTag(d);if(c&&c.gizmo)switch(n=c.gizmo.icon,r=c.gizmo.title,d){case"h1":case"h2":case"h3":case"h4":case"h5":case"h6":r=e.innerText,l="heading"}return i` <li
    ...
    >
      ...
      <div class="content-operations">
        <simple-icon-button-lite
          ...
          ?disabled="${"h1"===d||o.metadata.locked}"
          ?hidden="${"heading"!==l}"
        ></simple-icon-button-lite>
        <simple-icon-button-lite
        ...
        <simple-icon-button-lite
          ...
          ?disabled="${"h6"===d||o.metadata.locked}"
          ?hidden="${"heading"!==l}"
        ></simple-icon-button-lite>
        <simple-icon-button-lite
          class="content-operation"
