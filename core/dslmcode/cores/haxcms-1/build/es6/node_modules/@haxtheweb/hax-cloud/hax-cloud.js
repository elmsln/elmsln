import{html as e}from"../../lit/index.js";import{DDD as i}from"../d-d-d/d-d-d.js";import{FileSystemBrokerSingleton as t}from"../file-system-broker/file-system-broker.js";import"../simple-icon/lib/simple-icons.js";import"../hax-iconset/lib/simple-hax-iconset.js";import"../simple-icon/lib/simple-icon-button-lite.js";import"../haxcms-elements/lib/core/haxcms-site-builder.js";class HaxCloud extends i{createRenderRoot(){return this}static get tag(){return"hax-cloud"}constructor(){if(super(),this.windowControllers=new AbortController,this.fileRoot="",this.fileObjects=[],!window.__haxLogoFontLoaded){let e=document.createElement("link");e.setAttribute("href","https://fonts.googleapis.com/css?family=Press+Start+2P&display=swap"),e.setAttribute("rel","stylesheet"),document.head.appendChild(e),window.__haxLogoFontLoaded=!0}window.addEventListener("manifest-changed",this.loadLocalHax.bind(this),{signal:this.windowControllers.signal})}disconnectedCallback(){this.windowControllers.abort(),super.disconnectedCallback&&super.disconnectedCallback()}render(){return e`
    ...
    `}async downloadHAXLatest(){let e=document.createElement("a");e.href="https://github.com/elmsln/hax-single-site/archive/refs/heads/main.zip",e.download="hax-single-site.zip",e.click()}async findLocalHaxCopy(){const e=t;this.fileObjects=await e.openDir(!0,{mode:"readwrite"}),await this.fileObjects.forEach((async e=>{if("file"===e.kind&&"site.json"===e.name){let i=await e.handle.getFile(),t=JSON.parse(await i.text());this.fileRoot=e.folder,console.log(t),t&&t.items.length>0&&(document.querySelector("haxcms-site-builder").manifest=t)}}))}loadLocalHax(){window.appSettings={login:"dist/dev/login.json",logout:"dist/dev/logout.json",saveNodePath:"dist/dev/saveNode.json",saveManifestPath:"dist/dev/saveManifestPath.json",createNodePath:"dist/dev/saveNode.json",deleteNodePath:"dist/dev/saveNode.json",saveOutlinePath:"dist/dev/saveNode.json",publishSitePath:"dist/dev/saveNode.json",syncSitePath:"dist/dev/saveNode.json",getSiteFieldsPath:"dist/dev/getSiteFieldsPath.json",revertSitePath:"dist/dev/saveNode.json",getFormToken:"adskjadshjudfu823u823u8fu8fij",appStore:{url:new URL("./lib/appstore.json",import.meta.url).href},themes:{"haxcms-dev-theme":{element:"haxcms-dev-theme",path:"@haxtheweb/haxcms-elements/lib/haxcms-dev-theme.js",name:"Developer theme"}}},document.querySelector("haxcms-backend-userfs").fileObjects=this.fileObjects,document.querySelector("haxcms-backend-userfs").fileRoot=this.fileRoot,document.querySelector("haxcms-site-builder").style.display="",setTimeout((()=>{this.remove()}),0)}}customElements.define(HaxCloud.tag,HaxCloud);export{HaxCloud};