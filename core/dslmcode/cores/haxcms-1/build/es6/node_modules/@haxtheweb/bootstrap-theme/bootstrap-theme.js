 ...
 */
import{LitElement as e,html as o,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as r}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSMobileMenuMixin as s}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{BootstrapUserStylesMenuMixin as a}from"./lib/BootstrapUserStylesMenuMixin.js";import{HAXCMSUserStylesMenuMixin as i}from"../haxcms-elements/lib/core/utils/HAXCMSUserStylesMenu.js";import{HAXCMSThemeParts as l}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{DesignSystemManager as h}from"../d-d-d/lib/DesignSystemManager.js";import{BootstrapDesignSystemStyles as c}from"./lib/BootstrapDesignSystemStyles.js";import{adoptBootstrapStylesheet as n}from"./lib/BootstrapStylesheetManager.js";import"../es-global-bridge/es-global-bridge.js";import"../map-menu/map-menu.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import"./lib/BootstrapBreadcrumb.js";import"./lib/BootstrapFooter.js";import"./lib/BootstrapSearch.js";import{store as d}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as m,toJS as p}from"../../mobx/dist/mobx.esm.js";class BootstrapTheme extends(l(a(s(r)))){static get tag(){return"bootstrap-theme"}_registerBootstrapDesignSystem(){h.systems.bootstrap||h.addDesignSystem({name:"bootstrap",styles:c,fonts:[],hax:!0,integrations:{hax:{importer:()=>import("./lib/BootstrapStyleGuideAuthoring.js"),exportName:"registerBootstrapStyleGuideAuthoring",shouldLoad:(e={})=>!!e.editMode&&!1!==e.isAuthenticated}}})}static get styles(){return[super.styles,t`
      ...
      `]}static get properties(){return{...super.properties,searchTerm:{type:String},menuOpen:{type:Boolean,attribute:"menu-open",reflect:!0},colorTheme:{type:Number,attribute:"color-theme",reflect:!0}}}constructor(){super(),this._registerBootstrapDesignSystem(),this.HAXCMSThemeSettings.autoScroll=!0,this.menuOpen=!0,this._bootstrapPath=this._resolveVendorAssetPath("bootstrap","dist/css/bootstrap.min.css"),this._themeElements=[],void 0!==this.colorTheme&&null!==this.colorTheme||(this.colorTheme=0),this.searchTerm="",this.__siteTitle="",this.___pageTitle="",this.__siteImage="",import("../haxcms-elements/lib/ui-components/site/site-print-button.js"),"bootstrap"!==h.active&&(h.active="bootstrap"),this.__disposer=this.__disposer||[],this.__disposer.push(m(e=>{const o=p(d.activeManifestIndex),t=p(d.manifest&&d.manifest.title?d.manifest.title:null),r=p(d.manifest&&d.manifest.metadata&&d.manifest.metadata.author?d.manifest.metadata.author.image:null),s=p(d.activeTitle);Promise.resolve().then(()=>{this.activeManifestIndex=o,this.__siteTitle=t,this.__siteImage=r,this.__pageTitle=s})}))}render(){return o`
      <div class="site ">
    ...
    `}searchChanged(e){e.detail.searchText?import("../haxcms-elements/lib/ui-components/site/site-search.js").then(()=>{this.searchTerm=e.detail.searchText}):this.searchTerm=""}searchItemSelected(e){this.searchTerm=""}_generateBootstrapLink(){this._bootstrapLink&&globalThis.document.head.removeChild(this._bootstrapLink);let e=globalThis.document.createElement("link");return e.setAttribute("rel","stylesheet"),e.setAttribute("href",this._bootstrapPath),globalThis.document.head.appendChild(e),e}disconnectedCallback(){for(var e in this._bootstrapLink&&globalThis.document.head.removeChild(this._bootstrapLink),this.__disposer){const o=this.__disposer[e];"function"==typeof o?o():o&&"function"==typeof o.dispose&&o.dispose()}globalThis.document.body.style.removeProperty("overflow"),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this._loadScripts(),globalThis.document.body.style.overflow="hidden",this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector(".site-body"),globalThis.AbsolutePositionStateManager.requestAvailability().scrollTarget=this.HAXCMSThemeSettings.scrollTarget,this._bootstrapLink=this._generateBootstrapLink(),n(this,this._bootstrapPath)}_loadScripts(){globalThis.ESGlobalBridge.requestAvailability().load("jquery",this._resolveVendorAssetPath("jquery","dist/jquery.min.js")),globalThis.addEventListener("es-bridge-jquery-loaded",this._jqueryLoaded.bind(this))}_bootstrapLoaded(e){this._bootstrap=!0}_loadBootstrap(){globalThis.ESGlobalBridge.requestAvailability().load("bootstrap",this._resolveVendorAssetPath("bootstrap","dist/js/bootstrap.bundle.min.js")),globalThis.addEventListener("es-bridge-bootstrap-loaded",this._bootstrapLoaded.bind(this))}_resolveVendorAssetPath(e,o){const t=decodeURIComponent(import.meta.url);return-1!==t.indexOf("/node_modules/@haxtheweb/")?new URL(`../../${e}/${o}`,t).href:new URL(`../../node_modules/${e}/${o}`,t).href}_jqueryLoaded(e){this._jquery=!0,this._loadBootstrap()}updated(e){super.updated&&super.updated(e),e.forEach((e,o)=>{})}}globalThis.customElements.define(BootstrapTheme.tag,BootstrapTheme);export{BootstrapTheme};