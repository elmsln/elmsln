 ...
 *-----------------------------------------------------------*/
(function () {
  var e = ["require", "exports", "vs/editor/common/core/position", "vs/base/common/platform", "vs/base/common/errors", "vs/editor/common/core/range", "vs/editor/common/core/uint", "vs/base/common/lifecycle", "vs/base/common/winjs.base", "vs/base/common/event", "vs/base/common/cancellation", "vs/base/common/uri", "vs/base/common/iterator", "vs/base/common/diff/diff", "vs/base/common/async", "vs/base/common/linkedList", "vs/base/common/functional", "vs/base/common/strings", "vs/base/common/winjs.polyfill.promise", "vs/editor/common/model/mirrorTextModel", "vs/base/common/diff/diffChange", "vs/base/common/keyCodes", "vs/editor/common/core/selection", "vs/editor/common/core/token", "vs/base/common/arrays", "vs/editor/common/core/characterClassifier", "vs/editor/common/diff/diffComputer", "vs/editor/common/model/wordHelper", "vs/editor/common/modes/linkComputer", "vs/editor/common/modes/supports/inplaceReplaceSupport", "vs/editor/common/standalone/standaloneEnums", "vs/editor/common/standalone/standaloneBase", "vs/editor/common/viewModel/prefixSumComputer", "vs/base/common/worker/simpleWorker", "vs/editor/common/services/editorSimpleWorker"],
      t = function (t) {
  ...
  !function (e) {
    ...
    var t = function () {
      ...
      return Object.defineProperty(t.prototype, "isWindows", {
        ...
        this._detected || (this._detected = !0, this._isWindows = t._isWindows(), this._isNode = "undefined" != typeof module && !!module.exports, this._isElectronRenderer = "undefined" != typeof process && void 0 !== process.versions && void 0 !== process.versions.electron && "renderer" === process.type, this._isWebWorker = "function" == typeof e.global.importScripts);
  ...
  !function (e) {
    var t = function () {
      ...
      return e.prototype.load = function (e, t, r, s) {
        var u = this;
        this._scriptLoader || (this._scriptLoader = this._env.isWebWorker ? new i() : this._env.isNode ? new o(this._env) : new n());
        var a = {
          callback: r,
          errorback: s
        };
      ...
      return t.prototype._init = function (e) {
        ...
        var n = t.getConfig().getOptionsLiteral().nodeCachedDataDir;
          ...
          o.prototype._compile = function (e, s) {
            ...
            var c = new i._vm.Script(u, l),
              ...
              return n.resolve = function (n) {
                ...
                p = [this.exports, h, this, s, d, process, r, Buffer],
                m = f.apply(this.exports, p);

            return i._processCachedData(t, c, a), m;
          };
        }
        ...
        if (/^node\|/.test(r)) {
          ...
          if (e) o(e);else {
            ...
            if (s._env.isElectronRenderer) {
              var h = d.match(/^([a-z])\:(.*)/i);
              d = h ? "file:///" + (h[1].toUpperCase() + ":" + h[2]).replace(/\\/g, "/") : "file://" + d;
            }
              ...
              s._fs.readFile(g, function (e, t) {
                var u = {
                  ...
                  cachedData: t
                    ...
                    a = s._loadAndEvalScript(n, r, d, p, u, c, i, o);

                s._processCachedData(n, a, g);
              });
            } else s._loadAndEvalScript(n, r, d, p, {
              filename: d
            }, c, i, o);
          }
        });
        ...
        var l = new this._vm.Script(i, o),
            ...
            f = t.getGlobalAMDDefineFunc(),
            d = !1,
            h = function () {
          return d = !0, f.apply(null, arguments);
        };

        return h.amd = f.amd, c.call(e.global, t.getGlobalAMDRequireFunc(), h, r, this._path.dirname(n)), s.record(32, n), d ? u() : a(new Error("Didn't receive define call in " + n + "!")), l;
  ...
  !function (e) {
    ...
    var s = function () {
      ...
      return s.prototype.reset = function () {
        ...
        if (this._modules2[l]) this._config.isDuplicateMessageIgnoredFor(e) || console.warn("Duplicate definition of module '" + e + "'");else {
        ...
        for (s.push(n), r[e] = !0; s.length > 0;) {
          ...
          if (u) for (var i = 0, o = u.length; i < o; i++) {
            var a = u[i];
            if (a.id === t) return !0;
        ...
        if (!this._modules2[e] && !this._knownModules2[e]) {
          ...
          var i = -1,
              o = function (n) {
            if (++i >= r.length) t._onLoadError(e, n);else {
              var s = r[i],
                  u = t.getRecorder();
        ...
        if (!e.isComplete()) {
          ...
          if (this._inverseDependencies2[e.id] = null, c) for (var s = 0, u = c.length; s < u; s++) {
            var f = c[s],
                d = this._modules2[f];
            d.unresolvedDependenciesCount--, 0 === d.unresolvedDependenciesCount && this._onModuleComplete(d);
          }
  ...
  !function (e) {
    ...
    }, e.init = t, "function" == typeof e.global.define && e.global.define.amd || (r = new e.ModuleManager(n, e.createScriptLoader(n), o, u, e.Utilities.getHighPerformanceTimestamp()), void 0 !== e.global.require && "function" != typeof e.global.require && u.config(e.global.require), (i = function () {
      return o.apply(null, arguments);
    }).amd = o.amd, "undefined" == typeof doNotInitLoader && t());
  }(o || (o = {})), i(e[24], t([0, 1]), function (e, t) {
    "use strict";
    ...
    function r(e, t, n, i, o) {
      if (!(i <= n)) {
        var s = n + (i - n) / 2 | 0;
        r(e, t, n, s, o), r(e, t, s + 1, i, o), t(e[s], e[s + 1]) <= 0 || function (e, t, n, r, i, o) {
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      var r = [];
      if (n <= t) for (i = n; i < t; i++) r.push(i);else for (var i = n; i > t; i--) r.push(i);
      return r;
    ...
    t.DiffChange = n;
  }), i(e[13], t([0, 1, 20]), function (e, t, n) {
    "use strict";
    ...
    var s = function () {
      ...
      return e.prototype.ElementsAreEqual = function (e, t) {
        ...
        if (!s[0]) {
          var h = this.ComputeDiffRecursive(e, f, r, d, s),
              p = [];
          return p = s[0] ? [new n.DiffChange(f + 1, t - (f + 1) + 1, d + 1, o - (d + 1) + 1)] : this.ComputeDiffRecursive(f + 1, t, d + 1, o, s), this.ConcatenateChanges(h, p);
        }

        return [new n.DiffChange(e, t - e + 1, r, o - r + 1)];
      }, e.prototype.WALKTRACE = function (e, t, r, i, o, u, a, l, c, f, d, h, p, m, g, _, v, y) {
        var b,
            C = null,
            E = null,
            S = new s(),
        ...
        do {
          (b = P + e) === L || b < N && c[b - 1] < c[b + 1] ? (m = (d = c[b + 1]) - P - i, d < A && S.MarkNextChange(), A = d, S.AddModifiedElement(d + 1, m), P = b + 1 - e) : (m = (d = c[b - 1] + 1) - P - i, d < A && S.MarkNextChange(), A = d - 1, S.AddOriginalElement(d, m + 1), P = b - 1 - e), M >= 0 && (e = (c = this.m_forwardHistory[M])[0], L = 1, N = c.length - 1);
        } while (--M >= -1);
        ...
        if (C = S.getReverseChanges(), y[0]) {
          ...
          if (null !== C && C.length > 0) {
            var D = C[C.length - 1];
            I = Math.max(I, D.getOriginalEnd()), w = Math.max(w, D.getModifiedEnd());
          }

          E = [new n.DiffChange(I, h - I + 1, w, g - w + 1)];
        } else {
          S = new s(), L = u, N = a, P = p[0] - _[0] - l, A = Number.MAX_VALUE, M = v ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;

          do {
            (b = P + o) === L || b < N && f[b - 1] >= f[b + 1] ? (m = (d = f[b + 1] - 1) - P - l, d > A && S.MarkNextChange(), A = d + 1, S.AddOriginalElement(d + 1, m + 1), P = b + 1 - o) : (m = (d = f[b - 1]) - P - l, d > A && S.MarkNextChange(), A = d, S.AddModifiedElement(d + 1, m + 1), P = b - 1 - o), M >= 0 && (o = (f = this.m_reverseHistory[M])[0], L = 1, N = f.length - 1);
          } while (--M >= -1);
        ...
        for (l = 1; l <= g / 2 + 1; l++) {
          ...
          for (d = this.ClipDiagonalBound(b - l, l, b, _), h = this.ClipDiagonalBound(b + l, l, b, _), N = d; N <= h; N += 2) {
            for (f = (c = N === d || N < h && v[N - 1] < v[N + 1] ? v[N + 1] : v[N - 1] + 1) - (N - b) - E, P = c; c < t && f < i && this.ElementsAreEqual(c + 1, f + 1);) c++, f++;

            if (v[N] = c, c + f > A + M && (A = c, M = f), !L && Math.abs(N - C) <= l - 1 && c >= y[N]) return s[0] = c, u[0] = f, P <= y[N] && l <= 1448 ? this.WALKTRACE(b, d, h, E, C, p, m, S, v, y, c, t, s, f, i, u, L, a) : null;
          }

          var I = (A - e + (M - r) - l) / 2;
          if (null !== this.ContinueProcessingPredicate && !this.ContinueProcessingPredicate(A, this.OriginalSequence, I)) return a[0] = !0, s[0] = A, u[0] = M, I > 0 && l <= 1448 ? this.WALKTRACE(b, d, h, E, C, p, m, S, v, y, c, t, s, f, i, u, L, a) : (e++, r++, [new n.DiffChange(e, t - e + 1, r, i - r + 1)]);

          for (p = this.ClipDiagonalBound(C - l, l, C, _), m = this.ClipDiagonalBound(C + l, l, C, _), N = p; N <= m; N += 2) {
            for (f = (c = N === p || N < m && y[N - 1] >= y[N + 1] ? y[N + 1] - 1 : y[N - 1]) - (N - C) - S, P = c; c > e && f > r && this.ElementsAreEqual(c, f);) c--, f--;

            if (y[N] = c, L && Math.abs(N - b) <= l && c <= v[N]) return s[0] = c, u[0] = f, P >= v[N] && l <= 1448 ? this.WALKTRACE(b, d, h, E, C, p, m, S, v, y, c, t, s, f, i, u, L, a) : null;
          }

          if (l <= 1447) {
            var w = new Array(h - d + 2);
            w[0] = b - d + 1, o.Copy(v, d, w, 1, h - d + 1), this.m_forwardHistory.push(w), (w = new Array(m - p + 2))[0] = C - p + 1, o.Copy(y, p, w, 1, m - p + 1), this.m_reverseHistory.push(w);
          }
        }

        return this.WALKTRACE(b, d, h, E, C, p, m, S, v, y, c, t, s, f, i, u, L, a);
        ...
        for (var u = e.length - 1; u >= 0; u--) {
          ...
          if (u > 0) {
            var a = e[u - 1];
            a.originalLength > 0 && (n = a.originalStart + a.originalLength), a.modifiedLength > 0 && (r = a.modifiedStart + a.modifiedLength);
          }

          for (var i = t.originalLength > 0, o = t.modifiedLength > 0, l = 0, c = this._boundaryScore(t.originalStart, t.originalLength, t.modifiedStart, t.modifiedLength), f = 1;; f++) {
            var d = t.originalStart - f,
                h = t.modifiedStart - f;
            if (d < n || h < r) break;
            if (i && !this.OriginalElementsAreEqual(d, d + t.originalLength)) break;
            if (o && !this.ModifiedElementsAreEqual(h, h + t.modifiedLength)) break;

            var p = this._boundaryScore(d, t.originalLength, h, t.modifiedLength);
        ...
        if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
          ...
          return o.Copy(e, 0, r, 0, e.length - 1), r[e.length - 1] = n[0], o.Copy(t, 1, r, e.length, t.length - 1), r;
        }
        ...
        if (i.Assert(e.originalStart <= t.originalStart, "Left change is not less than or equal to right change"), i.Assert(e.modifiedStart <= t.modifiedStart, "Left change is not less than or equal to right change"), e.originalStart + e.originalLength >= t.originalStart || e.modifiedStart + e.modifiedLength >= t.modifiedStart) {
  ...
  i(e[12], t([0, 1]), function (e, t) {
    ...
    !function (e) {
      ...
      }, e.forEach = n, e.collect = function (e) {
        var t = [];
    ...
    function n(e, t) {
      var n = !!(2048 & e),
          r = !!(256 & e);
      return new u(2 === t ? r : n, !!(1024 & e), !!(512 & e), 2 === t ? n : r, 255 & e);
    }
    ...
    !function (e) {
      ...
      var r = (65535 & e) >>> 0,
          i = (4294901760 & e) >>> 16;
      return 0 !== i ? new a(n(r, t), n(i, t)) : n(r, t);
    ...
    }, t.dispose = n, t.combinedDisposable = function (e) {
      return {
        dispose: function () {
          return n(e);
        }
  ...
  }), i(e[15], t([0, 1, 12]), function (e, t, n) {
    "use strict";
    ...
    var r = function () {
      ...
      return e.prototype.isEmpty = function () {
        ...
        return function () {
          for (var e = n._first; e instanceof r;) {
            if (e === i) {
              if (e.prev && e.next) {
                var t = e.prev;
        ...
        return {
          next: function () {
            return t ? (e ? e.value = t.element : e = {
              done: !1,
              value: t.element
            }, t = t.next, e) : n.FIN;
          }
    ...
    var u = "undefined" != typeof process && void 0 !== process.versions && void 0 !== process.versions.electron && "renderer" === process.type;

    if ("object" != typeof navigator || u) {
      if ("object" == typeof process) {
        n = "win32" === process.platform, r = "darwin" === process.platform, i = "linux" === process.platform, t.LANGUAGE_DEFAULT, t.LANGUAGE_DEFAULT;
        var a = process.env.VSCODE_NLS_CONFIG;
        if (a) try {
          var l = JSON.parse(a),
              c = l.availableLanguages["*"];
          l.locale, c || t.LANGUAGE_DEFAULT, l._translationsConfigFile;
        } catch (e) {}
        o = !0;
      }
    } else {
      var f = navigator.userAgent;
      n = f.indexOf("Windows") >= 0, r = f.indexOf("Macintosh") >= 0, i = f.indexOf("Linux") >= 0, s = !0, navigator.language;
    }

    t.isWindows = n, t.isMacintosh = r, t.isLinux = i, t.isNative = o, t.isWeb = s;
    var d = "object" == typeof self ? self : "object" == typeof global ? global : {};
    t.globals = d;
    var h = null;
    t.setImmediate = function (e) {
      return null === h && (h = t.globals.setImmediate ? t.globals.setImmediate.bind(t.globals) : "undefined" != typeof process && "function" == typeof process.nextTick ? process.nextTick.bind(process) : t.globals.setTimeout.bind(t.globals)), h(e);
    }, t.OS = r ? 2 : n ? 1 : 3;
    ...
    t.format = function (e) {
      ...
      return 0 === t.length ? e : e.replace(c, function (e, n) {
        var r = parseInt(n, 10);
    ...
    }, t.escapeRegExpCharacters = n, t.trim = function (e, t) {
      return void 0 === t && (t = " "), i(r(e, t), t);
    }, t.ltrim = r, t.rtrim = i, t.convertSimple2RegExpPattern = function (e) {
      ...
      t || (e = n(e)), r.wholeWord && (/\B/.test(e.charAt(0)) || (e = "\\b" + e), /\B/.test(e.charAt(e.length - 1)) || (e += "\\b"));
      var i = "";
      return r.global && (i += "g"), r.matchCase || (i += "i"), r.multiline && (i += "m"), new RegExp(e, i);
    ...
    }, t.isLowerAsciiLetter = o, t.isUpperAsciiLetter = s, t.equalsIgnoreCase = function (e, t) {
    ...
    t.isBasicASCII = function (e) {
      ...
      return !1;
    }, t.isFullWidthCharacter = l, t.UTF8_BOM_CHARACTER = String.fromCharCode(65279), t.startsWithUTF8BOM = function (e) {
    ...
    function o(e, t) {
      var n = t ? function (e) {
        for (var t = void 0, n = 0; n < e.length; n++) {
          var r = e.charCodeAt(n);
          35 === r || 63 === r ? (void 0 === t && (t = e.substr(0, n)), t += _[r]) : void 0 !== t && (t += e[n]);
        }
      ...
      if (o && (i += o, i += ":"), (s || "file" === o) && (i += h, i += h), s) {
        ...
        if (-1 !== c) {
          var f = s.substr(0, c);
          s = s.substr(c + 1), -1 === (c = f.indexOf(":")) ? i += n(f, !1) : (i += n(f.substr(0, c), !1), i += ":", i += n(f.substr(c + 1), !1)), i += "@";
        }

        -1 === (c = (s = s.toLowerCase()).indexOf(":")) ? i += n(s, !1) : (i += n(s.substr(0, c), !1), i += s.substr(c));
      }

      if (u) {
        if (u.length >= 3 && 47 === u.charCodeAt(0) && 58 === u.charCodeAt(2)) {
          (d = u.charCodeAt(1)) >= 65 && d <= 90 && (u = "/" + String.fromCharCode(d + 32) + ":" + u.substr(3));
        } else if (u.length >= 2 && 58 === u.charCodeAt(1)) {
          var d = u.charCodeAt(0);
          d >= 65 && d <= 90 && (u = String.fromCharCode(d + 32) + ":" + u.substr(2));
        }
    ...
    var u,
        ...
        m = function () {
      function e(e, t, n, r, i) {
        "object" == typeof e ? (this.scheme = e.scheme || d, this.authority = e.authority || d, this.path = e.path || d, this.query = e.query || d, this.fragment = e.fragment || d) : (this.scheme = e || d, this.authority = t || d, this.path = function (e, t) {
          switch (e) {
            case "https":
            case "http":
            case "file":
          ...
          return t;
        }(this.scheme, n || d), this.query = r || d, this.fragment = i || d, function (e) {
          if (!e.scheme) {
            if (f) throw new Error('[UriError]: Scheme is missing: {scheme: "", authority: "' + e.authority + '", path: "' + e.path + '", query: "' + e.query + '", fragment: "' + e.fragment + '"}');
      ...
      return e.isUri = function (t) {
        ...
        var t = e.scheme,
            ...
            i = e.query,
            o = e.fragment;
        return void 0 === t ? t = this.scheme : null === t && (t = d), void 0 === n ? n = this.authority : null === n && (n = d), void 0 === r ? r = this.path : null === r && (r = d), void 0 === i ? i = this.query : null === i && (i = d), void 0 === o ? o = this.fragment : null === o && (o = d), t === this.scheme && n === this.authority && r === this.path && i === this.query && o === this.fragment ? this : new g(t, n, r, i, o);
      }, e.parse = function (e) {
        var t = p.exec(e);
        return t ? new g(t[2] || d, decodeURIComponent(t[4] || d), decodeURIComponent(t[5] || d), decodeURIComponent(t[7] || d), decodeURIComponent(t[9] || d)) : new g(d, d, d, d, d);
      }, e.file = function (e) {
        var t = d;
    ...
    var g = function (e) {
      ...
      return s(t, e), Object.defineProperty(t.prototype, "fsPath", {
        ...
        return void 0 === e && (e = !1), e ? o(this, !0) : (this._formatted || (this._formatted = o(this, !1)), this._formatted);
        ...
        _ = (u = {}, u[58] = "%3A", u[47] = "%2F", u[63] = "%3F", u[35] = "%23", u[91] = "%5B", u[93] = "%5D", u[64] = "%40", u[33] = "%21", u[36] = "%24", u[38] = "%26", u[39] = "%27", u[40] = "%28", u[41] = "%29", u[42] = "%2A", u[43] = "%2B", u[44] = "%2C", u[59] = "%3B", u[61] = "%3D", u[32] = "%20", u);
  });
  var u;
  !function () {
    ...
    t("WinJS/Core/_Global", [], function () {
      ...
      function u(e, t) {
        var n;
        n = t && "object" == typeof t && "function" == typeof t.then ? D : x, e._value = t, e._setState(n);
      }
      ...
      function p(e, t, n, r) {
        e._value = t, _(e, t, n, r), e._setState(U);
      }
      ...
      function m(t, n) {
        ...
        if (i) {
          ...
          for (s = 0, u = Array.isArray(i) ? i.length : 1; s < u; s++) {
            ...
            } else Y.prototype.done.call(t, l);
          }
        }
      }
      ...
      function g(t, n) {
        ...
        if (i) {
          ...
          for (s = 0, u = Array.isArray(i) ? i.length : 1; s < u; s++) {
            ...
            if (o._traceAsyncOperationCompleted(a.asyncOpID, d), f) {
              var h = !1;

              try {
                c ? (o._traceAsyncCallbackStarting(a.asyncOpID), h = !0, c.handlesOnError || _(f, r, l, t, c), f._setCompleteValue(c(r))) : f._setChainedErrorValue(r, t);
              } catch (e) {
            ...
            } else B.prototype.done.call(t, null, c);
          }
        }
      }
      ...
      function E(e, t) {
        var n;
        n = t && "object" == typeof t && "function" == typeof t.then ? D : k, e._value = t, e._setState(n);
      }
      ...
      I = {
        ...
        enter: function (e) {
          var t = e._value;
          if (t instanceof K && t._state !== F && t._state !== k) y(t, {
            promise: e
          });else {
            var n = function (r) {
        ...
        enter: function (e) {
          var t = new Error(P);
          t.name = t.message, e._value = t, e._setState(U);
        },
        cancel: s,
        done: s,
        then: s,
        ...
        enter: function (e) {
          if (e.done = Y.prototype.done, e.then = Y.prototype.then, e._listeners) for (var t, n = [e]; n.length;) (t = n.shift())._state._notify(t, n);
        ...
        name: "error_notify",
        enter: function (e) {
          if (e.done = B.prototype.done, e.then = B.prototype.then, e._listeners) for (var t, n = [e]; n.length;) (t = n.shift())._state._notify(t, n);
      ...
      var q,
        ...
        supportedForProcessing: !1
          ...
          K = n.Class.derive(j, function (e) {
        A && (!0 === A || A & M.thenPromise) && (this._stack = H._getStack()), this._creator = e, this._setState(I), this._run();
      }, {
        _creator: null,
        ...
        A && (!0 === A || A & M.errorPromise) && (this._stack = H._getStack()), this._value = e, _(this, e, f);
      }, {
        cancel: function () {},
        done: function (e, t) {
          var n = this._value;
        ...
        then: function (e, t) {
          ...
          try {
            t.handlesOnError || _(null, r, l, this, t), n = new Y(t(r));
          } catch (e) {
            n = e === r ? this : new V(e);
          }
        ...
        A && (!0 === A || A & M.exceptionPromise) && (this._stack = H._getStack()), this._value = e, _(this, e, d);
      }, {}, {
        supportedForProcessing: !1
      }),
          Y = n.Class.define(function (e) {
        if (A && (!0 === A || A & M.completePromise) && (this._stack = H._getStack()), e && "object" == typeof e && "function" == typeof e.then) {
          var t = new K(null);
        ...
        then: function (e) {
          try {
            ...
            return t === this._value ? this : new Y(t);
          } catch (e) {
            return new V(e);
          }
        }
        ...
        supportedForProcessing: !1
          ...
          H = n.Class.derive(j, function (e, t) {
        A && (!0 === A || A & M.promise) && (this._stack = H._getStack()), this._oncancel = t, this._setState(I), this._run();
          ...
          return new H(function (t, n) {
            ...
            r.forEach(function (o) {
              H.as(e[o]).then(function () {
                ...
                s instanceof Error && s.name === P ? ++i === r.length && t(H.cancel) : n({
                  key: o,
                  value: e[o]
                });
              });
        ...
        as: function (e) {
          return e && "object" == typeof e && "function" == typeof e.then ? e : new Y(e);
        },
        cancel: {
          get: function () {
            return q = q || new B(new r(P));
          }
        },
        dispatchEvent: function (e, t) {
      ...
      return Object.defineProperties(H, i.createEventProperties(N)), H._doneHandler = function (e) {
    ...
    }), (u = e["WinJS/Core/_WinJS"]).TPromise = u.Promise, u.PPromise = u.Promise, "undefined" == typeof exports && "function" == typeof i && i.amd ? i("vs/base/common/winjs.base", [], u) : module.exports = u;
  }(), i(e[4], t([0, 1, 8]), function (e, t, n) {
    "use strict";
    ...
    t.ErrorHandler = s, t.errorHandler = new s(), t.onUnexpectedError = r, t.onUnexpectedExternalError = function (e) {
  ...
  }), i(e[9], t([0, 1, 4, 16, 7, 15]), function (e, t, n, r, i, o) {
    "use strict";
    ...
    var l = function () {
      function e(e) {
        void 0 === e && (e = null), this._options = e, this._event = null, this._disposed = !1, this._deliveryQueue = null, this._listeners = null;
      }
      ...
      return Object.defineProperty(e.prototype, "event", {
        get: function () {
          ...
          return this._event || (this._event = function (n, r, i) {
            ...
            s && t._options && t._options.onFirstListenerDidAdd && t._options.onFirstListenerDidAdd(t), t._options && t._options.onListenerDidAdd && t._options.onListenerDidAdd(t, n, r);
            var a;
            return a = {
              dispose: function () {
                if (a.dispose = e._noop, !t._disposed && (u(), t._options && t._options.onLastListenerRemove)) {
        ...
        this._listeners && (this._listeners = null), this._deliveryQueue && (this._deliveryQueue.length = 0), this._disposed = !0;
      }, e._noop = function () {}, e;
    }();
    ...
    var c = function () {
      function e() {
        var e = this;
        this.hasListeners = !1, this.events = [], this.emitter = new l({
    ...
    t.EventMultiplexer = c, t.once = function (e) {
      return function (t, n, r) {
        ...
        return i && o.dispose(), o;
      };
    }, t.anyEvent = function () {
      for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];

      return function (t, n, r) {
        return void 0 === n && (n = null), i.combinedDisposable(e.map(function (e) {
          return e(function (e) {
            return t.call(n, e);
          }, null, r);
        }));
    ...
    t.EventBufferer = f, t.mapEvent = s, t.filterEvent = u;
    ...
    var h = function () {
      function e() {
        var e = this;
        this.listening = !1, this.inputEvent = a.None, this.inputEventListener = i.Disposable.None, this.emitter = new l({
  ...
  }), i(e[14], t([0, 1, 10, 4, 7, 8]), function (e, t, n, r, i, o) {
    "use strict";

    function u(e) {
      var t = new n.CancellationTokenSource(),
          i = e(t.token),
    ...
    function a(e, t) {
      return t ? new Promise(function (n, i) {
        ...
        t.onCancellationRequested(function () {
          clearTimeout(o), i(r.canceled());
        });
      }) : u(function (t) {
        return a(e, t);
      });
    ...
    var l = function () {
      function e(e) {
        this.defaultDelay = e, this.timeout = null, this.completionPromise = null, this.doResolve = null, this.task = null;
      }

      return e.prototype.trigger = function (e, t) {
        var n = this;
        return void 0 === t && (t = this.defaultDelay), this.task = e, this.cancelTimeout(), this.completionPromise || (this.completionPromise = new o.TPromise(function (e, t) {
          n.doResolve = e, n.doReject = t;
        }).then(function () {
          n.completionPromise = null, n.doResolve = null;
          var e = n.task;
          return n.task = null, e();
        })), this.timeout = setTimeout(function () {
          n.timeout = null, n.doResolve(null);
        }, t), this.completionPromise;
      }, e.prototype.cancel = function () {
        this.cancelTimeout(), this.completionPromise && (this.doReject(r.canceled()), this.completionPromise = null);
    ...
    t.Delayer = l, t.timeout = a, t.always = function (e, t) {
      function n() {
        try {
          t();
        } catch (e) {
      ...
      var r = 0,
        ...
        return Promise.resolve(s()).then(function (e) {
          return t(e) ? Promise.resolve(e) : o();
        });
      };
    ...
    var c = function (e) {
      function t(t, n) {
        ...
        return r._token = -1, "function" == typeof t && "number" == typeof n && r.setIfNotSet(t, n), r;
      }
    ...
    t.RunOnceScheduler = d, function () {
      if ("function" != typeof requestIdleCallback || "function" != typeof cancelIdleCallback) {
        ...
        t.runWhenIdle = function (t, n) {
          ...
          return {
            dispose: function () {
              i || (i = !0, clearTimeout(r));
            }
          };
        };
      } else t.runWhenIdle = function (e, t) {
        var n = requestIdleCallback(e, "number" == typeof t ? {
          timeout: t
        } : void 0),
            r = !1;
        return {
    ...
    t.IdleValue = h;
  }), i(e[18], t([0, 1, 8, 3, 14]), function (e, t, n, r, i) {
    "use strict";
    ...
    var o = function () {
      function e(e) {
        !function (e) {
          return i.isThenable(e) && "function" == typeof e.done;
        }(e) ? this._winjsPromise = new n.Promise(function (t, n) {
          var i = !0;
          e(function (e) {
        ...
        }) : this._winjsPromise = e;
      }

      return e.all = function (t) {
        return new e(n.Promise.join(t).then(null, function (e) {
          for (var t in e) if (e.hasOwnProperty(t)) return e[t];
        }));
      }, e.race = function (t) {
        return new e(n.Promise.any(t).then(function (e) {
          return e.value;
        }, function (e) {
          return e.value;
        }));
      }, e.resolve = function (t) {
        return new e(n.Promise.wrap(t));
      }, e.reject = function (t) {
        return new e(n.Promise.wrapError(t));
      }, e.prototype.then = function (t, i) {
        var o = !0,
            s = new e(this._winjsPromise.then(t && function (e) {
          return o ? new n.Promise(function (n, i) {
          ...
          return o ? new n.Promise(function (t, n) {
            r.setImmediate(function () {
              var r;
    ...
    t.PolyfillPromise = o;
  }), i(e[33], t([0, 1, 4, 7, 3, 18]), function (e, t, n, r, i, o) {
    "use strict";
    ...
    var u = self;
    void 0 === u.Promise && (u.Promise = o.PolyfillPromise);
    var a = "$initialize",
        l = !1;

    t.logOnceWebWorkerWarning = function (e) {
      i.isWeb && (l || (l = !0, console.warn("Could not create web worker(s). Falling back to loading web worker code in main thread, which might cause UI freezes. Please see https://github.com/Microsoft/monaco-editor#faq")), console.warn(e.message));
    };
    ...
    var c = function () {
      ...
      function t(t, n) {
        ...
        var o = null;
        void 0 !== self.require && "function" == typeof self.require.getConfig ? o = self.require.getConfig() : void 0 !== self.requirejs && (o = self.requirejs.s.contexts._.config), r._onModuleLoaded = r._protocol.sendMessage(a, [r._worker.getId(), n, o]), r._lazyProxy = new Promise(function (e, t) {
          i = t, r._onModuleLoaded.then(function (t) {
            for (var n = {}, r = 0; r < t.length; r++) n[t[r]] = u(t[r], s);
      ...
      return s(t, e), t.prototype.getProxyObject = function () {
    ...
    var d = function () {
      ...
      return e.prototype.onmessage = function (e) {
        ...
        if (this._protocol.setWorkerId(e), this._requestHandler) {
          ...
          for (var o in this._requestHandler) "function" == typeof this._requestHandler[o] && i.push(o);

          return Promise.resolve(i);
        }

        return n && (void 0 !== n.baseUrl && delete n.baseUrl, void 0 !== n.paths && void 0 !== n.paths.vs && delete n.paths.vs, n.catchError = !0, self.require.config(n)), new Promise(function (e, n) {
          self.require([t], function () {
            ...
            if (r._requestHandler = o.create(), r._requestHandler) {
              ...
              for (var u in r._requestHandler) "function" == typeof r._requestHandler[u] && s.push(u);
    ...
    t.Range = r;
  }), i(e[22], t([0, 1, 2, 5]), function (e, t, n, r) {
    "use strict";
    ...
    t.Uint8Matrix = r, t.toUint8 = function (e) {
    ...
    t.CharacterSet = i;
  }), i(e[26], t([0, 1, 13, 17]), function (e, t, n, r) {
    "use strict";
    ...
    var o = 5e3,
      ...
      return e.prototype.getLength = function () {
        ...
        for (var r = [], i = [], o = [], s = 0, u = t; u <= n; u++) for (var l = this._lines[u], c = e ? this._startColumns[u] : 1, f = e ? this._endColumns[u] : l.length + 1, d = c; d < f; d++) r[s] = l.charCodeAt(d - 1), i[s] = u + 1, o[s] = d, s++;
      ...
      return e.createFromDiffResult = function (t, n, r, o, u, a, c) {
        var f,
            d,
            h,
            p,
        ...
        if (0 === n.originalLength ? (f = r.getStartLineNumber(n.originalStart) - 1, d = 0) : (f = r.getStartLineNumber(n.originalStart), d = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), 0 === n.modifiedLength ? (h = o.getStartLineNumber(n.modifiedStart) - 1, p = 0) : (h = o.getStartLineNumber(n.modifiedStart), p = o.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), a && 0 !== n.originalLength && 0 !== n.modifiedLength && u()) {
          ...
          c && (v = function (e) {
            ...
            for (var t = [e[0]], n = t[0], r = 1, i = e.length; r < i; r++) {
              ...
              Math.min(u, a) < s ? (n.originalLength = o.originalStart + o.originalLength - n.originalStart, n.modifiedLength = o.modifiedStart + o.modifiedLength - n.modifiedStart) : (t.push(o), n = o);
            }

            return t;
          }(v)), m = [];

          for (var y = 0, b = v.length; y < b; y++) m.push(l.createFromDiffChange(v[y], g, _));
        }

        return new e(f, d, h, p, m);
      }, e;
    }(),
        f = function () {
      function e(e, t, n) {
        this.shouldComputeCharChanges = n.shouldComputeCharChanges, this.shouldPostProcessCharChanges = n.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = n.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = n.shouldMakePrettyDiff, this.maximumRunTimeMs = o, this.originalLines = e, this.modifiedLines = t, this.original = new u(e), this.modified = new u(t);
      }
      ...
      return e.prototype.computeDiff = function () {
        ...
        if (this.shouldIgnoreTrimWhitespace) {
          for (var t = [], n = 0, r = e.length; n < r; n++) t.push(c.createFromDiffResult(this.shouldIgnoreTrimWhitespace, e[n], this.original, this.modified, this._continueProcessingPredicate.bind(this), this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));

          return t;
        }

        for (var o = [], s = 0, a = 0, n = -1, l = e.length; n < l; n++) {
          for (var f = n + 1 < l ? e[n + 1] : null, d = f ? f.originalStart : this.originalLines.length, h = f ? f.modifiedStart : this.modifiedLines.length; s < d && a < h;) {
            var p = this.originalLines[s],
                m = this.modifiedLines[a];

            if (p !== m) {
              for (var g = u._getFirstNonBlankColumn(p, 1), _ = u._getFirstNonBlankColumn(m, 1); g > 1 && _ > 1;) {
                if ((E = p.charCodeAt(g - 2)) !== (S = m.charCodeAt(_ - 2))) break;
                g--, _--;
              }

              (g > 1 || _ > 1) && this._pushTrimWhitespaceCharChange(o, s + 1, 1, g, a + 1, 1, _);

              for (var v = u._getLastNonBlankColumn(p, 1), y = u._getLastNonBlankColumn(m, 1), b = p.length + 1, C = m.length + 1; v < b && y < C;) {
              ...
              (v < b || y < C) && this._pushTrimWhitespaceCharChange(o, s + 1, v, b, a + 1, y, C);
            }

            s++, a++;
          }

          f && (o.push(c.createFromDiffResult(this.shouldIgnoreTrimWhitespace, f, this.original, this.modified, this._continueProcessingPredicate.bind(this), this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += f.originalLength, a += f.modifiedLength);
        }
        ...
        if (0 === u) return !1;
        var a = e[u - 1];
        return 0 !== a.originalEndLineNumber && 0 !== a.modifiedEndLineNumber && a.originalEndLineNumber + 1 === t && a.modifiedEndLineNumber + 1 === i && (a.originalEndLineNumber = t, a.modifiedEndLineNumber = i, this.shouldComputeCharChanges && a.charChanges.push(new l(t, n, t, r, i, o, i, s)), !0);
  ...
  }), i(e[28], t([0, 1, 25, 6]), function (e, t, n, r) {
    "use strict";
    ...
    var i = function () {
      ...
      return e._createLink = function (e, t, n, r, i) {
        ...
        for (var r = (null === o && (o = new i([[1, 104, 2], [1, 72, 2], [1, 102, 6], [1, 70, 6], [2, 116, 3], [2, 84, 3], [3, 116, 4], [3, 84, 4], [4, 112, 5], [4, 80, 5], [5, 115, 9], [5, 83, 9], [5, 58, 10], [6, 105, 7], [6, 73, 7], [7, 108, 8], [7, 76, 8], [8, 101, 9], [8, 69, 9], [9, 58, 10], [10, 47, 11], [11, 47, 12]])), o), u = function () {
          if (null === s) {
            for (s = new n.CharacterClassifier(0), e = 0; e < " \t<>'\"、。｡､，．：；？！＠＃＄％＆＊‘“〈《「『【〔（［｛｢｣｝］）〕】』」》〉”’｀～…".length; e++) s.set(" \t<>'\"、。｡､，．：；？！＠＃＄％＆＊‘“〈《「『【〔（［｛｢｣｝］）〕】』」》〉”’｀～…".charCodeAt(e), 1);
          ...
          for (var f = t.getLineContent(l), d = f.length, h = 0, p = 0, m = 0, g = 1, _ = !1, v = !1, y = !1; h < d;) {
            var b = !1,
                C = f.charCodeAt(h);
            ...
            if (13 === g) {
              ...
              1 === E && (a.push(e._createLink(u, f, l, p, h)), b = !0);
            } else if (12 === g) {
              var E;
              1 === (E = u.get(C)) ? b = !0 : g = 13;
            } else 0 === (g = r.nextState(g, C)) && (b = !0);

            b && (g = 1, _ = !1, v = !1, y = !1, p = h + 1, m = C), h++;
          }

          13 === g && a.push(e._createLink(u, f, l, p, d));
        }
    ...
    }(t.SignatureHelpTriggerReason || (t.SignatureHelpTriggerReason = {}));
    !function (e) {
  ...
  }), i(e[31], t([0, 1, 10, 9, 21, 11, 8, 2, 5, 22, 23, 30]), function (e, t, n, r, i, o, s, u, a, l, c, f) {
    "use strict";
    ...
    t.KeyMod = d, t.createMonacoBaseAPI = function () {
      return {
        ...
        SelectionDirection: f.SelectionDirection,
        MarkerSeverity: f.MarkerSeverity,
        MarkerTag: f.MarkerTag,
        Promise: s.TPromise,
        Uri: o.URI,
        Token: c.Token
      };
    };
  }), i(e[32], t([0, 1, 6]), function (e, t, n) {
    "use strict";
    ...
    var i = function () {
      ...
      return e.prototype.getCount = function () {
        ...
        for (var t = 0, n = this.values.length - 1, i = 0, o = 0, s = 0; t <= n;) if (i = t + (n - t) / 2 | 0, o = this.prefixSum[i], s = o - this.values[i], e < s) n = i - 1;else {
          if (!(e >= o)) break;
          t = i + 1;
        }
  ...
  }), i(e[19], t([0, 1, 2, 32]), function (e, t, n, r) {
    "use strict";
    ...
    var i = function () {
      ...
      return e.prototype.dispose = function () {
        ...
        for (var t = e.changes, r = 0, i = t.length; r < i; r++) {
          var o = t[r];
    ...
    t.MirrorTextModel = i;
  }), i(e[34], t([0, 1, 24, 13, 12, 3, 11, 2, 5, 26, 19, 27, 28, 29, 31]), function (e, t, n, r, i, o, u, a, l, c, f, d, h, p, m) {
    "use strict";
    ...
    var g = function (e) {
      ...
      return s(t, e), Object.defineProperty(t.prototype, "uri", {
        get: function () {
          return this._uri;
        },
        enumerable: !0,
        ...
        var n = d.getWordAtText(e.column, d.ensureValidWordDefinition(t), this._lines[e.lineNumber - 1], 0);
      ...
      return t.prototype.computeDiff = function (e, t, n) {
        ...
        for (var s = [], u = void 0, a = 0, c = i = n.mergeSort(i, function (e, t) {
          ...
          if ("number" == typeof p && (u = p), d) {
            var m = o.getValueInRange(d);
            if (h = h.replace(/\r\n|\n|\r/g, o.eol), m !== h) if (Math.max(h.length, m.length) > t._diffLimit) s.push({
              range: d,
              text: h
            });else for (var g = r.stringDiff(m, h, !1), _ = o.offsetAt(l.Range.lift(d).getStartPosition()), v = 0, y = g; v < y.length; v++) {
              var b = y[v],
                  C = o.positionAt(_ + b.originalStart),
                  E = o.positionAt(_ + b.originalStart + b.originalLength),
                  S = {
              ...
              o.getValueInRange(S.range) !== S.text && s.push(S);
            }
          }
        }
        ...
        var s = [],
            u = new RegExp(r, i),
            a = o.getWordUntilPosition(n, u),
            l = Object.create(null);
        l[a.word] = !0;

        for (var c = o.createWordIterator(u), f = c.next(); !f.done && s.length <= t._suggestionsLimit; f = c.next()) {
          var d = f.value;
          l[d] || (l[d] = !0, isNaN(Number(d)) && s.push({
            kind: 18,
            label: d,
            insertText: d,
            range: {
        ...
        for (var o = new RegExp(n, r), s = Object.create(null), u = t.startLineNumber; u < t.endLineNumber; u++) for (var a = 0, l = i.getLineWords(u, o); a < l.length; a++) {
          var c = l[a];

          if (isNaN(Number(c.word))) {
            var f = s[c.word];
            f || (f = [], s[c.word] = f), f.push({
              startLineNumber: u,
        ...
        if (this._foreignModuleFactory) {
          ...
          for (var s in this._foreignModule) "function" == typeof this._foreignModule[s] && o.push(s);
        ...
        return new Promise(function (o, s) {
          e([t], function (e) {
            ...
            for (var s in r._foreignModule) "function" == typeof r._foreignModule[s] && t.push(s);
    ...
    var v = function (e) {
      ...
      return s(t, e), t.prototype.dispose = function () {
        ...
        this._models[e.url] = new g(u.URI.parse(e.url), e.lines, e.EOL, e.versionId);
    ...
    t.EditorSimpleWorkerImpl = v, t.create = function () {
      return new v(null);
