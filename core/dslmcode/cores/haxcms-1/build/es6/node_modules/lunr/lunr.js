...
/*!
   ...
   * Copyright (C) 2019 Oliver Nightingale
   */
lunr.tokenizer=function(e,t){if(null==e||null==e)return[];if(Array.isArray(e))return e.map((function(e){return new lunr.Token(lunr.utils.asString(e).toLowerCase(),lunr.utils.clone(t))}));for(var r=e.toString().trim().toLowerCase(),i=r.length,n=[],s=0,o=0;s<=i;s++){var a=s-o;if(r.charAt(s).match(lunr.tokenizer.separator)||s==i){if(a>0){var u=lunr.utils.clone(t)||{};u.position=[o,a],u.index=n.length,n.push(new lunr.Token(r.slice(o,s),u))}o=s+1}}return n},lunr.tokenizer.separator=/[\s\-]+/,
/*!
   * lunr.Pipeline
   * Copyright (C) 2019 Oliver Nightingale
   */
