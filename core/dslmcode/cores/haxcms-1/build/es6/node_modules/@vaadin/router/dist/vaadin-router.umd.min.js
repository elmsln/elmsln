!function (e, t) {
  "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(e.Vaadin = e.Vaadin || {});
}(this, function (e) {
  "use strict";
  ...
  function S(e) {
    for (var n = new Array(e.length), r = 0; r < e.length; r++) "object" === t(e[r]) && (n[r] = new RegExp("^(?:" + e[r].pattern + ")$"));
      ...
      value: function (e) {
        ...
        function c(e) {
          ...
          return i = a || r.next(l), a = null, e || !i.done && function (e, t) {
            for (var n = t; n;) if ((n = n.parent) === e) return !0;
        ...
        return n.next = c, Promise.resolve().then(function () {
          ...
          if (e ? console.warn(n) : e = new Error(n), e.context = e.context || u, e instanceof DOMException || (e.code = e.code || 500), t.errorHandler) return u.result = t.errorHandler(e), u;
          throw e;
        });
      }
    }, {
  ...
  function G(e) {
    ...
    if (!(e instanceof K)) throw new TypeError("An instance of Resolver is expected");
    var n = new Map();
    return function (r, o) {
      var i = Q(n, r);
      ...
      if (!a) {
        ...
        for (var s = q.parse(u), f = q.tokensToFunction(s), d = Object.create(null), h = 0; h < s.length; h++) g(s[h]) || (d[s[h].name] = !0);
  ...
  function ue(e) {
    if (e && e.length) for (var t = e[0].parentNode, n = 0; n < e.length; n++) t.removeChild(e[n]);
  }
  ...
  var se = function (e) {
    ...
    return function (e, t) {
      ...
      value: function (e) {
        ...
        m(t.children) && (n = n.then(function () {
          ...
          ne(e) || m(t.children) || (e = t.children), function (e, t) {
            ...
            for (var n = a(e), r = 0; r < n.length; r++) d(n[r]), t.__children.push(n[r]);
          }(e, t);
        }));
        var r = {
          redirect: function (t) {
        ...
        return n.then(function () {
          ...
          return ne(e) && (e instanceof HTMLElement || e.redirect || e === w) ? e : g(t.redirect) ? r.redirect(t.redirect) : t.bundle ? (n = t.bundle, g(n) ? p(n) : Promise.race(s.filter(function (e) {
            return e in n;
          }).map(function (e) {
            return p(n[e], e);
      ...
      value: function (e) {
        var n = this,
            r = e.result;
        return r instanceof HTMLElement ? Promise.resolve(e) : r.redirect ? this.__redirect(r.redirect, e.__redirectCount).then(function (e) {
          return n.__amendWithResolutionResult(e);
        }) : r instanceof Error ? Promise.reject(r) : Promise.reject(new Error(u('Invalid route resolution result for path "' + e.pathname + '". Expected redirect object or HTML element, but got: "' + function (e) {
      ...
      value: function () {
        ...
        if (!(e instanceof Node)) throw new TypeError(u("Expected router outlet to be a valid DOM Node (but got " + e + ")"));
      }
    }, {
      ...
      value: function (e) {
        for (var t = (this.__disappearingContent || [])[0], n = (this.__appearingContent || [])[0], r = [], o = e.chain, i = void 0, a = o.length; a > 0; a--) if (o[a - 1].route.animate) {
