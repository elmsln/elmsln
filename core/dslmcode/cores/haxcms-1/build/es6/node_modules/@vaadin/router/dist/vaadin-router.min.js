...
function s(t) {
  if (!t || !h(t.path)) throw new Error(e('Expected route config to be an object with a "path" string property, or an array of such objects'));
  const s = t.bundle,
        u = ["component", "redirect", "bundle"];
  if (!(l(t.action) || Array.isArray(t.children) || l(t.children) || f(s) || u.some(e => h(t[e])))) throw new Error(e(`Expected route config "${t.path}" to include either "${u.join('", "')}" ` + 'or "action" function but none found.'));
  if (s) if (h(s)) i(s);else {
...
function p(t) {
  ...
  e && "a" === e.nodeName.toLowerCase() && (e.target && "_self" !== e.target.toLowerCase() || e.hasAttribute("download") || e.pathname === window.location.pathname && "" !== e.hash || (e.origin || function (t) {
    const e = t.port,
          n = t.protocol;
    return `${n}//${"http:" === n && "80" === e || "https:" === n && "443" === e ? t.hostname : t.host}`;
  }(e)) === window.location.origin && a("go", {
    pathname: e.pathname
  }) && t.preventDefault());
}
...
const m = {
  activate() {
    window.document.addEventListener("click", p);
  },
...
function v(t) {
  "vaadin-router-ignore" !== t.state && a("go", {
    pathname: window.location.pathname
  });
}

/Trident/.test(navigator.userAgent) && !l(window.PopStateEvent) && (window.PopStateEvent = function (t, e) {
  e = e || {};
...
function R(t, e) {
  for (var n, r = [], o = 0, i = 0, s = "", u = e && e.delimiter || O, c = e && e.delimiters || x, a = !1; null !== (n = j.exec(t));) {
    var f = n[0],
        l = n[1],
        h = n.index;
    if (s += t.slice(i, h), i = h + f.length, l) s += l[1], a = !0;else {
      var d = "",
          w = t[i],
          p = n[2],
          m = n[3],
      ...
      if (!a && s.length) {
        var b = s.length - 1;
        c.indexOf(s[b]) > -1 && (d = s[b], s = s.slice(0, b));
      }

      s && (r.push(s), s = "", a = !1);

      var g = "" !== d && void 0 !== w && w !== d,
          E = "+" === y || "*" === y,
          $ = "?" === y || "*" === y,
          _ = d || u,
          R = m || v;
      ...
      if ("string" != typeof u) {
        ...
        if (Array.isArray(a)) {
          ...
          for (var f = 0; f < a.length; f++) {
            if (c = i(a[f], u), !e[s].test(c)) throw new TypeError('Expected all "' + u.name + '" to match "' + u.pattern + '"');
          ...
          if (c = i(String(a), u), !e[s].test(c)) throw new TypeError('Expected "' + u.name + '" to match "' + u.pattern + '", but got "' + c + '"');
          o += u.prefix + c;
        }
      } else o += u;
    }
...
function C(t, e, n) {
  for (var r = (n = n || {}).strict, o = !1 !== n.end, i = A(n.delimiter || O), s = n.delimiters || x, u = [].concat(n.endsWith || []).map(A).concat("$").join("|"), c = "", a = 0 === t.length, f = 0; f < t.length; f++) {
    var l = t[f];
    if ("string" == typeof l) c += A(l), a = f === t.length - 1 && s.indexOf(l[l.length - 1]) > -1;else {
      var h = A(l.prefix),
          d = l.repeat ? "(?:" + l.pattern + ")(?:" + h + "(?:" + l.pattern + "))*" : l.pattern;
      e && e.push(l), l.optional ? l.partial ? c += h + "(" + d + ")?" : c += "(?:" + h + "(" + d + "))?" : c += h + "(" + d + ")";
    }
  }

  return o ? (r || (c += "(?:" + i + ")?"), c += "$" === u ? "$" : "(?=" + u + ")") : (r || (c += "(?:" + i + "(?=" + u + "))?"), a || (c += "(?=" + i + "|" + u + ")")), new RegExp("^" + c, k(n));
}
...
function S(t, e, n) {
  return t instanceof RegExp ? function (t, e) {
    ...
    for (var r = [], o = 0; o < t.length; o++) r.push(S(t[o], e, n).source);
...
b.parse = g, b.compile = E, b.tokensToFunction = $, b.tokensToRegExp = _;
const {
  hasOwnProperty: B
} = Object.prototype,
      M = new Map();
      ...
      if (!i && (i = function (t, e, n, r, o) {
        ...
        for (let t = 1; t < u.length; t++) {
          const e = s.keys[t - 1],
                n = e.name,
                r = u[t];
          void 0 === r && B.call(c, n) || (e.repeat ? c[n] = r ? r.split(e.delimiter).map(U) : [] : c[n] = r ? U(r) : r);
        }
...
function L(t) {
  if (l(t.route.action)) return t.route.action(t);
}
...
class D {
  ...
  addRoutes(e) {
    return u(e), this.root.o.push(...t(e)), this.getRoutes();
  }
  ...
  resolve(t) {
    const e = Object.assign({}, this.context, h(t) ? {
      pathname: t
    } : t),
    ...
    function u(t, c = o.value.route, a) {
      const f = null === a && o.value.route;
      return o = i || n.next(f), i = null, t || !o.done && function (t, e) {
        let n = e;

        for (; n;) if ((n = n.parent) === t) return !0;

        return !1;
      }(c, o.value.route) ? o.done ? Promise.reject(d(e)) : (function (t, e) {
        const {
          route: n,
          path: r
        } = e;
        ...
        if (n && !n.i) {
          ...
          !function (t, e) {
            return !e.parent || !t || !t.length || t[t.length - 1].route !== e.parent;
          }(t.chain, n) ? t.chain.push(e) : t.chain = [e];
        }
      }(e, o.value), s = Object.assign({}, e, o.value), Promise.resolve(r(s)).then(e => null !== e && void 0 !== e && e !== w ? (s.result = e.result || e, s) : u(t, c, e))) : (i = o, Promise.resolve(w));
    }

    return e.next = u, Promise.resolve().then(() => u(!0, this.root)).catch(t => {
      const e = function (t) {
...
function q(t, e = {}) {
  ...
  return (r, o) => {
    ...
    if (!s) {
      ...
      for (let t = 0; t < n.length; t++) h(n[t]) || (o[n[t].name] = !0);
...
function Y({
  ...
  const s = e.map(t => t.route);
  return {
    baseUrl: o && o.baseUrl || "",
    pathname: t,
    routes: s,
    route: i || s.length && s[s.length - 1] || null,
    params: n,
    redirectFrom: r,
    getUrl: (t = {}) => rt(it.pathToRegexp.compile(ot(s))(Object.assign({}, n, t)), o)
  };
}
...
class it extends D {
  constructor(t, e) {
    ...
    super([], Object.assign({
      baseUrl: n && n.getAttribute("href")
    }, e)), this.resolveRoute = t => this.h(t);
    const r = it.NavigationTrigger;
    it.setTriggers.apply(it, Object.keys(r).map(t => r[t])), this.baseUrl, this.ready, this.ready = Promise.resolve(t), this.location, this.location = Y({
      resolver: this
    }), this.p = 0, this.m = this.v.bind(this), this.setOutlet(t), this.subscribe();
  }

  h(n) {
    const r = n.route;
    let i = Promise.resolve();
    l(r.children) && (i = i.then(() => r.children(function (t) {
      const e = Object.assign({}, t);
      return delete e.next, e;
    }(n))).then(n => {
      X(n) || l(r.children) || (n = r.children), function (n, r) {
        if (!Array.isArray(n) && !f(n)) throw new Error(e(`Incorrect "children" value for the route ${r.path}: expected array or object, but got ${n}`));
        r.o = [];
        const o = t(n);
    ...
    const u = {
      redirect: t => Z(n, t),
      component: t => function (t, e) {
        const n = document.createElement(e);
        n.location = Y(t);
        const r = t.chain.map(t => t.route).indexOf(t.route);
        return t.chain[r].element = n, n;
      }(n, t)
    };
    return i.then(() => tt(r.action, [n, u], r)).then(t => X(t) && (t instanceof HTMLElement || t.redirect || t === w) ? t : h(r.redirect) ? u.redirect(r.redirect) : r.bundle ? (a = r.bundle, h(a) ? c(a) : Promise.race(o.filter(t => t in a).map(t => c(a[t], t)))).then(() => {}, () => {
      throw new Error(e(`Bundle not found: ${r.bundle}. Check if the file name is correct`));
    }) : void 0).then(t => X(t) ? t : h(r.component) ? u.component(r.component) : void 0);
    var a;
  }
  ...
  setRoutes(t) {
    this._ = void 0, super.setRoutes(t), this.v();
  }

  render(t, e) {
    const n = ++this.p,
          r = t.pathname || t;
    return this.ready = this.resolve(t).then(t => this.O(t)).then(t => {
      if (n === this.p) {
        const r = this.j;
        if (t === r) return this.location;
        this.location = Y(t), a("location-changed", {
          router: this,
          location: this.location
        }), e && this.R(t.pathname, t.redirectFrom), this.P(t, r);
        const o = this.A(t);
        return this.T(t), this.k(t, r), o.then(() => {
          if (n === this.p) return this.C(), this.j = t, this.location;
        });
      }
    }).catch(t => {
      if (n === this.p) throw e && this.R(r), nt(this.$ && this.$.children), this.location = Y({
        pathname: r,
        resolver: this
      }), a("error", {
        router: this,
  ...
  O(t, e = t) {
    return this.S(e).then(n => {
      const r = n !== e ? n : t;
      return n.next().then(t => {
        if (null === t || t === w) {
          if (rt(ot(n.chain), n.resolver) !== n.pathname) throw d(r);
        }

        return t && t !== w ? this.O(r, t) : this.B(r);
      });
    });
  }
  ...
  S(t) {
    const n = t.result;
    return n instanceof HTMLElement ? Promise.resolve(t) : n.redirect ? this.M(n.redirect, t.U).then(t => this.S(t)) : n instanceof Error ? Promise.reject(n) : Promise.reject(new Error(e(`Invalid route resolution result for path "${t.pathname}". ` + `Expected redirect object or HTML element, but got: "${function (t) {
  ...
  B(t) {
    return this.I(t).then(e => e === this.j || e === t ? e : this.O(e));
  }

  I(t) {
    const e = (this.j || {}).chain || [],
          n = t.chain;
    ...
    if (t.L = 0, e.length) {
      for (let r = 0; r < Math.min(e.length, n.length) && e[r].route === n[r].route && e[r].path === n[r].path && (e[r].element && e[r].element.localName) === (n[r].element && n[r].element.localName); r = ++t.L);

      for (let n = e.length - 1; n >= t.L; n--) {
        const i = Y(t);
        r = r.then(et("onBeforeLeave", [i, {
          prevent: o
        }, this], e[n].element)).then(t => {
          if (!(t || {}).redirect) return t;
        });
      }
    }

    for (let e = t.L; e < n.length; e++) {
      const s = Y(t, n[e].route);
      r = r.then(et("onBeforeEnter", [s, {
        prevent: o,
        redirect: i
      }, this], n[e].element));
    }
    ...
    return r.then(e => {
      if (e) {
        if (e.cancel) return this.j;
        if (e.redirect) return this.M(e.redirect, t.U);
      }
  ...
  R(t, e) {
    if (window.location.pathname !== t) {
      const n = e ? "replaceState" : "pushState";
      window.history[n](null, document.title, t), window.dispatchEvent(new PopStateEvent("popstate", {
  ...
  P(t, e) {
    ...
    this.F = Array.from(n.children), this.N = [];
    let r = n;

    for (let e = t.L; e < t.chain.length; e++) {
      const o = t.chain[e].element;
      o && (r.appendChild(o), r === n && this.N.push(o), r = o);
    }
  }

  C() {
    this.F && nt(this.F), this.F = null, this.N = null;
  }

  D() {
    this.F && this.N && (nt(this.N), this.F = null, this.N = null);
  }

  k(t, e) {
    if (e) for (let n = e.chain.length - 1; n >= t.L; n--) {
  ...
  A(t) {
    ...
    if (e && n && i) {
      const t = f(i) && i.leave || "leaving",
            o = f(i) && i.enter || "entering";
  ...
  v(t) {
    const e = t ? t.detail.pathname : window.location.pathname;
    h(this.s(e)) && (t && t.preventDefault && t.preventDefault(), this.render(e, !0));
  }
  ...
  urlForName(t, e) {
    return this._ || (this._ = q(this)), rt(this._(t, e), this);
  }
...
void 0 === window.Vaadin.developmentMode && (window.Vaadin.developmentMode = function () {
  try {
    return localStorage.getItem("vaadin.developmentmode.force") || ["localhost", "127.0.0.1"].indexOf(window.location.hostname) >= 0 && !ut(function () {
      return !0;
    }) && !function () {
      if (window.Vaadin && window.Vaadin.Flow && window.Vaadin.Flow.clients) {
        const t = Object.keys(window.Vaadin.Flow.clients).map(t => window.Vaadin.Flow.clients[t]).filter(t => t.productionMode);
...
window.Vaadin = window.Vaadin || {}, window.Vaadin.registrations = window.Vaadin.registrations || [], window.Vaadin.registrations.push({
  is: "@vaadin/router",
  version: "1.2.0"
}), ct(at), it.NavigationTrigger = {
  POPSTATE: y,
  CLICK: m
};
export { it as Router, D as Resolver };