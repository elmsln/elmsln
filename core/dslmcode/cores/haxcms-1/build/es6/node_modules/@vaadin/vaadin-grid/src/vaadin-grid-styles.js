...
*/
import"../../../@polymer/polymer/lib/elements/dom-module.js";import{html as e}from"../../../@polymer/polymer/lib/utils/html-tag.js";const t=document.createElement("dom-module");t.appendChild(e`
  <style>
...
`);const o=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),i=navigator.userAgent.toLowerCase().indexOf("firefox")>-1;if(o||i){const e=document.createElement("style");e.textContent="\n    [scrolling][safari] #outerscroller,\n    [scrolling][firefox] #outerscroller {\n      pointer-events: auto;\n    }\n\n    [ios] #outerscroller {\n      pointer-events: auto;\n      z-index: -3;\n    }\n\n    [ios][scrolling] #outerscroller {\n      z-index: 0;\n    }\n\n    [ios] [frozen] {\n      will-change: auto;\n    }\n  ",t.querySelector("template").content.appendChild(e)}t.register("vaadin-grid-styles");