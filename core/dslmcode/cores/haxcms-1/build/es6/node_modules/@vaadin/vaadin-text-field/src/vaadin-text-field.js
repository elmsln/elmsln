...
`}static get is(){return"vaadin-text-field"}static get version(){return"2.9.2"}static get properties(){return{list:{type:String},pattern:{type:String},title:{type:String}}}}customElements.define(TextFieldElement.is,TextFieldElement);export{TextFieldElement};