...
*/
import"../../../iron-flex-layout/iron-flex-layout.js";import"../../../polymer/polymer-legacy.js";import"../../../paper-styles/color.js";import"../../../paper-input/paper-input.js";import"../../../paper-toggle-button/paper-toggle-button.js";import"../../app-route.js";import"./youtube-lite.js";import"./route-info.js";import{Polymer as e}from"../../../polymer/lib/legacy/polymer-fn.js";import{html as t}from"../../../polymer/lib/utils/html-tag.js";e({_template:t`
    <style>
      :host {
        display: block;
        position: relative;
  ...
  `,is:"video-viewer",properties:{route:{type:Object,notify:!0},data:{type:Object},playing:{type:Boolean},queryParams:{type:Object}},observers:["_playingChanged(playing)","_stateChanged(queryParams.state)"],pause:function(){this.set("queryParams.state","paused")},_playingChanged:function(e){this.set("queryParams.state",e?"playing":"paused")},_stateChanged:function(e){this.playing="playing"===e}});