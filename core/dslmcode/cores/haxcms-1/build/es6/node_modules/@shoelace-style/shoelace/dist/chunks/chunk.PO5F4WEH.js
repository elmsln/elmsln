import{progress_ring_styles_default as r}from"./chunk.NG5GLA5L.js";import{LocalizeController as e}from"./chunk.2A3352EO.js";import{ShoelaceElement as s}from"./chunk.7UUIUZXI.js";import{__decorateClass as t}from"./chunk.5F6CPPXO.js";import{html as a}from"../../../../lit/index.js";import{property as i,query as l,state as o}from"../../../../lit/decorators.js";var c=class extends s{constructor(){super(...arguments),this.localize=new e(this),this.value=0,this.label=""}updated(r){if(super.updated(r),r.has("value")){const r=parseFloat(getComputedStyle(this.indicator).getPropertyValue("r")),e=2*Math.PI*r,s=e-this.value/100*e;this.indicatorOffset=`${s}px`}}render(){return a`
      <div
        part="base"
        class="progress-ring"
        role="progressbar"
