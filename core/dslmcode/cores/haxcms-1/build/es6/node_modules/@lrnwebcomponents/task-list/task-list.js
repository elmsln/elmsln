import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import{SchemaBehaviors}from"../schema-behaviors/schema-behaviors.js";import"../../@polymer/polymer/lib/elements/dom-repeat.js";class TaskList extends(SchemaBehaviors(PolymerElement)){constructor(){super(),afterNextRender(this,function(){this.HAXWiring=new HAXWiring,this.HAXWiring.setup(TaskList.haxProperties,TaskList.tag,this)})}static get template(){return html`
      <style>
        :host {
          display: block;
        }
