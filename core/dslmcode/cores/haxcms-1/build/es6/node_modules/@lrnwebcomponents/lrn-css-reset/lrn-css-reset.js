 ...
 */
import{LitElement as e,html as s,css as a}from"../../lit-element/lit-element.js";const t=[a`
  ...
  `],AttachStylesToHead=(e=t,s="LrnCssResetStyles")=>{if(!window.LrnCssResetStyles){window[s]=document.createElement("div");let e=document.createElement("style"),a=t.map((e=>e.cssText)).join("");e.setAttribute("id",s),e.setAttribute("type","text/css"),e.styleSheet?e.styleSheet.cssText=a:e.appendChild(document.createTextNode(a)),document.getElementsByTagName("head")[0].appendChild(e)}};class LrnCssReset extends e{static get tag(){return"lrn-css-reset"}static get styles(){return t}static get properties(){return{applyToHead:{type:Boolean,attribute:"apply-to-head"}}}constructor(){super()}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.applyToHead&&AttachStylesToHead(t,"LrnCssResetStyles")}render(){return s`<slot></slot>`}}customElements.define(LrnCssReset.tag,LrnCssReset);export{t as LrnCssResetStyles,AttachStylesToHead,LrnCssReset};