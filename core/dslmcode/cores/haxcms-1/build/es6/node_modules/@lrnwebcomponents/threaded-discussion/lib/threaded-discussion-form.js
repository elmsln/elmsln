import{LitElement as t,html as e,css as o}from"../../../lit-element/lit-element.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";class ThreadedDiscussionForm extends t{static get styles(){return[o`
        :host {
          display: block;
          width: 100%;
    ...
    `}static get tag(){return"threaded-discussion-form"}static get properties(){return{button:{type:String},buttonLabel:{type:String,attribute:"button-label",reflect:!0},demo:{type:Boolean},disabled:{type:Boolean,attribute:"disabled",reflect:!0},field:{type:String},hidden:{type:Boolean,attribute:"hidden",reflect:!0},icon:{type:String,attribute:"icon",reflect:!0},submit:{type:String},textareaLabel:{type:String,attribute:"textarea-label",reflect:!0},thread:{type:String}}}constructor(){super(),this.disabled=!1,this.hidden=!1}_handleSubmit(t){if(t.preventDefault(),this.demo)return this.dispatchEvent(new CustomEvent("comment-demo",{bubbles:!0,cancelable:!0,composed:!0,detail:{textarea:this.shadowRoot.querySelector("textarea"),thread:this.thread}})),!1;this.dispatchEvent(new CustomEvent("comment-submitted",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}window.customElements.define(ThreadedDiscussionForm.tag,ThreadedDiscussionForm);export{ThreadedDiscussionForm};