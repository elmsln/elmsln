              ...
              <simple-popover for="summary" position="top" auto>
                ...
                <div part="links">
                  ${this.links&&this.links.length>0&&this.links.map?e`
                        <ul>
                          ${this.links.map((t=>e`
                              <li><a href="${t.href}" target="_blank" rel="noopener noreferrer">${t.title}</a></li>
                            `))}
                        </ul>
                      `:""}
                </div>
