 ...
 */
import{LitElement as s,html as i,css as t}from"../../lit-element/lit-element.js";import{router as o}from"../../lit-element-router/lit-element-router.js";import{ElmslnStudioUtilities as e}from"./lib/elmsln-studio-utilities.js";import{ElmslnStudioStyles as r}from"./lib/elmsln-studio-styles.js";import"../../@polymer/iron-ajax/iron-ajax.js";import"./lib/elmsln-studio-main.js";import"./lib/elmsln-studio-link.js";import"./lib/elmsln-studio-button.js";import"./lib/elmsln-studio-dashboard.js";import"./lib/elmsln-studio-submissions.js";import"./lib/elmsln-studio-portfolio.js";class ElmslnStudio extends(o(e(r(s)))){static get tag(){return"elmsln-studio"}render(){return i`
      <iron-ajax
        auto
    ...
    `}static get properties(){return{activity:{type:Array},activitySource:{type:String,reflect:!0,attribute:"activity-source"},discussion:{type:Array},discussionSource:{type:String,reflect:!0,attribute:"discussion-source"},portfolios:{type:Object},portfoliosSource:{type:String,reflect:!0,attribute:"portfolios-source"},profile:{type:Object},profileSource:{type:String,reflect:!0,attribute:"profile-source"},sourcePath:{type:String,reflect:!0,attribute:"source-path"},submissions:{type:Array},submissionsSource:{type:String,reflect:!0,attribute:"submissions-source"},route:{type:String},params:{type:Object},query:{type:Object},data:{type:Object}}}static get routes(){return[{name:"submissions",pattern:"submissions"},{name:"portfolios",pattern:"portfolios/:portfolio"},{name:"dashboard",pattern:"*",data:{title:"Home"}}]}constructor(){super(),this.activity=[],this.discussion=[],this.portfolios={},this.profile={},this.submissions=[],this.route="",this.params={},this.query={},this.data={}}router(s,i,t,o){this.route=s,this.params=i,this.query=t,this.data=o}updated(s){super.updated&&super.updated(s),s.forEach((s,i)=>{"params"===i&&console.log("params",this.params),"query"===i&&console.log("query",this.query)})}_filterBy(s,i,t=""){return s&&i&&s[`${t}${i}`]?s[`${t}${i}`]:{}}_loadDiscussion(s){this.query.discussion=s.detail||!0}_profileLoaded(s){console.log("_profileLoaded",s.detail.__data.response),this.profile=s.detail.__data.response}_activityLoaded(s){console.log("_activityLoaded",s.detail.__data.response),this.activity=s.detail.__data.response}_submissionsLoaded(s){console.log("_submissionsLoaded",s.detail.__data.response),this.submissions=s.detail.__data.response}_discussionLoaded(s){console.log("_discussionLoaded",s.detail.__data.response),this.discussion=s.detail.__data.response}_portfoliosLoaded(s){console.log("_portfoliosLoaded",s.detail.__data.response),this.portfolios=s.detail.__data.response}}customElements.define(ElmslnStudio.tag,ElmslnStudio);export{ElmslnStudio};