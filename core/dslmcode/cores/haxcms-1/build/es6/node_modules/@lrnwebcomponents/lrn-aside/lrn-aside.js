import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";class LrnAside extends PolymerElement{constructor(){super(),import("../lrndesign-panelcard/lrndesign-panelcard.js"),afterNextRender(this,function(){this.HAXWiring=new HAXWiring,this.HAXWiring.setup(LrnAside.haxProperties,LrnAside.tag,this)})}static get template(){return html`
      <style>
        :host {
          display: flex;
          padding: 8px;
