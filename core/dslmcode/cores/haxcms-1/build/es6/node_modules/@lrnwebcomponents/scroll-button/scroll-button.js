 ...
 */
import{LitElement as o,html as t,css as e}from"../../lit-element/lit-element.js";import"../../@polymer/polymer/lib/elements/custom-style.js";class ScrollButton extends o{static get styles(){return[e`
        :host {
          display: block;
      ...
      <simple-tooltip for="btn" position="${this.position}" offset="14">
        ${this.label}
      </simple-tooltip>`}static get haxProperties(){return{canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Scroll button",description:"button to scroll to an area or back to top",icon:"icons:android",color:"green",groups:["Button"],handles:[{type:"todo:read-the-docs-for-usage"}],meta:{author:"btopro",owner:"The Pennsylvania State University"}},settings:{quick:[],configure:[{property:"target",description:"",inputMethod:"array",required:!1,icon:"icons:android"},{property:"icon",description:"",inputMethod:"textfield",required:!1,icon:"icons:android"},{property:"label",description:"",inputMethod:"textfield",required:!1,icon:"icons:android"}],advanced:[]}}}static get properties(){return{...super.properties,target:{type:Object},icon:{type:String},label:{type:String},position:{type:String}}}constructor(){super(),this.icon="icons:expand-less",this.label="Scroll to top",this.position="top",import("../../@polymer/paper-icon-button/paper-icon-button.js"),import("../simple-tooltip/simple-tooltip.js"),import("../../@polymer/iron-icons/iron-icons.js")}static get tag(){return"scroll-button"}scrollEvent(o){this.target?this.target.scrollIntoView({behavior:"smooth",block:"end",inline:"nearest"}):window.scrollTo({top:0,left:0,behavior:"smooth"})}}window.customElements.define(ScrollButton.tag,ScrollButton);export{ScrollButton};