import{LitElement as e,html as t,css as i}from"../../lit-element/lit-element.js";import{SchemaBehaviors as o}from"../schema-behaviors/schema-behaviors.js";class ImageCompareSlider extends(o(e)){static get styles(){return[i`
        :host {
          display: inline-flex;
          width: 100%;
        }
      ...
      `]}constructor(){super(),this.opacity=!1,import("../user-action/user-action.js"),import("../../@polymer/iron-image/iron-image.js"),import("../../@polymer/paper-slider/paper-slider.js")}render(){return t`
      <div>
        <h2>${this.title}</h2>
