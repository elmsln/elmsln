import{LitElement as t,html as e,css as o}from"../../../lit-element/lit-element.js";import{SimpleToolbarButtonBehaviors as s}from"../../simple-toolbar/lib/simple-toolbar-button.js";import{HaxButton as l}from"./hax-ui-styles.js";const HaxToolbarItemBehaviors=function(t){return class extends(s(t)){static get tag(){return"hax-toolbar-item"}constructor(){super(),this.danger=!1,this.feature=!1,this.menu=!1}static get properties(){return{...super.properties,danger:{type:Boolean,reflect:!0},eventName:{type:String,reflect:!0,attribute:"event-name"},feature:{type:Boolean,reflect:!0},toggledTooltip:{type:String},tooltip:{type:String}}}get buttonTemplate(){return this.toggles?e` <button
            ...
            ${this.tooltipTemplate}`}static get simpleButtonThemeStyles(){return l}static get simpleButtonCoreStyles(){return super.simpleButtonCoreStyles}static get simpleButtonLayoutStyles(){return super.simpleButtonLayoutStyles}static get styles(){return[...super.styles,o`
          :host(:hover),
          :host(:focus-within) {
