 ...
 */
import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{A11yMediaBehaviors}from"./a11y-media-behaviors.js";import"../../simple-search/simple-search.js";import"./a11y-media-button.js";class A11yMediaTranscriptControls extends A11yMediaBehaviors{static get properties(){return{target:{type:Object,value:null}}}static get tag(){return"a11y-media-transcript-controls"}constructor(){super()}static get template(){return html`
    ...
    `}connectedCallback(){super.connectedCallback();this.search=this.shadowRoot.querySelector("#simplesearch"),this.dispatchEvent(new CustomEvent("searchbar-added",{detail:this.search}))}_handleScrollClick(e){this.dispatchEvent(new CustomEvent("toggle-scroll",{detail:this}))}}window.customElements.define(A11yMediaTranscriptControls.tag,A11yMediaTranscriptControls);export{A11yMediaTranscriptControls};