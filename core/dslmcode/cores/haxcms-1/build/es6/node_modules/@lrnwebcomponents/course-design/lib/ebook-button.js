import{LitElement as t,html as e,css as i}from"../../../lit-element/lit-element.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/lib/simple-icon-lite.js";class EbookButton extends t{static get properties(){return{link:{type:String},title:{type:String},icon:{type:String}}}static get haxProperties(){return{canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Ebook button",description:"A button that links to an Ebook.",icon:"icons:book",color:"blue",groups:["education","link"],handles:[{type:"",source:"",title:"",description:""}],meta:{author:"LRNWebComponents"}},settings:{configure:[{property:"title",title:"Title",description:"The title of the button.",inputMethod:"textfield",icon:"editor:title"},{property:"link",title:"Link",description:"The link to redirect to on click.",inputMethod:"textfield",icon:"editor:insert-link"},{property:"icon",title:"Icon",description:"Icon to represent this link",inputMethod:"textfield",icon:"editor:insert-link"}],advanced:[]},demoSchema:[{tag:"ebook-button",properties:{title:"Access Ebook",icon:"icons:book"},content:""}]}}constructor(){super(),this.link="",this.title="",this.icon="icons:book"}static get styles(){return[i`
        :host {
