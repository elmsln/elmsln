...
import{LitElement as t,html as a,css as e}from"../../../lit-element/lit-element.js";import"../../accent-card/accent-card.js";class ElmslnStudioSubmissionCard extends t{static get tag(){return"elmsln-studio-submission-card"}static get styles(){return[e`
    ...
    `}static get properties(){return{imageSrc:{type:String,attribute:"image-src"},imageAlt:{type:String,attribute:"image-alt"},imageAlign:{type:String,attribute:"image-align"},imageValign:{type:String,attribute:"image-valign"},horizontal:{type:Boolean,attribute:"horizontal"}}}constructor(){super(),this.horizontal=!1}}customElements.define("elmsln-studio-submission-card",ElmslnStudioSubmissionCard);export{ElmslnStudioSubmissionCard};