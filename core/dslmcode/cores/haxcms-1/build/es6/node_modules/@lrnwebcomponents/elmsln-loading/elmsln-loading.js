 ...
 */
import{html,css}from"../../lit-element/lit-element.js";import{SimpleColors}from"../simple-colors/simple-colors.js";class ElmslnLoading extends SimpleColors{static get styles(){return[...super.styles,css`
        @-moz-keyframes spin {
          100% {
      ...
      `]}static get tag(){return"elmsln-loading"}constructor(){super(),this.size="medium",import("../lrn-icons/lrn-icons.js"),import("../../@polymer/iron-icon/iron-icon.js")}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>{"color"==propName&&this._getAccentColor(this[propName])})}static get properties(){return{...super.properties,color:{type:String},size:{type:String,reflect:!0}}}render(){return html`
      <iron-icon icon="lrn:network"></iron-icon>
    `}_getAccentColor(color){color=color.replace("-text",""),this.accentColor&&"grey"!==this.accentColor||!this.colors[color]||(this.accentColor=color)}}window.customElements.define(ElmslnLoading.tag,ElmslnLoading);export{ElmslnLoading};