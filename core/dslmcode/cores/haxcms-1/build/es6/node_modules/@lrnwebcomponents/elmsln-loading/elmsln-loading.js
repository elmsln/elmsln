...
import{html as i,css as e}from"../../lit-element/lit-element.js";import{SimpleColors as t}from"../simple-colors/simple-colors.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import"../hax-iconset/lib/simple-hax-iconset.js";class ElmslnLoading extends t{static get styles(){return[...super.styles,e`
      ...
      `]}static get tag(){return"elmsln-loading"}constructor(){super(),this.size="medium"}updated(i){i.forEach((i,e)=>{"color"==e&&this._getAccentColor(this[e])})}static get properties(){return{...super.properties,color:{type:String},size:{type:String,reflect:!0}}}render(){return i` <simple-icon icon="lrn:network"></simple-icon> `}_getAccentColor(i){i=i.replace("-text",""),this.accentColor&&"grey"!==this.accentColor||!this.colors[i]||(this.accentColor=i)}}window.customElements.define(ElmslnLoading.tag,ElmslnLoading);export{ElmslnLoading};