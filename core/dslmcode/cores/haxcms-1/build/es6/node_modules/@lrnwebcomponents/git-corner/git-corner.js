 ...
 */
import{LitElement as r,html as t,css as e}from"../../lit/index.js";class GitCorner extends r{static get styles(){return[e`
:host {
  display: block;
}
...
</a>`}static get properties(){return{...super.properties,source:{type:String},alt:{type:String},corner:{type:Boolean,reflect:!0},size:{type:String,reflect:!0}}}static get tag(){return"git-corner"}constructor(){super(),this.alt=""}}customElements.define(GitCorner.tag,GitCorner);export{GitCorner};