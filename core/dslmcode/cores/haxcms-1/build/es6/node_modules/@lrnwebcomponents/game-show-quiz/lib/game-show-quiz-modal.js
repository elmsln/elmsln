import{LitElement as o,html as t,css as e}from"../../../lit/index.js";class GameShowQuizModal extends o{static get styles(){return[e`
      ...
      `]}static get tag(){return"game-show-quiz-modal"}static get properties(){return{title:{type:String}}}constructor(){super(),import("../../../@polymer/paper-dialog/paper-dialog.js")}render(){return t`
      <paper-dialog modal>
        <h2>${this.title}</h2>
        <div class="content"><slot name="content"></slot></div>
        <div class="buttons"><slot name="buttons"></slot></div>
      </paper-dialog>
    `}toggle(){this.shadowRoot.querySelector("paper-dialog").toggle(),setTimeout((()=>{var o=document.createEvent("UIEvents");o.initUIEvent("resize",!0,!1,window,0),window.dispatchEvent(o)}),100)}}window.customElements.define(GameShowQuizModal.tag,GameShowQuizModal);export{GameShowQuizModal};