...
import{LitElement as e,html as t,css as i}from"../../lit/index.js";import{editBehaviors as d,editableTableStyles as s,tableHtmlProperties as o,displayProperties as r,dataProperties as a}from"./lib/editable-table-behaviors.js";import"./lib/editable-table-display.js";import"./lib/editable-table-edit.js";class EditableTable extends(d(e)){static get styles(){return[i`
    ...
    `}static get tag(){return"editable-table"}constructor(){super(),this.editMode=!1}static get properties(){return{...super.properties,editMode:{type:Boolean,attribute:"edit-mode",reflect:!0}}}get display(){return this.shadowRoot&&this.shadowRoot.querySelector("editable-table-display")}get editor(){return this.shadowRoot&&this.shadowRoot.querySelector("editable-table-edit")}_handleSync(e){this.sync(e.detail)}sync(e){this.editor&&e&&(this[e]=this.editor[e])}toggleEditMode(e){this.editMode=void 0!==e?e:!this.editMode,this.dispatchEvent(new CustomEvent("toggle-edit-mode",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}window.customElements.define(EditableTable.tag,EditableTable);export{EditableTable};