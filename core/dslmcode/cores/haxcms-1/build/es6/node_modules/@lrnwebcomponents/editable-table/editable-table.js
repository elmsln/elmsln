...
import{html as e,PolymerElement as t}from"../../@polymer/polymer/polymer-element.js";import"../simple-tooltip/simple-tooltip.js";import"../../@polymer/paper-input/paper-input.js";import"../../@polymer/iron-ajax/iron-ajax.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import"../hax-iconset/lib/simple-hax-iconset.js";import{displayBehaviors as i}from"./lib/editable-table-behaviors.js";import"./lib/editable-table-editor-rowcol.js";import"./lib/editable-table-editor-toggle.js";import"./lib/editable-table-editor-cell.js";import"./lib/editable-table-styles.js";import"./lib/editable-table-display.js";class EditableTable extends(i(t)){static get template(){return e`
    ...
    `}static get tag(){return"editable-table"}haxHooks(){return{activeElementChanged:"haxactiveElementChanged"}}haxactiveElementChanged(e,t){if(!t){let t=this.getTableHTMLNode();e&&e.replaceWith(t),e=t}return this.toggleEditMode(t),e}constructor(){super(),this.haxUIElement=!0,this.editMode=!1,this.hideBordered=!1,this.hideCondensed=!1,this.hideDisplay=!1,this.hideFilter=!1,this.hideSortFilter=!1,this.hideSort=!1,this.hideResponsive=!1,this.hideStriped=!1}static get properties(){return{editMode:{type:Boolean},hideBordered:{type:Boolean},hideCondensed:{type:Boolean},hideDisplay:{type:Boolean,computed:"_tableDisplayHidden(hideBordered,hideCondensed,hideStriped,hideResponsive)"},hideFilter:{type:Boolean},hideSortFilter:{type:Boolean,computed:"_tableSortHidden(hideSort,hideFilter)"},hideSort:{type:Boolean},hideResponsive:{type:Boolean},hideStriped:{type:Boolean}}}deleteColumn(e){for(let t=0;t<this.data.length;t++)this.splice("data."+t,e,1);let t=this.data.slice();this.set("data",t)}deleteRow(e){this.splice("data",e,1);let t=this.data.slice();this.set("data",t)}insertColumn(e){let t=this.data.slice();for(let i=0;i<t.length;i++)t[i].splice(e,0,"");this.set("data",t)}insertRow(e){let t=this.data.slice(),i=new Array;for(let e=0;e<t[0].length;e++)i.push("");t.splice(e+1,0,i),this.set("data",t)}toggleEditMode(e){e=void 0!==e?e:!this.editMode,this.dispatchEvent(new CustomEvent("toggle-edit-mode",{bubbles:!0,cancelable:!0,composed:!0,detail:this})),e&&this.shadowRoot&&(this.shadowRoot.querySelector("editable-table-display").toggleFilter(),this.shadowRoot.querySelector("editable-table-display").sortData("none",-1),this.shadowRoot.querySelector("#inner").focus()),this.editMode=e}_captionChanged(){this.caption=this.shadowRoot.querySelector("#caption").value}connectedCallback(){super.connectedCallback(),setTimeout(()=>{if(!this.data||this.data.length<1||this.data[0].length<1){let e=this.children.item(0);e&&"EDITABLE-TABLE-DISPLAY"===e.tagName&&(e=e.children.item(0)),null!=e&&"TABLE"===e.tagName&&e.children&&e.children.length>0?this.importHTML(e):this.set("data",[["","",""],["","",""],["","",""]])}this.__ready=!0},0)}_dataChanged(e,t){if(this.__ready&&(!e||e.length<1||e[0].length<1)){let e=this.children.item(0);e&&"EDITABLE-TABLE-DISPLAY"===e.tagName&&(e=e.children.item(0)),null!=e&&"TABLE"===e.tagName&&e.children&&e.children.length>0?this.importHTML(e):this.set("data",[["","",""],["","",""],["","",""]])}}_getCurrentRow(e,t){let i=null;return null!=t&&void 0!==t[e]&&null!==t[e]&&(i=t[e]),i}_handleRowColumnMenu(e){e.detail.insert&&e.detail.row?this.insertRow(e.detail.index):e.detail.insert&&!e.detail.row?this.insertColumn(e.detail.index):!e.detail.insert&&e.detail.row?this.deleteRow(e.detail.index):this.deleteColumn(e.detail.index)}_isFirstRow(e){return 0===e}_isSortDisabled(e,t){return e||!t}_onCellClick(e){e.model&&e.model.root&&e.model.root.nodeList[0]&&e.model.root.nodeList[0].focus()}_onCellValueChange(e){let t=this.data.slice();t[e.detail.row][e.detail.column]=e.detail.value,this.set("data",[]),this.set("data",t)}_onTableSettingChange(e){this[e.detail.id]=e.detail.toggled}_setMinimumData(e){(e.length<1||e[0].length<1)&&this.set("data",[["","",""],["","",""],["","",""]])}_tableDisplayHidden(e,t,i,l){return e&&t&&i&&l}_tableSortHidden(e,t){return e&&t}}window.customElements.define(EditableTable.tag,EditableTable);export{EditableTable};