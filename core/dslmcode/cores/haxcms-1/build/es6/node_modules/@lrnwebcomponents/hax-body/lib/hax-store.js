import{LitElement as e,html as t}from"../../../lit-element/lit-element.js";import{SimpleTourManager as i}from"../../simple-popover/lib/simple-tour.js";import{winEventsElement as a,getRange as o,stripMSWord as n,nodeToHaxElement as s,haxElementToNode as r,validURL as l,camelToDash as d}from"../../utils/utils.js";import{observable as c,makeObservable as h,computed as p,configure as m,autorun as u,toJS as g}from"../../../mobx/dist/mobx.esm.js";m({enforceActions:!1});import{HAXElement as v}from"../../hax-body-behaviors/hax-body-behaviors.js";class HaxStore extends(a(v(e))){testHook(e,t){return e&&e.haxHooks()&&e.haxHooks()[t]}runHook(e,t,i=[]){return!!this.testHook(e,t)&&e[e.haxHooks()[t]](...i)}getSelection(){if(this.activeHaxBody&&this.activeHaxBody.parentNode){if(this.activeHaxBody.parentNode.getSelection)return this.activeHaxBody.parentNode.getSelection();if(o(this.activeHaxBody.parentNode))return o(this.activeHaxBody.parentNode)}return window.getSelection()}getRange(){let e=this.getSelection();return e.getRangeAt&&e.rangeCount?e.getRangeAt(0):e||void 0}guessGizmo(e,t,i=!1,a=!1){var o=[];if(void 0!==e&&this.validGizmoTypes.includes(e))for(var n in this.gizmoList){let l=this.gizmoList[n],d={},c=!1;if(l&&l.handles)for(var s=0;s<l.handles.length;s++)if(e===l.handles[s].type||"*"===e&&!c){for(var r in l.handles[s])"type"!==r&&void 0!==t[r]&&("inline"!==e&&l.meta&&(!l.meta||l.meta.inlineOnly||l.meta.hidden)||(c=!0,d[l.handles[s][r]]=t[r]));if(c||i){if(a&&l.handles[s].type_exclusive)return[this.haxElementPrototype(l,d,"")];o.push(this.haxElementPrototype(l,d,""))}}}return o}insertLogicFromValues(e,t,i=!1){let a=this.guessGizmoType(e),o=a,n=!0;if("*"==a){if(i)return!1;n=!1,o="link"}let s=this.guessGizmo(a,e,!1,n);return s.length>0?(1===s.length?void 0!==s[0].tag&&t.dispatchEvent(new CustomEvent("hax-insert-content",{bubbles:!0,cancelable:!0,composed:!0,detail:s[0]})):this.haxAppPicker.presentOptions(s,a,"Pick how to present this "+o,"gizmo"),!0):(this.toast("Sorry, HAX doesn't know how to handle that type of link yet."),!1)}write(e,t,i){i&&i.dispatchEvent(new CustomEvent("hax-store-write",{composed:!0,bubbles:!0,cancelable:!1,detail:{property:e,value:t,owner:i}}))}mimeTypeToGizmoType(e){let t=e.split("/");switch(t[0]){case"audio":return"audio";case"image":return"svg+xml"==t[1]?"svg":"image";case"video":return"video";case"text":return["csv","html","markdown"].includes(t[1])?t[1]:"document";case"application":return"pdf"==t[1]?"pdf":["zip","gzip","x-tar"].includes(t[1])?"archive":"document"}}guessGizmoType(e){if(void 0!==e.source){const t=e.source.toLowerCase();if(-1!=t.indexOf(".mp3")||-1!=t.indexOf(".midi")||-1!=t.indexOf(".mid"))return"audio";if(-1!=t.indexOf(".png")||-1!=t.indexOf(".jpg")||-1!=t.indexOf(".jpeg")||-1!=t.indexOf(".gif"))return"image";if(-1!=t.indexOf(".pdf"))return"pdf";if(-1!=t.indexOf(".svg"))return"svg";if(-1!=t.indexOf(".csv"))return"csv";if(-1!=t.indexOf(".md"))return"markdown";if(-1!=t.indexOf(".html")||-1!=t.indexOf(".htm"))return"html";if(-1!=t.indexOf(".txt")||-1!=t.indexOf(".doc")||-1!=t.indexOf(".docx")||-1!=t.indexOf(".xls")||-1!=t.indexOf(".xlsx")||-1!=t.indexOf(".vtt")||-1!=t.indexOf(".ppt"))return"document";if(-1!=t.indexOf(".zip")||-1!=t.indexOf(".tar.gz")||-1!=t.indexOf(".tar"))return"archive";if("external"!=window.MediaBehaviors.Video.getVideoType(t))return"video"}return"*"}render(){return t`
      <slot></slot>
      <hal-9000
        id="hal"
