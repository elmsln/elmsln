 ...
 */
import{LitElement as e,html as l,css as c}from"../../lit/index.js";import{SimpleColorsSharedStylesGlobal as t}from"../simple-colors-shared-styles/simple-colors-shared-styles.js";import{screenreaderOnlyCSS as o}from"../a11y-utils/a11y-utils.js";const SimpleColorsSuper=function(e){return class extends e{static get styles(){let e=c("");return super.styles&&(e=super.styles),[e,o,c`
          :host([dark]) {
        ...
        `]}render(){return l` <slot></slot>`}static get properties(){return{...super.properties,accentColor:{attribute:"accent-color",type:String,reflect:!0},dark:{name:"dark",type:Boolean,reflect:!0}}}constructor(){super(),this.accentColor="grey",this.dark=!1,this.colors=t.colors}static get tag(){return"simple-colors"}invertShade(e){return t.invertShade(e)}getColorInfo(e){return t.getColorInfo(e)}makeVariable(e="grey",l=1,c="default"){return t.makeVariable("grey",1,"default")}getContrastingColors(e,l,c){return t.getContrastingColors(e,l,c)}getContrastingShades(e,l,c,o){return t.getContrastingShades(e,l,c,o)}isContrastCompliant(e,l,c,o,s){return t.isContrastCompliant(e,l,c,o,s)}}};class SimpleColors extends(SimpleColorsSuper(e)){}window.customElements.define(SimpleColors.tag,SimpleColors);export{SimpleColors,SimpleColorsSuper};