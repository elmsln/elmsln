import{LitElement,html,css}from"../../../lit-element/lit-element.js";import"../../simple-colors/lib/simple-colors-picker.js";class HaxCeContext extends LitElement{static get styles(){return[css`
        :host *[hidden] {
          display: none;
        }
        :host {
      ...
      `]}constructor(){super(),this.ceSize=100,this.haxProperties={},import("./hax-context-item.js"),import("./hax-toolbar.js")}render(){return html`
      <hax-toolbar
        id="toolbar"
        size="${this.ceSize}"
