...
import{LitElement as e,html as o,css as t}from"../../lit-element/lit-element.js";import{HAXCMSLitElementTheme as r}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSMobileMenuMixin as s}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{BootstrapUserStylesMenuMixin as a}from"./lib/BootstrapUserStylesMenuMixin.js";import{HAXCMSUserStylesMenuMixin as i}from"../haxcms-elements/lib/core/utils/HAXCMSUserStylesMenu.js";import{HAXCMSThemeParts as l}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import"../es-global-bridge/es-global-bridge.js";import"../map-menu/map-menu.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import"./lib/BootstrapBreadcrumb.js";import"./lib/BootstrapFooter.js";import"./lib/BootstrapSearch.js";import{store as n}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as c,toJS as h}from"../../mobx/dist/mobx.esm.js";class BootstrapTheme extends(l(a(s(r)))){static get tag(){return"bootstrap-theme"}static get styles(){return[...super.styles,t`
    ...
    `}searchChanged(e){e.detail.searchText?import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{this.searchTerm=e.detail.searchText})):this.searchTerm=""}searchItemSelected(e){this.searchTerm=""}_generateBootstrapLink(){this._bootstrapLink&&document.head.removeChild(this._bootstrapLink);let e=this.getBasePath(decodeURIComponent(import.meta.url));console.log(e);let o=document.createElement("link");return o.setAttribute("rel","stylesheet"),o.setAttribute("href",e+"bootstrap/dist/css/bootstrap.min.css"),document.head.appendChild(o),o}disconnectedCallback(){this._bootstrapLink&&document.head.removeChild(this._bootstrapLink),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this._loadScripts(),this._bootstrapLink=this._generateBootstrapLink()}_loadScripts(){let e=this.getBasePath(decodeURIComponent(import.meta.url));window.ESGlobalBridge.requestAvailability(),window.ESGlobalBridge.instance.load("jquery",e+"jquery/dist/jquery.min.js"),window.addEventListener("es-bridge-jquery-loaded",this._jqueryLoaded.bind(this))}_bootstrapLoaded(e){this._bootstrap=!0}_loadBootstrap(){let e=this.getBasePath(decodeURIComponent(import.meta.url));window.ESGlobalBridge.instance.load("bootstrap",e+"bootstrap/dist/js/bootstrap.bundle.min.js"),window.addEventListener("es-bridge-bootstrap-loaded",this._bootstrapLoaded.bind(this))}_jqueryLoaded(e){this._jquery=!0,this._loadBootstrap()}getBasePath(e){return e.substring(0,e.lastIndexOf("/@lrnwebcomponents/")+1)}updated(e){super.updated&&super.updated(e),e.forEach(((e,o)=>{}))}}customElements.define(BootstrapTheme.tag,BootstrapTheme);export{BootstrapTheme};