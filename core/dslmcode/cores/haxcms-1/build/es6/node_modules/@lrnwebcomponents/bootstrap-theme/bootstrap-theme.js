 ...
 */
import{LitElement as e,html as o,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as r}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSMobileMenuMixin as s}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{BootstrapUserStylesMenuMixin as a}from"./lib/BootstrapUserStylesMenuMixin.js";import{HAXCMSUserStylesMenuMixin as i}from"../haxcms-elements/lib/core/utils/HAXCMSUserStylesMenu.js";import{HAXCMSThemeParts as l}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import"../es-global-bridge/es-global-bridge.js";import"../map-menu/map-menu.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import"./lib/BootstrapBreadcrumb.js";import"./lib/BootstrapFooter.js";import"./lib/BootstrapSearch.js";import{store as c}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as n,toJS as h}from"../../mobx/dist/mobx.esm.js";class BootstrapTheme extends(l(a(s(r)))){static get tag(){return"bootstrap-theme"}static get styles(){return[super.styles,t`
      ...
      `]}static get properties(){return{...super.properties,searchTerm:{type:String},menuOpen:{type:Boolean,attribute:"menu-open",reflect:!0},colorTheme:{type:String,attribute:"color-theme",reflect:!0}}}constructor(){super(),this.HAXCMSThemeSettings.autoScroll=!0,this.menuOpen=!0;let e=this.getBasePath(decodeURIComponent(import.meta.url));this._bootstrapPath=e+"bootstrap/dist/css/bootstrap.min.css",this._themeElements=[],this.colorTheme="0",this.searchTerm="",this.__siteTitle="",this.___pageTitle="",this.__siteImage="",import("../haxcms-elements/lib/ui-components/site/site-print-button.js"),this.__disposer=this.__disposer?this.__disposer:[],n((e=>{this.activeManifestIndex=h(c.activeManifestIndex),this.__siteTitle=h(c.manifest.title),this.__siteImage=h(c.manifest.metadata.author.image),this.__pageTitle=h(c.activeTitle),this.__disposer.push(e)}))}render(){return o`
      <link rel="stylesheet" href="${this._bootstrapPath}" />
      <div class="site ">
        <div class="menu-outline">
          <div class="site-title" part="site-title">
            ${this.__siteImage?o`<img class="site-img" src=${this.__siteImage} />`:""}
    ...
    `}searchChanged(e){e.detail.searchText?import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{this.searchTerm=e.detail.searchText})):this.searchTerm=""}searchItemSelected(e){this.searchTerm=""}_generateBootstrapLink(){this._bootstrapLink&&document.head.removeChild(this._bootstrapLink);let e=this.getBasePath(decodeURIComponent(import.meta.url)),o=document.createElement("link");return o.setAttribute("rel","stylesheet"),o.setAttribute("href",e+"bootstrap/dist/css/bootstrap.min.css"),document.head.appendChild(o),o}disconnectedCallback(){this._bootstrapLink&&document.head.removeChild(this._bootstrapLink),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this._loadScripts(),document.body.style.overflow="hidden",this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector(".site-body"),window.AbsolutePositionStateManager.requestAvailability().scrollTarget=this.HAXCMSThemeSettings.scrollTarget,this._bootstrapLink=this._generateBootstrapLink()}_loadScripts(){let e=this.getBasePath(decodeURIComponent(import.meta.url));window.ESGlobalBridge.requestAvailability().load("jquery",e+"jquery/dist/jquery.min.js"),window.addEventListener("es-bridge-jquery-loaded",this._jqueryLoaded.bind(this))}_bootstrapLoaded(e){this._bootstrap=!0}_loadBootstrap(){let e=this.getBasePath(decodeURIComponent(import.meta.url));window.ESGlobalBridge.requestAvailability().load("bootstrap",e+"bootstrap/dist/js/bootstrap.bundle.min.js"),window.addEventListener("es-bridge-bootstrap-loaded",this._bootstrapLoaded.bind(this))}_jqueryLoaded(e){this._jquery=!0,this._loadBootstrap()}getBasePath(e){return e.substring(0,e.lastIndexOf("/@lrnwebcomponents/")+1)}updated(e){super.updated&&super.updated(e),e.forEach(((e,o)=>{}))}}customElements.define(BootstrapTheme.tag,BootstrapTheme);export{BootstrapTheme};