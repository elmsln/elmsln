import{LitElement as t,html as o,css as e}from"../../../lit-element/lit-element.js";import{ImgPanZoom as i}from"../../img-pan-zoom/img-pan-zoom.js";import{FullscreenBehaviors as r}from"../../fullscreen-behaviors/fullscreen-behaviors.js";class ImgViewViewer extends(r(i)){static get styles(){return[e`
        :host {
          display: block;
      ...
      `]}constructor(){super(),this.minZoomImageRatio=1,this.maxZoomPixelRatio=3,this.__screenfullLoaded=!1,import("../../../@polymer/iron-icon/iron-icon.js"),import("../../../@polymer/iron-icons/iron-icons.js"),import("../../../@polymer/iron-icons/image-icons.js"),import("../../simple-tooltip/simple-tooltip.js")}render(){return o`
      ${this.dzi?"":o`
            ${this.hideSpinner?"":o`
    ...
    `}static get tag(){return"img-view-viewer"}static get properties(){let t={...super.properties};return delete t.src,delete t.sources,{...t,figures:{type:Array},infoToggled:{type:Boolean,attribute:"info-mode",reflect:!0},kbdToggled:{type:Boolean,attribute:"keyboard-help-mode",reflect:!0},toolbars:{type:Object,attribute:"toolbars",reflect:!0},__screenfullLoaded:{type:Boolean}}}getToolbars(t,o,e="bottom"){let i=o||t,r=i&&i[e]?i[e]:{id:e,contents:""};return this._item(r,"top"===e)}get homebutton(){return{id:"homebutton",icon:"home",text:"return image to home position"}}get fullscreenbutton(){return{id:"fullscreenbutton",icon:"fullscreen",toggleProp:"__fullscreen",enabledProp:"fullscreenEnabled",text:o` toggle fullscreen `}}get fullscreenTarget(){return this.shadowRoot&&this.shadowRoot.querySelector("#container")?this.shadowRoot.querySelector("#container"):this}get navigatorbutton(){return{id:"navigatorbutton",icon:"picture-in-picture",toggleProp:"navigatorToggled",shownProp:"showNavigator",enabledProp:"showNavigator",text:"toggle nav window"}}get infobutton(){return{id:"infobutton",icon:"info-outline",toggleProp:"infoToggled",hiddenProp:"noSources",text:"toggle information"}}get kbdbutton(){return{id:"kbdbutton",icon:"help-outline",toggleProp:"kbdToggled",text:"toggle keyboard shorcuts help",details:o`
      ...
      `}}get defaultToolbars(){return{bottom:{id:"bottom",type:"toolbar-group",contents:["prevbutton","homebutton","rotategroup","zoomgroup","pageXofY","pangroup","fullscreenbutton","nextbutton"]}}}_item(t={},e=!1){return"string"==typeof t&&this[t]&&(t=this[t]),"object"!=typeof t?o` <div class="misc-item">${t}</div> `:t&&void 0===t.contents?this._button(t,e):this._group(t,e)}_group(t={},e=!1){return"string"==typeof t&&this[t]&&(t=this[t]),t?o`
          <div
            .id="${t.id||void 0}"
            class="button-group ${t.type||""}"
          >
            ${Array.isArray(t.contents)?(t.contents||[]).map(t=>this._item(t,e)):t.contents}
          </div>
        `:""}_button(t={},e=!1){return"string"==typeof t&&this[t]&&(t=this[t]),t?t.toggleProp&&this[t.toggleProp]?o`
          <button
            .id="${t.id||void 0}"
            aria-pressed="${this[t.toggleProp]?"true":"false"}"
            class="${this._buttonClass(t)}"
            @click="${o=>this._toolbarButtonClick(t.id,o)}"
            controls="container"
        ...
        `:o`
          ...
          ${this._buttonTooltip(t,e)}
        `:""}_buttonDisabled(t){return t.disabledProp&&this[t.disabledProp]||t.enabledProp&&!this[t.enabledProp]}_buttonHidden(t){return t.hiddenProp&&this[t.hiddenProp]||t.shownProp&&!this[t.shownProp]}_buttonClass(t){return`${t.iconRight?"icon-right":""}${t.flexGrow?" flex-grow":""}`}_buttonInner(t){return t?o`
          <p>
        ...
        `:""}_buttonTooltip(t,e=!1){return t&&t.id?o`
          <simple-tooltip
            for="${t.id}"
            position="${e?"bottom":"top"}"
            >${t.text}</simple-tooltip
          >
        `:""}get src(){return this.figures&&this.figures[0]?this.figures[0].src:void 0}get loadSrc(){return this.figures&&this.figures[this.page]?this.figures[this.page].src:void 0}get sources(){return this.figures?this.figures.map(t=>t.src).slice(1):void 0}_setFullscreen(t){}_toolbarButtonClick(t,o){this.dispatchEvent(new CustomEvent("toolbar-button-click",{bubbles:!0,cancelable:!0,composed:!0,detail:{buttonId:t,eventType:o,viewer:this}})),"homebutton"===t&&this.resetZoom(),"panupbutton"===t&&this.pan(0,.2),"pandownbutton"===t&&this.pan(0,-.2),"panleftbutton"===t&&this.pan(.2,0),"panrightbutton"===t&&this.pan(-.2,0),"zoominbutton"===t&&this.zoomIn(.2),"zoomoutbutton"===t&&this.zoomOut(.2),"rotateccwbutton"===t&&this.rotate(-90),"rotatecwbutton"===t&&this.rotate(90),"navigatorbutton"===t&&(this.navigatorToggled=!this.navigatorToggled),"fullscreenbutton"===t&&this.toggleFullscreen(),"flipbutton"===t&&(this.flipToggled=!this.flipToggled),"infobutton"===t&&(this.kbdToggled=!1,this.infoToggled=!this.infoToggled),"kbdbutton"===t&&(this.infoToggled=!1,this.kbdToggled=!this.kbdToggled),"nextbutton"===t&&(this.page=Math.min(this.page+1,this.pages.length-1)),"prevbutton"===t&&(this.page=Math.max(0,this.page-1))}goToPageXofY(t){this._toolbarButtonClick("navXofY",t),this.page=t.path?t.path[0].value-1:t.target.value}loadedChangedEvent(t){console.log("loadedChangedEvent",t.detail.value,this.src,this.loadSrc),this.loaded=t.detail.value,this.loaded&&(this.loading=!1)}loadingChangedEvent(t){console.log("loadingChangedEvent",t.detail.value,this.src,this.loadSrc),this.loading=t.detail.value}_addImage(){console.log("_addImage",this.loadSrc),this.viewer.addSimpleImage({url:this.loadSrc,index:this.page,clone:!0})}_addTiledImage(){console.log("_addTiledImage",this.loadSrc),this.viewer.addTiledImage({tileSource:this.loadSrc,index:this.page,clone:!0})}}window.customElements.define(ImgViewViewer.tag,ImgViewViewer);export{ImgViewViewer};