import{html as e,css as o,LitElement as t}from"../../../lit-element/lit-element.js";import"../simple-popover.js";class SimplePopoverManager extends t{constructor(){super(),this.popover=null,this.opened=!1,this.context=null,this.orientation="tb",this.position="bottom",this.__ignore=!1}static get styles(){return[o`
        simple-popover {
    ...
    `}static get properties(){return{position:{type:String},opened:{type:Boolean},orientation:{type:String}}}updated(e){e.forEach(((e,o)=>{["opened","position","orientation"].includes(o)&&(clearTimeout(this.timer),this.timer=setTimeout((()=>{this.popover.updatePosition()}),0))}))}setPopover(e,o,t=null,i="tb",n){if(this.__ignore)this.__ignore=!1,setTimeout((()=>{this.popover.updatePosition()}),100);else{let r;o!==this.popover.target&&(this.context&&this.context.managerReset&&e!==this.context&&(this.context.managerReset(),this.__ignore=!0),this.context=e,this.setAttribute("mode",n||""),this.popover.target=null,this.popover.target=o);let p=o.getBoundingClientRect();r="tb"==i?p.y>window.innerHeight/2?"top":"bottom":p.x>window.innerWidth/2?"left":"right",this.orientation=i,this.position=r,null!=t&&(this.opened=t)}}firstUpdated(){this.popover=this.shadowRoot.querySelector("simple-popover")}}customElements.define("simple-popover-manager",SimplePopoverManager);export{SimplePopoverManager};window.SimplePopoverManager=window.SimplePopoverManager||{},window.SimplePopoverManager.requestAvailability=()=>(window.SimplePopoverManager.instance||(window.SimplePopoverManager.instance=document.createElement("simple-popover-manager"),document.body.appendChild(window.SimplePopoverManager.instance)),window.SimplePopoverManager.instance),window.SimplePopoverManager.requestAvailability();