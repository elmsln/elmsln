import{LitElement as t,html as e,css as i}from"../../../lit/index.js";import{store as o}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as r,toJS as n}from"../../../mobx/dist/mobx.esm.js";export class LrnH5p extends t{static get properties(){return{_editing:{type:Boolean}}}constructor(){super(),this._editing=!1,this._disposer=r((()=>{this._editing=n(o.editMode)})),this.querySelector("span")&&this.querySelector("span").childNodes.forEach(((t,e)=>{"#text"===t.nodeName&&t.textContent.includes("<script>")&&t.remove()}))}static get tag(){return"lrn-h5p"}static get haxProperties(){return{canScale:!1,canPosition:!0,canEditSource:!0,gizmo:{title:"H5P Element",description:"LRN H5P",icon:"editor:format-quote",color:"blue",meta:{author:"HAXTheWeb core team"}},settings:{configure:[{slot:"",title:"Text",description:"Content of the sidenote",inputMethod:"code-editor",required:!0}],advanced:[]}}}static get styles(){return[i`
        :host {
          display: block;
          width: 100%;
          position: relative;
