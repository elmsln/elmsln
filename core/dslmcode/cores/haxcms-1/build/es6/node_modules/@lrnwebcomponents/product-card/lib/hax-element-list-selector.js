 ...
 */
import{LitElement as e,html as t,css as s}from"../../../lit-element/lit-element.js";import"../../../@polymer/iron-icons/av-icons.js";import"../../../@polymer/iron-icons/communication-icons.js";import"../../../@polymer/iron-icons/device-icons.js";import"../../../@polymer/iron-icons/editor-icons.js";import"../../../@polymer/iron-icons/hardware-icons.js";import"../../../@polymer/iron-icons/image-icons.js";import"../../../@polymer/iron-icons/iron-icons.js";import"../../../@polymer/iron-icons/maps-icons.js";import"../../../@polymer/iron-icons/notification-icons.js";import"../../../@polymer/iron-icons/places-icons.js";import"../../../@polymer/iron-icons/social-icons.js";import"../../lrn-icons/lrn-icons.js";import"../../mdi-iconset-svg/mdi-iconset-svg.js";import"../../hax-iconset/hax-iconset.js";import{HaxSchematizer as i,HaxElementizer as o}from"../../hax-body-behaviors/lib/HAXFields.js";import"../../simple-fields/simple-fields.js";import{SimpleFieldsForm as a}from"../../simple-fields/lib/simple-fields-form.js";import"./hax-element-card-list.js";class HaxElementListSelector extends e{static get tag(){return"hax-element-list-selector"}static get styles(){return[s`
        :host {
          display: block;
        }
    ...
    `}_activeTabChanged(e){"haxcore.search"==e.detail.activeTab?this.showCardList=!0:this.showCardList=!1}_getElement(e){return this.form&&this.form.formElements&&this.form.formElements[e]?this.form.formElements[e].element:void 0}get form(){return this.shadowRoot&&this.shadowRoot.querySelector("#form")?this.shadowRoot.querySelector("#form"):void 0}get cardList(){return this._getElement("haxcore.search.haxcore-search-autoloader")}get searchColumns(){this._getElement("haxcore.search.haxcore-search-columns")}get haxTags(){this._getElement("haxcore.providerdetails.haxcore-providerdetails-haxtags")}get otherTags(){this._getElement("haxcore.providerdetails.haxcore-providerdetails-othertags")}updated(e){e.forEach(async(e,t)=>{if("loading"==t&&this.cardList&&(this.cardList.loading=this.loading),"showCardList"==t&&this.cardList&&(this.cardList.showCardList=this.showCardList),"cols"==t&&this.cardList&&(this.cardList.cols=this.cols),"cols"==t&&this.searchColumns&&(this.searchColumns.value=this.cols),"wcRegistryEndpoint"==t&&(this.haxData=[],this.imports=[],fetch(this.wcRegistryEndpoint).then(e=>(this.loading=!0,e.json())).then(e=>{this.imports=e})),"imports"==t){let e=this.haxData,i=this.noSchema;for(var s in this[t]){let o=this[t][s];try{await import(`${this.basePath}${o}`).then(t=>{if(t&&Object.keys(t)[0]&&t[Object.keys(t)[0]].haxProperties&&t[Object.keys(t)[0]].haxProperties.gizmo&&t[Object.keys(t)[0]].haxProperties.gizmo.title){let i={tag:s,file:o,showDemo:!1,schema:t[Object.keys(t)[0]].haxProperties};e.push(i)}else i[s]=o})}catch(e){console.warn(e)}}this.haxData=[...e],this.noSchema={},this.noSchema=i,this.loading=!1}if("haxData"==t&&(this.filteredHaxData=[...this.haxData],this.haxData.length>0)){let e={};for(var i in this.haxData)e[this.haxData[i].tag]=this.haxData[i].file;if(this.cardList){let e=this.form&&this.form.value&&this.form.value.haxcore&&this.form.value.haxcore.search?this.form.value.haxcore.search:void 0;this.cardList.list=this.filteredHaxData,e&&this.applyFilters(e),this.cardList.requestUpdate()}this.haxTags&&(this.haxTags.editorValue=JSON.stringify(e,null,2))}"noSchema"==t&&Object.keys(this.noSchema).length>0&&this.otherTags&&(this.otherTags.editorValue=JSON.stringify(this.noSchema,null,2))})}applyFilters(e){if(this.cardList){let t=[...this.haxData];Object.keys(e||{}).forEach(s=>{if(""!=e[s])switch(s){case"haxcore-search-search":t=t.filter(t=>!!t.schema.gizmo.title.toLowerCase().includes(e[s].toLowerCase()));break;case"haxcore-search-tags":t=t.filter(t=>!!t.schema.gizmo.groups.includes(e[s]));break;case"haxcore-search-hasdemo":e[s]&&(t=t.filter(e=>!!e.schema.demoSchema))}}),this.cardList.filteredTags=[...t].map(e=>e.tag),this.cardList.requestUpdate()}}_response(e){this.searchColumns&&(this.searchColumns.value=this.cols),this.cardList&&(this.cardList.cols=this.cols)}_valueChanged(){clearTimeout(this.__valueDebounce),this.__valueDebounce=setTimeout(()=>{let e=this.form&&this.form.value&&this.form.value.haxcore?this.form.value.haxcore:void 0;if(e){let t=e.search&&e.search["haxcore-search-columns"]?e.search["haxcore-search-columns"]:void 0;t&&(this.cols=t),"other"==e.providers["haxcore-providers-cdn"]?this.wcRegistryEndpoint=e.providers["haxcore-providers-other"]+"wc-registry.json":this.wcRegistryEndpoint=e.providers["haxcore-providers-cdn"]+"wc-registry.json",this.applyFilters(e.search),this.cardList&&this.dispatchEvent(new CustomEvent("appstore-changed",{detail:{value:this.getAppstoreValues()}}))}},50)}getAppstoreValues(){let e=this.shadowRoot.querySelector("#form").submit();e.haxcore=e.haxcore||{templates:{},providers:{}};let t={providers:{cdn:e.haxcore.providers["haxcore-providers-cdn"],other:e.haxcore.providers["haxcore-providers-other"],pk:e.haxcore.providers["haxcore-providers-pk"]},apps:{},blox:e.haxcore.templates["haxcore-templates-templates"],stax:e.haxcore.templates["haxcore-templates-layouts"],autoloader:e.haxcore.search["haxcore-search-autoloader"]};for(var s in e.haxcore.integrations)t.apps[s.replace("haxcore-integrations-","")]=e.haxcore.integrations[s];return t}getAutoloader(e){let t={};for(var s in e)e[s].status&&(t[e[s].tag]=e[s].file);return t}}window.customElements.define(HaxElementListSelector.tag,HaxElementListSelector);