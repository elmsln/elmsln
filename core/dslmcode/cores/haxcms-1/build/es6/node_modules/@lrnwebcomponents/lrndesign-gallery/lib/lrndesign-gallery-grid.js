 ...
 */
import{LitElement as e,html as r,css as i}from"../../../lit-element/lit-element.js";import{LrndesignGalleryBehaviors as l}from"./lrndesign-gallery-behaviors.js";import"./lrndesign-gallery-zoom.js";import"./lrndesign-gallery-details.js";class LrndesignGalleryGrid extends l{static get tag(){return"lrndesign-gallery-grid"}static get styles(){return[...super.styles,i`
        :host {
          margin: 15px 0;
          padding: 0;
          max-width: 100%;
      ...
      `]}static get properties(){return{...super.properties}}constructor(){super();let e=this.shadowRoot.querySelector("#carouselitem");this.selected.scroll&&e&&(this._scrollIntoView([this._getParentOffset(e)]),this.selected.zoomed||e.focus())}render(){return r`
      <div id="grid">
