import{LitElement as e,html as t,css as a}from"../../../lit-element/lit-element.js";import{winEventsElement as o,camelCaseToDash as i,wipeSlot as s,nodeToHaxElement as n,haxElementToNode as l}from"../../utils/utils.js";import"../../a11y-collapse/lib/a11y-collapse-group.js";import"../../a11y-collapse/a11y-collapse.js";import{HaxSchematizer as r,HaxElementizer as c}from"../../hax-body-behaviors/lib/HAXFields.js";class HaxTray extends(o(e)){static get tag(){return"hax-tray"}constructor(){super(),this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel","hax-store-property-updated":"_haxStorePropertyUpdated"},this.activeValue={settings:{layout:{__position:"hax-align-left",__scale:100},configure:{},advanced:{}}},this.collapsed=!1,this.activeTab="item-0",this.activeSchema=[],this.canUndo=!1,this.canRedo=!1,this.elementAlign="right",this.activeTagName="Select an element to configure",this.activeTagIcon="icons:settings",this.__setup=!1,setTimeout(()=>{import("./hax-tray-button.js"),import("../../../@polymer/iron-icon/iron-icon.js"),import("../../../@polymer/iron-icons/iron-icons.js"),import("../../../@polymer/iron-icons/editor-icons.js"),import("../../../@polymer/iron-icons/device-icons.js"),import("../../../@polymer/iron-icons/hardware-icons.js"),import("../../../@polymer/iron-icons/communication-icons.js"),import("../../../@polymer/iron-icons/social-icons.js"),import("../../../@polymer/iron-icons/image-icons.js"),import("../../../@polymer/iron-icons/av-icons.js"),import("../../../@polymer/iron-icons/maps-icons.js"),import("../../../@polymer/iron-icons/places-icons.js"),import("../../md-extra-icons/md-extra-icons.js"),import("../../hax-iconset/hax-iconset.js"),import("../../lrn-icons/lrn-icons.js"),import("./hax-tray-upload.js"),import("../../simple-fields/simple-fields.js"),this.addEventListener("hax-tray-button-click",this._processTrayEvent.bind(this)),import("./hax-gizmo-browser.js"),import("./hax-app-browser.js"),import("./hax-blox-browser.js"),import("./hax-stax-browser.js")},0)}_expandSettingsPanel(e){this.shadowRoot.querySelector("#settingscollapse").expand()}_redoChanged(e){this.canRedo=e.detail.value}_undoChanged(e){this.canUndo=e.detail.value}_haxStorePropertyUpdated(e){e.detail&&void 0!==e.detail.value&&e.detail.property&&("globalPreferences"!==e.detail.property&&"activeGizmo"!==e.detail.property&&"activeNode"!==e.detail.property||(this[e.detail.property]={}),this[e.detail.property]=e.detail.value)}static get styles(){return[a`
        :host {
