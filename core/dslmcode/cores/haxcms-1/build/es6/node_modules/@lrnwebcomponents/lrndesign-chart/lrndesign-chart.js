 ...
 */
import{LitElement,html,css}from"../../lit-element/lit-element.js";import{SimpleColors}from"../simple-colors/simple-colors.js";import{ChartistRender}from"../chartist-render/chartist-render.js";import"../../@polymer/iron-ajax/iron-ajax.js";class LrndesignChart extends SimpleColors{static get styles(){let styles=[css`
        :host {
      ...
      `];return super.styles&&(styles=Object.assign(super.styles,styles)),styles}render(){return html`
      <iron-ajax
        auto
        handle-as="text"
        url="${this.dataSource}"
