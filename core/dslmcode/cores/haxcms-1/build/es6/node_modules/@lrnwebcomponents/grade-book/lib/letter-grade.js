import{html as e,css as t,LitElement as r}from"../../../lit-element/lit-element.js";import{GradeBookStore as l}from"./grade-book-store.js";import{autorun as i,toJS as a}from"../../../mobx/dist/mobx.esm.js";class LetterGrade extends r{constructor(){super(),this.pointsSystem="pts",this.score=null,this.total=null,this.gradeScale=[],this.displayOnly=!1,this._letterIndex=null,this.letter="",this.showScale=!1,this.value="",this.mini=!1,this.label="",this.active=!1,i((()=>{this.gradeScale=a(l.gradeScale)}))}static get styles(){return[t`
        :host {
          display: block;
        }
        :host([letter="/"]) {
