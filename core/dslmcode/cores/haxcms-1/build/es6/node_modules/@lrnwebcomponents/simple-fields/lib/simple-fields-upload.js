          ...
          >
            <span id="drop" part="drop-area-text">
              <simple-icon-lite
                ...
                part="drop-area-icon"
              ></simple-icon-lite>
              Drop media here ${navigator.mediaDevices?e` or `:""}
            </span>
            <simple-toolbar-button
