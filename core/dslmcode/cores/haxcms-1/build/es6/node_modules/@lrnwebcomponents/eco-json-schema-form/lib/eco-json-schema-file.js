import{html as e,PolymerElement as t}from"../../../@polymer/polymer/polymer-element.js";import{microTask as r}from"../../../@polymer/polymer/lib/utils/async.js";import"../../../@polymer/iron-flex-layout/iron-flex-layout-classes.js";import{AppLocalizeBehavior as i}from"../../../@polymer/app-localize-behavior/app-localize-behavior.js";import{mixinBehaviors as o}from"../../../@polymer/polymer/lib/legacy/class.js";import"../../../@polymer/paper-button/paper-button.js";import"../../../@polymer/paper-input/paper-input.js";import"../../../@polymer/iron-icon/iron-icon.js";import"../../../@polymer/iron-icons/iron-icons.js";import"../../../@polymer/polymer/lib/elements/dom-repeat.js";class EcoJsonSchemaFile extends(o([i],t)){static get tag(){return"eco-json-schema-file"}static get template(){return e`
    ...
    `}static get properties(){return{language:{value:"en",notify:!0},resources:{value:()=>({}),notify:!0},schema:{type:Object,observer:"_schemaChanged"},value:{type:Object,notify:!0,value:()=>({}),observer:"_valueChanged"},target:{type:String,value:""},accept:{type:String,value:""},droppable:{type:Boolean,value:!1},dropText:{type:String,value:"Drop Files Here"},multi:{type:Boolean,value:!0},files:{type:Array,notify:!0,value:()=>[]},raised:{type:Boolean,value:!0},noink:{type:Boolean,value:!1},headers:{type:Object,value:{}},retryText:{type:String,value:"Retry Upload"},removeText:{type:String,value:"Remove"},successText:{type:String,value:"Success"},errorText:{type:String,value:"Error uploading file..."},_shownDropText:{type:Boolean,value:!1},additional:{type:Object,value:{}},fileDataName:{type:String,value:"file"},paperButtonAlt:{type:String,value:""},paperButtonTitle:{type:String,value:""}}}clear(){this.set("files",[]),this.shadowRoot.querySelector("#fileInput").value="",this._showDropText()}ready(){super.ready(),this.raised&&this.toggleAttribute("raised",!0,this.shadowRoot.querySelector("#button")),this.noink&&this.toggleAttribute("noink",!0,this.shadowRoot.querySelector("#button")),this.droppable&&(this._showDropText(),this.setupDrop())}setupDrop(){var e=this.shadowRoot.querySelector("#UploadBorder");this.toggleClass("enabled",!0,e),this.ondragover=function(t){t.stopPropagation(),this.toggleClass("hover",!0,e);var r=t.dataTransfer&&t.dataTransfer.dropEffect,i=t.dataTransfer&&t.dataTransfer.effectAllowed;return"none"===r&&"none"!==i&&(t.dataTransfer.dropEffect="move"===i?"move":"copy"),!1},this.ondragleave=function(){return this.toggleClass("hover",!1,e),!1},this.ondrop=function(t){if(this.toggleClass("hover",!1,e),t.preventDefault(),this.multi||0===this.files.length)for(var r=t.dataTransfer.files.length,i=0;i<r;i++){var o=t.dataTransfer.files[i],a=""!==o.type?o.type.match(/^[^\/]*\//)[0]:null,l=o.name.match(/\.[^\.]*$/)[0];(""===this.accept||this.accept.indexOf(a)>-1||this.accept.indexOf(l)>-1)&&(o.progress=0,o.error=!1,o.complete=!1,this.push("files",o),this.uploadFile(o))}}}_fileClick(){var e=this.shadowRoot.querySelector("#fileInput");if(e&&document.createEvent){var t=document.createEvent("MouseEvents");t.initEvent("click",!0,!1),e.dispatchEvent(t)}}_fileChange(e){for(var t=e.target.files.length,r=0;r<t;r++){var i=e.target.files[r];i.progress=0,i.error=!1,i.complete=!1,this.push("files",i),this.multi||0===this.files.length||(this.set("files",[]),this.set("value",{})),this.uploadFile(i)}}cancel(e){e&&(e.xhr&&e.xhr.abort(),this.splice("files",this.files.indexOf(e),1),this._showDropText())}_cancelUpload(e){this.cancel(e.model.__data__.item)}_retryUpload(e){e.model.set("item.error",!1),e.model.set("item.progress",0);var t=this;r.run(()=>{t.uploadFile(e.model.__data__.item)})}_showDropText(){this.set("_shownDropText",!this.files.length&&this.droppable)}uploadFile(e){if(e){this.dispatchEvent(new CustomEvent("before-upload",{bubbles:!0,cancelable:!0,composed:!0,detail:!0})),this._showDropText();this.files.indexOf(e);var t=this,r=new FileReader;r.addEventListener("load",(function(){var i=r.result;t.set("value."+t.attributes.name.value+"."+t.files.indexOf(e),i)}),!1),t.value.hasOwnProperty(t.attributes.name.value)||this.set("value."+t.attributes.name.value,{}),r.readAsDataURL(e)}}_valueChanged(){console.log("this.value: "+JSON.stringify(this.value))}_schemaChanged(){this.schema}_isSchemaValue(e){return this._isSchemaFile(e)}_isSchemaFile(e){return Array.isArray(e)?-1!==e.indexOf("file"):"file"===e}_isSchemaBoolean(e){return Array.isArray(e)?-1!==e.indexOf("boolean"):"boolean"===e}_isSchemaNumber(e){return Array.isArray(e)?-1!==e.indexOf("number")||-1!==e.indexOf("integer"):"number"===e||"integer"===e}_isSchemaString(e){return Array.isArray(e)?-1!==e.indexOf("string"):"string"===e}_isSchemaObject(e){return"object"===e}_isSchemaArray(e){return"array"===e}stringify(e){return JSON.stringify(e)}}window.customElements.define(EcoJsonSchemaFile.tag,EcoJsonSchemaFile);export{EcoJsonSchemaFile};