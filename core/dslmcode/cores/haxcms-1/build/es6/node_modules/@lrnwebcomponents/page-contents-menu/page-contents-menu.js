 ...
 */
import{LitElement as e,html as t,css as i}from"../../lit-element/lit-element.js";import{normalizeEventPath as n}from"../utils/utils.js";class PageContentsMenu extends e{static get styles(){return[i`
        :host {
          display: block;
        }
    ...
    `}keyToggle(e){["Enter","Space"].includes(e.key)&&this.toggleSettings(e)}keyScroll(e){"Enter"==e.key&&this.scrollToObject(e)}toggleSettings(e){this.mobile&&(this.hideSettings=!this.hideSettings)}scrollToObject(e){var t=n(e)[0];t.getAttribute("data-index")&&(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),this.items[parseInt(t.getAttribute("data-index"))].object.scrollIntoView({behavior:"smooth",block:"start",inline:"nearest"}),this.hideSettings=!0)}renderItem(e,i){return null==e.link&&e.object?t`
        <li class="item">
          <a
    ...
    `}static get properties(){return{contentContainer:{type:Object},relationship:{type:String},items:{type:Array},position:{type:String},mobile:{type:Boolean,reflect:!0},label:{type:String},hideSettings:{type:Boolean},hideIfEmpty:{type:Boolean,attribute:"hide-if-empty",reflect:!0},isEmpty:{type:Boolean,attribute:"is-empty",reflect:!0}}}static get tag(){return"page-contents-menu"}constructor(){super(),this.relationship=null,this.items=[],this.isEmpty=!0,this.hideIfEmpty=!1,this.position="left",this.contentContainer=null,this.mobile=!1,this.scrollPolling=100,this.hideSettings=!0,this.label="Contents",window.addEventListener("click",this.checkMenuOpen.bind(this)),this.hierarchyTags=["h1","h2","h3","h4","h5","h6"]}checkMenuOpen(e){var t=n(e)[0];!this.mobile||this.hideSettings||!t.includes||t.includes(this.__toggleTarget)||t.includes(this.shadowRoot.querySelector("simple-popover"))||(this.hideSettings=!0)}firstUpdated(){"parent"==this.relationship?this.contentContainer=this.parentElement:"next"==this.relationship?this.contentContainer=this.nextElementSibling:"previous"==this.relationship&&(this.contentContainer=this.previousElementSibling)}updated(e){e.forEach(((e,t)=>{"items"==t&&this[t]&&this[t].length>0&&setTimeout((()=>{this.scrollFinished()}),0),"contentContainer"==t&&this._contentContainerChanged(this[t]),"mobile"==t&&(this[t]?(import("../simple-popover/simple-popover.js").then((e=>{setTimeout((()=>{this.__toggleTarget=this.shadowRoot.querySelector("#popovertarget"),this.__toggleTarget.setAttribute("tabindex","0"),this.shadowRoot.querySelector("simple-popover").target=this.__toggleTarget}),0)})),import("../simple-tooltip/simple-tooltip.js")):e&&!this[t]&&this.__toggleTarget.removeAttribute("tabindex"))}))}updateMenu(){const e=this.hierarchyTags;let t=[];for(var i=0;i<this.contentContainer.childNodes.length;i++){let n=this.contentContainer.childNodes[i];if(void 0!==n.tagName&&e.includes(n.tagName.toLowerCase())){let e={title:n.innerText,link:n.id?"#"+n.id:null,object:n,indent:parseInt(n.tagName.toLowerCase().replace("h","")),active:""};t.push(e)}}0===t.length?this.isEmpty=!0:this.isEmpty=!1,this.items=[...t]}_applyScrollDetect(){clearTimeout(this.__debounce),this.__debounce=setTimeout((()=>{this.scrollFinished()}),this.scrollPolling)}scrollFinished(){if(this.items){let e=!1,t=window.innerHeight||document.documentElement.clientHeight;this.items.forEach(((i,n)=>{let s=this.items[n].object.getBoundingClientRect().top-100,o=0;o=n!==this.items.length-1?this.items[n+1].object.getBoundingClientRect().top-100:t,s<=t&&o>0&&!e?(e=!0,this.items[n].active="active"):this.items[n].active=""})),!e&&this.items&&this.items.length>0&&(this.items[0].object.getBoundingClientRect().top>=t?this.items[0].active="active":this.items[this.items.length-1].active="active"),this.requestUpdate()}}_contentContainerChanged(e){e&&e.childNodes&&e.childNodes.length>0&&this.updateMenu()}connectedCallback(){super.connectedCallback&&super.connectedCallback(),document.addEventListener("scroll",this._applyScrollDetect.bind(this))}disconnectedCallback(){super.disconnectedCallback&&super.disconnectedCallback(),document.removeEventListener("scroll",this._applyScrollDetect.bind(this))}}customElements.define(PageContentsMenu.tag,PageContentsMenu);export{PageContentsMenu};