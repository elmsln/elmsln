 ...
 */
import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import"../../@polymer/paper-icon-button/paper-icon-button.js";import"../../@polymer/paper-button/paper-button.js";import"../../@polymer/iron-icons/iron-icons.js";class ItemOverlayOps extends PolymerElement{static get template(){return html`
      <style>
        :host {
          display: block;
          outline: none;
      ...
      <slot></slot>
    `}static get tag(){return"item-overlay-ops"}static get properties(){return{editMode:{type:Boolean,reflectToAttribute:!0,value:!1},focused:{type:Boolean,reflectToAttribute:!0,value:!1},activeTitle:{type:String},activeOp:{type:String},add:{type:Boolean,value:!1},edit:{type:Boolean,value:!1},move:{type:Boolean,value:!1},fixedHeight:{type:Number,observer:"fixedHeightChanged"},disableAutoHeight:{type:Boolean,value:!1},remove:{type:Boolean,value:!1},duplicate:{type:Boolean,value:!1},__anyOp:{type:Boolean,value:!1}}}connectedCallback(){super.connectedCallback(),setTimeout(()=>{this._windowResize()},5),this.setAttribute("tabindex","0"),window.addEventListener("resize",this._windowResize.bind(this)),afterNextRender(this,(function(){this.addEventListener("focusin",this._inFocus.bind(this)),this.addEventListener("focusout",this._outFocus.bind(this))}))}disconnectedCallback(){this.removeEventListener("focusin",this._inFocus.bind(this)),this.removeEventListener("focusout",this._outFocus.bind(this)),window.removeEventListener("resize",this._windowResize.bind(this)),super.disconnectedCallback()}fixedHeightChanged(newValue,oldValue){newValue&&(this.disableAutoHeight||(this.shadowRoot.querySelector("#container").style.height=this.fixedHeight+"px",this.shadowRoot.querySelector("#workingarea").style.height=this.fixedHeight-80+"px"))}_windowResize(e){let rect=this.getBoundingClientRect();this.shadowRoot.querySelector("#container").style.width=rect.width+"px",this.disableAutoHeight?this.shadowRoot.querySelector("#workingarea").style.height=rect.height-80+"px":this.fixedHeight&&void 0!==this.fixedHeight?(this.shadowRoot.querySelector("#container").style.height=this.fixedHeight+"px",this.shadowRoot.querySelector("#workingarea").style.height=this.fixedHeight-80+"px"):(this.shadowRoot.querySelector("#container").style.height=rect.height+"px",this.shadowRoot.querySelector("#workingarea").style.height=rect.height-80+"px")}_opTap(e){let local=e.target;switch(this.activeTitle=local.getAttribute("id"),this.activeOp=local.getAttribute("id"),this._resetActive(),this.__anyOp=!0,local.classList.add("active"),this.activeOp){case"cancel":local.classList.remove("active"),this.activeTitle=null,this.activeOp=null,this.__anyOp=!1;break;case"remove":this.__option1Icon="icons:check",this.__option1Text="Confirm deleting this",this.__option2Icon="icons:clear",this.__option2Text="Cancel";break;case"duplicate":this.__option1Icon="icons:check",this.__option1Text="Confirm duplicating this",this.__option2Icon="icons:clear",this.__option2Text="Cancel";break;case"move":this.__option1Icon="icons:arrow-back",this.__option1Text="Move item left",this.__option2Icon="icons:arrow-forward",this.__option2Text="Move item right"}let op={element:this,operation:this.activeOp};this.dispatchEvent(new CustomEvent("item-overlay-op-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:op}))}_inFocus(e){this.editMode&&(this.focused=!0)}_outFocus(e){this.editMode&&(this.focused=!1)}_optionSelected(e){let local=e.target,ops={element:this,operation:this.activeOp,option:local.getAttribute("id")};this.dispatchEvent(new CustomEvent("item-overlay-option-selected",{bubbles:!0,cancelable:!0,composed:!0,detail:ops})),"move"!=this.activeOp&&(this._resetActive(),this.activeOp=null)}_resetActive(){this.shadowRoot.querySelector("#add").classList.remove("active"),this.shadowRoot.querySelector("#edit").classList.remove("active"),this.shadowRoot.querySelector("#move").classList.remove("active"),this.shadowRoot.querySelector("#remove").classList.remove("active"),this.shadowRoot.querySelector("#duplicate").classList.remove("active")}}window.customElements.define(ItemOverlayOps.tag,ItemOverlayOps);export{ItemOverlayOps};