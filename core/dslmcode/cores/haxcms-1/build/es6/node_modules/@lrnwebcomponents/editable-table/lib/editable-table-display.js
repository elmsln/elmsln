 ...
 */
import{html as e,PolymerElement as t}from"../../../@polymer/polymer/polymer-element.js";import"../../../@polymer/polymer/lib/elements/dom-repeat.js";import"../../../@polymer/polymer/lib/elements/dom-if.js";import"../../../@polymer/iron-ajax/iron-ajax.js";import"../../simple-picker/simple-picker.js";import{ResponsiveUtilityBehaviors as i}from"../../responsive-utility/lib/responsive-utility-behaviors.js";import{displayBehaviors as l}from"./editable-table-behaviors.js";import"./editable-table-styles.js";class EditableTableDisplay extends(l(i(t))){static get template(){return e`
    ...
    `}static get tag(){return"editable-table-display"}static get properties(){return{filterColumn:{type:Number,value:null},filtered:{type:Boolean,value:!1},filterText:{type:String,value:null},options:{type:Array,computed:"_getTheadOptions(thead)"},selected:{type:Number,value:1},sortMode:{type:String,value:"none"},sortColumn:{type:Number,value:-1},hidden:{type:Boolean,computed:"_hasNoData(data)"}}}_dataChanged(e,t){if(!e||e.length<1||e[0].length<1){let e=this.children.item(0);null!=e&&"TABLE"===e.tagName&&this.importHTML(e)}this.dispatchEvent(new CustomEvent("change",{bubbles:!0,cancelable:!0,composed:!0,detail:e}))}_hasNoData(e){return!e||e.length<1||e[0].length<1}_getTheadOptions(e){let t=[];if(null!=e&&e.length>0)for(let i=1;i<e[0].length;i++)t.push([{alt:e[0][i],value:i}]);return t}_isColHidden(e,t=1){return t=t||1,0!==parseInt(e)&&parseInt(e)!==parseInt(t)}_isFiltered(e,t,i){return null!==t&&t===e&&i}_isNegative(e){return this._isNumeric(e)&&0===e.trim().indexOf("-")}_isNumericColumn(e){let t=!0;for(let i=0;i<this.tbody.length;i++)this._isNumeric(this.tbody[i][e])||(t=!1);return t}_isRowHeader(e,t){return 0===t&&e}_tableChanged(){this._updateCols()}_selectedChanged(){this._updateCols()}_changeSortMode(e){this.sortColumn===e.detail.columnIndex&&"asc"===this.sortMode?this.sortMode="desc":this.sortColumn===e.detail.columnIndex&&"desc"===this.sortMode?this.sortMode="none":(this.sortMode="asc",this.sortColumn=e.detail.columnIndex),e.detail.setSortMode(this.sortMode),this.sortData(this.sortMode,e.detail.columnIndex)}_updateCols(){let e=this.shadowRoot.querySelector("#column").value,t=this.shadowRoot.querySelector("#table").querySelectorAll("th,td");if(t.length>0)for(let i=0;i<t.length;i++){let l=t[i];this._isColHidden(l.cellIndex,e)?l.setAttribute("xs-hidden",!0):l.removeAttribute("xs-hidden")}}filterRows(e,t){return null!=t?function(i){return i[e].toLowerCase().trim()===t.toLowerCase().trim()}:null}sortData(e,t){if("none"!==e&&!1!==e){let i=this.tbody.slice();for(let e=0;e<i.length;e++)i[e].unshift(i[e][t]);"asc"===e?i.sort():i.reverse();for(let e=0;e<i.length;e++)this.set("tbody."+e,[]),this.set("tbody."+e,i[e].slice(1))}}toggleFilter(e){void 0===e||this.filterColumn==e.detail.columnIndex&&this.filtered?(this.filtered=!1,this.filterText=null,this.filterColumn=null):(this.filterText=e.detail.text,this.filterColumn=e.detail.columnIndex,this.filtered=!0)}constructor(){super(),import("./editable-table-sort.js"),import("./editable-table-filter.js")}connectedCallback(){super.connectedCallback(),setTimeout(()=>{this.addEventListener("change-sort-mode",this._changeSortMode.bind(this)),this.addEventListener("toggle-filter",this.toggleFilter.bind(this))},0)}disconnectedCallback(){this.removeEventListener("change-sort-mode",this._changeSortMode.bind(this)),this.removeEventListener("toggle-filter",this.toggleFilter.bind(this)),super.disconnectedCallback()}}window.customElements.define(EditableTableDisplay.tag,EditableTableDisplay);export{EditableTableDisplay};