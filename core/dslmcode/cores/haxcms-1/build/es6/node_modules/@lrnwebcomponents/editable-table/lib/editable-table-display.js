 ...
 */
import{LitElement as t,html as e,css as i}from"../../../lit/index.js";import{displayBehaviors as s,editableTableDisplayStyles as l}from"./editable-table-behaviors.js";import{ResponsiveUtilityBehaviors as o}from"../../responsive-utility/lib/responsive-utility-behaviors.js";import"../../simple-picker/simple-picker.js";class EditableTableDisplay extends(s(o(t))){static get styles(){return[...super.styles||[],...l,i`
        :host([hidden]),
        :host([disabled]) {
            ...
            ${(this.thead[0]||[]).map(((t,i)=>e`
                ...
                >
                  ${this.sort?e`
                      ...
                      `:this.getHTML(this._replaceBlankCell(t))}
                  ${!this.disableResponsive&&i>0&&this.selected==i?e` <simple-picker
                          id="simple-picker-${i}"
                          class="column"
                          align-right
