 ...
 */
import{LitElement as e,html as t,css as s}from"../../lit-element/lit-element.js";class AwesomeExplosion extends e{static get styles(){return[s`
        :host {
      ...
      `]}pathFromUrl(e){return e.substring(0,e.lastIndexOf("/")+1)}constructor(){super();const e=this.pathFromUrl(decodeURIComponent(import.meta.url));this.state="stop",this.image=e+"assets/explode.gif",this.sound=e+"assets/273320__clagnut__fireworks.mp3",this.size="medium",this.color="",this.resetSound=!1,setTimeout(()=>{this.addEventListener("click",this._setPlaySound.bind(this)),this.addEventListener("mouseover",this._setPlaySound.bind(this)),this.addEventListener("mouseout",this._setStopSound.bind(this))},0)}render(){return t`
      <img
        loading="lazy"
        src="${this.image}"
        id="image"
