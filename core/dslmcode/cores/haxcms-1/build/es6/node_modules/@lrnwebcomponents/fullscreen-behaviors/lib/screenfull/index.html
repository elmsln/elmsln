<!DOCTYPE html><html lang="en" itemscope="" itemtype="https://schema.org/Product"><head>
		<meta charset="utf-8">
  ...
  screenfull.on('change', fullscreenchange); // Set the initial values

  fullscreenchange();
});</script>
		<script>var _gaq = [['_setAccount', 'UA-25562592-1'], ['_trackPageview'], ['_trackPageLoadTime']];
