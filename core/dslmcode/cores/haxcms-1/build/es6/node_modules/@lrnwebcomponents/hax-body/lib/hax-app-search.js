import{html as e,css as t}from"../../../lit-element/lit-element.js";import{SimpleColors as i}from"../../simple-colors/simple-colors.js";import"../../../@polymer/iron-ajax/iron-ajax.js";import{winEventsElement as a}from"../../utils/utils.js";class HaxAppSearch extends(a(i)){static get styles(){return[...super.styles,t`
      ...
      `]}constructor(){super(),this.__winEvents={"hax-store-property-updated":"_haxStorePropertyUpdated"},this.auto=!1,this.headers={},this.method="GET",this.loading=!1,this.requestData={},this.media=[],this.resultMap={},import("../../simple-fields/lib/simple-fields-field.js"),import("../../dropdown-select/dropdown-select.js"),import("../../hexagon-loader/hexagon-loader.js"),import("./hax-app-search-inputs.js"),import("./hax-app-search-result.js")}render(){return e`
      <iron-ajax
        id="request"
        handle-as="json"
