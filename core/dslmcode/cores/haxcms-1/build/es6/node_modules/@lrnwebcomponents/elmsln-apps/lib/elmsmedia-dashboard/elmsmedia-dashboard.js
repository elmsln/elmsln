...
import "../../../hax-body/lib/hax-app.js";
...
class ElmsmediaDashboard extends PolymerElement {
  ...
  removeFilter(path, propValue) {
    const currentParams = Object.assign({}, this.queryParams); // get the current value of the filter

    const currentValue = _.get(currentParams, path); // remove the specified filter from the current value
