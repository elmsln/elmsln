 ...
 */
import{LitElement as t,html as o,css as e}from"../../../lit-element/lit-element.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import{store as r}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as s,toJS as i}from"../../../mobx/dist/mobx.esm.js";class BootstrapBreadcrumb extends t{static get styles(){return[e`
        :host {
    ...
    `}getBasePath(t){return t.substring(0,t.lastIndexOf("/@lrnwebcomponents/")+1)}getParentById(t){let o=r.manifest.items.map((t=>i(t.id))).indexOf(t);return i(r.manifest.items[o])}addParentToItems(t){let o=this.getParentById(t.parent);this.items.unshift(o),o.parent&&this.addParentToItems(o)}firstUpdated(t){}updated(t){t.forEach(((t,o)=>{}))}}customElements.define(BootstrapBreadcrumb.tag,BootstrapBreadcrumb);export{BootstrapBreadcrumb};