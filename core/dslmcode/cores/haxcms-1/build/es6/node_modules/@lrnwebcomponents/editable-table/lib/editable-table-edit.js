...
import{LitElement as t,html as e,css as o}from"../../../lit/index.js";import{displayBehaviors as i,editBehaviors as l,editableTableStyles as a}from"./editable-table-behaviors.js";import"../../rich-text-editor/rich-text-editor.js";import"../../rich-text-editor/lib/toolbars/rich-text-editor-toolbar-mini.js";import"../../simple-toolbar/simple-toolbar.js";import"../../simple-tooltip/simple-tooltip.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import"./editable-table-editor-rowcol.js";import"../../simple-toolbar/lib/simple-toolbar-button.js";import"../../simple-toolbar/lib/simple-toolbar-button-group.js";import{ReplaceWithPolyfill as r}from"../../utils/utils.js";Element.prototype.replaceWith||(Element.prototype.replaceWith=r),CharacterData.prototype.replaceWith||(CharacterData.prototype.replaceWith=r),DocumentType.prototype.replaceWith||(DocumentType.prototype.replaceWith=r);class EditableTableEdit extends(l(t)){static get styles(){return[...super.styles||[],...a,o`
      ...
      `]}get textEditorToolbar(){return e`
      <rich-text-editor-toolbar-mini
      ...
      ></rich-text-editor-toolbar-mini>
    `}get columnHeaderButton(){return e`
    ...
    `}get headersFootersGroup(){return e`
    ...
    `}get columnStripeButton(){return e`
      <simple-toolbar-button
        id="columnStriped"
        ?disabled="${this.hideStriped}"
        ?hidden="${this.hideStriped}"
    ...
    `}get numericStylesButton(){return e`
      <simple-toolbar-button
        id="numericStyles"
    ...
    `}editableColumn(t){return e`
      <th
        class="col-${t}"
        scope="col"
        ?numeric="${this._isNumericColumn(t)}"
      >
        ${this.columnMenuButton(t)}
      </th>
    `}rowMenuButton(t){return e`
      <editable-table-editor-rowcol
        class="cell"
        ?condensed="${this.condensed}"
        index="${t}"
    ...
    `}editableRow(t,o){return e`
      <tr
        class="tr ${0==t&&this.columnHeader?"thead-tr":t==this.data.length-1&&this.footer?"tfoot-tr":"tbody-tr"}"
      >
        <th scope="row">${this.rowMenuButton(t)}</th>
        ${(o||[]).map(((e,o)=>this.editableCell(t,o,e)))}
      </tr>
    `}cellEditor(t,o,i){return e`
      <rich-text-editor
        autofocus
        @blur="${e=>this._onCellValueChange(e,t,o)}"
        class="cell"
        disable-mouseover
        toolbar="editable-table-toolbar"
        id="cell-${t}-${o}"
        label="${`Cell ${this._getLabel(o,!1)}${t}`}"
        rawhtml="${i}"
        type="rich-text-editor-toolbar-mini"
      >
      </rich-text-editor>
    `}editableCell(t,o,i){return e`
      <td
        class="${0===o&&this.rowHeader||0==t&&this.columnHeader?"th":"td"} th-or-td"
        ?negative="${this._isNegative(i)}"
        ?numeric="${this._isNumericColumn(o)}"
        @click="${this._onCellClick}"
      >
        ${this.cellEditor(t,o,i)}
        <div id="icons">
          <simple-icon-lite
            class="sortable-icon"
            icon="editable-table:sortable"
