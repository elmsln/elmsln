...
import{LitElement as e,html as t,css as a}from"../../lit/index.js";class MdBlock extends e{static get styles(){return[a`
    ...
    </div>`}static get haxProperties(){return{canScale:!1,canPosition:!1,canEditSource:!0,gizmo:{title:"Markdown",description:"A block of markdown content directly or remote loaded",icon:"icons:code",color:"yellow",groups:["Block"],handles:[],meta:{author:"HAXTheWeb",owner:"The Pennsylvania State University"}},settings:{configure:[{property:"markdown",title:"Markdown",description:"Raw markdown",inputMethod:"textarea"},{property:"source",title:"Source",description:"Source file for markdown",inputMethod:"haxupload"}],advanced:[]},demoSchema:[{tag:"md-block",properties:{markdown:"- The first bulleted item in a long list.."},content:""}]}}static get properties(){return{source:{type:String},markdown:{type:String}}}constructor(){super(),this.markdown="",this.source="",import("../../@polymer/marked-element/marked-element.js"),this.innerHTML&&(this.markdown=this.innerHTML.trim(),this.innerHTML=null)}static get tag(){return"md-block"}}customElements.define(MdBlock.tag,MdBlock);export{MdBlock};