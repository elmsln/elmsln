 ...
 */
import{LitElement as t,html as e,css as i}from"../../../../../lit-element/lit-element.js";import{store as o}from"../../core/haxcms-site-store.js";import{HAXCMSThemeParts as n}from"../../core/utils/HAXCMSThemeParts.js";import"../../../../simple-icon/simple-icon.js";import"../../../../simple-icon/lib/simple-icons.js";import"../../../../simple-icon/lib/simple-icon-button.js";class SitePrintButton extends(n(t)){static get styles(){return[...super.styles,i`
        :host {
          display: inline-flex;
      ...
      `]}static get tag(){return"site-print-button"}constructor(){super(),this.icon="icons:print",this.position="bottom",this.type="page",import("../../../../simple-tooltip/simple-tooltip.js")}render(){return e`
      <simple-icon-button
        .id="btn${this.type}"
        icon="${this.icon}"
        @click="${this.print}"
