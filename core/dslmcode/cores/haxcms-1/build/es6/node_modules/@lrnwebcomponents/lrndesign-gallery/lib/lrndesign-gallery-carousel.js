 ...
 */
import{LitElement as e,html as i,css as t}from"../../../lit-element/lit-element.js";import{LrndesignGalleryBehaviors as s}from"./lrndesign-gallery-behaviors.js";import"../../simple-tooltip/simple-tooltip.js";import"../../../@polymer/iron-image/iron-image.js";import"../../../@polymer/iron-icons/iron-icons.js";import"./lrndesign-gallery-zoom.js";import"./lrndesign-gallery-details.js";class LrndesignGalleryCarousel extends s{static get tag(){return"lrndesign-gallery-carousel"}static get styles(){return[...super.styles,t`
        :host {
          margin: 15px 0;
          padding: 0;
        ...
        >
          ...
          <div id="carouselimage">
            <iron-image
              ...
              sizing="${this.selected.sizing||"contain"===this.sizing||"cover"}"
            ...
            <div id="thumbnails" class="item-info" ?hidden="${this.hideNav}">
              ...
              ${this.sources.map(e=>i`
                  <button
                    ...
                    .style="--lrndesign-gallery-thumb-url:url(${e.thumbnail});background-size:${e.sizing||this.sizing||"cover"};background-position:${e.gravity?e.gravity.replace("-"," "):"center"}"
                  >
                    <span class="sr-only"
                      >${e.alt||`Item ${parseInt(e.index)+1}`}</span
                    >
                  </button>
                  <simple-tooltip
                    .for="${e.id}"
    ...
    `}static get properties(){return{...super.properties}}constructor(){super()}get hideNav(){return void 0===this.sources||this.sources.length<2}_onNavTapped(e){this.goToItem(e.index)}}window.customElements.define(LrndesignGalleryCarousel.tag,LrndesignGalleryCarousel);export{LrndesignGalleryCarousel};