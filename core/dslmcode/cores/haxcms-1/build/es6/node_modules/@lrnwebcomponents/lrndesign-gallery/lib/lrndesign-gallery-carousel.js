...
import{LitElement as e,html as i,css as t}from"../../../lit-element/lit-element.js";import{LrndesignGalleryBehaviors as s}from"./lrndesign-gallery-behaviors.js";import"../../../@polymer/iron-image/iron-image.js";import"../../../@polymer/iron-icons/iron-icons.js";import"./lrndesign-gallery-zoom.js";class LrndesignGalleryCarousel extends s{static get tag(){return"lrndesign-gallery-carousel"}static get styles(){return[...super.styles,t`
    ...
    `}static get properties(){return{...super.properties}}constructor(){super()}get hideNav(){return console.log("hideNav",this,this.sources,void 0===this.sources||this.sources.length<2),void 0===this.sources||this.sources.length<2}_onNavTapped(e){this.goToItem(e.index)}}window.customElements.define(LrndesignGalleryCarousel.tag,LrndesignGalleryCarousel);export{LrndesignGalleryCarousel};