 ...
 */
import{LitElement as e,html as t,css as i}from"../../lit-element/lit-element.js";import"./lib/map-menu-builder.js";import"./lib/map-menu-container.js";class MapMenu extends e{static get styles(){return[i`
        :host {
    ...
    `}static get tag(){return"map-menu"}static get properties(){return{disabled:{type:Boolean,reflect:!0},title:{type:String},data:{type:Array},manifest:{type:Object},items:{type:Array},selected:{type:String},activeItem:{type:Object},autoScroll:{type:Boolean,attribute:"auto-scroll"},activeIndicator:{type:Boolean,reflect:!0,attribute:"active-indicator"}}}updated(e){e.forEach((e,t)=>{"data"==t&&this._dataChanged(this[t]),"manifest"==t&&this._manifestChanged(this[t]),"activeItem"==t&&this.refreshActiveChildren(this[t],e),["manifest","items","selected"].includes(t)&&this.dispatchEvent(new CustomEvent(`${t}-changed`,{detail:{value:this[t]}}))})}__activeItemHandler(e){this.activeItem=e.detail}_mapMeuItemHiddenCheckHandler(e){const t=e.detail.action,i=e.detail.hiddenChild;"closed"===t&&!0===i?this.__updateActiveIndicator(this.activeItem,!0):this.__updateActiveIndicator(this.activeItem,!1)}refreshActiveChildren(e,t){e&&(e.setAttribute("active","active"),this.activeIndicator&&this.__updateActiveIndicator(e),this.autoScroll&&this.__scrollHandler(e,{duration:100,scrollElement:this})),t&&(t.removeAttribute("active"),this.__updateActiveIndicator(e))}__scrollHandler(e,t){const i={align:"top",delay:0,duration:300,scrollElement:window},n=Object.assign({},i,t),a=e.getBoundingClientRect(),l=(n.scrollElement.getBoundingClientRect(),n.scrollElement.getBoundingClientRect().bottom-n.scrollElement.getBoundingClientRect().top),s=a.bottom-a.top,o=n.scrollElement.scrollTop;let r=e.getBoundingClientRect().top-n.scrollElement.getBoundingClientRect().top;switch(r-=l/2,n.align){case"center":r+=s/2;break;case"bottom":r+=s}let c=null;requestAnimationFrame((function animation(e){null===c&&(c=e);let t=e-c,i=function ease(e,t,i,n){return(e/=n/2)<1?i/2*e*e+t:-i/2*(--e*(e-2)-1)+t}(t,o,r,n.duration);n.scrollElement.scrollTop=i,t<n.duration&&requestAnimationFrame(animation)}))}_manifestChanged(e){e&&(this.data=e.items)}_dataChanged(e){const t=[];e&&(e.forEach(e=>{e.parent||t.push(e)}),t.forEach((t,i)=>{this._setChildren(t,e)}),this.items=[...t])}_setChildren(e,t){const i=t.filter(t=>e.id===t.parent);e.children=i,e.children.length>0&&e.children.forEach(e=>{this._setChildren(e,t)})}__hasChildren(e){return e.children.length>0}__linkClickedHandler(e){this.selected=e.detail.id,this.dispatchEvent(new CustomEvent("selected",{bubbles:!0,cancelable:!0,composed:!0,detail:e.detail.id}))}__toggleUpdated(e){const t=e.detail.opened?"opened":"closed",i=e.path[0];void 0!==this.activeItem&&(this.__updateActiveIndicator(this.activeItem,!1),this.activeItem.dispatchEvent(new CustomEvent("map-menu-item-hidden-check",{bubbles:!0,cancelable:!0,composed:!0,detail:Object.assign({},{action:t,target:i})})))}__isInViewport(e){const t=this.__getScrollParent(e);if(!t)return!1;var i=e.offsetTop,n=i+e.offsetHeight,a=t.offsetTop,l=a+t.offsetHeight;return n>a&&i<l}__getScrollParent(e){return null==e?null:e.scrollHeight>e.clientHeight?e:this.__getScrollParent(e.parentNode)}__updateActiveIndicator(e,t=!1){setTimeout(()=>{const i=this.shadowRoot.querySelector("#activeindicator"),n=e.offsetLeft,a=e.offsetTop,l=e.offsetWidth,s=t?0:e.offsetHeight;i.setAttribute("style",`width:${l}px;height:${s}px;top:${a}px;left:${n}px`)},200)}__parentsHidden(e){const t=e.parentNode;return null==t?null:"MAP-MENU-SUBMENU"===t.tagName&&!t.opened||"MAP-MENU"!==t.tagName&&this.__parentsHidden(t)}}window.customElements.define(MapMenu.tag,MapMenu);export{MapMenu};