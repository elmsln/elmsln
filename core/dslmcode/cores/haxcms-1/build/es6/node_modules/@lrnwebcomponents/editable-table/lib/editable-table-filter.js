import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import"../../../@polymer/paper-button/paper-button.js";import"../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../@polymer/iron-icons/iron-icons.js";import"./editable-table-iconset.js";class EditableTableFilter extends PolymerElement{static get template(){return html`
      ...
      >
    `}static get tag(){return"editable-table-filter"}static get properties(){return{columnIndex:{type:Number,value:null},filtered:{type:Boolean,value:!1,reflectToAttribute:!0},text:{type:String,value:""}}}_getPressed(filtered){return filtered?"true":"false"}_onFilterClicked(){this.dispatchEvent(new CustomEvent("toggle-filter",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}window.customElements.define(EditableTableFilter.tag,EditableTableFilter);export{EditableTableFilter};