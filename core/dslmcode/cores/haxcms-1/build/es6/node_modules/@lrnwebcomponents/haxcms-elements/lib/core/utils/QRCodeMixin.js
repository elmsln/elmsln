import{css as t,html as e}from"../../../../../lit/index.js";import{store as o}from"../haxcms-site-store.js";const QRCodeMixin=function(i){return class extends i{constructor(){super(),this.showQRCode=!1,this.t||(this.t={}),this.t&&(this.t={...this.t,currentPage:"Current page"})}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),this.qrcodebtn=this.shadowRoot.querySelector("#qrcodebtn"),this.shadowRoot.querySelector("#qrcodepopover").target=this.qrcodebtn}static get styles(){let e=[];return super.styles&&(e=super.styles),[...e,t`
