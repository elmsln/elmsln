import{css as t,html as e}from"../../../../../lit/index.js";import{store as o}from"../haxcms-site-store.js";import"../../../../hax-iconset/lib/simple-hax-iconset.js";import{HAXCMSI18NMixin as i}from"./HAXCMSI18NMixin.js";const QRCodeMixin=function(s){return class extends(i(s)){constructor(){super(),this.showQRCode=!1,this.t=this.t||{},this.t={...this.t,currentPage:"Current page"}}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),this.shadowRoot.querySelector("#qrcodepopover")&&(this.qrcodebtn=this.shadowRoot.querySelector("#qrcodebtn"),this.shadowRoot.querySelector("#qrcodepopover").target=this.qrcodebtn)}static get styles(){let e=[];return super.styles&&(e=super.styles),[...e,t`
        ...
        `]}QRCodeButton(t="left"){return import("../../../../simple-icon/lib/simple-icon-button-lite.js"),import("../../../../simple-popover/simple-popover.js"),import("../../../../simple-tooltip/simple-tooltip.js"),import("../../../../q-r/q-r.js"),e`
        <div
          id="qrcodebtnwrapper"
        ...
        >
          <simple-icon-button-lite
            ...
            id="qrcodebtn"
          ></simple-icon-button-lite>
          <simple-tooltip for="qrcodebtn" position="${t}">
            ${this.t.currentPage}
          </simple-tooltip>
          <simple-popover
