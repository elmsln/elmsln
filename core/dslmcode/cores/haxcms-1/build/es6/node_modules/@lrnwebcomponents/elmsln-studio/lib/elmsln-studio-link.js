...
import{LitElement as t,html as e,css as i}from"../../../lit-element/lit-element.js";import{navigator as o}from"../../../lit-element-router/lit-element-router.js";import"../../simple-icon/lib/simple-icon-lite.js";class ElmslnStudioLink extends(o(t)){static get tag(){return"elmsln-studio-link"}static get properties(){return{disabled:{type:Boolean,reflect:!0},href:{type:String},icon:{type:String,reflect:!0}}}static get styles(){return i`
    ...
    `}linkClick(t){t.preventDefault(),t.stopPropagation(),this.disabled||this.navigate(this.href)}}customElements.define("elmsln-studio-link",ElmslnStudioLink);export{ElmslnStudioLink};