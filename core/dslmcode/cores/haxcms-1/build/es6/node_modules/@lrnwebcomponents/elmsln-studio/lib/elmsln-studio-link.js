 ...
 */
import{LitElement as t,html as e,css as i}from"../../../lit-element/lit-element.js";import{navigator as o}from"../../../lit-element-router/lit-element-router.js";class ElmslnStudioLink extends(o(t)){static get tag(){return"elmsln-studio-link"}static get properties(){return{href:{type:String}}}static get styles(){return i`
      :host {
        display: block;
      }
      :host([hidden]) {
    ...
    `}linkClick(t){t.preventDefault(),this.navigate(this.href)}}customElements.define("elmsln-studio-link",ElmslnStudioLink);export{ElmslnStudioLink};