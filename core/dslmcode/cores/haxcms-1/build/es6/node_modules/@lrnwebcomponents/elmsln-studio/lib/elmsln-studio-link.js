 ...
 */
import{LitElement as t,html as e,css as o}from"../../../lit-element/lit-element.js";import{navigator as i}from"../../../lit-element-router/lit-element-router.js";import"../../../@polymer/iron-icon/iron-icon.js";import"../../../@polymer/iron-icons/iron-icons.js";class ElmslnStudioLink extends(i(t)){static get tag(){return"elmsln-studio-link"}static get properties(){return{disabled:{type:Boolean,reflect:!0},href:{type:String},icon:{type:String,reflect:!0}}}static get styles(){return o`
      :host {
        display: block;
      }
      :host([hidden]) {
    ...
    `}linkClick(t){t.preventDefault(),t.stopPropagation(),this.disabled||this.navigate(`${window.ElmslnStudioPath||""}${this.href}`)}}customElements.define("elmsln-studio-link",ElmslnStudioLink);export{ElmslnStudioLink};