 ...
 */
import{LitElement as t,html as o,css as e}from"../../../../lit-element/lit-element.js";const RichTextEditorButtonStyles=function(t){return class extends t{static get tag(){return"rich-text-editor-button-styles"}static get styles(){return[e`
          :host {
        ...
        `]}}};class RichTextEditorButtonStylesEl extends(RichTextEditorButtonStyles(t)){}window.customElements.define(RichTextEditorButtonStylesEl.tag,RichTextEditorButtonStylesEl);export{RichTextEditorButtonStylesEl,RichTextEditorButtonStyles};