...
import{LitElement as t,html as e,css as s}from"../../../lit/index.js";import{editableTableCellStyles as o}from"./editable-table-behaviors.js";import"../../simple-icon/lib/simple-icon-lite.js";import"../../simple-icon/lib/simple-icons.js";import"../../hax-iconset/lib/simple-hax-iconset.js";import{SimpleToolbarButtonBehaviors as i}from"../../simple-toolbar/lib/simple-toolbar-button.js";class EditableTableSort extends(i(t)){static get styles(){return[...super.styles||[],...o,s`
      ...
      `]}static get tag(){return"editable-table-sort"}static get properties(){return{...super.properties,columnIndex:{attribute:"column-index",type:Number,reflect:!0},sortMode:{attribute:"sort-mode",type:String,reflect:!0},sortColumn:{attribute:"sort-column",type:Number,reflect:!0}}}render(){return e`
      <div>
        <slot id="cell"></slot>
