 ...
 */
import{LitElement as e,html as t,css as i}from"../../../lit-element/lit-element.js";import{AccentCard as s}from"../../accent-card/accent-card.js";import"../../../@github/time-elements/dist/time-elements.js";import"../../nav-card/nav-card.js";import"../../hexagon-loader/hexagon-loader.js";import"./elmsln-studio-link.js";import"./elmsln-studio-button.js";const ElmslnStudioUtilities=function(e){return class extends e{static get properties(){return{...super.properties,demoMode:{type:Boolean,attribute:"demo-mode",reflect:!0}}}constructor(){super(),this.demoMode=!1,import("../../../@polymer/iron-ajax/iron-ajax.js"),import("../../../@polymer/iron-icon/iron-icon.js"),import("../../../@polymer/iron-icons/iron-icons.js"),import("../../lrndesign-avatar/lrndesign-avatar.js"),import("../../simple-tooltip/simple-tooltip.js")}get defaultModalToolbars(){return{bottom:{id:"bottom",type:"toolbar-group",contents:["prevbutton","homebutton","rotategroup","zoomgroup","pageXofY","pangroup","fullscreenbutton","nextbutton"]}}}sortDates(e,t=!1){return e.sort((e,i)=>{let s="string"==typeof e.date?Date.parse(e.date):e.date,o="string"==typeof i.date?Date.parse(i.date):i.date;return t?s-o:o-s})}addDays(e=new Date,t=0){return new Date(Date.parse(e)+864e5*t)}addWeeks(e=new Date,t=0){return new Date(Date.parse(e)+6048e5*t)}toArray(e,t){return Object.keys(e||{}).map(i=>{let s=e[i];return s.id=i,Object.keys(t||{}).forEach(e=>s[e]=t[e]),s})}isEarly(e,t){return new Date(e)>(new Date(t)||new Date)}onTime(e,t){return new Date(e)===(new Date(t)||new Date)}isLate(e,t){return new Date(e)<(t?new Date(t):new Date)}getStatus(e,t,i,s,o,r){let n=!!e&&!!e.date&&!!t.date&&e.date>t.date;return!e&&!!t.date&&this.isLate(t.date)?i:n?s:e?o:r}getStatusIcon(e,t){return this.getStatus(e,t,"report-problem","assignment-late","assignment-turned-in","assignment")}getStatusColor(e,t){return this.getStatus(e,t,"red","amber","green","grey")}getStatusMessage(e,t){return this.getStatus(e,t,"Overdue","Submitted Late","Submitted","Not Submitted")}_recentArray(e){return this.sortDates(this.toArray(e))}getAncestor(e,t){if(e&&t&&t.length>0){t[0][1];let i=t[0][0],s=e[""+t[0][1]];return this.getAncestor(i[s],t.slice(1))}return e}getFigures(e,i="src",s="alt",o="full",r="longdesc"){return(e||[]).map(e=>({src:e[o]||e[i],info:e[s]&&e[r]?t`
                  <p>${e[s]}:</p>
                  <div>${e[r]}</div>
                `:e[s]?t` ${e[s]} `:t` ${e[r]} `})).filter(e=>!!e.src)}getThumnailGrid(e){return t`
        <div class="thumbnail-grid">
          ${(e.sources||[]).map((i,s)=>t`
              ...
              >
                <button
                  id="view-thumb-${e.id}"
                  .style="${this.getThumbailStyle(i.src)}"
                >
      ...
      `}loading(e,i,s="small"){return i?t`<hexagon-loader
          ...
          >
            ...
            color="${e}"
          >
          </hexagon-loader>`}submitData(e,t){console.log("submitData",e,t),this.dispatchEvent(new CustomEvent("submit-data",{bubbles:!0,cancelable:!0,composed:!0,detail:{type:e,data:t}}))}fetchData(e,t=!1){console.log("fetchData",e,t),this.dispatchEvent(new CustomEvent("fetch-data",{bubbles:!0,cancelable:!0,composed:!0,detail:{type:e,refresh:t}}))}_handleLinkButton(e,t){location.href=t,this.dispatchEvent(new CustomEvent("link-button-click",{bubbles:!0,cancelable:!0,composed:!0,detail:t}))}}};export{ElmslnStudioUtilities};