import{html as e,PolymerElement as o}from"../../../@polymer/polymer/polymer-element.js";import{AppLocalizeBehavior as t}from"../../../@polymer/app-localize-behavior/app-localize-behavior.js";import{mixinBehaviors as s}from"../../../@polymer/polymer/lib/legacy/class.js";import{afterNextRender as r}from"../../../@polymer/polymer/lib/utils/render-status.js";import"../../../@polymer/iron-flex-layout/iron-flex-layout-classes.js";class EcoJsonSchemaFieldset extends(s([t],o)){static get tag(){return"eco-json-schema-fieldset"}constructor(){super()}static get template(){return e`
    ...
    `}static get properties(){return{propertyName:{type:String,value:null},schema:{type:Object,value:{}}}}ready(){super.ready(),this._schemaChanged()}_schemaChanged(){r(this,()=>{this.shadowRoot.querySelectorAll(".item-fields").forEach((e,o)=>{let t=""+this.propertyName;this.dispatchEvent(new CustomEvent("build-fieldset",{bubbles:!1,cancelable:!0,composed:!0,detail:{container:e,path:t,prefix:t,properties:this.schema.properties,type:EcoJsonSchemaFieldset.tag,value:this.schema.properties[o].value||{}}}))})})}}window.customElements.define(EcoJsonSchemaFieldset.tag,EcoJsonSchemaFieldset);export{EcoJsonSchemaFieldset};