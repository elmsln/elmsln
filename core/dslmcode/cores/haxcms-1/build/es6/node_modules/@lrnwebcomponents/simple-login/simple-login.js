 ...
 */
import{css as e,html as r}from"../../lit-element/lit-element.js";import{SimpleColors as t}from"../simple-colors/simple-colors.js";import"../simple-progress/simple-progress.js";import"../simple-fields/lib/simple-fields-field.js";class SimpleLogin extends t{static get styles(){return[...super.styles,e`
        :host {
          display: block;
        }
      ...
      `]}render(){return r` <div id="loginform">
    ...
    </div>`}static get properties(){return{...super.properties,title:String,subtitle:String,errorMsg:String,username:{type:String},password:{type:String},loading:{type:Boolean},userInputLabel:{type:String,attribute:"user-input-label"},userInputErrMsg:{type:String},passwordInputLabel:{type:String,attribute:"password-input-label"},passwordInputErrMsg:{type:String},loginBtnText:{type:String,attribute:"login-btn-text"}}}static get tag(){return"simple-login"}constructor(){super(),this.password="",this.username="",this.loading=!1,this.userInputLabel="User name",this.userInputErrMsg="User name required",this.passwordInputLabel="Password",this.passwordInputErrMsg="Password required",this.loginBtnText="Login"}updated(e){super.updated(),e.forEach(((e,r)=>{["username","password"].includes(r)&&this.dispatchEvent(new CustomEvent(`${r}-changed`,{detail:{value:this[r]}}))}))}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),setTimeout((()=>{this.shadowRoot.querySelector("#loginform").addEventListener("keypress",this._keyPressLogin.bind(this))}),0)}_keyPressLogin(e){if(13==e.keyCode)return this._login(),!1}_passwordChanged(e){this.password=e.detail.value}_usernameChanged(e){this.username=e.detail.value}_login(){this.shadowRoot.querySelector("#userinput").validate()&&this.shadowRoot.querySelector("#passinput").validate()&&this.dispatchEvent(new CustomEvent("simple-login-login",{cancelable:!0,bubbles:!0,composed:!0,detail:{u:this.shadowRoot.querySelector("#userinput").value,p:this.shadowRoot.querySelector("#passinput").value}}))}}customElements.define(SimpleLogin.tag,SimpleLogin);export{SimpleLogin};