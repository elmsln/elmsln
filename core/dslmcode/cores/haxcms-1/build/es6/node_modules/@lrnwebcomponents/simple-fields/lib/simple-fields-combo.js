import{LitElement as t,html as i,css as e}from"../../../lit-element/lit-element.js";import{SimpleFieldsFieldBehaviors as s}from"./simple-fields-field.js";class SimpleFieldsCombo extends(s(t)){static get tag(){return"simple-fields-combo"}static get styles(){return[...super.styles,e`
        :host([expanded]) {
          overflow: visible;
        }
        :host(:focus-within),
      ...
      <div class="field-main" part="field-main" ?hidden="${this.hidden}">
        ...
        <div id="field-main-inner" part="field-main-inner">
          ...
          <ul
            ...
            data-options="${this.filteredOptions.map((t=>t.text)).join()}"
            ?hidden="${this.hidden||!this.expanded||this.filteredOptions.length<1}"
            id="${this.id}-list"
            @mouseout="${this._onListboxMouseout}"
            @mouseover="${this._onListboxMouseover}"
            role="listbox"
          >
            ${(this.filteredOptions||[]).map((t=>i`
                <li
                  aria-selected="${this._isSelected(t)}"
                  id="${this.id}.${t.textComparison}"
                  role="option"
