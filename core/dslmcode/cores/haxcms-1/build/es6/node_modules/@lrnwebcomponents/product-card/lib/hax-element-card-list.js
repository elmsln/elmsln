            ...
            ${this.productList.map((e,a)=>t`
                ...
                >
                  ...
                  <div slot="details-collapse-content">
                    <ul>
                      <li>
                        <strong>Tags:</strong> ${e.schema.gizmo.groups.map(e=>t` ${e}, `)}
                      </li>
