 ...
 */
import{LitElement as e,html as t,css as i}from"../../lit/index.js";import{SimpleColors as o}from"../simple-colors/simple-colors.js";import{SchemaBehaviors as r}from"../schema-behaviors/schema-behaviors.js";import{MediaBehaviorsVideo as a}from"../media-behaviors/media-behaviors.js";import{IntersectionObserverMixin as s}from"../intersection-element/lib/IntersectionObserverMixin.js";import"../a11y-media-player/a11y-media-player.js";import{I18NMixin as n}from"../i18n-manager/lib/I18NMixin.js";class VideoPlayer extends(s(a(r(n(o))))){static get styles(){return[...super.styles,i`
:host {
  display: block;
  margin: 0 0 15px;
...
${this.elementVisible?t`${this.isA11yMedia?t`
      <a11y-media-player
        ...
        .width="${this.width}"
        .height="${this.height}"
        .youtubeId="${this.youtubeId||void 0}"
        >
      </a11y-media-player><slot hidden></slot>`:t`
      <div class="responsive-video-container" .lang="${this.lang||void 0}">
        ${this.sandboxed?t``:t`
          <webview
    ...
    `}get iframed(){return!(!(this.sourceData&&this.sourceData.length>0&&void 0!==this.sourceData[0]&&window.MediaBehaviors.Video._sourceIsIframe(this.sourceData[0].src))||this.sandboxed)}get isA11yMedia(){return!this.sandboxed&&("youtube"==this.sourceType||"local"==this.sourceType||this.sourceData.length<1)}get observer(){return new MutationObserver((()=>this.setSourceData()))}get sandboxed(){if(this.sourceData&&this.sourceData.length>0&&void 0!==typeof this.sourceData[0]&&window.MediaBehaviors.Video._sourceIsIframe(this.sourceData[0].src)){if("function"==typeof document.createElement("webview").reload)return!0}return!1}get sourceProperties(){let e="string"==typeof this.sources?JSON.parse(this.sources):(this.sources||[]).slice();return this.source&&e.unshift({src:this.source}),e&&e.length>0&&e.forEach((e=>{e.type=e.type||this._computeMediaType(e.src),e.src=this._computeSRC(e.src,e.type)})),e}get trackProperties(){let e="string"==typeof this.tracks?JSON.parse(this.tracks):(this.tracks||[]).slice();return this.track&&e.unshift({src:this.track}),e&&e.length>0&&e.forEach((e=>{e.srclang=e.srclang||this.lang,e.kind=e.kind||"subtitles",e.label=e.label||e.kind||e.lang})),e}get sourceData(){let e=(this.sourceProperties||[]).slice();return this.querySelectorAll("video source, audio source, iframe").forEach((e=>{this.sources.filter((t=>t.src===e.src)).length<1&&this.sources.unshift({src:e.src,type:e.type||this._computeMediaType(e.src)})})),e}get audioOnly(){return this.sourceData.filter((e=>e.type.indexOf("audio")>-1)).length>1}get standAlone(){return void 0===this.trackData||null===this.trackData||this.trackData.length<1}get sourceType(){return this.sourceData&&this.sourceData.length>0&&void 0!==this.sourceData[0]&&void 0!==this.sourceData[0].src?window.MediaBehaviors.Video.getVideoType(this.sourceData[0].src):null}get trackData(){let e="string"==typeof this.tracks?(JSON.parse(this.tracks)||[]).slice():(this.tracks||[]).slice();return this.querySelectorAll("video track, audio track").forEach((e=>{if(this.tracks.filter((t=>t.src===e.src)).length<1){let t={src:e.src};e.lang&&(t.lang=e.lang),e.srclang&&(t.srclang=e.srclang),e.label&&(t.label=e.label),e.kind&&(t.kind=e.kind),this.tracks.unshift(t)}e.remove()})),void 0!==this.track&&null!==this.track&&""!==this.track&&e.push({src:this.track,srclang:this.lang,label:"en"===this.lang?"English":this.lang,kind:"subtitles"}),e}get youtubeId(){if(this.sourceData&&this.sourceData[0]&&"youtube"===this.sourceType)return this._computeSRC(this.sourceData[0].src).replace(/.*\/embed\//,"")}get playerId(){return`${this.id||this.schemaResourceID}-media`}_computeMediaType(e){let t="",findType=(i,o)=>{o.forEach((o=>{""===t&&void 0!==typeof e&&null!==e&&e.toLowerCase().indexOf("."+o)>-1&&(t=i+"/"+o)}))};return findType("audio",["aac","flac","mp3","oga","wav"]),findType("video",["mov","mp4","ogv","webm"]),t}_computeSRC(e,t){return null!==e&&void 0!==typeof e&&(t=t||window.MediaBehaviors.Video.getVideoType(e),e=window.MediaBehaviors.Video.cleanVideoSource(e,t),"vimeo"==t?(this.vimeoTitle?e+="?title=1":e+="?title=0",this.vimeoByline?e+="&byline=1":e+="&byline=0",this.vimeoPortrait?e+="&portrait=1":e+="&portrait=0"):"dailymotion"==t&&(e+="&ui-start-screen-info=false",e+="&ui-logo=false",e+="&sharing-enable=false",e+="&endscreen-enable=false")),e}haxHooks(){return{postProcessNodeToContent:"haxpostProcessNodeToContent"}}haxpostProcessNodeToContent(e){return e=(e=e.replace(' sources="[]",',"")).replace(' tracks="[]",',"")}setSourceData(){let e=this.source;this.source="",this.source=e}playEvent(e){this.playing=e.detail.__playing}pauseEvent(e){this.playing=e.detail.__playing}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),e.forEach(((e,t)=>{"allowBackgroundPlay"===t&&this[t]&&this.__setVisChange?(this.__setVisChange=!1,document.removeEventListener("visibilitychange",this._visChange.bind(this))):"allowBackgroundPlay"!==t||this[t]||this.__setVisChange||(this.__setVisChange=!0,document.addEventListener("visibilitychange",this._visChange.bind(this)))}))}_visChange(e){"visible"===document.visibilityState&&!this.playing&&this.__forcePaused?(this.__forcePaused=!1,this.shadowRoot.querySelector("a11y-media-player").togglePlay()):"hidden"===document.visibilityState&&this.playing&&(this.__forcePaused=!0,this.shadowRoot.querySelector("a11y-media-player").togglePlay())}}window.customElements.define(VideoPlayer.tag,VideoPlayer);export{VideoPlayer};