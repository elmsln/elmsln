 ...
 */
import"../a11y-media-player/a11y-media-player.js";import{I18NMixin as e}from"../i18n-manager/lib/I18NMixin.js";import{IntersectionObserverMixin as t}from"../intersection-element/lib/IntersectionObserverMixin.js";import{MediaBehaviorsVideo as i}from"../media-behaviors/media-behaviors.js";import{SchemaBehaviors as s}from"../schema-behaviors/schema-behaviors.js";import{SimpleColors as r}from"../simple-colors/simple-colors.js";import{css as o,html as a}from"../../lit/index.js";class VideoPlayer extends(t(i(s(e(r))))){static get styles(){return[...super.styles,o`
        :host {
          display: block;
          margin: 0 0 15px;
      ...
      `]}render(){return a` ${this.elementVisible?a`${this.isA11yMedia?a` <a11y-media-player
              ...
              >
                ...
                ${this.sandboxed||!this.iframed?a``:a`
                      <iframe
                        loading="lazy"
                        resource="${this.schemaResourceID}-video"
                        .src="${this.sourceData&&this.sourceData[0]&&this.sourceData[0].src||void 0}"
    ...
    `}get iframed(){return!(!(this.sourceData&&this.sourceData.length>0&&void 0!==this.sourceData[0]&&window.MediaBehaviors.Video._sourceIsIframe(this.sourceData[0].src))||this.sandboxed)}get isA11yMedia(){return!this.sandboxed&&("youtube"==this.sourceType||"local"==this.sourceType||this.sourceData.length<1)}get observer(){return new MutationObserver((()=>this.setSourceData()))}get sandboxed(){if(this.sourceData&&this.sourceData.length>0&&void 0!==typeof this.sourceData[0]&&window.MediaBehaviors.Video._sourceIsIframe(this.sourceData[0].src)){if("function"==typeof document.createElement("webview").reload)return!0}return!1}get sourceProperties(){let e="string"==typeof this.sources?JSON.parse(this.sources):(this.sources||[]).slice();return this.source&&e.unshift({src:this.source}),e&&e.length>0&&e.forEach((e=>{e.type=e.type||this._computeMediaType(e.src),e.src=this._computeSRC(e.src,e.type)})),e}get trackProperties(){let e="string"==typeof this.tracks?JSON.parse(this.tracks):(this.tracks||[]).slice();return this.track&&e.unshift({src:this.track}),e&&e.length>0&&e.forEach((e=>{e.srclang=e.srclang||this.lang,e.kind=e.kind||"subtitles",e.label=e.label||e.kind||e.lang})),e}get sourceData(){let e=(this.sourceProperties||[]).slice();return this.querySelectorAll("video source, audio source, iframe").forEach((e=>{this.sources.filter((t=>t.src===e.src)).length<1&&this.sources.unshift({src:e.src,type:e.type||this._computeMediaType(e.src)})})),e}get audioOnly(){return this.sourceData.filter((e=>e.type.indexOf("audio")>-1)).length>1}get standAlone(){return void 0===this.trackData||null===this.trackData||this.trackData.length<1}get trackData(){let e="string"==typeof this.tracks?(JSON.parse(this.tracks)||[]).slice():(this.tracks||[]).slice();return this.querySelectorAll("video track, audio track").forEach((e=>{if(this.tracks.filter((t=>t.src===e.src)).length<1){let t={src:e.src};e.lang&&(t.lang=e.lang),e.srclang&&(t.srclang=e.srclang),e.label&&(t.label=e.label),e.kind&&(t.kind=e.kind),this.tracks.unshift(t)}e.remove()})),void 0!==this.track&&null!==this.track&&""!==this.track&&e.push({src:this.track,srclang:this.lang,label:"en"===this.lang?"English":this.lang,kind:"subtitles"}),e}get youtubeId(){if(this.sourceData&&this.sourceData[0]&&"youtube"===this.sourceType)return this._computeSRC(this.sourceData[0].src).replace(/.*\/embed\//,"")}get playerId(){return`${this.id||this.schemaResourceID}-media`}_computeMediaType(e){let t="",findType=(i,s)=>{s.forEach((s=>{""===t&&void 0!==typeof e&&null!==e&&e.toLowerCase().indexOf("."+s)>-1&&(t=i+"/"+s)}))};return findType("audio",["aac","flac","mp3","oga","wav"]),findType("video",["mov","mp4","ogv","webm"]),t}_computeSRC(e,t){return null!==e&&void 0!==typeof e&&(t=t||window.MediaBehaviors.Video.getVideoType(e),e=window.MediaBehaviors.Video.cleanVideoSource(e,t),"vimeo"==t?(this.vimeoTitle?e+="?title=1":e+="?title=0",this.vimeoByline?e+="&byline=1":e+="&byline=0",this.vimeoPortrait?e+="&portrait=1":e+="&portrait=0"):"twitch"==t&&(e.indexOf("?")>-1?e+="&parent="+window.location.hostname:e+="?parent="+window.location.hostname)),e}haxHooks(){return{postProcessNodeToContent:"haxpostProcessNodeToContent"}}haxpostProcessNodeToContent(e){return e=(e=e.replace(' sources="[]",',"")).replace(' tracks="[]",',"")}setSourceData(){let e=this.source;this.source="",this.source=e,this.sourceData&&this.sourceData.length>0&&void 0!==this.sourceData[0]&&void 0!==this.sourceData[0].src&&(this.sourceType=window.MediaBehaviors.Video.getVideoType(this.sourceData[0].src))}playEvent(e){this.playing=e.detail.__playing}pauseEvent(e){this.playing=e.detail.__playing}updated(e){super.updated(e),e.forEach(((e,t)=>{if("source"===t&&this.sourceType&&void 0!==e){let e=window.MediaBehaviors.Video.getVideoType(this.sourceData[0].src);e!=this.sourceType&&(this.sourceType=e,this.elementVisible&&(this.elementVisible=!1,setTimeout((()=>{this.elementVisible=!0}),0)))}}))}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),e.forEach(((e,t)=>{"allowBackgroundPlay"===t&&this[t]&&this.__setVisChange?(this.__setVisChange=!1,this.windowControllers.abort()):"allowBackgroundPlay"!==t||this[t]||this.__setVisChange||(this.__setVisChange=!0,this.windowControllers=new AbortController,document.addEventListener("visibilitychange",this._visChange.bind(this),{signal:this.windowControllers.signal}))})),this.sourceData&&this.sourceData.length>0&&void 0!==this.sourceData[0]&&void 0!==this.sourceData[0].src&&(this.sourceType=window.MediaBehaviors.Video.getVideoType(this.sourceData[0].src))}_visChange(e){"visible"===document.visibilityState&&!this.playing&&this.__forcePaused?(this.__forcePaused=!1,this.shadowRoot.querySelector("a11y-media-player").togglePlay()):"hidden"===document.visibilityState&&this.playing&&(this.__forcePaused=!0,this.shadowRoot.querySelector("a11y-media-player").togglePlay())}}customElements.define(VideoPlayer.tag,VideoPlayer);export{VideoPlayer};