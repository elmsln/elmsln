import{LitElement as e,html as t,css as i}from"../../../lit-element/lit-element.js";import"../../simple-icon/lib/simple-icon-button-lite.js";export const SimpleTagLiteSuper=function(e){return class extends e{static get properties(){let e={};return super.properties&&(e=super.properties),{...e,readonly:{type:Boolean,reflect:!0},icon:{type:String},disabled:{type:Boolean,reflect:!0},value:{type:String},data:{type:Object},cancelButton:{type:Boolean,attribute:"cancel-button"},toggles:{type:Boolean,attribute:"toggles"},toggled:{type:Boolean,attribute:"toggled"},toggledIcon:{type:String,attribute:"toggled-icon"}}}constructor(){super(),this.data={},this.icon="cancel",this.cancelButton=!1,this.disabled=!1,this.readonly=!1}static get styles(){let e=[];return super.styles&&(e=super.styles),[...e,i`
          :host {
            display: inline-flex;
            align-items: center;
            color: var(
