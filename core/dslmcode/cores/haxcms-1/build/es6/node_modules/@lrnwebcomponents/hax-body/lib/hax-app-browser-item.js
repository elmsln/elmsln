import{LitElement,html,css}from"../../../lit-element/lit-element.js";import{SimpleColors}from"../../simple-colors/simple-colors.js";class HAXAppBrowserItem extends LitElement{static get tag(){return"hax-app-browser-item"}static get properties(){return{title:{type:String},index:{type:Number},icon:{type:String},image:{type:String,value:!1},color:{type:String},hexColor:{type:String,attribute:"hex-color"},author:{type:String},description:{type:String},examples:{type:Array},status:{type:Array},elevation:{type:Number,reflect:!0}}}constructor(){super(),this.elevation=1,import("../../../@polymer/paper-button/paper-button.js"),import("../../../@polymer/iron-icon/iron-icon.js"),import("../../../@polymer/iron-image/iron-image.js")}static get styles(){return[css`
        :host {
          display: block;
        }
        :host([elevation="1"]) {
