import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import{SchemaBehaviors}from"../schema-behaviors/schema-behaviors.js";import{SimpleColors}from"../simple-colors/simple-colors.js";import"../chartist-render/chartist-render.js";class ProgressDonut extends(SchemaBehaviors(PolymerElement)){constructor(){super(),afterNextRender(this,function(){this.HAXWiring=new HAXWiring,this.HAXWiring.setup(ProgressDonut.haxProperties,ProgressDonut.tag,this)})}static get template(){return html`
      <style>
        :host {
