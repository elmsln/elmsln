      ...
      <div id="primary">
        <div id="profile">
            ...
            <table slot="content">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ${this.profile&&this.profile.given?this.profile.given.length:"unknown"}
                  </td>
                </tr>
                <tr>
                  <th scope="row">Conversations</th>
                  <td>
                    ${this.profile&&this.profile.given&&this.profile.discussions?this.profile.given.length+this.profile.discussions.length:"unknown"}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <nav-card accent-color="green" class="card primary due">
            ...
            <div slot="linklist">
              ${this.profile?(this.profile.due||[]).slice(0,5).map(i=>t`
                        <nav-card-item
                          accent-color="${this._late(i.date)?"red":"grey"}"
                          allow-grey
                          avatar="${this._late(i.date)?"icons:assignment-late":"assignment"}"
                          icon="chevron-right"
                          invert
                        >
                          <elmsln-studio-link
        ...
        <div id="work">
              ...
              ${this.profile?(this.profile.submissions||[]).slice(0,5).map(i=>t`
                        <nav-card-item icon="chevron-right">
                          <elmsln-studio-link
                            ...
                            slot="label"
                            href="/portfolios/${i.portfolioId}?submission=${i.id}"
                          >
                            ${i.assignment}
                          </elmsln-studio-link>
          ...
          >
            ...
            <div slot="linklist">
              ${this.profile?(this.profile.feedback||[]).slice(0,5).map(i=>t`
                        <nav-card-item
                        ...
                        >
                          <elmsln-studio-link
                            ...
                            slot="label"
                            href="/portfolios/${i.portfolioId}?submission${i.submissionId}&comment=${i.id}"
                          >
