 ...
 */
import{LitElement as e,html as n,css as t}from"../../../lit-element/lit-element.js";class AgencyThemeBand extends e{static get styles(){return[t`
        :host {
      ...
      `]}static get tag(){return"agency-theme-band"}render(){return n`
      <div id="wrapper">
        <div id="slice">
    ...
    `}}window.customElements.define(AgencyThemeBand.tag,AgencyThemeBand);export{AgencyThemeBand};