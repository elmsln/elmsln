import{LitElement as t,html as e,css as i}from"../../../lit/index.js";import"../../haxcms-elements/lib/ui-components/site/site-title.js";export class TrainingTop extends t{constructor(){super(),this.id="",this.time=""}static get tag(){return"training-top"}static get properties(){return{presenter:{type:String},id:{type:String},time:{type:String}}}static get styles(){return i`
      :host {
        display: block;
      }
      .wrapper {
