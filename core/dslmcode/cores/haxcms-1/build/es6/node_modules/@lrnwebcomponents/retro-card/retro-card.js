 ...
 */
import{html as t,css as e}from"../../lit/index.js";import{SimpleColors as r}from"../simple-colors/simple-colors.js";class RetroCard extends r{static get styles(){return[super.styles,e`
        :host {
          display: block;
      ...
      `]}render(){return t` ${this.nosource?t`
 <div class="link ${this.color}">
   ${this.__source?t`<img class="img" loading="lazy" src="${this.__source}" alt="" />`:""}
   ...
   ${this.__cardTags?t`<hr />
           <div class="card-tags" part="card-tags">
             ${this.__cardTags.map((e=>t`<span class="project-tag" part="project-tag"
                   >${e.trim()}</span
                 >`))}
           </div>`:""}
 </div>`:t`
