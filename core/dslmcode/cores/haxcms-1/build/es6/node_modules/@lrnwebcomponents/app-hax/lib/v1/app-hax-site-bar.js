import{html as e,css as t,unsafeCSS as i}from"../../../../lit/index.js";import"../../../simple-icon/lib/simple-icons.js";import"../../../simple-icon/lib/simple-icon-button-lite.js";import{SimpleColors as o}from"../../../simple-colors/simple-colors.js";import"../../../simple-tooltip/simple-tooltip.js";import{animate as s}from"../../../../@lit-labs/motion/index.js";const l=new URL("../assets/images/DropDownBorder.svg",import.meta.url);export class AppHaxSiteBars extends o{static get tag(){return"app-hax-site-bar"}constructor(){super(),this.icon="link",this.opened=!1,this.inprogress=!1,this.iconLink="/",this.textInfo={},this.siteId=""}static get properties(){return{...super.properties,opened:{type:Boolean,reflect:!0},icon:{type:String},inprogress:{type:Boolean,reflect:!0},iconLink:{type:String,attribute:"icon-link"},textInfo:{type:Object},siteId:{type:String,reflect:!0,attribute:"site-id"}}}updated(e){super.updated&&super.updated(e),e.forEach(((e,t)=>{"opened"===t&&void 0!==e&&this.dispatchEvent(new CustomEvent(`${t}-changed`,{detail:{value:this[t]}}))}))}static get styles(){return[...super.styles,t`
        :host {
