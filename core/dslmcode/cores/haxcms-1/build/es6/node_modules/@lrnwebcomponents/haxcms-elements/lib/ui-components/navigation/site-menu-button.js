 ...
 */
import{LitElement as t,html as e,css as i}from"../../../../../lit-element/lit-element.js";import{store as o}from"../../core/haxcms-site-store.js";import{autorun as s,toJS as n}from"../../../../../mobx/lib/mobx.module.js";import{HAXCMSThemeParts as r}from"../../core/utils/HAXCMSThemeParts.js";import"../../../../../@polymer/polymer/lib/elements/custom-style.js";class SiteMenuButton extends(r(t)){static get styles(){return[...super.styles,i`
        :host {
          display: block;
          font-size: 16px;
      ...
      `]}static get tag(){return"site-menu-button"}constructor(){super(),this.__disposer=this.__disposer?this.__disposer:[],s(t=>{this.activeRouterManifestIndex=n(o.activeRouterManifestIndex),this.__disposer.push(t)}),s(t=>{this.routerManifest=n(o.routerManifest),this.__disposer.push(t)}),s(t=>{this.editMode=n(o.editMode),this.__disposer.push(t)}),import("../../../../../@polymer/iron-icon/iron-icon.js"),import("../../../../../@polymer/iron-icons/iron-icons.js"),import("../../../../simple-tooltip/simple-tooltip.js"),import("../../../../../@polymer/paper-button/paper-button.js")}render(){return e`
      <custom-style>
        <style>
          paper-button {
