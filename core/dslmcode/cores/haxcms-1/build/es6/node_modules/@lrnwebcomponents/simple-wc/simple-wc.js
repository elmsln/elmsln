 ...
 */
import{LitElement as e,css as t,html as s}from"../../lit-element/lit-element.js";function camelCaseToDash(e){return e.replace(/([A-Z])/g,e=>"-"+e[0].toLowerCase())}export function createSWC(a){let n=class SWC extends e{constructor(){super();for(let e in a.callbacks)this[e]=a.callbacks[e];for(let e in a.data.values)this[e]=a.data.values[e];setTimeout(()=>{a.deps.map(e=>{import("../../"+e)})},0)}static get tag(){return a.name}render(){return a.html(this,s)}static get styles(){return[t`
