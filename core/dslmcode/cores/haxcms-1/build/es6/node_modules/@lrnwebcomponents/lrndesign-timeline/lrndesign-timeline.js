...
import{html as e,css as i}from"../../lit-element/lit-element.js";import{SimpleColors as t}from"../simple-colors/simple-colors.js";import"../responsive-utility/responsive-utility.js";class LrndesignTimeline extends t{render(){return e`
        ...
        <div id="timeline">
          <div id="events" @scroll="${this._checkScroll}">
            ${this.eventsList.map((i,t)=>e`
                <section
                  class="event"
                  ?has-media="${i.imagesrc&&""!==i.imagesrc}"
                >
    ...
    `}static get properties(){return{events:{type:"Array"},timelineSize:{type:"String",reflect:!0,attribute:"timeline-size",value:"xs",timelineTitle:{type:"String",reflect:!0,attribute:"timeline-title"},title:{type:"String",attribute:"title"}}}}static get tag(){return"lrndesign-timeline"}constructor(){super(),this.events=[],this.timelineSize="xs",window.ResponsiveUtility.requestAvailability(),window.dispatchEvent(new CustomEvent("responsive-element",{detail:{element:this,attribute:"timeline-size",relativeToParent:!0,sm:600,md:900,lg:1200,xl:1600}}))}updated(e){super.updated(e),e.forEach((e,i)=>{"timelineTitle"===i&&this.title&&!this.timelineTitle&&(this.timelineTitle=this.title)})}get eventsElement(){return!(!this.shadowRoot||!this.shadowRoot.querySelector("#events"))&&this.shadowRoot.querySelector("#events")}get eventsList(){return("string"==typeof this.events?JSON.parse(this.events):this.events)||[]}_checkScroll(){if(this.shadowRoot){let e=this.shadowRoot.querySelectorAll(".event")||[];e.forEach(i=>{let t=i.offsetTop,n=e[0].offsetTop+50+i.parentNode.scrollTop,s=i.offsetTop+i.offsetHeight;n>t&&n<s?i.setAttribute("selected",!0):i.removeAttribute("selected")})}}}customElements.define(LrndesignTimeline.tag,LrndesignTimeline);export{LrndesignTimeline};