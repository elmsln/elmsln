import{html as t,PolymerElement as e}from"../../../../@polymer/polymer/polymer-element.js";import{dom as a}from"../../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../../@polymer/paper-input/paper-input.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-column.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-sorter.js";import"../../../../@vaadin/vaadin-grid/vaadin-grid-filter.js";import"../../../lrnsys-button/lrnsys-button.js";import"../../../materializecss-styles/materializecss-styles.js";import"../lrnapp-studio-submission/lrnapp-studio-submission-display.js";class LrnappOpenStudioTable extends e{static get template(){return t`
      <custom-style>
    ...
    `}static get tag(){return"lrnapp-open-studio-table"}static get properties(){return{elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},submissions:{type:Array,notify:!0},_numWidth:{type:String,value:"2.25em"},sourcePath:{type:String,notify:!0},basePath:{type:String,notify:!0},activeSubmission:{type:String,value:null,notify:!0}}}_loadProjectRoute(t){var e=a(t).localTarget,i=e.getAttribute("data-project-id"),r=e.getAttribute("data-author-id");this.dispatchEvent(new CustomEvent("route-change",{bubbles:!0,cancelable:!0,composed:!0,detail:{data:{page:"projects"},queryParams:{author:r,project:i}}}))}_loadSubmissionUrl(t){var e=a(t).localTarget.getAttribute("data-submission-id");window.location.href=this.basePath+"lrnapp-studio-submission/submissions/"+e}_handleResponse(t){this.$.loading.hidden=!0}_toArray(t){return null==t?[]:Object.keys(t).map((function(e){return t[e]}))}}window.customElements.define(LrnappOpenStudioTable.tag,LrnappOpenStudioTable);export{LrnappOpenStudioTable};