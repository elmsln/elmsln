 ...
 */
import{LitElement as t,html as e,css as o}from"../../../lit-element/lit-element.js";const A11yMenuButtonItemBehaviors=function(t){return class extends t{static get styles(){return[o`
          :host {
            margin: 0;
            padding: 0;
            display: block;
        ...
        `]}render(){return this.href&&""!==this.href.trim()?this.linkTemplate:this.buttonTemplate}static get tag(){return"a11y-menu-button-item"}static get properties(){return{disabled:{attribute:"disabled",type:Boolean},hidden:{attribute:"hidden",type:Boolean,reflect:!0},href:{attribute:"href",type:String},controls:{attribute:"controls",type:String},slot:{type:String,attribute:"menuitem",reflect:!0}}}constructor(){super()}get linkTemplate(){return e` <li role="none">
        <a
          role="menuitem"
          href="${this.href}"
      ...
      `}focus(){this.shadowRoot&&this.shadowRoot.querySelector("[role=menuitem]")&&this.shadowRoot.querySelector("[role=menuitem]").focus()}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent("add-a11y-menu-button-item",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new CustomEvent("remove-a11y-menu-button-item",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}};class A11yMenuButtonItem extends(A11yMenuButtonItemBehaviors(t)){}window.customElements.define(A11yMenuButtonItem.tag,A11yMenuButtonItem);export{A11yMenuButtonItem,A11yMenuButtonItemBehaviors};