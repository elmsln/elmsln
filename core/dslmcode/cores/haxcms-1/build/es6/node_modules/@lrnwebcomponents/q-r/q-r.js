import{LitElement,html,css}from"../../lit-element/lit-element.js";class QR extends LitElement{static get styles(){return[css`
        :host {
          display: block;
        }
        #link {
      ...
      `]}constructor(){super(),this.modulesize=4,this.margin=2,this.format="png",import("./lib/qr-code.js")}render(){return html`
      <qr-code
        id="qr"
        data="${this.data}"
