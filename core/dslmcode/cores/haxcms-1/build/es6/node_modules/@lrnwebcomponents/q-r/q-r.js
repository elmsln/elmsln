import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";class QR extends PolymerElement{constructor(){super(),import("./lib/qr-code.js"),afterNextRender(this,function(){this.HAXWiring=new HAXWiring,this.HAXWiring.setup(QR.haxProperties,QR.tag,this)})}static get template(){return html`
      <style>
        :host {
          display: block;
        }
