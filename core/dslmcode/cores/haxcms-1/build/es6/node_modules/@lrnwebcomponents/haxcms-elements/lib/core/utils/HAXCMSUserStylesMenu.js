import{css as e,html as s}from"../../../../../lit/index.js";import{normalizeEventPath as t}from"../../../../utils/utils.js";const HAXCMSUserStylesMenuMixin=function(o){return class extends o{constructor(){super(),this.hideUserStylesMenu=!0,this.fontSize=window.localStorage.getItem("haxcms-userPref-fontSize")?window.localStorage.getItem("haxcms-userPref-fontSize"):1,this.fontFamily=window.localStorage.getItem("haxcms-userPref-fontFamily")?window.localStorage.getItem("haxcms-userPref-fontFamily"):0,this.colorTheme=window.localStorage.getItem("haxcms-userPref-colorTheme")?window.localStorage.getItem("haxcms-userPref-colorTheme"):0,this.addEventListener("click",this.checkUserStylesMenuOpen.bind(this))}static get styles(){let s=[];return super.styles&&(s=super.styles),[...s,e`
          :host([font-family="0"]) {
