import{css as e,html as s}from"../../../../../lit/index.js";import{normalizeEventPath as t,localStorageGet as o,localStorageSet as r}from"../../../../utils/utils.js";import{HAXCMSI18NMixin as i}from"./HAXCMSI18NMixin.js";import{toJS as h,autorun as l}from"../../../../../mobx/dist/mobx.esm.js";import{store as a}from"../haxcms-site-store.js";const HAXCMSUserStylesMenuMixin=function(c){return class extends(i(c)){constructor(){super(),this.t=this.t||{},this.t={...this.t,A:"A",increaseFontSize:"Increase font size",decreaseFontSize:"Decrease font size",setFontToSerif:"Set font to serif",setFontToSansSerif:"Set font to sans serif",serif:"Serif",sansSerif:"Sans serif",day:"Day",sepia:"Sepia",night:"Night",textSettings:"Text settings"},this.hideUserStylesMenu=!0,this.fontSize=o("haxcms-userPref-fontSize",1),this.fontFamily=o("haxcms-userPref-fontFamily",0),this.colorTheme=o("haxcms-userPref-colorTheme",0),this.addEventListener("click",this.checkUserStylesMenuOpen.bind(this)),l((()=>{const e=h(a.darkMode);let s=o("haxcms-userPref-colorTheme",0);this.colorTheme=e?2:2===s?0:s}))}static get styles(){let s=[];return super.styles&&(s=super.styles),[...s,e`
          :host([font-family="0"]) {
