import{css as e,html as s}from"../../../../../lit/index.js";import{normalizeEventPath as t}from"../../../../utils/utils.js";function localStorageGet(e){try{return localStorage.getItem(e)}catch(e){return!1}}function localStorageSet(e,s){try{return localStorage.setItem(e,s)}catch(e){return!1}}const HAXCMSUserStylesMenuMixin=function(o){return class extends o{constructor(){super(),this.hideUserStylesMenu=!0,this.fontSize=localStorageGet("haxcms-userPref-fontSize")?localStorageGet("haxcms-userPref-fontSize"):1,this.fontFamily=localStorageGet("haxcms-userPref-fontFamily")?localStorageGet("haxcms-userPref-fontFamily"):0,this.colorTheme=localStorageGet("haxcms-userPref-colorTheme")?localStorageGet("haxcms-userPref-colorTheme"):0,this.addEventListener("click",this.checkUserStylesMenuOpen.bind(this))}static get styles(){let s=[];return super.styles&&(s=super.styles),[...s,e`
          :host([font-family="0"]) {
        ...
        `]}HAXCMSUserStylesMenu(){return import("../../../../simple-icon/simple-icon.js"),import("../../../../simple-icon/lib/simple-icons.js"),import("../../../../simple-icon/lib/simple-icon-button-lite.js"),import("../../../../simple-popover/simple-popover.js"),import("../../../../simple-tooltip/simple-tooltip.js"),s`
        <simple-icon-button-lite
      ...
      `}static get properties(){let e={};return super.properties&&(e=super.props),{...e,hideUserStylesMenu:{type:Boolean},fontSize:{type:Number,reflect:!0,attribute:"font-size"},fontFamily:{type:Number,reflect:!0,attribute:"font-family"},colorTheme:{type:Number,reflect:!0,attribute:"color-theme"}}}checkUserStylesMenuOpen(e){var s=t(e);this.hideUserStylesMenu||s.includes(this.toggleUserStylesMenuTarget)||s.includes(this.shadowRoot.querySelector("#haxcmsuserstylesmenu"))||"BUTTON"===s.tagName||(this.hideUserStylesMenu=!0)}updated(e){super.updated&&super.updated(e),e.forEach(((e,s)=>{"editMode"==s&&this[s]&&(this.hideUserStylesMenu=!0)}))}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.toggleUserStylesMenuTarget=this.shadowRoot.querySelector("#haxcmsuserstylesmenupopover"),this.shadowRoot.querySelector("#haxcmsuserstylesmenu").target=this.toggleUserStylesMenuTarget}toggleUserStylesMenu(e){this.hideUserStylesMenu=!this.hideUserStylesMenu}UserStylesSizeDown(e){this.fontSize>0&&(this.fontSize=this.fontSize-1,localStorageSet("haxcms-userPref-fontSize",this.fontSize))}UserStylesSizeUp(e){this.fontSize<4&&(this.fontSize=this.fontSize+1,localStorageSet("haxcms-userPref-fontSize",this.fontSize))}UserStylesFontFamilyChange(e){var s=t(e)[0];this.fontFamily=parseInt(s.getAttribute("data-font")),localStorageSet("haxcms-userPref-fontFamily",this.fontFamily)}UserStylesColorThemeChange(e){var s=t(e)[0];this.colorTheme=parseInt(s.getAttribute("data-theme")),localStorageSet("haxcms-userPref-colorTheme",this.colorTheme)}}};export{HAXCMSUserStylesMenuMixin};