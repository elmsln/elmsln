import{css as e,html as s}from"../../../../../lit-element/lit-element.js";import{store as t}from"../haxcms-site-store.js";import{autorun as o,toJS as r}from"../../../../../mobx/dist/mobx.esm.js";const HAXCMSUserStylesMenuMixin=function(t){return class extends t{constructor(){super(),this.hideUserStylesMenu=!0,this.fontSize=1,this.fontFamily=0,this.colorTheme=0,this.addEventListener("click",this.checkUserStylesMenuOpen.bind(this))}static get styles(){let s=[];return super.styles&&(s=super.styles),[...s,e`
          :host([font-family="0"]) {
        ...
        `]}HAXCMSUserStylesMenu(){return import("../../../../simple-icon/simple-icon.js"),import("../../../../simple-icon/lib/simple-icons.js"),import("../../../../simple-icon/lib/simple-icon-button.js"),import("../../../../simple-popover/simple-popover.js"),s`
        <simple-icon-button
      ...
      `}static get properties(){let e={};return super.properties&&(e=super.props),{...e,hideUserStylesMenu:{type:Boolean},fontSize:{type:Number,reflect:!0,attribute:"font-size"},fontFamily:{type:Number,reflect:!0,attribute:"font-family"},colorTheme:{type:Number,reflect:!0,attribute:"color-theme"}}}checkUserStylesMenuOpen(e){var s=null;s=e.path&&e.path[0]?e.path:e.originalTarget&&"SIMPLE-ICON-BUTTON"==e.originalTarget.tagName?[e.originalTarget]:e.originalTarget&&e.originalTarget.parentNode.host?[e.originalTarget.parentNode.host]:[e.target],this.hideUserStylesMenu||s.includes(this.toggleUserStylesMenuTarget)||s.includes(this.shadowRoot.querySelector("#haxcmsuserstylesmenu"))||"BUTTON"===s.tagName||(this.hideUserStylesMenu=!0)}updated(e){super.updated&&super.updated(e),e.forEach((e,s)=>{"editMode"==s&&this[s]&&(this.hideUserStylesMenu=!0)})}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.toggleUserStylesMenuTarget=this.shadowRoot.querySelector("#haxcmsuserstylesmenupopover"),this.shadowRoot.querySelector("#haxcmsuserstylesmenu").target=this.toggleUserStylesMenuTarget}toggleUserStylesMenu(e){this.hideUserStylesMenu=!this.hideUserStylesMenu}UserStylesSizeDown(e){this.fontSize>0&&(this.fontSize=this.fontSize-1)}UserStylesSizeUp(e){this.fontSize<4&&(this.fontSize=this.fontSize+1)}UserStylesFontFamilyChange(e){var s=null;s=e.path&&e.path[0]?e.path[0]:e.originalTarget?e.originalTarget:e.target,this.fontFamily=parseInt(s.getAttribute("data-font"))}UserStylesColorThemeChange(e){var s=null;s=e.path&&e.path[0]?e.path[0]:e.originalTarget?e.originalTarget:e.target,this.colorTheme=parseInt(s.getAttribute("data-theme"))}}};export{HAXCMSUserStylesMenuMixin};