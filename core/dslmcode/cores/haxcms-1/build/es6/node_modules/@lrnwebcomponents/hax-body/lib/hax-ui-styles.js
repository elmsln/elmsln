import{css as o,html as a,LitElement as r}from"../../../lit-element/lit-element.js";export const HaxUiText=[o`
    body {
  ...
  `];export class HaxUiStyles extends r{static get styles(){return HaxComponentStyles}render(){return a`<slot></slot>`}static get tag(){return"hax-ui-styles"}}window.customElements.define(HaxUiStyles.tag,HaxUiStyles);