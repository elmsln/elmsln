import{css as e,html as t}from"../../../../../lit-element/lit-element.js";import{store as s}from"../haxcms-site-store.js";import{autorun as i,toJS as o}from"../../../../../mobx/dist/mobx.esm.js";const HAXCMSMobileMenuMixin=function(n){return class extends n{constructor(){super(),this.menuOpen=!0}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.__disposer=this.__disposer?this.__disposer:[],i(e=>{this.shadowRoot.querySelector("#haxcmsmobilemenunav")&&this.menuOpen&&o(s.activeId)&&["sm","xs"].includes(this.responsiveSize)&&this.__HAXCMSMobileMenuToggle({}),this.__disposer.push(e)})}static get styles(){let t=[];return super.styles&&(t=super.styles),[...t,e`
        ...
        `]}HAXCMSMobileMenuButton(){return import("../../../../simple-icon/simple-icon.js"),import("../../../../simple-icon/lib/simple-icons.js"),import("../../../../simple-icon/lib/simple-icon-button.js"),import("../../../../simple-tooltip/simple-tooltip.js"),t`
        <simple-icon-button
          class="btn"
          icon="icons:menu"
