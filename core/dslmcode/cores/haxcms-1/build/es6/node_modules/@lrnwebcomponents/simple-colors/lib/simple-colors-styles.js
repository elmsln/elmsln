...
window.SimpleColorsStyles.makeVariable = (color = "grey", shade = 1, theme = "default") => {
...
window.SimpleColorsStyles.addCssVariables = sheet => {
  if (typeof sheet !== typeof undefined) {
    ...
    sheet.insertRule(window.SimpleColorsStyles.makeRule("html", window.SimpleColorsStyles.addColorShades("fixed", "accent", greys, false) + window.SimpleColorsStyles.addThemeVariables("fixed", false)), sheet.cssRules.length);
    sheet.insertRule(window.SimpleColorsStyles.makeRule("[dark]", window.SimpleColorsStyles.addColorShades("default", "accent", greys, true) + window.SimpleColorsStyles.addThemeVariables("default", true)), sheet.cssRules.length);
    return sheet;
  }
};
/**
...
window.SimpleColorsStyles.addAccentVariables = sheet => {
  if (typeof sheet !== typeof undefined) {
    for (let color in window.SimpleColorsStyles.colors) {
      sheet.insertRule(window.SimpleColorsStyles.makeRule('[accent-color="' + color + '"]', [window.SimpleColorsStyles.addColorShades("default", "accent", window.SimpleColorsStyles.colors[color], false), window.SimpleColorsStyles.addColorShades("fixed", "accent", window.SimpleColorsStyles.colors[color], false)].join("")), sheet.cssRules.length);
      sheet.insertRule(window.SimpleColorsStyles.makeRule('[dark][accent-color="' + color + '"]', [window.SimpleColorsStyles.addColorShades("default", "accent", window.SimpleColorsStyles.colors[color], true)].join("")), sheet.cssRules.length);
    }
...
class SimpleColorsStyles extends PolymerElement {
  ...
  maxContrastIndex(index) {
    return parseInt(index) < this.colors["grey"].length / 2 ? this.colors["grey"].length - 1 : 0;
  }
  /**
  ...
  maxContrastShade(shade) {
    return parseInt(shade) < this.colors["grey"].length / 2 + 1 ? this.colors["grey"].length : 1;
  }
  /**
...
window.SimpleColorsStyles.requestAvailability = function () {
  if (window.SimpleColorsStyles.instance == null) {
    ...
    window.SimpleColorsStyles.addCssVariables(window.SimpleColorsStyles.style.sheet);
    window.SimpleColorsStyles.addAccentVariables(window.SimpleColorsStyles.style.sheet);
  }
