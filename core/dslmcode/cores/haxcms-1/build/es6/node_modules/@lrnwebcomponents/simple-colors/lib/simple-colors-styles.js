...
window.SimpleColorsStyles.addCssVariables = sheet => {
  if (typeof sheet !== typeof undefined) {
    ...
    sheet.insertRule(window.SimpleColorsStyles.makeRule("body", window.SimpleColorsStyles.addColorShades("fixed", "accent", greys, false) + window.SimpleColorsStyles.addThemeVariables("fixed", false)), sheet.cssRules.length);
    sheet.insertRule(window.SimpleColorsStyles.makeRule("body[dark], [dark]", window.SimpleColorsStyles.addColorShades("default", "accent", greys, true) + window.SimpleColorsStyles.addThemeVariables("default", true)), sheet.cssRules.length);
    return sheet;
  }
};
/**
...
window.SimpleColorsStyles.addAccentVariables = sheet => {
  if (typeof sheet !== typeof undefined) {
    for (let color in window.SimpleColorsStyles.colors) {
      sheet.insertRule(window.SimpleColorsStyles.makeRule(`body[accent-color="${color}"], [accent-color="${color}"]`, [window.SimpleColorsStyles.addColorShades("default", "accent", window.SimpleColorsStyles.colors[color], false), window.SimpleColorsStyles.addColorShades("fixed", "accent", window.SimpleColorsStyles.colors[color], false)].join("")), sheet.cssRules.length);
      sheet.insertRule(window.SimpleColorsStyles.makeRule(`body[dark][accent-color="${color}"], [dark][accent-color="${color}"]`, [window.SimpleColorsStyles.addColorShades("default", "accent", window.SimpleColorsStyles.colors[color], true)].join("")), sheet.cssRules.length);
    }
