import{LitElement as e,html as t,css as i}from"../../../lit-element/lit-element.js";import"../../simple-icon/lib/simple-icon-lite.js";import"./hax-toolbar-item.js";import"../../simple-popover/lib/simple-popover-selection.js";class HaxToolbarMenu extends e{static get styles(){return[i`
    ...
    `}selectedChanged(e){this.shadowRoot.querySelector("simple-popover-selection").opened=!1,this.selected=e.detail.value}static get tag(){return"hax-toolbar-menu"}constructor(){super(),this.corner="",this.action=!1,this.disabled=!1,this.tooltip="",this.tooltipDirection="",this.selected=0,setTimeout(()=>{this.addEventListener("click",this._menubuttonTap.bind(this))},0)}static get properties(){return{corner:{type:String,reflect:!0},disabled:{type:Boolean,reflect:!0},mini:{type:Boolean,reflect:!0},action:{type:Boolean},icon:{type:String},tooltip:{type:String},tooltipDirection:{type:String,attribute:"tooltip-direction"},selected:{type:Number}}}updated(e){e.forEach((e,t)=>{"selected"==t&&this.dispatchEvent(new CustomEvent("selected-changed",{detail:this[t]}))})}_menubuttonTap(e){this.disabled||(this.selected="")}}window.customElements.define(HaxToolbarMenu.tag,HaxToolbarMenu);export{HaxToolbarMenu};