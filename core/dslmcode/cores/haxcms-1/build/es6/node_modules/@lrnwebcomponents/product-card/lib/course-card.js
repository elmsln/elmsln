import{html as e,css as o}from"../../../lit-element/lit-element.js";import{SimpleColors as i}from"../../simple-colors/simple-colors.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/simple-icon.js";class CourseCard extends i{static get properties(){return{...super.properties,size:{type:String,reflect:!0},url:{type:String},image:{type:String},alt:{type:String},number:{type:String},name:{type:String},icon:{type:String},author:{type:String},zoom:{type:Boolean,reflect:!0}}}constructor(){super(),this.zoom=!1,this.url="",this.image="",this.alt="",this.number="",this.name="",this.icon="",this.author=""}static get styles(){return[...super.styles,o`
        :host {
          display: block;
        }
    ...
    `}static get tag(){return"course-card"}}window.customElements.define(CourseCard.tag,CourseCard);export{CourseCard};