import{html as e,css as o}from"../../../lit-element/lit-element.js";import{SimpleColors as r}from"../../simple-colors/simple-colors.js";import"../../../@polymer/iron-icon/iron-icon.js";class CourseCard extends r{static get properties(){return{...super.properties,size:{type:String,reflect:!0},url:{type:String},image:{type:String},alt:{type:String},number:{type:String},name:{type:String},icon:{type:String},author:{type:String},zoom:{type:Boolean,reflect:!0}}}constructor(){super(),this.zoom=!1,this.url="",this.image="",this.alt="",this.number="",this.name="",this.icon="",this.author=""}static get styles(){return[...super.styles,o`
        :host {
          display: block;
        }
