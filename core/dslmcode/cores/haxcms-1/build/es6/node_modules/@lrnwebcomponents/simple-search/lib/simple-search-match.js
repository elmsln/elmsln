 ...
 */
import{LitElement as e,html as r,css as t}from"../../../lit-element/lit-element.js";class SimpleSearchMatch extends e{static get tag(){return"simple-search-match"}static get properties(){return{...super.properties,matchNumber:{type:Number,reflect:!0,attribute:"match-number"}}}static get styles(){return[t`
        :host {
          margin-right: 4px;
      ...
      `]}render(){return r` <slot></slot> `}}customElements.define(SimpleSearchMatch.tag,SimpleSearchMatch);export{SimpleSearchMatch};