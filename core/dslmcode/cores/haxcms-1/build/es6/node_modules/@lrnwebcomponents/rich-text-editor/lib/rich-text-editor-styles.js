...
window.RichTextEditorStyleManager.requestAvailability = function () {
  if (window.RichTextEditorStyleManager.instance == null) {
    window.RichTextEditorStyleManager.instance = document.createElement("style");
    window.RichTextEditorStyleManager.instance.setAttribute("is", "custom-style");
    window.RichTextEditorStyleManager.instance.setAttribute("include", "rich-text-editor-styles");
