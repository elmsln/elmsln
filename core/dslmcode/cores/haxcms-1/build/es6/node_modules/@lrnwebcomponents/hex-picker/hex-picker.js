 ...
 */
import{LitElement as e,html as t,css as r}from"../../lit-element/lit-element.js";class HexPicker extends e{static get haxProperties(){return{canScale:!1,canPosition:!1,canEditSource:!0,gizmo:{title:"Hex Picker",description:"Hexcode color picker",icon:"image:colorize",color:"grey",groups:["color","picker"],handles:[],meta:{author:"collinkleest",owner:"ELMS:LN"}},settings:{configure:[{property:"value",title:"Value",description:"Default hex value",inputMethod:"textfield"},{property:"disabled",title:"Disabled",description:"Disable the text field",inputMethod:"boolean"},{property:"largeDisplay",title:"Large Display",description:"Include color in large display",inputMethod:"boolean"}],advanced:[]},demoSchema:[{tag:"hex-picker",properties:{org:"elmsln",repo:"lrnwebcomponents"},content:""}]}}static get properties(){return{...super.properties,value:{type:String,reflect:!0,attribute:"value"},disabled:{type:Boolean,reflect:!0,attribute:"disabled"},largeDisplay:{type:Boolean,reflect:!0,attribute:"large-display"}}}static get styles(){return[r`
        :host {
