...
import{LitElement as t,css as e,html as i}from"../../lit/index.js";import{I18NMixin as s}from"../i18n-manager/lib/I18NMixin.js";import{unsafeHTML as n}from"../../lit/directives/unsafe-html.js";import{HAXStore as o}from"../hax-body/lib/hax-store.js";import{store as a}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as d,toJS as l}from"../../mobx/dist/mobx.esm.js";import{JSONOutlineSchemaItem as r}from"../json-outline-schema/lib/json-outline-schema-item.js";import{JsonOutlineSchema as c}from"../json-outline-schema/json-outline-schema.js";import"../simple-popover/simple-popover.js";import"../simple-icon/lib/simple-icon-lite.js";import"../hax-iconset/lib/simple-hax-iconset.js";import"../simple-icon/lib/simple-icon-button.js";import"../simple-fields/lib/simple-fields-field.js";import{encapScript as p,haxElementToNode as h}from"../utils/utils.js";export class OutlineDesigner extends(s(t)){static get styles(){return[e`
    ...
    `]}constructor(){super(),this.fidelity="medium",this.haxGizmos=[],this.hideDelete=!1,this.activeItemForActions=null,this.storeTools=!1,this.hideContentOps=!1,this.items=[],this.appReady=!1,this.eventData={},this.activeId=null,this.activePreview=null,this.activePreviewIndex=-1,this.t={selectParent:"Select target",importContentUnderThisPage:"Import content under this page",importThisContent:"Import this content",thisPage:"this page",newPage:"New page",copyOf:"Copy of"},this.registerLocalization({context:this,basePath:import.meta.url,locales:["es"]}),d((()=>{this.activeId=l(a.activeId)})),d((()=>{this.appReady=l(a.appReady)})),d((()=>{this.haxGizmos=l(o.gizmoList).filter((t=>!!(t&&t.meta&&t.meta.outlineDesigner)))})),this.addEventListener("click",this.resetPopOver.bind(this))}resetPopOver(){this.activePreview&&(this.shadowRoot.querySelector("simple-popover").setAttribute("hidden","hidden"),this.activePreview=null,this.activePreviewIndex=-1)}getSiteItems(){var t=[{text:this.t.selectParent,value:null}];if(this.appReady&&this.items.length>0){const e=a.getManifestItems(!0);e.forEach((i=>{let s=i,n="- ";for(;s&&null!=s.parent;)s=e.find((t=>t.id==s.parent)),s&&(n="--"+n);t.push({text:n+i.title,value:i.id})}))}return t}render(){return i`
    <div class="controls">
      ${this.storeTools?i`
      <label for="targetselector">${this.t.importThisContent}</label>
      <simple-fields-field id="targetselector" type="select" value="children" .itemsList="${[{text:"as children of",value:"children"},{text:"Above",value:"above"},{text:"Below",value:"below"}]}"></simple-fields-field>
      ${this.t.thisPage}:
      ...
      ${this.hasDeletedItems()?i`<simple-icon-button-lite icon="delete" @click="${this.toggleDelete}" class="control">${this.hideDelete?"Show Deleted":"Hide Deleted"}</simple-icon-button-lite>`:""}
    </div>
    <ul id="list">
    ...
    >
      ...
      <simple-icon-button-lite
        ...
        >
        ${t.new?i`<simple-icon ?disabled="${this.isLocked(e)}"
 icon="av:fiber-new" title="${this.t.newPage}" class="new" accent-color="green" dark contrast="1"></simple-icon>`:""}
      </simple-icon-button-lite>
      <span class="label shown" ?disabled="${this.isLocked(e)}" @dblclick="${this.editTitle}">${t.title}</span>
    ...
    <li 
      ...
      <simple-icon-button-lite class="operation" icon="${t.icon}" value="${t.tag}" @click="${this.prependNodeToContent}"
    ...
    <li 
      ...
      <simple-icon-button-lite icon="${d}" title="Click to preview" @click="${this.setActivePreview}"
></simple-icon-button-lite>
      ${"heading"===r?i`
      <span class="label shown" ?disabled="${s.metadata.locked}" @dblclick="${this.editTitle}">${l}</span>
