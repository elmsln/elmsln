import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import"../../@polymer/polymer/lib/elements/dom-repeat.js";import"./lib/hex-a-gon.js";export{HexagonLoader};class HexagonLoader extends PolymerElement{static get template(){return html`
      <style>
        :host {
          display: none;
        }
    ...
    `}static get properties(){let props={color:{name:"color",type:String,observer:"_colorChanged",reflectToAttribute:!0},size:{name:"size",type:String,reflectToAttribute:!0},loading:{name:"loading",type:Boolean,reflectToAttribute:!0},itemCount:{name:"itemCount",type:Number,value:37}};return super.properties&&(props=Object.assign(props,super.properties)),props}static get tag(){return"hexagon-loader"}connectedCallback(){super.connectedCallback();let items=[];for(var i=0;i<this.itemCount;i++)items.push("");this.set("items",items)}_colorChanged(newValue,oldValue){newValue&&this.updateStyles({"--hexagon-color":newValue})}}window.customElements.define(HexagonLoader.tag,HexagonLoader);