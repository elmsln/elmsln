 ...
 */
import{LitElement as i,html as t,css as a}from"../../lit-element/lit-element.js";import"./lib/hex-a-gon.js";class HexagonLoader extends i{static get styles(){return[a`
        :host {
          display: none;
        }
        :host([hidden]) {
    ...
    `}static get properties(){return{...super.properties,color:{name:"color",type:String,reflect:!0},size:{name:"size",type:String,reflect:!0},loading:{name:"loading",type:Boolean,reflect:!0},items:{name:"items",type:Array},itemCount:{name:"itemCount",type:Number,reflect:!0,attribute:"item-count"}}}static get tag(){return"hexagon-loader"}constructor(){super(),this.itemCount=37,this.items=[]}updated(i){i.forEach((i,t)=>{if("color"==t&&this._colorChanged(this[t],i),"itemCount"==t){this.items=[];for(let i=0;i<this[t];i++)this.items.push("")}})}_colorChanged(i,t){i&&window.ShadyCSS&&window.ShadyCSS.styleSubtree(this,{"--hexagon-color":i})}}window.customElements.define(HexagonLoader.tag,HexagonLoader);export{HexagonLoader};