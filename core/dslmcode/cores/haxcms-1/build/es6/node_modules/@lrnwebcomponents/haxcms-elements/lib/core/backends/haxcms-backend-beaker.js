...
import "../../../../beaker-broker/beaker-broker.js";
...
class HAXCMSBackendBeaker extends PolymerElement {
  ...
  _appPicked(e) {
    if (e.detail.connection.protocol === "dat") {
      ...
      reader.onload = event => {
        let fileLocation = "files/" + window.HaxStore.instance.haxManager.$.fileupload.files[0].name;
  ...
  async saveNode(e) {
    ...
    await this.$.beaker.write(this.activeItem.location, window.HaxStore.instance.activeHaxBody.haxToContent());
    store.cmsSiteEditor.instance.haxCmsSiteEditorElement.$.toast.show("Page updated!");
  ...
  async saveOutline(e) {
    ...
    this.manifest.items.forEach((element, index) => {
      ...
      if (typeof element.location === typeof undefined) {
        ...
        this.$.beaker.write("pages/" + id + "/index.html", "<p>Ex uno Plures</p>");
    ...
    store.cmsSiteEditor.instance.haxCmsSiteEditorElement.$.toast.show("Outline saved!");
    store.cmsSiteEditor.instance.haxCmsSiteEditorElement.dispatchEvent(new CustomEvent("haxcms-trigger-update", {
      bubbles: true,
      composed: true,
      cancelable: false,
      detail: true
    }));
    store.cmsSiteEditor.instance.haxCmsSiteEditorElement.dispatchEvent(new CustomEvent("json-outline-schema-changed", {
      bubbles: true,
      composed: true,
      cancelable: false,
  ...
  async deleteNode(e) {
    ...
    store.cmsSiteEditor.instance.haxCmsSiteEditorElement.$.toast.show(`${page.title} deleted`);
    store.cmsSiteEditor.instance.haxCmsSiteEditorElement.dispatchEvent(new CustomEvent("haxcms-trigger-update", {
      bubbles: true,
      composed: true,
      cancelable: false,
  ...
  async createNode(e) {
    ...
    store.cmsSiteEditor.instance.haxCmsSiteEditorElement.$.toast.show(`${page.title} created!`);
    store.cmsSiteEditor.instance.haxCmsSiteEditorElement.dispatchEvent(new CustomEvent("haxcms-trigger-update", {
      bubbles: true,
      composed: true,
      cancelable: false,
  ...
  async saveManifest(e) {
    ...
    await this.$.beaker.write("site.json", JSON.stringify(this.manifest, null, 2)); // simulate save events since they wont fire

    store.cmsSiteEditor.instance.haxCmsSiteEditorElement.$.toast.show("Site details saved!");
    store.cmsSiteEditor.instance.haxCmsSiteEditorElement.dispatchEvent(new CustomEvent("haxcms-trigger-update", {
      bubbles: true,
      composed: true,
      cancelable: false,
