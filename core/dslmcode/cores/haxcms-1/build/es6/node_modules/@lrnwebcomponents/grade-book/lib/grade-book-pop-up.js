import{html as t,LitElement as e}from"../../../lit-element/lit-element.js";import{GradeBookStore as i}from"./grade-book-store.js";import{I18NMixin as s}from"../../i18n-manager/lib/I18NMixin.js";import{autorun as o,toJS as n}from"../../../mobx/dist/mobx.esm.js";import{validURL as r,cleanVideoSource as a}from"../../utils/utils.js";class GradeBookPopUp extends(s(e)){constructor(){super(),this.t={studentSubmission:"Student submission",openInNewWindow:"Open in new window",submitted:"Submitted"},o((()=>{this.activeSubmission=n(i.activeSubmission)}))}createRenderRoot(){return this}changeActive(t){const e=t.target.value.split("-");switch(e[0]){case"prev":i[`active${e[1]}`]--;break;case"next":i[`active${e[1]}`]++}}render(){return t`
      <style>
