import{html as e,css as t,unsafeCSS as o}from"../../../../lit/index.js";import{store as i}from"./haxcms-site-store.js";import{HaxStore as a,HAXStore as s}from"../../../hax-body/lib/hax-store.js";import{autorun as n,toJS as l}from"../../../../mobx/dist/mobx.esm.js";import{ResponsiveUtilityBehaviors as d}from"../../../responsive-utility/lib/responsive-utility-behaviors.js";import{localStorageSet as r,winEventsElement as c}from"../../../utils/utils.js";import"../../../simple-icon/simple-icon.js";import"../../../simple-icon/lib/simple-icons.js";import{HAXCMSThemeParts as h}from"./utils/HAXCMSThemeParts.js";import{HAXCMSI18NMixin as m}from"./utils/HAXCMSI18NMixin.js";import"../../../rpg-character/rpg-character.js";import"../../../app-hax/lib/v1/app-hax-top-bar.js";import"../../../app-hax/lib/v1/app-hax-user-menu.js";import"../../../app-hax/lib/v1/app-hax-user-menu-button.js";import{SimpleColors as p}from"../../../simple-colors/simple-colors.js";import{SuperDaemonInstance as u}from"../../../super-daemon/super-daemon.js";import"../../../simple-modal/simple-modal.js";import"./haxcms-site-insights.js";import"../../../simple-fields/lib/simple-fields-form.js";import"./micros/haxcms-button-add.js";import"./haxcms-darkmode-toggle.js";import"../ui-components/site/site-remote-content.js";import"../../../page-flag/page-flag.js";import"../../../../wired-elements/lib/wired-button.js";new URL("../../../app-hax/lib/assets/images/ButtonBGLM.svg",import.meta.url).href,new URL("../../../app-hax/lib/assets/images/ButtonBGDM.svg",import.meta.url).href;const b=new URL("../../../app-hax/lib/assets/images/Logout.svg",import.meta.url).href;class HAXCMSSiteEditorUI extends(h(m(c(d(p))))){static get styles(){return[...super.styles,t`
        :host *:not(:defined) {
          display: none;
        }
        :host {
      ...
      `]}static get tag(){return"haxcms-site-editor-ui"}_internalLinkChanged(e){if(e.detail.value&&i.findItem(e.detail.value)){const t=l(i.findItem(e.detail.value));s.haxTray.shadowRoot.querySelector("[name='settings.configure.href']").value=t.slug}}_expandSettingsPanel(e){this.shadowRoot.querySelector("#content-edit").click()}constructor(){if(super(),this.__winEvents={"can-redo-changed":"_redoChanged","can-undo-changed":"_undoChanged","hax-drop-focus-event":"_expandSettingsPanel","hax-store-ready":"haxStoreReady","jwt-logged-in":"_jwtLoggedIn"},this.rpgHat="none",this.darkMode=!1,this.__editText="",this.userMenuOpen=!1,this.soundIcon="",this.__disposer=this.__disposer||[],this.t=this.t||{},u.allowedCallback=()=>!0,u.noResultsSlot=()=>e`Expecting to see results?
        <a
          @click="${e=>{s._haxStoreContribute("merlin","POP,enhancement",u.commandContext+" "+u.like)}}"
          >Make a suggestion</a
        >
        for what you thought you would see here!`,u.appendContext("CMS"),s.ready){let e=document.createElement("site-remote-content");s.haxAutoloader.appendChild(e);let t=document.createElement("citation-element");s.haxAutoloader.appendChild(t);let o=document.createElement("page-flag");s.haxAutoloader.appendChild(o),s.primativeHooks.a||(s.primativeHooks.a={}),s.primativeHooks.a.setupActiveElementForm=e=>{const t=i.getManifestItems(!0);var o=[{text:`-- ${this.t.selectPage} --`,value:null}];t.forEach((e=>{if(e.id!=this.itemId){let i=e,a="- ";for(;i&&null!=i.parent;)i=t.find((e=>e.id==i.parent)),i&&(a="--"+a);o.push({text:a+e.title,value:e.id})}})),e.settings.configure.splice(1,0,{property:"data-uuid",title:"Internal content",description:"Link to content internal to this site",inputMethod:"select",itemsList:o}),setTimeout((()=>{s.haxTray.shadowRoot.querySelector("[name='settings.configure.data-uuid']").addEventListener("value-changed",this._internalLinkChanged.bind(this))}),100)}}this.t={...this.t,selectPage:"Select page",backToSiteList:"Back to site list",mySites:"My sites",cancel:"Cancel",editDetails:"Page details",add:"Add",editSettings:"Edit settings",source:"Source",viewSource:"View source",findMedia:"Find media",undo:"Undo",redo:"Redo",media:"Media",outline:"Outline",blocks:"Blocks",addBlock:"Add block",addPage:"Add page",addChildPage:"Add child page",clonePage:"Clone page",importDocxFile:"Import docx file",delete:"Delete page",shareSite:"Share site",siteSettings:"Site settings",close:"Close",settings:"Settings",editPage:"Edit page",edit:"Edit",configureBlock:"Configure block",configure:"Configure",save:"Save",saveChanges:"Save changes",newJourney:"New Journey",accountInfo:"Account Info",outlineDesigner:"Outline designer",pageOutline:"Page outline",more:"More",siteActions:"Site actions",insights:"Insights dashboard (beta)",merlin:"Merlin",summonMerlin:"Summon Merlin",logOut:"Log out",menu:"Menu",showMore:"More"},this.backText="Site list",this.painting=!0,this.pageAllowed=!1,this.editMode=!1,this.__editIcon="hax:page-edit",this.icon="hax:site-settings",this.manifestEditMode=!1,this.backLink="../../",this.activeTagName="",this.activeNode=null,window.appSettings&&window.appSettings.backLink&&(this.backLink=window.appSettings.backLink),n((()=>{const e=l(s.activeGizmo);e&&e.title&&(this.activeTagName=e.title)})),n((()=>{this.activeNode=l(s.activeNode)})),n((()=>{const e=l(i.badDevice);if(!1===e){const e=document.createElement("link");e.setAttribute("href","https://fonts.googleapis.com/css2?family=Press+Start+2P&display=swap"),e.setAttribute("rel","stylesheet"),e.setAttribute("fetchpriority","low"),document.head.appendChild(e)}else!0===e&&document.body.classList.add("bad-device")})),n((()=>{this.darkMode=l(i.darkMode),this.dark=this.darkMode,l(i.darkMode)?(u.dark=!0,u.toastInstance.darkMode=!0,s.globalPreferences.haxUiTheme="haxdark"):(s.globalPreferences.haxUiTheme="hax",u.dark=!1,u.toastInstance.darkMode=!1)})),n((()=>{this.soundIcon=l(i.soundStatus)?new URL("../../../app-hax/lib/assets/images/FullVolume.svg",import.meta.url).href:new URL("../../../app-hax/lib/assets/images/Silence.svg",import.meta.url).href})),setTimeout((()=>{import("./haxcms-outline-editor-dialog.js"),import("./haxcms-share-dialog.js")}),0)}haxStoreReady(e){if(e.detail){let e=document.createElement("site-remote-content");s.haxAutoloader.appendChild(e)}}soundToggle(){const e=!l(i.soundStatus);i.soundStatus=e,r("app-hax-soundStatus",e),e?(i.toast("Can you hear me now? Good.",2e3,{hat:"random"}),i.playSound("click")):i.toast("Sound off.. hey.. HELLO!?!",2e3,{fire:!0})}closeMenu(){this.userMenuOpen=!1}toggleMenu(){this.userMenuOpen=!this.userMenuOpen,i.playSound("click")}getIconPosition(e){return["xl","lg"].includes(e)?"left":"top"}render(){return e`
