...
import{css as t,LitElement as a,render as e,unsafeCSS as o}from"../../../../lit/index.js";import{HAXCMSTheme as r}from"./HAXCMSThemeWiring.js";import{ResponsiveUtilityBehaviors as i}from"../../../responsive-utility/lib/responsive-utility-behaviors.js";import{store as n}from"./haxcms-site-store.js";import{autorun as l,toJS as c}from"../../../../mobx/dist/mobx.esm.js";import"../../../simple-icon/lib/simple-icons.js";import{SimpleIconsetStore as d}from"../../../simple-icon/lib/simple-iconset.js";import{editableTableDisplayStyles as s}from"../../../editable-table/lib/editable-table-behaviors.js";import{learningComponentColors as b,iconFromPageType as h}from"../../../course-design/lib/learning-component.js";class HAXCMSLitElementTheme extends(r(i(a))){constructor(){super(),this.editMode=!1,this.isLoggedIn=!1,this.__disposer=this.__disposer?this.__disposer:[],l((t=>{this.editMode=c(n.editMode),this.__disposer.push(t)})),l((t=>{c(n.activeItemContent);this.HAXCMSThemeSettings.autoScroll&&this.shadowRoot&&this.HAXCMSThemeSettings.scrollTarget&&this.HAXCMSThemeSettings.scrollTarget.scrollTo({top:0,left:0}),setTimeout((()=>{let t=this.querySelectorAll("h1,h2,h3,h4,h5,h6");t.length>0&&t.forEach((t=>{t.addEventListener("click",this.copyLink.bind(this)),t.addEventListener("pointerenter",this.hoverIntentEnter.bind(this)),t.addEventListener("pointerleave",this.hoverIntentLeave.bind(this))}))}),100),this.__disposer.push(t)}))}hoverIntentEnter(t){this.__styleTag=document.createElement("style");let a=d.getIcon("icons:link");this.__styleTag.innerHTML=`\n    #${t.target.getAttribute("id")} { cursor: copy; text-decoration: dotted underline}\n    #${t.target.getAttribute("id")} {\n      background-image: url("${a}");\n      background-position: right;\n      background-repeat: no-repeat;\n      background-size: 36px;\n    }`,t.target.appendChild(this.__styleTag)}hoverIntentLeave(t){this.__styleTag&&this.__styleTag.remove()}HAXCMSGlobalStyleSheetContent(){let a=["red","blue","green","orange","purple"].map((a=>t`
      ...
      `]}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),null==this.contentContainer&&(this.contentContainer=this.shadowRoot.querySelector("#contentcontainer")),e(this.HAXCMSGlobalStyleSheetContent(),n.themeStyleElement),setTimeout((()=>{setTimeout((()=>{if(this._location&&this._location.hash){let t=this.querySelector(this._location.hash);if(t){void 0!==window.safari?t.scrollIntoView():t.scrollIntoView({behavior:"smooth",block:"start",inline:"nearest"})}}}),0);let t=this.querySelectorAll("h1,h2,h3,h4,h5,h6");t.length>0&&t.forEach((t=>{t.addEventListener("click",this.copyLink.bind(this)),t.addEventListener("pointerenter",this.hoverIntentEnter.bind(this)),t.addEventListener("pointerleave",this.hoverIntentLeave.bind(this))}))}),1500)}updated(t){super.updated&&super.updated(t),t.forEach(((t,a)=>{"_location"==a&&(this._locationChanged(this[a],t),setTimeout((()=>{if(this._location&&this._location.hash){let t=this.querySelector(this._location.hash);if(t){void 0!==window.safari?t.scrollIntoView():t.scrollIntoView({behavior:"smooth",block:"start",inline:"nearest"})}}}),0)),"color"==a&&this._colorChanged(this[a],t),"contentContainer"==a&&(this.dispatchEvent(new CustomEvent("content-container-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this[a]})),this._contentContainerChanged(this[a],t)),"isLoggedIn"==a&&this.dispatchEvent(new CustomEvent("is-logged-in-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this[a]})),"editMode"==a&&(this.dispatchEvent(new CustomEvent("edit-mode-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this[a]})),this._editModeChanged(this[a],t))}))}}export{HAXCMSLitElementTheme};