 ...
 */
import{css as t,LitElement as a,render as e,unsafeCSS as o}from"../../../../lit/index.js";import{HAXCMSTheme as r}from"./HAXCMSThemeWiring.js";import{ResponsiveUtilityBehaviors as n}from"../../../responsive-utility/lib/responsive-utility-behaviors.js";import{store as i}from"./haxcms-site-store.js";import{autorun as l,toJS as c}from"../../../../mobx/dist/mobx.esm.js";import"../../../simple-icon/lib/simple-icons.js";import{SimpleIconsetStore as d}from"../../../simple-icon/lib/simple-iconset.js";import{editableTableDisplayStyles as s}from"../../../editable-table/lib/editable-table-behaviors.js";import{learningComponentColors as b,iconFromPageType as g}from"../../../course-design/lib/learning-component.js";class HAXCMSLitElementTheme extends(r(n(a))){constructor(){super(),this.editMode=!1,this.isLoggedIn=!1,this.__disposer=this.__disposer?this.__disposer:[],l((t=>{this.editMode=c(i.editMode),this.__disposer.push(t)})),l((t=>{c(i.activeItemContent);this.HAXCMSThemeSettings.autoScroll&&this.shadowRoot&&this.HAXCMSThemeSettings.scrollTarget&&this.HAXCMSThemeSettings.scrollTarget.scrollTo({top:0,left:0}),setTimeout((()=>{let t=this.querySelectorAll("h1,h2,h3,h4,h5,h6");t.length>0&&t.forEach((t=>{t.addEventListener("click",this.copyLink.bind(this)),t.addEventListener("pointerenter",this.hoverIntentEnter.bind(this)),t.addEventListener("pointerout",this.hoverIntentLeave.bind(this))}))}),500),this.__disposer.push(t)}))}hoverIntentEnter(t){this.__styleTag=document.createElement("style");let a=d.getIcon("icons:link");this.__styleTag.innerHTML=`\n    #${t.target.getAttribute("id")} { cursor: copy; text-decoration: dotted underline}\n    #${t.target.getAttribute("id")} {\n      background-image: url("${a}");\n      background-position: right;\n      background-repeat: no-repeat;\n      background-size: 36px;\n    }`,t.target.appendChild(this.__styleTag)}hoverIntentLeave(t){this.__styleTag&&this.__styleTag.remove()}HAXCMSGlobalStyleSheetContent(){let a=["red","blue","green","orange","purple"].map((a=>t`
        ...
        `)),e=Object.keys(b).map((a=>{let e=b[a];return t`
          ...
          h6[data-instructional-action="${o(a)}"]::after {
            -webkit-mask-image: url("${o(d.getIcon(g(a)))}");
          }
      ...
      `,...a,...e,s]}copyLink(t){let a=t.target;a||(a=t.path[0]);let e=document.createElement("textarea");e.value=window.location.origin+window.location.pathname+"#"+a.getAttribute("id"),window.history.pushState({},null,e.value),window.dispatchEvent(new PopStateEvent("popstate")),document.body.appendChild(e),e.select(),document.execCommand("copy"),document.body.removeChild(e),window.dispatchEvent(new CustomEvent("haxcms-toast-show",{cancelable:!0,detail:{text:"Link copied to clipboard",duration:3e3}}))}static get properties(){let t={};return super.properties&&(t=super.properties),{...t,hexColor:{type:String,attribute:"hex-color"},color:{type:String,reflect:!0},editMode:{type:Boolean,reflect:!0,attribute:"edit-mode"},isLoggedIn:{type:Boolean,reflect:!0,attribute:"is-logged-in"},contentContainer:{type:Object},_location:{type:Object}}}static get styles(){let a=[];return super.styles&&(a=super.styles),[...a,t`
        :host([edit-mode]) {
          opacity: 1;
      ...
      `]}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),null==this.contentContainer&&(this.contentContainer=this.shadowRoot.querySelector("#contentcontainer")),e(this.HAXCMSGlobalStyleSheetContent(),i.themeStyleElement)}updated(t){super.updated&&super.updated(t),t.forEach(((t,a)=>{"_location"==a&&this._locationChanged(this[a],t),"color"==a&&this._colorChanged(this[a],t),"contentContainer"==a&&(this.dispatchEvent(new CustomEvent("content-container-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this[a]})),this._contentContainerChanged(this[a],t)),"isLoggedIn"==a&&this.dispatchEvent(new CustomEvent("is-logged-in-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this[a]})),"editMode"==a&&(this.dispatchEvent(new CustomEvent("edit-mode-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this[a]})),this._editModeChanged(this[a],t))}))}}export{HAXCMSLitElementTheme};