...
(function ($) {
  ...
  H5PUtils.Table = function (classes) {
    ...
    var $sortCol;
    var sortCol;
    var sortDir; // Create basic table
    ...
    var addCol = function ($tr, col, id) {
      ...
      if (!(col instanceof Object)) {
        ...
        if (sortByCol !== undefined && col.sortable === true) {
          // Make sortable
          options.role = "button";
          options.tabIndex = 0; // This is the first sortable column, use as default sort
  ...
  H5PUtils.Pagination = function (num, limit, goneTo, l10n) {
    var current = 0;
    var pages = Math.ceil(num / limit); // Create components
    // Previous button
    ...
    var updateUI = function () {
      var next = current + 1; // Disable or enable buttons

      $left.attr("disabled", current === 0);
      $right.attr("disabled", next === pages); // Update counter
