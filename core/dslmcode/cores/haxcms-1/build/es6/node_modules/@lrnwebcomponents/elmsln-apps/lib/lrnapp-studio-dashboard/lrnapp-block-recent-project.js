import{html as t,PolymerElement as e}from"../../../../@polymer/polymer/polymer-element.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../simple-icon/simple-icon.js";import"../../../simple-icon/lib/simple-icons.js";import"../../../simple-icon/lib/simple-icon-button.js";import"../../../hax-iconset/lib/simple-hax-iconset.js";import"../../../../@polymer/iron-list/iron-list.js";import"../../../../@polymer/polymer/lib/elements/dom-if.js";import"../../../../@polymer/paper-item/paper-item-shared-styles.js";import"../../../lrnsys-button/lrnsys-button.js";import"../../../elmsln-loading/elmsln-loading.js";import"../../../materializecss-styles/materializecss-styles.js";class LrnappBlockRecentProject extends e{static get template(){return t`
    ...
    `}static get tag(){return"lrnapp-block-recent-project"}static get properties(){return{elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},sourcePath:{type:String,notify:!0},response:{type:Object,notify:!0},project:{type:Object,notify:!0},hasProject:{type:Boolean,notify:!0,reflectToAttribute:!0,computed:"_getHasProject(project)"}}}_getHasProject(t){return void 0!==t.id}handleResponse(t){this.$.loading.hidden=!0,this.project=this.response.data}_toArray(t){return null==t?[]:Object.keys(t).map((function(e){return t[e]}))}}window.customElements.define(LrnappBlockRecentProject.tag,LrnappBlockRecentProject);export{LrnappBlockRecentProject};