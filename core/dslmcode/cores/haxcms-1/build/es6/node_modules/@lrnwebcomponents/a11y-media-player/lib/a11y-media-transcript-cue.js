 ...
 */
import{LitElement,html,css}from"../../../lit-element/lit-element.js";import"../../simple-search/lib/simple-search-content.js";class A11yMediaTranscriptCue extends LitElement{static get properties(){return{...super.properties,active:{attribute:"active",type:Boolean,reflect:!0},disabled:{attribute:"disabled",type:Boolean,reflect:!0},end:{type:String},hideTimestamps:{attribute:"hide-timestamps",type:Boolean,reflect:!0},start:{type:String}}}static get tag(){return"a11y-media-transcript-cue"}constructor(){super(),this.active=!1,this.disabled=!1,this.hideTimestamps=!1,this.start="",this.end=""}static get styles(){return[css`
        :host {
          cursor: default;
          display: table-row;
          width: 100%;
    ...
    `}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>{"active"===propName&&this.active&&this.dispatchEvent(new CustomEvent("active-changed",{detail:{element:this,oldValue,value:this.active}}))})}}window.customElements.define(A11yMediaTranscriptCue.tag,A11yMediaTranscriptCue);export{A11yMediaTranscriptCue};