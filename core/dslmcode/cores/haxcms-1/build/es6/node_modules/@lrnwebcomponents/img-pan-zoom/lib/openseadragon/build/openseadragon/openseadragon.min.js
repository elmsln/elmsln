...
!function (e) {
  ...
  e.freezeObject = function (t) {
    Object.freeze ? e.freezeObject = Object.freeze : e.freezeObject = function (e) {
      return e;
    };
    return e.freezeObject(t);
  };
...
!function ($) {
  ...
  $.extend($, {
    ...
    getCssPropertyWithVendorPrefix: function (e) {
      ...
      $.getCssPropertyWithVendorPrefix = function (e) {
        ...
        var n = null;
        if (void 0 !== i[e]) n = e;else {
          var o = ["Webkit", "Moz", "MS", "O", "webkit", "moz", "ms", "o"];
          var r = $.capitalizeFirstLetter(e);
    ...
    makeAjaxRequest: function (e, t, i) {
      ...
      a.onreadystatechange = function () {
        if (4 == a.readyState) {
          ...
          if (a.status >= 200 && a.status < 300 || 0 === a.status && "http:" !== s && "https:" !== s) t(a);else {
      ...
      try {
        a.open("GET", e, !0);
        r && (a.responseType = r);
        if (o) for (var l in o) o.hasOwnProperty(l) && o[l] && a.setRequestHeader(l, o[l]);
  ...
  !function () {
    ...
    switch (navigator.appName) {
      ...
      case "Netscape":
        if (window.addEventListener) if (t.indexOf("Firefox") >= 0) {
          $.Browser.vendor = $.BROWSERS.FIREFOX;
          $.Browser.version = parseFloat(t.substring(t.indexOf("Firefox") + 8));
        } else if (t.indexOf("Safari") >= 0) {
          $.Browser.vendor = t.indexOf("Chrome") >= 0 ? $.BROWSERS.CHROME : $.BROWSERS.SAFARI;
    ...
    for (o = 0; o < r.length; o++) (n = (i = r[o]).indexOf("=")) > 0 && (URLPARAMS[i.substring(0, n)] = decodeURIComponent(i.substring(n + 1)));
...
!function (e) {
  ...
  e.EventSource.prototype = {
    ...
    removeHandler: function (t, i) {
      ...
      if (o && e.isArray(o)) {
        for (n = 0; n < o.length; n++) o[n].handler !== i && r.push(o[n]);
...
!function (e) {
  ...
  e.MouseTracker = function (n) {
    ...
    this.blurHandler = n.blurHandler || null;
    var r = this;
    i[this.hash] = {
      click: function (t) {
        i = t, r.clickHandler && e.cancelEvent(i);
        var i;
      },
      dblclick: function (t) {
        i = t, r.dblClickHandler && e.cancelEvent(i);
        var i;
      },
      keydown: function (t) {
        !function (t, i) {
      ...
      mouseover: function (t) {
        !function (t, i) {
          if ((i = e.getEvent(i)).currentTarget === i.relatedTarget || m(i.currentTarget, i.relatedTarget)) return;
          v(t, i);
        }(r, t);
      },
      mouseout: function (t) {
      ...
      mousedown: function (t) {
        !function (t, i) {
          ...
          if (H(t, i, [n], w(i.button))) {
            e.stopEvent(i);
            s(t, "mouse");
          }

          (t.clickHandler || t.dblClickHandler || t.pressHandler || t.dragHandler || t.dragEndHandler) && e.cancelEvent(i);
        }(r, t);
      },
      mouseup: function (e) {
        y(r, e);
      ...
      touchstart: function (i) {
        !function (i, n) {
          ...
          if (d.getLength() > n.touches.length - c) {
            e.console.warn("Tracked touch contact count doesn't match event.touches.length. Removing all tracked touch pointers.");
            x(i, n, d);
          }

          for (r = 0; r < c; r++) u.push({
          ...
          for (r = 0; r < t.length; r++) if (t[r] !== i && t[r].isTracking() && m(t[r].element, i.element)) {
            l = [];

            for (a = 0; a < c; a++) l.push({
      ...
      pointerupcaptured: function (t) {
        !function (t, i) {
          t.getActivePointersListByType(l(i)).getById(i.pointerId) && b(t, i);
          e.stopEvent(i);
        }(r, t);
      },
      pointermovecaptured: function (t) {
        !function (t, i) {
          t.getActivePointersListByType(l(i)).getById(i.pointerId) && I(t, i);
          e.stopEvent(i);
        }(r, t);
      },
      tracking: !1,
  ...
  e.MouseTracker.prototype = {
    ...
    setTracking: function (t) {
      t ? function (t) {
        ...
        if (!s.tracking) {
          for (r = 0; r < e.MouseTracker.subscribeEvents.length; r++) {
            o = e.MouseTracker.subscribeEvents[r];
            e.addEvent(t.element, o, s[o], !1);
          }
    ...
    getActivePointersListsExceptType: function (e) {
      ...
      for (var o = 0; o < t.activePointersLists.length; ++o) t.activePointersLists[o].type !== e && n.push(t.activePointersLists[o]);
    ...
    getActivePointersListByType: function (t) {
      ...
      for (n = 0; n < s; n++) if (r.activePointersLists[n].type === t) return r.activePointersLists[n];
  ...
  e.MouseTracker.resetAllMouseTrackers = function () {
    for (var e = 0; e < t.length; e++) if (t[e].isTracking()) {
      t[e].setTracking(!1);
      t[e].setTracking(!0);
    }
  };
  ...
  e.MouseTracker.gesturePointVelocityTracker = function () {
    ...
    return {
      ...
      removePoint: function (e, n) {
        ...
        for (r = 0; r < a; r++) if (t[r].guid === s) {
          t.splice(r, 1);
          0 == --a && window.clearInterval(i);
          break;
        }
      }
    };
  ...
  e.MouseTracker.supportsMouseCapture = function () {
    var t = document.createElement("div");
    return e.isFunction(t.setCapture) && e.isFunction(t.releaseCapture);
  }();

  e.MouseTracker.subscribeEvents = ["click", "dblclick", "keydown", "keyup", "keypress", "focus", "blur", e.MouseTracker.wheelEventName];
  "DOMMouseScroll" == e.MouseTracker.wheelEventName && e.MouseTracker.subscribeEvents.push("MozMousePixelScroll");

  if (window.PointerEvent && (window.navigator.pointerEnabled || e.Browser.vendor !== e.BROWSERS.IE)) {
    ...
    if (e.Browser.vendor === e.BROWSERS.IE && e.Browser.version < 9) {
      e.MouseTracker.subscribeEvents.push("mouseenter", "mouseleave");
    ...
    e.MouseTracker.subscribeEvents.push("mousedown", "mouseup", "mousemove");
  ...
  function n(t) {
    ...
    for (n = 0; n < r; n++) if (o.activePointersLists[n].captureCount > 0) {
      e.removeEvent(e.MouseTracker.captureElement, "mousemove", o.mousemovecaptured, !0);
      ...
      o.activePointersLists[n].captureCount = 0;
    }
  ...
  function o(t) {
    ...
    if (s.tracking) {
      for (r = 0; r < e.MouseTracker.subscribeEvents.length; r++) {
        o = e.MouseTracker.subscribeEvents[r];
        e.removeEvent(t.element, o, s[o], !1);
      }
  ...
  function s(t, i, n) {
    var o,
        s = t.getActivePointersListByType(i);
    s.captureCount += n || 1;
    if (1 === s.captureCount) if (e.Browser.vendor === e.BROWSERS.IE && e.Browser.version < 9) t.element.setCapture(!0);else {
      o = r(t, e.MouseTracker.havePointerEvents ? "pointerevent" : i);
  ...
  function a(t, i, n) {
    var o,
        s = t.getActivePointersListByType(i);
    s.captureCount -= n || 1;
    if (0 === s.captureCount) if (e.Browser.vendor === e.BROWSERS.IE && e.Browser.version < 9) t.element.releaseCapture();else {
      o = r(t, e.MouseTracker.havePointerEvents ? "pointerevent" : i);
  ...
  function l(t) {
    var i;
    if (e.MouseTracker.unprefixedPointerEvents) i = t.pointerType;else switch (t.pointerType) {
      case 2:
        i = "touch";
        break;
  ...
  function p(t, i) {
    ...
    "mousewheel" == e.MouseTracker.wheelEventName ? n.deltaY = -i.wheelDelta / e.DEFAULT_SETTINGS.pixelsPerWheelLine : n.deltaY = i.detail;
    g(t, n, i);
  }
  ...
  function g(t, i, n) {
    var o = 0;
    o = i.deltaY < 0 ? 1 : -1;
    t.scrollHandler && !1 === t.scrollHandler({
      eventSource: t,
      pointerType: "mouse",
  ...
  function P(t, i) {
    i.currentTarget === i.relatedTarget || m(i.currentTarget, i.relatedTarget) || z(t, i, [{
      id: i.pointerId,
      type: l(i),
  ...
  function R(t, i) {
    i.currentTarget === i.relatedTarget || m(i.currentTarget, i.relatedTarget) || M(t, i, [{
      id: i.pointerId,
      type: l(i),
      isPrimary: i.isPrimary,
      currentPos: h(i),
  ...
  function _(t, i) {
    ...
    (t.clickHandler || t.dblClickHandler || t.pressHandler || t.dragHandler || t.dragEndHandler || t.pinchHandler) && e.cancelEvent(i);
  }
  ...
  function B(e, t) {
    t.hasOwnProperty("isPrimary") || (0 === e.getLength() ? t.isPrimary = !0 : t.isPrimary = !1);
    t.speed = 0;
    t.direction = 0;
  ...
  function D(e, t) {
    ...
    if (e.getById(t.id)) {
      i = e.removeById(t.id);
      t.hasOwnProperty("isPrimary") || (n = e.getPrimary()) || (n = e.getByIndex(0)) && (n.isPrimary = !0);
    } else i = e.getLength();
  ...
  function z(t, i, n) {
    ...
    for (o = 0; o < l; o++) {
      ...
      t.enterHandler && !1 === t.enterHandler({
        eventSource: t,
        pointerType: r.type,
  ...
  function H(t, n, o, r) {
    var s,
        ...
        p = o.length;
    void 0 !== n.buttons ? c.buttons = n.buttons : e.Browser.vendor === e.BROWSERS.IE && e.Browser.version < 9 ? 0 === r ? c.buttons += 1 : 1 === r ? c.buttons += 4 : 2 === r ? c.buttons += 2 : 3 === r ? c.buttons += 8 : 4 === r ? c.buttons += 16 : 5 === r && (c.buttons += 32) : 0 === r ? c.buttons |= 1 : 1 === r ? c.buttons |= 4 : 2 === r ? c.buttons |= 2 : 3 === r ? c.buttons |= 8 : 4 === r ? c.buttons |= 16 : 5 === r && (c.buttons |= 32);
    var g = t.getActivePointersListsExceptType(o[0].type);

    for (s = 0; s < g.length; s++) x(t, n, g[s]);

    if (0 !== r) {
      t.nonPrimaryPressHandler && !1 === t.nonPrimaryPressHandler({
        eventSource: t,
    ...
    for (s = 0; s < p; s++) {
      ...
      c.addContact();
      (t.dragHandler || t.dragEndHandler || t.pinchHandler) && e.MouseTracker.gesturePointVelocityTracker.addPoint(t, a);
      if (1 === c.contacts) t.pressHandler && !1 === t.pressHandler({
        eventSource: t,
        pointerType: a.type,
        ...
        preventDefaultAction: !1,
        userData: t.userData
      }) && e.cancelEvent(n);else if (2 === c.contacts && t.pinchHandler && "touch" === a.type) {
        h.pinchGPoints = c.asArray();
        h.lastPinchDist = h.currentPinchDist = h.pinchGPoints[0].currentPos.distanceTo(h.pinchGPoints[1].currentPos);
        h.lastPinchCenter = h.currentPinchCenter = d(h.pinchGPoints[0].currentPos, h.pinchGPoints[1].currentPos);
      }
    }
  ...
  function L(t, n, o, r) {
    var s,
        ...
        f = !1,
        w = !1;
    void 0 !== n.buttons ? m.buttons = n.buttons : e.Browser.vendor === e.BROWSERS.IE && e.Browser.version < 9 ? 0 === r ? m.buttons -= 1 : 1 === r ? m.buttons -= 4 : 2 === r ? m.buttons -= 2 : 3 === r ? m.buttons -= 8 : 4 === r ? m.buttons -= 16 : 5 === r && (m.buttons -= 32) : 0 === r ? m.buttons ^= -2 : 1 === r ? m.buttons ^= -5 : 2 === r ? m.buttons ^= -3 : 3 === r ? m.buttons ^= -9 : 4 === r ? m.buttons ^= -17 : 5 === r && (m.buttons ^= -33);
    ...
    if (0 !== r) {
      ...
      x(t, n, t.getActivePointersListByType("mouse"));
      return !1;
    }
    ...
    for (l = 0; l < v; l++) {
      ...
      if (c = m.getById(h.id)) {
        ...
        if (w) {
          m.removeContact();
          (t.dragHandler || t.dragEndHandler || t.pinchHandler) && e.MouseTracker.gesturePointVelocityTracker.removePoint(t, c);

          if (0 === m.contacts) {
            t.releaseHandler && !1 === t.releaseHandler({
              eventSource: t,
              pointerType: c.type,
            ...
            t.dragEndHandler && !c.currentPos.equals(c.contactPos) && !1 === t.dragEndHandler({
              eventSource: t,
              pointerType: c.type,
            ...
            if ((t.clickHandler || t.dblClickHandler) && c.insideElement) {
              p = a - c.contactTime <= t.clickTimeThreshold && c.contactPos.distanceTo(s) <= t.clickDistThreshold;
              t.clickHandler && !1 === t.clickHandler({
                eventSource: t,
                pointerType: c.type,
                position: u(c.currentPos, t.element),
                quick: p,
              ...
              if (t.dblClickHandler && p) {
                m.clicks++;

                if (1 === m.clicks) {
                  g.lastClickPos = s;
                  g.dblClickTimeOut = setTimeout(function () {
                    m.clicks = 0;
                  }, t.dblClickTimeThreshold);
                } else if (2 === m.clicks) {
                  clearTimeout(g.dblClickTimeOut);
                  m.clicks = 0;
                  g.lastClickPos.distanceTo(s) <= t.dblClickDistThreshold && !1 === t.dblClickHandler({
                    eventSource: t,
                    pointerType: c.type,
                    position: u(c.currentPos, t.element),
                    shift: n.shiftKey,
          ...
          } else if (2 === m.contacts && t.pinchHandler && "touch" === c.type) {
            g.pinchGPoints = m.asArray();
            g.lastPinchDist = g.currentPinchDist = g.pinchGPoints[0].currentPos.distanceTo(g.pinchGPoints[1].currentPos);
            g.lastPinchCenter = g.currentPinchCenter = d(g.pinchGPoints[0].currentPos, g.pinchGPoints[1].currentPos);
          }
        } else t.releaseHandler && !1 === t.releaseHandler({
          eventSource: t,
          pointerType: c.type,
          position: u(s, t.element),
          buttons: m.buttons,
  ...
  function F(t, n, o) {
    var r,
        ...
        m = o.length;
    void 0 !== n.buttons && (g.buttons = n.buttons);

    for (r = 0; r < m; r++) {
      s = o[r];

      if (a = g.getById(s.id)) {
        s.hasOwnProperty("isPrimary") && (a.isPrimary = s.isPrimary);
    ...
    if (t.stopHandler && "mouse" === o[0].type) {
      clearTimeout(t.stopTimeOut);
      t.stopTimeOut = setTimeout(function () {
        e = t, i = n, r = o[0].type, e.stopHandler && e.stopHandler({
          eventSource: e,
          pointerType: r,
          position: c(i, e.element),
          buttons: e.getActivePointersListByType(r).buttons,
          isTouchEvent: "touch" === r,
          originalEvent: i,
          preventDefaultAction: !1,
          userData: e.userData
        });
    ...
    if (0 === g.contacts) t.moveHandler && !1 === t.moveHandler({
      eventSource: t,
      pointerType: o[0].type,
      position: u(o[0].currentPos, t.element),
      buttons: g.buttons,
      ...
      preventDefaultAction: !1,
      userData: t.userData
    }) && e.cancelEvent(n);else if (1 === g.contacts) {
      if (t.moveHandler) {
        a = g.asArray()[0];
        !1 === t.moveHandler({
          eventSource: t,
      ...
      if (t.dragHandler) {
        h = (a = g.asArray()[0]).currentPos.minus(a.lastPos);
        !1 === t.dragHandler({
          eventSource: t,
          pointerType: a.type,
          position: u(a.currentPos, t.element),
      ...
      if (t.pinchHandler && "touch" === o[0].type && (h = p.pinchGPoints[0].currentPos.distanceTo(p.pinchGPoints[1].currentPos)) != p.currentPinchDist) {
        p.lastPinchDist = p.currentPinchDist;
        p.currentPinchDist = h;
        p.lastPinchCenter = p.currentPinchCenter;
        p.currentPinchCenter = d(p.pinchGPoints[0].currentPos, p.pinchGPoints[1].currentPos);
        !1 === t.pinchHandler({
          eventSource: t,
          pointerType: "touch",
...
!function (e) {
  ...
  e.Control = function (t, i, n) {
    ...
    if ("number" == typeof i) {
      e.console.error("Passing an anchor directly into the OpenSeadragon.Control constructor is deprecated; please use an options object instead.  Support for this deprecated variant is scheduled for removal in December 2013");
      i = {
        anchor: i
      };
    }

    i.attachToViewer = void 0 === i.attachToViewer || i.attachToViewer;
...
!function (e) {
  ...
  e.Viewer = function (o) {
    ...
    "" !== o.tabIndex && (this.canvas.tabIndex = void 0 === o.tabIndex ? 0 : o.tabIndex);
    ...
    this.outerTracker = new e.MouseTracker({
      ...
      dblClickTimeThreshold: this.dblClickTimeThreshold,
      dblClickDistThreshold: this.dblClickDistThreshold,
      enterHandler: e.delegate(this, _),
    ...
    this.world.addHandler("remove-item", function (e) {
      h.world.getItemCount() ? h.source = h.world.getItemAt(0).source : h.source = null;
      t[h.hash].forceRedraw = !0;
    });
    this.world.addHandler("metrics-change", function (e) {
      h.viewport && h.viewport._setContentBounds(h.world.getHomeBounds(), h.world.getContentFactor());
    });
    ...
    for (r = 0; r < this.customControls.length; r++) this.addControl(this.customControls[r].id, {
  ...
  e.extend(e.Viewer.prototype, e.EventSource.prototype, e.ControlDock.prototype, {
    ...
    openDzi: function (t) {
      e.console.error("[Viewer.openDzi] this function is deprecated; use Viewer.open() instead.");
      return this.open(t);
    },
    openTileSource: function (t) {
      e.console.error("[Viewer.openTileSource] this function is deprecated; use Viewer.open() instead.");
      return this.open(t);
    },
    open: function (t, i) {
      var n = this;
      this.close();
      if (t) if (this.sequenceMode && e.isArray(t)) {
        ...
        if (t.length) {
          ...
          var h = function () {
            if (s + a === r) if (s) {
              if (n._firstOpen || !n.preserveViewport) {
                n.viewport.goHome(!0);
                n.viewport.update();
              }
              ...
              if (n.overlays && !n.preserveOverlays) for (var i = 0; i < n.overlays.length; i++) n.currentOverlays[i] = o(n, n.overlays[i]);
          ...
          var c = function (t) {
            ...
            if (void 0 !== t.index) {
              e.console.error("[Viewer.open] setting indexes here is not supported; use addTiledImage instead");
              delete t.index;
            }

            void 0 === t.collectionImmediately && (t.collectionImmediately = !0);
            var i = t.success;

            t.success = function (e) {
              s++;
              if (t.tileSource.overlays) for (var o = 0; o < t.tileSource.overlays.length; o++) n.addOverlay(t.tileSource.overlays[o]);
              i && i(e);
              h();
            };
    ...
    areControlsEnabled: function () {
      ...
      for (e = 0; e < this.controls.length; e++) t = t && this.controls[e].isVisibile();
    ...
    setFullPage: function (i) {
      ...
      this.raiseEvent("pre-full-page", h);
      if (h.preventDefaultAction) return this;
      ...
      if (i) {
        ...
        for (o = 0; o < n; o++) r.appendChild(this.previousBody.shift());
    ...
    setFullScreen: function (t) {
      ...
      if (n.preventDefaultAction) return this;
      ...
      if (t) {
        ...
        var o = function () {
          ...
          i.navigator && i.viewport && i.navigator.update(i.viewport);
    ...
    addTiledImage: function (t) {
      e.console.assert(t, "[Viewer.addTiledImage] options is required");
      e.console.assert(t.tileSource, "[Viewer.addTiledImage] options.tileSource is required");
      e.console.assert(!t.replace || t.index > -1 && t.index < this.world.getItemCount(), "[Viewer.addTiledImage] if options.replace is used, options.index must be a valid index in Viewer.world");
      var i = this;
      ...
      void 0 === t.ajaxHeaders || null === t.ajaxHeaders ? t.ajaxHeaders = this.ajaxHeaders : e.isPlainObject(t.ajaxHeaders) && e.isPlainObject(this.ajaxHeaders) && (t.ajaxHeaders = e.extend({}, this.ajaxHeaders, t.ajaxHeaders));
      var n = {
        options: t
      };

      function o(e) {
        for (var o = 0; o < i._loadQueue.length; o++) if (i._loadQueue[o] === n) {
      ...
      if (e.isArray(t.tileSource)) setTimeout(function () {
        o({
        ...
        !function (t, i, n, o, r) {
          var s = t;
          if ("string" == e.type(i)) if (i.match(/^\s*<.*>\s*$/)) i = e.parseXml(i);else if (i.match(/^\s*[\{\[].*[\}\]]\s*$/)) try {
            var a = e.parseJSON(i);
            i = a;
          } catch (e) {}
          ...
          setTimeout(function () {
            if ("string" == e.type(i)) (i = new e.TileSource({
              ...
              void 0 !== i.crossOriginPolicy || void 0 === n.crossOriginPolicy && void 0 === t.crossOriginPolicy || (i.crossOriginPolicy = void 0 !== n.crossOriginPolicy ? n.crossOriginPolicy : t.crossOriginPolicy);
              void 0 === i.ajaxWithCredentials && (i.ajaxWithCredentials = t.ajaxWithCredentials);
              void 0 === i.useCanvas && (i.useCanvas = t.useCanvas);

              if (e.isFunction(i.getTileUrl)) {
      ...
      function s() {
        ...
        for (; i._loadQueue.length && (t = i._loadQueue[0]).tileSource;) {
          i._loadQueue.splice(0, 1);
          ...
          1 !== i.world.getItemCount() || i.preserveViewport || i.viewport.goHome(!0);
          ...
          t.options.success && t.options.success({
            item: n
          });
        }
      }
    ...
    addSimpleImage: function (t) {
      e.console.assert(t, "[Viewer.addSimpleImage] options is required");
      e.console.assert(t.url, "[Viewer.addSimpleImage] options.url is required");
      var i = e.extend({}, t, {
        tileSource: {
          type: "image",
          url: t.url
    ...
    addLayer: function (t) {
      ...
      this.addTiledImage(n);
      return this;
    },
    getLayerAtLevel: function (t) {
      e.console.error("[Viewer.getLayerAtLevel] this function is deprecated; use World.getItemAt() instead.");
      return this.world.getItemAt(t);
    },
    getLevelOfLayer: function (t) {
      e.console.error("[Viewer.getLevelOfLayer] this function is deprecated; use World.getIndexOfItem() instead.");
      return this.world.getIndexOfItem(t);
    },
    getLayersCount: function () {
      e.console.error("[Viewer.getLayersCount] this function is deprecated; use World.getItemCount() instead.");
      return this.world.getItemCount();
    },
    setLayerLevel: function (t, i) {
      e.console.error("[Viewer.setLayerLevel] this function is deprecated; use World.setItemIndex() instead.");
      return this.world.setItemIndex(t, i);
    },
    removeLayer: function (t) {
      e.console.error("[Viewer.removeLayer] this function is deprecated; use World.removeItem() instead.");
      return this.world.removeItem(t);
    },
    ...
    bindStandardControls: function () {
      ...
      if (this.showNavigationControl) {
        (this.zoomInButton || this.zoomOutButton || this.homeButton || this.fullPageButton || this.rotateLeftButton || this.rotateRightButton || this.flipButton) && (f = !1);

        if (this.showZoomControl) {
          v.push(this.zoomInButton = new e.Button({
        ...
        if (this.showRotationControl) {
          v.push(this.rotateLeftButton = new e.Button({
    ...
    addOverlay: function (t, i, n, s) {
      ...
      if (r(this.currentOverlays, t) >= 0) return this;
      var l = o(this, a);
    ...
    updateOverlay: function (i, n, o) {
      ...
      if ((s = r(this.currentOverlays, i)) >= 0) {
    ...
    removeOverlay: function (i) {
      ...
      if ((n = r(this.currentOverlays, i)) >= 0) {
    ...
    getOverlayById: function (t) {
      var i;
      t = e.getElement(t);
      return (i = r(this.currentOverlays, t)) >= 0 ? this.currentOverlays[i] : null;
    },
    _updateSequenceButtons: function (e) {
      ...
      this.previousButton && (e > 0 ? this.previousButton.enable() : this.navPrevNextWrap || this.previousButton.disable());
    },
  ...
  function n(t) {
    t = e.getElement(t);
    return new e.Point(0 === t.clientWidth ? 1 : t.clientWidth, 0 === t.clientHeight ? 1 : t.clientHeight);
  }

  function o(t, i) {
    if (i instanceof e.Overlay) return i;
    var n = null;
    if (i.element) n = e.getElement(i.element);else {
    ...
    var u = i.placement;
    u && "string" === e.type(u) && (u = e.Placement[i.placement.toUpperCase()]);
    ...
    e.requestAnimationFrame(function () {
      !function (t) {
        ...
        if (t.controlsShouldFade) {
          ...
          for (r = t.controls.length - 1; r >= 0; r--) t.controls[r].autoFade && t.controls[r].setOpacity(o);
  ...
  function d(t) {
    ...
    if (i.preventDefaultAction || t.ctrl || t.alt || t.meta) return !0;

    switch (t.keyCode) {
      case 38:
        if (!i.preventVerticalPan) {
          t.shift ? this.viewport.zoomBy(1.1) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(0, -this.pixelsPerArrowPress)));
      ...
      case 40:
        if (!i.preventVerticalPan) {
          t.shift ? this.viewport.zoomBy(.9) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(0, this.pixelsPerArrowPress)));
          this.viewport.applyConstraints();
        }
      ...
      case 37:
        if (!i.preventHorizontalPan) {
          this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(-this.pixelsPerArrowPress, 0)));
          this.viewport.applyConstraints();
        }
  ...
  function p(t) {
    ...
    switch (t.keyCode) {
      ...
      case 87:
        if (!i.preventVerticalPan) {
          t.shift ? this.viewport.zoomBy(1.1) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(0, -40)));
          this.viewport.applyConstraints();
        }
      ...
      case 83:
        if (!i.preventVerticalPan) {
          t.shift ? this.viewport.zoomBy(.9) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(0, 40)));
          this.viewport.applyConstraints();
        }
  ...
  function f(t) {
    if (!t.preventDefaultAction && this.viewport) {
      ...
      if (i.flickEnabled && t.speed >= i.flickMinSpeed) {
        ...
        var s = this.viewport.pointFromPixel(new e.Point(r.x - n, r.y - o));
  ...
  function y(t) {
    window.location != window.parent.location && e.MouseTracker.resetAllMouseTrackers();
  ...
  function R(t) {
    ...
    if ((o = e.now()) - this._lastScrollTime > this.minScrollDeltaTime) {
      ...
      this.viewport.flipped && (t.position.x = this.viewport.getContainerSize().x - t.position.x);

      if (!t.preventDefaultAction && this.viewport && (i = this.gestureSettingsByDeviceType(t.pointerType)).scrollToZoom) {
  ...
  function b(e) {
    !function (e) {
      ...
      if (e.autoResize) {
        var i = n(e.container);
        var o = t[e.hash].prevContainerSize;
        ...
        if (!i.equals(o)) {
          ...
          if (e.preserveImageSizeOnResize) {
            ...
            var u = r.getBounds();
            r.resize(i, !0);
            r.fitBoundsWithConstraints(u, !0);
          }
  ...
  function z() {
    ...
    if (t[this.hash].zooming && this.viewport) {
...
!function (e) {
  e.Navigator = function (s) {
    ...
    if (s.id) {
      ...
      if (s.position) if ("BOTTOM_RIGHT" == s.position) s.controlOptions.anchor = e.ControlAnchor.BOTTOM_RIGHT;else if ("BOTTOM_LEFT" == s.position) s.controlOptions.anchor = e.ControlAnchor.BOTTOM_LEFT;else if ("TOP_RIGHT" == s.position) s.controlOptions.anchor = e.ControlAnchor.TOP_RIGHT;else if ("TOP_LEFT" == s.position) s.controlOptions.anchor = e.ControlAnchor.TOP_LEFT;else if ("ABSOLUTE" == s.position) {
    ...
    })).minPixelRatio = this.minPixelRatio = h.minPixelRatio;
    ...
    s.controlOptions.anchor != e.ControlAnchor.NONE && function (e, t) {
      e.margin = "0px";
    ...
    if (this._resizeWithViewer) {
      if (s.width && s.height) {
        this.element.style.height = "number" == typeof s.height ? s.height + "px" : s.height;
        this.element.style.width = "number" == typeof s.width ? s.width + "px" : s.width;
      } else {
        a = e.getElementSize(h.element);
    ...
    function u(e) {
      r(c.displayRegionContainer, e);
      r(c.displayRegion, -e);
      c.viewport.setRotation(e);
    }

    if (s.navigatorRotate) {
      u(s.viewer.viewport ? s.viewer.viewport.getRotation() : s.viewer.degrees || 0);
    ...
    h.world.addHandler("item-index-change", function (e) {
      window.setTimeout(function () {
        var t = c.world.getItemAt(e.previousIndex);
        c.world.setItemIndex(t, e.newIndex);
      }, 1);
    });
    h.world.addHandler("remove-item", function (e) {
      var t = e.item;

      var i = c._getMatchingItem(t);
  ...
  e.extend(e.Navigator.prototype, e.EventSource.prototype, e.Viewer.prototype, {
    updateSize: function () {
      if (this.viewport) {
        ...
        if (!t.equals(this.oldContainerSize)) {
    ...
    update: function (t) {
      ...
      if (t && this.viewport) {
        ...
        a = this.viewport.pixelFromPointNoRotate(r.getBottomRight(), !1).minus(this.totalBorderWidths);
        ...
        l.height = Math.round(Math.max(c, 0)) + "px";
      }
    },
    addTiledImage: function (t) {
      var i = this;
      var n = t.originalTiledImage;
      delete t.original;
      var o = e.extend({}, t, {
        success: function (e) {
          var t = e.item;
...
!function (e) {
  ...
  e.extend(e, {
    getString: function (i) {
      ...
      if ("string" != typeof (r = a[o[n]])) {
        e.console.log("Untranslated source string:", i);
        r = "";
      }
...
!function (e) {
  ...
  e.Point.prototype = {
    ...
    rotate: function (t, i) {
      ...
      var a = o * (this.x - i.x) + n * (this.y - i.y) + i.y;
...
!function (e) {
  e.TileSource = function (t, i, n, o, r, s) {
    ...
    e.EventSource.call(this);
    e.extend(!0, this, l);
    if (!this.success) for (h = 0; h < arguments.length; h++) if (e.isFunction(arguments[h])) {
      this.success = arguments[h];
      break;
    }
    ...
    if (this.url) {
      ...
      this.dimensions = new e.Point(l.width, l.height);
      ...
      this.tileOverlap = l.tileOverlap ? l.tileOverlap : 0;
  ...
  e.TileSource.prototype = {
    getTileSize: function (t) {
      e.console.error("[TileSource.getTileSize] is deprecated.Use TileSource.getTileWidth() and TileSource.getTileHeight() instead");
    ...
    getTileAtPoint: function (t, i) {
      ...
      var r = i.x * o;
      var s = i.y * o;
      var a = Math.floor(r / this.getTileWidth(t));
      var l = Math.floor(s / this.getTileHeight(t));
      i.x >= 1 && (a = this.getNumTiles(t).x - 1);
      i.y >= 1 / this.aspectRatio - 1e-15 && (l = this.getNumTiles(t).y - 1);
    ...
    getTileBounds: function (t, i, n, o) {
      ...
      c = Math.min(c, r.x - l);
      u = Math.min(u, r.y - h);
      return o ? new e.Rect(0, 0, c, u) : new e.Rect(l * d, h * d, c * d, u * d);
    },
    getImageInfo: function (t) {
      ...
      n = function (i) {
        ...
        if (n) {
          void 0 === (r = n.prototype.configure.apply(h, [i, t])).ajaxWithCredentials && (r.ajaxWithCredentials = h.ajaxWithCredentials);
          o = new n(r);
          h.ready = !0;
          h.raiseEvent("ready", {
            tileSource: o
          });
        } else h.raiseEvent("open-failed", {
          message: "Unable to load TileSource",
          source: t
        });
      };
          ...
          var i = function (t) {
                ...
                r = t.status;
            {
              ...
              if (200 !== t.status && 0 !== t.status) {
                ...
                throw new Error(e.getString("Errors.Status", r, i));
              }
            }
            if (o.match(/\s*<.*/)) try {
  ...
  e.TileSource.determineType = function (t, i, n) {
    ...
    for (o in OpenSeadragon) if (o.match(/.+TileSource$/) && e.isFunction(OpenSeadragon[o]) && e.isFunction(OpenSeadragon[o].prototype.supports) && OpenSeadragon[o].prototype.supports.call(t, i, n)) return OpenSeadragon[o];
...
!function (e) {
  e.DziTileSource = function (t, i, n, o, r, s, a, l, h) {
    ...
    if (this.displayRects) for (c = this.displayRects.length - 1; c >= 0; c--) for (d = (u = this.displayRects[c]).minLevel; d <= u.maxLevel; d++) {
  ...
  e.extend(e.DziTileSource.prototype, e.TileSource.prototype, {
    ...
    configure: function (i, n) {
      var o;
      o = e.isPlainObject(i) ? t(this, i) : function (i, n) {
        ...
        var o,
            ...
            p = [];
        if ("Image" == c) try {
          void 0 === (a = h.getElementsByTagName("Size")[0]) && (a = h.getElementsByTagNameNS(u, "Size")[0]);
          d = {
            Image: {
          ...
          if (!e.imageFormatSupported(d.Image.Format)) throw new Error(e.getString("Errors.ImageFormat", d.Image.Format.toUpperCase()));
          void 0 === (o = h.getElementsByTagName("DisplayRect")) && (o = h.getElementsByTagNameNS(u, "DisplayRect")[0]);
          ...
          p.length && (d.Image.DisplayRect = p);
          return t(i, d);
        } catch (t) {
          throw t instanceof Error ? t : new Error(e.getString("Errors.Dzi"));
        } else {
          if ("Collection" == c) throw new Error(e.getString("Errors.Dzc"));

          if ("Error" == c) {
            var g = h.getElementsByTagName("Message")[0];
            var m = g.firstChild.nodeValue;
            throw new Error(m);
          }
        }
      ...
      if (n && !o.tilesUrl) {
        o.tilesUrl = n.replace(/([^\/]+?)(\.(dzi|xml|js)?(\?[^\/]*)?)?\/?$/, "$1_files/");
        -1 != n.search(/\.(dzi|xml|js)\?/) ? o.queryParams = n.match(/\?.*/) : o.queryParams = "";
      }
    ...
    tileExists: function (e, t, i) {
      ...
      for (h = c.length - 1; h >= 0; h--) if (!(e < (n = c[h]).minLevel || e > n.maxLevel)) {
  ...
  function t(t, i) {
    ...
    for (o = 0; o < h.length; o++) {
      n = h[o].Rect;
      g.push(new e.DisplayRect(parseInt(n.X, 10), parseInt(n.Y, 10), parseInt(n.Width, 10), parseInt(n.Height, 10), parseInt(n.MinLevel, 10), parseInt(n.MaxLevel, 10)));
    }
...
!function (e) {
  e.IIIFTileSource = function (t) {
    ...
    if (this.tile_width && this.tile_height) {
      t.tileWidth = this.tile_width;
      t.tileHeight = this.tile_height;
    } else if (this.tile_width) t.tileSize = this.tile_width;else if (this.tile_height) t.tileSize = this.tile_height;else if (this.tiles) {
      if (1 == this.tiles.length) {
        ...
        for (var i = 0; i < this.tiles.length; i++) for (var n = 0; n < this.tiles[i].scaleFactors.length; n++) {
          var o = this.tiles[i].scaleFactors[n];
          this.scale_factors.push(o);
          t.tileSizePerScaleFactor[o] = {
            width: this.tiles[i].width,
            height: this.tiles[i].height || this.tiles[i].width
          };
        }
      }
    } else if (h = t.profile, -1 == ["http://library.stanford.edu/iiif/image-api/compliance.html#level0", "http://library.stanford.edu/iiif/image-api/1.1/compliance.html#level0", "http://iiif.io/api/image/2/level0.json"].indexOf(h[0]) || -1 != h.indexOf("sizeByW")) {
      var r = Math.min(this.height, this.width),
          s = [256, 512, 1024],
          a = [];

      for (var l = 0; l < s.length; l++) s[l] <= r && a.push(s[l]);

      a.length > 0 ? t.tileSize = Math.max.apply(null, a) : t.tileSize = r;
      ...
      t.levels = function (e) {
        ...
        for (var i = 0; i < e.sizes.length; i++) t.push({
          url: e["@id"] + "/full/" + e.sizes[i].width + ",/0/default.jpg",
    ...
    } else e.console.error("Nothing in the info.json to construct image pyramids from");

    var h;
    if (!t.maxLevel && !this.emulateLegacyImagePyramid) if (this.scale_factors) {
      var c = Math.max.apply(null, this.scale_factors);
      t.maxLevel = Math.round(Math.log(c) * Math.LOG2E);
    } else t.maxLevel = Number(Math.ceil(Math.log(Math.max(this.width, this.height), 2)));
  ...
  e.extend(e.IIIFTileSource.prototype, e.TileSource.prototype, {
    ...
    configure: function (t, i) {
      ...
      var n = function (t) {
        ...
        var i = t.documentElement,
            n = null;
        if ("info" == i.tagName) try {
          !function t(i, n, o) {
            var r, s;

            if (3 == i.nodeType && o) {
              (s = i.nodeValue.trim()).match(/^\d*$/) && (s = Number(s));

              if (n[o]) {
                e.isArray(n[o]) || (n[o] = [n[o]]);
                n[o].push(s);
              } else n[o] = s;
            } else if (1 == i.nodeType) for (r = 0; r < i.childNodes.length; r++) t(i.childNodes[r], n, i.nodeName);
          }(i, n = {});
          return n;
        } catch (t) {
          throw t instanceof Error ? t : new Error(e.getString("Errors.IIIF"));
        }
        throw new Error(e.getString("Errors.IIIF"));
      }(t);

      n["@context"] = "http://iiif.io/api/image/1.0/context.json";
      n["@id"] = i.replace("/info.xml", "");
      return n;
    },
    ...
    getLevelScale: function (t) {
      if (this.emulateLegacyImagePyramid) {
        var i = NaN;
        this.levels.length > 0 && t >= this.minLevel && t <= this.maxLevel && (i = this.levels[t].width / this.levels[this.maxLevel].width);
        return i;
      }
    ...
    getTileUrl: function (e, t, i) {
      if (this.emulateLegacyImagePyramid) {
        var n = null;
        this.levels.length > 0 && e >= this.minLevel && e <= this.maxLevel && (n = this.levels[e].url);
        return n;
      }
      ...
      s = Math.ceil(o / m);
      a = Math.ceil(r / m);
      g = this["@context"].indexOf("/1.0/context.json") > -1 || this["@context"].indexOf("/1.1/context.json") > -1 || this["@context"].indexOf("/1/context.json") > -1 ? "native.jpg" : "default.jpg";
...
!function (e) {
  ...
  e.extend(e.LegacyTileSource.prototype, e.TileSource.prototype, {
    ...
    configure: function (i, n) {
      return e.isPlainObject(i) ? t(this, i) : function (i, n) {
        ...
        if ("image" == a) try {
          ...
          h = s.getElementsByTagName("level");
    ...
    getLevelScale: function (e) {
      var t = NaN;
      this.levels.length > 0 && e >= this.minLevel && e <= this.maxLevel && (t = this.levels[e].width / this.levels[this.maxLevel].width);
      return t;
    },
    getNumTiles: function (t) {
      return this.getLevelScale(t) ? new e.Point(1, 1) : new e.Point(0, 0);
  ...
  e.extend(e.ImageTileSource.prototype, e.TileSource.prototype, {
    ...
    getImageInfo: function (t) {
      ...
      e.addEvent(i, "load", function () {
        n.width = Object.prototype.hasOwnProperty.call(i, "naturalWidth") ? i.naturalWidth : i.width;
    ...
    _buildLevels: function () {
      ...
      var n = Object.prototype.hasOwnProperty.call(this._image, "naturalHeight") ? this._image.naturalHeight : this._image.height;
      ...
      t[0].context2D = r;
      delete this._image;
      if (e.isCanvasTainted(o)) return t;
...
!function (e) {
  ...
  e.Button = function (t) {
    ...
    this.tracker = new e.MouseTracker({
      ...
      enterHandler: function (t) {
        if (t.insideElementPressed) {
          i(o, e.ButtonState.DOWN);
          o.raiseEvent("enter", {
            originalEvent: t.originalEvent
          });
        } else t.buttonDownAny || i(o, e.ButtonState.HOVER);
      },
      ...
      exitHandler: function (t) {
        ...
        t.insideElementPressed && o.raiseEvent("exit", {
          originalEvent: t.originalEvent
        });
      },
      ...
      releaseHandler: function (t) {
        if (t.insideElementPressed && t.insideElementReleased) {
          n(o, e.ButtonState.HOVER);
          o.raiseEvent("release", {
            originalEvent: t.originalEvent
          });
        } else t.insideElementPressed ? n(o, e.ButtonState.GROUP) : i(o, e.ButtonState.HOVER);
      },
  ...
  function i(t, i) {
    if (!t.element.disabled) {
      if (i >= e.ButtonState.GROUP && t.currentState == e.ButtonState.REST) {
        !function (t) {
          t.shouldFade = !1;
      ...
      if (i >= e.ButtonState.HOVER && t.currentState == e.ButtonState.GROUP) {
        t.imgHover && (t.imgHover.style.visibility = "");
        t.currentState = e.ButtonState.HOVER;
      }

      if (i >= e.ButtonState.DOWN && t.currentState == e.ButtonState.HOVER) {
  ...
  function n(i, n) {
    if (!i.element.disabled) {
      if (n <= e.ButtonState.HOVER && i.currentState == e.ButtonState.DOWN) {
        i.imgDown && (i.imgDown.style.visibility = "hidden");
        i.currentState = e.ButtonState.HOVER;
      }

      if (n <= e.ButtonState.GROUP && i.currentState == e.ButtonState.HOVER) {
        i.imgHover && (i.imgHover.style.visibility = "hidden");
        i.currentState = e.ButtonState.GROUP;
      }

      if (n <= e.ButtonState.REST && i.currentState == e.ButtonState.GROUP) {
        !function (i) {
          i.shouldFade = !0;
...
!function (e) {
  e.ButtonGroup = function (t) {
    ...
    if (!t.group) {
      this.label = e.makeNeutralElement("label");
      this.element.style.display = "inline-block";
    ...
    this.tracker = new e.MouseTracker({
      ...
      exitHandler: function (e) {
        var t;
        if (!e.insideElementPressed) for (t = 0; t < o.buttons.length; t++) o.buttons[t].notifyGroupExit();
      }
    });
  };
...
!function (e) {
  ...
  e.Rect.fromSummits = function (t, i, n) {
    ...
    var s = i.minus(t);
    var a = Math.atan(s.y / s.x);
    s.x < 0 ? a += Math.PI : s.y < 0 && (a += 2 * Math.PI);
    return new e.Rect(t.x, t.y, o, r, a / Math.PI * 180);
  };
  ...
  e.Rect.prototype = {
    ...
    union: function (t) {
      ...
      var r = Math.min(i.y, n.y);
      var s = Math.max(i.x + i.width, n.x + n.width);
    ...
    intersection: function (t) {
      ...
      var d = this._getSegments();

      var p = t._getSegments();
      ...
      function y(t, n, o, r) {
        var s = n.minus(t);
        var a = r.minus(o);
        var l = -a.x * s.y + s.x * a.y;
        if (0 === l) return null;
        var h = (s.x * (t.y - o.y) - s.y * (t.x - o.x)) / l;
        var c = (a.x * (t.y - o.y) - a.y * (t.x - o.x)) / l;
    ...
    rotate: function (t, i) {
      ...
      var o = this.getTopRight().rotate(t, i).minus(n);
      o = o.apply(function (e) {
        return Math.abs(e) < 1e-15 ? 0 : e;
      });
      var r = Math.atan(o.y / o.x);
      o.x < 0 ? r += Math.PI : o.y < 0 && (r += 2 * Math.PI);
      return new e.Rect(n.x, n.y, this.width, this.height, r / Math.PI * 180);
    },
    getBoundingBox: function () {
      ...
      var r = Math.min(t.x, i.x, n.x, o.x);
      var s = Math.max(t.x, i.x, n.x, o.x);
      var a = Math.min(t.y, i.y, n.y, o.y);
      var l = Math.max(t.y, i.y, n.y, o.y);
      return new e.Rect(r, a, s - r, l - a);
    },
    getIntegerBoundingBox: function () {
      var t = this.getBoundingBox();
      var i = Math.floor(t.x);
      var n = Math.floor(t.y);
      var o = Math.ceil(t.width + t.x - i);
      var r = Math.ceil(t.height + t.y - n);
...
!function (e) {
  ...
  e.ReferenceStrip = function (h) {
    ...
    } else if ("horizontal" == h.scroll) {
      this.element.style.width = g.x * h.sizeRatio * p.tileSources.length + 12 * p.tileSources.length + "px";
      this.element.style.height = g.y * h.sizeRatio + "px";
      p.addControl(this.element, {
        anchor: e.ControlAnchor.BOTTOM_LEFT
      });
    } else {
      this.element.style.height = g.y * h.sizeRatio * p.tileSources.length + 12 * p.tileSources.length + "px";
    ...
    for (d = 0; d < p.tileSources.length; d++) {
      ...
      c.innerTracker = new e.MouseTracker({
        element: c,
        clickTimeThreshold: this.clickTimeThreshold,
        clickDistThreshold: this.clickDistThreshold,
        pressHandler: function (t) {
        ...
        releaseHandler: function (t) {
          ...
          if (t.insideElementPressed && t.insideElementReleased && i.dragging && r - i.dragging < i.clickTimeThreshold) {
            i.dragging = null;
            p.goToPage(o);
          }
        }
    ...
    o(this, "vertical" == this.scroll ? g.y : g.x, 0);
    this.setFocus(0);
  };
  ...
  e.extend(e.ReferenceStrip.prototype, e.EventSource.prototype, e.Viewer.prototype, {
    setFocus: function (t) {
      var i,
          n = e.getElement(this.element.id + "-" + t),
      ...
      if (this.currentSelected !== n) {
        ...
        } else if ((i = Number(t) * (this.panelHeight + 3)) > c + s.y - this.panelHeight) {
          i = Math.min(i, l - s.y);
  ...
  function o(t, i, n) {
    ...
    for (h = r = (r = (s = Math.ceil((Math.abs(n) + i) / o) + 1) - r) < 0 ? 0 : r; h < s && h < t.panels.length; h++) if (!(c = t.panels[h]).activePanel) {
      var u;
      var d = t.viewer.tileSources[h];
  ...
  function s(t) {
    ...
    "horizontal" == this.scroll ? i.style.marginBottom = "-" + e.getElementSize(i).y / 2 + "px" : i.style.marginLeft = "-" + e.getElementSize(i).x / 2 + "px";
    return !1;
  }
...
!function (e) {
  e.Spring = function (t) {
    ...
    e.console.assert("number" == typeof t.animationTime && t.animationTime >= 0, "[OpenSeadragon.Spring] options.animationTime must be a number greater than or equal to 0");

    if (t.exponential) {
      this._exponential = !0;
      delete t.exponential;
    }
  ...
  e.Spring.prototype = {
    resetTo: function (t) {
      e.console.assert(!this._exponential || 0 !== t, "[OpenSeadragon.Spring.resetTo] target must be non-zero for exponential springs");
    ...
    springTo: function (t) {
      e.console.assert(!this._exponential || 0 !== t, "[OpenSeadragon.Spring.springTo] target must be non-zero for exponential springs");
    ...
    shiftBy: function (t) {
      ...
      if (this._exponential) {
        e.console.assert(0 !== this.target.value && 0 !== this.start.value, "[OpenSeadragon.Spring.shiftBy] spring value must be non-zero for exponential springs");
        this.start._logValue = Math.log(this.start.value);
        this.target._logValue = Math.log(this.target.value);
      }
    },
    setExponential: function (t) {
      ...
      if (this._exponential) {
        e.console.assert(0 !== this.current.value && 0 !== this.target.value && 0 !== this.start.value, "[OpenSeadragon.Spring.setExponential] spring value must be non-zero for exponential springs");
        this.start._logValue = Math.log(this.start.value);
        this.target._logValue = Math.log(this.target.value);
        this.current._logValue = Math.log(this.current.value);
      }
    ...
    update: function () {
      ...
      if (this._exponential) {
        t = this.start._logValue;
        i = this.target._logValue;
      } else {
        t = this.start.value;
        i = this.target.value;
      }

      var n = this.current.time >= this.target.time ? i : t + (i - t) * (o = this.springStiffness, r = (this.current.time - this.start.time) / (this.target.time - this.start.time), (1 - Math.exp(o * -r)) / (1 - Math.exp(-o)));
      var o, r;
      var s = this.current.value;
      this._exponential ? this.current.value = Math.exp(n) : this.current.value = n;
      return s != this.current.value;
    },
  ...
  t.prototype = {
    ...
    start: function () {
      ...
      this.image.onabort = this.image.onerror = function () {
        t.errorMsg = "Image load aborted";
        t.finish(!1);
      };

      this.jobId = window.setTimeout(function () {
        t.errorMsg = "Image load exceeded timeout";
        t.finish(!1);
      }, this.timeout);
      ...
      if (this.loadWithAjax) {
        this.request = e.makeAjaxRequest({
          ...
          success: function (e) {
            ...
            if (0 === i.size) {
              t.errorMsg = "Empty image response.";
              t.finish(!1);
            }
  ...
  e.Tile.prototype = {
    ...
    drawHTML: function (t) {
      if (this.cacheImageRecord) {
        ...
        } else e.console.warn("Attempting to draw tile %s when it's not yet loaded.", this.toString());
      } else e.console.warn("[Tile.drawHTML] attempting to draw tile %s when it's not cached", this.toString());
    },
    drawCanvas: function (t, i, n, o) {
      var r,
          s = this.position.times(e.pixelDensityRatio),
      ...
      if (this.context2D || this.cacheImageRecord) {
        ...
        if (this.loaded && r) {
          ...
          o instanceof e.Point && (s = s.plus(o));
          ...
          t.drawImage(r.canvas, 0, 0, l, h, s.x, s.y, a.x, a.y);
          t.restore();
        } else e.console.warn("Attempting to draw tile %s when it's not yet loaded.", this.toString());
      } else e.console.warn("[Tile.drawCanvas] attempting to draw tile %s when it's not cached", this.toString());
    },
    getScaleForEdgeSmoothing: function () {
      var t;
      if (this.cacheImageRecord) t = this.cacheImageRecord.getRenderedContext();else {
        if (!this.context2D) {
          e.console.warn("[Tile.drawCanvas] attempting to get tile scale %s when tile's not cached", this.toString());
          return 1;
        }
    ...
    getTranslationForEdgeSmoothing: function (t, i, n) {
      ...
      var r = Math.max(1, Math.ceil((n.y - i.y) / 2));
...
!function (e) {
  ...
  e.Overlay.prototype = {
    ...
    adjust: function (t, i) {
      ...
      if (n) {
        n.isHorizontallyCentered ? t.x -= i.x / 2 : n.isRight && (t.x -= i.x);
        n.isVerticallyCentered ? t.y -= i.y / 2 : n.isBottom && (t.y -= i.y);
      }
    },
    destroy: function () {
      var t = this.element;
      ...
      var o = e.getCssPropertyWithVendorPrefix("transform");
    ...
    drawHTML: function (t, i) {
      ...
      var r = o.position;
      var s = this.size = o.size;
      var a = o.rotate;
      if (this.onDraw) this.onDraw(r, s, this.element);else {
        var l = this.style;
        l.left = r.x + "px";
        l.top = r.y + "px";
        ...
        var c = e.getCssPropertyWithVendorPrefix("transform");
        if (h && c) if (a) {
          l[h] = this._getTransformOrigin();
          l[c] = "rotate(" + a + "deg)";
        } else {
          l[h] = "";
          l[c] = "";
    ...
    _getOverlayPositionAndSize: function (t) {
      ...
      var n = this._getSizeInPixels(t);

      this.adjust(i, n);
      var o = 0;
      if (t.degrees && this.rotationMode !== e.OverlayRotationMode.NO_ROTATION) if (this.rotationMode === e.OverlayRotationMode.BOUNDING_BOX && null !== this.width && null !== this.height) {
        var r = new e.Rect(i.x, i.y, n.x, n.y);

        var s = this._getBoundingBox(r, t.degrees);
    ...
    _getPlacementPoint: function (t) {
      ...
      if (n) {
        n.isHorizontallyCentered ? i.x += t.width / 2 : n.isRight && (i.x += t.width);
        n.isVerticallyCentered ? i.y += t.height / 2 : n.isBottom && (i.y += t.height);
      }
    ...
    getBounds: function (t) {
      ...
      return this._adjustBoundsForRotation(t, new e.Rect(r.x, r.y, i, n));
    },
...
!function (e) {
  ...
  e.Drawer.prototype = {
    ...
    updateOverlay: function (t, i, n) {
      e.console.error("drawer.updateOverlay is deprecated. Use viewer.updateOverlay instead.");
      this.viewer.updateOverlay(t, i, n);
      return this;
    },
    removeOverlay: function (t) {
      e.console.error("drawer.removeOverlay is deprecated. Use viewer.removeOverlay instead.");
      this.viewer.removeOverlay(t);
      return this;
    },
    clearOverlays: function () {
      e.console.error("drawer.clearOverlays is deprecated. Use viewer.clearOverlays instead.");
      this.viewer.clearOverlays();
      return this;
    },
    setOpacity: function (t) {
      e.console.error("drawer.setOpacity is deprecated. Use tiledImage.setOpacity instead.");
      var i = this.viewer.world;

      for (var n = 0; n < i.getItemCount(); n++) i.getItemAt(n).setOpacity(t);
    ...
    getOpacity: function () {
      ...
      for (var n = 0; n < t.getItemCount(); n++) {
    ...
    needsUpdate: function () {
      e.console.error("[Drawer.needsUpdate] this function is deprecated. Use World.needsDraw instead.");
      return this.viewer.world.needsDraw();
    },
    numTilesLoaded: function () {
      e.console.error("[Drawer.numTilesLoaded] this function is deprecated. Use TileCache.numTilesLoaded instead.");
      return this.viewer.tileCache.numTilesLoaded();
    },
    reset: function () {
      e.console.error("[Drawer.reset] this function is deprecated. Use World.resetItems instead.");
      this.viewer.world.resetItems();
      return this;
    },
    update: function () {
      e.console.error("[Drawer.update] this function is deprecated. Use Drawer.clear and World.draw instead.");
      this.clear();
    ...
    viewportToDrawerRectangle: function (t) {
      ...
      var n = this.viewport.deltaPixelsFromPointsNoRotate(t.getSize(), !0);
    ...
    blendSketch: function (t, i, n, o) {
      ...
      if (this.useCanvas && this.sketchCanvas) {
        ...
        if (s) {
          ...
          s.x + s.width > this.canvas.width && (s.width = this.canvas.width - s.x);
          ...
          s.y + s.height > this.canvas.height && (s.height = this.canvas.height - s.y);
          this.context.drawImage(this.sketchCanvas, s.x, s.y, s.width, s.height, s.x, s.y, s.width, s.height);
        } else {
          i = r.scale || 1;
          ...
          if (n) {
            ...
            var u = this.sketchCanvas.height - this.canvas.height;
            l = Math.round(c / 2);
            h = Math.round(u / 2);
          }
    ...
    drawDebugInfo: function (t, i, n, o) {
      if (this.useCanvas) {
        ...
        }) : this.viewer.viewport.flipped && this._flip();
        ...
        s.strokeRect(t.position.x * e.pixelDensityRatio, t.position.y * e.pixelDensityRatio, t.size.x * e.pixelDensityRatio, t.size.y * e.pixelDensityRatio);
        var a = (t.position.x + t.size.x / 2) * e.pixelDensityRatio;
        var l = (t.position.y + t.size.y / 2) * e.pixelDensityRatio;
        s.translate(a, l);
        s.rotate(Math.PI / 180 * -this.viewport.degrees);
        s.translate(-a, -l);

        if (0 === t.x && 0 === t.y) {
          s.fillText("Zoom: " + this.viewport.getZoom(), t.position.x * e.pixelDensityRatio, (t.position.y - 30) * e.pixelDensityRatio);
          s.fillText("Pan: " + this.viewport.getBounds().toString(), t.position.x * e.pixelDensityRatio, (t.position.y - 20) * e.pixelDensityRatio);
        }

        s.fillText("Level: " + t.level, (t.position.x + 10) * e.pixelDensityRatio, (t.position.y + 20) * e.pixelDensityRatio);
    ...
    _offsetForRotation: function (t) {
      ...
      var n = this._getContext(t.useSketch);
      ...
      if (this.viewer.viewport.flipped) {
        ...
        n.scale(-1, 1);
      } else n.rotate(Math.PI / 180 * t.degrees);
    ...
    _calculateCanvasSize: function () {
      ...
      var i = this.viewport.getContainerSize();
      return {
        x: i.x * t,
        y: i.y * t
      };
...
!function (e) {
  ...
  e.Viewport.prototype = {
    ...
    setMargins: function (t) {
      e.console.assert("object" === e.type(t), "[Viewport.setMargins] margins must be an object");
      this._margins = e.extend({
        left: 0,
        top: 0,
        right: 0,
    ...
    getBoundsNoRotate: function (t) {
      ...
      var n = 1 / this.getZoom(t);
      var o = n / this.getAspectRatio();
    ...
    getCenter: function (t) {
      var i,
          ...
          s,
          a,
          l = new e.Point(this.centerSpringX.current.value, this.centerSpringY.current.value),
          h = new e.Point(this.centerSpringX.target.value, this.centerSpringY.target.value);
      if (t) return l;
      if (!this.zoomPoint) return h;
      i = this.pixelFromPoint(this.zoomPoint, !0);
      r = (o = 1 / (n = this.getZoom())) / this.getAspectRatio();
      s = new e.Rect(l.x - o / 2, l.y - r / 2, o, r);
      a = this._pixelFromPoint(this.zoomPoint, s).minus(i).divide(this._containerInnerSize.x * n);
      return h.plus(a);
    },
    getZoom: function (e) {
    ...
    _applyBoundaryConstraints: function (t) {
      ...
      if (this.wrapHorizontal) ;else {
        ...
        var o = i.x + i.width;
        var r = this._contentBoundsNoRotate.x + this._contentBoundsNoRotate.width;
        var s = this._contentBoundsNoRotate.x - o + n;
        var a = r - i.x - n;
      ...
      if (this.wrapVertical) ;else {
        ...
        var h = i.y + i.height;
        var c = this._contentBoundsNoRotate.y + this._contentBoundsNoRotate.height;
        var u = this._contentBoundsNoRotate.y - h + l;
        var d = c - i.y - l;
    ...
    _fitBounds: function (t, i) {
      ...
      var o = i.constraints || !1;
      var r = this.getAspectRatio();
      var s = t.getCenter();
      var a = new e.Rect(t.x, t.y, t.width, t.height, t.degrees + this.getRotation()).getBoundingBox();
      ...
      if (o) {
        ...
        var c = this._applyZoomConstraints(l);
    ...
    zoomTo: function (t, i, n) {
      ...
      n ? this._adjustCenterSpringsForZoomPoint(function () {
    ...
    viewportToImageCoordinates: function (t, i) {
      ...
      if (this.viewer) {
        ...
        if (n > 1) e.console.error("[Viewport.viewportToImageCoordinates] is not accurate with multi-image; use TiledImage.viewportToImageCoordinates instead.");else if (1 === n) {
    ...
    imageToViewportCoordinates: function (t, i) {
      ...
      if (this.viewer) {
        var n = this.viewer.world.getItemCount();
        if (n > 1) e.console.error("[Viewport.imageToViewportCoordinates] is not accurate with multi-image; use TiledImage.imageToViewportCoordinates instead.");else if (1 === n) {
    ...
    imageToViewportRectangle: function (t, i, n, o) {
      ...
      if (this.viewer) {
        ...
        if (s > 1) e.console.error("[Viewport.imageToViewportRectangle] is not accurate with multi-image; use TiledImage.imageToViewportRectangle instead.");else if (1 === s) {
      ...
      var l = this._imageToViewportDelta(r.width, r.height);
    ...
    viewportToImageRectangle: function (t, i, n, o) {
      ...
      if (this.viewer) {
        var s = this.viewer.world.getItemCount();
        if (s > 1) e.console.error("[Viewport.viewportToImageRectangle] is not accurate with multi-image; use TiledImage.viewportToImageRectangle instead.");else if (1 === s) {
      ...
      var l = this._viewportToImageDelta(r.width, r.height);
    ...
    imageToWindowCoordinates: function (t) {
      ...
      return this.imageToViewerElementCoordinates(t).plus(e.getElementPosition(this.viewer.element));
    },
    ...
    viewportToWindowCoordinates: function (t) {
      ...
      return this.viewportToViewerElementCoordinates(t).plus(e.getElementPosition(this.viewer.element));
    },
    viewportToImageZoom: function (t) {
      if (this.viewer) {
        var i = this.viewer.world.getItemCount();
        if (i > 1) e.console.error("[Viewport.viewportToImageZoom] is not accurate with multi-image.");else if (1 === i) {
    ...
    imageToViewportZoom: function (t) {
      if (this.viewer) {
        var i = this.viewer.world.getItemCount();
        if (i > 1) e.console.error("[Viewport.imageToViewportZoom] is not accurate with multi-image.");else if (1 === i) {
...
!function (e) {
  e.TiledImage = function (t) {
    ...
    this.contentAspectX = t.source.dimensions.x / t.source.dimensions.y;
    var r = 1;
  ...
  e.extend(e.TiledImage.prototype, e.EventSource.prototype, {
    ...
    getWorldBounds: function () {
      e.console.error("[TiledImage.getWorldBounds] is deprecated; use TiledImage.getBounds instead");
    ...
    viewportToImageCoordinates: function (t, i, n) {
      ...
      if (t instanceof e.Point) {
        n = i;
        o = t;
      } else o = new e.Point(t, i);

      o = o.rotate(-this.getRotation(n), this._getRotationPoint(n));
      return n ? this._viewportToImageDelta(o.x - this._xSpring.current.value, o.y - this._ySpring.current.value) : this._viewportToImageDelta(o.x - this._xSpring.target.value, o.y - this._ySpring.target.value);
    },
    ...
    imageToViewportCoordinates: function (t, i, n) {
      ...
      return o.rotate(this.getRotation(n), this._getRotationPoint(n));
    },
    imageToViewportRectangle: function (t, i, n, o, r) {
      ...
      var l = this._imageToViewportDelta(s.width, s.height, r);
    ...
    viewportToImageRectangle: function (t, i, n, o, r) {
      ...
      var l = this._viewportToImageDelta(s.width, s.height, r);
    ...
    _viewportToTiledImageRectangle: function (t) {
      ...
      t = t.rotate(-this.getRotation(!0), this._getRotationPoint(!0));
      return new e.Rect((t.x - this._xSpring.current.value) / i, (t.y - this._ySpring.current.value) / i, t.width / i, t.height / i, t.degrees);
    },
    ...
    fitBounds: function (t, i, n) {
      ...
      if (this._clip) {
        ...
        h = this._clip.height / this.source.dimensions.y;

        if (t.getAspectRatio() > r) {
    ...
    setClip: function (t) {
      e.console.assert(!t || t instanceof e.Rect, "[TiledImage.setClip] newClip must be an OpenSeadragon.Rect or null");
    ...
    _updateViewport: function () {
      ...
      var r = this._viewportToTiledImageRectangle(i.getBoundsWithMargins(!0));
      ...
      for (var p = h; p >= l; p--) {
        ...
        var m = i.deltaPixelsFromPointsNoRotate(this.source.getPixelRatio(p), !0).x * this._scaleSpring.current.value;
        ...
        var f = i.deltaPixelsFromPointsNoRotate(this.source.getPixelRatio(Math.max(this.source.getClosestLevel(), 0)), !1).x * this._scaleSpring.current.value;

        var w = this.immediateRender ? 1 : f;
        c = t(this, u, g, p, Math.min(1, (m - .5) / .5), w / Math.abs(w - v), r, d, c);
        if (o(this.coverage, p)) break;
      }
      ...
      !function (t, i) {
        ...
        var n = i[0];
        var o;
        n && (o = t.opacity < 1 || t.compositeOperation && "source-over" !== t.compositeOperation || !t._isBottomItem() && n._hasTransparencyChannel());
        var r;
        var s;
        var a = t.viewport.getZoom(!0);
        var l = t.viewportToImageZoom(a);

        if (i.length > 1 && l > t.smoothTileEdgesMinZoom && !t.iOSDevice && t.getRotation(!0) % 360 == 0 && e.supportsCanvas) {
          o = !0;
          r = n.getScaleForEdgeSmoothing();
          s = n.getTranslationForEdgeSmoothing(r, t._drawer.getCanvasSize(!1), t._drawer.getCanvasSize(!0));
        }

        var h;

        if (o) {
          r || (h = t.viewport.viewportToViewerElementRectangle(t.getClippedBounds(!0)).getIntegerBoundingBox().times(e.pixelDensityRatio));

          t._drawer._clear(!0, h);
        }

        if (!r) {
          0 !== t.viewport.degrees ? t._drawer._offsetForRotation({
            degrees: t.viewport.degrees,
            useSketch: o
          }) : t._drawer.viewer.viewport.flipped && t._drawer._flip({});
        ...
        for (var m = i.length - 1; m >= 0; m--) {
          ...
          n.beingDrawn = !0;
          t.viewer && t.viewer.raiseEvent("tile-drawn", {
            tiledImage: t,
            tile: n
          });
        }

        c && t._drawer.restoreContext(o);

        if (!r) {
          t.getRotation(!0) % 360 != 0 && t._drawer._restoreRotationChanges(o);
          0 !== t.viewport.degrees ? t._drawer._restoreRotationChanges(o) : t._drawer.viewer.viewport.flipped && t._drawer._flip({});
        }
        ...
        if (o) {
          ...
          if (r) {
            t.getRotation(!0) % 360 != 0 && t._drawer._restoreRotationChanges(!1);
            0 !== t.viewport.degrees && t._drawer._restoreRotationChanges(!1);
          }
        }

        !function (t, i) {
          if (t.debugMode) for (var n = i.length - 1; n >= 0; n--) {
            var o = i[n];
          ...
          t._imageLoader.addJob({
            ...
            callback: function (r, s, a) {
              !function (t, i, o, r, s, a) {
                if (!r) {
                  e.console.log("Tile %s failed to load: %s - error: %s", i, i.url, s);
                ...
                if (o < t.lastResetTime) {
                  e.console.log("Ignoring tile %s loaded before reset: %s", i, i.url);
                  i.loading = !1;
                  return;
                }
    ...
    _getCornerTiles: function (t, i, n) {
      ...
      var c = this.source.getTileAtPoint(t, new e.Point(r, a));
      var u = this.source.getNumTiles(t);

      if (this.wrapHorizontal) {
        h.x += u.x * Math.floor(i.x);
        c.x += u.x * Math.floor(n.x);
      }

      if (this.wrapVertical) {
        h.y += u.y * Math.floor(i.y / l);
        c.y += u.y * Math.floor(n.y / l);
      }
  ...
  function t(e, t, n, o, r, s, l, h, c) {
    ...
    var d = l.getBoundingBox().getBottomRight();
    ...
    var g = p.topLeft;
    var m = p.bottomRight;
    var v = e.source.getNumTiles(o);
    var f = e.viewport.pixelFromPoint(e.viewport.getCenter());

    for (var w = g.x; w <= m.x; w++) for (var y = g.y; y <= m.y; y++) {
  ...
  function i(t, i, o, a, l, h, c, u, d, p, g, m) {
    var v = function (t, i, n, o, r, s, a, l, h, c) {
      ...
      if (!s[n][t][i]) {
        ...
        if (o.loadTilesWithAjax) {
          f = r.getTileAjaxHeaders(n, u, d);
          e.isPlainObject(o.ajaxHeaders) && (f = e.extend({}, o.ajaxHeaders, f));
        } else f = null;
    ...
    s(t.loadingCoverage, h, a, l, w);
    if (!v.exists) return m;
    i && !f && (r(t.coverage, h, a, l) ? s(t.coverage, h, a, l, !0) : f = !0);
    if (!f) return m;
    ...
    if (!v.loaded) if (v.context2D) n(t, v);else {
    ...
    if (v.loaded) {
      (function (e, t, i, n, o, r, a) {
        ...
        if (1 == h) {
          s(e.coverage, o, i, n, !0);
          e._hasOpaqueTile = !0;
        } else if (l < c) return !0;

        return !1;
      })(t, v, a, l, h, c, g) && (t._needsDraw = !0);
    } else v.loading ? t._tilesLoading++ : w || (m = function (e, t) {
      if (!e) return t;
      {
  ...
  function o(e, t, i, n) {
    ...
    if (void 0 === i || void 0 === n) {
      ...
      for (s in o) if (o.hasOwnProperty(s)) {
        ...
        for (a in r) if (r.hasOwnProperty(a) && !r[a]) return !1;
      }
  ...
  function s(t, i, n, o, r) {
    if (t[i]) {
      t[i][n] || (t[i][n] = {});
      t[i][n][o] = r;
    } else e.console.warn("Setting coverage for a tile before its level's coverage has been reset: %s", i);
  }
...
!function (e) {
  ...
  t.prototype = {
    ...
    setRenderedContext: function (t) {
      e.console.error("ImageRecord.setRenderedContext is deprecated. The rendered context should be created by the ImageRecord itself when calling ImageRecord.getRenderedContext.");
    ...
    removeTile: function (t) {
      for (var i = 0; i < this._tiles.length; i++) if (this._tiles[i] === t) {
  ...
  e.TileCache.prototype = {
    ...
    cacheTile: function (i) {
      e.console.assert(i, "[TileCache.cacheTile] options is required");
      ...
      e.console.assert(i.tiledImage, "[TileCache.cacheTile] options.tiledImage is required");
      var n = i.cutoff || 0;
      var o = this._tilesLoaded.length;
      var r = this._imagesLoaded[i.tile.cacheKey];

      if (!r) {
        e.console.assert(i.image, "[TileCache.cacheTile] options.image is required to create an ImageRecord");
        r = this._imagesLoaded[i.tile.cacheKey] = new t({
          image: i.image
        });
      ...
      if (this._imagesLoadedCount > this._maxImageCacheCount) {
        ...
        for (var m = this._tilesLoaded.length - 1; m >= 0; m--) if (!((h = (g = this._tilesLoaded[m]).tile).level <= n || h.beingDrawn)) if (s) {
          d = h.lastTouchTime;
          c = s.lastTouchTime;
          p = h.level;
          u = s.level;
      ...
      this._tilesLoaded[o] = new function (t) {
    ...
    clearTilesFor: function (t) {
      ...
      for (var n = 0; n < this._tilesLoaded.length; ++n) if ((i = this._tilesLoaded[n]).tiledImage === t) {
        this._unloadTile(i);
    ...
    getImageRecord: function (t) {
      e.console.assert(t, "[TileCache.getImageRecord] cacheKey is required");
      return this._imagesLoaded[t];
    },
...
!function (e) {
  ...
  e.extend(e.World.prototype, e.EventSource.prototype, {
    ...
    getItemAt: function (t) {
      e.console.assert(void 0 !== t, "[World.getItemAt] index is required");
      return this._items[t];
    },
    getIndexOfItem: function (t) {
      e.console.assert(t, "[World.getIndexOfItem] item is required");
      return e.indexOf(this._items, t);
    },
    ...
    setItemIndex: function (t, i) {
      ...
      e.console.assert(void 0 !== i, "[World.setItemIndex] index is required");
    ...
    arrange: function (t) {
      ...
      var n = t.layout || e.DEFAULT_SETTINGS.collectionLayout;
      var o = t.rows || e.DEFAULT_SETTINGS.collectionRows;
      var r = t.columns || e.DEFAULT_SETTINGS.collectionColumns;
      var s = t.tileSize || e.DEFAULT_SETTINGS.collectionTileSize;
      var a = s + (t.tileMargin || e.DEFAULT_SETTINGS.collectionTileMargin);
      var l;
      l = !t.rows && r ? r : Math.ceil(this._items.length / o);
      var h = 0;
      var c = 0;
      var u, d, p, g, m;
      ...
      for (var v = 0; v < this._items.length; v++) {
        ...
        g = (p = (d = (u = this._items[v]).getBounds()).width > d.height ? s : s * (d.width / d.height)) * (d.height / d.width);
        m = new e.Point(h + (s - p) / 2, c + (s - g) / 2);
        u.setPosition(m, i);
        u.setWidth(p, i);
        "horizontal" === n ? h += a : c += a;
      }
    ...
    _figureSizes: function () {
      ...
      var i = this._contentSize ? this._contentSize.clone() : null;
      var n = this._contentFactor || 0;
      ...
      if (this._items.length) {
        ...
        for (var u = 1; u < this._items.length; u++) {
          ...
          c = Math.max(c, s.y + s.height);
        }

        this._homeBounds = new e.Rect(a, l, h - a, c - l);
...
}(OpenSeadragon); //# sourceMappingURL=openseadragon.min.js.map