import{html as e,PolymerElement as t}from"../../../../@polymer/polymer/polymer-element.js";import{dom as s}from"../../../../@polymer/polymer/lib/legacy/polymer.dom.js";import"../../../../@polymer/iron-ajax/iron-ajax.js";import"../../../../@polymer/app-route/app-location.js";import"../elmsln-base-deps.js";import"../../../../@polymer/app-route/app-route.js";import"../../../simple-icon/simple-icon.js";import"../../../simple-icon/lib/simple-icons.js";import"../../../simple-icon/lib/simple-icon-button.js";import"../../../hax-iconset/lib/simple-hax-iconset.js";import"../../../../@polymer/paper-badge/paper-badge.js";import"../../../../@polymer/paper-toggle-button/paper-toggle-button.js";import"../../../../@polymer/app-layout/app-toolbar/app-toolbar.js";import"../../../../@polymer/app-layout/app-header/app-header.js";import"../../../../@polymer/iron-list/iron-list.js";import"../../../../@polymer/paper-toast/paper-toast.js";import"../../../../@polymer/paper-dialog/paper-dialog.js";import"../../../lrnsys-render-html/lrnsys-render-html.js";import"../../../lrnsys-layout/lib/lrnsys-dialog.js";import"../../../lrnsys-button/lrnsys-button.js";import"../../../elmsln-loading/elmsln-loading.js";import"../../../materializecss-styles/materializecss-styles.js";import"./lrnapp-studio-project-button.js";import"./lrnapp-studio-assignment-button.js";import"../lrnapp-studio-submission/lrnapp-studio-submission-button.js";import{normalizeEventPath as i}from"../../../utils/utils.js";class LrnappStudioKanban extends t{static get template(){return e`
    ...
    `}lastErrorChanged(e){if(e.detail.value){console.error(e);const t=i(e)[0];switch(parseInt(e.detail.value.status)){case 401:case 401:fetch(window.Drupal.settings.basePath,{mode:"no-cors"}).then((e=>{console.log(e),setTimeout((()=>{t.generateRequest()}),250)}))}}}static get tag(){return"lrnapp-studio-kanban"}static get properties(){return{elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String,notify:!0},csrfToken:{type:String,notify:!0},endPoint:{type:String,notify:!0},activeAssignment:{type:String,value:null,notify:!0},activeAssignmentNode:{type:Object},projectToDelete:{type:String,value:null,notify:!0},assignmentToDelete:{type:String,value:null,notify:!0},sourcePath:{type:String,notify:!0},submission:{type:Object,notify:!0},projectResponse:{type:Object,notify:!0},backendResponse:{type:Object,notify:!0}}}connectedCallback(){super.connectedCallback(),window.dispatchEvent(new Event("resize")),this.addEventListener("project-created",this._handleProjectCreated.bind(this)),this.addEventListener("assignment-created",this._handleAssignmentCreated.bind(this)),setTimeout((()=>{window.dispatchEvent(new Event("resize"))}),1e3)}disconnectedCallback(){this.removeEventListener("project-created",this._handleProjectCreated.bind(this)),this.removeEventListener("assignment-created",this._handleAssignmentCreated.bind(this)),super.disconnectedCallback()}static get observers(){return["_routeChanged(route, endPoint)","_deleteToast(queryParams.deletetoast)"]}_routeChanged(e,t){if("string"==typeof e.path){if("string"==typeof t&&(e.path.startsWith(t)||"/"==e.path))return;window.location.reload()}}_deleteToast(e,t){void 0!==e&&("error"==e?this.$.toast.show("That submission on longer exists!"):this.$.toast.show("Submission deleted successfully!"),this.set("queryParams.deletetoast",void 0),this.notifyPath("queryParams.deletetoast"))}_makeProjectEditLink(e){var t=s(e).localTarget.id.split("-");window.location.href=this.basePath+"../node/"+t[1]+"/edit?destination=apps/lrnapp-studio-kanban"}_makeAssignmentEditLink(e){var t=s(e).localTarget.id.split("-");window.location.href=this.basePath+"../node/"+t[2]+"/edit?destination=apps/lrnapp-studio-kanban"}_deleteProjectDialog(e){var t=s(e).localTarget.id.split("-");this.projectToDelete=t[1],this._deleteTitle="Delete project",this._deleteText="Are you sure you want to delete this project and all related assignments!?",this._deleteType="project",this.$.delete.open()}_handleDelete(){"project"==this._deleteType?(this.$.backend.method="DELETE",this.$.backend.body=this.projectToDelete,this.$.backend.url=this.endPoint+"/api/projects/"+this.projectToDelete+"?token="+this.csrfToken,this.$.backend.generateRequest()):"assignment"==this._deleteType&&(this.$.backend.method="DELETE",this.$.backend.body=this.assignmentToDelete,this.$.backend.url=this.endPoint+"/api/assignments/"+this.assignmentToDelete+"?token="+this.csrfToken,this.$.backend.generateRequest())}_deleteAssignmentDialog(e){var t=s(e).localTarget.id.split("-");this.assignmentToDelete=t[2],this._deleteTitle="Delete assignment",this._deleteText="Are you sure you want to delete this assignment?",this._deleteType="assignment",this.$.delete.open()}displayNewBadge(e){return void 0===e||0==e}statusToggle(e){var t=this.$.backend,s=this.activeAssignment.split("-"),i=this.projectResponse.data.projects["project-"+s[1]].relationships.assignments["assignment-"+s[2]].meta.relatedSubmissions.complete;this.shadowRoot.querySelector("#activetoggle").disabled||(this.$.loading.hidden=!1,t.params={submissionid:i.submission.id,status:this.shadowRoot.querySelector("#activetoggle").checked},t.generateRequest())}assignmentClick(e){var t=s(e).localTarget;"SPAN"===t.tagName&&(t=t.parentNode),null!=this.activeAssignment&&this.activeAssignment!=t.id&&(this.shadowRoot.querySelector("#"+this.activeAssignment).nextElementSibling.classList.remove("show"),this.shadowRoot.querySelector("#"+this.activeAssignment).classList.remove("active")),this.activeAssignment=t.id;var i=this.activeAssignment.split("-");this.activeAssignmentNode=this.projectResponse.data.projects["project-"+i[1]].relationships.assignments["assignment-"+i[2]],this._setToggle(!1),t.nextElementSibling.classList.add("show"),t.classList.add("active"),this.$.activeitemcontainer.toggle()}_handleProjectResponse(e){this.$.loading.hidden=!0,this._setToggle(!0),window.dispatchEvent(new Event("resize")),this.activeAssignment&&setTimeout((()=>{var e=this.activeAssignment.split("-");this.set("activeAssignmentNode",{}),this.activeAssignmentNode=this.projectResponse.data.projects["project-"+e[1]].relationships.assignments["assignment-"+e[2]],window.dispatchEvent(new Event("resize"))}),100)}buildSubmissionPath(e){return e+"lrnapp-studio-submission"}ready(){super.ready(),window.dispatchEvent(new Event("resize"))}_handleUpdateResponse(e){200==this.backendResponse.status?(this.$.toast.text="Updated successfully",this.$.toast.toggle(),window.dispatchEvent(new Event("resize")),this.set("projectResponse",{}),this.$.projectbackend.generateRequest(),setTimeout((()=>{var e=this.activeAssignment.split("-");window.dispatchEvent(new Event("resize")),this.set("activeAssignmentNode",{}),this.activeAssignmentNode=this.projectResponse.data.projects["project-"+e[1]].relationships.assignments["assignment-"+e[2]]}),500)):this.$.loading.hidden=!0}_setToggle(e){if(null!=this.activeAssignment){var t=this.activeAssignment.split("-"),s=this.projectResponse.data.projects["project-"+t[1]].relationships.assignments["assignment-"+t[2]].meta.relatedSubmissions.complete;0==s.status&&0==s.submission.length?(e||(this.shadowRoot.querySelector("#activetoggle").disabled=!0,this.shadowRoot.querySelector("#activetoggle").checked=!1),this.shadowRoot.querySelector("#activetoggle").title="Submission not started",this.shadowRoot.querySelector("#activetoggletext").textContent="Submission not started"):0==s.status?(e||(this.shadowRoot.querySelector("#activetoggle").disabled=!1,this.shadowRoot.querySelector("#activetoggle").checked=!1),this.shadowRoot.querySelector("#activetoggle").title="Submission started",this.shadowRoot.querySelector("#activetoggletext").textContent="Submission in progress"):(e||(this.shadowRoot.querySelector("#activetoggle").disabled=!1,this.shadowRoot.querySelector("#activetoggle").checked=!0),this.shadowRoot.querySelector("#activetoggle").title="Submission ready",this.shadowRoot.querySelector("#activetoggletext").textContent="Submission ready")}}_handleProjectCreated(e){this.$.toast.text="Project added",this.$.toast.toggle(),this.$.projectbackend.generateRequest(),setTimeout((()=>{window.dispatchEvent(new Event("resize"))}),100)}_handleAssignmentCreated(e){this.$.toast.text="Assignment added",this.$.toast.toggle(),this.$.projectbackend.generateRequest(),setTimeout((()=>{window.dispatchEvent(new Event("resize"))}),100)}_toArray(e){return null==e?[]:Object.keys(e).map((function(t){return e[t]}))}}window.customElements.define(LrnappStudioKanban.tag,LrnappStudioKanban);export{LrnappStudioKanban};