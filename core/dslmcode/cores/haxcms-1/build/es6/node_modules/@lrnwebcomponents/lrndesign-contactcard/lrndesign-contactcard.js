import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";class LrndesignContactcard extends PolymerElement{constructor(){super(),import("../../@polymer/paper-card/paper-card.js"),import("../../@polymer/paper-button/paper-button.js"),import("../lrn-icons/lrn-icons.js"),import("../../@polymer/iron-icons/iron-icons.js"),import("../../@polymer/iron-icons/maps-icons.js"),import("../../@polymer/iron-icons/hardware-icons.js"),import("../simple-tooltip/simple-tooltip.js"),import("../social-media-icons/social-media-icons.js")}static get template(){return html`
      <style>
        :host {
          display: block;
    ...
    `}static get tag(){return"lrndesign-contactcard"}static get properties(){return{image:{type:String},email:{type:String},name:{type:String},position:{type:String},organization:{type:String},phone:{type:String},website:{type:String},twitter:{type:String}}}}window.customElements.define(LrndesignContactcard.tag,LrndesignContactcard);export{LrndesignContactcard};