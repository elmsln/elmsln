import{html as t,PolymerElement as i}from"../../@polymer/polymer/polymer-element.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";import"../hax-iconset/lib/simple-hax-iconset.js";class LrndesignContactcard extends i{constructor(){super(),import("../simple-tooltip/simple-tooltip.js")}static get template(){return t`
      <style>
        :host {
          display: block;
    ...
    `}static get tag(){return"lrndesign-contactcard"}static get properties(){return{image:{type:String},email:{type:String},name:{type:String},position:{type:String},organization:{type:String},phone:{type:String},website:{type:String},twitter:{type:String}}}}customElements.define(LrndesignContactcard.tag,LrndesignContactcard);export{LrndesignContactcard};