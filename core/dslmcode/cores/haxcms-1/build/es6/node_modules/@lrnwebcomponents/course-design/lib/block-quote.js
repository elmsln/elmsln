import{LitElement as i,html as t,css as e}from"../../../lit/index.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/lib/simple-icon-lite.js";export class BlockQuote extends i{static get properties(){return{citation:{type:String},image:{type:String},alt:{type:String}}}static get haxProperties(){return new URL("./block-quote.haxProperties.json",import.meta.url).href}constructor(){super(),this.citation="",this.image="",this.alt=""}render(){return t`
      <div id="wrap">
        ${this.image?t`
              <div
                id="image"
    ...
    `}static get tag(){return"block-quote"}static get styles(){return[e`
        :host {
          display: block;
        }
