 ...
 */
import{LitElement,html,css}from"../../lit-element/lit-element.js";import{SchemaBehaviors}from"../schema-behaviors/schema-behaviors.js";class LrnTable extends(SchemaBehaviors(LitElement)){constructor(){super(),setTimeout(()=>{import("../csv-render/csv-render.js")},0)}static get styles(){return[css`
        :host {
          display: block;
        }
        .hidden-title {
