import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import{SchemaBehaviors}from"../schema-behaviors/schema-behaviors.js";class LrnTable extends(SchemaBehaviors(PolymerElement)){constructor(){super(),import("../csv-render/csv-render.js")}static get template(){return html`
      <style>
        :host {
          display: block;
        }
