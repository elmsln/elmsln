      ...
      >
        <div id="topcontextmenu">
          ...
          <hax-text-editor-toolbar
            id="textcontextmenu"
            class="hax-context-menu ignore-activation ${!this.activeNode||this.activeNode.getAttribute("data-hax-lock")||this.activeNode.parentNode&&this.activeNode.parentNode.getAttribute("data-hax-lock")||!a.isTextElement(this.activeNode)&&!a.isSingleSlotElement(this.activeNode)?"not-text":"is-text"}"
            .activeNode="${this.activeNode}"
            show="always"
          >
          </hax-text-editor-toolbar>
