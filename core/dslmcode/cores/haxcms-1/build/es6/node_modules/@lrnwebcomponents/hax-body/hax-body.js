import{html,css}from"../../lit-element/lit-element.js";import{SimpleColors}from"../simple-colors/simple-colors.js";import{encapScript,wipeSlot}from"../utils/utils.js";class HaxBody extends SimpleColors{static get styles(){return[...super.styles,css`
        :host,
        :host * ::slotted(*) {
          line-height: 1.8;
        }
      ...
      `]}constructor(){super(),this.___moveLock=!1,this.editMode=!1,this.globalPreferences={},this.haxRayMode=!1,this.activeNode=null,this.activeContainerNode=null,setTimeout(()=>{import("./lib/hax-text-context.js"),import("./lib/hax-ce-context.js"),import("./lib/hax-plate-context.js"),import("./lib/hax-input-mixer.js"),import("../grid-plate/grid-plate.js")},0)}static get tag(){return"hax-body"}render(){return html`
