import{html as e,css as t}from"../../lit/index.js";import{SimpleColors as i}from"../simple-colors/simple-colors.js";import{UndoManagerBehaviors as o}from"../undo-manager/undo-manager.js";import{HAXStore as a}from"./lib/hax-store.js";import{autorun as n,toJS as s}from"../../mobx/dist/mobx.esm.js";import"./lib/hax-text-editor-toolbar.js";import{encapScript as r,wipeSlot as l,generateResourceID as d,nodeToHaxElement as c,haxElementToNode as h,camelToDash as u,wrap as m,unwrap as g,ReplaceWithPolyfill as p,normalizeEventPath as v}from"../utils/utils.js";import{HaxUiBaseStyles as b}from"./lib/hax-ui-styles.js";import{I18NMixin as x}from"../i18n-manager/lib/I18NMixin.js";import"../absolute-position-behavior/absolute-position-behavior.js";import"../simple-icon/lib/simple-icons.js";import{SimpleIconsetStore as y}from"../simple-icon/lib/simple-iconset.js";Element.prototype.replaceWith||(Element.prototype.replaceWith=p),CharacterData.prototype.replaceWith||(CharacterData.prototype.replaceWith=p),DocumentType.prototype.replaceWith||(DocumentType.prototype.replaceWith=p),String.prototype.replaceAll||(String.prototype.replaceAll=function(e,t){return this.split(e).join(t)});var N=null;class HaxBody extends(x(o(i))){static get tag(){return"hax-body"}static get styles(){return[...super.styles,t`
        :host([edit-mode]),
      ...
      >
        <div id="topcontextmenu">
          ...
          <hax-text-editor-toolbar
            id="textcontextmenu"
            class="hax-context-menu ignore-activation ${!this.activeNode||this.activeNode.getAttribute("data-hax-lock")||this.activeNode.parentNode&&this.activeNode.parentNode.getAttribute("data-hax-lock")||!a.isTextElement(this.activeNode)?"not-text":"is-text"}"
            .activeNode="${this.activeNode}"
            show="always"
          >
          </hax-text-editor-toolbar>
