      ...
      >
        <div id="topcontextmenu">
          ...
          <hax-text-editor-toolbar
            id="textcontextmenu"
            class="hax-context-menu ignore-activation ${this.activeNode&&a.isTextElement(this.activeNode)?"is-text":"not-text"}"
            .activeNode="${this.activeNode}"
            show="always"
          >
          </hax-text-editor-toolbar>
