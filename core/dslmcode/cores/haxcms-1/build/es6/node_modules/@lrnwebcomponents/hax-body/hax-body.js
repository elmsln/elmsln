import{html as e,css as t}from"../../lit-element/lit-element.js";import{SimpleColors as o}from"../simple-colors/simple-colors.js";import{encapScript as i,wipeSlot as a,generateResourceID as n,nodeToHaxElement as s,haxElementToNode as r}from"../utils/utils.js";import{UndoManagerBehaviors as d,Undo as l}from"../undo-manager/undo-manager.js";var c=null;class HaxBody extends(d(o)){static get styles(){return[...super.styles,t`
      ...
      `]}constructor(){super(),this.__mouseMoving=!1,this.___moveLock=!1,this.editMode=!1,this.globalPreferences={},this.haxRayMode=!1,this.activeNode=null,this.haxSelectedText="",this.activeContainerNode=null,setTimeout(()=>{import("./lib/hax-text-context.js"),import("./lib/hax-ce-context.js"),import("./lib/hax-plate-context.js"),import("../grid-plate/grid-plate.js"),this.polyfillSafe=window.HaxStore.instance.computePolyfillSafe(),this.addEventListener("hax-context-item-selected",this._haxContextOperation.bind(this)),this.addEventListener("place-holder-replace",this.replacePlaceholder.bind(this)),this.addEventListener("focusin",this._focusIn.bind(this)),this.addEventListener("mousedown",this._mouseDown.bind(this)),this.addEventListener("mouseup",this._mouseUp.bind(this)),this.addEventListener("dragenter",this.dragEnterBody.bind(this)),this.addEventListener("drop",this.dropEvent.bind(this)),this.addEventListener("click",this.clickEvent.bind(this))},0)}_mouseDown(e){this.__mouseDown=!0,this.__focusLogic(e.target)&&(e.stopPropagation(),e.stopImmediatePropagation())}_mouseUp(e){setTimeout(()=>{this.__mouseDown=!1},0),clearTimeout(c),this.__manageFakeEndCap(!1)}static get tag(){return"hax-body"}clickEvent(e){clearTimeout(c)}__manageFakeEndCap(e=!0){if(e&&!this.__fakeEndCap){let e=document.createElement("fake-hax-body-end");e.style.width="100%",e.style.height="20px",e.style.display="block",e.classList.add("hax-move"),this.__fakeEndCap=e,this.appendChild(this.__fakeEndCap)}else!e&&this.__fakeEndCap&&(this.__fakeEndCap.remove(),this.__fakeEndCap=null)}dragEnterBody(e){const t=this.childNodes;for(var o in this.__manageFakeEndCap(!0),t)t[o].classList&&t[o]!==this.activeItem&&t[o].classList.add("hax-mover")}render(){return e`
