import{html as e,PolymerElement as t}from"../../../@polymer/polymer/polymer-element.js";import{AppLocalizeBehavior as a}from"../../../@polymer/app-localize-behavior/app-localize-behavior.js";import{mixinBehaviors as o}from"../../../@polymer/polymer/lib/legacy/class.js";import"../../a11y-tabs/a11y-tabs.js";import{afterNextRender as s}from"../../../@polymer/polymer/lib/utils/render-status.js";import"../../../@polymer/polymer/lib/elements/dom-repeat.js";class EcoJsonSchemaTabs extends(o([a],t)){static get tag(){return"eco-json-schema-tabs"}static get template(){return e`
      <custom-style>
    ...
    `}static get properties(){return{propertyName:{type:String,value:null},schema:{type:Object,value:{}}}}ready(){super.ready(),this._schemaChanged()}_schemaChanged(){s(this,()=>{this.shadowRoot.querySelectorAll(".item-fields").forEach(e=>{let t=e.getAttribute("data-index"),a=this.propertyName,o=this.schema.properties[t],s=`${a}.${o.name}`;this.dispatchEvent(new CustomEvent("build-fieldset",{bubbles:!1,cancelable:!0,composed:!0,detail:{container:e,path:s,prefix:s,properties:o.schema.properties,type:EcoJsonSchemaTabs.tag,value:o.value||{}}}))})})}}window.customElements.define(EcoJsonSchemaTabs.tag,EcoJsonSchemaTabs);export{EcoJsonSchemaTabs};