import{html as e,PolymerElement as t}from"../../../@polymer/polymer/polymer-element.js";import{AppLocalizeBehavior as o}from"../../../@polymer/app-localize-behavior/app-localize-behavior.js";import{mixinBehaviors as a}from"../../../@polymer/polymer/lib/legacy/class.js";import"../../a11y-tabs/a11y-tabs.js";import{afterNextRender as s}from"../../../@polymer/polymer/lib/utils/render-status.js";import"../../../@polymer/polymer/lib/elements/dom-repeat.js";class EcoJsonSchemaTabs extends(a([o],t)){static get tag(){return"eco-json-schema-tabs"}static get template(){return e`
      <custom-style>
    ...
    `}static get properties(){return{propertyName:{type:String,value:null},schema:{type:Object,value:{}}}}ready(){super.ready(),this._schemaChanged()}_schemaChanged(){s(this,()=>{this.shadowRoot.querySelectorAll(".item-fields").forEach(e=>{let t=e.getAttribute("data-index"),o=this.propertyName,a=this.schema.properties[t],s=`${o}.${a.name}`;this.dispatchEvent(new CustomEvent("build-fieldset",{bubbles:!1,cancelable:!0,composed:!0,detail:{container:e,path:s,prefix:s,properties:a.schema.properties,type:EcoJsonSchemaTabs.tag,value:a.value||{}}}))})})}}window.customElements.define(EcoJsonSchemaTabs.tag,EcoJsonSchemaTabs);export{EcoJsonSchemaTabs};