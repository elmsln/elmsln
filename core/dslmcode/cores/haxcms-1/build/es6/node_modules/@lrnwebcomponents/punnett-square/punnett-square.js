 ...
 */
import{LitElement as t,html as e,css as a}from"../../lit-element/lit-element.js";import"../../@polymer/paper-input/paper-input.js";class PunnettSquare extends t{static get tag(){return"punnett-square"}static get properties(){return{variant1:{type:String},variant2:{type:String},editable:{type:Boolean}}}constructor(){super(),this.variant1="",this.variant2="",this.editable=!1}connectedCallback(){super.connectedCallback()}__ensureArray(t){return("string"==typeof t?t.split(",").map(t=>t.trim()):[]).map(t=>"string"==typeof t?t.split("").map(t=>t.trim()):[])}render(){let t=this.__ensureArray(this.variant1),a=this.__ensureArray(this.variant2);return e`
      <style>
        :host {
          display: block;
      ...
      <div id="inputs">
        Variant1: <div class="input">${this.editable?e`
                <paper-input
                  value="${this.variant1}"
              ...
              `:e`
                ${this.variant1}
              `}</div>
        Variant2: <div class="input">${this.editable?e`
                <paper-input
                  value="${this.variant2}"
