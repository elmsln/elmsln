import{LitElement as t,html as e,css as a}from"../../lit-element/lit-element.js";import"../../@polymer/paper-tabs/paper-tabs.js";class TabList extends t{static get styles(){return[a`
        :host {
          display: block;
          margin: 0 auto;
          list-style: none;
      ...
      `]}constructor(){super(),this.tabs=[],import("../../@polymer/paper-tabs/paper-tab.js"),import("../../@polymer/paper-button/paper-button.js")}render(){return e`
      <paper-tabs>
        ${this.tabs.map(t=>e`
            <paper-tab>
              <a
              ...
              >
                <paper-button raised>${t.label}</paper-button>
              </a>
            </paper-tab>
          `)}
      </paper-tabs>
