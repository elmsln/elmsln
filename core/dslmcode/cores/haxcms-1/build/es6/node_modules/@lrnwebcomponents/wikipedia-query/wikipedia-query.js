import{LitElement,html,css}from"../../lit-element/lit-element.js";import"../../@polymer/iron-ajax/iron-ajax.js";class WikipediaQuery extends LitElement{static get styles(){return[css`
      ...
      `]}constructor(){super(),import("../citation-element/citation-element.js"),this.hideTitle=!1,this.search="Web_Components",this.renderAs="content";let date=new Date(Date.now());this.__now=date.getDate()+"/"+(date.getMonth()+1)+"/"+date.getFullYear()}static get tag(){return"wikipedia-query"}render(){return html`
      <iron-ajax
        auto
