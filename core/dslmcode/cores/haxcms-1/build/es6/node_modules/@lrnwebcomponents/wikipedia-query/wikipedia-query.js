import{LitElement as e,html as t,css as i}from"../../lit-element/lit-element.js";import{IntersectionObserverMixin as a}from"../intersection-element/lib/IntersectionObserverMixin.js";class WikipediaQuery extends(a(e)){static get styles(){return[i`
        :host {
          display: block;
      ...
      `]}constructor(){super(),this.hideTitle=!1;const e=document.body.getAttribute("xml:lang")||document.body.getAttribute("lang")||document.documentElement.getAttribute("xml:lang")||document.documentElement.getAttribute("lang")||navigator.language||"en";this.language=e.split("-")[0],this.headers={cache:"force-cache"};let t=new Date(Date.now());this.__now=t.getDate()+"/"+(t.getMonth()+1)+"/"+t.getFullYear()}static get tag(){return"wikipedia-query"}render(){return t` ${this.elementVisible?t` <h3 .hidden="${this.hideTitle}" part="heading-3">
            ${this._title}
          </h3>
          <div id="result"></div>
          <citation-element
