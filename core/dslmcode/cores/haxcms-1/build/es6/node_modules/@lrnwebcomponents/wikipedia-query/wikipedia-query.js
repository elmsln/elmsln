import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";import{afterNextRender}from"../../@polymer/polymer/lib/utils/render-status.js";import{HAXWiring}from"../hax-body-behaviors/lib/HAXWiring.js";import"../../@polymer/iron-ajax/iron-ajax.js";class WikipediaQuery extends PolymerElement{constructor(){super(),import("../citation-element/citation-element.js"),afterNextRender(this,function(){this.HAXWiring=new HAXWiring,this.HAXWiring.setup(WikipediaQuery.haxProperties,WikipediaQuery.tag,this)})}static get tag(){return"wikipedia-query"}static get template(){return html`
      <style>
        :host {
          display: block;
