 ...
 */
import{LitElement as t,html as e,css as r}from"../../../../lit/index.js";import{RichTextToolbarStyles as o}from"../buttons/rich-text-editor-button.js";import{RichTextEditorRangeBehaviors as i}from"../singletons/rich-text-editor-range-behaviors.js";class RichTextEditorBreadcrumbs extends(i(t)){static get tag(){return"rich-text-editor-breadcrumbs"}static get properties(){return{controls:{type:String},hidden:{type:Boolean,attribute:"hidden",reflect:!0},label:{type:String},sticky:{type:Boolean,reflect:!0},selectionAncestors:{type:Array},__target:{type:Object}}}constructor(){super(),this.hidden=!0,this.sticky=!1,this.label="Select"}_handleClick(t){t.selectAll?this.selectNodeContents(t.selectAll):this.selectNode(t),this.__target&&this.__target.focus()}render(){return e`
      ${this.label}:
