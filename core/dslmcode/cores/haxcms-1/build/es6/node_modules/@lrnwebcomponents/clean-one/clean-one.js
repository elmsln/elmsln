 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as o}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as i}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{HAXCMSRememberRoute as s}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{HAXCMSMobileMenuMixin as n}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSUserStylesMenuMixin as r}from"../haxcms-elements/lib/core/utils/HAXCMSUserStylesMenu.js";import{store as a}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as l,toJS as c}from"../../mobx/dist/mobx.esm.js";import"../scroll-button/scroll-button.js";import{normalizeEventPath as h}from"../utils/utils.js";import{I18NMixin as m}from"../i18n-manager/lib/I18NMixin.js";class CleanOne extends(s(m(i(r(n(o)))))){static get styles(){return[...super.styles,t`
        :host {
          color: #242A31;
          width: 100%;
          margin: 0;
    ...
    `}searchChanged(e){var t=h(e)[0];t.value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{this.searchTerm=t.value})):this.searchTerm=""}static get properties(){return{...super.properties,searchTerm:{type:String}}}static get tag(){return"clean-one"}constructor(){super(),this.t?(this.t.searchSiteContent="Search site content",this.t.typeToSearch="Type to search"):this.t={searchSiteContent:"Search site content",typeToSearch:"Type to search"},this.registerLocalization({context:this,basePath:import.meta.url,locales:["es","fr","de","ja"]}),this.HAXCMSThemeSettings.autoScroll=!0,import("../haxcms-elements/lib/ui-components/active-item/site-active-title.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"),import("../haxcms-elements/lib/ui-components/site/site-print-button.js"),import("../haxcms-elements/lib/ui-components/site/site-rss-button.js"),import("../haxcms-elements/lib/ui-components/active-item/site-git-corner.js"),this.__disposer=this.__disposer?this.__disposer:[],l((e=>{this.activeManifestIndex=c(a.activeManifestIndex),this.searchTerm="",this.__disposer.push(e)}))}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector("#body"),this.shadowRoot.querySelector("scroll-button").target=this.shadowRoot.querySelector("#top")}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}prevPage(e){super.prevPage(e)}nextPage(e){super.nextPage(e)}}window.customElements.define(CleanOne.tag,CleanOne);export{CleanOne};