 ...
 */
import{html as e,css as t}from"../../lit-element/lit-element.js";import{HAXCMSLitElementTheme as o}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{store as i}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as n,toJS as s}from"../../mobx/lib/mobx.module.js";import"../../@polymer/iron-icons/editor-icons.js";import"../../@polymer/iron-icons/iron-icons.js";import"../../@polymer/paper-icon-button/paper-icon-button.js";import"../simple-popover/simple-popover.js";import"../scroll-button/scroll-button.js";class CleanOne extends o{static get styles(){return[t`
        :host {
          display: block;
    ...
    `}static get properties(){return{...super.properties,withMenu:{type:String},hideSettings:{type:Boolean},fontSize:{type:Number,reflect:!0,attribute:"font-size"},fontFamily:{type:Number,reflect:!0,attribute:"font-family"},colorTheme:{type:Number,reflect:!0,attribute:"color-theme"}}}static get tag(){return"clean-one"}constructor(){super(),this.hideSettings=!0,this.fontSize=1,this.fontFamily=0,this.colorTheme=0,this.withMenu="with-menu",import("../haxcms-elements/lib/ui-components/active-item/site-active-title.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"),import("../haxcms-elements/lib/ui-components/site/site-print-button.js"),import("../haxcms-elements/lib/ui-components/site/site-rss-button.js"),this.__disposer=[],n(e=>{this.activeManifestIndex=s(i.activeManifestIndex),this.__disposer.push(e)})}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.shadowRoot.querySelector("scroll-button").target=this.shadowRoot.querySelector("#top"),this.shadowRoot.querySelector("simple-popover").target=this.shadowRoot.querySelector("#popovertarget")}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}prevPage(e){super.prevPage(e)}nextPage(e){super.nextPage(e)}}window.customElements.define(CleanOne.tag,CleanOne);export{CleanOne};