...
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as o}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as i}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{HAXCMSRememberRoute as s}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{QRCodeMixin as n}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{HAXCMSMobileMenuMixin as r}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSUserStylesMenuMixin as a}from"../haxcms-elements/lib/core/utils/HAXCMSUserStylesMenu.js";import{store as l}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as c,toJS as h}from"../../mobx/dist/mobx.esm.js";import"../scroll-button/scroll-button.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import"./lib/clean-one-search-box.js";import{SimpleColorsSuper as m}from"../simple-colors/simple-colors.js";import{PrintBranchMixin as u}from"../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{MicroFrontendRegistry as p}from"../micro-frontend-registry/micro-frontend-registry.js";import{PDFPageMixin as d}from"../haxcms-elements/lib/core/utils/PDFPageMixin.js";class CleanOne extends(s(u(d(n(i(a(r(m(o))))))))){static get styles(){return[...super.styles,t`
    ...
    `}searchChanged(e){e.detail.value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{this.searchTerm=e.detail.value})):this.searchTerm=""}static get properties(){return{...super.properties,searchTerm:{type:String}}}static get tag(){return"clean-one"}constructor(){super(),this.HAXCMSThemeSettings.autoScroll=!0,import("../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"),import("../haxcms-elements/lib/ui-components/site/site-print-button.js"),import("../haxcms-elements/lib/ui-components/site/site-rss-button.js"),import("../haxcms-elements/lib/ui-components/active-item/site-git-corner.js"),this.__disposer=this.__disposer?this.__disposer:[],c((e=>{this.activeManifestIndex=h(l.activeManifestIndex),this.searchTerm="",this.__disposer.push(e)}))}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),document.body.style.overflow="hidden",this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector("#body"),this.shadowRoot.querySelector("scroll-button").target=this.shadowRoot.querySelector("#haxcms-theme-top")}HAXCMSGlobalStyleSheetContent(){return[...super.HAXCMSGlobalStyleSheetContent(),t`
      ...
      `]}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}prevPage(e){super.prevPage(e)}nextPage(e){super.nextPage(e)}}customElements.define(CleanOne.tag,CleanOne);export{CleanOne};