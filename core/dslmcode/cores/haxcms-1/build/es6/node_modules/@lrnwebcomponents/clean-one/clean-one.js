 ...
 */
import{html as e,css as t}from"../../lit-element/lit-element.js";import{HAXCMSLitElementTheme as o}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as i}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{store as s}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as n,toJS as r}from"../../mobx/lib/mobx.module.js";import"../../@polymer/iron-icons/editor-icons.js";import"../../@polymer/iron-icons/iron-icons.js";import"../../@polymer/paper-icon-button/paper-icon-button.js";import"../simple-popover/simple-popover.js";import"../scroll-button/scroll-button.js";class CleanOne extends(i(o)){static get styles(){return[...super.styles,t`
        :host {
          color: #242A31;
          width: 100%;
          margin: 0;
      ...
      `]}toggleMenu(e){"with-menu"==this.withMenu?(this.withMenu="",this.shadowRoot.querySelector("#nav").setAttribute("tabindex","-1")):(this.withMenu="with-menu",this.shadowRoot.querySelector("#nav").removeAttribute("tabindex"))}toggleSettings(e){this.hideSettings=!this.hideSettings}sizeDown(e){this.fontSize>0&&(this.fontSize=this.fontSize-1)}sizeUp(e){this.fontSize<4&&(this.fontSize=this.fontSize+1)}fontFamilyChange(e){this.fontFamily=parseInt(e.path[0].getAttribute("data-font"))}colorThemeChange(e){this.colorTheme=parseInt(e.path[0].getAttribute("data-theme"))}render(){return e`
      <div
        class="site without-animation ${this.withMenu} font-size-${this.fontSize} font-family-${this.fontFamily} color-theme-${this.colorTheme}"
      >
    ...
    `}searchItemSelected(e){this.searchTerm=""}searchChanged(e){e.path[0].value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then(()=>{this.searchTerm=e.path[0].value}):this.searchTerm=""}static get properties(){return{...super.properties,withMenu:{type:String},searchTerm:{type:String},hideSettings:{type:Boolean},fontSize:{type:Number,reflect:!0,attribute:"font-size"},fontFamily:{type:Number,reflect:!0,attribute:"font-family"},colorTheme:{type:Number,reflect:!0,attribute:"color-theme"}}}static get tag(){return"clean-one"}constructor(){super(),this.HAXCMSThemeSettings.autoScroll=!0,this.hideSettings=!0,this.fontSize=1,this.fontFamily=0,this.searchTerm="",this.colorTheme=0,this.withMenu="with-menu",import("../haxcms-elements/lib/ui-components/active-item/site-active-title.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"),import("../haxcms-elements/lib/ui-components/site/site-print-button.js"),import("../haxcms-elements/lib/ui-components/site/site-rss-button.js"),import("../haxcms-elements/lib/ui-components/active-item/site-git-corner.js"),this.__disposer=this.__disposer?this.__disposer:[],n(e=>{this.activeManifestIndex=r(s.activeManifestIndex),this.__disposer.push(e)}),this.addEventListener("click",this.checkMenuOpen.bind(this))}checkMenuOpen(e){this.hideSettings||!e.path||e.path.includes(this.__toggleTarget)||e.path.includes(this.shadowRoot.querySelector("simple-popover"))||(this.hideSettings=!0)}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this.__toggleTarget=this.shadowRoot.querySelector("#popovertarget"),this.shadowRoot.querySelector("scroll-button").target=this.shadowRoot.querySelector("#top"),this.shadowRoot.querySelector("simple-popover").target=this.__toggleTarget}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}prevPage(e){super.prevPage(e)}nextPage(e){super.nextPage(e)}}window.customElements.define(CleanOne.tag,CleanOne);export{CleanOne};