import{LitElement as t,html as e,css as i}from"../../../lit-element/lit-element.js";import"../json-outline-schema.js";import{wipeSlot as s,valueMapTransform as r}from"../../utils/utils.js";import"../../dynamic-import-registry/dynamic-import-registry.js";class JosRender extends t{static get tag(){return"jos-render"}constructor(){super(),this.registry=window.DynamicImportRegistry.requestAvailability(),window.WCAutoloadBasePath&&(this.registry.basePath=window.WCAutoloadBasePath),this.items=[]}static get styles(){return[i`
        :host {
          display: block;
        }
        .children {
