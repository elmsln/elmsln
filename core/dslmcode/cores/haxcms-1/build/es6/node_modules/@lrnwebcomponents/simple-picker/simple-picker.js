 ...
 */
import{LitElement as e,html as i,css as t}from"../../lit-element/lit-element.js";import{cache as o}from"../../lit-html/directives/cache.js";import{nothing as l}from"../../lit-html/lit-html.js";import"../simple-icon/lib/simple-icon-lite.js";import"../simple-icon/lib/simple-icons.js";class SimplePicker extends e{static get styles(){return[t`
        :host {
      ...
      >
        ...
        <div id="collapse" part="listbox">
          <div class="rows" part="listbox-rows">
            ${o(this.expanded&&this.__options?this._renderOptions(this.__options):l)}
          </div>
        </div>
        ...
        <div class="row">
          ${Array.isArray(e)?this._renderRow(e,t):l}
        </div>
