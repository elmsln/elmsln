import{LitElement as t,html as e}from"../../lit-element/lit-element.js";class TwitterEmbed extends t{static get tag(){return"twitter-embed"}constructor(){super(),this.lang=document&&document.documentElement&&document.documentElement.lang?document.documentElement.lang:"en",this.dataWidth="550px",this.dataTheme="light",this.tweet=null,this.tweetId=null,this.allowPopups="allow-popups"}static get properties(){return{tweet:{type:String},lang:{type:String},dataWidth:{type:String,attribute:"data-width"},dataTheme:{type:String,attribute:"data-theme"},tweetId:{type:String,attribute:"tweet-id"},noPopups:{type:Boolean,attribute:"no-popups"},allowPopups:{type:String}}}static get haxProperties(){return{canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Twitter embed",description:"Embed a tweet from twitter in context",icon:"hax:meme",color:"blue",groups:["Social Media"],handles:[],meta:{author:"ELMS:LN"}},settings:{quick:[],configure:[{attribute:"tweet",title:"Tweet URL",description:"URL of the tweet in question to be embedded",inputMethod:"textfield"},{attribute:"data-theme",title:"Theme",description:"Light or dark version of twitter tweets",inputMethod:"select",options:{light:"Light",dark:"Dark"}},{attribute:"no-popups",title:"Prevent popup on click",description:"This blocks the user from clicking the tweet and going to twitter.com",inputMethod:"boolean"}],advanced:[]},demoSchema:[{tag:"twitter-embed",content:"",properties:{tweet:"https://twitter.com/btopro/status/1298632260707639298"}}]}}updated(t){t.forEach((t,e)=>{"noPopups"===e&&(this[e]?this.allowPopups="":this.allowPopups="allow-popups"),"tweet"===e&&this[e]&&this[e].includes("twitter.com")&&(this.tweetId=this[e].split("/").pop())})}render(){return e`
      <div
