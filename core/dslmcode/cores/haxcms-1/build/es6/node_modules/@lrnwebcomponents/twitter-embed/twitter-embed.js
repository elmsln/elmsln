import{LitElement as t,html as e,css as i}from"../../lit-element/lit-element.js";class TwitterEmbed extends t{static get tag(){return"twitter-embed"}constructor(){super(),this.lang=document.body.getAttribute("xml:lang")||document.body.getAttribute("lang")||document.documentElement.getAttribute("xml:lang")||document.documentElement.getAttribute("lang")||navigator.language||"en",this.dataWidth="550px",this.dataTheme="light",this.tweet=null,this.tweetId=null,this.allowPopups="allow-popups"}static get properties(){return{tweet:{type:String},_haxstate:{type:Boolean},lang:{type:String},dataWidth:{type:String,attribute:"data-width"},dataTheme:{type:String,attribute:"data-theme"},tweetId:{type:String,attribute:"tweet-id"},noPopups:{type:Boolean,attribute:"no-popups"},allowPopups:{type:String}}}static get haxProperties(){return decodeURIComponent(import.meta.url)+"/../lib/twitter-embed.haxProperties.json"}haxHooks(){return{gizmoRegistration:"haxgizmoRegistration",editModeChanged:"haxeditModeChanged",activeElementChanged:"haxactiveElementChanged"}}haxgizmoRegistration(t){window.dispatchEvent(new CustomEvent("i18n-manager-register-element",{detail:{namespace:"twitter-embed.haxProperties",localesPath:decodeURIComponent(import.meta.url)+"/../locales",locales:["es"]}}))}haxactiveElementChanged(t,e){e&&(this._haxstate=e)}haxeditModeChanged(t){this._haxstate=t}_clickPrevent(t){this._haxstate&&(t.preventDefault(),t.stopPropagation(),t.stopImmediatePropagation())}updated(t){t.forEach(((t,e)=>{"noPopups"===e&&(this[e]?this.allowPopups="":this.allowPopups="allow-popups"),"tweet"===e&&this[e]&&this[e].includes("twitter.com")&&(this.tweetId=this[e].split("/").pop())}))}render(){return e`
      <div
