...
import{LitElement as i,html as t,css as e}from"../../../lit-element/lit-element.js";import{ElmslnStudioStyles as s}from"./elmsln-studio-styles.js";import{ElmslnStudioUtilities as n}from"./elmsln-studio-utilities.js";import"../../../@polymer/iron-icons/communication-icons.js";import"./elmsln-studio-link.js";import"./elmsln-studio-button.js";class ElmslnStudioSubmissions extends(n(s(i))){static get tag(){return"elmsln-studio-submissions"}static get styles(){return[...super.styles,e`
      ...
      <div id="secondary">
        <div class="filters">
          ...
          <span class="comments-filter"
            >${""!==this.assignmentFilter||""!==this.studentFilter?"Filtered":"All"}</span
          >
        </div>
    ...
    `}static get properties(){return{...super.properties,assignmentFilter:{type:String,attribute:"assignment-filter"},comments:{type:Array},grid:{type:Boolean,attribute:"grid"},studentFilter:{type:String,attribute:"student-filter"},submissions:{type:Array}}}constructor(){super(),this.grid=!1,this.submissions=[],this.comments=[],this.tag=ElmslnStudioSubmissions.tag}get filteredComments(){return(this.comments||[]).filter(i=>this._isFiltered(i.userId,i.assignmentId))}get studentOptions(){let i={"":"All"};return(this.submissions||[]).forEach(t=>i[t.userId]=this.fullName(t)),i}get assignmentOptions(){let i={"":"All"};return(this.submissions||[]).forEach(t=>i[t.assignmentId]=t.assignment),i}get filteredSubmissions(){return(this.submissions||[]).filter(i=>this._isFiltered(i.userId,i.assignmentId))}_isFiltered(i="",t=""){return this._isFilteredStudent(i)&&this._isFilteredAssignment(t)}_isFilteredAssignment(i=""){return""===this.assignmentFilter||i===this.assignmentFilter}_isFilteredStudent(i=""){return""===this.studentFilter||i===this.studentFilter}}customElements.define("elmsln-studio-submissions",ElmslnStudioSubmissions);export{ElmslnStudioSubmissions};