 ...
 */
import{html as e,css as t}from"../../lit-element/lit-element.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as o}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{store as s}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as n,toJS as a}from"../../mobx/lib/mobx.module.js";import{ResponsiveUtilityBehaviors as r}from"../responsive-utility/lib/responsive-utility-behaviors.js";import"../../@polymer/paper-icon-button/paper-icon-button.js";class CleanTwo extends(o(r(i))){static get styles(){return[t`
        :host {
          display: block;
          font-size: 16px;
      ...
      `]}searchItemSelected(e){this.searchTerm=""}searchChanged(e){e.path[0].value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then(()=>{this.searchTerm=e.path[0].value}):this.searchTerm=""}render(){return e`
    ...
    `}__prevPageLabelChanged(e){this.prevPage=e.detail.value}__nextPageLabelChanged(e){this.nextPage=e.detail.value}static get properties(){return{...super.properties,searchTerm:{type:String},withMenu:{type:String},prevPage:{type:String},nextPage:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"clean-two"}constructor(){super(),this.withMenu="with-menu",this.HAXCMSThemeSettings.autoScroll=!0,this.searchTerm="",this.__disposer=this.__disposer?this.__disposer:[],n(e=>{this.activeManifestIndex=a(s.activeManifestIndex),this.__disposer.push(e)}),n(e=>{s.activeItem&&s.activeItem.metadata&&s.activeItem.metadata.updated&&(this.pageTimestamp=a(s.activeItem.metadata.updated)),this.__disposer.push(e)}),import("../simple-datetime/simple-datetime.js"),import("../haxcms-elements/lib/ui-components/active-item/site-active-title.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu-content.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"),import("../haxcms-elements/lib/ui-components/site/site-print-button.js"),import("../haxcms-elements/lib/ui-components/site/site-rss-button.js"),import("../haxcms-elements/lib/ui-components/active-item/site-git-corner.js")}toggleMenu(e){"with-menu"==this.withMenu?(this.withMenu="",this.shadowRoot.querySelector("#nav").setAttribute("tabindex","-1")):(this.withMenu="with-menu",this.shadowRoot.querySelector("#nav").removeAttribute("tabindex"))}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}}window.customElements.define(CleanTwo.tag,CleanTwo);export{CleanTwo};