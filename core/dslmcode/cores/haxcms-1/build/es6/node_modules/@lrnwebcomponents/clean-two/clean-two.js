 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSRememberRoute as o}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{HAXCMSThemeParts as s}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{QRCodeMixin as a}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{HAXCMSMobileMenuMixin as n}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as r}from"../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{store as l}from"../haxcms-elements/lib/core/haxcms-site-store.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import{autorun as d,toJS as p}from"../../mobx/dist/mobx.esm.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import{normalizeEventPath as c}from"../utils/utils.js";class CleanTwo extends(r(o(a(s(n(i)))))){static get styles(){return[...super.styles,t`
        :host {
          display: block;
          font-size: 16px;
      ...
      `]}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),document.body.style.overflow="hidden",this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector(".body-wrapper")}searchItemSelected(e){this.searchTerm=""}searchChanged(e){var t=c(e)[0];t.value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{this.searchTerm=t.value})):this.searchTerm=""}render(){return e`
