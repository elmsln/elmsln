 ...
 */
import{html as e,css as t}from"../../lit-element/lit-element.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSThemeParts as o}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{HAXCMSMobileMenuMixin as s}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{store as n}from"../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as a,toJS as r}from"../../mobx/dist/mobx.esm.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import"../simple-icon/lib/simple-icon-button.js";class CleanTwo extends(o(s(i))){static get styles(){return[...super.styles,t`
        :host {
          display: block;
          font-size: 16px;
      ...
      `]}searchItemSelected(e){this.searchTerm=""}searchChanged(e){var t=null;(t=e.path&&e.path[0]?e.path[0]:e.originalTarget?e.originalTarget:e.target).value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then(()=>{this.searchTerm=t.value}):this.searchTerm=""}render(){return e`
    ...
    `}__prevPageLabelChanged(e){this.prevPage=e.detail.value}__nextPageLabelChanged(e){this.nextPage=e.detail.value}static get properties(){return{...super.properties,searchTerm:{type:String},prevPage:{type:String},nextPage:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"clean-two"}constructor(){super(),this.HAXCMSThemeSettings.autoScroll=!0,this.searchTerm="",this.__disposer=this.__disposer?this.__disposer:[],a(e=>{this.activeManifestIndex=r(n.activeManifestIndex),this.__disposer.push(e)}),a(e=>{n.activeItem&&n.activeItem.metadata&&n.activeItem.metadata.updated&&(this.pageTimestamp=r(n.activeItem.metadata.updated)),this.__disposer.push(e)}),import("../simple-datetime/simple-datetime.js"),import("../haxcms-elements/lib/ui-components/active-item/site-active-title.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu-content.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu-button.js"),import("../haxcms-elements/lib/ui-components/site/site-print-button.js"),import("../haxcms-elements/lib/ui-components/site/site-rss-button.js"),import("../haxcms-elements/lib/ui-components/active-item/site-git-corner.js")}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}}window.customElements.define(CleanTwo.tag,CleanTwo);export{CleanTwo};