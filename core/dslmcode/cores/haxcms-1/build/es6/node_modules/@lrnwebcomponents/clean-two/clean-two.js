 ...
 */
import{html as e,css as t}from"../../lit/index.js";import{HAXCMSLitElementTheme as i}from"../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{HAXCMSRememberRoute as o}from"../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js";import{HAXCMSThemeParts as s}from"../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js";import{PrintBranchMixin as a}from"../haxcms-elements/lib/core/utils/PrintBranchMixin.js";import{PDFPageMixin as n}from"../haxcms-elements/lib/core/utils/PDFPageMixin.js";import{QRCodeMixin as r}from"../haxcms-elements/lib/core/utils/QRCodeMixin.js";import{HAXCMSMobileMenuMixin as l}from"../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js";import{HAXCMSOperationButtons as d}from"../haxcms-elements/lib/core/utils/HAXCMSOperationButtons.js";import{store as p}from"../haxcms-elements/lib/core/haxcms-site-store.js";import"../haxcms-elements/lib/ui-components/active-item/site-active-title.js";import"../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";import{autorun as c,toJS as m}from"../../mobx/dist/mobx.esm.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import{normalizeEventPath as h}from"../utils/utils.js";import{MicroFrontendRegistry as b}from"../micro-frontend-registry/micro-frontend-registry.js";class CleanTwo extends(d(o(n(a(r(s(l(i)))))))){static get styles(){return[...super.styles,t`
        :host {
          display: block;
          font-size: 16px;
      ...
      `]}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),document.body.style.overflow="hidden",this.HAXCMSThemeSettings.scrollTarget=this.shadowRoot.querySelector(".body-wrapper")}searchItemSelected(e){this.searchTerm=""}searchChanged(e){var t=h(e)[0];t.value?import("../haxcms-elements/lib/ui-components/site/site-search.js").then((()=>{this.searchTerm=t.value})):this.searchTerm=""}render(){return e`
      <div class="body-wrapper">
        <div class="left-col" part="left-col">${this.HAXCMSMobileMenu()}</div>
        <div class="content-wrapper">
          <div class="content">
            <header class="header">
              ${["lg","xl"].includes(this.responsiveSize)?"":e`
    ...
    `}__prevPageLabelChanged(e){this.prevPage=e.detail.value}__nextPageLabelChanged(e){this.nextPage=e.detail.value}static get properties(){let e={};return super.properties&&(e=super.properties),{...e,searchTerm:{type:String},prevPage:{type:String},nextPage:{type:String},pageTimestamp:{type:Number}}}static get tag(){return"clean-two"}constructor(){super(),this.HAXCMSThemeSettings.autoScroll=!0,this.searchTerm="",this.__disposer=this.__disposer?this.__disposer:[],c((e=>{this.activeManifestIndex=m(p.activeManifestIndex),this.__disposer.push(e)})),c((e=>{p.activeItem&&p.activeItem.metadata&&p.activeItem.metadata.updated&&(this.pageTimestamp=m(p.activeItem.metadata.updated)),this.__disposer.push(e)})),import("../haxcms-elements/lib/ui-components/layout/site-modal.js"),import("../haxcms-elements/lib/ui-components/navigation/site-menu-content.js")}siteModalClick(e){import("../haxcms-elements/lib/ui-components/site/site-search.js").then((e=>{window.SimpleModal.requestAvailability().querySelector("site-search").shadowRoot.querySelector("simple-fields-field").focus()}))}disconnectedCallback(){for(var e in this.__disposer)this.__disposer[e].dispose();super.disconnectedCallback()}}window.customElements.define(CleanTwo.tag,CleanTwo);export{CleanTwo};