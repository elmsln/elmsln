import{LitElement as e,html as i,css as t}from"../../../lit/index.js";import{store as n}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import"../../simple-icon/simple-icon.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/lib/simple-icon-button.js";import{autorun as o,toJS as r}from"../../../mobx/dist/mobx.esm.js";class CourseIntroHeader extends e{static get properties(){return{title:{type:String},description:{type:String},icon:{type:String},backgroundImage:{type:String},color:{type:String}}}constructor(){super(),this.title="",this.description="",this.icon="",this.backgroundImage="",this.color="",o((()=>{const e=r(n.manifest);e&&e.metadata&&e.metadata.theme&&e.metadata.theme.variables&&(this.title=e.title,this.description=e.description,this.icon=e.metadata.theme.variables.icon,this.backgroundImage=`url('${e.metadata.theme.variables.image}')`,this.color=e.metadata.theme.variables.hexCode)}))}static get styles(){return[t`
        :host {
          display: block;
        }
