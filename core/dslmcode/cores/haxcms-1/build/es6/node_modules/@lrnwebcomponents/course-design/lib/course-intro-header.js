import{LitElement as e,html as r,css as t}from"../../../lit/index.js";import{store as i}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import{autorun as o,toJS as a}from"../../../mobx/dist/mobx.esm.js";class CourseIntroHeader extends e{static get properties(){return{title:{type:String},description:{type:String}}}constructor(){super(),this.title="",this.description=""}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this._disposer=o((()=>{this.title=a(i.manifest.title),this.description=a(i.manifest.description),this.shadowRoot.querySelector("header").style.backgroundImage=`url(${a(i.manifest.metadata.theme.variables.image)})`}))}render(){return r`
      <header>
        <div id="info">
