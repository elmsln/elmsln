import{LitElement as e,html as i,css as a}from"../../../lit/index.js";import{store as n}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import"../../simple-icon/simple-icon.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/lib/simple-icon-button.js";import{autorun as d,toJS as t}from"../../../mobx/dist/mobx.esm.js";class CourseIntroHeader extends e{static get properties(){return{title:{type:String},description:{type:String},icon:{type:String}}}constructor(){super(),this.title="",this.description="",this.icon=""}static get styles(){return[a`
        :host {
          display: block;
        }
        ...
        @media screen and (min-width: 320px) {
          #header-icon {
            ...
            height: 100px;
            border-radius: 50%;
            border: 6px solid var(--course-intro-header--header--background-color, #1e1e1e);
            display: flex;
            justify-content: center;
            align-items: center;
            position: relative;
        ...
        @media screen and (min-width: 320px) {
          simple-icon#course-icon {
            ...
            --simple-icon-color: var(--course-intro-header--icon--color, #1e1e1e);
          }
        }
        ...
        @media screen and (min-width: 920px) {
          #header-icon {
            width: 210px;
            height: 210px;
            border: 8px solid var(--course-intro-header--icon--border-color, #1e1e1e);
            bottom: 128px;
          }
        }
