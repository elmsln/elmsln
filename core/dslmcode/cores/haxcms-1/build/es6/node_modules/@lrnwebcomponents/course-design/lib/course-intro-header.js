import{LitElement as e,html as i,css as a}from"../../../lit/index.js";import{store as t}from"../../haxcms-elements/lib/core/haxcms-site-store.js";import"../../simple-icon/simple-icon.js";import"../../simple-icon/lib/simple-icons.js";import"../../simple-icon/lib/simple-icon-button.js";import{autorun as n,toJS as d}from"../../../mobx/dist/mobx.esm.js";class CourseIntroHeader extends e{static get properties(){return{title:{type:String},description:{type:String},icon:{type:String}}}constructor(){super(),this.title="",this.description="",this.icon=""}static get styles(){return[a`
        :host {
          display: block;
        }
      ...
      `]}firstUpdated(e){super.firstUpdated&&super.firstUpdated(e),this._disposer=n((()=>{t.manifest&&t.manifest.metadata&&t.manifest.metadata.theme&&t.manifest.metadata.theme.variables&&(this.title=d(t.manifest.title),this.description=d(t.manifest.description),this.icon=d(t.manifest.metadata.theme.variables.icon),this.shadowRoot.querySelector("#sub-heading").style.color=`${d(t.manifest.metadata.theme.variables.hexCode)}`,this.shadowRoot.querySelector("#header").style.backgroundImage=`url(${d(t.manifest.metadata.theme.variables.image)})`)}))}render(){return i`
