 ...
 */
import{LitElement as t,html as i,css as e}from"../../lit-element/lit-element.js";import{SchemaBehaviors as o}from"../schema-behaviors/schema-behaviors.js";import"../a11y-details/a11y-details.js";import"../simple-tooltip/simple-tooltip.js";class A11yGifPlayer extends(o(t)){constructor(){super(),this.alt=null,this.disabled=!1,this.src=null,this.tooltip="Toggle animation",this.tooltipPlaying=null,this.srcWithoutAnimation=null,this.__playing=!1}static get styles(){return[e`
        :host {
          display: block;
        }
        :host([hidden]) {
