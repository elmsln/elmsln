 ...
 */
import{LitElement as t,html as i,css as e}from"../../lit-element/lit-element.js";import{nothing as o}from"../../lit-html/lit-html.js";import{SchemaBehaviors as s}from"../schema-behaviors/schema-behaviors.js";import{IntersectionObserverMixin as a}from"../intersection-element/lib/IntersectionObserverMixin.js";import{I18NMixin as r}from"../i18n-manager/lib/I18NMixin.js";class A11yGifPlayer extends(r(a(s(t)))){constructor(){super(),this.__gifLoaded=!1,this.disabled=!1,this.tooltip="",this.__playing=!1,this._updateFromSlot(),this.t={toggleAnimation:"Toggle animation"},this.registerLocalization({context:this,basePath:import.meta.url,locales:["es"]})}static get styles(){return[e`
        :host {
          display: block;
        }
        :host([hidden]) {
