...
import "../../circle-progress/circle-progress.js";
...
class LrnsysProgressCircle extends PolymerElement {
  ...
  static get properties() {
    return {
      ...
      completeSound: {
        type: String,
        value: this.pathFromUrl(decodeURIComponent(import.meta.url)) + "assets/complete.mp3",
        reflectToAttribute: true
      },
      ...
      finishedSound: {
        type: String,
        value: this.pathFromUrl(decodeURIComponent(import.meta.url)) + "assets/finished.mp3",
        reflectToAttribute: true
      },
