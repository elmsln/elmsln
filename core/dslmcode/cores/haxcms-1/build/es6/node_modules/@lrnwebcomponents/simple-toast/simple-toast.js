 ...
 */
import{html as t,css as e}from"../../lit/index.js";import{SimpleColors as s}from"../simple-colors/simple-colors.js";import"./lib/simple-toast-el.js";window.SimpleToast=window.SimpleToast||{},window.SimpleToast.requestAvailability=()=>(window.SimpleToast.instance||(window.SimpleToast.instance=document.createElement("simple-toast"),document.body.appendChild(window.SimpleToast.instance)),window.SimpleToast.instance);export const SimpleToastStore=window.SimpleToast.requestAvailability();class SimpleToast extends s{static get styles(){return[...super.styles,e`
        :host {
          display: block;
        }
