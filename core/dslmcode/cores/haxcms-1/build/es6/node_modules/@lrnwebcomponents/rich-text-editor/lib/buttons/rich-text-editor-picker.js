...
import{LitElement as e,html as t,css as i}from"../../../../lit/index.js";import{RichTextEditorButtonBehaviors as o}from"./rich-text-editor-button.js";import"../../../simple-picker/simple-picker.js";const RichTextEditorPickerBehaviors=function(e){return class extends(o(e)){static get tag(){return"rich-text-editor-picker"}static get styles(){return[...super.styles,i`
      ...
      `}static get properties(){return{...super.properties,allowNull:{type:Boolean},disabled:{type:Boolean,reflect:!0,attribute:"disabled"},command:{type:String},hideNullOption:{type:Boolean},icon:{type:String,reflect:!0},titleAsHtml:{type:Boolean},value:{type:Object}}}constructor(){super(),this.allowNull=!1,this.command="insertHTML",this.label="Insert link",this.titleAsHtml=!1,this.value=null}firstUpdated(e){super.firstUpdated(e),this._setOptions()}get isToggled(){return!1}get labelVisibleClass(){return this.icon?"hide":"show"}_pickerFocus(e){e.preventDefault()}_rangeChanged(){this._setRangeValue(),super._rangeChanged()}_setRangeValue(){let e=this._getSelection();this.shadowRoot&&(this.tagsArray.includes(e)?this.shadowRoot.querySelector("#button").value=e:this.range&&!this.range.collapsed||(this.shadowRoot.querySelector("#button").value=void 0))}_setOptions(){return this.options=this._setPickerOptions()}_setPickerOptions(e=this.options||[]){let t=[],i=Math.sqrt(e.length)<11?Math.ceil(Math.sqrt(e.length)):10;return e.forEach(((e,o)=>{let r=Math.floor(o/i),l=o-r*i;t[r]||(t[r]=[]),t[r][l]=e})),t}_pickerChange(e){let t=this._getSelectionType()||"";this.__highlight.parentNode;this.commandVal=e.detail.value||"",this.range&&t!==this.commandVal&&this.sendCommand()}}};class RichTextEditorPicker extends(RichTextEditorPickerBehaviors(e)){}window.customElements.define(RichTextEditorPicker.tag,RichTextEditorPicker);export{RichTextEditorPicker,RichTextEditorPickerBehaviors};