...
import{LitElement as t,html as e,css as i}from"../../../../lit/index.js";import{RichTextEditorButtonBehaviors as o}from"./rich-text-editor-button.js";import"../../../simple-picker/simple-picker.js";const RichTextEditorPickerBehaviors=function(t){return class extends(o(t)){static get tag(){return"rich-text-editor-picker"}static get styles(){return[...super.styles,i`
      ...
      `}static get properties(){return{...super.properties,allowNull:{type:Boolean},command:{type:String},icon:{type:String},titleAsHtml:{type:Boolean},value:{type:Object}}}constructor(){super(),this.allowNull=!1,this.command="insertHTML",this.label="Insert link",this.titleAsHtml=!1,this.value=null}firstUpdated(t){super.firstUpdated(t),this._setOptions()}get isToggled(){return!1}_pickerFocus(t){t.preventDefault()}_rangeChanged(){let t=this._getSelection();this.shadowRoot&&(this.tagsArray.includes(t)?this.shadowRoot.querySelector("#button").value=t:this.range&&!this.range.collapsed||(this.shadowRoot.querySelector("#button").value=null)),super._rangeChanged()}_setOptions(){return this.options=this._setPickerOptions()}_setPickerOptions(t=this.options||[]){let e=[],i=Math.sqrt(t.length)<11?Math.ceil(Math.sqrt(t.length)):10;return t.forEach(((t,o)=>{let r=Math.floor(o/i),s=o-r*i;e[r]||(e[r]=[]),e[r][s]=t})),e}_pickerChange(t){let e=this._getSelectionType()||"";this.__highlight.parentNode;this.commandVal=t.detail.value||"",this.range&&e!==this.commandVal&&this.sendCommand()}}};class RichTextEditorPicker extends(RichTextEditorPickerBehaviors(t)){}window.customElements.define(RichTextEditorPicker.tag,RichTextEditorPicker);export{RichTextEditorPicker,RichTextEditorPickerBehaviors};