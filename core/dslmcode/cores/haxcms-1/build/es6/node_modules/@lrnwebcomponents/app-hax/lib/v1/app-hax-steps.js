import{html as t,css as e,unsafeCSS as s}from"../../../../lit/index.js";import"./AppHaxRouter.js";import{SimpleColors as i}from"../../../simple-colors/simple-colors.js";import{autorun as a,toJS as o}from"../../../../mobx/dist/mobx.esm.js";import{store as p}from"./AppHaxStore.js";import{localStorageSet as n}from"../../../utils/utils.js";import"../../../../scrollable-component/index.js";import"../../../simple-icon/lib/simple-icon-lite.js";import"./app-hax-site-button.js";import"./app-hax-hat-progress.js";import"./app-hax-button.js";const r=new URL("../assets/images/Home.svg",import.meta.url).href,l=new URL("../assets/images/DisabledCircle.svg",import.meta.url).href,h=new URL("../assets/images/TransparentCircle.svg",import.meta.url).href,c=new URL("../assets/images/EnabledCircle.svg",import.meta.url).href,d={portfolio:["haxor-slevin","bootstrap-theme"],course:["clean-one","clean-two","learn-two-theme"],website:["bootstrap-theme","outline-player","haxor-slevin"]};export class AppHaxSteps extends i{static get tag(){return"app-hax-steps"}constructor(){super(),this.nameTyped="",this.stepRoutes=[],this._progressReady=!1,this.step=null,this.loaded=!1,this.themeNames=[],this.appSettings={},a((()=>{this.appSettings=o(p.appSettings);const t=o(p.site.structure);this.themeNames=Object.keys(this.appSettings.themes).filter((e=>t&&d[t]&&d[t].includes(e)))})),a((()=>{this.dark=o(p.darkMode)})),a((()=>{n("app-hax-step",o(p.step))})),a((()=>{n("app-hax-site",o(p.site)),this.step=p.stepTest(this.step)})),a((()=>{o(p.createSiteSteps)&&o(p.location)&&(this.step=p.stepTest(this.step))})),a((()=>{const t=o(p.routes);this.stepRoutes=t.filter((t=>t.step))}))}static get properties(){return{...super.properties,step:{type:Number,reflect:!0},stepRoutes:{type:Array},themeNames:{type:Array},loaded:{type:Boolean,reflect:!0},appSettings:{type:Object},nameTyped:{type:String}}}chooseStructure(t){if(!t.target.comingSoon){const{value:e}=t.target;p.site.structure=e,p.appEl.playSound("click2")}}chooseType(t){if(!t.target.comingSoon){const{value:e}=t.target;p.site.type=e,p.appEl.playSound("click2")}}chooseTheme(t){if(!t.target.comingSoon){const{value:e}=t.target;p.site.theme=e,p.appEl.playSound("click2")}}chooseName(){if(""!==this.nameTyped){const t=this.shadowRoot.querySelector("#sitename").value;p.site.name=t,p.appEl.playSound("click2")}}progressReady(t){t.detail&&(this._progressReady=!0,5===this.step&&setTimeout((()=>{this.shadowRoot.querySelector("app-hax-hat-progress").process()}),300))}updated(t){super.updated&&super.updated(t),t.forEach(((t,e)=>{4===this.step&&"step"===e&&this.shadowRoot&&(this.shadowRoot.querySelector("#sitename").value=o(p.site.name)),5===this.step&&"step"===e&&this.shadowRoot&&this._progressReady&&setTimeout((()=>{this.shadowRoot.querySelector("app-hax-hat-progress").process()}),600),"step"===e&&(p.step=this.step)}))}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",this.maintainScroll.bind(this))}disconnectedCallback(){window.removeEventListener("resize",this.maintainScroll.bind(this)),super.disconnectedCallback()}maintainScroll(){this.shadowRoot&&this.step&&(this.scrollToThing(`#step-${this.step}`,{behavior:"instant",block:"start",inline:"nearest"}),setTimeout((()=>{this.scrollToThing(`#step-${this.step}`,{behavior:"instant",block:"start",inline:"nearest"})}),100))}firstUpdated(t){super.firstUpdated&&super.firstUpdated(t),setTimeout((()=>{null===this.step&&(this.step=1),this.scrollToThing(`#step-${this.step}`,{behavior:"instant",block:"start",inline:"nearest"})}),100),a((()=>{if(o(p.createSiteSteps)&&o(p.appReady)){const t=o(p.location);t.route&&t.route.step&&t.route.name&&setTimeout((()=>{this.scrollToThing("#".concat(t.route.name),{behavior:"smooth",block:"start",inline:"nearest"}),4===t.route.step&&4===p.stepTest(4)&&setTimeout((()=>{this.shadowRoot.querySelector("#sitename").focus(),this.scrollToThing("#step-4",{behavior:"instant",block:"start",inline:"nearest"})}),800)}),300)}})),a((()=>{if(this.shadowRoot&&o(p.createSiteSteps)&&o(p.appReady)){const t=o(p.activeItem);t&&t.name&&t.step&&!this.__overrideProgression&&this.shadowRoot.querySelector("#link-".concat(t.name)).click()}}))}scrollToThing(t,e){const s=void 0!==window.safari;this.shadowRoot.querySelector(".carousel-with-snapping-item.active-step")&&this.shadowRoot.querySelector(".carousel-with-snapping-item.active-step").classList.remove("active-step"),s?this.shadowRoot.querySelector(t).scrollIntoView():this.shadowRoot.querySelector(t).scrollIntoView(e),this.shadowRoot.querySelector(t).classList.add("active-step")}static get styles(){return[...super.styles,e`
        :host {
          display: block;
        }
