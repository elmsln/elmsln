 ...
 */
import{LitElement as t,html as e,css as i}from"../../../../../lit-element/lit-element.js";import{HAXCMSThemeParts as o}from"../../core/utils/HAXCMSThemeParts.js";import{HAXCMSI18NMixin as s}from"../../core/utils/HAXCMSI18NMixin.js";import"../../../../simple-icon/lib/simple-icons.js";import"../../../../simple-icon/lib/simple-icon-button.js";import"../../../../simple-tooltip/simple-tooltip.js";class SiteRSSButton extends(s(o(t))){static get styles(){return[...super.styles,i`
        :host {
          display: inline-flex;
      ...
      `]}static get tag(){return"site-rss-button"}constructor(){super(),this.t={rssFeed:"RSS Feed",atomFeed:"ATOM Feed"},this._link={title:this.t.rssFeed},this.type="rss",this.raised=!1,this.position="bottom"}render(){return e`
      <a
