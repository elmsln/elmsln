...
import{LitElement as e,html as t,css as i}from"../../lit/index.js";import{SchemaBehaviors as a}from"../schema-behaviors/schema-behaviors.js";import{SimpleModalHandler as o}from"../simple-modal/lib/simple-modal-handler.js";import"../figure-label/figure-label.js";import{DDD as r}from"../d-d-d/d-d-d.js";class MediaImage extends r{static get styles(){return[super.styles,i`
      ...
      `]}constructor(){super(),this.disableZoom=!1,this.modalTitle="",this.source="",this.citation="",this.caption="",this.figureLabelTitle="",this.figureLabelDescription="",this.alt="",this.size="wide",this.round=!1,this.card=!1,this.box=!1,this.offset="none",this.cardColor="var(--ddd-theme-default-white)"}firstUpdated(e){e.forEach(((e,t)=>{"cardColor"==t&&this.style.setProperty("--card-background-color",this.cardColor)}))}updated(e){e.forEach(((e,t)=>{"caption"==t&&this._computeHasCaption(this[t]),["figureLabelTitle","figureLabelDescription"].includes(t)&&(this.__figureLabel=this._hasFigureLabel(this.figureLabelTitle,this.figureLabelDescription)),["figureLabelTitle","caption"].includes(t)&&(this.modalTitle=this.figureLabelTitle?this.figureLabelTitle:this.caption,this.modalTitle+=this.figureLabelDescription?" - "+this.figureLabelDescription:"")}))}render(){return t`
