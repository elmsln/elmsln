import{LitElement,html,css}from"../../lit-element/lit-element.js";import{SchemaBehaviors}from"../schema-behaviors/schema-behaviors.js";class MediaImage extends(SchemaBehaviors(LitElement)){static get styles(){return[css`
        :host {
          display: block;
          width: auto;
          margin: auto;
      ...
      `]}constructor(){super(),this.source="",this.citation="",this.caption="",this.figureLabelTitle="",this.figureLabelDescription="",this.alt="",this.size="wide",this.round=!1,this.card=!1,this.box=!1,this.offset="none",import("../figure-label/figure-label.js"),import("../../@polymer/iron-image/iron-image.js"),import("../../@polymer/iron-icons/iron-icons.js")}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>{"caption"==propName&&this._computeHasCaption(this[propName])})}render(){return html`
      ${this._hasFigureLabel(this.figureLabelTitle,this.figureLabelDescription)?html`
            <figure-label
