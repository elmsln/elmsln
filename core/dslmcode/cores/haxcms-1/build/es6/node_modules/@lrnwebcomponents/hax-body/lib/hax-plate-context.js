import{LitElement as t,css as e,html as i}from"../../../lit/index.js";import"./hax-toolbar.js";import"../../simple-toolbar/lib/simple-toolbar-menu-item.js";import{HAXStore as o}from"./hax-store.js";import"./hax-toolbar-menu.js";import"./hax-toolbar.js";import"./hax-context-item.js";import{wipeSlot as a}from"../../utils/utils.js";import{autorun as l,toJS as s}from"../../../mobx/dist/mobx.esm.js";import{HaxContextBehaviors as n}from"./hax-context-behaviors.js";import{normalizeEventPath as r}from"../../utils/utils.js";import{I18NMixin as d}from"../../i18n-manager/lib/I18NMixin.js";import{SimpleToast as c}from"../../simple-toast/simple-toast.js";class HaxPlateContext extends(d(n(t))){constructor(){super(),this.disableOps=!1,this.disableItemOps=!1,this.insertAbove=!0,this.disableDuplicate=!1,this.hasActiveEditingElement=!1,this.haxUIElement=!0,this.tourName="hax",this.trayDetail="content-edit",this.trayStatus="collapsed",this.t={edit:"Edit",dragHandle:"Drag handle",moveUp:"Move up",moveDown:"Move down",addColumn:"Add column",removeColumn:"Remove column",remove:"Remove",duplicate:"Duplicate",confirmDelete:"Confirm delete",changeTo:"Change to",editElement:"Edit Mode",modifyHTMLSource:"Modify HTML source",clickToChange:"Click to change",regions:"Available regions",insertItemAbove:"Insert item above",insertItemAboveOrBelow:"Insert item above or below",insertItemBelow:"Insert item below",selectLayout:"Select Layout Element"},this.registerLocalization({context:this,namespace:"hax"}),this.ceButtons=[],this.activeTagName="",this.activeTagIcon="hax:paragraph",this.addEventListener("hax-context-item-selected",this.handleCECustomEvent.bind(this))}static get tag(){return"hax-plate-context"}static get styles(){return[...super.styles,e`
      ...
      <hax-toolbar always-expanded>
        <div class="group">
          ...
          >
            ...
            ${this.activeNode&&this.activeNode.parentNode&&o.isLayoutElement(this.activeNode.parentNode)?(this.slottedItems||[]).map(((t,e)=>i`
                        <simple-toolbar-menu-item
                          slot="menuitem"
          ...
          >
            ...
            ${(this.slottedItems||[]).map(((t,e)=>(t.items||[]).map(((o,a)=>i`
                    <simple-toolbar-menu-item
                      slot="menuitem"
                      class="hax-select-grid-item ${e<1&&a<1?"first-slot":""}"
                    >
                      <hax-context-item
                        action
                        align-horizontal="left"
                        ?disabled="${this.viewSource||this.activeNode===o}"
                        label="${t.title||t.id}${t.items.length>1?` (${a+1})`:""}"
                        event-name="hax-select-grid-item"
                        .eventData="${{target:o,grid:t.grid,slot:t.slot,index:a,editMode:t.editMode}}"
                        role="menuitem"
                        show-text-label
                      >
                      </hax-context-item>
          ...
          >
            ...
            ${o.isLayoutElement(this.activeNode)?(this.slottedItems||[]).map(((t,e)=>i`
                        <simple-toolbar-menu-item
                          slot="menuitem"
                          class="insert-into-active ${e<1?"first-slot":""}"
                        >
                          <hax-context-item
                            action
                            align-horizontal="left"
      ...
      >
          ...
          <hax-context-item
            ...
            ?hidden="${!this.activeNode||o.isOriginalGridPlate(this.activeNode)}"
            id="rightremove"
            data-simple-tour-stop
            data-stop-title="label"
          >
          ...
          ${this.ceButtons.map((t=>i` <hax-context-item
              action
              icon="${t.icon}"
              label="${t.label}"
              event-name="hax-ce-custom-button"
              value="${t.callback}"
              ?disabled="${t.disabled||this.disableItemOps}"
            ></hax-context-item>`))}
    ...
    `}get disableTransform(){return!this.filteredBlocks||this.filteredBlocks.length<1}get filteredBlocks(){return this.getFilteredBlocks(this.formatBlocks)}__updatePlatePosition(t){let e=this.shadowRoot.querySelector("#right"),i=this.shadowRoot.querySelector("#rightremove");e.disabled=!1,i.disabled=!1,t&&"GRID-PLATE"==t.tagName?"1-1-1-1-1-1"==t.layout&&(e.disabled=!0):i.disabled=!0}__dblClickFire(t){"remove"===t.target.id&&this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,cancelable:!0,composed:!0,detail:{target:t.target,eventName:"hax-plate-delete",value:t.target.value}}))}_handleOpen(t){this.dispatchEvent(new CustomEvent("hax-transform-node",{bubbles:!0,cancelable:!0,composed:!0,detail:o.elementList[el]}))}handleCECustomEvent(t){let e=t.detail;switch(e.eventName){case"hax-ce-custom-button":this.activeNode&&"function"==typeof this.activeNode[e.value]&&this.activeNode[e.value](t)&&o.refreshActiveNodeForm()}}updated(t){super.updated&&super.updated(t),t.forEach(((t,e)=>{"onScreen"===e&&this.onScreen&&this._resetCEMenu(),"activeNode"!==e&&"activeEditingElement"!==e||(this.activeSchema=o.activeSchema(),this.editElementProperty=!(!this.activeSchema||!this.activeSchema.editElement)&&this.activeSchema.editElement,this.editElementToggled=this.activeNode&&this.editElementProperty&&!!this.activeNode[this.editElementProperty])}))}firstUpdated(t){super.firstUpdated(t),l((()=>{this.activeNode=s(o.activeNode),this.activeNode&&this.activeNode.classList&&this._resetCEMenu(),this.activeNode&&this.getAttribute("on-screen")&&this.__updatePlatePosition(this.activeNode)})),l((()=>{s(o.activeEditingElement)?this.hasActiveEditingElement=!0:this.hasActiveEditingElement=!1})),this.shadowRoot.querySelector("#drag").addEventListener("dragstart",this._dragStart),this.shadowRoot.querySelector("#drag").addEventListener("dragend",this._dragEnd)}_dragEnd(t){let e=r(t)?r(t)[0]:void 0;e&&e.close(!0),o._lockContextPosition=!1}_dragStart(t){let e=s(o.activeNode),i=r(t)?r(t)[0]:void 0;i&&i.close(!0),o.__dragTarget=e,o._lockContextPosition=!0,o.activeHaxBody.__activeHover=null,o.activeHaxBody._hideContextMenu(o.activeHaxBody.contextMenus.add),t.dataTransfer&&(t.dataTransfer.effectAllowed="move",t.dataTransfer.dropEffect="move",t.dataTransfer.setDragImage(e,-20,-20)),t.stopPropagation(),t.stopImmediatePropagation()}async _resetCEMenu(){if(this.shadowRoot&&a(this,"*"),this.ceButtons=[],o.activeHaxBody&&null!=this.activeNode){let t=o.haxSchemaFromTag(this.activeNode.tagName);if(this.sourceView=t.canEditSource,this.activeNode){let t=await o.activeHaxBody.replaceElementWorkflow(this.activeNode,!0)||[],e=this.activeNode&&this.activeNode.tagName?this.activeNode.tagName.toLowerCase():void 0,i=o.activeHaxBody.primitiveTextBlocks.includes(e)?"p":void 0;this.formatBlocks=e?t.filter((t=>t.tag&&![e,i].includes(t.tag))):t}o.activeGizmo&&(this.activeTagName=o.activeGizmo.title,this.activeTagIcon=o.activeGizmo.icon)}else o.activeGizmo?(this.activeTagName=o.activeGizmo.title,this.activeTagIcon=o.activeGizmo.icon):(this.activeTagName="",this.activeTagIcon="");await o.runHook(this.activeNode,"inlineContextMenu",[this])}static get properties(){return{...super.properties,activeTagIcon:{type:String},activeSchema:{type:Object},editElementProperty:{type:String},editElementToggled:{type:Boolean},activeTagName:{type:String},disableOps:{type:Boolean},disableItemOps:{type:Boolean},insertAbove:{type:Boolean},disableDuplicate:{type:Boolean},canMoveElement:{type:Boolean},ceButtons:{type:Array},formatBlocks:{type:Object},hasActiveEditingElement:{type:Boolean},onScreen:{type:Boolean,attribute:"on-screen",reflect:!0},sourceView:{type:Boolean},trayDetail:{type:String,reflect:!0,attribute:"tray-detail"},trayStatus:{type:String,reflect:!0,attribute:"tray-status"}}}}window.customElements.define(HaxPlateContext.tag,HaxPlateContext);export{HaxPlateContext};