import{LitElement as t,css as e,html as o}from"../../../lit/index.js";import"./hax-toolbar.js";import"../../simple-toolbar/lib/simple-toolbar-menu-item.js";import{HAXStore as i}from"./hax-store.js";import"./hax-toolbar-menu.js";import"./hax-toolbar.js";import"./hax-context-item.js";import{wipeSlot as a}from"../../utils/utils.js";import{autorun as l,toJS as s}from"../../../mobx/dist/mobx.esm.js";import{HaxContextBehaviors as n}from"./hax-context-behaviors.js";import{normalizeEventPath as r}from"../../utils/utils.js";import{I18NMixin as d}from"../../i18n-manager/lib/I18NMixin.js";import{SimpleToast as c}from"../../simple-toast/simple-toast.js";class HaxPlateContext extends(d(n(t))){constructor(){super(),this.disableOps=!1,this.disableItemOps=!1,this.insertAbove=!0,this.disableDuplicate=!1,this.hasActiveEditingElement=!1,this.haxUIElement=!0,this.tourName="hax",this.trayDetail="content-edit",this.trayStatus="collapsed",this.t={edit:"Edit",dragHandle:"Drag handle",moveUp:"Move up",moveDown:"Move down",addColumn:"Add column",removeColumn:"Remove column",remove:"Remove",duplicate:"Duplicate",confirmDelete:"Confirm delete",changeTo:"Change to",modifyHTMLSource:"Modify HTML source",clickToChange:"Click to change",regions:"Available regions",insertItemAbove:"Insert item above",insertItemAboveOrBelow:"Insert item above or below",insertItemBelow:"Insert item below",selectLayout:"Select Layout Element"},this.registerLocalization({context:this,namespace:"hax"}),this.ceButtons=[],this.activeTagName="",this.activeTagIcon="hax:paragraph",this.addEventListener("hax-context-item-selected",this.handleCECustomEvent.bind(this))}static get tag(){return"hax-plate-context"}static get styles(){return[...super.styles,e`
      ...
      <hax-toolbar>
        <div class="group">
          ...
          >
            ...
            ${this.activeNode&&this.activeNode.parentNode&&i.isLayoutElement(this.activeNode.parentNode)?(this.slottedItems||[]).map(((t,e)=>o`
                        <simple-toolbar-menu-item
                          slot="menuitem"
          ...
          >
            ...
            ${(this.slottedItems||[]).map(((t,e)=>(t.items||[]).map(((i,a)=>o`
                    <simple-toolbar-menu-item
                      slot="menuitem"
                    ...
                    >
                      <hax-context-item
                        ...
                        .eventData="${{target:i,grid:t.grid,slot:t.slot,index:a,editMode:t.editMode}}"
                        role="menuitem"
                        show-text-label
          ...
          >
            ...
            ${i.isLayoutElement(this.activeNode)?(this.slottedItems||[]).map(((t,e)=>o`
                        <simple-toolbar-menu-item
                          slot="menuitem"
      ...
      >
          ...
          <hax-context-item
            ...
            ?hidden="${!this.activeNode||i.isOriginalGridPlate(this.activeNode)}"
            id="rightremove"
            data-simple-tour-stop
            data-stop-title="label"
          >
