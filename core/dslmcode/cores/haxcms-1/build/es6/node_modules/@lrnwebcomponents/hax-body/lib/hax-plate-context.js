import{LitElement as t,css as e,html as a}from"../../../lit/index.js";import"./hax-toolbar.js";import"../../simple-toolbar/lib/simple-toolbar-menu-item.js";import{HAXStore as i}from"./hax-store.js";import"./hax-toolbar-menu.js";import"./hax-context-item.js";import{autorun as o,toJS as l}from"../../../mobx/dist/mobx.esm.js";import{HaxContextBehaviors as n}from"./hax-context-behaviors.js";import{normalizeEventPath as s}from"../../utils/utils.js";import{I18NMixin as d}from"../../i18n-manager/lib/I18NMixin.js";class HaxPlateContext extends(d(n(t))){constructor(){super(),this.hasActiveEditingElement=!1,this.haxUIElement=!0,this.tourName="hax",this.trayDetail="content-edit",this.trayStatus="collapsed",this.t={edit:"Edit",dragHandle:"Drag handle",moveUp:"Move up",moveDown:"Move down",addColumn:"Add column",removeColumn:"Remove column",remove:"Remove",duplicate:"Duplicate",confirmDelete:"Confirm delete"},this.registerLocalization({context:this,namespace:"hax"})}static get tag(){return"hax-plate-context"}static get styles(){return[...super.styles,e`
        :host {
          width: 200px;
        }
        hax-toolbar {
    ...
    `}__updatePlatePosition(t){let e=this.shadowRoot.querySelector("#right"),a=this.shadowRoot.querySelector("#rightremove");e.disabled=!1,a.disabled=!1,t&&"GRID-PLATE"==t.tagName?"1-1-1-1-1-1"==t.layout&&(e.disabled=!0):a.disabled=!0}__dblClickFire(t){"remove"===t.target.id&&this.dispatchEvent(new CustomEvent("hax-context-item-selected",{bubbles:!0,cancelable:!0,composed:!0,detail:{target:t.target,eventName:"hax-plate-delete",value:t.target.value}}))}firstUpdated(t){super.firstUpdated(t),o((()=>{const t=l(i.activeNode);t&&this.getAttribute("on-screen")&&this.__updatePlatePosition(t)})),o((()=>{l(i.activeEditingElement)?this.hasActiveEditingElement=!0:this.hasActiveEditingElement=!1})),this.shadowRoot.querySelector("#drag").addEventListener("dragstart",this._dragStart),this.shadowRoot.querySelector("#drag").addEventListener("dragend",this._dragEnd)}_dragEnd(t){let e=s(t)?s(t)[0]:void 0;e&&e.close(!0),i._lockContextPosition=!1}_dragStart(t){let e=l(i.activeNode),a=s(t)?s(t)[0]:void 0;a&&a.close(!0),i.__dragTarget=e,i._lockContextPosition=!0,i.activeHaxBody.__activeHover=null,i.activeHaxBody._hideContextMenu(i.activeHaxBody.contextMenus.add),t.dataTransfer&&(t.dataTransfer.effectAllowed="move",t.dataTransfer.dropEffect="move",t.dataTransfer.setDragImage(e,-20,-20)),t.stopPropagation(),t.stopImmediatePropagation()}static get properties(){return{...super.properties,hasActiveEditingElement:{type:Boolean},trayDetail:{type:String,reflect:!0,attribute:"tray-detail"},trayStatus:{type:String,reflect:!0,attribute:"tray-status"}}}}window.customElements.define(HaxPlateContext.tag,HaxPlateContext);export{HaxPlateContext};