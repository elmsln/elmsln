          ...
          >
            <simple-toolbar-menu-item slot="menuitem">
              <hax-context-item
                ...
                .eventData="${this.isGridLayoutSlot?this.activeNode.parentNode:void 0}"
                role="menuitem"
                show-text-label
              >
              </hax-context-item>
            </simple-toolbar-menu-item>
            ${(this.slottedItems||[]).map(((t,e)=>t.items.map(((e,i)=>o`
                    <simple-toolbar-menu-item slot="menuitem">
                      <hax-context-item
                        action
                        align-horizontal="left"
                        ?disabled="${this.viewSource||this.activeNode===e}"
                        label="${t.label}${t.items.length>1?` (${i+1})`:""}"
                        event-name="hax-select-grid-item"
                        .eventData="${e}"
                        role="menuitem"
                        show-text-label
