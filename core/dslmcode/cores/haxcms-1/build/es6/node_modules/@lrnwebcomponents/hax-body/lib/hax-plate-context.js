            ...
            ${(this.siblingSlots||[]).map(((t,e)=>o`
                ...
                >
                  <hax-context-item
                    ...
                    role="menuitem"
                    data-slot="${t}"
                    @click="${e=>this._handleMoveSlot(t)}"
