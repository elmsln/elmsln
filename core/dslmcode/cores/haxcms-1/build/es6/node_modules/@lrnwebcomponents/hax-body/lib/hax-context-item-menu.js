import{LitElement,html,css}from"../../../lit-element/lit-element.js";import"./hax-toolbar-menu.js";import"../../../@polymer/paper-tooltip/paper-tooltip.js";import"../../../@polymer/paper-item/paper-item.js";import"../../../@polymer/neon-animation/neon-animation.js";class HaxContextItemMenu extends LitElement{static get styles(){return[css`
      ...
      `]}constructor(){super(),this._blockEvent=!1,this.resetOnSelect=!1,this.selectedValue=0,this.direction="top",this.icon="editor:text-fields",this.label="editor:text-fields",this.eventName="button"}render(){return html`
      <hax-toolbar-menu
        id="menu"
        .icon="${this.icon}"
        .tooltip="${this.label}"
