import{LitElement as e,html as t,css as i}from"../../../lit-element/lit-element.js";import"./hax-toolbar-menu.js";import"../../simple-tooltip/simple-tooltip.js";class HaxContextItemMenu extends e{static get styles(){return[i`
        :host {
          display: inline-flex;
      ...
      `]}constructor(){super(),this._blockEvent=!1,this.selectedValue=0,this.action=!1,this.direction="top",this.icon="editor:text-fields",this.label=""}render(){return t`
      <hax-toolbar-menu
        id="menu"
        ?mini="${this.mini}"
        ?action="${this.action}"
