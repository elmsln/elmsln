...
import{LitElement as t,html as o,css as e}from"../../../../lit-element/lit-element.js";import{store as i}from"./haxcms-site-store.js";import{varGet as a,varExists as s}from"../../../utils/utils.js";import{autorun as r,toJS as n}from"../../../../mobx/lib/mobx.module.js";import"../../../../@polymer/paper-button/paper-button.js";import"../../../../@polymer/paper-icon-button/paper-icon-button.js";import"../../../simple-tooltip/simple-tooltip.js";import"../../../../@polymer/iron-icons/iron-icons.js";import"../../../../@polymer/iron-icons/notification-icons.js";import"../../../simple-fields/lib/simple-fields-form.js";import"../../../portal-launcher/portal-launcher.js";import{HaxSchematizer as p,HaxElementizer as c}from"../../../hax-body-behaviors/lib/HAXFields.js";class HAXCMSSiteDashboard extends t{static get tag(){return"haxcms-site-dashboard"}constructor(){super(),this.backText="Back to site list",this.backLink="../../",this.manifest={},this.__disposer=[],r(t=>{this.jwt=n(i.jwt),this.__disposer.push(t)}),r(t=>{this.dashboardOpened=n(i.dashboardOpened),this.__disposer.push(t)}),r(t=>{this.manifest=n(i.manifest),this.__disposer.push(t)})}static get styles(){return[e`
    ...
    `}static get properties(){return{backLink:{type:String},backText:{type:String},dashboardOpened:{type:Boolean,reflect:!0,attribute:"dashboard-opened"},method:{type:String},jwt:{type:String},publishing:{type:Boolean},manifest:{type:Object}}}disconnectedCallback(){for(var t in this.__disposer)this.__disposer[t].dispose();super.disconnectedCallback()}updated(t){super.updated&&super.updated(t),t.forEach((t,o)=>{"dashboardOpened"===o&&this.dashboardOpened&&(this.removeAttribute("aria-hidden"),this.removeAttribute("tabindex")),"dashboardOpened"!==o||this.dashboardOpened||(this.setAttribute("aria-hidden","aria-hidden"),this.setAttribute("tabindex","-1"))})}firstUpdated(t){setTimeout(()=>{window.appSettings&&window.appSettings.backText&&(this.backText=window.appSettings.backText),window.appSettings&&window.appSettings.backLink&&(this.backLink=window.appSettings.backLink)},0)}_saveSiteFieldsTap(t){window.dispatchEvent(new CustomEvent("haxcms-save-site-data",{bubbles:!0,composed:!0,cancelable:!0,detail:this.shadowRoot.querySelector("#siteform").submit()}))}_cancel(t){window.dispatchEvent(new CustomEvent("haxcms-load-site-dashboard",{bubbles:!0,composed:!0,cancelable:!1,detail:t.target}))}}window.customElements.define(HAXCMSSiteDashboard.tag,HAXCMSSiteDashboard);export{HAXCMSSiteDashboard};