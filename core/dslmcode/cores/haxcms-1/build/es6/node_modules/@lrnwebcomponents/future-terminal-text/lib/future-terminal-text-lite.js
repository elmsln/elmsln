...
import{LitElement as e,html as t,css as r}from"../../../lit/index.js";import{FutureTerminalTextLiteSuper as a}from"./FutureTerminalTextSuper.js";class FutureTerminalTextLite extends(a(e)){static get styles(){let e=r``;return super.styles&&(e=super.styles),[e,r`
      ...
      `]}updated(e){super.updated&&super.updated(e),e.forEach(((e,t)=>{"glitch"===t&&this[t]&&void 0!==e&&this._doGlitch()}))}render(){return t`<span><slot></slot></span>`}static get properties(){return{...super.properties,glitch:{type:Boolean},red:{type:Boolean,reflect:!0},fadein:{type:Boolean,reflect:!0},glitchMax:{type:Number,attribute:"glitch-max"},glitchDuration:{type:Number,attribute:"glitch-duration"}}}static get tag(){return"future-terminal-text-lite"}}customElements.define(FutureTerminalTextLite.tag,FutureTerminalTextLite);export{FutureTerminalTextLite};