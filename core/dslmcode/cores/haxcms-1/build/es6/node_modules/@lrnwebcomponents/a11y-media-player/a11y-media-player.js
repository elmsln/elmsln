          ...
          <div id="player" .style="${this.playerStyle}">
            ...
            ${0!==Object.keys(this.captionCues||[]).length&&this.showCustomCaptions?html`
                  <div id="cc-custom" aria-live="polite" class="screen-only">
                    <div id="cc-text">
                      ${this.captionCues?Object.keys(this.captionCues).map(key=>html`
