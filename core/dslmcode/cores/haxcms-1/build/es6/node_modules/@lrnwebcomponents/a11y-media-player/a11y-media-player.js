 ...
 */
import{LitElement as t,html as e,css as i}from"../../lit-element/lit-element.js";import{SimpleColors as s}from"../simple-colors/simple-colors.js";import"../responsive-utility/responsive-utility.js";import"../anchor-behaviors/anchor-behaviors.js";import("./lib/a11y-media-state-manager.js"),import("./lib/a11y-media-button.js"),import("./lib/a11y-media-transcript-cue.js"),import("./lib/a11y-media-youtube.js");import"../es-global-bridge/es-global-bridge.js";class A11yMediaPlayer extends s{static get styles(){return[...super.styles,i`
        :host {
          display: block;
          width: calc(100% - 2px);
        ...
        >
          <div id="player" .style="${this.playerStyle}">
            <a11y-media-play-button
              ...
              @button-click="${t=>this.togglePlay()}"
            ...
            ${0!==Object.keys(this.captionCues||[]).length&&this.showCustomCaptions?e`
                  <div id="cc-custom" aria-live="polite" class="screen-only">
                    <div id="cc-text">
                      ${this.captionCues?Object.keys(this.captionCues).map(t=>e`
                                ${this.captionCues[t].text?this.captionCues[t].text:""}
                              `):""}
                    </div>
                  </div>
                `:e``}
          ...
          >
            <div class="setting" ?hidden="${!this.hasCaptions}">
              ...
              <dropdown-select
                ...
                ?hidden="${!this.hasCaptions}"
                ?disabled="${!this.hasCaptions}"
                @value-changed="${t=>this.selectCaptionByKey(t.detail.value)}}"
              >
                <paper-item
                  value="-1"
                ...
                >
                ${this.loadedTracks?Object.keys(this.loadedTracks.textTracks).map(t=>e`
                        <paper-item
                          value="${t}"
                          aria-selected="${this.captionsTrackKey===t}"
                        >
                          ${this.loadedTracks.textTracks[t].label||this.loadedTracks.textTracks.language}
                        </paper-item>
                      `):""}
              </dropdown-select>
            </div>
            <div class="setting" ?hidden="${!this.hasCaptions}">
              ...
              <dropdown-select
                ...
                ?hidden="${!this.hasCaptions}"
                ?disabled="${!this.hasCaptions}"
                @value-changed="${t=>this.selectTranscriptByKey(t.detail.value)}"
              >
                <paper-item
                  value="-1"
                ...
                ${this.loadedTracks?Object.keys(this.loadedTracks.textTracks).map(t=>e`
                        <paper-item
                          value="${t}"
                          aria-selected="${this.transcriptTrackKey===t}"
                        >
                          ${this.loadedTracks.textTracks[t].label||this.loadedTracks.textTracks.language}
                        </paper-item>
                      `):""}
