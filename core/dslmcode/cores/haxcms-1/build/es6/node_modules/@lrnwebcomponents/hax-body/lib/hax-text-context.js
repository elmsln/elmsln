      ...
      <hax-toolbar id="toolbar">
        ...
        >
          ...
          ${this.formattingList.map(e=>t` <button slot="options" value="${e.value}">
                <simple-icon-lite icon="${e.icon}"></simple-icon-lite>
                ${e.text}
              </button>`)}
        </simple-popover-selection>
        <hax-context-item
