import{LitElement as e,html as t,css as r}from"../../../lit/index.js";import{HAXStore as i}from"./hax-store.js";import{haxElementToNode as a}from"../../utils/utils.js";import{IntersectionObserverMixin as s}from"../../intersection-element/lib/IntersectionObserverMixin.js";export class HaxElementDemo extends(s(e)){static get tag(){return"hax-element-demo"}constructor(){super(),this.renderTag=null,this.activeSchema=-1}static get properties(){return{...super.properties,renderTag:{type:String,attribute:"render-tag"},activePickerSchema:{type:Number,attribute:"active-picker-schema"}}}static get styles(){return[r`
        :host {
          display: block;
          overflow: hidden;
          height: 150px;
