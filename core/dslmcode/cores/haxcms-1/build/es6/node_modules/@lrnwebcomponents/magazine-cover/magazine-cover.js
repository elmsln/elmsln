import{LitElement,html,css}from"../../lit-element/lit-element.js";class MagazineCover extends LitElement{static get styles(){return[css`
        :host {
          display: block;
      ...
      `]}constructor(){super(),this.action="Touch to learn more",this.icon="trending-flat",this.link="",this.eventName="",this.eventData={},import("../../@polymer/iron-image/iron-image.js"),import("../../@polymer/iron-icons/iron-icons.js"),import("../../@polymer/iron-icon/iron-icon.js"),import("../../@polymer/paper-button/paper-button.js")}render(){return html`
      <iron-image
        src="${this.image}"
        preload=""
        fade=""
