import{LitElement as e,html as r,css as s}from"../../../lit-element/lit-element.js";import"../../responsive-utility/responsive-utility.js";import"./responsive-grid-col.js";import"./responsive-grid-clear.js";class ResponsiveGridRow extends e{static get styles(){return[s`
        :host {
          display: block;
          width: 100%;
          margin-right: auto;
    ...
    `}static get tag(){return"responsive-grid-row"}constructor(){super(),this.xl=null,this.lg=null,this.md=null,this.sm=null,this.xs=null,this.gutter=0,this.responsiveToParent=!1,this.screen="xs",window.ResponsiveUtility.requestAvailability()}firstUpdated(){this.dispatchEvent(new CustomEvent("responsive-element",{bubbles:!0,cancelable:!0,composed:!0,detail:{element:this,attribute:"screen",relativeToParent:this.responsiveToParent}}))}updated(e){e.forEach((e,r)=>{"screen"==r&&this.dispatchEvent(new CustomEvent("screen-changed",{detail:{value:this[r]}}))})}static get properties(){return{xs:{type:Number},sm:{type:Number},md:{type:Number},lg:{type:Number},xl:{type:Number},gutter:{type:Number},responsiveToParent:{type:Boolean,reflect:!0,attribute:"responsive-to-parent"},screen:{type:String,reflect:!0}}}}window.customElements.define(ResponsiveGridRow.tag,ResponsiveGridRow);export{ResponsiveGridRow};