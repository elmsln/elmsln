import{css as e,html as s}from"../../../lit-element/lit-element.js";import{normalizeEventPath as t}from"../../utils/utils.js";const BootstrapUserStylesMenuMixin=function(o){return class extends o{constructor(){super(),this.hideUserStylesMenu=!0,this.fontSize=1,this.fontFamily=0,this.colorTheme="0";let e=this.getBasePath(decodeURIComponent(import.meta.url));this._bootstrapPath=e+"bootstrap/dist/css/bootstrap.min.css",this.addEventListener("click",this.checkUserStylesMenuOpen.bind(this))}static get styles(){let s=[];return super.styles&&(s=super.styles),[...s,e`
          /* bootstrap defaults */
          :host([font-family="0"]) {
        ...
        `]}BootstrapUserStylesMenu(){return import("../../simple-icon/simple-icon.js"),import("../../simple-icon/lib/simple-icons.js"),import("../../simple-icon/lib/simple-icon-button-lite.js"),import("../../simple-popover/simple-popover.js"),import("../../simple-tooltip/simple-tooltip.js"),s`
