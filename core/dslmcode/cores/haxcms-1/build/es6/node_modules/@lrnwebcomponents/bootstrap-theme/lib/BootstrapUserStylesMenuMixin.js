import{css as e,html as s}from"../../../lit/index.js";import{normalizeEventPath as t}from"../../utils/utils.js";const BootstrapUserStylesMenuMixin=function(o){return class extends o{constructor(){super(),this.hideUserStylesMenu=!0,this.fontSize=1,this.fontFamily=0,this.colorTheme="0";let e=this.getBasePath(decodeURIComponent(import.meta.url));this._bootstrapPath=e+"bootstrap/dist/css/bootstrap.min.css",this.addEventListener("click",this.checkUserStylesMenuOpen.bind(this))}static get styles(){let s=[];return super.styles&&(s=super.styles),[...s,e`
          /* bootstrap defaults */
          :host([font-family="0"]) {
