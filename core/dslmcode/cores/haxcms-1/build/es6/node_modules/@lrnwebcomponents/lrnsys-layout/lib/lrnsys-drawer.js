import{html as t,css as e}from"../../../lit-element/lit-element.js";import{SimpleColors as s}from"../../simple-colors/simple-colors.js";import"../../simple-drawer/simple-drawer.js";import"./lrnsys-button-inner.js";import"../../simple-icon/simple-icon.js";import"../../simple-icon/lib/simple-icons.js";class LrnsysDrawer extends s{static get styles(){return[...super.styles,e`
        :host {
          display: block;
      ...
      `]}constructor(){super(),this.opened=!1,this.align="left",this.disabled=!1,this.focusState=!1,this.avatar="",this.icon="",this.text="",setTimeout(()=>{import("../../simple-tooltip/simple-tooltip.js")},0),this.__modal=window.SimpleDrawer.requestAvailability()}render(){return t`
      <button
        class="${this.class}"
        id="flyouttrigger"
