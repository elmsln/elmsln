import{html as t,css as e}from"../../../lit-element/lit-element.js";import{SimpleColors as s}from"../../simple-colors/simple-colors.js";import"../../simple-drawer/simple-drawer.js";import"./lrnsys-button-inner.js";class LrnsysDrawer extends s{static get styles(){return[...super.styles,e`
        :host {
          display: block;
      ...
      `]}constructor(){super(),this.opened=!1,this.align="left",this.disabled=!1,this.focusState=!1,this.avatar="",this.icon="",this.text="",setTimeout(()=>{import("../../simple-tooltip/simple-tooltip.js"),import("../../../@polymer/paper-button/paper-button.js"),import("../../../@polymer/iron-icons/iron-icons.js")},0),this.__modal=window.SimpleDrawer.requestAvailability()}render(){return t`
      <paper-button
        class="${this.class}"
        id="flyouttrigger"
