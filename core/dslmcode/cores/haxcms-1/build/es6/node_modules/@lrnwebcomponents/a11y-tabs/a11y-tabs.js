 ...
 */
import{LitElement as t,html as a,css as e}from"../../lit-element/lit-element.js";import{ResponsiveUtilityBehaviors as o}from"../responsive-utility/lib/responsive-utility-behaviors.js";import"../simple-icon/simple-icon.js";import"../simple-icon/lib/simple-icons.js";import"../simple-tooltip/simple-tooltip.js";import"./lib/a11y-tab.js";class A11yTabs extends(o(t)){static get styles(){return[e`
        :host {
          display: block;
      ...
      ${this._tabTooltip(t)}
    `}_tabFlag(t){return a`
      <span class="flag-type" ?hidden="${!t.flag}"> ${t.flag} </span>
    `}_tabIcon(t,e){return t.flag?a`
        ...
        `}_tabLabel(t){return a` <span class="label">${t.label}</span> `}_tabTooltip(t){return a`
      <simple-tooltip for="${t.id}-button"> ${t.label} </simple-tooltip>
