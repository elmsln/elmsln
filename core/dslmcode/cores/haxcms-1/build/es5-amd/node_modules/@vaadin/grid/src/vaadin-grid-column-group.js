define(["exports", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../@polymer/polymer/polymer-element.js", "../../component-base/src/async.js", "./vaadin-grid-column.js", "./vaadin-grid-helpers.js"], function (_exports, _flattenedNodesObserver, _polymerElement, _async, _vaadinGridColumn, _vaadinGridHelpers) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.GridColumnGroup = void 0;
   ...
   */
  var GridColumnGroup = /*#__PURE__*/function (_ColumnBaseMixin) {
    babelHelpers.inherits(GridColumnGroup, _ColumnBaseMixin);

    var _super = _createSuper(GridColumnGroup);

    function GridColumnGroup() {
      babelHelpers.classCallCheck(this, GridColumnGroup);
      return _super.apply(this, arguments);
    }

    babelHelpers.createClass(GridColumnGroup, [{
      key: "connectedCallback",
      value:
      /** @protected */
      function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(GridColumnGroup.prototype), "connectedCallback", this).call(this);
      ...
      value: function disconnectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(GridColumnGroup.prototype), "disconnectedCallback", this).call(this);
      ...
      value: function _groupOrderChanged(order, rootColumns) {
        if (rootColumns) {
          ...
          (0, _vaadinGridHelpers.updateColumnOrders)(_rootColumns, scope, order);
        }
      }
      /** @private */
  ...
  _exports.GridColumnGroup = GridColumnGroup;
