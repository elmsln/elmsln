...
if(anchor.hasAttribute("download")){return}// ignore the click if the <a> element has the 'router-ignore' attribute
if(anchor.hasAttribute("router-ignore")){return}// ignore the click if the target URL is a fragment on the current page
...
var _anchor=anchor,pathname=_anchor.pathname,search=_anchor.search,hash=_anchor.hash;if((0,_utils.fireRouterEvent)("go",{pathname:pathname,search:search,hash:hash})){event.preventDefault()}}/**
