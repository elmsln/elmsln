define(["exports", "../../../@polymer/polymer/lib/mixins/gesture-event-listeners.js", "../../../@polymer/polymer/lib/utils/gestures.js", "./vaadin-grid-helpers.js"], function (_exports, _gestureEventListeners, _gestures, _vaadinGridHelpers) {
  "use strict";
    ...
    return /*#__PURE__*/function (_GestureEventListener) {
      ...
      babelHelpers.createClass(ColumnReorderingMixin, [{
        ...
        value: function _cellFromPoint(x, y) {
          ...
          this.$.scroller.toggleAttribute('no-content-pointer-events', false); // Make sure the element is actually a cell
        ...
        value: function _updateOrders(columnTree, splices) {
          ...
          columnTree[0].forEach(function (column) {
            return column._order = 0;
          }); // Set order numbers to top-level columns

          (0, _vaadinGridHelpers.updateColumnOrders)(columnTree[0], this._orderBaseScope, 0);
        }
        /**
        ...
        value: function _setSiblingsReorderStatus(column, status) {
          ...
          Array.from(column.parentNode.children).filter(function (child) {
            return /column/.test(child.localName) && _this2._isSwapAllowed(child, column);
