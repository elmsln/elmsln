define(["exports","./path-to-regexp.js","./matchRoute.js","./resolveRoute.js","../utils.js"],function(_exports,_pathToRegexp,_matchRoute,_resolveRoute,_utils){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.default=void 0;_pathToRegexp=babelHelpers.interopRequireDefault(_pathToRegexp);_matchRoute=babelHelpers.interopRequireDefault(_matchRoute);_resolveRoute=babelHelpers.interopRequireDefault(_resolveRoute);/**
 ...
 */var Resolver=/*#__PURE__*/function(){function Resolver(routes){var options=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};babelHelpers.classCallCheck(this,Resolver);if(Object(routes)!==routes){throw new TypeError("Invalid routes")}this.baseUrl=options.baseUrl||"";this.errorHandler=options.errorHandler;this.resolveRoute=options.resolveRoute||_resolveRoute.default;this.context=Object.assign({resolver:this},options.context);this.root=Array.isArray(routes)?{path:"",__children:routes,parent:null,__synthetic:!0}:routes;this.root.parent=null}/**
   ...
   */},{key:"setRoutes",value:function setRoutes(routes){(0,_utils.ensureRoutes)(routes);var newRoutes=babelHelpers.toConsumableArray((0,_utils.toArray)(routes));this.root.__children=newRoutes}/**
   ...
   * @return {!Array<!Router.Route>}
   * @protected
   */},{key:"addRoutes",value:function addRoutes(routes){var _this$root$__children;(0,_utils.ensureRoutes)(routes);(_this$root$__children=this.root.__children).push.apply(_this$root$__children,babelHelpers.toConsumableArray((0,_utils.toArray)(routes)));return this.getRoutes()}/**
   ...
   * @return {!Promise<any>}
   */},{key:"resolve",value:function resolve(pathnameOrContext){var _this=this,context=Object.assign({},this.context,(0,_utils.isString)(pathnameOrContext)?{pathname:pathnameOrContext}:pathnameOrContext),match=(0,_matchRoute.default)(this.root,this.__normalizePathname(context.pathname),this.baseUrl),resolve=this.resolveRoute,matches=null,nextMatches=null,currentContext=context;function next(resume){var parent=1<arguments.length&&arguments[1]!==void 0?arguments[1]:matches.value.route,prevResult=2<arguments.length?arguments[2]:void 0,routeToSkip=null===prevResult&&matches.value.route;matches=nextMatches||match.next(routeToSkip);nextMatches=null;if(!resume){if(matches.done||!isChildRoute(parent,matches.value.route)){nextMatches=matches;return Promise.resolve(_utils.notFoundResult)}}if(matches.done){return Promise.reject((0,_utils.getNotFoundError)(context))}currentContext=Object.assign(currentContext?{chain:currentContext.chain?currentContext.chain.slice(0):[]}:{},context,matches.value);updateChainForRoute(currentContext,matches.value);return Promise.resolve(resolve(currentContext)).then(function(resolution){if(null!==resolution&&resolution!==void 0&&resolution!==_utils.notFoundResult){currentContext.result=resolution.result||resolution;return currentContext}return next(resume,parent,resolution)})}context.next=next;return Promise.resolve().then(function(){return next(!0,_this.root)}).catch(function(error){var errorMessage=generateErrorMessage(currentContext);if(!error){error=new Error(errorMessage)}else{console.warn(errorMessage)}error.context=error.context||currentContext;// DOMException has its own code which is read-only
...
return pathname}var base=this.__effectiveBaseUrl,normalizedUrl=this.constructor.__createUrl(pathname,base).href;if(normalizedUrl.slice(0,base.length)===base){return normalizedUrl.slice(base.length)}}},{key:"__effectiveBaseUrl",/**
   ...
   */get:function get(){return this.baseUrl?this.constructor.__createUrl(this.baseUrl,document.baseURI||document.URL).href.replace(/[^\/]*$/,""):""}}],[{key:"__createUrl",value:function __createUrl(url,base){return new URL(url,base)}}]);return Resolver}();Resolver.pathToRegexp=_pathToRegexp.default;var _default=Resolver;_exports.default=_default});