      ...
      babelHelpers.createClass(DragAndDropMixin, [{
        ...
        value: function _onDragStart(e) {
          ...
          if (this.rowsDraggable) {
            ...
            this.style.setProperty('--_grid-drag-start-x', "".concat(e.clientX - rowRect.left + 20, "px"));
            this.style.setProperty('--_grid-drag-start-y', "".concat(e.clientY - rowRect.top + 10, "px"));
            requestAnimationFrame(function () {
        ...
        value: function _dragDropAccessChanged() {
        ...
        value: function _filterDragAndDrop(row, model) {
          ...
          var draggableElements = Array.from(row.children).map(function (cell) {
