define(["exports", "./async.js", "./debounce.js"], function (_exports, _async, _debounce2) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.ironList = void 0;
  ...
  var ironList = {
    ...
    _positionItems: function _positionItems() {
      ...
      if (this.grid) {
        ...
        var order = []; // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    scrollToIndex: function scrollToIndex(idx) {
      ...
      (0, _debounce2.flush)(); // Items should have been rendered prior scrolling to an index.
