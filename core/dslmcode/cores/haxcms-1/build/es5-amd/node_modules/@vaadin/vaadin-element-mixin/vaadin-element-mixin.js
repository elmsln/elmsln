define(["exports", "../../@polymer/polymer/lib/utils/async.js", "../../@polymer/polymer/lib/utils/debounce.js", "../../@polymer/polymer/lib/utils/flush.js", "./node_modules/@vaadin/vaadin-usage-statistics/vaadin-usage-statistics.js"], function (_exports, _async, _debounce, _flush, _vaadinUsageStatistics) {
  "use strict";
    ...
    return (
      ...
      function (_superClass) {
        ...
        function VaadinElementMixin() {
          ...
          return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(VaadinElementMixin).apply(this, arguments));
        }

        babelHelpers.createClass(VaadinElementMixin, [{
          key: "ready",
          value: function ready() {
            babelHelpers.get(babelHelpers.getPrototypeOf(VaadinElementMixin.prototype), "ready", this).call(this);
          ...
          value: function _finalizeClass() {
            babelHelpers.get(babelHelpers.getPrototypeOf(VaadinElementMixin), "_finalizeClass", this).call(this); // Registers a class prototype for telemetry purposes.
