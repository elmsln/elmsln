define(["exports", "../../../@polymer/polymer/polymer-legacy.js", "../../../@polymer/polymer/lib/utils/async.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "./vaadin-grid-column.js", "./vaadin-grid-helpers.js", "../../../@polymer/polymer/polymer-element.js"], function (_exports, _polymerLegacy, _async, _flattenedNodesObserver, _vaadinGridColumn, _vaadinGridHelpers, _polymerElement) {
  "use strict";
    ...
    babelHelpers.createClass(GridColumnGroupElement, [{
      ...
      value: function _groupOrderChanged(order, rootColumns) {
        if (rootColumns) {
          ...
          var childCountDigits = ~~(Math.log(rootColumns.length) / Math.LN10) + 1; // Final scope for the child columns needs to mind both factors.
          ...
          _vaadinGridHelpers.GridHelper._updateColumnOrders(_rootColumns, scope, order);
        }
      }
      /** @private */
      ...
      value: function _groupHiddenChanged(hidden) {
      ...
      key: "_updateAutoHidden",
      value: function _updateAutoHidden() {
        var wasAutoHidden = this._autoHidden;
        this._autoHidden = (this._visibleChildColumns || []).length === 0; // Only modify hidden state if group was auto-hidden, or becomes auto-hidden
      ...
      value: function _addNodeObserver() {
        ...
        this._observer = new _flattenedNodesObserver.FlattenedNodesObserver(this, function (info) {
          if (info.addedNodes.filter(_this2._isColumnElement).length > 0 || info.removedNodes.filter(_this2._isColumnElement).length > 0) {
            ...
            // we don't want the other columns to become visible as well.
            _this2._preventHiddenSynchronization = true;
            _this2._rootColumns = _this2._getChildColumns(_this2);
            _this2._childColumns = _this2._rootColumns;

            _this2._updateVisibleChildColumns(_this2._childColumns);

            _this2._preventHiddenSynchronization = false; // Update the column tree with microtask timing to avoid shady style scope issues

            _async.microTask.run(function () {
              _this2._grid && _this2._grid._updateColumnTree && _this2._grid._updateColumnTree();
            });
          }
        });
      ...
      key: "observers",
      get: function get() {
        return ['_groupFrozenChanged(frozen, _rootColumns)', '_groupHiddenChanged(hidden)', '_colSpanChanged(_colSpan, _headerCell, _footerCell)', '_groupOrderChanged(_order, _rootColumns)', '_groupReorderStatusChanged(_reorderStatus, _rootColumns)', '_groupResizableChanged(resizable, _rootColumns)'];
      }
    }]);
