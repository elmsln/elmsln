  ...
  var FilterMixin = function FilterMixin(superClass) {
    return /*#__PURE__*/function (_superClass) {
      ...
      babelHelpers.createClass(FilterMixin, [{
        ...
        key: "__removeFilters",
        value: function __removeFilters(filtersToRemove) {
        ...
        key: "__addFilter",
        value: function __addFilter(filter) {
          var filterIndex = this._filters.indexOf(filter);
