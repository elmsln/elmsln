!function (e, t) {
  ...
  function x(e) {
    if (!e.defaultPrevented && 0 === e.button && !(e.shiftKey || e.ctrlKey || e.altKey || e.metaKey)) {
      ...
      if (t && "a" === t.nodeName.toLowerCase()) if (!t.target || "_self" === t.target.toLowerCase()) if (!t.hasAttribute("download")) if (t.pathname !== window.location.pathname || "" === t.hash) if ((t.origin || function (e) {
        var t = e.port,
            n = e.protocol,
    ...
    return o(e, [{
      ...
      value: function value(e) {
        ...
        function u(e) {
          ...
          }(n, a.value), c = Object.assign({}, n, a.value), Promise.resolve(o(c)).then(function (n) {
      ...
      value: function value(e) {
        ...
        return this.__findComponentContextAfterAllRedirects(n).then(function (r) {
          ...
          return r.next().then(function (e) {
            if ((null === e || e === C) && fe(de(r.chain), r.resolver) !== r.pathname) throw k(o);
            return e && e !== C ? t.__fullyResolveChain(o, e) : t.__amendWithOnBeforeCallbacks(r);
          });
        });
      }
    }, {
