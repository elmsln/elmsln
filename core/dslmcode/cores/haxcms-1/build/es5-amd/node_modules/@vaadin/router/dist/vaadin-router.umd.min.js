  ...
  var pe = function (e) {
    ...
    return function (e, t) {
        ...
        return this.__findComponentContextAfterAllRedirects(n).then(function (r) {
          ...
          return function e(t) {
            ...
            return t.next(void 0, n, r).then(function (r) {
              return null === r || r === C ? a ? t : null !== n.parent ? e(t, n.parent, r) : r : r;
            });
          }(r).then(function (e) {
      ...
      value: function value(e) {
        ...
        if (!e.__skipAttach) for (var f = 0; f < o.length; f++) {
          f < e.__divergedChainIndex ? f < r.length && r[f].element && (r[f].element.location = ce(e, r[f].route)) : (a = this.__runOnBeforeEnterCallbacks(a, e, {
            prevent: i,
            redirect: c
          }, o[f]), o[f].element && (o[f].element.location = ce(e, o[f].route)));
        }
