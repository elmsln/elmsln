...
this.$.items.style.transform=this._getTranslate(-this._scrollLeft||0,-this._scrollTop||0);this.$.footer.style.transform=this.$.header.style.transform=this._getTranslate(-this._scrollLeft||0,0)}else{this.$.footer.style.transform=this.$.header.style.transform=this._getTranslate(0,this._scrollTop)}for(var frozenCellTransform=this._getTranslate(this._scrollLeft,0),i=0;i<this._frozenCells.length;i++){this._frozenCells[i].style.transform=frozenCellTransform}}},{key:"_getTranslate",value:function _getTranslate(x,y){return"translate("+x+"px,"+y+"px)"}},{key:"_scrollHeightUpdated",value:function _scrollHeightUpdated(_estScrollHeight){this.$.outersizer.style.top=this.$.fixedsizer.style.top=_estScrollHeight+"px"}},{key:"_timeouts",get:function get(){return{SCROLL_PERIOD:1e3,WHEEL_SCROLLING:200,SCROLLING:100,IGNORE_WHEEL:500}}}],[{key:"properties",get:function get(){return{// Cached array of frozen cells
...
document.body.removeChild(scrollDiv);return scrollbarWidth}},_rowWithFocusedElement:Element,_deltaYAcc:{type:Number,value:0}}}},{key:"observers",get:function get(){return["_scrollHeightUpdated(_estScrollHeight)"]}}]);return ScrollMixin}(superClass))};_exports.ScrollMixin=ScrollMixin});