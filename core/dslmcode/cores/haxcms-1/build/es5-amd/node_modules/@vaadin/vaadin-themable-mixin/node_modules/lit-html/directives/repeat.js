define(["exports", "../lit-html.js"], function (_exports, _litHtml) {
  ...
  var createAndInsertPart = function createAndInsertPart(containerPart, beforePart) {
    ...
    var startNode = container.insertBefore((0, _litHtml.createMarker)(), beforeNode);
    container.insertBefore((0, _litHtml.createMarker)(), beforeNode);
    var newPart = new _litHtml.NodePart(containerPart.options);
  ...
  var repeat = (0, _litHtml.directive)(function (items, keyFnOrTemplate, template) {
    var keyFn;
    ...
    return function (containerPart) {
      if (!babelHelpers.instanceof(containerPart, _litHtml.NodePart)) {
