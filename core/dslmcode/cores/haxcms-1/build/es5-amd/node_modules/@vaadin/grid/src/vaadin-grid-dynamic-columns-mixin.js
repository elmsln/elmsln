define(["exports", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../@polymer/polymer/polymer-element.js", "../../component-base/src/async.js", "../../component-base/src/debounce.js"], function (_exports, _flattenedNodesObserver, _polymerElement, _async, _debounce) {
  "use strict";
        ...
        value: function _addNodeObserver() {
          ...
          this._observer = new _flattenedNodesObserver.FlattenedNodesObserver(this, function (info) {
            ...
            if (hasColumnElements(info.addedNodes) || hasColumnElements(info.removedNodes)) {
              var allRemovedCells = info.removedNodes.flatMap(function (c) {
                return c._allCells;
              });
