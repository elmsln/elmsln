    ...
    return (
      ...
      function (_superClass) {
        ...
        function DragAndDropMixin() {
          ...
          return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(DragAndDropMixin).apply(this, arguments));
        }
        ...
        babelHelpers.createClass(DragAndDropMixin, [{
          ...
          value: function _filterDragAndDrop(row, rowData) {
            var dragDisabled = !this.rowsDraggable || this.dragFilter && !this.dragFilter(rowData);
            var dropDisabled = !this.dropMode || this.dropFilter && !this.dropFilter(rowData);
