define(["exports"], function (_exports) {
  ...
  _exports.DragAndDropMixin = void 0;
  ...
  */
  ...
  var DragAndDropMixin = function DragAndDropMixin(superClass) {
    return /*#__PURE__*/function (_superClass) {
      babelHelpers.inherits(DragAndDropMixin, _superClass);

      var _super = _createSuper(DragAndDropMixin);

      function DragAndDropMixin() {
        babelHelpers.classCallCheck(this, DragAndDropMixin);
        return _super.apply(this, arguments);
      }

      babelHelpers.createClass(DragAndDropMixin, [{
        key: "ready",
        value:
        /** @protected */
        function ready() {
          ...
          babelHelpers.get(babelHelpers.getPrototypeOf(DragAndDropMixin.prototype), "ready", this).call(this);
          ...
          if (this.rowsDraggable) {
            ...
            if (this._isSelected(row._item)) {
              rows = this.__getViewportRows().filter(function (row) {
                return _this2._isSelected(row._item);
              }).filter(function (row) {
                return !_this2.dragFilter || _this2.dragFilter(_this2.__getRowModel(row));
              });
        ...
        value: function __dndAutoScroll(clientY) {
          ...
          if (scrollTopDelta) {
            ...
            if (scrollTopChanged) {
              ...
              setTimeout(function () {
                return _this3.__dndAutoScrolling = false;
              }, 20);
        ...
        value: function __getViewportRows() {
          ...
          var headerBottom = Math.max(this.$.header.getBoundingClientRect().bottom, scrollerRect.top);
          var footerTop = Math.min(this.$.footer.getBoundingClientRect().top, scrollerRect.bottom);
        ...
        value: function filterDragAndDrop() {
          ...
          Array.from(this.$.items.children).filter(function (row) {
            ...
            _this4._filterDragAndDrop(row, _this4.__getRowModel(row));
          });
        }
        /**
        ...
        value: function _filterDragAndDrop(row, model) {
          var loading = this.loading || row.hasAttribute('loading');
          var dragDisabled = !this.rowsDraggable || loading || this.dragFilter && !this.dragFilter(model);
          var dropDisabled = !this.dropMode || loading || this.dropFilter && !this.dropFilter(model);
  ...
  _exports.DragAndDropMixin = DragAndDropMixin;
});