define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../component-base/src/dir-mixin.js", "../../vaadin-themable-mixin/vaadin-themable-mixin.js"], function (_exports, _polymerElement, _dirMixin, _vaadinThemableMixin) {
  ...
  var _templateObject_023277a0942711ec84e88734a30f0661, _templateObject2_023277a0942711ec84e88734a30f0661;
  ...
  var InputContainer = /*#__PURE__*/function (_ThemableMixin) {
    ...
    babelHelpers.createClass(InputContainer, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_023277a0942711ec84e88734a30f0661 || (_templateObject_023277a0942711ec84e88734a30f0661 = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: flex;\n          align-items: center;\n          flex: 0 1 auto;\n        }\n\n        :host([hidden]) {\n          display: none !important;\n        }\n\n        /* Reset the native input styles */\n        ::slotted(input) {\n          -webkit-appearance: none;\n          -moz-appearance: none;\n          flex: auto;\n          white-space: nowrap;\n          overflow: hidden;\n          width: 100%;\n          height: 100%;\n          outline: none;\n          margin: 0;\n          padding: 0;\n          border: 0;\n          border-radius: 0;\n          min-width: 0;\n          font: inherit;\n          line-height: normal;\n          color: inherit;\n          background-color: transparent;\n          /* Disable default invalid style in Firefox */\n          box-shadow: none;\n        }\n\n        ::slotted(*) {\n          flex: none;\n        }\n\n        ::slotted(:is(input, textarea))::placeholder {\n          /* Use ::slotted(input:placeholder-shown) in themes to style the placeholder. */\n          /* because ::slotted(...)::placeholder does not work in Safari. */\n          /* See the workaround at the end of this file. */\n          font: inherit;\n          color: inherit;\n          /* Override default opacity in Firefox */\n          opacity: 1;\n        }\n      </style>\n      <slot name=\"prefix\"></slot>\n      <slot></slot>\n      <slot name=\"suffix\"></slot>\n    "])));
      }
    }, {
      key: "properties",
      get: function get() {
  ...
  var placeholderStyleWorkaround = (0, _vaadinThemableMixin.css)(_templateObject2_023277a0942711ec84e88734a30f0661 || (_templateObject2_023277a0942711ec84e88734a30f0661 = babelHelpers.taggedTemplateLiteral(["\n  /* Needed for Safari, where ::slotted(...)::placeholder does not work */\n  :is(input[slot='input'], textarea[slot='textarea'])::placeholder {\n    font: inherit;\n    color: inherit;\n  }\n"])));
