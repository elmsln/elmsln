define(["exports"], function (_exports) {
   ...
   *
   */
  var WebComponentInterface = /*#__PURE__*/function () {
    function WebComponentInterface() {
      babelHelpers.classCallCheck(this, WebComponentInterface);
    }

    babelHelpers.createClass(WebComponentInterface, [{
      key: "onBeforeLeave",
       ...
       */
      value: function onBeforeLeave(location, commands, router) {
      ...
      key: "onBeforeEnter",
      value: function onBeforeEnter(location, commands, router) {
        // user implementation example:
      ...
      key: "onAfterLeave",
      value: function onAfterLeave(location, commands, router) {
        // user implementation example:
      ...
      key: "onAfterEnter",
      value: function onAfterEnter(location, commands, router) {
        // user implementation example:
        sendVisitStatistics();
      }
    }]);
    return WebComponentInterface;
  }();
