define(["exports","../../../@polymer/polymer/lib/mixins/gesture-event-listeners.js","../../../@polymer/polymer/lib/utils/gestures.js"],function(_exports,_gestureEventListeners,_gestures){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ColumnResizingMixin=void 0;/**
@license
Copyright (c) 2017 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/ /**
 * @polymerMixin
 */var ColumnResizingMixin=function ColumnResizingMixin(superClass){return(/*#__PURE__*/function(_GestureEventListener){babelHelpers.inherits(ColumnResizingMixin,_GestureEventListener);function ColumnResizingMixin(){babelHelpers.classCallCheck(this,ColumnResizingMixin);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ColumnResizingMixin).apply(this,arguments))}babelHelpers.createClass(ColumnResizingMixin,[{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(ColumnResizingMixin.prototype),"ready",this).call(this);var scroller=this.$.scroller;(0,_gestures.addListener)(scroller,"track",this._onHeaderTrack.bind(this));// Disallow scrolling while resizing
...
this._resizeHandler()}}}]);return ColumnResizingMixin}((0,_gestureEventListeners.GestureEventListeners)(superClass)))};_exports.ColumnResizingMixin=ColumnResizingMixin});