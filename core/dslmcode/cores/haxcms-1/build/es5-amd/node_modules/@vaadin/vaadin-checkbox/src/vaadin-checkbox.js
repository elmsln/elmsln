 ...
 */var CheckboxElement=/*#__PURE__*/function(_ElementMixin){babelHelpers.inherits(CheckboxElement,_ElementMixin);babelHelpers.createClass(CheckboxElement,null,[{key:"template",get:function get(){return(0,_htmlTag.html)(_templateObject_35bc8cc0984711e9810e6d9eee9273ff())}},{key:"is",get:function get(){return"vaadin-checkbox"}},{key:"version",get:function get(){return"2.2.7"}},{key:"properties",get:function get(){return{/**
...
if("a"===e.target.localName){return!1}return!0}},{key:"_handleClick",value:function _handleClick(e){if(this.__interactionsAllowed(e)){if(!this.indeterminate){if(e.composedPath()[0]!==this._nativeCheckbox){e.preventDefault();this._toggleChecked()}}else{/*
         ...
         */this.indeterminate=!1;e.preventDefault();this._toggleChecked()}}}},{key:"_toggleChecked",value:function _toggleChecked(){this.checked=!this.checked;this.dispatchEvent(new CustomEvent("change",{composed:!0,bubbles:!0}))}/**
   * Fired when the user commits a value change.
   *
   * @event change
   */},{key:"name",get:function get(){return this.checked?this._storedName:""},set:function set(name){this._storedName=name}},{key:"focusElement",get:function get(){return this.shadowRoot.querySelector("input")}}]);return CheckboxElement}((0,_vaadinElementMixin.ElementMixin)((0,_vaadinControlStateMixin.ControlStateMixin)((0,_vaadinThemableMixin.ThemableMixin)((0,_gestureEventListeners.GestureEventListeners)(_polymerElement.PolymerElement)))));_exports.CheckboxElement=CheckboxElement;customElements.define(CheckboxElement.is,CheckboxElement)});