define(["exports"], function (_exports) {
  ...
  y.parse = _, y.compile = g, y.tokensToFunction = E, y.tokensToRegExp = $;
        ...
        function c(t) {
          ...
          return o = i || n.next(h), i = null, t || !o.done && function (t, e) {
            ...
            if (n && !n.i) {
              ...
              }(t.chain, n) ? t.chain.push(_e4) : t.chain = [_e4];
            }
          }(e, o.value), s = Object.assign({}, e, o.value), Promise.resolve(r(s)).then(function (e) {
    ...
    return function (r, o) {
      ...
      if (!s) {
        ...
        for (; _e5;) {
          ...
          _n3 && (_t3 = _n3.replace(/\/$/, "") + "/" + _t3.replace(/^\//, "")), _e5 = _e5.parent;
        }
  ...
  function nt(t) {
    if (t && t.length) {
      var _e7 = t[0].parentNode;

      for (var _n5 = 0; _n5 < t.length; _n5++) {
        _e7.removeChild(t[_n5]);
      }
    }
  }
  ...
  function (_D) {
    ...
    function it(t, e) {
      ...
      _this2 = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(it).call(this, [], Object.assign({
      ...
      }), _this2.p = 0, _this2.m = _this2.v.bind(babelHelpers.assertThisInitialized(_this2)), _this2.setOutlet(t), _this2.subscribe(), _this2._ = new WeakMap(), _this2.g = new WeakMap();
      return _this2;
    }
    ...
    babelHelpers.createClass(it, [{
      ...
      value: function A(t) {
        ...
        return this.D(e).then(function (n) {
          var r = n !== e ? n : t;
          return n.next().then(function (t) {
            if (null === t || t === p) {
              if (rt(ot(n.chain), n.resolver) !== n.pathname) throw d(r);
            }

            return t && t !== p ? _this5.A(r, t) : _this5.F(n);
          });
        });
      }
    }, {
      ...
      value: function W(t) {
        ...
        if (t.q = 0, t.T = !1, n.length) {
          for (var _e8 = 0; _e8 < Math.min(n.length, r.length) && n[_e8].route === r[_e8].route && (n[_e8].path === r[_e8].path || n[_e8].element === r[_e8].element) && this.J(n[_e8].element, r[_e8].element); _e8 = ++t.q) {
            ;
          }

          if (t.T = r.length === n.length && t.q == r.length && this.J(t.result, e.result), t.T) {
            for (var _s = r.length - 1; _s >= 0; _s--) {
              n[_s].path === r[_s].path && t.search === e.search || (o = this.K(o, t, {
                prevent: i
              }, n[_s]));
            }

            for (var _c = 0; _c < r.length; _c++) {
              n[_c].path === r[_c].path && t.search === e.search || (o = this.V(o, t, {
                prevent: i,
                redirect: s
              }, r[_c])), n[_c].element.location = Y(t, n[_c].route);
            }
          } else for (var _e9 = n.length - 1; _e9 >= t.q; _e9--) {
            o = this.K(o, t, {
              prevent: i
            }, n[_e9]);
          }
        ...
        for (var _e10 = t.q; !t.T && _e10 < r.length; _e10++) {
          o = this.V(o, t, {
            prevent: i,
            redirect: s
          }, r[_e10]);
      ...
      value: function J(t, e) {
        return !(!t || !e) && (this._.get(t) && this._.get(e) ? t.localName === e.localName : t === e);
      }
    }, {
      key: "$",
      value: function $(t) {
      ...
      value: function M(t, e) {
        ...
        this.X = [], this.Y = Array.from(n.children).filter(function (e) {
          return _this11.g.get(e) && e !== t.result;
        });
        var r = n;

        for (var _e11 = t.q; _e11 < t.chain.length; _e11++) {
          var _o8 = t.chain[_e11].element;
          _o8 && (r.appendChild(_o8), this.g.set(_o8, !0), r === n && this.X.push(_o8), r = _o8);
        }
      }
    }, {
      key: "L",
      ...
      key: "U",
      value: function U(t) {
        for (var _e12 = t.q; _e12 < t.chain.length && this.$(t); _e12++) {
          var _n8 = t.chain[_e12].element || {},
              _r12 = Y(t, t.chain[_e12].route);
