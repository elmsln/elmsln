    ...
    babelHelpers.createClass(it, [{
      ...
      value: function A(t) {
        ...
        return this.D(e).then(function (n) {
          var r = n !== e ? n : t,
              ...
              i = function i(t, e) {
            var n = void 0;
            return void 0 === e ? e = t.route : n = null, t.next(void 0, e, n).then(function (e) {
              return null === e || e === p ? o ? t : i(t, t.route.parent) : e;
            });
          };
      ...
      value: function W(t) {
        ...
        if (t.q = 0, t.T = !1, n.length) {
          ...
          } else for (var _e10 = n.length - 1; _e10 >= t.q; _e10--) {
            o = this.K(o, t, {
              prevent: i
            }, n[_e10]);
          }
        ...
        for (var _e11 = t.q; !t.T && _e11 < r.length; _e11++) {
          o = this.V(o, t, {
            prevent: i,
            redirect: s
          }, r[_e11]);
      ...
      value: function M(t, e) {
        ...
        for (var _e12 = t.q; _e12 < t.chain.length; _e12++) {
          var _o8 = t.chain[_e12].element;
      ...
      key: "U",
      value: function U(t) {
        for (var _e13 = t.q; _e13 < t.chain.length && this.$(t); _e13++) {
          var _n8 = t.chain[_e13].element || {},
              _r12 = Y(t, t.chain[_e13].route);
