define(["exports"], function (_exports) {
  ...
  function (_Resolver) {
    ...
    function Router(outlet, options) {
      ...
      _this2 = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(Router).call(this, [], Object.assign({
        // Default options
    ...
    babelHelpers.createClass(Router, [{
      ...
      value: function __runOnBeforeCallbacks(newContext) {
        ...
        if (previousChain.length) {
          ...
          if (newContext.__skipAttach) {
            ...
            for (var _i3 = 0; _i3 < newChain.length; _i3++) {
              if (previousChain[_i3].path !== newChain[_i3].path || newContext.search !== previousContext.search) {
        ...
        for (var _i5 = newContext.__divergedChainIndex; !newContext.__skipAttach && _i5 < newChain.length; _i5++) {
          callbacks = this.__runOnBeforeEnterCallbacks(callbacks, newContext, {
            prevent: prevent,
            redirect: redirect
          }, newChain[_i5]);
