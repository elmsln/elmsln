define(["exports"], function (_exports) {
  ...
  _exports.Resolver = _exports.Router = void 0;
    ...
    babelHelpers.createClass(Router, [{
        ...
        .then(function (context) {
          ...
          if (renderId === _this3.__lastStartedRenderId) {
            ...
            if (shouldUpdateHistory) {
              _this3.__updateBrowserHistory(context.pathname, context.redirectFrom);
            }
          ...
          if (renderId === _this3.__lastStartedRenderId) {
            if (shouldUpdateHistory) {
              _this3.__updateBrowserHistory(pathname);
            }

            removeDomNodes(_this3.__outlet && _this3.__outlet.children);
            _this3.location = createLocation({
              pathname: pathname,
              resolver: _this3
            });
      ...
      value: function __fullyResolveChain(originalContext) {
        ...
        return this.__amendWithResolutionResult(currentContext).then(function (amendedContext) {
          ...
          return amendedContext.next().then(function (nextContext) {
            ...
            return nextContext && nextContext !== notFoundResult ? _this4.__fullyResolveChain(initialContext, nextContext) : _this4.__amendWithOnBeforeCallbacks(initialContext);
          });
        });
      }
    }, {
      ...
      value: function __amendWithResolutionResult(context) {
        ...
        if (babelHelpers.instanceof(result, HTMLElement)) {
          ...
          return this.__redirect(result.redirect, context.__redirectCount).then(function (context) {
            return _this5.__amendWithResolutionResult(context);
          });
      ...
      value: function __runOnBeforeCallbacks(newContext) {
        ...
        if (previousChain.length) {
          ...
          for (var _i2 = previousChain.length - 1; _i2 >= newContext.__divergedChainIndex; _i2--) {
            var location = createLocation(newContext);
            callbacks = callbacks.then(amend('onBeforeLeave', [location, {
              prevent: prevent
            }, this], previousChain[_i2].element)).then(function (result) {
              if (!(result || {}).redirect) {
                return result;
              }
            });
        ...
        for (var _i3 = newContext.__divergedChainIndex; _i3 < newChain.length; _i3++) {
          var _location = createLocation(newContext, newChain[_i3].route);

          callbacks = callbacks.then(amend('onBeforeEnter', [_location, {
            prevent: prevent,
            redirect: redirect
          }, this], newChain[_i3].element));
        }
        ...
        return callbacks.then(function (amendmentResult) {
          if (amendmentResult) {
            ...
            if (amendmentResult.redirect) {
              return _this7.__redirect(amendmentResult.redirect, newContext.__redirectCount);
            }
          }
      ...
      value: function __addAppearingContent(context, previousContext) {
        ...
        for (var _i4 = context.__divergedChainIndex; _i4 < context.chain.length; _i4++) {
          var elementToAdd = context.chain[_i4].element;
