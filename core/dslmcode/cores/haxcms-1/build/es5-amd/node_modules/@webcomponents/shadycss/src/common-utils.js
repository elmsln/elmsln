...
for(var p in properties){// NOTE: for bc with shim, don't apply null values.
 ...
 * @return {boolean}
 */function detectMixin(cssText){var has=_commonRegex.MIXIN_MATCH.test(cssText)||_commonRegex.VAR_ASSIGN.test(cssText);// reset state of the regexes
