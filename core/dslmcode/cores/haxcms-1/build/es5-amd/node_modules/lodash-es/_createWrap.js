define(["exports", "./_baseSetData.js", "./_createBind.js", "./_createCurry.js", "./_createHybrid.js", "./_createPartial.js", "./_getData.js", "./_mergeData.js", "./_setData.js", "./_setWrapToString.js", "./toInteger.js"], function (_exports, _baseSetData, _createBind, _createCurry, _createHybrid, _createPartial, _getData, _mergeData, _setData, _setWrapToString, _toInteger) {
  "use strict";
  ...
  _baseSetData = babelHelpers.interopRequireDefault(_baseSetData);
  _createBind = babelHelpers.interopRequireDefault(_createBind);
  _createCurry = babelHelpers.interopRequireDefault(_createCurry);
  _createHybrid = babelHelpers.interopRequireDefault(_createHybrid);
  _createPartial = babelHelpers.interopRequireDefault(_createPartial);
  _getData = babelHelpers.interopRequireDefault(_getData);
  _mergeData = babelHelpers.interopRequireDefault(_mergeData);
  _setData = babelHelpers.interopRequireDefault(_setData);
  _setWrapToString = babelHelpers.interopRequireDefault(_setWrapToString);
