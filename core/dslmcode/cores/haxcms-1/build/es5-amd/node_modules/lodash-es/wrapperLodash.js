define(["exports", "./_LazyWrapper.js", "./_LodashWrapper.js", "./_baseLodash.js", "./isArray.js", "./isObjectLike.js", "./_wrapperClone.js"], function (_exports, _LazyWrapper, _LodashWrapper, _baseLodash, _isArray, _isObjectLike, _wrapperClone) {
  "use strict";
  ...
  function lodash(value) {
    if ((0, _isObjectLike.default)(value) && !(0, _isArray.default)(value) && !babelHelpers.instanceof(value, _LazyWrapper.default)) {
      if (babelHelpers.instanceof(value, _LodashWrapper.default)) {
        return value;
      }
