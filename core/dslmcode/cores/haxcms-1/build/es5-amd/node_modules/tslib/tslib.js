...
(function (factory) {
  var root = (typeof global === "undefined" ? "undefined" : babelHelpers.typeof(global)) === "object" ? global : (typeof self === "undefined" ? "undefined" : babelHelpers.typeof(self)) === "object" ? self : babelHelpers.typeof(this) === "object" ? this : {};
  ...
  _await = function __await(v) {
    return babelHelpers.instanceof(this, _await) ? (this.v = v, this) : new _await(v);
  };
  ...
  __asyncGenerator = function __asyncGenerator(thisArg, _arguments, generator) {
    ...
    function step(r) {
      babelHelpers.instanceof(r.value, _await) ? Promise.resolve(r.value.v).then(fulfill, reject) : settle(q[0][2], r);
    }
