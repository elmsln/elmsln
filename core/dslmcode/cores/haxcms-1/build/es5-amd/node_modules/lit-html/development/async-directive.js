define(["exports", "./lit-html.js", "./directive-helpers.js", "./directive.js"], function (_exports, _litHtml, _directiveHelpers, _directive) {
  "use strict";
  ...
  var setChildrenConnected = function setChildrenConnected(parent, isConnected) {
    var _a, _b;
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        (_b = (_a = obj)._$setDirectiveConnected) === null || _b === void 0 ? void 0 : _b.call(_a, isConnected, false); // Disconnect Part/TemplateInstance
  ...
  function setChildPartConnected(isConnected) {
  ...
  var AsyncDirective = /*#__PURE__*/function (_Directive) {
    ...
    function AsyncDirective() {
      ...
      _this._pendingValue = _litHtml.noChange; // @internal
    ...
    babelHelpers.createClass(AsyncDirective, [{
      ...
      key: "_$setDirectiveConnected",
      value: function _$setDirectiveConnected(isConnected) {
      ...
      value: function _setConnected(isConnected) {
        ...
        if (isConnected !== this.isConnected) {
          if (isConnected) {
            ...
            if (this._pendingValue !== _litHtml.noChange) {
              this.setValue(this._pendingValue);
              this._pendingValue = _litHtml.noChange;
            }
      ...
      value: function _$resolve(part, props) {
        if (!this.isConnected) {
          throw new Error("AsyncDirective ".concat(this.constructor.name, " was ") + "rendered while its tree was disconnected.");
        }

        return babelHelpers.get(babelHelpers.getPrototypeOf(AsyncDirective.prototype), "_$resolve", this).call(this, part, props);
      }
      /**
