define(["exports", "../lit-html.js", "../directive.js"], function (_exports, _litHtml, _directive) {
   ...
   */
  var o = (0, _directive.directive)( /*#__PURE__*/function (_s) {
    ...
    function _class(t) {
      ...
      var i;
      if (_this = _super.call(this, t), t.type !== _directive.PartType.ATTRIBUTE || "class" !== t.name || (null === (i = t.strings) || void 0 === i ? void 0 : i.length) > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
    ...
    babelHelpers.createClass(_class, [{
      ...
      value: function update(i, _ref) {
        ...
        if (void 0 === this.nt) {
          ...
          for (var _t in s) {
            s[_t] && !(null === (r = this.st) || void 0 === r ? void 0 : r.has(_t)) && this.nt.add(_t);
          }
