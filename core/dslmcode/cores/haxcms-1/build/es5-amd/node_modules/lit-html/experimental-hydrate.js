define(["exports", "./lit-html.js", "./directive.js", "./directive-helpers.js"], function (_exports, _litHtml, _directive, _directiveHelpers) {
  ...
  var i = _litHtml._$LH.R,
    ...
    if (0 === l.length) f = new c(r, null, void 0, d), p = t;else {
      ...
      if ("template-instance" === _e2.type) f = new c(r, null, _e2.instance, d), _e2.instance.v.push(f), p = _e2.result.values[_e2.instancePartIndex++], _e2.templatePartIndex++;else if ("iterable" === _e2.type) {
        ...
        p = _t2.value, _e2.part._$AH.push(f);
    ...
    if ("template-instance" !== p.type) throw Error("internal error");
    {
      ...
      for (;;) {
        var _t4 = _e5._$AD.parts[p.templatePartIndex];
        ...
        if (_t4.type === _directive.PartType.ATTRIBUTE) {
          ...
          _o._$AI(_i, _o, p.instancePartIndex, _a), p.instancePartIndex += _t4.strings.length - 1, _e5.v.push(_o);
        } else {
          var _t5 = new d(c, p.instance, n);

          s(_t5, p.result.values[p.instancePartIndex++]), _e5.v.push(_t5);
        }
