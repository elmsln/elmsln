define(["exports", "./lit-html.js", "./directive.js", "./directive-helpers.js"], function (_exports, _litHtml, _directive, _directiveHelpers) {
  ...
  var i = _litHtml._$LH.D,
    ...
    if (0 === l.length) p = new c(r, null, void 0, d), f = t;else {
      var _e = l[l.length - 1];
      if ("template-instance" === _e.type) p = new c(r, null, _e.instance, d), _e.instance.v.push(p), f = _e.result.values[_e.instancePartIndex++], _e.templatePartIndex++;else if ("iterable" === _e.type) {
    ...
    if ("template-instance" !== f.type) throw Error("internal error");
    {
      ...
      for (;;) {
        ...
        if (_t4.type === _directive.PartType.ATTRIBUTE) {
          ...
          _o._$AI(_i, _o, f.instancePartIndex, _a), f.instancePartIndex += _t4.strings.length - 1, _e4.v.push(_o);
        } else {
          var _t5 = new d(c, f.instance, n);

          s(_t5, f.result.values[f.instancePartIndex++]), _e4.v.push(_t5);
        }
