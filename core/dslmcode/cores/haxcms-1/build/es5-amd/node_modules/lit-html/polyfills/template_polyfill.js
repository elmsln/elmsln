define(["exports", "../lib/dom.js"], function (_exports, _dom) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.initTemplatePolyfill = void 0;
   ...
   */
  var initTemplatePolyfill = function initTemplatePolyfill() {
    ...
    var upgrade = function upgrade(template) {
      var content = contentDoc.createDocumentFragment();
      Object.defineProperties(template, {
        content: Object.assign({}, descriptor, {
          get: function get() {
            return content;
          }
        }),
        innerHTML: Object.assign({}, descriptor, {
          set: function set(text) {
            body.innerHTML = text;
            (0, _dom.removeNodes)(content, content.firstChild);
            (0, _dom.reparentNodes)(content, body.firstChild);
          }
        })
      });
    };
    ...
    Document.prototype.createElement = function createElement(tagName, options) {
      var el = capturedCreateElement.call(this, tagName, options);
  ...
  _exports.initTemplatePolyfill = initTemplatePolyfill;
});