define(["exports"], function (_exports) {
  ...
  var i = globalThis,
    ...
    if (void 0 === l) {
      ...
      n._$litPart$ = l = new S(i.insertBefore(r(), _t), _t, void 0, null != s ? s : {});
    }
    ...
    for (var _i = 0; _i < s; _i++) {
      ...
      for (; _$ < _s.length && (d.lastIndex = _$, _u = d.exec(_s), null !== _u);) {
        _$ = d.lastIndex, d === v ? "!--" === _u[1] ? d = a : void 0 !== _u[1] ? d = f : void 0 !== _u[2] ? (g.test(_u[2]) && (h = RegExp("</" + _u[2], "g")), d = _) : void 0 !== _u[3] && (d = _) : d === _ ? ">" === _u[0] ? (d = null != h ? h : v, _c = -1) : void 0 === _u[1] ? _c = -2 : (_c = d.lastIndex - _u[2].length, _e = _u[1], d = void 0 === _u[3] ? _ : '"' === _u[3] ? p : m) : d === p || d === m ? d = _ : d === a || d === f ? d = v : (d = _, h = void 0);
      }
    ...
    function P(_ref, e) {
      ...
      for (; null !== (l = E.nextNode()) && c.length < u;) {
        if (1 === l.nodeType) {
              ...
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                if (_i5.endsWith("$lit$") || _i5.startsWith(o)) {
                  ...
                  if (_t3.push(_i5), void 0 !== _s2) {
                    var _t5 = l.getAttribute(_s2.toLowerCase() + "$lit$").split(o),
                        _i6 = /([.?@])?(.*)/.exec(_s2);
                    ...
                    c.push({
                      ...
                      name: _i6[2],
                      strings: _t5,
                      ctor: "." === _i6[1] ? k : "?" === _i6[1] ? H : "@" === _i6[1] ? I : M
                    });
                  } else c.push({
                    type: 6,
                    index: h
          ...
          if (g.test(l.tagName)) {
            ...
            if (_i7 > 0) {
              ...
              for (var _s3 = 0; _s3 < _i7; _s3++) {
                l.append(_t6[_s3], r()), E.nextNode(), c.push({
                  type: 2,
                  index: ++h
                });
              }
          ...
          for (; -1 !== (_t7 = l.data.indexOf(o, _t7 + 1));) {
            c.push({
              type: 7,
              index: h
            }), _t7 += o.length - 1;
      ...
      value: function p(t) {
        ...
        for (; void 0 !== d;) {
          if (l === d.index) {
            ...
            2 === d.type ? _i8 = new S(n, n.nextSibling, this, t) : 1 === d.type ? _i8 = new d.ctor(n, d.name, d.strings, this, t) : 6 === d.type && (_i8 = new L(n, this, t)), this.v.push(_i8), d = e[++r];
          }
  ...
  var S = /*#__PURE__*/function () {
    ...
    babelHelpers.createClass(S, [{
      ...
      value: function _$AI(t) {
        ...
        t = V(this, t, i), d(t) ? t === b || null == t || "" === t ? (this._$AH !== b && this._$AR(), this._$AH = b) : t !== this._$AH && t !== T && this.$(t) : void 0 !== t._$litType$ ? this.T(t) : void 0 !== t.nodeType ? this.k(t) : c(t) ? this.O(t) : this.$(t);
      }
    }, {
      key: "S",
      value: function S(t) {
      ...
      value: function _$AC(t) {
        var i = w.get(t.strings);
        return void 0 === i && w.set(t.strings, i = new P(t)), i;
      }
    }, {
      key: "O",
      value: function O(t) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            var _o = _step3.value;
            e === i.length ? i.push(s = new S(this.S(r()), this.S(r()), this, this.options)) : s = i[e], s._$AI(_o), e++;
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
  ...
  var M = /*#__PURE__*/function () {
    ...
    babelHelpers.createClass(M, [{
      ...
      value: function _$AI(t) {
        ...
        var o = this.strings;
        var n = !1;
        if (void 0 === o) t = V(this, t, i, 0), n = !d(t) || t !== this._$AH && t !== T, n && (this._$AH = t);else {
          var _e2 = t;

          var _l, _h;

          for (t = o[0], _l = 0; _l < o.length - 1; _l++) {
            _h = V(this, _e2[s + _l], i, _l), _h === T && (_h = this._$AH[_l]), n || (n = !d(_h) || _h !== this._$AH[_l]), _h === b ? t = b : t !== b && (t += (null != _h ? _h : "") + o[_l + 1]), this._$AH[_l] = _h;
          }
        }
        n && !e && this.P(t);
      }
  ...
  var k = /*#__PURE__*/function (_M) {
    babelHelpers.inherits(k, _M);
  ...
  var H = /*#__PURE__*/function (_M2) {
    babelHelpers.inherits(H, _M2);
  ...
  var I = /*#__PURE__*/function (_M3) {
    babelHelpers.inherits(I, _M3);
    ...
    babelHelpers.createClass(I, [{
      ...
      value: function _$AI(t) {
        var i = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this;
        var s;
        if ((t = null !== (s = V(this, t, i, 0)) && void 0 !== s ? s : b) === T) return;
        var e = this._$AH,
