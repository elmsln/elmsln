define(["exports", "./lit-html.js"], function (_exports, _litHtml) {
  ...
  _exports.clearPart = _exports.removePart = _exports.getCommittedValue = _exports.setCommittedValue = _exports.setChildPartValue = _exports.insertPart = _exports.isSingleExpression = _exports.getDirectiveClass = _exports.isDirectiveResult = _exports.isTemplateResult = _exports.TemplateResultType = _exports.isPrimitive = void 0;
  ...
  var ChildPart = _litHtml._Σ._ChildPart;
  ...
  var isTemplateResult = function isTemplateResult(value, type) {
    ...
    return type === undefined ? ((_a = value) === null || _a === void 0 ? void 0 : _a._$litType$) !== undefined : ((_b = value) === null || _b === void 0 ? void 0 : _b._$litType$) === type;
  };
  /**
  ...
  var insertPart = function insertPart(containerPart, refPart, part) {
    ...
    if (part === undefined) {
      ...
      var parentChanged = part._$parent !== containerPart;
