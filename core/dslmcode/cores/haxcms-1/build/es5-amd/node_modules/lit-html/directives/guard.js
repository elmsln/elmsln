define(["exports", "../lit-html.js", "../directive.js"], function (_exports, _litHtml, _directive) {
  ...
  var e = {},
    ...
    function _class() {
      ...
      _this = _super.apply(this, arguments), _this.$t = e;
      return _this;
    }
    ...
    babelHelpers.createClass(_class, [{
      ...
      value: function update(t, _ref) {
        ...
        if (Array.isArray(s)) {
          if (Array.isArray(this.$t) && this.$t.length === s.length && s.every(function (r, t) {
            return r === _this2.$t[t];
          })) return _litHtml.noChange;
        } else if (this.$t === s) return _litHtml.noChange;

        return this.$t = Array.isArray(s) ? Array.from(s) : s, this.render(s, e);
      }
    }]);
    return _class;
