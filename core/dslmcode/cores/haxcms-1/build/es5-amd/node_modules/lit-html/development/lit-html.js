define(["exports"], function (_exports) {
  ...
  _exports._$LH = _exports.render = _exports.nothing = _exports.noChange = _exports.svg = _exports.html = _exports.INTERNAL = void 0;
  ...
  var wrap = ENABLE_SHADYDOM_NOPATCH && ((_b = window.ShadyDOM) === null || _b === void 0 ? void 0 : _b.inUse) && ((_c = window.ShadyDOM) === null || _c === void 0 ? void 0 : _c.noPatch) === true ? window.ShadyDOM.wrap : function (node) {
    return node;
  };
  ...
  var tag = function tag(type) {
    return function (strings) {
      ...
      return _ref = {}, babelHelpers.defineProperty(_ref, '_$litType$', type), babelHelpers.defineProperty(_ref, "strings", strings), babelHelpers.defineProperty(_ref, "values", values), _ref;
    };
  };
  /**
  ...
  var render = function render(value, container, options) {
    ...
    var partOwnerNode = (_a = options === null || options === void 0 ? void 0 : options.renderBefore) !== null && _a !== void 0 ? _a : container; // This property needs to remain unminified.
    // eslint-disable-next-line @typescript-eslint/no-explicit-any

    var part = partOwnerNode['_$litPart$'];

    if (part === undefined) {
      var endNode = (_b = options === null || options === void 0 ? void 0 : options.renderBefore) !== null && _b !== void 0 ? _b : null; // Internal modification: don't clear container to match lit-html 2.0

      if (INTERNAL && ((_c = options) === null || _c === void 0 ? void 0 : _c.clearContainerForLit2MigrationOnly) === true) {
        var n = container.firstChild; // Clear only up to the `endNode` aka `renderBefore` node.
  ...
  var Template = /*#__PURE__*/function () {
    ...
    _ref2, options) {
      ...
      while ((node = walker.nextNode()) !== null && parts.length < partCount) {
        if (node.nodeType === 1) {
          if (DEV_MODE) {
            var _tag = node.localName; // Warn if `textarea` includes an expression and throw if `template`
  ...
  function resolveDirective(part, value) {
    ...
    var nextDirectiveConstructor = isPrimitive(value) ? undefined : // This property needs to remain unminified.
    ...
    babelHelpers.createClass(ChildPart, [{
      ...
      value: function _commitTemplateResult(result) {
        ...
        var values = result.values,
            type = result['_$litType$']; // If $litType$ is a number, result is a plain TemplateResult and we get
        // the template from the template cache. If not, result is a
        // CompiledTemplateResult and _$litType$ is a CompiledTemplate and we need
        // to create the <template> element the first time we see it.

        var template = typeof type === 'number' ? this._$getTemplate(result) : (type.el === undefined && (type.el = Template.createElement(type.h, this.options)), type);
  ...
  var EventPart = /*#__PURE__*/function (_AttributePart3) {
    ...
    function EventPart(element, name, strings, parent, options) {
      ...
      _this3 = _super3.call(this, element, name, strings, parent, options);
  ...
  _exports._$LH = _$LH;
  (_d = globalThis["litHtmlPolyfillSupport".concat(DEV_MODE ? "DevMode" : "")]) === null || _d === void 0 ? void 0 : _d.call(globalThis, Template, ChildPart); // IMPORTANT: do not change the property name or the assignment expression.
