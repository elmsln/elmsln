define(["exports"], function (_exports) {
  ...
  var NODE_MODE = false; // Use window for browser builds because IE11 doesn't have globalThis.
  ...
  if (DEV_MODE) {
    (_a = global.litIssuedWarnings) !== null && _a !== void 0 ? _a : global.litIssuedWarnings = new Set(); // Issue a warning, if we haven't already.
  ...
  } : document; // Creates a dynamic marker. We never have to search for these in the DOM.
  ...
  var render = function render(value, container, options) {
    ...
    if (part === undefined) {
      var endNode = (_b = options === null || options === void 0 ? void 0 : options.renderBefore) !== null && _b !== void 0 ? _b : null; // This property needs to remain unminified.
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
