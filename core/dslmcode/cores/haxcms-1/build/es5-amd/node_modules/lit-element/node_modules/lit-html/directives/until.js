define(["exports", "../lit-html.js", "../directive.js", "../directive-helpers.js", "../async-directive.js", "./private-async-helpers.js"], function (_exports, _litHtml, _directive, _directiveHelpers, _asyncDirective, _privateAsyncHelpers) {
  ...
  var h = /*#__PURE__*/function (_r) {
    ...
    function h() {
      ...
      _this = _super.apply(this, arguments), _this._$Cft = 1073741823, _this._$Cwt = [], _this._$CG = new _privateAsyncHelpers.PseudoWeakRef(babelHelpers.assertThisInitialized(_this)), _this._$CK = new _privateAsyncHelpers.Pauser();
      return _this;
    }
    ...
    babelHelpers.createClass(h, [{
      ...
      value: function update(s, i) {
        ...
        var _loop = function _loop(_t) {
          ...
          _t < e && s === r[_t] || (_this2._$Cft = 1073741823, e = 0, Promise.resolve(s).then( /*#__PURE__*/function () {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      ...
                      if (void 0 !== i) {
                        _r2 = i._$Cwt.indexOf(s);
                        _r2 > -1 && _r2 < i._$Cft && (i._$Cft = _r2, i.setValue(t));
                      }
        ...
        for (var _t = 0; _t < i.length && !(_t > this._$Cft); _t++) {
          var _ret = _loop(_t);
