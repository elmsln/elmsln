  ...
  var u = function u(e, s, t) {
    ...
    babelHelpers.createClass(_class, [{
      ...
      value: function update(s, _ref) {
        ...
        if (!Array.isArray(a)) return this.ct = v, p;
        var h = null !== (d = this.ct) && void 0 !== d ? d : this.ct = [],
            m = [];
        var y,
            x,
            j = 0,
        ...
        return this.ct = v, (0, _directiveHelpers.setCommittedValue)(s, m), _litHtml.noChange;
      }
    }]);
    return _class;
