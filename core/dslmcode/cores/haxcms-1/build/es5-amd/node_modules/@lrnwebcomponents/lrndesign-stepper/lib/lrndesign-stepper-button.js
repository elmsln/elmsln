define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-button.js", "../../../@polymer/polymer/lib/elements/dom-if.js", "../../a11y-collapse/a11y-collapse.js"], function (_exports, _polymerElement, _simpleIcon, _simpleIcons, _simpleIconButton, _domIf, _a11yCollapse) {
  ...
  var _templateObject_fba905a01f0111edad7313f46a36d4d9;
  ...
  */
  var LrndesignStepperButton = /*#__PURE__*/function (_PolymerElement) {
    babelHelpers.inherits(LrndesignStepperButton, _PolymerElement);

    var _super = _createSuper(LrndesignStepperButton);
    ...
    babelHelpers.createClass(LrndesignStepperButton, [{
       ...
       */
      function hasCollapse(bool, test) {
        if (bool == test) {
          return true;
        } else {
          return false;
