...
function make_xlsx_lib(XLSX) {
  ...
  function ab2a(data) {
    ...
    if (babelHelpers.instanceof(data, ArrayBuffer)) return ab2a(new Uint8Array(data));
    ...
    */
    ...
    function general_fmt(v, opts) {
      switch (babelHelpers.typeof(v)) {
        ...
        case "object":
          if (v == null) return "";
          if (babelHelpers.instanceof(v, Date)) return format(14, datenum_local(v, opts && opts.date1904), opts);
      }
    ...
    function format(fmt, v, o) {
      ...
      switch (babelHelpers.typeof(fmt)) {
        case "string":
      ...
      if (babelHelpers.instanceof(v, Date)) v = datenum_local(v, o.date1904);
  ...
  function parseDate(str, fixdate) {
    ...
    if (babelHelpers.instanceof(str, Date)) return str;
  ...
  function dup(o) {
    ...
    if (babelHelpers.typeof(o) != "object" || o == null) return o;
    if (babelHelpers.instanceof(o, Date)) return new Date(o.getTime());
    var out = {};
  ...
  function write_vt(s, xlsx) {
    ...
    if (babelHelpers.instanceof(s, Date)) return writextag("vt:filetime", write_w3cdtf(s));
  ...
  function safe_format_cell(cell, v) {
    var q = cell.t == "d" && babelHelpers.instanceof(v, Date);
    if (cell.z != null) try {
  ...
  function sheet_add_aoa(_ws, data, opts) {
    ...
    for (var R = 0; R != data.length; ++R) {
      ...
      for (var C = 0; C != data[R].length; ++C) {
        ...
        if (data[R][C] && babelHelpers.typeof(data[R][C]) === "object" && !Array.isArray(data[R][C]) && !babelHelpers.instanceof(data[R][C], Date)) cell = data[R][C];else {
          ...
          } else if (typeof cell.v === "number") cell.t = "n";else if (typeof cell.v === "boolean") cell.t = "b";else if (babelHelpers.instanceof(cell.v, Date)) {
  ...
  var DBF = function () {
    ...
    function sheet_to_dbf(ws, opts) {
      ...
      for (i = 0; i < headers.length; ++i) {
        ...
        if (typeof headers[i] !== "string") throw new Error("DBF Invalid column name " + headers[i] + " |" + babelHelpers.typeof(headers[i]) + "|");
      ...
      for (i = 0; i <= range.e.c - range.s.c; ++i) {
        ...
        for (j = 0; j < col.length; ++j) {
          switch (babelHelpers.typeof(col[j])) {
            ...
            case "object":
              _guess = babelHelpers.instanceof(col[j], Date) ? "D" : "C";
              break;
    ...
    function dsv_to_sheet_str(str, opts) {
      ...
      function finish_cell() {
        ...
        if (s.length === 0) cell.t = "z";else if (o.raw) {
          ...
          if (o.cellText !== false) cell.w = SSF.format(cell.z, babelHelpers.instanceof(cell.v, Date) ? datenum(cell.v) : cell.v);
  ...
  */
  ...
  function parse_zip(zip, opts) {
    ...
    wsloop: for (i = 0; i != props.Worksheets; ++i) {
      ...
      if (opts && opts.sheets != null) switch (babelHelpers.typeof(opts.sheets)) {
        case "number":
  ...
  function readSync(data, opts) {
    reset_cp();
    if (typeof ArrayBuffer !== "undefined" && babelHelpers.instanceof(data, ArrayBuffer)) return readSync(new Uint8Array(data), opts);
    var d = data,
        n = [0, 0, 0, 0],
        str = false;
    var o = opts || {};
    ...
    if (o.type == "array" && typeof Uint8Array !== "undefined" && babelHelpers.instanceof(data, Uint8Array) && typeof ArrayBuffer !== "undefined") {
      // $FlowIgnore
  ...
  function writeFileAsync(filename, wb, opts, cb) {
    ...
    o.type = "buffer";
    var _cb = cb;
    if (!babelHelpers.instanceof(_cb, Function)) _cb = opts;
  ...
  function sheet_to_json(sheet, opts) {
    ...
    switch (babelHelpers.typeof(range)) {
      case "string":
  ...
  function sheet_add_json(_ws, js, opts) {
    ...
    js.forEach(function (JS, R) {
      keys(JS).forEach(function (k) {
        ...
        if (v && babelHelpers.typeof(v) === "object" && !babelHelpers.instanceof(v, Date)) {
          ws[ref] = v;
        } else {
          if (typeof v == "number") t = "n";else if (typeof v == "boolean") t = "b";else if (typeof v == "string") t = "s";else if (babelHelpers.instanceof(v, Date)) {
            t = "d";
