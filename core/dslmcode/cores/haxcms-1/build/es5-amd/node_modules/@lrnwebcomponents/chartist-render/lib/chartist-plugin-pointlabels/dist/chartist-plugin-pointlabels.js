  ...
  (function (window, document, Chartist) {
    ...
    Chartist.plugins.ctPointLabels = function (options) {
      ...
      function addLabel(position, data) {
        ...
        var value = data.value.x !== undefined && data.value.y ? data.value.x + ", " + data.value.y : data.value.y || data.value.x;
      ...
      return function ctPointLabels(chart) {
        if (babelHelpers.instanceof(chart, Chartist.Line) || babelHelpers.instanceof(chart, Chartist.Bar)) {
