define(["exports","../../../../@vaadin/router/dist/vaadin-router.js","../../../../mobx/lib/mobx.module.js","./haxcms-site-store.js"],function(_exports,_vaadinRouter,_mobxModule,_haxcmsSiteStore){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HAXCMSSiteRouter=void 0;/**
 * `haxcms-site-router`
 * `front-end router for haxcms`
 */var HAXCMSSiteRouter=/*#__PURE__*/function(_HTMLElement){babelHelpers.inherits(HAXCMSSiteRouter,_HTMLElement);babelHelpers.createClass(HAXCMSSiteRouter,null,[{key:"tag",/**
...
_haxcmsSiteStore.store.location=e.detail.location}}]);return HAXCMSSiteRouter}(babelHelpers.wrapNativeSuper(HTMLElement));_exports.HAXCMSSiteRouter=HAXCMSSiteRouter;window.customElements.define(HAXCMSSiteRouter.tag,HAXCMSSiteRouter)});