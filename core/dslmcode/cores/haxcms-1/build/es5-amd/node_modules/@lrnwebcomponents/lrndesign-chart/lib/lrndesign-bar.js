define(["exports", "../../../@polymer/polymer/polymer-element.js", "./lrndesign-chart-behaviors.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../hax-body-behaviors/lib/HAXWiring.js"], function (_exports, _polymerElement, _lrndesignChartBehaviors, _renderStatus, _HAXWiring) {
  ...
  function (_LrndesignChartBehavi) {
    babelHelpers.inherits(LrndesignBar, _LrndesignChartBehavi);

    function LrndesignBar() {
      babelHelpers.classCallCheck(this, LrndesignBar);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrndesignBar).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(LrndesignBar, [{
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignBar.prototype), "connectedCallback", this).call(this);
