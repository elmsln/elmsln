...
window.location.href=this.basePath+"lrnapp-studio-submission/submissions/"+active}/**
   ...
   */},{key:"_toArray",value:function _toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_eb09db407a9c11ea8ed6ed8c9eef0ab1())}},{key:"tag",get:function get(){return"lrnapp-open-studio-table"}},{key:"properties",get:function get(){var _ref;return _ref={elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},/**
       * The submissions to render
       */submissions:{type:Array,notify:!0},_numWidth:{type:String,value:"2.25em"},/**
       * Endpoint for submission data.
       */sourcePath:{type:String,notify:!0}},babelHelpers.defineProperty(_ref,"basePath",{type:String,notify:!0}),babelHelpers.defineProperty(_ref,"activeSubmission",{type:String,value:null,notify:!0}),_ref}}]);return LrnappOpenStudioTable}(_polymerElement.PolymerElement);_exports.LrnappOpenStudioTable=LrnappOpenStudioTable;window.customElements.define(LrnappOpenStudioTable.tag,LrnappOpenStudioTable)});