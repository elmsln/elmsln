define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../hax-body-behaviors/lib/HAXWiring.js", "../simple-colors/simple-colors.js"], function (_exports, _require, _polymerElement, _renderStatus, _HAXWiring, _simpleColors) {
  ...
  function _templateObject_bd2b4d90aa5311e9b999174ecd579fc6() {
    ...
    _templateObject_bd2b4d90aa5311e9b999174ecd579fc6 = function _templateObject_bd2b4d90aa5311e9b999174ecd579fc6() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    function PersonTestimonial() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(PersonTestimonial).call(this));
      ...
      new Promise(function (res, rej) {
        return _require.default(["./lib/person-testimonial-icon.js"], res, rej);
      });
      (0, _renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(_this), function () {
        this.HAXWiring = new _HAXWiring.HAXWiring();
        this.HAXWiring.setup(PersonTestimonial.haxProperties, PersonTestimonial.tag, this);
      });
      return _this;
    }
    ...
    babelHelpers.createClass(PersonTestimonial, null, [{
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_bd2b4d90aa5311e9b999174ecd579fc6());
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(PersonTestimonial), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(PersonTestimonial), "properties", this));
        }
