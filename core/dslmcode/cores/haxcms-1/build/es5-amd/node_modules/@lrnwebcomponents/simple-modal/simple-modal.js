define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../@polymer/polymer/lib/utils/async.js", "../../@polymer/paper-dialog/paper-dialog.js"], function (_exports, _require, _polymerElement, _renderStatus, _polymerDom, _async, _paperDialog) {
  "use strict";
  ...
  function _templateObject_6c3f0b80b54611e9b6ba27231b6f684a() {
    ...
    _templateObject_6c3f0b80b54611e9b6ba27231b6f684a = function _templateObject_6c3f0b80b54611e9b6ba27231b6f684a() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(SimpleModal, null, [{
      key: "template",
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_6c3f0b80b54611e9b6ba27231b6f684a());
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(SimpleModal), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(SimpleModal), "properties", this));
        }
    ...
    function SimpleModal() {
      ...
      new Promise(function (res, rej) {
        return _require.default(["../../@polymer/neon-animation/animations/scale-up-animation.js"], res, rej);
      });
      new Promise(function (res, rej) {
        return _require.default(["../../@polymer/neon-animation/animations/fade-out-animation.js"], res, rej);
      });
      return _this;
    }
    /**
    ...
    babelHelpers.createClass(SimpleModal, [{
      ...
      value: function showEvent(e) {
        ...
        if (this.opened) {
          ...
          setTimeout(function () {
            _this2.show(e.detail.title, e.detail.elements, e.detail.invokedBy, e.detail.id, e.detail.modalClass, e.detail.styles, e.detail.clone, e.detail.modal);
          }, 100);
        } else {
      ...
      value: function show(title, elements, invokedBy) {
        ...
        if (styles) {
          ["--simple-modal-width", "--simple-modal-height", "--simple-modal-min-width", "--simple-modal-min-height", "--simple-modal-max-width", "--simple-modal-max-height", "--simple-modal-titlebar-color", "--simple-modal-titlebar-background", "--simple-modal-header-color", "--simple-modal-header-background", "--simple-modal-content-container-color", "--simple-modal-content-container-background", "--simple-modal-buttons-color", "--simple-modal-buttons-background", "--simple-modal-button-color", "--simple-modal-button-background"].forEach(function (prop) {
            _this3.style.setProperty(prop, styles[prop] || "unset");
          });
        }
      ...
      value: function disconnectedCallback() {
        ...
        this.shadowRoot.querySelector("#simple-modal-content").removeEventListener("neon-animation-finish", this._ironOverlayClosed.bind(this));
