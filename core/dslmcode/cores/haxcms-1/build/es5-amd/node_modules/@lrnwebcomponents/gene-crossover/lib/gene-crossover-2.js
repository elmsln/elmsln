define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../lrndesign-animationctrl/lrndesign-animationctrl.js", "./TweenMax.min.js"], function (_exports, _polymerElement, _lrndesignAnimationctrl, _TweenMaxMin) {
  ...
  _exports.GeneCrossover2 = void 0;

  function _templateObject_3b5476b0dbdc11e9bcafdb98156fc1d6() {
    ...
    _templateObject_3b5476b0dbdc11e9bcafdb98156fc1d6 = function _templateObject_3b5476b0dbdc11e9bcafdb98156fc1d6() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(GeneCrossover2, _PolymerElement);

    function GeneCrossover2() {
      babelHelpers.classCallCheck(this, GeneCrossover2);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(GeneCrossover2).apply(this, arguments));
    }

    babelHelpers.createClass(GeneCrossover2, [{
      ...
      value: function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(GeneCrossover2.prototype), "ready", this).call(this);
        var root = this;
        ...
        var synapsetext = svg.getElementById("synapsetext"); // Right
        ...
        var setonerightone = svg.getElementById("setonerightone"); // Left
        ...
        var setoneleftone = svg.getElementById("setoneleftone"); // Set Animate

        tl.set([setoneleftfour, setoneleftthree, setonelefttwo, setonerightfour, setonerightthree, setonerighttwo], {
          display: "none"
        }); //Animate Start
        ...
        lefttl.to([setonelefttwo], 0.1, babelHelpers.defineProperty({
          x: "+=10",
          display: "block"
        }, "display", "none")).to([setoneleftthree], 0.3, babelHelpers.defineProperty({
          x: "+=10",
          display: "block"
        }, "display", "none")).to([setoneleftfour], 0.3, {
          x: "+=10",
          display: "block"
        }); // Animate Right

        righttl.to([setonerighttwo], 0.1, babelHelpers.defineProperty({
          x: "-=10",
          display: "block"
        }, "display", "none")).to([setonerightthree], 0.3, babelHelpers.defineProperty({
          x: "-=10",
          display: "block"
        }, "display", "none")).to([setonerightfour], 0.3, {
          x: "-=10",
          display: "block"
        });
        this.tl = tl;
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_3b5476b0dbdc11e9bcafdb98156fc1d6());
      }
    }, {
      key: "tag",
      get: function get() {
        return "gene-crossover-2";
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    return GeneCrossover2;
  }(_polymerElement.PolymerElement);

  _exports.GeneCrossover2 = GeneCrossover2;
  window.customElements.define(GeneCrossover2.tag, GeneCrossover2);
});