  ...
  _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (t, e, i) {
    ...
    var c = function c(t, e) {
      for (var s = [], r = 0, n = t._first; n;) {
        babelHelpers.instanceof(n, i) ? s[r++] = n : (e && (s[r++] = n), s = s.concat(c(n, e)), r = s.length), n = n._next;
      }
    ...
    n.killAll = function (t, i, s, r) {
      ...
      for (o = 0; h > o; o++) {
        a = l[o], (_ || babelHelpers.instanceof(a, e) || (n = a.target === a.vars.onComplete) && s || i && !n) && (t ? a.totalTime(a._reversed ? 0 : a.totalDuration()) : a._enabled(!1, !1));
      }
    ...
    var p = function p(t, i, s, r) {
      ...
      for (var n, a, o = f(r), l = i && s && r, h = o.length; --h > -1;) {
        a = o[h], (l || babelHelpers.instanceof(a, e) || (n = a.target === a.vars.onComplete) && s || i && !n) && a.paused(t);
      }
    };
    ...
    return s.version = "1.18.0", d.constructor = s, d.kill()._gc = d._forcingPlayhead = d._hasPause = !1, d.to = function (t, e, s, r) {
      ...
      for (null == e && (e = !0), o._remove(a, !0), a._startTime = 0, a._rawPrevTime = a._time = a._totalTime = o._time, r = o._first; r;) {
        n = r._next, e && babelHelpers.instanceof(r, i) && r.target === r.vars.onComplete || a.add(r, r._startTime - r._delay), r = n;
      }
      ...
      if ("number" != typeof n && (n = this._parseTimeOrLabel(n, 0, !0, r)), !babelHelpers.instanceof(r, t)) {
        if (babelHelpers.instanceof(r, Array) || r && r.push && l(r)) {
      ...
      if (babelHelpers.instanceof(e, t)) {
        this._remove(e, !1);
      ...
      if (babelHelpers.instanceof(e, Array) || e && e.push && l(e)) {
      ...
      var n;
      if (babelHelpers.instanceof(r, t) && r.timeline === this) this.remove(r);else if (r && (babelHelpers.instanceof(r, Array) || r.push && l(r))) for (n = r.length; --n > -1;) {
        babelHelpers.instanceof(r[n], t) && r[n].timeline === this && this.remove(r[n]);
      }
      ...
      for (var t = this._first; t;) {
        if (t._paused || babelHelpers.instanceof(t, s) && t._hasPausedChild()) return !0;
        t = t._next;
      }
      ...
      for (var n = [], a = this._first, o = 0; a;) {
        r > a._startTime || (babelHelpers.instanceof(a, i) ? e !== !1 && (n[o++] = a) : (s !== !1 && (n[o++] = a), t !== !1 && (n = n.concat(a.getChildren(!0, e, s)), o = n.length))), a = a._next;
      }
    ...
    var t = 180 / Math.PI,
      ...
      init: function init(t, e, i) {
        this._target = t, babelHelpers.instanceof(e, Array) && (e = {
          values: e
        ...
        this._autoRotate = f ? babelHelpers.instanceof(f, Array) ? f : [["x", "y", "rotation", f === !0 ? 0 : Number(f) || 0]] : null;
        ...
        if (f = this._autoRotate) for (this._initialRotations = [], babelHelpers.instanceof(f[0], Array) || (this._autoRotate = f = [f]), n = f.length; --n > -1;) {
          for (a = 0; 3 > a; a++) {
      ...
      if (t) {
        ...
        e._registerComplexSpecialProp("bezier", {
          parser: function parser(t, e, n, a, o, l) {
            babelHelpers.instanceof(e, Array) && (e = {
              values: e
            }), l = new m();
            ...
            return d.values = p, o = new r(t, "bezier", 0, 0, u.pt, 2), o.data = u, o.plugin = l, o.setRatio = s, 0 === d.autoRotate && (d.autoRotate = !0), !d.autoRotate || babelHelpers.instanceof(d.autoRotate, Array) || (h = d.autoRotate === !0 ? 0 : Number(d.autoRotate), d.autoRotate = null != u.end.left ? [["left", "top", "rotation", h, !1]] : null != u.end.x ? [["x", "y", "rotation", h, !1]] : !1), d.autoRotate && (a._transform || a._enableTransforms(!1), u.autoRotate = a._target._gsTransform), l._onInitTween(u.proxy, d, a._tween), o;
          }
        });
      }
    ...
    var ce = function ce(t, e, i, s) {
      ...
      this.t = t, this.p = e, this.s = s, this.c = r, this.n = l || e, babelHelpers.instanceof(t, me) || n.push(this.n), this.r = h, this.type = o || 0, _ && (this.pr = _, i = !0), this.b = void 0 === u ? s : u, this.e = void 0 === c ? s + r : c, a && (this._next = a, a._prev = this);
    }),
    ...
    var ye = function ye(t, e) {
      ...
      "object" != babelHelpers.typeof(e) && (e = {
        parser: i
      });
      var s,
          r,
    ...
    h = Oe.prototype, h.x = h.y = h.z = h.skewX = h.skewY = h.rotation = h.rotationX = h.rotationY = h.zOrigin = h.xPercent = h.yPercent = h.xOffset = h.yOffset = 0, h.scaleX = h.scaleY = h.scaleZ = 1, Te("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin", {
      parser: function parser(t, e, i, s, n, o, l) {
        ...
        if (l.display ? (c = Q(t, "display"), T.display = "block", h = Ne(t, r, !0, l.parseTransform), T.display = c) : h = Ne(t, r, !0, l.parseTransform), s._transform = h, "string" == typeof b.transform && Pe) c = L.style, c[Pe] = b.transform, c.display = "block", c.position = "absolute", E.body.appendChild(L), _ = Ne(L, null, !1), E.body.removeChild(L), _.perspective || (_.perspective = h.perspective), null != b.xPercent && (_.xPercent = ne(b.xPercent, h.xPercent)), null != b.yPercent && (_.yPercent = ne(b.yPercent, h.yPercent));else if ("object" == babelHelpers.typeof(b)) {
          ...
          }, d = b.directionalRotation, null != d) if ("object" == babelHelpers.typeof(d)) for (c in d) {
            b[c] = d[c];
          } else b.rotation = d;
    ...
    return d.constructor = m, d.getRatio = function (t) {
      ...
      for (var i, s, r, n, a, o, l = e.taper || "none", h = [], _ = 0, u = 0 | (e.points || 20), f = u, p = e.randomize !== !1, m = e.clamp === !0, d = babelHelpers.instanceof(e.template, t) ? e.template : null, g = "number" == typeof e.strength ? .4 * e.strength : .4; --f > -1;) {
  ...
  if (!i.TweenLite) {
    var s,
      ...
      var t = Object.prototype.toString,
          e = t.call([]);
      return function (i) {
        return null != i && (babelHelpers.instanceof(i, Array) || "object" == babelHelpers.typeof(i) && !!i.push && t.call(i) === e);
      };
    }(),
        p = {},
    ...
    var D = g("TweenLite", function (e, i, s) {
      ...
      if (this._overwrite = l = null == l ? V[D.defaultOverwrite] : "number" == typeof l ? l >> 0 : V[l], (o || babelHelpers.instanceof(e, Array) || e.push && f(e)) && "number" != typeof e[0]) for (this._targets = a = u(e), this._propLookup = [], this._siblings = [], r = 0; a.length > r; r++) {
    ...
    n._init = function () {
      ...
      for (n in this.vars) {
        if (_ = this.vars[n], q[n]) _ && (babelHelpers.instanceof(_, Array) || _.push && f(_)) && -1 !== _.join("").indexOf("{self}") && (this.vars[n] = _ = this._swapSelfInParams(_, this));else if (j[n] && (l = new j[n]())._onInitTween(e, this.vars[n], this)) {
          for (this._firstPT = h = {
            _next: this._firstPT,
            t: l,
            p: "setRatio",
      ...
      if ((f(e) || M(e)) && "number" != typeof e[0]) for (s = e.length; --s > -1;) {
        ...
        if (o) {
          if (h = t || o, _ = t !== r && "all" !== r && t !== o && ("object" != babelHelpers.typeof(t) || !t._tempKill), i && (D.onOverwrite || this.vars.onOverwrite)) {
            for (n in h) {
              o[n] && (u || (u = []), u.push(n));
            }
      ...
      "object" == babelHelpers.typeof(e) && (i = e, e = !1);
