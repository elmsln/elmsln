define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../simple-colors/simple-colors.js", "../../schema-behaviors/schema-behaviors.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../chartist-render/chartist-render.js"], function (_exports, _polymerElement, _simpleColors, _schemaBehaviors, _ironAjax, _chartistRender) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.LrndesignChartBehaviors = void 0;

  function _templateObject_0d62f020e48211e9b5c6f7b0a264592f() {
    ...
    _templateObject_0d62f020e48211e9b5c6f7b0a264592f = function _templateObject_0d62f020e48211e9b5c6f7b0a264592f() {
      return data;
    };
   ...
   *
   */
  var LrndesignChartBehaviors =
  /*#__PURE__*/
  function (_SchemaBehaviors) {
    babelHelpers.inherits(LrndesignChartBehaviors, _SchemaBehaviors);

    function LrndesignChartBehaviors() {
      babelHelpers.classCallCheck(this, LrndesignChartBehaviors);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrndesignChartBehaviors).apply(this, arguments));
    }

    babelHelpers.createClass(LrndesignChartBehaviors, [{
      key: "ready",
      ...
      value: function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignChartBehaviors.prototype), "ready", this).call(this);
        var root = this;
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_0d62f020e48211e9b5c6f7b0a264592f());
    ...
    return LrndesignChartBehaviors;
  }((0, _schemaBehaviors.SchemaBehaviors)(_simpleColors.SimpleColors));

  _exports.LrndesignChartBehaviors = LrndesignChartBehaviors;
  window.customElements.define(LrndesignChartBehaviors.tag, LrndesignChartBehaviors);
});