define(["exports", "meta", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/polymer/lib/utils/resolve-url.js", "../simple-colors/simple-colors.js", "../hax-body-behaviors/lib/HAXWiring.js", "../schema-behaviors/schema-behaviors.js", "../../@polymer/paper-styles/shadow.js"], function (_exports, meta, _polymerElement, _renderStatus, _resolveUrl, _simpleColors, _HAXWiring, _schemaBehaviors, _shadow) {
  "use strict";
  ...
  function _templateObject_8bed6830aa5311e9b999174ecd579fc6() {
    ...
    _templateObject_8bed6830aa5311e9b999174ecd579fc6 = function _templateObject_8bed6830aa5311e9b999174ecd579fc6() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    function LrndesignBlockquote() {
      ...
      (0, _renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(_this), function () {
        ...
        this.HAXWiring.setup(LrndesignBlockquote.haxProperties, LrndesignBlockquote.tag, this);
      });
      return _this;
    }
    ...
    babelHelpers.createClass(LrndesignBlockquote, [{
       ...
       */
      value: function _imageChanged(newValue, oldValue) {
        if (this.displayMode == "hypercard") {
          this.$.wrap.style.cssText = "";
          this.$.thumb.style.cssText = "";
        } else if (this.displayMode == "poster") {
          this.$.wrap.style.cssText = "background: #444 url(" + newValue + ") no-repeat 140% 25%";
          this.$.thumb.style.cssText = "";
        } else {
          this.$.wrap.style.cssText = "";
          this.$.thumb.style.cssText = "background: url(" + newValue + ") no-repeat center center";
        }
      }
      /**
       * Notice display mode change activated so load the font
      ...
      value: function _displayModeChanged(newValue, oldValue) {
        if (newValue == "hypercard") {
          ...
          this.$.wrap.style.cssText = "background: #444 url(" + this.image + ") no-repeat 140% 25%";
          this.$.thumb.style.cssText = "";
        } else {
          this.$.wrap.style.cssText = "";
          this.$.thumb.style.cssText = "background: url(" + this.image + ") no-repeat center center";
        }
      }
    }], [{
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_8bed6830aa5311e9b999174ecd579fc6());
      }
    }, {
      key: "tag",
      get: function get() {
