 ...
 */var PieMenu=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(PieMenu,_PolymerElement);function PieMenu(){var _this;babelHelpers.classCallCheck(this,PieMenu);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PieMenu).call(this));new Promise(function(res,rej){return _require.default(["../../@polymer/iron-icons/iron-icons.js"],res,rej)});return _this}babelHelpers.createClass(PieMenu,[{key:"ready",/**
   * add listeners for data-buttons
   */value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(PieMenu.prototype),"ready",this).call(this);for(var buttons=this.querySelectorAll("[role=\"button\"][data-button]"),i=0;i<buttons.length;i++){this._addListenerAddState(this,buttons[i],"mouseover","hover");this._addListenerAddState(this,buttons[i],"focus","focus");this._addListenerRemoveState(this,buttons[i],"mouseout","hover");this._addListenerRemoveState(this,buttons[i],"blur","focus")}}/**
   * add focus or hover states
   */},{key:"_addListenerAddState",value:function _addListenerAddState(menu,button,action,state){button.addEventListener(action,function(e){for(var elements=menu._getButtonElements(menu,button),i=0;i<elements.length;i++){elements[i].classList.add(state)}})}/**
   * remove focus or hover states
   */},{key:"_addListenerRemoveState",value:function _addListenerRemoveState(menu,button,action,state){button.addEventListener(action,function(e){for(var elements=menu._getButtonElements(menu,button),i=0;i<elements.length;i++){elements[i].classList.remove(state)}})}},{key:"_getButtonElements",value:function _getButtonElements(menu,button){return menu.querySelectorAll("[data-button=\""+button.getAttribute("data-button")+"\"]")}/**
   * Simple trap for bubbling up a tap / click event.
   */},{key:"_itemTapped",value:function _itemTapped(e){var normalizedEvent=(0,_polymerDom.dom)(e),localLink=normalizedEvent.localTarget;// make sure we normalize tap vs click vs keyboard
if(!(localLink.hasAttribute("role")&&"button"!==localLink.getAttribute("role"))){localLink=localLink.parentNode}// bubble up event
this.dispatchEvent(new CustomEvent("pie-menu-selection",{bubbles:!0,cancelable:!0,composed:!0,detail:{option:localLink}}))}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_6ef5a820a4c011e993314ff97b5a3737())}},{key:"tag",get:function get(){return"pie-menu"}},{key:"properties",get:function get(){return{/**
       ...
       * right button label
       */rightIcon:{type:String,value:"icons:check-box-outline-blank"}}}}]);return PieMenu}(_polymerElement.PolymerElement);_exports.PieMenu=PieMenu;window.customElements.define(PieMenu.tag,PieMenu)});