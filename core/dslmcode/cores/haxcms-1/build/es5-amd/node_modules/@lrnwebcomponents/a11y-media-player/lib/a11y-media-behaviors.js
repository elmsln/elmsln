define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../simple-colors/lib/simple-colors-polymer.js", "../../responsive-utility/responsive-utility.js"], function (_exports, _polymerElement, _simpleColorsPolymer, _responsiveUtility) {
  ...
  function (_SimpleColorsPolymer) {
    babelHelpers.inherits(A11yMediaBehaviors, _SimpleColorsPolymer);
    ...
    babelHelpers.createClass(A11yMediaBehaviors, [{
       ...
       */
      value: function _getShareLink(__elapsed) {
        var url = window.location.href.split(/[#?]/)[0],
            id = this.id ? "?id=".concat(this.id) : "",
            elapsed = id !== "" && this.__elapsed && this.__elapsed !== 0 ? "&t=".concat(this.__elapsed) : "";
        return "".concat(url).concat(id).concat(elapsed);
      }
      /**
      ...
      key: "properties",
      get: function get() {
        return Object.assign(_simpleColorsPolymer.SimpleColorsPolymer.properties, {
          /**
