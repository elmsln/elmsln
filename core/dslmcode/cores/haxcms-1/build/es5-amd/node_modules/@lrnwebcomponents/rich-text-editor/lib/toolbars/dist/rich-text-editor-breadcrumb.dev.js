...
function _templateObject2_d1af0a90f3b211eb88505306830c8694() {
  var data = _taggedTemplateLiteral(["\n        #button {\n          font-family: monospace;\n          display: inline-block;\n          text-align: center;\n          min-width: 25px;\n          margin: 0;\n          padding: 2px 5px;\n        }\n\xA0\xA0\xA0\xA0\xA0\xA0"]);

  _templateObject2_d1af0a90f3b211eb88505306830c8694 = function _templateObject2_d1af0a90f3b211eb88505306830c8694() {
    return data;
  };
...
function _templateObject_d1af0a90f3b211eb88505306830c8694() {
  var data = _taggedTemplateLiteral(['\n      <button\n        id="button"\n        aria-controls="', '"\n        @click="', '"\n        tabindex="0"\n      >\n        ', "\n      </button>\n    "]);

  _templateObject_d1af0a90f3b211eb88505306830c8694 = function _templateObject_d1af0a90f3b211eb88505306830c8694() {
    return data;
  };
...
var RichTextEditorBreadcrumb = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(RichTextEditorBreadcrumb, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_d1af0a90f3b211eb88505306830c8694(), this.controls, this._handleClick, this.label);
    }
  }], [{
    key: "tag",
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_richTextEditorButton.RichTextStyles), [(0, _litElement.css)(_templateObject2_d1af0a90f3b211eb88505306830c8694())]);
    }
  }, {
    key: "properties",
    get: function get() {
