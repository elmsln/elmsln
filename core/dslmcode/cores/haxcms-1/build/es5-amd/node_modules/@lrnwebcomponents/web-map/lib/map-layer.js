define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/legacy/polymer.dom.js","./map-styles.js"],function(_exports,_polymerElement,_polymerDom,_mapStyles){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MapLayer=void 0;function _templateObject_218adf40984711e9810e6d9eee9273ff(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style include=\"map-styles\">\n        :host {\n          display: none;\n        }\n      </style>\n      <!-- hide any feature, image or tile elements the author includes -->\n      <slot></slot>\n    "]);_templateObject_218adf40984711e9810e6d9eee9273ff=function _templateObject_218adf40984711e9810e6d9eee9273ff(){return data};return data}/* styles scoped to inside a custom element must be in a style module */var MapLayer=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(MapLayer,_PolymerElement);function MapLayer(){babelHelpers.classCallCheck(this,MapLayer);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MapLayer).apply(this,arguments))}babelHelpers.createClass(MapLayer,[{key:"_srcChanged",value:function _srcChanged(){// this should only be invoked after the ready callback
if(this._layer){this._layer.initialize(this.src,this)}}},{key:"_labelChanged",value:function _labelChanged(){var map=this.parentElement&&this.parentElement._map;if(map){this._toggleHidden(!1)}}},{key:"_toggleChecked",value:function _toggleChecked(){var map=this.parentElement&&this.parentElement._map;if(map){if(this._apiToggleChecked){if(map.hasLayer(this._layer)){map.removeLayer(this._layer)}else{map.addLayer(this._layer)}this._validateDisabled()}this._apiToggleChecked=!0}}},{key:"_onLayerExtentLoad",value:function _onLayerExtentLoad(e){// the mapml document associated to this layer can in theory contain many
...
if(this._layer._map){this._layer.dispatchEvent(new CustomEvent("attached",{bubbles:!0,cancelable:!0,composed:!0,detail:!0}))}}},{key:"_validateDisabled",value:function _validateDisabled(){var layer=this._layer,map=layer._map;if(map){var zoomBounds=layer.getZoomBounds(),zoom=map.getZoom(),withinZoomBounds=zoomBounds&&zoomBounds.min<=zoom&&zoom<=zoomBounds.max,projectionMatches=layer._projectionMatches(map),visible=projectionMatches&&withinZoomBounds&&map.getPixelBounds().intersects(layer.getLayerExtentBounds(map));this.disabled=!visible}}},{key:"_onLayerChange",value:function _onLayerChange(){if(this._layer._map){// can't disable observers, have to set a flag telling it where
// the 'event' comes from: either the api or a user click/tap
this._apiToggleChecked=!1;this.checked=this._layer._map.hasLayer(this._layer)}}},{key:"_toggleHidden",value:function _toggleHidden(hide){var map=this.parentElement&&this.parentElement._map;if(map&&this.parentElement.controls){if(hide){this.parentElement._layerControl.removeLayer(this._layer)}else{this._layerControl=this.parentElement._layerControl;this._layerControl.addOrUpdateOverlay(this._layer,this.label)}this._validateDisabled()}}},{key:"disconnectedCallback",value:function disconnectedCallback(){// if the map-layer node is removed from the dom, the layer should be
// removed from the map and the layer control
if(this._layer._map){this._layer._map.removeLayer(this._layer)}if(this._layerControl&&!this.hidden){this._layerControl.removeLayer(this._layer)}this._removeEvents();babelHelpers.get(babelHelpers.getPrototypeOf(MapLayer.prototype),"disconnectedCallback",this).call(this)}},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(MapLayer.prototype),"ready",this).call(this);// the layer might not be attached to a map
...
// See issue #26
this._layer._map.dispatchEvent(new CustomEvent("moveend",{bubbles:!0,cancelable:!0,composed:!0,detail:!0}))}},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(MapLayer.prototype),"connectedCallback",this).call(this);if("MAP"!==(0,_polymerDom.dom)(this).parentNode.nodeName){console.log("ERROR: "+this.localName+"#"+this.id+" must be a child of a map element");return}// if the map has been attached, set this layer up wrt Leaflet map
if((0,_polymerDom.dom)(this).parentNode._map){this._attachedToMap()}}},{key:"_removeEvents",value:function _removeEvents(){if(this._layer){this._layer.off("loadstart",!1,this)}}},{key:"_setUpEvents",value:function _setUpEvents(){var _this=this;this._layer.on("loadstart",function(){_this.dispatchEvent(new CustomEvent("loadstart",{bubbles:!0,cancelable:!0,composed:!0,detail:{target:_this}}))},this)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_218adf40984711e9810e6d9eee9273ff())}},{key:"tag",get:function get(){return"map-layer"}},{key:"properties",get:function get(){return{_apiToggleChecked:!0,src:{type:String,reflectToAttribute:!0,observer:"_srcChanged"},label:{type:String,value:"Layer",reflectToAttribute:!0,observer:"_labelChanged"},// changing checked turns the layer on or off, and reflects that in the
...
value:function value(){return[]}}}}}]);return MapLayer}(_polymerElement.PolymerElement);_exports.MapLayer=MapLayer;window.customElements.define(MapLayer.tag,MapLayer)});