...
(function () {
  var d = !1,
      l = function l(e) {
    return babelHelpers.instanceof(e, l) ? e : babelHelpers.instanceof(this, l) ? void (this.EXIFwrapped = e) : new l(e);
  };
  ...
  function r(i, o) {
    ...
    if (i.src) {
      if (/^data\:/i.test(i.src)) t(function (e, t) {
        ...
        return i;
      }(i.src));else if (/^blob\:/i.test(i.src)) {
    ...
    } else if (self.FileReader && (babelHelpers.instanceof(i, self.Blob) || babelHelpers.instanceof(i, self.File))) {
      var s;
      (s = new FileReader()).onload = function (e) {
  ...
  function S(e, t, n) {
    for (var r, i, o, a, s = new DataView(e), l = {}, u = t; u < t + n;) {
      28 === s.getUint8(u) && 2 === s.getUint8(u + 1) && (a = s.getUint8(u + 2)) in h && ((o = s.getInt16(u + 3)) + 5, i = h[a], r = y(s, u + 5, o), l.hasOwnProperty(i) ? babelHelpers.instanceof(l[i], Array) ? l[i].push(r) : l[i] = [l[i], r] : l[i] = r), u++;
    }
  ...
  function o(e, t) {
    ...
    if ((r = P(e, s, s + l, c, n)).ExifIFDPointer) for (i in o = P(e, s, s + r.ExifIFDPointer, u, n)) {
      switch (i) {
        case "LightSource":
        case "Flash":
        case "MeteringMode":
    ...
    if (r.GPSInfoIFDPointer) for (i in a = P(e, s, s + r.GPSInfoIFDPointer, f, n)) {
      switch (i) {
        case "GPSVersionID":
  ...
  function x(e) {
    try {
      var t = {};
      if (0 < e.children.length) for (var n = 0; n < e.children.length; n++) {
  ...
  l.enableXmp = function () {
    ...
    return !((self.Image && babelHelpers.instanceof(e, self.Image) || self.HTMLImageElement && babelHelpers.instanceof(e, self.HTMLImageElement)) && !e.complete) && (i(e) ? t && t.call(e) : r(e, t), !0);
    ...
    for (t in n) {
      n.hasOwnProperty(t) && ("object" == babelHelpers.typeof(n[t]) ? babelHelpers.instanceof(n[t], Number) ? r += t + " : " + n[t] + " [" + n[t].numerator + "/" + n[t].denominator + "]\r\n" : r += t + " : [" + n[t].length + " values]\r\n" : r += t + " : " + n[t] + "\r\n");
    }
...
}).call(this); //# sourceMappingURL=/sm/4f4f84956292156efc04b79e1131dc7c3a51794b7b3d62b43ed5eaca1b36d71e.map