define(["exports", "require", "../../../../../lit/index.js", "../../../../utils/utils.js"], function (_exports, _require, _index, _utils) {
  ...
  var _templateObject_50441ff001d011ecbeb6e9a2c14ad660, _templateObject2_50441ff001d011ecbeb6e9a2c14ad660;
  ...
  var HAXCMSUserStylesMenuMixin = function HAXCMSUserStylesMenuMixin(SuperClass) {
    return /*#__PURE__*/function (_SuperClass) {
      ...
      function _class() {
        ...
        _this.fontSize = window.localStorage.getItem("haxcms-userPref-fontSize") ? window.localStorage.getItem("haxcms-userPref-fontSize") : 1;
        _this.fontFamily = window.localStorage.getItem("haxcms-userPref-fontFamily") ? window.localStorage.getItem("haxcms-userPref-fontFamily") : 0;
        _this.colorTheme = window.localStorage.getItem("haxcms-userPref-colorTheme") ? window.localStorage.getItem("haxcms-userPref-colorTheme") : 0;
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function UserStylesFontFamilyChange(e) {
          ...
          window.localStorage.setItem("haxcms-userPref-fontFamily", this.fontFamily);
        }
      }, {
        ...
        value: function UserStylesColorThemeChange(e) {
          ...
          window.localStorage.setItem("haxcms-userPref-colorTheme", this.colorTheme);
        }
      }], [{
        key: "styles",
        get: function get() {
