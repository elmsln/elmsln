define(["exports", "require", "../../../../../lit/index.js", "../../../../utils/utils.js"], function (_exports, _require, _index, _utils) {
  ...
  var _templateObject_e157131010c311ec839617f030a92afb, _templateObject2_e157131010c311ec839617f030a92afb;
  ...
  var HAXCMSUserStylesMenuMixin = function HAXCMSUserStylesMenuMixin(SuperClass) {
    return /*#__PURE__*/function (_SuperClass) {
      ...
      function _class() {
        ...
        _this.fontSize = window.localStorageGet("haxcms-userPref-fontSize") ? window.localStorageGet("haxcms-userPref-fontSize") : 1;
        _this.fontFamily = window.localStorageGet("haxcms-userPref-fontFamily") ? window.localStorageGet("haxcms-userPref-fontFamily") : 0;
        _this.colorTheme = window.localStorageGet("haxcms-userPref-colorTheme") ? window.localStorageGet("haxcms-userPref-colorTheme") : 0;
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function HAXCMSUserStylesMenu() {
          ...
          return (0, _index.html)(_templateObject_e157131010c311ec839617f030a92afb || (_templateObject_e157131010c311ec839617f030a92afb = babelHelpers.taggedTemplateLiteral(["\n        <simple-icon-button-lite\n          .part=\"", "\"\n          class=\"btn\"\n          aria-label=\"Text settings\"\n          icon=\"editor:format-size\"\n          @click=\"", "\"\n          id=\"haxcmsuserstylesmenupopover\"\n        ></simple-icon-button-lite>\n        <simple-tooltip for=\"haxcmsuserstylesmenupopover\">\n          Text settings\n        </simple-tooltip>\n        <simple-popover\n          class=\"hcusm pull-left font-settings js-toolbar-action hcusm-settings-container\"\n          ?hidden=\"", "\"\n          id=\"haxcmsuserstylesmenu\"\n          auto\n        >\n          <div class=\"open\">\n            <div class=\"hcusm-caret\">\n              <span class=\"hcusm-caret-outer\"></span>\n              <span class=\"hcusm-caret-inner\"></span>\n            </div>\n            <div class=\"hcusm-buttons\">\n              <button\n                class=\"hcusm-button size-2 font-reduce\"\n                @click=\"", "\"\n              >\n                A\n              </button>\n              <button\n                class=\"hcusm-button size-2 font-enlarge\"\n                @click=\"", "\"\n              >\n                A\n              </button>\n            </div>\n            <div class=\"hcusm-buttons\">\n              <button\n                class=\"hcusm-button size-2\"\n                data-font=\"0\"\n                @click=\"", "\"\n              >\n                Serif\n              </button>\n              <button\n                class=\"hcusm-button size-2\"\n                data-font=\"1\"\n                @click=\"", "\"\n              >\n                Sans\n              </button>\n            </div>\n            <div class=\"hcusm-buttons\">\n              <button\n                class=\"hcusm-button size-3\"\n                data-theme=\"0\"\n                @click=\"", "\"\n              >\n                Day\n              </button>\n              <button\n                class=\"hcusm-button size-3\"\n                data-theme=\"1\"\n                @click=\"", "\"\n              >\n                Sepia\n              </button>\n              <button\n                class=\"hcusm-button size-3\"\n                data-theme=\"2\"\n                @click=\"", "\"\n              >\n                Night\n              </button>\n            </div>\n          </div>\n        </simple-popover>\n      "])), this.editMode ? "edit-mode-active" : "", this.toggleUserStylesMenu, this.hideUserStylesMenu, this.UserStylesSizeDown, this.UserStylesSizeUp, this.UserStylesFontFamilyChange, this.UserStylesFontFamilyChange, this.UserStylesColorThemeChange, this.UserStylesColorThemeChange, this.UserStylesColorThemeChange);
        }
      }, {
        ...
        value: function UserStylesSizeDown(e) {
          if (this.fontSize > 0) {
            ...
            window.localStorageSet("haxcms-userPref-fontSize", this.fontSize);
          }
        }
      }, {
        ...
        value: function UserStylesFontFamilyChange(e) {
          ...
          window.localStorageSet("haxcms-userPref-fontFamily", this.fontFamily);
        }
      }, {
        ...
        value: function UserStylesColorThemeChange(e) {
          ...
          window.localStorageSet("haxcms-userPref-colorTheme", this.colorTheme);
        }
      }], [{
        key: "styles",
        get: function get() {
