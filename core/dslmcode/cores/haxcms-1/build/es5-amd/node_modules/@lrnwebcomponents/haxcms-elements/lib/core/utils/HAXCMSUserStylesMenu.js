define(["exports", "require", "../../../../../lit/index.js", "../../../../utils/utils.js", "./HAXCMSI18NMixin.js"], function (_exports, _require, _index, _utils, _HAXCMSI18NMixin2) {
  "use strict";
  ...
  var _templateObject_fa4232e08e0011ed99ce491205e67b1d, _templateObject2_fa4232e08e0011ed99ce491205e67b1d;
  ...
  var HAXCMSUserStylesMenuMixin = function HAXCMSUserStylesMenuMixin(SuperClass) {
    return /*#__PURE__*/function (_HAXCMSI18NMixin) {
      ...
      function _class() {
        ...
        _this.fontSize = (0, _utils.localStorageGet)("haxcms-userPref-fontSize", 1);
        _this.fontFamily = (0, _utils.localStorageGet)("haxcms-userPref-fontFamily", 0);
        _this.colorTheme = (0, _utils.localStorageGet)("haxcms-userPref-colorTheme", 0);
      ...
      babelHelpers.createClass(_class, [{
        key: "HAXCMSUserStylesMenu",
        value: function HAXCMSUserStylesMenu() {
          ...
          return (0, _index.html)(_templateObject_fa4232e08e0011ed99ce491205e67b1d || (_templateObject_fa4232e08e0011ed99ce491205e67b1d = babelHelpers.taggedTemplateLiteral(["\n        <simple-icon-button-lite\n          .part=\"", "\"\n          class=\"btn\"\n          label=\"", "\"\n          icon=\"editor:format-size\"\n          @click=\"", "\"\n          id=\"haxcmsuserstylesmenupopover\"\n        ></simple-icon-button-lite>\n        <simple-tooltip for=\"haxcmsuserstylesmenupopover\">\n          ", "\n        </simple-tooltip>\n        <simple-popover\n          class=\"hcusm pull-left font-settings js-toolbar-action hcusm-settings-container\"\n          ?hidden=\"", "\"\n          id=\"haxcmsuserstylesmenu\"\n          auto\n        >\n          <div class=\"open\">\n            <div class=\"hcusm-caret\">\n              <span class=\"hcusm-caret-outer\"></span>\n              <span class=\"hcusm-caret-inner\"></span>\n            </div>\n            <div class=\"hcusm-buttons\">\n              <button\n                class=\"hcusm-button size-2 font-reduce\"\n                @click=\"", "\"\n                title=\"", "\"\n              >\n                ", "\n              </button>\n              <button\n                class=\"hcusm-button size-2 font-enlarge\"\n                @click=\"", "\"\n                title=\"", "\"\n              >\n                ", "\n              </button>\n            </div>\n            <div class=\"hcusm-buttons\">\n              <button\n                class=\"hcusm-button size-2\"\n                data-font=\"0\"\n                title=\"", "\"\n                @click=\"", "\"\n              >\n                ", "\n              </button>\n              <button\n                class=\"hcusm-button size-2\"\n                title=\"", "\"\n                data-font=\"1\"\n                @click=\"", "\"\n              >\n                ", "\n              </button>\n            </div>\n            <div class=\"hcusm-buttons\">\n              <button\n                class=\"hcusm-button size-3\"\n                data-theme=\"0\"\n                @click=\"", "\"\n              >\n                ", "\n              </button>\n              <button\n                class=\"hcusm-button size-3\"\n                data-theme=\"1\"\n                @click=\"", "\"\n              >\n                ", "\n              </button>\n              <button\n                class=\"hcusm-button size-3\"\n                data-theme=\"2\"\n                @click=\"", "\"\n              >\n                ", "\n              </button>\n            </div>\n          </div>\n        </simple-popover>\n      "])), this.editMode ? "edit-mode-active" : "", this.t.textSettings, this.toggleUserStylesMenu, this.t.textSettings, this.hideUserStylesMenu, this.UserStylesSizeDown, this.t.decreaseFontSize, this.t.A, this.UserStylesSizeUp, this.t.increaseFontSize, this.t.A, this.t.setFontToSerif, this.UserStylesFontFamilyChange, this.t.serif, this.t.setFontToSansSerif, this.UserStylesFontFamilyChange, this.t.sansSerif, this.UserStylesColorThemeChange, this.t.day, this.UserStylesColorThemeChange, this.t.sepia, this.UserStylesColorThemeChange, this.t.night);
        }
      }, {
        ...
        value: function UserStylesSizeDown(e) {
          if (this.fontSize > 0) {
            ...
            (0, _utils.localStorageSet)("haxcms-userPref-fontSize", this.fontSize);
          }
        }
      }, {
        ...
        value: function UserStylesFontFamilyChange(e) {
          ...
          (0, _utils.localStorageSet)("haxcms-userPref-fontFamily", this.fontFamily);
        }
      }, {
        ...
        value: function UserStylesColorThemeChange(e) {
          ...
          (0, _utils.localStorageSet)("haxcms-userPref-colorTheme", this.colorTheme);
        }
      }], [{
        key: "styles",
        get: function get() {
