define(["exports", "meta", "require"], function (_exports, meta, _require) {
  ...
  function (_HTMLElement) {
    ...
    function DynamicImportRegistry() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(DynamicImportRegistry).call(this)); // object for tracking what the registry is
    ...
    babelHelpers.createClass(DynamicImportRegistry, [{
      ...
      key: "loadDefinition",
      value: function () {
        var _loadDefinition = babelHelpers.asyncToGenerator(
        /*#__PURE__*/
