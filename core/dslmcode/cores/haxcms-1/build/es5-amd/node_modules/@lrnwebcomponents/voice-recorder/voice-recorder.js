define(["exports", "meta", "require", "../../lit-element/lit-element.js", "./lib/vmsg-fork.js"], function (_exports, meta, _require, _litElement, _vmsgFork) {
  ...
  function _templateObject2_d0f02cb088c411ea8e2ed3d8cb6f439c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n      "]);

    _templateObject2_d0f02cb088c411ea8e2ed3d8cb6f439c = function _templateObject2_d0f02cb088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function _templateObject_d0f02cb088c411ea8e2ed3d8cb6f439c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">\n        <iron-icon icon=\"", "\"></iron-icon>", "\n      </button>\n      <slot></slot>\n    "]);

    _templateObject_d0f02cb088c411ea8e2ed3d8cb6f439c = function _templateObject_d0f02cb088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(VoiceRecorder, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_d0f02cb088c411ea8e2ed3d8cb6f439c(), this.recordState, this.iconState, this.textState);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_d0f02cb088c411ea8e2ed3d8cb6f439c())];
      }
    }, {
      key: "properties",
      get: function get() {
