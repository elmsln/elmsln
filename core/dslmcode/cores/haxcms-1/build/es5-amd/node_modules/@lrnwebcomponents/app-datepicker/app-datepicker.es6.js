define(["exports", "./node_modules/@polymer/polymer/polymer-legacy.js", "./node_modules/@polymer/polymer/lib/legacy/polymer.dom.js", "./node_modules/@polymer/polymer/lib/utils/flattened-nodes-observer.js", "./node_modules/@polymer/polymer/lib/utils/async.js", "./node_modules/@polymer/iron-selector/iron-selector.js", "./node_modules/@polymer/iron-list/iron-list.js", "./node_modules/@polymer/paper-icon-button/paper-icon-button.js", "./node_modules/@polymer/neon-animation/neon-animation-runner-behavior.js", "./node_modules/@polymer/neon-animation/neon-animated-pages.js", "./lib/app-datepicker-icons.js", "./lib/app-datepicker-animations.js"], function (_exports, _polymerLegacy, _polymerDom, _flattenedNodesObserver, async, _ironSelector, _ironList, _paperIconButton, _neonAnimationRunnerBehavior, _neonAnimatedPages, _appDatepickerIcons, _appDatepickerAnimations) {
  ...
  function _templateObject_b9fa93602da211eaa247b36e11306899() {
    ...
    _templateObject_b9fa93602da211eaa247b36e11306899 = function _templateObject_b9fa93602da211eaa247b36e11306899() {
      return data;
    };
  ...
  var AppDatepicker = (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(_templateObject_b9fa93602da211eaa247b36e11306899()),
    is: "app-datepicker",
    ...
    _computeDaysOfMonth: function _computeDaysOfMonth(_activeYear, _activeMonth, _firstDayOfWeek, _locale) {
      ...
      for (var _formatter = window.Intl && window.Intl.DateTimeFormat ? new window.Intl.DateTimeFormat(_locale, {
        timeZone: "UTC",
        day: "numeric"
      }).format : function dateTimeFormatShim(date) {
        return date.getDate();
      }, i = 0, j = 1 - _start; 42 > i; i++, j++) {
    ...
    _computeShiftedDisableDays: function _computeShiftedDisableDays(_firstDayOfWeek, _isDisableDays) {
      _firstDayOfWeek = 0 < _firstDayOfWeek && 7 > _firstDayOfWeek ? _firstDayOfWeek : 0;
    ...
    _isToday: function _isToday(_item, _activeYear, _activeMonth) {
      var _now = new Date(),
          _isToday = _item === _now.getDate() && _activeYear === _now.getFullYear() && _activeMonth === _now.getMonth();
    ...
    _isChosenDaysOfMonth: function _isChosenDaysOfMonth(_item, _selectedYear, _selectedMonth, _selectedDate) {
      var _isChosenDaysOfMonth = 0 <= this._chosenDaysOfMonth && this._activeYear === _selectedYear && this._activeMonth === _selectedMonth && _item === _selectedDate;
    ...
    _computeDaysOfWeek: function _computeDaysOfWeek(_firstDayOfWeek, _locale) {
      ...
      if (_locale && window.Intl) {
        ...
        for (var _today = new Date(), _offsetDate = _today.getDate() - _today.getDay(), _formatter = new window.Intl.DateTimeFormat(_locale, {
          timeZone: "UTC",
          weekday: "narrow"
        }).format, newDate = null, i = 0; 7 > i; i++) {
    ...
    _convertDateStringToDateObject: function _convertDateStringToDateObject(_date) {
      var _checkDate = babelHelpers.instanceof(_date, Date) || "string" !== typeof _date ? _date : new Date(_date),
    ...
    _updateListScroller: function _updateListScroller(_list) {
      ...
      var _Mathfloor = Math.floor,
          _sl = (0, _polymerDom.dom)(_list.root).querySelector("#items"),
          _slh = _sl.getBoundingClientRect().height || 12863.994140625,
          _sli = _Mathfloor(_slh / (2100 - 1900 + 1) * (this._activeYear - 1900 - 2)) + 1;

      if (!this.$.dp.classList.contains("with-buttons") && window.matchMedia("(orientation: landscape)").matches) {
        _sli = _Mathfloor(_slh / (2100 - 1900 + 1) * (this._activeYear - 1900 - 1)) + 1;
      }
    ...
    _goCalendar: function _goCalendar(ev) {
      ...
      this.shadowRoot.querySelector("#listOfYears").selectItem(_selectedYear - 1900);
    ...
    _bindSelectedFulldate: function _bindSelectedFulldate(_selectedYear, _selectedMonth, _selectedDate, _format) {
      ...
      if ("do" === _format.d) {
        var _cardinalNumber = _formattedDate % 10,
            _suffixOrdinal = 3 < _cardinalNumber ? "th" : ["th", "st", "nd", "rd"][_cardinalNumber];

        if (11 === _formattedDate || 12 == _formattedDate || 13 === _formattedDate) {
          _suffixOrdinal = "th";
        }
    ...
    _computeShowLongDate: function _computeShowLongDate(_showLongDate, _locale, _returnResult) {
      if (!window.Intl || !this._selectedDate || "undefined" === typeof this._selectedDate) {
        return;
      }

      var _selectedDate = this._selectedDate,
          _longDate = Date.UTC(this._selectedYear, this._selectedMonth, _selectedDate);
    ...
    _isNumber: function _isNumber(_value) {
      return "number" == typeof _value || !isNaN(parseFloat(_value)) && isFinite(_value);
    },
    _updateThemeColor: function _updateThemeColor(_theme) {
      var _themes = ["dark-theme", "light-theme", "goog-theme"],
          ...
          _distributedButtons = (0, _polymerDom.dom)(this).querySelectorAll("paper-button"),
