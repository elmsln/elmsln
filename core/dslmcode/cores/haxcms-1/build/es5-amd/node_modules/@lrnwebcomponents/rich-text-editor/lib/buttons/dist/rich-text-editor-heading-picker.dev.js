...
var RichTextEditorHeadingPicker = /*#__PURE__*/function (_RichTextEditorPicker) {
  ...
  _createClass(RichTextEditorHeadingPicker, [{
    key: "render",
    // render function for template
    value: function render() {
      return _get(_getPrototypeOf(RichTextEditorHeadingPicker.prototype), "render", this).call(this);
    }
  }], [{
    key: "tag",
    ...
    key: "styles",
    get: function get() {
      return _toConsumableArray(_get(_getPrototypeOf(RichTextEditorHeadingPicker), "styles", this));
    }
  }]);
  ...
  function RichTextEditorHeadingPicker() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(RichTextEditorHeadingPicker).call(this));
  ...
  _createClass(RichTextEditorHeadingPicker, [{
    ...
    value: function _setOptions() {
      this.tagsList = this.blocks.map(function (block) {
        return block.tag;
      }).join(",");
      this.options = [[{
        alt: this.label,
        value: null
      }]].concat(_toConsumableArray(this.blocks.map(function (block) {
        return [{
          alt: block.label,
          value: block.tag
        }];
    ...
    key: "properties",
    get: function get() {
      var props = _get(_getPrototypeOf(RichTextEditorHeadingPicker), "properties", this);
