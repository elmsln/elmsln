define(["exports", "../../../lit/index.js", "./elmsln-studio-utilities.js", "./elmsln-studio-styles.js"], function (_exports, _index, _elmslnStudioUtilities, _elmslnStudioStyles) {
  ...
  var _templateObject_5e8b68e06fd311eca7e2ed068d5db377, _templateObject2_5e8b68e06fd311eca7e2ed068d5db377, _templateObject3_5e8b68e06fd311eca7e2ed068d5db377, _templateObject4_5e8b68e06fd311eca7e2ed068d5db377, _templateObject5_5e8b68e06fd311eca7e2ed068d5db377, _templateObject6_5e8b68e06fd311eca7e2ed068d5db377;
  ...
  var ElmslnStudioAssignments = /*#__PURE__*/function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioAssignments, [{
      ...
      function render() {
        ...
        return (0, _index.html)(_templateObject_5e8b68e06fd311eca7e2ed068d5db377 || (_templateObject_5e8b68e06fd311eca7e2ed068d5db377 = babelHelpers.taggedTemplateLiteral(["\n      <h1 class=\"sr-only\">Assignments</h1>\n      <div id=\"lessons\">\n        ", "\n      </div>\n    "])), !this.lessons ? this.loading("green", undefined, "large") : Object.keys(this.lessons || {}).map(function (l) {
          return (0, _index.html)(_templateObject2_5e8b68e06fd311eca7e2ed068d5db377 || (_templateObject2_5e8b68e06fd311eca7e2ed068d5db377 = babelHelpers.taggedTemplateLiteral(["\n                <div class=\"lesson\">\n                  <h2>", "</h2>\n                  ", "\n                </div>\n              "])), _this.lessons[l].lesson, (_this.lessons[l].assignments || []).map(function (p) {
            return !p.assignments ? (0, _index.html)(_templateObject3_5e8b68e06fd311eca7e2ed068d5db377 || (_templateObject3_5e8b68e06fd311eca7e2ed068d5db377 = babelHelpers.taggedTemplateLiteral(["\n                          <div class=\"assignment\">\n                            ", "\n                          </div>\n                        "])), _this.renderAssignment(p)) : (0, _index.html)(_templateObject4_5e8b68e06fd311eca7e2ed068d5db377 || (_templateObject4_5e8b68e06fd311eca7e2ed068d5db377 = babelHelpers.taggedTemplateLiteral(["\n                          <nav-card flat no-border class=\"card secondary\">\n                            <span slot=\"heading\" ?hidden=\"", "\">\n                              ", "\n                            </span>\n                            <div slot=\"linklist\">\n                              ", "\n                            </div>\n                          </nav-card>\n                        "])), !p.project, p.project, _this.sortDates(p.assignments || [], true).map(function (a) {
