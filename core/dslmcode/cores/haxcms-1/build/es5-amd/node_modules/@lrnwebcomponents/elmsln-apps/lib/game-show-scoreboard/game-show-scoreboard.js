...
if(route.path.startsWith(endPoint)||"/"==route.path){return}}window.location.reload()}}},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(GameShowScoreboard.prototype),"connectedCallback",this).call(this);if(document.getElementById("block-mooc-nav-block-mooc-nav-nav")){document.getElementById("block-mooc-nav-block-mooc-nav-nav").remove()}}},{key:"_toArray",value:function _toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_1a2a5de0783711eabb30eb9f481c23a6())}},{key:"tag",get:function get(){return"game-show-scoreboard"}},{key:"observers",get:function get(){return["_routeChanged(route, endPoint)"]}/**
   * props
