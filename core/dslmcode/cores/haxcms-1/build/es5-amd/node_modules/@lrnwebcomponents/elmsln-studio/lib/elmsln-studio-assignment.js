define(["exports", "../../../lit-element/lit-element.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "../../lrndesign-gallery/lrndesign-gallery.js", "../../hax-iconset/hax-iconset.js", "../../threaded-discussion/threaded-discussion.js", "./elmsln-studio-link.js", "./elmsln-studio-button.js"], function (_exports, _litElement, _elmslnStudioStyles, _elmslnStudioUtilities, _lrndesignGallery, _haxIconset, _threadedDiscussion, _elmslnStudioLink, _elmslnStudioButton) {
  ...
  function _templateObject12_05710bf001c211eba2339b0c52070e79() {
    ...
    _templateObject12_05710bf001c211eba2339b0c52070e79 = function _templateObject12_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject11_05710bf001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <section>\n                      <h2 class=\"sr-only\">Edit Text</h2>\n                      <textarea></textarea>\n                    </section>\n                  "]);

    _templateObject11_05710bf001c211eba2339b0c52070e79 = function _templateObject11_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject10_05710bf001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <section>\n                      <h2 class=\"sr-only\">Manage Links</h2>\n                      <input type=\"text\" />\n                    </section>\n                  "]);

    _templateObject10_05710bf001c211eba2339b0c52070e79 = function _templateObject10_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject9_05710bf001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <section>\n                      <h2 class=\"sr-only\">Manage Uploads</h2>\n                    </section>\n                  "]);

    _templateObject9_05710bf001c211eba2339b0c52070e79 = function _templateObject9_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject8_05710bf001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral([" <td>", "</td> "]);

    _templateObject8_05710bf001c211eba2339b0c52070e79 = function _templateObject8_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject7_05710bf001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral([" <th scope=\"col\">", "</th> "]);

    _templateObject7_05710bf001c211eba2339b0c52070e79 = function _templateObject7_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject6_05710bf001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                                <tr>\n                                  ", "\n                                </tr>\n                              "]);

    _templateObject6_05710bf001c211eba2339b0c52070e79 = function _templateObject6_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject5_05710bf001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral([" <th scope=\"row\">", "</th> "]);

    _templateObject5_05710bf001c211eba2339b0c52070e79 = function _templateObject5_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject4_05710bf001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            <thead>\n                              ", "\n                            </thead>\n                          "]);

    _templateObject4_05710bf001c211eba2339b0c52070e79 = function _templateObject4_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject3_05710bf001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <table>\n                      <caption>\n                        Rubric\n                      </caption>\n                      ", "\n                      <tbody>\n                        ", "\n                      </tbody>\n                    </table>\n                  "]);

    _templateObject3_05710bf001c211eba2339b0c52070e79 = function _templateObject3_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject2_05710bf001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <elmsln-studio-link\n                    href=\"", "\"\n                    >", "</elmsln-studio-link\n                  >\n                  <span> > </span>\n                "]);

    _templateObject2_05710bf001c211eba2339b0c52070e79 = function _templateObject2_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject_05710bf001c211eba2339b0c52070e79() {
    ...
    _templateObject_05710bf001c211eba2339b0c52070e79 = function _templateObject_05710bf001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  var ElmslnStudioAssignment = /*#__PURE__*/function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioAssignment, [{
      ...
      value: function render() {
        ...
        return !this.assignment ? "" : (0, _litElement.html)(_templateObject_05710bf001c211eba2339b0c52070e79(), !this.assignment.projectId || !this.assignment.project ? "" : (0, _litElement.html)(_templateObject2_05710bf001c211eba2339b0c52070e79(), "/assignments?project=".concat(this.assignment.projectId), this.assignment.project), this.assignment.assignment, !this.assignment, this.assignment.lesson, this.assignment.assignment, this.assignment.body, !this.assignment.rubric ? "" : (0, _litElement.html)(_templateObject3_05710bf001c211eba2339b0c52070e79(), !this.assignment.rubric || !this.assignment.rubric[0] ? "" : (0, _litElement.html)(_templateObject4_05710bf001c211eba2339b0c52070e79(), this.assignment.rubric[0].map(function (col) {
          return (0, _litElement.html)(_templateObject5_05710bf001c211eba2339b0c52070e79(), col);
        })), (this.assignment.rubric || []).map(function (row, i) {
          return i === 0 ? "" : (0, _litElement.html)(_templateObject6_05710bf001c211eba2339b0c52070e79(), _this2.assignment.rubric[0].map(function (col, ii) {
            return ii === 0 ? (0, _litElement.html)(_templateObject7_05710bf001c211eba2339b0c52070e79(), col) : (0, _litElement.html)(_templateObject8_05710bf001c211eba2339b0c52070e79(), col);
          }));
        })), !this.assignment.uploads ? "" : (0, _litElement.html)(_templateObject9_05710bf001c211eba2339b0c52070e79()), !this.assignment.links ? "" : (0, _litElement.html)(_templateObject10_05710bf001c211eba2339b0c52070e79()), !this.assignment.text ? "" : (0, _litElement.html)(_templateObject11_05710bf001c211eba2339b0c52070e79()), this.submission.draft);
      } // properties available to the custom element for data binding

    }], [{
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ElmslnStudioAssignment), "styles", this)), [(0, _litElement.css)(_templateObject12_05710bf001c211eba2339b0c52070e79())]);
      }
    }, {
      key: "properties",
      get: function get() {
