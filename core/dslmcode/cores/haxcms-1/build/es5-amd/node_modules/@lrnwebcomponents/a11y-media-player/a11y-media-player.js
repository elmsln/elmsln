define(["exports", "meta", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "./lib/a11y-media-behaviors.js", "../simple-colors/lib/simple-colors-polymer.js", "../es-global-bridge/es-global-bridge.js", "../anchor-behaviors/anchor-behaviors.js", "../../@polymer/paper-toast/paper-toast.js", "./lib/a11y-media-state-manager.js", "./lib/a11y-media-controls.js", "./lib/a11y-media-button.js", "./lib/a11y-media-html5.js", "./lib/a11y-media-transcript.js", "./lib/a11y-media-transcript-controls.js", "./lib/a11y-media-youtube.js"], function (_exports, meta, _require, _polymerElement, _renderStatus, _a11yMediaBehaviors, _simpleColorsPolymer, _esGlobalBridge, _anchorBehaviors, _paperToast, _a11yMediaStateManager, _a11yMediaControls, _a11yMediaButton, _a11yMediaHtml, _a11yMediaTranscript, _a11yMediaTranscriptControls, _a11yMediaYoutube) {
  ...
  function _templateObject_9d65bb001bb211eabd7cc30119585ddb() {
    ...
    _templateObject_9d65bb001bb211eabd7cc30119585ddb = function _templateObject_9d65bb001bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function (_A11yMediaBehaviors) {
    ...
    babelHelpers.createClass(A11yMediaPlayer, null, [{
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_9d65bb001bb211eabd7cc30119585ddb());
      } // properties available to the custom element for data binding

    }, {
      key: "properties",
      get: function get() {
        return babelHelpers.objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(A11yMediaPlayer), "properties", this), {
          /**
    ...
    babelHelpers.createClass(A11yMediaPlayer, [{
      ...
      value: function ready() {
        ...
        root.shadowRoot.querySelector("#transcript").setMedia(root.shadowRoot.querySelector("#innerplayer"));
      }
      /**
       * plays the media
       */
      ...
      value: function toggleTranscript(mode) {
        ...
        if (this.shadowRoot.querySelector("#transcript") !== undefined && this.shadowRoot.querySelector("#transcript") !== null) {
      ...
      value: function _setPlayerHeight(aspect) {
        ...
        if (root.audioOnly && root.thumbnailSrc === null && root.height === null) {
          ...
          root.shadowRoot.querySelector("#player").style.paddingTop = 100 / aspect + "%";
          root.shadowRoot.querySelector("#innerplayer").style.maxWidth = "calc(" + aspect * 100 + "vh - " + aspect * 80 + "px)";
        } else {
      ...
      value: function _addSourcesAndTracks() {
        ...
        root.shadowRoot.querySelector("#html5").media.textTracks.onaddtrack = function (e) {
        ...
        loadCueData = setInterval(function () {
          if (track.cues !== undefined && track.cues !== null && track.cues.length > 0) {
            ...
            track.oncuechange = function (e) {
              root.shadowRoot.querySelector("#transcript").setActiveCues(Object.keys(e.currentTarget.activeCues).map(function (key) {
      ...
      value: function _handleTranscriptSeek(e) {
        ...
        if (!root.standAlone && root.shadowRoot.querySelector("#transcript") !== undefined && root.shadowRoot.querySelector("#transcript") !== null) {
      ...
      value: function _handleMediaLoaded(e) {
        ...
        root.shadowRoot.querySelector("#playbutton").removeAttribute("disabled"); // gets and converts video duration

        root._setElapsedTime();

        root._getTrackData(root.shadowRoot.querySelector("#html5").media); //if this video is part of the page's query string or anchor, seek the video
      ...
      value: function _handleTimeUpdate(e) {
        ...
        if (root.isYoutube && root.media.duration !== root.media.getDuration()) {
          ...
          if (root.media.seekable && root.media.seekable.length > 0 && root.media.seekable.start(0) !== 0) {
            root.shadowRoot.querySelector("#slider").min = root.media.seekable.start(0);
          }
        }
      ...
      value: function _setElapsedTime() {
        var elapsed = this.__seeking === true ? this.shadowRoot.querySelector("#slider").immediateValue : this.media.getCurrentTime() > 0 ? this.media.getCurrentTime() : 0,
      ...
      value: function _youTubeRequest() {
        ...
        if (root.__playerAttached && root.__playerReady) {
          var _ytInit = function _ytInit() {
            ...
            root.shadowRoot.querySelector("#controls").setStatus(root.__status); // move the YouTube iframe to the media player's YouTube container
      ...
      value: function _updateCustomTracks() {
        if ((this.isYoutube || this.audioOnly) && this.__tracks) {
          var root = this,
              track = root.__tracks[this.shadowRoot.querySelector("#transcript").selectedTranscript],
              active = [],
              caption = "";
