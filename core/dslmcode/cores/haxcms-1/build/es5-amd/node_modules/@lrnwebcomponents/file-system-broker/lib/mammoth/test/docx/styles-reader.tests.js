...
test("paragraph style can be found by ID", function () {
  var styles = readStylesXml(new XmlElement("w:styles", {}, [paragraphStyleElement("Heading1", "Heading 1")]));
  assert.equal(styles.findParagraphStyleById("Heading1").styleId, "Heading1");
});
test("table style can be found by ID", function () {
  var styles = readStylesXml(new XmlElement("w:styles", {}, [tableStyleElement("TableNormal", "Normal Table")]));
  assert.equal(styles.findTableStyleById("TableNormal").styleId, "TableNormal");
});
test("character style can be found by ID", function () {
  var styles = readStylesXml(new XmlElement("w:styles", {}, [characterStyleElement("Heading1Char", "Heading 1 Char")]));
...
test("paragraph and character styles are distinct", function () {
  var styles = readStylesXml(new XmlElement("w:styles", {}, [paragraphStyleElement("Heading1", "Heading 1"), characterStyleElement("Heading1Char", "Heading 1 Char")]));
...
test("character and table styles are distinct", function () {
  var styles = readStylesXml(new XmlElement("w:styles", {}, [tableStyleElement("Heading1", "Heading 1")]));
  assert.equal(styles.findCharacterStyleById("Heading1"), null);
});
...
test("style name is null if w:name element does not exist", function () {
  var styles = readStylesXml(new XmlElement("w:styles", {}, [styleWithoutWNameElement("paragraph", "Heading1"), styleWithoutWNameElement("character", "Heading1Char")]));
...
test("numbering style has null numId if style has no paragraph properties", function () {
  var styles = readStylesXml(new XmlElement("w:styles", {}, [new XmlElement("w:style", {
    "w:type": "numbering",
    "w:styleId": "List1"
  })]));
...
test("numbering style has numId read from paragraph properties", function () {
  var styles = readStylesXml(new XmlElement("w:styles", {}, [new XmlElement("w:style", {
    "w:type": "numbering",
    "w:styleId": "List1"
  }, [new XmlElement("w:pPr", {}, [new XmlElement("w:numPr", {}, [new XmlElement("w:numId", {
    "w:val": "42"
  })])])])]));
