  ...
  function (_HTMLElement) {
    ...
    babelHelpers.createClass(JsonOutlineSchema, [{
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(JsonOutlineSchema), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(JsonOutlineSchema), "properties", this));
        }
    ...
    function JsonOutlineSchema() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(JsonOutlineSchema).call(this)); // set tag for later use
    ...
    babelHelpers.createClass(JsonOutlineSchema, [{
      ...
      value: function load(location) {
        if (location) {
          this.file = location;
          var fileData = json_decode(file_get_contents(location));
      ...
      key: "itemsToNodes",
      value: function itemsToNodes(items) {
      ...
      value: function unflattenItems(items, parent, tree) {
        ...
        if (children.length) {
          ...
          children.forEach(function (child) {
            _this3.unflattenItems(items, child);
          });
        }
      ...
      key: "nextPage",
      value: function nextPage(manifest, activeItem) {
