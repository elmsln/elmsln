define(["exports", "require", "../../lit-element/lit-element.js", "../../lit-element-router/lit-element-router.js", "./lib/elmsln-studio-utilities.js", "./lib/elmsln-studio-styles.js", "./lib/elmsln-studio-main.js", "./lib/elmsln-studio-link.js", "./lib/elmsln-studio-button.js"], function (_exports, _require, _litElement, _litElementRouter, _elmslnStudioUtilities, _elmslnStudioStyles, _elmslnStudioMain, _elmslnStudioLink, _elmslnStudioButton) {
  ...
  function _templateObject_a7ac93a0291111ebb1faf5089ca89c05() {
    ...
    _templateObject_a7ac93a0291111ebb1faf5089ca89c05 = function _templateObject_a7ac93a0291111ebb1faf5089ca89c05() {
      return data;
    };
  ...
  var ElmslnStudio = /*#__PURE__*/function (_router) {
    ...
    babelHelpers.createClass(ElmslnStudio, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_a7ac93a0291111ebb1faf5089ca89c05(), this.route === "dashboard", this.route === "submissions" || this.route === "portfolios", this.route === "assignments" || this.route === "assignment", this.route === "activity", this.route, this.demoMode, this.recentDiscussions, this.profile, this.recentSubmissions, this._handleFetch, this.demoMode, this.completedSubmissions, !this.discussion ? undefined : Object.keys(this.discussion || {}).map(function (key) {
          return _this2.discussion[key];
        }), this.query.grid || false, this.query.student || "", this.query.assignment || "", this.query.project || "", this._handleFetch, this.demoMode, this.portfolio, this.submissionFeedback, this.query.sort === "latest", this.query.submission || "", this.query.comment || "", this._handleFetch, this.demoMode, this.lessons, this.profile, this._handleFetch, this.demoMode, this.assignments, this.assignment, this.submission, this._handleFetch);
      }
    }], [{
      key: "tag",
    ...
    babelHelpers.createClass(ElmslnStudio, [{
      ...
      value: function fetchData(source, propName, params) {
        ...
        fetch(this._getPath(source, params)).then(function (response) {
          ...
          if (data) {
            ...
            _this4.refreshDates[propName] = new Date();
            console.log("".concat(propName, " Loaded"), source, data, _this4[propName], _this4.refreshDates);
          }
        });
      }
    }, {
      ...
      get: function get() {
        ...
        if (!portfolioId || !this.portfolios) {
          ...
          Object.keys(this.portfolios || {}).forEach(function (i) {
            var portfolio = _this6.portfolios[i],
                ...
                submission = project || _this6.portfolios[i].submissions && assignment && _this6.portfolios[i].submissions.includes(assignment);
      ...
      get: function get() {
        ...
        return !this.completedSubmissions ? undefined : this.sortDates(Object.keys(this.completedSubmissions || {}).map(function (key) {
          return _this7.completedSubmissions[key];
        })).slice(0, 5);
      }
    }, {
      ...
      get: function get() {
        ...
        return !this.submissions ? undefined : Object.keys(this.submissions || {}).filter(function (key) {
          return !!_this8.submissions[key].date;
        }).map(function (key) {
          return _this8.submissions[key];
        });
      }
    }, {
      key: "submission",
