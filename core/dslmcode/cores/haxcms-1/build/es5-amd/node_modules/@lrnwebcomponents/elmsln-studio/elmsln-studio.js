define(["exports", "require", "../../lit-element/lit-element.js", "../../lit-element-router/lit-element-router.js", "./lib/elmsln-studio-utilities.js", "./lib/elmsln-studio-styles.js", "./lib/elmsln-studio-main.js", "./lib/elmsln-studio-link.js", "./lib/elmsln-studio-button.js"], function (_exports, _require, _litElement, _litElementRouter, _elmslnStudioUtilities, _elmslnStudioStyles, _elmslnStudioMain, _elmslnStudioLink, _elmslnStudioButton) {
  ...
  var _templateObject_11900310b80511eb8d9bc563e5c0f5c2;
  ...
  var ElmslnStudio = /*#__PURE__*/function (_router) {
    ...
    babelHelpers.createClass(ElmslnStudio, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_11900310b80511eb8d9bc563e5c0f5c2 || (_templateObject_11900310b80511eb8d9bc563e5c0f5c2 = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"studio-nav\">\n        <elmsln-studio-link ?active=\"", "\" href=\"/\"\n          >Dashboard</elmsln-studio-link\n        >\n        <elmsln-studio-link\n          ?active=\"", "\"\n          href=\"/submissions\"\n          >Submissions</elmsln-studio-link\n        >\n        <elmsln-studio-link\n          ?active=\"", "\"\n          href=\"/assignments\"\n          >Assignments</elmsln-studio-link\n        >\n        <elmsln-studio-link\n          ?active=\"", "\"\n          href=\"/activity\"\n          >Activity Index</elmsln-studio-link\n        >\n      </div>\n      <br />\n      <elmsln-studio-main active-route=\"", "\">\n        <elmsln-studio-dashboard\n          ?demo-mode=\"", "\"\n          .discussion=\"", "\"\n          @fetch-data=\"", "\"\n          route=\"dashboard\"\n          .profile=\"", "\"\n          .submissions=\"", "\"\n        >\n        </elmsln-studio-dashboard>\n        <elmsln-studio-submissions\n          assignment-filter=\"", "\"\n          .comments=\"", "\"\n          ?demo-mode=\"", "\"\n          @fetch-data=\"", "\"\n          ?grid=\"", "\"\n          route=\"submissions\"\n          project-filter=\"", "\"\n          student-filter=\"", "\"\n          .submissions=\"", "\"\n        >\n        </elmsln-studio-submissions>\n        <elmsln-studio-portfolio\n          comment=\"", "\"\n          ?demo-mode=\"", "\"\n          .feedback=\"", "\"\n          @fetch-data=\"", "\"\n          .portfolio=\"", "\"\n          route=\"project\"\n          ?sort-latest=\"", "\"\n          submission-filter=\"", "\"\n          .navigation=\"", "\"\n        >\n        </elmsln-studio-portfolio>\n        <elmsln-studio-assignments\n          ?demo-mode=\"", "\"\n          @fetch-data=\"", "\"\n          .lessons=\"", "\"\n          .profile=\"", "\"\n          route=\"assignments\"\n        >\n        </elmsln-studio-assignments>\n        <elmsln-studio-assignment\n          .assignment=\"", "\"\n          .assignments=\"", "\"\n          ?demo-mode=\"", "\"\n          @fetch-data=\"", "\"\n          route=\"assignment\"\n          .submission=\"", "\"\n        >\n        </elmsln-studio-assignment>\n      </elmsln-studio-main>\n    "])), this.route === "dashboard", this.route === "submissions" || this.route === "project", this.route === "assignments" || this.route === "assignment", this.route === "activity", this.route, this.demoMode, this.recentDiscussions, this._handleFetch, this.profile, this.recentSubmissions, this.query.assignment || "", !this.discussion ? undefined : Object.keys(this.discussion || {}).map(function (key) {
      ...
      get: function get() {
        ...
        if (!portfolioId || !this.portfolios) {
          ...
          Object.keys(this.portfolios || {}).forEach(function (i) {
            var portfolio = _this4.portfolios[i],
                ...
                submission = project || _this4.portfolios[i].submissions && assignment && _this4.portfolios[i].submissions.includes(assignment);
      ...
      get: function get() {
        ...
        return !this.completedSubmissions ? undefined : this.sortDates(Object.keys(this.completedSubmissions || {}).map(function (key) {
          return _this5.completedSubmissions[key];
        })).slice(0, 5);
      }
    }, {
      ...
      get: function get() {
        ...
        return !this.submissions ? undefined : Object.keys(this.submissions || {}).filter(function (key) {
          return !!_this6.submissions[key].date;
        }).map(function (key) {
          return _this6.submissions[key];
        });
      }
      /**
      ...
      get: function get() {
        ...
        return !this.completedSubmissions || !this.query.submission ? undefined : this.completedSubmissions.filter(function (s) {
          return s.assignmentId === _this7.query.submission.replace(/\-\w+$/, "");
        });
      }
      /**
      ...
      value: function fetchData(source, propName, params) {
        ...
        fetch(this._getPath(source, params)).then(function (response) {
          ...
          if (data) {
            _this10[propName] = data;
            _this10.refreshDates[propName] = new Date();
            console.log("".concat(propName, " Loaded"), source, data, _this10[propName], _this10.refreshDates);
          }
        });
      }
    }, {
