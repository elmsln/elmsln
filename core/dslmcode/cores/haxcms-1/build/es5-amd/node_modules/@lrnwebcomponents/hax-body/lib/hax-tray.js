define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../a11y-collapse/lib/a11y-collapse-group.js", "../../a11y-collapse/a11y-collapse.js"], function (_exports, _require, _litElement, _utils, _a11yCollapseGroup, _a11yCollapse) {
  "use strict";
  ...
  function _templateObject4_351259e0833211ea85a195fb4be801bd() {
    ...
    _templateObject4_351259e0833211ea85a195fb4be801bd = function _templateObject4_351259e0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject3_351259e0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <hax-tray-button\n                    mini\n                    @click=\"", "\"\n                    icon=\"save\"\n                    id=\"haxsavebutton\"\n                    label=\"", "\"\n                    event-name=\"save\"\n                    voice-command=\"save (content)(page)\"\n                    color-meaning\n                  ></hax-tray-button>\n                  <hax-tray-button\n                    mini\n                    icon=\"cancel\"\n                    id=\"haxcancelbutton\"\n                    label=\"Cancel\"\n                    event-name=\"cancel\"\n                    voice-command=\"cancel\"\n                    color-meaning\n                  ></hax-tray-button>\n                "]);

    _templateObject3_351259e0833211ea85a195fb4be801bd = function _templateObject3_351259e0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject2_351259e0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              voice-command=\"edit page\"\n              .data-opened=\"", "\"\n              @click=\"", "\"\n              icon=\"create\"\n              id=\"button\"\n              label=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject2_351259e0833211ea85a195fb4be801bd = function _templateObject2_351259e0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject_351259e0833211ea85a195fb4be801bd() {
    ...
    _templateObject_351259e0833211ea85a195fb4be801bd = function _templateObject_351259e0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxTray, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_351259e0833211ea85a195fb4be801bd(), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject2_351259e0833211ea85a195fb4be801bd(), this.editMode, this._clickEditButton, this.__tipText), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject3_351259e0833211ea85a195fb4be801bd(), this._clickSaveButton, this.__tipText), this.traySizeIcon, this.traySizeText, this.menuAlignName, !this.canUndo, !this.canRedo, this.hidePreferencesButton, this._gizmoBrowserRefresh, this.activeTagIcon, this.activeTagName, this._appBrowserRefresh, this._refreshLists);
      }
    }, {
        ...
        switch (detail.eventName) {
          ...
          case "insert-blox":
            ...
            for (var i = 0; i < e.path[0].blox.length; i++) {
              var node = window.HaxStore.haxElementToNode(e.path[0].blox[i].tag, e.path[0].blox[i].content, e.path[0].blox[i].properties);
          ...
          case "insert-tag":
            ...
            var properties = JSON.parse(e.path[0].getAttribute("event-properties"));
            var innerContent = e.path[0].getAttribute("event-content");
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "activeNode") {
            if (_this4.activeNode && _this4.activeNode.tagName) {
              _this4.shadowRoot.querySelector("#settingscollapse").disabled = false;

              if (!_this4.shadowRoot.querySelector("#settingscollapse").expanded) {
                _this4.shadowRoot.querySelector('#settingscollapse div[slot="heading"]').click();
              } // process fields


              _this4.activeHaxElement = window.HaxStore.nodeToHaxElement(_this4.activeNode, null);
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_351259e0833211ea85a195fb4be801bd())];
      }
    }, {
      key: "properties",
      get: function get() {
