define(["exports", "require", "../../../lit/index.js", "../../utils/utils.js", "../../hax-body-behaviors/lib/HAXFields.js", "../../simple-popover/lib/SimpleTourFinder.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js", "./hax-ui-styles.js", "../../simple-fields/simple-fields.js", "../../simple-icon/lib/simple-icons.js", "../../hax-iconset/lib/simple-hax-iconset.js", "./hax-tray-upload.js", "./hax-app-browser.js", "./hax-gizmo-browser.js", "./hax-view-source.js", "./hax-stax-browser.js", "./hax-map.js", "./hax-preferences-dialog.js", "../../i18n-manager/lib/I18NMixin.js", "../../undo-manager/undo-manager.js", "../../iframe-loader/lib/loading-indicator.js", "../../simple-toolbar/lib/simple-toolbar-menu-item.js"], function (_exports, _require, _index, _utils, _HAXFields, _SimpleTourFinder, _haxStore, _mobxEsm, _haxUiStyles, _simpleFields, _simpleIcons, _simpleHaxIconset, _haxTrayUpload, _haxAppBrowser, _haxGizmoBrowser, _haxViewSource, _haxStaxBrowser, _haxMap, _haxPreferencesDialog, _I18NMixin2, _undoManager, _loadingIndicator, _simpleToolbarMenuItem) {
  "use strict";
  ...
  var _templateObject_962d1810fc6b11eba46329b1c18c9676, _templateObject2_962d1810fc6b11eba46329b1c18c9676, _templateObject3_962d1810fc6b11eba46329b1c18c9676, _templateObject4_962d1810fc6b11eba46329b1c18c9676, _templateObject5_962d1810fc6b11eba46329b1c18c9676, _templateObject6_962d1810fc6b11eba46329b1c18c9676, _templateObject7_962d1810fc6b11eba46329b1c18c9676, _templateObject8_962d1810fc6b11eba46329b1c18c9676, _templateObject9_962d1810fc6b11eba46329b1c18c9676, _templateObject10_962d1810fc6b11eba46329b1c18c9676, _templateObject11_962d1810fc6b11eba46329b1c18c9676, _templateObject12_962d1810fc6b11eba46329b1c18c9676, _templateObject13_962d1810fc6b11eba46329b1c18c9676, _templateObject14_962d1810fc6b11eba46329b1c18c9676, _templateObject15_962d1810fc6b11eba46329b1c18c9676, _templateObject16_962d1810fc6b11eba46329b1c18c9676, _templateObject17_962d1810fc6b11eba46329b1c18c9676;
    ...
    babelHelpers.createClass(HaxTray, [{
      ...
      value: function _setupForm() {
        ...
        if (activeNode && activeNode.tagName && _haxStore.HAXStore.elementList[activeNode.tagName.toLowerCase()]) {
          ...
          var isGrid = !!props.type && props.type === "grid";
          ...
          if (props.settings.configure.length > 0) {
            this.activeSchema[0].properties.push({
              ...
              properties: !isGrid ? props.settings.configure : props.settings.configure.filter(function (prop) {
                return !prop.slot;
              })
            });
          } else {
          ...
          if (props.settings.layout.length > 0) {
            this.activeSchema[0].properties.push({
              property: "layout",
              title: this.t.layout,
              properties: !isGrid ? props.settings.layout : props.settings.layout.filter(function (prop) {
                return !prop.slot;
              })
            });
          } else {
          ...
          if (props.settings.advanced.length > 0) {
            this.activeSchema[0].properties.push({
              ...
              properties: !isGrid ? props.settings.advanced : props.settings.advanced.filter(function (prop) {
                return !prop.slot;
              })
            });
          } else {
      ...
      value: function __valueChangedEvent(e) {
        ...
        if (this.editMode && e.detail.value && e.detail.value.settings) {
          ...
          var isGrid = e.detail.value.type && e.detail.value.type == "grid";
          var settingsKeys = {
            advanced: "advanced",
            configure: "configure",
            layout: "layout"
