define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../a11y-collapse/lib/a11y-collapse-group.js", "../../a11y-collapse/a11y-collapse.js", "../../hax-body-behaviors/lib/HAXFields.js"], function (_exports, _require, _litElement, _utils, _a11yCollapseGroup, _a11yCollapse, _HAXFields) {
  ...
  function _templateObject4_64f71260f9d711eab0a41741e72b3233() {
    ...
    _templateObject4_64f71260f9d711eab0a41741e72b3233 = function _templateObject4_64f71260f9d711eab0a41741e72b3233() {
      return data;
    };
  ...
  function _templateObject3_64f71260f9d711eab0a41741e72b3233() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <hax-tray-button\n                    mini\n                    @click=\"", "\"\n                    icon=\"save\"\n                    id=\"haxsavebutton\"\n                    label=\"", "\"\n                    event-name=\"save\"\n                    voice-command=\"save (content)(page)\"\n                    color-meaning\n                  ></hax-tray-button>\n                  <hax-tray-button\n                    mini\n                    icon=\"cancel\"\n                    id=\"haxcancelbutton\"\n                    label=\"Cancel\"\n                    event-name=\"cancel\"\n                    voice-command=\"cancel\"\n                    color-meaning\n                  ></hax-tray-button>\n                "]);

    _templateObject3_64f71260f9d711eab0a41741e72b3233 = function _templateObject3_64f71260f9d711eab0a41741e72b3233() {
      return data;
    };
  ...
  function _templateObject2_64f71260f9d711eab0a41741e72b3233() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              voice-command=\"edit page\"\n              .data-opened=\"", "\"\n              @click=\"", "\"\n              icon=\"create\"\n              id=\"button\"\n              label=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject2_64f71260f9d711eab0a41741e72b3233 = function _templateObject2_64f71260f9d711eab0a41741e72b3233() {
      return data;
    };
  ...
  function _templateObject_64f71260f9d711eab0a41741e72b3233() {
    ...
    _templateObject_64f71260f9d711eab0a41741e72b3233 = function _templateObject_64f71260f9d711eab0a41741e72b3233() {
      return data;
    };
   ...
   * @element hax-tray
   */
  var HaxTray = /*#__PURE__*/function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxTray, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_64f71260f9d711eab0a41741e72b3233(), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject2_64f71260f9d711eab0a41741e72b3233(), this.editMode, this._clickEditButton, this.__tipText), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject3_64f71260f9d711eab0a41741e72b3233(), this._clickSaveButton, this.__tipText), this.traySizeIcon, this.traySizeText, this.menuAlignName, !this.canUndo, !this.canRedo, this.hidePreferencesButton, this.activeTagIcon, this.activeTagName, _HAXFields.HaxSchematizer, _HAXFields.HaxElementizer, this._refreshLists);
      }
    }, {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "collapsed") {
            if (_this3[propName]) {
              _this3.traySizeIcon = "hax:hax:arrow-expand-left";
              ...
              _this3.traySizeIcon = "hax:hax:arrow-expand-right";
          ...
          if (propName == "activeNode") {
            if (_this3.activeNode && _this3.activeNode.tagName) {
              _this3.shadowRoot.querySelector("#settingscollapse").disabled = false; // process fields

              _this3.activeHaxElement = (0, _utils.nodeToHaxElement)(_this3.activeNode, null);
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_64f71260f9d711eab0a41741e72b3233())];
      }
    }, {
      key: "properties",
      get: function get() {
