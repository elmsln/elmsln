...
!function ($) {
  ...
  $.extend($, {
    ...
    SIGNAL: "----seadragon----",
    delegate: function delegate(t, i) {
      return function () {
        var e = arguments;
        void 0 === e && (e = []);
        return i.apply(t, e);
    ...
    createCallback: function createCallback(i, n) {
      var e,
          o = [];
    ...
    makeAjaxRequest: function makeAjaxRequest(e, i, n) {
      var t;
      var o;
      var r;
      ...
      try {
        ...
        r && (a.responseType = r);
        if (o) for (var l in o) {
          Object.prototype.hasOwnProperty.call(o, l) && o[l] && a.setRequestHeader(l, o[l]);
        }
...
!function (r) {
  ...
  r.EventSource.prototype = {
    addOnceHandler: function addOnceHandler(t, i, e, n) {
      var o = this;
      n = n || 1;
      var r = 0;
    ...
    addHandler: function addHandler(e, t, i) {
      var n = this.events[e];
      n || (this.events[e] = n = []);
    ...
    removeHandler: function removeHandler(e, t) {
      var i,
          n = this.events[e],
          o = [];
...
!function (v) {
  ...
  v.MouseTracker = function (e) {
    ...
    f[this.hash] = {
      ...
      mouseupcaptured: function mouseupcaptured(e) {
        !function (e, t) {
          R(e, t);
          v.stopEvent(t);
        }(o, e);
      ...
      mousemovecaptured: function mousemovecaptured(e) {
        !function (e, t) {
          _(e, t);
      ...
      touchendcaptured: function touchendcaptured(e) {
        !function (e, t) {
          C(e, t);
          v.stopEvent(t);
        }(o, e);
      ...
      touchmovecaptured: function touchmovecaptured(e) {
        !function (e, t) {
          O(e, t);
          v.stopEvent(t);
        }(o, e);
      ...
      pointerupcaptured: function pointerupcaptured(e) {
        !function (e, t) {
          e.getActivePointersListByType(p(t)).getById(t.pointerId) && M(e, t);
          v.stopEvent(t);
        }(o, e);
      },
      pointermovecaptured: function pointermovecaptured(e) {
        !function (e, t) {
  ...
  v.MouseTracker.prototype = {
    ...
    setTracking: function setTracking(e) {
      (e ? function (e) {
        var t,
            i,
            n = f[e.hash];
    ...
    getActivePointersListsExceptType: function getActivePointersListsExceptType(e) {
      ...
      for (var n = 0; n < t.activePointersLists.length; ++n) {
        t.activePointersLists[n].type !== e && i.push(t.activePointersLists[n]);
      }

      return i;
    },
    getActivePointersListByType: function getActivePointersListByType(e) {
      var t,
          i,
          n = f[this.hash],
  ...
  v.MouseTracker.gesturePointVelocityTracker = (l = [], c = s = 0, {
    addPoint: function addPoint(e, t) {
      var i = r(e, t);
      l.push({
        guid: i,
        gPoint: t,
    ...
    removePoint: function removePoint(e, t) {
      var i,
          n = r(e, t),
          o = l.length;
...
!function (o) {
  ...
  o.ControlDock.prototype = {
    addControl: function addControl(e, t) {
      var i = null;
    ...
    removeControl: function removeControl(e) {
...
!function (m) {
  ...
  m.extend(m.Viewer.prototype, m.EventSource.prototype, m.ControlDock.prototype, {
        ...
        if (i.length) {
          var _l = function _l() {
            if (r + s === n) if (r) {
              ...
              if (o.overlays && !o.preserveOverlays) for (var t = 0; t < o.overlays.length; t++) {
                o.currentOverlays[t] = d(o, o.overlays[t]);
              }
          ...
          var _t = function _t(i) {
            ...
            i.success = function (e) {
              r++;
              if (i.tileSource.overlays) for (var t = 0; t < i.tileSource.overlays.length; t++) {
    ...
    setFullPage: function setFullPage(e) {
      var t,
          i,
          n = document.body,
          o = n.style,
    ...
    addTiledImage: function addTiledImage(i) {
    ...
    addSimpleImage: function addSimpleImage(e) {
    ...
    getLayerAtLevel: function getLayerAtLevel(e) {
    ...
    getLevelOfLayer: function getLevelOfLayer(e) {
    ...
    setLayerLevel: function setLayerLevel(e, t) {
    ...
    addOverlay: function addOverlay(e, t, i, n) {
      var o;
    ...
    updateOverlay: function updateOverlay(e, t, i) {
      var n;
      e = m.getElement(e);
    ...
    getOverlayById: function getOverlayById(e) {
      var t;
      e = m.getElement(e);
    ...
    _showMessage: function _showMessage(e) {
      this._hideMessage();
  ...
  function d(e, t) {
    if (babelHelpers.instanceof(t, m.Overlay)) return t;
    var i = null;
    ...
    m.requestAnimationFrame(function () {
      !function (e) {
        ...
        if (e.controlsShouldFade) {
          ...
          for (o = e.controls.length - 1; 0 <= o; o--) {
            e.controls[o].autoFade && e.controls[o].setOpacity(n);
          }
  ...
  function g(e) {
    ...
    for (t = e.controls.length - 1; 0 <= t; t--) {
...
!function (c) {
  ...
  c.extend(c.Navigator.prototype, c.EventSource.prototype, c.Viewer.prototype, {
    ...
    addTiledImage: function addTiledImage(e) {
      var n = this;
...
!function (s) {
  ...
  s.extend(s, {
    ...
    setString: function setString(e, t) {
      var i,
          n = e.split("."),
          o = a;
...
!function (a) {
  ...
  a.Point.prototype = {
    ...
    equals: function equals(e) {
      return babelHelpers.instanceof(e, a.Point) && this.x === e.x && this.y === e.y;
    },
...
!function (d) {
  d.TileSource = function (e, t, i, n, o, r) {
    ...
    d.extend(!0, this, a);
    if (!this.success) for (l = 0; l < arguments.length; l++) {
  ...
  d.TileSource.prototype = {
    getTileSize: function getTileSize(e) {
    ...
    getNumTiles: function getNumTiles(e) {
    ...
    getPixelRatio: function getPixelRatio(e) {
    ...
    getTileAtPoint: function getTileAtPoint(e, t) {
    ...
    getTileBounds: function getTileBounds(e, t, i, n) {
    ...
    getImageInfo: function getImageInfo(n) {
      var e,
          i,
          o,
          r,
...
!function (g) {
  g.DziTileSource = function (e, t, i, n, o, r, s, a, l) {
    ...
    if (this.displayRects) for (h = this.displayRects.length - 1; 0 <= h; h--) {
    ...
    configure: function configure(e, t) {
      ...
      i = (g.isPlainObject(e) ? p : function (e, t) {
        ...
        if ("Image" == l) try {
          ...
          throw babelHelpers.instanceof(e, Error) ? e : new Error(g.getString("Errors.Dzi"));
        } else {
  ...
  h.extend(h.IIIFTileSource.prototype, h.TileSource.prototype, {
    ...
    configure: function configure(e, t) {
      if (h.isPlainObject(e)) {
        ...
        !e["@id"] && e.id && (e["@id"] = e.id);
        if (e.preferredFormats) for (var o = 0; o < e.preferredFormats.length; o++) {
      ...
      var r = function (e) {
        ...
        if ("info" == i) try {
          !function e(t, i, n) {
            ...
            } else if (1 == t.nodeType) for (o = 0; o < t.childNodes.length; o++) {
              e(t.childNodes[o], i, t.nodeName);
            }
          }(t, n = {});
          return n;
        } catch (e) {
          throw babelHelpers.instanceof(e, Error) ? e : new Error(h.getString("Errors.IIIF"));
        }
...
!function (o) {
  o.ButtonGroup = function (e) {
    ...
    this.tracker = new o.MouseTracker({
      ...
      exitHandler: function exitHandler(e) {
        var t;
        if (!e.insideElementPressed) for (t = 0; t < n.buttons.length; t++) {
...
!function (R) {
  ...
  R.Rect.prototype = {
    ...
    equals: function equals(e) {
      return babelHelpers.instanceof(e, R.Rect) && this.x === e.x && this.y === e.y && this.width === e.width && this.height === e.height && this.degrees === e.degrees;
    },
    times: function times(e) {
...
!function (s) {
  ...
  s.Spring.prototype = {
    ...
    setExponential: function setExponential(e) {
      this._exponential = e;
...
!function (h) {
  ...
  h.Tile.prototype = {
    ...
    drawCanvas: function drawCanvas(e, t, i, n) {
      var o,
      ...
      if (this.context2D || this.cacheImageRecord) {
        ...
        if (this.loaded && o) {
          ...
          babelHelpers.instanceof(n, h.Point) && (r = r.plus(n));
    ...
    getTranslationForEdgeSmoothing: function getTranslationForEdgeSmoothing(e, t, i) {
...
!function (c) {
  ...
  c.Overlay.prototype = {
    _init: function _init(e) {
      ...
      if (babelHelpers.instanceof(this.location, c.Rect)) {
    ...
    drawHTML: function drawHTML(e, t) {
      var i = this.element;
    ...
    _getOverlayPositionAndSize: function _getOverlayPositionAndSize(e) {
    ...
    _getSizeInPixels: function _getSizeInPixels(e) {
      var t = this.size.x;
      var i = this.size.y;
    ...
    _getPlacementPoint: function _getPlacementPoint(e) {
    ...
    _adjustBoundsForRotation: function _adjustBoundsForRotation(e, t) {
...
!function (u) {
  ...
  u.Drawer.prototype = {
    ...
    setOpacity: function setOpacity(e) {
      ...
      for (var i = 0; i < t.getItemCount(); i++) {
    ...
    viewportToDrawerRectangle: function viewportToDrawerRectangle(e) {
    ...
    drawTile: function drawTile(e, t, i, n, o) {
    ...
    blendSketch: function blendSketch(e, t, i, n) {
      var o = e;
      u.isPlainObject(o) || (o = {
        opacity: e,
        scale: t,
      ...
      if (this.useCanvas && this.sketchCanvas) {
        ...
        if (r) {
          ...
          t = o.scale || 1;
          var s = babelHelpers.instanceof(i = o.translate, u.Point) ? i : new u.Point(0, 0);
          var a = 0;
          var l = 0;
    ...
    drawDebugInfo: function drawDebugInfo(e, t, i, n) {
      if (this.useCanvas) {
    ...
    debugRect: function debugRect(e) {
      if (this.useCanvas) {
        var t = this.context;
        t.save();
    ...
    setImageSmoothingEnabled: function setImageSmoothingEnabled(e) {
      if (this.useCanvas) {
    ...
    _updateImageSmoothingEnabled: function _updateImageSmoothingEnabled(e) {
      e.msImageSmoothingEnabled = this._imageSmoothingEnabled;
      e.imageSmoothingEnabled = this._imageSmoothingEnabled;
    },
    getCanvasSize: function getCanvasSize(e) {
    ...
    _offsetForRotation: function _offsetForRotation(e) {
...
!function (p) {
  p.Viewport = function (e) {
    var t = arguments;
    t.length && babelHelpers.instanceof(t[0], p.Point) && (e = {
      containerSize: t[0],
      contentSize: t[1],
      config: t[2]
    });
  ...
  p.Viewport.prototype = {
    resetContentSize: function resetContentSize(e) {
      p.console.assert(e, "[Viewport.resetContentSize] contentSize is required");
      p.console.assert(babelHelpers.instanceof(e, p.Point), "[Viewport.resetContentSize] contentSize must be an OpenSeadragon.Point");
    ...
    setHomeBounds: function setHomeBounds(e, t) {
    ...
    _setContentBounds: function _setContentBounds(e, t) {
      p.console.assert(e, "[Viewport._setContentBounds] bounds is required");
      p.console.assert(babelHelpers.instanceof(e, p.Rect), "[Viewport._setContentBounds] bounds must be an OpenSeadragon.Rect");
    ...
    setMargins: function setMargins(e) {
    ...
    getBoundsNoRotate: function getBoundsNoRotate(e) {
    ...
    _applyBoundaryConstraints: function _applyBoundaryConstraints(e) {
    ...
    _fitBounds: function _fitBounds(e, t) {
    ...
    fitVertically: function fitVertically(e) {
    ...
    fitHorizontally: function fitHorizontally(e) {
    ...
    zoomTo: function zoomTo(e, t, i) {
      var n = this;
      this.zoomPoint = babelHelpers.instanceof(t, p.Point) && !isNaN(t.x) && !isNaN(t.y) ? t : null;
    ...
    _pixelFromPointNoRotate: function _pixelFromPointNoRotate(e, t) {
    ...
    pointFromPixelNoRotate: function pointFromPixelNoRotate(e, t) {
    ...
    _viewportToImageDelta: function _viewportToImageDelta(e, t) {
    ...
    viewportToImageCoordinates: function viewportToImageCoordinates(e, t) {
      if (babelHelpers.instanceof(e, p.Point)) return this.viewportToImageCoordinates(e.x, e.y);
    ...
    _imageToViewportDelta: function _imageToViewportDelta(e, t) {
      var i = this._contentBoundsNoRotate.width;
      return new p.Point(e / this._contentSizeNoRotate.x * i, t / this._contentSizeNoRotate.x * i);
    },
    imageToViewportCoordinates: function imageToViewportCoordinates(e, t) {
      if (babelHelpers.instanceof(e, p.Point)) return this.imageToViewportCoordinates(e.x, e.y);
    ...
    imageToViewportRectangle: function imageToViewportRectangle(e, t, i, n) {
      var o = e;
      babelHelpers.instanceof(o, p.Rect) || (o = new p.Rect(e, t, i, n));
    ...
    viewportToImageRectangle: function viewportToImageRectangle(e, t, i, n) {
      var o = e;
      babelHelpers.instanceof(o, p.Rect) || (o = new p.Rect(e, t, i, n));
    ...
    viewerElementToViewportRectangle: function viewerElementToViewportRectangle(e) {
    ...
    viewportToViewerElementRectangle: function viewportToViewerElementRectangle(e) {
    ...
    windowToViewportCoordinates: function windowToViewportCoordinates(e) {
    ...
    viewportToWindowCoordinates: function viewportToWindowCoordinates(e) {
...
!function (y) {
  y.TiledImage = function (e) {
    ...
    y.console.assert(!e.clip || babelHelpers.instanceof(e.clip, y.Rect), "[TiledImage] options.clip must be an OpenSeadragon.Rect if present");
    ...
    babelHelpers.instanceof(e.clip, y.Rect) && (this._clip = e.clip.clone());
    delete e.clip;
    var i = e.x || 0;
    delete e.x;
    var n = e.y || 0;
  ...
  y.extend(y.TiledImage.prototype, y.EventSource.prototype, {
    ...
    getClippedBounds: function getClippedBounds(e) {
      var t = this.getBoundsNoRotate(e);
    ...
    _viewportToImageDelta: function _viewportToImageDelta(e, t, i) {
    ...
    viewportToImageCoordinates: function viewportToImageCoordinates(e, t, i) {
      var n;

      if (babelHelpers.instanceof(e, y.Point)) {
        i = t;
        n = e;
    ...
    _imageToViewportDelta: function _imageToViewportDelta(e, t, i) {
      var n = i ? this._scaleSpring.current.value : this._scaleSpring.target.value;
      return new y.Point(e / this.source.dimensions.x * n, t / this.source.dimensions.y / this.contentAspectX * n);
    },
    imageToViewportCoordinates: function imageToViewportCoordinates(e, t, i) {
      if (babelHelpers.instanceof(e, y.Point)) {
        i = t;
        t = e.y;
        e = e.x;
    ...
    imageToViewportRectangle: function imageToViewportRectangle(e, t, i, n, o) {
      var r = e;
      babelHelpers.instanceof(r, y.Rect) ? o = t : r = new y.Rect(e, t, i, n);
    ...
    viewportToImageRectangle: function viewportToImageRectangle(e, t, i, n, o) {
      var r = e;
      babelHelpers.instanceof(e, y.Rect) ? o = t : r = new y.Rect(e, t, i, n);
    ...
    _viewportToTiledImageRectangle: function _viewportToTiledImageRectangle(e) {
    ...
    setCroppingPolygons: function setCroppingPolygons(e) {
      function t(e) {
        return e.map(function (e) {
          try {
            if (babelHelpers.instanceof(t = e, y.Point) || "number" == typeof t.x && "number" == typeof t.y) return {
              x: e.x,
              y: e.y
            };
            throw new Error();
    ...
    resetCroppingPolygons: function resetCroppingPolygons() {
      this._croppingPolygons = null;
    },
    fitBounds: function fitBounds(e, t, i) {
    ...
    setClip: function setClip(e) {
      y.console.assert(!e || babelHelpers.instanceof(e, y.Rect), "[TiledImage.setClip] newClip must be an OpenSeadragon.Rect or null");
      babelHelpers.instanceof(e, y.Rect) ? this._clip = e.clone() : this._clip = null;
      this._needsDraw = !0;
    ...
    _getCornerTiles: function _getCornerTiles(e, t, i) {
      var n;
      var o;
...
!function (g) {
  ...
  v.prototype = {
    ...
    setRenderedContext: function setRenderedContext(e) {
  ...
  g.TileCache.prototype = {
    ...
    cacheTile: function cacheTile(e) {
      g.console.assert(e, "[TileCache.cacheTile] options is required");
      g.console.assert(e.tile, "[TileCache.cacheTile] options.tile is required");
      ...
      if (this._imagesLoadedCount > this._maxImageCacheCount) {
        ...
        for (var p = this._tilesLoaded.length - 1; 0 <= p; p--) {
          if (!((a = (d = this._tilesLoaded[p]).tile).level <= t || a.beingDrawn)) if (o) {
            c = a.lastTouchTime;
            l = o.lastTouchTime;
            u = a.level;
            h = o.level;
    ...
    clearTilesFor: function clearTilesFor(e) {
...
!function (v) {
  ...
  v.extend(v.World.prototype, v.EventSource.prototype, {
    addItem: function addItem(e, t) {
      ...
      v.console.assert(babelHelpers.instanceof(e, v.TiledImage), "[World.addItem] only TiledImages supported at this time");
    ...
    getIndexOfItem: function getIndexOfItem(e) {
    ...
    setItemIndex: function setItemIndex(e, t) {
