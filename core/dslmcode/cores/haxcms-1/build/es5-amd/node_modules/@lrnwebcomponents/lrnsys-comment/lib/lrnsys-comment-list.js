define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../../@polymer/iron-form-element-behavior/iron-form-element-behavior.js", "../../../@polymer/app-layout/app-layout.js", "../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../simple-toast/simple-toast.js", "../../simple-modal/simple-modal.js", "../../../@polymer/paper-input/paper-input.js", "../../../@polymer/paper-button/paper-button.js", "../../../@polymer/paper-listbox/paper-listbox.js", "../../lrnsys-button/lrnsys-button.js", "../../grafitto-filter/grafitto-filter.js", "../../simple-fields/lib/simple-fields-container.js", "../lrnsys-comment.js"], function (_exports, _polymerElement, _ironAjax, _ironFormElementBehavior, _appLayout, _appToolbar, _simpleToast, _simpleModal, _paperInput, _paperButton, _paperListbox, _lrnsysButton, _grafittoFilter, _simpleFieldsContainer, _lrnsysComment) {
  ...
  function _templateObject_5d64aae0ac2411ea9505735c97269ace() {
    ...
    _templateObject_5d64aae0ac2411ea9505735c97269ace = function _templateObject_5d64aae0ac2411ea9505735c97269ace() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(LrnsysCommentList, [{
      ...
      value: function connectedCallback() {
        ...
        this.shadowRoot.querySelector("#filtertype").addEventListener("change", function (e) {
          _this2.shadowRoot.querySelector("#filtercomments").value = "";
          _this2.shadowRoot.querySelector("#filteredcomments").where = e.detail.value;
          _this2.shadowRoot.querySelector("#filteredcomments").like = "";
        });
      }
      /**
       * detached life cycle
      ...
      value: function disconnectedCallback() {
        ...
        this.shadowRoot.querySelector("#filtertype").removeEventListener("change", function (e) {
          _this3.shadowRoot.querySelector("#filtercomments").value = "";
          _this3.shadowRoot.querySelector("#filteredcomments").where = e.detail.value;
          _this3.shadowRoot.querySelector("#filteredcomments").like = "";
        });
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_5d64aae0ac2411ea9505735c97269ace());
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    function LrnsysCommentList() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrnsysCommentList).call(this));
    ...
    babelHelpers.createClass(LrnsysCommentList, [{
      ...
      value: function handleDeleteDialog(e) {
        ...
        var t = document.createTextNode("Are you sure you want to delete your comment?");
