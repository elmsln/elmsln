define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/iron-list/iron-list.js", "../../../../@polymer/iron-pages/iron-pages.js", "../../../../@polymer/iron-selector/iron-selector.js", "../../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../../../@polymer/app-route/app-location.js", "../../../../@polymer/app-route/app-route.js", "../../../../@polymer/paper-dropdown-menu/paper-dropdown-menu.js", "../../../../@polymer/paper-listbox/paper-listbox.js", "../../../../@polymer/paper-item/paper-item.js", "../../../../@polymer/paper-toast/paper-toast.js", "../../../lrndesign-gallerycard/lrndesign-gallerycard.js", "../../../elmsln-loading/elmsln-loading.js", "./lrnapp-open-studio-table.js", "./lrnapp-open-studio-projects.js", "./lrnapp-open-studio-assignments.js"], function (_exports, _litElement, _ironAjax, _ironList, _ironPages, _ironSelector, _appToolbar, _appLocation, _appRoute, _paperDropdownMenu, _paperListbox, _paperItem, _paperToast, _lrndesignGallerycard, _elmslnLoading, _lrnappOpenStudioTable, _lrnappOpenStudioProjects, _lrnappOpenStudioAssignments) {
  ...
  function _templateObject5_025852201bb311eabd7cc30119585ddb() {
    ...
    _templateObject5_025852201bb311eabd7cc30119585ddb = function _templateObject5_025852201bb311eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject4_025852201bb311eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <paper-item item-id=\"", "\"\n                  >", "</paper-item\n                >\n              "]);

    _templateObject4_025852201bb311eabd7cc30119585ddb = function _templateObject4_025852201bb311eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject3_025852201bb311eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <paper-item item-id=\"", "\"\n                  >", "</paper-item\n                >\n              "]);

    _templateObject3_025852201bb311eabd7cc30119585ddb = function _templateObject3_025852201bb311eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject2_025852201bb311eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <paper-item item-id=\"", "\"\n                  >", "</paper-item\n                >\n              "]);

    _templateObject2_025852201bb311eabd7cc30119585ddb = function _templateObject2_025852201bb311eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject_025852201bb311eabd7cc30119585ddb() {
    ...
    _templateObject_025852201bb311eabd7cc30119585ddb = function _templateObject_025852201bb311eabd7cc30119585ddb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnappOpenStudio, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_025852201bb311eabd7cc30119585ddb(), this.sourcePath, this.studioResponseChangedEvent, this._handleResponse, this.route, this.routeChangedEvent, this.queryParams, this.queryParamsChangedEvent, this.route, this.routeChangedEvent, this.data, this.dataChangedEvent, this.tail, this.tailChangedEvent, this.queryParams, this.queryParamsChangedEvent, this.endPoint, this.data.page, this.dataPageChangedEvent, this._submissionsClicked, this._projectsClicked, this._assignmentsClicked, this._tableClicked, this.submissions.length, this.originalSubmissions.length, !this.authors, this.queryParams.author, this.queryParamsAuthorEvent, this._toArray(this.authors).map(function (author) {
          return (0, _litElement.html)(_templateObject2_025852201bb311eabd7cc30119585ddb(), author.id, author.display_name);
        }), !this.projects, this.queryParams.project, this.queryParamsProjectEvent, this._toArray(this.projects).map(function (project) {
          return (0, _litElement.html)(_templateObject3_025852201bb311eabd7cc30119585ddb(), project.id, project.attributes.title);
          ...
          return (0, _litElement.html)(_templateObject4_025852201bb311eabd7cc30119585ddb(), assignment.id, assignment.attributes.title);
      ...
      value: function dataPageChangedEvent(e) {
        ...
        this.data = babelHelpers.objectSpread({}, attr);
      }
    }, {
      ...
      value: function queryParamsAssignmentEvent(e) {
        ...
        this.queryParams.attributes = babelHelpers.objectSpread({}, attr);
      }
    }, {
      ...
      value: function studioResponseChangedEvent(e) {
        this.studioResponse = babelHelpers.objectSpread({}, e.detail.value);
      }
    }, {
      key: "queryParamsChangedEvent",
      value: function queryParamsChangedEvent(e) {
        this.queryParams = babelHelpers.objectSpread({}, e.detail.value);
      }
    }, {
      key: "dataChangedEvent",
      value: function dataChangedEvent(e) {
        this.data = babelHelpers.objectSpread({}, e.detail.value);
      }
    }, {
      ...
      value: function tailChangedEvent(e) {
        this.tail = babelHelpers.objectSpread({}, e.detail.value);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_025852201bb311eabd7cc30119585ddb())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    babelHelpers.createClass(LrnappOpenStudio, [{
      ...
      value: function _routeChange(e) {
        ...
        if (babelHelpers.typeof(details.queryParams.assignment) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          this.queryParams = babelHelpers.objectSpread({}, attr);
        }
        ...
        if (babelHelpers.typeof(details.queryParams.project) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          this.queryParams = babelHelpers.objectSpread({}, _attr);
        }
        ...
        if (babelHelpers.typeof(details.queryParams.author) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          this.queryParams = babelHelpers.objectSpread({}, _attr2);
        }
        ...
        if (babelHelpers.typeof(details.data.page) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          this.data = babelHelpers.objectSpread({}, _attr3);
        }
      }
    }, {
      ...
      value: function _tableClicked(e) {
        ...
        this.route = babelHelpers.objectSpread({}, attr);
      }
      /**
