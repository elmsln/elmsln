define(["exports", "../../../../../lit-element/lit-element.js", "../../../../../@polymer/iron-list/iron-list.js", "./site-query.js"], function (_exports, _litElement, _ironList, _siteQuery) {
  ...
  var _templateObject_f2e66de0b80f11eb903f3b4791d1f11f, _templateObject2_f2e66de0b80f11eb903f3b4791d1f11f;
  ...
  var SiteRenderQuery = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SiteRenderQuery, [{
      ...
      function render() {
        return (0, _litElement.html)(_templateObject_f2e66de0b80f11eb903f3b4791d1f11f || (_templateObject_f2e66de0b80f11eb903f3b4791d1f11f = babelHelpers.taggedTemplateLiteral(["\n      <site-query\n        .result=\"", "\"\n        @result-changed=\"", "\"\n        .sort=\"", "\"\n        .conditions=\"", "\"\n      ></site-query>\n      <iron-list\n        id=\"list\"\n        .items=\"", "\"\n        ?grid=\"", "\"\n        mutable-data\n      >\n        <slot></slot>\n      </iron-list>\n    "])), this.result, this.resultEvent, this.sort, this.conditions, this.__items, this.grid);
      }
    }, {
      key: "resultEvent",
       ...
       */
      function get() {
        return [(0, _litElement.css)(_templateObject2_f2e66de0b80f11eb903f3b4791d1f11f || (_templateObject2_f2e66de0b80f11eb903f3b4791d1f11f = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "])))];
      }
      /**
