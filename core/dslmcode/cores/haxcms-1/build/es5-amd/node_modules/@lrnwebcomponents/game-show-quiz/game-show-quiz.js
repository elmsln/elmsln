define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/mixins/mutable-data.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/polymer/lib/legacy/polymer.dom.js", "../hax-body-behaviors/lib/HAXWiring.js", "../hax-body/lib/haxutils.js", "../../@polymer/paper-button/paper-button.js", "../simple-toast/simple-toast.js", "../../@polymer/iron-ajax/iron-ajax.js", "../simple-colors/simple-colors.js", "../../@vaadin/vaadin-split-layout/vaadin-split-layout.js", "../multiple-choice/multiple-choice.js", "./lib/game-show-quiz-modal.js"], function (_exports, _require, _polymerElement, _mutableData, _renderStatus, _polymerDom, _HAXWiring, _haxutils, _paperButton, _simpleToast, _ironAjax, _simpleColors, _vaadinSplitLayout, _multipleChoice, _gameShowQuizModal) {
  ...
  function _templateObject_5bb4fd40a99511e99df119a4fb9cecf3() {
    ...
    _templateObject_5bb4fd40a99511e99df119a4fb9cecf3 = function _templateObject_5bb4fd40a99511e99df119a4fb9cecf3() {
      return data;
    };
  ...
  function (_MutableData) {
    ...
    function GameShowQuiz() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(GameShowQuiz).call(this));
    ...
    babelHelpers.createClass(GameShowQuiz, [{
       ...
       */
      value: function _gameDirectionsChanged(newValue) {
        if (newValue) {
      ...
      value: function continueGameTap(e) {
        ...
        // logically
        if (babelHelpers.typeof(this.__activeTap) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && (0, _polymerDom.dom)(this.__activeTap).parentNode.nextElementSibling.firstElementChild != null) {
          (0, _polymerDom.dom)(this.__activeTap).parentNode.nextElementSibling.firstElementChild.focus();
      ...
      value: function submitAnswer(e) {
        ...
        if (!this.__activeQuestionDetails.isBonus) {
          ...
          if (unlockCheck === unlockThreashold) {
            this.shadowRoot.querySelectorAll('responsive-grid-col paper-button[data-type="bonus"][data-display-points="' + this.__activeQuestionDetails.points + '"]').forEach(function (item) {
        ...
        if (this.points[this.__activeType].attempted == 11 && !this.__activeQuestionDetails.isBonus) {
          // get last row
          this.shadowRoot.querySelectorAll('responsive-grid-col paper-button[data-is-bonus][data-type="' + this.__activeType + '"]').forEach(function (item) {
            item.removeAttribute("disabled");
            var uuid = item.getAttribute("data-question-uuid"); // bonus always last row, make data match the operation
        ...
        if (this.remainingAttempts === 2) {
          this.shadowRoot.querySelectorAll("responsive-grid-col paper-button[data-value='3']:not([disabled]):not([data-is-bonus])").forEach(function (item) {
            item.setAttribute("disabled", "disabled");
          });
        }

        if (this.remainingAttempts === 1) {
          this.shadowRoot.querySelectorAll("responsive-grid-col paper-button[data-value='2']:not([disabled]):not([data-is-bonus])").forEach(function (item) {
            item.setAttribute("disabled", "disabled");
          });
          this.shadowRoot.querySelectorAll('responsive-grid-col paper-button[data-value="3"]:not([disabled]):not([data-is-bonus])').forEach(function (item) {
            item.setAttribute("disabled", "disabled");
        ...
        if (this.remainingAttempts <= 0) {
          this.shadowRoot.querySelectorAll("responsive-grid-col paper-button:not([disabled]):not([data-is-bonus])").forEach(function (item) {
            item.setAttribute("disabled", "disabled");
          });
          ...
          if (this.shadowRoot.querySelectorAll("responsive-grid-col paper-button[data-is-bonus]:not([disabled])").length === 0) {
            ...
            if (this.gameScoreBoardBackend) {
              this.$.gamebackend.url = "".concat(this.gameScoreBoardBackend, "/").concat(this.title, "/").concat(this.points.total.earned, "?token=").concat(this.token);
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(GameShowQuiz.prototype), "connectedCallback", this).call(this); // punch a basic hole for elms:ln to make life easier for IDs

        if (window.Drupal && window.Drupal.settings && window.Drupal.settings.distro) {
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_5bb4fd40a99511e99df119a4fb9cecf3());
      }
    }, {
      key: "properties",
      get: function get() {
