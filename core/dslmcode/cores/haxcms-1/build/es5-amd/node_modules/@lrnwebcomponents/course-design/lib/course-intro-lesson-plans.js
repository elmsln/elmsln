define(["../../../lit/index.js", "../../haxcms-elements/lib/core/haxcms-site-store.js", "../../../mobx/dist/mobx.esm.js", "./course-intro-lesson-plan.js"], function (_index, _haxcmsSiteStore, _mobxEsm, _courseIntroLessonPlan) {
  ...
  var _templateObject_992845601bd511ecb06de58eee077492, _templateObject2_992845601bd511ecb06de58eee077492, _templateObject3_992845601bd511ecb06de58eee077492;
  ...
  var CourseIntroLessonPlans = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(CourseIntroLessonPlans, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_992845601bd511ecb06de58eee077492 || (_templateObject_992845601bd511ecb06de58eee077492 = babelHelpers.taggedTemplateLiteral(["\n      <h2 id=\"title\">Lesson Plan</h2>\n      <div id=\"plans-container\">\n        ", "\n      </div>\n    "])), this.items.map(function (plan) {
          return (0, _index.html)(_templateObject2_992845601bd511ecb06de58eee077492 || (_templateObject2_992845601bd511ecb06de58eee077492 = babelHelpers.taggedTemplateLiteral(["<course-intro-lesson-plan\n              title=\"", "\"\n              description=", "\n              link=", "\n            ></course-intro-lesson-plan>"])), plan.title, plan.metadata.courselist.description ? plan.metadata.courselist.description : "", plan.slug);
        }));
      }
    }], [{
      key: "properties",
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject3_992845601bd511ecb06de58eee077492 || (_templateObject3_992845601bd511ecb06de58eee077492 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        #title {\n          color: white;\n          font-family: \"Lato\";\n          text-transform: uppercase;\n          font-weight: 400;\n          text-align: center;\n          letter-spacing: 4.48px;\n          font-size: 1.4em;\n        }\n        #plans-container {\n          background: white;\n          margin: 0 auto;\n          max-width: 900px;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
