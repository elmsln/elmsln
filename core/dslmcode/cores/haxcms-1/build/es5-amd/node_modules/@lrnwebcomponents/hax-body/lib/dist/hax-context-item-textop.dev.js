...
exports.HaxContextItemTextop = void 0;
...
var HaxContextItemTextop = /*#__PURE__*/function (_HaxToolbarItemBehavi) {
  _inherits(HaxContextItemTextop, _HaxToolbarItemBehavi);

  function HaxContextItemTextop() {
    var _this;

    _classCallCheck(this, HaxContextItemTextop);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(HaxContextItemTextop).call(this));
    _this.action = false;
  ...
  _createClass(HaxContextItemTextop, [{
    key: "_handleKeys",
    ...
    key: "properties",
    get: function get() {
      return _objectSpread({}, _get(_getPrototypeOf(HaxContextItemTextop), "properties", this), {
        /**
...
exports.HaxContextItemTextop = HaxContextItemTextop;
