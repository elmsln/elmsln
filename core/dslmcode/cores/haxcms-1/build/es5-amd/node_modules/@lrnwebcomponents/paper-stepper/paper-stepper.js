define(["exports","../../@polymer/polymer/polymer-element.js"],function(_exports,_polymerElement){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PaperStepper=void 0;/**
...
value:function _tapPrevious(){this.shadowRoot.querySelector("#selector").selectPrevious()}},{key:"_tapNext",value:function _tapNext(){this.shadowRoot.querySelector("#selector").selectNext()}/**
   ...
   */},{key:"_computeProgressValue",value:function _computeProgressValue(selected,items){return selected+1}},{key:"_onItemsChanged",value:function _onItemsChanged(e){this._items=this.shadowRoot.querySelector("#selector").items}}],[{key:"tag",get:function get(){return"paper-stepper"}},{key:"properties",get:function get(){return{selected:{type:Number,notify:!0,value:0},/**
