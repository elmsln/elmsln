define(["exports", "../../../../../lit-element/lit-element.js", "../../core/utils/HAXCMSThemeParts.js", "../../core/utils/HAXCMSI18NMixin.js", "../../../../simple-icon/lib/simple-icons.js", "../../../../simple-icon/lib/simple-icon-button.js", "../../../../simple-tooltip/simple-tooltip.js"], function (_exports, _litElement, _HAXCMSThemeParts, _HAXCMSI18NMixin2, _simpleIcons, _simpleIconButton, _simpleTooltip) {
  "use strict";
  ...
  var _templateObject_1b7afbb0d39311eb9590b786b63a9382, _templateObject2_1b7afbb0d39311eb9590b786b63a9382;
  ...
  var SiteRSSButton = /*#__PURE__*/function (_HAXCMSI18NMixin) {
    ...
    babelHelpers.createClass(SiteRSSButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_1b7afbb0d39311eb9590b786b63a9382 || (_templateObject_1b7afbb0d39311eb9590b786b63a9382 = babelHelpers.taggedTemplateLiteral(["\n      <a\n        ?disabled=\"", "\"\n        tabindex=\"-1\"\n        href=\"", "\"\n        .id=\"btn", "\"\n        target=\"_blank\"\n        rel=\"noopener noreferrer\"\n        .aria-label=\"", "\"\n        .part=\"", "\"\n      >\n        <simple-icon-button-lite\n          icon=\"", "\"\n          @click=\"", "\"\n          aria-labelledby=\"btn", "\"\n          ?disabled=\"", "\"\n          .part=\"", "\"\n        ></simple-icon-button-lite>\n      </a>\n      <simple-tooltip\n        .for=\"btn", "\"\n        position=\"", "\"\n        offset=\"14\"\n      >\n        ", "\n      </simple-tooltip>\n    "])), this.disabled, this.href, this.type, this._link.title, this.editMode ? "edit-mode-active" : "", this.icon, this.print, this.type, this.disabled, this.editMode ? "edit-mode-active" : "", this.type, this.position, this._link.title);
      }
      /**
       ...
       */
      function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SiteRSSButton), "styles", this)), [(0, _litElement.css)(_templateObject2_1b7afbb0d39311eb9590b786b63a9382 || (_templateObject2_1b7afbb0d39311eb9590b786b63a9382 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          color: var(--site-rss-button-color, inherit);\n        }\n        a {\n          text-decoration: var(--site-rss-text-decoration);\n          outline: none;\n          color: var(--site-rss-button-color, inherit);\n        }\n        simple-icon-button-lite {\n          color: var(--site-rss-button-color, inherit);\n        }\n        simple-tooltip {\n          --simple-tooltip-background: var(\n            --haxcms-tooltip-background-color,\n            #000000\n          );\n          --simple-tooltip-opacity: 1;\n          --simple-tooltip-text-color: var(--haxcms-tooltip-color, #ffffff);\n          --simple-tooltip-delay-in: 0;\n          --simple-tooltip-border-radius: 0;\n        }\n      "])))]);
      }
      /**
  ...
  }((0, _HAXCMSI18NMixin2.HAXCMSI18NMixin)((0, _HAXCMSThemeParts.HAXCMSThemeParts)(_litElement.LitElement)));
