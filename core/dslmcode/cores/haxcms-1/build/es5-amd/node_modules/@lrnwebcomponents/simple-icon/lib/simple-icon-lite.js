define(["exports", "../../../lit-element/lit-element.js", "./simple-iconset.js"], function (_exports, _litElement, _simpleIconset) {
  ...
  var _templateObject_9a16b3a0b8e611eb906d9debaeb411a7, _templateObject2_9a16b3a0b8e611eb906d9debaeb411a7, _templateObject3_9a16b3a0b8e611eb906d9debaeb411a7;
  ...
  var SimpleIconBehaviors = function SimpleIconBehaviors(SuperClass) {
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        function render() {
          return (0, _litElement.svg)(_templateObject_9a16b3a0b8e611eb906d9debaeb411a7 || (_templateObject_9a16b3a0b8e611eb906d9debaeb411a7 = babelHelpers.taggedTemplateLiteral(["\n        <svg xmlns=\"http://www.w3.org/2000/svg\" part=\"simple-icon-svg\" viewBox=\"0 0 24 24\" preserveAspectRatio=\"xMidYMid meet\">\n          <filter\n            color-interpolation-filters=\"sRGB\"\n            x=\"0\"\n            y=\"0\"\n            height=\"24px\"\n            width=\"24px\"\n          >\n            ", "\n            <feComposite operator=\"in\" in=\"COLOR\" in2=\"SourceAlpha\" />\n          </filter>\n          <image\n            xlink:href=\"\"\n            width=\"24px\"\n            height=\"24px\"\n            focusable=\"false\"\n            preserveAspectRatio=\"xMidYMid meet\"\n          ></image>\n        </svg>\n      "])), this.feFlood);
        }
      }, {
        key: "feFlood",
        get: function get() {
          return !this.noColorize ? (0, _litElement.svg)(_templateObject2_9a16b3a0b8e611eb906d9debaeb411a7 || (_templateObject2_9a16b3a0b8e611eb906d9debaeb411a7 = babelHelpers.taggedTemplateLiteral(["<feFlood result=\"COLOR\" />"]))) : "";
        ...
        key: "styles",
        get: function get() {
          return [babelHelpers.get(babelHelpers.getPrototypeOf(_class), "styles", this) || []].concat([(0, _litElement.css)(_templateObject3_9a16b3a0b8e611eb906d9debaeb411a7 || (_templateObject3_9a16b3a0b8e611eb906d9debaeb411a7 = babelHelpers.taggedTemplateLiteral(["\n          :host {\n            display: inline-flex;\n            align-items: center;\n            justify-content: center;\n            position: relative;\n            vertical-align: middle;\n            height: var(--simple-icon-height, 24px);\n            width: var(--simple-icon-width, 24px);\n          }\n          :host([dir=\"rtl\"]) svg {\n            direction: rtl;\n          }\n          :host([hidden]) {\n            display: none;\n          }\n          svg {\n            height: var(--simple-icon-height, 24px);\n            width: var(--simple-icon-width, 24px);\n            max-height: var(--simple-icon-height, 24px);\n            max-width: var(--simple-icon-width, 24px);\n            filter: var(--simple-icon-color, initial);\n          }\n          feFlood {\n            flood-color: var(--simple-icon-color, currentColor);\n          }\n          svg {\n            pointer-events: none;\n          }\n        "])))]);
        }
      }, {
        key: "properties",
        get: function get() {
