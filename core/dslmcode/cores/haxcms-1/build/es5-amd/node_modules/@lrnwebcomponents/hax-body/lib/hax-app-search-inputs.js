define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../eco-json-schema-form/lib/eco-json-schema-object.js", "../../simple-colors/simple-colors.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _ecoJsonSchemaObject, _simpleColors, _haxSharedStyles) {
  "use strict";
  ...
  function _templateObject_3bf327b0dbdc11e9bcafdb98156fc1d6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n        eco-json-schema-object {\n          color: var(--hax-color-text);\n        }\n        .search-label {\n          font-size: 24px;\n          color: var(--hax-color-text);\n          font-weight: bold;\n          margin: 0;\n          padding: 0;\n        }\n      </style>\n      <div class=\"search-label\">Search [[label]]</div>\n      <eco-json-schema-object\n        id=\"form\"\n        schema=\"[[schema]]\"\n        value=\"{{values}}\"\n      ></eco-json-schema-object>\n    "]);

    _templateObject_3bf327b0dbdc11e9bcafdb98156fc1d6 = function _templateObject_3bf327b0dbdc11e9bcafdb98156fc1d6() {
      return data;
    };
  ...
  */
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(HaxAppSearchInputs, _PolymerElement);
    ...
    babelHelpers.createClass(HaxAppSearchInputs, [{
       ...
       */
      value: function _valueChanged(change) {
        this.dispatchEvent(new CustomEvent("hax-app-search-values-changed", {
          bubbles: true,
          cancelable: true,
          composed: true,
          detail: change.base
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_3bf327b0dbdc11e9bcafdb98156fc1d6());
      }
    }, {
      key: "tag",
      get: function get() {
