  ...
  return function (z) {
    ...
    function w(C, F, D, E) {
      ...
      for (; B < C.length; B++) {
        ...
        if (typeof G === "string") {
          ...
          if (babelHelpers.instanceof(G, RegExp)) {
            if (G.test(E)) {
              break;
            }
          } else {
    ...
    function n(D, B, C) {
      switch (z.arrayAccessForm) {
        case "property":
          if (!babelHelpers.instanceof(D[B], Array)) {
            D[B + "_asArray"] = [D[B]];
          } else {
            D[B + "_asArray"] = D[B];
          }
      ...
      if (!babelHelpers.instanceof(D[B], Array) && z.arrayAccessFormPaths.length > 0) {
      ...
      if (D.nodeType == h.DOCUMENT_NODE) {
        ...
        if (D.nodeType == h.ELEMENT_NODE) {
            ...
            if (C.nodeType != h.COMMENT_NODE) {
              ...
              if (b(K, C.nodeType, I, H)) {
                ...
                if (K[I] == null) {
                  ...
                  if (K[I] != null) {
                    if (!babelHelpers.instanceof(K[I], Array)) {
                      K[I] = [K[I]];
                      n(K, I, H);
                    }
                  }
          ...
          if (K["#text"] != null) {
            ...
            if (babelHelpers.instanceof(K.__text, Array)) {
    ...
    function y(C, B) {
      if (z.arrayAccessForm == "property" && v(B.toString(), "_asArray") || B.toString().indexOf(z.attributePrefix) == 0 || B.toString().indexOf("__") == 0 || babelHelpers.instanceof(C[B], Function)) {
        return true;
      } else {
        return false;
      }
    ...
    function m(D) {
      ...
      if (babelHelpers.instanceof(D, Object)) {
        for (var B in D) {
          if (y(D, B)) {
            continue;
          }
    ...
    function d(C) {
      ...
      if (babelHelpers.instanceof(C, Object)) {
        B += g(C);
      } else {
        if (C != null) {
          if (z.escapeMode) {
      ...
      if (F > 0) {
        for (var E in I) {
          ...
          if (D == null || D == undefined) {
            ...
            if (babelHelpers.instanceof(D, Object)) {
              if (babelHelpers.instanceof(D, Array)) {
                B += f(D, E, G, H);
              } else {
                if (babelHelpers.instanceof(D, Date)) {
                  B += o(D, E, G, false);
                  B += D.toISOString();
                  B += j(D, E);
                } else {
    ...
    this.asArray = function (B) {
      if (B === undefined || B == null) {
        ...
        if (babelHelpers.instanceof(B, Array)) {
          return B;
        } else {
          return [B];
        }
    ...
    this.toXmlDateTime = function (B) {
      if (babelHelpers.instanceof(B, Date)) {
