define(["exports", "../../@polymer/polymer/polymer-element.js", "../../@polymer/paper-toast/paper-toast.js", "../../@polymer/paper-button/paper-button.js", "../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../@polymer/polymer/lib/utils/async.js"], function (_exports, _polymerElement, _paperToast, _paperButton, _polymerDom, async) {
  "use strict";
  ...
  function _templateObject_2bf4ccc0e3b511e9b0d5a5c01151ac03() {
    ...
    _templateObject_2bf4ccc0e3b511e9b0d5a5c01151ac03 = function _templateObject_2bf4ccc0e3b511e9b0d5a5c01151ac03() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(SimpleToast, _PolymerElement);

    function SimpleToast() {
      babelHelpers.classCallCheck(this, SimpleToast);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SimpleToast).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(SimpleToast, [{
      ...
      value: function showSimpleToast(e) {
        ...
        while ((0, _polymerDom.dom)(this).firstChild !== null) {
          (0, _polymerDom.dom)(this).removeChild((0, _polymerDom.dom)(this).firstChild);
        }

        if (e.detail.slot) {
          (0, _polymerDom.dom)(this).appendChild(e.detail.slot);
        }
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_2bf4ccc0e3b511e9b0d5a5c01151ac03());
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(SimpleToast), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(SimpleToast), "properties", this));
        }
