...
function _templateObject2_8d7b3f30376211ec8144fbe8e0c64026() {
  var data = _taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n      "]);

  _templateObject2_8d7b3f30376211ec8144fbe8e0c64026 = function _templateObject2_8d7b3f30376211ec8144fbe8e0c64026() {
    return data;
  };
...
function _templateObject_8d7b3f30376211ec8144fbe8e0c64026() {
  var data = _taggedTemplateLiteral(['\n      <form part="form">\n        <slot name="before"></slot>\n        <simple-fields-lite\n          id="sf"\n          .autofocus="', '"\n          .language="', '"\n          .resources="', '"\n          .schema="', '"\n          .elementizer="', '"\n          .value="', '"\n          @value-changed="', '"\n          part="fields"\n        >\n        </simple-fields-lite>\n        <slot name="after"></slot>\n        <slot></slot>\n      </form>\n    ']);

  _templateObject_8d7b3f30376211ec8144fbe8e0c64026 = function _templateObject_8d7b3f30376211ec8144fbe8e0c64026() {
    return data;
  };
...
var SimpleFieldsFormLite = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(SimpleFieldsFormLite, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_8d7b3f30376211ec8144fbe8e0c64026(), !this.disableAutofocus, this.language, this.resources, this.schema, this.elementizer, this.value, this._valueChanged);
    }
    /**
    ...
    key: "styles",
    get: function get() {
      return [(0, _litElement.css)(_templateObject2_8d7b3f30376211ec8144fbe8e0c64026())];
    }
  }, {
    key: "tag",
    get: function get() {
