define(["exports", "../../lit/index.js", "./lib/absolute-position-state-manager.js"], function (_exports, _index, _absolutePositionStateManager) {
  ...
  _exports.AbsolutePositionBehavior = _exports.AbsolutePositionBehaviorClass = void 0;

  var _templateObject_1800e6a0012611ec9676957c409166bc, _templateObject2_1800e6a0012611ec9676957c409166bc;
  ...
  var AbsolutePositionBehaviorClass = function AbsolutePositionBehaviorClass(SuperClass) {
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        function render() {
          return (0, _index.html)(_templateObject_1800e6a0012611ec9676957c409166bc || (_templateObject_1800e6a0012611ec9676957c409166bc = babelHelpers.taggedTemplateLiteral([" <slot></slot>"])));
        ...
        value: function updated(changedProperties) {
          ...
          if (this.shadowRoot && !this.hidden) {
            changedProperties.forEach(function (oldValue, propName) {
              ...
              if (["fitToVisibleBounds", "for", "offset", "position", "justify", "positionAlign", "target", "hidden", "sticky"].includes(propName) && _this2[propName] !== oldValue) updatePosition = true;
            });
        ...
        get: //styles function
        function get() {
          return [(0, _index.css)(_templateObject2_1800e6a0012611ec9676957c409166bc || (_templateObject2_1800e6a0012611ec9676957c409166bc = babelHelpers.taggedTemplateLiteral(["\n          :host {\n            display: inline-block;\n            z-index: 99999999999;\n            position: absolute;\n          }\n\n          :host([hidden]) {\n            display: none;\n          }\n        "])))];
        }
      }, {
        key: "properties",
        get: function get() {
