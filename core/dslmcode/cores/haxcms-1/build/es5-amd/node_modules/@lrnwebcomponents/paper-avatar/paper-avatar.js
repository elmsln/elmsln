define(["exports", "meta", "../../lit/index.js", "../es-global-bridge/es-global-bridge.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "./lib/md5.min.js"], function (_exports, meta, _index, _esGlobalBridge, _simpleIconLite, _simpleIcons, md5) {
  ...
  var _templateObject_82a6ba00f9df11eba887937af67006f3, _templateObject2_82a6ba00f9df11eba887937af67006f3, _templateObject3_82a6ba00f9df11eba887937af67006f3, _templateObject4_82a6ba00f9df11eba887937af67006f3, _templateObject5_82a6ba00f9df11eba887937af67006f3;
  ...
  */
  var PaperAvatar = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(PaperAvatar, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_82a6ba00f9df11eba887937af67006f3 || (_templateObject_82a6ba00f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n      <svg id=\"jdenticon\" width=\"40\" height=\"40\"><slot></slot></svg>\n      <div\n        id=\"label\"\n        title=\"", "\"\n        ?hidden=\"", "\"\n      >\n        ", "\n      </div>\n      ", "\n    "])), this.label, this.jdenticonExists && this.jdenticon, this.icon ? (0, _index.html)(_templateObject2_82a6ba00f9df11eba887937af67006f3 || (_templateObject2_82a6ba00f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral([" <simple-icon-lite icon=\"", "\"></simple-icon-lite> "])), this.icon) : (0, _index.html)(_templateObject3_82a6ba00f9df11eba887937af67006f3 || (_templateObject3_82a6ba00f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n              <span ?two-chars=\"", "\"\n                >", "\n              </span>\n            "])), this.twoChars, this._label(this.label)), this.src ? (0, _index.html)(_templateObject4_82a6ba00f9df11eba887937af67006f3 || (_templateObject4_82a6ba00f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n            <img\n              id=\"img\"\n              loading=\"lazy\"\n              .src=\"", "\"\n              @load=\"", "\"\n              @error=\"", "\"\n              aria-hidden=\"true\"\n            />\n          "])), this.src || "", this._onImgLoad, this._onImgError) : "");
      }
    }, {
      key: "updated",
