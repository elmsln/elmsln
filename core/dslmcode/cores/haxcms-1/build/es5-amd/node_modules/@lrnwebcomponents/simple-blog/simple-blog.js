define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../haxcms-elements/lib/core/HAXCMSThemeWiring.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/lib/mobx.module.js", "../../@polymer/polymer/lib/utils/render-status.js", "../simple-colors/simple-colors.js", "./lib/simple-blog-listing.js", "./lib/simple-blog-post.js", "../../@polymer/iron-pages/iron-pages.js"], function (_exports, _require, _polymerElement, _HAXCMSThemeWiring, _haxcmsSiteStore, _mobxModule, _renderStatus, _simpleColors, _simpleBlogListing, _simpleBlogPost, _ironPages) {
  ...
  function _templateObject_dd1628d0b46e11e9978b67ee5ebb8bc8() {
    ...
    _templateObject_dd1628d0b46e11e9978b67ee5ebb8bc8 = function _templateObject_dd1628d0b46e11e9978b67ee5ebb8bc8() {
      return data;
    };
  ...
  function (_HAXCMSTheme) {
    babelHelpers.inherits(SimpleBlog, _HAXCMSTheme);
    babelHelpers.createClass(SimpleBlog, null, [{
      key: "tag",
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_dd1628d0b46e11e9978b67ee5ebb8bc8());
      }
      /**
      ...
      key: "properties",
      get: function get() {
        var props = babelHelpers.get(babelHelpers.getPrototypeOf(SimpleBlog), "properties", this);
        props.selectedPage = {
          type: Number,
    ...
    function SimpleBlog() {
      ...
      (0, _mobxModule.autorun)(function (reaction) {
        _this._locationChanged(_haxcmsSiteStore.store.location);
    ...
    babelHelpers.createClass(SimpleBlog, [{
      ...
      value: function connectedCallback() {
        ...
        (0, _renderStatus.afterNextRender)(this, function () {
          _this2.contentContainer = _this2.shadowRoot.querySelector("simple-blog-post").$.contentcontainer;
        });
      }
      /**
      ...
      value: function disconnectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(SimpleBlog.prototype), "disconnectedCallback", this).call(this); // clean up state
      ...
      value: function _goBack(e) {
        ...
        if (prevActiveItemId) {
          setTimeout(function () {
            var active = _this3.shadowRoot.querySelector("simple-blog-listing").shadowRoot.querySelector('simple-blog-overview[item-id="' + prevActiveItemId + '"]');
