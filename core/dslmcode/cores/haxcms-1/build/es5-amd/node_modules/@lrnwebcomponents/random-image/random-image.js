define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_3435f1e0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-image\n        style=\"width:200px; height:200px;\"\n        class=\"", "\"\n        sizing=\"contain\"\n        src=\"", "\"\n        title=\"", "\"\n      ></iron-image>\n    "]);

    _templateObject2_3435f1e0db3d11eaa14b6130b7e5d77f = function _templateObject2_3435f1e0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_3435f1e0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .is-circle {\n          border: 1px solid grey;\n          border-radius: 50%;\n          box-shadow: 0px 5px 10px #ccc;\n        }\n      "]);

    _templateObject_3435f1e0db3d11eaa14b6130b7e5d77f = function _templateObject_3435f1e0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  */
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(RandomImage, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_3435f1e0db3d11eaa14b6130b7e5d77f())];
      }
    }]);
    ...
    babelHelpers.createClass(RandomImage, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_3435f1e0db3d11eaa14b6130b7e5d77f(), this.mode, this._imgSrc, this._imgTitle);
      }
    }, {
