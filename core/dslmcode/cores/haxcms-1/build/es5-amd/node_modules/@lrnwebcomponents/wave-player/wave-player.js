define(["exports", "meta", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/polymer/lib/utils/resolve-url.js", "../../@polymer/paper-material/paper-material.js", "../../@polymer/paper-fab/paper-fab.js", "../../@polymer/paper-icon-button/paper-icon-button.js", "../hax-body-behaviors/lib/HAXWiring.js", "../schema-behaviors/schema-behaviors.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _require, _polymerElement, _renderStatus, _resolveUrl, _paperMaterial, _paperFab, _paperIconButton, _HAXWiring, _schemaBehaviors, _esGlobalBridge) {
  "use strict";
  ...
  function _templateObject_3d264270b3b911e9b58d79562a23326c() {
    ...
    _templateObject_3d264270b3b911e9b58d79562a23326c = function _templateObject_3d264270b3b911e9b58d79562a23326c() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(WavePlayer, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_3d264270b3b911e9b58d79562a23326c());
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(WavePlayer), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(WavePlayer), "properties", this));
        }
    ...
    function WavePlayer() {
      ...
      var location = "".concat(basePath, "lib/wavesurfer.js/dist/wavesurfer.js");
    ...
    babelHelpers.createClass(WavePlayer, [{
      ...
      value: function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(WavePlayer.prototype), "ready", this).call(this);
      ...
      value: function initWaveSurfer() {
        ...
        window.wavesurferobject.on("ready", function () {
          _this2.$.playbutton.removeAttribute("disabled");
        });
        window.wavesurferobject.on("finish", function () {
          _this2.deactivateAnimation();
        });
      }
      /**
