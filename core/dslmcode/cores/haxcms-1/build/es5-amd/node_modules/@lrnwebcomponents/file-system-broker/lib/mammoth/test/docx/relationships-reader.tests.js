...
test("relationships can be found by ID", function () {
  var relationships = readRelationships(relationshipsElement([relationshipElement({
    Id: "rId1",
...
test("relationships can be found by type", function () {
  ...
  assert.deepEqual(relationships.findTargetsByType("http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument"), ["word/document.xml", "word/document2.xml"]);
});
test("when there are no relationships of requested type then empty array is returned", function () {
  ...
  assert.deepEqual(relationships.findTargetsByType("http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument"), []);
});
