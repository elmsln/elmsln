  ...
  _createClass(HaxTextEditorButton, [{
    ...
    value: function getValue(node) {
      var el = node || this.rangeElement(),
          val = _get(_getPrototypeOf(HaxTextEditorButton.prototype), "getValue", this).call(this);
    ...
    value: function sendCommand() {
      ...
      if (!!this.selectedNode) {
        ...
        _get(_getPrototypeOf(HaxTextEditorButton.prototype), "sendCommand", this).call(this, command, "", range);
