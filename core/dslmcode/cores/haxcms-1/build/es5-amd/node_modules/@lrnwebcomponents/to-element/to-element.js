  ...
  function (_HTMLElement) {
    ...
    babelHelpers.createClass(ToElement, [{
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(ToElement), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(ToElement), "properties", this));
        }
    ...
    function ToElement() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(ToElement).call(this)); // set tag for later use
