...
(function ($) {
  $(document).on("ready", function () {
    ...
    H5PDisableHubData.selector = H5PDisableHubData.selector || ".h5p-settings-disable-hub-checkbox";
    H5PDisableHubData.overlaySelector = H5PDisableHubData.overlaySelector || ".h5p-settings-container";
    var dialogHtml = "<div>" + "<p>" + H5PDisableHubData.errors.join("</p><p>") + "</p>" + "<p>" + H5PDisableHubData.confirmationDialogMsg + "</p>"; // Create confirmation dialog, make sure to include translations
