      ...
      value: function render() {
        ...
        return !this.showCardList ? "" : (0, _index.html)(_templateObject_8d84e6a01da511ed9d313b9780b2ae17 || (_templateObject_8d84e6a01da511ed9d313b9780b2ae17 = babelHelpers.taggedTemplateLiteral(["\n          <p class=\"loaderText\" ?hidden=\"", "\">\n            <strong\n              >Scanning Web Component Registry for more HAX elements..</strong\n            ><hexagon-loader\n              item-count=\"4\"\n              ?loading=\"", "\"\n              size=\"small\"\n            ></hexagon-loader>\n          </p>\n          <div\n            class=\"grid\"\n            style=\"--hax-element-card--cols: repeat(", ", 1fr)\"\n          >\n            ", "\n          </div>\n        "])), !this.loading, this.loading, this.cols, this.productList.map(function (el, i) {
          return (0, _index.html)(_templateObject2_8d84e6a01da511ed9d313b9780b2ae17 || (_templateObject2_8d84e6a01da511ed9d313b9780b2ae17 = babelHelpers.taggedTemplateLiteral(["\n                <product-card\n                  .slot=\"col-", "\"\n                  ?disabled=\"", "\"\n                  ?hidden=\"", "\"\n                  ?has-demo=\"", "\"\n                  heading=\"", "\"\n                  icon=\"", "\"\n                  subheading=\"", "\"\n                  accent-color=\"", "\"\n                  @product-card-demo-show=\"", "\"\n                  @product-card-demo-hide=\"", "\"\n                >\n                  <label slot=\"card-header\">\n                    <span class=\"sr-only\"\n                      >", "</span\n                    >\n                    <input\n                      class=\"checkbox\"\n                      type=\"checkbox\"\n                      ?checked=\"", "\"\n                      @change=\"", "\"\n                    />\n                  </label>\n                  <div slot=\"details-collapse-header\">Details</div>\n                  <div slot=\"details-collapse-content\">\n                    <ul>\n                      <li>\n                        <strong>Tags:</strong> ", "\n                      </li>\n                      <li><strong>Tag name:</strong> <code>", "</code></li>\n                      <li>\n                        <strong>Developer usage:</strong>\n                        <code>import \"", "\";</code>\n                      </li>\n                      ", "\n                    </ul>\n                  </div>\n                  <div slot=\"demo-collapse-header\">Demo</div>\n                  <div slot=\"demo-collapse-content\">\n                    ", "\n                  </div>\n                </product-card>\n              "])), _this2.__getCol(i), !el.status, !(_this2.filteredTags && _this2.filteredTags.includes(el.tag)), el.schema.demoSchema, el.schema.gizmo.title, el.schema.gizmo.icon, el.schema.gizmo.description, el.schema.gizmo.color, function (e) {
            ...
            return (0, _index.html)(_templateObject3_8d84e6a01da511ed9d313b9780b2ae17 || (_templateObject3_8d84e6a01da511ed9d313b9780b2ae17 = babelHelpers.taggedTemplateLiteral([" ", ", "])), group);
          }), el.tag, el.file, el.schema.gizmo.meta ? (0, _index.html)(_templateObject4_8d84e6a01da511ed9d313b9780b2ae17 || (_templateObject4_8d84e6a01da511ed9d313b9780b2ae17 = babelHelpers.taggedTemplateLiteral(["\n                            ", "\n                          "])), Object.keys(el.schema.gizmo.meta).map(function (mel) {
            return (0, _index.html)(_templateObject5_8d84e6a01da511ed9d313b9780b2ae17 || (_templateObject5_8d84e6a01da511ed9d313b9780b2ae17 = babelHelpers.taggedTemplateLiteral(["\n                                <li>\n                                  <strong>", ":</strong>\n                                  <span>", "</span>\n                                </li>\n                              "])), _this2.capFirst(mel), el.schema.gizmo.meta[mel]);
          })) : "", el.schema.demoSchema && el.showDemo ? (0, _index.html)(_templateObject6_8d84e6a01da511ed9d313b9780b2ae17 || (_templateObject6_8d84e6a01da511ed9d313b9780b2ae17 = babelHelpers.taggedTemplateLiteral(["\n                          ", "\n                        "])), el.schema.demoSchema.map(function (demoItem) {
            return (0, _index.html)(_templateObject7_8d84e6a01da511ed9d313b9780b2ae17 || (_templateObject7_8d84e6a01da511ed9d313b9780b2ae17 = babelHelpers.taggedTemplateLiteral(["\n                              <button\n                                data-tag=\"", "\"\n                                outlined\n                                @click=\"", "\"\n                              >\n                                Pop up demo\n                              </button>\n                              <div class=\"demo\">\n                                ", "\n                              </div>\n                              <code-sample copy-clipboard-button>\n                                <template>\n                                  ", "\n                                </template>\n                              </code-sample>\n                            "])), demoItem.tag, _this2._viewDemo, _this2._haxElementToNode(demoItem), _this2._haxElementToNode(demoItem));
          })) : "");
        }));
      }
      /**
