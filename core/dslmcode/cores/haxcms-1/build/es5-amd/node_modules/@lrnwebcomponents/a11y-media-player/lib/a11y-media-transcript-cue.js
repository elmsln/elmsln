 ...
 * @customElement
 * @polymer
 */var A11yMediaTranscriptCue=/*#__PURE__*/function(_A11yMediaBehaviors){babelHelpers.inherits(A11yMediaTranscriptCue,_A11yMediaBehaviors);function A11yMediaTranscriptCue(){babelHelpers.classCallCheck(this,A11yMediaTranscriptCue);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(A11yMediaTranscriptCue).apply(this,arguments))}babelHelpers.createClass(A11yMediaTranscriptCue,[{key:"connectedCallback",/**
   ...
   * handles tap
   */},{key:"_handleTap",value:function _handleTap(e){var root=this;this.dispatchEvent(new CustomEvent("cue-seek",{detail:root.cue.seek}))}}],[{key:"properties",// properties available to the custom element for data binding
