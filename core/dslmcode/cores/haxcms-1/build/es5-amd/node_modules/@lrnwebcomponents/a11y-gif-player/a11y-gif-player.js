define(["exports", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js", "../a11y-details/a11y-details.js"], function (_exports, _require, _litElement, _schemaBehaviors, _a11yDetails) {
  ...
  function _templateObject2_2f177670c21511ea833d23105e857967() {
    ...
    _templateObject2_2f177670c21511ea833d23105e857967 = function _templateObject2_2f177670c21511ea833d23105e857967() {
      return data;
    };
  ...
  function _templateObject_2f177670c21511ea833d23105e857967() {
    ...
    _templateObject_2f177670c21511ea833d23105e857967 = function _templateObject_2f177670c21511ea833d23105e857967() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(A11yGifPlayer, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_2f177670c21511ea833d23105e857967(), this.src, this.alt, this.longdesc ? "longdesc" : "", (this.describedBy || "").trim(), !this.src, this.__playing ? "true" : "false", this.toggle, this.disabled || !this.src, this.srcWithoutAnimation, this.__playing && this.tooltipPlaying ? this.tooltipPlaying : this.tooltip, !this.src || !this.longdesc, this.__playing ? 0 : 1, this.longdesc, this.__playing && this.tooltipPlaying ? this.tooltipPlaying : this.tooltip);
      }
      /**
       * Convention
       */
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_2f177670c21511ea833d23105e857967())];
      }
    }, {
      key: "tag",
      get: function get() {
