...
this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(AccentCard.haxProperties,AccentCard.tag,this)}/**
   ...
   */get:function get(){return"accent-card"}// render function
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_2ae4f020a44b11e98c881fc26e93d8f9())}// haxProperty definition
       ...
       */__backgroundStyle:{name:"__backgroundStyle",type:String,computed:"_getBackgroundStyle(imageSrc)"}};if(babelHelpers.get(babelHelpers.getPrototypeOf(AccentCard),"properties",this)){props=Object.assign(props,babelHelpers.get(babelHelpers.getPrototypeOf(AccentCard),"properties",this))}return props}}]);return AccentCard}(_simpleColors.SimpleColors);_exports.AccentCard=AccentCard;window.customElements.define(AccentCard.tag,AccentCard)});