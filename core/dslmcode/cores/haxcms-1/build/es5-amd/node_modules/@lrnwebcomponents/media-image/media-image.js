define(["exports", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js", "../simple-modal/lib/simple-modal-handler.js"], function (_exports, _require, _litElement, _schemaBehaviors, _simpleModalHandler) {
  ...
  function _templateObject11_8a459430c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        .caption {\n          padding-bottom: 25px;\n          border-bottom: dashed 2px lightgray;\n          margin-bottom: 25px;\n          line-height: 1.5;\n          font-size: 18px;\n        }\n\n        .caption ::slotted(*) {\n          margin-top: 0;\n        }\n        .caption ::slotted(*:last-child) {\n          margin-bottom: 0;\n        }\n      "]);

    _templateObject11_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject11_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject10_8a459430c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <slot id=\"slot\"></slot>\n            "]);

    _templateObject10_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject10_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject9_8a459430c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"caption\">\n        ", "\n      </div>\n    "]);

    _templateObject9_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject9_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject8_8a459430c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        .citation {\n          font-size: 12.8px;\n          font-style: italic;\n          color: #4c4c4c;\n          margin: 15px 0 15px;\n        }\n      "]);

    _templateObject8_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject8_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject7_8a459430c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"citation\"><slot></slot></div>\n    "]);

    _templateObject7_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject7_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject6_8a459430c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-image\n        src=\"", "\"\n        alt=\"", "\"\n        aria-describedby=\"", "\"\n      >\n      </iron-image>\n    "]);

    _templateObject6_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject6_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject5_8a459430c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host(:hover) {\n          cursor: pointer;\n        }\n        iron-image {\n          width: 100%;\n          --iron-image-width: 100%;\n        }\n        :host([round]) iron-image {\n          border-radius: 50%;\n        }\n      "]);

    _templateObject5_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject5_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject4_8a459430c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <media-image-caption>\n              <slot name=\"caption\">\n                ", "\n              </slot>\n            </media-image-caption>\n          "]);

    _templateObject4_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject4_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject3_8a459430c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <figure-label\n              title=\"", "\"\n              description=\"", "\"\n            ></figure-label>\n          "]);

    _templateObject3_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject3_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject2_8a459430c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <media-image-image\n        ?round=\"", "\"\n        resource=\"", "-image\"\n        source=\"", "\"\n        modal-title=\"", "\"\n        alt=\"", "\"\n        .described-by=\"", "\"\n      ></media-image-image>\n      <media-image-citation>\n        <slot name=\"citation\">\n          ", "\n        </slot>\n      </media-image-citation>\n      ", "\n    "]);

    _templateObject2_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject2_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject_8a459430c96f11ea8be5e1d5fe7ec787() {
    ...
    _templateObject_8a459430c96f11ea8be5e1d5fe7ec787 = function _templateObject_8a459430c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(MediaImage, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_8a459430c96f11ea8be5e1d5fe7ec787())];
      }
    }]);
    ...
    babelHelpers.createClass(MediaImage, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_8a459430c96f11ea8be5e1d5fe7ec787(), this.__figureLabel ? (0, _litElement.html)(_templateObject3_8a459430c96f11ea8be5e1d5fe7ec787(), this.figureLabelTitle, this.figureLabelDescription) : "", this.round, this.schemaResourceID, this.source, this.modalTitle, this.alt, this.describedBy, this.citation, this._hasCaption ? (0, _litElement.html)(_templateObject4_8a459430c96f11ea8be5e1d5fe7ec787(), this.caption) : "");
      }
    }, {
      key: "_hasFigureLabel",
  ...
  function (_SimpleModalHandler) {
    ...
    babelHelpers.createClass(MediaImageImage, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_8a459430c96f11ea8be5e1d5fe7ec787())];
      }
    }]);
    ...
    babelHelpers.createClass(MediaImageImage, [{
      ...
      key: "render",
      value: function render() {
        return (0, _litElement.html)(_templateObject6_8a459430c96f11ea8be5e1d5fe7ec787(), this.source, this.alt, this.describedBy || "");
      }
    }, {
      key: "updated",
      value: function updated(changedProperties) {
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(MediaImageCitation, [{
      key: "render",
      value: function render() {
        return (0, _litElement.html)(_templateObject7_8a459430c96f11ea8be5e1d5fe7ec787());
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject8_8a459430c96f11ea8be5e1d5fe7ec787())];
      }
    }, {
      key: "tag",
      get: function get() {
  ...
  function (_LitElement2) {
    ...
    babelHelpers.createClass(MediaImageCaption, [{
      key: "render",
      value: function render() {
        return (0, _litElement.html)(_templateObject9_8a459430c96f11ea8be5e1d5fe7ec787(), !this.__hasContent ? (0, _litElement.html)(_templateObject10_8a459430c96f11ea8be5e1d5fe7ec787()) : "");
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject11_8a459430c96f11ea8be5e1d5fe7ec787())];
      }
    }, {
      key: "tag",
      get: function get() {
