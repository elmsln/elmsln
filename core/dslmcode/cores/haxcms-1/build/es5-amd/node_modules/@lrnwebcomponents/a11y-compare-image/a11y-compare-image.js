define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject3_1f2de190db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <div class=\"marker\" style=\"left: ", "%;\"></div>\n              "]);

    _templateObject3_1f2de190db3d11eaa14b6130b7e5d77f = function _templateObject3_1f2de190db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject2_1f2de190db3d11eaa14b6130b7e5d77f() {
    ...
    _templateObject2_1f2de190db3d11eaa14b6130b7e5d77f = function _templateObject2_1f2de190db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_1f2de190db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          margin: 15px 0;\n        }\n        :host([hidden]) {\n          display: none !important;\n        }\n        figure {\n          margin: 0;\n        }\n        #container,\n        #container > div {\n          margin: 0;\n          padding: 0;\n        }\n        #container,\n        #input {\n          position: relative;\n        }\n        #container {\n          background-size: contain;\n          background-repeat: no-repeat;\n        }\n        #layer {\n          top: 0;\n          left: 0;\n          position: absolute;\n          height: 100%;\n          opacity: var(--a11y-compare-image-opacity, 1);\n          width: var(--a11y-compare-image-width, 50%);\n          background-size: cover;\n          background-position-x: 0%;\n          background-repeat: no-repeat;\n        }\n        #placeholder {\n          opacity: 0;\n        }\n        #bottom {\n          width: 100%;\n        }\n        #slider {\n          top: 0;\n          left: 0;\n          position: absolute;\n          width: calc(100% + 32px);\n          margin: -15px 0 0 -16px;\n        }\n        .marker {\n          top: -3px;\n          position: absolute;\n          width: 1px;\n          height: 10px;\n          outline: 2px solid #bbb;\n          background-color: #bbb;\n        }\n        ::slotted([slot=\"bottom\"]) {\n          max-width: 100%;\n        }\n      "]);

    _templateObject_1f2de190db3d11eaa14b6130b7e5d77f = function _templateObject_1f2de190db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(a11yCompareImage, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_1f2de190db3d11eaa14b6130b7e5d77f())];
      }
    }]);
    ...
    babelHelpers.createClass(a11yCompareImage, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_1f2de190db3d11eaa14b6130b7e5d77f(), this.__lower, this.__upper, this.__markers.map(function (marker) {
          return (0, _litElement.html)(_templateObject3_1f2de190db3d11eaa14b6130b7e5d77f(), marker);
        }));
      }
    }, {
      key: "firstUpdated",
