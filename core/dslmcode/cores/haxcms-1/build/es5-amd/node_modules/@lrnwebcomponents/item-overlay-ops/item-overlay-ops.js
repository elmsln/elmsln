...
setTimeout(function(){_this._windowResize()},5);this.setAttribute("tabindex","0");window.addEventListener("resize",this._windowResize.bind(this));(0,_renderStatus.afterNextRender)(this,function(){this.addEventListener("focusin",this._inFocus.bind(this));this.addEventListener("focusout",this._outFocus.bind(this))})}/**
   ...
   */},{key:"fixedHeightChanged",value:function fixedHeightChanged(newValue,oldValue){if(newValue){if(!this.disableAutoHeight){this.shadowRoot.querySelector("#container").style.height=this.fixedHeight+"px";this.shadowRoot.querySelector("#workingarea").style.height=this.fixedHeight-80+"px"}}}/**
   * react to window resizing
   */},{key:"_windowResize",value:function _windowResize(e){var rect=this.getBoundingClientRect();this.shadowRoot.querySelector("#container").style.width=rect.width+"px";if(!this.disableAutoHeight){if(!this.fixedHeight||babelHelpers.typeof(this.fixedHeight)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.shadowRoot.querySelector("#container").style.height=rect.height+"px";this.shadowRoot.querySelector("#workingarea").style.height=rect.height-80+"px"}else{this.shadowRoot.querySelector("#container").style.height=this.fixedHeight+"px";this.shadowRoot.querySelector("#workingarea").style.height=this.fixedHeight-80+"px"}}else{this.shadowRoot.querySelector("#workingarea").style.height=rect.height-80+"px"}}/**
   * Support tapping the buttons in the top
   */},{key:"_opTap",value:function _opTap(e){var local=e.target;this.activeTitle=local.getAttribute("id");this.activeOp=local.getAttribute("id");this._resetActive();this.__anyOp=!0;local.classList.add("active");// we switch icons for these
...
var op={element:this,operation:this.activeOp};this.dispatchEvent(new CustomEvent("item-overlay-op-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:op}))}/**
   ...
   */},{key:"_optionSelected",value:function _optionSelected(e){var local=e.target,ops={element:this,operation:this.activeOp,option:local.getAttribute("id")};// fire that an option was selected and about what operation
this.dispatchEvent(new CustomEvent("item-overlay-option-selected",{bubbles:!0,cancelable:!0,composed:!0,detail:ops}));// don't reset for movement, just confirm / reject actions
if("move"!=this.activeOp){this._resetActive();this.activeOp=null}}/**
   * Reset the active selections
   */},{key:"_resetActive",value:function _resetActive(){this.shadowRoot.querySelector("#add").classList.remove("active");this.shadowRoot.querySelector("#edit").classList.remove("active");this.shadowRoot.querySelector("#move").classList.remove("active");this.shadowRoot.querySelector("#remove").classList.remove("active");this.shadowRoot.querySelector("#duplicate").classList.remove("active")}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_a2466270734911eaac0dbb5c5350affd())}},{key:"tag",get:function get(){return"item-overlay-ops"}},{key:"properties",get:function get(){return{/**
