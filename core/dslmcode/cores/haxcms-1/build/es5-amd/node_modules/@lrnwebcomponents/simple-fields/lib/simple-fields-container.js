define(["exports", "../../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  function _templateObject10_3986a3f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot name=\"suffix\"></slot>\n      ", "\n    "]);

    _templateObject10_3986a3f0833211ea85a195fb4be801bd = function _templateObject10_3986a3f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject9_3986a3f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot name=\"prefix\"></slot>\n      ", "\n    "]);

    _templateObject9_3986a3f0833211ea85a195fb4be801bd = function _templateObject9_3986a3f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject8_3986a3f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <label\n        for=\"", "\"\n        class=\"label-main\"\n        ?hidden=\"", "\"\n      >\n        <slot name=\"label\"></slot>\n        ", "", "\n      </label>\n    "]);

    _templateObject8_3986a3f0833211ea85a195fb4be801bd = function _templateObject8_3986a3f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject7_3986a3f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"fieldmeta\" aria-live=\"polite\">\n        <slot name=\"field-meta\"></slot>\n      </div>\n    "]);

    _templateObject7_3986a3f0833211ea85a195fb4be801bd = function _templateObject7_3986a3f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject6_3986a3f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div\n        class=\"", "\"\n      >\n        ", "\n        <div>\n          ", "\n          <slot name=\"field\"></slot>\n          ", "\n        </div>\n      </div>\n    "]);

    _templateObject6_3986a3f0833211ea85a195fb4be801bd = function _templateObject6_3986a3f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject5_3986a3f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"border-bottom blur\"></div>\n      <div class=\"border-bottom focus\"></div>\n      <div id=\"field-bottom\">\n        <div id=\"error-desc\">\n          ", " ", "\n        </div>\n        ", "\n      </div>\n    "]);

    _templateObject5_3986a3f0833211ea85a195fb4be801bd = function _templateObject5_3986a3f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject4_3986a3f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"error-message\" ?hidden=\"", "\" role=\"alert\">\n        ", "\n      </div>\n    "]);

    _templateObject4_3986a3f0833211ea85a195fb4be801bd = function _templateObject4_3986a3f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject3_3986a3f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"description\">\n        <slot name=\"description\"></slot>\n        ", "\n      </div>\n    "]);

    _templateObject3_3986a3f0833211ea85a195fb4be801bd = function _templateObject3_3986a3f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject2_3986a3f0833211ea85a195fb4be801bd() {
    ...
    _templateObject2_3986a3f0833211ea85a195fb4be801bd = function _templateObject2_3986a3f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject_3986a3f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", " ", "\n    "]);

    _templateObject_3986a3f0833211ea85a195fb4be801bd = function _templateObject_3986a3f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleFieldsContainer, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_3986a3f0833211ea85a195fb4be801bd(), this.fieldMainTemplate, this.fieldBottom);
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_3986a3f0833211ea85a195fb4be801bd())];
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(SimpleFieldsContainer, [{
      ...
      get: function get() {
        return (0, _litElement.html)(_templateObject3_3986a3f0833211ea85a195fb4be801bd(), this.description);
      }
      /**
      ...
      key: "errorTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject4_3986a3f0833211ea85a195fb4be801bd(), !this.error, this.errorMessage);
      }
      /**
       *
      ...
      key: "fieldBottom",
      get: function get() {
        return (0, _litElement.html)(_templateObject5_3986a3f0833211ea85a195fb4be801bd(), this.descriptionTemplate, this.errorTemplate, this.fieldMeta);
      }
      /**
       * gets field's id
       *
      ...
      get: function get() {
        return (0, _litElement.html)(_templateObject6_3986a3f0833211ea85a195fb4be801bd(), this.inline || ["checkbox", "color", "radio"].includes(this.type || "text") ? "field-main inline" : "field-main", this.labelTemplate, this.prefixTemplate, this.suffixTemplate);
      }
      /**
       *
       * gets field metadata
      ...
      key: "fieldMeta",
      get: function get() {
        return (0, _litElement.html)(_templateObject7_3986a3f0833211ea85a195fb4be801bd());
      }
      /**
       * template for slotted or shadow DOM label
       *
      ...
      key: "labelTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject8_3986a3f0833211ea85a195fb4be801bd(), this.fieldId, this.type === "fieldset", this.label, this.error || this.required ? "*" : "");
      }
      /**
      ...
      key: "prefixTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject9_3986a3f0833211ea85a195fb4be801bd(), this.prefix);
      }
      /**
      ...
      key: "suffixTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject10_3986a3f0833211ea85a195fb4be801bd(), this.suffix);
      }
    }]);
