define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/simple-icon.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _litElement, _simpleIcon, _simpleIcons) {
  ...
  function _templateObject2_916dee30290811ebbe0ae90af5f52b1f() {
    ...
    _templateObject2_916dee30290811ebbe0ae90af5f52b1f = function _templateObject2_916dee30290811ebbe0ae90af5f52b1f() {
      return data;
    };
  ...
  function _templateObject_916dee30290811ebbe0ae90af5f52b1f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <form \n        action=\"", "\"\n        ?hidden=", "\n        class=\"", "\"\n        @submit=\"", "\">\n        <label for=\"", "\">", "</label>\n        <textarea\n          id=\"", "\"\n          name=\"", "\"\n          aria-describedby=\"", "\"\n        ></textarea>\n        <button type=\"submit\">\n          ", "\n          <simple-icon  \n            aria-hidden=\"true\" \n            ?hidden=\"", "\"\n            icon=\"", "\"></simple-icon>\n        </button>\n      </div>\n    "]);

    _templateObject_916dee30290811ebbe0ae90af5f52b1f = function _templateObject_916dee30290811ebbe0ae90af5f52b1f() {
      return data;
    };
  ...
  var ThreadedDiscussionForm = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(ThreadedDiscussionForm, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_916dee30290811ebbe0ae90af5f52b1f(), this.submit, this.hidden || this.disabled, this.thread ? "reply-form" : "comment-form", this._handleSubmit, this.field, this.textareaLabel, this.field, this.field, this.thread, this.buttonLabel, !this.icon, this.icon);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_916dee30290811ebbe0ae90af5f52b1f())];
      }
    }, {
      key: "tag",
      get: function get() {
