    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function commandToggledForRange() {
          ...
          block = command === "underline" ? !!this.rangeOrMatchingAncestor("u") : command === "wrapRange" ? !!this.rangeOrMatchingAncestor(commandVal) : query;
          ...
          if (this.validCommands.includes(command)) {
            ...
            if (command == "wrapRange" && !!commandVal) {
              ...
              if (!toggled) {
                ...
                var nodes = node ? babelHelpers.toConsumableArray(node.childNodes).reverse() : [];
