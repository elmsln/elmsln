define(["exports", "./rich-text-editor-highlight.js", "./rich-text-editor-clipboard.js", "./rich-text-editor-source.js"], function (_exports, _richTextEditorHighlight, _richTextEditorClipboard, _richTextEditorSource) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.RichTextEditorRangeBehaviors = void 0;
    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function commandToggledForRange() {
          ...
          block = command === "underline" ? !!this.rangeOrMatchingAncestor("u") : query;
        ...
        key: "_handleCommand",
        value: function _handleCommand(command, commandVal, range) {
          ...
          if (this.validCommands.includes(command)) {
            ...
            if (this.__highlight.parentNode === document.body) this.__highlight.wrap(range);
  ...
  _exports.RichTextEditorRangeBehaviors = RichTextEditorRangeBehaviors;
});