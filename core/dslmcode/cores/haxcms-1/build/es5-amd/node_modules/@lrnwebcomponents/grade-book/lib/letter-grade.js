define(["exports", "require", "../../../lit/index.js", "./grade-book-store.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _require, _index, _gradeBookStore, _mobxEsm) {
  ...
  var _templateObject_ff156160514411ecad92218912f770fd, _templateObject2_ff156160514411ecad92218912f770fd, _templateObject3_ff156160514411ecad92218912f770fd, _templateObject4_ff156160514411ecad92218912f770fd, _templateObject5_ff156160514411ecad92218912f770fd, _templateObject6_ff156160514411ecad92218912f770fd;
  ...
  var LetterGrade = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LetterGrade, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_ff156160514411ecad92218912f770fd || (_templateObject_ff156160514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"wrap\">\n        <div class=\"letter\">", "</div>\n        ", "\n        ", "\n      </div>\n      ", "\n    "])), this.letter, this.showScale && this._letterIndex !== null ? (0, _index.html)(_templateObject2_ff156160514411ecad92218912f770fd || (_templateObject2_ff156160514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["<div class=\"score\">\n              (", "/", " ", ")\n            </div>"])), this.score, this.total, this.pointsSystem) : "", this.showScale && this._letterIndex !== null ? (0, _index.html)(_templateObject3_ff156160514411ecad92218912f770fd || (_templateObject3_ff156160514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["<div class=\"range\">\n              ", "% -\n              ", "%\n            </div>"])), this.gradeScale[this._letterIndex].lowRange, this.gradeScale[this._letterIndex].highRange) : "", this.mini ? (0, _index.html)(_templateObject4_ff156160514411ecad92218912f770fd || (_templateObject4_ff156160514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["<simple-tooltip position=\"top\"\n            >", "<br />", "</simple-tooltip\n          >"])), this.label, this.score != null ? (0, _index.html)(_templateObject5_ff156160514411ecad92218912f770fd || (_templateObject5_ff156160514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["(", "/", " ", ")"])), this.score, this.total, this.pointsSystem) : "") : "");
      }
    }, {
      key: "updated",
