 ...
 */H5P.externalDispatcher=new H5P.EventDispatcher;// EventDispatcher extensions
/**
 ...
 */H5P.EventDispatcher.prototype.triggerXAPI=function(verb,extra){this.trigger(this.createXAPIEventTemplate(verb,extra))};/**
 ...
 *   Instance
 */H5P.EventDispatcher.prototype.createXAPIEventTemplate=function(verb,extra){var event=new H5P.XAPIEvent;event.setActor();event.setVerb(verb);if(extra!==void 0){for(var i in extra){event.data.statement[i]=extra[i]}}if(!("object"in event.data.statement)){event.setObject(this)}if(!("context"in event.data.statement)){event.setContext(this)}return event};/**
 ...
 */H5P.EventDispatcher.prototype.triggerXAPICompleted=function(score,maxScore,success){this.triggerXAPIScored(score,maxScore,"completed",!0,success)};/**
