define(["exports", "../../../../@polymer/polymer/polymer-element.js", "./rich-text-editor-toolbar.js", "./rich-text-editor-breadcrumbs.js"], function (_exports, _polymerElement, _richTextEditorToolbar, _richTextEditorBreadcrumbs) {
  ...
  function _templateObject_ddabe8e088c411ea8e2ed3d8cb6f439c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", " ", " ", "\n    "]);

    _templateObject_ddabe8e088c411ea8e2ed3d8cb6f439c = function _templateObject_ddabe8e088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function (_RichTextEditorToolba) {
    ...
    babelHelpers.createClass(RichTextEditorToolbarFull, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_ddabe8e088c411ea8e2ed3d8cb6f439c(), this.styleTemplate, this.stickyTemplate, this.toolbarTemplate);
