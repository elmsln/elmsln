define(["exports", "../../../../lit-element/lit-element.js", "./haxcms-site-store.js", "../../../hax-body/lib/haxutils.js", "../../../../mobx/lib/mobx.module.js", "../../../../@polymer/paper-button/paper-button.js", "../../../../@polymer/iron-icons/iron-icons.js", "../../../../@polymer/iron-icons/notification-icons.js", "../../../simple-fields/lib/simple-fields-form.js"], function (_exports, _litElement, _haxcmsSiteStore, _haxutils, _mobxModule, _paperButton, _ironIcons, _notificationIcons, _simpleFieldsForm) {
  "use strict";
  ...
  function _templateObject3_10034820dedd11e9bf5a076df0f16721() {
    ...
    _templateObject3_10034820dedd11e9bf5a076df0f16721 = function _templateObject3_10034820dedd11e9bf5a076df0f16721() {
      return data;
    };
  ...
  function _templateObject2_10034820dedd11e9bf5a076df0f16721() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <span class=\"toptext\">\n                <a\n                  class=\"publishlink\"\n                  href=\"", "\"\n                  rel=\"noopener noreferrer\"\n                  target=\"_blank\"\n                >\n                  Click here to access the published version of this site\n                </a>\n              </span>\n            "]);

    _templateObject2_10034820dedd11e9bf5a076df0f16721 = function _templateObject2_10034820dedd11e9bf5a076df0f16721() {
      return data;
    };
  ...
  function _templateObject_10034820dedd11e9bf5a076df0f16721() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"title-wrapper\">\n        <h2 class=\"title\">", " settings</h2>\n        ", "\n      </div>\n      <div class=\"fields-wrapper\">\n        <simple-fields-form\n          id=\"siteform\"\n          .headers=\"", "\"\n          .body=\"", "\"\n          load-endpoint=\"", "\"\n          method=\"", "\"\n          @last-error-changed=\"", "\"\n        ></simple-fields-form>\n      </div>\n      <div class=\"buttons\">\n        <paper-button id=\"save\" @click=\"", "\"\n          ><iron-icon icon=\"icons:save\"></iron-icon> Save</paper-button\n        >\n        <paper-button id=\"cancel\" @click=\"", "\"\n          ><iron-icon icon=\"icons:cancel\"></iron-icon> Cancel</paper-button\n        >\n      </div>\n    "]);

    _templateObject_10034820dedd11e9bf5a076df0f16721 = function _templateObject_10034820dedd11e9bf5a076df0f16721() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    function HAXCMSSiteDashboard() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HAXCMSSiteDashboard).call(this));
      _this.manifest = {};
      ...
      (0, _mobxModule.autorun)(function (reaction) {
        _this.manifest = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.manifest);
    ...
    babelHelpers.createClass(HAXCMSSiteDashboard, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_10034820dedd11e9bf5a076df0f16721(), this.manifest.title, (0, _haxutils.varExists)(this.manifest, "metadata.site.static.publishedLocation") ? (0, _litElement.html)(_templateObject2_10034820dedd11e9bf5a076df0f16721(), (0, _haxutils.varGet)(this.manifest, "metadata.site.static.publishedLocation", "#")) : "", this.headers, this.body, this.loadEndpoint, this.method, this._lastErrorChanged, this._saveSiteFieldsTap, this._cancel);
      }
    }, {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "dashboardOpened" && _this2.dashboardOpened) {
            ...
            _this2.shadowRoot.querySelector("#siteform").loadData();
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_10034820dedd11e9bf5a076df0f16721())];
      }
    }, {
      key: "properties",
      get: function get() {
