...
@hero hero.svg
*/var PdfElement=/*#__PURE__*/function(_SchemaBehaviors){babelHelpers.inherits(PdfElement,_SchemaBehaviors);function PdfElement(){var _this;babelHelpers.classCallCheck(this,PdfElement);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PdfElement).call(this));new Promise(function(res,rej){return _require.default(["../../@polymer/paper-card/paper-card.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/app-layout/app-toolbar/app-toolbar.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-spinner/paper-spinner.js"],res,rej)});return _this}babelHelpers.createClass(PdfElement,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(PdfElement.prototype),"connectedCallback",this).call(this);this.src=this.getAttribute("src");this._initializeReader();if(this.src)this.instance.loadPDF();this._setFitWidth()}},{key:"loadPDF",/*
   * For the first time the pdf is loaded.
   * The inital page is set to 1 and it sets the total Pages
   */value:function loadPDF(){if(!this.getAttribute("src"))return;this.instance.changePDFSource(this.getAttribute("src"));this.currentPage=1;this.totalPages=this.instance.totalPages;this.fileName=this.src.split("/").pop();this._setFitWidth();this.shadowRoot.querySelector("#zoomIcon").icon="fullscreen"}/*
   ...
   */},{key:"zoomInOut",value:function zoomInOut(step){if(2<=this.instance.currentZoomVal){this.instance.currentZoomVal=2}else if(.1>=this.instance.currentZoomVal){this.instance.currentZoomVal=.1}else{this.shadowRoot.querySelector("#zoomIcon").icon="fullscreen";this.instance.zoomInOut(step)}}/*
   ...
   */},{key:"zoomFit",value:function zoomFit(){if(this.instance.pdfExists){if(this.instance.currentZoomVal==this.instance.widthZoomVal){this.instance.zoomPageFit();this.shadowRoot.querySelector("#zoomIcon").icon="fullscreen"}else{this.instance.zoomWidthFit();this.shadowRoot.querySelector("#zoomIcon").icon="fullscreen-exit"}}}/*
   ...
   */},{key:"pageNumSearch",value:function pageNumSearch(){var page=parseInt(this.shadowRoot.querySelector("#input").value);if(1<=page&&page<=this.instance.totalPagesNum){this.instance.currentPage=page;this.instance.queueRenderPage(this.instance.currentPage);this.currentPage=page;this.shadowRoot.querySelector("#input").blur()}else{this.shadowRoot.querySelector("#input").value=this.currentPage;this.shadowRoot.querySelector("#input").blur()}}/*
...
var parsedFileName=currentThis.src.split("/").pop(),self=currentInstance;currentThis.sidebarOpen=!0;if(1<=page&&page<=currentInstance.totalPagesNum){self.currentPage=page;self.queueRenderPage(self.currentPage);currentInstance.currentPage=page;currentThis.currentPage=page;this.shadowRoot.querySelector("#input").blur()}else{this.shadowRoot.querySelector("#input").value=self.currentPage;this.shadowRoot.querySelector("#input").blur()}}/*
   ...
   */},{key:"sideBar",value:function sideBar(){if(this.instance.pdfExists){if(!this.fromChange){this.shadowRoot.querySelector("#container").style.height=this.shadowRoot.querySelector("#test").style.height;this.shadowRoot.querySelector("#container").style.width=this.shadowRoot.querySelector("#test").style.width;if("25%"==this.shadowRoot.querySelector("#main").style.marginLeft){this.sidebarOpen=!1;this.instance.setViewportPos(!1);this.shadowRoot.querySelector("#main").style.marginLeft="0%";this.shadowRoot.querySelector("#container").style.marginLeft="-25%";this.shadowRoot.querySelector("#container").style.visibility="hidden"}else{this.sidebarOpen=!0;this.shadowRoot.querySelector("#main").style.marginLeft="25%";this.shadowRoot.querySelector("#container").style.marginLeft="0%";this.shadowRoot.querySelector("#container").style.visibility="visible";this.instance.setViewportPos(!0)}}this.fromChange=!1;this.instance.sidebarSetup(this);this.changedSideBar=!1}}/*
   * Is called when the download pdf button is selected
   */},{key:"download",value:function download(){if(this.instance.pdfExists){this.instance.download()}}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_6d3c16c07a2311ea877d9d791dd38f76())}},{key:"tag",get:function get(){return"pdf-element"}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(PdfElement),"properties",this),{/**
