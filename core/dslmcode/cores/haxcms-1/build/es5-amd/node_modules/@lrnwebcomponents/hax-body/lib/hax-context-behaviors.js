define(["exports", "../../../lit/index.js", "../../simple-popover/lib/SimpleTourFinder.js", "../../../mobx/dist/mobx.esm.js", "./hax-store.js"], function (_exports, _index, _SimpleTourFinder2, _mobxEsm, _haxStore) {
  ...
  var _templateObject_c96b7ca0f9df11eba887937af67006f3, _templateObject2_c96b7ca0f9df11eba887937af67006f3;
    ...
    return /*#__PURE__*/function (_SimpleTourFinder) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function render() {
          return (0, _index.html)(_templateObject_c96b7ca0f9df11eba887937af67006f3 || (_templateObject_c96b7ca0f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["<slot></slot> "])));
        }
      }, {
        key: "slotSchema",
        get: function get() {
          ...
          if (this.activeNode && this.parentSchema) {
            ...
            Object.keys(this.parentSchema.settings || {}).forEach(function (type) {
              (_this2.parentSchema.settings[type] || []).forEach(function (setting) {
        ...
        value: function getFilteredBlocks() {
          ...
          return blocks.filter(function (block) {
            if (!block.tag) return;
            var tag = block.tag || "",
                wrapper = !!_this3.slotSchema && !!_this3.slotSchema.slotWrapper && !!_this3.slotSchema.slotWrapper ? _this3.slotSchema.slotWrapper : undefined,
                allowed = !!_this3.slotSchema && !!_this3.slotSchema.slotWrapper && !!_this3.slotSchema.allowedSlotWrappers ? _this3.slotSchema.allowedSlotWrappers : undefined,
                excluded = !!_this3.slotSchema && !!_this3.slotSchema.slotWrapper && !!_this3.slotSchema.excludedSlotWrappers ? _this3.slotSchema.excludedSlotWrappers : undefined,
                //allow any tag since there is no allowed list specified
            allowAny = !_this3.slotSchema || !allowed,
            ...
            if (_this3.tag == "hax-plate-context") console.log(tag, wrapper, excluded, allowAny, allowOnly, allowExcept, show);
            return show;
          });
        }
      }, {
        ...
        value: function updated(changedProperties) {
          ...
          changedProperties.forEach(function (oldValue, propName) {
            if (propName === "activeNode" && _this4.activeNode !== oldValue) _this4.setTarget(_this4.activeNode);
          });
        }
      }, {
        key: "setTarget",
