define(["exports", "require", "../../../../../lit-element/lit-element.js", "../haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../jwt-login/jwt-login.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxEsm, _jwtLogin) {
  "use strict";
  ...
  function _templateObject_adcdf7e056b811eb8081cb2f2fa80813() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <jwt-login\n        auto\n        id=\"jwt\"\n        jwt=\"", "\"\n        @jwt-changed=\"", "\"\n      ></jwt-login>\n    "]);

    _templateObject_adcdf7e056b811eb8081cb2f2fa80813 = function _templateObject_adcdf7e056b811eb8081cb2f2fa80813() {
      return data;
    };
   ...
   */
  var HAXCMSBackendDemo = /*#__PURE__*/function (_LitElement) {
    babelHelpers.inherits(HAXCMSBackendDemo, _LitElement);

    var _super = _createSuper(HAXCMSBackendDemo);

    babelHelpers.createClass(HAXCMSBackendDemo, [{
      key: "render",
      // render function
      value: function render() {
        return (0, _litElement.html)(_templateObject_adcdf7e056b811eb8081cb2f2fa80813(), this.jwt, this.jwtChanged);
      }
    }, {
      key: "jwtChanged",
    ...
    babelHelpers.createClass(HAXCMSBackendDemo, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "jwt" && _this2.jwt) {
            _this2._jwtChanged(_this2[propName], oldValue);
          }
        });
      }
      /**
      ...
      value: function firstUpdated(changedProperties) {
        ...
        setTimeout(function () {
          if (window.appSettings) {
            var jwtlogin = _this3.shadowRoot.querySelector("#jwt");
            ...
            if (window.appSettings.jwt) {
              _this3.jwt = window.appSettings.jwt;
            }
          }
