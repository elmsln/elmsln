define(["exports", "../../lit-element/lit-element.js", "../hax-body-behaviors/lib/HAXWiring.js", "../accent-card/accent-card.js", "../../@polymer/iron-icon/iron-icon.js", "../../@polymer/iron-icons/iron-icons.js", "./lib/nav-card-item.js"], function (_exports, _litElement, _HAXWiring, _accentCard, _ironIcon, _ironIcons, _navCardItem) {
  "use strict";
  ...
  function _templateObject2_00f3c13001c211eba2339b0c52070e79() {
    ...
    _templateObject2_00f3c13001c211eba2339b0c52070e79 = function _templateObject2_00f3c13001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject_00f3c13001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral([" <article id=\"card\">\n      <div class=\"image-outer\" ?hidden=\"", "\">\n        <div\n          class=\"image\"\n          .style=\"", "\"\n        ></div>\n      </div>\n      <div class=\"body\">\n        <h1 id=\"heading\"><slot name=\"heading\"></slot></h1>\n        <div id=\"subheading\"><slot name=\"subheading\"></slot></div>\n        <div id=\"content\">\n          <slot name=\"body\"></slot>\n          <div id=\"linklist\">\n            <slot name=\"linklist\"></slot>\n          </div>\n        </div>\n        <div id=\"footer\"><slot name=\"footer\"></slot></div>\n      </div>\n    </article>"]);

    _templateObject_00f3c13001c211eba2339b0c52070e79 = function _templateObject_00f3c13001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  var NavCard = /*#__PURE__*/function (_AccentCard) {
    ...
    babelHelpers.createClass(NavCard, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_00f3c13001c211eba2339b0c52070e79(), !this.imageSrc, this.imageSrc ? "background-image: url(".concat(this.imageSrc, ");") : "display: none;");
      ...
      //styles function
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(NavCard), "styles", this)), [(0, _litElement.css)(_templateObject2_00f3c13001c211eba2339b0c52070e79())]);
      }
    }, {
      key: "haxProperties",
      get: function get() {
