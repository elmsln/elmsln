define(["exports", "../../lit-element/lit-element.js", "./lib/hex-a-gon.js"], function (_exports, _litElement, _hexAGon) {
  "use strict";
  ...
  function _templateObject3_7d9f4010552d11ebb4022f4768b4777e() {
    ...
    _templateObject3_7d9f4010552d11ebb4022f4768b4777e = function _templateObject3_7d9f4010552d11ebb4022f4768b4777e() {
      return data;
    };
  ...
  function _templateObject2_7d9f4010552d11ebb4022f4768b4777e() {
    var data = babelHelpers.taggedTemplateLiteral(["<hex-a-gon></hex-a-gon>"]);

    _templateObject2_7d9f4010552d11ebb4022f4768b4777e = function _templateObject2_7d9f4010552d11ebb4022f4768b4777e() {
      return data;
    };
  ...
  function _templateObject_7d9f4010552d11ebb4022f4768b4777e() {
    var data = babelHelpers.taggedTemplateLiteral([" <div>\n      ", "\n    </div>"]);

    _templateObject_7d9f4010552d11ebb4022f4768b4777e = function _templateObject_7d9f4010552d11ebb4022f4768b4777e() {
      return data;
    };
   ...
   */
  var HexagonLoader = /*#__PURE__*/function (_LitElement) {
    babelHelpers.inherits(HexagonLoader, _LitElement);

    var _super = _createSuper(HexagonLoader);

    babelHelpers.createClass(HexagonLoader, [{
      key: "render",
      // render function
      value: function render() {
        return (0, _litElement.html)(_templateObject_7d9f4010552d11ebb4022f4768b4777e(), this.items.map(function (item) {
          return (0, _litElement.html)(_templateObject2_7d9f4010552d11ebb4022f4768b4777e());
        }));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_7d9f4010552d11ebb4022f4768b4777e())];
      }
    }, {
      key: "properties",
      get: function get() {
        return _objectSpread(_objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(HexagonLoader), "properties", this)), {}, {
          /**
    ...
    function HexagonLoader() {
      ...
      _this = _super.call(this); // default for a nice arrangement of items
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "itemCount") {
            ...
            for (var i = 0; i < _this2[propName]; i++) {
              _this2.items.push("");
            }
            ...
            var ctr = -4,
                ...
                rownum = 0,
                offset = 0;
            [4, 5, 6, 7, 6, 5, 4].forEach(function (row, i) {
              ctr += row;

              if (_this2.itemCount >= ctr) {
                height = increment * (i + 1);
                order = _this2.itemCount - ctr;
                rownum = i + 1;
              }
            });
            offset = rownum > 3 ? 4 : rownum > 2 ? 3 : rownum > 1 ? 2 : 1;

            _this2.style.setProperty("--hexagon-loader-height", "".concat(height, "px"));
          }
        });
      }
      /**
