...
!function (a, b) {
  ...
  }) : "object" == (typeof exports === "undefined" ? "undefined" : babelHelpers.typeof(exports)) ? module.exports = b(require("chartist")) : a["Chartist.plugins.ctPointLabels"] = b(Chartist);
}(this, function (a) {
  return function (a, b, c) {
    ...
    c.plugins = c.plugins || {}, c.plugins.ctPointLabels = function (a) {
      function b(b, c) {
        ...
        }, a.labelClass).text(a.labelInterpolationFnc(d));
      }

      return a = c.extend({}, d, a), function (d) {
        (babelHelpers.instanceof(d, c.Line) || babelHelpers.instanceof(d, c.Bar)) && d.on("draw", function (c) {
          var d = e[c.type] && e[c.type][a.align] || e[c.type];
          d && b(d(c), c);
        });
      };
    };
  }(window, document, a), a.plugins.ctPointLabels;
});