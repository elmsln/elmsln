 ...
 */var OutlineDesigner=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(OutlineDesigner,_PolymerElement);function OutlineDesigner(){babelHelpers.classCallCheck(this,OutlineDesigner);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(OutlineDesigner).apply(this,arguments))}babelHelpers.createClass(OutlineDesigner,[{key:"connectedCallback",/**
   ...
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(OutlineDesigner.prototype),"connectedCallback",this).call(this);this.shadowRoot.querySelector("#ironlist").addEventListener("item-overlay-op-changed",this._overlayOpChanged.bind(this));this.shadowRoot.querySelector("#ironlist").addEventListener("item-overlay-option-selected",this._overlayOpSelected.bind(this));(0,_pagemap.pagemap)(this.shadowRoot.querySelector("#minimaparea"),{viewport:null,styles:{"ul,ol,li":"rgba(0, 0, 0, 0.08)","h1,h2,h3,h4,h5,h6,a":"rgba(0, 0, 0, 0.10)","lrnsys-outline-item":"rgba(0, 0, 0, 0.08)","p,section":"rgba(0, 0, 0, 0.02)"},back:"rgba(0, 0, 0, 0.02)",view:"rgba(0, 0, 0, 0.05)",drag:"rgba(0, 0, 0, 0.10)",interval:null})}/**
   * life cycle, element is removed from the DOM
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(OutlineDesigner.prototype),"disconnectedCallback",this).call(this);this.shadowRoot.querySelector("#ironlist").removeEventListener("item-overlay-op-changed",this._overlayOpChanged.bind(this));this.shadowRoot.querySelector("#ironlist").removeEventListener("item-overlay-option-selected",this._overlayOpSelected.bind(this))}},{key:"_toggleMiniMap",value:function _toggleMiniMap(e){this.miniMap=!this.miniMap}},{key:"_miniMapChanged",value:function _miniMapChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){if(newValue){this.shadowRoot.querySelector("#minimap").icon="device:gps-fixed";this.shadowRoot.querySelector("#minimaparea").classList.add("show-minimap")}else{this.shadowRoot.querySelector("#minimap").icon="device:gps-off";this.shadowRoot.querySelector("#minimaparea").classList.remove("show-minimap")}}}/**
   * toggle between view modes
   */},{key:"_toggleViewMode",value:function _toggleViewMode(e){switch(this.viewMode){case"cards":this.viewMode="outline";break;case"outline":this.outlineData=this.shadowRoot.querySelector("#outline").getData();this.viewMode="tree";break;case"tree":this.viewMode="drag";break;case"drag":this.viewMode="cards";break;}}/**
...
if(0===this.selectedView){async.microTask.run(function(){setTimeout(function(){_this.shadowRoot.querySelector("#ironlist").dispatchEvent(new CustomEvent("iron-resize",{bubbles:!0,cancelable:!0,composed:!0,detail:!0}));window.dispatchEvent(new Event("resize"))},50)})}}}/**
