define(["exports", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/async.js", "../../@polymer/paper-icon-button/paper-icon-button.js", "../../@polymer/iron-icons/iron-icons.js", "../../@polymer/iron-icons/social-icons.js", "../../@polymer/iron-icons/device-icons.js", "../../@polymer/iron-pages/iron-pages.js", "../../@polymer/iron-image/iron-image.js", "../../@polymer/paper-button/paper-button.js", "../../@polymer/paper-card/paper-card.js", "../../@polymer/iron-ajax/iron-ajax.js", "../../@polymer/iron-list/iron-list.js", "../../@polymer/iron-swipeable-container/iron-swipeable-container.js", "../../@polymer/paper-tooltip/paper-tooltip.js", "../../@polymer/paper-progress/paper-progress.js", "../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../@polymer/app-layout/app-header/app-header.js", "../item-overlay-ops/item-overlay-ops.js", "../lrnsys-outline/lrnsys-outline.js", "../simple-colors/simple-colors.js", "../simple-modal/simple-modal.js", "../editable-list/editable-list.js", "./lib/sortable-list.js", "./lib/pagemap.js"], function (_exports, _polymerElement, async, _paperIconButton, _ironIcons, _socialIcons, _deviceIcons, _ironPages, _ironImage, _paperButton, _paperCard, _ironAjax, _ironList, _ironSwipeableContainer, _paperTooltip, _paperProgress, _appToolbar, _appHeader, _itemOverlayOps, _lrnsysOutline, _simpleColors, _simpleModal, _editableList, _sortableList, _pagemap) {
  ...
  function _templateObject_25ef9250b3b911e9b58d79562a23326c() {
    ...
    _templateObject_25ef9250b3b911e9b58d79562a23326c = function _templateObject_25ef9250b3b911e9b58d79562a23326c() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    function OutlineDesigner() {
      ...
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(OutlineDesigner).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(OutlineDesigner, [{
      ...
      value: function connectedCallback() {
        ...
        this.$.ironlist.addEventListener("item-overlay-op-changed", this._overlayOpChanged.bind(this));
        this.$.ironlist.addEventListener("item-overlay-option-selected", this._overlayOpSelected.bind(this));
        (0, _pagemap.pagemap)(this.$.minimaparea, {
          viewport: null,
          styles: {
      ...
      value: function disconnectedCallback() {
        ...
        this.$.ironlist.removeEventListener("item-overlay-op-changed", this._overlayOpChanged.bind(this));
        this.$.ironlist.removeEventListener("item-overlay-option-selected", this._overlayOpSelected.bind(this));
      }
    }, {
      key: "_toggleMiniMap",
        ...
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          if (this.selectedView === 0) {
            async.microTask.run(function () {
              setTimeout(function () {
                _this.$.ironlist.dispatchEvent(new CustomEvent("iron-resize", {
                  bubbles: true,
                  cancelable: true,
                  composed: true,
                  detail: true
        ...
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          switch (newValue) {
            case "cards":
              ...
              async.microTask.run(function () {
                setTimeout(function () {
                  _this2.$.ironlist.dispatchEvent(new CustomEvent("iron-resize", {
                    bubbles: true,
                    cancelable: true,
                    composed: true,
                    detail: true
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_25ef9250b3b911e9b58d79562a23326c());
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(OutlineDesigner), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(OutlineDesigner), "properties", this));
        }
