define(["exports", "meta", "./rich-text-editor-picker.js", "../../../../@polymer/polymer/lib/utils/resolve-url.js", "../../../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _richTextEditorPicker, _resolveUrl, _esGlobalBridge) {
  "use strict";
  ...
  function (_RichTextEditorPicker) {
    ...
    function RichTextEditorSymbolPicker() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(RichTextEditorSymbolPicker).call(this));
    ...
    babelHelpers.createClass(RichTextEditorSymbolPicker, [{
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorSymbolPicker.prototype), "connectedCallback", this).call(this);
      ...
      value: function disconnectedCallback() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorSymbolPicker.prototype), "disconnectedCallback", this).call(this);
      }
      /**
      ...
      value: function _getPickerOptions() {
        ...
        var temp = babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorSymbolPicker.prototype), "_getPickerOptions", this).call(this, options, allowNull, icon);
        temp[0].unshift({
          alt: null,
          icon: this.icon,
          value: null
