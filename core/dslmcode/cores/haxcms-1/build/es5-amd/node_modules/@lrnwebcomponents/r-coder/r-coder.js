define(["exports","../../@polymer/polymer/polymer-element.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/paper-button/paper-button.js","../code-editor/code-editor.js"],function(_exports,_polymerElement,_HAXWiring,_paperButton,_codeEditor){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.RCoder=void 0;function _templateObject_395107a0991711e9a339815674c2f1cf(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #editor {\n          height: var(--r-coder-editor-height, 300px);\n          width: var(--r-coder-editor-width, 100%);\n        }\n\n        #button {\n          margin: var(--r-code-button-margin, 10px 0);\n        }\n      </style>\n      <code-editor id=\"editor\" language=\"r\"></code-editor>\n      <paper-button\n        id=\"button\"\n        disabled=\"[[!__connected]]\"\n        on-click=\"process\"\n        raised\n        >Process</paper-button\n      >\n      <div id=\"output\"></div>\n    "]);_templateObject_395107a0991711e9a339815674c2f1cf=function _templateObject_395107a0991711e9a339815674c2f1cf(){return data};return data}/**
 * `r-coder`
...
get:function get(){return(0,_polymerElement.html)(_templateObject_395107a0991711e9a339815674c2f1cf())}// haxProperty definition
