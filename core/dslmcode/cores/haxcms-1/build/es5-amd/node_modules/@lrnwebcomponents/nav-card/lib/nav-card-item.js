define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-icons/iron-icons.js", "../../lrndesign-avatar/lrndesign-avatar.js"], function (_exports, _litElement, _ironIcon, _ironIcons, _lrndesignAvatar) {
  ...
  function _templateObject4_916cf050c96f11ea8be5e1d5fe7ec787() {
    ...
    _templateObject4_916cf050c96f11ea8be5e1d5fe7ec787 = function _templateObject4_916cf050c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject3_916cf050c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <iron-icon icon=\"", "\"></iron-icon>\n          "]);

    _templateObject3_916cf050c96f11ea8be5e1d5fe7ec787 = function _templateObject3_916cf050c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject2_916cf050c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <lrndesign-avatar\n              .accentColor=\"", "\"\n              ?dark=\"", "\"\n              .icon=\"", "\"\n              .src=\"", "\"\n              .label=\"", "\"\n              ?two-chars=\"", "\"\n            >\n            </lrndesign-avatar>\n          "]);

    _templateObject2_916cf050c96f11ea8be5e1d5fe7ec787 = function _templateObject2_916cf050c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function _templateObject_916cf050c96f11ea8be5e1d5fe7ec787() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <div>\n        <slot name=\"label\"></slot>\n        <slot name=\"description\"></slot>\n      </div>\n      ", "\n    "]);

    _templateObject_916cf050c96f11ea8be5e1d5fe7ec787 = function _templateObject_916cf050c96f11ea8be5e1d5fe7ec787() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(NavCardItem, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_916cf050c96f11ea8be5e1d5fe7ec787(), !this.avatar && !this.initials ? "" : (0, _litElement.html)(_templateObject2_916cf050c96f11ea8be5e1d5fe7ec787(), this.accentColor || "", this.dark, this.ico || "", this.src || "", this.label, this.twoChars), !this.icon ? "" : (0, _litElement.html)(_templateObject3_916cf050c96f11ea8be5e1d5fe7ec787(), this.icon));
      } // life cycle
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_916cf050c96f11ea8be5e1d5fe7ec787())];
      }
    }]);
