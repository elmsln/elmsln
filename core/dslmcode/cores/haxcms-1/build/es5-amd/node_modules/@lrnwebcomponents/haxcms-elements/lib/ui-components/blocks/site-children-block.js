define(["exports", "../../../../../lit/index.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../query/site-query-menu-slice.js"], function (_exports, _index, _haxcmsSiteStore, _mobxEsm, _siteQueryMenuSlice) {
  ...
  var _templateObject_dda47d20f9df11eba887937af67006f3, _templateObject2_dda47d20f9df11eba887937af67006f3, _templateObject3_dda47d20f9df11eba887937af67006f3;
  ...
  var SiteChildrenBlock = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SiteChildrenBlock, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_dda47d20f9df11eba887937af67006f3 || (_templateObject_dda47d20f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"wrapper\">\n        <site-query-menu-slice\n          @result-changed=\"", "\"\n          dynamic-methodology=\"", "\"\n          start=\"", "\"\n          end=\"", "\"\n          parent=\"", "\"\n          ?fixed-id=\"", "\"\n        ></site-query-menu-slice>\n        ", "\n      </div>\n    "])), this.resultChanged, this.dynamicMethodology, this.start, this.end, this.parent, this.fixedId, this.__items.map(function (item) {
          return (0, _index.html)(_templateObject2_dda47d20f9df11eba887937af67006f3 || (_templateObject2_dda47d20f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n            <div class=\"spacing\">\n              <a\n                data-id=\"", "\"\n                class=\"link\"\n                tabindex=\"-1\"\n                href=\"", "\"\n              >\n                <button noink=\"", "\">\n                  <div class=\"indent indent-", "\"></div>\n                  ", "\n                </button>\n              </a>\n            </div>\n          "])), item.id, item.slug, _this2.noink, item.indent, item.title);
        }));
      }
    }, {
