...
this.set("activeChart.data",this._formatChartData(e.detail.value));this.notifyPath("activeChart.data")}}/**
   ...
   */},{key:"_formatChartData",value:function _formatChartData(type){var labels=[],series=[[]],stats=this.stats.stats,assignments=this._toArray(this.assignments),parts=type.split("-");if(babelHelpers.typeof(stats[parts[0]])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(stats[parts[0]][parts[1]])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){// make sure the data aligns now w/ the IDs in question
// or we'll start mixing up our data.
for(var i in assignments){var title=assignments[i].title;if(babelHelpers.typeof(stats[parts[0]][parts[1]][assignments[i].id])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){series[0].push(stats[parts[0]][parts[1]][assignments[i].id]);title+=" (".concat(stats[parts[0]][parts[1]][assignments[i].id],")")}else{series[0].push(0);title+=" (0)"}labels.push(title)}}return{labels:labels,series:series}}/**
   ...
   * and event
   */},{key:"_dataTypeChanged",value:function _dataTypeChanged(newValue,oldValue){// if type changes values and not from undefined to defined
// then we should execute the request for data after setting type
if(babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){if(newValue){this.dataTypeText="Comments (beta)"}else{this.dataTypeText="Submissions"}}}/**
   * Stupid thing to make it go from array position 0 to 1.
   */},{key:"_commentIndex",value:function _commentIndex(index){return index+1}/**
...
this.studentParams.projectId=this.activeProject;this.$.studentrequest.generateRequest()}},{key:"_openStatsDialog",value:function _openStatsDialog(e){this.$.statsdialog.toggle()}/**
   * attached life cycle
   */},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(LrnappStudioInstructor.prototype),"connectedCallback",this).call(this);this.$.statsdialogbutton.addEventListener("click",this._openStatsDialog.bind(this));// listen for focus event to have fired
this.$.statsdialog.addEventListener("opened-changed",this._accessibleFocus.bind(this));this.$.dialog.addEventListener("opened-changed",this._accessibleFocus.bind(this));this.$.selectedproject.addEventListener("dropdown-select-changed",this._projectChanged.bind(this));this.$.selectedchart.addEventListener("value-changed",this._chartChanged.bind(this))}/**
   * detached life cycle
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){this.$.statsdialogbutton.removeEventListener("click",this._openStatsDialog.bind(this));// listen for focus event to have fired
this.$.statsdialog.removeEventListener("opened-changed",this._accessibleFocus.bind(this));this.$.dialog.removeEventListener("opened-changed",this._accessibleFocus.bind(this));this.$.selectedproject.removeEventListener("dropdown-select-changed",this._projectChanged.bind(this));this.$.selectedchart.removeEventListener("value-changed",this._chartChanged.bind(this));babelHelpers.get(babelHelpers.getPrototypeOf(LrnappStudioInstructor.prototype),"disconnectedCallback",this).call(this)}/**
   * Set ourselves as having focus after the modal closes.
   */},{key:"_accessibleFocus",value:function _accessibleFocus(e){if(!e.detail){document.body.classList.remove("scroll-disabled");// focus on our dialog triggering button
this.__rememberClick.focus()}}/**
   * Handle response for the whole projects object.
   */},{key:"_handleProjectResponse",value:function _handleProjectResponse(event){this.$.loading.hidden=!0;this.set("projects",this._projectData.data.projects)}/**
   * Handle response for the whole projects object.
   */},{key:"_handleStudentResponse",value:function _handleStudentResponse(event){var _this=this;this.$.loading.hidden=!0;this.set("students",[]);this.set("students",this._studentData.data.students);this.set("assignments",[]);this.set("assignments",this._studentData.data.assignments);this.stats=this._studentData.data.stats;this.set("stats.header","Statistics for "+this.projects["project-"+this.activeProject].attributes.title);// make sure default is asc data
setTimeout(function(){_this.shadowRoot.querySelector("#sorter").direction="asc"},200)}/**
   * Pie menu operation handler based on which was clicked.
   */},{key:"_changeActiveItem",value:function _changeActiveItem(e){document.body.classList.add("scroll-disabled");var normalizedEvent=(0,_polymerDom.dom)(e),local=normalizedEvent.localTarget,newstudent,newassignment;// use button id in order to move around in the grid as far as active
switch(local.id){case"prevstudent":newstudent=this._getObjectByPosition(this.students,this.activeData.student.id,-1);if(-1!=newstudent&&babelHelpers.typeof(newstudent.assignments[this.activeData.assignment.id])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.set("activeData.student",{});this.set("activeData.student",newstudent);this.set("activeData.submission",{});this.set("activeData.submission",newstudent.assignments[this.activeData.assignment.id]);this.set("route.path",this.endPoint+"/submissions/"+this.activeData.submission.id)}break;case"nextstudent":newstudent=this._getObjectByPosition(this.students,this.activeData.student.id,1);if(-1!=newstudent&&babelHelpers.typeof(newstudent.assignments[this.activeData.assignment.id])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.set("activeData.student",{});this.set("activeData.student",newstudent);this.set("activeData.submission",{});this.set("activeData.submission",newstudent.assignments[this.activeData.assignment.id]);this.set("route.path",this.endPoint+"/submissions/"+this.activeData.submission.id)}break;case"prevassignment":newassignment=this._getObjectByPosition(this.assignments,this.activeData.assignment.id,-1);if(-1!=newassignment){this.set("activeData.assignment",{});this.set("activeData.assignment",newassignment);if(babelHelpers.typeof(this.activeData.student.assignments[newassignment.id].id)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.set("activeData.submission",this.activeData.student.assignments[newassignment.id]);this.set("activeData.submission",{});this.set("route.path",this.endPoint+"/submissions/"+this.activeData.student.assignments[newassignment.id].id)}else{this.set("activeData.submission",!1)}}break;case"nextassignment":newassignment=this._getObjectByPosition(this.assignments,this.activeData.assignment.id,1);if(-1!=newassignment){this.set("activeData.assignment",{});this.set("activeData.assignment",newassignment);if(babelHelpers.typeof(this.activeData.student.assignments[newassignment.id].id)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.set("activeData.submission",{});this.set("activeData.submission",this.activeData.student.assignments[newassignment.id]);this.set("route.path",this.endPoint+"/submissions/"+this.activeData.student.assignments[newassignment.id].id)}else{this.set("activeData.submission",!1)}}break;}}/**
   * Helper to move back and forth in an object like you can an array
   */},{key:"_getObjectByPosition",value:function _getObjectByPosition(items,key,i){var keys=Object.keys(items).sort(function(a,b){if(babelHelpers.typeof(items[a].sis)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){if(items[a].sis.sortable_name>items[b].sis.sortable_name){return 1}else if(items[a].sis.sortable_name<items[b].sis.sortable_name){return-1}return 0}else{return a-b}});if(key!==void 0){key=key.toString()}var index=keys.indexOf(key);// try fallback for type issues
if(-1==index){index=keys.indexOf(parseInt(key))}if(-1==i&&0<index||1==i&&index<keys.length-1){return items[keys[index+i]]}else{return-1}}/**
   ...
   */},{key:"_submissionStatus",value:function _submissionStatus(student,assignment,dataType){if(null!=student){if(!dataType&&babelHelpers.typeof(student.assignments[assignment.id])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(student.assignments[assignment.id].id)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){return!0}else if(dataType&&babelHelpers.typeof(student.assignmentComments[assignment.id])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&0<this._toArray(student.assignmentComments[assignment.id]).length){return!0}}return!1}/**
   * Test student submission status relative to assignments
   */},{key:"_submissionID",value:function _submissionID(student,assignment){if(null!=student&&babelHelpers.typeof(student.assignments[assignment.id])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(student.assignments[assignment.id].id)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){return student.assignments[assignment.id].id}return!1}/**
   * Return a piece of the submission needed for visualization bc of template scope
   */},{key:"_submissionPiece",value:function _submissionPiece(student,assignment,piece){if(null!=student&&babelHelpers.typeof(student.assignments[assignment.id])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(student.assignments[assignment.id].id)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){var submission=student.assignments[assignment.id];switch(piece){case"url":return this.basePath+"lrnapp-studio-submission/submissions/"+submission.id;break;case"title":return submission.attributes.title;break;case"icon":return submission.meta.state_icon;break;case"color":return submission.meta.state_color;break;case"comments":return this._toArray(student.assignmentComments[assignment.id]);break;}}return""}/**
   * Return number of comments on an assignment for display.
   */},{key:"_commentCount",value:function _commentCount(student,assignment,dataType){if(!dataType&&null!=student&&babelHelpers.typeof(student.assignmentComments[assignment.id])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){return this._toArray(student.assignmentComments[assignment.id]).length}return!1}/**
   * Set route for active submission to load
   */},{key:"_setActiveSubmission",value:function _setActiveSubmission(e){var normalizedEvent=(0,_polymerDom.dom)(e),local=normalizedEvent.localTarget;this.__rememberClick=local;var item=local.id.split("-");// find the active elements
this.set("activeData.student",this.students[item[1]]);this.set("activeData.assignment",this.assignments[item[3]]);this.set("activeData.submission",this.students[item[1]].assignments[item[3]]);this.set("route.path",this.endPoint+"/submissions/"+item[item.length-1]);document.body.classList.add("scroll-disabled");this.$.dialog.toggle()}/**
   ...
   */},{key:"_setActiveComment",value:function _setActiveComment(e){// disable all buttons for in modal nav
...
this.set("activeData.student",this.students[item[1]]);this.set("activeData.assignment",this.assignments[item[3]]);this.set("activeData.submission",this.students[item[1]].assignments[item[3]]);this.set("route.path",this.endPoint+"/submissions/"+item[item.length-1]);document.body.classList.add("scroll-disabled");this.$.dialog.toggle()}/**
   ...
   */},{key:"_toArray",value:function _toArray(obj){if(null==obj){return[]}return Object.keys(obj).map(function(key){return obj[key]})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_bf2a9ff0734911eaac0dbb5c5350affd())}},{key:"tag",get:function get(){return"lrnapp-studio-instructor"}},{key:"observers",get:function get(){return["_routeChanged(route, endPoint)","_activeDataChanged(activeData.student, activeData.assignment)"]}},{key:"properties",get:function get(){var _ref;return _ref={elmslnCourse:{type:String},elmslnSection:{type:String},basePath:{type:String},csrfToken:{type:String},endPoint:{type:String},sourceProjectPath:{type:String},sourceStudentPath:{type:String},simplePickerOptions:{type:Array,value:[[{alt:"Submissions by Assignment",value:"byassignment-submissions"}],[{alt:"Comments by Assignment",value:"byassignment-comments"}],[{alt:"Commenters by Assignment",value:"byassignment-commenters"}]]},/**
       ...
       */sourcePath:{type:String,notify:!0}},babelHelpers.defineProperty(_ref,"basePath",{type:String,notify:!0}),babelHelpers.defineProperty(_ref,"route",{type:String}),babelHelpers.defineProperty(_ref,"csrfToken",{type:String}),babelHelpers.defineProperty(_ref,"elmslnCourse",{type:String}),babelHelpers.defineProperty(_ref,"elmslnSection",{type:String}),babelHelpers.defineProperty(_ref,"data",{type:Object}),babelHelpers.defineProperty(_ref,"activeProject",{type:Number,value:!1}),babelHelpers.defineProperty(_ref,"activeData",{type:Object,value:{student:!1,assignment:!1,submission:!1}}),babelHelpers.defineProperty(_ref,"stats",{type:Object,value:{}}),babelHelpers.defineProperty(_ref,"activeChart",{type:Object,value:{}}),_ref}}]);return LrnappStudioInstructor}(_polymerElement.PolymerElement);_exports.LrnappStudioInstructor=LrnappStudioInstructor;window.customElements.define(LrnappStudioInstructor.tag,LrnappStudioInstructor)});