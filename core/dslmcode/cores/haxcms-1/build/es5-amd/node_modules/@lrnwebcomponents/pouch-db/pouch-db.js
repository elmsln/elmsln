define(["exports", "../../@polymer/polymer/polymer-element.js", "./lib/pouchdb.min.js"], function (_exports, _polymerElement, _pouchdbMin) {
  ...
  function _templateObject_d684fdb01bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n    "]);

    _templateObject_d684fdb01bb211eabd7cc30119585ddb = function _templateObject_d684fdb01bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(PouchDb, _PolymerElement);

    function PouchDb() {
      babelHelpers.classCallCheck(this, PouchDb);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(PouchDb).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(PouchDb, [{
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(PouchDb.prototype), "connectedCallback", this).call(this);
      ...
      value: function disconnectedCallback() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(PouchDb.prototype), "disconnectedCallback", this).call(this);
      }
    }], [{
      key: "template",
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_d684fdb01bb211eabd7cc30119585ddb());
      } // properties available to the custom element for data binding

    }, {
      key: "properties",
      get: function get() {
        return babelHelpers.objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(PouchDb), "properties", this), {
          title: {
            name: "title",
            type: String,
