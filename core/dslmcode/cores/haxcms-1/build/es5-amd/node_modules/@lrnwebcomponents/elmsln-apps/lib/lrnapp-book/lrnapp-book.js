define(["exports", "../../../../@polymer/polymer/polymer-element.js", "../../../../@polymer/polymer/lib/utils/render-status.js", "../../../haxcms-elements/lib/core/HAXCMSThemeWiring.js", "../../../../@polymer/iron-icons/iron-icons.js", "../../../../@polymer/iron-icons/hardware-icons.js", "../../../../@polymer/paper-icon-button/paper-icon-button.js", "../../../../@polymer/paper-styles/color.js", "../../../paper-search/lib/paper-search-bar.js", "../../../../@polymer/paper-tooltip/paper-tooltip.js", "../../../../@polymer/paper-slider/paper-slider.js", "../../../simple-toast/simple-toast.js", "../../../../@polymer/app-layout/app-layout.js", "../../../../@polymer/app-layout/app-drawer/app-drawer.js", "../../../../@polymer/app-layout/app-header/app-header.js", "../../../../@polymer/app-layout/app-toolbar/app-toolbar.js", "../../../../@polymer/app-layout/app-scroll-effects/app-scroll-effects.js", "../../../materializecss-styles/materializecss-styles.js", "../../../lrndesign-stepper/lrndesign-stepper.js", "../../../lrnsys-progress/lrnsys-progress.js", "../../../elmsln-loading/elmsln-loading.js", "../../../page-scroll-position/page-scroll-position.js", "../../../material-progress/material-progress.js", "../../../map-menu/map-menu.js", "./lrnapp-book-progress-dashboard.js"], function (_exports, _polymerElement, _renderStatus, _HAXCMSThemeWiring, _ironIcons, _hardwareIcons, _paperIconButton, _color, _paperSearchBar, _paperTooltip, _paperSlider, _simpleToast, _appLayout, _appDrawer, _appHeader, _appToolbar, _appScrollEffects, _materializecssStyles, _lrndesignStepper, _lrnsysProgress, _elmslnLoading, _pageScrollPosition, _materialProgress, _mapMenu, _lrnappBookProgressDashboard) {
  ...
  function _templateObject_99acfd20b54611e9b6ba27231b6f684a() {
    ...
    _templateObject_99acfd20b54611e9b6ba27231b6f684a = function _templateObject_99acfd20b54611e9b6ba27231b6f684a() {
      return data;
    };
  ...
  */
  ...
  function (_HAXCMSTheme) {
    babelHelpers.inherits(LrnappBook, _HAXCMSTheme);

    function LrnappBook() {
      babelHelpers.classCallCheck(this, LrnappBook);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrnappBook).apply(this, arguments));
    }

    babelHelpers.createClass(LrnappBook, [{
      key: "ready",
      ...
      value: function ready() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(LrnappBook.prototype), "ready", this).call(this);
        window.dispatchEvent(new CustomEvent("haxcms-router-manifest-subscribe", {
          detail: {
        ...
        this.$.bodyloading.hidden = true; // scroll top into view
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(LrnappBook.prototype), "connectedCallback", this).call(this);
        (0, _renderStatus.afterNextRender)(this, function () {
          this.$.progress.addEventListener("node-percent-milestone", this.testMilestone.bind(this));
          this.$.mapmenu.addEventListener("link-clicked", this._menuItemClicked.bind(this));
        });
      }
      /**
       * detached life cycle
      ...
      value: function disconnectedCallback() {
        this.$.progress.removeEventListener("node-percent-milestone", this.testMilestone.bind(this));
        this.$.mapmenu.removeEventListener("link-clicked", this._menuItemClicked.bind(this));
        babelHelpers.get(babelHelpers.getPrototypeOf(LrnappBook.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      key: "_haxcmsRouterManifestSubscribeHandler",
      value: function _haxcmsRouterManifestSubscribeHandler(e) {
        this._routerManifest = {};
        this._routerManifest = e.detail;
      }
    }, {
      key: "_menuItemClicked",
      value: function _menuItemClicked(e) {
        var i = this.manifest.items.findIndex(function (j) {
          return j.id === e.detail.id;
        });
        this.activePage = i;
      }
      /**
      ...
      key: "_fullWidthChanged",
      value: function _fullWidthChanged(newValue, oldValue) {
        this.updateStyles();
      }
      /**
      ...
      key: "progressdashboardopen",
      value: function progressdashboardopen(e) {
      ...
      key: "_computePageUpdatePath",
      value: function _computePageUpdatePath(data, sourcePath) {
      ...
      value: function _editModeChanged(newValue, oldValue) {
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          if (newValue === true) {
            this.$.currenttitle.contentEditable = true; // block scroll tracking during edit mode

            this.resetScroll = true; // notification to user
            ...
            this.$.currenttitle.contentEditable = false; // allow scrolling to take place now

            this.resetScroll = false; // we were in edit mode, now time to save for real
      ...
      key: "_activeOutlineChanged",
      value: function _activeOutlineChanged(newValue, oldValue) {
      ...
      value: function _activePageChanged(newValue, oldValue) {
        ...
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          if (babelHelpers.typeof(this.outlineItems) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && this.outlineItems.length > 0) {
          ...
          if (babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {} // ensure that scrolling percentage doesn't increase the next item
          // while active is being changed


          setTimeout(function () {
            _this2.resetScroll = false;
          }, 1000); // manage the previous page button on the UI
          ...
          if (newValue == 0) {
            ...
            if (babelHelpers.typeof(this.outlineItems) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              this.prevLabel = this.outlineItems[newValue - 1].title;
            }
          } // manage next page button on the UI


          if (babelHelpers.typeof(this.outlineItems) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue + 1 == this.outlineItems.length) {
      ...
      key: "_outlineItemsChanged",
      value: function _outlineItemsChanged(newValue, oldValue) {
        // these need set immediately
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue.length != 0) {
      ...
      key: "testMilestone",
      value: function testMilestone(e) {
      ...
      key: "_scrollChanged",
      value: function _scrollChanged(newValue, oldValue) {
        // only evaluate scroll if value is greater then previous
        if (babelHelpers.typeof(this.outlineItems) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && babelHelpers.typeof(this.outlineItems[this.activePage]) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue > this.outlineItems[this.activePage].metadata.value && !this.resetScroll) {
          // once we get 90% of the way through the material consider it finished
          if (newValue >= 75) {
            this.outlineItems[this.activePage].metadata.value = this.outlineItems[this.activePage].metadata.max;
            this.set("outlineItems." + this.activePage + ".metadata.value", this.outlineItems[this.activePage].metadata.max);
          } else {
      ...
      value: function _manifestChanged(newValue, oldValue) {
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          var outlineTitle = newValue.title; // set active to 0 because once we update the outlineItems it will try to
          ...
          this.notifyPath("bookItems.*"); // set title to match new parent title
      ...
      key: "_currentPageDataUpdated",
      value: function _currentPageDataUpdated(newValue, oldValue) {
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && babelHelpers.typeof(newValue.content) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          this.$.bodyloading.hidden = true; // manage state associated w/ edit mode if we were in edit mode previously
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_99acfd20b54611e9b6ba27231b6f684a());
      }
    }, {
      key: "tag",
      get: function get() {
