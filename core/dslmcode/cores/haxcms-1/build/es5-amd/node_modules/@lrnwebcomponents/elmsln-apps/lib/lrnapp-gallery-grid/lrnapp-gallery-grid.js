define(["exports", "../../../../lit-element/lit-element.js", "../../../../@polymer/polymer/lib/elements/custom-style.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/iron-scroll-threshold/iron-scroll-threshold.js", "../../../../@polymer/iron-image/iron-image.js", "../../../../@polymer/paper-button/paper-button.js", "../../../elmsln-loading/elmsln-loading.js", "../../../materializecss-styles/materializecss-styles.js"], function (_exports, _litElement, _customStyle, _ironAjax, _ironScrollThreshold, _ironImage, _paperButton, _elmslnLoading, _materializecssStyles) {
  ...
  function _templateObject3_6cca29b02d8511ea80ccf124101da415() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <paper-button>\n                <iron-image\n                  preload\n                  open-url=\"", "\"\n                  title=\"", "\"\n                  alt=\"", "\"\n                  src=\"", "\"\n                  author=\"", "\"\n                  comments=\"", "\"\n                  height=\"", "\"\n                  width=\"", "\"\n                ></iron-image>\n              </paper-button>\n            "]);

    _templateObject3_6cca29b02d8511ea80ccf124101da415 = function _templateObject3_6cca29b02d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function _templateObject2_6cca29b02d8511ea80ccf124101da415() {
    ...
    _templateObject2_6cca29b02d8511ea80ccf124101da415 = function _templateObject2_6cca29b02d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function _templateObject_6cca29b02d8511ea80ccf124101da415() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        paper-button {\n          padding: 0;\n          margin: 0;\n          min-width: 1rem;\n        }\n        #details {\n          opacity: 0.5;\n          position: absolute;\n          bottom: 0;\n          right: 0;\n          margin: 0 1rem 0 0;\n          background-color: white;\n          padding: 0.5em;\n        }\n        #details:hover {\n          opacity: 1;\n        }\n        #details span {\n          font-size: 0.6em;\n          font-weight: normal;\n        }\n        #details .comment-on-work {\n          font-size: 0.8em;\n          background-color: white;\n        }\n      "]);

    _templateObject_6cca29b02d8511ea80ccf124101da415 = function _templateObject_6cca29b02d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function (_LitElement) {
    babelHelpers.inherits(LrnappGalleryGrid, _LitElement);
    babelHelpers.createClass(LrnappGalleryGrid, null, [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_6cca29b02d8511ea80ccf124101da415())];
      }
    }]);
    ...
    function LrnappGalleryGrid() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrnappGalleryGrid).call(this));
      setTimeout(function () {
        _this.addEventListener("click", _this._triggerDialog.bind(babelHelpers.assertThisInitialized(_this)));
      }, 0);
      return _this;
    }
    ...
    babelHelpers.createClass(LrnappGalleryGrid, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          var notifiedProps = ["sourcePath", "submissions", "activeImage", "activeTitle", "activeUrl", "activeComments", "activeAuthor"];
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_6cca29b02d8511ea80ccf124101da415(), this.sourcePath, this.submissionsChangedEvent, this._loadMoreData, this._toArray(this.submissions.data), this._toArray(item.images).map(function (image) {
          return (0, _litElement.html)(_templateObject3_6cca29b02d8511ea80ccf124101da415(), item.url, item.title, item.title, image.src, item.author, item.comments, image.height, image.width);
        }), this.activeImage, this.activeTitle, this.activeAuthor, this.activeComments, this.activeUrl);
      }
    }, {
      key: "submissionsChangedEvent",
      value: function submissionsChangedEvent(e) {
