define(["exports", "../../../lit/index.js", "../../../lit/directives/unsafe-html.js", "../../simple-toolbar/simple-toolbar.js", "../../simple-icon/lib/simple-icon-button-lite.js", "../../simple-tooltip/simple-tooltip.js", "./simple-popover-manager.js"], function (_exports, _index, _unsafeHtml, _simpleToolbar, _simpleIconButtonLite, _simpleTooltip, _simplePopoverManager) {
  ...
  var _templateObject_a6ed3f20809211edaa2833647dc78c6c, _templateObject2_a6ed3f20809211edaa2833647dc78c6c;
  ...
  var SimpleTour = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleTour, [{
      ...
      value: function tourButtons() {
        return (0, _index.html)(_templateObject_a6ed3f20809211edaa2833647dc78c6c || (_templateObject_a6ed3f20809211edaa2833647dc78c6c = babelHelpers.taggedTemplateLiteral(["<h1 class=\"title\" slot=\"heading\">\n        ", ",\n        <span class=\"xofy\"\n          >", "/", "</span\n        >\n      </h1>\n      <simple-icon-button-lite\n        id=\"close\"\n        slot=\"heading\"\n        @click=\"", "\"\n        label=\"Stop Tour\"\n        icon=\"close\"\n      >\n      </simple-icon-button-lite>\n      <simple-icon-button-lite\n        id=\"prev\"\n        slot=\"nav\"\n        @click=\"", "\"\n        ?disabled=\"", "\"\n        label=\"Prev\"\n        title=\"Prev\"\n        icon=\"arrow-back\"\n        show-text-label\n      >\n      </simple-icon-button-lite>\n      <simple-icon-button-lite\n        id=\"next\"\n        slot=\"nav\"\n        @click=\"", "\"\n        ?disabled=\"", "\"\n        title=\"Next\"\n        label=\"Next\"\n        icon=\"arrow-forward\"\n        show-text-label\n      >\n      </simple-icon-button-lite>"])), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.stopTour.bind(this), this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext());
      }
      /**
