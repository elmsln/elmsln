define(["exports", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/lib/mobx.module.js"], function (_exports, _litElement, _haxcmsSiteStore, _mobxModule) {
  ...
  var SiteQueryMenuSlice = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SiteQueryMenuSlice, null, [{
      key: "tag",
    ...
    babelHelpers.createClass(SiteQueryMenuSlice, [{
      ...
      value: function firstUpdated(changedProperties) {
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          _this3._routerManifest = Object.assign({}, (0, _mobxModule.toJS)(_haxcmsSiteStore.store.routerManifest));
        ...
        if (!this.fixedId) {
          (0, _mobxModule.autorun)(function (reaction) {
            _this3.parent = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.activeId);
