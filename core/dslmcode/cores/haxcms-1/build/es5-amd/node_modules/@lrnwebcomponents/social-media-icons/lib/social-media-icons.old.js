define(["../../../@polymer/polymer/polymer-legacy.js", "../../../@polymer/polymer/lib/legacy/polymer.dom.js"], function (_polymerLegacy, _polymerDom) {
  ...
  (0, _polymerLegacy.Polymer)({
    ...
    _setWidthAndHeight: function _setWidthAndHeight(size) {
      return "width: " + size + "px; height: " + size + "px;";
    },
    capitalizeFirstLetter: function capitalizeFirstLetter(string) {
      return string.charAt(0).toUpperCase() + string.slice(1);
    },
    _setTitle: function _setTitle(icon) {
      return this.capitalizeFirstLetter(icon) + " Logo";
    },
    _getTitle: function _getTitle(title, icon) {
    ...
    _renderSVG: function _renderSVG() {
      var svg = (0, _polymerDom.dom)(this.$.svg);
      var path = document.createElementNS("http://www.w3.org/2000/svg", "path");
      (0, _polymerDom.dom)(path).setAttribute("fill", this.color);
      (0, _polymerDom.dom)(path).setAttribute("d", this.path);
