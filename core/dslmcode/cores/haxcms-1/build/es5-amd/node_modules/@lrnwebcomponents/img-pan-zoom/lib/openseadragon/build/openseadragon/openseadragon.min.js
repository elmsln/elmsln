...
!function (e) {
  ...
  e.isWindow = function (e) {
    return e && "object" == babelHelpers.typeof(e) && "setInterval" in e;
  };
...
!function ($) {
  $.extend = function () {
    ...
    "object" == babelHelpers.typeof(s) || OpenSeadragon.isFunction(s) || (s = {});
    ...
    for (; h < a; h++) {
      if (null !== (e = arguments[h]) || void 0 !== e) for (t in e) {
        i = s[t];
  ...
  var isIOSDevice = function isIOSDevice() {
    if ("object" != (typeof navigator === "undefined" ? "undefined" : babelHelpers.typeof(navigator))) return !1;
  ...
  $.extend($, {
    ...
    SIGNAL: "----seadragon----",
    delegate: function delegate(e, t) {
      return function () {
        var i = arguments;
        void 0 === i && (i = []);
        return t.apply(e, i);
    ...
    getElementPosition: function getElementPosition(e) {
      var t,
          i,
          n = new $.Point();
    ...
    getCssPropertyWithVendorPrefix: function getCssPropertyWithVendorPrefix(e) {
      var t = {};
    ...
    positiveModulo: function positiveModulo(e, t) {
      var i = e % t;
      i < 0 && (i += t);
      return i;
    },
    pointInElement: function pointInElement(e, t) {
      e = $.getElement(e);
    ...
    setPageScroll: function setPageScroll(e) {
    ...
    makeCenteredNode: function makeCenteredNode(e) {
      e = $.getElement(e);
    ...
    makeNeutralElement: function makeNeutralElement(e) {
    ...
    makeTransparentImage: function makeTransparentImage(e) {
    ...
    setElementOpacity: function setElementOpacity(e, t, i) {
      var n;
      e = $.getElement(e);
    ...
    setElementTouchActionNone: function setElementTouchActionNone(e) {
    ...
    indexOf: function indexOf(e, t, i) {
    ...
    createCallback: function createCallback(e, t) {
      var i,
          n = [];
    ...
    getUrlProtocol: function getUrlProtocol(e) {
      var t = e.match(/^([a-z]+:)\/\//i);
      return null === t ? window.location.protocol : t[1].toLowerCase();
    },
    createAjaxRequest: function createAjaxRequest(e) {
      var t;
    ...
    makeAjaxRequest: function makeAjaxRequest(e, t, i) {
      var n;
      var o;
      var r;
      ...
      try {
        ...
        r && (a.responseType = r);
        if (o) for (var l in o) {
          o.hasOwnProperty(l) && o[l] && a.setRequestHeader(l, o[l]);
        }
    ...
    imageFormatSupported: function imageFormatSupported(e) {
  ...
  !function () {
    ...
    for (o = 0; o < r.length; o++) {
      (n = (i = r[o]).indexOf("=")) > 0 && (URLPARAMS[i.substring(0, n)] = decodeURIComponent(i.substring(n + 1)));
    }
  ...
  var nullfunction = function nullfunction(e) {};
...
!function (e, t) {
  "function" == typeof define && define.amd ? define([], t) : "object" == (typeof module === "undefined" ? "undefined" : babelHelpers.typeof(module)) && module.exports ? module.exports = t() : e.OpenSeadragon = t();
}(this, function () {
...
!function (e) {
  ...
  e.EventSource.prototype = {
    addOnceHandler: function addOnceHandler(e, t, i, n) {
      var o = this;
      n = n || 1;
      var r = 0;
    ...
    addHandler: function addHandler(t, i, n) {
      var o = this.events[t];
      o || (this.events[t] = o = []);
    ...
    removeHandler: function removeHandler(t, i) {
      var n,
          o = this.events[t],
          r = [];
    ...
    removeAllHandlers: function removeAllHandlers(e) {
      if (e) this.events[e] = [];else for (var t in this.events) {
        this.events[t] = [];
      }
    },
...
!function (e) {
  ...
  e.MouseTracker = function (n) {
    ...
    i[this.hash] = {
      ...
      MozMousePixelScroll: function MozMousePixelScroll(e) {
        p(r, e);
      },
      ...
      mouseupcaptured: function mouseupcaptured(t) {
        !function (t, i) {
          y(t, i);
          e.stopEvent(i);
        }(r, t);
      ...
      mousemovecaptured: function mousemovecaptured(t) {
        !function (t, i) {
          T(t, i);
          e.stopEvent(i);
        }(r, t);
      ...
      touchendcaptured: function touchendcaptured(t) {
        !function (t, i) {
          S(t, i);
          e.stopEvent(i);
        }(r, t);
      ...
      touchmovecaptured: function touchmovecaptured(t) {
        !function (t, i) {
          E(t, i);
          e.stopEvent(i);
        }(r, t);
      ...
      MSPointerOver: function MSPointerOver(e) {
        P(r, e);
      },
      pointerout: function pointerout(e) {
        R(r, e);
      },
      MSPointerOut: function MSPointerOut(e) {
        R(r, e);
      },
      pointerdown: function pointerdown(e) {
        _(r, e);
      },
      MSPointerDown: function MSPointerDown(e) {
        _(r, e);
      },
      pointerup: function pointerup(e) {
        C(r, e);
      },
      MSPointerUp: function MSPointerUp(e) {
        C(r, e);
      },
      pointermove: function pointermove(e) {
        O(r, e);
      },
      MSPointerMove: function MSPointerMove(e) {
        O(r, e);
      },
      pointercancel: function pointercancel(e) {
        k(r, e);
      },
      MSPointerCancel: function MSPointerCancel(e) {
        k(r, e);
      },
      pointerupcaptured: function pointerupcaptured(t) {
        !function (t, i) {
          t.getActivePointersListByType(l(i)).getById(i.pointerId) && b(t, i);
          e.stopEvent(i);
        }(r, t);
      },
      pointermovecaptured: function pointermovecaptured(t) {
        !function (t, i) {
  ...
  e.MouseTracker.prototype = {
    ...
    setTracking: function setTracking(t) {
      t ? function (t) {
        var o,
            r,
            s = i[t.hash];
    ...
    getActivePointersListsExceptType: function getActivePointersListsExceptType(e) {
      var t = i[this.hash];
      var n = [];
    ...
    getActivePointersListByType: function getActivePointersListByType(t) {
      var n,
          o,
          r = i[this.hash],
    ...
    getActivePointerCount: function getActivePointerCount() {
      ...
      for (e = 0; e < n; e++) {
        o += t.activePointersLists[e].getLength();
      }
  ...
  e.MouseTracker.gesturePointVelocityTracker = function () {
    ...
    return {
      addPoint: function addPoint(s, a) {
        var l = o(s, a);
        t.push({
          guid: l,
          gPoint: a,
      ...
      removePoint: function removePoint(e, n) {
        var r,
            s = o(e, n),
            a = t.length;
  ...
  e.MouseTracker.GesturePointList.prototype = {
    ...
    getByIndex: function getByIndex(e) {
    ...
    getPrimary: function getPrimary(e) {
      var t,
          i = this._gPoints.length;
...
!function (e) {
  ...
  e.ControlDock.prototype = {
    addControl: function addControl(i, n) {
      var o = null;
    ...
    setControlsEnabled: function setControlsEnabled(e) {
      var t;
...
!function (e) {
  ...
  e.extend(e.Viewer.prototype, e.EventSource.prototype, e.ControlDock.prototype, {
        ...
        if (t.length) {
          ...
          var h = function h() {
            if (s + a === r) if (s) {
              ...
              if (n.overlays && !n.preserveOverlays) for (var i = 0; i < n.overlays.length; i++) {
          ...
          var c = function c(t) {
            ...
            t.success = function (e) {
              s++;
              if (t.tileSource.overlays) for (var o = 0; o < t.tileSource.overlays.length; o++) {
    ...
    destroy: function destroy() {
      if (t[this.hash]) {
        ...
        if (this.element) for (; this.element.firstChild;) {
    ...
    setMouseNavEnabled: function setMouseNavEnabled(e) {
    ...
    areControlsEnabled: function areControlsEnabled() {
      ...
      for (e = 0; e < this.controls.length; e++) {
        t = t && this.controls[e].isVisibile();
      }
    ...
    setDebugMode: function setDebugMode(e) {
    ...
    setFullPage: function setFullPage(i) {
      var n,
          o,
          r = document.body,
          s = r.style,
    ...
    addTiledImage: function addTiledImage(t) {
    ...
    addSimpleImage: function addSimpleImage(t) {
    ...
    getLayerAtLevel: function getLayerAtLevel(t) {
    ...
    getLevelOfLayer: function getLevelOfLayer(t) {
    ...
    setLayerLevel: function setLayerLevel(t, i) {
    ...
    addOverlay: function addOverlay(t, i, n, s) {
      var a;
    ...
    updateOverlay: function updateOverlay(i, n, o) {
      var s;
      i = e.getElement(i);
    ...
    removeOverlay: function removeOverlay(i) {
      var n;
      i = e.getElement(i);
    ...
    getOverlayById: function getOverlayById(t) {
      var i;
      t = e.getElement(t);
      return (i = r(this.currentOverlays, t)) >= 0 ? this.currentOverlays[i] : null;
    },
    _updateSequenceButtons: function _updateSequenceButtons(e) {
    ...
    _showMessage: function _showMessage(t) {
      this._hideMessage();
    ...
    gestureSettingsByDeviceType: function gestureSettingsByDeviceType(e) {
      switch (e) {
        case "mouse":
  ...
  function o(t, i) {
    if (babelHelpers.instanceof(i, e.Overlay)) return i;
    var n = null;
  ...
  function h(e) {
    ...
    for (t = e.controls.length - 1; t >= 0; t--) {
...
!function (e) {
  ...
  e.extend(e.Navigator.prototype, e.EventSource.prototype, e.Viewer.prototype, {
    ...
    setFlip: function setFlip(e) {
      this.viewport.setFlip(e);
      this.setDisplayTransform(this.viewer.viewport.getFlip() ? "scale(-1,1)" : "scale(1,1)");
      return this;
    },
    setDisplayTransform: function setDisplayTransform(e) {
    ...
    _getMatchingItem: function _getMatchingItem(e) {
    ...
    _matchBounds: function _matchBounds(e, t, i) {
    ...
    _matchOpacity: function _matchOpacity(e, t) {
      e.setOpacity(t.opacity);
    },
    _matchCompositeOperation: function _matchCompositeOperation(e, t) {
...
!function (e) {
  ...
  e.extend(e, {
    getString: function getString(i) {
      var n,
          o = i.split("."),
          r = null,
          s = arguments,
    ...
    setString: function setString(e, i) {
      var n,
          o = e.split("."),
          r = t;
...
!function (e) {
  ...
  e.Point.prototype = {
    ...
    squaredDistanceTo: function squaredDistanceTo(e) {
    ...
    equals: function equals(t) {
      return babelHelpers.instanceof(t, e.Point) && this.x === t.x && this.y === t.y;
    },
...
!function (e) {
  e.TileSource = function (t, i, n, o, r, s) {
    ...
    e.EventSource.call(this);
    e.extend(!0, this, l);
    if (!this.success) for (h = 0; h < arguments.length; h++) {
  ...
  e.TileSource.prototype = {
    getTileSize: function getTileSize(t) {
    ...
    getNumTiles: function getNumTiles(t) {
    ...
    getPixelRatio: function getPixelRatio(t) {
    ...
    getTileAtPoint: function getTileAtPoint(t, i) {
    ...
    getTileBounds: function getTileBounds(t, i, n, o) {
    ...
    supports: function supports(e, t) {
      return !1;
    },
    configure: function configure(e, t) {
      throw new Error("Method not implemented.");
    },
    getTileUrl: function getTileUrl(e, t, i) {
      throw new Error("Method not implemented.");
    },
    getTileAjaxHeaders: function getTileAjaxHeaders(e, t, i) {
      return {};
    },
    tileExists: function tileExists(e, t, i) {
...
!function (e) {
  e.DziTileSource = function (t, i, n, o, r, s, a, l, h) {
    ...
    if (this.displayRects) for (c = this.displayRects.length - 1; c >= 0; c--) {
  ...
  e.extend(e.DziTileSource.prototype, e.TileSource.prototype, {
    ...
    configure: function configure(i, n) {
      var o;
      o = e.isPlainObject(i) ? t(this, i) : function (i, n) {
        ...
        if ("Image" == c) try {
          ...
          throw babelHelpers.instanceof(t, Error) ? t : new Error(e.getString("Errors.Dzi"));
        } else {
...
!function (e) {
  ...
  e.extend(e.IIIFTileSource.prototype, e.TileSource.prototype, {
    ...
    configure: function configure(t, i) {
      ...
      var n = function (t) {
        ...
        if ("info" == i.tagName) try {
          !function t(i, n, o) {
            ...
            } else if (1 == i.nodeType) for (r = 0; r < i.childNodes.length; r++) {
              t(i.childNodes[r], n, i.nodeName);
            }
          }(i, n = {});
          return n;
        } catch (t) {
          throw babelHelpers.instanceof(t, Error) ? t : new Error(e.getString("Errors.IIIF"));
        }
    ...
    getTileWidth: function getTileWidth(t) {
    ...
    getTileHeight: function getTileHeight(t) {
    ...
    getLevelScale: function getLevelScale(t) {
...
!function (e) {
  ...
  e.extend(e.ZoomifyTileSource.prototype, e.TileSource.prototype, {
    _getGridSize: function _getGridSize(e, t, i) {
      return {
        x: Math.ceil(e / i),
        y: Math.ceil(t / i)
      };
    },
    _calculateAbsoluteTileNumber: function _calculateAbsoluteTileNumber(e, t, i) {
      var n = 0;
      var o = {};
  ...
  e.LegacyTileSource = function (t) {
    ...
    i.levels = function (t) {
      ...
      for (n = 0; n < t.length; n++) {
        (i = t[n]).height && i.width && i.url ? o.push({
          url: i.url,
    ...
    configure: function configure(i, n) {
      return e.isPlainObject(i) ? t(this, i) : function (i, n) {
        ...
        if ("image" == a) try {
          ...
          throw babelHelpers.instanceof(e, Error) ? e : new Error("Unknown error parsing Legacy Image Pyramid XML.");
        } else {
...
!function (e) {
  ...
  e.extend(e.ImageTileSource.prototype, e.TileSource.prototype, {
    ...
    getContext2D: function getContext2D(e, t, i) {
      var n = null;
...
!function (e) {
  ...
  e.Button = function (t) {
    ...
    this.tracker = new e.MouseTracker({
      ...
      clickTimeThreshold: this.clickTimeThreshold,
      clickDistThreshold: this.clickDistThreshold,
      enterHandler: function enterHandler(t) {
      ...
      exitHandler: function exitHandler(t) {
      ...
      pressHandler: function pressHandler(t) {
        i(o, e.ButtonState.DOWN);
        o.raiseEvent("press", {
          originalEvent: t.originalEvent
        });
      },
      releaseHandler: function releaseHandler(t) {
  ...
  e.ButtonGroup = function (t) {
    ...
    this.tracker = new e.MouseTracker({
      ...
      exitHandler: function exitHandler(e) {
        var t;
        if (!e.insideElementPressed) for (t = 0; t < o.buttons.length; t++) {
...
!function (e) {
  ...
  e.Rect.prototype = {
    ...
    equals: function equals(t) {
      return babelHelpers.instanceof(t, e.Rect) && this.x === t.x && this.y === t.y && this.width === t.width && this.height === t.height && this.degrees === t.degrees;
    },
    times: function times(t) {
    ...
    containsPoint: function containsPoint(e, t) {
      t = t || 0;
...
!function (e) {
  ...
  e.extend(e.ReferenceStrip.prototype, e.EventSource.prototype, e.Viewer.prototype, {
    ...
    destroy: function destroy() {
      if (this.miniViewers) for (var e in this.miniViewers) {
...
!function (e) {
  e.Spring = function (t) {
    var i = arguments;
    "object" != babelHelpers.typeof(t) && (t = {
  ...
  e.Spring.prototype = {
    ...
    setExponential: function setExponential(t) {
      this._exponential = t;
...
!function (e) {
  ...
  e.Tile.prototype = {
    ...
    drawCanvas: function drawCanvas(t, i, n, o) {
      var r,
      ...
      if (this.context2D || this.cacheImageRecord) {
        ...
        if (this.loaded && r) {
          ...
          babelHelpers.instanceof(o, e.Point) && (s = s.plus(o));
    ...
    getTranslationForEdgeSmoothing: function getTranslationForEdgeSmoothing(t, i, n) {
...
!function (e) {
  ...
  e.Overlay.prototype = {
    _init: function _init(t) {
      ...
      if (babelHelpers.instanceof(this.location, e.Rect)) {
    ...
    drawHTML: function drawHTML(t, i) {
      var n = this.element;
    ...
    _getOverlayPositionAndSize: function _getOverlayPositionAndSize(t) {
    ...
    _getSizeInPixels: function _getSizeInPixels(t) {
      var i = this.size.x;
      var n = this.size.y;
    ...
    _getBoundingBox: function _getBoundingBox(e, t) {
      var i = this._getPlacementPoint(e);

      return e.rotate(t, i).getBoundingBox();
    },
    _getPlacementPoint: function _getPlacementPoint(t) {
    ...
    _adjustBoundsForRotation: function _adjustBoundsForRotation(t, i) {
...
!function (e) {
  ...
  e.Drawer.prototype = {
    ...
    setOpacity: function setOpacity(t) {
      ...
      for (var n = 0; n < i.getItemCount(); n++) {
    ...
    viewportToDrawerRectangle: function viewportToDrawerRectangle(t) {
    ...
    drawTile: function drawTile(t, i, n, o, r) {
    ...
    _getContext: function _getContext(e) {
      var t = this.context;
    ...
    saveContext: function saveContext(e) {
      this.useCanvas && this._getContext(e).save();
    },
    restoreContext: function restoreContext(e) {
    ...
    drawRectangle: function drawRectangle(e, t, i) {
      if (this.useCanvas) {
    ...
    blendSketch: function blendSketch(t, i, n, o) {
      var r = t;
      e.isPlainObject(r) || (r = {
        opacity: t,
        scale: i,
      ...
      if (this.useCanvas && this.sketchCanvas) {
        ...
        if (s) {
          ...
          i = r.scale || 1;
          var a = babelHelpers.instanceof(n = r.translate, e.Point) ? n : new e.Point(0, 0);
          var l = 0;
          var h = 0;
    ...
    drawDebugInfo: function drawDebugInfo(t, i, n, o) {
      if (this.useCanvas) {
    ...
    debugRect: function debugRect(t) {
      if (this.useCanvas) {
        var i = this.context;
        i.save();
    ...
    getCanvasSize: function getCanvasSize(t) {
    ...
    _offsetForRotation: function _offsetForRotation(t) {
    ...
    _restoreRotationChanges: function _restoreRotationChanges(e) {
...
!function (e) {
  e.Viewport = function (t) {
    var i = arguments;
    i.length && babelHelpers.instanceof(i[0], e.Point) && (t = {
      containerSize: i[0],
      contentSize: i[1],
      config: i[2]
    });
  ...
  e.Viewport.prototype = {
    resetContentSize: function resetContentSize(t) {
      e.console.assert(t, "[Viewport.resetContentSize] contentSize is required");
      e.console.assert(babelHelpers.instanceof(t, e.Point), "[Viewport.resetContentSize] contentSize must be an OpenSeadragon.Point");
    ...
    setHomeBounds: function setHomeBounds(t, i) {
    ...
    _setContentBounds: function _setContentBounds(t, i) {
      e.console.assert(t, "[Viewport._setContentBounds] bounds is required");
      e.console.assert(babelHelpers.instanceof(t, e.Rect), "[Viewport._setContentBounds] bounds must be an OpenSeadragon.Rect");
    ...
    setMargins: function setMargins(t) {
    ...
    getZoom: function getZoom(e) {
      return e ? this.zoomSpring.current.value : this.zoomSpring.target.value;
    },
    _applyZoomConstraints: function _applyZoomConstraints(e) {
      return Math.max(Math.min(e, this.getMaxZoom()), this.getMinZoom());
    },
    _applyBoundaryConstraints: function _applyBoundaryConstraints(t) {
    ...
    _raiseConstraintsEvent: function _raiseConstraintsEvent(e) {
      this.viewer && this.viewer.raiseEvent("constrain", {
        immediately: e
      });
    },
    applyConstraints: function applyConstraints(e) {
      var t = this.getZoom();
    ...
    _fitBounds: function _fitBounds(t, i) {
    ...
    fitBounds: function fitBounds(e, t) {
      return this._fitBounds(e, {
        immediately: t,
        constraints: !1
      });
    },
    fitBoundsWithConstraints: function fitBoundsWithConstraints(e, t) {
      return this._fitBounds(e, {
        immediately: t,
        constraints: !0
      });
    },
    fitVertically: function fitVertically(t) {
    ...
    zoomBy: function zoomBy(e, t, i) {
      return this.zoomTo(this.zoomSpring.target.value * e, t, i);
    },
    zoomTo: function zoomTo(t, i, n) {
      var o = this;
      this.zoomPoint = babelHelpers.instanceof(i, e.Point) && !isNaN(i.x) && !isNaN(i.y) ? i : null;
    ...
    _adjustCenterSpringsForZoomPoint: function _adjustCenterSpringsForZoomPoint(e) {
      if (this.zoomPoint) {
    ...
    deltaPixelsFromPointsNoRotate: function deltaPixelsFromPointsNoRotate(e, t) {
      return e.times(this._containerInnerSize.x * this.getZoom(t));
    },
    deltaPixelsFromPoints: function deltaPixelsFromPoints(e, t) {
      return this.deltaPixelsFromPointsNoRotate(e.rotate(this.getRotation()), t);
    },
    deltaPointsFromPixelsNoRotate: function deltaPointsFromPixelsNoRotate(e, t) {
      return e.divide(this._containerInnerSize.x * this.getZoom(t));
    },
    deltaPointsFromPixels: function deltaPointsFromPixels(e, t) {
      return this.deltaPointsFromPixelsNoRotate(e, t).rotate(-this.getRotation());
    },
    pixelFromPointNoRotate: function pixelFromPointNoRotate(e, t) {
      return this._pixelFromPointNoRotate(e, this.getBoundsNoRotate(t));
    },
    pixelFromPoint: function pixelFromPoint(e, t) {
      return this._pixelFromPoint(e, this.getBoundsNoRotate(t));
    },
    _pixelFromPointNoRotate: function _pixelFromPointNoRotate(t, i) {
    ...
    _pixelFromPoint: function _pixelFromPoint(e, t) {
      return this._pixelFromPointNoRotate(e.rotate(this.getRotation(), this.getCenter(!0)), t);
    },
    pointFromPixelNoRotate: function pointFromPixelNoRotate(t, i) {
    ...
    pointFromPixel: function pointFromPixel(e, t) {
      return this.pointFromPixelNoRotate(e, t).rotate(-this.getRotation(), this.getCenter(!0));
    },
    _viewportToImageDelta: function _viewportToImageDelta(t, i) {
    ...
    viewportToImageCoordinates: function viewportToImageCoordinates(t, i) {
      if (babelHelpers.instanceof(t, e.Point)) return this.viewportToImageCoordinates(t.x, t.y);
    ...
    _imageToViewportDelta: function _imageToViewportDelta(t, i) {
      var n = this._contentBoundsNoRotate.width;
      return new e.Point(t / this._contentSizeNoRotate.x * n, i / this._contentSizeNoRotate.x * n);
    },
    imageToViewportCoordinates: function imageToViewportCoordinates(t, i) {
      if (babelHelpers.instanceof(t, e.Point)) return this.imageToViewportCoordinates(t.x, t.y);
    ...
    imageToViewportRectangle: function imageToViewportRectangle(t, i, n, o) {
      var r = t;
      babelHelpers.instanceof(r, e.Rect) || (r = new e.Rect(t, i, n, o));
    ...
    viewportToImageRectangle: function viewportToImageRectangle(t, i, n, o) {
      var r = t;
      babelHelpers.instanceof(r, e.Rect) || (r = new e.Rect(t, i, n, o));
    ...
    viewerElementToImageCoordinates: function viewerElementToImageCoordinates(e) {
      var t = this.pointFromPixel(e, !0);
      return this.viewportToImageCoordinates(t);
    },
    imageToViewerElementCoordinates: function imageToViewerElementCoordinates(e) {
      var t = this.imageToViewportCoordinates(e);
      return this.pixelFromPoint(t, !0);
    },
    windowToImageCoordinates: function windowToImageCoordinates(t) {
    ...
    imageToWindowCoordinates: function imageToWindowCoordinates(t) {
    ...
    viewerElementToViewportCoordinates: function viewerElementToViewportCoordinates(e) {
      return this.pointFromPixel(e, !0);
    },
    viewportToViewerElementCoordinates: function viewportToViewerElementCoordinates(e) {
      return this.pixelFromPoint(e, !0);
    },
    viewerElementToViewportRectangle: function viewerElementToViewportRectangle(t) {
    ...
    viewportToViewerElementRectangle: function viewportToViewerElementRectangle(t) {
    ...
    windowToViewportCoordinates: function windowToViewportCoordinates(t) {
    ...
    viewportToWindowCoordinates: function viewportToWindowCoordinates(t) {
    ...
    viewportToImageZoom: function viewportToImageZoom(t) {
      if (this.viewer) {
    ...
    imageToViewportZoom: function imageToViewportZoom(t) {
      if (this.viewer) {
        var i = this.viewer.world.getItemCount();
...
!function (e) {
  e.TiledImage = function (t) {
    ...
    e.console.assert(!t.clip || babelHelpers.instanceof(t.clip, e.Rect), "[TiledImage] options.clip must be an OpenSeadragon.Rect if present");
    e.EventSource.call(this);
    ...
    babelHelpers.instanceof(t.clip, e.Rect) && (this._clip = t.clip.clone());
    delete t.clip;
    var n = t.x || 0;
    delete t.x;
    var o = t.y || 0;
  ...
  e.extend(e.TiledImage.prototype, e.EventSource.prototype, {
    ...
    _setFullyLoaded: function _setFullyLoaded(e) {
    ...
    getClippedBounds: function getClippedBounds(t) {
    ...
    _viewportToImageDelta: function _viewportToImageDelta(t, i, n) {
    ...
    viewportToImageCoordinates: function viewportToImageCoordinates(t, i, n) {
      var o;

      if (babelHelpers.instanceof(t, e.Point)) {
        n = i;
        o = t;
    ...
    _imageToViewportDelta: function _imageToViewportDelta(t, i, n) {
      var o = n ? this._scaleSpring.current.value : this._scaleSpring.target.value;
      return new e.Point(t / this.source.dimensions.x * o, i / this.source.dimensions.y / this.contentAspectX * o);
    },
    imageToViewportCoordinates: function imageToViewportCoordinates(t, i, n) {
      if (babelHelpers.instanceof(t, e.Point)) {
        n = i;
        i = t.y;
        t = t.x;
    ...
    imageToViewportRectangle: function imageToViewportRectangle(t, i, n, o, r) {
      var s = t;
      babelHelpers.instanceof(s, e.Rect) ? r = i : s = new e.Rect(t, i, n, o);
    ...
    viewportToImageRectangle: function viewportToImageRectangle(t, i, n, o, r) {
      var s = t;
      babelHelpers.instanceof(t, e.Rect) ? r = i : s = new e.Rect(t, i, n, o);
    ...
    setClip: function setClip(t) {
      e.console.assert(!t || babelHelpers.instanceof(t, e.Rect), "[TiledImage.setClip] newClip must be an OpenSeadragon.Rect or null");
      babelHelpers.instanceof(t, e.Rect) ? this._clip = t.clone() : this._clip = null;
      this._needsDraw = !0;
    ...
    setPreload: function setPreload(e) {
      this._preload = !!e;
      this._needsDraw = !0;
    },
    ...
    setRotation: function setRotation(e, t) {
    ...
    _getRotationPoint: function _getRotationPoint(e) {
      return this.getBoundsNoRotate(e).getCenter();
    },
    getCompositeOperation: function getCompositeOperation() {
      return this.compositeOperation;
    },
    setCompositeOperation: function setCompositeOperation(e) {
    ...
    _setScale: function _setScale(e, t) {
      ...
      if (c && !c.context2D) {
        !function (t, i, o) {
          ...
          t._imageLoader.addJob({
            ...
            ajaxWithCredentials: t.ajaxWithCredentials,
            callback: function callback(r, s, a) {
    ...
    _getCornerTiles: function _getCornerTiles(t, i, n) {
      var o;
      var r;
...
!function (e) {
  var t = function t(_t) {
    e.console.assert(_t, "[ImageRecord] options is required");
    e.console.assert(_t.image, "[ImageRecord] options.image is required");
    this._image = _t.image;
    this._tiles = [];
  };
  ...
  t.prototype = {
    ...
    setRenderedContext: function setRenderedContext(t) {
  ...
  e.TileCache.prototype = {
    ...
    cacheTile: function cacheTile(i) {
      ...
      if (this._imagesLoadedCount > this._maxImageCacheCount) {
        ...
        for (var m = this._tilesLoaded.length - 1; m >= 0; m--) {
          if (!((h = (g = this._tilesLoaded[m]).tile).level <= n || h.beingDrawn)) if (s) {
            d = h.lastTouchTime;
            c = s.lastTouchTime;
            p = h.level;
            u = s.level;
    ...
    clearTilesFor: function clearTilesFor(t) {
...
!function (e) {
  ...
  e.extend(e.World.prototype, e.EventSource.prototype, {
    addItem: function addItem(t, i) {
      e.console.assert(t, "[World.addItem] item is required");
      e.console.assert(babelHelpers.instanceof(t, e.TiledImage), "[World.addItem] only TiledImages supported at this time");
    ...
    getIndexOfItem: function getIndexOfItem(t) {
    ...
    setItemIndex: function setItemIndex(t, i) {
    ...
    setAutoRefigureSizes: function setAutoRefigureSizes(e) {
    ...
    _raiseRemoveItem: function _raiseRemoveItem(e) {
