define(["exports", "../../../../../lit/index.js", "../haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js"], function (_exports, _index, _haxcmsSiteStore, _mobxEsm) {
  ...
  var _templateObject_a7dd12701bd511ecb06de58eee077492;
    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, null, [{
        ...
        get: function get() {
          ...
          return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject_a7dd12701bd511ecb06de58eee077492 || (_templateObject_a7dd12701bd511ecb06de58eee077492 = babelHelpers.taggedTemplateLiteral(["\n          [part=\"edit-mode-active\"] {\n            pointer-events: var(\n              --haxcms-theme-parts-edit-mode-active-pointer-events,\n              none\n            );\n            opacity: var(--haxcms-theme-parts-edit-mode-active-opacity, 0.5);\n            filter: var(\n              --haxcms-theme-parts-edit-mode-active-filter,\n              blur(1px)\n            );\n          }\n        "])))]);
        }
      }, {
        key: "properties",
        get: function get() {
