...
function make_xlsx_lib(e) {
  ...
  function T(e) {
    ...
    if (babelHelpers.instanceof(e, ArrayBuffer)) return T(new Uint8Array(e));
  ...
  var R = function Vl(e) {
    ...
    function A(e, r) {
      switch (babelHelpers.typeof(e)) {
        ...
        case "object":
          if (e == null) return "";
          if (babelHelpers.instanceof(e, Date)) return B(14, _(e, r && r.date1904), r);
      }
    ...
    var O = function U() {
      ...
      function x(e, h, _) {
        if (e.charCodeAt(0) === 40 && !h.match(p)) {
          var S = h.replace(/\( */, "").replace(/ \)/, "").replace(/\)/, "");
          if (_ >= 0) return x("n", S, _);
          return "(" + x("n", S, -_) + ")";
        }
        ...
        if (A = h.match(d)) {
          C = g(_, A[1].length).replace(/^([^\.]+)$/, "$1." + v(A[1])).replace(/\.$/, "." + v(A[1])).replace(/\.(\d*)$/, function (e, r) {
        ...
        if (A = h.match(/^#,##0\.([#0]*0)$/)) {
          return _ < 0 ? "-" + x(e, h, -_) : T("" + (Math.floor(_) + k(_, A[1].length))) + "." + a(w(_, A[1].length), A[1].length);
        }

        if (A = h.match(/^#,#*,#0/)) return x(e, h.replace(/^#,#*,/, ""), _);

        if (A = h.match(/^([0#]+)(\\?-([0#]+))+$/)) {
          C = r(x(e, h.replace(/[\\-]/g, ""), _));
          E = 0;
        ...
        if (A = h.match(/^([#0?]+)\.([#0]+)$/)) {
          C = "" + _.toFixed(Math.min(A[2].length, 10)).replace(/([^0])0+$/, "$1");
          E = C.indexOf(".");
          var R = h.indexOf(".") - E,
        ...
        if (A = h.match(/^00,000\.([#0]*0)$/)) {
          E = w(_, A[1].length);
          return _ < 0 ? "-" + x(e, h, -_) : T(y(_)).replace(/^\d,\d{3}$/, "0$&").replace(/^\d*$/, function (e) {
      ...
      if (y.length > 0) {
        ...
        if (E === n.length && C.indexOf("E") === -1) {
          ...
          for (s = E; s >= 0; --s) {
            ...
            for (; u >= 0; --u) {
              if (x >= 0 && (n[s].v.charAt(u) === "0" || n[s].v.charAt(u) === "#")) _ = C.charAt(x--) + _;
            }
  ...
  var j = function Xl() {
    ...
    function y(e, r) {
      return new Date((Br(e, r + 4) / 1e7 * Math.pow(2, 32) + Br(e, r) / 1e7 - 11644473600) * 1e3);
    }
    ...
    var B = "00000000000000000000000000000000";
    var W = {
      MAXREGSECT: -6,
      DIFSECT: -4,
      FATSECT: -3,
    ...
    function J(e) {
      return X ? X.deflateRawSync(e) : he(e);
    }
  ...
  if (typeof require !== "undefined" && typeof module !== "undefined" && typeof W === "undefined") {
    module.exports = j;
  }
  ...
  var Le = function () {
    ...
    return function t(a) {
      ...
      if (i == -1) return n.replace(e, function (e, r) {
        return Pe[e] || String.fromCharCode(parseInt(r, e.indexOf("x") > -1 ? 16 : 10)) || e;
  ...
  Nr = Rr = function Rr(e, r) {
    return dr(e, r);
  };

  var Pr = function Kl(e) {
    ...
    switch (t) {
      case "dbcs":
        ...
        if (w && Buffer.isBuffer(this)) a = this.slice(this.l, this.l + 2 * e).toString("utf16le");else for (c = 0; c < e; ++c) {
          a += String.fromCharCode(Lr(this, f));
          f += 2;
        }
        e *= 2;
        break;
      ...
      case "dbcs-cont":
        ...
        for (c = 0; c < e; ++c) {
          if (this.lens && this.lens.indexOf(f) !== -1) {
            l = Ir(this, f);
            this.l = f + 1;
            o = Ur.call(this, e - c, l ? "dbcs-cont" : "sbcs-cont");
            return s.join("") + o;
          }
  ...
  (function () {
    for (var e in zt) {
      if (Object.prototype.hasOwnProperty.call(zt, e)) It[e] = Lt[e] = zt[e];
    }
  })();
  ...
  var ha = or("cp:coreProperties", null, {
  ...
  function pa(e, r) {
    ...
    if (e) {
      if (e.CreatedDate != null) da("dcterms:created", typeof e.CreatedDate === "string" ? e.CreatedDate : cr(e.CreatedDate, t.WTF), {
        "xsi:type": "dcterms:W3CDTF"
      }, a, n);
      if (e.ModifiedDate != null) da("dcterms:modified", typeof e.ModifiedDate === "string" ? e.ModifiedDate : cr(e.ModifiedDate, t.WTF), {
        "xsi:type": "dcterms:W3CDTF"
      }, a, n);
    }
  ...
  function Sa(e) {
    ...
    Y(e).forEach(function a(n) {
      ++t;
      r[r.length] = or("property", fr(e[n], true), {
  ...
  var Ca = function () {
    ...
    function n(r, t) {
      ...
      while (i == 2 ? n.l < n.length && n[n.l] != 13 : n.l < m) {
        p = {};
      ...
      if (n[n.l] !== 13) n.l = f - 1;else if (i == 2) n.l = 521;
      ...
      while (c-- > 0) {
        ...
        for (w = 0; w != d.length; ++w) {
          ...
          switch (d[w].type) {
            case "C":
              a[g][w] = cptable.utils.decode(h, k);
              a[g][w] = a[g][w].trim();
              break;
    ...
    function c(e, a) {
      ...
      for (u = 0; u < c.length; ++u) {
        ...
        if (typeof c[u] !== "string") throw new Error("DBF Invalid column name " + c[u] + " |" + babelHelpers.typeof(c[u]) + "|");
      ...
      for (u = 0; u <= m.e.c - m.s.c; ++u) {
        ...
        for (h = 0; h < g.length; ++h) {
          switch (babelHelpers.typeof(g[h])) {
            case "number":
              w = "B";
              break;
            ...
            case "object":
              w = babelHelpers.instanceof(g[h], Date) ? "D" : "C";
              break;
      ...
      for (u = 0; u < f.length; ++u) {
        ...
        for (h = 0; h < c.length; ++h) {
          ...
          switch (v[h]) {
            case "L":
              S._W(1, f[u][h] == null ? 63 : f[u][h] ? 84 : 70);
            ...
            case "D":
              if (!f[u][h]) S._W(8, "00000000", "sbcs");else {
                S._W(4, ("0000" + f[u][h].getFullYear()).slice(-4), "sbcs");

                S._W(2, ("00" + (f[u][h].getMonth() + 1)).slice(-2), "sbcs");

                S._W(2, ("00" + f[u][h].getDate()).slice(-2), "sbcs");
              }
              break;
  ...
  var Ta = function () {
    ...
    function i(e, r) {
      ...
      var f = 0,
          ...
          p = 0;
      e = e.replace(/\r\n/gm, "\n");
      var m = t.dateNF != null ? z(t.dateNF) : null;
      ...
      function g() {
        ...
        if (r.length === 0) a.t = "z";else if (t.raw) {
          ...
          if (t.cellText !== false) a.w = N.format(a.z, babelHelpers.instanceof(a.v, Date) ? ee(a.v) : a.v);
    ...
    function l(e, r) {
      var t = "",
          a = r.type == "string" ? [0, 0, 0, 0] : ul(e, r);
  ...
  function La(e, r) {
    ...
    if (e.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
      ...
      a.r = Ye(e);
      a.t = Le(Ye((e.replace(Ia, "").match(Ra) || []).join("").replace(Oe, "")));
      if (t) a.h = Na(Ma(a.r));
    }
  ...
  function On(e, r, t) {
    r.themeElements = {};
    var a;
    [["clrScheme", En, Sn], ["fontScheme", Fn, Cn], ["fmtScheme", Tn, An]].forEach(function (n) {
  ...
  function ei(e, r) {
    return e.replace(Zn, function (e, t, a, n, i, s) {
      return t + (a == "$" ? a + n : ct(ot(n) + r.c)) + (i == "$" ? i + s : it(nt(s) + r.r));
    });
  }
  ...
  function _i(e, r, t, a, n, i, s) {
    ...
    if (u) $i(u[1], l, r, o, i, s);
    var w = f.match(wi);
    if (w) l["!autofilter"] = Pi(w[0]);
    var k = [];
    var y = f.match(pi);
    ...
    if (!l["!ref"] && o.e.c >= o.s.c && o.e.r >= o.s.r) l["!ref"] = vt(o);
  ...
  var $i = function () {
    ...
    return function l(o, c, f, u, h, d) {
      ...
      for (var W = o.split(r), $ = 0, U = W.length; $ != U; ++$) {
        ...
        for (p = 0; p < j; ++p) {
          if (m.charCodeAt(p) === 62) break;
        }

        ++p;
        _ = Ne(m.slice(0, p), true);
        S = _.r != null ? parseInt(_.r, 10) : S + 1;
        C = -1;
        if (f.sheetRows && f.sheetRows < S) continue;
          ...
          if (f.cellFormula) {
            if ((g = y.match(s)) != null && g[1] !== "") {
              ...
              if (g[0].indexOf('t="array"') > -1) {
                ...
                var V = Le(Ye(g[1]));
                if (!f.xlfn) V = ai(V);
                R[parseInt(E.si, 10)] = [E, V, _.r];
              }
            } else if (g = y.match(/<f[^>]*\/>/)) {
              E = Ne(g[0]);
              if (R[E.si]) x.f = ri(R[E.si][1], R[E.si][2], _.r);
            }
  ...
  function Hi(e, r, t, a) {
    ...
    if (o["!cols"] != null && o["!cols"].length > 0) n[n.length] = Ri(o, o["!cols"]);
    ...
    if (o["!merges"] != null && o["!merges"].length > 0) n[n.length] = Si(o["!merges"]);
    var h = -1,
        d,
        p = -1;
  ...
  function hs(e, r) {
    ...
    e.replace(Oe, function l(o, c) {
      ...
      switch (Re(f[0])) {
        ...
        case "<workbook":
          if (o.match(us)) n = "xmlns" + o.match(/<(\w+):/)[1];
          t.xmlns = f[n];
          break;
        ...
        case "<workbookPr/>":
          ...
          if (f.codeName) t.WBProps.CodeName = Ye(f.codeName);
          break;
        ...
        case "<definedName":
          {
            ...
            if (Ge(f.hidden || "0")) i.Hidden = true;
            s = c + o.length;
          }
          break;
  ...
  var Ms = function () {
    ...
    function t(e, r, t, a) {
      ...
      for (var s = r.s.c; s <= r.e.c; ++s) {
        ...
        var h = u && u.v != null && (u.h || je(u.w || (wt(u), u.w) || "")) || "";
        var d = {};
        if (l > 1) d.rowspan = l;
        if (o > 1) d.colspan = o;
        d.t = u && u.t || "z";
  ...
  function Ns(e, r, t) {
    ...
    for (; p < l.length && m < o; ++p) {
      ...
      for (g = b = 0; g < x.length; ++g) {
        ...
        var S = _.hasAttribute("v") ? _.getAttribute("v") : er(_.innerHTML);

        var C = _.getAttribute("z");
        ...
        if (S != null) {
          if (S.length == 0) E.t = F || "z";else if (a.raw || S.trim().length == 0 || F == "s") {} else if (S === "TRUE") E = {
            t: "b",
            v: true
          };else if (S === "FALSE") E = {
            t: "b",
            v: false
          };else if (!isNaN(he(S))) E = {
            t: "n",
            v: he(S)
    ...
    e["!ref"] = vt(c);
    if (m >= o) e["!fullref"] = vt((c.e.r = l.length - p + m - 1 + n, c));
    return e;
  }
    ...
    return function t(a, n) {
      ...
      while (w = xlmlregex.exec(s)) {
        switch (w[3] = w[3].replace(/_.*$/, "")) {
          ...
          case "工作表":
            if (w[1] === "/") {
              if (F.e.c >= F.s.c && F.e.r >= F.s.r) b["!ref"] = vt(F);else b["!ref"] = "A1:A1";
          ...
          case "数据":
            if (w[0].charAt(w[0].length - 2) === "/") {
              ...
              if (y.formula && i.cellFormula != false) k.f = ods_to_csf_formula(Le(y.formula));

              if ((y["数据类型"] || y["value-type"]) == "string") {
                k.t = "s";
                k.v = Le(y["string-value"] || "");
              ...
              if (i.cellFormula) {
                if (y.formula) y.formula = Le(y.formula);
                ...
                if (y.formula) k.f = ods_to_csf_formula(y.formula);else for (Y = 0; Y < z.length; ++Y) {
                  if (A >= z[Y][0].s.r && A <= z[Y][0].e.r) if (E >= z[Y][0].s.c && E <= z[Y][0].e.c) k.F = z[Y][1];
                }
              }
          ...
          case "database-range":
            ...
            try {
              $ = ods_to_csf_3D(Ne(w[0])["target-range-address"]);
              m[$[0]]["!autofilter"] = {
                ref: $[1]
              };
            } catch (Q) {}
  ...
  function Bs(e, r) {
    ...
    var n = zs(t ? a : Ye(a), r);
    if (we(e, "meta.xml")) n.Props = ua(ye(e, "meta.xml"));
    return n;
  }
      ...
      for (; l <= c.e.r; ++l) {
        ...
        for (; o <= c.e.c; ++o) {
          ...
          for (u = 0; u != f.length; ++u) {
            ...
            if (f[u].s.c != o || f[u].s.r != l) d = true;
            p["table:number-columns-spanned"] = f[u].e.c - f[u].s.c + 1;
            p["table:number-rows-spanned"] = f[u].e.r - f[u].s.r + 1;
            break;
          }
          ...
          if (g && g.f) {
            p["table:formula"] = We(csf_to_ods_formula(g.f));

            if (g.F) {
              if (g.F.slice(0, v.length) == v) {
                var b = mt(g.F);
          ...
          switch (g.t) {
            ...
            case "d":
              m = g.w || oe(g.v).toISOString();
              p["office:value-type"] = "date";
              p["office:date-value"] = oe(g.v).toISOString();
          ...
          if (g.l && g.l.Target) {
            var k = g.l.Target;
            k = k.charAt(0) == "#" ? "#" + csf_to_ods_3D(k.slice(1)) : k;
            w = or("text:a", w, {
              "xlink:href": k
            });
          }

          s.push("          " + or("table:table-cell", or("text:p", w, {}), p) + "\n");
        }
  ...
  function js(e, r) {
    if (r.bookType == "fods") return Us(e, r);
    var t = Ce();
    var a = "";
    var n = [];
    var i = [];
    a = "mimetype";
    Se(t, a, "application/vnd.oasis.opendocument.spreadsheet");
    a = "content.xml";
    Se(t, a, Us(e, r));
    n.push([a, "text/xml"]);
  ...
  var Ys = Vs(typeof Aa !== "undefined" ? Aa : {});
  var Js = Vs(typeof Ea !== "undefined" ? Ea : {});
  var qs = Vs(typeof Ta !== "undefined" ? Ta : {});
  var Ks = Vs(typeof RTF !== "undefined" ? RTF : {});
  var Zs = Vs({
    from_sheet: Il
  });
  var Qs = Vs(typeof Ca !== "undefined" ? Ca : {});
  var el = Vs(typeof Fa !== "undefined" ? Fa : {});
  ...
  var tl = function tl(e) {
    rl([["cellNF", false], ["cellHTML", true], ["cellFormula", true], ["cellStyles", false], ["cellText", true], ["cellDates", false], ["sheetStubs", false], ["sheetRows", 0, "n"], ["bookDeps", false], ["bookSheets", false], ["bookProps", false], ["bookFiles", false], ["bookVBA", false], ["password", ""], ["WTF", false]])(e);
  };

  var al = rl([["cellDates", false], ["bookSST", false], ["bookType", "xlsx"], ["compression", false], ["WTF", false]]);
  ...
  function il(e, r) {
    ...
    try {
      e = r.map(function a(r) {
        ...
        return [r.name, e["!id"][r.id].Target, nl(e["!id"][r.id].Type)];
      });
    } catch (t) {
      return null;
    }
  ...
  function sl(e, r, t, a, n, i, s, l, o, c, f, u) {
    try {
      ...
      switch (l) {
        case "sheet":
          d = vs(h, r, n, o, i[a], c, f, u);
          break;

        case "chart":
          d = gs(h, r, n, o, i[a], c, f, u);
          if (!d || !d["!drawel"]) break;
          ...
          var g = Ee(v, p);
          var b = aa(g);
          d = Xi(xe(e, g, true), g, o, na(xe(e, b, true), g), c, d);
          break;
  ...
  function ol(e, r) {
    ...
    r = r || {};
    tl(r);
    if (we(e, "META-INF/manifest.xml")) return Bs(e, r);
    if (we(e, "objectdata.xml")) return Bs(e, r);
    ...
    if (!r.bookSheets && !r.bookProps) {
      ni = [];
      if (a.sst) try {
        ni = xs(ye(e, ll(a.sst)), a.sst, r);
      } catch (c) {
        if (r.WTF) throw c;
      }
      if (r.cellStyles && a.themes.length) l = ys(xe(e, a.themes[0].replace(/^\//, ""), true) || "", a.themes[0], r);
      if (a.style) o = ks(ye(e, ll(a.style)), a.style, l, r);
    }

    a.links.map(function (t) {
      try {
        var a = na(xe(e, aa(ll(t))), t);
        return Cs(ye(e, ll(t)), a, t, r);
      } catch (n) {}
    });
    var f = ms(ye(e, ll(a.workbooks[0])), a.workbooks[0], r);
    var u = {},
        h = "";

    if (a.coreprops.length) {
      h = ye(e, ll(a.coreprops[0]), true);
      if (h) u = ua(h);

      if (a.extprops.length !== 0) {
        h = ye(e, ll(a.extprops[0]), true);
        if (h) ba(h, u, r);
      }
    }
    ...
    i = {};
    var m = {};
    if (r.bookDeps && a.calcchain) m = Ss(ye(e, ll(a.calcchain)), a.calcchain, r);
    var v = 0;
    var g = {};
    var b, w;
    {
    ...
    var S = (a.workbooks[0].slice(0, _ + 1) + "_rels/" + a.workbooks[0].slice(_ + 1) + ".rels").replace(/^\//, "");
    if (!we(e, S)) S = "xl/_rels/workbook." + x + ".rels";
    var C = na(xe(e, S, true), S);
    if (C) C = il(C, f.Sheets);
    ...
    e: for (v = 0; v != u.Worksheets; ++v) {
      ...
      if (C && C[v]) {
        ...
        if (!we(e, b)) b = C[v][1];
        if (!we(e, b)) b = S.replace(/_rels\/.*$/, "") + C[v][1];
        E = C[v][2];
      } else {
      ...
      sl(e, b, w, u.SheetNames[v], v, g, i, E, r, f, l, o);
    }
    ...
    if (r && r.bookVBA) {
      if (a.vba.length > 0) p.vbaraw = ye(e, ll(a.vba[0]), true);else if (a.defaults && a.defaults.bin === jn) p.vbaraw = ye(e, "xl/vbaProject.bin", true);
    }
  ...
  function fl(e, r) {
    Ln = 1024;
    if (r.bookType == "ods") return js(e, r);
    ...
    for (l = 1; l <= e.SheetNames.length; ++l) {
      ...
      if (u) {
        ...
        if (u["!legacy"]) {
          if (p) Se(i, "xl/drawings/vmlDrawing" + l + ".vml", zn(l, u["!comments"]));
        }
    ...
    Se(i, "[Content_Types].xml", ra(n, r));
    Se(i, "_rels/.rels", sa(r.rels));
    Se(i, "xl/_rels/workbook." + t + ".rels", sa(r.wbrels));
    delete r.revssf;
    delete r.ssf;
    return i;
  }
  ...
  function hl(e, r) {
    if (j.find(e, "EncryptedPackage")) return cl(e, r);
  ...
  function wl(e, r) {
    c();
    if (typeof ArrayBuffer !== "undefined" && babelHelpers.instanceof(e, ArrayBuffer)) return wl(new Uint8Array(e), r);
    var t = e,
        a = [0, 0, 0, 0],
        n = false;
    var i = r || {};
    ...
    switch ((a = ul(t, i))[0]) {
      case 208:
        if (a[1] === 207 && a[2] === 17 && a[3] === 224 && a[4] === 161 && a[5] === 177 && a[6] === 26 && a[7] === 225) return hl(j.read(t, i), i);
        break;
      ...
      case 80:
        return a[1] === 75 && a[2] < 9 && a[3] < 9 ? dl(t, i) : bl(e, t, i, n);

      case 239:
        return a[3] === 60 ? parse_xlml(t, i) : bl(e, t, i, n);
    ...
    if (Ca.versions.indexOf(a[0]) > -1 && a[2] <= 12 && a[3] <= 31) return Ca.to_workbook(t, i);
    return bl(e, t, i, n);
  }
  ...
  function xl(e, r) {
    ...
    if (t.password && typeof encrypt_agile !== "undefined") return yl(encrypt_agile(i, t.password), t);
  ...
  function Sl(e, r, t) {
    ...
    switch (r.type) {
      ...
      case "buffer":
        {
          if (w) return k(a, "utf8");else return Sl(a, {
            type: "binary"
  ...
  function El(e, r) {
    ...
    switch (t.bookType || "xlsb") {
      ...
      case "biff4":
        if (!t.biff) t.biff = 4;
        return Al(write_biff_buf(e, t), t);
  ...
  function Ol(e, r, t, a) {
    ...
    return H.writeFile(e, El(r, n), i);
  }

  function Dl(e, r, t, a, n, i, s, l) {
    var o = it(t);
    var c = l.defval,
    ...
    if (!s || e[t]) for (var p = r.s.c; p <= r.e.c; ++p) {
      ...
      if (i[p] != null) {
        if (v == null) {
          if (c !== undefined) h[i[p]] = c;else if (f && v === null) h[i[p]] = null;else continue;
        } else {
          h[i[p]] = f || l.rawNumbers && m.t == "n" ? v : wt(m, v, l);
        }
  ...
  function Rl(e, r, t, a, n, i, s, l) {
    ...
    for (var h = r.s.c; h <= r.e.c; ++h) {
      ...
      if (d == null) f = "";else if (d.v != null) {
        o = false;
        f = "" + (l.rawNumbers && d.t == "n" ? d.v : wt(d, null, l));
  ...
  function zl(e, r, t) {
    ...
    r.forEach(function (e, r) {
      Y(e).forEach(function (t) {
        ...
        c = Wl.sheet_get_cell(i, p);

        if (o && babelHelpers.typeof(o) === "object" && !babelHelpers.instanceof(o, Date)) {
          i[p] = o;
        } else {
          if (typeof o == "number") f = "n";else if (typeof o == "boolean") f = "b";else if (typeof o == "string") f = "s";else if (babelHelpers.instanceof(o, Date)) {
            f = "d";
  ...
  var Wl = {
    ...
    sheet_to_formulae: Ll,
    sheet_to_row_object_array: Ml
  };
