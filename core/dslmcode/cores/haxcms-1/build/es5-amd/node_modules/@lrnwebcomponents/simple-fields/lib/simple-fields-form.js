...
value:function render(){return(0,_litElement.html)(_templateObject_7d7130f079d011eab2fff3f0fe734e4a())}},{key:"updated",value:function updated(changedProperties){var _this=this;changedProperties.forEach(function(oldValue,propName){if(_this.autoload&&!_this.loadResponse&&!_this.loading){if("loadEndpoint"===propName||"autoload"===propName){_this.loadData()}}// we have response data from an end point this should create the form
