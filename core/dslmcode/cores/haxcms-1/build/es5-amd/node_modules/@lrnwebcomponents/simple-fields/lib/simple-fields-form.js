define(["exports", "../../../lit-element/lit-element.js", "../simple-fields.js", "./simple-fields-form-lite.js"], function (_exports, _litElement, _simpleFields, _simpleFieldsFormLite) {
  ...
  function _templateObject_39c3d400833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <form>\n        <slot name=\"before\"></slot>\n        <simple-fields id=\"sf\" autofocus></simple-fields>\n        <slot></slot>\n      </form>\n    "]);

    _templateObject_39c3d400833211ea85a195fb4be801bd = function _templateObject_39c3d400833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function (_SimpleFieldsFormLite) {
    ...
    babelHelpers.createClass(SimpleFieldsForm, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_39c3d400833211ea85a195fb4be801bd());
      }
    }, {
      key: "updated",
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (_this.autoload && !_this.loadResponse && !_this.loading) {
          ...
          if (propName === "loadResponse" && _this.loadResponse.data) {
            _this._applyLoadedData();
            /**
            ...
            _this.dispatchEvent(new CustomEvent("response", {
              bubbles: true,
              composed: true,
              cancelable: false,
              detail: _this.loadResponse
            }));
          }
        });
      }
      ...
      value: function _applyLoadedData() {
        var sf = this.shadowRoot.querySelector("#sf"); //console.log(this.loadResponse.data.schema, this.loadResponse.data.fields);
      ...
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsForm), "properties", this), {}, _simpleFields.SimpleFields.properties);
      }
    }]);
