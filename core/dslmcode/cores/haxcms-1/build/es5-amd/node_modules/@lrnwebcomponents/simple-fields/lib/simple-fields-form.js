...
value:function render(){return(0,_litElement.html)(_templateObject_1e4bb1c072ac11eab01767e8389e9c27())}},{key:"updated",value:function updated(changedProperties){var _this=this;changedProperties.forEach(function(oldValue,propName){if(_this.autoload&&!_this.loadResponse&&!_this.loading){if("loadEndpoint"===propName||"autoload"===propName){_this.loadData()}}// we have response data from an end point this should create the form
