define(["exports", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/iron-a11y-keys-behavior/iron-a11y-keys-behavior.js", "../../@polymer/polymer/lib/legacy/class.js", "../../@polymer/paper-progress/paper-progress.js", "../../@polymer/iron-icon/iron-icon.js", "../../@polymer/paper-icon-button/paper-icon-button.js", "../../@polymer/paper-ripple/paper-ripple.js", "../simple-colors/simple-colors.js", "../hax-body-behaviors/lib/HAXWiring.js", "../schema-behaviors/schema-behaviors.js", "../../@polymer/iron-iconset-svg/iron-iconset-svg.js", "./lib/paper-audio-icons.js"], function (_exports, _polymerElement, _renderStatus, _ironA11yKeysBehavior, _class, _paperProgress, _ironIcon, _paperIconButton, _paperRipple, _simpleColors, _HAXWiring, _schemaBehaviors, _ironIconsetSvg, _paperAudioIcons) {
  ...
  function _templateObject_089e6780b49011e9ae0d876050e9d419() {
    ...
    _templateObject_089e6780b49011e9ae0d876050e9d419 = function _templateObject_089e6780b49011e9ae0d876050e9d419() {
      return data;
    };
  ...
  */
  ...
  function (_mixinBehaviors) {
    ...
    function PaperAudioPlayer() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(PaperAudioPlayer).call(this));
      (0, _renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(_this), function () {
        this.HAXWiring = new _HAXWiring.HAXWiring();
        this.HAXWiring.setup(PaperAudioPlayer.haxProperties, PaperAudioPlayer.tag, this);
      });
      return _this;
    }
    ...
    babelHelpers.createClass(PaperAudioPlayer, [{
      ...
      value: function disconnectedCallback() {
        ...
        this.$.audio.removeEventListener("loadedmetadata", this._onCanPlay.bind(this));
      ...
      value: function _onCanPlay() {
        ...
        player.timeLeft = player.$.audio.duration; // If player has a Time Offset specified
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_089e6780b49011e9ae0d876050e9d419());
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(PaperAudioPlayer), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(PaperAudioPlayer), "properties", this));
        }
  ...
  }((0, _class.mixinBehaviors)([_ironA11yKeysBehavior.IronA11yKeysBehavior], (0, _schemaBehaviors.SchemaBehaviors)(_simpleColors.SimpleColors)));
