...
*/var PaperAudioPlayer=/*#__PURE__*/function(_mixinBehaviors){babelHelpers.inherits(PaperAudioPlayer,_mixinBehaviors);function PaperAudioPlayer(){babelHelpers.classCallCheck(this,PaperAudioPlayer);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PaperAudioPlayer).apply(this,arguments))}babelHelpers.createClass(PaperAudioPlayer,[{key:"connectedCallback",/**
   * attached life cycle
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(PaperAudioPlayer.prototype),"connectedCallback",this).call(this);(0,_renderStatus.afterNextRender)(this,function(){this.shadowRoot.querySelector("#audio").addEventListener("loadedmetadata",this._onCanPlay.bind(this));this.shadowRoot.querySelector("#audio").addEventListener("playing",this._onPlaying.bind(this));this.shadowRoot.querySelector("#audio").addEventListener("pause",this._onPause.bind(this));this.shadowRoot.querySelector("#audio").addEventListener("ended",this._onEnd.bind(this));this.shadowRoot.querySelector("#audio").addEventListener("error",this._onError.bind(this))});this.setAttribute("tabindex","0");this.setAttribute("role","application");this.setAttribute("aria-label","Audio Player");this.setAttribute("aria-describedby","title")}/**
   * detached life cycle
...
player.canBePlayed=!1;player.isPlaying=!1;player.ended=!1;player.error=!1;player.shadowRoot.querySelector("#audio").currentTime=player.timeOffset;// apply the audio start time property
}// Play/Pause controls
...
player.shadowRoot.querySelector("#audio").load();player._play()}}},{key:"_play",value:function _play(){var player=this;player.shadowRoot.querySelector("#audio").play()}},{key:"_pause",value:function _pause(){var player=this;player.shadowRoot.querySelector("#audio").pause()}//
// Restart audio
},{key:"restart",value:function restart(e){if(!!e)e.preventDefault();var player=this;player.shadowRoot.querySelector("#audio").currentTime=0;if(!player.isPlaying)player._play()}// when audio file can be played in user's browser
},{key:"_onCanPlay",value:function _onCanPlay(){var player=this;player.canBePlayed=!0;player.timeLeft=player.shadowRoot.querySelector("#audio").duration;// If player has a Time Offset specified
// style the progress bar and title accordingly
if(0<player.timeOffset){var percentagePlayed=player.timeOffset/player.shadowRoot.querySelector("#audio").duration;player._updateVisualProgress(percentagePlayed)}// If player has auto-play attribute set,
...
},{key:"_onPlaying",value:function _onPlaying(){var player=this;player.ended=!1;player.isPlaying=!0;player.shadowRoot.querySelector("#replay").style="";// remove Replay inline styling
...
},{key:"_startProgressTimer",value:function _startProgressTimer(){var player=this;player.timer={};if(player.timer.sliderUpdateInterval){clearInterval(player.timer.sliderUpdateInterval)}player.timer.sliderUpdateInterval=setInterval(function(){if(player.isPlaying){player.currentTime=player.shadowRoot.querySelector("#audio").currentTime;player.timeLeft=player.shadowRoot.querySelector("#audio").duration-player.currentTime;var percentagePlayed=player.currentTime/player.shadowRoot.querySelector("#audio").duration;player._updateVisualProgress(percentagePlayed)}else{clearInterval(player.timer.sliderUpdateInterval)}},60)}// when Player is paused
},{key:"_onPause",value:function _onPause(){var player=this;player.isPlaying=!1}// when Player ended playing an audio file
},{key:"_onEnd",value:function _onEnd(){var player=this;player.ended=!0;player.isPlaying=!1;player.shadowRoot.querySelector("#replay").style.opacity=1;// display Replay icon
}// on file load error
...
}else if("none"===player.preload){player.shadowRoot.querySelector("#audio").load();player.shadowRoot.querySelector("#audio").addEventListener("loadedmetadata",function(){player._updateProgressBar(e);if(!player.isPlaying){player._play()}},!1)}}//
// Helper function
// that recalculates the progress bar position
// based on the event.click position
},{key:"_updateProgressBar",value:function _updateProgressBar(e){var player=this,x=e.detail.x-player.shadowRoot.querySelector("#center").getBoundingClientRect().left,r=x/player.shadowRoot.querySelector("#center").getBoundingClientRect().width*player.shadowRoot.querySelector("#audio").duration;this._updatePlayPosition(r)}//
// Helper function
// updates the current time based on a time variable
},{key:"_updatePlayPosition",value:function _updatePlayPosition(newTime){var player=this;player.currentTime=player.shadowRoot.querySelector("#audio").currentTime=newTime;var percentagePlayed=player.currentTime/player.shadowRoot.querySelector("#audio").duration;player._updateVisualProgress(percentagePlayed)}//
// Helper function
// updates the progress bar based on a percentage played
},{key:"_updateVisualProgress",value:function _updateVisualProgress(percentagePlayed){var player=this;player.shadowRoot.querySelector("#progress").style.transform="scaleX("+percentagePlayed+")";player.shadowRoot.querySelector("#progress2").style.width=100*percentagePlayed+"%";player.shadowRoot.querySelector("#title2").style.width=100*(1/percentagePlayed)+"%"}//
