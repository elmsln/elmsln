define(["exports", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _litElement, _schemaBehaviors) {
  ...
  function _templateObject5_35269370db3d11eaa14b6130b7e5d77f() {
    ...
    _templateObject5_35269370db3d11eaa14b6130b7e5d77f = function _templateObject5_35269370db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject4_35269370db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <span property=\"oer:task\">", "</span>\n                  "]);

    _templateObject4_35269370db3d11eaa14b6130b7e5d77f = function _templateObject4_35269370db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject3_35269370db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <a href=\"", "\" property=\"oer:task\">", "</a>\n                  "]);

    _templateObject3_35269370db3d11eaa14b6130b7e5d77f = function _templateObject3_35269370db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject2_35269370db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <li>\n              ", "\n            </li>\n          "]);

    _templateObject2_35269370db3d11eaa14b6130b7e5d77f = function _templateObject2_35269370db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_35269370db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <h3><span property=\"oer:name\">", "</span></h3>\n      <ol>\n        ", "\n      </ol>\n    "]);

    _templateObject_35269370db3d11eaa14b6130b7e5d77f = function _templateObject_35269370db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(TaskList, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_35269370db3d11eaa14b6130b7e5d77f(), this.name, this.tasks.map(function (task) {
          return (0, _litElement.html)(_templateObject2_35269370db3d11eaa14b6130b7e5d77f(), task.link ? (0, _litElement.html)(_templateObject3_35269370db3d11eaa14b6130b7e5d77f(), task.link, task.name) : (0, _litElement.html)(_templateObject4_35269370db3d11eaa14b6130b7e5d77f(), task.name));
        }));
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_35269370db3d11eaa14b6130b7e5d77f())];
      }
    }, {
      key: "tag",
      get: function get() {
