define(["exports", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, _litElement, _schemaBehaviors) {
  ...
  function _templateObject5_d005a5a088c411ea8e2ed3d8cb6f439c() {
    ...
    _templateObject5_d005a5a088c411ea8e2ed3d8cb6f439c = function _templateObject5_d005a5a088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function _templateObject4_d005a5a088c411ea8e2ed3d8cb6f439c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <span property=\"oer:task\">", "</span>\n                  "]);

    _templateObject4_d005a5a088c411ea8e2ed3d8cb6f439c = function _templateObject4_d005a5a088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function _templateObject3_d005a5a088c411ea8e2ed3d8cb6f439c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <a href=\"", "\" property=\"oer:task\">", "</a>\n                  "]);

    _templateObject3_d005a5a088c411ea8e2ed3d8cb6f439c = function _templateObject3_d005a5a088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function _templateObject2_d005a5a088c411ea8e2ed3d8cb6f439c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <li>\n              ", "\n            </li>\n          "]);

    _templateObject2_d005a5a088c411ea8e2ed3d8cb6f439c = function _templateObject2_d005a5a088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function _templateObject_d005a5a088c411ea8e2ed3d8cb6f439c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <h3><span property=\"oer:name\">", "</span></h3>\n      <ol>\n        ", "\n      </ol>\n    "]);

    _templateObject_d005a5a088c411ea8e2ed3d8cb6f439c = function _templateObject_d005a5a088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(TaskList, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_d005a5a088c411ea8e2ed3d8cb6f439c(), this.name, this.tasks.map(function (task) {
          return (0, _litElement.html)(_templateObject2_d005a5a088c411ea8e2ed3d8cb6f439c(), task.link ? (0, _litElement.html)(_templateObject3_d005a5a088c411ea8e2ed3d8cb6f439c(), task.link, task.name) : (0, _litElement.html)(_templateObject4_d005a5a088c411ea8e2ed3d8cb6f439c(), task.name));
        }));
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject5_d005a5a088c411ea8e2ed3d8cb6f439c())];
      }
    }, {
      key: "tag",
      get: function get() {
