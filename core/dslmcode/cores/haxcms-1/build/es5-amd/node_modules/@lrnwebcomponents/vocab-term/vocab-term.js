define(["exports", "../../lit/index.js", "../simple-popover/simple-popover.js", "../simple-modal/lib/simple-modal-template.js"], function (_exports, _index, _simplePopover, _simpleModalTemplate) {
  ...
  var _templateObject_c0302750514411ecad92218912f770fd, _templateObject2_c0302750514411ecad92218912f770fd, _templateObject3_c0302750514411ecad92218912f770fd, _templateObject4_c0302750514411ecad92218912f770fd, _templateObject5_c0302750514411ecad92218912f770fd, _templateObject6_c0302750514411ecad92218912f770fd, _templateObject7_c0302750514411ecad92218912f770fd, _templateObject8_c0302750514411ecad92218912f770fd;
  ...
  var VocabTerm = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(VocabTerm, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_c0302750514411ecad92218912f770fd || (_templateObject_c0302750514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral([" ", ""])), !this.popoverMode ? (0, _index.html)(_templateObject2_c0302750514411ecad92218912f770fd || (_templateObject2_c0302750514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["\n          <div>\n            <summary id=\"summary\">", "</summary>\n            <simple-modal-template>\n              <div slot=\"header\">", "</div>\n              <p slot=\"content\">", "</p>\n              ", "\n              <div slot=\"buttons\">\n                <button dialog-dismiss>Close Modal</button>\n              </div>\n            </simple-modal-template>\n          </div>\n        "])), this.term, this.term, this.information, this.links.length > 0 ? (0, _index.html)(_templateObject3_c0302750514411ecad92218912f770fd || (_templateObject3_c0302750514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral([" <ul slot=\"content\">\n                    ", "\n                  </ul>"])), this.links.map(function (el) {
          return (0, _index.html)(_templateObject4_c0302750514411ecad92218912f770fd || (_templateObject4_c0302750514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["\n                        <li><a href=\"", "\">", "</a></li>\n                      "])), el.href, el.title);
        })) : "") : (0, _index.html)(_templateObject5_c0302750514411ecad92218912f770fd || (_templateObject5_c0302750514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["\n          <details>\n            <summary id=\"summary\">", "</summary>\n            <simple-popover for=\"summary\" position=\"top\">\n              <p>", "</p>\n              ", "\n            </simple-popover>\n          </details>\n        "])), this.term, this.information, this.links.length > 0 ? (0, _index.html)(_templateObject6_c0302750514411ecad92218912f770fd || (_templateObject6_c0302750514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["\n                    <ul>\n                      ", "\n                    </ul>\n                  "])), this.links.map(function (el) {
          return (0, _index.html)(_templateObject7_c0302750514411ecad92218912f770fd || (_templateObject7_c0302750514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["\n                          <li><a href=\"", "\">", "</a></li>\n                        "])), el.href, el.title);
        })) : ""));
      }
      /**
       * Convention we use
      ...
      get: function get() {
        ...
        return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject8_c0302750514411ecad92218912f770fd || (_templateObject8_c0302750514411ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        simple-modal-template {\n          --simple-modal-resize: both;\n          --simple-modal-width: 300px;\n          --simple-modal-height: 300px;\n          --simple-modal-min-width: 300px;\n          --simple-modal-min-height: 300px;\n        }\n        summary {\n          list-style: none;\n          border-bottom: 1px dashed gray;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
