define(["exports", "meta", "../../lit/index.js", "../simple-popover/simple-popover.js", "../simple-modal/lib/simple-modal-template.js"], function (_exports, meta, _index, _simplePopover, _simpleModalTemplate) {
  "use strict";
  ...
  var _templateObject_0295cac04fcb11ed8a8d232fdb18e48b, _templateObject2_0295cac04fcb11ed8a8d232fdb18e48b, _templateObject3_0295cac04fcb11ed8a8d232fdb18e48b, _templateObject4_0295cac04fcb11ed8a8d232fdb18e48b, _templateObject5_0295cac04fcb11ed8a8d232fdb18e48b, _templateObject6_0295cac04fcb11ed8a8d232fdb18e48b, _templateObject7_0295cac04fcb11ed8a8d232fdb18e48b, _templateObject8_0295cac04fcb11ed8a8d232fdb18e48b;
  ...
  var VocabTerm = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(VocabTerm, [{
       ...
       */
      function render() {
        return (0, _index.html)(_templateObject_0295cac04fcb11ed8a8d232fdb18e48b || (_templateObject_0295cac04fcb11ed8a8d232fdb18e48b = babelHelpers.taggedTemplateLiteral([" ", ""])), !this.popoverMode ? (0, _index.html)(_templateObject2_0295cac04fcb11ed8a8d232fdb18e48b || (_templateObject2_0295cac04fcb11ed8a8d232fdb18e48b = babelHelpers.taggedTemplateLiteral(["\n          <div>\n            <div part=\"term\">\n              <summary id=\"summary\">", "</summary>\n            </div>\n            <simple-modal-template title=\"", "\">\n              <p slot=\"content\">", "</p>\n              ", "\n            </simple-modal-template>\n          </div>\n        "])), this.term, this.term ? this.term : "", this.information, this.links && this.links.length > 0 && this.links.map ? (0, _index.html)(_templateObject3_0295cac04fcb11ed8a8d232fdb18e48b || (_templateObject3_0295cac04fcb11ed8a8d232fdb18e48b = babelHelpers.taggedTemplateLiteral([" <ul slot=\"content\">\n                    ", "\n                  </ul>"])), this.links.map(function (el) {
          return (0, _index.html)(_templateObject4_0295cac04fcb11ed8a8d232fdb18e48b || (_templateObject4_0295cac04fcb11ed8a8d232fdb18e48b = babelHelpers.taggedTemplateLiteral(["\n                        <li>\n                          <a\n                            href=\"", "\"\n                            target=\"_blank\"\n                            rel=\"noopener noreferrer\"\n                            >", "</a\n                          >\n                        </li>\n                      "])), el.href, el.title);
        })) : "") : (0, _index.html)(_templateObject5_0295cac04fcb11ed8a8d232fdb18e48b || (_templateObject5_0295cac04fcb11ed8a8d232fdb18e48b = babelHelpers.taggedTemplateLiteral(["\n          <details>\n            <summary id=\"summary\">", "</summary>\n            <div part=\"information\">\n              <simple-popover for=\"summary\" position=\"top\" auto>\n                <p>", "</p>\n                <div part=\"links\">\n                  ", "\n                </div>\n              </simple-popover>\n            </div>\n          </details>\n        "])), this.term, this.information, this.links && this.links.length > 0 && this.links.map ? (0, _index.html)(_templateObject6_0295cac04fcb11ed8a8d232fdb18e48b || (_templateObject6_0295cac04fcb11ed8a8d232fdb18e48b = babelHelpers.taggedTemplateLiteral(["\n                        <ul>\n                          ", "\n                        </ul>\n                      "])), this.links.map(function (el) {
          return (0, _index.html)(_templateObject7_0295cac04fcb11ed8a8d232fdb18e48b || (_templateObject7_0295cac04fcb11ed8a8d232fdb18e48b = babelHelpers.taggedTemplateLiteral(["\n                              <li>\n                                <a\n                                  href=\"", "\"\n                                  target=\"_blank\"\n                                  rel=\"noopener noreferrer\"\n                                  >", "</a\n                                >\n                              </li>\n                            "])), el.href, el.title);
        })) : ""));
      }
      /**
       * Convention we use
      ...
      value: function firstUpdated(changedProperties) {
        ...
        if (this.querySelector(".links a")) {
          this.querySelectorAll(".links a").forEach(function (el) {
            _this2.links.push({
        ...
        this.links = babelHelpers.toConsumableArray(this.links);
      }
      /**
       *
       */
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "popoverMode") {
            if (_this3[propName]) {
              _this3.detailsOpen = false;

              if (_this3.shadowRoot) {
                _this3.details = _this3.shadowRoot.querySelector("details");
              }

              _this3.addEventListener("click", _this3._handleClick.bind(_this3));
            } else {
              _this3.removeEventListener("click", _this3._handleClick.bind(_this3));
            }
          }
        });
      }
          ...
          links: {
            ...
            converter: {
              ...
              toAttribute: function toAttribute(val) {
                var ary = val.map(function (p) {
                  return "".concat(p.title, ",").concat(p.href);
                });
                return ary.join("\n");
              }
            }
      ...
      get: function get() {
        ...
        return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject8_0295cac04fcb11ed8a8d232fdb18e48b || (_templateObject8_0295cac04fcb11ed8a8d232fdb18e48b = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n        }\n        simple-modal-template {\n          --simple-modal-resize: both;\n          --simple-modal-width: 300px;\n          --simple-modal-height: 300px;\n          --simple-modal-min-width: 300px;\n          --simple-modal-min-height: 300px;\n        }\n        summary {\n          list-style: none;\n          border-bottom: var(--vocab-term-border-bottom, 1px dashed gray);\n          color: var(--vocab-term-color, black);\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
