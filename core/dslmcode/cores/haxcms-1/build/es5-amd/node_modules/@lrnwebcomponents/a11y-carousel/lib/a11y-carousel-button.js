define(["exports", "../../../lit-element/lit-element.js", "../../radio-behaviors/radio-behaviors.js"], function (_exports, _litElement, _radioBehaviors) {
  ...
  function _templateObject2_363607a0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline;\n          background-color: transparent;\n          border: 1px solid black;\n          padding: 2px 5px;\n          margin: 15px 2px;\n          text-align: center;\n        }\n        :host([hidden]) {\n          display: none !important;\n        }\n        :host([disabled]) {\n          opacity: 0.5;\n        }\n        @media print {\n          :host {\n            display: none !important;\n          }\n        }\n      "]);

    _templateObject2_363607a0db3d11eaa14b6130b7e5d77f = function _templateObject2_363607a0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_363607a0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n    "]);

    _templateObject_363607a0db3d11eaa14b6130b7e5d77f = function _templateObject_363607a0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(a11yCarouselButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_363607a0db3d11eaa14b6130b7e5d77f());
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_363607a0db3d11eaa14b6130b7e5d77f())];
      }
    }, {
      key: "properties",
      get: function get() {
