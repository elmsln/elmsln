define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../@polymer/polymer/lib/utils/async.js", "../../@polymer/paper-input/paper-textarea.js", "../materializecss-styles/lib/colors.js", "../mtz-marked-editor/mtz-marked-editor.js", "../mtz-marked-editor/lib/mtz-marked-control-generic-line.js", "../mtz-marked-editor/lib/mtz-marked-control-generic-wrap.js", "../mtz-marked-editor/lib/mtz-marked-control-link.js", "../word-count/word-count.js", "../lrnsys-button/lrnsys-button.js", "../lrndesign-avatar/lrndesign-avatar.js"], function (_exports, _require, _polymerElement, _polymerDom, async, _paperTextarea, _colors, _mtzMarkedEditor, _mtzMarkedControlGenericLine, _mtzMarkedControlGenericWrap, _mtzMarkedControlLink, _wordCount, _lrnsysButton, _lrndesignAvatar) {
  ...
  function _templateObject_d5a826c0b46e11e9978b67ee5ebb8bc8() {
    ...
    _templateObject_d5a826c0b46e11e9978b67ee5ebb8bc8 = function _templateObject_d5a826c0b46e11e9978b67ee5ebb8bc8() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(LrnsysComment, [{
      ...
      value: function disconnectedCallback() {
        ...
        this.$.bodyarea.removeEventListener("dblclick", this.bodyToggleOn.bind(this));
      }
    }, {
      key: "_generateName",
      ...
      value: function _editTrigger(e) {
        ...
        if (babelHelpers.typeof(this.comment) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && this.comment.actions.edit) {
          async.microTask.run(function () {
            ...
            _this2.$.renderedcomment.hidden = _this2.editform;
            _this2.$.commenteditor.hidden = !_this2.editform; // simple icon toggle

            if (_this2.editform) {
              _this2.$.edit.icon = "save";
              _this2.$.edit.alt = "Save";
              _this2.$.reply.disabled = true;

              _this2.$.editcomment.focus();
              ...
              _this2.$.edit.icon = "create";
              _this2.$.edit.alt = "Edit";
              _this2.$.reply.disabled = false;
            }
          });
        }
      }
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_d5a826c0b46e11e9978b67ee5ebb8bc8());
      }
    }, {
      key: "tag",
      get: function get() {
