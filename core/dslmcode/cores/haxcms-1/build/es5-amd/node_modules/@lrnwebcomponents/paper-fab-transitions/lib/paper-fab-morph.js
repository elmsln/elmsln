define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/async.js","../../../@polymer/iron-dropdown/iron-dropdown.js"],function(_exports,_polymerElement,_async,_ironDropdown){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PaperFabMorph=void 0;function _templateObject_99d6fdb0600811eaa16cad22a3013b8c(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        iron-dropdown {\n          @apply --paper-morph-dropdown;\n        }\n        .dropdown-content {\n          @apply --paper-morph-content;\n        }\n        #morpher {\n          position: fixed;\n          display: none;\n          background-color: var(--paper-morph-background, #fff);\n        }\n      </style>\n      <span id=\"fabContainer\" class=\"dropdown-trigger\"\n        ><slot name=\"dropdown-trigger\"></slot\n      ></span>\n      <span id=\"contentContainer\" class=\"dropdown-content\"\n        ><slot name=\"dropdown-content\"></slot\n      ></span>\n      <paper-material id=\"morpher\"></paper-material>\n    "]);_templateObject_99d6fdb0600811eaa16cad22a3013b8c=function _templateObject_99d6fdb0600811eaa16cad22a3013b8c(){return data};return data}/**
...
*/var PaperFabMorph=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(PaperFabMorph,_PolymerElement);function PaperFabMorph(){babelHelpers.classCallCheck(this,PaperFabMorph);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PaperFabMorph).apply(this,arguments))}babelHelpers.createClass(PaperFabMorph,[{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(PaperFabMorph.prototype),"ready",this).call(this);this._fab=this.shadowRoot.querySelector("#fabContainer");this._content=this.shadowRoot.querySelector("#contentContainer");if(this.isOverlayContent){this._fab.addEventListener("click",function(){this._content.open()}.bind(this));this._overlay=this._content}else{var dropdown=document.createElement("iron-dropdown");dropdown.appendChild(this._content);this.root.appendChild(dropdown);this._overlay=dropdown;this._dropdown=dropdown;this._fab.addEventListener("click",function(){this._dropdown.open()}.bind(this));this._updateOverlayPosition(this.verticalAlign,this.horizontalAlign,this.verticalOffset,this.horizontalOffset)}this._overlay.addEventListener("iron-overlay-opened",function(){this._morphOpen()}.bind(this));this._overlay.addEventListener("iron-overlay-closed",function(){this._morphClose()}.bind(this))}/**
   * Show the content.
   */},{key:"open",value:function open(){this._overlay.open()}/**
   * Hide the content.
   */},{key:"close",value:function close(){this._overlay.close()}},{key:"_updateOverlayPosition",value:function _updateOverlayPosition(verticalAlign,horizontalAlign,verticalOffset,horizontalOffset){if(this._dropdown){var d=this._dropdown;d.verticalAlign=verticalAlign;d.horizontalAlign=horizontalAlign;d.verticalOffset=verticalOffset;d.horizontalOffset=horizontalOffset}}},{key:"_morphOpen",value:function _morphOpen(){var fab=this._fab,content=this._content,fabRect=fab.getBoundingClientRect(),morpher=this.shadowRoot.querySelector("#morpher"),ms=morpher.style;ms.display="block";ms.top=fabRect.top+"px";ms.left=fabRect.left+"px";ms.width=fabRect.width+"px";ms.height=fabRect.height+"px";ms.borderRadius="50%";ms.transitionDuration=this.duration+"ms";fab.style.visibility="hidden";content.style.visibility="hidden";var contentRect=content.getBoundingClientRect();ms.top=contentRect.top+"px";ms.left=contentRect.left+"px";ms.width=contentRect.width+"px";ms.height=contentRect.height+"px";ms.borderRadius="";_async.microTask.run(function(){morpher.style.display="none";content.style.visibility="visible"})}},{key:"_morphClose",value:function _morphClose(){var fab=this._fab,content=this._content,contentRect=fab.getBoundingClientRect(),morpher=this.shadowRoot.querySelector("#morpher"),ms=morpher.style;morpher.style.display="block";_async.microTask.run(function(){var fabRect=fab.getBoundingClientRect();ms.top=fabRect.top+"px";ms.left=fabRect.left+"px";ms.width=fabRect.width+"px";ms.height=fabRect.height+"px";ms.borderRadius="50%";_async.microTask.run(function(){morpher.style.display="none";fab.style.visibility="visible"})})}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_99d6fdb0600811eaa16cad22a3013b8c())}},{key:"tag",get:function get(){return"paper-fab-morph"}},{key:"properties",get:function get(){return{/**
       ...
       */verticalOffset:{type:Number,value:0,notify:!0}}}},{key:"observers",get:function get(){return["_updateOverlayPosition(verticalAlign, horizontalAlign, verticalOffset, horizontalOffset)"]}}]);return PaperFabMorph}(_polymerElement.PolymerElement);_exports.PaperFabMorph=PaperFabMorph;window.customElements.define(PaperFabMorph.tag,PaperFabMorph)});