...
*/var PaperFabSpeedDial=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(PaperFabSpeedDial,_PolymerElement);function PaperFabSpeedDial(){babelHelpers.classCallCheck(this,PaperFabSpeedDial);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PaperFabSpeedDial).apply(this,arguments))}babelHelpers.createClass(PaperFabSpeedDial,[{key:"getDistributedNodes",value:function getDistributedNodes(node){return"slot"===node.localName?(0,_wrap.wrap)(node).assignedNodes({flatten:!0}):[]}},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(PaperFabSpeedDial.prototype),"ready",this).call(this);var fab=this.getDistributedNodes(this.shadowRoot.querySelector("#fabContainer"))[0];fab.addEventListener("click",function(){this.shadowRoot.querySelector("#dropdown").open()}.bind(this));var content=this.getDistributedNodes(this.shadowRoot.querySelector("#contentContainer"))[0];content.addEventListener("click",function(){this.shadowRoot.querySelector("#dropdown").close()}.bind(this))}/**
   * Show the speed dial options.
   */},{key:"open",value:function open(){this.shadowRoot.querySelector("#dropdown").open()}/**
   * Hide the speed dial options.
   */},{key:"close",value:function close(){this.shadowRoot.querySelector("#dropdown").close()}},{key:"_updateDropdown",value:function _updateDropdown(direction,offset){var d=this.shadowRoot.querySelector("#dropdown");switch(direction){case"bottom":d.verticalAlign="top";d.horizontalOffset=0;d.verticalOffset=offset;d.classList.add("vertical");d.classList.remove("horizontal");break;case"top":d.verticalAlign="bottom";d.horizontalOffset=0;d.verticalOffset=offset;d.classList.add("vertical");d.classList.remove("horizontal");break;case"right":d.horizontalAlign="left";d.horizontalOffset=offset;d.verticalOffset=0;d.classList.add("horizontal");d.classList.remove("vertical");break;case"left":d.horizontalAlign="right";d.horizontalOffset=offset;d.verticalOffset=0;d.classList.add("horizontal");d.classList.remove("vertical");break;default:throw"Invalid direction. Must be one of [top, bottom, left, right].";}}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_7aefdd4079d011eab2fff3f0fe734e4a())}},{key:"tag",get:function get(){return"paper-fab-speed-dial"}},{key:"properties",get:function get(){return{/**
