define(["../../../@polymer/polymer/lib/legacy/polymer.dom.js"], function (_polymerDom) {
  "use strict";

  var _Mathround = Math.round,
      Reader = function Reader(el) {
    this.element = el;
    this.reader = (0, _polymerDom.dom)(el.root).querySelector(".pdf-viewer");
    ...
    this.card = (0, _polymerDom.dom)(el.root).querySelector(".style-scope");
  ...
  Reader.prototype.sidebarSetup = function (currentThis) {
    ...
    function handlePages(page) {
      ...
      var addPage = (0, _polymerDom.dom)(self.container).childNodes[page.pageIndex];
