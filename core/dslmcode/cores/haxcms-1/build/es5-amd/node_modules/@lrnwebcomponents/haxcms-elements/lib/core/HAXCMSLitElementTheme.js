define(["exports", "../../../../lit-element/lit-element.js", "./HAXCMSThemeWiring.js"], function (_exports, _litElement, _HAXCMSThemeWiring) {
  ...
  function (_HAXCMSTheme) {
    ...
    babelHelpers.createClass(HAXCMSLitElementTheme, [{
      ...
      key: "properties",
      get: function get() {
        return babelHelpers.objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSLitElementTheme), "properties", this), {
          /**
           * Class for the color
           */
          hexColor: {
  ...
  }((0, _HAXCMSThemeWiring.HAXCMSTheme)(_litElement.LitElement));
