...
*/var EditableTableDisplay=/*#__PURE__*/function(_displayBehaviors){babelHelpers.inherits(EditableTableDisplay,_displayBehaviors);function EditableTableDisplay(){babelHelpers.classCallCheck(this,EditableTableDisplay);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(EditableTableDisplay).apply(this,arguments))}babelHelpers.createClass(EditableTableDisplay,[{key:"_getTbody",/**
   * Geth the rows in <tbody>
   */value:function _getTbody(data,columnHeader,footer){if(data!==void 0&&null!==data&&0<data.length){var ch=columnHeader?1:0,tbody;if(footer){tbody=data.slice(ch,data.length-1);this.__tfoot=data.slice(data.length-1)}else{tbody=data.slice(ch,data.length);this.__tfoot=[]}return tbody}return[]}/**
   * Get the columns in <thead>
   */},{key:"_getThead",value:function _getThead(data,columnHeader){var root=this;if(data!==void 0&&null!==data&&0<data.length&&columnHeader){return data.slice(0,1)}return[]}/**
   ...
   * sets a cell's numeric style
   */},{key:"_isNumeric",value:function _isNumeric(cell){return null!==cell&&!isNaN(cell.trim().replace(/\$/g,""))}/**
   * sets a cell's numeric style
   */},{key:"_isNumericColumn",value:function _isNumericColumn(col){for(var numeric=!0,i=0;i<this.tbody.length;i++){if(!this._isNumeric(this.tbody[i][col]))numeric=!1}return numeric}/**
   ...
   */},{key:"_onColumnChange",value:function _onColumnChange(e){this.selected=e.detail.value;this._updateCols(parseInt(e.detail.value))}/**
   * Handle sort button click
   */},{key:"_changeSortMode",value:function _changeSortMode(e){if(this.sortColumn===e.detail.columnNumber&&"asc"===this.sortMode){this.sortMode="desc"}else if(this.sortColumn===e.detail.columnNumber&&"desc"===this.sortMode){this.sortMode="none"}else{this.sortMode="asc";this.sortColumn=e.detail.columnNumber}e.detail.setSortMode(this.sortMode);this.sortData(this.sortMode,e.detail.columnNumber)}/**
   * update the responsive columns menu
   */},{key:"_updateCols",value:function _updateCols(selected){this.$.table.removeAttribute("default-xs-display");var cols=this.$.table.querySelectorAll("th,td");this.$.table.setAttribute("transition",!0);setTimeout(function(){for(var i=0;i<cols.length;i++){var col=cols[i],index=col.cellIndex,delay=void 0;if(0===index||index===selected){col.removeAttribute("xs-hidden")}else{col.setAttribute("xs-hidden",!0)}}},200);this.$.table.removeAttribute("transition")}/**
   ...
   */},{key:"sortData",value:function sortData(type,column){if("none"!==type&&!1!==type){for(var temp=this.tbody.slice(),i=0;i<temp.length;i++){temp[i].unshift(temp[i][column])}if("asc"===type){temp.sort()}else{temp.reverse()}for(var _i=0;_i<temp.length;_i++){this.set("tbody."+_i,[]);this.set("tbody."+_i,temp[_i].slice(1))}}else{for(var _temp=this.tbody.slice(),_i2=0;_i2<_temp.length;_i2++){this.set("data."+(_i2+1),[]);this.set("data."+(_i2+1),_temp[_i2].slice())}}}/**
   * Handle filter button click
   */},{key:"toggleFilter",value:function toggleFilter(e){if(e===void 0||this.filterColumn==e.detail.columnNumber&&this.filtered){this.filtered=!1;this.filterText=null;this.filterColumn=null}else{this.filterText=e.detail.text;this.filterColumn=e.detail.columnNumber;this.filtered=!0}}},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(EditableTableDisplay.prototype),"connectedCallback",this).call(this);(0,_renderStatus.afterNextRender)(this,function(){this.addEventListener("change-sort-mode",this._changeSortMode.bind(this));this.addEventListener("toggle-filter",this.toggleFilter.bind(this));this.addEventListener("dropdown-select-changed",this._onColumnChange.bind(this))})}},{key:"disconnectedCallback",value:function disconnectedCallback(){this.removeEventListener("change-sort-mode",this._changeSortMode.bind(this));this.removeEventListener("toggle-filter",this.toggleFilter.bind(this));this.removeEventListener("dropdown-select-changed",this._onColumnChange.bind(this));babelHelpers.get(babelHelpers.getPrototypeOf(EditableTableDisplay.prototype),"disconnectedCallback",this).call(this)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_51b3eee0a98211e9b32f63a96269e7a5())}},{key:"tag",get:function get(){return"editable-table-display"}},{key:"properties",get:function get(){return{/**
