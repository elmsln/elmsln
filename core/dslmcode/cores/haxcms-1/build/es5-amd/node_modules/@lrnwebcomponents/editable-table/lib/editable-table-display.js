define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/elements/dom-repeat.js", "../../../@polymer/polymer/lib/elements/dom-if.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../simple-picker/simple-picker.js", "../../responsive-utility/lib/responsive-utility-behaviors.js", "./editable-table-behaviors.js", "./editable-table-styles.js"], function (_exports, _require, _polymerElement, _domRepeat, _domIf, _ironAjax, _simplePicker, _responsiveUtilityBehaviors, _editableTableBehaviors, _editableTableStyles) {
  "use strict";
  ...
  function _templateObject_df8a34f0577c11eb974577f038855fc7() {
    ...
    _templateObject_df8a34f0577c11eb974577f038855fc7 = function _templateObject_df8a34f0577c11eb974577f038855fc7() {
      return data;
    };
  ...
  var EditableTableDisplay = /*#__PURE__*/function (_displayBehaviors) {
    ...
    babelHelpers.createClass(EditableTableDisplay, [{
      ...
      key: "_hasNoData",
      value: function _hasNoData(data) {
      ...
      key: "_getTheadOptions",
      value: function _getTheadOptions(thead) {
        var temp = [];

        if (thead !== undefined && thead !== null && thead.length > 0) {
          for (var i = 1; i < thead[0].length; i++) {
            temp.push([{
              alt: thead[0][i],
              value: i
            }]);
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_df8a34f0577c11eb974577f038855fc7());
      }
    }, {
      key: "haxProperties",
      get: function get() {
    ...
    babelHelpers.createClass(EditableTableDisplay, [{
      ...
      value: function connectedCallback() {
        ...
        setTimeout(function () {
          _this2.addEventListener("change-sort-mode", _this2._changeSortMode.bind(_this2));

          _this2.addEventListener("toggle-filter", _this2.toggleFilter.bind(_this2));
        }, 0);
      }
    }, {
