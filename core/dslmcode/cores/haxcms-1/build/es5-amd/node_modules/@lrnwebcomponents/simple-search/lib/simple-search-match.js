define(["exports", "../../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  function _templateObject2_39f59260833211ea85a195fb4be801bd() {
    ...
    _templateObject2_39f59260833211ea85a195fb4be801bd = function _templateObject2_39f59260833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject_39f59260833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n    "]);

    _templateObject_39f59260833211ea85a195fb4be801bd = function _templateObject_39f59260833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleSearchMatch, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_39f59260833211ea85a195fb4be801bd());
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_39f59260833211ea85a195fb4be801bd())];
      }
    }]);
