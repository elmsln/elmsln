define(["exports", "../../../../@polymer/polymer/polymer-element.js", "./rich-text-editor-button.js"], function (_exports, _polymerElement, _richTextEditorButton) {
  "use strict";
  ...
  function (_RichTextEditorButton) {
    ...
    function RichTextEditorMoreButton() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(RichTextEditorMoreButton).call(this));
    ...
    babelHelpers.createClass(RichTextEditorMoreButton, [{
      key: "_buttonTap",
      ...
      value: function _buttonTap(e) {
        this.dispatchEvent(new CustomEvent("rich-text-more-button-tap", {
          detail: this
        }));
      }
    }], [{
  ...
  window.customElements.define(RichTextEditorMoreButton.tag, RichTextEditorMoreButton);
});