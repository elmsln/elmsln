...
if(this.value){this.option="url"}else{this.option="fileupload"}this.shadowRoot.querySelector("#picker").addEventListener("change",function(e){if(e&&e.detail&&"selfie"===e.detail.value)_this3._takeSelfie(e);if(e&&e.detail&&"audio"===e.detail.value)_this3._voiceRecorder(e)})}/**
   ...
   */},{key:"_resolveObjectPath",value:function _resolveObjectPath(path,obj){return path.split(".").reduce(function(prev,curr){return prev?prev[curr]:null},obj||self)}}],[{key:"properties",get:function get(){return{label:{type:String},value:{type:String},option:{type:String},options:{type:Array},/**
