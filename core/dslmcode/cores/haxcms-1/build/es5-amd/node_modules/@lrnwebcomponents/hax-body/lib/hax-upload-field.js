define(["exports", "../../../lit/index.js", "../../simple-fields/lib/simple-fields-upload.js", "../../utils/utils.js", "./hax-store.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, _index, _simpleFieldsUpload, _utils, _haxStore, _I18NMixin) {
  "use strict";
    ...
    babelHelpers.createClass(HaxUploadField, [{
      ...
      value: function _haxAppPickerSelection(e) {
        ...
        if (_haxStore.HAXStore.connectionRewrites.appendJwt != null) {
          requestEndPoint += "&" + _haxStore.HAXStore.connectionRewrites.appendJwt + "=" + (0, _utils.localStorageGet)(_haxStore.HAXStore.connectionRewrites.appendJwt);
        }
