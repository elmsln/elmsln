define(["exports", "../../../@polymer/polymer/polymer-element.js", "./a11y-media-behaviors.js"], function (_exports, _polymerElement, _a11yMediaBehaviors) {
  ...
  function _templateObject_656799502d8511ea80ccf124101da415() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style include=\"simple-colors-shared-styles-polymer\">\n        :host {\n          height: 100%;\n          display: flex;\n          align-items: stretch;\n          position: relative;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n        #video {\n          width: 100%;\n          max-width: 100%;\n        }\n      </style>\n      <video\n        id=\"video\"\n        aria-hidden$=\"[[isYoutube]]\"\n        autoplay$=\"[[autoplay]]\"\n        crossorigin$=\"[[crossorigin]]\"\n        hidden$=\"[[audioOnly]]\"\n        lang$=\"[[mediaLang]]\"\n        on-loadedmetadata=\"_handleMetadata\"\n        poster$=\"[[thumbnailSrc]]\"\n        src$=\"[[manifest]]\"\n        preload=\"metadata\"\n      >\n        HTML5 video not supported\n      </video>\n      <audio\n        id=\"audio\"\n        autoplay$=\"[[autoplay]]\"\n        crossorigin$=\"[[crossorigin]]\"\n        hidden$=\"[[!audioOnly]]\"\n        lang$=\"[[mediaLang]]\"\n        on-loadedmetadata=\"_handleMetadata\"\n        poster$=\"[[thumbnailSrc]]\"\n        preload=\"metadata\"\n      >\n        HTML5 audio not supported\n      </audio>\n    "]);

    _templateObject_656799502d8511ea80ccf124101da415 = function _templateObject_656799502d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function (_A11yMediaBehaviors) {
    ...
    function A11yMediaHtml5() {
      ...
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(A11yMediaHtml5).call(this));
    } //render function
    ...
    babelHelpers.createClass(A11yMediaHtml5, [{
      ...
      value: function ready() {
        ...
        var root = this;
        root.media = root.shadowRoot.querySelector("#video") !== undefined && !root.audioOnly ? root.shadowRoot.querySelector("#video") : root.shadowRoot.querySelector("#audio");
      }
      /**
      ...
      value: function setCC(mode) {
        ...
        if (this.selectedTrack !== undefined && mode == true) {
          ...
          this.shadowRoot.querySelector("#video").textTracks.value = this.selectedTrackId;
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_656799502d8511ea80ccf124101da415());
      }
    }]);
