define(["./lib/colors.js", "./lib/shapes.js"], function (_colors, _shapes) {
  "use strict";
  ...
  window.MaterializeCSSBehaviors.ColorBehaviors = {
    ...
    getColorClasses: function getColorClasses() {
      var parta = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
      var partb = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
      var colorClasses = {
        "#ffffff": "white",
        "#000000": "black",
     ...
     */
    _colorTransform: function _colorTransform(item, parta, partb) {
      var colorClasses = this.getColorClasses(parta, partb);
     ...
     */
    _colorTransformFromClass: function _colorTransformFromClass(color) {
      var colorClasses = this.getColorClasses();
      var hexColor = null;
