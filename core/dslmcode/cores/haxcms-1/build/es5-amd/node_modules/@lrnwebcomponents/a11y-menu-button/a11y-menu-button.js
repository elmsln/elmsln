define(["exports", "../../lit/index.js", "./lib/a11y-menu-button-item.js", "../absolute-position-behavior/absolute-position-behavior.js", "../utils/utils.js"], function (_exports, _index, _a11yMenuButtonItem, _absolutePositionBehavior, _utils) {
  "use strict";
  ...
  var _templateObject_72f1dce04fbd11edb93baf2315d3222f, _templateObject2_72f1dce04fbd11edb93baf2315d3222f, _templateObject3_72f1dce04fbd11edb93baf2315d3222f, _templateObject4_72f1dce04fbd11edb93baf2315d3222f, _templateObject5_72f1dce04fbd11edb93baf2315d3222f, _templateObject6_72f1dce04fbd11edb93baf2315d3222f;
  ...
  var A11yMenuButtonBehaviors = function A11yMenuButtonBehaviors(SuperClass) {
    return /*#__PURE__*/function (_SuperClass) {
      ...
      function _class() {
        ...
        _this.offset = 0;
        _this.menuItems = [];
        _this.keepOpenOnClick = false;
        _this.noOpenOnHover = false;
        babelHelpers.toConsumableArray(_this.children).filter(function (n) {
          return n.slot === "menuitem";
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function render() {
          return (0, _index.html)(_templateObject_72f1dce04fbd11edb93baf2315d3222f || (_templateObject_72f1dce04fbd11edb93baf2315d3222f = babelHelpers.taggedTemplateLiteral([" ", " ", " "])), this.buttonTemplate, this.menuTemplate);
        }
      }, {
        key: "menuTemplate",
        get: function get() {
          ...
          return (0, _index.html)(_templateObject2_72f1dce04fbd11edb93baf2315d3222f || (_templateObject2_72f1dce04fbd11edb93baf2315d3222f = babelHelpers.taggedTemplateLiteral(["\n        <absolute-position-behavior\n          ?auto=\"", "\"\n          for=\"menubutton\"\n          position=\"", "\"\n          position-align=\"", "\"\n          .offset=\"", "\"\n          fit-to-visible-bounds\n          part=\"menu-outer\"\n        >\n          <ul\n            id=\"menu\"\n            role=\"menu\"\n            aria-labelledby=\"menubutton\"\n            ?hidden=\"", "\"\n            @mousover=\"", "\"\n            @mousout=\"", "\"\n            part=\"menu\"\n          >\n            ", "\n          </ul>\n        </absolute-position-behavior>\n      "])), this.expanded, this.position, this.positionAlign, this.offset, !this.expanded, function (e) {
        ...
        key: "buttonTemplate",
        get: function get() {
          return (0, _index.html)(_templateObject3_72f1dce04fbd11edb93baf2315d3222f || (_templateObject3_72f1dce04fbd11edb93baf2315d3222f = babelHelpers.taggedTemplateLiteral(["\n        <button\n          id=\"menubutton\"\n          aria-haspopup=\"true\"\n          aria-controls=\"menu\"\n          aria-expanded=\"", "\"\n          part=\"button\"\n        >\n          <slot name=\"button\"></slot>\n        </button>\n      "])), this.expanded ? "true" : "false");
        }
        /**
        ...
        get: function get() {
          return (0, _index.html)(_templateObject4_72f1dce04fbd11edb93baf2315d3222f || (_templateObject4_72f1dce04fbd11edb93baf2315d3222f = babelHelpers.taggedTemplateLiteral(["<slot name=\"menuitem\"></slot><slot></slot>"])));
        }
        /**
        ...
        value: function getItemIndex() {
          ...
          var index = -1;
          this.menuItems.forEach(function (b, i) {
            if (b === _this4.currentItem) index = i;
          });
          return index;
        }
        /**
        ...
        value: function getItem() {
          ...
          return !this.menuItems || index < 0 || this.menuItems.length <= index ? undefined : this.menuItems[index];
        }
        /**
        ...
        value: function addItem(item) {
          ...
          Object.keys(listeners).forEach(function (evt) {
            return item.addEventListener(evt, listeners[evt].bind(_this5));
          });
        ...
        value: function removeItem(item) {
          ...
          var listeners = this.itemListeners;
          if (this.menuItems) this.menuItems = babelHelpers.toConsumableArray(this.menuItems.filter(function (i) {
            return item !== i;
          }));
          Object.keys(listeners).forEach(function (evt) {
            return item.removeEventListener(evt, listeners[evt].bind(_this6));
          });
        }
        /**
        ...
        value: function _handleItemKeydown(event) {
          var flag = false,
            ...
            return str.length === 1 && str.match(/\S/);
              ...
              path = (0, _utils.normalizeEventPath)(event) || [],
              target = path[0]; //don't handle form field keystrokes


          if (!isPrintableCharacter(char) && (["INPUT", "TEXTAREA", "SELECT"].includes(target.tagName) || this._excludeEvent(event))) return;
         ...
         */
        function get() {
          return [(0, _index.css)(_templateObject5_72f1dce04fbd11edb93baf2315d3222f || (_templateObject5_72f1dce04fbd11edb93baf2315d3222f = babelHelpers.taggedTemplateLiteral(["\n          :host {\n            padding: 0;\n            display: inline-flex;\n            position: relative;\n            z-index: 1;\n          }\n          :host([expanded]) {\n            z-index: var(--a11y-menu-button-focus-z-index, 1000);\n          }\n          button[part=\"button\"] {\n            display: block;\n            text-decoration: inherit;\n            font-family: inherit;\n            font-size: inherit;\n            margin: 0;\n            width: 100%;\n          }\n          absolute-position-behavior {\n            z-index: -1;\n            overflow: hidden;\n            transition: z-index 0s;\n          }\n          :host([expanded]) absolute-position-behavior {\n            z-index: var(--a11y-menu-button-focus-z-index, 1000);\n            transition: z-index 0s;\n          }\n          :host(:not([expanded])) absolute-position-behavior {\n            border-color: none !important;\n          }\n          ul {\n            margin: 0;\n            padding: 0;\n            list-style: none;\n          }\n        "])))];
        }
        /**
  ...
  var A11yMenuButton = /*#__PURE__*/function (_A11yMenuButtonBehavi) {
    ...
    return babelHelpers.createClass(A11yMenuButton);
