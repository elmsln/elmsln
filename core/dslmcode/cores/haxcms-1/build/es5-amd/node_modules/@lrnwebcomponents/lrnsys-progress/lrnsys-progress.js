define(["exports", "meta", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../../@polymer/polymer/lib/utils/resolve-url.js", "../../@polymer/paper-progress/paper-progress.js", "./lib/lrnsys-progress-circle.js"], function (_exports, meta, _polymerElement, _renderStatus, _resolveUrl, _paperProgress, _lrnsysProgressCircle) {
  "use strict";
  ...
  function _templateObject_b7e69be0e53211e9a0cfefb808989d41() {
    ...
    _templateObject_b7e69be0e53211e9a0cfefb808989d41 = function _templateObject_b7e69be0e53211e9a0cfefb808989d41() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    function LrnsysProgress() {
      ...
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrnsysProgress).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(LrnsysProgress, [{
       ...
       */
      value: function _getStrokeWidth(size) {
        var width = 4;
      ...
      value: function _itemsChanged(newValue, oldValue) {
        ...
        if (babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue.length != oldValue.length && babelHelpers.typeof(this._responseList[this.active]) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          if (babelHelpers.typeof(newValue[this.active].dataUrl) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !this.disableAjaxCalls) {
            ...
            setTimeout(function () {
              newValue[_this.active].metadata.status = "available";

              _this.set("items." + _this.active + ".metadata.status", "available");

              _this.notifyPath("items." + _this.active + ".metadata.status");

              _this._responseList[_this.active] = {};
              _this.activeNodeResponse = _this._responseList[_this.active];
            }, 1200);
          }
        }
      }
      ...
      value: function _activeChanged(newValue, oldValue) {
        ...
        this.items.forEach(function (element, index, array) {
          ...
          if (_this2.items[index].metadata.status == "disabled") {
            // do nothing, it's disabled unless....
            if (index != 0 && _this2.progressiveUnlock && _this2.items[index - 1].metadata.status == "complete") {
              _this2.items[index].metadata.status = "loading";

              _this2.set("items." + index + ".metadata.status", "loading");

              _this2.notifyPath("items." + index + ".metadata.status");
            }
          } // or if our value is at max AND it's the last item in the list
          else if (_this2.items[index].metadata.value >= _this2.items[index].metadata.max && index == _this2.items.length - 1) {
              _this2.items[index].metadata.status = "finished";

              _this2.set("items." + index + ".metadata.status", "finished");

              _this2.notifyPath("items." + index + ".metadata.status");
            } // or if we're just at max then mark us complete
            else if (_this2.items[index].metadata.value >= _this2.items[index].metadata.max) {
                _this2.items[index].metadata.status = "complete";

                _this2.set("items." + index + ".metadata.status", "complete");
                ...
                _this2.notifyPath("items." + index + ".metadata.status");
                  ...
                  if (babelHelpers.typeof(_this2._responseList[index]) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                    _this2.items[index].metadata.status = "loading";
                    ...
                    _this2.notifyPath("items." + index + ".metadata.status");
                      ...
                      _this2.activeNodeResponse = _this2._responseList[index];
                      _this2.items[index].metadata.status = "available";
      ...
      value: function _statusChanged(e) {
        ...
        if (e.target.status == "loading") {
          if (babelHelpers.typeof(this.items[this.active].metadata.dataUrl) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !this.disableAjaxCalls) {
            ...
            setTimeout(function () {
              _this3.items[_this3.active].metadata.status = "available";

              _this3.set("items." + _this3.active + ".metadata.status", "available");

              _this3.notifyPath("items." + _this3.active + ".metadata.status");

              _this3._responseList[_this3.active] = {};
              _this3.activeNodeResponse = _this3._responseList[_this3.active];
            }, 1500);
          }
        } else if (e.target.status == "complete" && this.items.length === this.active + 1) {
          setTimeout(function () {
            _this3.items[_this3.active].metadata.status = "finished";

            _this3.set("items." + _this3.active + ".metadata.status", "finished");
      ...
      value: function handleNodeResponse(e) {
        ...
        if (babelHelpers.typeof(detail.response) === babelHelpers.typeof(null)) {
          setTimeout(function () {
            ...
            _this4._responseList[_this4.active] = detail.response;
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_b7e69be0e53211e9a0cfefb808989d41());
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      get: function get() {
        return {
          ...
          completeSound: {
            type: String,
            value: (0, _resolveUrl.pathFromUrl)(decodeURIComponent(meta.url)) + "lib/assets/complete.mp3",
            reflectToAttribute: true
          },
          ...
          finishedSound: {
            type: String,
            value: (0, _resolveUrl.pathFromUrl)(decodeURIComponent(meta.url)) + "lib/assets/finished.mp3",
            reflectToAttribute: true
          },
