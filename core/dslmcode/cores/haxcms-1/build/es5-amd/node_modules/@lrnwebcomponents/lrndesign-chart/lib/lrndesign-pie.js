define(["exports", "../lrndesign-chart.js"], function (_exports, _lrndesignChart) {
  ...
  function (_LrndesignChart) {
    ...
    function LrndesignPie() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrndesignPie).call(this));
    ...
    babelHelpers.createClass(LrndesignPie, [{
      ...
      value: function _getOptions() {
        var options = babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignPie.prototype), "_getOptions", this).call(this);
      ...
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignPie), "properties", this), {
          /**
      ...
      get: function get() {
        ...
        haxProps.settings.configure = haxProps.settings.configure.concat(pieQuick, pieConfig);
        haxProps.settings.advanced = haxProps.settings.configure.advanced(pieAdvanced);
        return haxProps;
      }
    }]);
    return LrndesignPie;
