define(["exports", "require", "../../lit-element/lit-element.js", "../responsive-utility/responsive-utility.js"], function (_exports, _require, _litElement, _responsiveUtility) {
  ...
  function _templateObject2_a131ff303ee611ea9b2edd59a4f93ed0() {
    ...
    _templateObject2_a131ff303ee611ea9b2edd59a4f93ed0 = function _templateObject2_a131ff303ee611ea9b2edd59a4f93ed0() {
      return data;
    };
  ...
  function _templateObject_a131ff303ee611ea9b2edd59a4f93ed0() {
    ...
    _templateObject_a131ff303ee611ea9b2edd59a4f93ed0 = function _templateObject_a131ff303ee611ea9b2edd59a4f93ed0() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(GridPlate, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_a131ff303ee611ea9b2edd59a4f93ed0())];
      }
    }]);
    ...
    babelHelpers.createClass(GridPlate, [{
      ...
      value: function __sortChildren() {
        ...
        var children = Array.prototype.slice.call(this.querySelectorAll("[slot]"), 0); // sort the children by slot id being low to high
      ...
      value: function dropEvent(e) {
        ...
        if (this.editMode) {
          ...
          setTimeout(function () {
            var children = _this6.children; // walk the children and apply the draggable state needed
            ...
            for (var j = 1; j <= _this6.columns; j++) {
              if (_this6.shadowRoot.querySelector("#col" + j) !== undefined) {
                _this6.shadowRoot.querySelector("#col" + j).classList.remove("mover", "hovered", "moving");
              }
