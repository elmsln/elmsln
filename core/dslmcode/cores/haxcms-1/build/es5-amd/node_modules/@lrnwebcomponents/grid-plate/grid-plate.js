define(["exports", "require", "../../lit-element/lit-element.js", "../responsive-utility/responsive-utility.js"], function (_exports, _require, _litElement, _responsiveUtility) {
  ...
  function _templateObject2_c93fb9902da211eaa247b36e11306899() {
    ...
    _templateObject2_c93fb9902da211eaa247b36e11306899 = function _templateObject2_c93fb9902da211eaa247b36e11306899() {
      return data;
    };
  ...
  function _templateObject_c93fb9902da211eaa247b36e11306899() {
    ...
    _templateObject_c93fb9902da211eaa247b36e11306899 = function _templateObject_c93fb9902da211eaa247b36e11306899() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(GridPlate, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_c93fb9902da211eaa247b36e11306899())];
      }
    }]);
    ...
    babelHelpers.createClass(GridPlate, [{
      ...
      value: function dropEvent(e) {
        ...
        if (this.editMode) {
          ...
          setTimeout(function () {
            var children = _this5.children; // walk the children and apply the draggable state needed
            ...
            for (var j = 1; j <= _this5.columns; j++) {
              if (_this5.shadowRoot.querySelector("#col" + j) !== undefined) {
                _this5.shadowRoot.querySelector("#col" + j).classList.remove("mover", "hovered", "moving");
              }
          ...
          }, 0); // edge case, something caused this to drag and it tried to do
          // itself into itself
          ...
          setTimeout(function () {
            ...
            if (window.HaxStore && window.HaxStore.ready && window.HaxStore.instance) {
              if (target.parentNode.tagName === "GRID-PLATE") {
                window.HaxStore.write("activeNode", target, _this5);
                window.HaxStore.write("activeContainerNode", target.parentNode, _this5);
                setTimeout(function () {
      ...
      value: function dragEnd(e) {
        if (this.editMode) {
          ...
          for (var j = 1; j <= this.columns; j++) {
            if (this.shadowRoot.querySelector("#col" + j) !== undefined) {
              this.shadowRoot.querySelector("#col" + j).classList.remove("mover", "hovered", "moving");
            }
          }
        }
      }
      ...
      get: function get() {
        return {
          ...
          saveOptions: {
            unsetAttributes: ["grid-plate-active-item", "edit-mode", "active-item", "layouts", "columns", "options", "droppable", "ignorehax", "disableresponsive", "activeitem"]
          }
        };
      }
    }, {
