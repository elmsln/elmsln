define(["exports"], function (_exports) {
  ...
  function (_HTMLElement) {
    ...
    babelHelpers.createClass(PortalLauncher, null, [{
      key: "tag",
    ...
    function PortalLauncher() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(PortalLauncher).call(this)); // set tag for later use
    ...
    babelHelpers.createClass(PortalLauncher, [{
      ...
      value: function click(e) {
        var target = e.target; // support walking the path in order to find the link clicked
