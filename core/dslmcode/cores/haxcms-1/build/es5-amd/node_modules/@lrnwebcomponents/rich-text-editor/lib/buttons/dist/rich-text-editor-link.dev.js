...
var RichTextEditorLink = /*#__PURE__*/function (_RichTextEditorPrompt) {
  ...
  _createClass(RichTextEditorLink, [{
    ...
    value: function render() {
      return _get(_getPrototypeOf(RichTextEditorLink.prototype), "render", this).call(this);
    ...
    key: "properties",
    get: function get() {
      return _objectSpread({}, _get(_getPrototypeOf(RichTextEditorLink), "properties", this), {
        /**
  ...
  function RichTextEditorLink() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(RichTextEditorLink).call(this));
    _this.fields = [].concat(_toConsumableArray(_get(_getPrototypeOf(RichTextEditorLink.prototype), "fields", _assertThisInitialized(_this))), [{
      property: "href",
      title: "Link",
      inputMethod: "url",
      autoValidate: true
    ...
    _this.toggles = "true";
    _this.tagsList = "a";
    _this.value = _objectSpread({}, _get(_getPrototypeOf(RichTextEditorLink.prototype), "value", _assertThisInitialized(_this)), {
      href: null
    });
  ...
  _createClass(RichTextEditorLink, [{
    ...
    value: function updated(changedProperties) {
      ...
      if (_get(_getPrototypeOf(RichTextEditorLink.prototype), "updated", this)) _get(_getPrototypeOf(RichTextEditorLink.prototype), "updated", this).call(this, changedProperties);
      changedProperties.forEach(function (oldValue, propName) {
        if (propName === "allowTarget") {
          var fields = [].concat(_toConsumableArray(_get(_getPrototypeOf(RichTextEditorLink.prototype), "fields", _this2)), [{
            property: "href",
            title: "Link",
            inputMethod: "url",
            autoValidate: true
          }]);
          _this2.fields = _this2.allowTarget ? _objectSpread({}, fields) : _objectSpread({}, fields, {
            allowTarget: {
              property: "target",
              title: "Target",
    ...
    value: function getValue(node) {
      ...
      return _objectSpread({}, _get(_getPrototypeOf(RichTextEditorLink.prototype), "getValue", this).call(this), {
        target: this.allowTarget && target.getAttribute ? target.getAttribute("target") : undefined,
        href: target && target.getAttribute ? target.getAttribute("href") : undefined
      });
    }
    /**
     * overrides RichTextEditorPromptButtonBehaviors
