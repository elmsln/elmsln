(function (root, factory) {
  ...
  (function (window, document, Chartist) {
    ...
    Chartist.extend = function (target) {
      ...
      for (i = 1; i < arguments.length; i++) {
        ...
        for (var prop in source) {
          ...
          if (babelHelpers.typeof(sourceProp) === "object" && sourceProp !== null && !babelHelpers.instanceof(sourceProp, Array)) {
    ...
    Chartist.querySelector = function (query) {
      return babelHelpers.instanceof(query, Node) ? query : document.querySelector(query);
    };
    /**
    ...
    Chartist.serialize = function (data) {
      if (data === null || data === undefined) {
        ...
        data = "" + data;
      } else if (babelHelpers.typeof(data) === "object") {
        data = JSON.stringify({
          data: data
        });
      }
    ...
    Chartist.normalizeData = function (data, reverse, multi) {
      ...
      if (output.normalized.series.every(function (value) {
        return babelHelpers.instanceof(value, Array);
      })) {
    ...
    Chartist.safeHasProperty = function (object, property) {
      return object !== null && babelHelpers.typeof(object) === "object" && object.hasOwnProperty(property);
    };
    /**
    ...
    Chartist.reverseData = function (data) {
      ...
      for (var i = 0; i < data.series.length; i++) {
        if (babelHelpers.typeof(data.series[i]) === "object" && data.series[i].data !== undefined) {
          data.series[i].data.reverse();
        } else if (babelHelpers.instanceof(data.series[i], Array)) {
    ...
    Chartist.getDataArray = function (data, reverse, multi) {
      ...
      function recursiveConvert(value) {
        ...
        } else if (babelHelpers.instanceof(value, Array)) {
    ...
    Chartist.getHighLow = function (data, options, dimension) {
      ...
      function recursiveHighLow(data) {
        if (data === undefined) {
          return undefined;
        } else if (babelHelpers.instanceof(data, Array)) {
    ...
    Chartist.isMultiValue = function (value) {
      return babelHelpers.typeof(value) === "object" && ("x" in value || "y" in value);
    };
    /**
    ...
    function initialize() {
      ...
      if (this.options.plugins) {
        this.options.plugins.forEach(function (plugin) {
          if (babelHelpers.instanceof(plugin, Array)) {
  ...
  (function (window, document, Chartist) {
    ...
    function Svg(name, attributes, className, parent, insertFirst) {
      ...
      if (babelHelpers.instanceof(name, Element)) {
        this._node = name;
      } else {
    ...
    function parent() {
      return babelHelpers.instanceof(this._node.parentNode, SVGElement) ? new Chartist.Svg(this._node.parentNode) : null;
    }
    /**
      ...
      Object.keys(animations).forEach(function createAnimateForAttributes(attribute) {
        function createAnimate(animationDefinition, guided) {
          ...
          if (animationDefinition.easing) {
            ...
            easing = babelHelpers.instanceof(animationDefinition.easing, Array) ? animationDefinition.easing : Chartist.Svg.Easing[animationDefinition.easing];
        ...
        if (babelHelpers.instanceof(animations[attribute], Array)) {
    ...
    function createChart(options) {
      ...
      data.raw.series.forEach(function (series, seriesIndex) {
        ...
        data.normalized.series[seriesIndex].forEach(function (value, valueIndex) {
          ...
          if (babelHelpers.instanceof(labelAxis, Chartist.StepAxis)) {
