define(["exports","./hax-app.js"],function(_exports,_haxApp){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.HAXStax=void 0;/**
 `hax-stax`
...
```
*/var HAXStax=/*#__PURE__*/function(_HAXApp){babelHelpers.inherits(HAXStax,_HAXApp);function HAXStax(){var _this;babelHelpers.classCallCheck(this,HAXStax);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HAXStax).call(this));_this.eventName="hax-register-stax";return _this}babelHelpers.createClass(HAXStax,null,[{key:"tag",get:function get(){return"hax-stax"}}]);return HAXStax}(_haxApp.HAXApp);_exports.HAXStax=HAXStax;window.customElements.define(HAXStax.tag,HAXStax)});