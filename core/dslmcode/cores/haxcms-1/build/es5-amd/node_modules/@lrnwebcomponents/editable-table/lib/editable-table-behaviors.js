      ...
      function (_SuperClass) {
        ...
        babelHelpers.createClass(_class, [{
          ...
          value: function ready() {
            babelHelpers.get(babelHelpers.getPrototypeOf(_class.prototype), "ready", this).call(this);
            /*
              only import slotted HTML if there is no taable data
            */

            if ((this.data.length < 1 || this.data[0].length < 1) && this.querySelector("table") !== null) this.importHTML(this.querySelector("table"));
          }
          /**
          ...
          value: function getTableCSV() {
            ...
            return this.data.map(function (row) {
              return row.map(function (cell) {
                cell = _this2._replaceBlankCell(cell);
                return _this2._isNumeric(cell) ? cell.replace(/,/g, "") : "\"".concat(cell, "\"");
              }).join(",");
            }).join("\n");
          }
          /**
          ...
          value: function getTableHTML() {
            ...
            var getTR = function getTR(tr) {
              ...
              var th = _this3.rowHeader ? tr.slice(0, 1) : [],
                  td = _this3.rowHeader ? tr.slice(1) : tr;
              return "\n\t\t<tr>".concat(th.map(function (cell) {
                return "\n\t\t\t<th scope=\"row\">".concat(_this3._replaceBlankCell(cell), "</th>");
              }).join("")).concat(td.map(function (cell) {
                return "\n\t\t\t<".concat(open, ">").concat(_this3._replaceBlankCell(cell), "</").concat(close, ">");
              }).join(""), "\n\t\t</tr>");
            },
