define(["exports"],function(_exports){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.editBehaviors=_exports.cellBehaviors=_exports.displayBehaviors=void 0;/**
 ...
 */var displayBehaviors=function displayBehaviors(SuperClass){return(/*#__PURE__*/function(_SuperClass){babelHelpers.inherits(_class,_SuperClass);function _class(){babelHelpers.classCallCheck(this,_class);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(_class).apply(this,arguments))}babelHelpers.createClass(_class,[{key:"getData",/**
     * Return table data
     */value:function getData(){var data={accentColor:this.accentColor,bordered:!this.hideBordered?this.bordered:null,caption:this.caption,columnHeader:this.columnHeader,condensed:!this.hideCondensed?this.condensed:null,dark:!this.hideDark?this.dark:null,data:this.data,filter:!this.hideFilter?this.filter:null,footer:this.footer,rowHeader:this.rowHeader,scroll:!this.hideScroll?this.scroll:null,sort:!this.hideSort?this.sort:null,striped:!this.hideStriped?this.striped:null,summary:this.summary};return data}}],[{key:"properties",get:function get(){var props={/**
     ...
     */},{key:"_getLetter",value:function _getLetter(index){var place=Math.floor(index/26),multiplier=26*place,remainder=index-multiplier,letters="";letters+=remainder+"-";if(0<place&&26>place){letters+=place-1+"-"}else if(26<=place){letters+=this._getLetter(place-1)}return letters}}]);return _class2}(SuperClass))};_exports.cellBehaviors=cellBehaviors;var editBehaviors=function editBehaviors(SuperClass){return(/*#__PURE__*/function(_SuperClass3){babelHelpers.inherits(_class3,_SuperClass3);function _class3(){babelHelpers.classCallCheck(this,_class3);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(_class3).apply(this,arguments))}babelHelpers.createClass(_class3,null,[{key:"properties",get:function get(){var props={/**
         ...
         */hideStriped:{type:Boolean,value:!1}};if(babelHelpers.get(babelHelpers.getPrototypeOf(_class3),"properties",this)){props=Object.assign(props,babelHelpers.get(babelHelpers.getPrototypeOf(_class3),"properties",this))}return props}}]);return _class3}(SuperClass))};_exports.editBehaviors=editBehaviors});