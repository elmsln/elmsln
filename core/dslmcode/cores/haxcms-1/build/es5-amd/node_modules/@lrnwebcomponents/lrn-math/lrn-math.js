define(["exports"], function (_exports) {
  ...
  var LrnMathController =
  /*#__PURE__*/
  function (_HTMLElement) {
    babelHelpers.inherits(LrnMathController, _HTMLElement);

    function LrnMathController() {
      babelHelpers.classCallCheck(this, LrnMathController);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrnMathController).apply(this, arguments));
    }

    babelHelpers.createClass(LrnMathController, [{
  ...
  */
  ...
  function (_HTMLElement2) {
    babelHelpers.inherits(LrnMath, _HTMLElement2);

    function LrnMath() {
      var _this;

      babelHelpers.classCallCheck(this, LrnMath);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrnMath).call(this));
    ...
    babelHelpers.createClass(LrnMath, [{
      key: "connectedCallback",
      value: function connectedCallback() {
        var elem = this;
        check_handler();
