define(["exports", "../../../@polymer/polymer/polymer-element.js", "./extensible-toolbar-button.js", "../../simple-picker/simple-picker.js", "../../es-global-bridge/es-global-bridge.js"], function (_exports, _polymerElement, _extensibleToolbarButton, _simplePicker, _esGlobalBridge) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.ExtensibleToolbarPicker = void 0;

  function _templateObject_ffbe81a0e48111e9b5c6f7b0a264592f() {
    ...
    _templateObject_ffbe81a0e48111e9b5c6f7b0a264592f = function _templateObject_ffbe81a0e48111e9b5c6f7b0a264592f() {
      return data;
    };
   ...
   * @polymer
   */
  var ExtensibleToolbarPicker =
  /*#__PURE__*/
  function (_ExtensibleToolbarBut) {
    babelHelpers.inherits(ExtensibleToolbarPicker, _ExtensibleToolbarBut);

    function ExtensibleToolbarPicker() {
      var _this;

      babelHelpers.classCallCheck(this, ExtensibleToolbarPicker);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(ExtensibleToolbarPicker).call(this));
      _this.label = "Insert link";
      return _this;
    } // render function


    babelHelpers.createClass(ExtensibleToolbarPicker, [{
      key: "_isToggled",
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_ffbe81a0e48111e9b5c6f7b0a264592f());
    ...
    return ExtensibleToolbarPicker;
  }(_extensibleToolbarButton.ExtensibleToolbarButton);

  _exports.ExtensibleToolbarPicker = ExtensibleToolbarPicker;
  window.customElements.define(ExtensibleToolbarPicker.tag, ExtensibleToolbarPicker);
});