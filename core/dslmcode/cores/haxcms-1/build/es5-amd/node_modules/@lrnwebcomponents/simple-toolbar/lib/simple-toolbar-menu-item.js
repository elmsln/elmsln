define(["exports", "../../../lit/index.js", "../../a11y-menu-button/lib/a11y-menu-button-item.js"], function (_exports, _index, _a11yMenuButtonItem) {
  ...
  var _templateObject_028fd6607fe611edbfd7dd19f6a31344, _templateObject2_028fd6607fe611edbfd7dd19f6a31344;
  ...
  var SimpleToolbarMenuItem = /*#__PURE__*/function (_A11yMenuButtonItemBe) {
    ...
    babelHelpers.createClass(SimpleToolbarMenuItem, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_028fd6607fe611edbfd7dd19f6a31344 || (_templateObject_028fd6607fe611edbfd7dd19f6a31344 = babelHelpers.taggedTemplateLiteral(["\n      <li role=\"none\">\n        <slot></slot>\n      </li>\n    "])));
      }
    }, {
      key: "menuItem",
      get:
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleToolbarMenuItem), "styles", this)), [(0, _index.css)(_templateObject2_028fd6607fe611edbfd7dd19f6a31344 || (_templateObject2_028fd6607fe611edbfd7dd19f6a31344 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          --simple-toolbar-button-min-width: 100% !important;\n        }\n        ::slotted(*) {\n          --simple-toolbar-border-radius: 0px;\n          display: flex;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
