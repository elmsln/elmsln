define(["exports", "../../../lit/index.js", "../../rich-text-editor/lib/toolbars/rich-text-editor-toolbar.js", "./hax-text-editor-button.js", "./hax-store.js", "./hax-context-behaviors.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, _index, _richTextEditorToolbar, _haxTextEditorButton, _haxStore, _haxContextBehaviors, _I18NMixin) {
  "use strict";
  ...
  var _templateObject_db4f3920f9f811eba5a28d25d08c9378, _templateObject2_db4f3920f9f811eba5a28d25d08c9378;
  ...
  var HaxTextEditorToolbar = /*#__PURE__*/function (_RichTextEditorToolba) {
    ...
    babelHelpers.createClass(HaxTextEditorToolbar, [{
      key: "tourTemplate",
      get: function get() {
        return (0, _index.html)(_templateObject_db4f3920f9f811eba5a28d25d08c9378 || (_templateObject_db4f3920f9f811eba5a28d25d08c9378 = babelHelpers.taggedTemplateLiteral([" <div slot=\"tour\" data-stop-content>\n      ", "\n    </div>"])), this.t.textEditorToolbarTour);
      } // render function
      ...
      value: function updateBlocks() {
        var currentTag = !!this.formatButtonElement && !!this.formatButtonElement.rangeOrMatchingAncestor && !!this.formatButtonElement.rangeOrMatchingAncestor() ? this.formatButtonElement.rangeOrMatchingAncestor().tagName : undefined;
