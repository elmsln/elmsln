define(["exports", "../../../lit-element/lit-element.js", "./elmsln-studio-utilities.js", "../../lorem-data/lorem-data.js"], function (_exports, _litElement, _elmslnStudioUtilities, _loremData) {
  ...
  function _templateObject2_5e0db56051d611eba9e8f7a417db1b23() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject2_5e0db56051d611eba9e8f7a417db1b23 = function _templateObject2_5e0db56051d611eba9e8f7a417db1b23() {
      return data;
    };
  ...
  function _templateObject_5e0db56051d611eba9e8f7a417db1b23() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <lorem-data id=\"lorem\" .schemas=\"", "\"></lorem-data>\n    "]);

    _templateObject_5e0db56051d611eba9e8f7a417db1b23 = function _templateObject_5e0db56051d611eba9e8f7a417db1b23() {
      return data;
    };
  ...
  var ElmslnStudioLoremdata = /*#__PURE__*/function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioLoremdata, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_5e0db56051d611eba9e8f7a417db1b23(), this.schemas || []);
      }
    }, {
      key: "firstUpdated",
      value: function firstUpdated(changedProperties) {
        ...
        Object.keys(this.assignments || {}).forEach(function (a, i) {
          ...
          creators.forEach(function (creator) {
            return _this2._submission(a, creator.id, topic, types, a.date, lorem);
          });
        });
        ...
        this.students.forEach(function (student) {
          return _this2.profiles[student.id] = _this2._profile(student, lorem);
        });
      ...
      value: function _profile(student, lorem) {
        ...
        profile.submissions = lorem.sortDates(Object.keys(this.submissions).filter(function (key) {
          return _this3.submissions[key].userId === profile.id;
        }).map(function (key) {
          return _this3.submissions[key];
        }));
        ...
        profile.feedback = lorem.sortDates(profile.submissions.map(function (submission) {
          ...
          return _this3.discussions[key];
        }));
        profile.given = Object.keys(this.discussions).filter(function (key) {
          return _this3.discussions[key].userId === profile.id;
        });
        profile.replies = Object.keys(this.discussions).map(function (key) {
          return _this3.discussions[key].replies.filter(function (reply) {
        ...
        if (!lorem) {
          ...
          return {
            ...
            assignments: project.assignments.map(function (a, i) {
              return _this4._assignment(a, lessonId, project.id, i, lorem.addDays(date, i), lorem);
            })
          };
        }
      }
      ...
      value: function _submission(assignmentId, creatorId, topic, types, date, lorem) {
        ...
        if (lorem) {
          ...
          types.forEach(function (type) {
            return submission[type] = _this5._assets(type, topic, lorem);
          });
          this.activity.push({
            id: id,
            activity: "submission",
          ...
          this.submissions[id].feedback = lorem.shuffle([].concat(babelHelpers.toConsumableArray(reviewers), babelHelpers.toConsumableArray(instructors))).map(function (reviewer, i) {
            return _this5._feedback(id, reviewer.id, lorem.addMinutes(submitDate, (i + 1) * 64), lorem);
          });
      ...
      get: function get() {
        ...
        return Object.keys(this.users || {}).filter(function (u) {
          return _this7.users[u].instructor;
        }).map(function (s) {
          return _this7.users[s];
        });
      }
    }, {
      key: "schemas",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_5e0db56051d611eba9e8f7a417db1b23())];
      }
    }]);
