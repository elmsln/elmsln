define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/elements/dom-repeat.js"], function (_exports, _polymerElement, _domRepeat) {
  "use strict";
  ...
  function _templateObject_63e87090b3b911e9b58d79562a23326c() {
    ...
    _templateObject_63e87090b3b911e9b58d79562a23326c = function _templateObject_63e87090b3b911e9b58d79562a23326c() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(SimpleSearchContent, _PolymerElement);
    ...
    babelHelpers.createClass(SimpleSearchContent, [{
      ...
      value: function enableSearch(searchObject) {
        ...
        if (content[0].text === null) content[0].text = root.innerHTML; // set rendered content to default unsearched content
      ...
      value: function focus(matchNumber) {
        var result = this.$.content.querySelector('[match-number="' + matchNumber + '"]');
      ...
      key: "_getTabIndex",
      value: function _getTabIndex(matchNumber) {
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_63e87090b3b911e9b58d79562a23326c());
      }
    }]);
