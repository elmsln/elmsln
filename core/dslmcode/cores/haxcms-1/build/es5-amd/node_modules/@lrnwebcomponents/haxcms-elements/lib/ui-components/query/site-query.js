define(["exports", "../../../../../@polymer/polymer/polymer-element.js", "../../../../../@polymer/polymer/lib/mixins/mutable-data.js", "../../core/haxcms-site-store.js", "../../../../../mobx/lib/mobx.module.js"], function (_exports, _polymerElement, _mutableData, _haxcmsSiteStore, _mobxModule) {
  "use strict";
  ...
  function (_MutableData) {
    babelHelpers.inherits(SiteQuery, _MutableData);

    function SiteQuery() {
      babelHelpers.classCallCheck(this, SiteQuery);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SiteQuery).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(SiteQuery, [{
        ...
        if (routerManifest && routerManifest.items) {
          ...
          if (conditions && items) {
            ...
            for (var i in conditions) {
              ...
              if (babelHelpers.typeof(conditions[i]) !== "object") {
                conditions[i] = {
                  value: conditions[i],
                  operator: "="
                };
      ...
      key: "_noticeResultChange",
      value: function _noticeResultChange(newValue) {
