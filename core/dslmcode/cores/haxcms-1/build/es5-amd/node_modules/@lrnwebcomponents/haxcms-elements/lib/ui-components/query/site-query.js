...
for(var a=s.split("."),i=0,n=a.length,k;i<n;++i){k=a[i];if(k in o){o=o[k]}else{return}}return o};var SiteQuery=/*#__PURE__*/function(_MutableData){babelHelpers.inherits(SiteQuery,_MutableData);function SiteQuery(){babelHelpers.classCallCheck(this,SiteQuery);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SiteQuery).apply(this,arguments))}babelHelpers.createClass(SiteQuery,[{key:"_computeResult",/**
   * Compute what we should present as a slice of the real deal
   */value:function _computeResult(entity,conditions,sorts,routerManifest,activeId,limit,startIndex,random,forceRebuild){if(routerManifest&&routerManifest.items){// ensure no data references, clone object
...
items=items.filter(function(item){// specialized condition for active id
...
while(items.length>limit){items.pop()}}return items}return[]}/**
   ...
   */},{key:"_noticeResultChange",value:function _noticeResultChange(newValue){this.set("result",newValue);this.notifyPath("result")}/**
   * Connected life cycle
   */},{key:"connectedCallback",value:function connectedCallback(){var _this=this;babelHelpers.get(babelHelpers.getPrototypeOf(SiteQuery.prototype),"connectedCallback",this).call(this);this.__disposer=(0,_mobxModule.autorun)(function(){_this.routerManifest=Object.assign({},(0,_mobxModule.toJS)(_haxcmsSiteStore.store.routerManifest))});this.__disposer2=(0,_mobxModule.autorun)(function(){_this.activeId=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.activeId)})}/**
   * Disconnected life cycle
   */},{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(SiteQuery.prototype),"disconnectedCallback",this).call(this);this.__disposer();this.__disposer2()}}],[{key:"tag",/**
   ...
   */},{key:"properties",get:function get(){return{/**
       ...
       * Entity to focus on
       */entity:{type:String,value:"node"}}}}]);return SiteQuery}((0,_mutableData.MutableData)(_polymerElement.PolymerElement));_exports.SiteQuery=SiteQuery;window.customElements.define(SiteQuery.tag,SiteQuery)});