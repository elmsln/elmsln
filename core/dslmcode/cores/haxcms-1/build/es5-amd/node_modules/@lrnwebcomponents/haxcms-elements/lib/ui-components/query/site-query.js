define(["exports", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../utils/utils.js", "../../../../../mobx/lib/mobx.module.js"], function (_exports, _litElement, _haxcmsSiteStore, _utils, _mobxModule) {
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteQuery, null, [{
      key: "tag",
    ...
    function SiteQuery() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SiteQuery).call(this));
      _this.entity = "node";
      _this.conditions = {};
      _this.random = false;
      _this.sort = {
    ...
    babelHelpers.createClass(SiteQuery, [{
      ...
      value: function connectedCallback() {
        ...
        this.__disposer = (0, _mobxModule.autorun)(function () {
          _this3.routerManifest = Object.assign({}, (0, _mobxModule.toJS)(_haxcmsSiteStore.store.routerManifest));
        });
