define(["exports", "./haxcms-site-store.js", "../../../../mobx/lib/mobx.module.js", "../../../utils/utils.js", "../../../simple-colors-shared-styles/simple-colors-shared-styles.js"], function (_exports, _haxcmsSiteStore, _mobxModule, _utils, _simpleColorsSharedStyles) {
  "use strict";
    ...
    return (
      ...
      function (_SuperClass) {
        ...
        function _class() {
          ...
          _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(_class).call(this)); // a bucket for settings that can be for reusable
        ...
        babelHelpers.createClass(_class, [{
          ...
          value: function connectedCallback() {
            ...
            (0, _mobxModule.autorun)(function (reaction) {
              _this2._location = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.location);
