      ...
      function (_SuperClass) {
        ...
        babelHelpers.createClass(_class, [{
          ...
          value: function _contentContainerChanged(newValue, oldValue) {
            ...
            setTimeout(function () {
              if (newValue && oldValue == null) {
                _this2.HAXCMSThemeWiring.connect(_this2, newValue);
              } // previously connected, needs to change to new connection
              // this is an edge case at best...
              else if (newValue && oldValue) {
                  _this2.HAXCMSThemeWiring.disconnect(_this2);
          ...
          value: function connectedCallback() {
            babelHelpers.get(babelHelpers.getPrototypeOf(_class.prototype), "connectedCallback", this).call(this); // we don't have a content container, establish one
            ...
            (0, _renderStatus.afterNextRender)(this, function () {
              ...
              setTimeout(function () {
                if ((0, _polymerDom.dom)(_this3).getEffectiveChildNodes().length === 0) {
                  var frag = document.createRange().createContextualFragment(_haxcmsSiteStore.store.activeItemContent);
                  (0, _polymerDom.dom)(_this3).appendChild(frag);
                }
              }, 50);
              (0, _elementMixin.updateStyles)(); // keep editMode in sync globally
              ...
              (0, _mobxModule.autorun)(function (reaction) {
                var __routerManifest = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.routerManifest);

                if (babelHelpers.typeof(__routerManifest.title) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                  document.title = __routerManifest.title;
                }

                if (babelHelpers.typeof(__routerManifest.metadata) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && babelHelpers.typeof(__routerManifest.metadata.cssVariable) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                  // json outline schema changed, allow other things to react
                  // fake way of forcing an update of these items
                  var ary = __routerManifest.metadata.cssVariable.replace("--simple-colors-default-theme-", "").split("-");
                  ...
                  document.body.style.setProperty("--haxcms-color", __routerManifest.metadata.hexCode);
                }

                _this3.__disposer.push(reaction);
              });
              (0, _mobxModule.autorun)(function (reaction) {
                _this3._location = _haxcmsSiteStore.store.location;
          ...
          value: function disconnectedCallback() {
            babelHelpers.get(babelHelpers.getPrototypeOf(_class.prototype), "disconnectedCallback", this).call(this); // remove our content container var which will disconnect the wiring
  ...
  function () {
    function HAXCMSThemeWiring(element) {
      ...
      if (load) {
        ...
        window.addEventListener("haxcms-trigger-update", this._triggerUpdate.bind(element)); // @todo may want to set this to sessionStorage instead...
    ...
    babelHelpers.createClass(HAXCMSThemeWiring, [{
      ...
      value: function disconnect(element) {
        ...
        window.removeEventListener("haxcms-trigger-update", this._triggerUpdate.bind(element));
      }
      /**
