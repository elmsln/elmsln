define(["exports", "../../../lit-element/lit-element.js", "./hax-toolbar-item.js"], function (_exports, _litElement, _haxToolbarItem) {
  ...
  function _templateObject2_3e3a7e303bf111ebaf01f745694f3285() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-item\n        id=\"button\"\n        ?disabled=\"", "\"\n        icon=\"", "\"\n        ?hidden=\"", "\"\n        tooltip-direction=\"", "\"\n        tooltip=\"", "\"\n        @mousedown=\"", "\"\n        ?mini=\"", "\"\n        ?action=\"", "\"\n        ?menu=\"", "\"\n        ?light=\"", "\"\n      >\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);

    _templateObject2_3e3a7e303bf111ebaf01f745694f3285 = function _templateObject2_3e3a7e303bf111ebaf01f745694f3285() {
      return data;
    };
  ...
  function _templateObject_3e3a7e303bf111ebaf01f745694f3285() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          box-sizing: border-box;\n        }\n        :host([menu]) {\n          display: flex;\n          width: 100%;\n        }\n      "]);

    _templateObject_3e3a7e303bf111ebaf01f745694f3285 = function _templateObject_3e3a7e303bf111ebaf01f745694f3285() {
      return data;
    };
  ...
  var HaxContextItemTextop = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxContextItemTextop, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_3e3a7e303bf111ebaf01f745694f3285())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxContextItemTextop, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_3e3a7e303bf111ebaf01f745694f3285(), this.disabled, this.icon, !this.icon, this.direction, this.label, this._fireEvent, this.mini, this.action, this.menu, this.light);
      }
    }, {
      key: "firstUpdated",
