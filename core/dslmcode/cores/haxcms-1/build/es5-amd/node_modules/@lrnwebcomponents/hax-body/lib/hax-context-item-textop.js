define(["exports", "../../../lit-element/lit-element.js", "./hax-toolbar-item.js"], function (_exports, _litElement, _haxToolbarItem) {
  ...
  function _templateObject2_3869b03056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hax-toolbar-item\n        id=\"button\"\n        ?disabled=\"", "\"\n        icon=\"", "\"\n        ?hidden=\"", "\"\n        tooltip-direction=\"", "\"\n        tooltip=\"", "\"\n        @mousedown=\"", "\"\n        ?mini=\"", "\"\n        ?action=\"", "\"\n        ?menu=\"", "\"\n        ?light=\"", "\"\n      >\n        <slot></slot>\n      </hax-toolbar-item>\n    "]);

    _templateObject2_3869b03056b211eb8620237ff5403573 = function _templateObject2_3869b03056b211eb8620237ff5403573() {
      return data;
    };
  ...
  function _templateObject_3869b03056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-flex;\n          box-sizing: border-box;\n        }\n        :host([menu]) {\n          display: flex;\n          width: 100%;\n        }\n      "]);

    _templateObject_3869b03056b211eb8620237ff5403573 = function _templateObject_3869b03056b211eb8620237ff5403573() {
      return data;
    };
   ...
   */
  var HaxContextItemTextop = /*#__PURE__*/function (_LitElement) {
    babelHelpers.inherits(HaxContextItemTextop, _LitElement);

    var _super = _createSuper(HaxContextItemTextop);
    ...
    babelHelpers.createClass(HaxContextItemTextop, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_3869b03056b211eb8620237ff5403573())];
      }
    }]);
    ...
    babelHelpers.createClass(HaxContextItemTextop, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_3869b03056b211eb8620237ff5403573(), this.disabled, this.icon, !this.icon, this.direction, this.label, this._fireEvent, this.mini, this.action, this.menu, this.light);
      }
    }, {
      key: "firstUpdated",
      ...
      value: function firstUpdated(changedProperties) {
        ...
        this.shadowRoot.querySelector("#button").addEventListener("keydown", function (e) {
          if (e.key == "Enter") {
            _this2._fireEvent();
          }
        });
