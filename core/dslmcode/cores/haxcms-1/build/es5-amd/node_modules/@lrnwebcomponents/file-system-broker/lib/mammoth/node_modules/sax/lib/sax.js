...
(function (sax) {
  ...
  function SAXParser(strict, opt) {
    if (!babelHelpers.instanceof(this, SAXParser)) {
      return new SAXParser(strict, opt);
    }
  ...
  function SAXStream(strict, opt) {
    if (!babelHelpers.instanceof(this, SAXStream)) {
      return new SAXStream(strict, opt);
    }
  ...
  function strictFail(parser, message) {
    if (babelHelpers.typeof(parser) !== 'object' || !babelHelpers.instanceof(parser, SAXParser)) {
  ...
  function write(chunk) {
    ...
    if (babelHelpers.typeof(chunk) === 'object') {
