define(["exports", "../simple-icon/lib/simple-iconset.js", "../../lit-element/lit-element.js", "../simple-icon/lib/simple-icons.js", "../intersection-element/lib/IntersectionObserverMixin.js", "../loading-helpers/lib/LoadingHelper.js"], function (_exports, _simpleIconset, _litElement, _simpleIcons, _IntersectionObserverMixin, _LoadingHelper2) {
  ...
  function _templateObject5_b5506b1054f111eba18757df1555c032() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .image-wrap {\n          min-height: 250px;\n          max-height: 400px;\n          overflow: hidden;\n        }\n      "]);

    _templateObject5_b5506b1054f111eba18757df1555c032 = function _templateObject5_b5506b1054f111eba18757df1555c032() {
      return data;
    };
  ...
  function _templateObject4_b5506b1054f111eba18757df1555c032() {
    var data = babelHelpers.taggedTemplateLiteral(["<div class=\"image-wrap\">\n      ", "\n      <img\n        src=\"", "\"\n        alt=\"", "\"\n        aria-describedby=\"", "\"\n        loading=\"lazy\"\n      />\n    </div>"]);

    _templateObject4_b5506b1054f111eba18757df1555c032 = function _templateObject4_b5506b1054f111eba18757df1555c032() {
      return data;
    };
  ...
  function _templateObject3_b5506b1054f111eba18757df1555c032() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          img[loading=\"lazy\"] {\n            width: 100%;\n            margin-top: -200px;\n            min-height: 200px;\n            float: left;\n            opacity: 0;\n            transition: opacity 0.3s ease-in-out;\n          }\n          :host([image-loaded]) img[loading=\"lazy\"] {\n            margin-top: unset;\n            float: unset;\n            opacity: 1;\n          }\n        "]);

    _templateObject3_b5506b1054f111eba18757df1555c032 = function _templateObject3_b5506b1054f111eba18757df1555c032() {
      return data;
    };
  ...
  function _templateObject2_b5506b1054f111eba18757df1555c032() {
    ...
    _templateObject2_b5506b1054f111eba18757df1555c032 = function _templateObject2_b5506b1054f111eba18757df1555c032() {
      return data;
    };
  ...
  function _templateObject_b5506b1054f111eba18757df1555c032() {
    var data = babelHelpers.taggedTemplateLiteral(["", ""]);

    _templateObject_b5506b1054f111eba18757df1555c032 = function _templateObject_b5506b1054f111eba18757df1555c032() {
      return data;
    };
    ...
    return /*#__PURE__*/function (_IntersectionObserver) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function renderSVGLoader() {
          return (0, _litElement.html)(_templateObject_b5506b1054f111eba18757df1555c032(), !this.imageLoaded ? (0, _litElement.svg)(_templateObject2_b5506b1054f111eba18757df1555c032()) : "");
        }
      }], [{
        key: "styles",
        get: function get() {
          ...
          return [styles, (0, _litElement.css)(_templateObject3_b5506b1054f111eba18757df1555c032())];
        }
      }, {
        key: "properties",
        get: function get() {
  ...
  var lazyImage = /*#__PURE__*/function (_LoadingHelper) {
    ...
    babelHelpers.createClass(lazyImage, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject4_b5506b1054f111eba18757df1555c032(), this.renderSVGLoader(), this.src, this.alt, this.describedBy || "");
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(lazyImage), "styles", this)), [(0, _litElement.css)(_templateObject5_b5506b1054f111eba18757df1555c032())]);
      }
    }]);
    return lazyImage;
