define(["exports", "meta", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../intersection-element/lib/IntersectionObserverMixin.js", "../i18n-manager/lib/I18NMixin.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-iconset.js", "./lib/page-break-manager.js"], function (_exports, meta, _index, _schemaBehaviors, _IntersectionObserverMixin, _I18NMixin, _simpleIcon, _simpleIcons, _simpleIconset, _pageBreakManager) {
  "use strict";
  ...
  var _templateObject_edd80920514e11ec8e7319d78c6833b8, _templateObject2_edd80920514e11ec8e7319d78c6833b8, _templateObject3_edd80920514e11ec8e7319d78c6833b8;
  ...
  var PageBreak = /*#__PURE__*/function (_IntersectionObserver) {
    ...
    babelHelpers.createClass(PageBreak, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_edd80920514e11ec8e7319d78c6833b8 || (_templateObject_edd80920514e11ec8e7319d78c6833b8 = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host([data-hax-ray]:hover) .mid::before {\n          content: \"", "\";\n        }\n      </style>\n      <a .href=\"", "\" .name=\"#", "\" aria-hidden=\"true\"></a>\n      <hr class=\"mid\" />\n      ", "\n    "])), this.t.pageBreak, this.slug, this.itemId, this.locked ? (0, _index.html)(_templateObject2_edd80920514e11ec8e7319d78c6833b8 || (_templateObject2_edd80920514e11ec8e7319d78c6833b8 = babelHelpers.taggedTemplateLiteral(["<simple-icon-lite\n            @click=\"", "\"\n            icon=\"icons:lock\"\n            title=\"", "\"\n          ></simple-icon-lite>"])), this.haxClickLockInPage, this.t.clickToUnlock) : "");
      }
      /**
      ...
      value: function haxsetupActiveElementForm(props) {
        ...
        if (window.HAXCMS) {
          var itemManifest = window.HAXCMS.requestAvailability().store.getManifestItems(true);
          var items = [];
      ...
      value: function haxIndentParent(e) {
        if (_pageBreakManager.pageBreakManager.getParent(this, "indent")) {
          this.parent = _pageBreakManager.pageBreakManager.getParent(this, "indent").slug;
        }
      ...
      value: function haxOutdentItem(e) {
        if (_pageBreakManager.pageBreakManager.getParent(this, "outdent")) {
          this.parent = _pageBreakManager.pageBreakManager.getParent(this, "outdent").slug;
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject3_edd80920514e11ec8e7319d78c6833b8 || (_templateObject3_edd80920514e11ec8e7319d78c6833b8 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          opacity: 0;\n          height: 1px;\n        }\n        :host([data-hax-ray]) {\n          display: block;\n          margin: 20px 0;\n          padding: 20px;\n          opacity: 0.2;\n          background-position: center;\n          background-repeat: no-repeat;\n          transition: all 0.2s linear;\n        }\n        .mid {\n          border: none;\n          border-top: 2px solid #cccccc;\n          overflow: visible;\n          margin: 4px 0 0 0;\n          padding: 0;\n          height: 0;\n        }\n        :host([data-hax-ray]:hover) {\n          opacity: 1;\n        }\n        :host([data-hax-ray]:hover) .mid::before {\n          font-weight: bold;\n          color: #000000;\n          background-color: #ffffff;\n          font-size: 16px;\n          left: calc(50% - 2.5em);\n          top: -16px;\n          position: relative;\n          height: 0;\n          line-height: 36px;\n        }\n        simple-icon-lite {\n          float: right;\n          color: red;\n          --simple-icon-width: 36px;\n          --simple-icon-height: 36px;\n          margin-top: -28px;\n          margin-right: -46px;\n        }\n      "])))];
      }
    }, {
      key: "haxProperties",
      get: function get() {
