...
function _templateObject_9289c6b0b81c11eb80aa4b4d3d30a499() {
  var data = _taggedTemplateLiteral(['\n      <label id="listLabel" for="button"> ', ' </label>\n      <simple-symbol-picker\n        id="button"\n        ?allow-null="', '"\n        aria-labeledby="listlabel"\n        controls="', '"\n        ?disabled="', '"\n        @keydown="', '"\n        label=""\n        @mouseover="', '"\n        .symbol-types="', '"\n        tabindex="0"\n        title-as-html\n        ?toggled="', '"\n        @value-changed="', '"\n      >\n      </simple-symbol-picker>\n      ', "\n    "]);

  _templateObject_9289c6b0b81c11eb80aa4b4d3d30a499 = function _templateObject_9289c6b0b81c11eb80aa4b4d3d30a499() {
    return data;
  };
...
var RichTextEditorSymbolPicker = /*#__PURE__*/function (_RichTextEditorPicker) {
  ...
  _createClass(RichTextEditorSymbolPicker, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_9289c6b0b81c11eb80aa4b4d3d30a499(), this.labelTemplate, this.allowNull, _get(_getPrototypeOf(RichTextEditorSymbolPicker.prototype), "controls", this), this.disabled, this._pickerFocus, this._pickerFocus, this.symbolTypes, this.toggled, this._pickerChange, _get(_getPrototypeOf(RichTextEditorSymbolPicker.prototype), "tooltipTemplate", this));
