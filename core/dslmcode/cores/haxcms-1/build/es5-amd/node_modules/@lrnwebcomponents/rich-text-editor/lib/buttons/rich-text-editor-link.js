define(["exports", "../../../../@polymer/polymer/polymer-element.js", "../../../simple-tooltip/simple-tooltip.js", "../../../../@polymer/iron-icons/iron-icons.js", "./rich-text-editor-button-styles.js", "./rich-text-editor-prompt-button.js", "../singletons/rich-text-editor-prompt.js"], function (_exports, _polymerElement, _simpleTooltip, _ironIcons, _richTextEditorButtonStyles, _richTextEditorPromptButton, _richTextEditorPrompt) {
  ...
  function (_RichTextEditorPrompt) {
    ...
    function RichTextEditorLink() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(RichTextEditorLink).call(this));
      _this.fields = [{
        property: "",
        title: "Text",
    ...
    babelHelpers.createClass(RichTextEditorLink, [{
      ...
      value: function _getTagNeeded(value) {
        return value && this.getCleanValue("") && this.getCleanValue("") !== "" && this.getCleanValue("href") && this.getCleanValue("href") !== null;
      }
    }], [{
      key: "properties",
      get: function get() {
