      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "allowTarget") {
            var fields = [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorLink.prototype), "fields", _this2)), [{
              property: "href",
              title: "Link",
              inputMethod: "url",
              autoValidate: true
            }]);
            _this2.fields = _this2.allowTarget ? _objectSpread({}, fields) : _objectSpread(_objectSpread({}, fields), {}, {
              allowTarget: {
                property: "target",
                title: "Target",
