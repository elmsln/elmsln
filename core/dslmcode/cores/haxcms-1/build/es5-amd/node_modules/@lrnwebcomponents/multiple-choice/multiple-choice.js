define(["exports", "meta", "require", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../simple-colors/simple-colors.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../simple-fields/lib/simple-fields-field.js", "../simple-toast/simple-toast.js"], function (_exports, meta, _require, _index, _schemaBehaviors, _simpleColors, _simpleIcon, _simpleIcons, _simpleFieldsField, _simpleToast) {
  ...
  var _templateObject_826ac270f9df11eba887937af67006f3, _templateObject2_826ac270f9df11eba887937af67006f3, _templateObject3_826ac270f9df11eba887937af67006f3, _templateObject4_826ac270f9df11eba887937af67006f3, _templateObject5_826ac270f9df11eba887937af67006f3, _templateObject6_826ac270f9df11eba887937af67006f3, _templateObject7_826ac270f9df11eba887937af67006f3;
  ...
  var MultipleChoice = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(MultipleChoice, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_826ac270f9df11eba887937af67006f3 || (_templateObject_826ac270f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n      <confetti-container id=\"confetti\">\n        <meta property=\"oer:assessing\" content=\"", "\" />\n        <h3><span property=\"oer:name\">", "</span></h3>\n        ", "\n        ", "\n      </confetti-container>\n    "])), this.relatedResource, this.question, this.singleOption ? (0, _index.html)(_templateObject2_826ac270f9df11eba887937af67006f3 || (_templateObject2_826ac270f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n              ", "\n            "])), this.displayedAnswers.map(function (answer, index) {
          return (0, _index.html)(_templateObject3_826ac270f9df11eba887937af67006f3 || (_templateObject3_826ac270f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n                  <simple-fields-field\n                    ?disabled=\"", "\"\n                    property=\"oer:answer\"\n                    type=\"radio\"\n                    name=\"", "\"\n                    .value=\"", "\"\n                    @value-changed=\"", "\"\n                    label=\"", "\"\n                  ></simple-fields-field>\n                "])), _this3.disabled, index, answer.userGuess, _this3.checkedEvent, answer.label ? answer.label : "");
        })) : (0, _index.html)(_templateObject4_826ac270f9df11eba887937af67006f3 || (_templateObject4_826ac270f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n              <ul>\n                ", "\n              </ul>\n            "])), this.displayedAnswers.map(function (answer, index) {
          return (0, _index.html)(_templateObject5_826ac270f9df11eba887937af67006f3 || (_templateObject5_826ac270f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n                    <li>\n                      <simple-fields-field\n                        ?disabled=\"", "\"\n                        property=\"oer:answer\"\n                        name=\"", "\"\n                        type=\"checkbox\"\n                        label=\"", "\"\n                        .value=\"", "\"\n                        @value-changed=\"", "\"\n                      ></simple-fields-field>\n                    </li>\n                  "])), _this3.disabled, index, answer.label ? answer.label : "", answer.userGuess, _this3.checkedEvent);
        })), !this.hideButtons ? (0, _index.html)(_templateObject6_826ac270f9df11eba887937af67006f3 || (_templateObject6_826ac270f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n              <div id=\"buttons\">\n                <button\n                  id=\"check\"\n                  ?disabled=\"", "\"\n                  @click=\"", "\"\n                >\n                  ", "\n                </button>\n                <button\n                  id=\"reset\"\n                  ?disabled=\"", "\"\n                  @click=\"", "\"\n                >\n                  ", "\n                </button>\n              </div>\n            "])), this.disabled, this._verifyAnswers, this.checkLabel, this.disabled, this.resetAnswers, this.resetLabel) : "");
      }
    }, {
      key: "checkedEvent",
