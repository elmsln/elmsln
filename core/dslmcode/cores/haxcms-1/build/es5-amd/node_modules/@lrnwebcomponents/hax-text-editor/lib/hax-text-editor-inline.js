define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../rich-text-editor/lib/buttons/rich-text-editor-prompt-button.js"], function (_exports, _polymerElement, _richTextEditorPromptButton) {
  ...
  function (_RichTextEditorPrompt) {
    babelHelpers.inherits(HaxTextEditorInline, _RichTextEditorPrompt);

    function HaxTextEditorInline() {
      var _this;

      babelHelpers.classCallCheck(this, HaxTextEditorInline);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HaxTextEditorInline).call(this));
