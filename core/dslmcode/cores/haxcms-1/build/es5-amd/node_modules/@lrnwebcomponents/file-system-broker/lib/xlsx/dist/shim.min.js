...
if (!Object.keys) Object.keys = function () {
  var t = Object.prototype.hasOwnProperty,
    ...
    toString: null
      ...
      i = r.length;
  return function (n) {
    if (babelHelpers.typeof(n) !== "object" && typeof n !== "function" || n === null) throw new TypeError("Object.keys called on non-object");
    var o = [];
...
if (!Date.prototype.toISOString) Date.prototype.toISOString = function () {
  ...
  return function e() {
    var e = this.getUTCFullYear(),
        r = "";
    if (e > 9999) r = "+" + t(e, 6);else if (e < 0) r = "-" + t(-e, 6);else r = t(e, 4);
...
if (typeof ArrayBuffer !== "undefined" && !ArrayBuffer.prototype.slice) ArrayBuffer.prototype.slice = function (t, e) {
  ...
  if (i.set) i.set(n);else while (t <= --e) {
    i[e - t] = n[e];
  }
  return r;
};
  ...
  try {
    var e = function e(t) {
      ...
      for (var i = 0; i < t.length; ++i) {
        e.push(("00" + (r ? t.charCodeAt(i) : t[i]).toString(16)).slice(-2));
      }
...
var IE_LoadFile = function () {
  try {
    var t = function t(_t) {
      ...
      for (var r = 0; r < _t.length; r += 2) {
        e.push(String.fromCharCode(parseInt(_t.slice(r, r + 2), 16)));
      }
