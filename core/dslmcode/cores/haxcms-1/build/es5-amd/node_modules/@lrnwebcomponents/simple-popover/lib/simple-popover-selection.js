define(["exports", "../../../lit-element/lit-element.js", "../../../lit-html/lib/render.js", "../../../lit-html/directives/unsafe-html.js", "./simple-popover-manager.js"], function (_exports, _litElement, _render, _unsafeHtml, _simplePopoverManager) {
  ...
  var _templateObject_e857a3d0b80f11eb903f3b4791d1f11f, _templateObject2_e857a3d0b80f11eb903f3b4791d1f11f, _templateObject3_e857a3d0b80f11eb903f3b4791d1f11f;
  ...
  var SimplePopoverSelection = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePopoverSelection, [{
      ...
      value: function openedChanged(state) {
        ...
        if (state) {
          ...
          if (this.querySelector('[slot="style"]')) {
            ...
            content = (0, _litElement.html)(_templateObject_e857a3d0b80f11eb903f3b4791d1f11f || (_templateObject_e857a3d0b80f11eb903f3b4791d1f11f = babelHelpers.taggedTemplateLiteral(["", "", ""])), (0, _unsafeHtml.unsafeHTML)(div.innerHTML), (0, _unsafeHtml.unsafeHTML)(style.outerHTML));
          } else {
            content = (0, _litElement.html)(_templateObject2_e857a3d0b80f11eb903f3b4791d1f11f || (_templateObject2_e857a3d0b80f11eb903f3b4791d1f11f = babelHelpers.taggedTemplateLiteral(["", ""])), (0, _unsafeHtml.unsafeHTML)(div.innerHTML));
          }
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject3_e857a3d0b80f11eb903f3b4791d1f11f || (_templateObject3_e857a3d0b80f11eb903f3b4791d1f11f = babelHelpers.taggedTemplateLiteral(["<slot name=\"button\"></slot>"])));
      }
    }], [{
      key: "properties",
      get: function get() {
