define(["exports", "../../../lit-element/lit-element.js", "../../../lit-html/lib/render.js", "../../../lit-html/directives/unsafe-html.js", "./simple-popover-manager.js"], function (_exports, _litElement, _render, _unsafeHtml, _simplePopoverManager) {
  ...
  function _templateObject3_844a780029e311ebad094ba710b19d49() {
    var data = babelHelpers.taggedTemplateLiteral(["<slot name=\"button\"></slot>"]);

    _templateObject3_844a780029e311ebad094ba710b19d49 = function _templateObject3_844a780029e311ebad094ba710b19d49() {
      return data;
    };
  ...
  function _templateObject2_844a780029e311ebad094ba710b19d49() {
    var data = babelHelpers.taggedTemplateLiteral(["", ""]);

    _templateObject2_844a780029e311ebad094ba710b19d49 = function _templateObject2_844a780029e311ebad094ba710b19d49() {
      return data;
    };
  ...
  function _templateObject_844a780029e311ebad094ba710b19d49() {
    var data = babelHelpers.taggedTemplateLiteral(["", "", ""]);

    _templateObject_844a780029e311ebad094ba710b19d49 = function _templateObject_844a780029e311ebad094ba710b19d49() {
      return data;
    };
    ...
    babelHelpers.createClass(SimplePopoverSelection, [{
      ...
      value: function openedChanged(state) {
        ...
        if (state) {
          ...
          (0, _render.render)(div, window.SimplePopoverManager.requestAvailability());
          ...
          if (this.querySelector('[slot="style"]')) {
            var style = this.querySelector('[slot="style"]').cloneNode(true);
            style.removeAttribute("slot");
            content = (0, _litElement.html)(_templateObject_844a780029e311ebad094ba710b19d49(), (0, _unsafeHtml.unsafeHTML)(div.innerHTML), (0, _unsafeHtml.unsafeHTML)(style.outerHTML));
          } else {
            content = (0, _litElement.html)(_templateObject2_844a780029e311ebad094ba710b19d49(), (0, _unsafeHtml.unsafeHTML)(div.innerHTML));
          }
          ...
          setTimeout(function () {
            ...
            for (var i in children) {
              if (children[i].addEventListener) {
                children[i].addEventListener("click", _this.itemSelect.bind(_this));
              }
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "opened" && _this2.shadowRoot) {
            _this2.openedChanged(_this2[propName]);
          }
        });
      }
    }, {
      ...
      value: function itemSelect(e) {
        ...
        this.opened = false;
        setTimeout(function () {
          window.SimplePopoverManager.requestAvailability().setPopover(_this3, _this3.querySelector('[slot="button"]'), false);

          _this3.querySelector('[slot="button"]').focus();
        }, 0);
      }
    }, {
      key: "firstUpdated",
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject3_844a780029e311ebad094ba710b19d49());
      }
    }], [{
      key: "properties",
      get: function get() {
