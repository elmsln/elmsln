define(["exports", "../../../lit-element/lit-element.js", "../../../lit-html/lib/render.js", "../../../lit-html/directives/unsafe-html.js", "./simple-popover-manager.js"], function (_exports, _litElement, _render, _unsafeHtml, _simplePopoverManager) {
  ...
  function _templateObject3_2db90410284011eb97976fb20742a907() {
    var data = babelHelpers.taggedTemplateLiteral(["<slot name=\"button\"></slot>"]);

    _templateObject3_2db90410284011eb97976fb20742a907 = function _templateObject3_2db90410284011eb97976fb20742a907() {
      return data;
    };
  ...
  function _templateObject2_2db90410284011eb97976fb20742a907() {
    var data = babelHelpers.taggedTemplateLiteral(["", ""]);

    _templateObject2_2db90410284011eb97976fb20742a907 = function _templateObject2_2db90410284011eb97976fb20742a907() {
      return data;
    };
  ...
  function _templateObject_2db90410284011eb97976fb20742a907() {
    var data = babelHelpers.taggedTemplateLiteral(["", "", ""]);

    _templateObject_2db90410284011eb97976fb20742a907 = function _templateObject_2db90410284011eb97976fb20742a907() {
      return data;
    };
  ...
  var SimplePopoverSelection = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePopoverSelection, [{
      ...
      value: function openedChanged(state) {
        ...
        if (state) {
          ...
          if (this.querySelector('[slot="style"]')) {
            ...
            content = (0, _litElement.html)(_templateObject_2db90410284011eb97976fb20742a907(), (0, _unsafeHtml.unsafeHTML)(div.innerHTML), (0, _unsafeHtml.unsafeHTML)(style.outerHTML));
          } else {
            content = (0, _litElement.html)(_templateObject2_2db90410284011eb97976fb20742a907(), (0, _unsafeHtml.unsafeHTML)(div.innerHTML));
          }
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject3_2db90410284011eb97976fb20742a907());
      }
    }], [{
      key: "properties",
      get: function get() {
