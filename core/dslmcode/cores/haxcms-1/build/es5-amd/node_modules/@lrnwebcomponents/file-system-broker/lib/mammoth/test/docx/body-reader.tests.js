...
var fakeContentTypes = {
  findContentType: function findContentType(filePath) {
    var extensionTypes = {
      ".png": "image/png",
      ".emf": "image/x-emf"
    };
...
test("paragraph has style ID and name read from paragraph properties if present", function () {
  var styleXml = new XmlElement("w:pStyle", {
    "w:val": "Heading1"
  }, []);
...
test("paragraph has justification read from paragraph properties if present", function () {
  var justificationXml = new XmlElement("w:jc", {
    "w:val": "center"
  }, []);
...
test("paragraph indent", {
  "when w:start is set then start indent is read from w:start": function whenWStartIsSetThenStartIndentIsReadFromWStart() {
  ...
  "when w:start is not set then start indent is read from w:left": function whenWStartIsNotSetThenStartIndentIsReadFromWLeft() {
    var paragraphXml = paragraphWithIndent({
      "w:left": "720"
    });
    var paragraph = readXmlElementValue(paragraphXml);
  ...
  "when w:end is set then end indent is read from w:end": function whenWEndIsSetThenEndIndentIsReadFromWEnd() {
    var paragraphXml = paragraphWithIndent({
      "w:end": "720",
      "w:right": "40"
    });
  ...
  "when w:end is not set then end indent is read from w:right": function whenWEndIsNotSetThenEndIndentIsReadFromWRight() {
    var paragraphXml = paragraphWithIndent({
      "w:right": "720"
    });
    var paragraph = readXmlElementValue(paragraphXml);
  ...
  "paragraph has indent firstLine read from paragraph properties if present": function paragraphHasIndentFirstLineReadFromParagraphPropertiesIfPresent() {
    var paragraphXml = paragraphWithIndent({
      "w:firstLine": "720"
    });
    var paragraph = readXmlElementValue(paragraphXml);
  ...
  "paragraph has indent hanging read from paragraph properties if present": function paragraphHasIndentHangingReadFromParagraphPropertiesIfPresent() {
    var paragraphXml = paragraphWithIndent({
      "w:hanging": "720"
    });
    var paragraph = readXmlElementValue(paragraphXml);
  ...
  "when indent attributes aren't set then indents are null": function whenIndentAttributesArenTSetThenIndentsAreNull() {
    var paragraphXml = paragraphWithIndent({});
    var paragraph = readXmlElementValue(paragraphXml);
...
test("paragraph has numbering properties from paragraph properties if present", function () {
  var numberingPropertiesXml = new XmlElement("w:numPr", {}, [new XmlElement("w:ilvl", {
    "w:val": "1"
  }), new XmlElement("w:numId", {
    "w:val": "42"
  })]);
  ...
  assert.deepEqual(paragraph.numbering, {
    level: "1",
    isOrdered: true
  });
});
test("numbering on paragraph style takes precedence over numPr", function () {
  ...
  var propertiesXml = new XmlElement("w:pPr", {}, [new XmlElement("w:pStyle", {
    "w:val": "List"
...
test("numbering properties are converted to numbering at specified level", function () {
  ...
  assert.deepEqual(numberingLevel, {
    level: "1",
    isOrdered: true
  });
});
test("numbering properties are ignored if w:ilvl is missing", function () {
  var numberingPropertiesXml = new XmlElement("w:numPr", {}, [new XmlElement("w:numId", {
    "w:val": "42"
  })]);
  var numbering = new NumberingMap({
    findLevel: {
...
test("complex fields", function () {
  ...
  var beginXml = new XmlElement("w:r", {}, [new XmlElement("w:fldChar", {
    "w:fldCharType": "begin"
  })]);
  var endXml = new XmlElement("w:r", {}, [new XmlElement("w:fldChar", {
    "w:fldCharType": "end"
  })]);
  var separateXml = new XmlElement("w:r", {}, [new XmlElement("w:fldChar", {
    "w:fldCharType": "separate"
  })]);
  var hyperlinkInstrText = new XmlElement("w:instrText", {}, [xml.text(' HYPERLINK "' + uri + '"')]);
  var hyperlinkRunXml = runOfText("this is a hyperlink");
  var isEmptyHyperlinkedRun = isHyperlinkedRun({
    children: []
  });
  ...
  return {
    "stores instrText returns empty result": function storesInstrTextReturnsEmptyResult() {
      var instrText = readXmlElementValue(hyperlinkInstrText);
      assert.deepEqual(instrText, []);
    },
    "runs in a complex field for hyperlink without switch are read as external hyperlinks": function runsInAComplexFieldForHyperlinkWithoutSwitchAreReadAsExternalHyperlinks() {
      var hyperlinkRunXml = runOfText("this is a hyperlink");
      var paragraphXml = new XmlElement("w:p", {}, [beginXml, hyperlinkInstrText, separateXml, hyperlinkRunXml, endXml]);
      var paragraph = readXmlElementValue(paragraphXml);
      assertThat(paragraph.children, contains(isEmptyRun, isEmptyHyperlinkedRun, isHyperlinkedRun({
        href: uri,
        children: contains(isText("this is a hyperlink"))
      }), isEmptyRun));
    },
    "runs in a complex field for hyperlink with l switch are read as internal hyperlinks": function runsInAComplexFieldForHyperlinkWithLSwitchAreReadAsInternalHyperlinks() {
      var hyperlinkRunXml = runOfText("this is a hyperlink");
      var paragraphXml = new XmlElement("w:p", {}, [beginXml, new XmlElement("w:instrText", {}, [xml.text(' HYPERLINK \\l "InternalLink"')]), separateXml, hyperlinkRunXml, endXml]);
      var paragraph = readXmlElementValue(paragraphXml);
      assertThat(paragraph.children, contains(isEmptyRun, isEmptyHyperlinkedRun, isHyperlinkedRun({
        anchor: "InternalLink",
        children: contains(isText("this is a hyperlink"))
    ...
    "runs after a complex field for hyperlinks are not read as hyperlinks": function runsAfterAComplexFieldForHyperlinksAreNotReadAsHyperlinks() {
      var afterEndXml = runOfText("this will not be a hyperlink");
      var paragraphXml = new XmlElement("w:p", {}, [beginXml, hyperlinkInstrText, separateXml, endXml, afterEndXml]);
      var paragraph = readXmlElementValue(paragraphXml);
      assertThat(paragraph.children, contains(isEmptyRun, isEmptyHyperlinkedRun, isEmptyRun, isRun({
        children: contains(isText("this will not be a hyperlink"))
      })));
    },
    "can handle split instrText elements": function canHandleSplitInstrTextElements() {
      var hyperlinkInstrTextPart1 = new XmlElement("w:instrText", {}, [xml.text(" HYPE")]);
      var hyperlinkInstrTextPart2 = new XmlElement("w:instrText", {}, [xml.text('RLINK "' + uri + '"')]);
      var paragraphXml = new XmlElement("w:p", {}, [beginXml, hyperlinkInstrTextPart1, hyperlinkInstrTextPart2, separateXml, hyperlinkRunXml, endXml]);
      var paragraph = readXmlElementValue(paragraphXml);
      assertThat(paragraph.children, contains(isEmptyRun, isEmptyHyperlinkedRun, isHyperlinkedRun({
        href: uri,
        children: contains(isText("this is a hyperlink"))
    ...
    "hyperlink is not ended by end of nested complex field": function hyperlinkIsNotEndedByEndOfNestedComplexField() {
      var authorInstrText = new XmlElement("w:instrText", {}, [xml.text(' AUTHOR "John Doe"')]);
      var paragraphXml = new XmlElement("w:p", {}, [beginXml, hyperlinkInstrText, separateXml, beginXml, authorInstrText, separateXml, endXml, hyperlinkRunXml, endXml]);
      var paragraph = readXmlElementValue(paragraphXml);
      assertThat(paragraph.children, contains(isEmptyRun, isEmptyHyperlinkedRun, isEmptyHyperlinkedRun, isEmptyHyperlinkedRun, isEmptyHyperlinkedRun, isHyperlinkedRun({
        href: uri,
        children: contains(isText("this is a hyperlink"))
      }), isEmptyRun));
    },
    "complex field nested within a hyperlink complex field is wrapped with the hyperlink": function complexFieldNestedWithinAHyperlinkComplexFieldIsWrappedWithTheHyperlink() {
      var authorInstrText = new XmlElement("w:instrText", {}, [xml.text(' AUTHOR "John Doe"')]);
      var paragraphXml = new XmlElement("w:p", {}, [beginXml, hyperlinkInstrText, separateXml, beginXml, authorInstrText, separateXml, runOfText("John Doe"), endXml, endXml]);
      var paragraph = readXmlElementValue(paragraphXml);
      assertThat(paragraph.children, contains(isEmptyRun, isEmptyHyperlinkedRun, isEmptyHyperlinkedRun, isEmptyHyperlinkedRun, isHyperlinkedRun({
        href: uri,
        children: contains(isText("John Doe"))
      }), isEmptyHyperlinkedRun, isEmptyRun));
    },
    "field without separate w:fldChar is ignored": function fieldWithoutSeparateWFldCharIsIgnored() {
      var hyperlinkRunXml = runOfText("this is a hyperlink");
      var paragraphXml = new XmlElement("w:p", {}, [beginXml, hyperlinkInstrText, separateXml, beginXml, endXml, hyperlinkRunXml, endXml]);
      var paragraph = readXmlElementValue(paragraphXml);
      assertThat(paragraph.children, contains(isEmptyRun, isEmptyHyperlinkedRun, isEmptyHyperlinkedRun, isEmptyHyperlinkedRun, isHyperlinkedRun({
        href: uri,
        children: contains(isText("this is a hyperlink"))
...
test("run has font read from properties", function () {
  var fontXml = new XmlElement("w:rFonts", {
    "w:ascii": "Arial"
  });
...
test("run has fontSize read from properties", function () {
  var fontSizeXml = new XmlElement("w:sz", {
    "w:val": "28"
  });
...
test("w:tbl is read as document table element", function () {
  var tableXml = new XmlElement("w:tbl", {}, [new XmlElement("w:tr", {}, [new XmlElement("w:tc", {}, [new XmlElement("w:p", {}, [])])])]);
  var result = readXmlElement(tableXml);
  assert.deepEqual(result.value, new documents.Table([new documents.TableRow([new documents.TableCell([new documents.Paragraph([])])])]));
});
...
test("table has style ID and name read from table properties if present", function () {
  var styleXml = new XmlElement("w:tblStyle", {
    "w:val": "TableNormal"
  }, []);
...
test("w:tblHeader marks table row as header", function () {
  var tableXml = new XmlElement("w:tbl", {}, [new XmlElement("w:tr", {}, [new XmlElement("w:trPr", {}, [new XmlElement("w:tblHeader")])]), new XmlElement("w:tr")]);
  var result = readXmlElementValue(tableXml);
  assertThat(result, isTable({
    children: contains(isRow({
      isHeader: true
    }), isRow({
      isHeader: false
    }))
...
test("w:gridSpan is read as colSpan for table cell", function () {
  var tableXml = new XmlElement("w:tbl", {}, [new XmlElement("w:tr", {}, [new XmlElement("w:tc", {}, [new XmlElement("w:tcPr", {}, [new XmlElement("w:gridSpan", {
    "w:val": "2"
  })]), new XmlElement("w:p", {}, [])])])]);
  var result = readXmlElement(tableXml);
  assert.deepEqual(result.value, new documents.Table([new documents.TableRow([new documents.TableCell([new documents.Paragraph([])], {
...
test("w:vMerge is read as rowSpan for table cell", function () {
  var tableXml = new XmlElement("w:tbl", {}, [row(emptyCell()), row(emptyCell(vMerge("restart"))), row(emptyCell(vMerge("continue"))), row(emptyCell(vMerge("continue"))), row(emptyCell())]);
  var result = readXmlElement(tableXml);
  assert.deepEqual(result.value, new documents.Table([docRow([docEmptyCell()]), docRow([docEmptyCell({
    rowSpan: 3
  })]), docRow([]), docRow([]), docRow([docEmptyCell()])]));
});
test("w:vMerge without val is treated as continue", function () {
  var tableXml = new XmlElement("w:tbl", {}, [row(emptyCell(vMerge("restart"))), row(emptyCell(vMerge()))]);
  var result = readXmlElement(tableXml);
  assert.deepEqual(result.value, new documents.Table([docRow([docEmptyCell({
    rowSpan: 2
  })]), docRow([])]));
});
test("w:vMerge accounts for cells spanning columns", function () {
  var tableXml = new XmlElement("w:tbl", {}, [row(emptyCell(), emptyCell(), emptyCell(vMerge("restart"))), row(emptyCell(gridSpan("2")), emptyCell(vMerge("continue"))), row(emptyCell(), emptyCell(), emptyCell(vMerge("continue"))), row(emptyCell(), emptyCell(), emptyCell())]);
  var result = readXmlElement(tableXml);
  assert.deepEqual(result.value, new documents.Table([docRow([docEmptyCell(), docEmptyCell(), docEmptyCell({
    rowSpan: 3
  })]), docRow([docEmptyCell({
    colSpan: 2
  })]), docRow([docEmptyCell(), docEmptyCell()]), docRow([docEmptyCell(), docEmptyCell(), docEmptyCell()])]));
});
test("no vertical cell merging if merged cells do not line up", function () {
  var tableXml = new XmlElement("w:tbl", {}, [row(emptyCell(gridSpan("2"), vMerge("restart"))), row(emptyCell(), emptyCell(vMerge("continue")))]);
  var result = readXmlElement(tableXml);
  assert.deepEqual(result.value, new documents.Table([docRow([docEmptyCell({
    colSpan: 2
...
function emptyCell() {
  return new XmlElement("w:tc", {}, [new XmlElement("w:tcPr", {}, Array.prototype.slice.call(arguments))]);
}

function vMerge(val) {
  return new XmlElement("w:vMerge", {
    "w:val": val
  }, []);
}

function gridSpan(val) {
  return new XmlElement("w:gridSpan", {
    "w:val": val
  });
}
...
function isImage(options) {
  var matcher = hasProperties(_.extend({
    type: "image"
  }, _.omit(options, "buffer")));

  if (options.buffer) {
    return allOf(matcher, new FeatureMatcher(willBe(options.buffer), "buffer", "buffer", function (element) {
      return element.read();
    }));
  } else {
    return matcher;
...
function readEmbeddedImage(element) {
  return readXmlElement(element, {
    relationships: new Relationships([imageRelationship("rId5", "media/hat.png")]),
...
test("can read anchored pictures", function () {
  var drawing = new XmlElement("w:drawing", {}, [new XmlElement("wp:anchor", {}, [new XmlElement("wp:docPr", {
    descr: "It's a hat"
  }), new XmlElement("a:graphic", {}, [new XmlElement("a:graphicData", {}, [new XmlElement("pic:pic", {}, [new XmlElement("pic:blipFill", {}, [new XmlElement("a:blip", {
    "r:embed": IMAGE_RELATIONSHIP_ID
  })])])])])])]);
  var result = readEmbeddedImage(drawing);
  return promiseThat(result, isSuccess(contains(isImage({
    altText: "It's a hat",
...
test("can read linked pictures", function () {
  ...
  var element = single(readXmlElementValue(drawing, {
    relationships: new Relationships([imageRelationship("rId5", "file:///media/hat.png")]),
    contentTypes: fakeContentTypes,
...
test("warning if unsupported image type", function () {
  ...
  var result = readXmlElement(drawing, {
    relationships: new Relationships([imageRelationship("rId5", "media/hat.emf")]),
    contentTypes: fakeContentTypes,
    docxFile: createFakeDocxFile({
...
test("w:hyperlink", {
  "is read as external hyperlink if it has a relationship ID": function isReadAsExternalHyperlinkIfItHasARelationshipID() {
    var runXml = new XmlElement("w:r", {}, []);
    var hyperlinkXml = new XmlElement("w:hyperlink", {
      "r:id": "r42"
    }, [runXml]);
    var relationships = new Relationships([hyperlinkRelationship("r42", "http://example.com")]);
  ...
  "is read as external hyperlink if it has a relationship ID and an anchor": function isReadAsExternalHyperlinkIfItHasARelationshipIDAndAnAnchor() {
    var runXml = new XmlElement("w:r", {}, []);
    var hyperlinkXml = new XmlElement("w:hyperlink", {
      "r:id": "r42",
      "w:anchor": "fragment"
  ...
  "existing fragment is replaced when anchor is set on external link": function existingFragmentIsReplacedWhenAnchorIsSetOnExternalLink() {
    var runXml = new XmlElement("w:r", {}, []);
    var hyperlinkXml = new XmlElement("w:hyperlink", {
      "r:id": "r42",
      "w:anchor": "fragment"
    }, [runXml]);
    var relationships = new Relationships([hyperlinkRelationship("r42", "http://example.com/#previous")]);
    var result = readXmlElement(hyperlinkXml, {
      relationships: relationships
    });
    assert.deepEqual(result.value.href, "http://example.com/#fragment");
  ...
  "is read as internal hyperlink if it has an anchor": function isReadAsInternalHyperlinkIfItHasAnAnchor() {
    var runXml = new XmlElement("w:r", {}, []);
    var hyperlinkXml = new XmlElement("w:hyperlink", {
      "w:anchor": "_Peter"
    }, [runXml]);
  ...
  "is ignored if it does not have a relationship ID nor anchor": function isIgnoredIfItDoesNotHaveARelationshipIDNorAnchor() {
    var runXml = new XmlElement("w:r", {}, []);
    var hyperlinkXml = new XmlElement("w:hyperlink", {}, [runXml]);
    var result = readXmlElement(hyperlinkXml);
    assert.deepEqual(result.value[0].type, "run");
  },
  "target frame is read": function targetFrameIsRead() {
    var hyperlinkXml = new XmlElement("w:hyperlink", {
  ...
  "empty target frame is ignored": function emptyTargetFrameIsIgnored() {
    var hyperlinkXml = new XmlElement("w:hyperlink", {
      "w:anchor": "Introduction",
      "w:tgtFrame": ""
    });
...
test("w:footnoteReference has ID read", function () {
  var referenceXml = new XmlElement("w:footnoteReference", {
    "w:id": "4"
  });
  var result = readXmlElement(referenceXml);
  assert.deepEqual(result.value, documents.noteReference({
    noteType: "footnote",
    noteId: "4"
  }));
  assert.deepEqual(result.messages, []);
...
test("w:commentReference has ID read", function () {
  var referenceXml = new XmlElement("w:commentReference", {
    "w:id": "4"
  });
  var result = readXmlElement(referenceXml);
  assert.deepEqual(result.value, documents.commentReference({
    commentId: "4"
  }));
  assert.deepEqual(result.messages, []);
});
...
test("text boxes have content appended after containing paragraph", function () {
  var textbox = new XmlElement("w:pict", {}, [new XmlElement("v:shape", {}, [new XmlElement("v:textbox", {}, [new XmlElement("w:txbxContent", {}, [paragraphWithStyleId("textbox-content")])])])]);
  var paragraph = new XmlElement("w:p", {}, [new XmlElement("w:r", {}, [textbox])]);
...
test("mc:Fallback is used when mc:AlternateContent is read", function () {
  ...
  var textbox = new XmlElement("mc:AlternateContent", {}, [new XmlElement("mc:Choice", {
    Requires: "wps"
  }, [paragraphWithStyleId("first")]), new XmlElement("mc:Fallback", {}, [paragraphWithStyleId("second")])]);
...
test("w:sdtContent is used when w:sdt is read", function () {
  var element = xml.element("w:sdt", {}, [xml.element("w:sdtContent", {}, [xml.element("w:t", {}, [xml.text("Blackdown")])])]);
  var result = readXmlElement(element);
...
function paragraphWithStyleId(styleId) {
  return new XmlElement("w:p", {}, [new XmlElement("w:pPr", {}, [new XmlElement("w:pStyle", {
    "w:val": styleId
  }, [])])]);
}
...
function createInlineImage(options) {
  return new XmlElement("w:drawing", {}, [new XmlElement("wp:inline", {}, [new XmlElement("wp:docPr", {
    descr: options.description,
    title: options.title
  }), new XmlElement("a:graphic", {}, [new XmlElement("a:graphicData", {}, [new XmlElement("pic:pic", {}, [new XmlElement("pic:blipFill", {}, [options.blip])])])])])]);
}

function createEmbeddedBlip(relationshipId) {
  return new XmlElement("a:blip", {
...
function NumberingMap(options) {
  var _findLevel = options.findLevel;

  var _findLevelByParagraphStyleId = options.findLevelByParagraphStyleId || {};

  return {
    findLevel: function findLevel(numId, level) {
      return _findLevel[numId][level];
    },
    findLevelByParagraphStyleId: function findLevelByParagraphStyleId(styleId) {
      return _findLevelByParagraphStyleId[styleId];
    }
  };
}