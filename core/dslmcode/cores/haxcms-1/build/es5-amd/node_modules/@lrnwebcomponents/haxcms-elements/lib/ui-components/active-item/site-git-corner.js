define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/lib/mobx.module.js", "../../../../utils/utils.js", "../../core/utils/HAXCMSThemeParts.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxModule, _utils, _HAXCMSThemeParts2) {
  ...
  function _templateObject2_438acf80db3d11eaa14b6130b7e5d77f() {
    ...
    _templateObject2_438acf80db3d11eaa14b6130b7e5d77f = function _templateObject2_438acf80db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_438acf80db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <git-corner\n        .part=\"", "\"\n        size=\"", "\"\n        alt=\"", "\"\n        ?circle=\"", "\"\n        source=\"", "\"\n      ></git-corner>\n    "]);

    _templateObject_438acf80db3d11eaa14b6130b7e5d77f = function _templateObject_438acf80db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_HAXCMSThemeParts) {
    ...
    babelHelpers.createClass(SiteGitCorner, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_438acf80db3d11eaa14b6130b7e5d77f(), this.editMode ? "edit-mode-active" : "", this.size, this.alt, this.circle, this.activeGitFileLink);
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SiteGitCorner), "styles", this)), [(0, _litElement.css)(_templateObject2_438acf80db3d11eaa14b6130b7e5d77f())]);
      }
    }]);
