define(["exports", "require", "../../../../../lit/index.js", "../haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js"], function (_exports, _require, _index, _haxcmsSiteStore, _mobxEsm) {
  ...
  var _templateObject_64040170feb211eb882a11948c8a9144, _templateObject2_64040170feb211eb882a11948c8a9144, _templateObject3_64040170feb211eb882a11948c8a9144;
    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function HAXCMSMobileMenuButton() {
          ...
          return (0, _index.html)(_templateObject_64040170feb211eb882a11948c8a9144 || (_templateObject_64040170feb211eb882a11948c8a9144 = babelHelpers.taggedTemplateLiteral(["\n        <simple-icon-button-lite\n          class=\"btn\"\n          icon=\"icons:menu\"\n          label=\"Toggle menu\"\n          id=\"haxcmsmobilemenubutton\"\n          .part=\"", "\"\n          @click=\"", "\"\n        ></simple-icon-button-lite>\n        <simple-tooltip for=\"haxcmsmobilemenubutton\">\n          Toggle menu\n        </simple-tooltip>\n      "])), this.editMode ? "edit-mode-active" : "", this.__HAXCMSMobileMenuToggle);
        }
      }, {
        ...
        value: function HAXCMSMobileMenu(e) {
          return (0, _index.html)(_templateObject2_64040170feb211eb882a11948c8a9144 || (_templateObject2_64040170feb211eb882a11948c8a9144 = babelHelpers.taggedTemplateLiteral(["\n        <nav\n          id=\"haxcmsmobilemenunav\"\n          role=\"navigation\"\n          aria-labelledby=\"sitemenu\"\n        >\n          <replace-tag\n            with=\"site-menu\"\n            part=\"site-menu\"\n            id=\"sitemenu\"\n            import-method=\"view\"\n          ></replace-tag>\n        </nav>\n      "])));
        }
        /**
        ...
        get: function get() {
          ...
          return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject3_64040170feb211eb882a11948c8a9144 || (_templateObject3_64040170feb211eb882a11948c8a9144 = babelHelpers.taggedTemplateLiteral(["\n          site-menu:not(:defined) {\n            display: none;\n          }\n          replace-tag[with=\"site-menu\"] {\n            height: 100vh;\n          }\n          :host([responsive-size=\"xs\"][menu-open]),\n          :host([responsive-size=\"sm\"][menu-open]) {\n            overflow: hidden;\n          }\n          simple-icon-button-lite {\n            color: inherit;\n          }\n        "])))]);
        }
      }, {
        key: "properties",
        get: function get() {
