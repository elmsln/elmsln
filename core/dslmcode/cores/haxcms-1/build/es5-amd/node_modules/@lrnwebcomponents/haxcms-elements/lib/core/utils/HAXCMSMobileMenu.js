define(["exports", "require", "../../../../../lit/index.js", "../haxcms-site-store.js", "./HAXCMSI18NMixin.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../utils/utils.js"], function (_exports, _require, _index, _haxcmsSiteStore, _HAXCMSI18NMixin2, _mobxEsm, _utils) {
  "use strict";
  ...
  var _templateObject_c2e43670809211edaa2833647dc78c6c, _templateObject2_c2e43670809211edaa2833647dc78c6c, _templateObject3_c2e43670809211edaa2833647dc78c6c;
  ...
  var HAXCMSMobileMenuMixin = function HAXCMSMobileMenuMixin(SuperClass) {
    return /*#__PURE__*/function (_HAXCMSI18NMixin) {
      ...
      function _class() {
        ...
        _this.menuOpen = true;
        _this.t = _this.t || {};
        _this.t.toggleMenu = "Toggle menu";
        var status = (0, _utils.localStorageGet)("hax-mobile-menu-menuOpen", null);
        ...
        (0, _mobxEsm.autorun)(function (reaction) {
          ...
          // close the menu
          if (_this.shadowRoot && _this.shadowRoot.querySelector("#haxcmsmobilemenunav") && _this.menuOpen && (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeId) && ["sm", "xs"].includes(_this.responsiveSize) && (0, _utils.localStorageGet)("hax-mobile-menu-menuOpen", null) === null) {
            _this.__HAXCMSMobileMenuToggle();
          }
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function HAXCMSMobileMenuButton() {
          ...
          return (0, _index.html)(_templateObject_c2e43670809211edaa2833647dc78c6c || (_templateObject_c2e43670809211edaa2833647dc78c6c = babelHelpers.taggedTemplateLiteral(["\n        <simple-icon-button-lite\n          class=\"btn\"\n          icon=\"icons:menu\"\n          label=\"", "\"\n          id=\"haxcmsmobilemenubutton\"\n          .part=\"", "\"\n          @click=\"", "\"\n        ></simple-icon-button-lite>\n        <simple-tooltip for=\"haxcmsmobilemenubutton\" position=\"", "\">\n          ", "\n        </simple-tooltip>\n      "])), this.t.toggleMenu, this.editMode ? "edit-mode-active" : "", this.__HAXCMSMobileMenuClickToggle, position, this.t.toggleMenu);
        }
      }, {
        key: "__HAXCMSMobileMenuClickToggle",
        value: function __HAXCMSMobileMenuClickToggle() {
          this.__HAXCMSMobileMenuToggle(); //set local storage when clicking by the user


          (0, _utils.localStorageSet)("hax-mobile-menu-menuOpen", this.menuOpen);
        }
      }, {
        key: "__HAXCMSMobileMenuToggle",
        value: function __HAXCMSMobileMenuToggle() {
          if (this.menuOpen) {
            this.menuOpen = false;
        ...
        value: function HAXCMSMobileMenu(e) {
          return (0, _index.html)(_templateObject2_c2e43670809211edaa2833647dc78c6c || (_templateObject2_c2e43670809211edaa2833647dc78c6c = babelHelpers.taggedTemplateLiteral(["\n        <nav\n          id=\"haxcmsmobilemenunav\"\n          role=\"navigation\"\n          aria-labelledby=\"sitemenu\"\n        >\n          <replace-tag\n            with=\"site-menu\"\n            part=\"site-menu\"\n            id=\"sitemenu\"\n            import-method=\"view\"\n          ></replace-tag>\n        </nav>\n      "])));
        }
        /**
        ...
        value: function updated(changedProperties) {
          ...
          changedProperties.forEach(function (oldValue, propName) {
            ...
            if (propName == "responsiveSize" && (0, _utils.localStorageGet)("hax-mobile-menu-menuOpen", null) === null) {
              switch (_this2[propName]) {
                case "sm":
                  // auto close for small layouts
                  if (_this2.menuOpen && oldValue != "xs") {
                ...
                case "xs":
                  // auto close for small layouts
                  if (_this2.menuOpen && oldValue != "sm") {
                    _this2.__HAXCMSMobileMenuToggle();
                  }
        ...
        get: function get() {
          ...
          return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject3_c2e43670809211edaa2833647dc78c6c || (_templateObject3_c2e43670809211edaa2833647dc78c6c = babelHelpers.taggedTemplateLiteral(["\n          site-menu:not(:defined) {\n            display: none;\n          }\n          replace-tag[with=\"site-menu\"] {\n            height: 100vh;\n          }\n          :host([responsive-size=\"xs\"][menu-open]),\n          :host([responsive-size=\"sm\"][menu-open]) {\n            overflow: hidden;\n          }\n          simple-icon-button-lite {\n            color: inherit;\n          }\n        "])))]);
        }
      }, {
        key: "properties",
        get: function get() {
