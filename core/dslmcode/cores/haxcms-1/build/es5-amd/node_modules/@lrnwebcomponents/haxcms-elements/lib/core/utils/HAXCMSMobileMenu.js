define(["exports", "require", "../../../../../lit/index.js", "../haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js"], function (_exports, _require, _index, _haxcmsSiteStore, _mobxEsm) {
  ...
  var _templateObject_1784d0e0514b11ecb9f033a821100adf, _templateObject2_1784d0e0514b11ecb9f033a821100adf, _templateObject3_1784d0e0514b11ecb9f033a821100adf;
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function firstUpdated(changedProperties) {
          ...
          (0, _mobxEsm.autorun)(function (reaction) {
            ...
            // close the menu
            if (_this2.shadowRoot.querySelector("#haxcmsmobilemenunav") && _this2.menuOpen && (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeId) && ["sm", "xs"].includes(_this2.responsiveSize) && localStorageGet("hax-mobile-menu-menuOpen") == null) {
        ...
        value: function HAXCMSMobileMenuButton() {
          ...
          return (0, _index.html)(_templateObject_1784d0e0514b11ecb9f033a821100adf || (_templateObject_1784d0e0514b11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["\n        <simple-icon-button-lite\n          class=\"btn\"\n          icon=\"icons:menu\"\n          label=\"Toggle menu\"\n          id=\"haxcmsmobilemenubutton\"\n          .part=\"", "\"\n          @click=\"", "\"\n        ></simple-icon-button-lite>\n        <simple-tooltip for=\"haxcmsmobilemenubutton\">\n          Toggle menu\n        </simple-tooltip>\n      "])), this.editMode ? "edit-mode-active" : "", this.__HAXCMSMobileMenuToggle);
        }
      }, {
        ...
        value: function HAXCMSMobileMenu(e) {
          return (0, _index.html)(_templateObject2_1784d0e0514b11ecb9f033a821100adf || (_templateObject2_1784d0e0514b11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["\n        <nav\n          id=\"haxcmsmobilemenunav\"\n          role=\"navigation\"\n          aria-labelledby=\"sitemenu\"\n        >\n          <replace-tag\n            with=\"site-menu\"\n            part=\"site-menu\"\n            id=\"sitemenu\"\n            import-method=\"view\"\n          ></replace-tag>\n        </nav>\n      "])));
        }
        /**
        ...
        get: function get() {
          ...
          return [].concat(babelHelpers.toConsumableArray(styles), [(0, _index.css)(_templateObject3_1784d0e0514b11ecb9f033a821100adf || (_templateObject3_1784d0e0514b11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["\n          site-menu:not(:defined) {\n            display: none;\n          }\n          replace-tag[with=\"site-menu\"] {\n            height: 100vh;\n          }\n          :host([responsive-size=\"xs\"][menu-open]),\n          :host([responsive-size=\"sm\"][menu-open]) {\n            overflow: hidden;\n          }\n          simple-icon-button-lite {\n            color: inherit;\n          }\n        "])))]);
        }
      }, {
        key: "properties",
        get: function get() {
