define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../haxcms-elements/lib/core/HAXCMSThemeWiring.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/lib/mobx.module.js", "../hax-body/lib/haxutils.js", "../haxcms-elements/lib/ui-components/query/site-query.js", "../../@polymer/iron-pages/iron-pages.js", "../../@polymer/iron-icon/iron-icon.js", "../../@polymer/polymer/lib/elements/dom-repeat.js", "../haxcms-elements/lib/ui-components/active-item/site-share-widget.js"], function (_exports, _require, _polymerElement, _HAXCMSThemeWiring, _haxcmsSiteStore, _mobxModule, _haxutils, _siteQuery, _ironPages, _ironIcon, _domRepeat, _siteShareWidget) {
  ...
  function _templateObject_eec69180e3b411e9b0d5a5c01151ac03() {
    ...
    _templateObject_eec69180e3b411e9b0d5a5c01151ac03 = function _templateObject_eec69180e3b411e9b0d5a5c01151ac03() {
      return data;
    };
  ...
  function (_HAXCMSTheme) {
    babelHelpers.inherits(HaxorSlevin, _HAXCMSTheme);
    babelHelpers.createClass(HaxorSlevin, [{
      ...
      value: function _getColor(manifest) {
        if (manifest && (0, _haxutils.varExists)(manifest, "metadata.theme.variables.hexCode")) {
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_eec69180e3b411e9b0d5a5c01151ac03());
      } // properties available to the custom element for data binding

    }, {
      key: "properties",
      get: function get() {
        return Object.assign(babelHelpers.get(babelHelpers.getPrototypeOf(HaxorSlevin), "properties", this), {
          manifest: {
            type: Object
          },
          color: {
    ...
    babelHelpers.createClass(HaxorSlevin, [{
      ...
      value: function connectedCallback() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(HaxorSlevin.prototype), "connectedCallback", this).call(this);
        (0, _mobxModule.autorun)(function (reaction) {
          _this2._noticeLocationChange(_haxcmsSiteStore.store.location);
        });
        (0, _mobxModule.autorun)(function (reaction) {
          var manifest = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.manifest);
          _this2.title = manifest.title;
          _this2.image = (0, _haxutils.varGet)(manifest, "metadata.theme.variables.image", "assets/banner.jpg");
          _this2.icon = (0, _haxutils.varGet)(manifest, "metadata.theme.variables.icon", "icons:record-voice-over");
          _this2.author = (0, _haxutils.varGet)(manifest, "metadata.author", {});
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          _this2.activeTitle = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.activeTitle);
          _this2.shareUrl = document.location.href;
          _this2.shareMsg = _this2.activeTitle + " " + _this2.shareUrl;

          if (_haxcmsSiteStore.store.activeItem && _haxcmsSiteStore.store.activeItem.metadata && _haxcmsSiteStore.store.activeItem.metadata.fields && _haxcmsSiteStore.store.activeItem.metadata.fields.subtitle) {
            _this2.subtitle = _haxcmsSiteStore.store.activeItem.metadata.fields.subtitle;
          } else {
            _this2.subtitle = false;
          } // look for image on the post and make it the pin share


          if (_haxcmsSiteStore.store.activeItem && _haxcmsSiteStore.store.activeItem.metadata && _haxcmsSiteStore.store.activeItem.metadata.fields && _haxcmsSiteStore.store.activeItem.metadata.fields.images && _haxcmsSiteStore.store.activeItem.metadata.fields.images[0] && _haxcmsSiteStore.store.activeItem.metadata.fields.images[0].src) {
            _this2.activeImage = _haxcmsSiteStore.store.activeItem.metadata.fields.images[0].src;
          }
