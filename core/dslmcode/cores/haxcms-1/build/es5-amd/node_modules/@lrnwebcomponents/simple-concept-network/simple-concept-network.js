define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../simple-colors/simple-colors.js", "../hax-body-behaviors/lib/HAXWiring.js", "../a11y-behaviors/a11y-behaviors.js"], function (_exports, _require, _polymerElement, _renderStatus, _simpleColors, _HAXWiring, _a11yBehaviors) {
  "use strict";
  ...
  function _templateObject_c314d280aa5311e9b999174ecd579fc6() {
    ...
    _templateObject_c314d280aa5311e9b999174ecd579fc6 = function _templateObject_c314d280aa5311e9b999174ecd579fc6() {
      return data;
    };
  ...
  function (_A11yBehaviors) {
    ...
    function SimpleConceptNetwork() {
      ...
      (0, _renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(_this), function () {
        ...
        this.HAXWiring.setup(SimpleConceptNetwork.haxProperties, SimpleConceptNetwork.tag, this);
      });
      return _this;
    }
    ...
    babelHelpers.createClass(SimpleConceptNetwork, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_c314d280aa5311e9b999174ecd579fc6());
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(SimpleConceptNetwork), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(SimpleConceptNetwork), "properties", this));
        }
