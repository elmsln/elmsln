define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/simple-icon.js", "./hax-toolbar-item.js", "../../simple-popover/lib/simple-popover-selection.js"], function (_exports, _litElement, _simpleIcon, _haxToolbarItem, _simplePopoverSelection) {
  ...
  function _templateObject2_8ffd3a502a8011eba2d4d1ca9882dbe4() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          box-sizing: border-box;\n        }\n        simple-icon {\n          --simple-icon-height: 10px;\n          --simple-icon-width: 10px;\n        }\n        .flip-icon {\n          transform: rotateY(180deg);\n        }\n      "]);

    _templateObject2_8ffd3a502a8011eba2d4d1ca9882dbe4 = function _templateObject2_8ffd3a502a8011eba2d4d1ca9882dbe4() {
      return data;
    };
  ...
  function _templateObject_8ffd3a502a8011eba2d4d1ca9882dbe4() {
    ...
    _templateObject_8ffd3a502a8011eba2d4d1ca9882dbe4 = function _templateObject_8ffd3a502a8011eba2d4d1ca9882dbe4() {
      return data;
    };
  ...
  var HaxToolbarMenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxToolbarMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_8ffd3a502a8011eba2d4d1ca9882dbe4(), this.selectedChanged, this.mini, this.action, this.icon, !this.icon, this.iconClass, this.tooltip);
      }
    }, {
      key: "selectedChanged",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_8ffd3a502a8011eba2d4d1ca9882dbe4())];
      }
    }, {
      key: "tag",
      get: function get() {
