define(["exports", "../../../lit/index.js", "../../simple-toolbar/lib/simple-toolbar-menu.js", "./hax-ui-styles.js"], function (_exports, _index, _simpleToolbarMenu, _haxUiStyles) {
  ...
  var _templateObject_ca493270f9df11eba887937af67006f3, _templateObject2_ca493270f9df11eba887937af67006f3;
  ...
  var HaxToolbarMenu = /*#__PURE__*/function (_SimpleToolbarMenuBeh) {
    ...
    babelHelpers.createClass(HaxToolbarMenu, [{
      ...
      get: function get() {
        return (0, _index.html)(_templateObject_ca493270f9df11eba887937af67006f3 || (_templateObject_ca493270f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["<slot name=\"menuitem\"></slot>"])));
      }
    }], [{
      key: "styles",
      get:
      ...
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxToolbarMenu), "simpleButtonCoreStyles", this)), [(0, _index.css)(_templateObject2_ca493270f9df11eba887937af67006f3 || (_templateObject2_ca493270f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n        ::slotted([slot=\"menuitem\"]) {\n          --simple-toolbar-button-justify: flex-start;\n          --simple-toolbar-button-label-white-space: nowrap;\n        }\n      "])))]);
      }
    }, {
      key: "tag",
      get: function get() {
