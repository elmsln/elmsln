define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/simple-icon.js", "./hax-toolbar-item.js", "../../simple-popover/lib/simple-popover-selection.js"], function (_exports, _litElement, _simpleIcon, _haxToolbarItem, _simplePopoverSelection) {
  ...
  function _templateObject2_8740f330290811ebbe0ae90af5f52b1f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          box-sizing: border-box;\n        }\n        simple-icon {\n          --simple-icon-height: 10px;\n          --simple-icon-width: 10px;\n        }\n        .flip-icon {\n          transform: rotateY(180deg);\n        }\n      "]);

    _templateObject2_8740f330290811ebbe0ae90af5f52b1f = function _templateObject2_8740f330290811ebbe0ae90af5f52b1f() {
      return data;
    };
  ...
  function _templateObject_8740f330290811ebbe0ae90af5f52b1f() {
    ...
    _templateObject_8740f330290811ebbe0ae90af5f52b1f = function _templateObject_8740f330290811ebbe0ae90af5f52b1f() {
      return data;
    };
  ...
  var HaxToolbarMenu = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HaxToolbarMenu, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_8740f330290811ebbe0ae90af5f52b1f(), this.selectedChanged, this.mini, this.action, this.icon, !this.icon, this.iconClass, this.tooltip);
      }
    }, {
      key: "selectedChanged",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_8740f330290811ebbe0ae90af5f52b1f())];
      }
    }, {
      key: "tag",
      get: function get() {
