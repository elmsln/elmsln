define(["exports"], function (_exports) {
   ...
   */
  var TwitterEmbedVanilla =
  /*#__PURE__*/
  function (_HTMLElement) {
    babelHelpers.inherits(TwitterEmbedVanilla, _HTMLElement);
    babelHelpers.createClass(TwitterEmbedVanilla, null, [{
      key: "tag",
      get: function get() {
    ...
    function TwitterEmbedVanilla() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(TwitterEmbedVanilla).call(this));
