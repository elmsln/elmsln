define(["exports", "../../lit/index.js", "./lib/fullscreen-behaviors-manager.js"], function (_exports, _index, _fullscreenBehaviorsManager) {
  "use strict";
  ...
  var _templateObject_33104fa005b111eca8d88f1707d5c443;
    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function render() {
          return (0, _index.html)(_templateObject_33104fa005b111eca8d88f1707d5c443 || (_templateObject_33104fa005b111eca8d88f1707d5c443 = babelHelpers.taggedTemplateLiteral([" <slot></slot> "])));
        }
      }, {
        ...
        value: function _updateFullscreen(fullscreen) {
          var _this2 = this;

          if (babelHelpers.typeof(fullscreen) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) fullscreen = screenfull && screenfull.isFullscreen;

          var delayedUpdate = function delayedUpdate(e) {
            setTimeout(_this2._updateFullscreen(), 500);
          };

          this.__fullscreen = fullscreen; //needed for escape key detection

          if (this.__fullscreen) {
            document.addEventListener("fullscreenchange", delayedUpdate.bind(this));
          } else {
            document.removeEventListener("fullscreenchange", delayedUpdate.bind(this));
          }
        }
      }, {
        key: "_updateEnabled",
        value: function _updateEnabled() {
          ...
          if (screenfull && screenfull.isEnabled) {
            screenfull.on("change", function (e) {
              return _this3._updateFullscreen.bind(_this3);
            });
          }
        }
      }, {
        ...
        value: function toggleFullscreen(mode) {
          if (babelHelpers.typeof(mode) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) mode = !screenfull.isFullscreen;
