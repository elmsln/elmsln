define(["exports", "meta", "../../lit-element/lit-element.js", "../es-global-bridge/es-global-bridge.js", "../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, meta, _litElement, _esGlobalBridge, _ironAjax) {
  ...
  function _templateObject2_395dbd70019d11eb9027c17497ee62cd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n      "]);

    _templateObject2_395dbd70019d11eb9027c17497ee62cd = function _templateObject2_395dbd70019d11eb9027c17497ee62cd() {
      return data;
    };
  ...
  function _templateObject_395dbd70019d11eb9027c17497ee62cd() {
    var data = babelHelpers.taggedTemplateLiteral([" <iron-ajax\n      ?auto=\"", "\"\n      url=\"", "\"\n      method=\"", "\"\n      handle-as=\"json\"\n      @response=\"", "\"\n    ></iron-ajax>"]);

    _templateObject_395dbd70019d11eb9027c17497ee62cd = function _templateObject_395dbd70019d11eb9027c17497ee62cd() {
      return data;
    };
  ...
  var LunrSearch = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(LunrSearch, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_395dbd70019d11eb9027c17497ee62cd(), this.__auto, this.dataSource, this.method, this._dataResponse);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_395dbd70019d11eb9027c17497ee62cd())];
      }
    }, {
      key: "properties",
      get: function get() {
        return _objectSpread(_objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(LunrSearch), "properties", this)), {}, {
          dataSource: {
            type: String,
    ...
    function LunrSearch() {
      ...
      var basePath = _this.pathFromUrl(meta.url);
    ...
    babelHelpers.createClass(LunrSearch, [{
      ...
      value: function _dataResponse(e) {
        ...
        if (e && e.detail && e.detail.response) {
          try {
            this.data = babelHelpers.toConsumableArray(e.detail.response);
          } catch (e) {
            console.warn(e);
          }
        }
