...
test("ID and body of footnote are read", function () {
  ...
  var footnotes = createFootnotesReader(bodyReader)(new XmlElement("w:footnotes", {}, [new XmlElement("w:footnote", {
    "w:id": "1"
  }, footnoteBody)]));
...
function footnoteTypeIsIgnored(type) {
  test("footnotes of type " + type + " are ignored", function () {
    var footnotes = createFootnotesReader()(new XmlElement("w:footnotes", {}, [new XmlElement("w:footnote", {
      "w:id": "1",
      "w:type": type
    }, [])]));
