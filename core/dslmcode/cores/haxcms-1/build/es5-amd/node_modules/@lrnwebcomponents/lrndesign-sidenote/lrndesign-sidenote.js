define(["exports", "../../@polymer/polymer/polymer-element.js", "../a11y-behaviors/a11y-behaviors.js", "../materializecss-styles/materializecss-styles.js"], function (_exports, _polymerElement, _a11yBehaviors, _materializecssStyles) {
  ...
  function _templateObject_f3a6f900b48f11e9ae0d876050e9d419() {
    ...
    _templateObject_f3a6f900b48f11e9ae0d876050e9d419 = function _templateObject_f3a6f900b48f11e9ae0d876050e9d419() {
      return data;
    };
  ...
  */
  var LrndesignSidenote =
  /*#__PURE__*/
  function (_A11yBehaviors) {
    babelHelpers.inherits(LrndesignSidenote, _A11yBehaviors);
    babelHelpers.createClass(LrndesignSidenote, null, [{
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_f3a6f900b48f11e9ae0d876050e9d419());
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    function LrndesignSidenote() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrndesignSidenote).call(this));

      for (var prop in _this.properties) {
        var prefix = _this.is; // convert prefix to camel case

        prefix = prefix.replace("-", " ").replace(/(?:^\w|[A-Z]|\b\w)/g, function (letter, index) {
          return index == 0 ? letter.toLowerCase() : letter.toUpperCase();
        }).replace(/\s+/g, ""); // find out if a property override is set on the window object

        if (typeof window[prefix] !== "undefined") {
          if (typeof window[prefix][prop] !== "undefined") {
            _this.properties[prop].value = window[prefix][prop];
          }
        }
      }
    ...
    babelHelpers.createClass(LrndesignSidenote, [{
      key: "__updateStyles",
      value: function __updateStyles(bgColor, outset, outsetMeasurementType) {
        ...
        this.updateStyles({
          ...
          "--container-outset": "".concat(Number(outset)).concat(outsetMeasurementType)
        });
      }
    }], [{
      key: "observers",
  ...
  }((0, _a11yBehaviors.A11yBehaviors)(_polymerElement.PolymerElement));
