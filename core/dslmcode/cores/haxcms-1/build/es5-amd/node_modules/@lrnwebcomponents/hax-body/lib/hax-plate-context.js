define(["exports", "../../simple-popover/lib/SimpleTourFinder.js", "./hax-store.js", "./hax-context-item-menu.js", "./hax-context-item.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _SimpleTourFinder2, _haxStore, _haxContextItemMenu, _haxContextItem, _mobxEsm) {
  "use strict";
    ...
    function HaxPlateContext() {
      ...
      (0, _mobxEsm.autorun)(function () {
        if ((0, _mobxEsm.toJS)(_haxStore.HAXStore.activeEditingElement)) {
          _this.hasActiveEditingElement = true;
        } else {
