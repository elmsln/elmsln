define(["exports", "require", "../hax-body/lib/hax-store.js"], function (_exports, _require, _haxStore) {
  ...
  function (_HTMLElement) {
    ...
    babelHelpers.createClass(HAX, [{
      ...
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(HAX), "properties", this), {
          appStore: {
            name: "appStore",
            type: String,
            value: ""
    ...
    babelHelpers.createClass(HAX, [{
      ...
      value: function storeReady(e) {
        ...
        if (e.detail) {
          setTimeout(function () {
            window.HaxStore.instance.appStore = _objectSpread({}, JSON.parse(_this2.getAttribute("app-store")));
          }, 0);
        }
      }
      /**
