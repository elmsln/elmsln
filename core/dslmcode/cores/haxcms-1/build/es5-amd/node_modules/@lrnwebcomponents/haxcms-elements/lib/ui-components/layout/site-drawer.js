define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _customStyle) {
  ...
  function _templateObject2_43d4d0d0db3d11eaa14b6130b7e5d77f() {
    ...
    _templateObject2_43d4d0d0db3d11eaa14b6130b7e5d77f = function _templateObject2_43d4d0d0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_43d4d0d0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        .drawer-contents {\n          height: 100%;\n          overflow-y: auto;\n          padding: 16px;\n        }\n        paper-icon-button {\n          color: var(--site-drawer-button-color, #ffffff);\n        }\n      "]);

    _templateObject_43d4d0d0db3d11eaa14b6130b7e5d77f = function _templateObject_43d4d0d0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteDrawer, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_43d4d0d0db3d11eaa14b6130b7e5d77f())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(SiteDrawer, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_43d4d0d0db3d11eaa14b6130b7e5d77f(), this.icon, this.toggle, this.align);
      }
    }, {
      key: "toggle",
