define(["exports"], function (_exports) {
  ...
  function (_HTMLElement) {
    babelHelpers.inherits(HAXApp, _HTMLElement);

    function HAXApp() {
      var _this;

      babelHelpers.classCallCheck(this, HAXApp);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HAXApp).call(this));
      _this.eventName = "hax-register-app";
      return _this;
    }

    babelHelpers.createClass(HAXApp, [{
      ...
      value: function connectedCallback() {
        if (babelHelpers.typeof(this.data) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
  ...
  * @demo demo/index.html
  ...
  /*#__PURE__*/
  function (_HAXApp) {
    babelHelpers.inherits(HAXBlox, _HAXApp);

    function HAXBlox() {
      var _this2;

      babelHelpers.classCallCheck(this, HAXBlox);
      _this2 = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HAXBlox).call(this));
      _this2.eventName = "hax-register-blox";
      return _this2;
    }

    babelHelpers.createClass(HAXBlox, null, [{
      key: "tag",
      get: function get() {
        return "hax-blox";
      }
  ...
  /*#__PURE__*/
  function (_HAXApp2) {
    babelHelpers.inherits(HAXStax, _HAXApp2);

    function HAXStax() {
      var _this3;

      babelHelpers.classCallCheck(this, HAXStax);
      _this3 = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HAXStax).call(this));
      _this3.eventName = "hax-register-stax";
      return _this3;
    }

    babelHelpers.createClass(HAXStax, null, [{
      key: "tag",
      get: function get() {
        return "hax-stax";
      }
