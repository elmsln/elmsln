...
target.querySelectorAll("*").forEach(function(el){loader.processNewElement(el)})}}else{setTimeout(/*#__PURE__*/babelHelpers.asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee(){var i,target;return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:// set the basePath if it exists
