define(["exports", "meta", "../../lit-element/lit-element.js"], function (_exports, meta, _litElement) {
  ...
  var _templateObject_b7e42400d39211eb9590b786b63a9382;
      ...
      value: function haxgizmoRegistration(store) {
        window.dispatchEvent(new CustomEvent("i18n-manager-register-element", {
          detail: {
            ...
            localesPath: decodeURIComponent(meta.url) + "/../locales",
            locales: ["es"]
          }
        }));
      }
