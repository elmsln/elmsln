  ...
  var RichTextEditorImage = /*#__PURE__*/function (_RichTextEditorPrompt) {
    ...
    babelHelpers.createClass(RichTextEditorImage, [{
      ...
      value: function getValue() {
        return !this.targetedNode ? undefined : {
          alt: !this.targetedNode ? undefined : this.targetedNode.getAttribute("alt"),
          src: !this.targetedNode ? undefined : this.targetedNode.getAttribute("src"),
          width: !this.targetedNode ? undefined : this.targetedNode.getAttribute("width"),
          height: !this.targetedNode ? undefined : this.targetedNode.getAttribute("height")
        };
      }
      /**
