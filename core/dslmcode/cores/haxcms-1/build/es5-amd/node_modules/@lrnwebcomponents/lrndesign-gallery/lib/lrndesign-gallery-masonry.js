define(["exports", "../../../lit/index.js", "./lrndesign-gallery-behaviors.js", "./lrndesign-gallery-zoom.js", "./lrndesign-gallery-details.js", "../../utils/utils.js"], function (_exports, _index, _lrndesignGalleryBehaviors, _lrndesignGalleryZoom, _lrndesignGalleryDetails, _utils) {
  ...
  var _templateObject_b43f8680514811ecbc9c292a285688ae, _templateObject2_b43f8680514811ecbc9c292a285688ae, _templateObject3_b43f8680514811ecbc9c292a285688ae, _templateObject4_b43f8680514811ecbc9c292a285688ae;
  ...
  var LrndesignGalleryMasonry = /*#__PURE__*/function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGalleryMasonry, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_b43f8680514811ecbc9c292a285688ae || (_templateObject_b43f8680514811ecbc9c292a285688ae = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"grid\">\n        <p class=\"sr-only\">A list of columns buttons items:</p>\n        <div id=\"galleryscreen\">\n          ", "\n        </div>\n      </div>\n    "])), (this.__items || []).map(function (row, i) {
          return (0, _index.html)(_templateObject2_b43f8680514811ecbc9c292a285688ae || (_templateObject2_b43f8680514811ecbc9c292a285688ae = babelHelpers.taggedTemplateLiteral(["\n              <div>\n                ", "\n              </div>\n            "])), (row.cols || []).map(function (col, j) {
            return (0, _index.html)(_templateObject3_b43f8680514811ecbc9c292a285688ae || (_templateObject3_b43f8680514811ecbc9c292a285688ae = babelHelpers.taggedTemplateLiteral(["\n                    <lrndesign-gallery-zoom\n                      .id=\"", "\"\n                      .details=\"", "\"\n                      .heading=\"", "\"\n                      .src=\"", "\"\n                      .tooltip=\"", "\"\n                      .zoom-alt=\"", "\"\n                      style=\"", "\"\n                    >\n                      <img\n                        .alt=\"", "\"\n                        fade\n                        .src=\"", "\"\n                        @load=\"", "\"\n                      />\n                      <div class=\"zoombg\"></div>\n                      <simple-icon-lite\n                        icon=\"zoom-in\"\n                        class=\"zoomicon\"\n                      ></simple-icon-lite>\n                    </lrndesign-gallery-zoom>\n                  "])), col.id, col.details, col.heading, col.large, col.tooltip, col.zoomAlt, _this2._getStyle(col.aspect, row.aspect), col.alt, col.src, function (e) {
