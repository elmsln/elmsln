define(["exports", "meta", "../../lit-element/lit-element.js", "../utils/utils.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _litElement, _utils, _esGlobalBridge) {
  ...
  function _templateObject2_e56c72c0512d11eba3cb872b69c5cbbb() {
    ...
    _templateObject2_e56c72c0512d11eba3cb872b69c5cbbb = function _templateObject2_e56c72c0512d11eba3cb872b69c5cbbb() {
      return data;
    };
  ...
  function _templateObject_e56c72c0512d11eba3cb872b69c5cbbb() {
    var data = babelHelpers.taggedTemplateLiteral([" <div id=\"", "-title\" class=\"title\">\n          ", "\n          <slot name=\"heading\"></slot>\n        </div>\n        <div id=\"", "-desc\" class=\"desc\">\n          ", "\n          <slot name=\"desc\"></slot>\n        </div>\n        <div\n          id=\"chart\"\n          chart=\"", "\"\n          role=\"presentation\"\n          aria-labelledby=\"", "-title\"\n          aria-describedby=\"", "-table ", "-desc\"\n          class=\"ct-chart ", "\"\n        ></div>\n        <div\n          id=\"", "-table\"\n          class=\"", "\"\n        >\n          <slot></slot>\n        </div>"]);

    _templateObject_e56c72c0512d11eba3cb872b69c5cbbb = function _templateObject_e56c72c0512d11eba3cb872b69c5cbbb() {
      return data;
    };
    ...
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function render() {
          return (0, _litElement.html)(_templateObject_e56c72c0512d11eba3cb872b69c5cbbb(), this.__chartId, this.chartTitle, this.__chartId, this.chartDesc, this.__chartId, this.__chartId, this.__chartId, this.__chartId, this.scale, this.__chartId, this.showTable ? "table" : "table sr-only");
        ...
        //styles function
        get: function get() {
          return [(0, _litElement.css)(_templateObject2_e56c72c0512d11eba3cb872b69c5cbbb())];
        }
      }, {
        key: "properties",
        get: function get() {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function updated(changedProperties) {
          ...
          changedProperties.forEach(function (oldValue, propName) {
            if (propName === "chartData" && JSON.stringify(_this2.chartData) !== JSON.stringify(oldValue)) {
              ...
              if (_this2.dataSource !== "") fetch(_this2.dataSource).then(function (response) {
                return response.text();
              }).then(function (data) {
                return _this2.data = _this2._CSVtoArray(data);
              });
        ...
        get: function get() {
          ...
          var callback = function callback(mutationsList, observer) {
            return _this6._updateData(mutationsList, observer);
          };
