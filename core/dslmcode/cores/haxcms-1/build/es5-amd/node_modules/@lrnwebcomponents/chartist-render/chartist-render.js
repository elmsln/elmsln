define(["exports", "meta", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/resolve-url.js", "../es-global-bridge/es-global-bridge.js", "./lib/chartist-render-shared-styles.js"], function (_exports, meta, _polymerElement, _resolveUrl, _esGlobalBridge, _chartistRenderSharedStyles) {
  ...
  function _templateObject_2788bbf0b49511e9bfd4f79a8a57e0f7() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style include=\"chartist-render-shared-styles\">\n        :host {\n          display: block;\n        }\n      </style>\n      <div id=\"chart\" chart$=\"[[__chartId]]\" class$=\"ct-chart [[scale]]\"></div>\n    "]);

    _templateObject_2788bbf0b49511e9bfd4f79a8a57e0f7 = function _templateObject_2788bbf0b49511e9bfd4f79a8a57e0f7() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(ChartistRender, _PolymerElement);
    ...
    babelHelpers.createClass(ChartistRender, [{
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(ChartistRender.prototype), "connectedCallback", this).call(this);
        ...
        window.addEventListener("es-bridge-chartistLib-loaded", this._chartistLoaded.bind(this));
      ...
      value: function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(ChartistRender.prototype), "ready", this).call(this);
        var root = this;
        window.dispatchEvent(new CustomEvent("chartist-render-ready", {
          detail: root
        }));
        if ((typeof Chartist === "undefined" ? "undefined" : babelHelpers.typeof(Chartist)) === "object") root._chartistLoaded.bind(root);
      }
      /**
      ...
      value: function makeChart() {
        ...
        setTimeout(function () {
          _this.chart = _this._renderChart();
        }, 100);
      }
      /**
      ...
      value: function _renderChart() {
        ...
        if (root !== undefined && (typeof Chartist === "undefined" ? "undefined" : babelHelpers.typeof(Chartist)) === "object" && root.$.chart !== null && root.data !== null) {
          if (root.type == "bar") {
            if (root.responsiveOptions !== undefined && root.responsiveOptions.length > 0) {
              root.responsiveOptions.forEach(function (option) {
            ...
            chart = Chartist.Bar(this.$.chart, root.data, root.options, root.responsiveOptions);
          } else if (root.type == "line") {
            chart = Chartist.Line(this.$.chart, root.data, root.options, root.responsiveOptions);
          } else if (root.type == "pie") {
            chart = Chartist.Pie(this.$.chart, root.data, root.options, root.responsiveOptions);
          }

          window.dispatchEvent(new CustomEvent("chartist-render-draw", {
            detail: chart
          }));
      ...
      value: function addA11yFeatures(svg) {
        var desc = this.data.labels !== undefined && this.data.labels !== null ? this.chartDesc + this.makeA11yTable(svg) : this.chartDesc;
      ...
      key: "makeA11yTable",
      value: function makeA11yTable(svg) {
        var title = this.chartTitle !== null ? this.chartTitle : "A " + this.type + " chart.";
        var table = ['<table summary="Each column is a series of data, and the first column is the data label.">', "<caption>" + title + "</caption>", "<tbody>"];
      ...
      key: "_addA11yFeature",
      value: function _addA11yFeature(svg, tag, html) {
        var el = document.createElement(tag);
        var first = svg.childNodes[0];
        el.innerHTML = html;
      ...
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_2788bbf0b49511e9bfd4f79a8a57e0f7());
