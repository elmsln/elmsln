...
(function ($) {
  ...
  H5PUtils.createTable = function (headers) {
    ...
    if (headers) {
      ...
      $.each(headers, function (index, value) {
        if (!babelHelpers.instanceof(value, Object)) {
          value = {
            html: value
          };
        }
  ...
  H5PUtils.Table = function (classes) {
    ...
    var addCol = function addCol($tr, col, id) {
      var options = {
        on: {}
      };

      if (!babelHelpers.instanceof(col, Object)) {
        options.text = col;
      } else {
  ...
  H5PUtils.Pagination = function (num, limit, goneTo, l10n) {
    ...
    var gotInput = function gotInput() {
