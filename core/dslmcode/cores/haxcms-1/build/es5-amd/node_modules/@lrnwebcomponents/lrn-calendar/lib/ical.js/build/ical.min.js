"object" == (typeof module === "undefined" ? "undefined" : babelHelpers.typeof(module)) ? ICAL = module.exports : "object" != (typeof ICAL === "undefined" ? "undefined" : babelHelpers.typeof(ICAL)) && (this.ICAL = {}), ICAL.foldLength = 75, ICAL.newLineChar = "\r\n", ICAL.helpers = {
  isStrictlyNaN: function isStrictlyNaN(a) {
    return "number" == typeof a && isNaN(a);
  },
  strictParseInt: function strictParseInt(a) {
    var b = parseInt(a, 10);
    if (ICAL.helpers.isStrictlyNaN(b)) throw new Error('Could not extract integer from "' + a + '"');
    return b;
  },
  formatClassType: function formatClassType(a, b) {
    if ("undefined" != typeof a) return babelHelpers.instanceof(a, b) ? a : new b(a);
  },
  unescapedIndexOf: function unescapedIndexOf(a, b, c) {
    for (; (c = a.indexOf(b, c)) !== -1;) {
  ...
  binsearchInsert: function binsearchInsert(a, b, c) {
    if (!a.length) return 0;

    for (var d, e, f = 0, g = a.length - 1; f <= g;) {
      if (d = f + Math.floor((g - f) / 2), e = c(b, a[d]), e < 0) g = d - 1;else {
        if (!(e > 0)) break;
        f = d + 1;
      }
    }
  ...
  clone: function clone(a, b) {
    if (a && "object" == babelHelpers.typeof(a)) {
      if (babelHelpers.instanceof(a, Date)) return new Date(a.getTime());
      if ("clone" in a) return a.clone();

      if (Array.isArray(a)) {
        for (var c = [], d = 0; d < a.length; d++) {
          c.push(b ? ICAL.helpers.clone(a[d], !0) : a[d]);
        }
      ...
      for (var f in a) {
        Object.prototype.hasOwnProperty.call(a, f) && (b ? e[f] = ICAL.helpers.clone(a[f], !0) : e[f] = a[f]);
      }
  ...
  foldline: function foldline(a) {
    for (var b = "", c = a || ""; c.length;) {
      b += ICAL.newLineChar + " " + c.substr(0, ICAL.foldLength), c = c.substr(ICAL.foldLength);
    }

    return b.substr(ICAL.newLineChar.length + 1);
  },
  pad2: function pad2(a) {
  ...
  inherits: function inherits(a, b, c) {
    function d() {}
  ...
  function a(a, b) {
    var d = {
      matches: /.*/,
      fromICAL: function fromICAL(b, d) {
        return c(b, a, d);
      },
      toICAL: function toICAL(a, c) {
        var d = b;
  ...
  var d = /\\\\|\\;|\\,|\\[Nn]/g,
    ...
    "utc-offset": {
      ...
      decorate: function decorate(a) {
        return ICAL.UtcOffset.fromString(a);
      },
      undecorate: function undecorate(a) {
        return a.toString();
      }
    }
  },
    ...
    rdate: {
      ...
      multiValue: ",",
      detectType: function detectType(a) {
    ...
    time: {
      ...
      _splitZone: function _splitZone(a, b) {
        var c,
            d,
            e = a.length - 1,
            f = a.length - (b ? 5 : 6),
    ...
    vcard: D,
    vcard3: E,
    getDesignSet: function getDesignSet(a) {
  ...
  a.component = function (c, e) {
    ...
    for ("vcard" === k && c[1].length > 0 && ("version" !== c[1][0][0] || "4.0" !== c[1][0][3]) && (k = "vcard3"), e = e || d.getDesignSet(k); i < j; i++) {
      g += a.property(h[i], e) + b;
    }

    for (var l = c[2], m = 0, n = l.length; m < n; m++) {
      g += a.component(l[m], e) + b;
    }
    ...
    for (var h = "", i = b.length, j = 0; j < i; j++) {
      h += e && Array.isArray(b[j]) ? a.multiValue(b[j], e, d, null, f, g) : a.value(b[j], d, f, g), j !== i - 1 && (h += c);
    }
  ...
  a.prototype = Error.prototype, b.property = function (a, c) {
    ...
    for (var k, l, m, n, o, p, q = g, r = 0, s = f, t = {}, u = -1; r !== !1 && (r = j.unescapedIndexOf(c, s, r + 1)) !== -1;) {
      ...
      if ('"' === v) {
        if (u = r + 2, r = j.unescapedIndexOf(c, '"', u), o && r != -1) for (var w = !0; w;) {
          c[r + 1] == o && '"' == c[r + 2] ? r = j.unescapedIndexOf(c, '"', r + 3) : w = !1;
        }
  ...
  return b._parseMultiValue = function (a, c, d, e, f, g, h) {
    ...
    for (; (k = j.unescapedIndexOf(a, c, l)) !== -1;) {
      i = a.substr(l, k - l), i = f ? b._parseMultiValue(i, f, d, [], null, g, h) : b._parseValue(i, d, g, h), e.push(i), l = k + c.length;
    }
    ...
    do {
      i = a.indexOf("\n", h) + 1, f = i > 1 && "\r" === a[i - 2] ? 2 : 1, 0 === i && (i = g, f = 0), e = a[h], " " === e || "\t" === e ? d += a.substr(h + 1, i - h - (f + 1)) : (d && b(null, d), d = a.substr(h, i - h - f)), h = i;
    } while (i !== g);
  ...
  function a(a, b) {
    "string" == typeof a && (a = [a, [], []]), this.jCal = a, this.parent = b || null;
  }
  ...
  return a.prototype = {
    ...
    _hydrateComponent: function _hydrateComponent(b) {
    ...
    _hydrateProperty: function _hydrateProperty(a) {
    ...
    getFirstSubcomponent: function getFirstSubcomponent(a) {
      if (a) {
    ...
    getAllSubcomponents: function getAllSubcomponents(a) {
      var b = this.jCal[c].length,
          e = 0;

      if (a) {
        for (var f = this.jCal[c], g = []; e < b; e++) {
          a === f[e][d] && g.push(this._hydrateComponent(e));
        }

        return g;
      }

      if (!this._components || this._hydratedComponentCount !== b) for (; e < b; e++) {
        this._hydrateComponent(e);
      }
      return this._components || [];
    },
    hasProperty: function hasProperty(a) {
    ...
    getFirstProperty: function getFirstProperty(a) {
      if (a) {
    ...
    getFirstPropertyValue: function getFirstPropertyValue(a) {
      var b = this.getFirstProperty(a);
      return b ? b.getFirstValue() : null;
    },
    getAllProperties: function getAllProperties(a) {
      var c = this.jCal[b].length,
          e = 0;

      if (a) {
        for (var f = this.jCal[b], g = []; e < c; e++) {
          a === f[e][d] && g.push(this._hydrateProperty(e));
        }

        return g;
      }

      if (!this._properties || this._hydratedPropertyCount !== c) for (; e < c; e++) {
        this._hydrateProperty(e);
      }
      return this._properties || [];
    },
    _removeObjectByIndex: function _removeObjectByIndex(a, b, c) {
      if (b = b || [], b[c]) {
        var d = b[c];
    ...
    _removeObject: function _removeObject(a, b, c) {
      var e = 0,
          f = this.jCal[a],
          g = f.length,
          h = this[b];
    ...
    _removeAllObjects: function _removeAllObjects(a, b, c) {
      for (var e = this[b], f = this.jCal[a], g = f.length - 1; g >= 0; g--) {
        c && f[g][d] !== c || this._removeObjectByIndex(a, e, g);
      }
    },
    addSubcomponent: function addSubcomponent(a) {
    ...
    removeSubcomponent: function removeSubcomponent(a) {
      var b = this._removeObject(c, "_components", a);

      return b && this._hydratedComponentCount--, b;
    },
    removeAllSubcomponents: function removeAllSubcomponents(a) {
      var b = this._removeAllObjects(c, "_components", a);

      return this._hydratedComponentCount = 0, b;
    },
    addProperty: function addProperty(a) {
      if (!babelHelpers.instanceof(a, ICAL.Property)) throw new TypeError("must instance of ICAL.Property");
  ...
  return a.prototype = {
    ...
    _hydrateValue: function _hydrateValue(a) {
    ...
    _decorate: function _decorate(a) {
      return this._designSet.value[this.type].decorate(a, this);
    },
    _undecorate: function _undecorate(a) {
      return this._designSet.value[this.type].undecorate(a, this);
    },
    _setDecoratedValue: function _setDecoratedValue(a, b) {
      this._values || (this._values = []), "object" == babelHelpers.typeof(a) && "icaltype" in a ? (this.jCal[e + b] = this._undecorate(a), this._values[b] = a) : (this.jCal[e + b] = a, this._values[b] = this._decorate(a));
    },
    ...
    removeParameter: function removeParameter(a) {
    ...
    resetType: function resetType(a) {
    ...
    setValues: function setValues(a) {
      ...
      var b = a.length,
          c = 0;
      if (this.removeAllValues(), b > 0 && "object" == babelHelpers.typeof(a[0]) && "icaltype" in a[0] && this.resetType(a[0].icaltype), this.isDecorated) for (; c < b; c++) {
        this._setDecoratedValue(a[c], c);
      } else for (; c < b; c++) {
        this.jCal[e + c] = a[c];
      }
    },
    setValue: function setValue(a) {
      this.removeAllValues(), "object" == babelHelpers.typeof(a) && "icaltype" in a && this.resetType(a.icaltype), this.isDecorated ? this._setDecoratedValue(a, 0) : this.jCal[e] = a;
    },
    toJSON: function toJSON() {
      return this.jCal;
    },
  ...
  return a.prototype = {
    ...
    fromSeconds: function fromSeconds(a) {
      var b = Math.abs(a);
    ...
    _normalize: function _normalize() {
      for (var a = this.toSeconds(), b = this.factor; a < -43200;) {
        a += 97200;
      }
  ...
  return a.prototype = {
    ...
    setEncodedValue: function setEncodedValue(a) {
      this.value = this._b64_encode(a);
    },
    _b64_encode: function _b64_encode(a) {
      var b,
          c,
          d,
          e,
    ...
    _b64_decode: function _b64_decode(a) {
      var b,
          c,
          d,
          e,
      ...
      do {
        e = j.indexOf(a.charAt(k++)), f = j.indexOf(a.charAt(k++)), g = j.indexOf(a.charAt(k++)), h = j.indexOf(a.charAt(k++)), i = e << 18 | f << 12 | g << 6 | h, b = i >> 16 & 255, c = i >> 8 & 255, d = 255 & i, 64 == g ? n[l++] = String.fromCharCode(b) : 64 == h ? n[l++] = String.fromCharCode(b, c) : n[l++] = String.fromCharCode(b, c, d);
      } while (k < a.length);
  ...
  ICAL.Period = function (a) {
    if (this.wrappedJSObject = this, a && "start" in a) {
      if (a.start && !babelHelpers.instanceof(a.start, ICAL.Time)) throw new TypeError(".start must be an instance of ICAL.Time");
      this.start = a.start;
    }
    ...
    if (a && "end" in a) {
      if (a.end && !babelHelpers.instanceof(a.end, ICAL.Time)) throw new TypeError(".end must be an instance of ICAL.Time");
      this.end = a.end;
    }

    if (a && "duration" in a) {
      if (a.duration && !babelHelpers.instanceof(a.duration, ICAL.Duration)) throw new TypeError(".duration must be an instance of ICAL.Duration");
  ...
  ICAL.Duration = function (a) {
    ...
    for (var d = 0, e = Object.create(null), f = 0; (d = c.search(b)) !== -1;) {
      var g = c[d],
          h = c.substr(0, d);
  ...
  ICAL.Timezone = function (a) {
    ...
    fromData: function fromData(b) {
      if (this.expandedUntilYear = 0, this.changes = [], babelHelpers.instanceof(b, ICAL.Component)) this.component = b;else {
        if (b && "component" in b) if ("string" == typeof b.component) {
          var c = ICAL.parse(b.component);
          this.component = new ICAL.Component(c);
        } else babelHelpers.instanceof(b.component, ICAL.Component) ? this.component = b.component : this.component = null;
      ...
      return babelHelpers.instanceof(this.component, ICAL.Component) && !this.tzid && (this.tzid = this.component.getFirstPropertyValue("tzid")), this;
    },
    ...
    _findNearbyChange: function _findNearbyChange(a) {
    ...
    _ensureCoverage: function _ensureCoverage(a) {
      ...
      if (c < ICAL.Timezone._minimumExpansionYear && (c = ICAL.Timezone._minimumExpansionYear), c += ICAL.Timezone.EXTRA_COVERAGE, c > ICAL.Timezone.MAX_YEAR && (c = ICAL.Timezone.MAX_YEAR), !this.changes.length || this.expandedUntilYear < a) {
        for (var d = this.component.getAllSubcomponents(), e = d.length, f = 0; f < e; f++) {
          this._expandComponent(d[f], c, this.changes);
        }

        this.changes.sort(ICAL.Timezone._compare_change_fn), this.expandedUntilYear = c;
      }
    },
    _expandComponent: function _expandComponent(a, b, c) {
      function d(a) {
      ...
      var f,
          g = a.getFirstProperty("dtstart").getFirstValue();
      ...
      if (a.hasProperty("rrule") || a.hasProperty("rdate")) {
        ...
        if (l) {
          ...
          for (var m, n = l.iterator(g); (m = n.next()) && (f = e(), !(m.year > b) && m);) {
            f.year = m.year, f.month = m.month, f.day = m.day, f.hour = m.hour, f.minute = m.minute, f.second = m.second, f.isDate = m.isDate, ICAL.Timezone.adjust_change(f, 0, 0, 0, -f.prevUtcOffset), c.push(f);
          }
        }
  ...
  var a,
    ...
    register: function register(b, c) {
      if (babelHelpers.instanceof(b, ICAL.Component) && "vtimezone" === b.name && (c = new ICAL.Timezone(b), b = c.tzid), !babelHelpers.instanceof(c, ICAL.Timezone)) throw new TypeError("timezone must be ICAL.Timezone or ICAL.Component");
      a[b] = c;
    },
  ...
  ICAL.Time = function (a, b) {
    ...
    resetTo: function resetTo(a, b, c, d, e, f, g) {
      this.fromData({
        year: a,
        month: b,
        day: c,
    ...
    fromJSDate: function fromJSDate(a, b) {
    ...
    startDoyWeek: function startDoyWeek(a) {
      var b = a || ICAL.Time.SUNDAY,
          c = this.dayOfWeek() - b;
    ...
    nthWeekDay: function nthWeekDay(a, b) {
      var c,
          d = ICAL.Time.daysInMonth(this.month, this.year),
          e = b,
          f = 0,
          g = this.clone();
    ...
    isNthWeekDay: function isNthWeekDay(a, b) {
      var c = this.dayOfWeek();
      if (0 === b && c === a) return !0;
      var d = this.nthWeekDay(a, b);
      return d === this.day;
    },
    weekNumber: function weekNumber(a) {
    ...
    addDuration: function addDuration(a) {
    ...
    compareDateOnlyTz: function compareDateOnlyTz(a, b) {
      function c(a) {
    ...
    convertToZone: function convertToZone(a) {
      var b = this.clone(),
    ...
    adjust: function adjust(a, b, c, d, e) {
      var f,
          g,
          h,
          i,
          ...
          n = 0,
          o = e || this._time;
      if (o.isDate || (h = o.second + d, o.second = h % 60, f = ICAL.helpers.trunc(h / 60), o.second < 0 && (o.second += 60, f--), i = o.minute + c + f, o.minute = i % 60, g = ICAL.helpers.trunc(i / 60), o.minute < 0 && (o.minute += 60, g--), j = o.hour + b + g, o.hour = j % 24, m = ICAL.helpers.trunc(j / 24), o.hour < 0 && (o.hour += 24, m--)), o.month > 12 ? n = ICAL.helpers.trunc((o.month - 1) / 12) : o.month < 1 && (n = ICAL.helpers.trunc(o.month / 12) - 1), o.year += n, o.month -= 12 * n, k = o.day + a + m, k > 0) for (; l = ICAL.Time.daysInMonth(o.month, o.year), !(k <= l);) {
        o.month++, o.month > 12 && (o.year++, o.month = 1), k -= l;
      } else for (; k <= 0;) {
        1 == o.month ? (o.year--, o.month = 12) : o.month--, k += ICAL.Time.daysInMonth(o.month, o.year);
      }
      return o.day = k, this._cachedUnixTime = null, this;
    },
    fromUnixTime: function fromUnixTime(a) {
    ...
    toJSON: function toJSON() {
      for (var a, b = ["year", "month", "day", "hour", "minute", "second", "isDate"], c = Object.create(null), d = 0, e = b.length; d < e; d++) {
        a = b[d], c[a] = this[a];
      }
  ...
  ICAL.VCardTime = function (a, b, c) {
    ...
    utcOffset: function utcOffset() {
      return babelHelpers.instanceof(this.zone, ICAL.UtcOffset) ? this.zone.toSeconds() : ICAL.Time.prototype.utcOffset.apply(this, arguments);
    },
    toICALString: function toICALString() {
    ...
    toString: function toString() {
      ...
      if (this.zone === ICAL.Timezone.utcTimezone) a = "Z";else if (babelHelpers.instanceof(this.zone, ICAL.UtcOffset)) a = this.zone.toString();else if (this.zone === ICAL.Timezone.localTimezone) a = "";else if (babelHelpers.instanceof(this.zone, ICAL.Timezone)) {
  ...
  for (var d in b) {
    b.hasOwnProperty(d) && (c[b[d]] = d);
  }

  ICAL.Recur = function (a) {
    this.wrappedJSObject = this, this.parts = {}, a && "object" == babelHelpers.typeof(a) && this.fromData(a);
    ...
    getNextOccurrence: function getNextOccurrence(a, b) {
      var c,
          d = this.iterator(a);

      do {
        c = d.next();
      } while (c && c.compare(b) <= 0);
    ...
    fromData: function fromData(a) {
      ...
      this.wkst && "number" != typeof this.wkst && (this.wkst = ICAL.Recur.icalDayToNumericDay(this.wkst)), !this.until || babelHelpers.instanceof(this.until, ICAL.Time) || (this.until = ICAL.Time.fromString(this.until));
    },
    toJSON: function toJSON() {
    ...
    toString: function toString() {
      ...
      for (var b in this.parts) {
        this.parts.hasOwnProperty(b) && (a += ";" + b + "=" + this.parts[b]);
      }
  ...
  ICAL.Recur.fromString = function (a) {
    ...
    for (var c = Object.create(null), d = a.split(";"), e = d.length, f = 0; f < e; f++) {
      ...
      if (j in i) {
        for (var n = m.split(","), o = 0, p = n.length; o < p; o++) {
          n[o] = i[j](n[o]);
        }
  ...
  return a.prototype = {
        ...
        for (var j in this.by_data.BYDAY) {
          if (this.by_data.BYDAY.hasOwnProperty(j)) {
            ...
            if (k > i || k <= 0) {
              ...
              for (; k > i || k <= 0;) {
                this.increment_month(), i = ICAL.Time.daysInMonth(this.last.month, this.last.year), k = this.last.nthWeekDay(d, c);
              }
            }
    ...
    normalizeByMonthDayRules: function normalizeByMonthDayRules(a, b, c) {
      for (var d, e = ICAL.Time.daysInMonth(b, a), f = [], g = 0, h = c.length; g < h; g++) {
        if (d = c[g], !(Math.abs(d) > e)) {
          if (d < 0) d = e + (d + 1);else if (0 === d) continue;
    ...
    _byDayAndMonthDay: function _byDayAndMonthDay(a) {
      function b() {
        for (g = ICAL.Time.daysInMonth(l.last.month, l.last.year), d = l.normalizeByMonthDayRules(l.last.year, l.last.month, l.by_data.BYMONTHDAY), f = d.length; d[i] <= m && (!a || d[i] != m) && i < f - 1;) {
          i++;
        }
      }
    ...
    next_month: function next_month() {
      ...
      if (this.has_by_data("BYDAY") && this.has_by_data("BYMONTHDAY")) a = this._byDayAndMonthDay();else if (this.has_by_data("BYDAY")) {
        var b = ICAL.Time.daysInMonth(this.last.month, this.last.year),
            c = 0,
            d = 0;

        if (this.has_by_data("BYSETPOS")) {
          for (var e = this.last.day, f = 1; f <= b; f++) {
            this.last.day = f, this.is_day_in_byday(this.last) && (d++, f <= e && c++);
          }
    ...
    ruleDayOfWeek: function ruleDayOfWeek(a) {
    ...
    next_generic: function next_generic(a, b, c, d, e) {
    ...
    increment_monthday: function increment_monthday(a) {
      for (var b = 0; b < a; b++) {
    ...
    increment_month: function increment_month() {
      if (this.last.day = 1, this.has_by_data("BYMONTH")) this.by_indices.BYMONTH++, this.by_indices.BYMONTH == this.by_data.BYMONTH.length && (this.by_indices.BYMONTH = 0, this.increment_year(1)), this.last.month = this.by_data.BYMONTH[this.by_indices.BYMONTH];else {
    ...
    increment_year: function increment_year(a) {
      this.last.year += a;
    },
    increment_generic: function increment_generic(a, b, c, d) {
      this.last[b] += a;
      var e = ICAL.helpers.trunc(this.last[b] / c);
      this.last[b] %= c, 0 != e && this["increment_" + d](e);
    },
    has_by_data: function has_by_data(a) {
      return a in this.rule.parts;
    },
    expand_year_days: function expand_year_days(a) {
      var b = new ICAL.Time();
      this.days = [];
      var c = {},
      ...
      } else if (1 == o && "BYWEEKNO" in c) ;else if (2 == o && "BYWEEKNO" in c && "BYMONTHDAY" in c) ;else if (1 == o && "BYDAY" in c) this.days = this.days.concat(this.expand_by_day(a));else if (2 == o && "BYDAY" in c && "BYMONTH" in c) {
        for (var q in this.by_data.BYMONTH) {
          if (this.by_data.BYMONTH.hasOwnProperty(q)) {
            ...
            if (this.has_by_data("BYSETPOS")) {
              for (var A = [], B = 1; B <= v; B++) {
                b.day = B, this.is_day_in_byday(b) && A.push(B);
              }

              for (var C = 0; C < A.length; C++) {
                (this.check_set_position(C + 1) || this.check_set_position(C - A.length)) && this.days.push(y + A[C]);
              }
            } else for (var D in this.by_data.BYDAY) {
              if (this.by_data.BYDAY.hasOwnProperty(D)) {
                var E,
                    F = this.by_data.BYDAY[D],
                    G = this.ruleDayOfWeek(F),
                    H = G[0],
                    I = G[1],
                    J = (I + 7 - x) % 7 + 1,
                    K = v - (z + 7 - I) % 7;
                if (0 == H) for (var B = J; B <= v; B += 7) {
                  this.days.push(y + B);
    ...
    expand_by_day: function expand_by_day(a) {
      var b = [],
          c = this.last.clone();
      ...
      for (var g in this.by_data.BYDAY) {
        if (this.by_data.BYDAY.hasOwnProperty(g)) {
          var h = this.by_data.BYDAY[g],
              ...
              j = i[0],
              k = i[1];
          if (0 == j) for (var l = (k + 7 - d) % 7 + 1, m = l; m <= f; m += 7) {
            b.push(m);
          } else if (j > 0) {
            var n;
    ...
    is_day_in_byday: function is_day_in_byday(a) {
    ...
    check_set_position: function check_set_position(a) {
      if (this.has_by_data("BYSETPOS")) {
    ...
    sort_byday_rules: function sort_byday_rules(a, b) {
      for (var c = 0; c < a.length; c++) {
        for (var d = 0; d < c; d++) {
    ...
    check_contract_restriction: function check_contract_restriction(b, c) {
      var d = a._indexMap[b],
    ...
    setup_defaults: function setup_defaults(b, c, d) {
      var e = a._indexMap[b],
  ...
  return d.prototype = {
    ...
    fromData: function fromData(b) {
      ...
      if (this.dtstart = c, b.component) this._init(b.component);else {
    ...
    _extractDates: function _extractDates(a, c) {
      function d(a) {
        e = ICAL.helpers.binsearchInsert(f, a, b), f.splice(e, 0, a);
      }

      for (var e, f = [], g = a.getAllProperties(c), h = g.length, i = 0; i < h; i++) {
        g[i].getValues().forEach(d);
      }
    ...
    _nextRecurrenceIter: function _nextRecurrenceIter() {
      ...
      for (var b, c, d, e = a.length, f = 0; f < e; f++) {
        b = a[f], c = b.last, b.completed ? (e--, 0 !== f && f--, a.splice(f, 1)) : (!d || d.last.compare(c) > 0) && (d = b);
      }
  ...
  return a.prototype = {
    ...
    exceptions: null,
    strictExceptions: !1,
    relateException: function relateException(a) {
      if (this.isRecurrenceException()) throw new Error("cannot relate exception to exceptions");
      if (babelHelpers.instanceof(a, ICAL.Component) && (a = new ICAL.Event(a)), this.strictExceptions && a.uid !== this.uid) throw new Error("attempted to relate unrelated exception");
    ...
    findRangeException: function findRangeException(a) {
    ...
    getOccurrenceDetails: function getOccurrenceDetails(a) {
      var b,
          c = a.toString(),
      ...
      if (c in this.exceptions) b = e.item = this.exceptions[c], e.startDate = b.startDate, e.endDate = b.endDate, e.item = b;else if (d in this.exceptions) b = this.exceptions[d], e.startDate = b.startDate, e.endDate = b.endDate, e.item = b;else {
        var f,
            g = this.findRangeException(a);
    ...
    _setProp: function _setProp(a, b) {
      this.component.updatePropertyWithValue(a, b);
    },
    _firstProp: function _firstProp(a) {
  ...
  return a.prototype = {
    ...
    ontimezone: function ontimezone(a) {},
    onevent: function onevent(a) {},
    process: function process(a) {
      "string" == typeof a && (a = ICAL.parse(a)), babelHelpers.instanceof(a, ICAL.Component) || (a = new ICAL.Component(a));

      for (var b, c = a.getAllSubcomponents(), d = 0, e = c.length; d < e; d++) {
        switch (b = c[d], b.name) {
          case "vtimezone":
