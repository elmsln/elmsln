define(["exports", "require", "../../../../lit/index.js", "../../../simple-toolbar/simple-toolbar.js", "../../../simple-toolbar/lib/simple-toolbar-button.js", "../buttons/rich-text-editor-button.js", "../singletons/rich-text-editor-range-behaviors.js", "../singletons/rich-text-editor-prompt.js", "../../../absolute-position-behavior/absolute-position-behavior.js", "../../../../shadow-selection-polyfill/shadow.js", "../../../utils/utils.js"], function (_exports, _require, _index, _simpleToolbar, _simpleToolbarButton, _richTextEditorButton, _richTextEditorRangeBehaviors, _richTextEditorPrompt, _absolutePositionBehavior, shadow, _utils) {
  ...
  var _templateObject_bd9e10e06f3711ecb02ca75a1b314816, _templateObject2_bd9e10e06f3711ecb02ca75a1b314816, _templateObject3_bd9e10e06f3711ecb02ca75a1b314816;
  ...
  var RichTextEditorToolbarBehaviors = function RichTextEditorToolbarBehaviors(SuperClass) {
    return /*#__PURE__*/function (_RichTextEditorRangeB) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        key: "miniTemplate",
        get: function get() {
          return (0, _index.html)(_templateObject_bd9e10e06f3711ecb02ca75a1b314816 || (_templateObject_bd9e10e06f3711ecb02ca75a1b314816 = babelHelpers.taggedTemplateLiteral([" <div id=\"container\">", "</div> "])), babelHelpers.get(babelHelpers.getPrototypeOf(_class.prototype), "toolbarTemplate", this));
        }
        /**
        ...
        value: function setTarget(target) {
          ...
          if (!!target) {
            ...
            if (oldTarget && oldTarget.getAttribute("role") == "textbox") oldTarget.removeAttribute("role");
          ...
          if (this.target !== target) {
            ...
            eventPath.forEach(function (target) {
              ...
              if (tagname && els.includes(tagname)) {
                console.log("!!!!!", tagname, target, _objectSpread(_objectSpread({}, e), {}, {
                  detail: target,
                  eventPath: eventPath
                }), els, _this11.clickableElements[tagname]);
                matched = true;
                e.preventDefault();
        ...
        key: "miniStyles",
        get: function get() {
          return [(0, _index.css)(_templateObject2_bd9e10e06f3711ecb02ca75a1b314816 || (_templateObject2_bd9e10e06f3711ecb02ca75a1b314816 = babelHelpers.taggedTemplateLiteral(["\n          :host {\n            position: relative;\n            height: 0;\n            margin: 0 auto;\n            padding: 0;\n            border: none;\n            background-color: none;\n          }\n          #container {\n            display: flex;\n            position: absolute;\n            bottom: 0;\n            margin: 0 auto;\n            padding: 0;\n            border: var(--rich-text-editor-border-width, 1px) solid\n              var(--rich-text-editor-border-color, #ddd);\n            background-color: var(\n              --rich-text-editor-bg,\n              var(--rich-text-editor-bg, #ffffff)\n            );\n          }\n        "])))];
        }
        /**
