define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../../../simple-fields/lib/simple-fields-field.js", "../../../../../@polymer/iron-icons/iron-icons.js", "../../../../../@polymer/iron-icon/iron-icon.js"], function (_exports, _require, _litElement, _simpleFieldsField, _ironIcons, _ironIcon) {
  ...
  function _templateObject5_445a5480db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <a\n            class=\"result\"\n            .href=\"", "\"\n            @click=\"", "\"\n          >\n            <div class=\"title\">\n              ", "<span\n                ?hidden=\"", "\"\n                class=\"link-text\"\n                aria-hidden=\"true\"\n                >(", ")</span\n              >\n            </div>\n            <div class=\"date\" ?hidden=\"", "\">\n              <simple-datetime format=\"M jS\" .timestamp=\"", "\" unix\n                >", "</simple-datetime\n              >\n            </div>\n            <p>", "..</p>\n          </a>\n        "]);

    _templateObject5_445a5480db3d11eaa14b6130b7e5d77f = function _templateObject5_445a5480db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject4_445a5480db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject4_445a5480db3d11eaa14b6130b7e5d77f = function _templateObject4_445a5480db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject3_445a5480db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <h1 class=\"results-found-text\">\n              Found ", " results.\n            </h1>\n          "]);

    _templateObject3_445a5480db3d11eaa14b6130b7e5d77f = function _templateObject3_445a5480db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject2_445a5480db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-fields-field\n        ?hidden=\"", "\"\n        id=\"search\"\n        always-float-label\n        label=\"Search\"\n        type=\"text\"\n        @value-changed=\"", "\"\n      >\n        <iron-icon icon=\"search\" slot=\"prefix\"></iron-icon>\n      </simple-fields-field>\n      ", "\n      <lunr-search id=\"lunr\"></lunr-search>\n\n      ", "\n    "]);

    _templateObject2_445a5480db3d11eaa14b6130b7e5d77f = function _templateObject2_445a5480db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_445a5480db3d11eaa14b6130b7e5d77f() {
    ...
    _templateObject_445a5480db3d11eaa14b6130b7e5d77f = function _templateObject_445a5480db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SiteSearch, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_445a5480db3d11eaa14b6130b7e5d77f())];
      }
      /**
    ...
    babelHelpers.createClass(SiteSearch, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_445a5480db3d11eaa14b6130b7e5d77f(), this.hideInput, this._searchValueChanged, this.search.length > 0 ? (0, _litElement.html)(_templateObject3_445a5480db3d11eaa14b6130b7e5d77f(), this.__results.length) : (0, _litElement.html)(_templateObject4_445a5480db3d11eaa14b6130b7e5d77f()), this.__results.map(function (item) {
          return (0, _litElement.html)(_templateObject5_445a5480db3d11eaa14b6130b7e5d77f(), item.location, _this2.selectionMade, item.title, !_this2.showPath, item.location, !_this2.showDate, item.created, item.created, item.description);
        }));
      }
    }, {
      key: "selectionMade",
