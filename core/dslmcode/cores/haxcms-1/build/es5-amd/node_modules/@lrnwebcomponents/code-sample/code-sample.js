define(["exports", "../../lit/index.js", "./lib/themes/one-dark.js", "./lib/highlightjs/highlight.js", "./lib/highlightjs/languages/javascript.js", "./lib/highlightjs/languages/yaml.js", "./lib/highlightjs/languages/json.js", "./lib/highlightjs/languages/css.js", "./lib/highlightjs/languages/php.js", "./lib/highlightjs/languages/xml.js"], function (_exports, _index, _oneDark, _highlight, _javascript, _yaml, _json, _css, _php, _xml) {
  "use strict";
  ...
  var _templateObject_a0913b108e0011ed99ce491205e67b1d, _templateObject2_a0913b108e0011ed99ce491205e67b1d;
  ...
  _highlight.hljs.registerLanguage("css", _css.cssLang);

  _highlight.hljs.registerLanguage("php", _php.phpLang);

  _highlight.hljs.registerLanguage("yaml", _yaml.yaml);

  _highlight.hljs.registerLanguage("xml", _xml.xml);

  _highlight.hljs.registerLanguage("html", _xml.xml);

  window["hljs"] = _highlight.hljs;
  (0, _highlight.highlightjs_line_numbers)();
  /**
   * `code-sample`
  ...
  var CodeSample = /*#__PURE__*/function (_LitElement) {
    ...
    function CodeSample() {
      ...
      _this.highlightStart = null;
      _this.highlightEnd = null;
    ...
    babelHelpers.createClass(CodeSample, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_a0913b108e0011ed99ce491205e67b1d || (_templateObject_a0913b108e0011ed99ce491205e67b1d = babelHelpers.taggedTemplateLiteral([" <div id=\"theme\"></div>\n      <div id=\"demo\" class=\"demo\"></div>\n      <slot></slot>\n      <div id=\"code-container\">\n        <button\n          type=\"button\"\n          ?hidden=\"", "\"\n          id=\"copyButton\"\n          title=\"Copy to clipboard\"\n          @click=\"", "\"\n        >\n          Copy\n        </button>\n        <pre id=\"code\"></pre>\n      </div>"])), !this.copyClipboardButton, this._copyToClipboard);
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName === "highlightStart" && _this4.shadowRoot && _this4[propName] !== null && _this4.highlightEnd !== null) {
            setTimeout(function () {
              _this4.highlightLines(_this4.highlightStart, _this4.highlightEnd);
            }, 100);
          }

          if (propName === "highlightEnd" && _this4.shadowRoot && _this4[propName] !== null && _this4.highlightStart !== null) {
            setTimeout(function () {
              _this4.highlightLines(_this4.highlightStart, _this4.highlightEnd);
            }, 100);
          }
      ...
      key: "highlightLines",
      value: function highlightLines(start, end) {
        Array.from(this.shadowRoot.querySelector('code.hljs table tbody').children).map(function (node, index) {
      ...
      key: "_applyHighlightjs",
      value: function _applyHighlightjs(str) {
        ...
        if (this.shadowRoot && this.shadowRoot.querySelector("#code")) {
          ...
          _highlight.hljs.initLineNumbersOnLoad({}, this.shadowRoot.querySelector('code'));
        }
      }
    }, {
