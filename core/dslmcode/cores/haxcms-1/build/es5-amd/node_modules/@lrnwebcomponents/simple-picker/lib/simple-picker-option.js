 ...
 */var SimplePickerOption=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(SimplePickerOption,_PolymerElement);function SimplePickerOption(){babelHelpers.classCallCheck(this,SimplePickerOption);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimplePickerOption).apply(this,arguments))}babelHelpers.createClass(SimplePickerOption,[{key:"_hideIcon",/**
   ...
   * updates the title
   * @returns {void}
   */},{key:"_updateLabel",value:function _updateLabel(){var label=document.createElement("span");if(!1!==this.titleAsHtml){label.innerHTML=this.label;this.$.label.innerHTML="";this.$.label.appendChild(label)}}/**
   * Set event listeners
   * @returns {void}
   */},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(SimplePickerOption.prototype),"ready",this).call(this);var root=this;this._updateLabel();this.addEventListener("focus",function(e){root._handleFocus()});this.addEventListener("mouseover",function(e){root._handleHover()})}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_ae1decd0a44b11e98c881fc26e93d8f9())}// properties available to the custom element for data binding
       ...
       */label:{name:"label",type:"String",value:null,reflectToAttribute:!0,observer:"_updateLabel"},/**
