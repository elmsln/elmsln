define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _ironIcon, _ironIcons) {
  ...
  function _templateObject4_39f23700833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["red"]);

    _templateObject4_39f23700833211ea85a195fb4be801bd = function _templateObject4_39f23700833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject3_39f23700833211ea85a195fb4be801bd() {
    ...
    _templateObject3_39f23700833211ea85a195fb4be801bd = function _templateObject3_39f23700833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject2_39f23700833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              ", "\n            "]);

    _templateObject2_39f23700833211ea85a195fb4be801bd = function _templateObject2_39f23700833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject_39f23700833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-icon\n        ?hidden=\"", "\"\n        .icon=\"", "\"\n        aria-hidden=\"true\"\n      ></iron-icon>\n      <div id=\"label\">\n        ", "\n      </div>\n    "]);

    _templateObject_39f23700833211ea85a195fb4be801bd = function _templateObject_39f23700833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_39f23700833211ea85a195fb4be801bd(), !this.icon, this.icon, this.titleAsHtml ? (0, _litElement.html)(_templateObject2_39f23700833211ea85a195fb4be801bd(), this.label) : this.label);
      }
    }], [{
      key: "styles",
      //styles
      get: function get() {
        return (0, _litElement.css)(_templateObject3_39f23700833211ea85a195fb4be801bd());
      }
    }]);
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      value: function _getColor() {
        return (0, _litElement.css)(_templateObject4_39f23700833211ea85a195fb4be801bd());
      }
    }], [{
      key: "properties",
      get: function get() {
