define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _ironIcon, _ironIcons) {
  ...
  function _templateObject4_3e7d2a00d1d911ea92952ff2097cf814() {
    var data = babelHelpers.taggedTemplateLiteral(["red"]);

    _templateObject4_3e7d2a00d1d911ea92952ff2097cf814 = function _templateObject4_3e7d2a00d1d911ea92952ff2097cf814() {
      return data;
    };
  ...
  function _templateObject3_3e7d2a00d1d911ea92952ff2097cf814() {
    ...
    _templateObject3_3e7d2a00d1d911ea92952ff2097cf814 = function _templateObject3_3e7d2a00d1d911ea92952ff2097cf814() {
      return data;
    };
  ...
  function _templateObject2_3e7d2a00d1d911ea92952ff2097cf814() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              ", "\n            "]);

    _templateObject2_3e7d2a00d1d911ea92952ff2097cf814 = function _templateObject2_3e7d2a00d1d911ea92952ff2097cf814() {
      return data;
    };
  ...
  function _templateObject_3e7d2a00d1d911ea92952ff2097cf814() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-icon\n        ?hidden=\"", "\"\n        .icon=\"", "\"\n        aria-hidden=\"true\"\n      ></iron-icon>\n      <div id=\"label\">\n        ", "\n      </div>\n    "]);

    _templateObject_3e7d2a00d1d911ea92952ff2097cf814 = function _templateObject_3e7d2a00d1d911ea92952ff2097cf814() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_3e7d2a00d1d911ea92952ff2097cf814(), !this.icon, this.icon, this.titleAsHtml ? (0, _litElement.html)(_templateObject2_3e7d2a00d1d911ea92952ff2097cf814(), this.label) : this.label);
      }
    }], [{
      key: "styles",
      //styles
      get: function get() {
        return (0, _litElement.css)(_templateObject3_3e7d2a00d1d911ea92952ff2097cf814());
      }
    }]);
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      value: function _getColor() {
        return (0, _litElement.css)(_templateObject4_3e7d2a00d1d911ea92952ff2097cf814());
      }
    }], [{
      key: "properties",
      get: function get() {
