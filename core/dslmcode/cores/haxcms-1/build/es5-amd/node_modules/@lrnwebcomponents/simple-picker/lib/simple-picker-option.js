define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _ironIcon, _ironIcons) {
  ...
  function _templateObject4_05635ae0d0ef11ea896db74067b80894() {
    var data = babelHelpers.taggedTemplateLiteral(["red"]);

    _templateObject4_05635ae0d0ef11ea896db74067b80894 = function _templateObject4_05635ae0d0ef11ea896db74067b80894() {
      return data;
    };
  ...
  function _templateObject3_05635ae0d0ef11ea896db74067b80894() {
    ...
    _templateObject3_05635ae0d0ef11ea896db74067b80894 = function _templateObject3_05635ae0d0ef11ea896db74067b80894() {
      return data;
    };
  ...
  function _templateObject2_05635ae0d0ef11ea896db74067b80894() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              ", "\n            "]);

    _templateObject2_05635ae0d0ef11ea896db74067b80894 = function _templateObject2_05635ae0d0ef11ea896db74067b80894() {
      return data;
    };
  ...
  function _templateObject_05635ae0d0ef11ea896db74067b80894() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-icon\n        ?hidden=\"", "\"\n        .icon=\"", "\"\n        aria-hidden=\"true\"\n      ></iron-icon>\n      <div id=\"label\">\n        ", "\n      </div>\n    "]);

    _templateObject_05635ae0d0ef11ea896db74067b80894 = function _templateObject_05635ae0d0ef11ea896db74067b80894() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_05635ae0d0ef11ea896db74067b80894(), !this.icon, this.icon, this.titleAsHtml ? (0, _litElement.html)(_templateObject2_05635ae0d0ef11ea896db74067b80894(), this.label) : this.label);
      }
    }], [{
      key: "styles",
      //styles
      get: function get() {
        return (0, _litElement.css)(_templateObject3_05635ae0d0ef11ea896db74067b80894());
      }
    }]);
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      value: function _getColor() {
        return (0, _litElement.css)(_templateObject4_05635ae0d0ef11ea896db74067b80894());
      }
    }], [{
      key: "properties",
      get: function get() {
