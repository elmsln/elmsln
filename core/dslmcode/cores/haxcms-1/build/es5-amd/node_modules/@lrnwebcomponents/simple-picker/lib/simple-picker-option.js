define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _ironIcon, _ironIcons) {
  ...
  function _templateObject4_3d7e8050db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["red"]);

    _templateObject4_3d7e8050db3d11eaa14b6130b7e5d77f = function _templateObject4_3d7e8050db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject3_3d7e8050db3d11eaa14b6130b7e5d77f() {
    ...
    _templateObject3_3d7e8050db3d11eaa14b6130b7e5d77f = function _templateObject3_3d7e8050db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject2_3d7e8050db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              ", "\n            "]);

    _templateObject2_3d7e8050db3d11eaa14b6130b7e5d77f = function _templateObject2_3d7e8050db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_3d7e8050db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-icon\n        ?hidden=\"", "\"\n        .icon=\"", "\"\n        aria-hidden=\"true\"\n      ></iron-icon>\n      <div id=\"label\">\n        ", "\n      </div>\n    "]);

    _templateObject_3d7e8050db3d11eaa14b6130b7e5d77f = function _templateObject_3d7e8050db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_3d7e8050db3d11eaa14b6130b7e5d77f(), !this.icon, this.icon, this.titleAsHtml ? (0, _litElement.html)(_templateObject2_3d7e8050db3d11eaa14b6130b7e5d77f(), this.label) : this.label);
      }
    }], [{
      key: "styles",
      //styles
      get: function get() {
        return (0, _litElement.css)(_templateObject3_3d7e8050db3d11eaa14b6130b7e5d77f());
      }
    }]);
    ...
    babelHelpers.createClass(SimplePickerOption, [{
      ...
      value: function _getColor() {
        return (0, _litElement.css)(_templateObject4_3d7e8050db3d11eaa14b6130b7e5d77f());
      }
    }], [{
      key: "properties",
      get: function get() {
