define(["exports", "./lib/UserActionBroker.js"], function (_exports, _UserActionBroker) {
  ...
  function (_HTMLElement) {
    ...
    babelHelpers.createClass(UserAction, [{
      ...
      key: "properties",
      get: function get() {
        return babelHelpers.objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(UserAction), "properties", this), {
          track: {
            name: "track",
            type: String,
            value: "visibility"
    ...
    function UserAction() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(UserAction).call(this));
