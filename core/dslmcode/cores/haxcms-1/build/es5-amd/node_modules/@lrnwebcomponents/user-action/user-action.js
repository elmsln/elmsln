define(["exports", "../hax-body-behaviors/lib/HAXWiring.js", "./lib/UserActionBroker.js"], function (_exports, _HAXWiring, _UserActionBroker) {
  "use strict";
  ...
  function (_HTMLElement) {
    ...
    babelHelpers.createClass(UserAction, [{
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(UserAction), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(UserAction), "properties", this));
        }
    ...
    function UserAction() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(UserAction).call(this)); // set tag for later use
      ...
      _this.UserActionBroker = new _UserActionBroker.UserActionBroker();
      return _this;
    }
    /**
