define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../simple-modal/simple-modal.js"], function (_exports, _require, _litElement, _simpleColors, _simpleModal) {
  ...
  function _templateObject2_68a9f3102d8511ea80ccf124101da415() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        class=\"", "\"\n        id=\"dialogtrigger\"\n        @click=\"", "\"\n        ?raised=\"", "\"\n        ?disabled=\"", "\"\n        title=\"", "\"\n        aria-label=\"", "\"\n      >\n        <lrnsys-button-inner\n          avatar=\"", "\"\n          icon=\"", "\"\n          text=\"", "\"\n        >\n          <slot name=\"button\"></slot>\n        </lrnsys-button-inner>\n      </paper-button>\n      <paper-tooltip\n        for=\"dialogtrigger\"\n        animation-delay=\"0\"\n        ?hidden=\"", "\"\n        >", "</paper-tooltip\n      >\n    "]);

    _templateObject2_68a9f3102d8511ea80ccf124101da415 = function _templateObject2_68a9f3102d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function _templateObject_68a9f3102d8511ea80ccf124101da415() {
    ...
    _templateObject_68a9f3102d8511ea80ccf124101da415 = function _templateObject_68a9f3102d8511ea80ccf124101da415() {
      return data;
    };
  ...
  */
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(LrnsysDialog, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysDialog), "styles", this)), [(0, _litElement.css)(_templateObject_68a9f3102d8511ea80ccf124101da415())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(LrnsysDialog, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_68a9f3102d8511ea80ccf124101da415(), this.class, this.openDialog, this.raised, this.disabled, this.alt, this.alt, this.avatar, this.icon, this.text, !this.alt, this.alt);
      }
    }, {
      key: "tapEventOn",
      ...
      value: function firstUpdated(changedProperties) {
        if (babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysDialog.prototype), "firstUpdated", this)) {
          babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysDialog.prototype), "firstUpdated", this).call(this, changedProperties);
        }

        this.shadowRoot.querySelector("#dialogtrigger").addEventListener("focused-changed", this.focusToggle.bind(this));
        this.shadowRoot.querySelector("#dialogtrigger").addEventListener("mousedown", this.tapEventOn.bind(this));
        this.shadowRoot.querySelector("#dialogtrigger").addEventListener("mouseover", this.tapEventOn.bind(this));
        this.shadowRoot.querySelector("#dialogtrigger").addEventListener("mouseout", this.tapEventOff.bind(this));
      }
    }], [{
      key: "tag",
      get: function get() {
