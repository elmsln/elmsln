define(["exports", "require", "../../../../@polymer/polymer/polymer-element.js", "../../../../@polymer/polymer/lib/utils/async.js", "./haxcms-site-store.js", "../../../../mobx/lib/mobx.module.js", "../../../../@polymer/polymer/lib/utils/render-status.js", "../../../hax-body-behaviors/lib/HAXWiring.js", "../../../simple-colors/simple-colors.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../jwt-login/jwt-login.js", "../../../h-a-x/h-a-x.js", "../../../simple-toast/simple-toast.js", "../../../simple-modal/simple-modal.js"], function (_exports, _require, _polymerElement, _async, _haxcmsSiteStore, _mobxModule, _renderStatus, _HAXWiring, _simpleColors, _ironAjax, _jwtLogin, _hAX, _simpleToast, _simpleModal) {
  ...
  function _templateObject_5531d410b49011e9ae0d876050e9d419() {
    ...
    _templateObject_5531d410b49011e9ae0d876050e9d419 = function _templateObject_5531d410b49011e9ae0d876050e9d419() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(HAXCMSSiteEditor, _PolymerElement);
    ...
    babelHelpers.createClass(HAXCMSSiteEditor, [{
      ...
      value: function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSSiteEditor.prototype), "ready", this).call(this);
        (0, _renderStatus.afterNextRender)(this, function () {
          ...
          new Promise(function (res, rej) {
            return _require.default(["../../../hax-body/lib/hax-schema-form.js"], res, rej);
          });
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSSiteEditor.prototype), "connectedCallback", this).call(this); // fire event suggesting that we were authorized to have a site editor
      ...
      key: "loadSiteFields",
      value: function loadSiteFields(e) {
      ...
      key: "_handleGetFieldsResponse",
      value: function _handleGetFieldsResponse(e) {
      ...
      key: "_handleGetSiteFieldsResponse",
      value: function _handleGetSiteFieldsResponse(e) {
        // we get back HAXSchema from the server
        var wiring = new _HAXWiring.HAXWiring();
        this._haxSchema = wiring.prototypeHaxProperties();
        this._haxSchema.settings = e.detail.response.haxSchema;
        ...
        var c = document.createElement("hax-schema-form");
        ...
        var b3 = document.createElement("paper-button");
        b3.raised = true;
        ...
        var b4 = document.createElement("paper-button");
        b4.raised = true;
      ...
      key: "_revertCommit",
      value: function _revertCommit(e) {
      ...
      key: "_saveFieldsTap",
      value: function _saveFieldsTap(e) {
      ...
      value: function _saveSiteFieldsTap(e) {
        var values = this.__siteFieldsForm.value; // fire event with details for saving
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_5531d410b49011e9ae0d876050e9d419());
      }
    }, {
      key: "properties",
      get: function get() {
        ...
        }, babelHelpers.defineProperty(_ref, "updateManifestData", {
          type: Object,
          value: {}
        }), babelHelpers.defineProperty(_ref, "getFieldsData", {
          type: Object,
          value: {}
        }), babelHelpers.defineProperty(_ref, "getSiteFieldsData", {
          type: Object,
          value: {}
        }), babelHelpers.defineProperty(_ref, "activeItem", {
          type: Object,
          notify: true,
          observer: "_activeItemChanged"
        }), babelHelpers.defineProperty(_ref, "manifest", {
          type: Object,
          notify: true,
          observer: "_manifestChanged"
        }), babelHelpers.defineProperty(_ref, "getNodeFieldsPath", {
          type: String
        }), babelHelpers.defineProperty(_ref, "getSiteFieldsPath", {
          type: String
        }), babelHelpers.defineProperty(_ref, "getFieldsToken", {
          type: String
        }), _ref;
      }
    }]);
