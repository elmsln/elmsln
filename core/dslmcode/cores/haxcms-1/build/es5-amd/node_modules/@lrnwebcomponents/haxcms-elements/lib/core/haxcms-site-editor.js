define(["exports", "../../../../lit/index.js", "./haxcms-site-store.js", "../../../../mobx/dist/mobx.esm.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../jwt-login/jwt-login.js", "../../../h-a-x/h-a-x.js", "../../../simple-toast/simple-toast.js", "../../../simple-modal/simple-modal.js", "../../../simple-fields/lib/simple-fields-form.js", "./haxcms-site-dashboard.js", "../../../hax-body/lib/hax-store.js", "../../../utils/utils.js"], function (_exports, _index, _haxcmsSiteStore, _mobxEsm, _ironAjax, _jwtLogin, _hAX, _simpleToast, _simpleModal, _simpleFieldsForm, _haxcmsSiteDashboard, _haxStore, _utils) {
  ...
  var _templateObject_3a36f7106dbd11ec87be753c13ebc708;
  ...
  var HAXCMSSiteEditor = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSSiteEditor, [{
      ...
      value: function _handleDeleteResponse(response) {
        ...
        window.history.pushState({}, null, _haxcmsSiteStore.store.fallbackItemSlug()); // show message

        var title = this.__deleteNodeResponse.title || "";
        var evt = new CustomEvent("simple-toast-show", {
          bubbles: true,
          composed: true,
          cancelable: true,
          detail: {
            text: "Page deleted ".concat(title),
            duration: 2000
          }
        });
        this.dispatchEvent(evt); // delay ensures the fallback has been moved to prior to
