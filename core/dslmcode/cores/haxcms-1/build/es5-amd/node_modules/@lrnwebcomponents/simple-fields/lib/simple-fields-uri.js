define(["exports", "require", "../../../lit-element/lit-element.js", "./simple-fields-container.js"], function (_exports, _require, _litElement, _simpleFieldsContainer) {
  ...
  function _templateObject2_570082f083fc11eab921a14edd773829() {
    ...
    _templateObject2_570082f083fc11eab921a14edd773829 = function _templateObject2_570082f083fc11eab921a14edd773829() {
      return data;
    };
  ...
  function _templateObject_570082f083fc11eab921a14edd773829() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <fieldset>\n        <legend class=\"label-main\" ?hidden=\"", "\">\n          ", "", "\n        </legend>\n        <simple-picker\n          id=\"picker\"\n          aria-label=\"Source...\"\n          required\n          .value=\"", "\"\n          @value-changed=\"", "\"\n          @change=\"", "\"\n          .options=\"", "\"\n        >\n        </simple-picker>\n        <simple-fields-field\n          id=\"url\"\n          ?hidden=\"", "\"\n          value=\"", "\"\n          @value-changed=\"", "\"\n          label=\"URL\"\n          type=\"url\"\n          auto-validate=\"\"\n        ></simple-fields-field>\n        <vaadin-upload\n          capture\n          form-data-name=\"file-upload\"\n          ?hidden=\"", "\"\n          id=\"fileupload\"\n          @upload-before=\"", "\"\n          @upload-response=\"", "\"\n        ></vaadin-upload>\n        <div\n          id=\"camerahole\"\n          ?hidden=\"", "\"\n        ></div>\n        <div\n          id=\"voicerecorder\"\n          ?hidden=\"", "\"\n        ></div>\n      </fieldset>\n    "]);

    _templateObject_570082f083fc11eab921a14edd773829 = function _templateObject_570082f083fc11eab921a14edd773829() {
      return data;
    };
  ...
  function (_SimpleFieldsContaine) {
    babelHelpers.inherits(SimpleFieldsUri, _SimpleFieldsContaine);
    babelHelpers.createClass(SimpleFieldsUri, [{
      key: "render",
      value: function render() {
        return (0, _litElement.html)(_templateObject_570082f083fc11eab921a14edd773829(), !this.label, this.label, this.error || this.required ? "*" : "", this.option, this.optionChanged, this.changed, this.options, this.option !== "url", this.value, this.valueChanged, this.option !== "fileupload", this._fileAboutToUpload, this._fileUploadResponse, this.option !== "selfie" || !navigator.mediaDevices || this.noCamera, this.option !== "audio" || !navigator.mediaDevices || this.noVoiceRecord);
      }
    }], [{
      key: "tag",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUri), "styles", this)), [(0, _litElement.css)(_templateObject2_570082f083fc11eab921a14edd773829())]);
      }
    }, {
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUri), "properties", this), {
          /**
    ...
    function SimpleFieldsUri() {
      var _this;

      babelHelpers.classCallCheck(this, SimpleFieldsUri);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SimpleFieldsUri).call(this));
      ...
      new Promise(function (res, rej) {
        return _require.default(["../../simple-picker/lib/simple-picker-option.js"], res, rej);
      });
      return _this;
    }
    ...
    babelHelpers.createClass(SimpleFieldsUri, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName === "value" && _this2.value !== oldValue) {
            if (_this2.type !== "select" && _this2.field) _this2._updateAttribute("value");
      ...
      value: function firstUpdated(changedProperties) {
        if (babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUri.prototype), "firstUpdated", this)) {
          babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUri.prototype), "firstUpdated", this).call(this, changedProperties);
      ...
      get: function get() {
        ...
        return this.pattern && this.pattern !== "" && this.value && (!this.multiple ? !this.value.match(this.pattern) : this.value.filter(function (value) {
          return !value.match(_this4.pattern);
        }));
      }
    }]);
    return SimpleFieldsUri;
