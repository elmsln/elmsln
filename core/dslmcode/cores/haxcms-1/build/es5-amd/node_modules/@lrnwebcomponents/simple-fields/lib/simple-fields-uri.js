 ...
 */var SimpleFieldsUri=/*#__PURE__*/function(_SimpleFieldsContaine){babelHelpers.inherits(SimpleFieldsUri,_SimpleFieldsContaine);babelHelpers.createClass(SimpleFieldsUri,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject_d3a5e340743e11ea9e08eb59bf762ebe(),!this.label,this.label,this.error||this.required?"*":"",this.option,this.optionChanged,this.changed,this.options,"url"!==this.option,this.value,this.valueChanged,"fileupload"!==this.option,this._fileAboutToUpload,this._fileUploadResponse,"selfie"!==this.option||!navigator.mediaDevices||this.noCamera,"audio"!==this.option||!navigator.mediaDevices||this.noVoiceRecord)}}],[{key:"tag",get:function get(){return"simple-fields-uri"}},{key:"styles",get:function get(){return[].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUri),"styles",this)),[(0,_litElement.css)(_templateObject2_d3a5e340743e11ea9e08eb59bf762ebe())])}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUri),"properties",this),{/**
       ...
       * No Voice Recording
       */noVoiceRecord:{type:Boolean,attribute:"no-voice-record"},option:{type:String},/**
       ...
       */requiredMessage:{type:String}})}}]);function SimpleFieldsUri(){var _this;babelHelpers.classCallCheck(this,SimpleFieldsUri);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleFieldsUri).call(this));_this.autocomplete="off";_this.autofocus=!1;_this.multiple=!1;_this.readonly=!1;_this.spellcheck=!1;_this.id=_this._generateUUID();_this.wrap=!1;_this.options={};_this.__winEvents={"hax-app-picker-selection":"_haxAppPickerSelection"};_this.label=null;_this.noCamera=!1;// @todo leave this off until we can do more testing
// the wiring is all there but the UI pattern is not
_this.noVoiceRecord=!0;new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-icon-button/paper-icon-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@vaadin/vaadin-upload/vaadin-upload.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../simple-picker/lib/simple-picker-option.js"],res,rej)});return _this}babelHelpers.createClass(SimpleFieldsUri,[{key:"updated",value:function updated(changedProperties){var _this2=this;changedProperties.forEach(function(oldValue,propName){if("id"===propName&&!_this2.id)_this2.id=_this2._generateUUID();if(_this2._getAttributes(_this2.type).includes(propName))_this2._updateAttribute(propName);if("value"===propName&&_this2.value!==oldValue){if("select"!==_this2.type&&_this2.field)_this2._updateAttribute("value");_this2._fireValueChanged()}if(["counter","maxlength","type"].includes(propName)&&["text","textarea"].includes(_this2.type))_this2._updateCount();if("type"===propName&&_this2.type!==oldValue){_this2._updateField()}})}/**
...
var options=[[{alt:"URL",icon:"icons:link",value:"url"}],[{alt:"Upload",icon:"icons:file-upload",value:"fileupload"}]];if(navigator.mediaDevices&&!this.noCamera){options.push([{alt:"Camera",icon:"image:photo-camera",value:"selfie"}])}if(navigator.mediaDevices&&!this.noVoiceRecord){/*options.push([
        {
          alt: "Audio",
   ...
   * LitElement
   */},{key:"firstUpdated",value:function firstUpdated(changedProperties){if(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUri.prototype),"firstUpdated",this)){babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsUri.prototype),"firstUpdated",this).call(this,changedProperties)}// test on load for if we have a media device
...
this.option=this.value?"url":"fileupload"}/**
   ...
   */},{key:"_resolveObjectPath",value:function _resolveObjectPath(path,obj){return path.split(".").reduce(function(prev,curr){return prev?prev[curr]:null},obj||self)}},{key:"optionChanged",value:function optionChanged(e){this.option=e.detail.value}},{key:"changed",value:function changed(e){if(e&&e.detail&&"selfie"===e.detail.value)this._takeSelfie(e);if(e&&e.detail&&"audio"===e.detail.value)this._voiceRecorder(e)}},{key:"valueChanged",value:function valueChanged(e){this.value=e.detail.value}/**
   ...
   */value:function validate(){if(!this.value&&this.required){this.error=!0;this.errorMessage=this.requiredMessage||"required"}}/**
   ...
   * @memberof SimpleFieldsUri
   */},{key:"_updateAttribute",value:function _updateAttribute(attribute){if(this.field&&this.type&&this[attribute]!==this.field.getAttribute(attribute)){if(this[attribute]){this.field.setAttribute(attribute,this[attribute])}else{this.field.removeAttribute(attribute,this[attribute])}}}/**
   * updates field an type
   *
   * @memberof SimpleFieldsUri
   */},{key:"_updateField",value:function _updateField(){var _this3=this;this.type=this._getValidType(this.type);this.field=this.shadowRoot&&this.shadowRoot.querySelector(this.fieldElementTag)?this.shadowRoot.querySelector(this.fieldElementTag):void 0;this._getAttributes(this.type).forEach(function(attr){return _this3._updateAttribute(attr)});if("select"!==this.type&&this.field)this._updateAttribute("value")}/**
   * generates a unique id
   * @returns {string } unique id
   */},{key:"_generateUUID",value:function _generateUUID(){return"ss-s-s-s-sss".replace(/s/g,Math.floor(65536*(1+Math.random())).toString(16).substring(1))}},{key:"slottedFieldObserver",get:function get(){}/**
   * determines if value does not match regex pattern
   *
   * @readonly
   * @memberof SimpleFieldsUri
   */},{key:"patternError",get:function get(){var _this4=this;return this.pattern&&""!==this.pattern&&this.value&&(!this.multiple?!this.value.match(this.pattern):this.value.filter(function(value){return!value.match(_this4.pattern)}))}}]);return SimpleFieldsUri}(_simpleFieldsContainer.SimpleFieldsContainer);_exports.SimpleFieldsUri=SimpleFieldsUri;window.customElements.define(SimpleFieldsUri.tag,SimpleFieldsUri)});