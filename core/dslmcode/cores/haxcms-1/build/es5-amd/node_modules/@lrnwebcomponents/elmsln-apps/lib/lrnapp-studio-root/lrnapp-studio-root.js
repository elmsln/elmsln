define(["exports", "../../../../@polymer/polymer/polymer-element.js", "../../../../@polymer/polymer/lib/utils/render-status.js", "../../../../@polymer/app-route/app-location.js", "../../../../@polymer/app-route/app-route.js", "../../../../@polymer/iron-icon/iron-icon.js", "../../../../@polymer/iron-list/iron-list.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../../@polymer/paper-card/paper-card.js", "../../../../@polymer/iron-selector/iron-selector.js", "../../../../@polymer/iron-pages/iron-pages.js", "../../../lrnsys-button/lrnsys-button.js", "../../../elmsln-loading/elmsln-loading.js", "../lrnapp-studio-dashboard/lrnapp-studio-dashboard.js", "../lrnapp-studio-kanban/lrnapp-studio-kanban.js", "../lrnapp-open-studio/lrnapp-open-studio.js"], function (_exports, _polymerElement, _renderStatus, _appLocation, _appRoute, _ironIcon, _ironList, _ironAjax, _paperCard, _ironSelector, _ironPages, _lrnsysButton, _elmslnLoading, _lrnappStudioDashboard, _lrnappStudioKanban, _lrnappOpenStudio) {
  ...
  function _templateObject_619f2ae0dbdc11e9bcafdb98156fc1d6() {
    ...
    _templateObject_619f2ae0dbdc11e9bcafdb98156fc1d6 = function _templateObject_619f2ae0dbdc11e9bcafdb98156fc1d6() {
      return data;
    };
  ...
  var LrnappStudioRoot =
  /*#__PURE__*/
  function (_PolymerElement) {
    babelHelpers.inherits(LrnappStudioRoot, _PolymerElement);

    function LrnappStudioRoot() {
      babelHelpers.classCallCheck(this, LrnappStudioRoot);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrnappStudioRoot).apply(this, arguments));
    }

    babelHelpers.createClass(LrnappStudioRoot, [{
      key: "connectedCallback",
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(LrnappStudioRoot.prototype), "connectedCallback", this).call(this);
      ...
      value: function disconnectedCallback() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(LrnappStudioRoot.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      key: "_endPoint",
      value: function _endPoint(path) {
        return this.basePath + path;
      }
    }, {
      key: "_sourcePath",
      value: function _sourcePath(path) {
      ...
      // application routing
      value: function _routeChanged(route, basePath) {
      ...
      key: "_dashboardClicked",
      value: function _dashboardClicked(e) {
        this.set("route.path", this.basePath + "/lrnapp-studio-dashboard");
        this.notifyPath("route.path");
      }
    }, {
      key: "_kanbanClicked",
      value: function _kanbanClicked(e) {
        this.set("route.path", this.basePath + "/lrnapp-studio-kanban");
        this.notifyPath("route.path");
      }
    }, {
      key: "_openstudioClicked",
      value: function _openstudioClicked(e) {
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_619f2ae0dbdc11e9bcafdb98156fc1d6());
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      key: "observers",
      get: function get() {
        return ["_routeChanged(route, basePath)", "_deleteToast(queryParams.deletetoast)"];
      }
    }]);
    return LrnappStudioRoot;
  }(_polymerElement.PolymerElement);

  _exports.LrnappStudioRoot = LrnappStudioRoot;
