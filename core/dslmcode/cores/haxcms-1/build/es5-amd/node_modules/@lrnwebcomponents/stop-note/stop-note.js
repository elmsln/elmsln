define(["exports","../../@polymer/polymer/polymer-element.js","../schema-behaviors/schema-behaviors.js","../hax-body-behaviors/lib/HAXWiring.js","../../@polymer/iron-icon/iron-icon.js","./lib/stop-icon.js"],function(_exports,_polymerElement,_schemaBehaviors,_HAXWiring,_ironIcon,_stopIcon){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.StopNote=void 0;function _templateObject_37f90da0a74d11e9bc65c96257933704(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n          width: auto;\n          --background-color: #f7f7f7;\n          --accent-color: #d32f2f;\n          margin-bottom: 20px;\n        }\n\n        iron-icon {\n          height: 100px;\n          width: 100px;\n        }\n\n        :host([icon=\"stopnoteicons:stop-icon\"]) {\n          --accent-color: #d8261c;\n        }\n\n        :host([icon=\"stopnoteicons:warning-icon\"]) {\n          --accent-color: #ffeb3b;\n        }\n\n        :host([icon=\"stopnoteicons:confirm-icon\"]) {\n          --accent-color: #81c784;\n        }\n\n        :host([icon=\"stopnoteicons:book-icon\"]) {\n          --accent-color: #21a3db;\n        }\n\n        .container {\n          display: flex;\n          width: auto;\n        }\n\n        .message_wrap {\n          border-right: 7px solid var(--accent-color);\n          padding: 10px 25px;\n          flex: 1 1 auto;\n          background-color: var(--background-color);\n        }\n\n        .main_message {\n          font-size: 32px;\n          margin-top: 10px;\n        }\n\n        .secondary_message {\n          margin-top: 5px;\n          font-size: 19.2px;\n          float: left;\n        }\n\n        .link a {\n          margin-top: 5px;\n          font-size: 19.2px;\n          float: left;\n          clear: left;\n          text-decoration: none;\n          color: #2196f3;\n        }\n\n        .link a:hover {\n          color: #1976d2;\n        }\n\n        .svg {\n          display: flex;\n          justify-content: center;\n        }\n\n        .svg_wrap {\n          background-color: var(--accent-color);\n          padding: 5px;\n          width: auto;\n        }\n      </style>\n      <div class=\"container\">\n        <div class=\"svg_wrap\">\n          <div class=\"svg\"><iron-icon icon=\"[[icon]]\"></iron-icon></div>\n        </div>\n        <div class=\"message_wrap\">\n          <div class=\"main_message\">[[title]]</div>\n          <div class=\"secondary_message\"><slot name=\"message\"></slot></div>\n          <div class=\"link\" hidden$=\"[[!url]]\">\n            <a href=\"[[url]]\" target$=\"[[_urlTarget(url)]]\"\n              >More Information &gt;</a\n            >\n          </div>\n        </div>\n      </div>\n    "],["\n      <style>\n        :host {\n          display: block;\n          width: auto;\n          --background-color: #f7f7f7;\n          --accent-color: #d32f2f;\n          margin-bottom: 20px;\n        }\n\n        iron-icon {\n          height: 100px;\n          width: 100px;\n        }\n\n        :host([icon=\"stopnoteicons:stop-icon\"]) {\n          --accent-color: #d8261c;\n        }\n\n        :host([icon=\"stopnoteicons:warning-icon\"]) {\n          --accent-color: #ffeb3b;\n        }\n\n        :host([icon=\"stopnoteicons:confirm-icon\"]) {\n          --accent-color: #81c784;\n        }\n\n        :host([icon=\"stopnoteicons:book-icon\"]) {\n          --accent-color: #21a3db;\n        }\n\n        .container {\n          display: flex;\n          width: auto;\n        }\n\n        .message_wrap {\n          border-right: 7px solid var(--accent-color);\n          padding: 10px 25px;\n          flex: 1 1 auto;\n          background-color: var(--background-color);\n        }\n\n        .main_message {\n          font-size: 32px;\n          margin-top: 10px;\n        }\n\n        .secondary_message {\n          margin-top: 5px;\n          font-size: 19.2px;\n          float: left;\n        }\n\n        .link a {\n          margin-top: 5px;\n          font-size: 19.2px;\n          float: left;\n          clear: left;\n          text-decoration: none;\n          color: #2196f3;\n        }\n\n        .link a:hover {\n          color: #1976d2;\n        }\n\n        .svg {\n          display: flex;\n          justify-content: center;\n        }\n\n        .svg_wrap {\n          background-color: var(--accent-color);\n          padding: 5px;\n          width: auto;\n        }\n      </style>\n      <div class=\"container\">\n        <div class=\"svg_wrap\">\n          <div class=\"svg\"><iron-icon icon=\"[[icon]]\"></iron-icon></div>\n        </div>\n        <div class=\"message_wrap\">\n          <div class=\"main_message\">[[title]]</div>\n          <div class=\"secondary_message\"><slot name=\"message\"></slot></div>\n          <div class=\"link\" hidden$=\"[[!url]]\">\n            <a href=\"[[url]]\" target\\$=\"[[_urlTarget(url)]]\"\n              >More Information &gt;</a\n            >\n          </div>\n        </div>\n      </div>\n    "]);_templateObject_37f90da0a74d11e9bc65c96257933704=function _templateObject_37f90da0a74d11e9bc65c96257933704(){return data};return data}/**
 * `stop-note`
