define(["exports", "../../../lit-element/lit-element.js", "./simple-fields-field.js"], function (_exports, _litElement, _simpleFieldsField) {
  "use strict";
  ...
  var _templateObject_0db23c50d39311eb9590b786b63a9382, _templateObject2_0db23c50d39311eb9590b786b63a9382, _templateObject3_0db23c50d39311eb9590b786b63a9382;
  ...
  var SimpleFieldsCombo = /*#__PURE__*/function (_SimpleFieldsFieldBeh) {
    ...
    babelHelpers.createClass(SimpleFieldsCombo, [{
      ...
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject_0db23c50d39311eb9590b786b63a9382 || (_templateObject_0db23c50d39311eb9590b786b63a9382 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"field-main\" part=\"field-main\" ?hidden=\"", "\">\n        ", "\n        <div id=\"field-main-inner\" part=\"field-main-inner\">\n          ", "\n          <span class=\"input-option\" part=\"option-inner\">\n            <input\n              .aria-activedescendant=\"", "\"\n              .aria-autocomplete=\"", "\"\n              .aria-descrbedby=\"", "\"\n              .aria-expanded=\"", "\"\n              .aria-haspopup=\"true\"\n              .aria-invalid=\"", "\"\n              .aria-owns=\"", "-list\"\n              ?autofocus=\"", "\"\n              @blur=\"", "\"\n              class=\"field box-input ", "\"\n              @click=\"", "\"\n              ?disabled=\"", "\"\n              @focus=\"", "\"\n              id=\"", "\"\n              @keydown=\"", "\"\n              @keyup=\"", "\"\n              name=\"", "\"\n              .placeholder=\"", "\"\n              part=\"option-input\"\n              ?readonly=\"", "\"\n              ?required=\"", "\"\n              tabindex=\"0\"\n              type=\"text\"\n              value=\"", "\"\n            />\n            ", "\n            <simple-icon-button-lite\n              label=\"open\"\n              icon=\"arrow-drop-down\"\n              @click=\"", "\"\n              part=\"option-icon\"\n              tabindex=\"-1\"\n            >\n            </simple-icon-button-lite>\n          </span>\n          <ul\n            .aria-labelledBy=\"", "-label\"\n            class=\"", "\"\n            data-items=\"", "\"\n            data-options=\"", "\"\n            ?hidden=\"", "\"\n            id=\"", "-list\"\n            @mouseout=\"", "\"\n            @mouseover=\"", "\"\n            role=\"listbox\"\n          >\n            ", "\n          </ul>\n        </div>\n      </div>\n    "])), this.hidden, this.labelTemplate, this.prefixTemplate, this.activeDescendant, this.autocomplete, this.describedBy, this.expanded, this.error ? "true" : "false", this.id, this.autofocus, this._onInputBlur, this.inputFocus ? "focus" : "", this._onInputClick, this.disabled, this._onInputFocus, this.id, this._onInputKeydown, this._onInputKeyup, this.id, this.placeholder || "", this.readonly, this.required, this.value || "", this.suffixTemplate, this._onButtonClick, this.fieldId, this.listFocus ? "focus" : "", this.itemsList.join(), this.filteredOptions.map(function (option) {
          return option.text;
        }).join(), this.hidden || !this.expanded || this.filteredOptions.length < 1, this.id, this._onListboxMouseout, this._onListboxMouseover, (this.filteredOptions || []).map(function (option) {
          return (0, _litElement.html)(_templateObject2_0db23c50d39311eb9590b786b63a9382 || (_templateObject2_0db23c50d39311eb9590b786b63a9382 = babelHelpers.taggedTemplateLiteral(["\n                <li\n                  aria-selected=\"", "\"\n                  id=\"", ".", "\"\n                  role=\"option\"\n                  @click=\"", "\"\n                  @mouseout=\"", "\"\n                  @mouseover=\"", "\"\n                >\n                  ", "\n                </li>\n              "])), _this3._isSelected(option), _this3.id, option.textComparison, function (e) {
            return _this3._onOptionClick(e, option);
          }, function (e) {
            return _this3._onOptionMouseout(e, option);
          }, function (e) {
            return _this3._onOptionMouseover(e, option);
          }, option.text);
        }));
      }
    }, {
      ...
      value: function setActiveDescendant(option) {
        if (option && this.listFocus) {
          this.activeDescendant = "".concat(this.id, ".").concat(option.textComparison);
        } else {
      ...
      value: function setOption(option) {
        ...
        if (option) {
          ...
          if (this.isBoth) {
            ...
            if (flag) {
              setTimeout(function () {
                _this4.input.setSelectionRange(_this4.option.text.length, _this4.option.text.length);
              }, 0);
            } else {
              setTimeout(function () {
                _this4.input.setSelectionRange(_this4.filter.length, _this4.option.text.length);
              }, 0);
            }
          }
        }
      ...
      value: function setCurrentOptionStyle(option) {
        ...
        if (option && this.shadowRoot && this.shadowRoot.querySelector("#".concat(this.id, ".").concat(option.textComparison))) this.listbox.scrollTop = this.shadowRoot.querySelector("#".concat(this.id, ".").concat(option.textComparison)).offsetTop;
      }
    }, {
      key: "_isSelected",
