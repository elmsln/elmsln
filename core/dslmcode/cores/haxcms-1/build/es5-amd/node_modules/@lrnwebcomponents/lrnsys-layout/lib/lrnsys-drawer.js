...
break;default:var tmp2=nodes[i].cloneNode(!0);tmp2.removeAttribute("slot");c.appendChild(tmp2);break;}}}var evt=new CustomEvent("simple-drawer-show",{bubbles:!0,cancelable:!0,detail:{title:this.header,elements:{content:c,header:h},invokedBy:this.$.flyouttrigger,align:this.align,size:"30%",clone:!0}});this.dispatchEvent(evt)}/**
