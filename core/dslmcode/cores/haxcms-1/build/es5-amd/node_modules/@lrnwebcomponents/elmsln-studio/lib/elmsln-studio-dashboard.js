define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../accent-card/accent-card.js", "../../a11y-collapse/a11y-collapse.js", "../../progress-donut/progress-donut.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _ironAjax, _accentCard, _a11yCollapse, _progressDonut, _ironIcons) {
  ...
  function _templateObject7_aaba4620955311ea95f91796ba9726d2() {
    ...
    _templateObject7_aaba4620955311ea95f91796ba9726d2 = function _templateObject7_aaba4620955311ea95f91796ba9726d2() {
      return data;
    };
  ...
  function _templateObject6_aaba4620955311ea95f91796ba9726d2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <li>\n                <iron-icon aria-hidden=\"true\" icon=\"chevron-right\"></iron-icon>\n                <button class=\"linklist-heading\">\n                  ", "\n                  ", "\n                  ", "\n                </button>\n                <span class=\"linklist-subheading\">\n                  ", "\n                </span>\n              </li>\n            "]);

    _templateObject6_aaba4620955311ea95f91796ba9726d2 = function _templateObject6_aaba4620955311ea95f91796ba9726d2() {
      return data;
    };
  ...
  function _templateObject5_aaba4620955311ea95f91796ba9726d2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <iron-icon\n                      aria-hidden=\"true\"\n                      icon=\"chevron-right\"\n                    ></iron-icon>\n                    <button class=\"linklist-heading\">\n                      ", "\n                    </button>\n                    <span class=\"linklist-subheading\"\n                      >", "</span\n                    >\n                  </li>\n                "]);

    _templateObject5_aaba4620955311ea95f91796ba9726d2 = function _templateObject5_aaba4620955311ea95f91796ba9726d2() {
      return data;
    };
  ...
  function _templateObject4_aaba4620955311ea95f91796ba9726d2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <iron-icon\n                      aria-hidden=\"true\"\n                      icon=\"chevron-right\"\n                    ></iron-icon>\n                    <button class=\"linklist-heading\">\n                      ", "\n                    </button>\n                    <span class=\"linklist-subheading\"\n                      >", "</span\n                    >\n                  </li>\n                "]);

    _templateObject4_aaba4620955311ea95f91796ba9726d2 = function _templateObject4_aaba4620955311ea95f91796ba9726d2() {
      return data;
    };
  ...
  function _templateObject3_aaba4620955311ea95f91796ba9726d2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            Due\n                            ", "\n                          "]);

    _templateObject3_aaba4620955311ea95f91796ba9726d2 = function _templateObject3_aaba4620955311ea95f91796ba9726d2() {
      return data;
    };
  ...
  function _templateObject2_aaba4620955311ea95f91796ba9726d2() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <iron-icon\n                      aria-hidden=\"true\"\n                      icon=\"chevron-right\"\n                    ></iron-icon>\n                    <button class=\"linklist-heading\">\n                      ", "\n                    </button>\n                    <span class=\"linklist-subheading\"\n                      >", "\n                    </span>\n                  </li>\n                "]);

    _templateObject2_aaba4620955311ea95f91796ba9726d2 = function _templateObject2_aaba4620955311ea95f91796ba9726d2() {
      return data;
    };
  ...
  function _templateObject_aaba4620955311ea95f91796ba9726d2() {
    ...
    _templateObject_aaba4620955311ea95f91796ba9726d2 = function _templateObject_aaba4620955311ea95f91796ba9726d2() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ElmslnStudioDashboard, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_aaba4620955311ea95f91796ba9726d2(), this.activitySrc, function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_aaba4620955311ea95f91796ba9726d2(), assign.attributes.title, _this2._getDueDate(assign) ? (0, _litElement.html)(_templateObject3_aaba4620955311ea95f91796ba9726d2(), _this2.date(parseInt(_this2._getDueDate(assign)) * 1000)) : "");
        }), Object.keys(this.__submissions).map(function (submission) {
          return (0, _litElement.html)(_templateObject4_aaba4620955311ea95f91796ba9726d2(), _this2.__submissions[submission].attributes.title, _this2.date(_this2.__submissions[submission].meta.changed));
        }), this.__comments.map(function (comment) {
          return (0, _litElement.html)(_templateObject5_aaba4620955311ea95f91796ba9726d2(), comment.attributes.subject, _this2.date(comment.attributes.changed));
        }), this.__activity.map(function (activity) {
          return (0, _litElement.html)(_templateObject6_aaba4620955311ea95f91796ba9726d2(), activity.relationships.author.data.sis.sortable_name.replace(/.*,/, ""), activity.type === "comment" ? "commented" : "submitted", activity.type === "comment" ? activity.attributes.subject : activity.attributes.title, _this2.date(activity.type === "comment" ? activity.attributes.changed : activity.meta.changed));
        }));
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject7_aaba4620955311ea95f91796ba9726d2())];
      }
    }, {
      key: "properties",
      get: function get() {
