define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../accent-card/accent-card.js", "../../a11y-collapse/a11y-collapse.js", "../../progress-donut/progress-donut.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _ironAjax, _accentCard, _a11yCollapse, _progressDonut, _ironIcons) {
  ...
  function _templateObject7_6d9b7520939b11eaa49d972a432e908f() {
    ...
    _templateObject7_6d9b7520939b11eaa49d972a432e908f = function _templateObject7_6d9b7520939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function _templateObject6_6d9b7520939b11eaa49d972a432e908f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <li>\n                <iron-icon aria-hidden=\"true\" icon=\"chevron-right\"></iron-icon>\n                <button class=\"linklist-heading\">\n                  ", "\n                  ", "\n                  ", "\n                </button>\n                <span class=\"linklist-subheading\">\n                  ", "\n                </span>\n              </li>\n            "]);

    _templateObject6_6d9b7520939b11eaa49d972a432e908f = function _templateObject6_6d9b7520939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function _templateObject5_6d9b7520939b11eaa49d972a432e908f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <iron-icon\n                      aria-hidden=\"true\"\n                      icon=\"chevron-right\"\n                    ></iron-icon>\n                    <button class=\"linklist-heading\">\n                      ", "\n                    </button>\n                    <span class=\"linklist-subheading\"\n                      >", "</span\n                    >\n                  </li>\n                "]);

    _templateObject5_6d9b7520939b11eaa49d972a432e908f = function _templateObject5_6d9b7520939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function _templateObject4_6d9b7520939b11eaa49d972a432e908f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <iron-icon\n                      aria-hidden=\"true\"\n                      icon=\"chevron-right\"\n                    ></iron-icon>\n                    <button class=\"linklist-heading\">\n                      ", "\n                    </button>\n                    <span class=\"linklist-subheading\"\n                      >", "</span\n                    >\n                  </li>\n                "]);

    _templateObject4_6d9b7520939b11eaa49d972a432e908f = function _templateObject4_6d9b7520939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function _templateObject3_6d9b7520939b11eaa49d972a432e908f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            Due\n                            ", "\n                          "]);

    _templateObject3_6d9b7520939b11eaa49d972a432e908f = function _templateObject3_6d9b7520939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function _templateObject2_6d9b7520939b11eaa49d972a432e908f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <li>\n                    <iron-icon\n                      aria-hidden=\"true\"\n                      icon=\"chevron-right\"\n                    ></iron-icon>\n                    <button class=\"linklist-heading\">\n                      ", "\n                    </button>\n                    <span class=\"linklist-subheading\"\n                      >", "\n                    </span>\n                  </li>\n                "]);

    _templateObject2_6d9b7520939b11eaa49d972a432e908f = function _templateObject2_6d9b7520939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function _templateObject_6d9b7520939b11eaa49d972a432e908f() {
    ...
    _templateObject_6d9b7520939b11eaa49d972a432e908f = function _templateObject_6d9b7520939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ElmslnStudioDashboard, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_6d9b7520939b11eaa49d972a432e908f(), this.activitySrc, function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_6d9b7520939b11eaa49d972a432e908f(), assign.attributes.title, _this2._getDueDate(assign) ? (0, _litElement.html)(_templateObject3_6d9b7520939b11eaa49d972a432e908f(), _this2.date(parseInt(_this2._getDueDate(assign)) * 1000)) : "");
        }), Object.keys(this.__submissions).map(function (submission) {
          return (0, _litElement.html)(_templateObject4_6d9b7520939b11eaa49d972a432e908f(), _this2.__submissions[submission].attributes.title, _this2.date(_this2.__submissions[submission].meta.changed));
        }), this.__comments.map(function (comment) {
          return (0, _litElement.html)(_templateObject5_6d9b7520939b11eaa49d972a432e908f(), comment.attributes.subject, _this2.date(comment.attributes.changed));
        }), this.__activity.map(function (activity) {
          return (0, _litElement.html)(_templateObject6_6d9b7520939b11eaa49d972a432e908f(), activity.relationships.author.data.sis.sortable_name.replace(/.*,/, ""), activity.type === "comment" ? "commented" : "submitted", activity.type === "comment" ? activity.attributes.subject : activity.attributes.title, _this2.date(activity.type === "comment" ? activity.attributes.changed : activity.meta.changed));
        }));
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject7_6d9b7520939b11eaa49d972a432e908f())];
      }
    }, {
      key: "properties",
      get: function get() {
