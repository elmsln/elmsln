define(["exports", "require", "../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_269390f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: flex;\n          padding: 8px;\n        }\n        :host([sticky]) {\n          top: 0;\n          position: sticky;\n        }\n        :host([direction=\"left\"]) {\n          float: left;\n          max-width: 480px;\n        }\n        :host([direction=\"right\"]) {\n          float: right;\n          max-width: 480px;\n        }\n      "]);

    _templateObject2_269390f0833211ea85a195fb4be801bd = function _templateObject2_269390f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject_269390f0833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <aside>\n        <lrndesign-panelcard title=\"", "\">\n          <slot></slot>\n        </lrndesign-panelcard>\n      </aside>\n    "]);

    _templateObject_269390f0833211ea85a195fb4be801bd = function _templateObject_269390f0833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnAside, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_269390f0833211ea85a195fb4be801bd(), this.title);
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_269390f0833211ea85a195fb4be801bd())];
      }
    }, {
      key: "tag",
      get: function get() {
