define(["exports", "../hax-body-behaviors/lib/HAXWiring.js"], function (_exports, _HAXWiring) {
  "use strict";
  ...
  function (_HTMLElement) {
    ...
    babelHelpers.createClass(HtmlBlock, [{
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(HtmlBlock), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(HtmlBlock), "properties", this));
        }
    ...
    function HtmlBlock() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HtmlBlock).call(this)); // set tag for later use
    ...
    babelHelpers.createClass(HtmlBlock, [{
      ...
      value: function connectedCallback() {
        ...
        this.HAXWiring.setup(HtmlBlock.haxProperties, HtmlBlock.tag, this); // default we block all script unless the user says to do so
