...
(function (root, factory) {
  ...
  var annyang; // Get the SpeechRecognition object, while handling browser prefixes

  var SpeechRecognition = root.SpeechRecognition || root.webkitSpeechRecognition || root.mozSpeechRecognition || root.msSpeechRecognition || root.oSpeechRecognition; // Check browser support
  ...
  var _isListening = false; // The command matching code is a modified version of Backbone.Router by Jeremy Ashkenas, under the MIT license.
  ...
  var parseResults = function parseResults(results) {
    ...
    var commandText; // go over each of the 5 results and alternative results received (we have set maxAlternatives to 5 above)
  ...
  annyang = {
    ...
    init: function init(commands) {
      ...
      recognition.continuous = root.location.protocol === 'http:'; // Sets the language to the default 'en-US'. This can be changed with annyang.setLanguage()
      ...
      recognition.onerror = function (event) {
        ...
        switch (event.error) {
          ...
          case 'service-not-allowed':
            ...
            autoRestart = false; // determine if permission was denied by user or automatically.
      ...
      recognition.onend = function () {
        _isListening = false;
        invokeCallbacks(callbacks.end); // annyang will auto restart if it is closed automatically and not by user action.
    ...
    addCommands: function addCommands(commands) {
      ...
      for (var phrase in commands) {
        if (commands.hasOwnProperty(phrase)) {
          ...
          } else if (babelHelpers.typeof(cb) === 'object' && babelHelpers.instanceof(cb.regexp, RegExp)) {
