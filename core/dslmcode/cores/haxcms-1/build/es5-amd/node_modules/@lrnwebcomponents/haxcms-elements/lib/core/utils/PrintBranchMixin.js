define(["exports", "../../../../../lit/index.js", "../haxcms-site-store.js", "../../../../hax-iconset/lib/simple-hax-iconset.js", "../../../../utils/utils.js", "../../../../micro-frontend-registry/micro-frontend-registry.js", "./HAXCMSI18NMixin.js", "../../../../simple-icon/lib/simple-icon-button-lite.js", "../../../../simple-tooltip/simple-tooltip.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../micro-frontend-registry/lib/microServices.js"], function (_exports, _index, _haxcmsSiteStore, _simpleHaxIconset, _utils, _microFrontendRegistry, _HAXCMSI18NMixin2, _simpleIconButtonLite, _simpleTooltip, _mobxEsm, _microServices) {
  "use strict";
  ...
  var _templateObject_c307eb10809211edaa2833647dc78c6c, _templateObject2_c307eb10809211edaa2833647dc78c6c;
  ...
  var PrintBranchMixin = function PrintBranchMixin(SuperClass) {
    return /*#__PURE__*/function (_HAXCMSI18NMixin) {
      ...
      function _class() {
        ...
        _this.__printBranchLoading = false;
        return _this;
      }
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function PrintBranchButton() {
          ...
          return (0, _index.html)(_templateObject_c307eb10809211edaa2833647dc78c6c || (_templateObject_c307eb10809211edaa2833647dc78c6c = babelHelpers.taggedTemplateLiteral(["\n        ", "\n      "])), _microFrontendRegistry.MicroFrontendRegistry.has("@haxcms/siteToHtml") ? (0, _index.html)(_templateObject2_c307eb10809211edaa2833647dc78c6c || (_templateObject2_c307eb10809211edaa2833647dc78c6c = babelHelpers.taggedTemplateLiteral([" <div\n              class=\"print-branch-btn\"\n              part=\"", "\"\n            >\n              <simple-icon-button-lite\n                part=\"print-branch-btn\"\n                icon=\"", "\"\n                @click=\"", "\"\n                icon-position=\"top\"\n                id=\"print-branch-btn\"\n              >\n              </simple-icon-button-lite>\n              <simple-tooltip for=\"print-branch-btn\" position=\"", "\">\n                ", "\n              </simple-tooltip>\n            </div>"])), this.editMode ? "edit-mode-active" : "", this.__printBranchLoading ? "hax:loading" : "icons:print", this.printBranchOfSite, position, this.__printBranchLoading ? this.t.printingPleaseWait : this.t.print) : "");
        }
        /**
        ...
        value: function () {
          var _printBranchOfSite = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
            var base, site, params, response, link;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    this.__printBranchLoading = true; // base helps w/ calculating URLs in content
                    ...
                    params = {
                      ...
                      ancestor: (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeId),
                      link: base,
                  ...
                  case 7:
                    ...
                    if (response.status == 200 && response.data) {
                      ...
                      link.href = window.URL.createObjectURL((0, _utils.b64toBlob)(btoa(unescape(encodeURIComponent(response.data))), "text/html"));
                      ...
                      window.open(window.URL.createObjectURL((0, _utils.b64toBlob)(btoa(unescape(encodeURIComponent(response.data))), "text/html")), "", "left=0,top=0,width=800,height=800,toolbar=0,scrollbars=0,status=0,noopener=1,noreferrer=1");
                    } else {
                      // fallback in case the service fails
