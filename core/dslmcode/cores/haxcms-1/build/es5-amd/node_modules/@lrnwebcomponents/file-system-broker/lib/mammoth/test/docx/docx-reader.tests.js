...
test("can read document with single paragraph with single run of text", function () {
  var expectedDocument = documents.Document([documents.Paragraph([documents.Run([documents.Text("Hello.")])])]);
...
test("main document is found using _rels/.rels", function () {
  var relationships = xml.element("r:Relationships", {}, [xml.element("r:Relationship", {
...
test("part paths", {
  "main document part is found using package relationships": function mainDocumentPartIsFoundUsingPackageRelationships() {
    var relationships = xml.element("r:Relationships", {}, [xml.element("r:Relationship", {
      Type: "http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument",
      Target: "/word/document2.xml"
    })]);
  ...
  "word/document.xml is used as fallback location for main document part": function wordDocumentXmlIsUsedAsFallbackLocationForMainDocumentPart() {
    var docxFile = createFakeDocxFile({
      "word/document.xml": " "
    });
    return docxReader._findPartPaths(docxFile).then(function (partPaths) {
...
[{
  ...
  test(options.name + " part is found using main document relationships", function () {
    var docxFile = createFakeDocxFile({
      ...
      "word/document.xml": " ",
      "word/_rels/document.xml.rels": xml.writeString(xml.element("r:Relationships", {}, [xml.element("r:Relationship", {
        Type: options.type,
...
function createPackageRelationships(mainDocumentPath) {
  return xml.writeString(xml.element("r:Relationships", {}, [xml.element("r:Relationship", {
    Type: "http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument",
