define(["exports", "../../lit-element/lit-element.js", "../responsive-utility/lib/responsive-utility-behaviors.js", "../../@polymer/paper-button/paper-button.js", "../../@polymer/iron-icons/iron-icons.js", "../simple-tooltip/simple-tooltip.js", "./lib/a11y-tab.js"], function (_exports, _litElement, _responsiveUtilityBehaviors, _paperButton, _ironIcons, _simpleTooltip, _a11yTab) {
  ...
  function _templateObject8_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-tooltip for=\"", "-button\">\n        ", "\n      </simple-tooltip>\n    "]);

    _templateObject8_2b3f2cf0db3d11eaa14b6130b7e5d77f = function _templateObject8_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject7_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"label\">", "</span>\n    "]);

    _templateObject7_2b3f2cf0db3d11eaa14b6130b7e5d77f = function _templateObject7_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject6_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-icon\n        class=\"icon\"\n        ?hidden=\"", "\"\n        .icon=\"", "\"\n        .title=\"", "\"\n      >\n      </iron-icon>\n    "]);

    _templateObject6_2b3f2cf0db3d11eaa14b6130b7e5d77f = function _templateObject6_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject5_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"flag-type\" ?hidden=\"", "\">\n        ", "\n      </span>\n    "]);

    _templateObject5_2b3f2cf0db3d11eaa14b6130b7e5d77f = function _templateObject5_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject4_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        id=\"", "-button\"\n        controls=\"", "\"\n        class=\"", "\"\n        @click=\"", "\"\n        ?disabled=\"", "\"\n        .flag=\"", "\"\n      >\n        ", " ", "\n        ", " ", "\n      </paper-button>\n      ", "\n    "]);

    _templateObject4_2b3f2cf0db3d11eaa14b6130b7e5d77f = function _templateObject4_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject3_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
    ...
    _templateObject3_2b3f2cf0db3d11eaa14b6130b7e5d77f = function _templateObject3_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject2_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <li>", "</li>\n          "]);

    _templateObject2_2b3f2cf0db3d11eaa14b6130b7e5d77f = function _templateObject2_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <ul id=\"tabs\">\n        ", "\n      </ul>\n      <div id=\"content\">\n        <slot></slot>\n      </div>\n    "]);

    _templateObject_2b3f2cf0db3d11eaa14b6130b7e5d77f = function _templateObject_2b3f2cf0db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_ResponsiveUtilityBeh) {
    ...
    babelHelpers.createClass(A11yTabs, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_2b3f2cf0db3d11eaa14b6130b7e5d77f(), this.tabs.map(function (tab, i) {
          return (0, _litElement.html)(_templateObject2_2b3f2cf0db3d11eaa14b6130b7e5d77f(), _this2._tabButton(tab));
        }));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_2b3f2cf0db3d11eaa14b6130b7e5d77f())];
      }
    }, {
      key: "haxProperties",
      get: function get() {
    ...
    babelHelpers.createClass(A11yTabs, [{
      ...
      value: function _tabButton(tab) {
        ...
        return (0, _litElement.html)(_templateObject4_2b3f2cf0db3d11eaa14b6130b7e5d77f(), tab.id, tab.id, tab.id === this.activeTab && !this.disabled ? "active" : "", function (e) {
      ...
      value: function _tabFlag(tab) {
        return (0, _litElement.html)(_templateObject5_2b3f2cf0db3d11eaa14b6130b7e5d77f(), !tab.flag, tab.flag);
      }
      /**
       * makes tab icon
       *
      ...
      value: function _tabIcon(tab, icon) {
        return (0, _litElement.html)(_templateObject6_2b3f2cf0db3d11eaa14b6130b7e5d77f(), !tab[icon], tab[icon], tab[flag]);
      }
      /**
       * makes tab label
       *
      ...
      value: function _tabLabel(tab) {
        return (0, _litElement.html)(_templateObject7_2b3f2cf0db3d11eaa14b6130b7e5d77f(), tab.label);
      }
      /**
       * makes tab tooltip
       *
      ...
      value: function _tabTooltip(tab) {
        return (0, _litElement.html)(_templateObject8_2b3f2cf0db3d11eaa14b6130b7e5d77f(), tab.id, tab.label);
      }
    }, {
      key: "iconsOnly",
      get: function get() {
