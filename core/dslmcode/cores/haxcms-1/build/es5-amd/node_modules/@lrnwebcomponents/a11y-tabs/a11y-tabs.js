...
value:function render(){var _this2=this;return(0,_litElement.html)(_templateObject_2d8e0800600411eaa0d6e50c2e6c3fee(),this._showIcons(this.__hasIcons,this.iconBreakpoint,this.layoutBreakpoint,this.responsiveSize),this.tabs.map(function(tab,i){return(0,_litElement.html)(_templateObject2_2d8e0800600411eaa0d6e50c2e6c3fee(),tab.id,tab.id,tab.id===_this2.activeTab?"active":"",function(e){return _this2._handleTab(tab)},tab.id===_this2.activeTab||tab.disabled,tab.flag,!tab.flagIcon,tab.flagIcon,tab.label,!tab.flag,tab.flag,!tab.icon,tab.icon,tab.id,tab.label)}))}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject3_2d8e0800600411eaa0d6e50c2e6c3fee())]}},{key:"haxProperties",get:function get(){return{}}// properties available to the custom element for data binding
       ...
       */__observer:{type:Object},forceHorizontal:{type:Boolean,attribute:"force-horizontal"}})}/**
   * Store the tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */},{key:"tag",get:function get(){return"a11y-tabs"}}]);function A11yTabs(){var _this;babelHelpers.classCallCheck(this,A11yTabs);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(A11yTabs).call(this));var callback=function callback(mutationsList,observer){return _this.updateItems()};_this.activeTab=null;_this.disabled=!1;_this.hidden=!1;_this.iconBreakpoint=400;_this.id=null;_this.layoutBreakpoint=600;_this.forceHorizontal=!1;_this.responsiveSize="xs";_this.vertical=!1;_this.__hasIcons=!1;_this.__tabs=[];_this.updateItems();_this.__observer=new MutationObserver(callback);_this._breakpointChanged();window.ResponsiveUtility.requestAvailability();_this.__observer.observe(babelHelpers.assertThisInitialized(_this),{attributes:!1,childList:!0,subtree:!1});_this.addEventListener("a11y-tab-changed",function(e){return _this.updateItems()});return _this}babelHelpers.createClass(A11yTabs,[{key:"connectedCallback",/**
   * life cycle, element is afixed to the DOM
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(A11yTabs.prototype),"connectedCallback",this).call(this)}/**
   ...
   */},{key:"updateItems",value:function updateItems(e){var _this5=this;this.__tabs=this.querySelectorAll("a11y-tab");this.__hasIcons=!0;if(!this.id)this.id=this._generateUUID();if(this.__tabs&&0<this.__tabs.length)this.__tabs.forEach(function(tab,index){if(!tab.icon)_this5.__hasIcons=!1;tab.order=index+1;tab.total=_this5.__tabs.length});this.selectTab(this.activeTab)}/**
   ...
   */},{key:"_setVertical",value:function _setVertical(){if(this.forceHorizontal){this.vertical=!1}else{this.vertical=-1===this.layoutBreakpoint||this.iconBreakpoint>this.layoutBreakpoint?"xs"===this.responsiveSize:-1<this.responsiveSize.indexOf("s")}}/**
   ...
   */},{key:"_unsetBreakpoints",value:function _unsetBreakpoints(){window.dispatchEvent(new CustomEvent("responsive-element-deleted",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}},{key:"tabs",get:function get(){var _this6=this;return this.__tabs?Object.keys(this.__tabs).map(function(index){return _this6.__tabs[index]}):[]}}]);return A11yTabs}(_litElement.LitElement);_exports.A11yTabs=A11yTabs;window.customElements.define(A11yTabs.tag,A11yTabs)});