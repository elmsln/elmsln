...
value:function render(){var _this2=this;return(0,_litElement.html)(_templateObject_882927b0729a11ea913eb9f5205e3d49(),this.iconClass,this.tabs.map(function(tab,i){return(0,_litElement.html)(_templateObject2_882927b0729a11ea913eb9f5205e3d49(),_this2._tabButton(tab))}))}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject3_882927b0729a11ea913eb9f5205e3d49())]}},{key:"haxProperties",get:function get(){return{}}// properties available to the custom element for data binding
   ...
   * handle updates
   */},{key:"updated",value:function updated(changedProperties){var _this5=this;changedProperties.forEach(function(oldValue,propName){if("id"===propName)_this5._idChanged(_this5.id,oldValue);if("activeTab"===propName&&_this5.activeTab!==oldValue)_this5._activeTabChanged(_this5.activeTab,oldValue);if("iconBreakpoint"===propName)_this5._breakpointChanged();if("layoutBreakpoint"===propName)_this5._breakpointChanged();if("responsiveSize"===propName)_this5._setVertical()})}/**
   * selects a tab
   ...
   */},{key:"_activeTabChanged",value:function _activeTabChanged(newValue,oldValue){console.log("_activeTabChanged",this,newValue,oldValue);if(newValue!==oldValue)this.selectTab(newValue);window.dispatchEvent(new CustomEvent("active-tab-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}/**
   ...
   */},{key:"_handleTab",value:function _handleTab(tab){console.log("_handleTab",this,tab);if(!tab.disabled)this.activeTab=tab.id}/**
   ...
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabButton",value:function _tabButton(tab){var _this6=this;return(0,_litElement.html)(_templateObject4_882927b0729a11ea913eb9f5205e3d49(),tab.id,tab.id,tab.id===this.activeTab?"active":"",function(e){return _this6._handleTab(tab)},tab.id===this.activeTab||tab.disabled,tab.flag,this._tabIcon(tab,"flagIcon"),this._tabLabel(tab),this._tabFlag(tab),this._tabIcon(tab,"icon"),this._tabTooltip(tab))}/**
   * makes tab flag
   *
   * @param {string} flag tab's flag
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabFlag",value:function _tabFlag(tab){return(0,_litElement.html)(_templateObject5_882927b0729a11ea913eb9f5205e3d49(),!tab.flag,tab.flag)}/**
   * makes tab icon
   *
   * @param {string} icon tab's icon
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabIcon",value:function _tabIcon(tab,icon){return(0,_litElement.html)(_templateObject6_882927b0729a11ea913eb9f5205e3d49(),!tab[icon],tab[icon])}/**
   * makes tab label
   *
   * @param {string} flag tab's flag
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabLabel",value:function _tabLabel(tab){return(0,_litElement.html)(_templateObject7_882927b0729a11ea913eb9f5205e3d49(),tab.label)}/**
   * makes tab tooltip
   *
   ...
   * @returns object
   * @memberof A11yTabs
   */},{key:"_tabTooltip",value:function _tabTooltip(tab){return(0,_litElement.html)(_templateObject8_882927b0729a11ea913eb9f5205e3d49(),tab.id,tab.label)}/**
