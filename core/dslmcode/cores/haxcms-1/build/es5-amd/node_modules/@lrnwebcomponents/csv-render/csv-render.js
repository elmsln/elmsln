define(["exports", "require", "../../lit/index.js", "../simple-colors/simple-colors.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button-lite.js", "../intersection-element/lib/IntersectionObserverMixin.js"], function (_exports, _require, _index, _simpleColors, _simpleIconLite, _simpleIcons, _simpleIconButtonLite, _IntersectionObserverMixin) {
  ...
  var _templateObject_9d0f7b30514a11ecb9f033a821100adf, _templateObject2_9d0f7b30514a11ecb9f033a821100adf, _templateObject3_9d0f7b30514a11ecb9f033a821100adf, _templateObject4_9d0f7b30514a11ecb9f033a821100adf, _templateObject5_9d0f7b30514a11ecb9f033a821100adf, _templateObject6_9d0f7b30514a11ecb9f033a821100adf;
  ...
  var CsvRender = /*#__PURE__*/function (_IntersectionObserver) {
    ...
    babelHelpers.createClass(CsvRender, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_9d0f7b30514a11ecb9f033a821100adf || (_templateObject_9d0f7b30514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["\n      <hexagon-loader\n        id=\"loading\"\n        accent-color=\"", "\"\n        ?loading=\"", "\"\n        item-count=\"4\"\n        size=\"small\"\n      ></hexagon-loader>\n      <a href=\"", "\" id=\"download\" tabindex=\"-1\">\n        <simple-icon-button-lite\n          id=\"ficon\"\n          icon=\"file-download\"\n        ></simple-icon-button-lite>\n      </a>\n      <simple-tooltip for=\"ficon\" offset=\"14\" position=\"top\"\n        >Download table data</simple-tooltip\n      >\n      <table class=\"table\" summary=\"", "\">\n        ", "\n        <thead>\n          <tr>\n            ", "\n          </tr>\n        </thead>\n        <tbody>\n          ", "\n        </tbody>\n      </table>\n    "])), this.accentColor, this.loading, this.dataSource, this.summary, this.caption ? (0, _index.html)(_templateObject2_9d0f7b30514a11ecb9f033a821100adf || (_templateObject2_9d0f7b30514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["\n              <caption>\n                ", "\n              </caption>\n            "])), this.caption) : "", this.tableHeadings.map(function (heading) {
          return (0, _index.html)(_templateObject3_9d0f7b30514a11ecb9f033a821100adf || (_templateObject3_9d0f7b30514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral([" <th scope=\"col\">", "</th> "])), heading);
        }), this.table.map(function (row) {
          return (0, _index.html)(_templateObject4_9d0f7b30514a11ecb9f033a821100adf || (_templateObject4_9d0f7b30514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["\n              <tr>\n                ", "\n              </tr>\n            "])), row.map(function (col) {
            return (0, _index.html)(_templateObject5_9d0f7b30514a11ecb9f033a821100adf || (_templateObject5_9d0f7b30514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral([" <td>", "</td> "])), col);
          }));
        }));
      }
    }, {
