define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js"], function (_exports, _require, _litElement, _simpleColors) {
  ...
  function _templateObject6_1f654540db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                    <td>", "</td>\n                  "]);

    _templateObject6_1f654540db3d11eaa14b6130b7e5d77f = function _templateObject6_1f654540db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject5_1f654540db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <tr>\n                ", "\n              </tr>\n            "]);

    _templateObject5_1f654540db3d11eaa14b6130b7e5d77f = function _templateObject5_1f654540db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject4_1f654540db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <th scope=\"col\">", "</th>\n                "]);

    _templateObject4_1f654540db3d11eaa14b6130b7e5d77f = function _templateObject4_1f654540db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject3_1f654540db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <caption>\n                ", "\n              </caption>\n            "]);

    _templateObject3_1f654540db3d11eaa14b6130b7e5d77f = function _templateObject3_1f654540db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject2_1f654540db3d11eaa14b6130b7e5d77f() {
    ...
    _templateObject2_1f654540db3d11eaa14b6130b7e5d77f = function _templateObject2_1f654540db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_1f654540db3d11eaa14b6130b7e5d77f() {
    ...
    _templateObject_1f654540db3d11eaa14b6130b7e5d77f = function _templateObject_1f654540db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(CsvRender, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_1f654540db3d11eaa14b6130b7e5d77f())];
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(CsvRender, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_1f654540db3d11eaa14b6130b7e5d77f(), this.dataSource, this.tableDataChanged, this.handleResponse, this.accentColor, this.dataSource, this.summary, this.caption ? (0, _litElement.html)(_templateObject3_1f654540db3d11eaa14b6130b7e5d77f(), this.caption) : "", this.tableHeadings.map(function (heading) {
          return (0, _litElement.html)(_templateObject4_1f654540db3d11eaa14b6130b7e5d77f(), heading);
        }), this.table.map(function (row) {
          return (0, _litElement.html)(_templateObject5_1f654540db3d11eaa14b6130b7e5d77f(), row.map(function (col) {
            return (0, _litElement.html)(_templateObject6_1f654540db3d11eaa14b6130b7e5d77f(), col);
          }));
        }));
      }
    }, {
