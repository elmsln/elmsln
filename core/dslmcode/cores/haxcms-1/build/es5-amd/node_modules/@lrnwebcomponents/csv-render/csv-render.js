define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-icon-button-lite.js", "../intersection-element/lib/IntersectionObserverMixin.js"], function (_exports, _require, _litElement, _simpleColors, _simpleIconLite, _simpleIcons, _simpleIconButtonLite, _IntersectionObserverMixin) {
  ...
  function _templateObject6_25a59c7056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral([" <td>", "</td> "]);

    _templateObject6_25a59c7056b211eb8620237ff5403573 = function _templateObject6_25a59c7056b211eb8620237ff5403573() {
      return data;
    };
  ...
  function _templateObject5_25a59c7056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <tr>\n                ", "\n              </tr>\n            "]);

    _templateObject5_25a59c7056b211eb8620237ff5403573 = function _templateObject5_25a59c7056b211eb8620237ff5403573() {
      return data;
    };
  ...
  function _templateObject4_25a59c7056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral([" <th scope=\"col\">", "</th> "]);

    _templateObject4_25a59c7056b211eb8620237ff5403573 = function _templateObject4_25a59c7056b211eb8620237ff5403573() {
      return data;
    };
  ...
  function _templateObject3_25a59c7056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <caption>\n                ", "\n              </caption>\n            "]);

    _templateObject3_25a59c7056b211eb8620237ff5403573 = function _templateObject3_25a59c7056b211eb8620237ff5403573() {
      return data;
    };
  ...
  function _templateObject2_25a59c7056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <hexagon-loader\n        id=\"loading\"\n        accent-color=\"", "\"\n        ?loading=\"", "\"\n        item-count=\"4\"\n        size=\"small\"\n      ></hexagon-loader>\n      <a href=\"", "\" id=\"download\" tabindex=\"-1\">\n        <simple-icon-button-lite\n          id=\"ficon\"\n          icon=\"file-download\"\n        ></simple-icon-button-lite>\n      </a>\n      <simple-tooltip for=\"ficon\" offset=\"14\" position=\"top\"\n        >Download table data</simple-tooltip\n      >\n      <table class=\"table\" summary=\"", "\">\n        ", "\n        <thead>\n          <tr>\n            ", "\n          </tr>\n        </thead>\n        <tbody>\n          ", "\n        </tbody>\n      </table>\n    "]);

    _templateObject2_25a59c7056b211eb8620237ff5403573 = function _templateObject2_25a59c7056b211eb8620237ff5403573() {
      return data;
    };
  ...
  function _templateObject_25a59c7056b211eb8620237ff5403573() {
    ...
    _templateObject_25a59c7056b211eb8620237ff5403573 = function _templateObject_25a59c7056b211eb8620237ff5403573() {
      return data;
    };
  ...
  var CsvRender = /*#__PURE__*/function (_IntersectionObserver) {
    ...
    babelHelpers.createClass(CsvRender, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(CsvRender), "styles", this)), [(0, _litElement.css)(_templateObject_25a59c7056b211eb8620237ff5403573())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(CsvRender, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_25a59c7056b211eb8620237ff5403573(), this.accentColor, this.loading, this.dataSource, this.summary, this.caption ? (0, _litElement.html)(_templateObject3_25a59c7056b211eb8620237ff5403573(), this.caption) : "", this.tableHeadings.map(function (heading) {
          return (0, _litElement.html)(_templateObject4_25a59c7056b211eb8620237ff5403573(), heading);
        }), this.table.map(function (row) {
          return (0, _litElement.html)(_templateObject5_25a59c7056b211eb8620237ff5403573(), row.map(function (col) {
            return (0, _litElement.html)(_templateObject6_25a59c7056b211eb8620237ff5403573(), col);
          }));
        }));
      }
    }, {
