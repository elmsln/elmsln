define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/paper-listbox/paper-listbox.js", "../../../@polymer/paper-item/paper-item.js", "../../../@polymer/paper-menu-button/paper-menu-button.js", "../../simple-tooltip/simple-tooltip.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-button-lite.js", "../../hax-iconset/lib/simple-hax-iconset.js", "./editable-table-behaviors.js"], function (_exports, _polymerElement, _paperListbox, _paperItem, _paperMenuButton, _simpleTooltip, _simpleIconLite, _simpleIcons, _simpleIconButtonLite, _simpleHaxIconset, _editableTableBehaviors) {
  "use strict";
  ...
  function _templateObject_379bd8e056b211eb8620237ff5403573() {
    ...
    _templateObject_379bd8e056b211eb8620237ff5403573 = function _templateObject_379bd8e056b211eb8620237ff5403573() {
      return data;
    };
  ...
  var EditableTableEditorRowcol = /*#__PURE__*/function (_cellBehaviors) {
    ...
    babelHelpers.createClass(EditableTableEditorRowcol, [{
      ...
      key: "_getMenuControls",
      value: function _getMenuControls(index, row) {
        return row ? "cell-0-".concat(index) : "cell-".concat(index, "-0");
      }
      /**
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_379bd8e056b211eb8620237ff5403573());
      }
    }, {
      key: "tag",
      get: function get() {
