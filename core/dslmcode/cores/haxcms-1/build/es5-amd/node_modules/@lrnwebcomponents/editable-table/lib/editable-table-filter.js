define(["exports", "../../../lit-element/lit-element.js", "./editable-table-behaviors.js", "../../simple-tooltip/simple-tooltip.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js", "../../simple-icon/lib/simple-icon-button-lite.js", "../../hax-iconset/lib/simple-hax-iconset.js"], function (_exports, _litElement, _editableTableBehaviors, _simpleTooltip, _simpleIconLite, _simpleIcons, _simpleIconButtonLite, _simpleHaxIconset) {
  "use strict";
  ...
  var _templateObject_dddc88d0b80f11eb903f3b4791d1f11f, _templateObject2_dddc88d0b80f11eb903f3b4791d1f11f;
  ...
  var EditableTableFilter = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(EditableTableFilter, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_dddc88d0b80f11eb903f3b4791d1f11f || (_templateObject_dddc88d0b80f11eb903f3b4791d1f11f = babelHelpers.taggedTemplateLiteral(["\n      <button id=\"button\" class=\"cell-button\" @click=\"", "\">\n        <span><slot></slot></span>\n        <span class=\"sr-only\" .hidden=\"", "\"> (filtered)</span>\n        <span class=\"sr-only\"> Toggle filter.</span>\n        <simple-icon-lite\n          id=\"filter\"\n          icon=\"editable-table:filter\"\n        ></simple-icon-lite>\n        <simple-icon-lite\n          id=\"filter-off\"\n          icon=\"editable-table:filter-off\"\n        ></simple-icon-lite>\n      </button>\n      <simple-tooltip for=\"button\"\n        >Toggle Column ", " filter for \"<slot\n        ></slot>\"</simple-tooltip\n      >\n    "])), this._onFilterClicked, !this.filtered, this.columnIndex);
      }
    }, {
      key: "_getPressed",
      value:
