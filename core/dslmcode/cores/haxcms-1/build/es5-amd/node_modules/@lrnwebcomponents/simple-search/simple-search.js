define(["exports", "../../lit-element/lit-element.js", "../../@polymer/iron-icons/iron-icons.js", "../../@polymer/paper-input/paper-input.js", "../../@polymer/paper-tooltip/paper-tooltip.js", "./lib/simple-search-content.js", "./lib/simple-search-match.js"], function (_exports, _litElement, _ironIcons, _paperInput, _paperTooltip, _simpleSearchContent, _simpleSearchMatch) {
  "use strict";
  ...
  function _templateObject2_63c3fb702d8511ea80ccf124101da415() {
    ...
    _templateObject2_63c3fb702d8511ea80ccf124101da415 = function _templateObject2_63c3fb702d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function _templateObject_63c3fb702d8511ea80ccf124101da415() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-input\n        id=\"input\"\n        label=\"", "\"\n        ?always-float-label=\"", "\"\n        ?no-label-float=\"", "\"\n        @change=\"", "\"\n      >\n        <iron-icon icon=\"", "\" slot=\"prefix\"></iron-icon>\n      </paper-input>\n      <div id=\"xofy\" ?shrink-hide=\"", "\">\n        ", "\n      </div>\n      <div ?shrink-hide=\"", "\">\n        <button\n          id=\"prev\"\n          aria-label=\"", "\"\n          aria-role=\"button\"\n          controls=\"", "\"\n          tabindex=\"0\"\n          ?disabled=\"", "\"\n          @click=\"", "\"\n        >\n          <iron-icon icon=\"", "\"></iron-icon>\n        </button>\n        <paper-tooltip for=\"prev\">", "</paper-tooltip>\n        <button\n          id=\"next\"\n          aria-label=\"", "\"\n          aria-role=\"button\"\n          controls=\"", "\"\n          tabindex=\"0\"\n          ?disabled=\"", "\"\n          @click=\"", "\"\n        >\n          <iron-icon icon=\"", "\"></iron-icon>\n        </button>\n        <paper-tooltip for=\"next\">", "</paper-tooltip>\n      </div>\n    "]);

    _templateObject_63c3fb702d8511ea80ccf124101da415 = function _templateObject_63c3fb702d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleSearch, [{
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_63c3fb702d8511ea80ccf124101da415())];
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(SimpleSearch, [{
      ...
      key: "_hasNoResults",
      value: function _hasNoResults(count) {
        return count < 1;
      }
      /**
       * are there any results to navigate?
      ...
      value: function _getResultsSpan(pointer, count) {
        return count > 0 && pointer > 0 ? pointer + "/" + count : count > 0 ? count : "";
      }
      /**
       * navigate results
       */
      ...
      value: function findMatches(results) {
        ...
        this.searchTerms.forEach(function (term) {
          var modifier = _this3.caseSensitive ? "gm" : "gim",
              regex = new RegExp("\\b(" + term + ")\\b", modifier),
              replacer = function replacer(match) {
            _this3.resultCount++;
            return "<simple-search-match tabindex=\"0\" match-number=\"".concat(_this3.resultCount, "\">").concat(match, "</simple-search-match>");
          };
