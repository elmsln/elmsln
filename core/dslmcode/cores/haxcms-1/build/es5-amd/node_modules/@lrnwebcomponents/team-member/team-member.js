 ...
 */var TeamMember=/*#__PURE__*/function(_SchemaBehaviors){babelHelpers.inherits(TeamMember,_SchemaBehaviors);function TeamMember(){var _this;babelHelpers.classCallCheck(this,TeamMember);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(TeamMember).call(this));new Promise(function(res,rej){return _require.default(["../../@polymer/iron-iconset-svg/iron-iconset-svg.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/iron-image/iron-image.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-icon-button/paper-icon-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../mdi-iconset-svg/lib/mdi-social-iconset-svg.js"],res,rej)});return _this}babelHelpers.createClass(TeamMember,null,[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_b3a540e0734911eaac0dbb5c5350affd())}},{key:"tag",get:function get(){return"team-member"}},{key:"haxProperties",get:function get(){return{canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Sample gizmo",description:"The user will be able to see this for selection in a UI.",icon:"av:play-circle-filled",color:"grey",groups:["Video","Media"],handles:[{type:"video",url:"source"}],meta:{author:"Your organization on github"}},settings:{quick:[{property:"title",title:"Title",description:"The title of the element",inputMethod:"textfield",icon:"editor:title"}],configure:[{property:"title",title:"Title",description:"The title of the element",inputMethod:"textfield",icon:"editor:title"}],advanced:[]}}}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(TeamMember),"properties",this),{/**
       ...
       * whatsapp
       */whatsapp:{type:String,value:!1}})}}]);return TeamMember}((0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement));_exports.TeamMember=TeamMember;window.customElements.define(TeamMember.tag,TeamMember)});