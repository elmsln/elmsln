...
value:function render(){return(0,_litElement.html)(_templateObject_998f42a06d7711eabc05594818a06afe())}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFields),"styles",this)),[(0,_litElement.css)(_templateObject2_998f42a06d7711eabc05594818a06afe())])}},{key:"haxProperties",get:function get(){return{}}// properties available to the custom element for data binding
   ...
   */},{key:"tag",get:function get(){return"simple-fields"}}]);function SimpleFields(){var _format,_this;babelHelpers.classCallCheck(this,SimpleFields);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SimpleFields).call(this));_this.fieldsConversion={defaultSettings:{defaultSettings:{type:"string"}},inputMethod:{alt:{defaultSettings:{type:"string",format:"alt"}},array:{defaultSettings:{type:"array"},properties:{label:"itemLabel"}},boolean:{defaultSettings:{type:"boolean"}},code:{defaultSettings:{type:"markup"}},"code-editor":{defaultSettings:{type:"markup"}},color:{defaultSettings:{type:"string",format:"color"}},colorpicker:{defaultSettings:{type:"string",format:"colorpicker"}},"date-time":{defaultSettings:{type:"string",format:"date-time"}},datepicker:{defaultSettings:{type:"string",format:"date"}},fieldset:{defaultSettings:{type:"object"}},haxupload:{defaultSettings:{type:"string",format:"haxupload"}},iconpicker:{defaultSettings:{type:"string",format:"iconpicker"}},markup:{defaultSettings:{type:"markup"}},monthpicker:{defaultSettings:{type:"string",format:"month"}},number:{defaultSettings:{type:"number"}},object:{defaultSettings:{type:"object"}},select:{defaultSettings:{type:"string",format:"select"}},slider:{defaultSettings:{type:"number",format:"slider"}},tabs:{defaultSettings:{type:"object",format:"tabs"}},textarea:{defaultSettings:{type:"string",format:"textarea"}},timepicker:{defaultSettings:{type:"string",format:"time"}},weekpicker:{defaultSettings:{type:"string",format:"week"}}}};_this.schemaConversion={defaultSettings:{element:"simple-fields-field",errorProperty:"errorMessage",invalidProperty:"invalid",noWrap:!0,attributes:{type:"text"},properties:{minLength:"minlength",maxLength:"maxlength"}},format:{radio:{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"radio"},properties:{options:"options"},child:{element:"simple-fields-array-item",noWrap:!0,descriptionProperty:"description",properties:{previewBy:"previewBy"}}}},select:{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"select"},properties:{options:"options"}}},"simple-picker":{defaultSettings:{element:"simple-picker",attributes:{autofocus:!0},properties:{options:"options"}}}},type:{array:{defaultSettings:{element:"simple-fields-array",noWrap:!0,descriptionProperty:"description",child:{element:"simple-fields-array-item",noWrap:!0,descriptionProperty:"description",properties:{previewBy:"previewBy"}}}},boolean:{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"checkbox",value:!1}}},file:{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"file"},properties:{accepts:"accepts"}}},integer:{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,step:1,type:"number"},properties:{minimum:"min",maximum:"max",multiplef:"step"}}},markup:{defaultSettings:{element:"simple-fields-code",setValueProperty:"editorValue",noWrap:!0}},number:{defaultSettings:{element:"simple-fields-field",noWrap:!0,type:"number",attributes:{autofocus:!0,type:"number"},properties:{minimum:"min",maximum:"max",multipleOf:"step"}}},object:{defaultSettings:{element:"simple-fields-fieldset",noWrap:!0},format:{tabs:{defaultSettings:{element:"simple-fields-tabs",noWrap:!0,child:{element:"simple-fields-tab",noWrap:!0,labelSlot:"label",descriptionSlot:""},attributes:{"layout-breakpoint":0}}}}},string:{format:(_format={alt:{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,required:!0}}},color:{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"color"}}},colorpicker:{defaultSettings:{element:"simple-colors-picker",attributes:{autofocus:!0}}},date:{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"date"}}},"date-time":{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"datetime-local"}}}},babelHelpers.defineProperty(_format,"date",{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"date"}}}),babelHelpers.defineProperty(_format,"email",{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"email"}}}),babelHelpers.defineProperty(_format,"haxupload",{defaultSettings:{element:"hax-upload-field",noWrap:!0,attributes:{autofocus:!0}}}),babelHelpers.defineProperty(_format,"iconpicker",{defaultSettings:{element:"simple-icon-picker",attributes:{autofocus:!0}}}),babelHelpers.defineProperty(_format,"month",{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"month"}}}),babelHelpers.defineProperty(_format,"textarea",{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"textarea"}}}),babelHelpers.defineProperty(_format,"time",{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"time"}}}),babelHelpers.defineProperty(_format,"uri",{defaultSettings:{element:"simple-fields-field",noWrap:!0,attributes:{autofocus:!0,type:"file"}}}),_format)}}};setTimeout(function(){new Promise(function(res,rej){return _require.default(["./lib/simple-fields-field.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./lib/simple-fields-tabs.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./lib/simple-fields-code.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../hax-body/lib/hax-upload-field.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../simple-picker/simple-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../simple-colors/lib/simple-colors-picker.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../simple-icon-picker/simple-icon-picker.js"],res,rej)})},0);return _this}/**
   ...
   * @returns {object}
   * @memberof SimpleFieldsLite
   */},{key:"_convertField",value:function _convertField(field){var _this3=this,conversion=1<arguments.length&&arguments[1]!==void 0?arguments[1]:this.fieldsConversion,settings=2<arguments.length&&arguments[2]!==void 0?arguments[2]:{},fieldKeys=Object.keys(field||{}),convKeys=Object.keys(conversion||{}).filter(function(key){return fieldKeys.includes(key)});if(conversion.defaultSettings)settings=conversion.defaultSettings;convKeys.forEach(function(key){var val=field[key],convData=conversion?conversion[key]:void 0,convVal=!convData?void 0:Array.isArray(val)?convData[val[0]]:convData[val];if(convVal)settings=_this3._convertField(field,convVal,settings)});return settings}/**
   * converts fields array to schema properties
   * @param {*} field field object to convert
   * @returns object schema properties
   * @memberof SimpleFieldsLite
   */},{key:"_fieldToSchema",value:function _fieldToSchema(field){var _this4=this,schema={};Object.keys(field||{}).forEach(function(key){if(!field.inputMethod&&field.properties)field.inputMethod="object";var conversion=_this4._convertField(field);if(conversion.type)schema.type=conversion.type;if(conversion.format)schema.format=conversion.format;if("pattern"===key){if(".*"!=field.validation)schema.pattern=field.validation}else if("properties"===key){if("array"===conversion.type&&Array.isArray(field.properties)){schema.items={type:"object",properties:_this4._fieldsToSchema(field.properties)}}else if("array"===conversion.type){schema.items=_this4._fieldToSchema(field.properties)}else{schema.properties=_this4._fieldsToSchema(field.properties)}/*} else if (key === "slot") {
   ...
   * @returns object schema properties
   * @memberof SimpleFieldsLite
   */},{key:"_fieldsToSchema",value:function _fieldsToSchema(fields){var _this5=this,schema={};fields.forEach(function(field){var prop=!field.property?"":field.property;schema[prop]=_this5._fieldToSchema(field)});//console.log("_fieldsToSchema", schema, fields);
return schema}},{key:"convertedSchema",get:function get(){var schema={$schema:"http://json-schema.org/schema#",title:this.label,type:"object",required:[],properties:this._fieldsToSchema(this.fields)};return schema}}]);return SimpleFields}(_simpleFieldsLite.SimpleFieldsLite);_exports.SimpleFields=SimpleFields;window.customElements.define(SimpleFields.tag,SimpleFields)});