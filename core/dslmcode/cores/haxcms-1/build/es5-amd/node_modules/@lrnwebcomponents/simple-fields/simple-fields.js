define(["exports", "require", "../../lit-element/lit-element.js", "./lib/simple-fields-lite.js"], function (_exports, _require, _litElement, _simpleFieldsLite) {
  ...
  function _templateObject2_c9d23f907b5411eabe077dd4dade3abc() {
    ...
    _templateObject2_c9d23f907b5411eabe077dd4dade3abc = function _templateObject2_c9d23f907b5411eabe077dd4dade3abc() {
      return data;
    };
  ...
  function _templateObject_c9d23f907b5411eabe077dd4dade3abc() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"schema-fields\" aria-live=\"polite\">\n        <slot></slot>\n      </div>\n    "]);

    _templateObject_c9d23f907b5411eabe077dd4dade3abc = function _templateObject_c9d23f907b5411eabe077dd4dade3abc() {
      return data;
    };
  ...
  function (_SimpleFieldsLite) {
    ...
    babelHelpers.createClass(SimpleFields, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_c9d23f907b5411eabe077dd4dade3abc());
      ...
      //styles function
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFields), "styles", this)), [(0, _litElement.css)(_templateObject2_c9d23f907b5411eabe077dd4dade3abc())]);
      }
    }, {
      key: "haxProperties",
      get: function get() {
      ...
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFields), "properties", this), {
          /**
    ...
    function SimpleFields() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SimpleFields).call(this));
      _this.activeTabs = {};
      _this.fieldsConversion = {
        defaultSettings: {
          type: "string"
        },
        inputMethod: {
      ...
      _this.schemaConversion = {
        ...
        type: {
          ...
          string: {
            ...
            }), babelHelpers.defineProperty(_format, "haxupload", {
              defaultSettings: {
      ...
      setTimeout(function () {
        new Promise(function (res, rej) {
          return _require.default(["./lib/simple-fields-field.js"], res, rej);
        });
        new Promise(function (res, rej) {
          return _require.default(["./lib/simple-fields-tabs.js"], res, rej);
        });
        new Promise(function (res, rej) {
          return _require.default(["./lib/simple-fields-code.js"], res, rej);
        });
        new Promise(function (res, rej) {
          return _require.default(["../hax-body/lib/hax-upload-field.js"], res, rej);
        });
        new Promise(function (res, rej) {
    ...
    babelHelpers.createClass(SimpleFields, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "fields") _this2.schema = _this2.convertedSchema;
      ...
      value: function _convertField(field) {
        ...
        convKeys.forEach(function (key) {
          ...
          if (convVal) settings = _this4._convertField(field, convVal, settings);
        });
        return settings;
      }
      /**
