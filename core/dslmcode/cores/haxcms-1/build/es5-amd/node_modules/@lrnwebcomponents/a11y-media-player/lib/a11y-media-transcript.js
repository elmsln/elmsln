define(["exports", "../../../@polymer/polymer/polymer-element.js", "./a11y-media-behaviors.js", "./a11y-media-transcript-cue.js"], function (_exports, _polymerElement, _a11yMediaBehaviors, _a11yMediaTranscriptCue) {
  "use strict";
  ...
  function _templateObject3_f1a685302c1c11eaacb4bf54e86db688() {
    ...
    _templateObject3_f1a685302c1c11eaacb4bf54e86db688 = function _templateObject3_f1a685302c1c11eaacb4bf54e86db688() {
      return data;
    };
  ...
  function _templateObject2_f1a685302c1c11eaacb4bf54e86db688() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <h1>Transcript</h1>\n      "]);

    _templateObject2_f1a685302c1c11eaacb4bf54e86db688 = function _templateObject2_f1a685302c1c11eaacb4bf54e86db688() {
      return data;
    };
  ...
  function _templateObject_f1a685302c1c11eaacb4bf54e86db688() {
    ...
    _templateObject_f1a685302c1c11eaacb4bf54e86db688 = function _templateObject_f1a685302c1c11eaacb4bf54e86db688() {
      return data;
    };
   ...
   * @polymer
   */
  var A11yMediaTranscript =
  /*#__PURE__*/
  function (_A11yMediaBehaviors) {
    babelHelpers.inherits(A11yMediaTranscript, _A11yMediaBehaviors);

    function A11yMediaTranscript() {
      babelHelpers.classCallCheck(this, A11yMediaTranscript);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(A11yMediaTranscript).apply(this, arguments));
    }

    babelHelpers.createClass(A11yMediaTranscript, [{
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(A11yMediaTranscript.prototype), "connectedCallback", this).call(this);
        this.dispatchEvent(new CustomEvent("transcript-ready", {
          detail: this
        }));
      }
      /**
      ...
      value: function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(A11yMediaTranscript.prototype), "ready", this).call(this);
        this.__ready = true;
      }
      /**
      ...
      key: "download",
      value: function download(mediaTitle) {
        var root = this,
            a = document.createElement("a"),
            title = mediaTitle !== null && mediaTitle !== "" ? mediaTitle : this._getLocal("transcript", "label"),
            filename = mediaTitle !== null && mediaTitle !== "" ? mediaTitle.replace(/[^\w\d]/g, "") : "Transcript",
      ...
      value: function print(mediaTitle) {
        var root = this,
            ...
            css = (0, _polymerElement.html)(_templateObject_f1a685302c1c11eaacb4bf54e86db688()),
            h1 = (0, _polymerElement.html)(_templateObject2_f1a685302c1c11eaacb4bf54e86db688());
        ...
        if (track !== null & track !== undefined) {
          ...
          var print = window.open("", "", "left=0,top=0,width=552,height=477,toolbar=0,scrollbars=0,status =0");
      ...
      key: "setActiveCues",
      value: function setActiveCues(cues) {
        var root = this,
            offset = root.shadowRoot.querySelector("#track") !== null && root.shadowRoot.querySelector("#track") !== undefined ? root.shadowRoot.querySelector("#track").offsetTop : 0,
            cue = root.shadowRoot.querySelector("#track a11y-media-transcript-cue[active]");
        root.set("activeCues", cues.slice(0));

        if (!root.disableScroll && cue !== undefined && cue !== null && root.activeCues !== undefined && cue.getAttribute("order") !== root.activeCues[0]) {
      ...
      key: "setMedia",
      value: function setMedia(player) {
        this.media = player;
        this.dispatchEvent(new CustomEvent("transcript-ready", {
          detail: this
        }));
      ...
      value: function setTracks(tracks) {
        ...
        if (this.tracks !== undefined && this.tracks.length > 0) this.shadowRoot.querySelector("#tracks").render();
      }
      /**
       * fires an event when media is associated with the player
       *
      ...
      key: "toggleHidden",
      value: function toggleHidden(mode) {
        var root = this,
            inner = document.getElementById("inner"),
            active = inner !== null && inner !== undefined ? inner.querySelector("a11y-media-transcript-cue[active]") : null,
            first = inner !== null && inner !== undefined ? inner.querySelector("a11y-media-transcript-cue") : null;
      ...
      key: "_getTabIndex",
      value: function _getTabIndex(disableInteractive) {
      ...
      key: "_getRole",
      value: function _getRole(disableInteractive) {
      ...
      key: "_handleCueSeek",
      value: function _handleCueSeek(e) {
        if (!this.disableInteractive) {
          this.dispatchEvent(new CustomEvent("transcript-seek", {
            detail: e.detail
          }));
        }
      }
      ...
      key: "_isActive",
      value: function _isActive(selectedTranscript, index) {
        return selectedTranscript !== undefined && selectedTranscript !== null && parseInt(selectedTranscript) === parseInt(index);
      }
      /**
       * determines if this is the currently selected transcript to show or hide
       *
      ...
      key: "_isLoading",
      value: function _isLoading(selectedTranscript, tracks) {
        return selectedTranscript === undefined || selectedTranscript === null || tracks === undefined || tracks === null || tracks.length === 0;
      }
    }, {
      key: "_stampLoadingStatus",
      value: function _stampLoadingStatus(disableSeek, __ready) {
        if (__ready) {
          this.shadowRoot.querySelector("#loading").innerHTML = disableSeek === false ? this._getLocal("transcript", "label") : this._getLocal("youTubeTranscript", "label");
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject3_f1a685302c1c11eaacb4bf54e86db688());
      }
    }]);
    return A11yMediaTranscript;
  }(_a11yMediaBehaviors.A11yMediaBehaviors);

  _exports.A11yMediaTranscript = A11yMediaTranscript;
