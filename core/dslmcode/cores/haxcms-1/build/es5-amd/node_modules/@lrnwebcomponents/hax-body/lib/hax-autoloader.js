define(["exports", "meta", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/async.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../@polymer/polymer/lib/utils/resolve-url.js", "../../hax-body-behaviors/hax-body-behaviors.js", "./haxutils.js"], function (_exports, meta, _require, _polymerElement, async, _flattenedNodesObserver, _resolveUrl, _haxBodyBehaviors, _haxutils) {
  "use strict";
  ...
  function _templateObject_45ef9730e14a11e9bce923988a998e3c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n    "]);

    _templateObject_45ef9730e14a11e9bce923988a998e3c = function _templateObject_45ef9730e14a11e9bce923988a998e3c() {
      return data;
    };
  ...
  function (_HAXElement) {
    ...
    function HaxAutoloader() {
      ...
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HaxAutoloader).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(HaxAutoloader, [{
      ...
      value: function ready() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(HaxAutoloader.prototype), "ready", this).call(this); // fire an event that this is the manager

        this.dispatchEvent(new CustomEvent("hax-register-autoloader", {
          bubbles: true,
          cancelable: true,
          composed: true,
          detail: this
              ...
              (function () {
                ...
                if (typeof effectiveChildren[i].getHaxProperties === "function") {
                  ...
                  if (!window.customElements.get(name)) {
                    var nameLocation = (0, _haxutils.varGet)(window.HaxStore, "instance.__appStoreData.autoloader." + name, "@lrnwebcomponents/".concat(name, "/").concat(name, ".js"));
                    new Promise(function (res, rej) {
                      ...
                      if (!CEClass) {
                        ...
                        _this2.setHaxProperties(CEClass.getHaxProperties(), name);
                      } else if (typeof CEClass.HAXWiring === "function") {
                        _this2.setHaxProperties(CEClass.HAXWiring.getHaxProperties(), name);
                      } else if (CEClass.haxProperties) {
                        _this2.setHaxProperties(CEClass.haxProperties, name);
                      } else {
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_45ef9730e14a11e9bce923988a998e3c());
      }
    }, {
      key: "tag",
      get: function get() {
  ...
  }((0, _haxBodyBehaviors.HAXElement)(_polymerElement.PolymerElement));
