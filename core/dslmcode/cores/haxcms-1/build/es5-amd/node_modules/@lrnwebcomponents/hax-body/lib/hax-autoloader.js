define(["exports", "meta", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/async.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../@polymer/polymer/lib/utils/resolve-url.js", "../../hax-body-behaviors/hax-body-behaviors.js"], function (_exports, meta, _require, _polymerElement, async, _flattenedNodesObserver, _resolveUrl, _haxBodyBehaviors) {
  ...
  function _templateObject_cfcf5630aa5311e9b999174ecd579fc6() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: none;\n        }\n      </style>\n      <slot></slot>\n    "]);

    _templateObject_cfcf5630aa5311e9b999174ecd579fc6 = function _templateObject_cfcf5630aa5311e9b999174ecd579fc6() {
      return data;
    };
  ...
  function (_HAXElement) {
    ...
    babelHelpers.createClass(HaxAutoloader, [{
              ...
              (function () {
                ...
                if (typeof effectiveChildren[i].getHaxProperties === "function") {
                  ...
                  new Promise(function (res, rej) {
                    return _require.default(["".concat(basePath, "../../").concat(name, "/").concat(name, ".js")], res, rej);
                    ...
                    if (typeof CEClass.getHaxProperties === "function") {
                      ...
                      console.log("".concat(name, " didn't have hax wiring in the end"));
                    }
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_cfcf5630aa5311e9b999174ecd579fc6());
      }
    }, {
      key: "tag",
      get: function get() {
