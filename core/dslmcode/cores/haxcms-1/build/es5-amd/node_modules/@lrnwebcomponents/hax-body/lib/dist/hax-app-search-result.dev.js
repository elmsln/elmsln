...
function _templateObject2_0a5f32507fe611edbfd7dd19f6a31344() {
  ...
  _templateObject2_0a5f32507fe611edbfd7dd19f6a31344 = function _templateObject2_0a5f32507fe611edbfd7dd19f6a31344() {
    return data;
  };
...
function _templateObject_0a5f32507fe611edbfd7dd19f6a31344() {
  var data = _taggedTemplateLiteral(['\n      <button\n        draggable="true"\n        @click="', '"\n        @dragstart="', '"\n        @dragend="', '"\n        title="', '"\n      >\n        <img loading="lazy" class="image" src="', '" />\n        <div class="detail-wrapper">', "</div>\n      </button>\n    "]);

  _templateObject_0a5f32507fe611edbfd7dd19f6a31344 = function _templateObject_0a5f32507fe611edbfd7dd19f6a31344() {
    return data;
  };
...
var HaxAppSearchResult = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxAppSearchResult, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_0a5f32507fe611edbfd7dd19f6a31344(), this._itemSelected, this._dragStart, this._dragEnd, this.details, this.image, this.title.substr(0, 40));
    }
  }, {
    key: "_dragStart",
    ...
    key: "styles",
    get: function get() {
      return [(0, _litElement.css)(_templateObject2_0a5f32507fe611edbfd7dd19f6a31344())];
    }
  }, {
    key: "tag",
    get: function get() {
