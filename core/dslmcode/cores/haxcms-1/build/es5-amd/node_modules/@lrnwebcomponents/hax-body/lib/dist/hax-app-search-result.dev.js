...
function _templateObject2_cd2b05b0fadc11eb92688bf0453ba51f() {
  ...
  _templateObject2_cd2b05b0fadc11eb92688bf0453ba51f = function _templateObject2_cd2b05b0fadc11eb92688bf0453ba51f() {
    return data;
  };
...
function _templateObject_cd2b05b0fadc11eb92688bf0453ba51f() {
  var data = _taggedTemplateLiteral(['\n      <button\n        draggable="true"\n        @click="', '"\n        @dragstart="', '"\n        @dragend="', '"\n        title="', '"\n      >\n        <img loading="lazy" class="image" src="', '" />\n        <div class="detail-wrapper">', "</div>\n      </button>\n    "]);

  _templateObject_cd2b05b0fadc11eb92688bf0453ba51f = function _templateObject_cd2b05b0fadc11eb92688bf0453ba51f() {
    return data;
  };
...
var HaxAppSearchResult = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxAppSearchResult, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_cd2b05b0fadc11eb92688bf0453ba51f(), this._itemSelected, this._dragStart, this._dragEnd, this.details, this.image, this.title.substr(0, 40));
    }
  }, {
    key: "_dragStart",
    ...
    key: "styles",
    get: function get() {
      return [(0, _litElement.css)(_templateObject2_cd2b05b0fadc11eb92688bf0453ba51f())];
    }
  }, {
    key: "tag",
    get: function get() {
