...
function _templateObject2_e5cd18b07fe711ed91214d829072706f() {
  ...
  _templateObject2_e5cd18b07fe711ed91214d829072706f = function _templateObject2_e5cd18b07fe711ed91214d829072706f() {
    return data;
  };
...
function _templateObject_e5cd18b07fe711ed91214d829072706f() {
  var data = _taggedTemplateLiteral(['\n      <button\n        draggable="true"\n        @click="', '"\n        @dragstart="', '"\n        @dragend="', '"\n        title="', '"\n      >\n        <img loading="lazy" class="image" src="', '" />\n        <div class="detail-wrapper">', "</div>\n      </button>\n    "]);

  _templateObject_e5cd18b07fe711ed91214d829072706f = function _templateObject_e5cd18b07fe711ed91214d829072706f() {
    return data;
  };
...
var HaxAppSearchResult = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(HaxAppSearchResult, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_e5cd18b07fe711ed91214d829072706f(), this._itemSelected, this._dragStart, this._dragEnd, this.details, this.image, this.title.substr(0, 40));
    }
  }, {
    key: "_dragStart",
    ...
    key: "styles",
    get: function get() {
      return [(0, _litElement.css)(_templateObject2_e5cd18b07fe711ed91214d829072706f())];
    }
  }, {
    key: "tag",
    get: function get() {
