...
function _templateObject2_f2e0f5001f0511ed8cc3e9a95995ad69() {
  ...
  _templateObject2_f2e0f5001f0511ed8cc3e9a95995ad69 = function _templateObject2_f2e0f5001f0511ed8cc3e9a95995ad69() {
    return data;
  };
...
function _templateObject_f2e0f5001f0511ed8cc3e9a95995ad69() {
  var data = _taggedTemplateLiteral(['\n        <div id="grid">\n          <div\n            id="buttons"\n            class="', '"\n            style="', '"\n            part="buttons"\n          >\n            <slot></slot>\n            ', "\n          </div>\n        </div>\n      "]);

  _templateObject_f2e0f5001f0511ed8cc3e9a95995ad69 = function _templateObject_f2e0f5001f0511ed8cc3e9a95995ad69() {
    return data;
  };
...
var SimpleButtonGridBehaviors = function SimpleButtonGridBehaviors(SuperClass) {
  return /*#__PURE__*/function (_SimpleToolbarBehavio) {
    ...
    _createClass(_class, [{
      ...
      key: "toolbarTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject_f2e0f5001f0511ed8cc3e9a95995ad69(), !this.alwaysExpanded && this.collapsed ? "collapsed" : "", this.gridStyles, this.alwaysExpanded ? "" : this.moreButton);
      }
    }], [{
      key: "baseStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_f2e0f5001f0511ed8cc3e9a95995ad69())];
