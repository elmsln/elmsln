...
function _templateObject2_1a829390771f11eda127255eab9a1aca() {
  ...
  _templateObject2_1a829390771f11eda127255eab9a1aca = function _templateObject2_1a829390771f11eda127255eab9a1aca() {
    return data;
  };
...
function _templateObject_1a829390771f11eda127255eab9a1aca() {
  var data = _taggedTemplateLiteral(['\n        <div id="grid">\n          <div\n            id="buttons"\n            class="', '"\n            style="', '"\n            part="buttons"\n          >\n            <slot></slot>\n            ', "\n          </div>\n        </div>\n      "]);

  _templateObject_1a829390771f11eda127255eab9a1aca = function _templateObject_1a829390771f11eda127255eab9a1aca() {
    return data;
  };
...
var SimpleButtonGridBehaviors = function SimpleButtonGridBehaviors(SuperClass) {
  return /*#__PURE__*/function (_SimpleToolbarBehavio) {
    ...
    _createClass(_class, [{
      ...
      key: "toolbarTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject_1a829390771f11eda127255eab9a1aca(), !this.alwaysExpanded && this.collapsed ? "collapsed" : "", this.gridStyles, this.alwaysExpanded ? "" : this.moreButton);
      }
    }], [{
      key: "baseStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_1a829390771f11eda127255eab9a1aca())];
