define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../haxcms-elements/lib/core/haxcms-site-store.js", "../../hax-body/lib/haxutils.js", "../../../mobx/lib/mobx.module.js"], function (_exports, _require, _polymerElement, _haxcmsSiteStore, _haxutils, _mobxModule) {
  "use strict";
  ...
  function _templateObject_19faa990e48211e9b5c6f7b0a264592f() {
    ...
    _templateObject_19faa990e48211e9b5c6f7b0a264592f = function _templateObject_19faa990e48211e9b5c6f7b0a264592f() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(SimpleBlogFooter, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_19faa990e48211e9b5c6f7b0a264592f());
      }
      /**
    ...
    babelHelpers.createClass(SimpleBlogFooter, [{
      ...
      value: function connectedCallback() {
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          ...
          if ((0, _haxutils.varExists)(_this2.manifest, "title")) {
            document.title = _this2.manifest.title;
          }

          if ((0, _haxutils.varExists)(_this2.manifest, "metadata.theme.variables.cssVariable")) {
            // json outline schema changed, allow other things to react
            // fake way of forcing an update of these items
            var ary = _this2.manifest.metadata.theme.variables.cssVariable.replace("--simple-colors-default-theme-", "").split("-");
