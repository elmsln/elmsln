define(["exports", "../../lit-element/lit-element.js", "./lib/date.format.js"], function (_exports, _litElement, _dateFormat) {
  ...
  function _templateObject2_34a1ac00db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 14px;\n          color: #b3b3b1;\n          line-height: 30px;\n        }\n      "]);

    _templateObject2_34a1ac00db3d11eaa14b6130b7e5d77f = function _templateObject2_34a1ac00db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_34a1ac00db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <time datetime=\"", "\">", "</time>\n    "]);

    _templateObject_34a1ac00db3d11eaa14b6130b7e5d77f = function _templateObject_34a1ac00db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(SimpleDatetime, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_34a1ac00db3d11eaa14b6130b7e5d77f(), this.date, this.date);
      }
    }, {
      key: "updated",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_34a1ac00db3d11eaa14b6130b7e5d77f())];
      }
    }, {
      key: "tag",
      get: function get() {
