define(["exports", "meta", "require", "../../../../lit-element/lit-element.js", "../../../../@polymer/polymer/lib/utils/settings.js", "../../../json-outline-schema/json-outline-schema.js", "../../../utils/utils.js", "../../../../mobx/lib/mobx.module.js", "./haxcms-site-store.js", "../../../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, meta, _require, _litElement, _settings, _jsonOutlineSchema, _utils, _mobxModule, _haxcmsSiteStore, _ironAjax) {
  ...
  function _templateObject2_a1e51590a11d11eaa169d9d604127774() {
    ...
    _templateObject2_a1e51590a11d11eaa169d9d604127774 = function _templateObject2_a1e51590a11d11eaa169d9d604127774() {
      return data;
    };
  ...
  function _templateObject_a1e51590a11d11eaa169d9d604127774() {
    ...
    _templateObject_a1e51590a11d11eaa169d9d604127774 = function _templateObject_a1e51590a11d11eaa169d9d604127774() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSSiteBuilder, [{
      ...
      value: function _updateManifest(e) {
        this.manifest = _objectSpread({}, e.detail.value);
      }
    }, {
      key: "_updateLoading",
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_a1e51590a11d11eaa169d9d604127774())];
      }
      /**
    ...
    babelHelpers.createClass(HAXCMSSiteBuilder, [{
        ...
        if (newValue) {
          ...
          if (html !== null) {
            ...
            setTimeout(function () {
              ...
              if (!window.WCAutoload && (0, _utils.varExists)(_this4.manifest, "metadata.node.dynamicElementLoader")) {
                var i;
      ...
      value: function _manifestChanged(newValue, oldValue) {
        if (newValue && newValue.metadata && newValue.items) {
          ...
          newValue.items.forEach(function (item, index, array) {
            if (!item.slug) {
