define(["exports", "meta", "require", "../../../../lit/index.js", "../../../utils/utils.js", "../../../../mobx/dist/mobx.esm.js", "./haxcms-site-store.js", "../../../simple-progress/simple-progress.js", "../../../replace-tag/replace-tag.js", "../../../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _require, _index, _utils, _mobxEsm, _haxcmsSiteStore, _simpleProgress, _replaceTag, _I18NMixin2) {
  ...
  var _templateObject_17927430514511ecad92218912f770fd, _templateObject2_17927430514511ecad92218912f770fd;
    ...
    babelHelpers.createClass(HAXCMSSiteBuilder, [{
              ...
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  return fetch(url).then(function (response) {
                    ...
                    _this3._updateActiveItemContent(data);
                ...
                case 9:
                  ...
                  return fetch(url, headers).then(function (response) {
                    if (response.ok) {
                      ...
                      _this4.lastErrorChanged(err);
                    }
                  }).then(function (data) {
                    _this4._updateManifest(data);
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (["outlineLocation", "activeItemLocation"].includes(propName) && _this5[propName] != "") {
            loadPage = true;
          }

          if (["outlineLocation", "file"].includes(propName) && _this5[propName] != "") {
            loadOutline = true;
          }
          ...
          if (propName == "dashboardOpened") {
            _this5._dashboardOpenedChanged(_this5[propName], oldValue);
          } else if (propName == "themeData") {
            _this5._themeChanged(_this5[propName], oldValue);
          } else if (propName == "themeName") {
            _this5._themeNameChanged(_this5[propName], oldValue);
          } else if (propName == "outlineLocation") {
            // fire an to match notify
            _this5.dispatchEvent(new CustomEvent("outline-location-changed", {
              bubbles: true,
              cancelable: true,
              composed: true,
              detail: _this5[propName]
            }));
          } else if (propName == "manifest") {
            // fire an to match notify
            _this5.dispatchEvent(new CustomEvent("manifest-changed", {
              bubbles: true,
              cancelable: true,
              composed: true,
              detail: _this5[propName]
            ...
            _this5._manifestChanged(_this5[propName], oldValue);
          } else if (propName == "activeItem") {
            // fire an to match notify
            _this5.dispatchEvent(new CustomEvent("active-item-changed", {
              bubbles: true,
              cancelable: true,
              composed: true,
              detail: _this5[propName]
            ...
            _this5._activeItemChanged(_this5[propName], oldValue);
          } else if (propName == "activeItemContent") {
            // fire an to match notify
            _this5.dispatchEvent(new CustomEvent("active-item-content-changed", {
              bubbles: true,
              cancelable: true,
              composed: true,
              detail: _this5[propName]
            ...
            _this5._activeItemContentChanged(_this5[propName], oldValue);
          }
        });
      ...
      value: function firstUpdated(changedProperties) {
        ...
        new Promise(function (res, rej) {
          ...
          _this6.editorBuilder = document.createElement("haxcms-editor-builder"); // attach editor builder after we've appended to the screen

          document.body.appendChild(_this6.editorBuilder); // get fresh data if not published / demo which is a form of published

          if (_haxcmsSiteStore.HAXcmsStore.getApplicationContext() !== "published") {
            _this6._timeStamp = Math.floor(Date.now() / 1000);
          } else {
            _this6._timeStamp = "";
          }
        ...
        setTimeout(function () {
          (0, _mobxEsm.autorun)(function (reaction) {
            _this6.dashboardOpened = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.dashboardOpened);

            _this6.__disposer.push(reaction);
          });
          (0, _mobxEsm.autorun)(function (reaction) {
            _this6.themeData = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.themeData);
            ...
            if (_this6.themeData) {
              ...
              if (format != null) {
                switch (format) {
                  case "print-page":
                    _this6.themeData.element = "haxcms-print-theme";
                    break;
                }
              }
            }

            if (_this6.themeData && _this6.themeData.element !== _this6.themeName) {
              _this6.themeName = _this6.themeData.element;
            }

            _this6.__disposer.push(reaction);
          });
          (0, _mobxEsm.autorun)(function (reaction) {
            _this6.activeItem = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeItem);

            if (_this6.activeItem && _this6.activeItem.location) {
              _this6.activeItemLocation = _this6.activeItem.location;
            }
          ...
          if (html !== null) {
            ...
            setTimeout(function () {
              if (_haxcmsSiteStore.store.themeElement.childNodes.length === 0) {
                var frag = document.createRange().createContextualFragment(_this7.replaceTagReplacement(html));

                _haxcmsSiteStore.store.themeElement.appendChild(frag);

                _this7.dispatchEvent(new CustomEvent("json-outline-schema-active-body-changed", {
                  bubbles: true,
                  composed: true,
                  cancelable: false,
                  detail: html
              ...
              if (!window.WCAutoload && (0, _utils.varExists)(_this7.manifest, "metadata.node.dynamicElementLoader")) {
                var i;
                ...
                (function () {
                  ...
                  var _loop = function _loop() {
                    ...
                    if (_this7.manifest.metadata.node.dynamicElementLoader[tagName] && !window.customElements.get(tagName)) {
                      // prettier-ignore
                      new Promise(function (res, rej) {
                        return _require.default(["".concat(basePath, "../../../../").concat(_this7.manifest.metadata.node.dynamicElementLoader[tagName])], res, rej);
            ...
            if (window.WCAutoload) {
              ...
              try {
                ...
                new Promise(function (res, rej) {
                  ...
                  _this8.__imported[theme.element] = theme.element;
                  _this8.themeLoaded = true;
                });
              } catch (err) {
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_17927430514511ecad92218912f770fd || (_templateObject2_17927430514511ecad92218912f770fd = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          position: relative;\n        }\n        :host #slot {\n          opacity: 0.2;\n          visibility: hidden;\n        }\n        :host([dashboard-opened]) {\n          display: inline-block !important;\n          margin-left: 50vw;\n          height: 100vh;\n          pointer-events: none;\n          opacity: 0.5;\n          width: 100vw;\n        }\n        :host([theme-loaded]) #slot {\n          opacity: 1;\n          visibility: visible;\n        }\n        simple-progress {\n          display: block;\n          width: 100%;\n          position: fixed;\n          top: 0;\n          left: 0;\n          right: 0;\n          background-color: transparent;\n          z-index: 1000;\n          --simple-progress-active-color: var(\n            --haxcms-color,\n            rgba(255, 255, 255, 0.5)\n          );\n        }\n        simple-progress[disabled] {\n          display: none;\n        }\n      "])))];
      }
      /**
