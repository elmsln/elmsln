define(["exports", "meta", "require", "../../../../@polymer/polymer/polymer-element.js", "../../../../@polymer/polymer/lib/utils/settings.js", "../../../../@polymer/polymer/lib/mixins/element-mixin.js", "../../../../@polymer/polymer/lib/utils/render-status.js", "../../../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../../../@polymer/polymer/lib/utils/resolve-url.js", "../../../hax-body/lib/haxutils.js", "../../../../mobx/lib/mobx.module.js", "./haxcms-site-store.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "./haxcms-site-router.js"], function (_exports, meta, _require, _polymerElement, _settings, _elementMixin, _renderStatus, _polymerDom, _resolveUrl, _haxutils, _mobxModule, _haxcmsSiteStore, _ironAjax, _haxcmsSiteRouter) {
  ...
  function _templateObject_ef9249a0aa5311e9b999174ecd579fc6() {
    ...
    _templateObject_ef9249a0aa5311e9b999174ecd579fc6 = function _templateObject_ef9249a0aa5311e9b999174ecd579fc6() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(HAXCMSSiteBuilder, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_ef9249a0aa5311e9b999174ecd579fc6());
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(HAXCMSSiteBuilder, [{
      ...
      value: function connectedCallback() {
        ...
        (0, _renderStatus.afterNextRender)(this, function () {
          ...
          new Promise(function (res, rej) {
            ...
            if (_this2.editorBuilder.getContext() !== "published") {
      ...
      value: function _activeItemContentChanged(newValue, oldValue) {
        ...
        if (newValue) {
          ...
          if (html !== null) {
            ...
            setTimeout(function () {
              if ((0, _polymerDom.dom)(_this3.themeElement).getEffectiveChildNodes().length === 0) {
                var frag = document.createRange().createContextualFragment(html);
                (0, _polymerDom.dom)(_this3.themeElement).appendChild(frag);
            ...
            if (this.manifest.metadata.dynamicElementLoader) {
              ...
              (function () {
                ...
                var _loop = function _loop() {
                  ...
                  if (_this3.manifest.metadata.dynamicElementLoader[tagName] && !window.customElements.get(tagName)) {
                    new Promise(function (res, rej) {
                      return _require.default(["".concat(basePath, "../../../../").concat(_this3.manifest.metadata.dynamicElementLoader[tagName])], res, rej);
      ...
      value: function _themeChanged(newValue, oldValue) {
        ...
        if (newValue && oldValue) {
          if (_haxcmsSiteStore.store.cmsSiteEditor && _haxcmsSiteStore.store.cmsSiteEditor.instance && babelHelpers.typeof(_haxcmsSiteStore.store.cmsSiteEditor.instance.haxCmsSiteEditorElement) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
        ...
        if (newValue) {
          ...
          var theme = newValue; // wipe out what we got
          ...
          if (babelHelpers.typeof(this.__imported[theme.element]) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
            ...
            try {
              new Promise(function (res, rej) {
                ...
                (0, _polymerDom.dom)(_this4).appendChild(_this4.themeElement);
