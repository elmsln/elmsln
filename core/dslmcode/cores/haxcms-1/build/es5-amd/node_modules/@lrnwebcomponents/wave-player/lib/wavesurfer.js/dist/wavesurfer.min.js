 ...
 */
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : babelHelpers.typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : babelHelpers.typeof(module)) ? module.exports = t() : "function" == typeof define && define.amd ? define("WaveSurfer", [], t) : "object" == (typeof exports === "undefined" ? "undefined" : babelHelpers.typeof(exports)) ? exports.WaveSurfer = t() : e.WaveSurfer = t();
}(window, function () {
  return function (r) {
    var n = {};
      ...
      return t = e, (r = [{
        ...
        value: function value(e, t) {
          if (this.handlers) {
            var r,
                n = this.handlers[e];
            if (n) if (t) for (r = n.length - 1; 0 <= r; r--) {
              n[r] == t && n.splice(r, 1);
            } else n.length = 0;
          }
        }
    ...
    var h = "playing",
      ...
      function i(e) {
        ...
        return function (e, t) {
          if (!babelHelpers.instanceof(e, t)) throw new TypeError("Cannot call a class as a function");
        }(this, i), (n = s(this, o(i).call(this))).audioContext = null, n.offlineAudioContext = null, n.stateBehaviors = (a(t = {}, h, {
          init: function init() {
      ...
      return function (e, t) {
        ...
        value: function value() {
          ...
          this.scriptNode.onaudioprocess = function () {
            ...
            e >= t.getDuration() ? (t.setState(d), t.fireEvent("pause")) : e >= t.scheduledPause ? t.pause() : t.state === t.states[h] && t.fireEvent("audioprocess", e);
          };
        }
      }, {
        ...
        key: "seekTo",
        value: function value(e, t) {
          if (this.buffer) return (this.scheduledPause = null) == e && (e = this.getCurrentTime()) >= this.getDuration() && (e = 0), null == t && (t = this.getDuration()), this.startPosition = e, this.lastPlay = this.ac.currentTime, this.state === this.states[d] && this.setState(f), {
            start: e,
            end: t
          };
        }
    ...
    var m = function (e) {
      function n(e) {
        ...
        if (p(this, n), (t = c(this, h(n).call(this))).defaultParams = {
          ...
          WebAudio: s.default
        }, t.util = i, t.params = i.extend({}, t.defaultParams, e), t.container = "string" == typeof e.container ? document.querySelector(t.params.container) : t.params.container, !t.container) throw new Error("Container element not found");
        ...
        if (t.savedVolume = 0, t.isMuted = !1, t.tmpEvents = [], t.currentAjax = null, t.arraybuffer = null, t.drawer = null, t.backend = null, t.peakCache = null, "function" != typeof t.params.renderer) throw new Error("Renderer parameter is invalid");
        t.Drawer = t.params.renderer, t.Backend = t.backends[t.params.backend], t.initialisedPluginList = {}, t.isDestroyed = !1, t.isReady = !1;
        var r = 0;
      ...
      return function (e, t) {
        ...
        value: function value(e) {
          var t = this;
          if ("number" != typeof e || !isFinite(e) || e < 0 || 1 < e) return console.error("Error calling wavesurfer.seekTo, parameter must be a number between 0 and 1!");
      ...
      return function (e, t) {
        ...
        value: function value() {
          ...
          this.canvases.forEach(function (e, t) {
            ...
            t == n.canvases.length - 1 && (r = n.width - n.maxCanvasWidth * (n.canvases.length - 1)), n.updateDimensions(e, r, n.height), n.clearWaveForEntry(e);
          });
        }
      }, {
        key: "addCanvas",
        ...
        key: "drawLine",
        value: function value(t, r, n, i, a, s) {
          var o = this;
          this.canvases.forEach(function (e) {
        ...
        value: function value(e, t, r, n, i, a, s, o) {
          if (t) {
            var u = r.length / 2,
        ...
        key: "prepareDraw",
        value: function value(s, o, u, l, c) {
          var h = this;
          return f.frame(function () {
            if (babelHelpers.instanceof(s[0], Array)) {
              var e = s;
              if (h.params.splitChannels) return h.setHeight(e.length * h.params.height * h.params.pixelRatio), e.forEach(function (e, t) {
    ...
    function n(e) {
      return (n = "function" == typeof Symbol && "symbol" == babelHelpers.typeof(Symbol.iterator) ? function (e) {
        return babelHelpers.typeof(e);
      } : function (e) {
        return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : babelHelpers.typeof(e);
      })(e);
      ...
      return function (e, t) {
        ...
        value: function value(e, t) {
          ...
          var r,
              ...
              a = this.width,
              s = this.getWidth();
          return !this.params.fillParent && a < s ? 1 < (r = (n - i.left) * (this.params.pixelRatio / a) || 0) && (r = 1) : r = (n - i.left + this.wrapper.scrollLeft) / this.wrapper.scrollWidth || 0, r;
        }
      }, {
    ...
    var h = function (e) {
      function n(e) {
        ...
        return function (e, t) {
          ...
          volume: 0
        }, t.mediaType = e.mediaType.toLowerCase(), t.elementPosition = e.elementPosition, t.peaks = null, t.playbackRate = 1, t.volume = 1, t.buffer = null, t.onPlayEnd = null, t;
      }
