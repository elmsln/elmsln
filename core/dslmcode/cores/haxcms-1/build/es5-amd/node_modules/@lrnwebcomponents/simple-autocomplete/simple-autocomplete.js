define(["exports", "require", "../../lit/index.js", "../simple-filter/simple-filter.js", "../utils/utils.js", "../simple-popover/simple-popover.js"], function (_exports, _require, _index, _simpleFilter, _utils, _simplePopover) {
  ...
  var _templateObject_a82109d0514a11ecb9f033a821100adf, _templateObject2_a82109d0514a11ecb9f033a821100adf, _templateObject3_a82109d0514a11ecb9f033a821100adf, _templateObject4_a82109d0514a11ecb9f033a821100adf, _templateObject5_a82109d0514a11ecb9f033a821100adf, _templateObject6_a82109d0514a11ecb9f033a821100adf, _templateObject7_a82109d0514a11ecb9f033a821100adf, _templateObject8_a82109d0514a11ecb9f033a821100adf;
  ...
  var SimpleAutocomplete = /*#__PURE__*/function (_SimpleFilterMixin) {
    ...
    babelHelpers.createClass(SimpleAutocomplete, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_a82109d0514a11ecb9f033a821100adf || (_templateObject_a82109d0514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <simple-popover\n        part=\"popover\"\n        auto\n        part=\"simple-popover\"\n        ?hidden=\"", "\"\n        position=\"bottom\"\n        for=\"input\"\n      >\n        ", "\n      </simple-popover>\n    "])), !this.hideInput ? (0, _index.html)(_templateObject2_a82109d0514a11ecb9f033a821100adf || (_templateObject2_a82109d0514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["<span\n            part=\"input\"\n            id=\"input\"\n            name=\"input\"\n            @input=\"", "\"\n            contenteditable\n            @keydown=\"", "\"\n          ></span>"])), this.inputChanged, this.a11yInputKeys) : "", !this.opened || this.filtered.length === 0, this.filtered.length > 0 && this.opened ? (0, _index.html)(_templateObject3_a82109d0514a11ecb9f033a821100adf || (_templateObject3_a82109d0514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral([" <ul\n              part=\"list\"\n              role=\"listbox\"\n              @keydown=\"", "\"\n            >\n              ", "\n            </ul>"])), this.a11yListKeys, this.filtered.map(function (item, i) {
          return (0, _index.html)(_templateObject4_a82109d0514a11ecb9f033a821100adf || (_templateObject4_a82109d0514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["", ""])), i < _this2.itemLimit ? (0, _index.html)(_templateObject5_a82109d0514a11ecb9f033a821100adf || (_templateObject5_a82109d0514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["<li\n                        role=\"option\"\n                        part=\"list-item\"\n                        value=\"", "\"\n                        data-index=\"", "\"\n                      >\n                        <button\n                          part=\"button\"\n                          value=\"", "\"\n                          data-index=\"", "\"\n                          @click=\"", "\"\n                        >\n                          ", "", "\n                        </button>\n                      </li>"])), item.value, i, item.value, i, _this2.itemSelect, item.icon ? (0, _index.html)(_templateObject6_a82109d0514a11ecb9f033a821100adf || (_templateObject6_a82109d0514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["<simple-icon-lite\n                                icon=\"", "\"\n                              ></simple-icon-lite>"])), item.icon) : "", item.label) : "");
        })) : (0, _index.html)(_templateObject7_a82109d0514a11ecb9f033a821100adf || (_templateObject7_a82109d0514a11ecb9f033a821100adf = babelHelpers.taggedTemplateLiteral(["<div class=\"no-results\" part=\"no-result\">No results</div>"]))));
      }
      /**
