define(["exports", "require", "../../lit/index.js", "../simple-filter/simple-filter.js", "../utils/utils.js", "../simple-popover/simple-popover.js"], function (_exports, _require, _index, _simpleFilter, _utils, _simplePopover) {
  ...
  var _templateObject_ae6c8b001f0511ed8cc3e9a95995ad69, _templateObject2_ae6c8b001f0511ed8cc3e9a95995ad69, _templateObject3_ae6c8b001f0511ed8cc3e9a95995ad69, _templateObject4_ae6c8b001f0511ed8cc3e9a95995ad69, _templateObject5_ae6c8b001f0511ed8cc3e9a95995ad69, _templateObject6_ae6c8b001f0511ed8cc3e9a95995ad69, _templateObject7_ae6c8b001f0511ed8cc3e9a95995ad69, _templateObject8_ae6c8b001f0511ed8cc3e9a95995ad69;
  ...
  var SimpleAutocomplete = /*#__PURE__*/function (_SimpleFilterMixin) {
    ...
    babelHelpers.createClass(SimpleAutocomplete, [{
      ...
      value: function render() {
        ...
        return (0, _index.html)(_templateObject_ae6c8b001f0511ed8cc3e9a95995ad69 || (_templateObject_ae6c8b001f0511ed8cc3e9a95995ad69 = babelHelpers.taggedTemplateLiteral(["\n      ", "\n      <simple-popover\n        part=\"popover\"\n        auto\n        part=\"simple-popover\"\n        ?hidden=\"", "\"\n        position=\"bottom\"\n        for=\"input\"\n      >\n        ", "\n      </simple-popover>\n    "])), !this.hideInput ? (0, _index.html)(_templateObject2_ae6c8b001f0511ed8cc3e9a95995ad69 || (_templateObject2_ae6c8b001f0511ed8cc3e9a95995ad69 = babelHelpers.taggedTemplateLiteral(["<span\n            part=\"input\"\n            id=\"input\"\n            name=\"input\"\n            @input=\"", "\"\n            contenteditable\n            @keydown=\"", "\"\n          ></span>"])), this.inputChanged, this.a11yInputKeys) : "", !this.opened || this.filtered.length === 0, this.filtered.length > 0 && this.opened ? (0, _index.html)(_templateObject3_ae6c8b001f0511ed8cc3e9a95995ad69 || (_templateObject3_ae6c8b001f0511ed8cc3e9a95995ad69 = babelHelpers.taggedTemplateLiteral([" <ul\n              part=\"list\"\n              role=\"listbox\"\n              @keydown=\"", "\"\n            >\n              ", "\n            </ul>"])), this.a11yListKeys, this.filtered.map(function (item, i) {
          return (0, _index.html)(_templateObject4_ae6c8b001f0511ed8cc3e9a95995ad69 || (_templateObject4_ae6c8b001f0511ed8cc3e9a95995ad69 = babelHelpers.taggedTemplateLiteral(["", ""])), i < _this2.itemLimit ? (0, _index.html)(_templateObject5_ae6c8b001f0511ed8cc3e9a95995ad69 || (_templateObject5_ae6c8b001f0511ed8cc3e9a95995ad69 = babelHelpers.taggedTemplateLiteral(["<li\n                        role=\"option\"\n                        part=\"list-item\"\n                        value=\"", "\"\n                        data-index=\"", "\"\n                      >\n                        <button\n                          part=\"button\"\n                          value=\"", "\"\n                          data-index=\"", "\"\n                          @click=\"", "\"\n                        >\n                          ", "", "\n                        </button>\n                      </li>"])), item.value, i, item.value, i, _this2.itemSelect, item.icon ? (0, _index.html)(_templateObject6_ae6c8b001f0511ed8cc3e9a95995ad69 || (_templateObject6_ae6c8b001f0511ed8cc3e9a95995ad69 = babelHelpers.taggedTemplateLiteral(["<simple-icon-lite\n                                icon=\"", "\"\n                              ></simple-icon-lite>"])), item.icon) : "", item.label) : "");
        })) : (0, _index.html)(_templateObject7_ae6c8b001f0511ed8cc3e9a95995ad69 || (_templateObject7_ae6c8b001f0511ed8cc3e9a95995ad69 = babelHelpers.taggedTemplateLiteral(["<div class=\"no-results\" part=\"no-result\">No results</div>"]))));
      }
      /**
