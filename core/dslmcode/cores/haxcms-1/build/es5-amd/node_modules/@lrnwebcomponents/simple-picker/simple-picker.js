define(["exports", "require", "../../lit/index.js", "../../lit/directives/cache.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js"], function (_exports, _require, _index, _cache, _simpleIconLite, _simpleIcons) {
  ...
  var _templateObject_b782bf20f15711eb870c37be8598a0cc, _templateObject2_b782bf20f15711eb870c37be8598a0cc, _templateObject3_b782bf20f15711eb870c37be8598a0cc, _templateObject4_b782bf20f15711eb870c37be8598a0cc, _templateObject5_b782bf20f15711eb870c37be8598a0cc, _templateObject6_b782bf20f15711eb870c37be8598a0cc, _templateObject7_b782bf20f15711eb870c37be8598a0cc;
  ...
  var SimplePicker = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(SimplePicker, [{
      ...
      value: function _renderOptions(options) {
        ...
        return (0, _index.html)(_templateObject2_b782bf20f15711eb870c37be8598a0cc || (_templateObject2_b782bf20f15711eb870c37be8598a0cc = babelHelpers.taggedTemplateLiteral(["", ""])), options.map(function (row, rownum) {
          return (0, _index.html)(_templateObject3_b782bf20f15711eb870c37be8598a0cc || (_templateObject3_b782bf20f15711eb870c37be8598a0cc = babelHelpers.taggedTemplateLiteral(["\n        <div class=\"row\">\n          ", "\n        </div>\n      "])), Array.isArray(row) ? _this2._renderRow(row, rownum) : _index.nothing);
        }));
      }
    }, {
      key: "_renderRow",
      value: function _renderRow(row, rownum) {
        ...
        return (0, _index.html)(_templateObject4_b782bf20f15711eb870c37be8598a0cc || (_templateObject4_b782bf20f15711eb870c37be8598a0cc = babelHelpers.taggedTemplateLiteral(["", ""])), row.map(function (option, colnum) {
          return (0, _index.html)(_templateObject5_b782bf20f15711eb870c37be8598a0cc || (_templateObject5_b782bf20f15711eb870c37be8598a0cc = babelHelpers.taggedTemplateLiteral(["\n        <simple-picker-option\n          @option-focus=\"", "\"\n          @set-selected-option=\"", "\"\n          ?active=\"", "\"\n          ?hide-option-labels=\"", "\"\n          ?hidden=\"", "\"\n          ?selected=\"", "\"\n          ?title-as-html=\"", "\"\n          .data=\"", "\"\n          .icon=\"", "\"\n          .id=\"option-", "-", "\"\n          .label=\"", "\"\n          .style=", "\n          aria-selected=\"", "\"\n          role=\"option\"\n          tabindex=\"-1\"\n          value=\"", "\"\n        >\n        </simple-picker-option>\n      "])), _this3._handleOptionFocus, _this3._handleSetSelectedOption, "".concat(_this3.__activeDesc) === "option-".concat(rownum, "-").concat(colnum), _this3.hideOptionLabels, !_this3.allowNull && !option.value, _this3.value === option.value, _this3.titleAsHtml, _this3.data, option.icon, rownum, colnum, option.alt, option.style, _this3.value === option.value ? "true" : "false", option.value);
        }));
      }
    }, {
      key: "updated",
      ...
      value: function _goToOption(rownum, colnum) {
        var targetId = (0, _index.html)(_templateObject6_b782bf20f15711eb870c37be8598a0cc || (_templateObject6_b782bf20f15711eb870c37be8598a0cc = babelHelpers.taggedTemplateLiteral([" option-", "-", " "])), rownum, colnum),
