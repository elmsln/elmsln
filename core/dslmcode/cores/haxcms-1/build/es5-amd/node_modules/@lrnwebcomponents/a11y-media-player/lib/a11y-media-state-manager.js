define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/iron-resizable-behavior/iron-resizable-behavior.js"], function (_exports, _polymerElement, _ironResizableBehavior) {
  "use strict";
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(A11yMediaStateManager, _PolymerElement);
    ...
    function A11yMediaStateManager() {
      ...
      if (!window.A11yMediaStateManager.instance) {
        window.A11yMediaStateManager.instance = babelHelpers.assertThisInitialized(_this); // listen for a players added to the page
    ...
    babelHelpers.createClass(A11yMediaStateManager, [{
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(A11yMediaStateManager.prototype), "connectedCallback", this).call(this);
        var root = this;
