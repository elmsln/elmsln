  ...
  var A11yMediaStateManager = /*#__PURE__*/function (_LitElement) {
    ...
    function A11yMediaStateManager() {
      ...
      _this.__scrollChecker = function (e) {
        return setTimeout(_this._checkScroll(), 500);
      };
    ...
    babelHelpers.createClass(A11yMediaStateManager, [{
      ...
      value: function _checkScroll() {
        ...
        var wintop = window.pageYOffset,
            winbottom = wintop + window.innerHeight; //no need to handle player if it isn't playing or if in fullscreen mode

        if (!this.activePlayer || this.activePlayer.fullscreen) {} else if (!this.activePlayer.__playing) {
          this.activePlayer.toggleSticky(false);
        } else {
          var parent = this._getParentNode(this.activePlayer),
      ...
      value: function connectedCallback() {
        ...
        window.addEventListener("fullscreen-toggle", this._handleFullscreen); // listen for scrolling and find out if a player is off-screen
