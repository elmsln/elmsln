define(["../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js"], function (_polymerElement, _renderStatus) {
  "use strict";
  ...
  window.SimpleColorsStyles.addAccentVariables = function (sheet) {
    if (babelHelpers.typeof(sheet) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
      for (var color in window.SimpleColorsStyles.colors) {
        sheet.insertRule(window.SimpleColorsStyles.makeRule("body[accent-color=\"".concat(color, "\"], [accent-color=\"").concat(color, "\"]"), [window.SimpleColorsStyles.addColorShades("default", "accent", window.SimpleColorsStyles.colors[color], false), window.SimpleColorsStyles.addColorShades("fixed", "accent", window.SimpleColorsStyles.colors[color], false)].join("")), sheet.cssRules.length);
        sheet.insertRule(window.SimpleColorsStyles.makeRule("body[dark][accent-color=\"".concat(color, "\"], [dark][accent-color=\"").concat(color, "\"]"), [window.SimpleColorsStyles.addColorShades("default", "accent", window.SimpleColorsStyles.colors[color], true)].join("")), sheet.cssRules.length);
      }
