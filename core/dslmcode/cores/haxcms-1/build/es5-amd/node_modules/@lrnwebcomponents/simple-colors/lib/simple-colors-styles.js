  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(SimpleColorsStyles, [{
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(SimpleColorsStyles.prototype), "connectedCallback", this).call(this);
        /**
      ...
      key: "invertIndex",
      value: function invertIndex(index) {
      ...
      key: "maxContrastIndex",
      value: function maxContrastIndex(index) {
      ...
      key: "getHex",
      value: function getHex(hexcodes, index, dark) {
        if (dark) {
      ...
      key: "addThemeVariables",
      value: function addThemeVariables(theme, dark) {
        var str = [];
      ...
      key: "addColorShades",
      value: function addColorShades(theme, color, hexcodes, dark) {
        var str = [];

        for (var i = 0; i < hexcodes.length; i++) {
          var cssvar = this.makeVariable(color, i + 1, theme),
      ...
      value: function addAccentVariables(sheet) {
        if (babelHelpers.typeof(sheet) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
      ...
      key: "makeStyleElement",
      value: function makeStyleElement() {
        var style = document.createElement("style");
      ...
      key: "getAccentVariablesText",
      value: function getAccentVariablesText() {
        var text = "";
      ...
      key: "makeRule",
      value: function makeRule(selector, style) {
        return selector + " {\n" + style + "\n}\n";
      }
    }], [{
      key: "properties",
