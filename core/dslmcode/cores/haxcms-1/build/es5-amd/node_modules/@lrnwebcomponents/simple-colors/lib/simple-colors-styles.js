define(["exports"], function (_exports) {
  ...
  function (_HTMLElement) {
    babelHelpers.inherits(SimpleColorsStyles, _HTMLElement);

    function SimpleColorsStyles() {
      var _this;

      babelHelpers.classCallCheck(this, SimpleColorsStyles);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SimpleColorsStyles).call(this));
      /**
       * The colors object.
       * Each color contains an array of shades as hex codes from lightest to darkest.
       */

      _this.colors = window.SimpleColorsStyles.colors;
      /**
