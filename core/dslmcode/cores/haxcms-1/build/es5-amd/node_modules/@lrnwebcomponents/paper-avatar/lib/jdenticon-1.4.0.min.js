...
(function (l, h, k) {
  ...
  function t(b, a, c, d, f) {
    ...
    function v(c, d, f, g, h) {
      ...
      for (c = 0; c < h.length; c++) {
        l.m = new m(e + h[c][0] * k, u + h[c][1] * k, k, g++ % 4), d(l, k, c);
      }
    ...
    function g(a) {
      if (0 <= a.indexOf(h)) for (var b = 0; b < a.length; b++) {
  ...
  function z() {
    function b(a, b, e) {
      var d = babelHelpers.instanceof(c[a], Array) ? c[a] : [b, e];
      return function (a) {
        a = d[0] + a * (d[1] - d[0]);
    ...
    if ("string" === typeof b) {
      ...
      if (f || d && "getContext" in b) {
        ...
        if (f) {
          ...
          for (a.innerHTML = g.K(!1); b.firstChild;) {
            b.removeChild(b.firstChild);
          }

          for (a = a.firstChild.childNodes; a.length;) {
            b.appendChild(a[0]);
          }
  ...
  A.prototype = {
    a: function a(b, _a) {
      ...
      for (e = _a ? b.length - 2 : 0; e < b.length && 0 <= e; e += c) {
        f.push(d.L(b[e], b[e + 1]));
      }

      this.C.a(f);
    },
    b: function b(_b, a, c, d) {
      this.C.b(this.m.L(_b, a, c, c), c, d);
    },
    c: function c(b, a, _c, d, f) {
      this.a([b, a, b + _c, a, b + _c, a + d, b, a + d], f);
    },
    g: function g(b, a, c, d, f, e) {
      b = [b + c, a, b + c, a + d, b, a + d, b, a];
      b.splice((f || 0) % 4 * 2, 2);
      this.a(b, e);
    },
    D: function D(b, a, c, d, f) {
  ...
  B.prototype = {
    a: function a(b) {
      for (var a = "M" + b[0].x + " " + b[0].y, c = 1; c < b.length; c++) {
        a += "L" + b[c].x + " " + b[c].y;
      }

      this.i += a + "Z";
    },
    b: function b(_b2, a, c) {
      c = c ? 0 : 1;
      var d = a / 2;
      this.i += "M" + _b2.x + " " + (_b2.y + d) + "a" + d + "," + d + " 0 1," + c + " " + a + ",0a" + d + "," + d + " 0 1," + c + " " + -a + ",0";
    }
  };
  x.prototype = {
    F: function F(b) {
  ...
  y.prototype = {
    ...
    b: function b(_b4, a, c) {
      var d = this.h;
      a /= 2;
      d.arc(_b4.x + a, _b4.y + a, a, 0, 2 * Math.PI, c);
      d.closePath();
    }
  };
