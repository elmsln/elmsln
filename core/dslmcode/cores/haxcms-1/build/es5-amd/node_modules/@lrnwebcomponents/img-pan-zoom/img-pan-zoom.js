define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _require, _litElement, _esGlobalBridge) {
  ...
  function _templateObject4_b3f1504054f111eba18757df1555c032() {
    ...
    _templateObject4_b3f1504054f111eba18757df1555c032 = function _templateObject4_b3f1504054f111eba18757df1555c032() {
      return data;
    };
  ...
  function _templateObject3_b3f1504054f111eba18757df1555c032() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <div id=\"loader\">\n                    <hexagon-loader\n                      ?loading=", "\n                      item-count=\"4\"\n                      size=\"small\"\n                    ></hexagon-loader>\n                  </div>\n                "]);

    _templateObject3_b3f1504054f111eba18757df1555c032 = function _templateObject3_b3f1504054f111eba18757df1555c032() {
      return data;
    };
  ...
  function _templateObject2_b3f1504054f111eba18757df1555c032() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            ", "\n            <img-loader\n              ?loaded=\"", "\"\n              @loaded-changed=\"", "\"\n              ?loading=\"", "\"\n              @loading-changed=\"", "\"\n              src=\"", "\"\n              described-by=\"", "\"\n            ></img-loader>\n          "]);

    _templateObject2_b3f1504054f111eba18757df1555c032 = function _templateObject2_b3f1504054f111eba18757df1555c032() {
      return data;
    };
  ...
  function _templateObject_b3f1504054f111eba18757df1555c032() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <!-- Only preload regular images -->\n      ", "\n\n      <!-- Openseadragon -->\n      <div id=\"viewer\"></div>\n    "]);

    _templateObject_b3f1504054f111eba18757df1555c032 = function _templateObject_b3f1504054f111eba18757df1555c032() {
      return data;
    };
  ...
  var ImgPanZoom = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(ImgPanZoom, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b3f1504054f111eba18757df1555c032(), !this.dzi ? (0, _litElement.html)(_templateObject2_b3f1504054f111eba18757df1555c032(), this.hideSpinner || this.loaded ? "" : (0, _litElement.html)(_templateObject3_b3f1504054f111eba18757df1555c032(), this.loading || !this.loaded), this.loaded, this.loadedChangedEvent, this.loading, this.loadingChangedEvent, this.src || (this.sources || [])[0], this.describedBy || "") : "");
      }
    }, {
      key: "pathFromUrl",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_b3f1504054f111eba18757df1555c032())];
      }
    }, {
      key: "tag",
      get: function get() {
