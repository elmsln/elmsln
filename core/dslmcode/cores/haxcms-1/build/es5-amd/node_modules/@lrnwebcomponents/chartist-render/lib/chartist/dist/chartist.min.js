...
!function (a, b) {
  "function" == typeof define && define.amd ? define("Chartist", [], function () {
    return a.Chartist = b();
  }) : "object" == (typeof module === "undefined" ? "undefined" : babelHelpers.typeof(module)) && module.exports ? module.exports = b() : a.Chartist = b();
}(this, function () {
  var a = {
    version: "0.11.0"
  };
  return function (a, b, c) {
    ...
    c.namespaces = {
      ...
      for (a = a || {}, b = 1; b < arguments.length; b++) {
        ...
        for (var f in d) {
          e = d[f], "object" != babelHelpers.typeof(e) || null === e || babelHelpers.instanceof(e, Array) ? a[f] = e : a[f] = c.extend(a[f], e);
        }
      }
      ...
      return babelHelpers.instanceof(a, Node) ? a : b.querySelector(a);
    }, c.times = function (a) {
      ...
      return null === a || void 0 === a ? a : ("number" == typeof a ? a = "" + a : "object" == babelHelpers.typeof(a) && (a = JSON.stringify({
        data: a
      ...
      return f.normalized.series = c.getDataArray({
        ...
        return babelHelpers.instanceof(a, Array);
      ...
      return null !== a && "object" == babelHelpers.typeof(a) && a.hasOwnProperty(b);
      ...
      for (var b = 0; b < a.series.length; b++) {
        "object" == babelHelpers.typeof(a.series[b]) && void 0 !== a.series[b].data ? a.series[b].data.reverse() : babelHelpers.instanceof(a.series[b], Array) && a.series[b].reverse();
      }
    }, c.getDataArray = function (a, b, d) {
      function e(a) {
        if (c.safeHasProperty(a, "value")) return e(a.value);
        if (c.safeHasProperty(a, "data")) return e(a.data);
        if (babelHelpers.instanceof(a, Array)) return a.map(e);
      ...
      function e(a) {
        if (void 0 !== a) if (babelHelpers.instanceof(a, Array)) for (var b = 0; b < a.length; b++) {
          e(a[b]);
        } else {
          var c = d ? +a[d] : +a;
      ...
      return "object" == babelHelpers.typeof(a) && ("x" in a || "y" in a);
    ...
    function h() {
      a.addEventListener("resize", this.resizeListener), this.optionsProvider = c.optionsProvider(this.options, this.responsiveOptions, this.eventEmitter), this.eventEmitter.addEventHandler("optionsChanged", function () {
        ...
        babelHelpers.instanceof(a, Array) ? a[0](this, a[1]) : a(this);
    ...
    function d(a, d, e, f, g) {
      babelHelpers.instanceof(a, Element) ? this._node = a : (this._node = b.createElementNS(c.namespaces.svg, a), "svg" === a && this.attr({
    ...
    function g() {
      return babelHelpers.instanceof(this._node.parentNode, SVGElement) ? new c.Svg(this._node.parentNode) : null;
    }
      ...
      return void 0 === b && (b = !0), Object.keys(a).forEach(function (e) {
        function f(a, b) {
          var f,
              ...
              h,
              i = {};
          a.easing && (h = babelHelpers.instanceof(a.easing, Array) ? a.easing : c.Svg.Easing[a.easing], delete a.easing), a.begin = c.ensureUnit(a.begin, "ms"), a.dur = c.ensureUnit(a.dur, "ms"), h && (a.calcMode = "spline", a.keySplines = h.join(" "), a.keyTimes = "0;1"), b && (a.fill = "freeze", i[e] = a.from, this.attr(i), g = c.quantity(a.begin || 0).value, a.begin = "indefinite"), f = this.elem("animate", c.extend({
            attributeName: e
        ...
        babelHelpers.instanceof(a[e], Array) ? a[e].forEach(function (a) {
          f.bind(this)(a, !1);
    ...
    function d(a) {
      ...
      l.createGridAndLabels(e, h, this.supportsForeignObject, a, this.eventEmitter), j.createGridAndLabels(e, h, this.supportsForeignObject, a, this.eventEmitter), a.showGridBackground && c.createGridBackground(e, o, a.classNames.gridBackground, this.eventEmitter), b.raw.series.forEach(function (d, e) {
        ...
        f = a.distributeSeries && !a.stackBars ? l.axisLength / b.normalized.series.length / 2 : a.distributeSeries && a.stackBars ? l.axisLength / 2 : l.axisLength / b.normalized.series[e].length / 2, h = g.elem("g"), h.attr({
          ...
          }, babelHelpers.instanceof(l, c.StepAxis) && (l.options.stretch || (r[l.units.pos] += f * (a.horizontalBars ? -1 : 1)), r[l.units.pos] += a.stackBars || a.distributeSeries ? 0 : i * a.seriesBarDistance * (a.horizontalBars ? -1 : 1)), t = q[k] || p, q[k] = t - (p - r[l.counterUnits.pos]), void 0 !== g) {
            var v = {};
