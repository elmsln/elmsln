define(["exports"], function (_exports) {
   ...
   */
  var OERSchema = function OERSchema() {
    ...
    this.latestSchema = {
      ...
      classes: {
        Resource: {
          ...
          schema: "root",
          subClassOf: ["http://schema.org/Thing", "http://creativecommons.org/ns#Work"],
          properties: ["parentOf", "childOf", "forCourse", "mainContent", "forTopic"]
        },
        TableOfContents: {
        ...
        Course: {
          ...
          subClassOf: ["Resource"],
          properties: ["courseIdentifier", "primaryInstructor", "instructor", "duration", "prerequisite", "institution", "department", "program", "syllabus", "currentStanding", "deliveryFormat", "enrollmentSize", "section", "termOffered"]
        },
        CourseSection: {
          label: "CourseSection",
          comment: "A specific instance of a course offered during a specific term",
          subClassOf: ["Resource"],
          properties: ["sectionIdentifier", "primaryInstructor", "instructor", "syllabus", "forCourse", "termOffered", "enrollmentSize", "duration", "deliveryFormat"]
        },
        CourseSyllabus: {
        ...
        LearningComponent: {
          ...
          properties: ["forCourse", "forComponent", "hasComponent", "duration", "doTask", "hasLearningObjective", "deliveryFormat"]
        },
        LearningObjective: {
          label: "LearningObjective",
          commnet: "An expected outcome or skill gained by application of a LearningComponent",
          subClassOf: ["Resource"],
        ...
        Thing: {
          ...
          subClassOf: ["http://schema.org/Thing"],
          properties: ["name", "additionalType", "description", "image", "mainEntityOfPage", "sameAs", "uri"]
        },
        Intangible: {
          label: "Intangible",
        ...
        Property: {
          ...
          properties: ["rangeIncludes", "domainIncludes", "supersededBy", "inverseOf"]
        },
        Enumeration: {
          label: "Enumeration",
    ...
    for (var i in schema.classes) {
      if (babelHelpers.typeof(schema.classes[i].label) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && babelHelpers.typeof(schema.classes[i].subClassOf) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && (schema.classes[i].subClassOf.includes("Resource") || schema.classes[i].subClassOf.includes("LearningComponent") || schema.classes[i].subClassOf.includes("InstructionalPattern"))) {
