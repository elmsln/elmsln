...
function _templateObject4_0cfe9fc0facf11eba0e99d6dce951a3d() {
  ...
  _templateObject4_0cfe9fc0facf11eba0e99d6dce951a3d = function _templateObject4_0cfe9fc0facf11eba0e99d6dce951a3d() {
    return data;
  };
...
function _templateObject3_0cfe9fc0facf11eba0e99d6dce951a3d() {
  var data = _taggedTemplateLiteral(['<span class="sr-only">', "</span>"]);

  _templateObject3_0cfe9fc0facf11eba0e99d6dce951a3d = function _templateObject3_0cfe9fc0facf11eba0e99d6dce951a3d() {
    return data;
  };
...
function _templateObject2_0cfe9fc0facf11eba0e99d6dce951a3d() {
  var data = _taggedTemplateLiteral(['<a11y-menu-button-item\n      @click="', '"\n    >\n      ', "\n      ", "", "\n      ", "\n    </a11y-menu-button-item>"]);

  _templateObject2_0cfe9fc0facf11eba0e99d6dce951a3d = function _templateObject2_0cfe9fc0facf11eba0e99d6dce951a3d() {
    return data;
  };
...
function _templateObject_0cfe9fc0facf11eba0e99d6dce951a3d() {
  ...
  _templateObject_0cfe9fc0facf11eba0e99d6dce951a3d = function _templateObject_0cfe9fc0facf11eba0e99d6dce951a3d() {
    return data;
  };
...
var EditableTableEditorRowcol = /*#__PURE__*/function (_cellBehaviors) {
  ...
  _createClass(EditableTableEditorRowcol, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_0cfe9fc0facf11eba0e99d6dce951a3d(), this.row ? "right" : "bottom", this._onOpen, this.type, this.label || "", this._getItem(), this._getItem(false, true), this._getItem(true));
    }
  }, {
    key: "rowColAction",
    ...
    value: function _getItem() {
      ...
      return (0, _litElement.html)(_templateObject2_0cfe9fc0facf11eba0e99d6dce951a3d(), deleteItem ? this._onDelete : after ? this._onInsertAfter : this._onInsertBefore, deleteItem ? "Delete" : "Insert", this.type, deleteItem ? " " : after ? " After " : " Before ", this.labelInfo);
    }
  }, {
    key: "_onOpen",
    ...
    key: "labelInfo",
    get: function get() {
      return (0, _litElement.html)(_templateObject3_0cfe9fc0facf11eba0e99d6dce951a3d(), this.label);
    }
    /**
     *
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorRowcol), "styles", this) || []), _toConsumableArray(_editableTableBehaviors.editableTableCellStyles), [(0, _litElement.css)(_templateObject4_0cfe9fc0facf11eba0e99d6dce951a3d())]);
    }
  }, {
    key: "tag",
    get: function get() {
