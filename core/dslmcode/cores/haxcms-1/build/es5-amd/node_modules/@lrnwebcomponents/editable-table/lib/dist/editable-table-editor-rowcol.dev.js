...
function _templateObject4_a3d1aa60faba11eb8019c7472fdfce9a() {
  ...
  _templateObject4_a3d1aa60faba11eb8019c7472fdfce9a = function _templateObject4_a3d1aa60faba11eb8019c7472fdfce9a() {
    return data;
  };
...
function _templateObject3_a3d1aa60faba11eb8019c7472fdfce9a() {
  var data = _taggedTemplateLiteral(['<span class="sr-only">', "</span>"]);

  _templateObject3_a3d1aa60faba11eb8019c7472fdfce9a = function _templateObject3_a3d1aa60faba11eb8019c7472fdfce9a() {
    return data;
  };
...
function _templateObject2_a3d1aa60faba11eb8019c7472fdfce9a() {
  var data = _taggedTemplateLiteral(['<a11y-menu-button-item\n      @click="', '"\n    >\n      ', "\n      ", "", "\n      ", "\n    </a11y-menu-button-item>"]);

  _templateObject2_a3d1aa60faba11eb8019c7472fdfce9a = function _templateObject2_a3d1aa60faba11eb8019c7472fdfce9a() {
    return data;
  };
...
function _templateObject_a3d1aa60faba11eb8019c7472fdfce9a() {
  ...
  _templateObject_a3d1aa60faba11eb8019c7472fdfce9a = function _templateObject_a3d1aa60faba11eb8019c7472fdfce9a() {
    return data;
  };
...
var EditableTableEditorRowcol = /*#__PURE__*/function (_cellBehaviors) {
  ...
  _createClass(EditableTableEditorRowcol, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject_a3d1aa60faba11eb8019c7472fdfce9a(), this.row ? "right" : "bottom", this._onOpen, this.type, this.label || "", this._getItem(), this._getItem(false, true), this._getItem(true));
    }
  }, {
    key: "rowColAction",
    ...
    value: function _getItem() {
      ...
      return (0, _litElement.html)(_templateObject2_a3d1aa60faba11eb8019c7472fdfce9a(), deleteItem ? this._onDelete : after ? this._onInsertAfter : this._onInsertBefore, deleteItem ? "Delete" : "Insert", this.type, deleteItem ? " " : after ? " After " : " Before ", this.labelInfo);
    }
  }, {
    key: "_onOpen",
    ...
    key: "labelInfo",
    get: function get() {
      return (0, _litElement.html)(_templateObject3_a3d1aa60faba11eb8019c7472fdfce9a(), this.label);
    }
    /**
     *
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(EditableTableEditorRowcol), "styles", this) || []), _toConsumableArray(_editableTableBehaviors.editableTableCellStyles), [(0, _litElement.css)(_templateObject4_a3d1aa60faba11eb8019c7472fdfce9a())]);
    }
  }, {
    key: "tag",
    get: function get() {
