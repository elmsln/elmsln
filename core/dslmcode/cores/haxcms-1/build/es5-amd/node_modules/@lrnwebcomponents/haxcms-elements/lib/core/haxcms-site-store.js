define(["exports", "../../../../mobx/dist/mobx.esm.js", "../../../utils/utils.js", "../../../json-outline-schema/json-outline-schema.js"], function (_exports, _mobxEsm, _utils, _jsonOutlineSchema) {
  ...
  var Store = /*#__PURE__*/function () {
    ...
    babelHelpers.createClass(Store, [{
      ...
      key: "loadManifest",
      value: function () {
        var _loadManifest = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(manifest) {
          var target,
              git,
              site,
              nodes,
          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  target = _args.length > 1 && _args[1] !== undefined ? _args[1] : null;
      ...
      value: function () {
        var _findItemAsObject = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(id) {
          var attrLookup,
              scope,
              useToJS,
              tmpItem,
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  attrLookup = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : "id";
                  scope = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : "item";
                  useToJS = _args2.length > 3 && _args2[3] !== undefined ? _args2[3] : true;
                ...
                case 6:
                  ...
                  return _context2.abrupt("return", tmpItem);
      ...
      key: "addItem",
      value: function () {
        var _addItem = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(item) {
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  return _context3.abrupt("return", this.findItem(newItem.id));
