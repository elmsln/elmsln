define(["exports", "../../../../mobx/lib/mobx.module.js", "../../../hax-body/lib/haxutils.js"], function (_exports, _mobxModule, _haxutils) {
  "use strict";
    ...
    babelHelpers.createClass(Store, [{
      ...
      get: function get() {
        ...
        if (manifest && typeof manifest.items !== "undefined") {
          ...
          if ((0, _haxutils.varGet)(manifest, "metadata.site.settings.publishPagesOn", false) === true) {
      ...
      get: function get() {
        if (this.manifest) {
          ...
          if ((0, _haxutils.varExists)(this.manifest, "metadata.theme")) {
          ...
          if (this.activeItem && (0, _haxutils.varExists)(this.activeItem, "metadata.theme")) {
