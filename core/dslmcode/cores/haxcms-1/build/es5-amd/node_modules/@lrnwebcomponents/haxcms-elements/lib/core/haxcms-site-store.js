define(["exports", "../../../../mobx/lib/mobx.module.js"], function (_exports, _mobxModule) {
  "use strict";
  ...
  function () {
    ...
    babelHelpers.createClass(Store, [{
      ...
      value: function cmsSiteEditorAvailability() {
        ...
        var location = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document.body;

        if (!store.cmsSiteEditor.instance) {
          store.cmsSiteEditor.instance = document.createElement(store.cmsSiteEditor.tag);
          store.cmsSiteEditor.instance.appElement = element;
          store.cmsSiteEditor.instance.appendTarget = location; // self append the reference to.. well.. us.
          ...
          if (element) {
            ...
            if (babelHelpers.typeof(store.cmsSiteEditor.instance.haxCmsSiteEditorElement) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              store.cmsSiteEditor.instance.appendTarget.appendChild(store.cmsSiteEditor.instance.haxCmsSiteEditorElement);
            }
          }
        }
