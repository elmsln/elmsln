define(["exports", "../../../../mobx/dist/mobx.esm.js", "../../../utils/utils.js", "../../../json-outline-schema/json-outline-schema.js", "../../../hax-body/lib/hax-store.js"], function (_exports, _mobxEsm, _utils, _jsonOutlineSchema, _haxStore) {
  "use strict";
  ...
  var HAXCMSSiteStore = /*#__PURE__*/function (_HTMLElement) {
    ...
    function HAXCMSSiteStore() {
      ...
      (0, _mobxEsm.autorun)(function () {
        ...
        if (_haxStore.HAXStore && _haxStore.HAXStore.write) {
          ...
          _haxStore.HAXStore.editMode = editMode; // @todo hack to keep voice controls active if enabled

          if (_haxStore.HAXStore.globalPreferences.haxVoiceCommands) {
            setTimeout(function () {
              _haxStore.HAXStore.__hal.auto = true;
            }, 10);
          }
        }
      });
