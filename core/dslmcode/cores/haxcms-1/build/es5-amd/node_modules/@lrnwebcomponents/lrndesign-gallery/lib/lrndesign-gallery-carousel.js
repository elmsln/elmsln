define(["exports", "../../../lit-element/lit-element.js", "./lrndesign-gallery-behaviors.js", "../../../@polymer/iron-image/iron-image.js", "../../../@polymer/iron-icons/iron-icons.js", "./lrndesign-gallery-zoom.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _ironImage, _ironIcons, _lrndesignGalleryZoom) {
  ...
  function _templateObject3_d75215f088c411ea8e2ed3d8cb6f439c() {
    ...
    _templateObject3_d75215f088c411ea8e2ed3d8cb6f439c = function _templateObject3_d75215f088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function _templateObject2_d75215f088c411ea8e2ed3d8cb6f439c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                          <button\n                            id=\"", "\"\n                            aria-controls=\"carousel\"\n                            class=\"gallerythumb\"\n                            index=\"", "\"\n                            @click=\"", "\"\n                            ?disabled=\"", "\"\n                          >\n                            <iron-image\n                              alt=\"", "\"\n                              fade\n                              sizing=\"cover\"\n                              src=\"", "\"\n                            >\n                            </iron-image>\n                          </button>\n                          <simple-tooltip\n                            for=\"", "\"\n                            ?hidden=\"", "\"\n                            position=\"top\"\n                          >\n                            ", "\n                          </simple-tooltip>\n                        "]);

    _templateObject2_d75215f088c411ea8e2ed3d8cb6f439c = function _templateObject2_d75215f088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function _templateObject_d75215f088c411ea8e2ed3d8cb6f439c() {
    ...
    _templateObject_d75215f088c411ea8e2ed3d8cb6f439c = function _templateObject_d75215f088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGalleryCarousel, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_d75215f088c411ea8e2ed3d8cb6f439c(), this.galleryTitle, this.galleryTitle, this.aspectRatio, this.dark, this.extraWide, this.imageStyle, this.responsiveSize, this.hideNav, this.selected.xofy, this.selected.alt, this.selected.id, this.selected.thumbnail, this.selected.sizing, this.selected.src, this.imageStyle, this.selected.details, this.selected.heading, this.selected.large, this.selected.tooltip, this.selected.alt, this.selected.tooltip, this.hideNav, !this.selected || this.selected.prev < 0, function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_d75215f088c411ea8e2ed3d8cb6f439c(), item.id, item.index, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryCarousel), "styles", this)), [(0, _litElement.css)(_templateObject3_d75215f088c411ea8e2ed3d8cb6f439c())]);
      }
    }, {
      key: "properties",
      get: function get() {
