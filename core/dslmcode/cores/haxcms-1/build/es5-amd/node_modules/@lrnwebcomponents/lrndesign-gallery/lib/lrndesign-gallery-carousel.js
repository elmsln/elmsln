define(["exports", "../../../lit-element/lit-element.js", "./lrndesign-gallery-behaviors.js", "../../simple-tooltip/simple-tooltip.js", "../../../@polymer/iron-image/iron-image.js", "../../../@polymer/iron-icons/iron-icons.js", "./lrndesign-gallery-zoom.js", "./lrndesign-gallery-details.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _simpleTooltip, _ironImage, _ironIcons, _lrndesignGalleryZoom, _lrndesignGalleryDetails) {
  ...
  function _templateObject3_2995b9e0cd1f11eaaa022d9e3d9b9d51() {
    ...
    _templateObject3_2995b9e0cd1f11eaaa022d9e3d9b9d51 = function _templateObject3_2995b9e0cd1f11eaaa022d9e3d9b9d51() {
      return data;
    };
  ...
  function _templateObject2_2995b9e0cd1f11eaaa022d9e3d9b9d51() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <button\n                    id=\"", "\"\n                    aria-controls=\"carousel\"\n                    class=\"gallerythumb\"\n                    .index=\"", "\"\n                    @click=\"", "\"\n                    ?disabled=\"", "\"\n                    .style=\"--lrndesign-gallery-thumb-url:url(", ");background-size:", ";background-position:", "\"\n                  >\n                    <span class=\"sr-only\"\n                      >", "</span\n                    >\n                  </button>\n                  <simple-tooltip\n                    .for=\"", "\"\n                    ?hidden=\"", "\"\n                    position=\"top\"\n                  >\n                    ", "\n                  </simple-tooltip>\n                "]);

    _templateObject2_2995b9e0cd1f11eaaa022d9e3d9b9d51 = function _templateObject2_2995b9e0cd1f11eaaa022d9e3d9b9d51() {
      return data;
    };
  ...
  function _templateObject_2995b9e0cd1f11eaaa022d9e3d9b9d51() {
    ...
    _templateObject_2995b9e0cd1f11eaaa022d9e3d9b9d51 = function _templateObject_2995b9e0cd1f11eaaa022d9e3d9b9d51() {
      return data;
    };
  ...
  function (_LrndesignGalleryBeha) {
    ...
    babelHelpers.createClass(LrndesignGalleryCarousel, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_2995b9e0cd1f11eaaa022d9e3d9b9d51(), this.dark, this.extraWide, this.responsiveSize, this.hideNav, this.selected.xofy, this.selected.alt, this.selected.thumbnail, this.selected.sizing || this.sizing === "contain" || "cover", this.selected.src, this.selected.details, this.selected.heading, this.selected.large, this.selected.tooltip, this.selected.alt, this.hideNav, !this.selected || this.selected.prev < 0, function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_2995b9e0cd1f11eaaa022d9e3d9b9d51(), item.id, item.index, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryCarousel), "styles", this)), [(0, _litElement.css)(_templateObject3_2995b9e0cd1f11eaaa022d9e3d9b9d51())]);
      }
    }, {
      key: "properties",
      get: function get() {
