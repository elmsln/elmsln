define(["exports", "../../../lit-element/lit-element.js", "./lrndesign-gallery-behaviors.js", "../../../@polymer/iron-image/iron-image.js", "../../../@polymer/iron-icons/iron-icons.js", "./lrndesign-gallery-zoom.js"], function (_exports, _litElement, _lrndesignGalleryBehaviors, _ironImage, _ironIcons, _lrndesignGalleryZoom) {
  "use strict";
  ...
  function _templateObject3_3587ff10833211ea85a195fb4be801bd() {
    ...
    _templateObject3_3587ff10833211ea85a195fb4be801bd = function _templateObject3_3587ff10833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject2_3587ff10833211ea85a195fb4be801bd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                          <button\n                            id=\"", "\"\n                            aria-controls=\"carousel\"\n                            class=\"gallerythumb\"\n                            index=\"", "\"\n                            @click=\"", "\"\n                            ?disabled=\"", "\"\n                          >\n                            <iron-image\n                              alt=\"", "\"\n                              fade\n                              sizing=\"cover\"\n                              src=\"", "\"\n                            >\n                            </iron-image>\n                          </button>\n                          <simple-tooltip\n                            for=\"", "\"\n                            ?hidden=\"", "\"\n                            position=\"top\"\n                          >\n                            ", "\n                          </simple-tooltip>\n                        "]);

    _templateObject2_3587ff10833211ea85a195fb4be801bd = function _templateObject2_3587ff10833211ea85a195fb4be801bd() {
      return data;
    };
  ...
  function _templateObject_3587ff10833211ea85a195fb4be801bd() {
    ...
    _templateObject_3587ff10833211ea85a195fb4be801bd = function _templateObject_3587ff10833211ea85a195fb4be801bd() {
      return data;
    };
   ...
   *
   */
  var LrndesignGalleryCarousel =
  /*#__PURE__*/
  function (_LrndesignGalleryBeha) {
    babelHelpers.inherits(LrndesignGalleryCarousel, _LrndesignGalleryBeha);
    babelHelpers.createClass(LrndesignGalleryCarousel, [{
      key: "render",
      // render function
      value: function render() {
        var _this = this;

        return (0, _litElement.html)(_templateObject_3587ff10833211ea85a195fb4be801bd(), this.galleryTitle, this.galleryTitle, this.aspectRatio, this.dark, this.extraWide, this.imageStyle, this.responsiveSize, this.hideNav, this.selected.xofy, this.selected.alt, this.selected.id, this.selected.thumbnail, this.selected.sizing, this.selected.src, this.imageStyle, this.selected.details, this.selected.heading, this.selected.large, this.selected.tooltip, this.selected.alt, this.selected.tooltip, this.hideNav, !this.selected || this.selected.prev < 0, function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_3587ff10833211ea85a195fb4be801bd(), item.id, item.index, function (e) {
            return _this._itemChanged(item.id);
          }, _this.selected.id === item.id, item.alt, item.thumbnail, item.id, _this.selected.id === item.id, item.alt);
        }), this.galleryPrint);
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryCarousel), "styles", this)), [(0, _litElement.css)(_templateObject3_3587ff10833211ea85a195fb4be801bd())]);
      }
    }, {
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryCarousel), "properties", this));
      }
      /**
    ...
    function LrndesignGalleryCarousel() {
      babelHelpers.classCallCheck(this, LrndesignGalleryCarousel);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrndesignGalleryCarousel).call(this));
    ...
    return LrndesignGalleryCarousel;
