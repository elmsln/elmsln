define(["exports", "../../../@polymer/polymer/polymer-element.js", "./lrndesign-gallery-behaviors.js", "./lrndesign-gallery-details.js", "./lrndesign-gallery-zoom.js"], function (_exports, _polymerElement, _lrndesignGalleryBehaviors, _lrndesignGalleryDetails, _lrndesignGalleryZoom) {
  "use strict";
  ...
  function _templateObject_4ccb4960494a11eab3124f20b4f7a7f7() {
    ...
    _templateObject_4ccb4960494a11eab3124f20b4f7a7f7 = function _templateObject_4ccb4960494a11eab3124f20b4f7a7f7() {
      return data;
    };
  ...
  function (_LrndesignGalleryBeha) {
    ...
    function LrndesignGalleryCarousel() {
      ...
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrndesignGalleryCarousel).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(LrndesignGalleryCarousel, [{
      ...
      value: function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryCarousel.prototype), "ready", this).call(this);

        if (this.selected.scroll) {
          var target = this.shadowRoot.querySelector("#carouselitem");
      ...
      key: "_getImageStyle",
      value: function _getImageStyle(extraWide, responsiveSize) {
      ...
      key: "_getIndex",
      value: function _getIndex(index, step) {
        return index + step;
      }
      /**
      ...
      key: "_onPrev",
      value: function _onPrev(e) {
        this.goToItem(parseInt(this.shadowRoot.querySelector("#carouselprev").getAttribute("index")));
      }
      /**
      ...
      value: function _onNext(e) {
        this.goToItem(parseInt(this.shadowRoot.querySelector("#carouselnext").getAttribute("index")));
      }
      /**
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_4ccb4960494a11eab3124f20b4f7a7f7());
