 ...
 */var LrndesignGalleryCarousel=/*#__PURE__*/function(_LrndesignGalleryBeha){babelHelpers.inherits(LrndesignGalleryCarousel,_LrndesignGalleryBeha);function LrndesignGalleryCarousel(){babelHelpers.classCallCheck(this,LrndesignGalleryCarousel);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignGalleryCarousel).apply(this,arguments))}babelHelpers.createClass(LrndesignGalleryCarousel,[{key:"ready",/**
   * life cycle, element is ready
   */value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGalleryCarousel.prototype),"ready",this).call(this);if(this.selected.scroll){var target=this.shadowRoot.querySelector("#carouselitem");this._scrollIntoView([this._getParentOffset(target)]);if(!this.selected.zoomed)target.focus()}}/**
   * go to item by id, or index
   *
   * @param {o}
   */},{key:"goToItem",value:function goToItem(index){var root=this;if("number"===typeof index&&0<=index&&index<root.items.length){root.selected=root.items[index]}}/**
   ...
   */},{key:"_getImageStyle",value:function _getImageStyle(extraWide,responsiveSize){if(extraWide||"xs"===responsiveSize){return"padding-bottom: "+100/this.aspectRatio+"%;"}else{if("xl"===responsiveSize){return"width: "+400*this.aspectRatio+"px; height: 400px;"}else if("lg"===responsiveSize){return"width: "+300*this.aspectRatio+"px; height: 300px;"}else if("md"===responsiveSize){return"width: "+200*this.aspectRatio+"px; height: 200px;"}else{return"width: "+200*this.aspectRatio+"px; height: 200px;"}}}/**
   * returns index of the previous or next item
   *
   *
   */},{key:"_getIndex",value:function _getIndex(index,step){return index+step}/**
   * gets unique id for carousel and sets it as a target
   */},{key:"_hideNav",value:function _hideNav(items){return items!==void 0?2>items.length:!0}/**
   * when a prev is tapped, goes to the prev item
   */},{key:"_onPrev",value:function _onPrev(e){this.goToItem(parseInt(this.shadowRoot.querySelector("#carouselprev").getAttribute("index")))}/**
   * when a next is tapped, goes to the next item
   */},{key:"_onNext",value:function _onNext(e){this.goToItem(parseInt(this.shadowRoot.querySelector("#carouselnext").getAttribute("index")))}/**
   * when a thumbnail is tapped, goes to that item
   */},{key:"_onNavTapped",value:function _onNavTapped(e){this.goToItem(e.model.item.index)}/**
   * updates the item details
   */},{key:"_updateDetails",value:function _updateDetails(){this.shadowRoot.querySelector("#itembody").innerHTML=this.item.details}}],[{key:"tag",/**
   * Store the tag name to make it easier to obtain directly.
   */get:function get(){return"lrndesign-gallery-carousel"}//get gallery behaviors
},{key:"behaviors",get:function get(){return[_lrndesignGalleryBehaviors.LrndesignGalleryBehaviors]}// render function
},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_b79b3200696b11eabd167f7c8887b3bc())}// properties available to the custom element for data binding
},{key:"properties",get:function get(){return{/**
       * height css of iron image (sets aspect ratio in xs or extraWide)
       */__imageStyle:{type:String,computed:"_getImageStyle(extraWide,responsiveSize)"}}}}]);return LrndesignGalleryCarousel}(_lrndesignGalleryBehaviors.LrndesignGalleryBehaviors);_exports.LrndesignGalleryCarousel=LrndesignGalleryCarousel;window.customElements.define(LrndesignGalleryCarousel.tag,LrndesignGalleryCarousel)});