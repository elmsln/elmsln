...
this.shadowRoot.querySelector("#indicator").classList.remove("activated")}}}},{key:"connectedCallback",value:function connectedCallback(){var _this3=this;babelHelpers.get(babelHelpers.getPrototypeOf(SiteTopMenu.prototype),"connectedCallback",this).call(this);this.shadowRoot.querySelector("#menu").addEventListener("click",this.toggleOpen.bind(this));(0,_mobxModule.autorun)(function(reaction){_this3.manifest=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.manifest);_this3.__disposer.push(reaction)});(0,_mobxModule.autorun)(function(reaction){_this3.editMode=(0,_mobxModule.toJS)(_haxcmsSiteStore.store.editMode);_this3.__disposer.push(reaction)});// minor timing thing to ensure store has picked active
...
for(var i in this.__disposer){this.__disposer[i].dispose()}window.removeEventListener("resize",function(){_this4._activeIdChanged(_this4.activeId)},!0);babelHelpers.get(babelHelpers.getPrototypeOf(SiteTopMenu.prototype),"disconnectedCallback",this).call(this)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_8236f66079d011eab2fff3f0fe734e4a())}/**
   ...
   */},{key:"properties",get:function get(){return{/**
       ...
       */conditions:{type:Object,value:{parent:null}},mobileTitle:{type:String,value:"Navigation"},editMode:{type:Boolean,reflectToAttribute:!0}}}}]);return SiteTopMenu}(_polymerElement.PolymerElement);_exports.SiteTopMenu=SiteTopMenu;window.customElements.define(SiteTopMenu.tag,SiteTopMenu)});