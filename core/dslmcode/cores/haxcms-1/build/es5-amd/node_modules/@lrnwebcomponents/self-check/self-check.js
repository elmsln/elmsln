 ...
 * @element self-check
 * 
 */var SelfCheck=/*#__PURE__*/function(_SchemaBehaviors){babelHelpers.inherits(SelfCheck,_SchemaBehaviors);function SelfCheck(){var _this;babelHelpers.classCallCheck(this,SelfCheck);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SelfCheck).call(this));_this.correct=!1;_this.alt="";_this.image="";_this.question="";_this.title="Self-Check";new Promise(function(res,rej){return _require.default(["../user-action/user-action.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-card/paper-card.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/paper-icon-button/paper-icon-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/iron-icons/editor-icons.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../@polymer/iron-icons/iron-icons.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../simple-tooltip/simple-tooltip.js"],res,rej)});return _this}babelHelpers.createClass(SelfCheck,[{key:"render",value:function render(){return(0,_litElement.html)(_templateObject_1479f62072ac11eab01767e8389e9c27(),this.image,this.alt,this.title,this.correct,this.openAnswer,this.correct?"false":"true",this.link?(0,_litElement.html)(_templateObject2_1479f62072ac11eab01767e8389e9c27(),this.link):"",this.openAnswer)}},{key:"openAnswer",/**
   * Property for toggling "checkbtn".
   */value:function openAnswer(e){this.correct=!this.correct}}],[{key:"styles",get:function get(){return[].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SelfCheck),"styles",this)),[(0,_litElement.css)(_templateObject3_1479f62072ac11eab01767e8389e9c27())])}},{key:"tag",get:function get(){return"self-check"}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(SelfCheck),"properties",this),{/**
       * Title.
       */title:{type:String},/**
       * Question.
