define(["exports", "../../../lit-element/lit-element.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "../../../@polymer/iron-icons/communication-icons.js", "./elmsln-studio-link.js", "./elmsln-studio-button.js", "../../img-view-modal/img-view-modal.js"], function (_exports, _litElement, _elmslnStudioStyles, _elmslnStudioUtilities, _communicationIcons, _elmslnStudioLink, _elmslnStudioButton, _imgViewModal) {
  ...
  function _templateObject4_05b4f2c001c211eba2339b0c52070e79() {
    ...
    _templateObject4_05b4f2c001c211eba2339b0c52070e79 = function _templateObject4_05b4f2c001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject3_05b4f2c001c211eba2339b0c52070e79() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <nav-card-item\n                  accent-color=\"", "\"\n                  .avatar=\"", "\"\n                  icon=\"chevron-right\"\n                  initials=\"", "\"\n                >\n                  <elmsln-studio-link\n                    id=\"comment-", "\"\n                    aria-describedby=\"comment-", "-desc\"\n                    slot=\"label\"\n                    href=\"", "\"\n                  >\n                    ", "\n                  </elmsln-studio-link>\n                  <span id=\"comment-", "\" slot=\"description\">\n                    ", "\n                  </span>\n                </nav-card-item>\n              "]);

    _templateObject3_05b4f2c001c211eba2339b0c52070e79 = function _templateObject3_05b4f2c001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject2_05b4f2c001c211eba2339b0c52070e79() {
    ...
    _templateObject2_05b4f2c001c211eba2339b0c52070e79 = function _templateObject2_05b4f2c001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  function _templateObject_05b4f2c001c211eba2339b0c52070e79() {
    ...
    _templateObject_05b4f2c001c211eba2339b0c52070e79 = function _templateObject_05b4f2c001c211eba2339b0c52070e79() {
      return data;
    };
  ...
  var ElmslnStudioSubmissions = /*#__PURE__*/function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioSubmissions, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_05b4f2c001c211eba2339b0c52070e79(), this.projectOptions, this.projectFilter || "", function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_05b4f2c001c211eba2339b0c52070e79(), i, s.image || "", s.imageAlt || undefined, s.feature || _this2.list ? true : false, _this2._getAlign(s.imageGravity || undefined), _this2._getValign(s.imageGravity || undefined), s.imageGravity || undefined, _this2.getFigures(_this2.filteredSubmissions, "image", "imageAlt", "full", "imageLongdesc"), i, _this2.modalTitle, _this2.defaultModalToolbars, i, !s.image, s.id, [s.firstName, s.lastName].join(" "), s.id, _this2.list ? _this2.dateFormat(s.date) : _this2.dateFormat(s.date, "short"), s.id, s.assignment, s.id, s.project, !s.feature, s.feature, s.id, s.id, s.id, s.id, _this2.getActivityLink(s), !s.feedback || s.feedback.length < 1 ? "" : ": ".concat(s.feedback.length), s.id, s.id, s.id, s.id, _this2.getActivityLink(s, true));
        }), this.filteredComments.length > 0, this.filteredComments.map(function (f) {
          return (0, _litElement.html)(_templateObject3_05b4f2c001c211eba2339b0c52070e79(), _this2.accentColor(_this2.fullName(f)), f.avatar, _this2.fullName(f), f.id, f.id, _this2.getActivityLink(f), _this2.getActivityTitle(f), f.id, _this2.dateFormat(f.date));
        }));
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ElmslnStudioSubmissions), "styles", this)), [(0, _litElement.css)(_templateObject4_05b4f2c001c211eba2339b0c52070e79())]);
      }
    }, {
      key: "properties",
      get: function get() {
