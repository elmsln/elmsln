define(["exports", "../../../lit-element/lit-element.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "../../../@polymer/iron-icons/communication-icons.js", "./elmsln-studio-link.js", "./elmsln-studio-button.js"], function (_exports, _litElement, _elmslnStudioStyles, _elmslnStudioUtilities, _communicationIcons, _elmslnStudioLink, _elmslnStudioButton) {
  ...
  function _templateObject4_27a582a0cd1f11eaaa022d9e3d9b9d51() {
    ...
    _templateObject4_27a582a0cd1f11eaaa022d9e3d9b9d51 = function _templateObject4_27a582a0cd1f11eaaa022d9e3d9b9d51() {
      return data;
    };
  ...
  function _templateObject3_27a582a0cd1f11eaaa022d9e3d9b9d51() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <nav-card-item\n                  accent-color=\"", "\"\n                  .avatar=\"", "\"\n                  icon=\"chevron-right\"\n                  initials=\"", "\"\n                >\n                  <elmsln-studio-link\n                    id=\"comment-", "\"\n                    aria-describedby=\"comment-", "-desc\"\n                    slot=\"label\"\n                    href=\"", "\"\n                  >\n                    ", "\n                  </elmsln-studio-link>\n                  <span id=\"comment-", "\" slot=\"description\">\n                    ", "\n                  </span>\n                </nav-card-item>\n              "]);

    _templateObject3_27a582a0cd1f11eaaa022d9e3d9b9d51 = function _templateObject3_27a582a0cd1f11eaaa022d9e3d9b9d51() {
      return data;
    };
  ...
  function _templateObject2_27a582a0cd1f11eaaa022d9e3d9b9d51() {
    ...
    _templateObject2_27a582a0cd1f11eaaa022d9e3d9b9d51 = function _templateObject2_27a582a0cd1f11eaaa022d9e3d9b9d51() {
      return data;
    };
  ...
  function _templateObject_27a582a0cd1f11eaaa022d9e3d9b9d51() {
    ...
    _templateObject_27a582a0cd1f11eaaa022d9e3d9b9d51 = function _templateObject_27a582a0cd1f11eaaa022d9e3d9b9d51() {
      return data;
    };
  ...
  function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioSubmissions, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_27a582a0cd1f11eaaa022d9e3d9b9d51(), this.projectOptions, this.projectFilter || "", function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_27a582a0cd1f11eaaa022d9e3d9b9d51(), s.image && s.image.src ? s.image.src : "", s.feature || !_this2.grid ? true : false, _this2._getAlign(s.image && s.image.gravity ? s.image.gravity : undefined), _this2._getValign(s.image && s.image.gravity ? s.image.gravity : undefined), s.image && s.image.gravity ? s.image.gravity : undefined, s.id, s.firstName, s.lastName, s.id, _this2.grid ? _this2.dateFormat(s.date, "short") : _this2.dateFormat(s.date), s.id, s.assignment, s.id, s.project, !s.feature, s.feature, s.id, s.id, s.id, s.id, s.link, s.id, s.id, s.id, s.id, s.link);
        }), this.filteredComments.length > 0, this.filteredComments.map(function (f) {
          return (0, _litElement.html)(_templateObject3_27a582a0cd1f11eaaa022d9e3d9b9d51(), _this2.accentColor(_this2.fullName(f)), f.avatar, _this2.fullName(f), f.id, f.id, f.link, f.title, f.id, _this2.dateFormat(f.date));
        }));
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ElmslnStudioSubmissions), "styles", this)), [(0, _litElement.css)(_templateObject4_27a582a0cd1f11eaaa022d9e3d9b9d51())]);
      }
    }, {
      key: "properties",
      get: function get() {
