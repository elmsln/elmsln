define(["exports", "../../../lit-element/lit-element.js", "./elmsln-studio-styles.js", "./elmsln-studio-utilities.js", "../../../@polymer/iron-icons/communication-icons.js", "./elmsln-studio-link.js", "./elmsln-studio-button.js", "./elmsln-studio-zoom.js"], function (_exports, _litElement, _elmslnStudioStyles, _elmslnStudioUtilities, _communicationIcons, _elmslnStudioLink, _elmslnStudioButton, _elmslnStudioZoom) {
  ...
  function _templateObject4_8b0cdeb0e0cf11eab599756c9ebe7c2f() {
    ...
    _templateObject4_8b0cdeb0e0cf11eab599756c9ebe7c2f = function _templateObject4_8b0cdeb0e0cf11eab599756c9ebe7c2f() {
      return data;
    };
  ...
  function _templateObject3_8b0cdeb0e0cf11eab599756c9ebe7c2f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <nav-card-item\n                  accent-color=\"", "\"\n                  .avatar=\"", "\"\n                  icon=\"chevron-right\"\n                  initials=\"", "\"\n                >\n                  <elmsln-studio-link\n                    id=\"comment-", "\"\n                    aria-describedby=\"comment-", "-desc\"\n                    slot=\"label\"\n                    href=\"", "\"\n                  >\n                    ", "\n                  </elmsln-studio-link>\n                  <span id=\"comment-", "\" slot=\"description\">\n                    ", "\n                  </span>\n                </nav-card-item>\n              "]);

    _templateObject3_8b0cdeb0e0cf11eab599756c9ebe7c2f = function _templateObject3_8b0cdeb0e0cf11eab599756c9ebe7c2f() {
      return data;
    };
  ...
  function _templateObject2_8b0cdeb0e0cf11eab599756c9ebe7c2f() {
    ...
    _templateObject2_8b0cdeb0e0cf11eab599756c9ebe7c2f = function _templateObject2_8b0cdeb0e0cf11eab599756c9ebe7c2f() {
      return data;
    };
  ...
  function _templateObject_8b0cdeb0e0cf11eab599756c9ebe7c2f() {
    ...
    _templateObject_8b0cdeb0e0cf11eab599756c9ebe7c2f = function _templateObject_8b0cdeb0e0cf11eab599756c9ebe7c2f() {
      return data;
    };
  ...
  function (_ElmslnStudioUtilitie) {
    ...
    babelHelpers.createClass(ElmslnStudioSubmissions, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_8b0cdeb0e0cf11eab599756c9ebe7c2f(), this.projectOptions, this.projectFilter || "", function (e) {
          ...
          return (0, _litElement.html)(_templateObject2_8b0cdeb0e0cf11eab599756c9ebe7c2f(), s.image || "", s.imageAlt || undefined, s.feature || _this2.list ? true : false, _this2._getAlign(s.imageGravity || undefined), _this2._getValign(s.imageGravity || undefined), s.imageGravity || undefined, i, s.image, i + 1 < _this2.filteredSubmissions.length ? i + 1 : -1, i > 0 ? i - 1 : -1, s.id, [s.firstName, s.lastName].join(" "), s.id, _this2.list ? _this2.dateFormat(s.date) : _this2.dateFormat(s.date, "short"), s.id, s.assignment, s.id, s.project, !s.feature, s.feature, s.id, s.id, s.id, s.id, _this2.getActivityLink(s), !s.feedback || s.feedback.length < 1 ? "" : ": ".concat(s.feedback.length), s.id, s.id, s.id, s.id, _this2.getActivityLink(s, true));
        }), this.filteredComments.length > 0, this.filteredComments.map(function (f) {
          return (0, _litElement.html)(_templateObject3_8b0cdeb0e0cf11eab599756c9ebe7c2f(), _this2.accentColor(_this2.fullName(f)), f.avatar, _this2.fullName(f), f.id, f.id, _this2.getActivityLink(f), _this2.getActivityTitle(f), f.id, _this2.dateFormat(f.date));
        }));
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ElmslnStudioSubmissions), "styles", this)), [(0, _litElement.css)(_templateObject4_8b0cdeb0e0cf11eab599756c9ebe7c2f())]);
      }
    }, {
      key: "properties",
      get: function get() {
