...
parent=null!==range&&range.commonAncestorContainer?range.commonAncestorContainer.parentNode:null;this.$.button.value="formatBlock"===this.command&&selectors&&parent&&null!==parent.closest(selectors)?parent.closest(selectors).tagName.toLowerCase():null;return!1}/**
   ...
   * Picker change
   */},{key:"_pickerChange",value:function _pickerChange(e){var val=this.$.button.value;e.preventDefault();if(null!==val&&this.range!==void 0&&null!==this.range){this.commandVal=this.$.button.value;this.doTextOperation();if(!0!==this.block){this.$.button.value=null;this.dispatchEvent(new CustomEvent("deselect",{detail:this}))}}}/**
