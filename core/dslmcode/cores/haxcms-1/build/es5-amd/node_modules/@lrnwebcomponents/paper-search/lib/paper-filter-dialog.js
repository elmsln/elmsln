define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/legacy/polymer.dom.js"], function (_exports, _polymerElement, _polymerDom) {
  "use strict";
  ...
  function (_PolymerElement) {
    ...
    function PaperFilterDialog() {
      ...
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(PaperFilterDialog).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(PaperFilterDialog, [{
      ...
      value: function open() {
        ...
        setTimeout(function () {
          this.$.dialog.open(); // Clone selected filters, so it can be changed without touching the external property
