 ...
 */var A11yCollapseIconButton=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(A11yCollapseIconButton,_PolymerElement);function A11yCollapseIconButton(){babelHelpers.classCallCheck(this,A11yCollapseIconButton);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(A11yCollapseIconButton).apply(this,arguments))}babelHelpers.createClass(A11yCollapseIconButton,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(A11yCollapseIconButton.prototype),"connectedCallback",this).call(this);(0,_renderStatus.afterNextRender)(this,function(){this.$.expand.addEventListener("click",this._onTap.bind(this))})}},{key:"disconnectedCallback",value:function disconnectedCallback(){this.$.expand.removeEventListener("click",this._onTap.bind(this));babelHelpers.get(babelHelpers.getPrototypeOf(A11yCollapseIconButton.prototype),"disconnectedCallback",this).call(this)}/**
   * Handle tap
   */},{key:"_onTap",value:function _onTap(e){if(!this.disabled){this.dispatchEvent(new CustomEvent("a11y-collapse-tap",{bubbles:!0,composed:!0,cancelable:!0,detail:this}))}}}],[{key:"tag",get:function get(){return"a11y-collapse-icon-button"}},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_e32ee6e0a4d211e9a986a5b37737d2f0())}},{key:"properties",get:function get(){return{/**
       * is disabled?
       ...
       */rotated:{type:Boolean,value:!1}}}}]);return A11yCollapseIconButton}(_polymerElement.PolymerElement);_exports.A11yCollapseIconButton=A11yCollapseIconButton;window.customElements.define(A11yCollapseIconButton.tag,A11yCollapseIconButton)});