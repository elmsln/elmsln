...
*/var LrnIcon=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(LrnIcon,_PolymerElement);function LrnIcon(){babelHelpers.classCallCheck(this,LrnIcon);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrnIcon).apply(this,arguments))}babelHelpers.createClass(LrnIcon,[{key:"_iconChanged",value:function _iconChanged(icon){this._iconName=icon;this._iconsetName="lrn";this._updateIcon()}},{key:"_srcChanged",value:function _srcChanged(src){this._updateIcon()}},{key:"_usesIconset",value:function _usesIconset(){return this.icon||!this.src}/** @suppress {visibility} */},{key:"_updateIcon",value:function _updateIcon(){if(this._usesIconset()){if(this._img&&this._img.parentNode){this.root.removeChild(this._img)}if(""===this._iconName){if(this._iconset){this._iconset.removeIcon(this)}}else if(this._iconsetName&&this._meta){this._iconset=this._meta.byKey(this._iconsetName);if(this._iconset){this._iconset.applyIcon(this,this._iconName,this.theme);window.removeEventListener("lrn-iconset-added",this._updateIcon.bind(this))}else{window.addEventListener("lrn-iconset-added",this._updateIcon.bind(this))}}}else{if(this._iconset){this._iconset.removeIcon(this)}if(!this._img){this._img=document.createElement("img");this._img.style.width="100%";this._img.style.height="100%";this._img.draggable=!1}this._img.src=this.src;this.root.appendChild(this._img)}}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_87a9f44075c911eab6bfd9e4068a045e())}},{key:"tag",get:function get(){return"lrn-icon"}},{key:"properties",get:function get(){return{/**
