define(["exports", "meta", "../../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _esGlobalBridge) {
  ...
  var SimpleLoginCamera = /*#__PURE__*/function (_HTMLElement) {
    ...
    function SimpleLoginCamera() {
      ...
      window.dispatchEvent(new CustomEvent("i18n-manager-register-element", {
        detail: {
          ...
          localesPath: _this.pathFromUrl(decodeURIComponent(meta.url)) + "../locales",
    ...
    babelHelpers.createClass(SimpleLoginCamera, [{
      ...
      key: "_applyMSR",
      value: function () {
        var _applyMSR2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
          var _this3 = this;
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  window.addEventListener("site-listing-video-activate", /*#__PURE__*/babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
