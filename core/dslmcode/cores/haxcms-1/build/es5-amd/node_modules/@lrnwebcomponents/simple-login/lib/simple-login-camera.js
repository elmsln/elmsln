define(["exports", "meta", "../../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _esGlobalBridge) {
  ...
  var SimpleLoginCamera = /*#__PURE__*/function (_HTMLElement) {
    ...
    babelHelpers.createClass(SimpleLoginCamera, [{
      ...
      key: "_applyMSR",
      value: function () {
        var _applyMSR2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      ...
      value: function connectedCallback() {
        if (window.ESGlobalBridge && window.ESGlobalBridge.imports["msr"] === true) {
          this._applyMSR();
        }
