define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../../@polymer/polymer/lib/elements/dom-if.js", "../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../../@polymer/app-localize-behavior/app-localize-behavior.js", "../../../@polymer/polymer/lib/legacy/class.js", "../../../@polymer/iron-flex-layout/iron-flex-layout-classes.js", "./eco-json-schema-array.js", "./eco-json-schema-tabs.js", "./eco-json-schema-boolean.js", "./eco-json-schema-enum.js", "./eco-json-schema-file.js", "./eco-json-schema-input.js"], function (_exports, _polymerElement, _polymerDom, _domIf, _flattenedNodesObserver, _appLocalizeBehavior, _class, _ironFlexLayoutClasses, _ecoJsonSchemaArray, _ecoJsonSchemaTabs, _ecoJsonSchemaBoolean, _ecoJsonSchemaEnum, _ecoJsonSchemaFile, _ecoJsonSchemaInput) {
  ...
  function _templateObject_5bcee7c0add011e983121daa910d1ce6() {
    ...
    _templateObject_5bcee7c0add011e983121daa910d1ce6 = function _templateObject_5bcee7c0add011e983121daa910d1ce6() {
      return data;
    };
  ...
  */
  ...
  function (_mixinBehaviors) {
    ...
    function EcoJsonSchemaObject() {
      ...
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(EcoJsonSchemaObject).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(EcoJsonSchemaObject, [{
      ...
      value: function _buildSchemaProperties() {
        ...
        this._schemaProperties = Object.keys(this.schema.properties || []).map(function (key) {
          ...
          var property = (_property = {
            ...
            schema: schema
          }, babelHelpers.defineProperty(_property, "label", schema.title || key), babelHelpers.defineProperty(_property, "description", schema.description), babelHelpers.defineProperty(_property, "component", schema.component || {}), _property);
      ...
      value: function _setValue() {
        ...
        this._schemaProperties.forEach(function (property) {
          if (babelHelpers.typeof(property.value) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
            value[property.property] = _this._deepClone(property.value);
          }
        });
      ...
      value: function _buildForm() {
        ...
        this._schemaProperties.forEach(function (property) {
          if (property.component.name === "code-editor") {
            ...
            property.schema.component.properties.theme = _this2.codeTheme;
          }

          var el = _this2.create(property.component.name, {
          ...
          _this2.listen(el, property.component.valueProperty.replace(/([A-Z])/g, "-$1").toLowerCase() + "-changed", "_schemaPropertyChanged");

          if (babelHelpers.typeof(_this2.$) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
            (0, _polymerDom.dom)(_this2).appendChild(el);
            ...
            if (property.description) {
              ...
              (0, _polymerDom.dom)(_this2).appendChild(tip);
            }
          ...
          if (property.component.slot != "") {
            ...
            while ((0, _polymerDom.dom)(cloneDiv).firstChild !== null) {
              (0, _polymerDom.dom)(el).appendChild((0, _polymerDom.dom)(cloneDiv).firstChild);
            }
          }

          _this2.dispatchEvent(new CustomEvent("form-changed", {
            bubbles: true,
            cancelable: true,
            composed: true,
            detail: _this2
      ...
      value: function _errorChanged() {
        ...
        (0, _polymerDom.dom)(this).childNodes.forEach(function (el) {
          ...
          if (_this3.error && _this3.error[name]) {
            el.error = _this3.error[name];
          } else {
            el.error = null;
          }
        });
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_5bcee7c0add011e983121daa910d1ce6());
      }
    }, {
      key: "properties",
      get: function get() {
