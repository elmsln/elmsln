...
*/var EcoJsonSchemaObject=/*#__PURE__*/function(_mixinBehaviors){babelHelpers.inherits(EcoJsonSchemaObject,_mixinBehaviors);function EcoJsonSchemaObject(){babelHelpers.classCallCheck(this,EcoJsonSchemaObject);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(EcoJsonSchemaObject).apply(this,arguments))}babelHelpers.createClass(EcoJsonSchemaObject,[{key:"disconnectedCallback",value:function disconnectedCallback(){this._clearForm();babelHelpers.get(babelHelpers.getPrototypeOf(EcoJsonSchemaObject.prototype),"disconnectedCallback",this).call(this)}/**
   * returns an array of properties for a given schema object
   * @param {object} thisSchema the source schema
   * @returns {array} an array
   */},{key:"_buildSchemaProperties",value:function _buildSchemaProperties(){var _this=this,thisSchema=0<arguments.length&&arguments[0]!==void 0?arguments[0]:this.schema,ctx=this;return Object.keys(thisSchema.properties||[]).map(function(key){var schema=thisSchema.properties[key],property={name:key,schema:schema,label:schema.title||key,description:schema.description,component:schema.component||{}};if(!property.component.valueProperty){property.component.valueProperty="value"}if(!property.component.slot){property.component.slot=""}if(ctx._isSchemaEnum(schema)){property.component.name=property.component.name||"eco-json-schema-enum";if(babelHelpers.typeof(schema.value)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){schema.value=""}property.value=schema.value}else if(ctx._isSchemaBoolean(schema.type)){property.component.name=property.component.name||"eco-json-schema-boolean";if(babelHelpers.typeof(schema.value)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){schema.value=!1}property.value=schema.value}else if(ctx._isSchemaFile(schema.type)){property.component.name=property.component.name||"eco-json-schema-file";if(babelHelpers.typeof(schema.value)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){schema.value={}}property.value=schema.value}else if(ctx._isSchemaValue(schema.type)){property.component.name=property.component.name||"eco-json-schema-input";if(babelHelpers.typeof(schema.value)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){schema.value=""}property.value=schema.value}else if(ctx._isSchemaObject(schema.type)){property.component.name=property.component.name||"eco-json-schema-object";if(babelHelpers.typeof(schema.value)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){schema.value={}}property.value=schema.value}else if(ctx._isSchemaArray(schema.type)){property.component.name=property.component.name||"eco-json-schema-array";_this._buildNestedSchemaProperties(property,schema)}else if(ctx._isSchemaFieldset(schema.type)){property.component.name=property.component.name||"eco-json-schema-fieldset";_this._buildNestedSchemaProperties(property,schema)}else if(ctx._isSchemaTabs(schema.type)){property.component.name=property.component.name||"eco-json-schema-tabs";_this._buildNestedSchemaProperties(property,schema)}else if(ctx._isSchemaMarkup(schema.type)){property.component.name=property.component.name||"eco-json-schema-markup";if(babelHelpers.typeof(schema.value)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){schema.value=""}property.value=schema.value}else{return console.error("Unknown property type %s",schema.type)}return property})}/**
   ...
   */},{key:"_buildNestedSchemaProperties",value:function _buildNestedSchemaProperties(property,schema){if(babelHelpers.typeof(schema.value)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0)))schema.value="array"!==schema.type?{}:[];property.value=schema.value;for(var key in schema.items.properties){schema.items.properties[key].value=schema.value[key]}property.schema.properties=this._buildSchemaProperties(schema.items,property.property+".")}/**
   * updates the value when a schema property (or subproperty) changes
   * @param {event} event the
   * @param {object} detail the event details
   */},{key:"_schemaPropertyChanged",value:function _schemaPropertyChanged(event,detail){if(detail){if(detail.path&&/\.length$/.test(detail.path)){return}var ctx=this,property=event.target.schemaProperty,path=["value"].concat("".concat(event.target.propertyPrefix).concat(event.target.propertyName).split(".")),prop=property.property||event.target.propertyName,val=detail&&detail.value?this._deepClone(detail.value):null;if(detail.path&&/\.splices$/.test(detail.path)){var parts=detail.path.split(".").slice(1,-1);while(parts.length){path.push(parts.shift());if(property.keyMap&&property.keyMap[path.join(".")]){path=property.keyMap[path.join(".")].split(".")}}if(detail.value.keySplices){if(property.keyMap){detail.value.keySplices.forEach(function(splice){splice.removed.forEach(function(k){delete property.keyMap[path.concat([k]).join(".")]})})}}if(detail.value){detail.value.indexSplices.forEach(function(splice){var args=[path.join("."),splice.index,splice.removed.length];if(splice.addedCount){for(var i=0,ii=splice.addedCount;i<ii;i++){if(splice.addedKeys&&splice.addedKeys[i]){property.keyMap=property.keyMap||{};property.keyMap[path.concat([splice.addedKeys[i]]).join(".")]=path.concat([i+splice.index]).join(".")}args.push(ctx._deepClone(splice.object[i+splice.index]))}}ctx.splice.apply(ctx,args)})}}else if(detail.path){var parts=detail.path.split(".").slice(1),v=this.value;if(!v.hasOwnProperty(property.property)){this.set("value."+property.property,{});this.notifyPath("value."+property.property)}while(parts.length){var k=parts.shift();path.push(k);if(property.keyMap&&property.keyMap[path.join(".")]){path=property.keyMap[path.join(".")].split(".")}}this.set(path.join("."),this._deepClone(detail.value));this.notifyPath(path.join("."))}else{//most of our fields will just set the value this way
this.set(path.join("."),this._deepClone(detail.value));this.notifyPath("value")}//fire an event to let array listeners handle changed fields
event.target.dispatchEvent(new CustomEvent("form-field-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:event.target}));this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:this}))}}/**
   ...
   */},{key:"_setValue",value:function _setValue(){var _this2=this,props=0<arguments.length&&arguments[0]!==void 0?arguments[0]:this._schemaProperties,path=1<arguments.length&&arguments[1]!==void 0?arguments[1]:"",setter=path.replace(/\[(\d+)\]/g,".$1");if(""!=setter)setter=".".concat(setter);if(0<props.length){props.forEach(function(property){if(babelHelpers.typeof(property.value)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){_this2.set("value".concat(setter,".").concat(property.property),_this2._deepClone(property.value),JSON.stringify(property.value))}});this.notifyPath("value.*")}}/**
   ...
   */},{key:"_buildForm",value:function _buildForm(){var _this3=this,props=0<arguments.length&&arguments[0]!==void 0?arguments[0]:this._schemaProperties,container=1<arguments.length&&arguments[1]!==void 0?arguments[1]:this,prefix=2<arguments.length&&arguments[2]!==void 0?arguments[2]:"",autofocus=this.autofocus;props.forEach(function(property){if("code-editor"===property.component.name){// special case, can't come up with a better way to do this but monoco is very special case
property.schema.component.properties.editorValue=property.schema.value;property.schema.component.properties.theme=_this3.codeTheme}var propertyPrefix=""!==prefix?"".concat(prefix,"."):"",propertyName=property.property||property.name,el=_this3.create(property.component.name,{label:property.label,schema:property.schema,schemaProperty:property,propertyPrefix:propertyPrefix,propertyName:propertyName,language:_this3.language,resources:_this3.resources});if("paper-input"===property.component.name){el.style["background-color"]="transparent";el.style.width="100%"}el.setAttribute("name","".concat(propertyPrefix).concat(propertyName));if(property.schema.hidden&&property.schema.hidden!==void 0){el.setAttribute("hidden",property.schema.hidden)}//allows the first form fields to be focused on autopmatically
...
for(var prop in property.component.properties){el[prop]=property.component.properties[prop]}_this3.listen(el,property.component.valueProperty.replace(/([A-Z])/g,"-$1").toLowerCase()+"-changed","_schemaPropertyChanged");_this3.listen(el,"build-fieldset","_onBuildFieldset");if(babelHelpers.typeof(_this3.$)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){container.appendChild(el);if(property.description){var id="tip-"+property.property,tip=document.createElement("div");el.setAttribute("aria-describedby",id);el.setAttribute("class","has-tooltip-desc");tip.setAttribute("id",id);tip.setAttribute("class","tooltip-desc desc-for-"+property.component.name);if(!0===property.schema.hidden)tip.setAttribute("hidden","hidden");tip.setAttribute("role","tooltip");tip.innerHTML=property.description;container.appendChild(tip)}}// support for slot injection too!
if(""!=property.component.slot){var temp=document.createElement("div");temp.innerHTML=property.component.slot;var cloneDiv=temp.cloneNode(!0);while(null!==cloneDiv.firstChild){el.appendChild(cloneDiv.firstChild)}}_this3.dispatchEvent(new CustomEvent("form-changed",{bubbles:!0,cancelable:!0,composed:!0,detail:_this3}))})}/**
   ...
   * @param {object} detail the details of the event, as in:```
{
  ...
  ```
   */},{key:"_onBuildFieldset",value:function _onBuildFieldset(event,detail){if(babelHelpers.typeof(this.get("value.".concat(detail.prefix)))===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0)))this.set("value.".concat(detail.path),this._deepClone(detail.value));this._clearForm(detail.container);this._buildForm(detail.properties,detail.container,detail.prefix)}/**
   * removes a field element
   * @param {object} el the element to remove
   * @param {*} parent the container where the field element exists
   */},{key:"_removePropertyEl",value:function _removePropertyEl(el){var parent=1<arguments.length&&arguments[1]!==void 0?arguments[1]:this;if(babelHelpers.typeof(el.schemaProperty)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.unlisten(el,el.schemaProperty.component.valueProperty.replace(/([A-Z])/g,"-$1").toLowerCase()+"-changed","_schemaPropertyChanged")}el.schemaProperty=null;parent.removeChild(el)}/**
   * clears a form or a fieldset container within a form
   * @param {object} el the element to remove
   * @param {*} parent the container where the field element exists
   */},{key:"_clearForm",value:function _clearForm(){var container=0<arguments.length&&arguments[0]!==void 0?arguments[0]:this;if(babelHelpers.typeof(this.$)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){var formEl=container;while(formEl.firstChild){this._removePropertyEl(formEl.firstChild,container)}}}/**
   ...
   */},{key:"_schemaChanged",value:function _schemaChanged(newValue,oldValue){if(newValue&&newValue!==oldValue){this._clearForm();this._schemaProperties=this._buildSchemaProperties();this._buildForm();this._setValue()}}/**
   * handles errors
   * @todo how do we want to handle errors for nested fields?
   */},{key:"_errorChanged",value:function _errorChanged(){var _this4=this;/*
    console.log(
      "_errorChanged",
      this,
      this.querySelectorAll("[name]"),
      this.error
    );*/this.childNodes.forEach(function(el){var name=el.getAttribute("name");if(_this4.error&&_this4.error[name]){el.error=_this4.error[name]}else{el.error=null}})}/**
   * clones an object and all its subproperties
   * @param {object} o the object to clone
   * @returns {object} the cloned object
   */},{key:"_deepClone",value:function _deepClone(o){return JSON.parse(JSON.stringify(o))}},{key:"_isSchemaValue",value:function _isSchemaValue(type){return this._isSchemaBoolean(type)||this._isSchemaNumber(type)||this._isSchemaString(type)||this._isSchemaFile(type)}},{key:"_isSchemaFile",value:function _isSchemaFile(type){if(Array.isArray(type)){return-1!==type.indexOf("file")}else{return"file"===type}}},{key:"_isSchemaBoolean",value:function _isSchemaBoolean(type){if(Array.isArray(type)){return-1!==type.indexOf("boolean")}else{return"boolean"===type}}},{key:"_isSchemaEnum",value:function _isSchemaEnum(schema){return!!schema.enum}},{key:"_isSchemaNumber",value:function _isSchemaNumber(type){if(Array.isArray(type)){return-1!==type.indexOf("number")||-1!==type.indexOf("integer")}else{return"number"===type||"integer"===type}}},{key:"_isSchemaString",value:function _isSchemaString(type){if(Array.isArray(type)){return-1!==type.indexOf("string")}else{return"string"===type}}},{key:"_isSchemaObject",value:function _isSchemaObject(type){return"object"===type}},{key:"_isSchemaArray",value:function _isSchemaArray(type){return"array"===type}},{key:"_isSchemaFieldset",value:function _isSchemaFieldset(type){return"fieldset"===type}},{key:"_isSchemaTabs",value:function _isSchemaTabs(type){return"tabs"===type}},{key:"_isSchemaMarkup",value:function _isSchemaMarkup(type){return"markup"===type}},{key:"focus",value:function focus(){//console.log(this);
}}],[{key:"tag",get:function get(){return"eco-json-schema-object"}},{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_79c1a7b07ae711ea9f6d454984daed83())}},{key:"properties",get:function get(){return{language:{value:"en"},resources:{value:function value(){return{}}},schema:{type:Object,notify:!0,observer:"_schemaChanged"},label:{type:String},value:{type:Object,notify:!0,value:function value(){return{}}},error:{type:Object,observer:"_errorChanged"},wizard:{type:Boolean,notify:!0},/**
       ...
       */autofocus:{type:Boolean,value:!1}}}}]);return EcoJsonSchemaObject}((0,_class.mixinBehaviors)([_appLocalizeBehavior.AppLocalizeBehavior],_polymerElement.PolymerElement));_exports.EcoJsonSchemaObject=EcoJsonSchemaObject;window.customElements.define(EcoJsonSchemaObject.tag,EcoJsonSchemaObject)});