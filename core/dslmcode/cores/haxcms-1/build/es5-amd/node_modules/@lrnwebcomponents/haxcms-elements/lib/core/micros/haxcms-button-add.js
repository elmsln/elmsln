define(["exports", "../haxcms-site-store.js", "../../../../hax-body/lib/hax-store.js", "../utils/HAXCMSButton.js", "../../../../../mobx/dist/mobx.esm.js"], function (_exports, _haxcmsSiteStore, _haxStore, _HAXCMSButton2, _mobxEsm) {
  "use strict";
  ...
  var HAXCMSButtonAdd = /*#__PURE__*/function (_HAXCMSButton) {
    babelHelpers.inherits(HAXCMSButtonAdd, _HAXCMSButton);
    ...
    function HAXCMSButtonAdd() {
      ...
      _this.t.newPage = "New page";
      _this.t.copy = "Copy";
      _this.t.newChildPage = "New child page";
      _this.t.duplicatePage = "Duplicate page";
    ...
    babelHelpers.createClass(HAXCMSButtonAdd, [{
      ...
      value: function HAXCMSButtonClick(e) {
