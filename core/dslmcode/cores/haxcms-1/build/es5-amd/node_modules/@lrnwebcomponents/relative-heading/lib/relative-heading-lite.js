define(["exports", "../../../lit/index.js", "./relative-heading-state-manager.js"], function (_exports, _index, _relativeHeadingStateManager) {
  "use strict";
  ...
  var _templateObject_bea23810012611ec9676957c409166bc, _templateObject2_bea23810012611ec9676957c409166bc;
   ...
   */
  var RelativeHeadingLite = /*#__PURE__*/function (_LitElement) {
    babelHelpers.inherits(RelativeHeadingLite, _LitElement);

    var _super = _createSuper(RelativeHeadingLite);
    ...
    babelHelpers.createClass(RelativeHeadingLite, [{
      ...
      key: "template",
      get: function get() {
        return (0, _index.html)(_templateObject_bea23810012611ec9676957c409166bc || (_templateObject_bea23810012611ec9676957c409166bc = babelHelpers.taggedTemplateLiteral([" <slot></slot> "])));
      }
    }, {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "defaultLevel") {
            if (!_this3.defaultLevel || _this3.defaultLevel < 1 || _this3.defaultLevel > 6) _this3.defaultLevel = Math.min(0, Math.max(_this3.defaultLevel, 6));

            _this3.manager.updateDefaultLevel(_this3, oldValue);
          }

          if (propName === "id") {
            if (!_this3.id) _this3.checkId();

            _this3.manager.updateId(_this3, oldValue);
          }

          if (propName === "parent") _this3.manager.updateParent(_this3, oldValue);
      ...
      get: //styles function
      function get() {
        return [(0, _index.css)(_templateObject2_bea23810012611ec9676957c409166bc || (_templateObject2_bea23810012611ec9676957c409166bc = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
        return _objectSpread(_objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(RelativeHeadingLite), "properties", this)), {}, {
          /**
