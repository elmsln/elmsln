define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../materializecss-styles/lib/colors.js", "../../@polymer/paper-button/paper-button.js", "../../@polymer/iron-icon/iron-icon.js"], function (_exports, _require, _polymerElement, _renderStatus, _colors, _paperButton, _ironIcon) {
  "use strict";
  ...
  function _templateObject_bbc8c4d0b46e11e9978b67ee5ebb8bc8() {
    ...
    _templateObject_bbc8c4d0b46e11e9978b67ee5ebb8bc8 = function _templateObject_bbc8c4d0b46e11e9978b67ee5ebb8bc8() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(LrnsysButton, _PolymerElement);
    ...
    babelHelpers.createClass(LrnsysButton, [{
      key: "_applyPrefetch",
      value: function _applyPrefetch(newValue) {
        if (newValue && this.__ready && !this.__prefetchLink) {
          var link = document.createElement("link");
          link.setAttribute("rel", "prefetch");
          link.setAttribute("href", this.href); // store for disconnect so we can clean up if needed
      ...
      value: function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysButton.prototype), "ready", this).call(this);
        (0, _renderStatus.afterNextRender)(this, function () {
          ...
          this.$.button.addEventListener("focused-changed", this.focusToggle.bind(this));
        });
      }
    }, {
      key: "connectedCallback",
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysButton.prototype), "connectedCallback", this).call(this);
        this.__ready = true;
        (0, _renderStatus.afterNextRender)(this, function () {
          var _this2 = this;
          ...
          if (this.prefetch) {
            setTimeout(function () {
              _this2._applyPrefetch(_this2.prefetch);
            }, 1000);
          }
        });
      }
      ...
      value: function disconnectedCallback() {
        ...
        this.$.button.removeEventListener("focused-changed", this.focusToggle.bind(this));
        babelHelpers.get(babelHelpers.getPrototypeOf(LrnsysButton.prototype), "disconnectedCallback", this).call(this);
      }
      /**
      ...
      key: "_getShowHref",
      value: function _getShowHref(href, disabled) {
        if (href && !disabled) {
          return href;
        }
      }
      ...
      value: function tapEventOn(e) {
        ...
        if (babelHelpers.typeof(this.hoverClass) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !this.disabled) {
          ...
          classes.forEach(function (item, index) {
            if (item != "") {
              _this3.$.button.classList.add(item);

              if (item.indexOf("-") != -1) {
                _this3.$.icon.classList.add(item);
              }
            }
          });
        }
      ...
      value: function tapEventOff(e) {
        ...
        if (babelHelpers.typeof(this.hoverClass) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !this.disabled) {
          ...
          classes.forEach(function (item, index) {
            if (item != "") {
              _this4.$.button.classList.remove(item);

              if (item.indexOf("-") != -1) {
                _this4.$.icon.classList.remove(item);
              }
            }
          });
        }
          ...
          classes.forEach(function (item, index) {
            if (item != "") {
              if (!_this5.focusState) {
                _this5.$.button.classList.add(item);

                if (item.indexOf("-") != -1) {
                  _this5.$.icon.classList.add(item);
                }
              } else {
                _this5.$.button.classList.remove(item);

                if (item.indexOf("-") != -1) {
                  _this5.$.icon.classList.remove(item);
                }
              }
            }
          });
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_bbc8c4d0b46e11e9978b67ee5ebb8bc8());
      }
    }, {
      key: "tag",
      get: function get() {
