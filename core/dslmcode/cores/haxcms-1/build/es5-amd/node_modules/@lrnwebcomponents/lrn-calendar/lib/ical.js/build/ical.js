...
if ((typeof module === "undefined" ? "undefined" : babelHelpers.typeof(module)) === "object") {
  ...
  ICAL = module.exports;
} else if ((typeof ICAL === "undefined" ? "undefined" : babelHelpers.typeof(ICAL)) !== "object") {
  /* istanbul ignore next */
...
ICAL.helpers = {
  ...
  formatClassType: function formatClassType(data, type) {
    ...
    if (babelHelpers.instanceof(data, type)) {
      return data;
    }
  ...
  clone: function clone(aSrc, aDeep) {
    if (!aSrc || babelHelpers.typeof(aSrc) != "object") {
      return aSrc;
    } else if (babelHelpers.instanceof(aSrc, Date)) {
...
ICAL.Component = function () {
  ...
  Component.prototype = {
    ...
    addProperty: function addProperty(property) {
      if (!babelHelpers.instanceof(property, ICAL.Property)) {
...
ICAL.Property = function () {
  ...
  Property.prototype = {
    ...
    _setDecoratedValue: function _setDecoratedValue(value, index) {
      ...
      if (babelHelpers.typeof(value) === "object" && "icaltype" in value) {
        // decorated value
    ...
    setValues: function setValues(values) {
      ...
      if (len > 0 && babelHelpers.typeof(values[0]) === "object" && "icaltype" in values[0]) {
...
(function () {
  ...
  ICAL.Period = function icalperiod(aData) {
    ...
    if (aData && "start" in aData) {
      if (aData.start && !babelHelpers.instanceof(aData.start, ICAL.Time)) {
    ...
    if (aData && "end" in aData) {
      if (aData.end && !babelHelpers.instanceof(aData.end, ICAL.Time)) {
    ...
    if (aData && "duration" in aData) {
      if (aData.duration && !babelHelpers.instanceof(aData.duration, ICAL.Duration)) {
...
(function () {
  ...
  ICAL.Timezone.prototype = {
    ...
    fromData: function fromData(aData) {
      ...
      if (babelHelpers.instanceof(aData, ICAL.Component)) {
        ...
        if (aData && "component" in aData) {
          ...
          } else if (babelHelpers.instanceof(aData.component, ICAL.Component)) {
      ...
      if (babelHelpers.instanceof(this.component, ICAL.Component) && !this.tzid) {
...
ICAL.TimezoneService = function () {
  ...
  var TimezoneService = {
    ...
    register: function register(name, timezone) {
      if (babelHelpers.instanceof(name, ICAL.Component)) {
      ...
      if (babelHelpers.instanceof(timezone, ICAL.Timezone)) {
        zones[name] = timezone;
      } else {
...
(function () {
  ...
  /** @lends ICAL.VCardTime */
  {
    ...
    utcOffset: function utcOffset() {
      if (babelHelpers.instanceof(this.zone, ICAL.UtcOffset)) {
    ...
    toString: function toString() {
      ...
      if (this.zone === ICAL.Timezone.utcTimezone) {
        zone = "Z";
      } else if (babelHelpers.instanceof(this.zone, ICAL.UtcOffset)) {
        zone = this.zone.toString();
      } else if (this.zone === ICAL.Timezone.localTimezone) {
        zone = "";
      } else if (babelHelpers.instanceof(this.zone, ICAL.Timezone)) {
...
(function () {
  ...
  ICAL.Recur.prototype = {
    ...
    fromData: function fromData(data) {
      ...
      if (this.until && !babelHelpers.instanceof(this.until, ICAL.Time)) {
...
ICAL.Event = function () {
  ...
  function Event(component, options) {
    if (!babelHelpers.instanceof(component, ICAL.Component)) {
      options = component;
      component = null;
    }
  ...
  Event.prototype = {
    ...
    relateException: function relateException(obj) {
      ...
      if (babelHelpers.instanceof(obj, ICAL.Component)) {
...
ICAL.ComponentParser = function () {
  ...
  ComponentParser.prototype = {
    ...
    process: function process(ical) {
      ...
      if (!babelHelpers.instanceof(ical, ICAL.Component)) {
