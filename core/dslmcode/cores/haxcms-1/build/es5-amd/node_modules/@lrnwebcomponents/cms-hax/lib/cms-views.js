define(["exports","../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/utils/flattened-nodes-observer.js","../../../@polymer/polymer/lib/utils/async.js","../../utils/utils.js","../../../@polymer/iron-ajax/iron-ajax.js","../../../@polymer/paper-spinner/paper-spinner.js"],function(_exports,_polymerElement,_flattenedNodesObserver,_async,_utils,_ironAjax,_paperSpinner){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.CMSViews=void 0;function _templateObject_76c71b2079d011eab2fff3f0fe734e4a(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n          min-width: 112px;\n          min-height: 112px;\n          transition: 0.6s all ease;\n          background-color: transparent;\n        }\n        paper-spinner {\n          visibility: hidden;\n          opacity: 0;\n          height: 80px;\n          width: 80px;\n          padding: 16px;\n        }\n        #replacementcontent {\n          visibility: visible;\n          opacity: 1;\n        }\n        :host([loading]) {\n          text-align: center;\n        }\n        :host([loading]) paper-spinner {\n          visibility: visible;\n          opacity: 1;\n        }\n        :host([loading]) #replacementcontent {\n          opacity: 0;\n          visibility: hidden;\n        }\n      </style>\n      <iron-ajax\n        id=\"viewsrequest\"\n        method=\"GET\"\n        params=\"[[bodyData]]\"\n        url=\"[[viewsEndPoint]]\"\n        handle-as=\"json\"\n        last-response=\"{{viewsData}}\"\n      ></iron-ajax>\n      <paper-spinner active=\"[[loading]]\"></paper-spinner>\n      <span id=\"replacementcontent\"><slot></slot></span>\n    "]);_templateObject_76c71b2079d011eab2fff3f0fe734e4a=function _templateObject_76c71b2079d011eab2fff3f0fe734e4a(){return data};return data}/**
 * `cms-views`
 * @element cms-views
...
_async.microTask.run(function(){var frag=document.createElement("span");frag.innerHTML=newValue.content;var newNode=frag.cloneNode(!0);_this.appendChild(newNode);setTimeout(function(){_this.loading=!1},600)})}}/**
...
if(babelHelpers.typeof(this.viewsEndPoint)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(window.cmsviewsEndPoint)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.viewsEndPoint=window.cmsviewsEndPoint}if(this.viewsEndPoint){this.loading=!0;_async.microTask.run(function(){_this2.shadowRoot.querySelector("#viewsrequest").generateRequest()})}}}/**
...
if(babelHelpers.typeof(this.viewsEndPoint)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&babelHelpers.typeof(window.cmsviewsEndPoint)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.viewsEndPoint=window.cmsviewsEndPoint}if(this.viewsEndPoint){this.loading=!0;_async.microTask.run(function(){_this3.shadowRoot.querySelector("#viewsrequest").generateRequest()})}}}}},{key:"postProcessgetHaxJSONSchema",/**
   * Implements getHaxJSONSchema post processing callback.
   */value:function postProcessgetHaxJSONSchema(schema){schema.properties.__editThis={type:"string",component:{name:"a",properties:{id:"cmstokenidtolockonto",href:"",target:"_blank"},slot:"Edit this view"}};return schema}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_76c71b2079d011eab2fff3f0fe734e4a())}},{key:"tag",get:function get(){return"cms-views"}},{key:"properties",get:function get(){return{/**
       * Loading state
