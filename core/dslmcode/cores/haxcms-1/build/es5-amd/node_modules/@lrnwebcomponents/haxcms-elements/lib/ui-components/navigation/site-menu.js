define(["exports", "../../../../../lit/index.js", "../../core/haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../map-menu/map-menu.js", "../../../../utils/utils.js", "../../core/utils/HAXCMSThemeParts.js"], function (_exports, _index, _haxcmsSiteStore, _mobxEsm, _mapMenu, _utils, _HAXCMSThemeParts2) {
  "use strict";
  ...
  var _templateObject_1df319201f0211edad7313f46a36d4d9, _templateObject2_1df319201f0211edad7313f46a36d4d9;
   ...
   * `Menu hierarchy`
   */
  var SiteMenu = /*#__PURE__*/function (_HAXCMSThemeParts) {
    ...
    function SiteMenu() {
      ...
      (0, _mobxEsm.autorun)(function (reaction) {
        _this.routerManifest = Object.assign({}, (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.routerManifest));
    ...
    babelHelpers.createClass(SiteMenu, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_1df319201f0211edad7313f46a36d4d9 || (_templateObject_1df319201f0211edad7313f46a36d4d9 = babelHelpers.taggedTemplateLiteral(["\n      <map-menu\n        .part=\"map-menu ", "\"\n        .manifest=\"", "\"\n        ?active-indicator=\"", "\"\n        ?auto-scroll=\"", "\"\n        @active-item=\"", "\"\n      ></map-menu>\n    "])), this.editMode ? "edit-mode-active" : "", this.routerManifest, !this.hideActiveIndicator, !this.preventAutoScroll, this.mapMenuActiveChanged);
      }
    }, {
      key: "firstUpdated",
      ...
      value: function mapMenuActiveChanged(e) {
        ...
        try {
          ...
          var userData = (0, _utils.localStorageGet)("HAXCMSSystemData");

          if (userData.manifests) {
            if (babelHelpers.typeof(userData.manifests[this.routerManifest.id]) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
      ...
      key: "properties",
      get: function get() {
        return _objectSpread(_objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(SiteMenu), "properties", this)), {}, {
          /**
