define(["exports", "../../../lit-element/lit-element.js", "../a11y-collapse.js"], function (_exports, _litElement, _a11yCollapse) {
  ...
  function _templateObject2_e225fb101bb211eabd7cc30119585ddb() {
    ...
    _templateObject2_e225fb101bb211eabd7cc30119585ddb = function _templateObject2_e225fb101bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject_e225fb101bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"wrapper\"><slot></slot></div>\n    "]);

    _templateObject_e225fb101bb211eabd7cc30119585ddb = function _templateObject_e225fb101bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  /*#__PURE__*/
  function (_A11yCollapse) {
    babelHelpers.inherits(A11yCollapseGroup, _A11yCollapse);
    babelHelpers.createClass(A11yCollapseGroup, [{
      key: "render",
      value: function render() {
        return (0, _litElement.html)(_templateObject_e225fb101bb211eabd7cc30119585ddb());
      }
    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_e225fb101bb211eabd7cc30119585ddb())];
      }
    }]);
    ...
    function A11yCollapseGroup() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(A11yCollapseGroup).call(this));
    ...
    babelHelpers.createClass(A11yCollapseGroup, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          _this2.__items.forEach(function (item) {
            if (propName === "globalOptions" || propName === "__items") {
              if (_this2.globalOptions !== {}) for (var key in _this2.globalOptions) {
                if (_this2.globalOptions.hasOwnProperty(key)) {
                  item[key] = _this2.globalOptions[key];
                }
              }
            }

            if (propName === "expanded" && _this2.expanded) {
              item.expanded = true;
            }

            if (propName === "radio" && _this2.radio) {
              item.expanded = false;
            }

            if (propName === "accordion" || propName === "disabled" || propName === "icon" || propName === "iconExpanded" || propName === "label" || propName === "lanelExpanded" || propName === "tooltip" || propName === "tooltipExpanded") {
              if (_this2[propName] !== null) item[propName] = _this2[propName];
            }
          });
        });
      }
      ...
      key: "properties",
      get: function get() {
        return babelHelpers.objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(A11yCollapseGroup), "properties", this), {
          /**
