define(["exports", "meta", "../../../lit/index.js", "../a11y-collapse.js"], function (_exports, meta, _index, _a11yCollapse) {
  ...
  var _templateObject_d51ded207fe511edbfd7dd19f6a31344, _templateObject2_d51ded207fe511edbfd7dd19f6a31344;
  ...
  var A11yCollapseGroup = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(A11yCollapseGroup, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_d51ded207fe511edbfd7dd19f6a31344 || (_templateObject_d51ded207fe511edbfd7dd19f6a31344 = babelHelpers.taggedTemplateLiteral([" <div class=\"wrapper\"><slot></slot></div> "])));
      }
    }, {
      key: "items",
      get: function get() {
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_d51ded207fe511edbfd7dd19f6a31344 || (_templateObject2_d51ded207fe511edbfd7dd19f6a31344 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          margin: var(--a11y-collapse-group-margin, 15px 0);\n          --a11y-collapse-margin: 15px;\n        }\n        :host([hidden]) {\n          display: none;\n        }\n        #heading {\n          font-weight: bold;\n        }\n        .wrapper {\n          border-radius: 0;\n          display: block;\n          --a11y-collapse-margin: 0 0;\n          --a11y-collapse-border-between: none;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
