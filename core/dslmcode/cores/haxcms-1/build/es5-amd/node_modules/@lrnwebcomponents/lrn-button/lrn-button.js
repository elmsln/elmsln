define(["exports", "require", "../../lit-element/lit-element.js", "../materializecss-styles/materializecss-styles.js"], function (_exports, _require, _litElement, _materializecssStyles) {
  "use strict";
  ...
  function _templateObject4_ba1553f01bb211eabd7cc30119585ddb() {
    ...
    _templateObject4_ba1553f01bb211eabd7cc30119585ddb = function _templateObject4_ba1553f01bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject3_ba1553f01bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <span class=\"label\">\n                    ", "\n                  </span>\n                "]);

    _templateObject3_ba1553f01bb211eabd7cc30119585ddb = function _templateObject3_ba1553f01bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject2_ba1553f01bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <iron-icon\n                    icon=\"", "\"\n                    id=\"icon\"\n                    class=\"", "\"\n                  ></iron-icon>\n                "]);

    _templateObject2_ba1553f01bb211eabd7cc30119585ddb = function _templateObject2_ba1553f01bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject_ba1553f01bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style include=\"materializecss-styles-colors\">\n          :host {\n            @apply --paper-button;\n          }\n        </style>\n      </custom-style>\n      <a\n        tabindex=\"-1\"\n        id=\"lrnsys-button-link\"\n        href=\"", "\"\n        data-prefetch-hover=\"", "\"\n        target=\"", "\"\n      >\n        <paper-button\n          id=\"button\"\n          raised=\"", "\"\n          class=\"", " ", " ", "\"\n          ?disabled=\"", "\"\n        >\n          <div class=\"inner ", "\">\n            ", "\n            ", "\n            <slot></slot>\n          </div>\n        </paper-button>\n      </a>\n      <paper-tooltip for=\"lrnsys-button-link\" animation-delay=\"0\"\n        >", "</paper-tooltip\n      >\n    "]);

    _templateObject_ba1553f01bb211eabd7cc30119585ddb = function _templateObject_ba1553f01bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function (_LitElement) {
    babelHelpers.inherits(LrnButton, _LitElement);
    babelHelpers.createClass(LrnButton, [{
      key: "render",
      // render function
      value: function render() {
        return (0, _litElement.html)(_templateObject_ba1553f01bb211eabd7cc30119585ddb(), this.showHref, this.prefetch, this.target, this.raised, this.class, this.color, this.textColor, this.disabled, this.innerClass, this.icon ? (0, _litElement.html)(_templateObject2_ba1553f01bb211eabd7cc30119585ddb(), this.icon, this.iconClass) : "", this.label ? (0, _litElement.html)(_templateObject3_ba1553f01bb211eabd7cc30119585ddb(), this.label) : "", this.alt);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_ba1553f01bb211eabd7cc30119585ddb())];
      }
    }, {
      key: "properties",
      get: function get() {
        return babelHelpers.objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(LrnButton), "properties", this), {
          /**
    ...
    function LrnButton() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrnButton).call(this));
    ...
    babelHelpers.createClass(LrnButton, [{
      ...
      value: function tapEventOn(e) {
        ...
        if (babelHelpers.typeof(this.hoverClass) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !this.disabled) {
          ...
          classes.forEach(function (item, index) {
            if (item != "") {
              _this2.shadowRoot.querySelector("#button").classList.add(item);

              if (item.indexOf("-") != -1) {
                _this2.shadowRoot.querySelector("#icon").classList.add(item);
              }
            }
          });
        }
      ...
      value: function tapEventOff(e) {
        ...
        if (babelHelpers.typeof(this.hoverClass) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !this.disabled) {
          ...
          classes.forEach(function (item, index) {
            if (item != "") {
              _this3.shadowRoot.querySelector("#button").classList.remove(item);

              if (item.indexOf("-") != -1) {
                _this3.shadowRoot.querySelector("#icon").classList.remove(item);
              }
            }
          });
        }
          ...
          classes.forEach(function (item, index) {
            if (item != "") {
              if (_this4.focusState) {
                _this4.shadowRoot.querySelector("#button").classList.add(item);

                if (item.indexOf("-") != -1) {
                  _this4.shadowRoot.querySelector("#icon").classList.add(item);
                }
              } else {
