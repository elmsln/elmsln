define(["exports", "require", "../../lit-element/lit-element.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/lib/mobx.module.js", "../../@polymer/iron-icons/editor-icons.js", "../../@polymer/iron-icons/iron-icons.js", "../../@polymer/paper-icon-button/paper-icon-button.js", "../simple-popover/simple-popover.js", "../scroll-button/scroll-button.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _HAXCMSThemeParts2, _haxcmsSiteStore, _mobxModule, _editorIcons, _ironIcons, _paperIconButton, _simplePopover, _scrollButton) {
  "use strict";
  ...
  function _templateObject2_1b0dfbb0bff711ea911389a091fca225() {
    ...
    _templateObject2_1b0dfbb0bff711ea911389a091fca225 = function _templateObject2_1b0dfbb0bff711ea911389a091fca225() {
      return data;
    };
  ...
  function (_HAXCMSThemeParts) {
    babelHelpers.inherits(CleanOne, _HAXCMSThemeParts);
    babelHelpers.createClass(CleanOne, [{
      ...
      key: "sizeUp",
      value: function sizeUp(e) {
        if (this.fontSize < 4) {
          this.fontSize = this.fontSize + 1;
        }
      }
    }, {
      key: "fontFamilyChange",
      value: function fontFamilyChange(e) {
        this.fontFamily = parseInt(e.path[0].getAttribute("data-font"));
      }
    }, {
      key: "colorThemeChange",
      value: function colorThemeChange(e) {
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_1b0dfbb0bff711ea911389a091fca225(), this.withMenu, this.fontSize, this.fontFamily, this.colorTheme, this.searchTerm, this.searchChanged, this.editMode ? "edit-mode-active" : "", this.editMode ? "edit-mode-active" : "", this.toggleMenu, this.editMode ? "edit-mode-active" : "", this.toggleSettings, this.hideSettings, this.sizeDown, this.sizeUp, this.fontFamilyChange, this.fontFamilyChange, this.colorThemeChange, this.colorThemeChange, this.colorThemeChange, this.searchTerm, this.searchItemSelected, this.searchTerm != "" ? false : true, this.searchTerm != "" ? true : false, this.editMode ? "edit-mode-active" : "");
      }
    }, {
      ...
      value: function searchChanged(e) {
        ...
        if (e.path[0].value) {
          new Promise(function (res, rej) {
            ...
            _this2.searchTerm = e.path[0].value;
          });
        } else {
          this.searchTerm = "";
        }
      ...
      //styles function
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(CleanOne), "styles", this)), [(0, _litElement.css)(_templateObject2_1b0dfbb0bff711ea911389a091fca225())]);
      }
    }, {
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(CleanOne), "properties", this), {
          withMenu: {
            type: String
          },
          searchTerm: {
    ...
    function CleanOne() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(CleanOne).call(this));
      ...
      _this.addEventListener("click", _this.checkMenuOpen.bind(babelHelpers.assertThisInitialized(_this)));
    ...
    babelHelpers.createClass(CleanOne, [{
      ...
      value: function firstUpdated(changedProperties) {
        ...
        this.__toggleTarget = this.shadowRoot.querySelector("#popovertarget"); // hook up the scroll target

        this.shadowRoot.querySelector("scroll-button").target = this.shadowRoot.querySelector("#top"); // hook up the pop over menu
    ...
    return CleanOne;
  }((0, _HAXCMSThemeParts2.HAXCMSThemeParts)(_HAXCMSLitElementTheme.HAXCMSLitElementTheme));
