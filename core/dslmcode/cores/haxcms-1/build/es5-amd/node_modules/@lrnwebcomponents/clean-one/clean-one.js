define(["exports", "require", "../../lit/index.js", "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js", "../haxcms-elements/lib/core/utils/HAXCMSThemeParts.js", "../haxcms-elements/lib/core/utils/HAXCMSRememberRoute.js", "../haxcms-elements/lib/core/utils/QRCodeMixin.js", "../haxcms-elements/lib/core/utils/HAXCMSMobileMenu.js", "../haxcms-elements/lib/core/utils/HAXCMSUserStylesMenu.js", "../haxcms-elements/lib/core/haxcms-site-store.js", "../../mobx/dist/mobx.esm.js", "../scroll-button/scroll-button.js", "../haxcms-elements/lib/ui-components/active-item/site-active-title.js", "../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js", "./lib/clean-one-search-box.js", "../simple-colors/simple-colors.js", "../haxcms-elements/lib/core/utils/PrintBranchMixin.js", "../micro-frontend-registry/micro-frontend-registry.js", "../haxcms-elements/lib/core/utils/PDFPageMixin.js"], function (_exports, _require, _index, _HAXCMSLitElementTheme, _HAXCMSThemeParts, _HAXCMSRememberRoute2, _QRCodeMixin, _HAXCMSMobileMenu, _HAXCMSUserStylesMenu, _haxcmsSiteStore, _mobxEsm, _scrollButton, _siteActiveTitle, _siteBreadcrumb, _cleanOneSearchBox, _simpleColors, _PrintBranchMixin, _microFrontendRegistry, _PDFPageMixin) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.CleanOne = void 0;
  _require = _interopRequireWildcard(_require);

  var _templateObject_cabd5f007fe511edbfd7dd19f6a31344, _templateObject2_cabd5f007fe511edbfd7dd19f6a31344, _templateObject3_cabd5f007fe511edbfd7dd19f6a31344, _templateObject4_cabd5f007fe511edbfd7dd19f6a31344;
   ...
   * @element clean-one
   */
  var CleanOne = /*#__PURE__*/function (_HAXCMSRememberRoute) {
    babelHelpers.inherits(CleanOne, _HAXCMSRememberRoute);

    var _super = _createSuper(CleanOne);
    ...
    function CleanOne() {
      ...
      babelHelpers.classCallCheck(this, CleanOne);
      _this = _super.call(this);
      _this.HAXCMSThemeSettings.autoScroll = true; // prettier-ignore
      ...
      (0, _mobxEsm.autorun)(function (reaction) {
        _this.activeManifestIndex = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeManifestIndex);
        _this.searchTerm = "";
    ...
    babelHelpers.createClass(CleanOne, [{
      key: "render",
      value: // render function
      function render() {
        return (0, _index.html)(_templateObject_cabd5f007fe511edbfd7dd19f6a31344 || (_templateObject_cabd5f007fe511edbfd7dd19f6a31344 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"site\">\n        <div class=\"menu-outline\">\n          <div id=\"site-search-input\" role=\"search\" part=\"search-btn\">\n            <clean-one-search-box\n              @input-changed=\"", "\"\n              value=\"", "\"\n            ></clean-one-search-box>\n          </div>\n          ", "\n        </div>\n        <div id=\"body\" class=\"site-body\" part=\"site-body\">\n          <div id=\"haxcms-theme-top\"></div>\n          <div class=\"site-inner\">\n            <header class=\"site-header\">\n              <div class=\"btn-container\">\n                <div class=\"pull-left\">\n                  ", "\n                  ", "\n                  ", "\n                  ", "\n                </div>\n                <div class=\"pull-right\">\n                  ", "\n                  <site-rss-button\n                    type=\"rss\"\n                    class=\"btn js-toolbar-action\"\n                    part=\"rss-btn\"\n                  ></site-rss-button>\n                  <site-git-corner\n                    size=\"small\"\n                    part=\"git-corner-btn\"\n                  ></site-git-corner>\n                </div>\n              </div>\n            </header>\n            <main class=\"page-wrapper\" role=\"main\">\n              <article class=\"main-content page-inner\">\n                <site-breadcrumb\n                  part=\"page-breadcrumb ", "\"\n                ></site-breadcrumb>\n                <site-active-title part=\"page-title\"></site-active-title>\n                <div class=\"normal main-section\">\n                  <site-search\n                    hide-input\n                    part=\"search-btn\"\n                    search=\"", "\"\n                    ?hidden=\"", "\"\n                  ></site-search>\n                  <section\n                    id=\"contentcontainer\"\n                    ?hidden=\"", "\"\n                  >\n                    <div id=\"slot\">\n                      <slot></slot>\n                    </div>\n                  </section>\n                </div>\n              </article>\n            </main>\n          </div>\n          <footer>\n            <!-- These two buttons allow you to go left and right through the pages in the manifest -->\n            <site-menu-button\n              type=\"prev\"\n              position=\"right\"\n              class=\"navigation\"\n            ></site-menu-button>\n            <site-menu-button\n              type=\"next\"\n              position=\"left\"\n              class=\"navigation\"\n            ></site-menu-button>\n          </footer>\n        </div>\n        <scroll-button\n          .part=\"", "\"\n        ></scroll-button>\n      </div>\n    "])), this.searchChanged, this.searchTerm, this.HAXCMSMobileMenu(), this.HAXCMSMobileMenuButton(), this.HAXCMSUserStylesMenu(), _microFrontendRegistry.MicroFrontendRegistry.has("@haxcms/siteToHtml") ? this.PrintBranchButton("bottom") : (0, _index.html)(_templateObject2_cabd5f007fe511edbfd7dd19f6a31344 || (_templateObject2_cabd5f007fe511edbfd7dd19f6a31344 = babelHelpers.taggedTemplateLiteral(["\n                        <site-print-button\n                          class=\"btn js-toolbar-action\"\n                          part=\"print-btn\"\n                        ></site-print-button>\n                      "]))), _microFrontendRegistry.MicroFrontendRegistry.has("@core/htmlToPdf") ? this.PDFPageButton("bottom") : "", this.QRCodeButton(), this.editMode ? "edit-mode-active" : "", this.searchTerm, this.searchTerm != "" ? false : true, this.searchTerm != "" ? true : false, this.editMode ? "edit-mode-active" : "");
      }
    }, {
      key: "searchChanged",
      value: function searchChanged(e) {
        ...
        if (e.detail.value) {
          ...
          new Promise(function (res, rej) {
            ...
            _this2.searchTerm = e.detail.value;
          });
        } else {
          this.searchTerm = "";
        }
      ...
      value: function firstUpdated(changedProperties) {
        if (babelHelpers.get(babelHelpers.getPrototypeOf(CleanOne.prototype), "firstUpdated", this)) {
          babelHelpers.get(babelHelpers.getPrototypeOf(CleanOne.prototype), "firstUpdated", this).call(this, changedProperties);
        } // only way to hit this


        document.body.style.overflow = "hidden";
        this.HAXCMSThemeSettings.scrollTarget = this.shadowRoot.querySelector("#body"); // hook up the scroll target

        this.shadowRoot.querySelector("scroll-button").target = this.shadowRoot.querySelector("#haxcms-theme-top");
      }
    }, {
      key: "HAXCMSGlobalStyleSheetContent",
      value: function HAXCMSGlobalStyleSheetContent() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(CleanOne.prototype), "HAXCMSGlobalStyleSheetContent", this).call(this)), [(0, _index.css)(_templateObject3_cabd5f007fe511edbfd7dd19f6a31344 || (_templateObject3_cabd5f007fe511edbfd7dd19f6a31344 = babelHelpers.taggedTemplateLiteral(["\n        clean-one a {\n          text-decoration-thickness: 3px;\n        }\n      "])))]);
      }
      /**
      ...
      value: function disconnectedCallback() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(CleanOne.prototype), "disconnectedCallback", this).call(this);
      }
      /**
      ...
      value: function prevPage(e) {
        babelHelpers.get(babelHelpers.getPrototypeOf(CleanOne.prototype), "prevPage", this).call(this, e);
      }
      /**
    ...
    return CleanOne;
  }((0, _HAXCMSRememberRoute2.HAXCMSRememberRoute)((0, _PrintBranchMixin.PrintBranchMixin)((0, _PDFPageMixin.PDFPageMixin)((0, _QRCodeMixin.QRCodeMixin)((0, _HAXCMSThemeParts.HAXCMSThemeParts)((0, _HAXCMSUserStylesMenu.HAXCMSUserStylesMenuMixin)((0, _HAXCMSMobileMenu.HAXCMSMobileMenuMixin)((0, _simpleColors.SimpleColorsSuper)(_HAXCMSLitElementTheme.HAXCMSLitElementTheme)))))))));

  _exports.CleanOne = CleanOne;
