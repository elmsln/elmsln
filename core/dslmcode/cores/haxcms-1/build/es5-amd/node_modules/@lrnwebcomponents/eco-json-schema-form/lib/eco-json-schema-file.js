...
*/var EcoJsonSchemaFile=/*#__PURE__*/function(_mixinBehaviors){babelHelpers.inherits(EcoJsonSchemaFile,_mixinBehaviors);function EcoJsonSchemaFile(){babelHelpers.classCallCheck(this,EcoJsonSchemaFile);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(EcoJsonSchemaFile).apply(this,arguments))}babelHelpers.createClass(EcoJsonSchemaFile,[{key:"clear",/**
   ...
   */value:function clear(){this.set("files",[]);this.$.fileInput.value="";this._showDropText()}},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(EcoJsonSchemaFile.prototype),"ready",this).call(this);if(this.raised){this.toggleAttribute("raised",!0,this.$.button)}if(this.noink){this.toggleAttribute("noink",!0,this.$.button)}if(this.droppable){this._showDropText();this.setupDrop()}}/**
   * A function to set up a drop area for drag-and-drop file uploads
   */},{key:"setupDrop",value:function setupDrop(){var uploadBorder=this.$.UploadBorder;this.toggleClass("enabled",!0,uploadBorder);this.ondragover=function(e){e.stopPropagation();this.toggleClass("hover",!0,uploadBorder);// Workaround for allowgin drop from Chome's download footer on OSX
...
if(""!==this.accept&&!(-1<this.accept.indexOf(mimeType)||-1<this.accept.indexOf(fileType))){continue}file.progress=0;file.error=!1;file.complete=!1;this.push("files",file);this.uploadFile(file)}}}/**
   ...
   */},{key:"_fileClick",value:function _fileClick(){var elem=this.$.fileInput;if(elem&&document.createEvent){// sanity check
