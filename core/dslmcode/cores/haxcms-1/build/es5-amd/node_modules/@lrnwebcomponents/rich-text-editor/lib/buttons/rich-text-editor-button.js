define(["exports", "require", "../../../../lit-element/lit-element.js", "./rich-text-editor-button-styles.js", "../../../../@polymer/paper-button/paper-button.js", "../../../../@polymer/iron-a11y-keys/iron-a11y-keys.js", "../singletons/rich-text-editor-selection.js"], function (_exports, _require, _litElement, _richTextEditorButtonStyles, _paperButton, _ironA11yKeys, _richTextEditorSelection) {
  ...
  function _templateObject2_4ef47930019d11eb9027c17497ee62cd() {
    ...
    _templateObject2_4ef47930019d11eb9027c17497ee62cd = function _templateObject2_4ef47930019d11eb9027c17497ee62cd() {
      return data;
    };
  ...
  function _templateObject_4ef47930019d11eb9027c17497ee62cd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        <iron-a11y-keys\n          id=\"a11y\"\n          .target=\"", "\"\n          keys=\"enter\"\n          @keys-pressed=\"", "\"\n        >\n        </iron-a11y-keys>\n        <paper-button\n          id=\"button\"\n          class=\"rtebutton\"\n          ?disabled=\"", "\"\n          ?controls=\"", "\"\n          @click=\"", "\"\n          tabindex=\"0\"\n          ?toggled=\"", "\"\n        >\n          <iron-icon id=\"icon\" aria-hidden=\"true\" icon=\"", "\">\n          </iron-icon>\n          <span id=\"label\" class=\"", "\"\n            >", "</span\n          >\n        </paper-button>\n        <simple-tooltip id=\"tooltip\" for=\"button\"\n          >", "</simple-tooltip\n        >\n      "]);

    _templateObject_4ef47930019d11eb9027c17497ee62cd = function _templateObject_4ef47930019d11eb9027c17497ee62cd() {
      return data;
    };
    ...
    return /*#__PURE__*/function (_RichTextEditorButton) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function render() {
          return (0, _litElement.html)(_templateObject_4ef47930019d11eb9027c17497ee62cd(), this.__a11y, this._buttonTap, this.disabled, this.controls, this._buttonTap, this.isToggled, this.currentIcon, this.labelStyle, this.currentLabel, this.currentLabel);
        }
      }], [{
        key: "tag",
        ...
        key: "styles",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(_class), "styles", this)), [(0, _litElement.css)(_templateObject2_4ef47930019d11eb9027c17497ee62cd())]);
        }
      }, {
        key: "properties",
        get: function get() {
