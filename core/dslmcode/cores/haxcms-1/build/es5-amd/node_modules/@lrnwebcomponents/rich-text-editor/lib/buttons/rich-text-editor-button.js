 ...
 */var RichTextEditorButton=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(RichTextEditorButton,_PolymerElement);function RichTextEditorButton(){babelHelpers.classCallCheck(this,RichTextEditorButton);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(RichTextEditorButton).apply(this,arguments))}babelHelpers.createClass(RichTextEditorButton,[{key:"ready",/**
   ...
   */value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorButton.prototype),"ready",this).call(this);var root=this;root.addEventListener("mousedown",function(e){console.log("mousedown",e)});root.addEventListener("keypress",function(e){e.preventDefault()})}/**
   * life cycle, element is afixed to the DOM
   */},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(RichTextEditorButton.prototype),"connectedCallback",this).call(this);this.__a11y=this.shadowRoot.querySelector("#button")}/**
   ...
   */},{key:"doTextOperation",value:function doTextOperation(){var root=this,range=root.range;if(root.toggled&&null!==root.toggledCommand){document.execCommand(root.toggledCommand,!1,root.toggledCommand||"")}else if(null!==root.command){root.dispatchEvent(new CustomEvent(root.command+"-button",{bubbles:!0,cancelable:!0,composed:!0,detail:root}));console.log("doTextOperation",range,root.command,!1,root.commandVal||"");document.execCommand(root.command,!1,root.commandVal||"");root.range=range}}/**
   * Handles button tap
   */},{key:"_buttonTap",value:function _buttonTap(e){e.preventDefault();console.log("_buttonTap",e);this.doTextOperation()}/**
   ...
   */},{key:"_isToggled",value:function _isToggled(range){var toggled=null!==this.command&&this.toggles?document.queryCommandState(this.command):!1;/*,
    ...
    if (this.shadowRoot.querySelector('#tooltip') !== undefined) this.shadowRoot.querySelector('#tooltip').innerHTML = label*/return toggled}/**
   * Handles keys the same way a button is handled
   * @param {event} e the  event
   */},{key:"_keysPressed",value:function _keysPressed(e){console.log("_keysPressed",e);e.preventDefault();this._buttonTap(e)}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_2035ce8072ac11eab01767e8389e9c27())}// properties available to the custom element for data binding
       ...
       */shortcutKeys:{name:"shortcutKeys",type:String,value:null},/**
