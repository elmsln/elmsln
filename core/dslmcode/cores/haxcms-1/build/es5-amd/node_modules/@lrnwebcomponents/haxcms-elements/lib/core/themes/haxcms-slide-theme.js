define(["exports", "require", "../../../../../lit-element/lit-element.js", "../HAXCMSLitElementTheme.js", "../../../../simple-colors/simple-colors.js", "../haxcms-site-store.js", "../../../../../mobx/lib/mobx.module.js"], function (_exports, _require, _litElement, _HAXCMSLitElementTheme, _simpleColors, _haxcmsSiteStore, _mobxModule) {
  ...
  function _templateObject2_a2216c80c1f111eaab7cc57641978817() {
    ...
    _templateObject2_a2216c80c1f111eaab7cc57641978817 = function _templateObject2_a2216c80c1f111eaab7cc57641978817() {
      return data;
    };
  ...
  function _templateObject_a2216c80c1f111eaab7cc57641978817() {
    ...
    _templateObject_a2216c80c1f111eaab7cc57641978817 = function _templateObject_a2216c80c1f111eaab7cc57641978817() {
      return data;
    };
  ...
  function (_SimpleColorsSuper) {
    ...
    function HAXCMSSlideTheme() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HAXCMSSlideTheme).call(this));
      _this.__disposer = [];
      setTimeout(function () {
    ...
    babelHelpers.createClass(HAXCMSSlideTheme, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_a2216c80c1f111eaab7cc57641978817(), this.activeManifestIndexCounter, this.manifestLength);
      }
    }, {
      ...
      value: function connectedCallback() {
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          _this2.manifestLength = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.routerManifest.items.length);

          _this2.__disposer.push(reaction);
        });
        (0, _mobxModule.autorun)(function (reaction) {
          _this2.activeManifestIndexCounter = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.activeManifestIndexCounter);
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSSlideTheme), "styles", this)), [(0, _litElement.css)(_templateObject2_a2216c80c1f111eaab7cc57641978817())]);
      }
    }, {
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSSlideTheme), "properties", this), {
          manifestLength: {
            type: Number
          },
