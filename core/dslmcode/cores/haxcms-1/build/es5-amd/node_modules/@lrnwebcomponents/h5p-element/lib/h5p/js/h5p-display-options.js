...
(function ($) {
  function setupHiding() {
    var $toggler = $(this); // Getting the field which should be hidden:
  ...
  function setupRevealing() {
    var $button = $(this); // Getting the field which should have the value:
  ...
  $(document).ready(function () {
    ...
    $(".h5p-visibility-toggler").each(setupHiding); // Get the buttons making other fields have hidden values:
