 ...
 */var CitationElement=/*#__PURE__*/function(_SchemaBehaviors){babelHelpers.inherits(CitationElement,_SchemaBehaviors);function CitationElement(){babelHelpers.classCallCheck(this,CitationElement);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(CitationElement).apply(this,arguments))}babelHelpers.createClass(CitationElement,[{key:"_generateLicenseLink",/**
...
if(this._aboutLink){document.head.removeChild(this._aboutLink)}var link=document.createElement("link");link.setAttribute("about",relatedResource);link.setAttribute("property","cc:license");link.setAttribute("content",licenseLink);document.head.appendChild(link);return link}/**
   * Notice scope change.
   */},{key:"_scopeChanged",value:function _scopeChanged(newValue,oldValue){// make sure we actually have a sibling first
...
(0,_polymerDom.dom)(this).parentNode.setAttribute("prefix",this.getAttribute("prefix"))}}/**
   ...
   */},{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(CitationElement.prototype),"connectedCallback",this).call(this);(0,_renderStatus.afterNextRender)(this,function(){this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(CitationElement.haxProperties,CitationElement.tag,this)})}/**
   * License was updated, time to update license name and link.
   */},{key:"_licenseUpdated",value:function _licenseUpdated(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){var list=new _licenseElement.licenseList;if(babelHelpers.typeof(list[newValue])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.licenseName=list[newValue].name;this.licenseLink=list[newValue].link;this.licenseImage=list[newValue].image}}}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_28e1bef0a4c011e993314ff97b5a3737())}},{key:"tag",get:function get(){return"citation-element"}},{key:"properties",get:function get(){var props={/**
       * Title of the work.
       */title:{type:String},/**
       * License scope
       ...
       */_licenseLink:{type:Object,computed:"_generateLicenseLink(source)"}};if(babelHelpers.get(babelHelpers.getPrototypeOf(CitationElement),"properties",this)){props=Object.assign(props,babelHelpers.get(babelHelpers.getPrototypeOf(CitationElement),"properties",this))}return props}},{key:"haxProperties",get:function get(){return{canScale:!1,canPosition:!1,canEditSource:!1,gizmo:{title:"Citation",description:"A basic citation element with 3 presentation modes",icon:"editor:title",color:"grey",groups:["Content","Text","Copyright"],handles:[{type:"citation",source:"source",title:"title",author:"creator",license:"license",accessDate:"date"}],meta:{author:"LRNWebComponents"}},settings:{quick:[{property:"title",title:"Title",description:"The title of the work being cited.",inputMethod:"textfield",icon:"editor:title"}],configure:[{property:"title",title:"Title",description:"The title of the work being cited.",inputMethod:"textfield",icon:"editor:title"},{property:"source",title:"Source link",description:"The source url for the element this is citing.",inputMethod:"textfield",icon:"link",validationType:"url"},{property:"date",title:"Date accessed",description:"The date this was accessed.",inputMethod:"textfield",icon:"link"},{property:"scope",title:"Scope",description:"Scope of what to cite.",inputMethod:"select",options:{sibling:"Sibling element",parent:"Parent element"},icon:"code"},{property:"license",title:"License",description:"The source url for the element this is citing.",inputMethod:"select",options:new _licenseElement.licenseList("select"),icon:"link"},{property:"creator",title:"Creator",description:"Who made or owns this.",inputMethod:"textfield",icon:"link"}],advanced:[]}}}}]);return CitationElement}((0,_schemaBehaviors.SchemaBehaviors)(_polymerElement.PolymerElement));_exports.CitationElement=CitationElement;window.customElements.define(CitationElement.tag,CitationElement)});