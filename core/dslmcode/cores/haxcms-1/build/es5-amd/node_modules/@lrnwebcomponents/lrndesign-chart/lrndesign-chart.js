...
get:function get(){return[].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignChart),"styles",this)),[(0,_litElement.css)(_templateObject2_640710507a2311ea877d9d791dd38f76())])}},{key:"haxProperties",get:function get(){return{canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{description:"Creates an accessible chart based on a CSV.",color:"green darken-4",groups:["Data","Presentation"],handles:[{type:"data",url:"csvFile"}],meta:{author:"LRNWebComponents"}},settings:{quick:[{property:"accentColor",title:"Accent Color",description:"An optional accent color.",inputMethod:"colorpicker",icon:"editor:format-color-fill"},{property:"dark",title:"Dark Theme",description:"Enable Dark Theme",inputMethod:"boolean",icon:"icons:invert-colors"},{property:"chartTitle",title:"Chart Title",description:"Accessible alt text for your chart.",inputMethod:"textfield",icon:"text-field",required:!0}],configure:[{property:"accentColor",title:"Accent Color",description:"An optional accent color.",inputMethod:"colorpicker"},{property:"dark",title:"Dark Theme",description:"Enable Dark Theme",inputMethod:"boolean"},{property:"dataSource",title:"CSV File",description:"Load data from a CSV.",inputMethod:"haxupload",icon:"link",required:!0},{property:"chartTitle",title:"Chart Title",description:"Accessible alt text for your chart.",inputMethod:"textfield",icon:"text-field",required:!0},{property:"chartDesc",title:"Chart Description",description:"Accessible description of your chart.",inputMethod:"textfield",icon:"text-field"}],advanced:[{property:"scale",title:"Scale Name",description:"The ratio of width:height of the chart (See https://gionkunz.github.io/chartist-js/getting-started.html#default-sass-settings for $ct-scales and $ct-scales-names).",inputMethod:"select",options:{"ct-square":"ct-square (1:1)","ct-minor-second":"ct-minor-second  (15:16)","ct-major-second":"ct-major-second  (8:9)","ct-minor-third":"ct-minor-third  (5:6)","ct-major-third":"ct-major-third  (4:5)","ct-perfect-fourth":"ct-perfect-fourth  (3:4)","ct-perfect-fifth":"ct-perfect-fifth  (2:3)","ct-minor-sixth":"ct-minor-sixth  (5:8)","ct-golden-section":"ct-golden-section  (1:1.618)","ct-major-sixth":"ct-major-sixth  (3:5)","ct-minor-seventh":"ct-minor-seventh  (9:16)","ct-major-seventh":"ct-major-seventh  (8:15)","ct-octave":"ct-octave  (1:2)","ct-major-tenth":"ct-major-tenth  (2:5)","ct-major-eleventh":"ct-major-eleventh  (3:8)","ct-major-twelfth":"ct-major-twelfth  (1:3)","ct-double-octave":"ct-double-octave  (1:4`)"},icon:"text-field"},{property:"reverseData",title:"Reverse Data",description:"Reverse data including labels, the series order as well as the whole series data arrays.",inputMethod:"boolean",icon:"check-box"}]}}}// properties available to the custom element for data binding
       ...
       */width:{type:String}})}}]);function LrndesignChart(){var _this;babelHelpers.classCallCheck(this,LrndesignChart);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignChart).call(this));_this.setProperties();_this.makeChart();return _this}/**
   * Store the tag name to make it easier to obtain directly.
   */babelHelpers.createClass(LrndesignChart,[{key:"updated",value:function updated(changedProperties){var _this2=this;if(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignChart.prototype),"updated",this))babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignChart.prototype),"updated",this).call(this,changedProperties);changedProperties.forEach(function(oldValue,propName){/**
       * Fired when data source changes.
       *
       * @event data-source-changed
       * @param {string} dataSource data source of the chart
       *
       */if("dataSource"===propName)_this2.dispatchEvent(new CustomEvent("data-source-changed",{detail:_this2}));/**
       ...
       *
       */if("rawData"===propName)_this2.dispatchEvent(new CustomEvent("raw-data-changed",{detail:_this2}));if("data"===propName&&_this2.data&&_this2.data!==oldValue){_this2._renderTable();_this2.dispatchEvent(new CustomEvent("data-changed",{detail:_this2}))}})}/**
   * creates an accessible table based on data object
   * @memberof LrndesignChart
   */},{key:"_renderTable",value:function _renderTable(){var table=this.querySelector("table");if(table)table.remove();var html="";table=document.createElement("table");if(this.data.labels)html+="<thead><tr>".concat((this.data.labels||[]).map(function(label){return"<th scope=\"col\">".concat(label,"</th>")}).join(""),"</tr></thead>");if(this.data.series)html+="<tbody>\n        ".concat(this.data.series&&Array.isArray(this.data.series[0])?(this.data.series||[]).map(function(row){return"<tr>".concat((row||[]).map(function(col){return"<td>".concat(col,"</td>")}).join(""),"</tr>")}).join(""):"<tr>".concat((this.data.series||[]).map(function(col){return"<td>".concat(col,"</td>")}).join(""),"</tr>"),"\n      </tbody>");table.innerHTML=html;this.appendChild(table);console.log("data-changed",this.data,this.querySelector("table"))}/**
   * refreshes the chart
   */},{key:"makeChart",value:function makeChart(){var chart=this.shadowRoot.querySelector("#chart");if(chart){chart.options=this._getOptions();/**
       * Fired when chart options change.
       *
       * @event options-changed
       * @param {object} chart options
       *
       */this.dispatchEvent(new CustomEvent("options-changed",{detail:this}));chart.makeChart();/**
   ...
   */},{key:"setBarLineProperties",value:function setBarLineProperties(){this.high=void 0;this.low=void 0;this.axisXLabelOffsetX=0;this.axisXLabelOffsetY=0;this.axisXOffset=30;this.axisXPosition="end";this.axisXShowGrid=!0;this.axisXShowLabel=!0;this.axisXTopLeft=!1;this.axisYLabelOffsetX=0;this.axisYLabelOffsetY=0;this.axisYOffset=30;this.axisYOnlyInteger=!1;this.axisYPosition="start";this.axisYScaleMinSpace=20;this.axisYShowGrid=!0;this.axisYshowLabel=!0;this.axisYTopLeft=!0;this.showGridBackground=!1;this.chartPaddingBottom=5;this.chartPaddingLeft=10;this.chartPaddingRight=15;this.chartPaddingTop=15}/**
   * life cycle, element is removed from the DOM
   */ //disconnectedCallback() {}
}],[{key:"tag",get:function get(){return"lrndesign-chart"}//properties common to line and bar charts
