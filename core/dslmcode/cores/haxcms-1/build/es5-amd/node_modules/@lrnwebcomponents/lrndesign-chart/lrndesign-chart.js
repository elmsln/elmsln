define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../chartist-render/chartist-render.js", "../../@polymer/iron-ajax/iron-ajax.js"], function (_exports, _litElement, _simpleColors, _chartistRender, _ironAjax) {
  "use strict";
  ...
  function _templateObject2_d29dd8701bb211eabd7cc30119585ddb() {
    ...
    _templateObject2_d29dd8701bb211eabd7cc30119585ddb = function _templateObject2_d29dd8701bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject_d29dd8701bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-ajax\n        auto\n        handle-as=\"text\"\n        url=\"", "\"\n        @response=\"", "\"\n      ></iron-ajax>\n      <chartist-render\n        id=\"chartist\"\n        .type=\"", "\"\n        .scale=\"", "\"\n        .chart-title=\"", "\"\n        .chart-desc=\"", "\"\n        .data=\"", "\"\n        .responsive-options=\"", "\"\n      ></chartist-render>\n    "]);

    _templateObject_d29dd8701bb211eabd7cc30119585ddb = function _templateObject_d29dd8701bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function (_SimpleColors) {
    babelHelpers.inherits(LrndesignChart, _SimpleColors);
    babelHelpers.createClass(LrndesignChart, [{
      key: "render",
      // render function
      value: function render() {
        return (0, _litElement.html)(_templateObject_d29dd8701bb211eabd7cc30119585ddb(), this.dataSource, this.handleResponse, this.type, this.scale, this.chartTitle, this.chartDesc, this.data, this.responsiveOptions);
      ...
      //styles function
      get: function get() {
        var styles = [(0, _litElement.css)(_templateObject2_d29dd8701bb211eabd7cc30119585ddb())];
      ...
      key: "properties",
      get: function get() {
        return babelHelpers.objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignChart), "properties", this), {
          /**
    ...
    function LrndesignChart() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrndesignChart).call(this));

      _this.setProperties();

      var checkReady = setInterval(function () {
        if (_this.__dataReady) {
          _this.makeChart();
    ...
    babelHelpers.createClass(LrndesignChart, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
           ...
           *
           */
          if (propName === "dataSource") _this2.dispatchEvent(new CustomEvent("data-source-changed", {
            detail: _this2
          }));
          /**
          ...
          if (propName === "rawData") _this2.dispatchEvent(new CustomEvent("raw-data-changed", {
            detail: _this2
          }));

          if (_this2.__dataReady) {
            _this2.makeChart();
          }
        });
      }
      ...
      value: function makeChart() {
        var chart = this.shadowRoot.querySelector("#chartist");
        ...
        if (chart) {
          ...
          this.dispatchEvent(new CustomEvent("chart-changed", {
            detail: this
          }));
        }
      }
      ...
      value: function handleResponse(e) {
        ...
        var raw = this.CSVtoArray(this.rawData);
        this.data = {
          labels: raw[0],
      ...
      key: "_getLineBarOptions",
      value: function _getLineBarOptions() {
        return {
          high: this.high,
          low: this.low,
          axisX: {
