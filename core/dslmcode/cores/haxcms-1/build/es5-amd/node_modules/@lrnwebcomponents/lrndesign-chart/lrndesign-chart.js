 ...
 *
 */var LrndesignChart=/*#__PURE__*/function(_SimpleColors){babelHelpers.inherits(LrndesignChart,_SimpleColors);babelHelpers.createClass(LrndesignChart,[{key:"render",// render function
value:function render(){return(0,_litElement.html)(_templateObject_b0169be0734911eaac0dbb5c5350affd(),this.dataSource,this.handleResponse,this.type,this.scale,this.chartTitle,this.chartDesc,this.data,this.responsiveOptions)}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){var styles=[(0,_litElement.css)(_templateObject2_b0169be0734911eaac0dbb5c5350affd())];if(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignChart),"styles",this))styles=Object.assign(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignChart),"styles",this),styles);return styles}},{key:"haxProperties",get:function get(){return{canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{description:"Creates an accessible chart based on a CSV.",color:"green darken-4",groups:["Data","Presentation"],handles:[{type:"data",url:"csvFile"}],meta:{author:"LRNWebComponents"}},settings:{quick:[{property:"chartTitle",title:"Chart Title",description:"Accessible alt text for your chart.",inputMethod:"textfield",icon:"text-field",required:!0}],configure:[{property:"data-source",title:"CSV File",description:"The URL for your CSV file.",inputMethod:"textfield",icon:"link",validationType:"url",required:!0},{property:"chartTitle",title:"Chart Title",description:"Accessible alt text for your chart.",inputMethod:"textfield",icon:"text-field",required:!0},{property:"chartDesc",title:"Chart Description",description:"Accessible description of your chart.",inputMethod:"textfield",icon:"text-field"}],advanced:[{property:"scale",title:"Scale Name",description:"The ratio of width:height of the chart (See https://gionkunz.github.io/chartist-js/getting-started.html#default-sass-settings for $ct-scales and $ct-scales-names).",inputMethod:"textfield",icon:"text-field"},{property:"reverseData",title:"Reverse Data",description:"Reverse data including labels, the series order as well as the whole series data arrays.",inputMethod:"boolean",icon:"check-box"}]}}}// properties available to the custom element for data binding
       ...
       */rawData:{type:String,attribute:"raw-data"},/**
       ...
       */width:{type:String}})}}]);function LrndesignChart(){var _this;babelHelpers.classCallCheck(this,LrndesignChart);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignChart).call(this));_this.setProperties();var checkReady=setInterval(function(){if(_this.__dataReady){_this.makeChart();clearInterval(checkReady)}},1);return _this}/**
   * Store the tag name to make it easier to obtain directly.
   */babelHelpers.createClass(LrndesignChart,[{key:"updated",value:function updated(changedProperties){var _this2=this;changedProperties.forEach(function(oldValue,propName){/**
       ...
       *
       */if("rawData"===propName)_this2.dispatchEvent(new CustomEvent("raw-data-changed",{detail:_this2}));if(_this2.__dataReady){_this2.makeChart()}})}/**
   * refreshes the chart
   */},{key:"makeChart",value:function makeChart(){var chart=this.shadowRoot.querySelector("#chartist");if(chart){chart.options=this._getOptions();/**
   ...
   */},{key:"setProperties",value:function setProperties(){this.chartTitle=null;this.chartDesc=null;this.scale="ct-minor-seventh";this.reverseData=!1;this.rawData=""}/**
   ...
   */},{key:"handleResponse",value:function handleResponse(e){this.rawData=e.detail.response;var raw=this.CSVtoArray(this.rawData);this.data={labels:raw[0],series:"pie"!==this.type?raw.slice(1,raw.length):raw[1]};this.__dataReady=!0}/**
   * override this with type-specific options
   * @returns {object} options
   */},{key:"_getOptions",value:function _getOptions(){return{reverseData:this.reverseData}}/**
   * override this with type-specific options
   * @returns {object} options specific to both bar and line charts
   */},{key:"_getLineBarOptions",value:function _getLineBarOptions(){return{high:this.high,low:this.low,axisX:{labelOffset:{x:this.axisXLabelOffsetX,y:this.axisXLabelOffsetY,offset:this.axisXOffset},position:this.axisXPosition,showGrid:this.axisXShowGrid,showLabel:this.axisXShowLabel},axisY:{labelOffset:{x:this.axisYLabelOffsetX,y:this.axisYLabelOffsetY,offset:this.axisYOffset},position:this.axisYPosition,showGrid:this.axisYShowGrid,showLabel:this.axisYShowLabel,onlyInteger:this.axisYOnlyInteger,scaleMinSpace:this.axisYScaleMinSpace},showGridBackground:this.showGridBackground,chartPadding:{bottom:this.chartPaddingBottom,left:this.chartPaddingLeft,right:this.chartPaddingRight,top:this.chartPaddingTop}}}/**
   * Mix of solutions from https://stackoverflow.com/questions/8493195/how-can-i-parse-a-csv-string-with-javascript-which-contains-comma-in-data
   * @param {string} text csv data
   * @returns {array} chart data
   */},{key:"CSVtoArray",value:function CSVtoArray(text){var p="",row=[""],ret=[row],i=0,r=0,s=!0,l;for(l in text){l=text[l];if("\""===l){if(s&&l===p)row[i]+=l;s=!s}else if(","===l&&s){if(null!==row[i].trim().match(/^\d+$/m))row[i]=parseInt(row[i].trim());l=row[++i]=""}else if("\n"===l&&s){if("\r"===p)row[i]=row[i].slice(0,-1);if(null!==row[i].trim().match(/^\d+$/m))row[i]=parseInt(row[i].trim());row=ret[++r]=[l=""];i=0}else row[i]+=l;p=l}if(null!==row[i].trim().match(/^\d+$/m))row[i]=parseInt(row[i].trim());return ret}/**
