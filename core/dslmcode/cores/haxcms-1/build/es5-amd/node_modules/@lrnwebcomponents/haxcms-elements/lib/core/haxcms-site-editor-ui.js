define(["exports", "meta", "require", "../../../../lit/index.js", "./haxcms-site-store.js", "../../../hax-body/lib/hax-store.js", "../../../../mobx/dist/mobx.esm.js", "../../../utils/utils.js", "../../../simple-icon/simple-icon.js", "../../../simple-icon/lib/simple-icons.js", "../../../simple-icon/lib/simple-icon-button.js", "./utils/HAXCMSThemeParts.js", "./utils/HAXCMSI18NMixin.js", "../../../rpg-character/rpg-character.js", "../../../app-hax/lib/v1/app-hax-top-bar.js", "../../../app-hax/lib/v1/app-hax-user-menu.js", "../../../app-hax/lib/v1/app-hax-user-menu-button.js", "../../../../wired-elements/lib/wired-button.js", "../../../simple-colors/simple-colors.js", "../../../simple-modal/simple-modal.js", "../../../simple-fields/lib/simple-fields-form.js", "./micros/haxcms-button-add.js", "./haxcms-darkmode-toggle.js"], function (_exports, meta, _require, _index, _haxcmsSiteStore, _haxStore, _mobxEsm, _utils, _simpleIcon, _simpleIcons, _simpleIconButton, _HAXCMSThemeParts2, _HAXCMSI18NMixin, _rpgCharacter, _appHaxTopBar, _appHaxUserMenu, _appHaxUserMenuButton, _wiredButton, _simpleColors, _simpleModal, _simpleFieldsForm, _haxcmsButtonAdd, _haxcmsDarkmodeToggle) {
  "use strict";
  ...
  var _templateObject_cd1cd3e0c7fb11ecb6e7e53d635e268e, _templateObject2_cd1cd3e0c7fb11ecb6e7e53d635e268e;
  ...
  var HAXCMSSiteEditorUI = /*#__PURE__*/function (_HAXCMSThemeParts) {
    ...
    babelHelpers.createClass(HAXCMSSiteEditorUI, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_cd1cd3e0c7fb11ecb6e7e53d635e268e || (_templateObject_cd1cd3e0c7fb11ecb6e7e53d635e268e = babelHelpers.taggedTemplateLiteral(["\n      <app-hax-top-bar>\n        <span slot=\"left\">\n          <a href=\"", "\" class=\"haxLogo\" id=\"backtosites\">\n            <simple-icon-lite src=\"", "\"></simple-icon-lite>\n          </a>\n          <slot name=\"haxcms-site-editor-ui-prefix-avatar\"></slot>\n        </span>\n      <span slot=\"center\">\n        <slot name=\"haxcms-site-editor-ui-prefix-buttons\"></slot>\n        <simple-icon-button\n          hidden\n          ?dark=\"", "\"\n          id=\"editbutton\"\n          icon=\"", "\"\n          @click=\"", "\"\n          label=\"", "\"\n          voice-command=\"edit (this) page\"\n          class=\"topbar-button\"\n          accent-color=\"green\"\n        ></simple-icon-button>\n        <simple-icon-button\n          id=\"cancelbutton\"\n          ?dark=\"", "\"\n          icon=\"icons:cancel\"\n          @click=\"", "\"\n          .hidden=\"", "\"\n          label=\"", "\"\n          voice-command=\"cancel (editing)\"\n          class=\"topbar-button\"\n          accent-color=\"red\"\n        ></simple-icon-button>\n        <simple-icon-button\n          ?dark=\"", "\"\n          id=\"editdetails\"\n          icon=\"hax:page-details\"\n          @click=\"", "\"\n          label=\"", "\"\n          voice-command=\"edit (page) details\"\n          class=\"topbar-button\"\n          accent-color=\"blue\"\n          part=\"", "\"\n          tabindex=\"", "\"\n        ></simple-icon-button>\n        <simple-icon-button\n          part=\"", "\"\n          tabindex=\"", "\"\n          ?dark=\"", "\"\n          id=\"deletebutton\"\n          icon=\"icons:delete\"\n          @click=\"", "\"\n          label=\"", "\"\n          voice-command=\"delete page\"\n          class=\"topbar-button\"\n          accent-color=\"red\"\n        ></simple-icon-button>\n        <haxcms-button-add\n        hidden\n        ?dark-mode=\"", "\"\n        accent-color=\"purple\"\n        id=\"addbutton\"></haxcms-button-add>\n        <haxcms-button-add\n          hidden\n          ?dark-mode=\"", "\"\n          id=\"addbuttonchild\"\n          type=\"child\"\n          accent-color=\"purple\"\n        ></haxcms-button-add>\n        <haxcms-button-add\n          hidden\n          ?dark-mode=\"", "\"\n          type=\"duplicate\"\n          id=\"duplicatebutton\"\n          accent-color=\"purple\"\n        ></haxcms-button-add>\n        <simple-tooltip for=\"backtosites\" position=\"right\"\n          >", "</simple-tooltip\n        >\n        <simple-tooltip for=\"cancelbutton\" position=\"bottom\" offset=\"14\"\n          >", "</simple-tooltip\n        >\n        <simple-tooltip for=\"editbutton\" position=\"bottom\" offset=\"14\"\n          >", "</simple-tooltip\n        >\n        <simple-tooltip for=\"editdetails\" position=\"bottom\" offset=\"14\"\n          >", "</simple-tooltip\n        >\n        <simple-tooltip for=\"deletebutton\" position=\"bottom\" offset=\"14\"\n          >", "</simple-tooltip\n        >\n        <slot name=\"haxcms-site-editor-ui-suffix-buttons\"></slot>\n      </span>\n\n      <app-hax-user-menu slot=\"right\" id=\"user-menu\">\n        <button class=\"topbar-character\" slot=\"menuButton\" id=\"tbchar\" @click=\"", "\">\n          <rpg-character\n            seed=\"", "\"\n            width=\"68\"\n            height=\"68\"\n            aria-label=\"", "\"\n            hat=\"", "\"\n          ></rpg-character>\n        </button>\n        <simple-tooltip for=\"tbchar\" position=\"left\" slot=\"menuButton\">", "</simple-tooltip>\n        <div slot=\"pre-menu\" class=\"ops-panel\">\n          <wired-button\n            elevation=\"1\"\n            class=\"soundToggle\"\n            @click=\"", "\"\n          >\n            <simple-icon-lite src=\"", "\" loading=\"lazy\" decoding=\"async\"></simple-icon-lite>\n          </wired-button>\n          <haxcms-darkmode-toggle></haxcms-darkmode-toggle>\n        </div>\n        <!-- <app-hax-user-menu-button\n          slot=\"main-menu\"\n          icon=\"face\"\n          label=\"", "\"\n        ></app-hax-user-menu-button> -->\n\n        <app-hax-user-menu-button\n          id=\"outlinebutton\"\n          @click=\"", "\"\n          slot=\"main-menu\"\n          icon=\"hax:site-map\"\n          label=\"", "\"\n        ></app-hax-user-menu-button>\n\n        <app-hax-user-menu-button\n          @click=\"", "\"\n          slot=\"main-menu\"\n          icon=\"", "\"\n          label=\"", "\"\n        ></app-hax-user-menu-button>\n\n        <app-hax-user-menu-button\n          slot=\"main-menu\"\n          icon=\"add\"\n          label=\"", "\"\n          @click=\"", "\"\n        ></app-hax-user-menu-button>\n        \n        <app-hax-user-menu-button\n          slot=\"post-menu\"\n          class=\"logout\"\n          label=\"", "\"\n          @click=", "\n        ></app-hax-user-menu-button>\n      </app-hax-user-menu>\n    </app-hax-top-bar>\n    "])), this.backLink, haxLogo, !this.darkMode, this.__editIcon, this._editButtonTap, this.__editText, !this.darkMode, this._cancelButtonTap, !this.editMode, this.t.cancelEditing, !this.darkMode, this._editDetailsButtonTap, this.t.editDetails, this.editMode ? "edit-mode-active" : "", this.editMode ? "-1" : "", this.editMode ? "edit-mode-active" : "", this.editMode ? "-1" : "", !this.darkMode, this._deleteButtonTap, this.t.deletePage, this.darkMode, this.darkMode, this.darkMode, this.backText, this.t.cancelEditing, this.__editText, this.t.editDetails, this.t.deletePage, this.toggleMenu, this.userName, this.t.systemMenu, this.rpgHat, this.t.systemMenu, this.soundToggle, this.soundIcon, this.t.accountInfo, this._outlineButtonTap, this.t.editSiteOutline, this._manifestButtonTap, this.icon, this.__settingsText, this.t.startNewJourney, this._addButtonTap, this.t.logOut, this._logout);
      }
    }, {
      key: "_logout",
