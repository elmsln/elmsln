define(["exports", "require", "../../../../lit/index.js", "./haxcms-site-store.js", "../../../../mobx/dist/mobx.esm.js", "../../../simple-icon/simple-icon.js", "../../../simple-icon/lib/simple-icons.js", "../../../simple-icon/lib/simple-icon-button.js", "./utils/HAXCMSI18NMixin.js"], function (_exports, _require, _index, _haxcmsSiteStore, _mobxEsm, _simpleIcon, _simpleIcons, _simpleIconButton, _HAXCMSI18NMixin2) {
  "use strict";
  ...
  var _templateObject_f362f9506e5811eca35dfbf9740b185c, _templateObject2_f362f9506e5811eca35dfbf9740b185c;
   ...
   */
  var HAXCMSSiteEditorUI = /*#__PURE__*/function (_HAXCMSI18NMixin) {
    babelHelpers.inherits(HAXCMSSiteEditorUI, _HAXCMSI18NMixin);
    ...
    babelHelpers.createClass(HAXCMSSiteEditorUI, [{
      ...
      value: function _addButtonTap(e) {
        ...
        this.__newForm.fields = [{
          ...
          property: "location",
          title: "Location",
          description: "What is displayed in the browser bar after your site name / URL",
          inputMethod: "textfield",
          required: true
        }, {
          property: "parentId",
