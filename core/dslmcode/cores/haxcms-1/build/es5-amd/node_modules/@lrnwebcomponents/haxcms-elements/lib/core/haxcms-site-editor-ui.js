define(["exports", "require", "../../../../lit-element/lit-element.js", "./haxcms-site-store.js", "../../../../mobx/dist/mobx.esm.js", "../../../simple-icon/simple-icon.js", "../../../simple-icon/lib/simple-icons.js", "../../../simple-icon/lib/simple-icon-button.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxEsm, _simpleIcon, _simpleIcons, _simpleIconButton) {
  ...
  function _templateObject2_2ea67150284011eb97976fb20742a907() {
    ...
    _templateObject2_2ea67150284011eb97976fb20742a907 = function _templateObject2_2ea67150284011eb97976fb20742a907() {
      return data;
    };
  ...
  function _templateObject_2ea67150284011eb97976fb20742a907() {
    ...
    _templateObject_2ea67150284011eb97976fb20742a907 = function _templateObject_2ea67150284011eb97976fb20742a907() {
      return data;
    };
  ...
  var HAXCMSSiteEditorUI = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSSiteEditorUI, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_2ea67150284011eb97976fb20742a907())];
      }
      /**
      ...
      value: function connectedCallback() {
        ...
        (0, _mobxEsm.autorun)(function (reaction) {
          if (_haxcmsSiteStore.store.userData) {
            _this4.userName = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.userData.userName);
            _this4.userPicture = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.userData.userPicture);
          }

          _this4.__disposer.push(reaction);
        });
        (0, _mobxEsm.autorun)(function (reaction) {
          _this4.editMode = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.editMode);

          _this4.__disposer.push(reaction);
        });
        (0, _mobxEsm.autorun)(function (reaction) {
          _this4.manifest = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.manifest);
          _this4.icon = "hax:site-settings";

          _this4.__disposer.push(reaction);
        });
        (0, _mobxEsm.autorun)(function (reaction) {
          _this4.dashboardOpened = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.dashboardOpened);

          _this4.__disposer.push(reaction);
        });
        (0, _mobxEsm.autorun)(function (reaction) {
          var activeItem = (0, _mobxEsm.toJS)(_haxcmsSiteStore.store.activeItem);
