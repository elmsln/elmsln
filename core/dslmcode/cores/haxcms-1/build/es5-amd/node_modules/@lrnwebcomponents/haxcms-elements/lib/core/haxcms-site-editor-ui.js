define(["exports", "require", "../../../../lit-element/lit-element.js", "./haxcms-site-store.js", "../../../../mobx/lib/mobx.module.js", "../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxModule, _customStyle) {
  "use strict";
  ...
  function _templateObject2_6bf637e02d8511ea80ccf124101da415() {
    ...
    _templateObject2_6bf637e02d8511ea80ccf124101da415 = function _templateObject2_6bf637e02d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function _templateObject_6bf637e02d8511ea80ccf124101da415() {
    ...
    _templateObject_6bf637e02d8511ea80ccf124101da415 = function _templateObject_6bf637e02d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSSiteEditorUI, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_6bf637e02d8511ea80ccf124101da415())];
      }
      /**
    ...
    function HAXCMSSiteEditorUI() {
      ...
      _this.manifestEditMode = false; // this ensures that an initial paint won't get a cached copy of the site.json file
      ...
      _this.dispatchEvent(new CustomEvent("haxcms-trigger-update", {
        bubbles: true,
        composed: true,
        cancelable: false,
        detail: true
    ...
    babelHelpers.createClass(HAXCMSSiteEditorUI, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "editMode") {
            ...
            _this3.dispatchEvent(new CustomEvent("edit-mode-changed", {
          ...
          if (propName == "manifestEditMode") {
            ...
            _this3.dispatchEvent(new CustomEvent("manifest-edit-mode-changed", {
              detail: _this3[propName]
            }));
          }
          ...
          if (propName == "dashboardOpened") {
            // observer
            _this3._dashboardOpenedChanged(_this3[propName], oldValue);
          }
        });
      }
    }, {
      ...
      value: function connectedCallback() {
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          _this4.userName = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.userData.userName);
          _this4.userPicture = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.userData.userPicture);

          _this4.__disposer.push(reaction);
        });
        (0, _mobxModule.autorun)(function (reaction) {
          _this4.editMode = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.editMode);

          _this4.__disposer.push(reaction);
        });
        (0, _mobxModule.autorun)(function (reaction) {
          _this4.manifest = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.manifest);
          _this4.icon = "hax:site-settings";

          _this4.__disposer.push(reaction);
        });
        (0, _mobxModule.autorun)(function (reaction) {
          _this4.dashboardOpened = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.dashboardOpened);
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          ...
          if (activeItem && activeItem.id) {
            _this4.activeTitle = activeItem.title;
            _this4.pageAllowed = true;
          } else {
            _this4.pageAllowed = false;
          }
