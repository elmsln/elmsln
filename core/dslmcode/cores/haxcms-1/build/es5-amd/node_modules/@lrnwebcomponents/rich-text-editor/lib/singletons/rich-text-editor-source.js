define(["exports", "require", "../../../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_f71af8406e5811eca35dfbf9740b185c, _templateObject2_f71af8406e5811eca35dfbf9740b185c;
  ...
  var RichTextEditorSource = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(RichTextEditorSource, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_f71af8406e5811eca35dfbf9740b185c || (_templateObject_f71af8406e5811eca35dfbf9740b185c = babelHelpers.taggedTemplateLiteral([" <div id=\"container\">\n      <div id=\"wysiwyg\" part=\"wysiwyg\">\n        <slot></slot>\n      </div>\n      <code-editor\n        id=\"source\"\n        font-size=\"13\"\n        language=\"html\"\n        @value-changed=\"", "\"\n        word-wrap\n        part=\"source\"\n      >\n      </code-editor>\n    </div>"])), this._handleSourceChange);
      }
    }, {
      key: "firstUpdated",
