define(["exports", "require", "../../../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_6ad415d0feb211eb882a11948c8a9144, _templateObject2_6ad415d0feb211eb882a11948c8a9144;
  ...
  var RichTextEditorSource = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(RichTextEditorSource, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_6ad415d0feb211eb882a11948c8a9144 || (_templateObject_6ad415d0feb211eb882a11948c8a9144 = babelHelpers.taggedTemplateLiteral([" <div id=\"container\">\n      <div id=\"wysiwyg\" part=\"wysiwyg\">\n        <slot></slot>\n      </div>\n      <code-editor\n        id=\"source\"\n        font-size=\"13\"\n        language=\"html\"\n        @value-changed=\"", "\"\n        word-wrap\n        part=\"source\"\n      >\n      </code-editor>\n    </div>"])), this._handleSourceChange);
      }
    }, {
      key: "firstUpdated",
