define(["exports", "require", "../../../../lit/index.js"], function (_exports, _require, _index) {
  ...
  var _templateObject_68f16bc014ae11ecb222b7931773abdb, _templateObject2_68f16bc014ae11ecb222b7931773abdb;
  ...
  var RichTextEditorSource = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(RichTextEditorSource, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_68f16bc014ae11ecb222b7931773abdb || (_templateObject_68f16bc014ae11ecb222b7931773abdb = babelHelpers.taggedTemplateLiteral([" <div id=\"container\">\n      <div id=\"wysiwyg\" part=\"wysiwyg\">\n        <slot></slot>\n      </div>\n      <code-editor\n        id=\"source\"\n        font-size=\"13\"\n        language=\"html\"\n        @value-changed=\"", "\"\n        word-wrap\n        part=\"source\"\n      >\n      </code-editor>\n    </div>"])), this._handleSourceChange);
      }
    }, {
      key: "firstUpdated",
