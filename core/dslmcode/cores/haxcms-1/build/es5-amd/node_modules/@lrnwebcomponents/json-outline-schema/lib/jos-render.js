define(["exports", "../../../lit-element/lit-element.js", "../json-outline-schema.js", "../../utils/utils.js", "../../dynamic-import-registry/dynamic-import-registry.js"], function (_exports, _litElement, _jsonOutlineSchema, _utils, _dynamicImportRegistry) {
  ...
  function _templateObject2_f5ee27e0954111eaba7de7fca9c9f5e8() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .children {\n          display: block;\n          margin: 16px auto;\n        }\n        .children ::slotted(*) {\n          display: inline-flex;\n          margin: var(--jos-render-margin, 8px);\n          padding: var(--jos-render-padding, 8px);\n        }\n      "]);

    _templateObject2_f5ee27e0954111eaba7de7fca9c9f5e8 = function _templateObject2_f5ee27e0954111eaba7de7fca9c9f5e8() {
      return data;
    };
  ...
  function _templateObject_f5ee27e0954111eaba7de7fca9c9f5e8() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"children\">\n        <slot></slot>\n      </div>\n    "]);

    _templateObject_f5ee27e0954111eaba7de7fca9c9f5e8 = function _templateObject_f5ee27e0954111eaba7de7fca9c9f5e8() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(JosRender, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_f5ee27e0954111eaba7de7fca9c9f5e8());
      }
    }, {
      key: "updated",
      ...
      value: function renderItems(items) {
        ...
        if (this.map && this.map.properties) {
          ...
          items.forEach(function (item) {
            ...
            for (var key in _this3.map.properties) {
              var value = _this3.map.properties[key]; // complex transform capability for values that need processing
              // prior to being set

              if (value === true || value === false || value === null) {
                n[key] = value;
              } else if (value.transform && value.value && (0, _utils.varExists)(item, value.value)) {
                n[key] = value.transform((0, _utils.varGet)(item, value.value), item);
              ...
              else if (typeof value === "string" && (0, _utils.varExists)(item, value)) {
                  n[key] = (0, _utils.varGet)(item, value);
                } else {
                  n[key] = value;
                }
            }
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_f5ee27e0954111eaba7de7fca9c9f5e8())];
      }
    }, {
      key: "properties",
      get: function get() {
