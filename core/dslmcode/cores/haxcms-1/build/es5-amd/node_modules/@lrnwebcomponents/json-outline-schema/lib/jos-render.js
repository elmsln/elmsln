define(["exports", "../../../lit/index.js", "../json-outline-schema.js", "../../utils/utils.js", "../../dynamic-import-registry/dynamic-import-registry.js"], function (_exports, _index, _jsonOutlineSchema, _utils, _dynamicImportRegistry) {
  ...
  var _templateObject_caca7060f9df11eba887937af67006f3, _templateObject2_caca7060f9df11eba887937af67006f3;
  ...
  var JosRender = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(JosRender, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_caca7060f9df11eba887937af67006f3 || (_templateObject_caca7060f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"children\">\n        <slot></slot>\n      </div>\n    "])));
      }
    }, {
      key: "updated",
      ...
      key: "styles",
      get: function get() {
        return [(0, _index.css)(_templateObject2_caca7060f9df11eba887937af67006f3 || (_templateObject2_caca7060f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        .children {\n          display: block;\n          margin: 16px auto;\n        }\n        .children ::slotted(*) {\n          display: inline-flex;\n          margin: var(--jos-render-margin, 8px);\n          padding: var(--jos-render-padding, 8px);\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
