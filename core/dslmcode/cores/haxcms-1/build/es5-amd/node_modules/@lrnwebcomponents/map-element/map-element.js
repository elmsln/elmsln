define(["exports", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/render-status.js", "../hax-body-behaviors/lib/HAXWiring.js", "../schema-behaviors/schema-behaviors.js", "../web-map/web-map.js"], function (_exports, _polymerElement, _renderStatus, _HAXWiring, _schemaBehaviors, _webMap) {
  "use strict";
  ...
  function _templateObject_1f363a40b3b911e9b58d79562a23326c() {
    ...
    _templateObject_1f363a40b3b911e9b58d79562a23326c = function _templateObject_1f363a40b3b911e9b58d79562a23326c() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    babelHelpers.inherits(MapElement, _SchemaBehaviors);

    function MapElement() {
      var _this;

      babelHelpers.classCallCheck(this, MapElement);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(MapElement).call(this));
    ...
    babelHelpers.createClass(MapElement, null, [{
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_1f363a40b3b911e9b58d79562a23326c());
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(MapElement), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(MapElement), "properties", this));
        }
