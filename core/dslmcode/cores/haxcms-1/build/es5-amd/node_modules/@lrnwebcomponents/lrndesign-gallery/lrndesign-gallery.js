define(["exports","../../lit-element/lit-element.js","./lib/lrndesign-gallery-behaviors.js","../responsive-utility/responsive-utility.js","./lib/lrndesign-gallery-carousel.js","./lib/lrndesign-gallery-grid.js"],function(_exports,_litElement,_lrndesignGalleryBehaviors,_responsiveUtility,_lrndesignGalleryCarousel,_lrndesignGalleryGrid){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.LrndesignGallery=void 0;function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});keys.push.apply(keys,symbols)}return keys}function _objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){ownKeys(Object(source),!0).forEach(function(key){babelHelpers.defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}function _templateObject4_0add2d3072ac11eab01767e8389e9c27(){var data=babelHelpers.taggedTemplateLiteral([""]);_templateObject4_0add2d3072ac11eab01767e8389e9c27=function _templateObject4_0add2d3072ac11eab01767e8389e9c27(){return data};return data}function _templateObject3_0add2d3072ac11eab01767e8389e9c27(){var data=babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-carousel\n                accent-color=\"","\"\n                .aspect-ratio=\"","\"\n                .extra-wide=\"","\"\n                ?dark=\"","\"\n                .gallery-id=\"","\"\n                @item-changed=\"","\"\n                responsive-size=\"","\"\n                .selected=\"","\"\n                sizing=\"","\"\n                .sources=\"","\"\n                gallery-title=\"","\"\n              >\n                <slot></slot>\n              </lrndesign-gallery-carousel>\n            "]);_templateObject3_0add2d3072ac11eab01767e8389e9c27=function _templateObject3_0add2d3072ac11eab01767e8389e9c27(){return data};return data}function _templateObject2_0add2d3072ac11eab01767e8389e9c27(){var data=babelHelpers.taggedTemplateLiteral(["\n              <lrndesign-gallery-grid\n                accent-color=\"","\"\n                .aspect-ratio=\"","\"\n                .extra-wide=\"","\"\n                ?dark=\"","\"\n                .gallery-id=\"","\"\n                @item-changed=\"","\"\n                responsive-size=\"","\"\n                .selected=\"","\"\n                sizing=\"","\"\n                .sources=\"","\"\n                gallery-title=\"","\"\n              >\n                <slot></slot>\n              </lrndesign-gallery-grid>\n            "]);_templateObject2_0add2d3072ac11eab01767e8389e9c27=function _templateObject2_0add2d3072ac11eab01767e8389e9c27(){return data};return data}function _templateObject_0add2d3072ac11eab01767e8389e9c27(){var data=babelHelpers.taggedTemplateLiteral(["\n      <div id=\"gallery\">\n        ","\n      </div>\n    "]);_templateObject_0add2d3072ac11eab01767e8389e9c27=function _templateObject_0add2d3072ac11eab01767e8389e9c27(){return data};return data}/**
 * `lrndesign-gallery`
...
value:function render(){var _this=this;return(0,_litElement.html)(_templateObject_0add2d3072ac11eab01767e8389e9c27(),this.grid?(0,_litElement.html)(_templateObject2_0add2d3072ac11eab01767e8389e9c27(),this.accentColor,this.aspect,this.extra,this.dark,this.id,function(e){return _this.goToItem(e.detail)},this.responsiveSize,this.selected,this.sizing,this.items,this.galleryTitle):(0,_litElement.html)(_templateObject3_0add2d3072ac11eab01767e8389e9c27(),this.accentColor,this.aspect,this.extra,this.dark,this.id,function(e){return _this.goToItem(e.detail)},this.responsiveSize,this.selected,this.sizing,this.items,this.galleryTitle))}// properties available to the custom element for data binding
},{key:"tag",/**
   * Store the tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */value:function tag(){return"lrndesign-gallery"}// life cycle
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject4_0add2d3072ac11eab01767e8389e9c27())]}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignGallery),"properties",this),{id:{type:String,reflect:!0,attribute:"id"}})}}]);function LrndesignGallery(){babelHelpers.classCallCheck(this,LrndesignGallery);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignGallery).call(this))}/**
   ...
   *
   * @param {string} query
   */value:function goToItem(query){var start=this.items[0]||{};if("number"===typeof query&&0<=query&&query<this.items.length){this.selected=this.items[query]||start}else{var matches=this.items.filter(function(item){return item.id===query});console.log("matches",query,matches);this.selected=0<matches.length?matches[0]:start}console.log("goToItem",query,this.selected)}/**
   * gets aspect ratio of an image and
   * determine if aspect ratio is extra wide
   *
   * @param {array}
   */},{key:"_getAnchorData",value:function _getAnchorData(){var hash=null!==window.location.hash&&""!==window.location.hash?window.location.hash.replace("#",""):!1,data=hash?hash.split("---"):[];console.log("anchor",data,hash);return{id:1<data.length?data[1]:-1,gallery:0<data.length?data[0]:-1,zoom:scroll&&2<data.length&&"zoom"===data[2]}}},{key:"aspect",get:function get(){var items=(this.items||[]).filter(function(item){return item.src&&""!=item.src}),src=items&&items[0]?items[0].src:!1;if(src){var img=new Image;img.src=src;return 0<img.naturalWidth&&0<img.naturalHeight?img.naturalWidth/img.naturalHeight:1.33333333}else{return 1.33333333}}/**
   * gets aspect ratio of an image and
   * determine if aspect ratio is extra wide
   *
   * @readonly
