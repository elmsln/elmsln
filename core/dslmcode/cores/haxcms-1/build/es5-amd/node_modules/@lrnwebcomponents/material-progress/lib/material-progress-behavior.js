define(["../../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../../@polymer/polymer/lib/utils/async.js"], function (_polymerDom, async) {
  "use strict";
  ...
  window.MaterialProgressBehaviorImpl = _obj = {
    ...
    ready: function ready() {
      ...
      this._mutationFilter = function (mutation) {
        ...
        return this._mutationIsChildList(mutation, this.$.barsContainer) || this._mutationIsChildAttributes(mutation, this.$.barsContainer);
      };
    },
    ...
    _computeSumAndBars: function _computeSumAndBars() {
      var sum = 0,
          ...
          max = 0,
          validBars = [],
          allChildren = (0, _polymerDom.dom)(this.$.content).getDistributedNodes();
