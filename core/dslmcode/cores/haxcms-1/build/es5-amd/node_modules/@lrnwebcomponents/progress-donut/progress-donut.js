 ...
 */var ProgressDonut=/*#__PURE__*/function(_SchemaBehaviors){babelHelpers.inherits(ProgressDonut,_SchemaBehaviors);babelHelpers.createClass(ProgressDonut,[{key:"render",// render function
value:function render(){return(0,_litElement.html)(_templateObject_de04ba007a9c11ea8ed6ed8c9eef0ab1(),this.imageAlt,this.imageSrc,!this.imageSrc||""==this.imageSrc,this.title,this.desc,this._onCreated)}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject2_de04ba007a9c11ea8ed6ed8c9eef0ab1())]}},{key:"haxProperties",get:function get(){return{canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Progress Donut",description:"The user will be able to see this for selection in a UI.",icon:"av:play-circle-filled",color:"grey",groups:["Video","Media"],handles:[{type:"image",url:"source"}],meta:{author:"Your organization on github"}},settings:{quick:[{property:"animated",title:"Animated",description:"Whether progress animates on first load",inputMethod:"boolean"},{property:"complete",title:"Complete",description:"An array of completed values.",inputMethod:"array",properties:[{title:"Number",description:"Completed number.",inputMethod:"number"}]},{property:"total",title:"Total",description:"Total when all items are complete.",inputMethod:"number"},{property:"startAngle",title:"Start Angle",description:"Donut angle where progress starts",inputMethod:"number"}],configure:[{property:"title",title:"Title",description:"The title of the element",inputMethod:"textfield",icon:"editor:title"},{property:"desc",title:"Description",description:"Accessible long description",inputMethod:"textfield"},{property:"imageSrc",title:"Image Source",description:"Source of image inside donut.",inputMethod:"haxupload",icon:"link",validationType:"url"},{property:"imageAlt",title:"Image Alt Text",description:"Alt text for image.",inputMethod:"alt"},{property:"animated",title:"Animated",description:"Whether progress animates on first load",inputMethod:"boolean"},{property:"complete",title:"Complete",description:"An array of completed values.",inputMethod:"array"},{property:"total",title:"Total",description:"Total when all items are complete.",inputMethod:"arrnumberay"},{property:"startAngle",title:"Start Angle",description:"Donut angle where progress starts",inputMethod:"number"}],advanced:[]}}}// properties available to the custom element for data binding
},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(ProgressDonut),"properties",this),{/**
       ...
       */imageSrc:{attribute:"image-src",type:String,reflect:!0},/**
       * Alt text for image.
       */imageAlt:{attribute:"image-alt",type:String,reflect:!0},/**
       * Donut angle where progress starts
       */startAngle:{attribute:"start-angle",type:Number},/**
       * Title of donut
       */title:{type:String},/**
       * Array of incomplete values
       */total:{type:Number}})}}]);function ProgressDonut(){var _this;babelHelpers.classCallCheck(this,ProgressDonut);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ProgressDonut).call(this));_this.animated=!1;_this.accentColor="grey";_this.dark=!1;_this.complete=[];_this.desc="";_this.title="";_this.imageSrc="";_this.imageAlt="";_this.total=100;return _this}babelHelpers.createClass(ProgressDonut,[{key:"updated",value:function updated(changedProperties){this.makeChart()}/**
   * Handles chart creation event.
   * @param {event} e create event
   */},{key:"_onCreated",value:function _onCreated(e){if(this.animated)e.detail.on("draw",function(data){if("slice"===data.type){var pathLength=data.element._node.getTotalLength();data.element.attr({"stroke-dasharray":pathLength+"px "+pathLength+"px"});var animationDefinition={"stroke-dashoffset":{id:"anim"+data.index,dur:500,from:-pathLength+"px",to:"0px",easing:Chartist.Svg.Easing.easeOutQuint,fill:"freeze"}};if(0!==data.index){animationDefinition["stroke-dashoffset"].begin="anim"+(data.index-1)+".end"}data.element.attr({"stroke-dashoffset":-pathLength+"px"});data.element.animate(animationDefinition,!1)}})}/**
   * refreshes the chart
   */},{key:"makeChart",value:function makeChart(){for(var sum=0,chart=this.shadowRoot.querySelector("#chart"),i=0;i<this.complete.length;i++){sum+=parseFloat(this.complete[i])}if(chart){chart.data={series:this.complete};chart.options={donut:!0,donutWidth:"25%",chartPadding:0,showLabel:!1,startAngle:0,total:Math.max(sum,this.total)};/**
     ...
     * @event chart-changed
     *
     */this.dispatchEvent(new CustomEvent("chart-changed",{detail:this}));return chart}}],[{key:"tag",get:function get(){return"progress-donut"}}]);return ProgressDonut}((0,_schemaBehaviors.SchemaBehaviors)(_simpleColors.SimpleColors));_exports.ProgressDonut=ProgressDonut;window.customElements.define(ProgressDonut.tag,ProgressDonut)});