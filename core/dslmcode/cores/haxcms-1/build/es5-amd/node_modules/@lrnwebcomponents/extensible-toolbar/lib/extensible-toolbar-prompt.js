define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/iron-a11y-keys/iron-a11y-keys.js", "../../simple-popover/simple-popover.js", "../../simple-fields/simple-fields.js", "../buttons/extensible-toolbar-button-styles.js"], function (_exports, _polymerElement, _ironA11yKeys, _simplePopover, _simpleFields, _extensibleToolbarButtonStyles) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.ExtensibleToolbarPrompt = void 0;

  function _templateObject_dc5e3dc0e53211e9a0cfefb808989d41() {
    ...
    _templateObject_dc5e3dc0e53211e9a0cfefb808989d41 = function _templateObject_dc5e3dc0e53211e9a0cfefb808989d41() {
      return data;
    };
   ...
   * @polymer
   */
  var ExtensibleToolbarPrompt =
  /*#__PURE__*/
  function (_PolymerElement) {
    babelHelpers.inherits(ExtensibleToolbarPrompt, _PolymerElement);
    babelHelpers.createClass(ExtensibleToolbarPrompt, null, [{
      key: "template",

      /* REQUIRED FOR TOOLING DO NOT TOUCH */
      // render function
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_dc5e3dc0e53211e9a0cfefb808989d41());
      }
      /**
    ...
    function ExtensibleToolbarPrompt() {
      var _this;

      babelHelpers.classCallCheck(this, ExtensibleToolbarPrompt);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(ExtensibleToolbarPrompt).call(this)); // sets the instance to the current instance

      if (!window.ExtensibleToolbarPrompt.instance) {
        window.ExtensibleToolbarPrompt.instance = babelHelpers.assertThisInitialized(_this);
    ...
    babelHelpers.createClass(ExtensibleToolbarPrompt, [{
      key: "connectedCallback",
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(ExtensibleToolbarPrompt.prototype), "connectedCallback", this).call(this);
    ...
    return ExtensibleToolbarPrompt;
  }(_polymerElement.PolymerElement);

  _exports.ExtensibleToolbarPrompt = ExtensibleToolbarPrompt;
  window.customElements.define(ExtensibleToolbarPrompt.tag, ExtensibleToolbarPrompt);
  // register globally so we can make sure there is only one
  window.ExtensibleToolbarPrompt = window.ExtensibleToolbarPrompt || {}; // request if this exists. This helps invoke the element existing in the dom
  // as well as that there is only one of them. That way we can ensure everything
  // is rendered through the same modal

  window.ExtensibleToolbarPrompt.requestAvailability = function () {
    if (!window.ExtensibleToolbarPrompt.instance) {
      window.ExtensibleToolbarPrompt.instance = document.createElement("extensible-toolbar-prompt");
