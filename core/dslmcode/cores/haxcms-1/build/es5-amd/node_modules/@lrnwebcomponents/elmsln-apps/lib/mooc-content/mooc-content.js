...
if(window.Drupal){window.Drupal.attachBehaviors(document,window.Drupal.settings)}if(window.WCAutoload){window.WCAutoload.process()}// first time this fires let's get the outline block in the background
