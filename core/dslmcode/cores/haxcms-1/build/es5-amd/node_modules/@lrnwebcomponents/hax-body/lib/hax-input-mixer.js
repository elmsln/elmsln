define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/legacy/polymer.dom.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _renderStatus, _polymerDom, _haxSharedStyles) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.HaxImportMixer = void 0;
  _require = babelHelpers.interopRequireWildcard(_require);

  function _templateObject_4f4822c0b3b911e9b58d79562a23326c() {
    ...
    _templateObject_4f4822c0b3b911e9b58d79562a23326c = function _templateObject_4f4822c0b3b911e9b58d79562a23326c() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(HaxImportMixer, _PolymerElement);

    function HaxImportMixer() {
      var _this;

      babelHelpers.classCallCheck(this, HaxImportMixer);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HaxImportMixer).call(this));
    ...
    babelHelpers.createClass(HaxImportMixer, [{
      key: "ready",
      ...
      value: function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(HaxImportMixer.prototype), "ready", this).call(this); // prime methods even though invisible most likely
      ...
      value: function _inputMethodChanged(newValue, oldValue) {
        ...
        if (newValue != null && babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          var method = newValue;
          ...
          if (methods.includes(method)) {
            ...
            setTimeout(function () {
              if (typeof _this2.shadowRoot.querySelector("#input").hideMenu === "function") {
                _this2.shadowRoot.querySelector("#input").hideMenu();
              }
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_4f4822c0b3b911e9b58d79562a23326c());
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    return HaxImportMixer;
  }(_polymerElement.PolymerElement);

  _exports.HaxImportMixer = HaxImportMixer;
