...
for(var i in target.childNodes){// this is crazy... you know that right
if(babelHelpers.typeof(target.childNodes[i])!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){if(1===target.childNodes[i].nodeType){// make sure slots that are named line up
if(settings[value].slot===target.childNodes[i].slot){slot+=target.childNodes[i].innerHTML}}else if(1!==target.childNodes[i].nodeType&&babelHelpers.typeof(target.childNodes[i].textContent)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&""!==target.childNodes[i].textContent){slot+=target.childNodes[i].textContent}}}// @todo verify this stuff actually works
props[settings[value].slot].component.properties.editorValue=slot.trim();if(settings[value].description!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){props[settings[value].slot].description=settings[value].description}}}}return props};/**
     ...
     */this.getHaxJSONSchemaType=function(inputMethod){var methods=_this.validHAXPropertyInputMethod();if(methods.includes(inputMethod)){switch(inputMethod){case"flipboolean":case"boolean":return"boolean";break;case"number":case"slider":return"number";break;case"select":case"textarea":case"colorpicker":case"iconpicker":case"datepicker":case"haxupload":case"markup":case"textfield":case"alt":return"string";break;case"array":return"array";break;default:return"string";break;}}};/**
     * List valid input methods.
     */this.validHAXPropertyInputMethod=function(){var methods=["flipboolean","boolean","select","textfield","textarea","datepicker","haxupload","slider","markup","colorpicker","iconpicker","alt","number","code-editor","array"];return methods};/**
