define(["exports", "meta", "require", "../../../@polymer/polymer/lib/legacy/polymer.dom.js", "../../../@polymer/polymer/lib/utils/resolve-url.js"], function (_exports, meta, _require, _polymerDom, _resolveUrl) {
  "use strict";
  ...
  var HAXWiring = function HAXWiring() {
    ...
    this.getHaxJSONSchema = function (type, haxProperties) {
      ...
      schema.properties = target._getHaxJSONSchemaProperty(settings, target); // support post processing of schema in order to allow for really
    ...
    this._getHaxJSONSchemaProperty = function (settings, target) {
      ...
      for (var value in settings) {
        if (settings.hasOwnProperty(value)) {
          if (babelHelpers.typeof(settings[value].property) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
            props[settings[value].property] = {
              title: settings[value].title,
              type: _this.getHaxJSONSchemaType(settings[value].inputMethod)
            };

            if (babelHelpers.typeof(target[settings[value].property]) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              props[settings[value].property].value = target[settings[value].property];
            }
            ...
            switch (settings[value].inputMethod) {
              ...
              case "array":
                ...
                props[settings[value].property].items = {
                  type: "object",
                  properties: _this._getHaxJSONSchemaProperty(settings[value].properties, target),
              ...
              case "tabs":
                ...
                settings[value].properties.map(function (tab) {
                  tab.inputMethod = "tab";
                  return tab;
                });
                props[settings[value].property].items = {
              ...
              case "tab":
                props[settings[value].property].property = settings[value].property;
                props[settings[value].property].items = {
                  type: "object",
                  properties: _this._getHaxJSONSchemaProperty(settings[value].properties, target),
              ...
              case "iconpicker":
                ...
                var opts = settings[value].options !== undefined && settings[value].options !== null ? settings[value].options : [];
                props[settings[value].property].component.properties.icons = opts;
                break;
            ...
            if (settings[value].hidden !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              props[settings[value].property].hidden = settings[value].hidden;
            }

            if (settings[value].description !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              props[settings[value].property].description = settings[value].description;
            }
          } else if (babelHelpers.typeof(settings[value].attribute) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
            ...
            } else if (babelHelpers.typeof(target.attributes[settings[value].attribute]) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              props[settings[value].attribute].value = target.getAttribute(settings[value].attribute);
            ...
            if (settings[value].description !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              props[settings[value].attribute].description = settings[value].description;
            }
          } else {
            ...
            var slot = ""; // test for slotted content values names is tricky

            for (var i in (0, _polymerDom.dom)(target).childNodes) {
              // this is crazy... you know that right
              if (babelHelpers.typeof((0, _polymerDom.dom)(target).childNodes[i]) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                if ((0, _polymerDom.dom)(target).childNodes[i].nodeType === 1) {
                  // make sure slots that are named line up
                  if (settings[value].slot === (0, _polymerDom.dom)(target).childNodes[i].slot) {
                    slot += (0, _polymerDom.dom)(target).childNodes[i].innerHTML;
                  }
                } else if ((0, _polymerDom.dom)(target).childNodes[i].nodeType !== 1 && babelHelpers.typeof((0, _polymerDom.dom)(target).childNodes[i].textContent) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && (0, _polymerDom.dom)(target).childNodes[i].textContent !== "") {
                  slot += (0, _polymerDom.dom)(target).childNodes[i].textContent;
                }
              }
            } // @todo verify this stuff actually works


            props[settings[value].slot].component.properties.editorValue = slot.trim();

            if (settings[value].description !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              props[settings[value].slot].description = settings[value].description;
            }
          }
        }
      }
    ...
    this.validHAXPropertyInputMethod = function () {
      var methods = ["flipboolean", "boolean", "select", "textfield", "textarea", "datepicker", "haxupload", "markup", "colorpicker", "iconpicker", "alt", "number", "code-editor", "array"];
      return methods;
    };
    /**
    ...
    return (
      ...
      function (_SuperClass) {
        ...
        babelHelpers.createClass(_class, [{
          ...
          value: function _getHaxJSONSchemaProperty(settings, target) {
  ...
  window.HAXBehaviors.PropertiesBehaviors = {
     ...
     * correctly with support for recursive nesting thx to objects / arrays.
     */
    _getHaxJSONSchemaProperty: function _getHaxJSONSchemaProperty(settings, target) {
