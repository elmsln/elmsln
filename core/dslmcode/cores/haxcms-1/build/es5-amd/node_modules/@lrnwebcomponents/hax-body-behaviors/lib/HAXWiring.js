define(["exports", "meta", "require", "../../simple-fields/simple-fields.js"], function (_exports, meta, _require, _simpleFields) {
  "use strict";
  ...
  var HAXWiring = function HAXWiring() {
    ...
    this.getHaxJSONSchema = function (type, haxProperties) {
      ...
      schema.properties = _simpleFields.SimpleFields.fieldsToSchema(settings); // support post processing of schema in order to allow for really
    ...
    this._getHaxJSONSchemaProperty = function (settings) {
      return _simpleFields.SimpleFields.fieldsToSchema(settings);
    };
    /**
    ...
    this.getHaxJSONSchemaType = function (inputMethod) {
      var method = _simpleFields.SimpleFields.fieldsConversion.inputMethod[inputMethod] || _simpleFields.SimpleFields.fieldsConversion;
    ...
    this.validHAXPropertyInputMethod = function () {
      var methods = Object.keys(_simpleFields.SimpleFields.fieldsConversion.inputMethod);
      return methods;
    };
    /**
