            ...
            (function () {
              switch (settings[value].inputMethod) {
                ...
                case "select":
                  ...
                  for (option in settings[value].options) {
                    var item = [{
                ...
                case "array":
                  props[settings[value].property].items = {
                    type: "object",
                    properties: target._getHaxJSONSchemaProperty(settings[value].properties, target),
                ...
                case "tabs":
                  var tabprops = {};
                  settings[value].properties.forEach(function (tabprop) {
                    tabprops[tabprop.property] = {
                      title: tabprop.title,
                      items: {
                        properties: target._getHaxJSONSchemaProperty(tabprop.properties, target)
                      }
                    };
                  });
