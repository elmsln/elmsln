define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../utils/utils.js", "../undo-manager/undo-manager.js"], function (_exports, _require, _litElement, _simpleColors, _utils, _undoManager) {
  ...
  function _templateObject2_2ead3a90019d11eb9027c17497ee62cd() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n    "]);

    _templateObject2_2ead3a90019d11eb9027c17497ee62cd = function _templateObject2_2ead3a90019d11eb9027c17497ee62cd() {
      return data;
    };
  ...
  function _templateObject_2ead3a90019d11eb9027c17497ee62cd() {
    ...
    _templateObject_2ead3a90019d11eb9027c17497ee62cd = function _templateObject_2ead3a90019d11eb9027c17497ee62cd() {
      return data;
    };
  ...
  var HaxBody = /*#__PURE__*/function (_UndoManagerBehaviors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_2ead3a90019d11eb9027c17497ee62cd())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_2ead3a90019d11eb9027c17497ee62cd());
      }
      /**
      ...
      value: function connectedCallback() {
        ...
        this._observer = new MutationObserver(function (mutations) {
          ...
          if (!_this5.__mouseMoving && !_this5.undoStackIgnore && !_this5.__fakeEndCap) {
          ...
          else if (_this5.undoStackIgnore) {
              mutations.forEach(function (mutation) {
                if (mutation.addedNodes.length > 0) {
                  mutation.addedNodes.forEach(function (node) {
        ...
        if (!this.openDrawer && this.editMode && !this.__tabTrap) {
          ...
          if (this._validElementTest(containerNode) && containerNode.parentNode && containerNode.parentNode.tagName) {
            ...
            if (this.activeNode !== activeNode && !activeNode.classList.contains("ignore-activation")) {
              ...
              setTimeout(function () {
                if (!_this15.__mouseDown && window.HaxStore.instance.isTextElement(activeNode)) {
                  try {
                    var range = document.createRange();
                    var sel = window.HaxStore.getSelection();
                ...
                _this15.positionContextMenus(activeNode, activeNode);
              }, 0);
              stopProp = true;
            }
          }
      ...
      value: function _editModeChanged(newValue, oldValue) {
        ...
        if (babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          setTimeout(function () {
            _this18.undoStack.undoStackLimit = 20;
      ...
      value: function undoManagerStackLogic(mutations) {
        if (!this.__mouseMoving) {
          var children = this.querySelectorAll(".hax-mover, .hax-hovered, .hax-moving, .grid-plate-active-item");
          ...
          try {
            ...
            if (e.dataTransfer && e.dataTransfer.items && e.dataTransfer.items.length > 0 && e.dataTransfer.items[0].kind === "file") {
              ...
              if (target && typeof target.focus === "function") {
                ...
                setTimeout(function () {
                  _this20.scrollHere(_this20.activeNode);

                  _this20.positionContextMenus();
                }, 0);
              }
            }
          } catch (e) {
