define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../utils/utils.js"], function (_exports, _require, _litElement, _simpleColors, _utils) {
  ...
  function _templateObject2_54c03930f9d711eab0a41741e72b3233() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n    "]);

    _templateObject2_54c03930f9d711eab0a41741e72b3233 = function _templateObject2_54c03930f9d711eab0a41741e72b3233() {
      return data;
    };
  ...
  function _templateObject_54c03930f9d711eab0a41741e72b3233() {
    ...
    _templateObject_54c03930f9d711eab0a41741e72b3233 = function _templateObject_54c03930f9d711eab0a41741e72b3233() {
      return data;
    };
  ...
  var HaxBody = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_54c03930f9d711eab0a41741e72b3233())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_54c03930f9d711eab0a41741e72b3233());
      }
      /**
      ...
      value: function firstUpdated(changedProperties) {
        ...
        this.shadowRoot.querySelector("slot").addEventListener("mouseup", function (e) {
          if (!_this3.openDrawer && _this3.editMode) {
            setTimeout(function () {
              var tmp = window.HaxStore.getSelection();
              window.HaxStore._tmpSelection = tmp;
              window.HaxStore.write("haxSelectedText", tmp.toString(), _this3);
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "globalPreferences") {
            _this4._globalPreferencesUpdated(_this4[propName], oldValue);
          }

          if (propName == "activeNode" && _this4.__ready) {
            _this4._activeNodeChanged(_this4[propName], oldValue); // notify


            _this4.dispatchEvent(new CustomEvent("active-node-changed", {
              detail: {
          ...
          if (propName == "activeContainerNode" && _this4.__ready) {
            _this4._activeContainerNodeChanged(_this4[propName], oldValue); // notify


            _this4.dispatchEvent(new CustomEvent("active-container-node-changed", {
              detail: {
                value: _this4[propName]
              }
            }));
      ...
      value: function connectedCallback() {
        ...
        setTimeout(function () {
          ...
          window.addEventListener("resize", _this5._keepContextVisible.bind(_this5));
        }, 0);
      }
      /**
       * HTMLElement
      ...
      value: function _keepContextVisible() {
        ...
        if (!this.openDrawer && this.editMode) {
          ...
          this.__contextVisibleLock = setTimeout(function () {
            ...
            if (el) {
              if (_this6.elementMidViewport()) {
                el.classList.add("hax-context-pin-top");

                _this6.shadowRoot.querySelector("#platecontextmenu").classList.add("hax-context-pin-top");
              } else {
                el.classList.remove("hax-context-pin-top");

                _this6.shadowRoot.querySelector("#platecontextmenu").classList.remove("hax-context-pin-top");
              }
      ...
      value: function haxDuplicateNode(node) {
        ...
        var parent = node.parentNode; // convert the node to a hax element
      ...
      value: function positionContextMenus() {
        ...
        this.__positionContextTimer = setTimeout(function () {
          if (node && !window.HaxStore.instance._lockContextPosition && _this12.__ready) {
            ...
            if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !window.HaxStore.instance.isTextElement(node)) {
              _this12._hideContextMenu(_this12.shadowRoot.querySelector("#textcontextmenu"));

              props.element = node;

              _this12._positionContextMenu(_this12.shadowRoot.querySelector("#cecontextmenu"), container, -1, -30);

              menuWidth += 28;
            } else {
              _this12._hideContextMenu(_this12.shadowRoot.querySelector("#cecontextmenu"));

              _this12._positionContextMenu(_this12.shadowRoot.querySelector("#textcontextmenu"), container, -1, -30); // text menu can expand based on selection


              var textRect = _this12.shadowRoot.querySelector("#textcontextmenu").getBoundingClientRect();
            ...
            if (container) {
              ...
              if (Math.round(menuWidth) >= Math.round(activeRect.width)) {
                _this12._positionContextMenu(_this12.shadowRoot.querySelector("#platecontextmenu"), container, -1, -58);
              } else {
                _this12._positionContextMenu(_this12.shadowRoot.querySelector("#platecontextmenu"), container, activeRect.width - _this12.shadowRoot.querySelector("#platecontextmenu").getBoundingClientRect().width + 2, -28);
              }
      ...
      value: function haxMoveGridPlate(direction, node, container) {
        ...
        setTimeout(function () {
          ...
          _this13.positionContextMenus(node, node);
        }, 10);
        return true;
      }
      /**
      ...
      key: "haxGridPlateOps",
      value: function () {
        var _haxGridPlateOps = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(node, side) {
          var _this14 = this;
              ...
              switch (_context.prev = _context.next) {
                ...
                case 51:
                  ...
                  setTimeout(function () {
                    ...
                    _this14.activeContainerNode = grid;
                    window.HaxStore.write("activeContainerNode", grid, _this14);
        ...
        if (!this.openDrawer && this.editMode && !this.__tabTrap) {
          ...
          if (this._validElementTest(containerNode) && containerNode.parentNode && containerNode.parentNode.tagName) {
            ...
            if (this.activeNode !== activeNode && !activeNode.classList.contains("ignore-activation")) {
              ...
              setTimeout(function () {
                _this17.positionContextMenus(activeNode, activeNode);
              }, 0);
              stopProp = true;
            }
          }
      ...
      value: function _editModeChanged(newValue, oldValue) {
        ...
        if (babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          if (newValue) {
            ...
            setTimeout(function () {
              if (_this18.children && _this18.children[0] && _this18.children[0].focus) {
                _this18.activeNode = _this18.children[0];
                _this18.activeContainerNode = _this18.activeNode;
                window.HaxStore.write("activeNode", _this18.children[0], _this18);
                window.HaxStore.write("activeContainerNode", _this18.children[0], _this18);
                setTimeout(function () {
                  if (window.HaxStore.instance.isTextElement(_this18.activeNode)) {
                    try {
                      var range = document.createRange();
                      var sel = window.HaxStore.getSelection();
                      range.setStart(_this18.activeNode, 0);
                      range.collapse(true);
                      sel.removeAllRanges();
                      sel.addRange(range);

                      _this18.activeNode.focus();
                    } catch (e) {
                      console.warn(e);
                    }
                ...
                setTimeout(function () {
                  try {
                    ...
                    _this18.activeContainerNode = _this18.activeNode;
                    window.HaxStore.write("activeContainerNode", _this18.activeContainerNode, _this18);
                  } catch (e) {
                    console.warn(e);
                  }
      ...
      value: function dropEvent(e) {
        ...
        if (!this.openDrawer && this.editMode) {
          ...
          setTimeout(function () {
            var children = _this19.querySelectorAll(".hax-mover, .hax-hovered, .hax-moving, .grid-plate-active-item");
              ...
              if (babelHelpers.typeof(children[i].classList) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                ...
                if (children[i].tagName === "GRID-PLATE") {
                  ...
                  for (var j in children[i].children) {
                    if (babelHelpers.typeof(children[i].children[j].classList) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          try {
            ...
            if (e.dataTransfer && e.dataTransfer.items && e.dataTransfer.items.length > 0 && e.dataTransfer.items[0].kind === "file") {
              ...
              if (target && typeof target.focus === "function") {
                ...
                setTimeout(function () {
                  if (typeof _this19.activeNode.scrollIntoViewIfNeeded === "function") {
                    _this19.activeNode.scrollIntoViewIfNeeded(true);
                  } else {
                    _this19.activeNode.scrollIntoView({
                      behavior: "smooth",
                      inline: "center"
                    });
                  }

                  _this19.positionContextMenus();
                }, 250);
              }
            }
          } catch (e) {
