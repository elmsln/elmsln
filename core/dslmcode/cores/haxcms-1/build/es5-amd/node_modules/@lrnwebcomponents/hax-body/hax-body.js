define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../utils/utils.js", "../undo-manager/undo-manager.js", "./lib/hax-store.js", "../../mobx/dist/mobx.esm.js"], function (_exports, meta, _require, _litElement, _simpleColors, _utils, _undoManager, _haxStore, _mobxEsm) {
  ...
  function _templateObject2_523fec7029e611eb8d6d659e8e3deb86() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n      <hax-context-item\n        id=\"addincontext\"\n        class=\"hax-context-menu ignore-activation\"\n        icon=\"icons:add-circle\"\n        label=\"Add here\"\n        mini\n        circle\n      >\n      </hax-context-item>\n    "]);

    _templateObject2_523fec7029e611eb8d6d659e8e3deb86 = function _templateObject2_523fec7029e611eb8d6d659e8e3deb86() {
      return data;
    };
  ...
  function _templateObject_523fec7029e611eb8d6d659e8e3deb86() {
    ...
    _templateObject_523fec7029e611eb8d6d659e8e3deb86 = function _templateObject_523fec7029e611eb8d6d659e8e3deb86() {
      return data;
    };
  ...
  var HaxBody = /*#__PURE__*/function (_UndoManagerBehaviors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_523fec7029e611eb8d6d659e8e3deb86())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_523fec7029e611eb8d6d659e8e3deb86());
      }
      /**
        ...
        for (var i = 0, len = children.length; i < len; i++) {
          ...
          if (this._validElementTest(children[i])) {
            ...
            // yet we need to remove from output as they do not really exist :)
                ...
                var tmp = _haxStore.HAXStore.runHook(children[i], "activeChanged", [this.activeNode, false]);
        ...
        this.__positionContextTimer = setTimeout(function () {
          if (node && node.tagName && !_haxStore.HAXStore._lockContextPosition && _this11.__ready) {
            ...
            if (props.editingElement == "core") {
              ...
              setTimeout(function () {
                var activeRect = node.parentNode.getBoundingClientRect();

                _this11._positionContextMenu(_this11.contextMenus.plate, node.parentNode, activeRect.width - _this11.contextMenus.plate.getBoundingClientRect().width + 1, -26);
              }, 250);
                ...
                case 2:
                  ...
                  if (oldValue) {
                    ...
                    if (oldSchema.editingElement != "core") {
                      ...
                      replacement = _haxStore.HAXStore.runHook(this.__activeEditingElement, "activeChanged", [oldValue, false]);
