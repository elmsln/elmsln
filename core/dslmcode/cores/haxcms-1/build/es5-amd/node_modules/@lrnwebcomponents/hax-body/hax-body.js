define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../utils/utils.js"], function (_exports, _require, _litElement, _simpleColors, _utils) {
  ...
  function _templateObject2_abdce2d01bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n      <hax-input-mixer\n        id=\"haxinputmixer\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-input-mixer>\n    "]);

    _templateObject2_abdce2d01bb211eabd7cc30119585ddb = function _templateObject2_abdce2d01bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject_abdce2d01bb211eabd7cc30119585ddb() {
    ...
    _templateObject_abdce2d01bb211eabd7cc30119585ddb = function _templateObject_abdce2d01bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_abdce2d01bb211eabd7cc30119585ddb())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_abdce2d01bb211eabd7cc30119585ddb());
      }
      /**
      ...
      value: function firstUpdated(changedProperties) {
        ...
        this.addEventListener("mousedown", this._focusIn.bind(this)); // in case we miss this on the initial setup. possible in auto opening environments.
            ...
            if (mutation.addedNodes.length > 0) {
              mutation.addedNodes.forEach(function (node) {
                if (_this3._validElementTest(node)) {
                  if (_this3._HTMLPrimativeTest(node)) {
                    node.contentEditable = _this3.editMode;
                  } // this does the real targetting


                  node.setAttribute("data-editable", _this3.editMode);
          ...
          switch (e.key) {
            ...
            case "ArrowRight":
              setTimeout(function () {
                ...
                if (rng.commonAncestorContainer && _this4.activeNode !== rng.commonAncestorContainer && typeof rng.commonAncestorContainer.focus === "function") {
                  if (rng.commonAncestorContainer.tagName !== "HAX-BODY") {
                    ...
                    _this4.__focusLogic(rng.commonAncestorContainer);
                  }
                } // need to check on the parent too if this was a text node
                else if (rng.commonAncestorContainer && rng.commonAncestorContainer.parentNode && _this4.activeNode !== rng.commonAncestorContainer.parentNode && typeof rng.commonAncestorContainer.parentNode.focus === "function") {
                    if (rng.commonAncestorContainer.parentNode.tagName !== "HAX-BODY") {
                      ...
                      _this4.__focusLogic(rng.commonAncestorContainer.parentNode);
                    }
                  }
              }, 50);
              break;
      ...
      value: function _onKeyPress(e) {
        ...
        if (!this.openDrawer && this.editMode && this.shadowRoot.querySelector("#platecontextmenu").classList.contains("hax-active-hover")) {
          this.__dropActiveHover();
          ...
          this.positionContextTimer = setTimeout(function () {
            // always on active if we were just typing
            _this5.positionContextMenus(_this5.activeNode, _this5.activeNode);
          }, 2000);
        }
      }
      /**
      ...
      value: function replacePlaceholder(e) {
        ...
        if (e.detail === "text") {
          ...
          setTimeout(function () {
            ...
            _this6.activeNode = p;
            window.HaxStore.write("activeNode", p, _this6);

            _this6.activeContainerNode.setAttribute("contenteditable", true); // focus on it


            p.focus();

            _this6.__focusLogic(p);
          }, 210);
        } else {
      ...
      value: function haxDuplicateNode(node) {
        ...
        setTimeout(function () {
          ...
          if (parent === _this8) {
            window.HaxStore.write("activeContainerNode", nodeClone, _this8);
          }

          window.HaxStore.write("activeNode", nodeClone, _this8);
        }, 100);
        return true;
      }
      /**
      ...
      value: function positionContextMenus(node, container) {
        if (node) {
          ...
          if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !window.HaxStore.instance.isTextElement(node)) {
            this.__activeContextType = this.shadowRoot.querySelector("#cecontextmenu");
            props.element = node;

            this.__activeContextType.setHaxProperties(props);
          } else {
            this.__activeContextType = this.shadowRoot.querySelector("#textcontextmenu");
          }

          this._positionContextMenu(this.__activeContextType, node, -39, -39);

          this._positionContextMenu(this.shadowRoot.querySelector("#platecontextmenu"), container, -39, 0); // special case for node not matching container
      ...
      value: function haxMoveGridPlate(direction, node, container) {
        ...
        setTimeout(function () {
          _this9.positionContextMenus(node, container);
      ...
      value: function haxChangeTagName(node, tagName, newNode) {
        ...
        try {
          this.replaceChild(replacement, node); // focus on the thing switched to
          ...
          while (fragment.firstChild !== null) {
            if (babelHelpers.typeof(fragment.firstChild.tagName) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              ...
              if (window.HaxStore.instance._isSandboxed && fragment.firstChild.tagName.toLowerCase() === "iframe") {
                ...
                _this10.appendChild(replacement);
              } else {
                _this10.appendChild(fragment.firstChild);
              }
            } else {
      ...
      value: function _haxContextOperation(e) {
        ...
        switch (detail.eventName) {
          ...
          case "code":
            ...
            this.shadowRoot.querySelector("#textcontextmenu").realSelectedValue = detail.eventName;
          ...
          case "hax-align-left":
            ...
            this.activeNode.style.display = null; // animation forces us to have to wait to position

            setTimeout(function () {
              _this11.positionContextMenus(_this11.activeNode, _this11.activeContainerNode);
            }, 200);
            break;
          ...
          case "hax-align-center":
            ...
            this.activeNode.style.display = "block"; // animation forces us to have to wait to position
          ...
          case "hax-size-change":
            if (this.activeNode) {
              this.activeNode.style.width = detail.value + "%"; // animation forces us to have to wait to position
            ...
            if (status) {
              ...
              if (children[i].querySelectorAll("a").length > 0) {
                ...
                for (var j = 0, len2 = _links.length; j < len2; j++) {
                  _links[j].removeAttribute("data-editable");

                  _links[j].removeAttribute("contenteditable");
      ...
      value: function _activeNodeChanged(newValue, oldValue) {
        ...
        if (this.editMode && babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue !== null) {
          ...
          if (window.HaxStore.instance.isTextElement(newValue) || window.HaxStore.instance.isGridPlateElement(newValue)) {
            ...
            clearTimeout(this.positionContextTimer);
            this.positionContextTimer = setTimeout(function () {
              _this12.positionContextMenus(newValue, newValue);
            }, 1000);
          } else {
            newValue.removeAttribute("contenteditable");
            this.removeAttribute("contenteditable");
      ...
      key: "properties",
      get: function get() {
        return babelHelpers.objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "properties", this), {
          openDrawer: {
            type: Object
          },
