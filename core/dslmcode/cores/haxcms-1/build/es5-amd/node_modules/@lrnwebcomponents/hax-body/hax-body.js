...
if(status){(0,_haxutils.wipeSlot)(this)}}/**
   ...
   */},{key:"haxInsert",value:function haxInsert(tag,content){var _this5=this,properties=2<arguments.length&&arguments[2]!==void 0?arguments[2]:{},waitForLock=3<arguments.length&&arguments[3]!==void 0?arguments[3]:!0;this.__activeHover=null;// verify this tag is a valid one
...
if(this._haxElementTest(children[i])){children[i].removeAttribute("data-editable");children[i].removeAttribute("data-hax-ray");children[i].contentEditable=!1;content+=window.HaxStore.nodeToContent(children[i]);if("grid-plate"===children[i].tagName.toLowerCase()){this._applyContentEditable(this.editMode,children[i])}}// keep comments with a special case since they need wrapped
...
if(this.editMode&&!this.__tabTrap){var containerNode=target,activeNode=null;// ensure this is valid
