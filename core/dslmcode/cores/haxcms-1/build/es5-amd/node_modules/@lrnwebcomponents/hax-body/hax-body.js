define(["exports", "meta", "require", "../../lit/index.js", "../simple-colors/simple-colors.js", "../undo-manager/undo-manager.js", "./lib/hax-store.js", "../../mobx/dist/mobx.esm.js", "./lib/hax-text-editor-toolbar.js", "../utils/utils.js", "./lib/hax-ui-styles.js", "../i18n-manager/lib/I18NMixin.js", "../absolute-position-behavior/absolute-position-behavior.js"], function (_exports, meta, _require, _index, _simpleColors, _undoManager, _haxStore, _mobxEsm, _haxTextEditorToolbar, _utils, _haxUiStyles, _I18NMixin2, _absolutePositionBehavior) {
  ...
  var _templateObject_8a81f370f9f811eba5a28d25d08c9378, _templateObject2_8a81f370f9f811eba5a28d25d08c9378;
  ...
  var HaxBody = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_8a81f370f9f811eba5a28d25d08c9378 || (_templateObject_8a81f370f9f811eba5a28d25d08c9378 = babelHelpers.taggedTemplateLiteral(["\n      <div\n        id=\"bodycontainer\"\n        class=\"ignore-activation\"\n        element-align=\"", "\"\n      >\n        <slot id=\"body\"></slot>\n      </div>\n      <absolute-position-behavior\n        id=\"topcontext\"\n        fit-to-visible-bounds\n        justify\n        position=\"top\"\n        auto\n        sticky\n        data-node-type=\"", "\"\n        .target=\"", "\"\n        ?hidden=\"", "\"\n      >\n        <div id=\"topcontextmenu\">\n          <hax-plate-context\n            id=\"platecontextmenu\"\n            class=\"hax-context-menu ignore-activation\"\n            .activeNode=\"", "\"\n            .trayDetail=\"", "\"\n            .trayStatus=\"", "\"\n            ?viewSource=\"", "\"\n            ?canMoveElement=\"", "\"\n          ></hax-plate-context>\n          <hax-text-editor-toolbar\n            id=\"textcontextmenu\"\n            class=\"hax-context-menu ignore-activation\"\n            .activeNode=\"", "\"\n            show=\"always\"\n          >\n          </hax-text-editor-toolbar>\n        </div>\n      </absolute-position-behavior>\n    "])), this.elementAlign || "right", !this.activeNode ? "" : this.viewSourceToggle ? this.activeNode.parentNode.tagName : this.activeNode.tagName, !this.activeNode ? document.body : this.viewSourceToggle ? this.activeNode.parentNode : this.activeNode, !this.activeNode, this.activeNode, this.trayDetail, this.trayStatus, this.viewSourceToggle, this.canMoveElement, this.activeNode);
      }
      /**
      ...
      value: function _onKeyPress(e) {
        ...
        var next = this.activeNode.nextElementSibling;
        if (e.key === "Enter") this.setActiveNode(this.activeNode.nextElementSibling); //needed so that you can add new paragraphs before and element
      ...
      value: function setActiveNode(node) {
        ...
        if (node && this.editMode && this.activeNode && _haxStore.HAXStore.isTextElement(this.activeNode)) {
      ...
      value: function getAllSlotConfig(grid) {
      ...
      value: function getSlotConfig() {
        ...
        var settings = props.settings,
          ...
          return settings[group].filter(function (setting) {
            return !!setting.slot && (!slotName || setting.slot === slotName);
          });
        }).flat() : undefined;
      ...
      value: function () {
        var _haxContextOperation2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(e) {
          ...
          var detail, eventPath, p, _slot, _p, target, replacement, oldSchema, i, _replacement, _oldSchema;

          return regeneratorRuntime.wrap(function _callee10$(_context10) {
            while (1) {
              switch (_context10.prev = _context10.next) {
                case 0:
                  detail = e.detail, eventPath = (0, _utils.normalizeEventPath)(e); // support a simple insert event to bubble up or everything else

                  _context10.t0 = detail.eventName;
                  _context10.next = _context10.t0 === "insert-above-active" ? 4 : _context10.t0 === "insert-below-active" ? 6 : _context10.t0 === "insert-into-active" ? 8 : _context10.t0 === "select-parent-grid" ? 11 : _context10.t0 === "hax-source-view-toggle" ? 13 : _context10.t0 === "hax-full-text-editor-toggle" ? 48 : _context10.t0 === "text-tag" ? 65 : _context10.t0 === "text-tag-ul" ? 68 : _context10.t0 === "text-tag-ol" ? 72 : _context10.t0 === "text-align-left" ? 76 : _context10.t0 === "hax-transform-node" ? 78 : _context10.t0 === "hax-plate-create-right" ? 80 : _context10.t0 === "hax-plate-remove-right" ? 82 : _context10.t0 === "hax-plate-duplicate" ? 84 : _context10.t0 === "hax-plate-delete" ? 86 : _context10.t0 === "hax-plate-up" ? 88 : _context10.t0 === "hax-plate-down" ? 90 : _context10.t0 === "content-edit" ? 92 : 95;
                  break;
                ...
                case 4:
                  ...
                  return _context10.abrupt("break", 95);
                ...
                case 8:
                  _slot = !eventPath || !eventPath[0] ? undefined : eventPath[0].getAttribute("data-slot");

                  if (_slot && this.activeNode && _haxStore.HAXStore.isGridPlateElement(this.activeNode)) {
                ...
                case 11:
                  if (this.activeNode && this.activeNode.parentNode && _haxStore.HAXStore.isGridPlateElement(this.activeNode.parentNode)) {
                    target = this.activeNode.parentNode;
      ...
      value: function __applyDragDropState(layout, haxRay) {
        ...
        var events = {
          drop: function drop(e) {
            return _this20.__layoutDropEvent(e, layout).bind(_this20);
          },
          ...
          return regeneratorRuntime.wrap(function _callee13$(_context13) {
            while (1) {
              switch (_context13.prev = _context13.next) {
                ...
                case 3:
                  //prevent mutation
                  if (!!newValue && !!oldValue && oldValue.parentNode === newValue && _haxStore.HAXStore.isGridPlateElement(newValue)) {
                    this.__ignoreActive = true;
                  }
