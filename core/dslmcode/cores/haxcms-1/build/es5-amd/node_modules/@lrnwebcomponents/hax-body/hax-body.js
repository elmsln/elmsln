define(["exports", "meta", "require", "../../lit/index.js", "../simple-colors/simple-colors.js", "../undo-manager/undo-manager.js", "./lib/hax-store.js", "../../mobx/dist/mobx.esm.js", "./lib/hax-text-editor-toolbar.js", "../utils/utils.js", "./lib/hax-ui-styles.js", "../i18n-manager/lib/I18NMixin.js", "../absolute-position-behavior/absolute-position-behavior.js", "../simple-icon/lib/simple-icons.js", "../simple-icon/lib/simple-iconset.js"], function (_exports, meta, _require, _index, _simpleColors, _undoManager, _haxStore, _mobxEsm, _haxTextEditorToolbar, _utils, _haxUiStyles, _I18NMixin2, _absolutePositionBehavior, _simpleIcons, _simpleIconset) {
  ...
  var _templateObject_e9268f00514e11ec8e7319d78c6833b8, _templateObject2_e9268f00514e11ec8e7319d78c6833b8;
  ...
  var HaxBody = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_e9268f00514e11ec8e7319d78c6833b8 || (_templateObject_e9268f00514e11ec8e7319d78c6833b8 = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host([edit-mode]) #bodycontainer ::slotted(*[data-hax-lock])::after {\n          background-image: url(\"", "\");\n        }\n      </style>\n      <div\n        id=\"bodycontainer\"\n        class=\"ignore-activation\"\n        element-align=\"", "\"\n      >\n        <slot id=\"body\"></slot>\n      </div>\n      <absolute-position-behavior\n        id=\"topcontext\"\n        fit-to-visible-bounds\n        justify\n        position=\"top\"\n        allow-overlap\n        auto\n        sticky\n        data-node-type=\"", "\"\n        .target=\"", "\"\n        .trayStatus=\"", "\"\n        ?hidden=\"", "\"\n      >\n        <div id=\"topcontextmenu\">\n          <hax-plate-context\n            id=\"platecontextmenu\"\n            class=\"hax-context-menu ignore-activation\"\n            .activeNode=\"", "\"\n            .trayDetail=\"", "\"\n            .trayStatus=\"", "\"\n            ?viewSource=\"", "\"\n            ?canMoveElement=\"", "\"\n          ></hax-plate-context>\n          <hax-text-editor-toolbar\n            id=\"textcontextmenu\"\n            class=\"hax-context-menu ignore-activation ", "\"\n            .activeNode=\"", "\"\n            show=\"always\"\n          >\n          </hax-text-editor-toolbar>\n        </div>\n      </absolute-position-behavior>\n    "])), this.__lockIconPath, this.elementAlign || "right", !this.activeNode ? "" : this.viewSourceToggle ? this.activeNode.parentNode.tagName : this.activeNode.tagName, !this.activeNode ? document.body : this.viewSourceToggle ? this.activeNode.parentNode : this.activeNode, this.trayStatus, !this.activeNode, this.activeNode, this.trayDetail, this.trayStatus, this.viewSourceToggle, this.canMoveElement, !this.activeNode || this.activeNode.getAttribute("data-hax-lock") || this.activeNode.parentNode && this.activeNode.parentNode.getAttribute("data-hax-lock") || !_haxStore.HAXStore.isTextElement(this.activeNode) ? "not-text" : "is-text", this.activeNode);
      }
      /**
      ...
      value: function () {
        var _haxContextOperation2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(e) {
          ...
          var detail, eventPath, slot, p, _p, target, data, _target, _slot, _i, grid, editMode, nodePosition, targetItem, replacement, oldSchema, i, _replacement, _oldSchema;
            ...
            while (1) {
              switch (_context10.prev = _context10.next) {
                case 0:
                  ...
                  _context10.next = _context10.t0 === "insert-above-active" ? 4 : _context10.t0 === "insert-below-active" ? 6 : _context10.t0 === "move-to-slot" ? 8 : _context10.t0 === "insert-into-active" ? 10 : _context10.t0 === "hax-select-grid" ? 12 : _context10.t0 === "hax-select-grid-item" ? 14 : _context10.t0 === "hax-source-view-toggle" ? 16 : _context10.t0 === "hax-full-text-editor-toggle" ? 51 : _context10.t0 === "text-tag" ? 68 : _context10.t0 === "text-tag-ul" ? 71 : _context10.t0 === "text-tag-ol" ? 75 : _context10.t0 === "text-align-left" ? 79 : _context10.t0 === "hax-transform-node" ? 81 : _context10.t0 === "hax-plate-create-right" ? 83 : _context10.t0 === "hax-plate-remove-right" ? 85 : _context10.t0 === "hax-plate-duplicate" ? 87 : _context10.t0 === "hax-plate-delete" ? 89 : _context10.t0 === "hax-plate-up" ? 91 : _context10.t0 === "hax-plate-down" ? 93 : _context10.t0 === "content-edit" ? 95 : 98;
                  break;
                ...
                case 4:
                  ...
                  return _context10.abrupt("break", 98);
                ...
                case 14:
                  if (eventPath[0] && eventPath[0].eventData) {
                    data = eventPath[0].eventData, _target = data.target, _slot = data.slot, _i = data.index, grid = data.grid, editMode = data.editMode, nodePosition = function nodePosition() {
                      ...
                      var matches = babelHelpers.toConsumableArray(grid.children).filter(function (child) {
                        return !_slot || _slot === "" ? !child.slot || child.slot === "" : child.slot === _slot;
                      }),
                          newTarget = matches.length > _i ? matches[_i] : _target;
                    ...
                    if (grid && editMode) {
                      this.setGridEditMode(grid, editMode); //make sure we target correct slot after dom changes
      ...
      key: "unsetGridEditMode",
      value: function unsetGridEditMode(node) {
      ...
      key: "setGridEditMode",
      value: function setGridEditMode(node, settings) {
          ...
          return regeneratorRuntime.wrap(function _callee13$(_context13) {
            while (1) {
              switch (_context13.prev = _context13.next) {
                ...
                case 47:
                  if (oldValue && oldValue.parentNode && (!newValue || !newValue.parentNode || newValue.parentNode !== oldValue.parentNode)) this.unsetGridEditMode(oldValue.parentNode);
