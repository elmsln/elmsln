define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../undo-manager/undo-manager.js", "./lib/hax-store.js", "../../mobx/dist/mobx.esm.js", "../utils/utils.js"], function (_exports, meta, _require, _litElement, _simpleColors, _undoManager, _haxStore, _mobxEsm, _utils) {
  ...
  function _templateObject2_bcc2b0f056b411ebb2c24bb50d8f41ab() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n      <hax-context-item\n        id=\"addincontext\"\n        class=\"hax-context-menu ignore-activation\"\n        icon=\"icons:add-circle\"\n        label=\"Add here\"\n        mini\n        circle\n      >\n      </hax-context-item>\n    "]);

    _templateObject2_bcc2b0f056b411ebb2c24bb50d8f41ab = function _templateObject2_bcc2b0f056b411ebb2c24bb50d8f41ab() {
      return data;
    };
  ...
  function _templateObject_bcc2b0f056b411ebb2c24bb50d8f41ab() {
    ...
    _templateObject_bcc2b0f056b411ebb2c24bb50d8f41ab = function _templateObject_bcc2b0f056b411ebb2c24bb50d8f41ab() {
      return data;
    };
  ...
  var HaxBody = /*#__PURE__*/function (_UndoManagerBehaviors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_bcc2b0f056b411ebb2c24bb50d8f41ab())]);
      }
      /**
       * HTMLElement
       */
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function _mouseMove(e) {
        ...
        if (this.editMode && _haxStore.HAXStore.ready) {
          ...
          this.__mouseQuickTimer = setTimeout(function () {
            if (_this2.__activeHover && _this2.__activeHover != eventPath[0].closest("[data-hax-ray]:not(li)") && !eventPath[0].closest("#addincontext")) {
              var keep;
          ...
          this.__mouseTimer = setTimeout(function () {
            ...
            if (target) {
              ...
              if (!eventPath[0].closest(".column:not(.has-nodes")) {
                ...
                _this2.__activeHover = eventPath[0].closest(".column").parentNode.parentNode.host;
                ...
                _this2.__activeHover = eventPath[0].closest(".column").parentNode.parentNode.host.children[0]; // we focus on the column unlike anything else
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_bcc2b0f056b411ebb2c24bb50d8f41ab());
      }
      /**
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "editMode" && oldValue !== undefined) {
            ...
            setTimeout(function () {
              ...
              if (_this5[propName]) {
                _this5._activeNodeChanged(_this5.activeNode, null);

                _this5.activeNode.focus();
              } else {
                _this5._activeNodeChanged(null, _this5.activeNode);
              }
            }, 0);
          }
      ...
      value: function _keepContextVisible() {
        ...
        if (this.editMode) {
          ...
          this.__contextVisibleLock = setTimeout(function () {
            ...
            if (el) {
              if (_this7.activeNode && _this7.elementMidViewport()) {
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (this._validElementTest(children[i])) {
            ...
            // yet we need to remove from output as they do not really exist :)
                ...
                var tmp = _haxStore.HAXStore.runHook(children[i], "activeElementChanged", [this.activeNode, false]);
              ...
              if (!props || props.editingElement == "core") {
                ...
                setTimeout(function () {
                  if (node && node.parentNode) {
                    var _activeRect2 = node.parentNode.getBoundingClientRect();

                    _this11._positionContextMenu(_this11.contextMenus.plate, node.parentNode, _activeRect2.width - _this11.contextMenus.plate.getBoundingClientRect().width + 1, -26);
                  }
                }, 250);
              }
            }
        ...
        switch (detail.eventName) {
          ...
          case "hax-source-view-toggle":
            if (!this.activeNode.__haxSourceView) {
              ...
              var replacement = _haxStore.HAXStore.runHook(_haxStore.HAXStore.activeEditingElement, "activeElementChanged", [this.activeNode, false]);

              var oldSchema = _haxStore.HAXStore.haxSchemaFromTag(this.activeNode.tagName.toLowerCase()); // test for slots to match to ensure this is maintained
          ...
          case "hax-full-text-editor-toggle":
            if (!this.activeNode.__haxSourceView) {
              ...
              new Promise(function (res, rej) {
                ...
                _this13.activeNode.removeAttribute("data-hax-ray");
              ...
              var _replacement = _haxStore.HAXStore.runHook(_haxStore.HAXStore.activeEditingElement, "activeElementChanged", [this.activeNode, false]);

              var _oldSchema = _haxStore.HAXStore.haxSchemaFromTag(this.activeNode.tagName.toLowerCase()); // test for slots to match to ensure this is maintained
              ...
              if (_oldSchema.saveOptions && _oldSchema.saveOptions.unsetAttributes && _oldSchema.saveOptions.unsetAttributes.length) {
                for (var i in _oldSchema.saveOptions.unsetAttributes) {
      ...
      value: function _editModeChanged(newValue, oldValue) {
        ...
        if (newValue == false) {
          ...
          var activeKids = this.querySelectorAll("[contenteditable],.hax-active");
                ...
                case 3:
                  ...
                  if (this.editMode && oldValue) {
                    ...
                    if (oldSchema.editingElement != "core" || oldValue.parentNode && oldValue.parentNode.haxUIElement && oldValue.parentNode === _haxStore.HAXStore.activeEditingElement) {
                      ...
                      replacement = _haxStore.HAXStore.runHook(_haxStore.HAXStore.activeEditingElement, "activeElementChanged", [oldValue, false]);
