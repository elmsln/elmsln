define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../utils/utils.js"], function (_exports, _require, _litElement, _simpleColors, _utils) {
  ...
  function _templateObject2_33e45130494a11eab3124f20b4f7a7f7() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n      <hax-input-mixer\n        id=\"haxinputmixer\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-input-mixer>\n    "]);

    _templateObject2_33e45130494a11eab3124f20b4f7a7f7 = function _templateObject2_33e45130494a11eab3124f20b4f7a7f7() {
      return data;
    };
  ...
  function _templateObject_33e45130494a11eab3124f20b4f7a7f7() {
    ...
    _templateObject_33e45130494a11eab3124f20b4f7a7f7 = function _templateObject_33e45130494a11eab3124f20b4f7a7f7() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_33e45130494a11eab3124f20b4f7a7f7())]);
      }
      /**
       * HTMLElement
       */
    ...
    function HaxBody() {
      ...
      setTimeout(function () {
        ...
        new Promise(function (res, rej) {
          return _require.default(["./lib/hax-input-mixer.js"], res, rej);
        });
        new Promise(function (res, rej) {
        ...
        _this.addEventListener("hax-input-mixer-update", _this._haxInputMixerOperation.bind(babelHelpers.assertThisInitialized(_this)));
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_33e45130494a11eab3124f20b4f7a7f7());
      }
      /**
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "openDrawer") {
            _this2._openDrawerChanged(_this2[propName], oldValue);
          }
          ...
          if (propName == "globalPreferences") {
            _this2._globalPreferencesUpdated(_this2[propName], oldValue);
          }

          if (propName == "activeNode") {
            _this2._activeNodeChanged(_this2[propName], oldValue); // notify


            _this2.dispatchEvent(new CustomEvent("active-node-changed", {
              detail: {
          ...
          if (propName == "activeContainerNode") {
            _this2._activeContainerNodeChanged(_this2[propName], oldValue); // notify


            _this2.dispatchEvent(new CustomEvent("active-container-node-changed", {
              detail: {
                value: _this2[propName]
              }
            }));
      ...
      value: function connectedCallback() {
          ...
          mutations.forEach(function (mutation) {
            ...
            if (mutation.addedNodes.length > 0) {
              mutation.addedNodes.forEach(function (node) {
                if (_this3._validElementTest(node)) {
                  ...
                  if (_this3.editMode && (node.getAttribute("contenteditable") == "true" || node.getAttribute("contenteditable") === true || node.getAttribute("contenteditable") == "contenteditable")) {
                    _this3.__applyNodeEditableState(node, !_this3.editMode);
                  }

                  _this3.__applyNodeEditableState(node, _this3.editMode);

                  _this3.dispatchEvent(new CustomEvent("hax-body-tag-added", {
                    bubbles: true,
                    cancelable: true,
                    composed: true,
                    detail: {
                  ...
                  if (!_this3.___moveLock && !mutFind) {
                    mutFind = true;
                    _this3.activeNode = node;
                    window.HaxStore.write("activeNode", node, _this3);
                  } else {
                    _this3.___moveLock = false;
                  }
                }
              });
            ...
            if (mutation.removedNodes.length > 0) {
              ...
              mutation.removedNodes.forEach(function (node) {
                if (_this3._validElementTest(node) && !node.classList.contains("hax-active")) {
                  _this3.dispatchEvent(new CustomEvent("hax-body-tag-removed", {
                    bubbles: true,
                    cancelable: true,
                    composed: true,
                    detail: {
        ...
        setTimeout(function () {
          window.addEventListener("keydown", _this3._onKeyDown.bind(_this3));
          window.addEventListener("keypress", _this3._onKeyPress.bind(_this3));
          document.body.addEventListener("hax-store-property-updated", _this3._haxStorePropertyUpdated.bind(_this3));
          window.addEventListener("scroll", _this3._keepContextVisible.bind(_this3));
        }, 0);
      }
      /**
       * HTMLElement
      ...
      value: function _keepContextVisible(e) {
        ...
        if (!this.openDrawer && this.editMode) {
          ...
          this.__contextVisibleLock = setTimeout(function () {
            ...
            if (_this4.shadowRoot.querySelector("#textcontextmenu").classList.contains("hax-context-visible")) {
              el = _this4.shadowRoot.querySelector("#textcontextmenu");
            } else if (_this4.shadowRoot.querySelector("#cecontextmenu").classList.contains("hax-context-visible")) {
              el = _this4.shadowRoot.querySelector("#cecontextmenu");
            } // if we see it, ensure we don't have the pin


            if (el) {
              _this4._positionContextMenu(_this4.shadowRoot.querySelector("#platecontextmenu"), _this4.activeContainerNode, -59, 0);

              if (_this4.elementInViewport(el)) {
                el.classList.remove("hax-context-pin-bottom", "hax-context-pin-top");
              } else {
                if (_this4.__OffBottom) {
      ...
      value: function _onKeyDown(e) {
        ...
        if (!this.openDrawer && this.editMode && this.getAttribute("contenteditable")) {
          switch (e.key) {
            case "Tab":
              if (window.HaxStore.instance.isTextElement(this.activeContainerNode)) {
            ...
            case "ArrowRight":
              ...
              this.__keyPressDirection = setTimeout(function () {
                var rng = window.HaxStore.getRange();

                if (rng.commonAncestorContainer && _this5.activeNode !== rng.commonAncestorContainer && typeof rng.commonAncestorContainer.focus === "function") {
                  if (rng.commonAncestorContainer.tagName !== "HAX-BODY") {
                    if (window.HaxStore.instance.isTextElement(rng.commonAncestorContainer)) {
                      _this5.setAttribute("contenteditable", true);
                    } else {
                      _this5.removeAttribute("contenteditable");
                    }

                    rng.commonAncestorContainer.focus();

                    _this5.__focusLogic(rng.commonAncestorContainer);
                  }
                } // need to check on the parent too if this was a text node
                else if (rng.commonAncestorContainer && rng.commonAncestorContainer.parentNode && _this5.activeNode !== rng.commonAncestorContainer.parentNode && typeof rng.commonAncestorContainer.parentNode.focus === "function") {
                    if (rng.commonAncestorContainer.parentNode.tagName !== "HAX-BODY") {
                      ...
                      _this5.__focusLogic(rng.commonAncestorContainer.parentNode);
                    } else {
                      _this5.activeNode = rng.commonAncestorContainer;
                      _this5.activeContainerNode = _this5.activeNode;
                      window.HaxStore.write("activeNode", rng.commonAncestorContainer, _this5);
                      window.HaxStore.write("activeContainerNode", rng.commonAncestorContainer, _this5);
                      setTimeout(function () {
      ...
      value: function elementInViewport(el) {
        var top = el.offsetTop - 32 - window.HaxStore.instance.haxPanel.shadowRoot.querySelector("#drawer").offsetHeight;
      ...
      value: function replacePlaceholder(e) {
        ...
        if (e.detail === "text") {
          ...
          setTimeout(function () {
            ...
            _this7.activeNode = p;
            window.HaxStore.write("activeNode", p, _this7);

            _this7.activeContainerNode.setAttribute("contenteditable", true); // focus on it


            p.focus();

            _this7.__focusLogic(p);
          }, 210);
        } else {
      ...
      value: function haxDuplicateNode(node) {
        ...
        setTimeout(function () {
          ...
          if (parent === _this9) {
            window.HaxStore.write("activeContainerNode", nodeClone, _this9);
          }

          window.HaxStore.write("activeNode", nodeClone, _this9);
        }, 100);
        return true;
      }
      /**
      ...
      value: function hideContextMenus() {
        ...
        this._hideContextMenu(this.shadowRoot.querySelector("#haxinputmixer")); // force context menu state to closed
      ...
      value: function positionContextMenus() {
        ...
        var container = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.activeContainerNode;
        ...
        if (node) {
          ...
          if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !window.HaxStore.instance.isTextElement(node)) {
            ...
            this._positionContextMenu(this.shadowRoot.querySelector("#cecontextmenu"), container, -58, -40);
          } else {
            this._hideContextMenu(this.shadowRoot.querySelector("#cecontextmenu"));

            this._positionContextMenu(this.shadowRoot.querySelector("#textcontextmenu"), container, -58, -40);
          }

          this._positionContextMenu(this.shadowRoot.querySelector("#platecontextmenu"), container, -59, 0); // special case for node not matching container yet it being editable
      ...
      value: function haxMoveGridPlate(direction, node, container) {
        ...
        setTimeout(function () {
          _this10.positionContextMenus(node, container);
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 24:
                  ...
                  _context.next = _context.t1 === "1" ? 27 : _context.t1 === "1-1" ? 31 : _context.t1 === "1-1-1" ? 34 : _context.t1 === "1-1-1-1" ? 37 : _context.t1 === "1-1-1-1-1" ? 40 : _context.t1 === "1-1-1-1-1-1" ? 43 : 46;
                  break;
                ...
                case 46:
                  ...
                  if (changed) {
                    ...
                    left = platecontextmenu.shadowRoot.querySelector("#left");
                    rightremove = platecontextmenu.shadowRoot.querySelector("#rightremove");
                    leftremove = platecontextmenu.shadowRoot.querySelector("#leftremove");
                ...
                case 49:
                  ...
                  setTimeout(function () {
                    ...
                    _this11.activeContainerNode = grid;
                    window.HaxStore.write("activeContainerNode", grid, _this11);
      ...
      value: function haxDeleteNode(node) {
        ...
        if (this.activeContainerNode != null && this.activeContainerNode.previousElementSibling !== null) {
          ...
          if (this.activeContainerNode != null && window.HaxStore.instance.isTextElement(this.activeContainerNode) && this.activeContainerNode.textContent !== "") {
            try {
      ...
      value: function _haxContextOperation(e) {
        ...
        switch (detail.eventName) {
            ...
            if (window.HaxStore.instance.isTextElement(addData)) {
              setTimeout(function () {
                try {
                  ...
                  _this13.activeContainerNode = _this13.activeNode;
                  window.HaxStore.write("activeContainerNode", _this13.activeContainerNode, _this13);
                } catch (e) {
                  console.warn(e);
                }
              }, 0);
          ...
          case "hax-edit-property":
            var haxInputMixer = this.shadowRoot.querySelector("#haxinputmixer");
            ...
            var style = this.shadowRoot.querySelector("#cecontextmenu").currentStyle || window.getComputedStyle(this.shadowRoot.querySelector("#cecontextmenu")); // force input mixes to match width of the ce context menu currently
          ...
          case "hax-manager-configure":
            ...
            this._hideContextMenu(this.shadowRoot.querySelector("#haxinputmixer")); // reset the manager
            ...
            window.HaxStore.write("openDrawer", window.HaxStore.instance.haxManager, this); // accessibility enhancement to keyboard focus configure button

            setTimeout(function () {
              window.HaxStore.instance.haxManager.shadowRoot.querySelector("#preview").shadowRoot.querySelector("#configurebutton").focus();
            }, 100);
            break;
      ...
      value: function _editModeChanged(newValue, oldValue) {
        ...
        if (babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          if (newValue) {
            ...
            setTimeout(function () {
              if (_this14.children && _this14.children[0] && _this14.children[0].focus) {
                _this14.activeNode = _this14.children[0];
                _this14.activeContainerNode = _this14.activeNode;
                window.HaxStore.write("activeNode", _this14.children[0], _this14);
                window.HaxStore.write("activeContainerNode", _this14.children[0], _this14);
                setTimeout(function () {
                  if (window.HaxStore.instance.isTextElement(_this14.activeNode)) {
                    try {
                      var range = document.createRange();
                      var sel = window.HaxStore.getSelection();
                      range.setStart(_this14.activeNode, 0);
                      range.collapse(true);
                      sel.removeAllRanges();
                      sel.addRange(range);

                      _this14.activeNode.focus();
                    } catch (e) {
                      console.warn(e);
                    }

                    _this14.positionContextMenus();
                  }
                }, 0);
              } else {
                _this14.haxInsert("p", "", {}, false);
                ...
                setTimeout(function () {
                  try {
                    ...
                    _this14.activeContainerNode = _this14.activeNode;
                    window.HaxStore.write("activeContainerNode", _this14.activeContainerNode, _this14);
                  } catch (e) {
                    console.warn(e);
                  }
      ...
      value: function dropEvent(e) {
        ...
        if (!this.openDrawer && this.editMode) {
          setTimeout(function () {
            var children = _this15.children; // walk the children and apply the draggable state needed

            for (var i in children) {
              if (babelHelpers.typeof(children[i].classList) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                children[i].classList.remove("mover", "hovered", "moving", "grid-plate-active-item"); // special support for grid plates as they manage internal drag/drop
          ...
          if (babelHelpers.typeof(target) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && target !== null && babelHelpers.typeof(local) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && target !== local && target !== local.parentNode && target.parentNode === this || local.parentNode === this) {
      ...
      value: function dragEnter(e) {
        if (!this.openDrawer && this.editMode && e.target && e.target.classList) {
          e.preventDefault();
          e.target.classList.add("hovered"); // perform check for edge of screen
      ...
      value: function _activeNodeChanged(newValue, oldValue) {
        ...
        if (this.editMode && babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue !== null) {
          ...
          if (window.HaxStore.instance.isTextElement(newValue) || window.HaxStore.instance.isGridPlateElement(newValue)) {
            ...
            clearTimeout(this.__positionContextTimer);
            this.__positionContextTimer = setTimeout(function () {
              if (newValue === _this16.activeNode) {
                _this16.positionContextMenus(newValue);
              }
            }, 10);
          } else {
            newValue.removeAttribute("contenteditable");
          ...
          if (newValue.style.textAlign == "left") {
            this.shadowRoot.querySelector("#textcontextmenu").justifyIcon = "editor:format-align-left";
            this.shadowRoot.querySelector("#textcontextmenu").justifyValue = "text-align-left";
          } else if (newValue.style.float == "left") {
            this.shadowRoot.querySelector("#cecontextmenu").justifyIcon = "editor:format-align-left";
            this.shadowRoot.querySelector("#cecontextmenu").justifyValue = "hax-align-left";
          } else if (newValue.style.margin == "0 auto") {
            this.shadowRoot.querySelector("#cecontextmenu").justifyIcon = "editor:format-align-center";
            this.shadowRoot.querySelector("#cecontextmenu").justifyValue = "hax-align-center";
          }
