define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../undo-manager/undo-manager.js", "./lib/hax-store.js", "../../mobx/dist/mobx.esm.js", "../utils/utils.js", "./lib/hax-ui-styles.js", "../i18n-manager/lib/I18NMixin.js", "../absolute-position-behavior/absolute-position-behavior.js"], function (_exports, meta, _require, _litElement, _simpleColors, _undoManager, _haxStore, _mobxEsm, _utils, _haxUiStyles, _I18NMixin2, _absolutePositionBehavior) {
  "use strict";
  ...
  var _templateObject_a7a0c7b0d39211eb9590b786b63a9382, _templateObject2_a7a0c7b0d39211eb9590b786b63a9382;
    ...
    function HaxBody() {
      ...
      setTimeout(function () {
        new Promise(function (res, rej) {
          return _require.default(["./lib/hax-context-behaviors.js"], res, rej);
        });
        new Promise(function (res, rej) {
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function _mouseDown(e) {
        if (this.editMode) {
          ...
          var _target = e.target; // resolve to the closest ediable element if possible
          // otherwise keep the target we had
          // @todo need to test more situations for this..

          if (_target.closest("[draggable]")) {
            _target = _target.closest("[draggable]");
          } else if (_target.closest("[slot]")) {
            _target = _target.closest("[slot]");
          } else if (_target.closest("[data-hax-ray]")) {
            _target = _target.closest("[data-hax-ray]");
          } else if (_target.closest("[contenteditable]")) {
            _target = _target.closest("[contenteditable]");
          } else if (_haxStore.HAXStore.validTagList.includes(_target.tagName.toLowerCase())) {// tagName is in the valid tag list so just let it get selected
          } else if (_target.tagName !== "HAX-BODY" && !_target.haxUIElement) {
            // this is a usecase we didn't think of...
            console.warn(_target);
          }

          if (!_target.haxUIElement && this.__focusLogic(_target)) {
            e.stopPropagation();
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_a7a0c7b0d39211eb9590b786b63a9382 || (_templateObject_a7a0c7b0d39211eb9590b786b63a9382 = babelHelpers.taggedTemplateLiteral(["\n      <div\n        id=\"bodycontainer\"\n        class=\"ignore-activation\"\n        element-align=\"", "\"\n      >\n        <slot id=\"body\"></slot>\n      </div>\n      <absolute-position-behavior\n        id=\"topcontext\"\n        auto\n        justify\n        position=\"top\"\n        fit-to-visible-bounds\n        .target=\"", "\"\n        ?hidden=\"", "\"\n      >\n        <div id=\"topcontextmenu\">\n          <hax-text-context\n            id=\"textcontextmenu\"\n            class=\"hax-context-menu ignore-activation\"\n            .activeNode=\"", "\"\n            ?viewSource=\"", "\"\n          ></hax-text-context>\n          <hax-ce-context\n            id=\"cecontextmenu\"\n            class=\"hax-context-menu ignore-activation\"\n            .activeNode=\"", "\"\n            ?viewSource=\"", "\"\n          ></hax-ce-context>\n          <hax-plate-context\n            id=\"platecontextmenu\"\n            class=\"hax-context-menu ignore-activation\"\n            .activeNode=\"", "\"\n            .trayDetail=\"", "\"\n            .trayStatus=\"", "\"\n            ?viewSource=\"", "\"\n          ></hax-plate-context>\n        </div>\n      </absolute-position-behavior>\n    "])), this.elementAlign || "right", !this.activeNode ? document.body : this.viewSourceToggle ? this.activeNode.parentNode : this.activeNode, !this.activeNode, this.activeNode, this.viewSourceToggle, this.activeNode, this.viewSourceToggle, this.activeNode, this.trayDetail, this.trayStatus, this.viewSourceToggle);
      }
      /**
                ...
                try {
                  for (_iterator.s(); !(_step = _iterator.n()).done;) {
                    ...
                    if (_this6._validElementTest(node)) {
                      console.log("valid element", node); // no empty HTML primative tags w/ just a BR in it for spacing purposes
                      ...
                      if (!_this6.___moveLock && !mutFind) {
                        console.log("not movelock", target);
                        mutFind = true;
                        ...
                        if (node.tagName === "BR") {
                          ...
                          if (rng.collapsed && _this6.activeNode.tagName === "BR" && _this6.activeNode.parentNode === rng.commonAncestorContainer && _this6.activeNode.innerText === "") {
                            console.log("collapsed", _this6.activeNode.parentNode);
        ...
        // look for wildcard / web component pro insert mode
            ...
            if (_haxStore.HAXStore.elementList[tag]) {
              ...
              if (schema.gizmo.tag && schema.demoSchema && schema.demoSchema[0]) {
                _target2 = (0, _utils.haxElementToNode)(schema.demoSchema[0]);
              } else {
                _target2 = document.createElement(tag);
              }

              this.haxReplaceNode(this.activeNode, _target2);

              this.__focusLogic(_target2);
            } else {
      ...
      value: function _onKeyPress(e) {
        ...
        if (this.editMode && this.activeNode && e.key === "Enter" && _haxStore.HAXStore.isTextElement(this.activeNode)) {
          console.log("keypress", e);
          this.activeNode = this.activeNode.nextElementSibling; // If the user has paused for awhile, show the menu
            ...
            while (1) {
              switch (_context6.prev = _context6.next) {
                ...
                case 5:
                  ...
                  type = "*";
                  skipPropMatch = false; // special support for place holder which defines exactly
                  ...
                  props = {}; // see if we have a gizmo as it's not a requirement to registration
                  ...
                  haxElements = _haxStore.HAXStore.guessGizmo(type, props, skipPropMatch); // see if we got anything
      ...
      value: function () {
        var _haxDuplicateNode = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(node) {
          var haxElement, props, nodeClone;
            ...
            while (1) {
              switch (_context8.prev = _context8.next) {
                ...
                case 2:
                  ...
                  props = _haxStore.HAXStore.elementList[node.tagName.toLowerCase()]; // @see haxHooks: preProcessInsertContent
                  ...
                  _context8.next = 7;
                  return _haxStore.HAXStore.runHook(node, "preProcessInsertContent", [haxElement]);
        ...
        if (node && node.tagName && this.ready) {
          ...
          this.__positionContextTimer = setTimeout(function () {
            if (!_haxStore.HAXStore._lockContextPosition) {
              ...
              var props = _haxStore.HAXStore.elementList[_tag]; // try and work against anything NOT a P tag
              ...
              if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !_haxStore.HAXStore.isTextElement(node)) {
                ...
                if (props.editingElement == "core") {
                  _this11._showContextMenu(_this11.contextMenus.ce);
                } else {
                ...
                _this11._showContextMenu(_this11.contextMenus.text); // text menu can expand based on selection
              ...
              if (!props || props.editingElement == "core") {
                ...
                if (_this11.activeNode && (_this11.activeNode.tagName === "LI" || _this11._HTMLInlineTextDecorationTest(_this11.activeNode))) {
                  _this11._hideContextMenu(_this11.contextMenus.plate);
                } else {
                  _this11._showContextMenu(_this11.contextMenus.plate);
                }
              } else {
                setTimeout(function () {
            ...
            _this11.shadowRoot.querySelector("#topcontext").updatePosition();
          }, 50);
        }
      }
      /**
      ...
      value: function () {
        var _haxContextOperation2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(e) {
          ...
          var detail, p, replacement, oldSchema, i, _replacement, _oldSchema;

          return regeneratorRuntime.wrap(function _callee10$(_context10) {
            while (1) {
              switch (_context10.prev = _context10.next) {
                case 0:
                  detail = e.detail; // support a simple insert event to bubble up or everything else

                  _context10.t0 = detail.eventName;
                  _context10.next = _context10.t0 === "insert-above-active" ? 4 : _context10.t0 === "insert-below-active" ? 6 : _context10.t0 === "hax-source-view-toggle" ? 8 : _context10.t0 === "hax-full-text-editor-toggle" ? 43 : _context10.t0 === "text-tag" ? 60 : _context10.t0 === "text-tag-ul" ? 63 : _context10.t0 === "text-tag-ol" ? 67 : _context10.t0 === "text-align-left" ? 71 : _context10.t0 === "hax-transform-node" ? 73 : _context10.t0 === "hax-plate-create-right" ? 75 : _context10.t0 === "hax-plate-remove-right" ? 77 : _context10.t0 === "hax-plate-duplicate" ? 79 : _context10.t0 === "hax-plate-delete" ? 81 : _context10.t0 === "hax-plate-up" ? 83 : _context10.t0 === "hax-plate-down" ? 85 : _context10.t0 === "content-edit" ? 87 : 90;
                  break;
                ...
                case 43:
                  ...
                  new Promise(function (res, rej) {
                    ...
                    if (_this13.activeNode.getAttribute && _this13.activeNode.getAttribute("slot") != null) {
                      _haxStore.HAXStore.activeEditingElement.setAttribute("slot", _this13.activeNode.getAttribute("slot"));
                    }

                    _this13.__ignoreActive = true;

                    _this13.activeNode.removeAttribute("contenteditable");

                    _this13.__applyDragDropState(_this13.activeNode, false);

                    _this13.activeNode.classList.remove("hax-active");

                    (0, _utils.wrap)(_this13.activeNode, _haxStore.HAXStore.activeEditingElement);
                    _this13.viewSourceElement = _haxStore.HAXStore.activeEditingElement;
                  });
                  _context10.next = 59;
                  break;
        ...
        if (this.editMode && !this.__tabTrap) {
          ...
          if (this._validElementTest(containerNode) && containerNode.parentNode && containerNode.parentNode.tagName) {
            ...
            if (!activeNode.haxUIElement && !activeNode.classList.contains("ignore-activation")) {
              ...
              setTimeout(function () {
                if (autoFocus && !_this14.__mouseDown && _haxStore.HAXStore.isTextElement(activeNode)) {
                  try {
                    var range = document.createRange();
                ...
                _this14.positionContextMenus(activeNode);
              }, 0);
              stopProp = true;
            }
          }
              ...
              switch (_context11.prev = _context11.next) {
                case 0:
                  ...
                  if (babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
                    ...
                    setTimeout(function () {
                      _this17.undoStack.undoStackLimit = 50;
                      _this17.undoStack.undoStackPosition = -1;
                      _this17.undoStack.commands = []; // execute once just to get these values

                      _this17.undoStack.changed(); // reset initial value to avoid some state management issues


                      _this17.undoStackInitialValue = _this17.innerHTML;
                      _this17.undoStackPrevValue = _this17.undoStackInitialValue;
                    }, 0);
      ...
      value: function __getLayoutOrder(target, layout) {
        ...
        var slot = target.getAttribute("slot"),
            ...
            containers = babelHelpers.toConsumableArray(layout.shadowRoot.querySelectorAll("[data-layout-slotname]")),
      ...
      value: function __layoutSlots(layout) {
        return layout.shadowRoot ? babelHelpers.toConsumableArray(layout.shadowRoot.querySelectorAll("[data-layout-slotname]")).map(function (container) {
      ...
      value: function __applyDragDropState(layout, haxRay) {
        ...
        var events = {
          drop: function drop(e) {
            return _this19.__layoutDropEvent(e, layout).bind(_this19);
          },
              ...
              mutations.forEach(function (mutation) {
                ...
                mutation.addedNodes.forEach(function (node) {
                  if (node.tagName && node !== _this19) {
                    ...
                    if (node.parentElement && node.parentElement.tagName !== "HAX-BODY" && !_this19.__layoutSlotValid(node, layout) && _this19.__layoutSlots(layout).length > 0) {
                      node.setAttribute("slot", _this19.__layoutSlots(layout)[0]);
                    }
                  }
                });
              });

              _this19.__sortLayoutChildren(layout);
            }
          });
      ...
      value: function __isLayout(el) {
        return el && _haxStore.HAXStore.isGridPlateElement(el);
      }
      /**
          ...
          return regeneratorRuntime.wrap(function _callee13$(_context13) {
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  console.log("_activeNodeChanged", newValue, oldValue); // close any open popover items
                ...
                case 29:
                  ...
                  basePath = _haxStore.HAXStore.pathFromUrl(decodeURIComponent(meta.url));
                  _context13.next = 36;
      ...
      value: function _hideContextMenu(menu) {
        ...
        var container = this._getContextContainer(menu);
