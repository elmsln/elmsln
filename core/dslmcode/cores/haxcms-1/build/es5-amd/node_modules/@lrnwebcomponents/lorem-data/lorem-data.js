define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../iconset-demo/iconset-demo.js"], function (_exports, _litElement, _simpleColors, _iconsetDemo) {
  "use strict";
  ...
  function _templateObject3_260560f0e18811eaa5662328babf1f8b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <p>\n            <label>\n              <a href=\"", "\" download=\"", "\"\n                >", ":\n              </a>\n              <br />\n              <textarea>", "</textarea>\n            </label>\n          </p>\n        "]);

    _templateObject3_260560f0e18811eaa5662328babf1f8b = function _templateObject3_260560f0e18811eaa5662328babf1f8b() {
      return data;
    };
  ...
  function _templateObject2_260560f0e18811eaa5662328babf1f8b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">Save All</button>\n      ", "\n      <button @click=\"", "\">Save All</button>\n    "]);

    _templateObject2_260560f0e18811eaa5662328babf1f8b = function _templateObject2_260560f0e18811eaa5662328babf1f8b() {
      return data;
    };
  ...
  function _templateObject_260560f0e18811eaa5662328babf1f8b() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        label {\n          font-size: 80%;\n          font-family: sans-serif;\n        }\n        textarea {\n          width: 100%;\n          height: 200px;\n        }\n      "]);

    _templateObject_260560f0e18811eaa5662328babf1f8b = function _templateObject_260560f0e18811eaa5662328babf1f8b() {
      return data;
    };
  ...
  window.loremdata.getIconset = function () {
    var iconset = document.createElement("iconset-demo");
    iconset.hidden = true;
    document.body.appendChild(iconset);
    return iconset;
  };

  window.loremdata.iconset = window.loremdata.iconset && window.loremdata.iconset.length > 0 ? window.loremdata.iconset : window.loremdata.getIconset();

  window.loremdata.getIcons = function () {
    var iconset = window.loremdata.iconset,
        list = iconset && iconset.__iconList ? iconset.__iconList : [[]],
        icons = list.map(function (group) {
      return group.icons.map(function (icon) {
        return icon.replace(/^icons\:/, "");
      });
    }).flat();
    return icons;
  };
  ...
  function (_LitElement) {
    ...
    function LoremData() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LoremData).call(this));
      _this.schemas = {};
      return _this;
    }
    ...
    babelHelpers.createClass(LoremData, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_260560f0e18811eaa5662328babf1f8b(), this.saveAll, Object.keys(this.schemas || []).map(function (key) {
          return (0, _litElement.html)(_templateObject3_260560f0e18811eaa5662328babf1f8b(), _this2.saveDataUrl(_this2.schemas[key]), key, key, _this2.getJson(_this2.schemas[key]));
        }), this.saveAll);
      }
    }, {
      key: "saveAll",
      ...
      value: function randomHex() {
        ...
        return "#".concat([0, 0, 0].map(function (i) {
          return _this3.randomNumber(i, 255).toString(16);
        }).map(function (i) {
      ...
      value: function randomIcon() {
        ...
        var random = this.randomOption(window.loremdata.icons);
      ...
      value: function randomPicsum(aspect, greyscale) {
        ...
        var params = this.randomWeightedOption([{
          value: false,
          weight: 3
        }, {
          value: true,
        ...
        if (multiple > -1) params.push("random=".concat(multiple));
        aspect = aspect || this.randomAspect();
        return "https://picsum.photos/".concat(aspect, "/").concat(params.length == 0 ? "" : "?".concat(params.join("&")));
      }
    }, {
      key: "randomKitten",
      ...
      value: function randomImage(aspect, greyscale, topic, multiple) {
        return topic && ["man", "woman", "person"].includes(topic) ? this.randomProfileImage(aspect, topic) : babelHelpers.typeof(multiple) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) ? this.randomPlaceImg(aspect, greyscale, topic) : babelHelpers.typeof(multiple) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) ? this.randomPicsum(aspect, greyscale, multiple) : this.randomFlickr(aspect, [topic], false, multiple);
      }
    }, {
      key: "randomImageData",
      ...
      value: function randomLink(type) {
        var min = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
        var max = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 4;
        var w = this.draw(window.loremdata.words, min, max),
      ...
      value: function randomObject() {
        ...
        Object.keys(schema).forEach(function (key) {
          return obj[key] = _this4.randomType(schema[key]);
        });
        return obj;
      }
      /**
      ...
      value: function randomParagraph() {
        ...
        var wordMinPerSentencce = arguments.length > 2 ? arguments[2] : undefined;
        var wordMaxPerSentencce = arguments.length > 3 ? arguments[3] : undefined;
        var paragraph = [];
      ...
      value: function randomType(schema) {
        ...
        if (schema.type) switch (schema.type) {
          ...
          case "paragraph":
            val = this.randomParagraph(schema.min, schema.max, schema.wordMinPerSentencce, schema.wordMaxPerSentencce);
            break;
      ...
      get: function get() {
        ...
        Object.keys(this.schemas || []).forEach(function (key) {
          return data[key] = _this5.randomType(_this5.schemas[key]);
        });
        return data;
      }
      /**
