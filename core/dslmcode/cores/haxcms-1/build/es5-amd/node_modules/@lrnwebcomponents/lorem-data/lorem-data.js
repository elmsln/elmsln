define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../simple-icon/lib/simple-iconset-demo.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-iconset-manifest.js", "../hax-iconset/lib/hax-iconset-manifest.js"], function (_exports, _litElement, _simpleColors, _simpleIconsetDemo, _simpleIcon, _simpleIconLite, _simpleIconsetManifest, _haxIconsetManifest) {
  "use strict";
  ...
  function _templateObject3_e9b1cb10544211ebad6c77197a564a47() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <p>\n            <label>\n              <a href=\"", "\" download=\"", "\"\n                >", ":\n              </a>\n              <br />\n              <textarea>", "</textarea>\n            </label>\n          </p>\n        "]);

    _templateObject3_e9b1cb10544211ebad6c77197a564a47 = function _templateObject3_e9b1cb10544211ebad6c77197a564a47() {
      return data;
    };
  ...
  function _templateObject2_e9b1cb10544211ebad6c77197a564a47() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button @click=\"", "\">Save All</button>\n      ", "\n      <button @click=\"", "\">Save All</button>\n    "]);

    _templateObject2_e9b1cb10544211ebad6c77197a564a47 = function _templateObject2_e9b1cb10544211ebad6c77197a564a47() {
      return data;
    };
  ...
  function _templateObject_e9b1cb10544211ebad6c77197a564a47() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        label {\n          font-size: 80%;\n          font-family: sans-serif;\n        }\n        textarea {\n          width: 100%;\n          height: 200px;\n        }\n      "]);

    _templateObject_e9b1cb10544211ebad6c77197a564a47 = function _templateObject_e9b1cb10544211ebad6c77197a564a47() {
      return data;
    };
  ...
  var LoremDataBehaviors = function LoremDataBehaviors(SuperClass) {
    return /*#__PURE__*/function (_SuperClass) {
      ...
      babelHelpers.createClass(_class, [{
        ...
        value: function kebabToCamel(kebab) {
          return kebab ? kebab.replace(/-./g, function (x) {
        ...
        value: function randomHex() {
          ...
          return "#".concat([0, 0, 0].map(function (i) {
            return _this.randomNumber(i, 255).toString(16);
          }).map(function (i) {
        ...
        key: "randomFlickr",
        value: function randomFlickr() {
          var aspect = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.randomAspect();
        ...
        value: function randomImage() {
          var aspect = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.randomAspect();
          var greyscale = arguments.length > 1 ? arguments[1] : undefined;
          var topic = arguments.length > 2 ? arguments[2] : undefined;
        ...
        key: "randomImageData",
        value: function randomImageData() {
          var aspect = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.randomAspect();
          var greyscale = arguments.length > 1 ? arguments[1] : undefined;
          var topic = arguments.length > 2 ? arguments[2] : undefined;
          var multiple = arguments.length > 3 ? arguments[3] : undefined;
        ...
        value: function randomObject() {
          ...
          Object.keys(schema).forEach(function (key) {
            return obj[key] = _this2.randomType(schema[key]);
          });
          return obj;
        }
        /**
        ...
        value: function randomProfileImage() {
          var aspect = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.randomAspect();
          var topic = arguments.length > 1 ? arguments[1] : undefined;
        ...
        value: function randomParagraph() {
          ...
          var wordMinPerSent = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 3;
          var wordMaxPerSent = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 10;
          var paragraph = [];
        ...
        value: function randomPassage() {
          ...
          var sentMinPerPara = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;
          var sentMaxPerPara = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 5;
          var wordMinPerSent = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 3;
          var wordMaxPerSent = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 10;
          var passage = [];

          for (var i = this.randomNumber(min, max); i > 0; i--) {
            passage.push("<p>".concat(this.randomParagraph(sentMinPerPara, sentMaxPerPara, wordMinPerSent, wordMaxPerSent), "</p>"));
          }
        ...
        key: "randomPhrase",
        value: function randomPhrase() {
          var min = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
          var max = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 5;
          var titlecase = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
          var colon = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
          var phrase = [],
              wordCount = this.randomNumber(min, max),
              colonIndex = colon && wordCount > 1 ? this.randomNumber(1, wordCount - 1) : -1;

          for (var i = 0; i <= wordCount; i++) {
            var word = this.randomWord();
            phrase.push(i == colonIndex ? "".concat(word, ":") : word);
          }
        ...
        value: function randomType(schema) {
          ...
          if (schema.type) switch (schema.type) {
            ...
            case "image":
              val = this.randomImage(schema.aspect, schema.greyscale, schema.topic, schema.multiple);
              break;
        ...
        key: "icons",
        get: function get() {
          return [].concat(babelHelpers.toConsumableArray(_simpleIconsetManifest.SimpleIconIconsetsManifest || []), babelHelpers.toConsumableArray(_haxIconsetManifest.HaxIconsetManifest || [])).map(function (iconset) {
            return ((iconset || {}).icons || []).map(function (icon) {
              return iconset.name == "icons" ? icon : "".concat(iconset.name, ":").concat(icon);
            });
          }).flat();
        }
      }, {
  ...
  _exports.LoremDataBehaviors = LoremDataBehaviors;

  var LoremData = /*#__PURE__*/function (_LoremDataBehaviors) {
    babelHelpers.inherits(LoremData, _LoremDataBehaviors);

    var _super2 = _createSuper(LoremData);

    babelHelpers.createClass(LoremData, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_e9b1cb10544211ebad6c77197a564a47())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    babelHelpers.createClass(LoremData, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject2_e9b1cb10544211ebad6c77197a564a47(), this.saveAll, Object.keys(this.schemas || []).map(function (key) {
          return (0, _litElement.html)(_templateObject3_e9b1cb10544211ebad6c77197a564a47(), _this4.saveDataUrl(_this4.schemas[key]), key, key, _this4.getJson(_this4.schemas[key]));
        }), this.saveAll);
      }
    }, {
      key: "saveAll",
      ...
      value: function randomHex() {
        ...
        return "#".concat([0, 0, 0].map(function (i) {
          return _this5.randomNumber(i, 255).toString(16);
        }).map(function (i) {
          return i.length < 2 ? "0".concat(i) : "".concat(i);
        }).join(""));
      }
      ...
      value: function randomObject() {
        ...
        var obj = {};
        Object.keys(schema).forEach(function (key) {
          return obj[key] = _this6.randomType(schema[key]);
        });
        return obj;
      }
      /**
      ...
      get: function get() {
        ...
        Object.keys(this.schemas || []).forEach(function (key) {
          return data[key] = _this7.randomType(_this7.schemas[key]);
        });
        return data;
      }
      /**
    ...
    return LoremData;
  }(LoremDataBehaviors(_litElement.LitElement));
