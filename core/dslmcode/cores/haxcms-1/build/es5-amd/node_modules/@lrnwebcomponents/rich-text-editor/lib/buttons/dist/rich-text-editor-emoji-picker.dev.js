...
function _templateObject2_45f0d6e0f55c11ebafdc4fbab1dea929() {
  var data = _taggedTemplateLiteral([""]);

  _templateObject2_45f0d6e0f55c11ebafdc4fbab1dea929 = function _templateObject2_45f0d6e0f55c11ebafdc4fbab1dea929() {
    return data;
  };
...
function _templateObject_45f0d6e0f55c11ebafdc4fbab1dea929() {
  var data = _taggedTemplateLiteral(['\n      <label id="listLabel" for="button"> ', ' </label>\n      <simple-emoji-picker\n        id="button"\n        id="button"\n        ?allow-null="', '"\n        aria-labeledby="listlabel"\n        controls="', '"\n        ?disabled="', '"\n        .emoji-types="', '"\n        @keydown="', '"\n        label=""\n        @mouseover="', '"\n        tabindex="0"\n        title-as-html\n        ?toggled="', '"\n        @value-changed="', '"\n      >\n      </simple-emoji-picker>\n      ', "\n    "]);

  _templateObject_45f0d6e0f55c11ebafdc4fbab1dea929 = function _templateObject_45f0d6e0f55c11ebafdc4fbab1dea929() {
    return data;
  };
...
var RichTextEditorEmojiPicker = /*#__PURE__*/function (_RichTextEditorPicker) {
  ...
  _createClass(RichTextEditorEmojiPicker, [{
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(RichTextEditorEmojiPicker), "styles", this)), [(0, _litElement.css)(_templateObject2_45f0d6e0f55c11ebafdc4fbab1dea929())]);
    }
  }, {
    key: "properties",
    get: function get() {
