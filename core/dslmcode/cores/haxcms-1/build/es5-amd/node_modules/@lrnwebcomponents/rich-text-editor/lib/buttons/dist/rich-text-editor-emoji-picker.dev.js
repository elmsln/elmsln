...
function _templateObject2_365b2920514511ecad92218912f770fd() {
  var data = _taggedTemplateLiteral([""]);

  _templateObject2_365b2920514511ecad92218912f770fd = function _templateObject2_365b2920514511ecad92218912f770fd() {
    return data;
  };
...
function _templateObject_365b2920514511ecad92218912f770fd() {
  var data = _taggedTemplateLiteral(['\n      <simple-emoji-picker\n        id="button"\n        ?allow-null="', '"\n        class="rtebutton ', "-label ", '"\n        .controls="', '"\n        ?disabled="', '"\n        .emoji-types="', '"\n        @keydown="', '"\n        .label="', '"\n        @mouseover="', '"\n        tabindex="0"\n        title-as-html\n        ?toggled="', '"\n        @value-changed="', '"\n      >\n      </simple-emoji-picker>\n      ', "\n    "]);

  _templateObject_365b2920514511ecad92218912f770fd = function _templateObject_365b2920514511ecad92218912f770fd() {
    return data;
  };
...
var RichTextEditorEmojiPicker = /*#__PURE__*/function (_RichTextEditorPicker) {
  ...
  _createClass(RichTextEditorEmojiPicker, [{
    ...
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_get(_getPrototypeOf(RichTextEditorEmojiPicker), "styles", this)), [(0, _litElement.css)(_templateObject2_365b2920514511ecad92218912f770fd())]);
    }
  }, {
    key: "properties",
    get: function get() {
