define(["exports", "../../lit-element/lit-element.js", "../h-a-x/h-a-x.js"], function (_exports, _litElement, _hAX) {
  ...
  function _templateObject2_19a71610db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      "]);

    _templateObject2_19a71610db3d11eaa14b6130b7e5d77f = function _templateObject2_19a71610db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_19a71610db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <h-a-x .app-store=\"", "\"></h-a-x>\n    "]);

    _templateObject_19a71610db3d11eaa14b6130b7e5d77f = function _templateObject_19a71610db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(AppEditorHax, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_19a71610db3d11eaa14b6130b7e5d77f(), this.appStoreConnection);
      }
    }, {
      key: "save",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_19a71610db3d11eaa14b6130b7e5d77f())];
      }
    }, {
      key: "tag",
      get: function get() {
