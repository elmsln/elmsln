define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/utils/async.js", "../../haxcms-elements/lib/core/haxcms-site-store.js", "../../../mobx/lib/mobx.module.js"], function (_exports, _require, _polymerElement, _renderStatus, _async, _haxcmsSiteStore, _mobxModule) {
  ...
  function _templateObject_62afc980b3b911e9b58d79562a23326c() {
    ...
    _templateObject_62afc980b3b911e9b58d79562a23326c = function _templateObject_62afc980b3b911e9b58d79562a23326c() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(SimpleBlogPost, _PolymerElement);
    babelHelpers.createClass(SimpleBlogPost, null, [{
      key: "tag",
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_62afc980b3b911e9b58d79562a23326c());
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    function SimpleBlogPost() {
      ...
      (0, _renderStatus.afterNextRender)(babelHelpers.assertThisInitialized(_this), function () {
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          ...
          _this2.hasImage = _this2._computeHasImage(fields);

          if (_this2.hasImage) {
            _this2.image = fields.images[0].src;
          }
      ...
      value: function _hasImageChanged(newValue, oldValue) {
        ...
        if (newValue) {
          _async.microTask.run(function () {
            var rect = _this3.shadowRoot.querySelector("#image").getBoundingClientRect();

            _this3.$.contentcontainer.style.paddingTop = rect.height + "px";
          });
        } else {
