define(["exports", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../simple-tooltip/simple-tooltip.js"], function (_exports, _litElement, _simpleColors, _simpleTooltip) {
  ...
  function _templateObject7_2d1e0b40416811ebba3583de56522db0() {
    ...
    _templateObject7_2d1e0b40416811ebba3583de56522db0 = function _templateObject7_2d1e0b40416811ebba3583de56522db0() {
      return data;
    };
  ...
  function _templateObject6_2d1e0b40416811ebba3583de56522db0() {
    var data = babelHelpers.taggedTemplateLiteral([" <simple-tooltip>", "</simple-tooltip> "]);

    _templateObject6_2d1e0b40416811ebba3583de56522db0 = function _templateObject6_2d1e0b40416811ebba3583de56522db0() {
      return data;
    };
  ...
  function _templateObject5_2d1e0b40416811ebba3583de56522db0() {
    var data = babelHelpers.taggedTemplateLiteral([" <div class=\"item-label\">", "</div> "]);

    _templateObject5_2d1e0b40416811ebba3583de56522db0 = function _templateObject5_2d1e0b40416811ebba3583de56522db0() {
      return data;
    };
  ...
  function _templateObject4_2d1e0b40416811ebba3583de56522db0() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject4_2d1e0b40416811ebba3583de56522db0 = function _templateObject4_2d1e0b40416811ebba3583de56522db0() {
      return data;
    };
  ...
  function _templateObject3_2d1e0b40416811ebba3583de56522db0() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject3_2d1e0b40416811ebba3583de56522db0 = function _templateObject3_2d1e0b40416811ebba3583de56522db0() {
      return data;
    };
  ...
  function _templateObject2_2d1e0b40416811ebba3583de56522db0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n              <div class=\"button-inner\">\n                <simple-icon\n                  icon=\"", "\"\n                  accent-color=\"", "\"\n                  contrast=\"4\"\n                  ?dark=\"", "\"\n                ></simple-icon>\n              </div>\n            "]);

    _templateObject2_2d1e0b40416811ebba3583de56522db0 = function _templateObject2_2d1e0b40416811ebba3583de56522db0() {
      return data;
    };
  ...
  function _templateObject_2d1e0b40416811ebba3583de56522db0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n        title=\"", "\"\n        ?disabled=\"", "\"\n        @click=\"", "\"\n      >\n        ", "\n        ", "\n      </button>\n      ", "\n    "]);

    _templateObject_2d1e0b40416811ebba3583de56522db0 = function _templateObject_2d1e0b40416811ebba3583de56522db0() {
      return data;
    };
  ...
  var HAXTrayButton = /*#__PURE__*/function (_SimpleColors) {
    ...
    babelHelpers.createClass(HAXTrayButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_2d1e0b40416811ebba3583de56522db0(), this.label, this.disabled, this._fireEvent, this.icon ? (0, _litElement.html)(_templateObject2_2d1e0b40416811ebba3583de56522db0(), this.icon, this.colorMeaning ? this.accentColor : "grey", this.colorMeaning ? true : this.iconDark) : (0, _litElement.html)(_templateObject3_2d1e0b40416811ebba3583de56522db0()), this.mini ? (0, _litElement.html)(_templateObject4_2d1e0b40416811ebba3583de56522db0()) : (0, _litElement.html)(_templateObject5_2d1e0b40416811ebba3583de56522db0(), this.label), this.mini ? (0, _litElement.html)(_templateObject6_2d1e0b40416811ebba3583de56522db0(), this.label) : "");
      }
    }, {
      key: "_focusIn",
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HAXTrayButton), "styles", this)), [(0, _litElement.css)(_templateObject7_2d1e0b40416811ebba3583de56522db0())]);
      }
    }]);
