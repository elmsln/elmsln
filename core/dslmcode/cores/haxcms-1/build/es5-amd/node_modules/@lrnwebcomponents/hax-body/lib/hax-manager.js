 ...
 */var HaxManager=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(HaxManager,_PolymerElement);function HaxManager(){var _this;babelHelpers.classCallCheck(this,HaxManager);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(HaxManager).call(this));new Promise(function(res,rej){return _require.default(["../../../@polymer/iron-icons/iron-icons.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/iron-icon/iron-icon.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-input/paper-input.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-button/paper-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/paper-icon-button/paper-icon-button.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@vaadin/vaadin-upload/vaadin-upload.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-preview.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-app-browser.js"],res,rej)});new Promise(function(res,rej){return _require.default(["./hax-gizmo-browser.js"],res,rej)});new Promise(function(res,rej){return _require.default(["../../../@polymer/app-layout/app-drawer/app-drawer.js"],res,rej)});return _this}babelHelpers.createClass(HaxManager,[{key:"ready",/**
   * life cycle
   */value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(HaxManager.prototype),"ready",this).call(this);// send an event that this is the manager
...
document.body.addEventListener("place-holder-file-drop",this._placeHolderFileDrop.bind(this));this.shadowRoot.querySelector("#dialog").addEventListener("iron-overlay-canceled",this.close.bind(this));this.shadowRoot.querySelector("#dialog").addEventListener("iron-overlay-closed",this.close.bind(this));this.shadowRoot.querySelector("#closedialog").addEventListener("click",this.close.bind(this));this.shadowRoot.querySelector("#newassetconfigure").addEventListener("click",this.newAssetConfigure.bind(this));this.shadowRoot.querySelector("#fileupload").addEventListener("upload-before",this._fileAboutToUpload.bind(this));this.shadowRoot.querySelector("#fileupload").addEventListener("upload-response",this._fileUploadResponse.bind(this))})}/**
   * Toggle panel size
   */},{key:"togglePanelSize",value:function togglePanelSize(e){this.shadowRoot.querySelector("#dialog").classList.toggle("grow");this.updateStyles();window.dispatchEvent(new Event("resize"))}/**
   * compute title for edit mode
   */},{key:"_computeEditTitle",value:function _computeEditTitle(updateExisting){if(babelHelpers.typeof(this.activeHaxElement)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))&&updateExisting){return"Update"}else{return"Insert"}}/**
   * A file event was detected from a drag and drop in the interface, most likely
   * from a place-holder tag
   */},{key:"_placeHolderFileDrop",value:function _placeHolderFileDrop(e){// reset the manager back to the first page
...
this.newAssetConfigure()}/**
   * Notice page changed.
   */},{key:"_activePageChanged",value:function _activePageChanged(newValue,oldValue){if(babelHelpers.typeof(newValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.searching=!1;this.updateStyles();if(1===newValue){this.shadowRoot.querySelector("#appbrowser").resetBrowser()}else if(2===newValue){this.shadowRoot.querySelector("#gizmobrowser").resetBrowser()}}}/**
   * Store updated, sync.
   ...
   */},{key:"_activeHaxElementChanged",value:function _activeHaxElementChanged(newValue,oldValue){if(babelHelpers.typeof(oldValue)!==("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.shadowRoot.querySelector("#preview").advancedForm=!1;if(babelHelpers.typeof(newValue.tag)===("undefined"===typeof void 0?"undefined":babelHelpers.typeof(void 0))){this.resetManager()}else{// reset files so it doesn't bloat up
...
window.HaxStore.instance.haxAppPicker.presentOptions(haxElements,type,"Pick how to present the "+type,"gizmo")}}else{window.HaxStore.toast("Sorry, HAX doesn't know how to handle that type of link yet.")}}/**
   * Toggle ourselves.
   */},{key:"toggleDialog",value:function toggleDialog(){var toggle=0<arguments.length&&arguments[0]!==void 0?arguments[0]:!0;if(this.opened&&toggle){this.close()}else{window.HaxStore.instance.closeAllDrawers(this)}}/**
   * Set step to configure or insert
   */},{key:"selectStep",value:function selectStep(step){if("configure"==step){this.activeStep=!0}else{this.activeStep=!1}}/**
   * Notice step changes
   */},{key:"_activeStepChanged",value:function _activeStepChanged(newValue,oldValue){if(newValue||!newValue){this.updateStyles();window.dispatchEvent(new Event("resize"))}}/**
   * Helper to take a multi-dimensional object and convert
   * it's reference into the real value. This allows for variable input defined
   * in a string to actually hit the deeper part of an object structure.
   */},{key:"_resolveObjectPath",value:function _resolveObjectPath(path,obj){return path.split(".").reduce(function(prev,curr){return prev?prev[curr]:null},obj||self)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_a7748fd0975111e99b82efb4a85a01e0())}},{key:"tag",get:function get(){return"hax-manager"}},{key:"properties",get:function get(){return{/**
       ...
       */__allowUpload:{type:Boolean,value:!1}}}}]);return HaxManager}(_polymerElement.PolymerElement);_exports.HaxManager=HaxManager;window.customElements.define(HaxManager.tag,HaxManager)});