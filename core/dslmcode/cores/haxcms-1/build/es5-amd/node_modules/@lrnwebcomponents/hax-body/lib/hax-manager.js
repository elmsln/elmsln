define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../../@polymer/paper-styles/paper-styles.js", "../../../@polymer/iron-pages/iron-pages.js", "../../utils/utils.js", "../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _simpleColors, _paperStyles, _ironPages, _utils, _customStyle) {
  "use strict";
  ...
  function _templateObject2_ebd53a901bb211eabd7cc30119585ddb() {
    ...
    _templateObject2_ebd53a901bb211eabd7cc30119585ddb = function _templateObject2_ebd53a901bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject_ebd53a901bb211eabd7cc30119585ddb() {
    ...
    _templateObject_ebd53a901bb211eabd7cc30119585ddb = function _templateObject_ebd53a901bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function (_winEventsElement) {
    babelHelpers.inherits(HaxManager, _winEventsElement);
    babelHelpers.createClass(HaxManager, null, [{
      key: "styles",
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxManager), "styles", this)), [(0, _litElement.css)(_templateObject_ebd53a901bb211eabd7cc30119585ddb())]);
      }
      /**
    ...
    function HaxManager() {
      ...
      _this.opened = false;
      _this.editExistingNode = false;
      _this.addTitle = "Upload media";
      _this.activeStep = 0;
      _this.searching = false;
      _this.activePage = 0;
      _this.canSupportUploads = false;
      _this.appList = [];
      _this.__allowUpload = false;
    ...
    babelHelpers.createClass(HaxManager, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_ebd53a901bb211eabd7cc30119585ddb(), this.opened, this.openedChanged, this.activeStep, this.activeStepChanged, this.activePageChanged, this.activePage, this.addTitle, this._fileAboutToUpload, this._fileUploadResponse, !this.canSupportUploads, this.newAssetConfigure, this.closeEvent, this.activeStep === 0 ? false : true);
      }
    }, {
      key: "activePageChanged",
      value: function activePageChanged(e) {
      ...
      value: function openedChanged(e) {
        ...
        if (this.opened) {
          new Promise(function (res, rej) {
            return _require.default(["./hax-manager-openeddeps.js"], res, rej);
          });
        }
      }
    }, {
      key: "activeStepChanged",
      value: function activeStepChanged(e) {
      ...
      value: function firstUpdated(changedProperties) {
        if (babelHelpers.get(babelHelpers.getPrototypeOf(HaxManager.prototype), "firstUpdated", this)) {
          babelHelpers.get(babelHelpers.getPrototypeOf(HaxManager.prototype), "firstUpdated", this).call(this, changedProperties);
        }
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "editExistingNode") {
            _this2.editTitle = _this2._computeEditTitle(_this2[propName]);
          }

          if (propName == "activeStep") {
            _this2._activeStepChanged(_this2[propName], oldValue);
          }

          if (propName == "activePage") {
            _this2._activePageChanged(_this2[propName], oldValue);
          }

          if (propName == "activeHaxElement" && _this2[propName] !== oldValue) {
            _this2._activeHaxElementChanged(_this2[propName], oldValue);
          }
      ...
      value: function _placeHolderFileDrop(e) {
        ...
        window.HaxStore.write("openDrawer", this, this); // reference the active place holder element since place holders are
      ...
      value: function _activePageChanged(newValue, oldValue) {
        ...
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          if (Number(newValue) === 1 && this.shadowRoot.querySelector("#appbrowser")) {
            this.shadowRoot.querySelector("#appbrowser").resetBrowser();
          } else if (Number(newValue) === 2 && this.shadowRoot.querySelector("#gizmobrowser")) {
      ...
      value: function close(e) {
        if (babelHelpers.typeof(e) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) || e.target === this.shadowRoot.querySelector("#dialog") || e.target === this.shadowRoot.querySelector("#closedialog")) {
