define(["exports", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/elements/dom-if.js", "../../@polymer/polymer/lib/utils/flush.js", "./lib/a11y-collapse-accordion-button.js", "./lib/a11y-collapse-icon-button.js"], function (_exports, _polymerElement, _domIf, _flush2, _a11yCollapseAccordionButton, _a11yCollapseIconButton) {
  "use strict";
  ...
  function _templateObject_21699d70e14a11e9bce923988a998e3c() {
    ...
    _templateObject_21699d70e14a11e9bce923988a998e3c = function _templateObject_21699d70e14a11e9bce923988a998e3c() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(A11yCollapse, _PolymerElement);

    function A11yCollapse() {
      babelHelpers.classCallCheck(this, A11yCollapse);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(A11yCollapse).apply(this, arguments));
    }

    babelHelpers.createClass(A11yCollapse, [{
      key: "_flush",
      value: function _flush(newValue) {
        (0, _flush2.flush)();
      }
      /**
      ...
      key: "_overrideProp",
      value: function _overrideProp(prop, val) {
        this[prop] = val;
      }
      /**
       * If no expanded value is set, the default will be same as collapsed
      ...
      key: "_getExpandCollapse",
      value: function _getExpandCollapse(expanded, ifFalse, ifTrue) {
      ...
      key: "_isRotated",
      value: function _isRotated(expanded, iconExpanded) {
      ...
      value: function _setAriaExpanded(expanded) {
        return "" + expanded;
      }
    }], [{
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_21699d70e14a11e9bce923988a998e3c());
      }
    }, {
      key: "tag",
      get: function get() {
