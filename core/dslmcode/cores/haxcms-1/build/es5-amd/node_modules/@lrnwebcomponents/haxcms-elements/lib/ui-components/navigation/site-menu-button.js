define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/lib/mobx.module.js", "../../core/utils/HAXCMSThemeParts.js", "../../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxModule, _HAXCMSThemeParts2, _customStyle) {
  "use strict";
  ...
  function _templateObject3_46ebbbb0c08c11ea97035babff2e214c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <simple-tooltip\n              for=\"menulink\"\n              offset=\"8\"\n              .position=\"", "\"\n            >\n              ", "\n            </simple-tooltip>\n          "]);

    _templateObject3_46ebbbb0c08c11ea97035babff2e214c = function _templateObject3_46ebbbb0c08c11ea97035babff2e214c() {
      return data;
    };
  ...
  function _templateObject2_46ebbbb0c08c11ea97035babff2e214c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <custom-style>\n        <style>\n          paper-button {\n            @apply --site-menu-button-button;\n          }\n        </style>\n      </custom-style>\n      <a\n        tabindex=\"-1\"\n        ?disabled=\"", "\"\n        .aria-label=\"", "\"\n        .part=\"", "\"\n      >\n        <paper-button\n          id=\"menulink\"\n          noink\n          ?disabled=\"", "\"\n          ?raised=\"", "\"\n          aria-label=\"", "\"\n          .part=\"", "\"\n        >\n          <slot name=\"prefix\"></slot>\n          <iron-icon icon=\"", "\"></iron-icon>\n          <slot name=\"suffix\"></slot>\n        </paper-button>\n      </a>\n      ", "\n    "]);

    _templateObject2_46ebbbb0c08c11ea97035babff2e214c = function _templateObject2_46ebbbb0c08c11ea97035babff2e214c() {
      return data;
    };
  ...
  function _templateObject_46ebbbb0c08c11ea97035babff2e214c() {
    ...
    _templateObject_46ebbbb0c08c11ea97035babff2e214c = function _templateObject_46ebbbb0c08c11ea97035babff2e214c() {
      return data;
    };
  ...
  function (_HAXCMSThemeParts) {
    ...
    babelHelpers.createClass(SiteMenuButton, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SiteMenuButton), "styles", this)), [(0, _litElement.css)(_templateObject_46ebbbb0c08c11ea97035babff2e214c())]);
      }
      /**
    ...
    function SiteMenuButton() {
      ...
      (0, _mobxModule.autorun)(function (reaction) {
        _this.activeRouterManifestIndex = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.activeRouterManifestIndex);
      ...
      (0, _mobxModule.autorun)(function (reaction) {
        _this.editMode = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.editMode);
    ...
    babelHelpers.createClass(SiteMenuButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_46ebbbb0c08c11ea97035babff2e214c(), this.disabled, this.label, this.editMode ? "edit-mode-active" : "", this.disabled, this.raised, this.label, this.editMode ? "edit-mode-active" : "", this.icon, !this.hideLabel ? (0, _litElement.html)(_templateObject3_46ebbbb0c08c11ea97035babff2e214c(), this.position, this.label) : "");
      }
      /**
       * Props
       */
      ...
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(SiteMenuButton), "properties", this), {
          type: {
            type: String,
            reflect: true
          },
