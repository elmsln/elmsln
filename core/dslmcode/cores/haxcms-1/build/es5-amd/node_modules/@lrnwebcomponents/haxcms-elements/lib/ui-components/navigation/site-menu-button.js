define(["exports", "require", "../../../../../@polymer/polymer/polymer-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/lib/mobx.module.js", "../../../../../@polymer/paper-button/paper-button.js"], function (_exports, _require, _polymerElement, _haxcmsSiteStore, _mobxModule, _paperButton) {
  ...
  function _templateObject_842186d0e14a11e9bce923988a998e3c() {
    ...
    _templateObject_842186d0e14a11e9bce923988a998e3c = function _templateObject_842186d0e14a11e9bce923988a998e3c() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(SiteMenuButton, [{
      ...
      key: "pageLinkStatus",
      value: function pageLinkStatus(type, activeRouterManifestIndex, items, editMode) {
        if (editMode) {
          return true;
        }
      ...
      value: function connectedCallback() {
        ...
        this.__disposer2 = (0, _mobxModule.autorun)(function () {
          _this2.activeRouterManifestIndex = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.activeRouterManifestIndex);
        });
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_842186d0e14a11e9bce923988a998e3c());
      }
      /**
       * Props
       */
      ...
      get: function get() {
        return {
          ...
          link: {
            type: String,
            computed: "pageLink(type, activeRouterManifestIndex, routerManifest.items)"
          },
          editMode: {
            type: Boolean
          },
          disabled: {
            type: Boolean,
            reflectToAttribute: true,
            computed: "pageLinkStatus(type, activeRouterManifestIndex, routerManifest.items, editMode)"
          },
          label: {
            type: String
          },
