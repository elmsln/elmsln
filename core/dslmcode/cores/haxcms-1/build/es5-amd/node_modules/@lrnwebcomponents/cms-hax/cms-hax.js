define(["exports", "require", "../../@polymer/polymer/polymer-element.js", "../../@polymer/polymer/lib/utils/flattened-nodes-observer.js", "../../@polymer/iron-ajax/iron-ajax.js", "../h-a-x/h-a-x.js", "../simple-toast/simple-toast.js"], function (_exports, _require, _polymerElement, _flattenedNodesObserver, _ironAjax, _hAX, _simpleToast) {
  ...
  function _templateObject_f527c750b3b811e9b58d79562a23326c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <style>\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      </style>\n      <iron-ajax\n        id=\"pageupdateajax\"\n        url=\"[[endPoint]]\"\n        method=\"[[method]]\"\n        body=\"[[updatePageData]]\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        on-response=\"_handleUpdateResponse\"\n      ></iron-ajax>\n      <h-a-x app-store$=\"[[appStoreConnection]]\"></h-a-x>\n    "]);

    _templateObject_f527c750b3b811e9b58d79562a23326c = function _templateObject_f527c750b3b811e9b58d79562a23326c() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(CmsHax, [{
      ...
      value: function _noticeTagChanges(openDefault, allowedTags, hideExportButton, hidePanelOps, hidePreferencesButton, align, bodyOffsetLeft) {
      ...
      value: function _storeReady(e) {
        ...
        this._noticeTagChanges(this.openDefault, this.allowedTags, this.hideExportButton, this.hidePanelOps, this.hidePreferencesButton, this.align, this.bodyOffsetLeft);
      }
      /**
       * Created life cycle
       */
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_f527c750b3b811e9b58d79562a23326c());
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      key: "observers",
      get: function get() {
        return ["_noticeTagChanges(openDefault, allowedTags, hideExportButton, hidePanelOps, hidePreferencesButton, align, bodyOffsetLeft)"];
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(CmsHax, [{
      ...
      value: function connectedCallback() {
        ...
        this.__lock = false;
        window.addEventListener("hax-save", this._saveFired.bind(this)); // open things by default and set state for edit mode
        ...
        if (this.syncBody) {
          (0, _flattenedNodesObserver.FlattenedNodesObserver)(window.HaxStore.instance.activeHaxBody, function (info) {
            if (!_this2.__lock) {
              _this2.__lock = true;

              _this2.dispatchEvent(new CustomEvent("hax-body-content-changed", {
                bubbles: true,
                cancelable: true,
                composed: true,
        ...
        if (!this.hideMessage) {
          ...
          if (this.redirectOnSave) {
            setTimeout(function () {
              ...
              window.location = _this3.redirectLocation;
            }, 1000);
          }
        }
      }
