define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/iron-ajax/iron-ajax.js", "../h-a-x/h-a-x.js", "../hax-body/lib/hax-store.js"], function (_exports, _require, _litElement, _ironAjax, _hAX, _haxStore) {
  ...
  function _templateObject2_0932f9105a6e11eb8957f34616f75140() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      "]);

    _templateObject2_0932f9105a6e11eb8957f34616f75140 = function _templateObject2_0932f9105a6e11eb8957f34616f75140() {
      return data;
    };
  ...
  function _templateObject_0932f9105a6e11eb8957f34616f75140() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-ajax\n        id=\"pageupdateajax\"\n        url=\"", "\"\n        method=\"", "\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @response=\"", "\"\n      ></iron-ajax>\n      <h-a-x app-store=\"", "\"></h-a-x>\n    "]);

    _templateObject_0932f9105a6e11eb8957f34616f75140 = function _templateObject_0932f9105a6e11eb8957f34616f75140() {
      return data;
    };
  ...
  var CmsHax = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(CmsHax, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_0932f9105a6e11eb8957f34616f75140(), this.endPoint, this.method, this._handleUpdateResponse, this.__appStore);
      }
    }, {
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_0932f9105a6e11eb8957f34616f75140())];
      }
    }, {
      key: "tag",
      get: function get() {
        ...
        if (!this._observer && this.syncBody && _haxStore.HAXStore.activeHaxBody) {
          this._observer = new MutationObserver(function (mutations) {
            if (!_this7.__lock) {
              ...
              _this7.dispatchEvent(new CustomEvent("hax-body-content-changed", {
                bubbles: true,
                cancelable: true,
                composed: true,
