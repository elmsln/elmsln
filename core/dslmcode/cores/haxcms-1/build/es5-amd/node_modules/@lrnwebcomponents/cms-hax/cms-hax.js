define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/iron-ajax/iron-ajax.js", "../h-a-x/h-a-x.js", "../hax-body/lib/hax-store.js"], function (_exports, _require, _litElement, _ironAjax, _hAX, _haxStore) {
  "use strict";
  ...
  function _templateObject2_a664d69054f111eba18757df1555c032() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      "]);

    _templateObject2_a664d69054f111eba18757df1555c032 = function _templateObject2_a664d69054f111eba18757df1555c032() {
      return data;
    };
  ...
  function _templateObject_a664d69054f111eba18757df1555c032() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-ajax\n        id=\"pageupdateajax\"\n        url=\"", "\"\n        method=\"", "\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @response=\"", "\"\n      ></iron-ajax>\n      <h-a-x app-store=\"", "\"></h-a-x>\n    "]);

    _templateObject_a664d69054f111eba18757df1555c032 = function _templateObject_a664d69054f111eba18757df1555c032() {
      return data;
    };
  ...
  var CmsHax = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(CmsHax, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_a664d69054f111eba18757df1555c032(), this.endPoint, this.method, this._handleUpdateResponse, this.__appStore);
      }
    }, {
       ...
       */
      value: function _activeHaxBodyUpdated(ready) {
      ...
      value: function _noticeTagChanges(openDefault, allowedTags, hidePanelOps, offsetMargin, hidePreferencesButton, elementAlign) {
        if (_haxStore.HAXStore.ready) {
          ...
          setTimeout(function () {
            ...
            _haxStore.HAXStore.haxTray.elementAlign = elementAlign;
          }, 0);

          if (openDefault) {
            _haxStore.HAXStore.editMode = openDefault;
          }
        }
      }
      /**
      ...
      value: function _storeReady(e) {
        ...
        setTimeout(function () {
          ...
          _this2._noticeTagChanges(_this2.openDefault, _this2.allowedTags, _this2.hidePanelOps, _this2.offsetMargin, _this2.hidePreferencesButton, _this2.elementAlign);

          _this2.__applyMO();

          window.removeEventListener("hax-store-ready", _this2._storeReady.bind(_this2), {
            once: true,
            passive: true
          });
        }, 0);
      ...
      value: function _appstoreLoaded(e) {
        ...
        setTimeout(function () {
          _this3.ready = true;
          window.removeEventListener("hax-store-app-store-loaded", _this3._appstoreLoaded.bind(_this3), {
            once: true,
            passive: true
          });
        }, 0);
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_a664d69054f111eba18757df1555c032())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    function CmsHax() {
      ...
      window.addEventListener("hax-save", _this._saveFired.bind(babelHelpers.assertThisInitialized(_this)));
      _this.__lock = false;
      _this.endPoint = null;
    ...
    babelHelpers.createClass(CmsHax, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "redirectLocation") {
            _this4.redirectOnSave = _this4._computeRedirectOnSave(_this4[propName]);
          }

          if (propName == "ready" && _this4.ready && _this4.shadowRoot) {
            _this4._activeHaxBodyUpdated(_this4.ready);
          }

          if (propName == "appStoreConnection") {
            _this4._makeAppStore(_this4[propName]);
          }

          if (["openDefault", "allowedTags", "hidePanelOps", "offsetMargin", "hidePreferencesButton", "elementAlign"].includes(propName)) {
            _this4._noticeTagChanges(_this4.openDefault, _this4.allowedTags, _this4.hidePanelOps, _this4.offsetMargin, _this4.hidePreferencesButton, _this4.elementAlign);
          }
        });
      }
      /**
        ...
        if (!this._observer && this.syncBody && _haxStore.HAXStore.activeHaxBody) {
          this._observer = new MutationObserver(function (mutations) {
            if (!_this5.__lock) {
              ...
              _this5.dispatchEvent(new CustomEvent("hax-body-content-changed", {
                bubbles: true,
                cancelable: true,
                composed: true,
                detail: _haxStore.HAXStore.activeHaxBody.haxToContent()
              }));
      ...
      value: function _saveFired(e) {
        ...
        if (this.endPoint) {
          this.shadowRoot.querySelector("#pageupdateajax").body = _haxStore.HAXStore.activeHaxBody.haxToContent(); // send the request
      ...
      value: function _handleUpdateResponse(e) {
        ...
        if (!this.hideMessage) {
          ...
          if (this.redirectOnSave) {
            setTimeout(function () {
              // trigger redirect
              window.location = _this6.redirectLocation;
            }, 500);
          }
        }
      }
