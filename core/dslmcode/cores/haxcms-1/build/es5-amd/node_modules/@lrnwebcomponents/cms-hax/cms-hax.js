define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/iron-ajax/iron-ajax.js", "../h-a-x/h-a-x.js", "../hax-body/lib/hax-store.js"], function (_exports, _require, _litElement, _ironAjax, _hAX, _haxStore) {
  ...
  function _templateObject2_fc3bb4f0380711ebb75743ba17e46dd5() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          font-size: 16px;\n          box-sizing: content-box;\n        }\n      "]);

    _templateObject2_fc3bb4f0380711ebb75743ba17e46dd5 = function _templateObject2_fc3bb4f0380711ebb75743ba17e46dd5() {
      return data;
    };
  ...
  function _templateObject_fc3bb4f0380711ebb75743ba17e46dd5() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <iron-ajax\n        id=\"pageupdateajax\"\n        url=\"", "\"\n        method=\"", "\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @response=\"", "\"\n      ></iron-ajax>\n      <h-a-x app-store=\"", "\"></h-a-x>\n    "]);

    _templateObject_fc3bb4f0380711ebb75743ba17e46dd5 = function _templateObject_fc3bb4f0380711ebb75743ba17e46dd5() {
      return data;
    };
  ...
  var CmsHax = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(CmsHax, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_fc3bb4f0380711ebb75743ba17e46dd5(), this.endPoint, this.method, this._handleUpdateResponse, this.__appStore);
      }
    }, {
       ...
       */
      value: function _activeHaxBodyUpdated(bodyElement, ready) {
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_fc3bb4f0380711ebb75743ba17e46dd5())];
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "redirectLocation") {
            _this3.redirectOnSave = _this3._computeRedirectOnSave(_this3[propName]);
          }

          if (propName == "activeHaxBody" || propName == "__ready") {
            _this3._activeHaxBodyUpdated(_this3.activeHaxBody, _this3.__ready);
          }

          if (propName == "appStoreConnection") {
            _this3._makeAppStore(_this3[propName]);
          }

          if (["openDefault", "allowedTags", "hidePanelOps", "offsetMargin", "hidePreferencesButton", "elementAlign"].includes(propName)) {
            _this3._noticeTagChanges(_this3.openDefault, _this3.allowedTags, _this3.hidePanelOps, _this3.offsetMargin, _this3.hidePreferencesButton, _this3.elementAlign);
          }
        });
      }
      /**
        ...
        if (!this._observer && this.syncBody && _haxStore.HAXStore.activeHaxBody) {
          this._observer = new MutationObserver(function (mutations) {
            if (!_this4.__lock) {
              ...
              _this4.dispatchEvent(new CustomEvent("hax-body-content-changed", {
                bubbles: true,
                cancelable: true,
                composed: true,
      ...
      value: function _handleUpdateResponse(e) {
        ...
        if (!this.hideMessage) {
          ...
          if (this.redirectOnSave) {
            setTimeout(function () {
              // trigger redirect
              window.location = _this5.redirectLocation;
            }, 500);
          }
        }
      }
