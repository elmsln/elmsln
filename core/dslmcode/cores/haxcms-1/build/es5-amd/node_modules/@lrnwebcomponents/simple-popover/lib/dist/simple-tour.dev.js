...
function _templateObject2_1abadd50514511ecad92218912f770fd() {
  var data = _taggedTemplateLiteral(["", '\n          <h2 class="subheading" slot="body">\n            ', "\n          </h2>\n          ", "", ""]);

  _templateObject2_1abadd50514511ecad92218912f770fd = function _templateObject2_1abadd50514511ecad92218912f770fd() {
    return data;
  };
...
function _templateObject_1abadd50514511ecad92218912f770fd() {
  ...
  _templateObject_1abadd50514511ecad92218912f770fd = function _templateObject_1abadd50514511ecad92218912f770fd() {
    return data;
  };
...
var SimpleTour = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(SimpleTour, [{
    ...
    value: function tourButtons() {
      return (0, _litElement.html)(_templateObject_1abadd50514511ecad92218912f770fd(), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.stopTour.bind(this), this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext());
    }
    /**
