...
function _templateObject2_aebdc8a01bd511ecb06de58eee077492() {
  var data = _taggedTemplateLiteral(["", '\n          <h2 class="subheading" slot="body">\n            ', "\n          </h2>\n          ", "", ""]);

  _templateObject2_aebdc8a01bd511ecb06de58eee077492 = function _templateObject2_aebdc8a01bd511ecb06de58eee077492() {
    return data;
  };
...
function _templateObject_aebdc8a01bd511ecb06de58eee077492() {
  ...
  _templateObject_aebdc8a01bd511ecb06de58eee077492 = function _templateObject_aebdc8a01bd511ecb06de58eee077492() {
    return data;
  };
...
var SimpleTour = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(SimpleTour, [{
    ...
    value: function tourButtons() {
      return (0, _litElement.html)(_templateObject_aebdc8a01bd511ecb06de58eee077492(), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.stopTour.bind(this), this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext());
    }
    /**
