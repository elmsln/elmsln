...
function _templateObject2_8cd9cb709bf111ec9d3703fd9549253d() {
  var data = _taggedTemplateLiteral(["", '\n          <h2 class="subheading" slot="body">\n            ', "\n          </h2>\n          ", "", ""]);

  _templateObject2_8cd9cb709bf111ec9d3703fd9549253d = function _templateObject2_8cd9cb709bf111ec9d3703fd9549253d() {
    return data;
  };
...
function _templateObject_8cd9cb709bf111ec9d3703fd9549253d() {
  ...
  _templateObject_8cd9cb709bf111ec9d3703fd9549253d = function _templateObject_8cd9cb709bf111ec9d3703fd9549253d() {
    return data;
  };
...
var SimpleTour = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(SimpleTour, [{
    ...
    value: function tourButtons() {
      return (0, _litElement.html)(_templateObject_8cd9cb709bf111ec9d3703fd9549253d(), this.tourInfo[this.active].name, this.stop + 1, this.stacks[this.active].length, this.stopTour.bind(this), this.prevStop.bind(this), !this.hasPrev(), this.nextStop.bind(this), !this.hasNext());
    }
    /**
