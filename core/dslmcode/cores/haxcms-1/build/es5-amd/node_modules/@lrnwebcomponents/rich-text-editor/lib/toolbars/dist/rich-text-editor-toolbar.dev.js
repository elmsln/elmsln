...
function _templateObject3_818713a0d50811ebbe9e3797c9b99b72() {
  ...
  _templateObject3_818713a0d50811ebbe9e3797c9b99b72 = function _templateObject3_818713a0d50811ebbe9e3797c9b99b72() {
    return data;
  };
...
function _templateObject2_818713a0d50811ebbe9e3797c9b99b72() {
  var data = _taggedTemplateLiteral(["\n          :host {\n            position: relative;\n            height: 0;\n            margin: 0 auto;\n            padding: 0;\n            border: none;\n            background-color: none;\n          }\n          #container {\n            display: flex;\n            position: absolute;\n            bottom: 0;\n            margin: 0 auto;\n            padding: 0;\n            border: var(--rich-text-editor-border-width, 1px) solid\n              var(--rich-text-editor-border-color, #ddd);\n            background-color: var(\n              --rich-text-editor-bg,\n              var(--rich-text-editor-bg, #ffffff)\n            );\n          }\n        "]);

  _templateObject2_818713a0d50811ebbe9e3797c9b99b72 = function _templateObject2_818713a0d50811ebbe9e3797c9b99b72() {
    return data;
  };
...
function _templateObject_818713a0d50811ebbe9e3797c9b99b72() {
  var data = _taggedTemplateLiteral([' <div id="container">', "</div> "]);

  _templateObject_818713a0d50811ebbe9e3797c9b99b72 = function _templateObject_818713a0d50811ebbe9e3797c9b99b72() {
    return data;
  };
...
var RichTextEditorToolbarBehaviors = function RichTextEditorToolbarBehaviors(SuperClass) {
  return /*#__PURE__*/function (_SimpleToolbarBehavio) {
    ...
    _createClass(_class, [{
      ...
      key: "miniTemplate",
      get: function get() {
        return (0, _litElement.html)(_templateObject_818713a0d50811ebbe9e3797c9b99b72(), _get(_getPrototypeOf(_class.prototype), "toolbarTemplate", this));
      }
      /**
      ...
      key: "miniStyles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_818713a0d50811ebbe9e3797c9b99b72())];
      }
      /**
      ...
      key: "baseStyles",
      get: function get() {
        return [].concat(_toConsumableArray(_get(_getPrototypeOf(_class), "baseStyles", this)), _toConsumableArray(_richTextEditorButton.RichTextStyles), [(0, _litElement.css)(_templateObject3_818713a0d50811ebbe9e3797c9b99b72())]);
      }
      /**
    ...
    function _class() {
      ...
      Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../buttons/rich-text-editor-button.js"));
      });
      Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../buttons/rich-text-editor-source-code.js"));
      });
      Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../buttons/rich-text-editor-heading-picker.js"));
      });
      Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../buttons/rich-text-editor-symbol-picker.js"));
      });
      Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../buttons/rich-text-editor-underline.js"));
      });
      Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../buttons/rich-text-editor-image.js"));
      });
      Promise.resolve().then(function () {
        return _interopRequireWildcard(require("../buttons/rich-text-editor-link.js"));
      });
    ...
    _createClass(_class, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (["editor", "show", "range"].includes(propName)) _this2.hidden = _this2.disconnected;
          if (["breadcrumbs", "sticky"].includes(propName) && !!_this2.breadcrumbs) _this2.breadcrumbs.sticky = _this2.sticky;
        });
      }
    }, {
      ...
      value: function close() {
        this.dispatchEvent(new CustomEvent("disableediting", {
          bubbles: true,
          cancelable: true,
          composed: true,
          detail: this
      ...
      value: function setRange(range) {
        this.dispatchEvent(new CustomEvent("setrange", {
          bubbles: true,
          cancelable: true,
          composed: true,
          detail: {
      ...
      value: function _addBreadcrumbs() {
        ...
        if (!this.breadcrumbs) {
          ...
          this.breadcrumbs.addEventListener("breadcrumb-click", this._handleBreadcrumb.bind(this));
        }
      ...
      value: function _rangeChange() {
        ...
        if (this.range && this.range.commonAncestorContainer && this.editor && this.editor.contains(this.range.commonAncestorContainer)) {
          var ancestor = this.range.commonAncestorContainer,
              ancestorNode = ancestor.nodeType == 1 ? ancestor : ancestor.parentNode,
              nodes = [],
              getParentNode = function getParentNode(node) {
            nodes.push(node);
            if (node.parentNode && node.parentNode !== _this7.editor) getParentNode(node.parentNode);
          };
      ...
      key: "disconnected",
      get: function get() {
        return this.show == "always" ? false : this.show != "selection" ? !this.editor : this.noSelection;
      }
      /**
