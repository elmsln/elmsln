define(["exports", "../../lit-element/lit-element.js", "../a11y-collapse/lib/a11y-collapse-group.js", "../a11y-collapse/a11y-collapse.js", "../simple-colors/simple-colors.js", "../accent-card/accent-card.js"], function (_exports, _litElement, _a11yCollapseGroup, _a11yCollapse, _simpleColors, _accentCard) {
  ...
  function _templateObject3_cb569c8088c411ea8e2ed3d8cb6f439c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: flex;\n        }\n      "]);

    _templateObject3_cb569c8088c411ea8e2ed3d8cb6f439c = function _templateObject3_cb569c8088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function _templateObject2_cb569c8088c411ea8e2ed3d8cb6f439c() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <iron-icon icon=\"", "\"></iron-icon>\n              "]);

    _templateObject2_cb569c8088c411ea8e2ed3d8cb6f439c = function _templateObject2_cb569c8088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function _templateObject_cb569c8088c411ea8e2ed3d8cb6f439c() {
    ...
    _templateObject_cb569c8088c411ea8e2ed3d8cb6f439c = function _templateObject_cb569c8088c411ea8e2ed3d8cb6f439c() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(ProductCard, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_cb569c8088c411ea8e2ed3d8cb6f439c(), !this.disabled ? this.accentColor : "grey", this.disabled, this.icon ? (0, _litElement.html)(_templateObject2_cb569c8088c411ea8e2ed3d8cb6f439c(), this.icon) : "", this.heading, this.subheading, this.disabled, this.disabled || !this.hasDemo, this.__demoCollapseStatusChange, this.__demoCollapseStatusChange);
      }
    }, {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(ProductCard), "styles", this)), [(0, _litElement.css)(_templateObject3_cb569c8088c411ea8e2ed3d8cb6f439c())]);
      }
    }, {
      key: "properties",
      get: function get() {
