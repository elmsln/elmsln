...
mutation.removedNodes.forEach(function(node){if(node.tagName){_this3.updateEditorValue(node)}})}})});this._observer.observe(this,{childList:!0})}},{key:"disconnectedCallback",value:function disconnectedCallback(){if(this._observer){this._observer.disconnect();this._observer=null}babelHelpers.get(babelHelpers.getPrototypeOf(CodeEditor.prototype),"disconnectedCallback",this).call(this)}},{key:"editorReady",value:function editorReady(e){if(this.editorValue){this.shadowRoot.querySelector("#codeeditor").value=this.editorValue}}}],[{key:"tag",get:function get(){return"code-editor"}},{key:"properties",get:function get(){return _objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(CodeEditor),"properties",this),{/**
       * Title
       */title:{type:String},/**
       ...
       */focused:{type:Boolean,reflect:!0}})}}]);return CodeEditor}((0,_schemaBehaviors.SchemaBehaviors)(_litElement.LitElement));_exports.CodeEditor=CodeEditor;window.customElements.define(CodeEditor.tag,CodeEditor)});