...
test("reads default-per-extension from XML", function () {
  var contentTypes = readContentTypesFromXml(new XmlElement("content-types:Types", {}, [new XmlElement("content-types:Default", {
    Extension: "png",
...
test("fallback content types have common image types", function () {
  var contentTypes = readContentTypesFromXml(new XmlElement("content-types:Types", {}, []));
  assert.equal(contentTypes.findContentType("word/media/hat.png"), "image/png");
