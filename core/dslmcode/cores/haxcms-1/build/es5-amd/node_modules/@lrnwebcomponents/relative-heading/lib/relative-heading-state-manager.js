define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_2bef8eb0284011eb97976fb20742a907() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        simple-toast:not(:defined) {\n          display: none;\n        }\n      "]);

    _templateObject2_2bef8eb0284011eb97976fb20742a907 = function _templateObject2_2bef8eb0284011eb97976fb20742a907() {
      return data;
    };
  ...
  function _templateObject_2bef8eb0284011eb97976fb20742a907() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-toast\n        id=\"relative-heading-toast\"\n        duration=\"5000\"\n        ?hidden=\"", "\"\n        ?disabled=\"", "\"\n        text=\"", ": ", "\"\n      >\n        <simple-icon-button\n          icon=\"", "\"\n          label=\"", "\"\n          title=\"", "\"\n          @click=\"", "\"\n        ></simple-icon-button>\n      </simple-toast>\n    "]);

    _templateObject_2bef8eb0284011eb97976fb20742a907 = function _templateObject_2bef8eb0284011eb97976fb20742a907() {
      return data;
    };
  ...
  var RelativeHeadingStateManager = /*#__PURE__*/function (_LitElement) {
    babelHelpers.inherits(RelativeHeadingStateManager, _LitElement);

    var _super = _createSuper(RelativeHeadingStateManager);
    ...
    babelHelpers.createClass(RelativeHeadingStateManager, null, [{
      ...
      key: "properties",
      get: function get() {
        return _objectSpread(_objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(RelativeHeadingStateManager), "properties", this)), {}, {
          /**
    ...
    babelHelpers.createClass(RelativeHeadingStateManager, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_2bef8eb0284011eb97976fb20742a907(), !this.usesCopyLink, !this.usesCopyLink, this.copyHeading.copyMessage || this.copyMessage, this.copyUrl, this.copyHeading.closeIcon || this.closeIcon, this.copyHeading.closeLabel || this.closeLabel, this.copyHeading.closeLabel || this.closeLabel, this.closeCopyLink);
      }
      /**
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_2bef8eb0284011eb97976fb20742a907())];
      }
    }]);
