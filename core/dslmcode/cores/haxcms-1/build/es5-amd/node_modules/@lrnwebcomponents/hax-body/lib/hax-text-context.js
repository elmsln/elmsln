define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/simple-icon.js", "../../hax-iconset/lib/simple-hax-iconset.js", "./hax-context-item-menu.js", "./hax-context-item.js", "./hax-context-item-textop.js", "./hax-toolbar.js", "../../simple-popover/lib/simple-popover-selection.js", "../../simple-popover/lib/SimpleTourFinder.js", "./hax-store.js", "../../../mobx/dist/mobx.esm.js"], function (_exports, _litElement, _simpleIcon, _simpleHaxIconset, _haxContextItemMenu, _haxContextItem, _haxContextItemTextop, _haxToolbar, _simplePopoverSelection, _SimpleTourFinder2, _haxStore, _mobxEsm) {
  "use strict";
  ...
  function _templateObject3_87377d50290811ebbe0ae90af5f52b1f() {
    var data = babelHelpers.taggedTemplateLiteral([" <button slot=\"options\" value=\"", "\">\n                <simple-icon icon=\"", "\"></simple-icon>\n                ", "\n              </button>"]);

    _templateObject3_87377d50290811ebbe0ae90af5f52b1f = function _templateObject3_87377d50290811ebbe0ae90af5f52b1f() {
      return data;
    };
  ...
  function _templateObject_87377d50290811ebbe0ae90af5f52b1f() {
    ...
    _templateObject_87377d50290811ebbe0ae90af5f52b1f = function _templateObject_87377d50290811ebbe0ae90af5f52b1f() {
      return data;
    };
  ...
  var HaxTextContext = /*#__PURE__*/function (_SimpleTourFinder) {
    ...
    babelHelpers.createClass(HaxTextContext, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_87377d50290811ebbe0ae90af5f52b1f())];
      }
    }]);
    ...
    function HaxTextContext() {
      ...
      (0, _mobxEsm.autorun)(function () {
        ...
        var activeNode = (0, _mobxEsm.toJS)(_haxStore.HAXStore.activeNode); // update our icon if global changes what we are pointing to

        if (_haxStore.HAXStore.isTextElement(activeNode) && _this.shadowRoot.querySelector('#textformat button[value="' + activeNode.tagName.toLowerCase() + '"]')) {
          if (_this.shadowRoot.querySelector("simple-popover-selection").opened) {
    ...
    babelHelpers.createClass(HaxTextContext, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_87377d50290811ebbe0ae90af5f52b1f(), !this.hasSelectedText, this.textFormatChanged, this.formatIcon, this.formattingList.map(function (val) {
          return (0, _litElement.html)(_templateObject3_87377d50290811ebbe0ae90af5f52b1f(), val.value, val.icon, val.text);
        }), !this._showLists, !this._showLists, !this._showIndent, !this._showIndent, !this.hasSelectedText, !this.hasSelectedText, !this.hasSelectedText, !this.hasSelectedText, !this.hasSelectedText, this.isSafari || !this.hasSelectedText, !this.isSafari || !this.hasSelectedText);
      }
    }, {
      ...
      value: function updateTextIconSelection(tag) {
        ...
        var localItem = this.shadowRoot.querySelector('#textformat button[value="' + this.realSelectedValue + '"]');
