define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _ironIcons) {
  ...
  function _templateObject2_e22b04201bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          height: var(--a11y-tabs-tab-height, --a11y-tabs-height);\n          overflow: var(--a11y-tabs-tab-overflow, --a11y-tabs-overflow);\n        }\n        :host([hidden]) {\n          display: none;\n        }\n        .sr-only {\n          position: absolute;\n          left: -99999px;\n          height: 0;\n          overflow: hidden;\n        }\n      "]);

    _templateObject2_e22b04201bb211eabd7cc30119585ddb = function _templateObject2_e22b04201bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject_e22b04201bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"sr-only\">Tab ", "</span>\n      <slot></slot>\n      <span class=\"sr-only\"\n        >End of tab ", ". Back to\n        <a href=\"", "\">tabs</a>.</span\n      >\n    "]);

    _templateObject_e22b04201bb211eabd7cc30119585ddb = function _templateObject_e22b04201bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(A11yTab, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_e22b04201bb211eabd7cc30119585ddb(), this.__xOfY, this.__xOfY, this.__toTop);
      } // properties available to the custom element for data binding

    }], [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_e22b04201bb211eabd7cc30119585ddb())];
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    babelHelpers.createClass(A11yTab, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "flag") _this3._tabChanged();
          if (propName === "flagIcon") _this3._tabChanged();
          if (propName === "icon") _this3._tabChanged();
          if (propName === "id") _this3._tabChanged();
          if (propName === "label") _this3._tabChanged();
        });
      }
      /**
