define(["exports", "../../../lit-element/lit-element.js", "../../simple-icon/lib/simple-icon-lite.js", "../../simple-icon/lib/simple-icons.js"], function (_exports, _litElement, _simpleIconLite, _simpleIcons) {
  ...
  var _templateObject_9b3516a0b80f11eb903f3b4791d1f11f, _templateObject2_9b3516a0b80f11eb903f3b4791d1f11f;
  ...
  var A11yTab = /*#__PURE__*/function (_LitElement) {
    ...
    var _super = _createSuper(A11yTab);
    ...
    babelHelpers.createClass(A11yTab, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_9b3516a0b80f11eb903f3b4791d1f11f || (_templateObject_9b3516a0b80f11eb903f3b4791d1f11f = babelHelpers.taggedTemplateLiteral(["\n      <span class=\"sr-only\">Tab ", "</span>\n      <div class=\"label-heading\" part=\"heading\">\n        <simple-icon-lite\n          class=\"icon\"\n          ?hidden=\"", "\"\n          .icon=\"", "\"\n          part=\"icon\"\n        >\n        </simple-icon-lite>\n        <slot name=\"label\" ?hidden=\"", "\"></slot>\n        <div class=\"label\" part=\"label\">", "</div>\n      </div>\n      <div id=\"content-inner\" part=\"content\"><slot></slot></div>\n      <span class=\"sr-only\">\n        End of tab ", ". Back to <a href=\"#", "\">tabs</a>.\n      </span>\n    "])), this.xOfY, !this.icon, this.icon, !this.label, this.label, this.xOfY, this.id);
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (["id", "order"].includes(propName) && !_this4.id) _this4.id = "tab-".concat(_this4.order);
          if (["label", "order"].includes(propName) && !_this4.label) _this4._labelChanged();
          if (propName === "flag") _this4._fireTabChanged();
          if (propName === "flagIcon") _this4._fireTabChanged();
          if (propName === "icon") _this4._fireTabChanged();

          if (propName === "id") {
            _this4.ariaLabelledby = "".concat(_this4.id, "-button");

            _this4._fireTabChanged();
          }

          if (propName === "label") _this4._fireTabChanged();
          if (propName === "disabled" && _this4.disabled) _this4._fireTabChanged();
        });
      }
      /**
