...
*/var EditableTable=/*#__PURE__*/function(_displayBehaviors){babelHelpers.inherits(EditableTable,_displayBehaviors);function EditableTable(){babelHelpers.classCallCheck(this,EditableTable);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(EditableTable).apply(this,arguments))}babelHelpers.createClass(EditableTable,[{key:"toggleEditMode",/**
   * Toggles between edit-mode and display mode.
   */value:function toggleEditMode(edit){var temp;edit=edit!==void 0?edit:!this.editMode;if(edit){this.shadowRoot.querySelector("editable-table-display").toggleFilter();this.shadowRoot.querySelector("editable-table-display").sortData(!1);temp=this.shadowRoot.querySelector("editable-table-display").getData();console.log(temp)}else{temp=this.shadowRoot.querySelector("editable-table-editor").getData()}for(var prop in temp){if("data"!==prop){this[prop]=temp[prop]}else{this.set("data",temp[prop])}}this.editMode=edit}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_bc7e3f40a89311e989aa8f044e2d635b())}},{key:"tag",get:function get(){return"editable-table"}},{key:"properties",get:function get(){return{/**
       * Is the table in edit-mode? Default is false (display mode).
       */editMode:{type:Boolean,value:!1}}}}]);return EditableTable}((0,_editableTableBehaviors.displayBehaviors)((0,_editableTableBehaviors.editBehaviors)(_polymerElement.PolymerElement)));_exports.EditableTable=EditableTable;window.customElements.define(EditableTable.tag,EditableTable)});