define(["exports", "../../@polymer/polymer/polymer-element.js", "../simple-tooltip/simple-tooltip.js", "../../@polymer/paper-input/paper-input.js", "../../@polymer/iron-ajax/iron-ajax.js", "../simple-icon/simple-icon.js", "../simple-icon/lib/simple-icons.js", "../hax-iconset/lib/simple-hax-iconset.js", "./lib/editable-table-behaviors.js", "./lib/editable-table-editor-rowcol.js", "./lib/editable-table-editor-toggle.js", "./lib/editable-table-editor-cell.js", "./lib/editable-table-styles.js", "./lib/editable-table-display.js"], function (_exports, _polymerElement, _simpleTooltip, _paperInput, _ironAjax, _simpleIcon, _simpleIcons, _simpleHaxIconset, _editableTableBehaviors, _editableTableEditorRowcol, _editableTableEditorToggle, _editableTableEditorCell, _editableTableStyles, _editableTableDisplay) {
  "use strict";
  ...
  function _templateObject_7a4e14902a8011eba2d4d1ca9882dbe4() {
    ...
    _templateObject_7a4e14902a8011eba2d4d1ca9882dbe4 = function _templateObject_7a4e14902a8011eba2d4d1ca9882dbe4() {
      return data;
    };
  ...
  var EditableTable = /*#__PURE__*/function (_displayBehaviors) {
    ...
    babelHelpers.createClass(EditableTable, [{
      ...
      value: function haxactiveElementChanged(el, value) {
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_7a4e14902a8011eba2d4d1ca9882dbe4());
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    babelHelpers.createClass(EditableTable, [{
      ...
      value: function connectedCallback() {
        ...
        babelHelpers.get(babelHelpers.getPrototypeOf(EditableTable.prototype), "connectedCallback", this).call(this);
        setTimeout(function () {
          // re-run initial state if missed because of how element is stamped into DOM
          if (!_this2.data || _this2.data.length < 1 || _this2.data[0].length < 1) {
            var table = _this2.children.item(0); // support wrapping editable-table-display tag or primative
            ...
            if (babelHelpers.typeof(table) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && table !== null && table.tagName === "TABLE" && table.children && table.children.length > 0) {
              _this2.importHTML(table);
            } else {
              _this2.set("data", [["", "", ""], ["", "", ""], ["", "", ""]]);
            }
          }
      ...
      value: function _dataChanged(newValue, oldValue) {
        if (this.__ready && (!newValue || newValue.length < 1 || newValue[0].length < 1)) {
