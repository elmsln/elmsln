define(["exports", "../../lit/index.js", "./lib/editable-table-behaviors.js", "../rich-text-editor/rich-text-editor.js", "../rich-text-editor/lib/toolbars/rich-text-editor-toolbar-mini.js", "../simple-tooltip/simple-tooltip.js", "../simple-icon/lib/simple-icon-lite.js", "../simple-icon/lib/simple-icons.js", "../hax-iconset/lib/simple-hax-iconset.js", "./lib/editable-table-editor-rowcol.js", "./lib/editable-table-editor-toggle.js", "./lib/editable-table-display.js", "../utils/utils.js"], function (_exports, _index, _editableTableBehaviors, _richTextEditor, _richTextEditorToolbarMini, _simpleTooltip, _simpleIconLite, _simpleIcons, _simpleHaxIconset, _editableTableEditorRowcol, _editableTableEditorToggle, _editableTableDisplay, _utils) {
  "use strict";
  ...
  var _templateObject_14d414b0d50811ebbe9e3797c9b99b72, _templateObject2_14d414b0d50811ebbe9e3797c9b99b72, _templateObject3_14d414b0d50811ebbe9e3797c9b99b72, _templateObject4_14d414b0d50811ebbe9e3797c9b99b72, _templateObject5_14d414b0d50811ebbe9e3797c9b99b72;
  ...
  var EditableTable = /*#__PURE__*/function (_displayBehaviors) {
    ...
    babelHelpers.createClass(EditableTable, [{
      ...
      key: "_handleMenuOpen",
      value: function _handleMenuOpen(e) {} //console.log(e);
      ...
      value: function haxeditModeChanged(val) {
        if (babelHelpers.get(babelHelpers.getPrototypeOf(EditableTable.prototype), "haxeditModeChanged", this)) babelHelpers.get(babelHelpers.getPrototypeOf(EditableTable.prototype), "haxeditModeChanged", this).call(this, val);
        this.editMode = val;
        ...
        return {
          ...
          settings: {
            configure: [{
              ...
              inputMethod: "boolean",
              description: "When table is wider than screens, users will select a column to display instead of scrolling across table."
            }, {
              property: "printable",
              inputMethod: "boolean",
            ...
            advanced: [{
              ...
              inputMethod: "boolean",
              description: "Right-align numeric values and indicate negative values as red text"
            }]
          },
          saveOptions: {
          ...
          demoSchema: [{
            ...
            content: "<table><caption></caption><thead><tr><th></th><th></th><th></th></tr></thead><tbody><tr><th></th><td></td><td></td></tr></thead></table>"
          }]
        };
      }
    }]);
    return EditableTable;
  }((0, _editableTableBehaviors.displayBehaviors)(_index.LitElement));
