define(["exports", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "./lrndesign-chart-behaviors.js", "../../hax-body-behaviors/lib/HAXWiring.js"], function (_exports, _polymerElement, _renderStatus, _lrndesignChartBehaviors, _HAXWiring) {
  "use strict";
  ...
  var LrndesignLine =
  /*#__PURE__*/
  function (_LrndesignChartBehavi) {
    babelHelpers.inherits(LrndesignLine, _LrndesignChartBehavi);

    function LrndesignLine() {
      babelHelpers.classCallCheck(this, LrndesignLine);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrndesignLine).apply(this, arguments));
    }
    ...
    babelHelpers.createClass(LrndesignLine, [{
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignLine.prototype), "connectedCallback", this).call(this);
      ...
      get: function get() {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignLine), "properties", this)) {
          props = Object.assign(props, babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignLine), "properties", this));
        }
  ...
  }(_lrndesignChartBehaviors.LrndesignChartBehaviors);
  /**
