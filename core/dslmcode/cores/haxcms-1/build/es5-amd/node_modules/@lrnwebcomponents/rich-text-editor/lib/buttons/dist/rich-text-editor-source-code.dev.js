...
var RichTextEditorSourceCode = /*#__PURE__*/function (_RichTextEditorButton) {
  ...
  _createClass(RichTextEditorSourceCode, [{
    key: "render",
    // render function for template
    value: function render() {
      return _get(_getPrototypeOf(RichTextEditorSourceCode.prototype), "render", this).call(this);
    }
  }], [{
    key: "tag",
  ...
  function RichTextEditorSourceCode() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(RichTextEditorSourceCode).call(this));
    _this.icon = "code";
    _this.toggled = false;
  ...
  _createClass(RichTextEditorSourceCode, [{
    ...
    key: "properties",
    get: function get() {
      return _objectSpread({}, _get(_getPrototypeOf(RichTextEditorSourceCode), "properties", this), {
        /**
...
}((0, _richTextEditorButton.RichTextEditorButtonBehaviors)(_litElement.LitElement));

exports.RichTextEditorSourceCode = RichTextEditorSourceCode;
window.customElements.define(RichTextEditorSourceCode.tag, RichTextEditorSourceCode);