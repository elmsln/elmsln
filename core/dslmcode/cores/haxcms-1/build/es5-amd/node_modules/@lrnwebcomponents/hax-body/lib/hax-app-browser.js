define(["exports", "require", "../../../@polymer/polymer/polymer-element.js", "../../../@polymer/polymer/lib/utils/render-status.js", "../../../@polymer/polymer/lib/utils/async.js", "../../simple-colors/simple-colors.js", "../../grafitto-filter/grafitto-filter.js", "../../../@polymer/iron-list/iron-list.js", "../../../@polymer/iron-pages/iron-pages.js", "./hax-shared-styles.js"], function (_exports, _require, _polymerElement, _renderStatus, _async, _simpleColors, _grafittoFilter, _ironList, _ironPages, _haxSharedStyles) {
  ...
  function _templateObject_446c0470e14a11e9bce923988a998e3c() {
    ...
    _templateObject_446c0470e14a11e9bce923988a998e3c = function _templateObject_446c0470e14a11e9bce923988a998e3c() {
      return data;
    };
  ...
  function (_PolymerElement) {
    babelHelpers.inherits(HaxAppBrowser, _PolymerElement);
    ...
    babelHelpers.createClass(HaxAppBrowser, [{
      ...
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(HaxAppBrowser.prototype), "connectedCallback", this).call(this);
        this.resetBrowser();
      }
    }, {
      key: "ready",
      value: function ready() {
        babelHelpers.get(babelHelpers.getPrototypeOf(HaxAppBrowser.prototype), "ready", this).call(this);
      ...
      value: function resetBrowser() {
        ...
        _async.microTask.run(function () {
          ...
          _this3.set("__appList", window.HaxStore.instance.appList);

          if (_this3.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist")) {
            _this3.shadowRoot.querySelector("#filter").shadowRoot.querySelector("#ironlist").filtered = _this3.__appList;
          }

          _this3.shadowRoot.querySelector("#inputfilter").value = "";
          _this3.shadowRoot.querySelector("#filtertype").value = "details.title";
          _this3.shadowRoot.querySelector("#filter").value = "";

          _this3.shadowRoot.querySelector("#filter").filter();

          _this3.shadowRoot.querySelector("#filter").where = "details.title";
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_446c0470e14a11e9bce923988a998e3c());
      }
    }, {
      key: "tag",
      get: function get() {
