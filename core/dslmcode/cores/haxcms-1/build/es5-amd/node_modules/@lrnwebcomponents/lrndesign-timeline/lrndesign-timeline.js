...
value:function render(){return(0,_litElement.html)(_templateObject_d80fc3607a9c11ea8ed6ed8c9eef0ab1(),this.timelineTitle,this._checkScroll,this.eventsList.map(function(event,index){return(0,_litElement.html)(_templateObject2_d80fc3607a9c11ea8ed6ed8c9eef0ab1(),event.imagesrc&&""!==event.imagesrc,event.heading,!event.imagesrc||""===event.imagesrc?"":(0,_litElement.html)(_templateObject3_d80fc3607a9c11ea8ed6ed8c9eef0ab1(),event.imagealt,event.imagesrc),event.details)}))}// properties available to the custom element for data binding
...
[
   ...
   */timelineSize:{type:"String",reflect:!0,attribute:"timeline-size",value:"xs",/**
     ...
     */title:{type:"String",attribute:"title"}}}}},{key:"tag",get:function get(){return"lrndesign-timeline"}// life cycle
}]);function LrndesignTimeline(){var _this;babelHelpers.classCallCheck(this,LrndesignTimeline);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LrndesignTimeline).call(this));_this.events=[];_this.timelineSize="xs";window.ResponsiveUtility.requestAvailability();window.dispatchEvent(new CustomEvent("responsive-element",{detail:{element:babelHelpers.assertThisInitialized(_this),attribute:"timeline-size",relativeToParent:!0,sm:600,md:900,lg:1200,xl:1600}}));return _this}/**
   * handle updates
   ...
   * @readonly
   * @memberof LrndesignTimeline
   */},{key:"eventsList",get:function get(){var events="string"===typeof this.events?JSON.parse(this.events):this.events;return events||[]}}]);return LrndesignTimeline}(_simpleColors.SimpleColors);_exports.LrndesignTimeline=LrndesignTimeline;customElements.define(LrndesignTimeline.tag,LrndesignTimeline)});