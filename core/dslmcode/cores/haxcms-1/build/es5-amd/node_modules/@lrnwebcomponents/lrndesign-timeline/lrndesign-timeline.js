define(["exports", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../responsive-utility/responsive-utility.js"], function (_exports, _litElement, _simpleColors, _responsiveUtility) {
  ...
  function _templateObject4_614a3a90939b11eaa49d972a432e908f() {
    ...
    _templateObject4_614a3a90939b11eaa49d972a432e908f = function _templateObject4_614a3a90939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function _templateObject3_614a3a90939b11eaa49d972a432e908f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                            <div>\n                              <div>\n                                <img\n                                  alt=\"", "\"\n                                  src=\"", "\"\n                                />\n                              </div>\n                            </div>\n                          "]);

    _templateObject3_614a3a90939b11eaa49d972a432e908f = function _templateObject3_614a3a90939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function _templateObject2_614a3a90939b11eaa49d972a432e908f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                <section\n                  class=\"event\"\n                  ?has-media=\"", "\"\n                >\n                  <div class=\"event-overview\">\n                    <div class=\"heading\"><h2>", "</h2></div>\n                    <div class=\"media-outer\">\n                      ", "\n                    </div>\n                  </div>\n                  <div class=\"details\">", "</div>\n                </section>\n              "]);

    _templateObject2_614a3a90939b11eaa49d972a432e908f = function _templateObject2_614a3a90939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function _templateObject_614a3a90939b11eaa49d972a432e908f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <article>\n        <h1 id=\"title\">", "</h1>\n        <slot></slot>\n        <div id=\"timeline\">\n          <div id=\"events\" @scroll=\"", "\">\n            ", "\n          </div>\n        </div>\n      </article>\n    "]);

    _templateObject_614a3a90939b11eaa49d972a432e908f = function _templateObject_614a3a90939b11eaa49d972a432e908f() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(LrndesignTimeline, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_614a3a90939b11eaa49d972a432e908f(), this.timelineTitle, this._checkScroll, this.eventsList.map(function (event, index) {
          return (0, _litElement.html)(_templateObject2_614a3a90939b11eaa49d972a432e908f(), event.imagesrc && event.imagesrc !== "", event.heading, !event.imagesrc || event.imagesrc === "" ? "" : (0, _litElement.html)(_templateObject3_614a3a90939b11eaa49d972a432e908f(), event.imagealt, event.imagesrc), event.details);
        }));
      ...
      //styles function
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(LrndesignTimeline), "styles", this)), [(0, _litElement.css)(_templateObject4_614a3a90939b11eaa49d972a432e908f())]);
      }
    }, {
      key: "properties",
      get: function get() {
    ...
    function LrndesignTimeline() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrndesignTimeline).call(this));
      _this.events = [];
      _this.timelineSize = "xs";
      window.ResponsiveUtility.requestAvailability();
      window.dispatchEvent(new CustomEvent("responsive-element", {
        detail: {
          element: babelHelpers.assertThisInitialized(_this),
          attribute: "timeline-size",
    ...
    babelHelpers.createClass(LrndesignTimeline, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "timelineTitle" && _this2.title && !_this2.timelineTitle) _this2.timelineTitle = _this2.title;
        });
        this.updateTimeline();
      }
      /**
      ...
      value: function updateTimeline() {
        var events = this.shadowRoot && this.shadowRoot.querySelector("#events") ? this.shadowRoot.querySelector("#events") : undefined,
