define(["exports", "require", "../../../../../lit-element/lit-element.js", "../haxcms-site-store.js", "../../../../beaker-broker/beaker-broker.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _beakerBroker) {
  "use strict";
  ...
  function _templateObject_7045e2f02d8511ea80ccf124101da415() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <beaker-broker id=\"beaker\"></beaker-broker>\n    "]);

    _templateObject_7045e2f02d8511ea80ccf124101da415 = function _templateObject_7045e2f02d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSBackendBeaker, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_7045e2f02d8511ea80ccf124101da415());
      }
    }], [{
      key: "tag",
      ...
      value: function _appPicked(e) {
        ...
        if (e.detail.connection.protocol === "dat") {
          ...
          reader.onload = function (event) {
            var fileLocation = "files/" + window.HaxStore.instance.haxManager.shadowRoot.querySelector("#fileupload").files[0].name;
