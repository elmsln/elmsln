define(["exports", "require", "../../../../../lit-element/lit-element.js", "../haxcms-site-store.js", "../../../../../mobx/dist/mobx.esm.js", "../../../../utils/utils.js", "../../../../beaker-broker/beaker-broker.js", "../../../../hax-body/lib/hax-store.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _mobxEsm, _utils, _beakerBroker, _haxStore) {
  "use strict";
  ...
  function _templateObject_6d17804051d611eba9e8f7a417db1b23() {
    var data = babelHelpers.taggedTemplateLiteral([" <beaker-broker id=\"beaker\"></beaker-broker> "]);

    _templateObject_6d17804051d611eba9e8f7a417db1b23 = function _templateObject_6d17804051d611eba9e8f7a417db1b23() {
      return data;
    };
  ...
  var HAXCMSBackendBeaker = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSBackendBeaker, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_6d17804051d611eba9e8f7a417db1b23());
      }
    }], [{
      key: "tag",
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return this.shadowRoot.querySelector("#beaker").write(this.activeItem.location, _haxStore.HAXStore.activeHaxBody.haxToContent());
