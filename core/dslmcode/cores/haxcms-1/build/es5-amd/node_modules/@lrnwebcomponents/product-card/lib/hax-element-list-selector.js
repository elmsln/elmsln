define(["meta", "require", "../../../lit-element/lit-element.js", "../../hexagon-loader/hexagon-loader.js", "../../../@polymer/iron-icons/av-icons.js", "../../../@polymer/iron-icons/communication-icons.js", "../../../@polymer/iron-icons/device-icons.js", "../../../@polymer/iron-icons/editor-icons.js", "../../../@polymer/iron-icons/hardware-icons.js", "../../../@polymer/iron-icons/image-icons.js", "../../../@polymer/iron-icons/iron-icons.js", "../../../@polymer/iron-icons/maps-icons.js", "../../../@polymer/iron-icons/notification-icons.js", "../../../@polymer/iron-icons/places-icons.js", "../../../@polymer/iron-icons/social-icons.js", "../../lrn-icons/lrn-icons.js", "../../mdi-iconset-svg/mdi-iconset-svg.js", "../../hax-iconset/hax-iconset.js", "../../simple-fields/lib/simple-fields-form.js", "./hax-element-card-list.js"], function (meta, _require, _litElement, _hexagonLoader, _avIcons, _communicationIcons, _deviceIcons, _editorIcons, _hardwareIcons, _imageIcons, _ironIcons, _mapsIcons, _notificationIcons, _placesIcons, _socialIcons, _lrnIcons, _mdiIconsetSvg, _haxIconset, _simpleFieldsForm, _haxElementCardList) {
  ...
  function _templateObject3_3568a550833411ea8e4b05ff9c5d5706() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hexagon-loader\n              item-count=\"4\"\n              color=\"blue\"\n              ?loading=\"", "\"\n              size=\"large\"\n            ></hexagon-loader>\n            <h2 ?hidden=\"", "\">Loading HAX elements..</h2>\n            <hax-element-card-list\n              id=\"productlist\"\n              @enabled-changed=\"", "\"\n              cols=\"", "\"\n              .list=\"", "\"\n            ></hax-element-card-list>\n          "]);

    _templateObject3_3568a550833411ea8e4b05ff9c5d5706 = function _templateObject3_3568a550833411ea8e4b05ff9c5d5706() {
      return data;
    };
  ...
  function _templateObject2_3568a550833411ea8e4b05ff9c5d5706() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <simple-fields-form\n        id=\"form\"\n        autoload\n        load-endpoint=\"", "\"\n        method=\"", "\"\n        @response=\"", "\"\n        @value-changed=\"", "\"\n      >\n      </simple-fields-form>\n      ", "\n    "]);

    _templateObject2_3568a550833411ea8e4b05ff9c5d5706 = function _templateObject2_3568a550833411ea8e4b05ff9c5d5706() {
      return data;
    };
  ...
  function _templateObject_3568a550833411ea8e4b05ff9c5d5706() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        :host([loading]) hax-element-card-list {\n          visibility: hidden;\n          opacity: 0;\n          transition: 1s ease-in-out all;\n        }\n        hax-element-card-list {\n          visibility: visible;\n          opacity: 1;\n        }\n        hexagon-loader[loading] {\n          position: absolute;\n          width: 100%;\n        }\n        [hidden] {\n          display: none !important;\n        }\n      "]);

    _templateObject_3568a550833411ea8e4b05ff9c5d5706 = function _templateObject_3568a550833411ea8e4b05ff9c5d5706() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HaxElementListSelector, null, [{
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_3568a550833411ea8e4b05ff9c5d5706())];
      }
    }]);
    ...
    function HaxElementListSelector() {
      ...
      _this.haxData = [];
      _this.noSchema = {};
      _this.method = "GET"; // default fields json blob, most implementations should provide their own though obviously
    ...
    babelHelpers.createClass(HaxElementListSelector, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_3568a550833411ea8e4b05ff9c5d5706(), this.fieldsEndpoint, this.method, this._response, this._valueChanged, this.showCardList ? (0, _litElement.html)(_templateObject3_3568a550833411ea8e4b05ff9c5d5706(), this.loading, !this.loading, this._enabledChanged, this.cols, this.filteredHaxData) : "");
      }
    }, {
      key: "_enabledChanged",
      value: function _enabledChanged(e) {
        ...
        this.haxData.forEach(function (el, i) {
          if (el.tag == e.detail.tag) {
            _this2.haxData[i].status = e.detail.status;
          }
        });
                ...
                switch (_context3.prev = _context3.next) {
                  case 0:
                    if (propName == "wcRegistryEndpoint") {
                      _this3.haxData = [];
                      _this3.imports = [];
                      fetch(_this3[propName]).then(function (response) {
                        _this3.loading = true;
                  ...
                  case 3:
                    ...
                    if (propName == "haxData") {
                      ...
                      if (_this3.haxData.length > 0) {
                        ...
                        _this3.shadowRoot.querySelector("#form").shadowRoot.querySelector("#sf").querySelector('[name="haxcore.providerdetails.haxcore-providerdetails-haxtags"]').editorValue = JSON.stringify(renderHaxData, null, 2);
                      }
                    }

                    if (propName == "noSchema") {
                      if (Object.keys(_this3.noSchema).length > 0) {
                        _this3.shadowRoot.querySelector("#form").shadowRoot.querySelector("#sf").querySelector('[name="haxcore.providerdetails.haxcore-providerdetails-othertags"]').editorValue = JSON.stringify(_this3.noSchema, null, 2);
                      }
                    }
      ...
      value: function _valueChanged(e) {
        ...
        this.__valueDebounce = setTimeout(function () {
          var value = _this4.shadowRoot.querySelector("#form").submit();

          if (value && value.haxcore) {
            // look for CDN provider
            if (value.haxcore.providers["haxcore-providers-cdn"] == "other") {
              _this4.wcRegistryEndpoint = value.haxcore.providers["haxcore-providers-other"] + "wc-registry.json";
            } else {
              _this4.wcRegistryEndpoint = value.haxcore.providers["haxcore-providers-cdn"] + "wc-registry.json";
            } // set columns


            _this4.cols = parseInt(value.haxcore.search["haxcore-search-columns"]); // apply filters

            _this4.filteredHaxData = babelHelpers.toConsumableArray(_this4.applyFilters(value.haxcore.search));

            if (_this4.shadowRoot.querySelector("#productlist")) {
              _this4.shadowRoot.querySelector("#productlist").requestUpdate();
            }
          }
