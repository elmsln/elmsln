...
if(!newValue){this.$.outline.importJsonOutlineSchemaItems()}else{var items=this.$.outline.exportJsonOutlineSchemaItems(!0);this.set("manifestItems",items)}}/**
   ...
   */},{key:"_saveTap",value:function _saveTap(e){window.dispatchEvent(new CustomEvent("haxcms-save-outline",{bubbles:!0,composed:!0,detail:this.$.outline.exportJsonOutlineSchemaItems(!0)}))}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_be1eb760975111e99b82efb4a85a01e0())}},{key:"properties",get:function get(){return{/**
