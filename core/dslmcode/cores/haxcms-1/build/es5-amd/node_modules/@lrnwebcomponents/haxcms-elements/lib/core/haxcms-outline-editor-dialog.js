define(["exports", "../../../../lit/index.js", "./haxcms-site-store.js", "../../../../mobx/dist/mobx.esm.js", "./utils/HAXCMSI18NMixin.js", "../../../json-outline-schema/json-outline-schema.js", "../../../outline-designer/outline-designer.js", "../../../simple-icon/simple-icon.js", "../../../simple-icon/lib/simple-icons.js"], function (_exports, _index, _haxcmsSiteStore, _mobxEsm, _HAXCMSI18NMixin2, _jsonOutlineSchema, _outlineDesigner, _simpleIcon, _simpleIcons) {
  "use strict";
  ...
  var _templateObject_b00dd330809211edaa2833647dc78c6c, _templateObject2_b00dd330809211edaa2833647dc78c6c;
   ...
   */
  var HAXCMSOutlineEditorDialog = /*#__PURE__*/function (_HAXCMSI18NMixin) {
    babelHelpers.inherits(HAXCMSOutlineEditorDialog, _HAXCMSI18NMixin);
    ...
    babelHelpers.createClass(HAXCMSOutlineEditorDialog, [{
      ...
      function render() {
        return (0, _index.html)(_templateObject_b00dd330809211edaa2833647dc78c6c || (_templateObject_b00dd330809211edaa2833647dc78c6c = babelHelpers.taggedTemplateLiteral(["\n      <outline-designer\n        id=\"outline\"\n        edit-mode\n        .hidden=\"", "\"\n        .items=\"", "\"\n      ></outline-designer>\n      <div class=\"buttons\">\n        <button @click=\"", "\" class=\"hax-modal-btn\">\n          ", "\n        </button>\n        <button @click=\"", "\" class=\"cancel hax-modal-btn\">\n          ", "\n        </button>\n      </div>\n    "])), this.viewMode, this.manifestItems, this._saveTap, this.t.save, this._cancelTap, this.t.cancel);
      }
    }, {
      key: "updated",
      value:
      ...
      function updated(changedProperties) {
        ...
        if (babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSOutlineEditorDialog.prototype), "updated", this)) {
          babelHelpers.get(babelHelpers.getPrototypeOf(HAXCMSOutlineEditorDialog.prototype), "updated", this).call(this, changedProperties);
        }
        ...
        (0, _mobxEsm.autorun)(function (reaction) {
          ...
          setTimeout(function () {
            ...
            if (_this3.shadowRoot) {
              _this3.shadowRoot.querySelector("#outline").__syncUIAndDataModel();
            }
          }, 500);
      ...
      key: "_saveTap",
      value: function () {
        var _saveTap2 = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
          var _this4 = this;

          var data, deleted, modified, added, sumChanges, confirmation;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.next = 3;
                  return this.shadowRoot.querySelector("#outline").getData();
        ...
        function _saveTap(_x) {
          return _saveTap2.apply(this, arguments);
        }
