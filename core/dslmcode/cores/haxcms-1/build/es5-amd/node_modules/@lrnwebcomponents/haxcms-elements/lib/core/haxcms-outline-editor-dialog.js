define(["exports", "require", "../../../../@polymer/polymer/polymer-element.js", "../../../../@polymer/polymer/lib/utils/render-status.js", "./haxcms-site-store.js", "../../../../mobx/lib/mobx.module.js", "../../../json-outline-schema/json-outline-schema.js", "../../../json-editor/json-editor.js", "../../../editable-outline/editable-outline.js"], function (_exports, _require, _polymerElement, _renderStatus, _haxcmsSiteStore, _mobxModule, _jsonOutlineSchema, _jsonEditor, _editableOutline) {
  ...
  function _templateObject_548407e0b49011e9ae0d876050e9d419() {
    ...
    _templateObject_548407e0b49011e9ae0d876050e9d419 = function _templateObject_548407e0b49011e9ae0d876050e9d419() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(HAXCMSOutlineEditorDialog, null, [{
      key: "tag",
    ...
    babelHelpers.createClass(HAXCMSOutlineEditorDialog, [{
      ...
      value: function ready() {
        ...
        (0, _renderStatus.afterNextRender)(this, function () {
          ...
          this.$.editor.addEventListener("current-data-changed", function (e) {
            if (e.detail.value) {
              _this2.set("manifestItems", e.detail.value);

              _this2.$.outline.importJsonOutlineSchemaItems();
            }
          });
        });
      }
      ...
      value: function connectedCallback() {
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          setTimeout(function () {
            _this3.manifestItems = Object.assign([], (0, _mobxModule.toJS)(_haxcmsSiteStore.store.manifest.items));
      ...
      value: function disconnectedCallback() {
        ...
        this.$.editor.removeEventListener("current-data-changed", function (e) {
          if (e.detail.value) {
            _this4.set("manifestItems", e.detail.value);

            _this4.$.outline.importJsonOutlineSchemaItems();
          }
        });
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_548407e0b49011e9ae0d876050e9d419());
      }
    }, {
      key: "properties",
      get: function get() {
