define(["exports", "../../../../lit-element/lit-element.js", "./haxcms-site-store.js", "../../../../mobx/lib/mobx.module.js", "../../../json-outline-schema/json-outline-schema.js", "../../../json-editor/json-editor.js", "../../../editable-outline/editable-outline.js", "../../../../@polymer/paper-button/paper-button.js", "../../../../@polymer/iron-icon/iron-icon.js", "../../../../@polymer/iron-icons/iron-icons.js"], function (_exports, _litElement, _haxcmsSiteStore, _mobxModule, _jsonOutlineSchema, _jsonEditor, _editableOutline, _paperButton, _ironIcon, _ironIcons) {
  ...
  function _templateObject2_6bd961102d8511ea80ccf124101da415() {
    ...
    _templateObject2_6bd961102d8511ea80ccf124101da415 = function _templateObject2_6bd961102d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function _templateObject_6bd961102d8511ea80ccf124101da415() {
    ...
    _templateObject_6bd961102d8511ea80ccf124101da415 = function _templateObject_6bd961102d8511ea80ccf124101da415() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(HAXCMSOutlineEditorDialog, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_6bd961102d8511ea80ccf124101da415(), this.viewMode, this.manifestItems, this.currentDataChangedEvent, this.manifestItemsStatic, !this.viewMode, this._saveTap, this.toggleView, this._viewIcon, this.viewLabel);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_6bd961102d8511ea80ccf124101da415())];
      }
      /**
    ...
    function HAXCMSOutlineEditorDialog() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HAXCMSOutlineEditorDialog).call(this));
      _this.__disposer = [];
    ...
    babelHelpers.createClass(HAXCMSOutlineEditorDialog, [{
      key: "currentDataChangedEvent",
      value: function currentDataChangedEvent(e) {
        if (e.detail.value) {
          this.manifestItems = babelHelpers.toConsumableArray(e.detail.value);
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "viewMode") {
            ...
            _this2._viewModeChanged(_this2[propName], oldValue);
          }
        });
      }
    }, {
      ...
      value: function connectedCallback() {
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          _this3.manifestItems = babelHelpers.toConsumableArray((0, _mobxModule.toJS)(_haxcmsSiteStore.store.manifest.items));
      ...
      value: function _viewModeChanged(newValue, oldValue) {
        ...
        if (!newValue) {
          ...
          var items = this.shadowRoot.querySelector("#outline").exportJsonOutlineSchemaItems(true);
