define(["exports", "../../../lit-element/lit-element.js", "./simple-fields-fieldset.js", "../../../@polymer/paper-button/paper-button.js", "../../../@polymer/iron-icon/iron-icon.js", "../../../@polymer/iron-icons/iron-icons.js", "./simple-fields-array-item.js"], function (_exports, _litElement, _simpleFieldsFieldset, _paperButton, _ironIcon, _ironIcons, _simpleFieldsArrayItem) {
  ...
  function _templateObject3_3d022460db3d11eaa14b6130b7e5d77f() {
    ...
    _templateObject3_3d022460db3d11eaa14b6130b7e5d77f = function _templateObject3_3d022460db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject2_3d022460db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"top\">\n        ", "\n        <paper-button\n          id=\"expand\"\n          controls=\"item-fields\"\n          @click=\"", "\"\n        >\n          ", "\n          <iron-icon\n            class=\"", "\"\n            aria-hidden=\"true\"\n            icon=\"expand-more\"\n          ></iron-icon>\n        </paper-button>\n      </div>\n      <div id=\"item-fields\" aria-live=\"polite\">\n        <slot></slot>\n        <paper-button\n          id=\"add\"\n          controls=\"item-fields\"\n          @click=\"", "\"\n        >\n          Add Item\n          <iron-icon aria-hidden=\"true\" icon=\"add\"></iron-icon>\n        </paper-button>\n      </div>\n    "]);

    _templateObject2_3d022460db3d11eaa14b6130b7e5d77f = function _templateObject2_3d022460db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_3d022460db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <fieldset>\n        ", "", "\n      </fieldset>\n    "]);

    _templateObject_3d022460db3d11eaa14b6130b7e5d77f = function _templateObject_3d022460db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_SimpleFieldsFieldset) {
    ...
    babelHelpers.createClass(SimpleFieldsArray, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_3d022460db3d11eaa14b6130b7e5d77f(), this.legend, this.fields);
      }
    }, {
      key: "fields",
      get: function get() {
        ...
        return (0, _litElement.html)(_templateObject2_3d022460db3d11eaa14b6130b7e5d77f(), this.desc, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(SimpleFieldsArray), "styles", this)), [(0, _litElement.css)(_templateObject3_3d022460db3d11eaa14b6130b7e5d77f())]);
      }
    }, {
      key: "properties",
      get: function get() {
