...
var H5POldEmbed = H5POldEmbed || function () {
  ...
  var loadResizer = function loadResizer(url) {
    var data,
        callback = "H5POldEmbed";
    resizer = true; // Callback for when content data is loaded.

    window[callback] = function (content) {
      // Add resizing script to head
      var resizer = document.createElement("script");
      resizer.src = content;
      head.appendChild(resizer); // Clean up
  ...
  var addIframe = function addIframe(script) {
    // Add iframe
