define(["exports", "../../lit/index.js", "../schema-behaviors/schema-behaviors.js", "../simple-modal/simple-modal.js"], function (_exports, _index, _schemaBehaviors, _simpleModal) {
  ...
  var _templateObject_b411db50f15711eb870c37be8598a0cc, _templateObject2_b411db50f15711eb870c37be8598a0cc;
  ...
  var LrnVocab = /*#__PURE__*/function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(LrnVocab, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_b411db50f15711eb870c37be8598a0cc || (_templateObject_b411db50f15711eb870c37be8598a0cc = babelHelpers.taggedTemplateLiteral([" <button>", "</button> "])), this.term);
      }
    }, {
      key: "haxHooks",
      value:
       ...
       */
      function get() {
        return [(0, _index.css)(_templateObject2_b411db50f15711eb870c37be8598a0cc || (_templateObject2_b411db50f15711eb870c37be8598a0cc = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline;\n          --lrn-vocab-border: 1px dashed #ccc;\n        }\n        button {\n          text-transform: none;\n          min-width: unset;\n          margin: 0;\n          position: relative;\n          top: 0px;\n          border-radius: 0;\n          border-bottom: var(--lrn-vocab-border);\n          background: #f5f5f5;\n          font-size: 1.1em;\n          padding: 2px;\n        }\n        button:hover {\n          background: #bbdefb;\n          border-bottom: 1px dashed #2196f3;\n        }\n      "])))];
      }
    }, {
      key: "tag",
      get: function get() {
