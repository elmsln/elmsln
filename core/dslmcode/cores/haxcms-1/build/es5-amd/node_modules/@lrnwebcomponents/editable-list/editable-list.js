define(["exports", "require", "../../lit-element/lit-element.js", "../simple-modal/simple-modal.js"], function (_exports, _require, _litElement, _simpleModal) {
  ...
  function _templateObject3_0bed37105a6e11eb8957f34616f75140() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #list {\n          height: 100%;\n        }\n      "]);

    _templateObject3_0bed37105a6e11eb8957f34616f75140 = function _templateObject3_0bed37105a6e11eb8957f34616f75140() {
      return data;
    };
  ...
  function _templateObject2_0bed37105a6e11eb8957f34616f75140() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <editable-list-item\n            ?edit-mode=\"", "\"\n            ?can-edit=\"", "\"\n            ?can-delete=\"", "\"\n            value=\"", "\"\n          ></editable-list-item>\n        "]);

    _templateObject2_0bed37105a6e11eb8957f34616f75140 = function _templateObject2_0bed37105a6e11eb8957f34616f75140() {
      return data;
    };
  ...
  function _templateObject_0bed37105a6e11eb8957f34616f75140() {
    var data = babelHelpers.taggedTemplateLiteral([" <div id=\"list\">\n      ", "\n    </div>"]);

    _templateObject_0bed37105a6e11eb8957f34616f75140 = function _templateObject_0bed37105a6e11eb8957f34616f75140() {
      return data;
    };
  ...
  var EditableList = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(EditableList, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_0bed37105a6e11eb8957f34616f75140(), this.items.map(function (item) {
          return (0, _litElement.html)(_templateObject2_0bed37105a6e11eb8957f34616f75140(), item.metadata.canEdit, item.metadata.canEdit, item.metadata.canDelete, item.title);
        }));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_0bed37105a6e11eb8957f34616f75140())];
      }
    }, {
      key: "properties",
      get: function get() {
