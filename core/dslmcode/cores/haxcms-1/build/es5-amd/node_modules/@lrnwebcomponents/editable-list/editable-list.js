define(["exports", "require", "../../lit-element/lit-element.js", "../simple-modal/simple-modal.js"], function (_exports, _require, _litElement, _simpleModal) {
  ...
  var _templateObject_8a3484d0b80f11eb903f3b4791d1f11f, _templateObject2_8a3484d0b80f11eb903f3b4791d1f11f, _templateObject3_8a3484d0b80f11eb903f3b4791d1f11f;
  ...
  var EditableList = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(EditableList, [{
      ...
      function render() {
        return (0, _litElement.html)(_templateObject_8a3484d0b80f11eb903f3b4791d1f11f || (_templateObject_8a3484d0b80f11eb903f3b4791d1f11f = babelHelpers.taggedTemplateLiteral([" <div id=\"list\">\n      ", "\n    </div>"])), this.items.map(function (item) {
          return (0, _litElement.html)(_templateObject2_8a3484d0b80f11eb903f3b4791d1f11f || (_templateObject2_8a3484d0b80f11eb903f3b4791d1f11f = babelHelpers.taggedTemplateLiteral(["\n          <editable-list-item\n            ?edit-mode=\"", "\"\n            ?can-edit=\"", "\"\n            ?can-delete=\"", "\"\n            value=\"", "\"\n          ></editable-list-item>\n        "])), item.metadata.canEdit, item.metadata.canEdit, item.metadata.canDelete, item.title);
        }));
      ...
      get: //styles function
      function get() {
        return [(0, _litElement.css)(_templateObject3_8a3484d0b80f11eb903f3b4791d1f11f || (_templateObject3_8a3484d0b80f11eb903f3b4791d1f11f = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #list {\n          height: 100%;\n        }\n      "])))];
      }
    }, {
      key: "properties",
      get: function get() {
