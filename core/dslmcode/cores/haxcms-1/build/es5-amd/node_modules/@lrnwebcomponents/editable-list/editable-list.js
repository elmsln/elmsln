define(["exports", "require", "../../lit-element/lit-element.js", "../simple-modal/simple-modal.js"], function (_exports, _require, _litElement, _simpleModal) {
  ...
  function _templateObject3_21000980db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n\n        #list {\n          height: 100%;\n        }\n      "]);

    _templateObject3_21000980db3d11eaa14b6130b7e5d77f = function _templateObject3_21000980db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject2_21000980db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <editable-list-item\n              ?edit-mode=\"", "\"\n              ?can-edit=\"", "\"\n              ?can-delete=\"", "\"\n              value=\"", "\"\n            ></editable-list-item>\n          "]);

    _templateObject2_21000980db3d11eaa14b6130b7e5d77f = function _templateObject2_21000980db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function _templateObject_21000980db3d11eaa14b6130b7e5d77f() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"list\">\n        ", "\n      </div>\n    "]);

    _templateObject_21000980db3d11eaa14b6130b7e5d77f = function _templateObject_21000980db3d11eaa14b6130b7e5d77f() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(EditableList, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_21000980db3d11eaa14b6130b7e5d77f(), this.items.map(function (item) {
          return (0, _litElement.html)(_templateObject2_21000980db3d11eaa14b6130b7e5d77f(), item.metadata.canEdit, item.metadata.canEdit, item.metadata.canDelete, item.title);
        }));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_21000980db3d11eaa14b6130b7e5d77f())];
      }
    }, {
      key: "properties",
      get: function get() {
