define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../../undoer/undoer.js"], function (_exports, meta, _require, _litElement, _utils, _haxBodyBehaviors, _undoer) {
  ...
  function _templateObject2_64925d20f9d711eab0a41741e72b3233() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n        }\n      "]);

    _templateObject2_64925d20f9d711eab0a41741e72b3233 = function _templateObject2_64925d20f9d711eab0a41741e72b3233() {
      return data;
    };
  ...
  function _templateObject_64925d20f9d711eab0a41741e72b3233() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n      <undoer-element></undoer-element>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"", "\"\n        .params=\"", "\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n      ></iron-ajax>\n      <hal-9000\n        id=\"hal\"\n        .responds-to=\"", "\"\n        .debug=\"", "\"\n      ></hal-9000>\n    "]);

    _templateObject_64925d20f9d711eab0a41741e72b3233 = function _templateObject_64925d20f9d711eab0a41741e72b3233() {
      return data;
    };
  ...
  var HaxStore = /*#__PURE__*/function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_64925d20f9d711eab0a41741e72b3233(), this.appStore.url, this.appStore.params, this.__appStoreDataChanged, this.voiceRespondsTo, this.voiceDebug);
      }
    }, {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (["haxAutoloader", "activeHaxBody", "haxToast", "haxExport", "haxMap", "haxPreferences", "haxAppPicker", "haxTray"].includes(propName)) {
            ...
            _this4._storePiecesAllHere(_this4.haxAutoloader, _this4.activeHaxBody, _this4.haxToast, _this4.haxExport, _this4.haxMap, _this4.haxPreferences, _this4.haxAppPicker, _this4.haxTray);
          }
        });
      ...
      value: function _storePiecesAllHere(haxAutoloader, activeHaxBody, haxToast, haxExport, haxMap, haxPreferences, haxAppPicker, haxTray) {
      ...
      value: function _onPaste(e) {
        ...
        if (window.HaxStore.instance.isTextElement(window.HaxStore.instance.activeNode)) {
          ...
          originalContent = pasteContent; // detect word garbage
          ...
          console.log(originalContent); // edges that some things preserve empty white space needlessly

          var haxElements = window.HaxStore.htmlToHaxElements(pasteContent);
          console.log(haxElements); // if interpretation as HTML fails then let's ignore this whole thing
            ...
            if (originalContent != pasteContent) {
              ...
              inlinePaste = true;
                ...
                if (this.activeNode.innerText.trim() != "") {
                  ...
                  if (!window.HaxStore.insertLogicFromValues(_values, window.HaxStore.instance)) {
                    return false;
                  }
                }
          ...
          try {
            ...
            if (range && sel && typeof range.deleteContents === "function") {
              ...
              for (var i in newNodes.children) {
                ...
                if (newNodes.children[i].tagName && newNodes.children[i].tagName === "P" && newNodes.children[i].innerHTML === "") {
              ...
              if (inlinePaste) {
                ...
                setTimeout(function () {
                  _this7._positionCursorInNode(txt, txt.length);
                }, 0);
              } else {
                var activeEl;
                ...
                while (newNodes.lastElementChild) {
                  ...
                  if (range.commonAncestorContainer && range.commonAncestorContainer.parentNode) {
                    ...
                    activeEl = newNodes.lastElementChild; // should always be there but just in case there was no range
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_64925d20f9d711eab0a41741e72b3233())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function openDrawersCallback() {
        ...
        var drawers = ["haxAppPicker", "haxPreferences", "haxMap", "haxExport"];
      ...
      value: function _haxStoreInsertContent(e) {
        ...
        if (e.detail) {
          ...
          setTimeout(function () {
            var gizmoList = _this8.gizmoList;
            ...
            for (var gizmoposition in gizmoList) {
              ...
              if (gizmo.tag === details.tag) {
                ...
                _this8.gizmoList.unshift(tmp);
              }
            } // spread for accurate data usage locally, then write store globally


            _this8.gizmoList = babelHelpers.toConsumableArray(gizmoList);
            window.HaxStore.write("gizmoList", gizmoList, _this8);
          }, 10);
        }
      }
      /**
  ...
  window.HaxStore.mimeTypeToGizmoType = function (mime) {
  ...
  window.HaxStore.insertLogicFromValues = function (values, context) {
    ...
    var haxElements = window.HaxStore.guessGizmo(type, values, false, preferExclusive); // see if we got anything
    ...
    if (haxElements.length > 0) {
      if (haxElements.length === 1) {
        ...
        window.HaxStore.instance.haxAppPicker.presentOptions(haxElements, type, "Pick how to present this " + typeName, "gizmo");
      }
  ...
  var UndoerElement = /*#__PURE__*/function (_HTMLElement) {
    babelHelpers.inherits(UndoerElement, _HTMLElement);

    var _super2 = _createSuper(UndoerElement);
    ...
    function UndoerElement() {
      ...
      _this9.openDrawer = false;
      _this9._root = _this9.attachShadow({
        mode: "open"
      }); // hide from the first attributeChangedCallback call

      _this9._selfAttributeChange = true;
      window.setTimeout(function () {
        _this9._selfAttributeChange = false;
      });
      ...
      var callback = function callback(data) {
        ...
        _this9._updateAttribute(attr ? value : null); // hooray! tell the client


        _this9.dispatchEvent(new CustomEvent("state", {
          detail: value
        }));
      }; // set up initial zero undo state from attr


      var zero = _this9.getAttribute("state");

      var attr = _this9.hasAttribute("state");

      _this9._undoer = new _undoer.Undoer(callback, {
        value: zero,
        attr: attr
      });
      return _this9;
