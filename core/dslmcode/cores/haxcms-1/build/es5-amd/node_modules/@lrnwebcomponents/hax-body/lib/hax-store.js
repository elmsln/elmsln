define(["exports", "meta", "require", "../../../lit/index.js", "../../simple-popover/lib/simple-tour.js", "../../utils/utils.js", "../../../mobx/dist/mobx.esm.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _require, _index, _simpleTour, _utils, _mobxEsm, _haxBodyBehaviors, _I18NMixin2) {
  "use strict";
  ...
  var _templateObject_ca08ce10f9df11eba887937af67006f3;
  ...
  var HaxStore = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function render() {
        return (0, _index.html)(_templateObject_ca08ce10f9df11eba887937af67006f3 || (_templateObject_ca08ce10f9df11eba887937af67006f3 = babelHelpers.taggedTemplateLiteral([" <slot></slot> "])));
      }
      /**
       * convention
       */
      ...
      value: function _storePiecesAllHere(haxAutoloader, activeHaxBody, haxTray, haxCancel) {
        if (!this.ready && activeHaxBody && haxAutoloader && haxTray && haxCancel) {
          ...
          var modal = HAXStore.haxCancel.shadowRoot.querySelector("#dialog").associateEvents(haxTray.shadowRoot.querySelector("#haxcancelbutton"));
          if (!!modal) modal.addEventListener("simple-modal-confirmed", this._handleConfirmCancel);
      ...
      value: function __validTags() {
        return ["p", "div", "span", "table", "caption", "sup", "sub", "u", "strike", "tr", "th", "td", "ol", "ul", "li", "a", "strong", "kbd", "tt", "em", "i", "b", "hr", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "code", "figure", "figcaption", "img", "iframe", "video", "audio", "section", "grid-plate", "template", "webview"];
      }
      /**
      ...
      value: function slotsFromSchema(schema) {
        ...
        var settings = schema ? schema.settings : {},
            slotsList = [];
        return Object.keys(settings || {}).map(function (setting) {
      ...
      get: function get() {
        ...
        if (this.activeNode) {
          Array.from((0, _mobxEsm.toJS)(this.activeHaxBody).children).map(function (el, i) {
            if ((0, _mobxEsm.toJS)(_this12.activeNode) === el || (0, _mobxEsm.toJS)(_this12.activeNode).parentElement === el) {
              nodeLookup = i;
            }
          });
        }
