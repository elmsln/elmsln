define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../simple-popover/lib/simple-tour.js", "../../utils/utils.js", "../../../mobx/dist/mobx.esm.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../i18n-manager/lib/I18NMixin.js"], function (_exports, meta, _require, _litElement, _simpleTour, _utils, _mobxEsm, _haxBodyBehaviors, _I18NMixin2) {
  "use strict";
  ...
  var _templateObject_91f4cae0b8e611eb906d9debaeb411a7;
  ...
  var HaxStore = /*#__PURE__*/function (_I18NMixin) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_91f4cae0b8e611eb906d9debaeb411a7 || (_templateObject_91f4cae0b8e611eb906d9debaeb411a7 = babelHelpers.taggedTemplateLiteral([" <slot></slot> "])));
      }
      /**
       * convention
       */
                      ...
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            ...
                            if (_this2.isExternalURLImport(items[i])) {
                              importPath = items[i];
                        ...
                        return regeneratorRuntime.wrap(function _callee5$(_context5) {
                          while (1) {
                            switch (_context5.prev = _context5.next) {
                              case 0:
                                _context5.t0 = regeneratorRuntime.keys(_this3.elementList);
                              ...
                              case 1:
                                ...
                                el = _this3.elementList[i]; // run through translations to see if we have any
                                // apply as nessecary; abstract out the current translation thing to be reused

                                _context5.next = 6;
                                return _this3.attemptGizmoTranslation(i, el);

                              case 6:
                                el = _context5.sent;
                                _this3.elementList[i] = el;
                                _context5.next = 1;
                                break;

                              case 10:
                                _this3.gizmoList.forEach(function (el) {
                                  // if a title / description exists; "translate" it to match what came across
                                  if (_this3.elementList[el.tag].gizmo.title) {
                                    el.title = _this3.elementList[el.tag].gizmo.title;
                                  }

                                  if (_this3.elementList[el.tag].gizmo.description) {
                                    el.description = _this3.elementList[el.tag].gizmo.description;
                                  }
                                });
            ...
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  ...
                  _context8.next = 7;
                  return this.runHook(prototypeNode, "preProcessInsertContent", [details]);
      ...
      get: function get() {
        ...
        if (this.activeNode) {
          Array.from((0, _mobxEsm.toJS)(this.activeHaxBody).children).map(function (el, i) {
            if ((0, _mobxEsm.toJS)(_this11.activeNode) === el || (0, _mobxEsm.toJS)(_this11.activeNode).parentElement === el) {
              nodeLookup = i;
            }
          });
        }
    ...
    return HaxStore;
  }((0, _I18NMixin2.I18NMixin)((0, _utils.winEventsElement)((0, _haxBodyBehaviors.HAXElement)(_litElement.LitElement))));
