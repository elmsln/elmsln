define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../../@polymer/polymer/lib/utils/settings.js", "../../utils/utils.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../code-sample/code-sample.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../simple-toast/simple-toast.js", "./hax-app.js", "./hax-stax.js", "./hax-blox.js", "../../../undoer/undoer.js"], function (_exports, meta, _require, _litElement, _settings, _utils, _haxBodyBehaviors, _codeSample, _ironAjax, _simpleToast, _haxApp, _haxStax, _haxBlox, _undoer) {
  ...
  function _templateObject2_ed9672901bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n        }\n      "]);

    _templateObject2_ed9672901bb211eabd7cc30119585ddb = function _templateObject2_ed9672901bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function _templateObject_ed9672901bb211eabd7cc30119585ddb() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n      <undoer-element></undoer-element>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"", "\"\n        params=\"", "\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n      ></iron-ajax>\n      <hal-9000\n        id=\"hal\"\n        .responds-to=\"", "\"\n        .debug=\"", "\"\n      ></hal-9000>\n    "]);

    _templateObject_ed9672901bb211eabd7cc30119585ddb = function _templateObject_ed9672901bb211eabd7cc30119585ddb() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_ed9672901bb211eabd7cc30119585ddb(), this.appStore.url, this.appStore.params, this.__appStoreDataChanged, this.voiceRespondsTo, this.voiceDebug);
      }
    }, {
      ...
      value: function _storePiecesAllHere(haxAutoloader, activeHaxBody, haxPanel, haxToast, haxExport, haxPreferences, haxManager, haxStaxPicker, haxBloxPicker, haxAppPicker) {
        if (!this.__ready && activeHaxBody && haxAutoloader && haxPanel && haxToast && haxExport && haxPreferences && haxManager && haxStaxPicker && haxBloxPicker && haxAppPicker) {
          ...
          this.__hal.commands = babelHelpers.objectSpread({}, this.voiceCommands);
        }
      }
      /**
      ...
      value: function __validGizmoTypes() {
        return ["data", "video", "audio", "text", "link", "file", "pdf", "image", "csv", "doc", "content", "text", "inline", "*"];
      }
      /**
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_ed9672901bb211eabd7cc30119585ddb())];
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      key: "properties",
      get: function get() {
        return babelHelpers.objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(HaxStore), "properties", this), {
          openDrawer: {
            type: Object
          },
          voiceDebug: {
    ...
    function HaxStore() {
      ...
      _this.activeApp = {};
      _this.connectionRewrites = {};
      _this.voiceDebug = true;
        ...
        if (properties[property] === true) {
          ...
          if (frag.properties && frag.properties[property] && frag.properties[property].readOnly) {} else {
            if (newNode.set) {
              ...
              newNode[attributeName] = babelHelpers.objectSpread({}, properties[property]);
            }
          }
        } else {
          newNode.setAttribute(attributeName, properties[property]);
