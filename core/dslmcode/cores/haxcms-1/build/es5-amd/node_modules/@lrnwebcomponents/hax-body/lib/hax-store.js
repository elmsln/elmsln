define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../simple-popover/lib/simple-tour.js", "../../utils/utils.js", "../../../mobx/dist/mobx.esm.js", "../../hax-body-behaviors/hax-body-behaviors.js"], function (_exports, meta, _require, _litElement, _simpleTour, _utils, _mobxEsm, _haxBodyBehaviors) {
  ...
  function _templateObject_7a2b86c029e311ebad094ba710b19d49() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n      <hal-9000\n        id=\"hal\"\n        .responds-to=\"", "\"\n        .debug=\"", "\"\n      ></hal-9000>\n    "]);

    _templateObject_7a2b86c029e311ebad094ba710b19d49 = function _templateObject_7a2b86c029e311ebad094ba710b19d49() {
      return data;
    };
  ...
  var HaxStore = /*#__PURE__*/function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function getSelection() {
        ...
        if (this.activeHaxBody && this.activeHaxBody.parentNode) {
          ...
          else if ((0, _utils.getRange)(this.activeHaxBody.parentNode)) {
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_7a2b86c029e311ebad094ba710b19d49(), this.voiceRespondsTo, this.voiceDebug);
      }
    }, {
      ...
      value: function _appStoreChanged(newValue, oldValue) {
        ...
        if (babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue != null && babelHelpers.typeof(oldValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          if (babelHelpers.typeof(newValue.apps) === (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && this.shadowRoot) {
            this.loadAppStore();
          } else {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (["__ready", "__appStoreData", "haxAutoloader"].includes(propName) && _this4.__ready && _this4.__appStoreData) {
            _this4._loadAppStoreData(_this4.__appStoreData);
          }

          if (["haxAutoloader", "activeHaxBody", "haxTray"].includes(propName)) {
            // allow this to verify if everything is here or not
            clearTimeout(_this4.__storeReady);
            _this4.__storeReady = setTimeout(function () {
              _this4._storePiecesAllHere(_this4.haxAutoloader, _this4.activeHaxBody, _this4.haxTray, _this4.haxExport);
            }, 0);
          }
        });
      }
      ...
      value: function loadAppStore() {
        ...
        fetch(url, {
          ...
          _this5.__appStoreDataChanged(json);
        });
      }
      /**
       * ready life cycle
      ...
      value: function firstUpdated(changedProperties) {
        ...
        new Promise(function (res, rej) {
          ...
          _this6.__hal = _this6.shadowRoot.querySelector("#hal");
        }); // set this global flag so we know it's safe to start trusting data
        // that is written to global preferences / storage bin

        setTimeout(function () {
          _this6.__storageDataProcessed = true;

          if (_this6.storageData.globalPreferences) {
            _this6.write("globalPreferences", _this6.storageData.globalPreferences, _this6);
          }
      ...
      value: function _storePiecesAllHere(haxAutoloader, activeHaxBody, haxTray, haxExport) {
        if (!this.__ready && activeHaxBody && haxAutoloader && haxTray && haxExport) {
          ...
          this.ready = true; // associate the export button in the tray to the dialog
      ...
      value: function _initVoiceCommands() {
        ...
        this.voiceCommands["".concat(this.voiceRespondsTo, " (show)(focus) active (element)(content)")] = function () {
          try {
            _this7._positionCursorInNode(_this7.activeNode);
          } catch (e) {}
        };

        this.voiceCommands["".concat(this.voiceRespondsTo, " (focus) previous (element)(content)")] = function () {
          if (_this7.activeNode.previousElementSibling) {
            _this7.activeNode = _this7.activeNode.previousElementSibling;

            _this7.write("activeNode", _this7.activeNode, _this7);

            _this7._positionCursorInNode(_this7.activeNode);
          } else {
            _this7.speak("You are at the top of the document");
          }
        };

        this.voiceCommands["".concat(this.voiceRespondsTo, " (focus) next (element)(content)")] = function () {
          if (_this7.activeNode.nextElementSibling) {
            _this7.activeNode = _this7.activeNode.nextElementSibling;

            _this7.write("activeNode", _this7.activeNode, _this7);

            _this7._positionCursorInNode(_this7.activeNode);
          } else {
            _this7.speak("You are at the bottom of the document");
          }
        };

        this.voiceCommands["".concat(this.voiceRespondsTo, " type *mycontent")] = function (e) {
          if (_this7.isTextElement(_this7.activeNode)) {
            try {
              var range = _this7._positionCursorInNode(_this7.activeNode);

              var text = document.createTextNode(e);
              range.deleteContents();
              range.insertNode(text);
            } catch (e) {
              _this7.speak("That didn't work");

              console.warn(e);
            }
          } else {
            _this7.speak("I'm sorry but I can only type in text areas. Try saying Insert Paragraph and try again.");
          }
        }; // trolling


        this.voiceCommands["hey ".concat(this.voiceRespondsTo)] = function () {
          _this7.speak("Yeah what do you want");
        }; // trolling


        this.voiceCommands["".concat(this.voiceRespondsTo, " now your name is *splat")] = function (text) {
          var past = _this7.voiceRespondsTo;

          _this7.speak("I used to be named ".concat(past, " but you can call me ").concat(text, " now."));

          _this7.voiceRespondsTo = "(".concat(text, ")"); // @todo this needs to now update the previous commands somehow to match
          ...
          if (this.isBase64(originalContent)) {
            ...
            return this.retrieveImageFromClipboardAsBlob(e, function (imageBlob) {
              ...
              if (imageBlob) {
                ...
                _this8.activeNode.parentNode.insertBefore(img, _this8.activeNode.nextElementSibling);
                ...
                _this8.dispatchEvent(new CustomEvent("place-holder-file-drop", {
                  bubbles: true,
                  cancelable: true,
                  composed: true,
                  detail: e
          ...
          try {
            ...
            if (range && sel) {
              ...
              if (inlinePaste) {
                ...
                setTimeout(function () {
                  _this8._positionCursorInNode(txt, txt.length);
                }, 0);
              } else {
                ...
                setTimeout(function () {
                  if (activeEl && activeEl.childNodes && activeEl.childNodes[0]) {
                    _this8._positionCursorInNode(activeEl.childNodes[0], activeEl.childNodes[0].length);
    ...
    function HaxStore() {
      ...
      _this._isSandboxed = typeof test.reload === "function"; // imports app, blox, stax definitions
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function _haxStoreRegisterBlox(e) {
        if (e.detail) {
          ...
          this.write("bloxList", this.bloxList, this); // we don't care about this after it's launched
