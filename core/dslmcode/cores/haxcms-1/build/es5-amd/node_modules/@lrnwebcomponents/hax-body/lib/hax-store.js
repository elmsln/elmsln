define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../../@polymer/polymer/lib/utils/settings.js", "../../utils/utils.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../code-sample/code-sample.js", "../../../@polymer/iron-ajax/iron-ajax.js", "../../simple-toast/simple-toast.js", "./hax-app.js", "./hax-stax.js", "./hax-blox.js", "../../../undoer/undoer.js"], function (_exports, meta, _require, _litElement, _settings, _utils, _haxBodyBehaviors, _codeSample, _ironAjax, _simpleToast, _haxApp, _haxStax, _haxBlox, _undoer) {
  ...
  function _templateObject2_b89871e03ee611ea9b2edd59a4f93ed0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n        }\n      "]);

    _templateObject2_b89871e03ee611ea9b2edd59a4f93ed0 = function _templateObject2_b89871e03ee611ea9b2edd59a4f93ed0() {
      return data;
    };
  ...
  function _templateObject_b89871e03ee611ea9b2edd59a4f93ed0() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n      <undoer-element></undoer-element>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"", "\"\n        .params=\"", "\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n      ></iron-ajax>\n      <hal-9000\n        id=\"hal\"\n        .responds-to=\"", "\"\n        .debug=\"", "\"\n      ></hal-9000>\n    "]);

    _templateObject_b89871e03ee611ea9b2edd59a4f93ed0 = function _templateObject_b89871e03ee611ea9b2edd59a4f93ed0() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_b89871e03ee611ea9b2edd59a4f93ed0(), this.appStore.url, this.appStore.params, this.__appStoreDataChanged, this.voiceRespondsTo, this.voiceDebug);
      }
    }, {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "openDrawer") {
            _this3.openDrawersCallback(_this3[propName], oldValue);
          }

          if (propName == "appStore") {
            _this3._appStoreChanged(_this3[propName], oldValue);
          }

          if (propName == "globalPreferences") {
            _this3._globalPreferencesChanged(_this3[propName], oldValue);
          }
          ...
          if (["haxAutoloader", "activeHaxBody", "haxPanel", "haxToast", "haxExport", "haxPreferences", "haxManager", "haxStaxPicker", "haxBloxPicker", "haxAppPicker"].includes(propName)) {
            // allow this to verify if everything is here or not
            _this3._storePiecesAllHere(_this3.haxAutoloader, _this3.activeHaxBody, _this3.haxPanel, _this3.haxToast, _this3.haxExport, _this3.haxPreferences, _this3.haxManager, _this3.haxStaxPicker, _this3.haxBloxPicker, _this3.haxAppPicker);
          }
        });
      ...
      value: function firstUpdated(changedProperties) {
        ...
        this.__hal = this.shadowRoot.querySelector("#hal"); // see if a global was used to prevent this check
      ...
      value: function _storePiecesAllHere(haxAutoloader, activeHaxBody, haxPanel, haxToast, haxExport, haxPreferences, haxManager, haxStaxPicker, haxBloxPicker, haxAppPicker) {
        if (!this.__ready && activeHaxBody && haxAutoloader && haxPanel && haxToast && haxExport && haxPreferences && haxManager && haxStaxPicker && haxBloxPicker && haxAppPicker) {
      ...
      value: function _initVoiceCommands() {
        ...
        this.voiceCommands["hey ".concat(this.voiceRespondsTo)] = function () {
          _this5.__hal.speak("Yeah what do you want");
        };

        this.voiceCommands["".concat(this.voiceRespondsTo, " close")] = function () {
          window.HaxStore.write("openDrawer", false, _this5);
        };
      }
      /**
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_b89871e03ee611ea9b2edd59a4f93ed0())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    function HaxStore() {
      ...
      _this._isSandboxed = typeof test.reload === "function"; // polymer specific thing
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function openDrawersCallback() {
        ...
        var drawers = ["haxManager", "haxAppPicker", "haxBloxPicker", "haxStaxPicker", "haxPreferences", "haxExport"];
        ...
        if (e.detail) {
          ...
          if (details.replace && details.replacement) {
            ...
            if (this.activeContainerNode && this.activeContainerNode.tagName === "GRID-PLATE") {
              ...
              this.activeContainerNode.appendChild(_node2);
      ...
      value: function haxInsertAnything(e) {
        ...
        for (var i in window.HaxStore.instance.gizmoList) {
          haxElements.push(window.HaxStore.haxElementPrototype(window.HaxStore.instance.gizmoList[i], props, ""));
  ...
  window.HaxStore.guessGizmoType = function (guess) {
    if (babelHelpers.typeof(guess.source) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
      if (guess.source.indexOf(".mp3") != -1) {
        ...
        return "markdown";
      } else if (guess.source.indexOf(".html") != -1 || guess.source.indexOf(".htm") != -1) {
        return "html";
      } else if (guess.source.indexOf(".txt") != -1 || guess.source.indexOf(".doc") != -1 || guess.source.indexOf(".docx") != -1 || guess.source.indexOf(".xls") != -1 || guess.source.indexOf(".xlsx") != -1 || guess.source.indexOf(".ppt") != -1) {
        return "document";
      } else if (guess.source.indexOf(".zip") != -1 || guess.source.indexOf(".tar.gz") != -1 || guess.source.indexOf(".tar") != -1) {
        return "archive";
      } // if it's external we can't assume what it actually is
      else if (window.MediaBehaviors.Video.getVideoType(guess.source) != "external") {
          return "video";
        } else {
