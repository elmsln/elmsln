define(["exports", "./utils.js", "./es5.js", "./compiler.js", "../../intl-messageformat-parser/src/parser.js"], function (_exports, _utils, _es, _compiler, _parser) {
  "use strict";
  ...
  _compiler = babelHelpers.interopRequireDefault(_compiler);
  _parser = babelHelpers.interopRequireDefault(_parser);
  ...
  */
  ...
  /* jslint esnext: true */
  var _default = MessageFormat; // -- MessageFormat --------------------------------------------------------
  ...
  function MessageFormat(message, locales, formats) {
    ...
    (0, _es.defineProperty)(this, '_locale', {
  ...
  (0, _es.defineProperty)(MessageFormat, '__localeData__', {
    value: (0, _es.objCreate)(null)
  });
  (0, _es.defineProperty)(MessageFormat, '__addLocaleData', {
  ...
  (0, _es.defineProperty)(MessageFormat, '__parse', {
    value: _parser.default.parse
