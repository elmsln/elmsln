define(["exports"], function (_exports) {
  ...
  function stringifyKey(key) {
    ...
    if (babelHelpers.typeof(key) === "symbol") {
      return key.toString();
    }
  ...
  function createObservable(v, arg2, arg3) {
    ...
    if (babelHelpers.typeof(v) === "object" && v !== null) {
      return v;
    } // anything else
  ...
  function extendObservable(target, properties, annotations, options) {
    if (process.env.NODE_ENV !== "production") {
      ...
      if (babelHelpers.typeof(target) !== "object") {
  ...
  function toJSHelper(source, __alreadySeen) {
    if (source == null || babelHelpers.typeof(source) !== "object" || babelHelpers.instanceof(source, Date) || !isObservable(source)) {
      return source;
    }
  ...
  function when(predicate, arg1, arg2) {
    if (arguments.length === 1 || arg1 && babelHelpers.typeof(arg1) === "object") {
  ...
  function eq(a, b, depth, aStack, bStack) {
    ...
    if (type !== "function" && type !== "object" && babelHelpers.typeof(b) != "object") {
      return false;
    } // Compare `[[Class]]` names.
    ...
    if (!areArrays) {
      if (babelHelpers.typeof(a) != "object" || babelHelpers.typeof(b) != "object") {
        return false;
