define(["exports"], function (_exports) {
  ...
  _exports.FlowCancellationError = FlowCancellationError;
  _exports._allowStateChanges = allowStateChanges;
  _exports.runInAction = _exports._allowStateChangesInsideComputed = runInAction;
  _exports._allowStateReadsEnd = allowStateReadsEnd;
  _exports._allowStateReadsStart = allowStateReadsStart;
  _exports._endAction = _endAction;
  _exports._getAdministration = getAdministration;
  _exports._getGlobalState = getGlobalState;
  _exports._interceptReads = interceptReads;
  _exports._isComputingDerivation = isComputingDerivation;
  _exports._resetGlobalState = resetGlobalState;
  _exports._startAction = _startAction;
  _exports.autorun = autorun;
  _exports.configure = configure;
  _exports.createAtom = createAtom;
  _exports.defineProperty = apiDefineProperty;
  _exports.entries = entries;
  _exports.extendObservable = extendObservable;
  _exports.flowResult = flowResult;
  _exports.get = get;
  _exports.getAtom = getAtom;
  _exports.getDebugName = getDebugName;
  _exports.getDependencyTree = getDependencyTree;
  _exports.getObserverTree = getObserverTree;
  _exports.has = has;
  _exports.intercept = intercept;
  _exports.isAction = isAction;
  _exports.isComputed = isComputed;
  _exports.isComputedProp = isComputedProp;
  _exports.isFlow = isFlow;
  _exports.isFlowCancellationError = isFlowCancellationError;
  _exports.isObservable = isObservable;
  _exports.isObservableArray = isObservableArray;
  _exports.isObservableObject = isObservableObject;
  _exports.isObservableProp = isObservableProp;
  _exports.keys = keys;
  _exports.makeAutoObservable = makeAutoObservable;
  _exports.makeObservable = makeObservable;
  _exports.observe = observe;
  _exports.onBecomeObserved = onBecomeObserved;
  _exports.onBecomeUnobserved = onBecomeUnobserved;
  _exports.onReactionError = onReactionError;
  _exports.ownKeys = apiOwnKeys;
  _exports.reaction = reaction;
  _exports.remove = remove;
  _exports.set = set;
  _exports.spy = spy;
  _exports.toJS = toJS;
  _exports.trace = trace;
  _exports.transaction = transaction;
  _exports.untracked = untracked;
  _exports.values = values;
  _exports.when = when;
  _exports.override = _exports.observable = _exports.isObservableSet = _exports.isObservableMap = _exports.isBoxedObservable = _exports.flow = _exports.computed = _exports.comparer = _exports.action = _exports._autoAction = _exports.Reaction = _exports.ObservableSet = _exports.ObservableMap = _exports.$mobx = void 0;
  var niceErrors = {
  ...
  function isES6Map(thing) {
    return babelHelpers.instanceof(thing, Map);
  }

  function isES6Set(thing) {
    return babelHelpers.instanceof(thing, Set);
  }
  ...
  function stringifyKey(key) {
    ...
    if (babelHelpers.typeof(key) === "symbol") return key.toString();
    return new String(key).toString();
  }

  function toPrimitive(value) {
    return value === null ? null : babelHelpers.typeof(value) === "object" ? "" + value : value;
  }
  ...
  function createObservable(v, arg2, arg3) {
    ...
    if (babelHelpers.typeof(v) === "object" && v !== null) return v; // anything else
  ...
  _exports.isBoxedObservable = isObservableValue;
  ...
  function isCaughtException(e) {
    return babelHelpers.instanceof(e, CaughtException);
  }
  /**
    ...
    if (--globalState.inBatch === 0) {
      ...
      for (var i = 0; i < list.length; i++) {
        ...
        if (observable.observers_.size === 0) {
          ...
          if (babelHelpers.instanceof(observable, ComputedValue)) {
  ...
  _exports._autoAction = autoAction;
  ...
  function extendObservable(target, properties, annotations, options) {
    if (process.env.NODE_ENV !== "production") {
      ...
      if (babelHelpers.typeof(target) !== "object") die("'extendObservable' expects an object as first argument");
  ...
  function isFlowCancellationError(error) {
    return babelHelpers.instanceof(error, FlowCancellationError);
  }
  ...
  function toJSHelper(source, __alreadySeen) {
    if (source == null || babelHelpers.typeof(source) !== "object" || babelHelpers.instanceof(source, Date) || !isObservable(source)) return source;
  ...
  function when(predicate, arg1, arg2) {
    if (arguments.length === 1 || arg1 && babelHelpers.typeof(arg1) === "object") return whenPromise(predicate, arg1);
  ...
  var arrayTraps = {
    ...
    set: function set(target, name, value) {
      ...
      if (babelHelpers.typeof(name) === "symbol" || isNaN(name)) {
        target[name] = value;
      } else {
        // numeric string
  ...
  _exports.ObservableMap = ObservableMap;
  var isObservableMap = /*#__PURE__*/createInstanceofPredicate("ObservableMap", ObservableMap);
  _exports.isObservableMap = isObservableMap;
  ...
  _exports.ObservableSet = ObservableSet;
  var isObservableSet = /*#__PURE__*/createInstanceofPredicate("ObservableSet", ObservableSet);
  _exports.isObservableSet = isObservableSet;
    ...
    _proto.delete_ = function delete_(key, proxyTrap) {
      ...
      try {
        ...
        if (observable) {
          ...
          if (babelHelpers.instanceof(observable, ObservableValue)) {
  ...
  function asObservableObject(target, options) {
    ...
    if (hasProp(target, $mobx)) {
      if (process.env.NODE_ENV !== "production" && !babelHelpers.instanceof(getAdministration(target), ObservableObjectAdministration)) {
  ...
  function getAtom(thing, property) {
    if (babelHelpers.typeof(thing) === "object" && thing !== null) {
  ...
  function eq(a, b, depth, aStack, bStack) {
    ...
    var type = babelHelpers.typeof(a);
    if (!isFunction(type) && type !== "object" && babelHelpers.typeof(b) != "object") return false; // Compare `[[Class]]` names.
    ...
    if (!areArrays) {
      if (babelHelpers.typeof(a) != "object" || babelHelpers.typeof(b) != "object") return false; // Objects with different constructors are not equivalent, but `Object`s or `Array`s
      // from different frames are.

      var aCtor = a.constructor,
          bCtor = b.constructor;

      if (aCtor !== bCtor && !(isFunction(aCtor) && babelHelpers.instanceof(aCtor, aCtor) && isFunction(bCtor) && babelHelpers.instanceof(bCtor, bCtor)) && "constructor" in a && "constructor" in b) {
        return false;
      }
    }
  ...
  function isAnnotation(thing) {
    return (// Can be function
      babelHelpers.instanceof(thing, Object) && typeof thing.annotationType_ === "string" && isFunction(thing.make_) && isFunction(thing.extend_)
    );
  }
  /**
  ...
  if ((typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ === "undefined" ? "undefined" : babelHelpers.typeof(__MOBX_DEVTOOLS_GLOBAL_HOOK__)) === "object") {
