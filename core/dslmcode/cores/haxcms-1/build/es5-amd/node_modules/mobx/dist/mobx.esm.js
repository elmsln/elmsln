define(["exports"], function (_exports) {
  ...
  _exports.when = when;
  _exports.observable = _exports.isObservableSet = _exports.isObservableMap = _exports.isBoxedObservable = _exports.flow = _exports.computed = _exports.comparer = _exports.action = _exports._autoAction = _exports.Reaction = _exports.ObservableSet = _exports.ObservableMap = _exports.$mobx = void 0;
  var niceErrors = {
  ...
  var objectProxyTraps = {
    ...
    get: function get(target, name) {
      ...
      if (babelHelpers.instanceof(observable, Atom)) {
    ...
    _proto.getKeys_ = function getKeys_() {
      ...
      for (var _iterator = _createForOfIteratorHelperLoose(this.values_), _step; !(_step = _iterator()).done;) {
        var _step$value = _step.value,
            key = _step$value[0],
            value = _step$value[1];
        if (babelHelpers.instanceof(value, ObservableValue)) this.keysValue_.push(key);
      }
