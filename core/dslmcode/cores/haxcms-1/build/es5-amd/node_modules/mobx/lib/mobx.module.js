define(["exports"], function (_exports) {
  ...
  _exports.untracked = untracked$$1;
  _exports.createAtom = createAtom$$1;
  _exports.spy = spy$$1;
  _exports.isObservableObject = isObservableObject$$1;
  _exports.isObservableArray = isObservableArray$$1;
  _exports.transaction = transaction$$1;
  _exports.isObservable = isObservable$$1;
  _exports.isObservableProp = isObservableProp$$1;
  _exports.isComputed = isComputed$$1;
  _exports.isComputedProp = isComputedProp$$1;
  _exports.extendObservable = extendObservable$$1;
  _exports.observe = observe$$1;
  _exports.intercept = intercept$$1;
  _exports.autorun = autorun$$1;
  _exports.reaction = reaction$$1;
  _exports.when = when$$1;
  _exports.isAction = isAction$$1;
  _exports.runInAction = runInAction$$1;
  _exports.keys = keys$$1;
  _exports.values = values$$1;
  _exports.entries = entries$$1;
  _exports.set = set$$1;
  _exports.remove = remove$$1;
  _exports.has = has$$1;
  _exports.get = get$$1;
  _exports.decorate = decorate$$1;
  _exports.configure = configure$$1;
  _exports.onBecomeObserved = onBecomeObserved$$1;
  _exports.onBecomeUnobserved = onBecomeUnobserved$$1;
  _exports.flow = flow$$1;
  _exports.toJS = toJS$$1;
  _exports.trace = trace$$1;
  _exports.getDependencyTree = getDependencyTree$$1;
  _exports.getObserverTree = getObserverTree$$1;
  _exports._resetGlobalState = resetGlobalState$$1;
  _exports._getGlobalState = getGlobalState$$1;
  _exports.getDebugName = getDebugName$$1;
  _exports.getAtom = getAtom$$1;
  _exports._getAdministration = getAdministration$$1;
  _exports._allowStateChanges = allowStateChanges$$1;
  _exports._allowStateChangesInsideComputed = allowStateChangesInsideComputed$$1;
  _exports.isArrayLike = isArrayLike$$1;
  _exports._isComputingDerivation = isComputingDerivation$$1;
  _exports.onReactionError = onReactionError$$1;
  _exports._interceptReads = interceptReads$$1;
  _exports.$mobx = _exports.action = _exports.computed = _exports.observable = _exports.isObservableSet = _exports.ObservableSet = _exports.isObservableMap = _exports.ObservableMap = _exports.isBoxedObservable = _exports.comparer = _exports.IDerivationState = _exports.Reaction = void 0;
  ...
  ***************************************************************************** */
  ...
  var extendStatics = Object.setPrototypeOf || babelHelpers.instanceof({
    __proto__: []
  }, Array) && function (d, b) {
    d.__proto__ = b;
  } || function (d, b) {
  ...
  function isPlainObject$$1(value) {
    if (value === null || babelHelpers.typeof(value) !== "object") return false;
  ...
  function asCreateObservableOptions$$1(thing) {
    ...
    if (process.env.NODE_ENV !== "production") {
      if (babelHelpers.typeof(thing) !== "object") return fail$$1("expected options object");
  ...
  _exports.observable = observable$$1;
  ...
  var computed$$1 = function computed$$1(arg1, arg2, arg3) {
    ...
    if (arg1 !== null && babelHelpers.typeof(arg1) === "object" && arguments.length === 1) {
      // @computed({ options })
      return computedDecorator$$1.apply(null, arguments);
    ...
    var opts = babelHelpers.typeof(arg2) === "object" ? arg2 : {};
    opts.get = arg1;
  ...
  _exports.isBoxedObservable = isObservableValue$$1;
  ...
  _exports.IDerivationState = IDerivationState;
  ...
  })(IDerivationState || (_exports.IDerivationState = IDerivationState = {}));
  ...
  function isCaughtException$$1(e) {
    return babelHelpers.instanceof(e, CaughtException$$1);
  }
  /**
    ...
    if (--globalState$$1.inBatch === 0) {
      ...
      for (var i = 0; i < list.length; i++) {
        ...
        if (observable$$1.observers.size === 0) {
          ...
          if (babelHelpers.instanceof(observable$$1, ComputedValue$$1)) {
  ...
  function reaction$$1(expression, effect, opts) {
    ...
    if (process.env.NODE_ENV !== "production") {
      ...
      invariant$$1(babelHelpers.typeof(opts) === "object", "Third argument of reactions should be an object");
    }
  ...
  function extendObservable$$1(target, properties, decorators, options) {
    if (process.env.NODE_ENV !== "production") {
      ...
      invariant$$1(babelHelpers.typeof(target) === "object", "'extendObservable' expects an object as first argument");
  ...
  function toJSHelper(source, options, __alreadySeen) {
    ...
    if (babelHelpers.typeof(source) !== "object") return source; // Directly return null if source is null

    if (source === null) return null; // Directly return the Date object itself if contained in the observable

    if (babelHelpers.instanceof(source, Date)) return source;
  ...
  var objectProxyTraps = {
    ...
    get: function get(target, name) {
      ...
      if (babelHelpers.instanceof(observable$$1, Atom$$1)) {
    ...
    ObservableMap$$1.prototype.toPOJO = function () {
      ...
      try {
        for (var _b = __values(this), _c = _b.next(); !_c.done; _c = _b.next()) {
          ...
          res[babelHelpers.typeof(key) === "symbol" ? key : stringifyKey(key)] = value;
        }
      } catch (e_3_1) {
        e_3 = {
          error: e_3_1
  ...
  _exports.ObservableMap = ObservableMap$$1;
  ...
  _exports.isObservableMap = isObservableMap$$1;
  ...
  _exports.isObservableSet = isObservableSet$$1;
    ...
    ObservableObjectAdministration$$1.prototype.getKeys = function () {
      ...
      try {
        for (var _b = __values(this.values), _c = _b.next(); !_c.done; _c = _b.next()) {
          ...
          if (babelHelpers.instanceof(value, ObservableValue$$1)) res.push(key);
        }
      } catch (e_1_1) {
        e_1 = {
          error: e_1_1
  ...
  function eq(a, b, aStack, bStack) {
    ...
    if (type !== "function" && type !== "object" && babelHelpers.typeof(b) != "object") return false;
  ...
  function deepEq(a, b, aStack, bStack) {
    ...
    if (!areArrays) {
      ...
      if (aCtor !== bCtor && !(typeof aCtor === "function" && babelHelpers.instanceof(aCtor, aCtor) && typeof bCtor === "function" && babelHelpers.instanceof(bCtor, bCtor)) && "constructor" in a && "constructor" in b) {
        return false;
      }
