define(["exports"], function (_exports) {
  ...
  _exports._allowStateChangesInsideComputed = allowStateChangesInsideComputed;
  ...
  _exports.runInAction = runInAction;
  _exports.set = _set;
  _exports.spy = spy;
  _exports.toJS = toJS;
  ...
  _exports.when = when;
  _exports.observable = _exports.isObservableSet = _exports.isObservableMap = _exports.isBoxedObservable = _exports.computed = _exports.comparer = _exports.action = _exports.Reaction = _exports.ObservableSet = _exports.ObservableMap = _exports.IDerivationState = _exports.FlowCancellationError = _exports.$mobx = void 0;
  ...
  ***************************************************************************** */
  ...
  function quacksLikeADecorator(args) {
    return (args.length === 2 || args.length === 3) && (typeof args[1] === "string" || babelHelpers.typeof(args[1]) === "symbol") || args.length === 4 && args[3] === true;
  }
  ...
  function asCreateObservableOptions(thing) {
    ...
    if (process.env.NODE_ENV !== "production") {
      if (babelHelpers.typeof(thing) !== "object") return fail("expected options object");
  ...
  function createObservable(v, arg2, arg3) {
    // @observable someProp;
    if (typeof arguments[1] === "string" || babelHelpers.typeof(arguments[1]) === "symbol") {
  ...
  function reaction(expression, effect, opts) {
    ...
    if (process.env.NODE_ENV !== "production") {
      ...
      invariant(babelHelpers.typeof(opts) === "object", "Third argument of reactions should be an object");
    }
  ...
  function extendObservable(target, properties, decorators, options) {
    if (process.env.NODE_ENV !== "production") {
      ...
      invariant(babelHelpers.typeof(target) === "object", "'extendObservable' expects an object as first argument");
  ...
  function isPropertyKey(val) {
    return typeof val === "string" || typeof val === "number" || babelHelpers.typeof(val) === "symbol";
    ...
    ObservableObjectAdministration.prototype.getKeys = function () {
      ...
      try {
        for (var _b = __values(this.values), _c = _b.next(); !_c.done; _c = _b.next()) {
          ...
          if (babelHelpers.instanceof(value, ObservableValue)) res.push(key);
        }
      } catch (e_1_1) {
        e_1 = {
          error: e_1_1
  ...
  function eq(a, b, depth, aStack, bStack) {
    ...
    if (type !== "function" && type !== "object" && babelHelpers.typeof(b) != "object") return false; // Unwrap any wrapped objects.
