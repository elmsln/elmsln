define(["exports", "../../tslib/tslib.es6.js", "../mwc-icon/mwc-icon.js", "../mwc-ripple/mwc-ripple.js", "../mwc-ripple/ripple-handlers.js", "../../lit-element/lit-element.js", "../../lit-html/directives/class-map.js"], function (_exports, _tslibEs, _mwcIcon, _mwcRipple, _rippleHandlers, _litElement, _classMap) {
  ...
  function _templateObject4_1d14772056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral(["\n    <mwc-icon class=\"mdc-button__icon\">\n      ", "\n    </mwc-icon>"]);

    _templateObject4_1d14772056b211eb8620237ff5403573 = function _templateObject4_1d14772056b211eb8620237ff5403573() {
      return data;
    };
  ...
  function _templateObject3_1d14772056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <button\n          id=\"button\"\n          class=\"mdc-button ", "\"\n          ?disabled=\"", "\"\n          aria-label=\"", "\"\n          @focus=\"", "\"\n          @blur=\"", "\"\n          @mousedown=\"", "\"\n          @mouseenter=\"", "\"\n          @mouseleave=\"", "\"\n          @touchstart=\"", "\"\n          @touchend=\"", "\"\n          @touchcancel=\"", "\">\n        ", "\n        <span class=\"leading-icon\">\n          <slot name=\"icon\">\n            ", "\n          </slot>\n        </span>\n        <span class=\"mdc-button__label\">", "</span>\n        <slot></slot>\n        <span class=\"trailing-icon\">\n          <slot name=\"trailingIcon\">\n            ", "\n          </slot>\n        </span>\n      </button>"]);

    _templateObject3_1d14772056b211eb8620237ff5403573 = function _templateObject3_1d14772056b211eb8620237ff5403573() {
      return data;
    };
  ...
  function _templateObject2_1d14772056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral(["<mwc-ripple .primary=\"", "\" .disabled=\"", "\"></mwc-ripple>"]);

    _templateObject2_1d14772056b211eb8620237ff5403573 = function _templateObject2_1d14772056b211eb8620237ff5403573() {
      return data;
    };
  ...
  function _templateObject_1d14772056b211eb8620237ff5403573() {
    var data = babelHelpers.taggedTemplateLiteral(["", ""]);

    _templateObject_1d14772056b211eb8620237ff5403573 = function _templateObject_1d14772056b211eb8620237ff5403573() {
      return data;
    };
  ...
  var ButtonBase = /*#__PURE__*/function (_LitElement) {
    ...
    babelHelpers.createClass(ButtonBase, [{
      ...
      value: function renderRipple() {
        ...
        return (0, _litElement.html)(_templateObject_1d14772056b211eb8620237ff5403573(), this.shouldRenderRipple ? (0, _litElement.html)(_templateObject2_1d14772056b211eb8620237ff5403573(), !filled, this.disabled) : '');
      }
    }, {
      ...
      value: function renderIcon() {
        return (0, _litElement.html)(_templateObject4_1d14772056b211eb8620237ff5403573(), this.icon);
      }
    }, {
