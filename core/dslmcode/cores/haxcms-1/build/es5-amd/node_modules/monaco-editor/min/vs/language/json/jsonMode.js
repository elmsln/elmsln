...
define("vs/language/json/workerManager", ["require", "exports"], function (e, t) {
  ...
  function f(e) {
    return "string" == typeof e ? {
      value: e
    } : (t = e) && "object" == babelHelpers.typeof(t) && "string" == typeof t.kind ? "plaintext" === e.kind ? {
  ...
  t.format = function (r, e, t) {
    ...
    for (; 17 !== b;) {
      for (var C = g.getTokenOffset() + g.getTokenLength() + i, _ = m(), E = ""; !d && (12 === _ || 13 === _);) {
        y(" ", C, g.getTokenOffset() + i), C = g.getTokenOffset() + g.getTokenLength() + i, E = 12 === _ ? p() : "", _ = m();
      }
  ...
  t.getLocation = function (e, o) {
    ...
    try {
      f(e, {
        ...
        onObjectProperty: function onObjectProperty(e, t, n) {
          if (o < t) throw a;
        ...
        onLiteralValue: function onLiteralValue(e, t, n) {
          if (o < t) throw a;
          if (r(e, t, n, d(e)), o <= t + n) throw a;
        },
        onSeparator: function onSeparator(e, t, n) {
          if (o <= t) throw a;
    ...
    return {
      ...
      matches: function matches(e) {
        for (var t = 0, n = 0; t < e.length && n < i.length; n++) {
          if (e[t] === i[n] || "*" === e[t]) t++;else if ("**" !== e[t]) return !1;
        }
  ...
  function r(e, t, n, r, o) {
    for (var i, a = t.slice(), s = C.parseTree(e, []), u = void 0, c = void 0; 0 < a.length && (c = a.pop(), void 0 === (u = C.findNodeAtLocation(s, a)) && void 0 !== n);) {
  ...
  function _(e, t, n) {
    ...
    if (0 === t.length || 0 === t.content.length) {
      for (; 0 < o && !c.isEOL(r, o - 1);) {
        o--;
      }

      for (; i < r.length && !c.isEOL(r, i);) {
        i++;
      }
    }
  ...
  Object.defineProperty(g, "__esModule", {
    ...
    return {
      ...
      tokenize: function tokenize(e, t, n, r) {
  ...
  var p = function () {
    ...
    return t.prototype.clone = function () {
      ...
      return e === this || !!(e && babelHelpers.instanceof(e, t)) && this.scanError === e.scanError && this.lastWasColon === e.lastWasColon;
