 ...
 *-----------------------------------------------------------------------------*/
define("vs/basic-languages/solidity/solidity", ["require", "require"], function (require) {
  var moduleExports = function () {
    ...
    var o = function o(e) {
      return f(e, "__esModule", {
        value: !0
      });
    };

    var r = function r(e, x) {
      for (var i in x) {
        f(e, i, {
          get: x[i],
          enumerable: !0
        ...
        a = function a(e, x, i, u) {
      if (x && babelHelpers.typeof(x) == "object" || typeof x == "function") {
        var _iterator = _createForOfIteratorHelper(n(x)),
            _step;

        try {
          var _loop = function _loop() {
            var d = _step.value;
            !s.call(e, d) && (i || d !== "default") && f(e, d, {
              get: function get() {
                return x[d];
              },
    ...
    var c = function (e) {
      return function (x, i) {
        return e && e.get(x) || (i = a(o({}), x, 1), e && e.set(x, i), i);
      };
