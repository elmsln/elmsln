 ...
 *-----------------------------------------------------------------------------*/
!function (e) {
  if ("object" == (typeof module === "undefined" ? "undefined" : babelHelpers.typeof(module)) && "object" == babelHelpers.typeof(module.exports)) {
  ...
  var a, r, n, o, i, s, c, u, f, l, d, p, h, m, g, v, y, b, x, S, C, j, T, k;
  Object.defineProperty(t, "__esModule", {
    ...
    var t = e;
    return Y.defined(t) && A.is(t.textDocument) && Array.isArray(t.edits);
  }, (k = t.WorkspaceEdit || (t.WorkspaceEdit = {})).is = function (e) {
    var t = e;
  ...
  }, (E = A = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {})).create = function (e, t) {
    return {
      uri: e,
      version: t
    };
  ...
  t.DocumentSymbol = z, ($ = z = t.DocumentSymbol || (t.DocumentSymbol = {})).create = function (e, t, r, n, o, i) {
    ...
    var t = e;
    return t && Y.string(t.name) && Y.number(t.kind) && n.is(t.range) && n.is(t.selectionRange) && (void 0 === t.detail || Y.string(t.detail)) && (void 0 === t.deprecated || Y.boolean(t.deprecated)) && (void 0 === t.children || Array.isArray(t.children));
    ...
    var t = e;
    return t && Y.string(t.title) && (void 0 === t.diagnostics || Y.typedArray(t.diagnostics, v.is)) && (void 0 === t.kind || Y.string(t.kind)) && (void 0 !== t.edit || void 0 !== t.command) && (void 0 === t.command || b.is(t.command)) && (void 0 === t.edit || k.is(t.edit));
  ...
  ee = Y || (Y = {}), te = Object.prototype.toString, ee.defined = function (e) {
    ...
    return null !== e && "object" == babelHelpers.typeof(e);
  ...
  Object.defineProperty(t, "__esModule", {
    ...
    function f(e, t) {
      for (var r = 0, n = 0; r < e || !t;) {
        ...
        if (48 <= o && o <= 57) n = 16 * n + o - 48;else if (65 <= o && o <= 70) n = 16 * n + o - 65 + 10;else {
          if (!(97 <= o && o <= 102)) break;
          n = 16 * n + o - 97 + 10;
        }
        a++, r++;
    ...
    function t() {
      ...
      switch (e) {
        ...
        case 47:
          ...
          if (42 !== i.charCodeAt(a + 1)) return n += String.fromCharCode(e), a++, c = 16;
          a += 2;
        ...
        case 57:
          return n += function () {
            var e = a;
            if (48 === i.charCodeAt(a)) a++;else for (a++; a < i.length && h(i.charCodeAt(a));) {
              a++;
            }
            ...
            if (a < i.length && 46 === i.charCodeAt(a)) {
              ...
              for (a++; a < i.length && h(i.charCodeAt(a));) {
                a++;
              }
            }

            var t = a;
            if (a < i.length && (69 === i.charCodeAt(a) || 101 === i.charCodeAt(a))) if ((++a < i.length && 43 === i.charCodeAt(a) || 45 === i.charCodeAt(a)) && a++, a < i.length && h(i.charCodeAt(a))) {
              for (a++; a < i.length && h(i.charCodeAt(a));) {
                a++;
              }
        ...
        default:
          ...
          if (s === a) return n += String.fromCharCode(e), a++, c = 16;
  ...
  t.format = function (n, e, t) {
    ...
    u = t.insertSpaces ? k(" ", t.tabSize || 4) : "\t";
    ...
    for (; 17 !== b;) {
      for (var S = p.getTokenOffset() + p.getTokenLength() + i, C = g(), j = ""; !l && (12 === C || 13 === C);) {
        y(" ", S, p.getTokenOffset() + i), S = p.getTokenOffset() + p.getTokenLength() + i, j = 12 === C ? m() : "", C = g();
      }

      if (2 === C) 1 !== b && (d--, j = m());else if (4 === C) 3 !== b && (d--, j = m());else {
        switch (b) {
          case 3:
          case 1:
            d++, j = m();
  ...
  function f(e, t, r) {
    ...
    function y(e, t, r) {
      if (void 0 === t && (t = []), void 0 === r && (r = []), h(e), 0 < t.length + r.length) for (var n = o.getToken(); 17 !== n;) {
        if (-1 !== t.indexOf(n)) {
          v();
          break;
        }
  ...
  t.getLocation = function (e, o) {
    ...
    try {
      f(e, {
        onObjectBegin: function onObjectBegin(e, t) {
          if (o <= e) throw a;
          s = void 0, u = e < o, i.push("");
        },
        onObjectProperty: function onObjectProperty(e, t, r) {
          if (o < t) throw a;
          if (n(e, t, r, "property"), i[i.length - 1] = e, o <= t + r) throw a;
        },
        onObjectEnd: function onObjectEnd(e, t) {
          if (o <= e) throw a;
          s = void 0, i.pop();
        },
        onArrayBegin: function onArrayBegin(e, t) {
          if (o <= e) throw a;
          s = void 0, i.push(0);
        },
        onArrayEnd: function onArrayEnd(e, t) {
          if (o <= e) throw a;
          s = void 0, i.pop();
        },
        onLiteralValue: function onLiteralValue(e, t, r) {
          if (o < t) throw a;
          if (n(e, t, r, l(e)), o <= t + r) throw a;
        },
        onSeparator: function onSeparator(e, t, r) {
          if (o <= t) throw a;
          if (":" === e && s && "property" === s.type) s.colonOffset = t, u = !1, s = void 0;else if ("," === e) {
            var n = i[i.length - 1];
    ...
    return {
      ...
      matches: function matches(e) {
        for (var t = 0, r = 0; t < e.length && r < i.length; r++) {
          if (e[t] === i[r] || "*" === e[t]) t++;else if ("**" !== e[t]) return !1;
        }
    ...
    f(e, {
      onObjectBegin: function onObjectBegin(e) {
        o = a({
          type: "object",
          offset: e,
          length: -1,
    ...
    if (void 0 === n && (n = !1), s(t, r, n)) {
      var o = t.children;
      if (Array.isArray(o)) for (var i = 0; i < o.length && o[i].offset <= r; i++) {
        var a = e(o[i], r, n);
        if (a) return a;
      }
      return t;
  ...
  function n(e, t, r, n, o) {
    for (var i, a = t.slice(), s = S.parseTree(e, []), c = void 0, u = void 0; 0 < a.length && (u = a.pop(), void 0 === (c = S.findNodeAtLocation(s, a)) && void 0 !== r);) {
    ...
    if (c) {
      if ("object" === c.type && "string" == typeof u && Array.isArray(c.children)) {
        ...
        if (void 0 !== f) {
          ...
          return 0 < l ? d = (b = c.children[l - 1]).offset + b.length : (d = c.offset + 1, 1 < c.children.length && (p = c.children[1].offset)), C(e, {
            offset: d,
            length: p - d,
            content: ""
          }, n);
        ...
        var h = JSON.stringify(u) + ": " + JSON.stringify(r),
            m = o ? o(c.children.map(function (e) {
          return e.children[0].value;
        })) : c.children.length,
            g = void 0;
        return C(e, g = 0 < m ? {
          offset: (b = c.children[m - 1]).offset + b.length,
          length: 0,
          content: "," + h
        } : 0 === c.children.length ? {
          offset: c.offset + 1,
      ...
      if ("array" === c.type && "number" == typeof u && Array.isArray(c.children)) {
        ...
        if (void 0 === r && 0 <= c.children.length) {
          ...
          if (1 === c.children.length) g = {
            ...
            g = {
              offset: x,
              length: c.offset + c.length - 2 - x,
              content: ""
            };
          } else g = {
            offset: y.offset,
            length: c.children[v + 1].offset - y.offset,
            content: ""
          };
          return C(e, g, n);
        }
  ...
  function C(e, t, r) {
    ...
    if (0 === t.length || 0 === t.content.length) {
      for (; 0 < o && !u.isEOL(n, o - 1);) {
        o--;
      }

      for (; i < n.length && !u.isEOL(n, i);) {
        i++;
      }
    }
  ...
  Object.defineProperty(t, "__esModule", {
    ...
    if (babelHelpers.typeof(t) != babelHelpers.typeof(r)) return !1;
    if ("object" != babelHelpers.typeof(t)) return !1;
...
var __extends = this && this.__extends || function () {
  var n = Object.setPrototypeOf || babelHelpers.instanceof({
    __proto__: []
  }, Array) && function (e, t) {
    e.__proto__ = t;
  } || function (e, t) {
...
!function (e) {
  ...
  if (Object.defineProperty(t, "__esModule", {
    value: !0
  }), "object" == (typeof process === "undefined" ? "undefined" : babelHelpers.typeof(process))) n = "win32" === process.platform;else if ("object" == (typeof navigator === "undefined" ? "undefined" : babelHelpers.typeof(navigator))) {
  ...
  var o,
    ...
    function r(e, t, r, n, o) {
      "object" == babelHelpers.typeof(e) ? (this.scheme = e.scheme || "", this.authority = e.authority || "", this.path = e.path || "", this.query = e.query || "", this.fragment = e.fragment || "") : (this.scheme = e || "", this.authority = t || "", this.path = function (e, t) {
        switch (e) {
          case "https":
          case "http":
          case "file":
    ...
    return r.isUri = function (e) {
      return babelHelpers.instanceof(e, r) || !!e && "string" == typeof e.authority && "string" == typeof e.fragment && "string" == typeof e.path && "string" == typeof e.query && "string" == typeof e.scheme;
      ...
      if (n && (e = e.replace(/\\/g, d)), e[0] === d && e[1] === d) {
        var r = e.indexOf(d, 2);
        e = -1 === r ? (t = e.substring(2), d) : (t = e.substring(2, r), e.substring(r) || d);
      }
      ...
      if (e) {
        if (babelHelpers.instanceof(e, r)) return e;
        var t = new f(e);
  ...
  function p(e, t) {
    for (var r = void 0, n = -1, o = 0; o < e.length; o++) {
      ...
      if (97 <= i && i <= 122 || 65 <= i && i <= 90 || 48 <= i && i <= 57 || 45 === i || 46 === i || 95 === i || 126 === i || t && 47 === i) -1 !== n && (r += encodeURIComponent(e.substring(n, o)), n = -1), void 0 !== r && (r += e.charAt(o));else {
  ...
  function g(e, t) {
    ...
    if (a) {
      if (3 <= a.length && 47 === a.charCodeAt(0) && 58 === a.charCodeAt(2)) 65 <= (l = a.charCodeAt(1)) && l <= 90 && (a = "/" + String.fromCharCode(l + 32) + ":" + a.substr(3));else if (2 <= a.length && 58 === a.charCodeAt(1)) {
        var l;
...
__extends = this && this.__extends || function () {
  var _n = function n(e, t) {
    return (_n = Object.setPrototypeOf || babelHelpers.instanceof({
      __proto__: []
    }, Array) && function (e, t) {
      e.__proto__ = t;
    } || function (e, t) {
...
!function (e) {
  ...
  var o = e("jsonc-parser"),
      S = e("../utils/objects"),
      C = e("../jsonLanguageTypes"),
      r = e("vscode-nls"),
      s = e("vscode-uri"),
      j = e("vscode-languageserver-types"),
      T = r.loadMessageBundle(),
  ...
  t.ObjectASTNodeImpl = A, t.asSchema = E, (a = t.EnumMatch || (t.EnumMatch = {}))[a.Key = 0] = "Key", a[a.Enum = 1] = "Enum";
    ...
    return e.prototype.hasProblems = function () {
      ...
      if (!this.enumValueMatch && !e.enumValueMatch && this.enumValues && e.enumValues) {
        ...
        for (var t = 0, r = this.problems; t < r.length; t++) {
          var n = r[t];
          n.code === C.ErrorCode.EnumValueMismatch && (n.message = T("enumWarning", "Value is not accepted. Valid values: {0}.", this.enumValues.map(function (e) {
  ...
  t.ValidationResult = I, t.newJSONDocument = function (e, t) {
    return void 0 === t && (t = []), new w(e, t, []);
  }, t.getNodeValue = P, t.getNodePath = function (e) {
    ...
    return e.prototype.getNodeFromOffset = function (e, t) {
      ...
      if (this.root) {
        var i = function i(e) {
          var t = o(e),
              r = e.children;
          if (Array.isArray(r)) for (var n = 0; n < r.length && t; n++) {
            t = i(r[n]);
          }
          return t;
        };
      ...
      if (this.root && e) {
        var t = new I();
        return N(this.root, e, t, d.instance), t.problems.map(function (e) {
          var t = j.Range.create(r.positionAt(e.location.offset), r.positionAt(e.location.offset + e.location.length));
          return j.Diagnostic.create(t, e.message, e.severity, e.code);
        });
      }
      ...
      var n = new f(t, r);
      return this.root && e && N(this.root, e, new I(), n), n.schemas;
    }, e;
  }();
          ...
          !function (i, s, c, u) {
            ...
            i.properties.forEach(function (e) {
              ...
              if (!f[e]) {
                ...
                c.problems.push({
                  location: r,
                  severity: j.DiagnosticSeverity.Warning,
                  message: T("MissingRequiredPropWarning", 'Missing property "{0}".', e)
                });
              }
            });
            ...
            s.properties && Object.keys(s.properties).forEach(function (e) {
              ...
              var t = s.properties[e],
                  r = f[e];
              if (r) if ("boolean" == typeof t) {
                if (t) c.propertiesMatches++, c.propertiesValueMatches++;else {
                  var n = r.parent;
                  c.problems.push({
                    location: {
                    ...
                    severity: j.DiagnosticSeverity.Warning,
                    message: s.errorMessage || T("DisallowedExtraPropWarning", "Property {0} is not allowed.", e)
                  });
                }
              } else {
                var o = new I();
                N(r, t, o, u), c.mergePropertyMatch(o);
              }
            });
              ...
              r.slice(0).forEach(function (e) {
                if (a.test(e)) {
                  ...
                  if (t) {
                    ...
                    if ("boolean" == typeof r) {
                      if (r) c.propertiesMatches++, c.propertiesValueMatches++;else {
                        var n = t.parent;
                        c.problems.push({
                          location: {
                            offset: n.keyNode.offset,
                      ...
                      var o = new I();
                      N(t, r, o, u), c.mergePropertyMatch(o);
                    }
                  }
                }
              });
            });
            "object" == babelHelpers.typeof(s.additionalProperties) ? r.forEach(function (e) {
              var t = f[e];

              if (t) {
                var r = new I();
                N(t, s.additionalProperties, r, u), c.mergePropertyMatch(r);
              }
            ...
            s.maxProperties && i.properties.length > s.maxProperties && c.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("MaxPropWarning", "Object has more properties than limit of {0}.", s.maxProperties)
            });
            s.minProperties && i.properties.length < s.minProperties && c.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("MinPropWarning", "Object has fewer properties than the required number of {0}", s.minProperties)
            });
              ...
              if (e) {
                ...
                if (Array.isArray(r)) r.forEach(function (e) {
                  f[e] ? c.propertiesValueMatches++ : c.problems.push({
                    ...
                    severity: j.DiagnosticSeverity.Warning,
                    message: T("RequiredDependentPropWarning", "Object is missing property {0} required by property {1}.", e, t)
                  });
                });else {
                  var n = E(r);
                  ...
                  if (n) {
                    var o = new I();
                    N(i, n, o, u), c.mergePropertyMatch(o);
                  }
                }
              }
            });
            var n = E(s.propertyNames);
            n && i.properties.forEach(function (e) {
              var t = e.keyNode;
              t && N(t, n, c, d.instance);
            });
          }(v, y, b, x);
          break;
          ...
          !function (i, e, a, s) {
            if (Array.isArray(e.items)) {
              ...
              if (c.forEach(function (e, t) {
                var r = E(e),
                    n = new I(),
                    o = i.items[t];
                o ? (N(o, r, n, s), a.mergePropertyMatch(n)) : i.items.length >= c.length && a.propertiesValueMatches++;
              }), i.items.length > c.length) if ("object" == babelHelpers.typeof(e.additionalItems)) for (var t = c.length; t < i.items.length; t++) {
                var r = new I();
                N(i.items[t], e.additionalItems, r, s), a.mergePropertyMatch(r);
                ...
                severity: j.DiagnosticSeverity.Warning,
                message: T("additionalItemsWarning", "Array has too many items according to schema. Expected {0} or fewer.", c.length)
              });
            } else {
              var n = E(e.items);
              n && i.items.forEach(function (e) {
                var t = new I();
                N(e, n, t, s), a.mergePropertyMatch(t);
              });
            }
            ...
            if (o) {
              var u = i.items.some(function (e) {
                var t = new I();
                return N(e, o, t, d.instance), !t.hasProblems();
              });
              u || a.problems.push({
                location: {
                  offset: i.offset,
                ...
                severity: j.DiagnosticSeverity.Warning,
                message: e.errorMessage || T("requiredItemMissingWarning", "Array does not contain required item.")
              });
            }
            ...
            e.minItems && i.items.length < e.minItems && a.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("minItemsWarning", "Array has too few items. Expected {0} or more.", e.minItems)
            });
            e.maxItems && i.items.length > e.maxItems && a.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("maxItemsWarning", "Array has too many items. Expected {0} or fewer.", e.maxItems)
            });
            ...
            if (!0 === e.uniqueItems) {
              ...
              l && a.problems.push({
                ...
                severity: j.DiagnosticSeverity.Warning,
                message: T("uniqueItemsWarning", "Array has duplicate items.")
              });
            }
          }(v, y, b, x);
          break;
        ...
        case "string":
          !function (e, t, r, n) {
            t.minLength && e.value.length < t.minLength && r.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("minLengthWarning", "String is shorter than the minimum length of {0}.", t.minLength)
            });
            t.maxLength && e.value.length > t.maxLength && r.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("maxLengthWarning", "String is longer than the maximum length of {0}.", t.maxLength)
            });
            ...
            if (t.pattern) {
              ...
              o.test(e.value) || r.problems.push({
                ...
                severity: j.DiagnosticSeverity.Warning,
                message: t.patternErrorMessage || t.errorMessage || T("patternWarning", 'String does not match the pattern of "{0}".', t.pattern)
              });
            }
            ...
            if (t.format) switch (t.format) {
              ...
              case "uri-reference":
                ...
                if (e.value) try {
                  ...
                  a.scheme || "uri" !== t.format || (i = T("uriSchemeMissing", "URI with a scheme is expected."));
                } catch (e) {
                  i = e.message;
                } else i = T("uriEmpty", "URI expected.");
                i && r.problems.push({
                  location: {
                    offset: e.offset,
                    length: e.length
                  ...
                  severity: j.DiagnosticSeverity.Warning,
                  message: t.patternErrorMessage || t.errorMessage || T("uriFormatWarning", "String is not a URI: {0}", i)
                });
                break;
              ...
              case "email":
                e.value.match(u) || r.problems.push({
                  ...
                  severity: j.DiagnosticSeverity.Warning,
                  message: t.patternErrorMessage || t.errorMessage || T("emailFormatWarning", "String is not an e-mail address.")
                });
                break;
              ...
              case "color-hex":
                e.value.match(c) || r.problems.push({
                  ...
                  severity: j.DiagnosticSeverity.Warning,
                  message: t.patternErrorMessage || t.errorMessage || T("colorHexFormatWarning", "Invalid color format. Use #RGB, #RGBA, #RRGGBB or #RRGGBBAA.")
                });
            }
          }(v, y, b);
          break;
        ...
        case "number":
          !function (e, t, r, n) {
            ...
            "number" == typeof t.multipleOf && o % t.multipleOf != 0 && r.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("multipleOfWarning", "Value is not divisible by {0}.", t.multipleOf)
            });
            ...
            "number" == typeof s && o <= s && r.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("exclusiveMinimumWarning", "Value is below the exclusive minimum of {0}.", s)
            });
            ...
            "number" == typeof c && c <= o && r.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("exclusiveMaximumWarning", "Value is above the exclusive maximum of {0}.", c)
            });
            ...
            "number" == typeof u && o < u && r.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("minimumWarning", "Value is below the minimum of {0}.", u)
            });
            ...
            "number" == typeof f && f < o && r.problems.push({
              ...
              severity: j.DiagnosticSeverity.Warning,
              message: T("maximumWarning", "Value is above the maximum of {0}.", f)
            });
          }(v, y, b);
          break;

        case "property":
          return N(v.valueNode, y, b, x);
      }

      !function () {
        function e(e) {
          return v.type === e || "integer" === e && "number" === v.type && v.isInteger;
        }

        Array.isArray(y.type) ? y.type.some(e) || b.problems.push({
          location: {
            offset: v.offset,
            length: v.length
          },
          severity: j.DiagnosticSeverity.Warning,
          message: y.errorMessage || T("typeArrayMismatchWarning", "Incorrect type. Expected one of {0}.", y.type.join(", "))
        }) : y.type && (e(y.type) || b.problems.push({
          location: {
            offset: v.offset,
            length: v.length
          },
          severity: j.DiagnosticSeverity.Warning,
          message: y.errorMessage || T("typeMismatchWarning", 'Incorrect type. Expected "{0}".', y.type)
        }));
        Array.isArray(y.allOf) && y.allOf.forEach(function (e) {
          N(v, E(e), b, x);
        });
        var t = E(y.not);
        ...
        if (t) {
          var r = new I(),
              n = x.newSub();
          N(v, t, r, n), r.hasProblems() || b.problems.push({
            location: {
              offset: v.offset,
              length: v.length
            },
            severity: j.DiagnosticSeverity.Warning,
            message: T("notSchemaWarning", "Matches a schema that is not allowed.")
          }), n.schemas.forEach(function (e) {
            e.inverted = !e.inverted, x.add(e);
          });
        }
        ...
        var o = function o(e, i) {
          ...
          return e.forEach(function (e) {
            var t = E(e),
                r = new I(),
                n = x.newSub();
            if (N(v, t, r, n), r.hasProblems() || a.push(t), s) {
          ...
          }), 1 < a.length && i && b.problems.push({
            location: {
              offset: v.offset,
              length: 1
            },
            severity: j.DiagnosticSeverity.Warning,
            message: T("oneOfWarning", "Matches multiple schemas when only one must validate.")
          }), null !== s && (b.merge(s.validationResult), b.propertiesMatches += s.validationResult.propertiesMatches, b.propertiesValueMatches += s.validationResult.propertiesValueMatches, x.merge(s.matchingSchemas)), a.length;
        };

        Array.isArray(y.anyOf) && o(y.anyOf, !1);
        Array.isArray(y.oneOf) && o(y.oneOf, !0);

        var i = function i(e) {
          var t = E(e),
              r = new I(),
              n = x.newSub();
          N(v, t, r, n), b.merge(r), b.propertiesMatches += r.propertiesMatches, b.propertiesValueMatches += r.propertiesValueMatches, x.merge(n);
        };

        y.if && (a = y.if, s = y.then, c = y.else, u = E(a), f = new I(), l = x.newSub(), N(v, u, f, l), f.hasProblems() ? c && i(c) : s && i(s));
        var a, s, c, u, f, l;

        if (Array.isArray(y.enum)) {
          for (var d = P(v), p = !1, h = 0, m = y.enum; h < m.length; h++) {
            var g = m[h];
          ...
          b.enumValues = y.enum, (b.enumValueMatch = p) || b.problems.push({
            location: {
              offset: v.offset,
              length: v.length
            },
            severity: j.DiagnosticSeverity.Warning,
            code: C.ErrorCode.EnumValueMismatch,
            message: y.errorMessage || T("enumWarning", "Value is not accepted. Valid values: {0}.", y.enum.map(function (e) {
              return JSON.stringify(e);
            }).join(", "))
          });
        }
        ...
        if (y.const) {
          var d = P(v);
          S.equals(d, y.const) ? b.enumValueMatch = !0 : (b.problems.push({
            location: {
              offset: v.offset,
              length: v.length
            },
            severity: j.DiagnosticSeverity.Warning,
            code: C.ErrorCode.EnumValueMismatch,
            message: y.errorMessage || T("constWarning", "Value must be {0}.", JSON.stringify(y.const))
          }), b.enumValueMatch = !1), b.enumValues = [y.const];
        }

        y.deprecationMessage && v.parent && b.problems.push({
          location: {
            offset: v.parent.offset,
            length: v.parent.length
          },
          severity: j.DiagnosticSeverity.Warning,
          message: y.deprecationMessage
        });
      }(), x.add({
        node: v,
        schema: y
  ...
  t.JSONDocument = w, t.parse = function (s, e) {
    var a = [],
        c = -1,
        u = s.getText(),
    ...
    function l() {
      for (;;) {
        ...
        switch (r(), e) {
          case 12:
          case 13:
            Array.isArray(t) && t.push(j.Range.create(s.positionAt(f.getTokenOffset()), s.positionAt(f.getTokenOffset() + f.getTokenLength())));
            break;
    ...
    function d(e, t, r, n, o) {
      if (void 0 === o && (o = j.DiagnosticSeverity.Error), 0 === a.length || r !== c) {
        var i = j.Range.create(s.positionAt(r), s.positionAt(n));
        a.push(j.Diagnostic.create(i, e, o, t, s.languageId)), c = r;
      }
    }
    ...
    function p(e, t, r, n, o) {
      ...
      if (d(e, t, i, a), r && h(r, !1), 0 < n.length + o.length) for (var s = f.getToken(); 17 !== s;) {
        if (-1 !== n.indexOf(s)) {
          l();
          break;
        }
    ...
    function r() {
      switch (f.getTokenError()) {
        case 4:
          return p(T("InvalidUnicode", "Invalid unicode sequence in string."), C.ErrorCode.InvalidUnicode), !0;

        case 5:
          return p(T("InvalidEscapeCharacter", "Invalid escape character in string."), C.ErrorCode.InvalidEscapeCharacter), !0;

        case 3:
          return p(T("UnexpectedEndOfNumber", "Unexpected end of number."), C.ErrorCode.UnexpectedEndOfNumber), !0;

        case 1:
          return p(T("UnexpectedEndOfComment", "Unexpected end of comment."), C.ErrorCode.UnexpectedEndOfComment), !0;

        case 2:
          return p(T("UnexpectedEndOfString", "Unexpected end of string."), C.ErrorCode.UnexpectedEndOfString), !0;

        case 6:
          return p(T("InvalidCharacter", "Invalid characters in string. Control characters must be escaped."), C.ErrorCode.InvalidCharacter), !0;
      }
    ...
    function m(e, t) {
      var r = new O(e, f.getTokenOffset()),
          n = g(r);

      if (!n) {
        if (16 !== f.getToken()) return null;
        p(T("DoubleQuotesExpected", "Property keys must be doublequoted"), C.ErrorCode.Undefined);
        var o = new k(r, f.getTokenOffset(), f.getTokenLength());
        o.value = f.getTokenValue(), n = o, l();
      }

      var i = t[(r.keyNode = n).value];
      if (t[n.value] = i ? (d(T("DuplicateKeyWarning", "Duplicate object key"), C.ErrorCode.DuplicateKey, r.keyNode.offset, r.keyNode.offset + r.keyNode.length, j.DiagnosticSeverity.Warning), "object" == babelHelpers.typeof(i) && d(T("DuplicateKeyWarning", "Duplicate object key"), C.ErrorCode.DuplicateKey, i.keyNode.offset, i.keyNode.offset + i.keyNode.length, j.DiagnosticSeverity.Warning), !0) : r, 6 === f.getToken()) r.colonOffset = f.getTokenOffset(), l();else if (p(T("ColonExpected", "Colon expected"), C.ErrorCode.ColonExpected), 10 === f.getToken() && s.positionAt(n.offset + n.length).line < s.positionAt(f.getTokenOffset()).line) return r.length = n.length, r;
      var a = v(r, n.value);
      return a ? (r.valueNode = a, r.length = a.offset + a.length - r.offset, r) : p(T("ValueExpected", "Value expected"), C.ErrorCode.ValueExpected, r, [], [2, 5]);
    }

    function g(e) {
      if (10 !== f.getToken()) return null;
      var t = new k(e, f.getTokenOffset());
    ...
    function v(e, t) {
      return function (e) {
        ...
        for (var r = !1; 4 !== f.getToken() && 17 !== f.getToken();) {
          if (5 === f.getToken()) {
            r || p(T("ValueExpected", "Value expected"), C.ErrorCode.ValueExpected);
            var n = f.getTokenOffset();

            if (l(), 4 === f.getToken()) {
              r && d(T("TrailingComma", "Trailing comma"), C.ErrorCode.TrailingComma, n, n + 1);
              continue;
            }
          } else r && p(T("ExpectedComma", "Expected comma"), C.ErrorCode.CommaExpected);

          var o = v(t, 0);
          o ? t.items.push(o) : p(T("PropertyExpected", "Value expected"), C.ErrorCode.ValueExpected, null, [], [4, 5]), r = !0;
        }

        return 4 !== f.getToken() ? p(T("ExpectedCloseBracket", "Expected comma or closing bracket"), C.ErrorCode.CommaOrCloseBacketExpected, t) : h(t, !0);
      }(e) || function (e) {
        ...
        for (var n = !1; 2 !== f.getToken() && 17 !== f.getToken();) {
          if (5 === f.getToken()) {
            n || p(T("PropertyExpected", "Property expected"), C.ErrorCode.PropertyExpected);
            var o = f.getTokenOffset();

            if (l(), 2 === f.getToken()) {
              n && d(T("TrailingComma", "Trailing comma"), C.ErrorCode.TrailingComma, o, o + 1);
              continue;
            }
          } else n && p(T("ExpectedComma", "Expected comma"), C.ErrorCode.CommaExpected);

          var i = m(t, r);
          i ? t.properties.push(i) : p(T("PropertyExpected", "Property expected"), C.ErrorCode.PropertyExpected, null, [], [2, 5]), n = !0;
        }

        return 2 !== f.getToken() ? p(T("ExpectedCloseBrace", "Expected comma or closing brace"), C.ErrorCode.CommaOrCloseBraceExpected, t) : h(t, !0);
      }(e) || g(e) || function (e) {
        ...
        if (0 === f.getTokenError()) {
          ...
          try {
            var n = JSON.parse(r);
            if ("number" != typeof n) return p(T("InvalidNumberFormat", "Invalid number format."), C.ErrorCode.Undefined, t);
            t.value = n;
          } catch (e) {
            return p(T("InvalidNumberFormat", "Invalid number format."), C.ErrorCode.Undefined, t);
          }
    ...
    var n = null;
    return 17 !== l() && ((n = v(null)) ? 17 !== f.getToken() && p(T("End of file expected", "End of file expected."), C.ErrorCode.Undefined) : p(T("Invalid symbol", "Expected a JSON object, array or literal."), C.ErrorCode.Undefined)), new w(n, a, t);
  };
}), function (e) {
  if ("object" == (typeof module === "undefined" ? "undefined" : babelHelpers.typeof(module)) && "object" == babelHelpers.typeof(module.exports)) {
    var t = e(require, exports);
  ...
  Object.defineProperty(t, "__esModule", {
    ...
    if (null === t || "object" != babelHelpers.typeof(t)) return n(t);
    var o = r + "\t";
  ...
  var b = e("../parser/jsonParser"),
    ...
    return e.prototype.doResolve = function (e) {
      ...
      t.getMatchingSchemas(e.schema, r.offset).forEach(function (e) {
        if (e.node === r && !e.inverted) {
          ...
          n && Object.keys(n).forEach(function (e) {
            ...
            if ("object" == babelHelpers.typeof(t) && !t.deprecationMessage && !t.doNotSuggest) {
              var r = {
                kind: x.CompletionItemKind.Property,
                label: e,
      ...
      var o = this;
      "object" == babelHelpers.typeof(e) && (this.addEnumValueCompletions(e, t, r), this.addDefaultValueCompletions(e, t, r), this.collectTypes(e, n), Array.isArray(e.allOf) && e.allOf.forEach(function (e) {
      ...
      }), m || "object" != babelHelpers.typeof(f.items) || Array.isArray(f.items) || this.addDefaultValueCompletions(f.items, l, d, p + 1);
      ...
      if (g(e.const) && r.add({
        ...
        insertTextFormat: x.InsertTextFormat.Snippet,
        documentation: e.description
      }), Array.isArray(e.enum)) for (var n = 0, o = e.enum.length; n < o; n++) {
        var i = e.enum[n],
            a = e.description;
  ...
  var d = e("../parser/jsonParser"),
    ...
    return e.prototype.doHover = function (e, t, s) {
      ...
      for (var i = p.Range.create(e.positionAt(n.offset), e.positionAt(n.offset + n.length)), u = function u(e) {
        return {
          contents: e,
          range: i
        };
  ...
  function y(e) {
    if (e && "object" == babelHelpers.typeof(e)) {
  ...
  if ("object" == (typeof module === "undefined" ? "undefined" : babelHelpers.typeof(module)) && "object" == babelHelpers.typeof(module.exports)) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t);
  } else "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonDocumentSymbols", ["require", "exports", "../parser/jsonParser", "../utils/strings", "../utils/colors", "vscode-nls", "vscode-languageserver-types"], e);
}(function (e, t) {
  "use strict";
  ...
  var l = e("../parser/jsonParser"),
    ...
    return e.prototype.findDocumentSymbols = function (a, e) {
      ...
      if (("vscode://defaultsettings/keybindings.json" === r || n.endsWith(r.toLowerCase(), "/user/keybindings.json")) && "array" === t.type) {
        ...
        return t.items.forEach(function (e) {
          if ("object" === e.type) for (var t = 0, r = e.properties; t < r.length; t++) {
            var n = r[t];
      ...
      var u = function u(a, e) {
        return "array" === e.type ? e.items.forEach(function (e, t) {
          if (e) {
            var r = p(s, e),
                n = r,
                o = String(t),
    ...
    }, e.prototype.getSymbolDetail = function (e) {
      switch (e) {
        case "object":
          return o("kind.object", "object");

        case "string":
          return o("kind.string", "string");

        case "number":
          return o("kind.number", "number");

        case "array":
          return o("kind.array", "array");

        case "boolean":
          return o("kind.boolean", "boolean");

        default:
          return o("kind.null", "null");
      }
    }, e.prototype.findDocumentColors = function (u, f) {
      return this.schemaService.getSchemaForResource(u.uri, f).then(function (e) {
        var t = [];
        if (e) for (var r = {}, n = 0, o = f.getMatchingSchemas(e.schema); n < o.length; n++) {
          var i = o[n];
      ...
      return o = 1 === r.alpha ? "#" + u(a) + u(s) + u(c) : "#" + u(a) + u(s) + u(c) + u(Math.round(255 * r.alpha)), i.push({
        label: o,
        textEdit: f.TextEdit.replace(n, JSON.stringify(o))
      }), i;
    }, e;
  }();
  ...
  var d = function () {
    ...
    return e.prototype.getSection = function (e) {
      ...
      if (r.patternProperties) Object.keys(r.patternProperties).forEach(function (e) {
        ...
        if ("object" == babelHelpers.typeof(r.additionalProperties)) return this.getSectionRecursive(t, r.additionalProperties);
        if (o.match("[0-9]+")) if (Array.isArray(r.items)) {
          var e = parseInt(o, 10);
  ...
  var i = function () {
    ...
    return e.prototype.getRegisteredSchemaIds = function (r) {
      ...
      for (; 0 < this.callOnDispose.length;) {
      ...
      for (var e in this.schemasById = {}, this.filePatternAssociations = [], this.filePatternAssociationById = {}, this.registeredSchemasIds = {}, this.contributionSchemas) {
      ...
      if (this.requestService) return this.requestService(i).then(function (e) {
        if (!e) {
      ...
      var s = this,
        ...
        return i && !/^\w+:\/\/.*/.test(n) && (n = i.resolveRelativePath(n, e)), n = s.normalizeId(n), s.getOrAddSchemaHandle(n).getUnresolvedSchema().then(function (e) {
          ...
          c = function c(e, r, n) {
        if (!e || "object" != babelHelpers.typeof(e)) return Promise.resolve(null);

        for (var c = [e], t = [], o = [], i = function i(e) {
          for (; e.$ref;) {
            var t = e.$ref.split("#", 2);
          ...
          !function () {
            ...
            for (var r = 0, n = e; r < n.length; r++) {
              var o = n[r];
              "object" == babelHelpers.typeof(o) && c.push(o);
            }
          }(e.items, e.additionalProperties, e.not, e.contains, e.propertyNames, e.if, e.then, e.else), function () {
            for (var e = [], t = 0; t < arguments.length; t++) {
              e[t] = arguments[t];
            }
            ...
            for (var r = 0, n = e; r < n.length; r++) {
              var o = n[r];
              if ("object" == babelHelpers.typeof(o)) for (var i in o) {
                var a = o[i];
                "object" == babelHelpers.typeof(a) && c.push(a);
              }
            }
            ...
            for (var r = 0, n = e; r < n.length; r++) {
              var o = n[r];
              if (Array.isArray(o)) for (var i = 0, a = o; i < a.length; i++) {
                var s = a[i];
                "object" == babelHelpers.typeof(s) && c.push(s);
              }
            }
      ...
      for (var i = Object.create(null), a = [], s = 0, c = this.filePatternAssociations; s < c.length; s++) {
        var u = c[s];
        if (u.matchesPattern(e)) for (var f = 0, l = u.getSchemas(); f < l.length; f++) {
          var d = l[f];
          i[d] || (a.push(d), i[d] = !0);
        }
      }
  ...
  var k = e("vscode-languageserver-types"),
      O = e("jsonc-parser"),
    ...
    for (; 17 !== s;) {
      switch (s) {
        ...
        case 13:
          ...
          1 === a.getTokenError() && d + 1 < e.lineCount ? a.setPosition(e.offsetAt(k.Position.create(d + 1, 0))) : d < p && (c({
            startLine: d,
            endLine: p,
            kind: A.FoldingRangeKind.Comment
          }), i = d);
          break;

        case 12:
          var h = e.getText().substr(a.getTokenOffset(), a.getTokenLength()).match(/^\/\/\s*#(region\b)|(endregion\b)/);
          if (h) if (l = e.positionAt(a.getTokenOffset()).line, h[1]) u = {
            startLine: l,
            endLine: l,
            kind: A.FoldingRangeKind.Region
          }, o.push(u);else {
            for (var m = o.length - 1; 0 <= m && o[m].kind !== A.FoldingRangeKind.Region;) {
              m--;
            }
  ...
  !function (e) {
    ...
    return {
      ...
      parseJSONDocument: function parseJSONDocument(e) {
        return d.parse(e, {
          collectComments: !0
        });
      },
      ...
      findColorSymbols: function findColorSymbols(e, t) {
  ...
  var n,
      a = monaco.Promise;
  "undefined" != typeof fetch && (n = function n(e) {
  ...
  t.JSONWorker = s, t.create = function (e, t) {
    return new s(e, t);
  };
});