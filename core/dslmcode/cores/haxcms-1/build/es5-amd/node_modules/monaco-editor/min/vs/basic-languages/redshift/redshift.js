 ...
 *-----------------------------------------------------------------------------*/
define("vs/basic-languages/redshift/redshift", ["require", "require"], function (require) {
  var moduleExports = function () {
    ...
    var p = function p(_) {
      return i(_, "__esModule", {
        value: !0
      });
    };

    var l = function l(_, e) {
      for (var t in e) {
        i(_, t, {
          get: e[t],
          enumerable: !0
    ...
    var c = function (_) {
      return function (e, t) {
        return _ && _.get(e) || (t = g(p({}), e, 1), _ && _.set(e, t), t);
      };
