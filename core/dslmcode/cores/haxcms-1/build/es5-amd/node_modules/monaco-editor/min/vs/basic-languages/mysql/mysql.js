 ...
 *-----------------------------------------------------------------------------*/
define("vs/basic-languages/mysql/mysql", ["require", "require"], function (require) {
  var moduleExports = function () {
    ...
    var n = function (T) {
      return function (E, S) {
        return T && T.get(E) || (S = t(o({}), E, 1), T && T.set(E, S), S);
      };
