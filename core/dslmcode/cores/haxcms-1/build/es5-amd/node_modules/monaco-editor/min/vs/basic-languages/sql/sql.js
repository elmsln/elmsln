 ...
 *-----------------------------------------------------------------------------*/
define("vs/basic-languages/sql/sql", ["require", "require"], function (require) {
  var moduleExports = function () {
    ...
    var D = function (T) {
      return function (E, R) {
        return T && T.get(E) || (R = P(L({}), E, 1), T && T.set(E, R), R);
      };
