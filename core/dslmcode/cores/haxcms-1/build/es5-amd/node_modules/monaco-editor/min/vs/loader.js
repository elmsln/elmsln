...
var _amdLoaderGlobal = this,
    _commonjsGlobal = "object" == (typeof global === "undefined" ? "undefined" : babelHelpers.typeof(global)) ? global : {};
...
!function (e) {
  ...
  n.INSTANCE = new n(), e.NullLoaderEventRecorder = n;
}(AMDLoader || (AMDLoader = {}));
!function (e) {
  var t = function () {
    function t() {}
    ...
    return t.fileUriToFilePath = function (e, t) {
      ...
      if (!e || "object" != babelHelpers.typeof(e)) return e;
      var r = Array.isArray(e) ? [] : {};
      return t.forEachProperty(e, function (e, n) {
        r[e] = n && "object" == babelHelpers.typeof(n) ? t.recursiveClone(n) : n;
      }), r;
...
!function (e) {
  ...
  var r = function () {
    function r(e, r) {
      if (this._env = e, this.options = t.mergeConfigurationOptions(r), this._createIgnoreDuplicateModulesMap(), this._createNodeModulesMap(), this._createSortedPathsRules(), "" === this.options.baseUrl) {
    ...
    return r.prototype._createIgnoreDuplicateModulesMap = function () {
      ...
      if (this.options.urlArgs) for (var t = 0, r = e.length; t < r; t++) {
      ...
      var r,
          n = t;
      if (e.Utilities.endsWith(n, ".js") || e.Utilities.isAbsolutePath(n)) e.Utilities.endsWith(n, ".js") || e.Utilities.containsQueryString(n) || (n += ".js"), r = [n];else for (var o = 0, i = (r = this._applyPaths(n)).length; o < i; o++) {
...
!function (e) {
  var t = function () {
    ...
    return t.prototype._init = function (e) {
      ...
      var r = t.getConfig().getOptionsLiteral().nodeCachedDataDir;
      ...
      if (r && !this._didPatchNodeRequire) {
        ...
        o.prototype._compile = function (e, i) {
          ...
          var s = o.wrap(e),
              d = n._getCachedDataPath(r, i),
              a = {
            filename: i
          };

          try {
            a.cachedData = n._fs.readFileSync(d);
          } catch (e) {
            a.produceCachedData = !0;
          }

          var l = new n._vm.Script(s, a),
              u = l.runInThisContext(a),
              c = n._path.dirname(i),
              h = function (e) {
            var t = e.constructor,
                r = function r(t) {
            ...
            return r.resolve = function (r) {
              ...
              f = [this.exports, h, this, i, c, process, _commonjsGlobal, Buffer],
              p = u.apply(this.exports, f);

          return n._processCachedData(t, l, d), p;
        };
      }
            ...
            s._fs.readFile(g, function (e, t) {
              var d = {
                ...
                cachedData: t
                  ...
                  a = s._loadAndEvalScript(r, n, h, p, d, u, o, i);
      ...
      var l = new this._vm.Script(o, i),
          u = l.runInThisContext(i),
      ...
      return f.amd = c.amd, u.call(e.global, t.getGlobalAMDRequireFunc(), f, n, this._path.dirname(r)), s.record(32, r), h ? d() : a(new Error("Didn't receive define call in " + r + "!")), l;
  ...
  var s = function () {
    ...
    return s.prototype.reset = function () {
      ...
      if (this._modules2[l]) this._config.isDuplicateMessageIgnoredFor(e) || console.warn("Duplicate definition of module '" + e + "'");else {
        var u = new r(l, e, this._normalizeDependencies(n, d), o, i, d);
      ...
      var r = this,
          n = function n(e, _n, o) {
        return r._relativeRequire(t, e, _n, o);
      };
        ...
        if (d !== o.EXPORTS) {
          if (d !== o.MODULE) {
            if (d !== o.REQUIRE) {
              ...
              if (a && a.isComplete()) e.unresolvedDependenciesCount--;else if (this._hasDependencyPath(d.id, e.id)) {
              ...
              } else if (this._inverseDependencies2[d.id] = this._inverseDependencies2[d.id] || [], this._inverseDependencies2[d.id].push(e.id), babelHelpers.instanceof(d, i)) {
      ...
      if (!e.isComplete()) {
        ...
        if (this._inverseDependencies2[e.id] = null, u) for (var s = 0, d = u.length; s < d; s++) {
          var c = u[s],
              h = this._modules2[c];
...
!function (e) {
  ...
  var r = new e.Environment(),
      n = null,
      o = function o(e, t, r) {
    "string" != typeof e && (r = t, t = e, e = null), "object" == babelHelpers.typeof(t) && Array.isArray(t) || (r = t, t = null), t || (t = ["require", "exports", "module"]), e ? n.defineModule(e, t, r, null, null) : n.enqueueDefineAnonymousModule(t, r);
  };
  ...
  var i = function i(e, t) {
    ...
    if (1 === arguments.length) {
      if (babelHelpers.instanceof(arguments[0], Object) && !Array.isArray(arguments[0])) return void i(arguments[0]);
  ...
  }, e.init = t, "function" == typeof e.global.define && e.global.define.amd || (n = new e.ModuleManager(r, e.createScriptLoader(r), o, s, e.Utilities.getHighPerformanceTimestamp()), void 0 !== e.global.require && "function" != typeof e.global.require && s.config(e.global.require), (define = function define() {
    return o.apply(null, arguments);
  }).amd = o.amd, "undefined" == typeof doNotInitLoader && t());
}(AMDLoader || (AMDLoader = {})); //# sourceMappingURL=../../min-maps/vs/loader.js.map