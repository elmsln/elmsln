...
define("vs/language/html/workerManager", ["require", "exports"], function (e, t) {
  ...
  }, (T = E = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {})).create = function (e, t) {
    return {
      uri: e,
      version: t
    };
  ...
  }, (S = t.TextDocumentItem || (t.TextDocumentItem = {})).create = function (e, t, n, r) {
    return {
      uri: e,
      languageId: t,
      version: n,
  ...
  }, (A = t.CompletionItemKind || (t.CompletionItemKind = {})).Text = 1, A.Method = 2, A.Function = 3, A.Constructor = 4, A.Field = 5, A.Variable = 6, A.Class = 7, A.Interface = 8, A.Module = 9, A.Property = 10, A.Unit = 11, A.Value = 12, A.Enum = 13, A.Keyword = 14, A.Snippet = 15, A.Color = 16, A.File = 17, A.Reference = 18, A.Folder = 19, A.EnumMember = 20, A.Constant = 21, A.Struct = 22, A.Event = 23, A.Operator = 24, A.TypeParameter = 25, (P = t.InsertTextFormat || (t.InsertTextFormat = {})).PlainText = 1, P.Snippet = 2, (t.CompletionItem || (t.CompletionItem = {})).create = function (e) {
    return {
      label: e
    };
  ...
  }, t.DocumentSymbol = $, (U = t.CodeActionKind || (t.CodeActionKind = {})).QuickFix = "quickfix", U.Refactor = "refactor", U.RefactorExtract = "refactor.extract", U.RefactorInline = "refactor.inline", U.RefactorRewrite = "refactor.rewrite", U.Source = "source", U.SourceOrganizeImports = "source.organizeImports", (q = t.CodeActionContext || (t.CodeActionContext = {})).create = function (e, t) {
    var n = {
      diagnostics: e
    };
  ...
  return e;
}), define("vs/language/html/languageFeatures", ["require", "exports", "vscode-languageserver-types"], function (e, t, o) {
  "use strict";
  ...
  var i = function () {
    ...
    return Object.defineProperty(e.prototype, "triggerCharacters", {
      ...
      return this._worker(i).then(function (e) {
        return e.doComplete(i.toString(), a(t));
      }).then(function (e) {
        if (e) {
          var t = e.items.map(function (e) {
            ...
            return e.textEdit && (t.range = u(e.textEdit.range), t.insertText = e.textEdit.newText), e.additionalTextEdits && (t.additionalTextEdits = e.additionalTextEdits.map(s)), e.insertTextFormat === o.InsertTextFormat.Snippet && (t.insertTextRules = monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet), t;
          });
          return {
  ...
  var g = function () {
    ...
    return e.prototype.provideDocumentFormattingEdits = function (e, t, n) {
      var r = e.uri;
      return this._worker(r).then(function (e) {
        return e.format(r.toString(), null, l(t)).then(function (e) {
  ...
  t.DocumentFormattingEditProvider = g;
  ...
  var f = function () {
    ...
    return e.prototype.provideDocumentRangeFormattingEdits = function (e, t, n, r) {
      var i = e.uri;
      return this._worker(i).then(function (e) {
        return e.format(i.toString(), function (e) {
          if (e) return {
            start: a(e.getStartPosition()),
            end: a(e.getEndPosition())
          };
        }(t), l(n)).then(function (e) {
          if (e && 0 !== e.length) return e.map(s);
        });
      });
    }, e;
  ...
  t.DocumentRangeFormattingEditProvider = f;
