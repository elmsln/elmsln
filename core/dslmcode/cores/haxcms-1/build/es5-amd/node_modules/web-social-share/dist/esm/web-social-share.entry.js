define(["exports", "./chunk-92e462c5.js"], function (_exports, _chunk92e462c) {
  "use strict";
  ...
  function () {
    function WebSocialShare(hostRef) {
      ...
      (0, _chunk92e462c.r)(this, hostRef);
      this.closed = (0, _chunk92e462c.c)(this, "closed", 7);
    }
    ...
    babelHelpers.createClass(WebSocialShare, [{
      ...
      value: function renderTargets() {
        ...
        if (!this.share || !this.share.config) {
          return (0, _chunk92e462c.h)("span", null);
        } else {
          return this.share.config.map(function (config) {
            return (0, _chunk92e462c.h)("div", {
              class: "web-social-share-target"
            }, _this3.renderButton(config));
          });
        }
      }
    }, {
      key: "renderButton",
      value: function renderButton(share) {
        var _this4 = this;

        if (share.facebook) {
          return (0, _chunk92e462c.h)("button", {
            onClick: function onClick($event) {
              return _this4.handleFacebookShare($event, share);
            },
            class: 'web-social-share-button web-social-share-button-facebook'
          }, (0, _chunk92e462c.h)("div", {
            class: "web-social-share-button-icon"
          }, (0, _chunk92e462c.h)("slot", {
            name: "facebook"
          })), this.renderName(share.facebook, 'Facebook'));
        } else if (share.twitter) {
          return (0, _chunk92e462c.h)("button", {
            onClick: function onClick($event) {
              return _this4.handleTwitterShare($event, share);
            },
          ...
          return (0, _chunk92e462c.h)("button", {
            onClick: function onClick($event) {
              return _this4.handleEmailShare($event, share);
            },
          ...
          return (0, _chunk92e462c.h)("button", {
            onClick: function onClick($event) {
              return _this4.handleLinkedinShare($event, share);
            },
          ...
          return (0, _chunk92e462c.h)("button", {
            onClick: function onClick($event) {
              return _this4.handlePinterestShare($event, share);
            },
          ...
          return (0, _chunk92e462c.h)("button", {
            onClick: function onClick($event) {
              return _this4.handleRedditShare($event, share);
            },
          ...
          return (0, _chunk92e462c.h)("button", {
            onClick: function onClick($event) {
              return _this4.handleWhatsappShare($event, share);
            },
          ...
          return (0, _chunk92e462c.h)("button", {
            onClick: function onClick($event) {
              return _this4.handleCopyShare($event, share);
            },
          ...
          return (0, _chunk92e462c.h)("div", null);
        }
      }
    }, {
      key: "handleFacebookShare",
      value: function handleFacebookShare($event, share) {
      ...
      value: function handleTwitterShare($event, share) {
        $event.stopPropagation();
      ...
      value: function handleEmailShare($event, share) {
        $event.stopPropagation();
        WebSocialShareEmail.share(share.email);
        this.hide();
      }
    }, {
      key: "handleLinkedinShare",
      value: function handleLinkedinShare($event, share) {
        $event.stopPropagation();
        WebSocialShareLinkedin.share(share.linkedin);
        this.hide();
      }
    }, {
      key: "handlePinterestShare",
      value: function handlePinterestShare($event, share) {
        $event.stopPropagation();
        WebSocialSharePinterest.share(share.pinterest);
        this.hide();
      }
    }, {
      key: "handleRedditShare",
      value: function handleRedditShare($event, share) {
        $event.stopPropagation();
      ...
      value: function handleWhatsappShare($event, share) {
        $event.stopPropagation();
      ...
      key: "handleCopyShare",
      value: function () {
        var _handleCopyShare = babelHelpers.asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee2($event, share) {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  $event.stopPropagation();
                  _context2.next = 3;
                  return WebSocialShareCopy.share(share.copy);
        ...
        function handleCopyShare(_x2, _x3) {
          return _handleCopyShare.apply(this, arguments);
        }

        return handleCopyShare;
      }()
    }, {
      key: "renderName",
      value: function renderName(displayAttributes, defaultBrandName) {
        if (this.share.displayNames) {
          return (0, _chunk92e462c.h)("p", null, displayAttributes && displayAttributes.brandName && displayAttributes.brandName !== '' ? displayAttributes.brandName : defaultBrandName);
        } else {
          return (0, _chunk92e462c.h)("span", null);
        }
      }
