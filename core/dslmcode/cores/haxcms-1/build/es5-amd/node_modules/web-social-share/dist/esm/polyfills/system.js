      ...
      var n = function e(n, t, r) {
        ...
        var l = Promise.resolve().then(function () {
          ...
          var r = e[1](function (e, n) {
            o.h = !0;
            var t = !1;
            if ("object" != babelHelpers.typeof(e)) e in s && s[e] === n || (s[e] = n, t = !0);else for (var n in e) {
              var r = e[n];
              n in s && s[n] === r || (s[n] = r, t = !0);
            }
            if (t) for (var e = 0; e < u.length; e++) {
              u[e](s);
            }
            return n;
          }, 2 === e[1].length ? {
    ...
    var o = function (e, n) {
      ...
      if ("." === e[0] && ("/" === e[1] || "." === e[1] && ("/" === e[2] || 2 === e.length && (e += "/")) || 1 === e.length && (e += "/")) || "/" === e[0]) {
        ...
        for (var e = 0; e < o.length; e++) {
          -1 !== c ? "/" === o[e] && (i.push(o.slice(c, e + 1)), c = -1) : "." === o[e] ? "." !== o[e + 1] || "/" !== o[e + 2] && e + 2 !== o.length ? "/" === o[e + 1] || e + 1 === o.length ? e += 1 : c = e : (i.pop(), e += 2) : c = e;
        }
