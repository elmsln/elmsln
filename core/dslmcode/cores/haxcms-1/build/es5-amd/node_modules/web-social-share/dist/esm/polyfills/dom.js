(function () {
  ...
  */
  ...
  function l(a) {
    ...
    for (; a && !(a.__CE_isImportDocument || babelHelpers.instanceof(a, Document));) {
      a = a.parentNode || (window.ShadowRoot && babelHelpers.instanceof(a, ShadowRoot) ? a.host : void 0);
    }

    return !(!a || !(a.__CE_isImportDocument || babelHelpers.instanceof(a, Document)));
  }
    ...
    for (var c = a; c;) {
      if (c.nodeType === Node.ELEMENT_NODE) {
        ...
        if ("link" === f && "import" === e.getAttribute("rel")) {
          c = e.import;
          if (babelHelpers.instanceof(c, Node) && !d.has(c)) for (d.add(c), c = c.firstChild; c; c = c.nextSibling) {
            p(c, b, d);
          }
          c = n(a, e);
          continue;
  ...
  function A(a, b, d) {
    ...
    p(b, function (b) {
      if ("link" === b.localName && "import" === b.getAttribute("rel")) {
        var d = b.import;
        babelHelpers.instanceof(d, Node) && (d.__CE_isImportDocument = !0, d.__CE_hasRegistry = !0);
  ...
  E.prototype.l = function (a, b) {
    var d = this;
    if (!babelHelpers.instanceof(b, Function)) throw new TypeError("Custom element constructors must be functions.");
    ...
    try {
      var c = function c(b) {
        var a = e[b];
        if (void 0 !== a && !babelHelpers.instanceof(a, Function)) throw Error("The '" + b + "' callback must be a function.");
        return a;
      },
          e = b.prototype;

      if (!babelHelpers.instanceof(e, Object)) throw new TypeError("The custom element constructor's prototype is not an object.");
    ...
    function c(b) {
      return function (d) {
        ...
        for (var f = [], m = 0; m < e.length; m++) {
          var q = e[m];
          babelHelpers.instanceof(q, Element) && l(q) && f.push(q);
          if (babelHelpers.instanceof(q, DocumentFragment)) for (q = q.firstChild; q; q = q.nextSibling) {
            c.push(q);
          } else c.push(q);
        }
        ...
        if (l(this)) for (e = 0; e < c.length; e++) {
          f = c[e], babelHelpers.instanceof(f, Element) && x(a, f);
        }
      };
    }
  ...
  function za() {
    ...
    r(Node.prototype, "insertBefore", function (a, c) {
      if (babelHelpers.instanceof(a, DocumentFragment)) {
  ...
  function Aa(a) {
    function b(b) {
      return function (e) {
        ...
        for (var k = [], h = 0; h < c.length; h++) {
          var m = c[h];
          babelHelpers.instanceof(m, Element) && l(m) && k.push(m);
          if (babelHelpers.instanceof(m, DocumentFragment)) for (m = m.firstChild; m; m = m.nextSibling) {
            d.push(m);
          } else d.push(m);
        }
        ...
        if (l(this)) for (c = 0; c < d.length; c++) {
          k = d[c], babelHelpers.instanceof(k, Element) && x(a, k);
        }
      };
    }
    ...
    void 0 !== ra && r(d, "replaceWith", function (b) {
      ...
      for (var d = [], k = 0; k < e.length; k++) {
        var h = e[k];
        babelHelpers.instanceof(h, Element) && l(h) && d.push(h);
        if (babelHelpers.instanceof(h, DocumentFragment)) for (h = h.firstChild; h; h = h.nextSibling) {
          c.push(h);
        } else c.push(h);
      }
      ...
      if (k) for (z(a, this), e = 0; e < c.length; e++) {
        d = c[e], babelHelpers.instanceof(d, Element) && x(a, d);
      }
    });
