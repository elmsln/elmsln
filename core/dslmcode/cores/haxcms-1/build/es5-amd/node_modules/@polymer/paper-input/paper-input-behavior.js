define(["exports", "../polymer/polymer-legacy.js", "../iron-a11y-keys-behavior/iron-a11y-keys-behavior.js", "../iron-behaviors/iron-control-state.js", "../polymer/lib/legacy/polymer.dom.js", "../polymer/polymer-element.js"], function (_exports, _polymerLegacy, _ironA11yKeysBehavior, _ironControlState, _polymerDom, _polymerElement) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.PaperInputHelper = _exports.PaperInputBehaviorImpl = _exports.PaperInputBehavior = void 0;
  ...
  */
  ...
  var PaperInputBehaviorImpl = {
    ...
    _focusBlurHandler: function _focusBlurHandler(event) {
      _ironControlState.IronControlState._focusBlurHandler.call(this, event); // Forward the focus to the nested input.
    ...
    _autofocusChanged: function _autofocusChanged() {
      ...
      if (this.autofocus && this._focusableElement) {
        ...
        var isActiveElementValid = babelHelpers.instanceof(activeElement, HTMLElement); // Has some other element has already taken the focus?
  ...
  var PaperInputBehavior = [_ironControlState.IronControlState, _ironA11yKeysBehavior.IronA11yKeysBehavior, PaperInputBehaviorImpl];
