...
*/ /** @const {!AsyncInterface} */var microtask=_async.microTask,PropertiesChanged=(0,_mixin.dedupingMixin)(/**
     * @template T
...
old===old||value===value))}/**
     ...
     * @return {void}
     * @override
     */},{key:"_valueToNodeAttribute",value:function _valueToNodeAttribute(node,value,attribute){var str=this._serializeValue(value);if(str===void 0){node.removeAttribute(attribute)}else{if("class"===attribute||"name"===attribute||"slot"===attribute){node=/** @type {?Element} */(0,_wrap.wrap)(node)}node.setAttribute(attribute,str)}}/**
