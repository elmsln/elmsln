 ...
 *  fully dereferenced.
 */function get(root,path,info){// Loop over path parts[0..n-1] and dereference
 ...
 */function set(root,path,value){var prop=root,parts=split(path),last=parts[parts.length-1];if(1<parts.length){// Loop over path parts[0..n-2] and dereference
 ...
 * @param {string} path Path string
 * @return {boolean} True if the string contained one or more dots
 */var isDeep=isPath;_exports.isDeep=isDeep});