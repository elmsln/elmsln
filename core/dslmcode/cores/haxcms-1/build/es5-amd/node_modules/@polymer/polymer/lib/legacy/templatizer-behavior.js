define(["exports", "../utils/templatize.js"], function (_exports, _templatize2) {
  "use strict";
  ...
  */
  ...
  var Templatizer = {
    ...
    templatize: function templatize(template, mutableData) {
      ...
      this.ctor = (0, _templatize2.templatize)(template, this, {
    ...
    modelForElement: function modelForElement(el) {
      return (0, _templatize2.modelForElement)(this._templatizerTemplate, el);
    }
  };
