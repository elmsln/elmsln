define(["exports", "../polymer/polymer-legacy.js", "../iron-ajax/iron-ajax.js", "../../intl-messageformat/src/main.js"], function (_exports, _polymerLegacy, _ironAjax, _main) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.AppLocalizeBehavior = void 0;
  ...
  */
  ...
  var AppLocalizeBehavior = {
    ...
    __localizationCache: {
      ...
      /* Unique localized strings. Invalidated when the language,
    ...
    __computeLocalize: function __computeLocalize(language, resources, formats) {
      ...
      return function () {
        ...
        if (!translatedMessage) {
          translatedMessage = new _main.default(translatedValue, language, formats);
    ...
    __onRequestResponse: function __onRequestResponse(event, language, merge) {
      var propertyUpdates = {};
      ...
      if (merge) {
        if (language) {
          ...
          propertyUpdates['resources.' + language] = assign(propertyUpdates.resources[language] || {}, newResources);
        } else {
    ...
    __onRequestError: function __onRequestError(event) {
      this.fire('app-localize-resources-error');
    },
    __checkLocalizationCache: function __checkLocalizationCache(proto) {
