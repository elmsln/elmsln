define(["exports", "../../polymer/polymer-legacy.js"], function (_exports, _polymerLegacy) {
  ...
  */
  ...
  var ElementWithBackground =
  /*#__PURE__*/
  function () {
    function ElementWithBackground() {
      babelHelpers.classCallCheck(this, ElementWithBackground);
    }

    babelHelpers.createClass(ElementWithBackground, [{
      key: "isContentBelow",

      /** @return {boolean} True if there's content below the current element */
      value: function isContentBelow() {}
