define(["../polymer/polymer-legacy.js","../iron-a11y-announcer/iron-a11y-announcer.js","../iron-validatable-behavior/iron-validatable-behavior.js","../polymer/lib/legacy/polymer-fn.js","../polymer/lib/legacy/polymer.dom.js","../polymer/lib/utils/html-tag.js"],function(_polymerLegacy,_ironA11yAnnouncer,_ironValidatableBehavior,_polymerFn,_polymerDom,_htmlTag){"use strict";function _templateObject_9ef7f990696b11eabd167f7c8887b3bc(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: inline-block;\n      }\n    </style>\n    <slot id=\"content\"></slot>\n"]);_templateObject_9ef7f990696b11eabd167f7c8887b3bc=function _templateObject_9ef7f990696b11eabd167f7c8887b3bc(){return data};return data}/**
...
*/(0,_polymerFn.Polymer)({_template:(0,_htmlTag.html)(_templateObject_9ef7f990696b11eabd167f7c8887b3bc()),is:"iron-input",behaviors:[_ironValidatableBehavior.IronValidatableBehavior],/**
   ...
   */properties:{/**
     ...
     */_inputElement:Object},observers:["_bindValueChanged(bindValue, _inputElement)"],listeners:{input:"_onInput",keypress:"_onKeypress"},created:function created(){_ironA11yAnnouncer.IronA11yAnnouncer.requestAvailability();this._previousValidInput="";this._patternAlreadyChecked=!1},attached:function attached(){// If the input is added at a later time, update the internal reference.
this._observer=(0,_polymerDom.dom)(this).observeNodes(function(info){this._initSlottedInput()}.bind(this))},detached:function detached(){if(this._observer){(0,_polymerDom.dom)(this).unobserveNodes(this._observer);this._observer=null}},/**
