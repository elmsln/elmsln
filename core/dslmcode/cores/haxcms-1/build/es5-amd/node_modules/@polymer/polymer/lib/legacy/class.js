  ...
  function GenerateClassFromInfo(info, Base, behaviors) {
    ...
    function (_Base) {
      ...
      function PolymerGenerated() {
        ...
        return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(PolymerGenerated).apply(this, arguments));
      }
      ...
      babelHelpers.createClass(PolymerGenerated, [{
        ...
        value: function _finalizeClass() {
          ...
          if (!this.hasOwnProperty(JSCompiler_renameProperty('generatedFrom', this))) {
            babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated), "_finalizeClass", this).call(this);
          } else {
