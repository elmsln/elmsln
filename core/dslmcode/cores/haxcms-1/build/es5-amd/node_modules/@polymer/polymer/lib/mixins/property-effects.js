define(["exports", "../utils/boot.js", "../utils/wrap.js", "../utils/mixin.js", "../utils/path.js", "../utils/case-map.js", "./property-accessors.js", "./template-stamp.js", "../utils/settings.js"], function (_exports, _boot, _wrap, _mixin, _path, _caseMap, _propertyAccessors, _templateStamp, _settings) {
    ...
    if (!effects) {
      ...
      if (cloneArrays) {
        for (var p in effects) {
          var protoFx = effects[p]; // Perf optimization over Array.slice
  ...
  function dependencyCounts(inst) {
    ...
    var ready = [];
    var total = 0; // Count dependencies for each computed property

    for (var p in infoForComputed) {
      var info = infoForComputed[p]; // Be sure to add the method name itself in case of "dynamic functions"
    ...
    var PropertyEffects = /*#__PURE__*/function (_propertyEffectsBase) {
      ...
      babelHelpers.createClass(PropertyEffects, [{
        ...
        value: function _propertiesChanged(currentProps, changedProps, oldProps) {
          ...
          var notifyProps; // Compute properties
        ...
        value: function _createComputedProperty(property, expression, dynamicFn) {
          ...
          var info = createMethodEffect(this, sig, TYPES.COMPUTE, runComputedEffect, property, dynamicFn); // Effects are normally stored as map of dependency->effect, but for
        ...
        function _bindTemplate(template, instanceBinding) {
          ...
          var wasPreBound = this.__preBoundTemplateInfo == templateInfo; // Optimization: since this is called twice for proto-bound templates,
        ...
        function _stampTemplate(template, templateInfo) {
          ...
          hostStack.push(this);
          var dom = babelHelpers.get(babelHelpers.getPrototypeOf(PropertyEffects.prototype), "_stampTemplate", this).call(this, template, templateInfo);
        ...
        value: function _parseTemplateNestedTemplate(node, templateInfo, nodeInfo) {
          ...
          var isDomRepeat = parent.localName === 'dom-repeat'; // Remove nested template and redirect its host bindings & templateInfo
