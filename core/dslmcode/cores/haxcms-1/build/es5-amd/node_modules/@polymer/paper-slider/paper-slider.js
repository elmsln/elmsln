...
*/(0,_polymerFn.Polymer)({_template:template,is:"paper-slider",behaviors:[_ironA11yKeysBehavior.IronA11yKeysBehavior,_ironFormElementBehavior.IronFormElementBehavior,_paperInkyFocusBehavior.PaperInkyFocusBehavior,_ironRangeBehavior.IronRangeBehavior],properties:{value:{type:Number,value:0},/**
     ...
     */dragging:{type:Boolean,value:!1,readOnly:!0,notify:!0},transiting:{type:Boolean,value:!1,readOnly:!0},markers:{type:Array,readOnly:!0,value:function value(){return[]}}},observers:["_updateKnob(value, min, max, snaps, step)","_valueChanged(value)","_immediateValueChanged(immediateValue)","_updateMarkers(maxMarkers, min, max, snaps)"],hostAttributes:{role:"slider",tabindex:0},/** @type {!Object} */keyBindings:{left:"_leftKey",right:"_rightKey","down pagedown home":"_decrementKey","up pageup end":"_incrementKey"},ready:function ready(){if(this.ignoreBarTouch){(0,_gestures.setTouchAction)(this.$.sliderBar,"auto")}},/**
...
this.focus()},_bartrack:function _bartrack(event){if(this._allowBarEvent(event)){this._onTrack(event)}},_barclick:function _barclick(event){this._w=this.$.sliderBar.offsetWidth;var rect=this.$.sliderBar.getBoundingClientRect(),ratio=100*((event.detail.x-rect.left)/this._w);if(this._isRTL){ratio=100-ratio}var prevRatio=this.ratio;this._setTransiting(!0);this._positionKnob(ratio);// if the ratio doesn't change, sliderKnob's animation won't start
