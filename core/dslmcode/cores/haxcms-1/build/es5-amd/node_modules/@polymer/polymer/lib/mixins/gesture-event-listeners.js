define(["exports", "../utils/boot.js", "../utils/mixin.js", "../utils/gestures.js"], function (_exports, _boot, _mixin, _gestures) {
  ...
  */
   ...
   * gesture events to nodes
   */
  var GestureEventListeners = (0, _mixin.dedupingMixin)(
  /**
   * @template T
  ...
  function (superClass) {
    ...
    function (_superClass) {
      ...
      function GestureEventListeners() {
        ...
        return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(GestureEventListeners).apply(this, arguments));
      }
