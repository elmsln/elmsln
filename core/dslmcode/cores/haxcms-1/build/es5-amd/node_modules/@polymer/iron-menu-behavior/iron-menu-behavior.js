...
if((0,_polymerDom.dom)(owner).activeElement==item){return}}}},/**
   ...
   */_applySelection:function _applySelection(item,isSelected){if(isSelected){item.setAttribute("aria-selected","true")}else{item.setAttribute("aria-selected","false")}_ironSelectable.IronSelectableBehavior._applySelection.apply(this,arguments)},/**
...
_activateHandler:function _activateHandler(event){_ironSelectable.IronSelectableBehavior._activateHandler.call(this,event);event.stopPropagation()},/**
...
}else if(!this.hasAttribute("tabindex")){this.setAttribute("tabindex",this._previousTabIndex)}}};_exports.IronMenuBehaviorImpl=IronMenuBehaviorImpl;IronMenuBehaviorImpl._shiftTabPressed=!1;/** @polymerBehavior */var IronMenuBehavior=[_ironMultiSelectable.IronMultiSelectableBehavior,_ironA11yKeysBehavior.IronA11yKeysBehavior,IronMenuBehaviorImpl];_exports.IronMenuBehavior=IronMenuBehavior});