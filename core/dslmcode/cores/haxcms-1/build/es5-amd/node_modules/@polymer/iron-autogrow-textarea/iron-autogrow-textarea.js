...
*/(0,_polymerFn.Polymer)({_template:(0,_htmlTag.html)(_templateObject_8ebc1bb07aa011eaae968b3bc65fe8dd()),is:"iron-autogrow-textarea",behaviors:[_ironValidatableBehavior.IronValidatableBehavior,_ironControlState.IronControlState],properties:{/**
...
// value.
this.fire("bind-value-changed",{value:this.bindValue})},_onInput:function _onInput(event){var eventPath=(0,_polymerDom.dom)(event).path;this.value=eventPath?eventPath[0].value:event.target.value},_constrain:function _constrain(tokens){var _tokens;tokens=tokens||[""];// Enforce the min and max heights for a multiline input to avoid
// measurement
