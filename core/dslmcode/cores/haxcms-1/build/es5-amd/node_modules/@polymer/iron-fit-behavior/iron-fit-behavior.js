    ...
    position: function position() {
      ...
      if (this.expandSizingTargetForScrollbars) {
        ...
        if (sizingTargetScrollbarHeight > 0) {
          ...
          this.sizingTarget.style.maxHeight = "".concat(newMaxHeight, "px"); // Measure the element's real change in height. This may not equal
          // `sizingTargetScrollbarHeight` if the overflow amount is less than the
          // scrollbar size.

          var offsetHeight = this.sizingTarget.offsetHeight;
          var addedHeight = offsetHeight - positionedOffsetHeight; // Adjust the top position if the alignment requires it.
        ...
        if (sizingTargetScrollbarWidth > 0) {
          var maxWidthBugOffset = getVerticalScrollbarMaxWidthBugOffset(); // Expand `maxWidth` by `sizingTargetScrollbarWidth` up to the overall
          ...
          this.sizingTarget.style.maxWidth = "".concat(newMaxWidth, "px"); // Measure the element's real change in width. This may not equal
          ...
          var addedWidth = offsetWidth - positionedOffsetWidth; // Adjust the left position if the alignment requires it.
