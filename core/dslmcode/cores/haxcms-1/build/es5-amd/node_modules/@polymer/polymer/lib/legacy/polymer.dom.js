define(["exports","../utils/boot.js","../utils/wrap.js","../utils/settings.js","../utils/flattened-nodes-observer.js","../utils/flush.js","../utils/debounce.js"],function(_exports,_boot,_wrap,_settings,_flattenedNodesObserver,_flush,_debounce){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});Object.defineProperty(_exports,"flush",{enumerable:!0,get:function get(){return _flush.flush}});Object.defineProperty(_exports,"addDebouncer",{enumerable:!0,get:function get(){return _flush.enqueueDebouncer}});_exports.dom=_exports.DomApi=_exports.EventApi=_exports.matchesSelector=void 0;/**
@license
...
/* eslint-enable no-unused-vars */var p=Element.prototype,normalizedMatchesSelector=p.matches||p.matchesSelector||p.mozMatchesSelector||p.msMatchesSelector||p.oMatchesSelector||p.webkitMatchesSelector,matchesSelector=function matchesSelector(node,selector){return normalizedMatchesSelector.call(node,selector)};/**
 ...
 */var DomApiNative=/*#__PURE__*/function(){/**
   ...
   * @override
   */babelHelpers.createClass(DomApiNative,[{key:"observeNodes",value:function observeNodes(callback){return new _flattenedNodesObserver.FlattenedNodesObserver(/** @type {!HTMLElement} */this.node,callback)}/**
   ...
   * @override
   */},{key:"deepContains",value:function deepContains(node){if((0,_wrap.wrap)(this.node).contains(node)){return!0}var n=node,doc=node.ownerDocument;// walk from node to `this` or `document`
...
n=(0,_wrap.wrap)(n).parentNode||(0,_wrap.wrap)(n).host}return n===this.node}/**
   ...
   * @override
   */},{key:"getOwnerRoot",value:function getOwnerRoot(){return(0,_wrap.wrap)(this.node).getRootNode()}/**
   * For slot elements, returns the nodes assigned to the slot; otherwise
   * an empty array. It is equivalent to `<slot>.addignedNodes({flatten:true})`.
   *
   * @return {!Array<!Node>} Array of assigned nodes
   * @override
   */},{key:"getDistributedNodes",value:function getDistributedNodes(){return"slot"===this.node.localName?(0,_wrap.wrap)(this.node).assignedNodes({flatten:!0}):[]}/**
   * Returns an array of all slots this element was distributed to.
   *
   * @return {!Array<!HTMLSlotElement>} Description
   * @override
   */},{key:"getDestinationInsertionPoints",value:function getDestinationInsertionPoints(){var ip$=[],n=(0,_wrap.wrap)(this.node).assignedSlot;while(n){ip$.push(n);n=(0,_wrap.wrap)(n).assignedSlot}return ip$}/**
   ...
   */},{key:"importNode",value:function importNode(node,deep){var doc=babelHelpers.instanceof(this.node,Document)?this.node:this.node.ownerDocument;return(0,_wrap.wrap)(doc).importNode(node,deep)}/**
   * @return {!Array<!Node>} Returns a flattened list of all child nodes and
   * nodes assigned to child slots.
   * @override
   */},{key:"getEffectiveChildNodes",value:function getEffectiveChildNodes(){return _flattenedNodesObserver.FlattenedNodesObserver.getFlattenedNodes(/** @type {!HTMLElement} */this.node)}/**
   ...
   * @override
   */},{key:"queryDistributedElements",value:function queryDistributedElements(selector){for(var c$=this.getEffectiveChildNodes(),list=[],i=0,l=c$.length,c;i<l&&(c=c$[i]);i++){if(c.nodeType===Node.ELEMENT_NODE&&matchesSelector(c,selector)){list.push(c)}}return list}/**
   * For shadow roots, returns the currently focused element within this
   * shadow root.
   *
   * return {Node|undefined} Currently focused element
   * @override
   */},{key:"activeElement",get:function get(){var node=this.node;return node._activeElement!==void 0?node._activeElement:node.activeElement}}]);return DomApiNative}();function forwardMethods(proto,methods){for(var _loop=function _loop(i){var method=methods[i];/* eslint-disable valid-jsdoc */proto[method]=/** @this {DomApiNative} */function(){return this.node[method].apply(this.node,arguments)};/* eslint-enable */},i=0;i<methods.length;i++){_loop(i)}}function forwardReadOnlyProperties(proto,properties){for(var _loop2=function _loop2(i){var name=properties[i];Object.defineProperty(proto,name,{get:function get(){var domApi=/** @type {DomApiNative} */this;return domApi.node[name]},configurable:!0})},i=0;i<properties.length;i++){_loop2(i)}}function forwardProperties(proto,properties){for(var _loop3=function _loop3(i){var name=properties[i];Object.defineProperty(proto,name,{/**
       * @this {DomApiNative}
       * @return {*} .
       */get:function get(){return this.node[name]},/**
       * @this {DomApiNative}
       * @param {*} value .
       */set:function set(value){this.node[name]=value},configurable:!0})},i=0;i<properties.length;i++){_loop3(i)}}/**
...
// path.
localTarget:{get:function get(){for(var current=this.event.currentTarget,currentRoot=current&&dom(current).getOwnerRoot(),p$=this.path,i=0,e;i<p$.length;i++){e=p$[i];if(dom(e).getOwnerRoot()===currentRoot){return e}}},configurable:!0},path:{get:function get(){return window.ShadyDOM.composedPath(this.event)},configurable:!0}})}else{// Methods that can provoke distribution or must return the logical, not
// composed tree.
