...
*/(0,_polymerFn.Polymer)({/** @override */_template:(0,_htmlTag.html)(_templateObject_8add787079d011eab2fff3f0fe734e4a()),is:"app-header-layout",behaviors:[_appLayoutBehavior.AppLayoutBehavior],properties:{/**
   ...
   *
   * @property header
   */get header(){return(0,_polymerDom.dom)(this.$.headerSlot).getDistributedNodes()[0]},_updateLayoutStates:function _updateLayoutStates(){var header=this.header;if(!this.isAttached||!header){return}// Remove the initializing class, which staticly positions the header and
