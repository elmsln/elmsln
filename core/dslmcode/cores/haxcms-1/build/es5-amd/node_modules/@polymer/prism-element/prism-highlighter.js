define(["./prism-import.js", "../polymer/lib/legacy/polymer-fn.js", "../polymer/polymer-legacy.js"], function (_prismImport, _polymerFn, _polymerLegacy) {
  "use strict";
  ...
  (0, _polymerFn.Polymer)({
    ...
    _highlight: function _highlight(event) {
      if (!event.detail || !event.detail.code) {
        _polymerLegacy.Base._warn('Malformed', HIGHLIGHT_EVENT, 'event:', event.detail);
