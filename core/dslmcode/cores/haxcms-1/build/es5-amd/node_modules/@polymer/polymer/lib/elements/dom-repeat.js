    ...
    babelHelpers.createClass(DomRepeat, [{
      ...
      value: function __ensureTemplatized() {
        ...
        if (!this.__ctor) {
          ...
          /** @type {!HTMLElement} */
          this;
          var template = this.template = thisAsTemplate._templateInfo ? thisAsTemplate :
          /** @type {!HTMLTemplateElement} */
      ...
      value: function __calculateLimit(filteredItemCount) {
        ...
        var currentCount = this.__instances.length; // When chunking, we increase the limit from the currently rendered count
      ...
      value: function __updateInstances(items, limit, isntIdxToItemsIdx) {
        ...
        var instIdx; // Generate instances and assign items
