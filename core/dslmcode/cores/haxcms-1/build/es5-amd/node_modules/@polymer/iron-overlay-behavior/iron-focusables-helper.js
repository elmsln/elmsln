...
*/var p=Element.prototype,matches=p.matches||p.matchesSelector||p.mozMatchesSelector||p.msMatchesSelector||p.oMatchesSelector||p.webkitMatchesSelector,IronFocusablesHelperClass=/*#__PURE__*/function(){function IronFocusablesHelperClass(){babelHelpers.classCallCheck(this,IronFocusablesHelperClass)}babelHelpers.createClass(IronFocusablesHelperClass,[{key:"getTabbableNodes",/**
...
// e.g. in Firefox `<div contenteditable>` has `tabIndex = -1`
var ati=Math.max(a.tabIndex,0),bti=Math.max(b.tabIndex,0);return 0===ati||0===bti?bti>ati:ati>bti}}]);return IronFocusablesHelperClass}(),IronFocusablesHelper=new IronFocusablesHelperClass;_exports.IronFocusablesHelper=IronFocusablesHelper});