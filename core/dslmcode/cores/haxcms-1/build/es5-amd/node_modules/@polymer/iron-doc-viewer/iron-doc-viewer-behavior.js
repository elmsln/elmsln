define(["exports", "../polymer/lib/legacy/polymer.dom.js", "../polymer/lib/utils/render-status.js"], function (_exports, _polymerDom, _renderStatus) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.IronDocViewerBehavior = void 0;

  /**
   * @polymerBehavior
   */
  var IronDocViewerBehavior = {
    properties: {
      /**
       * The [Polymer
    ...
    _filterMembers: function _filterMembers(items, showProtected, showInherited) {
    ...
    _noneToShow: function _noneToShow(showProtected, showInherited, descriptor, name) {
      if (!descriptor) {
        return true;
      }
     ...
     */
    scrollToAnchor: function scrollToAnchor(hash) {
    ...
    _getElementId: function _getElementId(element) {
      return element.name || element.tagname;
    },
    _getPolymerBehaviors: function _getPolymerBehaviors(descriptor) {
     ...
     * display name.
     */
    _compareDescriptors: function _compareDescriptors(a, b) {
  ...
  _exports.IronDocViewerBehavior = IronDocViewerBehavior;
