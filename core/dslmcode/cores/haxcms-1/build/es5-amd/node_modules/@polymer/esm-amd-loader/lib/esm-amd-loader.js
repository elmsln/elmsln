...
(function () {
  ...
  function load(module) {
    ...
    script.onload = function () {
      ...
      if (_pendingDefine !== undefined) {
        _a = _pendingDefine(), deps = _a[0], moduleBody = _a[1];
      } else {
  ...
  window.define = function (deps, moduleBody) {
    ...
    _pendingDefine = function pendingDefine() {
      defined = true;
      _pendingDefine = undefined;
