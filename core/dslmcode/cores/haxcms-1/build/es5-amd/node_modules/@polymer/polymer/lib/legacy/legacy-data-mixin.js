define(["exports", "../../polymer-legacy.js", "../utils/mixin.js", "../utils/templatize.js"], function (_exports, _polymerLegacy, _mixin, _templatize) {
  "use strict";
  ...
  var Class = _polymerLegacy.Polymer.Class;
  ...
  var existingTemplatizeMixin = _templatize.templatize.mixin;
  _templatize.templatize.mixin = existingTemplatizeMixin ? function (s) {
    return TemplatizeMixin(existingTemplatizeMixin(s));
  } : TemplatizeMixin;
