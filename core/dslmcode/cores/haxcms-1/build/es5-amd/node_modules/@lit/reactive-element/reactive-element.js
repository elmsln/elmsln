define(["exports", "./css-tag.js"], function (_exports, _cssTag) {
  ...
  _exports.notEqual = _exports.defaultConverter = _exports.ReactiveElement = void 0;
  ...
  _exports.notEqual = h;
  _exports.defaultConverter = r;

  var n = /*#__PURE__*/function (_HTMLElement) {
    babelHelpers.inherits(n, _HTMLElement);
    ...
    babelHelpers.createClass(n, [{
      ...
      value: function o() {
        ...
        var t;
        this._$Ev = new Promise(function (t) {
          return _this2.enableUpdating = t;
        }), this._$AL = new Map(), this._$Ep(), this.requestUpdate(), null === (t = this.constructor.l) || void 0 === t || t.forEach(function (t) {
          return t(_this2);
        });
      }
    }, {
      ...
      value: function connectedCallback() {
        var t;
        void 0 === this.renderRoot && (this.renderRoot = this.createRenderRoot()), this.enableUpdating(!0), null === (t = this._$Em) || void 0 === t || t.forEach(function (t) {
          var i;
      ...
      value: function disconnectedCallback() {
        var t;
        null === (t = this._$Em) || void 0 === t || t.forEach(function (t) {
          var i;
      ...
      value: function _$Eg(t, i) {
        ...
        var _n = this.constructor._$Eh(t, s);

        if (void 0 !== _n && !0 === s.reflect) {
          var _o = (null !== (h = null === (e = s.converter) || void 0 === e ? void 0 : e.toAttribute) && void 0 !== h ? h : r.toAttribute)(i, s.type);

          this._$Ei = t, null == _o ? this.removeAttribute(_n) : this.setAttribute(_n, _o), this._$Ei = null;
        }
      }
    }, {
      key: "_$AK",
      ...
      key: "_$EC",
      value: function () {
        var _$EC2 = babelHelpers.asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          var t;
      ...
      value: function performUpdate() {
        ...
        try {
          i = this.shouldUpdate(s), i ? (this.willUpdate(s), null === (t = this._$Em) || void 0 === t || t.forEach(function (t) {
            var i;
      ...
      value: function _$AE(t) {
        var i;
        null === (i = this._$Em) || void 0 === i || i.forEach(function (t) {
          var i;
      ...
      value: function update(t) {
        ...
        void 0 !== this._$ES && (this._$ES.forEach(function (t, i) {
      ...
      value: function createProperty(t) {
        var i = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : o;
