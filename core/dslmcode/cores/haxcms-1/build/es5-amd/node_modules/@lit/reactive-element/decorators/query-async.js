define(["exports", "./base.js"], function (_exports, _base) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.queryAsync = e;
  ...
  function e(e) {
    return (0, _base.decorateProperty)({
      descriptor: function descriptor(r) {
        return {
          get: function () {
            var _get = babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              var r;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      return _context.abrupt("return", null === (r = this.renderRoot) || void 0 === r ? void 0 : r.querySelector(e));
