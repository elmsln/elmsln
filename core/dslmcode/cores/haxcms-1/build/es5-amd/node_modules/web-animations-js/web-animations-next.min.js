...
!function () {
  ...
  !function (a, b) {
    ...
    b.animationsWithPromises = [], b.Animation = function (b, c) {
      ...
      _rebuildUnderlyingAnimation: function _rebuildUnderlyingAnimation() {
        ...
        var a,
            ...
            e,
            f = !!this._animation;
        f && (a = this.playbackRate, c = this._paused, d = this.startTime, e = this.currentTime, this._animation.cancel(), this._animation._wrapper = null, this._animation = null), (!this.effect || babelHelpers.instanceof(this.effect, window.KeyframeEffect)) && (this._animation = b.newUnderlyingAnimationForKeyframeEffect(this.effect), b.bindAnimationForKeyframeEffect(this)), (babelHelpers.instanceof(this.effect, window.SequenceEffect) || babelHelpers.instanceof(this.effect, window.GroupEffect)) && (this._animation = b.newUnderlyingAnimationForGroup(this.effect), b.bindAnimationForGroup(this)), this.effect && this.effect._onsample && b.bindAnimationForCustomEffect(this), f && (1 != a && (this.playbackRate = a), null !== d ? this.startTime = d : null !== e ? this.currentTime = e : null !== this._holdTime && (this.currentTime = this._holdTime), c && this.pause()), this._updatePromises();
      },
      _updateChildren: function _updateChildren() {
        if (this.effect && "idle" != this.playState) {
          ...
          this._childAnimations.forEach(function (c) {
            this._arrangeChildren(c, a), babelHelpers.instanceof(this.effect, window.SequenceEffect) && (a += b.groupChildDuration(c.effect));
          }.bind(this));
        }
      },
      ...
      _constructChildAnimations: function _constructChildAnimations() {
        if (this.effect && this._isGroup) {
          ...
          this._removeChildAnimations(), this.effect.children.forEach(function (c) {
            ...
            this._childAnimations.push(d), d.playbackRate = this.playbackRate, this._paused && d.pause(), c._animation = this.effect._animation, this._arrangeChildren(d, a), babelHelpers.instanceof(this.effect, window.SequenceEffect) && (a += b.groupChildDuration(c));
          }.bind(this));
        }
      },
      ...
      _forEachChild: function _forEachChild(b) {
        ...
        if (this.effect.children && this._childAnimations.length < this.effect.children.length && this._constructChildAnimations(), this._childAnimations.forEach(function (a) {
          b.call(this, a, c), babelHelpers.instanceof(this.effect, window.SequenceEffect) && (c += a.effect.activeDuration);
    ...
    var f = function f(a) {
      if (a._animation = void 0, babelHelpers.instanceof(a, window.SequenceEffect) || babelHelpers.instanceof(a, window.GroupEffect)) for (var b = 0; b < a.children.length; b++) {
        f(a.children[b]);
      }
    };
    ...
    window.SequenceEffect = function () {
      ...
      clone: function clone() {
        ...
        return babelHelpers.instanceof(this, GroupEffect) ? new GroupEffect(c, b) : new SequenceEffect(c, b);
      },
      remove: function remove() {
        b.removeMulti([this]);
      }
