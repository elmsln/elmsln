...
Clazz.defineEnumConstant (c$, "IMAGE", 9, []);
Clazz.defineEnumConstant (c$, "LOADSTRUCT", 10, []);
Clazz.defineEnumConstant (c$, "MEASURE", 11, []);
Clazz.defineEnumConstant (c$, "MESSAGE", 12, []);
Clazz.defineEnumConstant (c$, "MINIMIZATION", 13, []);
Clazz.defineEnumConstant (c$, "SERVICE", 14, []);
Clazz.defineEnumConstant (c$, "PICK", 15, []);
Clazz.defineEnumConstant (c$, "RESIZE", 16, []);
Clazz.defineEnumConstant (c$, "SCRIPT", 17, []);
Clazz.defineEnumConstant (c$, "SYNC", 18, []);
Clazz.defineEnumConstant (c$, "STRUCTUREMODIFIED", 19, []);
});
