  ...
  CKEDITOR.plugins.add( 'drupal_accessibility',
  {
    ...
    init: function( editor )
    {
      ...
      editor.ui.addButton( 'drupal_accessibility',
      {
        ...
        icon: Drupal.settings.basePath + Drupal.settings.accessibility_wysiwyg.path + '/plugins/ckeditor4/drupal_accessibility/img/button.png'
      });
              ...
              $ : function( element ) {
                if(typeof element.attributes !== 'undefined') {
                  if(typeof element.attributes.class === 'string') {
                    element.attributes.class = element.attributes.class.replace(/((severe|moderate|suggestion)|accessibility-result|bt-active)/gi, '').trim();
