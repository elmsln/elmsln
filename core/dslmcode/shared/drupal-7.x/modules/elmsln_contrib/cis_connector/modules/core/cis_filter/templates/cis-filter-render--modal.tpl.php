...
?>
<!-- Modal Trigger -->
<a class="elmsln-modal-trigger elmsln-filter-tpl-modal waves-effect waves-<?php print $lmsless_classes[$tool]['color'];?> waves-light btn vibrate <?php print $lmsless_classes[$tool]['text'];?> <?php print $lmsless_classes[$tool]['color'];?> <?php print $lmsless_classes[$tool]['light'];?> <?php print $lmsless_classes[$tool]['outline'];?>" aria-controls="accessibility-drop" aria-expanded="false" href="#modal-<?php print $trigger;?>"><?php print $icon; ?> <?php print $label; ?></a>
<!-- Modal Structure -->
<div id="modal-<?php print $trigger;?>" class="elmsln-modal modal elmsln-modal-append-container" aria-hidden="true" role="dialog" tabindex="-1" aria-label="<?php print $title; ?>">
  <div class="center-align valign-wrapper elmsln-modal-title-wrapper <?php print $lmsless_classes[$tool]['color'] . ' ' . $lmsless_classes[$tool]['light'] . ' ' . $lmsless_classes[$tool]['color'];?>-border">
    <h3 class="flow-text valign elmsln-modal-title"><?php print $title; ?></h3>
