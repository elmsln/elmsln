...
?>
<!-- Modal Trigger -->
<a href="#side-nav-<?php print $trigger;?>" class="middle-align-wrap elmsln-network-button elmsln-right-side-nav-trigger black-text waves-effect waves-<?php print $lmsless_classes[$tool]['color'];?> waves-light" aria-controls="accessibility-drop" aria-expanded="false" data-activates="side-nav-<?php print $trigger;?>"><?php print $icon; ?> <?php print $label; ?></a>
<!-- Modal Structure -->
