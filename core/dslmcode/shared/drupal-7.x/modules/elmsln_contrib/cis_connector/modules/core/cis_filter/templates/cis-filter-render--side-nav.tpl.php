...
?>
<!-- Modal Trigger -->
<a href="#side-nav-<?php print $trigger;?>" class="elmsln-right-side-nav-trigger <?php print $lmsless_classes[$tool]['text'];?> waves-effect btn waves-<?php print $lmsless_classes[$tool]['color'];?> waves-light <?php print $lmsless_classes[$tool]['color'];?> <?php print $lmsless_classes[$tool]['light'];?> <?php print $lmsless_classes[$tool]['outline'];?>" aria-controls="accessibility-drop" aria-expanded="false" data-activates="side-nav-<?php print $trigger;?>"><?php print $icon; ?> <?php print $label; ?></a>
<!-- Modal Structure -->
