...
class WebComponentsService {
   ...
   */
  public function applyWebcomponents($directory = '/', $buildFile = 'build.js') {
    return 
      $this->getPolyfill($directory) .
      $this->getBuild($directory, $buildFile);
  }
  /**
  ...
  public function getPolyfill($directory = '/') {
    ...
    <script async src="' . $directory . 'build/es6/node_modules/web-animations-js/web-animations-next-lite.min.js"></script>
    <script>if(!window.customElements){document.write("<!--");}</script>
    <script src="' . $directory . 'build/es6/node_modules/@webcomponents/webcomponentsjs/custom-elements-es5-adapter.js"></script>
    <!--! do not remove -->
   ...
   */
  public function getBuild($directory  = '/', $buildFile = 'build.js') {
