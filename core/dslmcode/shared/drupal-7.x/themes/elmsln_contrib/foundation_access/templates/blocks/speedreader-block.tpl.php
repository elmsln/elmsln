...
<div class="controls settings-controls">
  <span class="speed">
    ...
    <simple-icon-button icon="av:fast-rewind" alt="<?php print t('Read slower'); ?>"></simple-icon-button>
    </a>
    <a tabindex="-1" id="spritz_pause" href="#spritz-play" title="<?php print t('Pause or Play');?>" data-jwerty-key="ctrl+d" data-voicecommand="speed reader play"><simple-icon-button icon="av:play-arrow" alt="<?php print t('Pause or Play'); ?>">
    </simple-icon-button></a>
    <a id="spritz_faster" href="#spritz-faster" title="<?php print t('Speed Up');?>" data-jwerty-key="ctrl+f" data-voicecommand="speed reader speed up">
      <simple-icon-button icon="av:fast-forward" alt="<?php print t('Read faster'); ?>"></simple-icon-button>
    </a>
    </a>
  </span>
</div>
