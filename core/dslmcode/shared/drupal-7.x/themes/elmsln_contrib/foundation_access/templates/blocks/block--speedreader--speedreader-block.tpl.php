<section id="<?php print $block_html_id ?>-nav-modal" class="elmsln-scroll-bar elmsln-modal modal" aria-label="<?php print $block->subject; ?>" aria-hidden="true" role="dialog" tabindex="-1">
  <div class="center-align valign-wrapper elmsln-modal-title-wrapper black">
    ...
    <a tabindex="-1" href="#close-dialog" class="close-reveal-modal" aria-label="<?php print t('Close'); ?>" data-voicecommand="close" data-jwerty-key="Esc"><button>&#215;</button></a>
  </div>
  <div class="elmsln-modal-content">
    ...
    <div class="controls settings-controls">
      <span class="speed">
        ...
        <a tabindex="-1" id="spritz_pause" href="#spritz-play" title="<?php print t('Pause/Play');?>" data-jwerty-key="ctrl+d" data-voicecommand="speed reader play"><simple-icon-button icon="av:play-arrow" class="blue-text text-darken-4">
