...
To use these stylesheets, rename the files and chamfer with the name of your theme.
...
chamfer-alpha-default-narrow.css  
...
chamfer-alpha-default-normal.css
...
chamfer-alpha-default-wide.css
