 ...
 */
function discuss_foundation_access_menu_link__menu_discuss_navigation(&$variables) {
 ...
 */
function discuss_foundation_access_menu_tree__menu_discuss_navigation($variables) {
