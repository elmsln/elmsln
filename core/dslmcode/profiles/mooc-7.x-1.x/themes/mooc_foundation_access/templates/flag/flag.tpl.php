...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <?php if ($status == 'unflagged'): ?>
        <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?>" rel="nofollow"><i class="material-icons">bookmark_border</i></a><span class="flag-throbber">&nbsp;</span>
    <?php endif; ?>
    <?php if ($status == 'flagged'): ?>
      <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?> " rel="nofollow"><i class="material-icons">bookmark</i></a><span class="flag-throbber">&nbsp;</span>
    <?php endif; ?>
  <?php else: ?>
