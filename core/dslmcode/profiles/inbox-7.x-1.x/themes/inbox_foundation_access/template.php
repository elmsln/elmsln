 ...
 */
function inbox_foundation_access_menu_link__menu_inbox_navigation(&$variables) {
 ...
 */
function inbox_foundation_access_menu_tree__menu_inbox_navigation($variables) {
