...
function meedjum_preprocess_html(&$vars, $hook) {
...
function meedjum_preprocess_block(&$vars, $hook) {
...
function meedjum_preprocess_node(&$vars) {
 ...
 * 
 */
function meedjum_menu_link(array $variables) {
  ...
  $element['#attributes']['class'][] = meedjum_id_safe($element['#title']);
