...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourcemap!./../../../node_modules/postcss-loader/index.js!./font-awesome.css", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js?sourcemap!./../../../node_modules/postcss-loader/index.js!./font-awesome.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourcemap!./../../../node_modules/postcss-loader/index.js!./wysiwyg-editor.css", function() {
			var newContent = require("!!./../../../node_modules/css-loader/index.js?sourcemap!./../../../node_modules/postcss-loader/index.js!./wysiwyg-editor.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../../css-loader/index.js?sourcemap!./../../../../postcss-loader/index.js!./bootstrap-datepicker3.min.css", function() {
			var newContent = require("!!./../../../../css-loader/index.js?sourcemap!./../../../../postcss-loader/index.js!./bootstrap-datepicker3.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../../../css-loader/index.js?sourcemap!./../../../../postcss-loader/index.js!./bootstrap-timepicker.min.css", function() {
			var newContent = require("!!./../../../../css-loader/index.js?sourcemap!./../../../../postcss-loader/index.js!./bootstrap-timepicker.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
