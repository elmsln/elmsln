...
function startCritqueFailure(assignment) {
    return {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngrx_effects__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_actions__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assignment_service__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__elmsln_service__ = __webpack_require__(38);
...
var AppEffects = (function () {
    function AppEffects(actions$, assignmentService, elmslnService) {
        ...
        this.createAssignment$ = this.actions$
            .ofType(__WEBPACK_IMPORTED_MODULE_4__app_actions__["g" /* ActionTypes */].CREATE_ASSIGNMENT)
            .mergeMap(function (action) { return _this.assignmentService.createAssignment(action.payload); })
            .map(function (assignmentId) { return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__app_actions__["h" /* createAssignmentSuccess */])(assignmentId); });
        this.createCritiqueAssignment$ = this.actions$
            .ofType(__WEBPACK_IMPORTED_MODULE_4__app_actions__["g" /* ActionTypes */].CREATE_CRITIQUE_ASSIGNMENT)
            ...
            .map(function (assignment) { return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__app_actions__["i" /* createCritiqueAssignmentSuccess */])(assignment); });
        // Update the assignment on the server
        this.updateAssignment$ = this.actions$
            .ofType(__WEBPACK_IMPORTED_MODULE_4__app_actions__["g" /* ActionTypes */].UPDATE_ASSIGNMENT)
            .mergeMap(function (action) {
            ...
            .map(function (assignment) { return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__app_actions__["j" /* updateAssignmentSuccess */])(assignment); });
        this.loadAssignments$ = this.actions$
            .ofType(__WEBPACK_IMPORTED_MODULE_4__app_actions__["g" /* ActionTypes */].LOAD_ASSIGNMENTS)
            .mergeMap(function () { return _this.assignmentService.loadAssignments(); })
            .map(function (assignments) { return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__app_actions__["k" /* loadAssignmentsSuccess */])(assignments); });
        // Populate the user.permissions store when the user profile returns
        this.loadPermissions$ = this.actions$
            .ofType(__WEBPACK_IMPORTED_MODULE_4__app_actions__["g" /* ActionTypes */].LOAD_PERMISSIONS)
            .mergeMap(function () { return _this.elmslnService.getUserProfile(); })
            .map(function (profile) {
            if (typeof profile.user.permissions !== 'undefined') {
                return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__app_actions__["l" /* loadPermissionsSuccess */])(profile.user.permissions, profile.user['csrf-token'], Number(profile.user['uid']));
            }
            else {
                return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__app_actions__["l" /* loadPermissionsSuccess */])([], null, null);
            }
        });
        this.deleteAssignment$ = this.actions$
            .ofType(__WEBPACK_IMPORTED_MODULE_4__app_actions__["g" /* ActionTypes */].DELETE_ASSIGNMENT)
        ...
        this.startCritique$ = this.actions$
            .ofType(__WEBPACK_IMPORTED_MODULE_4__app_actions__["g" /* ActionTypes */].START_CRITQUE)
            .map(function (action) { return _this.assignmentService.startCritique(action.payload)
            .subscribe(function (submission) { return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__app_actions__["m" /* startCritqueSuccess */])(_this.assignmentService.convertToAssignment(submission.data[0])); }, function (error) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__app_actions__["n" /* startCritqueFailure */])(action.payload);
    ...
    AppEffects = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3__ngrx_effects__["b" /* Actions */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_3__ngrx_effects__["b" /* Actions */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_5__assignment_service__["a" /* AssignmentService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_5__assignment_service__["a" /* AssignmentService */]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_6__elmsln_service__["a" /* ElmslnService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_6__elmsln_service__["a" /* ElmslnService */]) === 'function' && _c) || Object])
    ], AppEffects);
    return AppEffects;
    var _a, _b, _c;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__reducers_assignments__ = __webpack_require__(624);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__reducers_users__ = __webpack_require__(625);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__submission_submission_reducer__ = __webpack_require__(630);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__projects_project_reducer__ = __webpack_require__(622);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__image_image_reducer__ = __webpack_require__(617);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__app_effects__ = __webpack_require__(603);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__submission_submission_effects__ = __webpack_require__(629);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__projects_project_effects__ = __webpack_require__(621);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22_angular2_moment__ = __webpack_require__(635);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__user_user_component__ = __webpack_require__(631);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__wysiwygjs_wysiwygjs_component__ = __webpack_require__(632);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__projects_projects_component__ = __webpack_require__(623);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__projects_project_card_project_card_component__ = __webpack_require__(619);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__projects_project_item_project_item_component__ = __webpack_require__(620);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__submission_submission_list_submission_list_component__ = __webpack_require__(628);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__submission_submission_detail_submission_detail_component__ = __webpack_require__(626);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__submission_submission_edit_states_submission_edit_states_component__ = __webpack_require__(627);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53__image_image_component__ = __webpack_require__(616);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__ = __webpack_require__(860);
...
function reducer(state, action) {
    ...
    switch (action.type) {
        ...
        case __WEBPACK_IMPORTED_MODULE_0__app_actions__["g" /* ActionTypes */].START_CRITQUE: {
            return state;
        }
        default: {
            return state;
