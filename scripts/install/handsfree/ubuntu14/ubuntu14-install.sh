...
apt-get -y install sendmail uuid curl policycoreutils php5-mysql mysql-server patch git nano gcc make apache2 libapache2-mod-fastcgi apache2-mpm-event libapache2-mod-php5 php5 php5-fpm php5-common php-xml-parser php5-cgi php5-curl php5-gd php5-cli php5-fpm php-apc php-pear php5-dev php5-mcrypt mcrypt php5-gd
# Install docker
