...
#install php
apt-get -y install php php7.2-fpm php7.2-gd php7.2-xml php-common php-mysql php-ldap php-cgi php-pear php7.2-mbstring php7.2-zip php-xml-parser php-curl php-cli php-apcu php-dev php-mcrypt mcrypt
apt-get install -y 
